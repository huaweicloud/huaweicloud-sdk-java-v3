...
public class UpdateAssetReq  {
    ...
    public UpdateAssetReq withAssetId(String assetId) {
    ...
    public UpdateAssetReq withVideoMd5(String videoMd5) {
    ...
    public UpdateAssetReq withVideoName(String videoName) {
    ...
    public UpdateAssetReq withVideoType(VideoTypeEnum videoType) {
    ...
    public UpdateAssetReq withCoverId(Integer coverId) {
    ...
    public UpdateAssetReq withCoverType(CoverTypeEnum coverType) {
    ...
    public UpdateAssetReq withCoverMd5(String coverMd5) {
    ...
    public UpdateAssetReq withSubtitles(List<Subtitle> subtitles) {
        this.subtitles = subtitles;
        return this;
    }

    
    public UpdateAssetReq addSubtitlesItem(Subtitle subtitlesItem) {
    ...
    public UpdateAssetReq withSubtitles(Consumer<List<Subtitle>> subtitlesSetter) {
        if(this.subtitles == null) {
            this.subtitles = new ArrayList<>();
        }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        return Objects.equals(this.assetId, updateAssetReq.assetId) &&
            Objects.equals(this.videoMd5, updateAssetReq.videoMd5) &&
            Objects.equals(this.videoName, updateAssetReq.videoName) &&
            Objects.equals(this.videoType, updateAssetReq.videoType) &&
            Objects.equals(this.coverId, updateAssetReq.coverId) &&
            Objects.equals(this.coverType, updateAssetReq.coverType) &&
            Objects.equals(this.coverMd5, updateAssetReq.coverMd5) &&
            Objects.equals(this.subtitles, updateAssetReq.subtitles);
    }
    @Override
    public int hashCode() {
