...
public class UpdateStorageModeRequest {
    ...
    public UpdateStorageModeRequest withBody(Consumer<UpdateStorageModeReq> bodySetter) {
        if (this.body == null) {
            this.body = new UpdateStorageModeReq();
     ...
     * @return body
     */
    public UpdateStorageModeReq getBody() {
        return body;
    }

    public void setBody(UpdateStorageModeReq body) {
        this.body = body;
    }
