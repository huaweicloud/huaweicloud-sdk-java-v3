...
public class AssetDetails  {
    ...
    public AssetDetails withAssetId(String assetId) {
    ...
    public AssetDetails withAssetStatus(AssetStatusEnum assetStatus) {
    ...
    public AssetDetails withTranscodeStatus(TranscodeStatusEnum transcodeStatus) {
    ...
    public AssetDetails withBaseInfo(BaseInfo baseInfo) {
        this.baseInfo = baseInfo;
        return this;
    }

    public AssetDetails withBaseInfo(Consumer<BaseInfo> baseInfoSetter) {
    ...
    public AssetDetails withTranscodeInfo(TranscodeInfo transcodeInfo) {
        this.transcodeInfo = transcodeInfo;
        return this;
    }

    public AssetDetails withTranscodeInfo(Consumer<TranscodeInfo> transcodeInfoSetter) {
