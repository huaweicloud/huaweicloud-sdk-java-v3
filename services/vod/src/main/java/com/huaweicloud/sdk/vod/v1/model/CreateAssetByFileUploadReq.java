...
public class CreateAssetByFileUploadReq  {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(title, description, videoName, videoType, categoryId, videoMd5, coverType, coverMd5, subtitles, tags, autoPublish, templateGroupName, autoEncrypt, autoPreheat, thumbnail, review, workflowName);
    }
    @Override
    public String toString() {
