...
public class QuotaDetailVolumesGPSSD  {
    ...
    public QuotaDetailVolumesGPSSD withLimit(Integer limit) {
        this.limit = limit;
        return this;
    }
    ...
    public QuotaDetailVolumesGPSSD withReserved(Integer reserved) {
    ...
    public QuotaDetailVolumesGPSSD withAllocated(String allocated) {
