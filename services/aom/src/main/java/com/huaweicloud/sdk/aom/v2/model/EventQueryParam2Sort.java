...
public class EventQueryParam2Sort  {
    ...
    public EventQueryParam2Sort withOrderBy(List<String> orderBy) {
        this.orderBy = orderBy;
        return this;
    }

    
    public EventQueryParam2Sort addOrderByItem(String orderByItem) {
    ...
    public EventQueryParam2Sort withOrderBy(Consumer<List<String>> orderBySetter) {
        if(this.orderBy == null) {
            this.orderBy = new ArrayList<>();
        }
    ...
    public EventQueryParam2Sort withOrder(OrderEnum order) {
        this.order = order;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        EventQueryParam2Sort eventQueryParam2Sort = (EventQueryParam2Sort) o;
        return Objects.equals(this.orderBy, eventQueryParam2Sort.orderBy) &&
            Objects.equals(this.order, eventQueryParam2Sort.order);
    }
    @Override
    public int hashCode() {
