package com.huaweicloud.sdk.aom.v3.region;
...
public class AomRegion {
    ...
    public static final Region CN_SOUTHWEST_2 = new Region("cn-southwest-2", "https://aom.cn-southwest-2.myhuaweicloud.com");
    public static final Region AP_SOUTHEAST_1 = new Region("ap-southeast-1", "https://aom.ap-southeast-1.myhuaweicloud.com");
    public static final Region AF_SOUTH_1 = new Region("af-south-1", "https://aom.af-south-1.myhuaweicloud.com");
    public static final Region AP_SOUTHEAST_2 = new Region("ap-southeast-2", "https://aom.ap-southeast-2.myhuaweicloud.com");
    public static final Region AP_SOUTHEAST_3 = new Region("ap-southeast-3", "https://aom.ap-southeast-3.myhuaweicloud.com");
    public static final Region CN_NORTH_2 = new Region("cn-north-2", "https://aom.cn-north-2.myhuaweicloud.com");
    public static final Region RU_NORTHWEST_2 = new Region("ru-northwest-2", "https://aom.ru-northwest-2.myhuaweicloud.com");
