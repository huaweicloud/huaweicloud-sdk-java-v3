 ...
 * Response Object
 */
public class ShowDashBoardResponse extends SdkResponse {
    ...
    public ShowDashBoardResponse withProjectId(String projectId) {
    ...
    public ShowDashBoardResponse withDashboardType(String dashboardType) {
    ...
    public ShowDashBoardResponse withDashboardTitle(String dashboardTitle) {
    ...
    public ShowDashBoardResponse withDashboardTitleEn(String dashboardTitleEn) {
    ...
    public ShowDashBoardResponse withDashboardId(String dashboardId) {
    ...
    public ShowDashBoardResponse withVersion(String version) {
    ...
    public ShowDashBoardResponse withEnterpriseProjectId(String enterpriseProjectId) {
    ...
    public ShowDashBoardResponse withFolderName(String folderName) {
    ...
    public ShowDashBoardResponse withFolderId(String folderId) {
    ...
    public ShowDashBoardResponse withSyncData(String syncData) {
    ...
    public ShowDashBoardResponse withIsCreateAction(Boolean isCreateAction) {
    ...
    public ShowDashBoardResponse withDashboardTags(List<Map<String, String>> dashboardTags) {
        this.dashboardTags = dashboardTags;
        return this;
    }

    public ShowDashBoardResponse addDashboardTagsItem(Map<String, String> dashboardTagsItem) {
    ...
    public ShowDashBoardResponse withDashboardTags(Consumer<List<Map<String, String>>> dashboardTagsSetter) {
        if (this.dashboardTags == null) {
            this.dashboardTags = new ArrayList<>();
        }
    ...
    public ShowDashBoardResponse withIsFavorite(Boolean isFavorite) {
    ...
    public ShowDashBoardResponse withCreated(Long created) {
    ...
    public ShowDashBoardResponse withUpdated(Long updated) {
    ...
    public ShowDashBoardResponse withCreatedBy(String createdBy) {
    ...
    public ShowDashBoardResponse withUpdatedBy(String updatedBy) {
    ...
    public ShowDashBoardResponse withCharts(Object charts) {
        this.charts = charts;
        return this;
    }
    ...
    public ShowDashBoardResponse withTemplating(Object templating) {
    ...
    public ShowDashBoardResponse withDisplay(Boolean display) {
    ...
    public ShowDashBoardResponse withQueryCount(Integer queryCount) {
    ...
    public ShowDashBoardResponse withTimeRange(String timeRange) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ShowDashBoardResponse that = (ShowDashBoardResponse) obj;
