...
public class UpdateAppResponse extends SdkResponse {
    ...
    public UpdateAppResponse withAomId(String aomId) {
        this.aomId = aomId;
        return this;
    }
    ...
    public UpdateAppResponse withAppId(String appId) {
        this.appId = appId;
        return this;
    }
    ...
    public UpdateAppResponse withCreateTime(String createTime) {
    ...
    public UpdateAppResponse withCreator(String creator) {
    ...
    public UpdateAppResponse withDescription(String description) {
    ...
    public UpdateAppResponse withDisplayName(String displayName) {
    ...
    public UpdateAppResponse withEpsId(String epsId) {
        this.epsId = epsId;
        return this;
    }
    ...
    public UpdateAppResponse withModifiedTime(String modifiedTime) {
    ...
    public UpdateAppResponse withModifier(String modifier) {
    ...
    public UpdateAppResponse withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public UpdateAppResponse withRegisterType(RegisterTypeEnum registerType) {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        return Objects.equals(this.aomId, updateAppResponse.aomId) &&
            Objects.equals(this.appId, updateAppResponse.appId) &&
            Objects.equals(this.createTime, updateAppResponse.createTime) &&
            Objects.equals(this.creator, updateAppResponse.creator) &&
            Objects.equals(this.description, updateAppResponse.description) &&
            Objects.equals(this.displayName, updateAppResponse.displayName) &&
            Objects.equals(this.epsId, updateAppResponse.epsId) &&
            Objects.equals(this.modifiedTime, updateAppResponse.modifiedTime) &&
            Objects.equals(this.modifier, updateAppResponse.modifier) &&
            Objects.equals(this.name, updateAppResponse.name) &&
            Objects.equals(this.registerType, updateAppResponse.registerType);
    }
    @Override
    public int hashCode() {
