 ...
 * 查询事件或者告警信息 。
 */
@JacksonXmlRootElement(localName = "EventQueryParam")
public class EventQueryParam  {
    ...
    public EventQueryParam withTimeRange(String timeRange) {
    ...
    public EventQueryParam withStep(Long step) {
        this.step = step;
        return this;
    }
    ...
    public EventQueryParam withSearch(String search) {
        this.search = search;
        return this;
    }
    ...
    public EventQueryParam withSort(EventQueryParamSort sort) {
        this.sort = sort;
        return this;
    }

    public EventQueryParam withSort(Consumer<EventQueryParamSort> sortSetter) {
        if(this.sort == null ){
    ...
    public EventQueryParam withMetadataRelation(List<RelationModel> metadataRelation) {
        this.metadataRelation = metadataRelation;
        return this;
    }

    
    public EventQueryParam addMetadataRelationItem(RelationModel metadataRelationItem) {
    ...
    public EventQueryParam withMetadataRelation(Consumer<List<RelationModel>> metadataRelationSetter) {
        if(this.metadataRelation == null) {
            this.metadataRelation = new ArrayList<>();
        }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        EventQueryParam eventQueryParam = (EventQueryParam) o;
        return Objects.equals(this.timeRange, eventQueryParam.timeRange) &&
            Objects.equals(this.step, eventQueryParam.step) &&
            Objects.equals(this.search, eventQueryParam.search) &&
            Objects.equals(this.sort, eventQueryParam.sort) &&
            Objects.equals(this.metadataRelation, eventQueryParam.metadataRelation);
    }
    @Override
    public int hashCode() {
