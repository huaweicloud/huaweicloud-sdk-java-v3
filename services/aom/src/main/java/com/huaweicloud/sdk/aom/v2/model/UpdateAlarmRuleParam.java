...
public class UpdateAlarmRuleParam {
    ...
    public UpdateAlarmRuleParam withComparisonOperator(ComparisonOperatorEnum comparisonOperator) {
    ...
    public UpdateAlarmRuleParam withIsTurnOn(Boolean isTurnOn) {
    ...
    public UpdateAlarmRuleParam withPeriod(PeriodEnum period) {
        this.period = period;
        return this;
    }
