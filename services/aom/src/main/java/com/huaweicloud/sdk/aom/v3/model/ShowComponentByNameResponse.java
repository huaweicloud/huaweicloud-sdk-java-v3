...
public class ShowComponentByNameResponse extends SdkResponse {
    ...
    public ShowComponentByNameResponse withCreateTime(String createTime) {
    ...
    public ShowComponentByNameResponse withCreator(String creator) {
    ...
    public ShowComponentByNameResponse withDescription(String description) {
    ...
    public ShowComponentByNameResponse withModifiedTime(String modifiedTime) {
    ...
    public ShowComponentByNameResponse withModifier(String modifier) {
    ...
    public ShowComponentByNameResponse withRegisterType(RegisterTypeEnum registerType) {
    ...
    public ShowComponentByNameResponse withSubAppId(String subAppId) {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        return Objects.equals(this.aomId, showComponentByNameResponse.aomId) &&
            Objects.equals(this.appId, showComponentByNameResponse.appId) &&
            Objects.equals(this.createTime, showComponentByNameResponse.createTime) &&
            Objects.equals(this.creator, showComponentByNameResponse.creator) &&
            Objects.equals(this.description, showComponentByNameResponse.description) &&
            Objects.equals(this.id, showComponentByNameResponse.id) &&
            Objects.equals(this.modifiedTime, showComponentByNameResponse.modifiedTime) &&
            Objects.equals(this.modifier, showComponentByNameResponse.modifier) &&
            Objects.equals(this.name, showComponentByNameResponse.name) &&
            Objects.equals(this.registerType, showComponentByNameResponse.registerType) &&
            Objects.equals(this.subAppId, showComponentByNameResponse.subAppId);
    }
    @Override
    public int hashCode() {
        return Objects.hash(aomId, appId, createTime, creator, description, id, modifiedTime, modifier, name, registerType, subAppId);
    }
    @Override
    public String toString() {
