 ...
 * Request Object
 */
@JacksonXmlRootElement(localName = "UpdateEventRuleRequest")
public class UpdateEventRuleRequest  {
    ...
    public UpdateEventRuleRequest withBody(Event2alarmRuleBody body) {
        this.body = body;
        return this;
    }

    public UpdateEventRuleRequest withBody(Consumer<Event2alarmRuleBody> bodySetter) {
        if(this.body == null ){
    ...
    public boolean equals(java.lang.Object o) {
        ...
        return Objects.equals(this.body, updateEventRuleRequest.body);
    }
    @Override
    public int hashCode() {
