...
public class QueryBodyParam {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        QueryBodyParam that = (QueryBodyParam) obj;
        return Objects.equals(this.category, that.category) && Objects.equals(this.endTime, that.endTime)
            && Objects.equals(this.hideSyslog, that.hideSyslog) && Objects.equals(this.keyWord, that.keyWord)
            && Objects.equals(this.lineNum, that.lineNum) && Objects.equals(this.pageSizeSize, that.pageSizeSize)
            && Objects.equals(this.searchKey, that.searchKey) && Objects.equals(this.startTime, that.startTime)
            && Objects.equals(this.type, that.type) && Objects.equals(this.isDesc, that.isDesc);
    }

    @Override
    public int hashCode() {
        return Objects
            .hash(category, endTime, hideSyslog, keyWord, lineNum, pageSizeSize, searchKey, startTime, type, isDesc);
    }
