 ...
 * Response Object
 */
public class CreateCallNotifyResponse extends SdkResponse {
    ...
    public CreateCallNotifyResponse withResultcode(String resultcode) {
    ...
    public CreateCallNotifyResponse withResultdesc(String resultdesc) {
    ...
    public CreateCallNotifyResponse withSessionId(String sessionId) {
    ...
    public CreateCallNotifyResponse withIdlePort(Integer idlePort) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        CreateCallNotifyResponse that = (CreateCallNotifyResponse) obj;
    ...
    public String toString() {
        ...
        sb.append("class CreateCallNotifyResponse {\n");
