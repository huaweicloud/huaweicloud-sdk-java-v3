 ...
 * Response Object
 */
public class CreateCallVerifyResponse extends SdkResponse {
    ...
    public CreateCallVerifyResponse withResultcode(String resultcode) {
    ...
    public CreateCallVerifyResponse withResultdesc(String resultdesc) {
    ...
    public CreateCallVerifyResponse withSessionId(String sessionId) {
    ...
    public CreateCallVerifyResponse withIdlePort(Integer idlePort) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        CreateCallVerifyResponse that = (CreateCallVerifyResponse) obj;
    ...
    public String toString() {
        ...
        sb.append("class CreateCallVerifyResponse {\n");
