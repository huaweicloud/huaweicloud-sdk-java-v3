...
public class CreateCallBackRequest {
    ...
    private CallBackReq body;

    public CreateCallBackRequest withAuthorization(String authorization) {
    ...
    public CreateCallBackRequest withXAksk(String xAksk) {
        this.xAksk = xAksk;
        return this;
    }
    ...
    public CreateCallBackRequest withBody(CallBackReq body) {
        this.body = body;
        return this;
    }

    public CreateCallBackRequest withBody(Consumer<CallBackReq> bodySetter) {
        if (this.body == null) {
            this.body = new CallBackReq();
     ...
     * @return body
     */
    public CallBackReq getBody() {
        return body;
    }

    public void setBody(CallBackReq body) {
        this.body = body;
    }
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        CreateCallBackRequest that = (CreateCallBackRequest) obj;
    ...
    public String toString() {
        ...
        sb.append("class CreateCallBackRequest {\n");
