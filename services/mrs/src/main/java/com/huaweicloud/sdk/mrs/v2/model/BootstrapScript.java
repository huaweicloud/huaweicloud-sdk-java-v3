...
public class BootstrapScript {
    ...
    /**
     * 枚举值： - BEFORE_COMPONENT_FIRST_START: 组件首次启动前 - AFTER_COMPONENT_FIRST_START: 组件首次启动后 - BEFORE_SCALE_IN: 缩容前 - AFTER_SCALE_IN: 缩容后 - BEFORE_SCALE_OUT: 扩容前 - AFTER_SCALE_OUT: 扩容后
     */
    public static final class ActionStagesEnum {
        ...
        public static ActionStagesEnum fromValue(String value) {
            ...
            return java.util.Optional.ofNullable(STATIC_FIELDS.get(value)).orElse(new ActionStagesEnum(value));
        }
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        BootstrapScript that = (BootstrapScript) obj;
        return Objects.equals(this.name, that.name) && Objects.equals(this.uri, that.uri)
            ...
            && Objects.equals(this.beforeComponentStart, that.beforeComponentStart)
            && Objects.equals(this.startTime, that.startTime) && Objects.equals(this.state, that.state)
            && Objects.equals(this.actionStages, that.actionStages);
    }
