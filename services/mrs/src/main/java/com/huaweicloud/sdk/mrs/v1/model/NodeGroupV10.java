...
public class NodeGroupV10 {
    ...
    /** 节点数量，取值范围0～500，Master节点和Core节点数量至少为1，Core与Task节点总数最大为500个。 minimum: 0 maximum: 500
     * 
     * @return nodeNum */
    ...
    /** 节点系统盘大小，不可配置，默认为40GB。 minimum: 40 maximum: 32000
     * 
    ...
    /** 节点数据磁盘存储数目。 minimum: 0 maximum: 10
     * 
