...
public class CreateAndExecuteJobResponse extends SdkResponse {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        CreateAndExecuteJobResponse that = (CreateAndExecuteJobResponse) obj;
        return Objects.equals(this.templated, that.templated) && Objects.equals(this.createdAt, that.createdAt)
            && Objects.equals(this.updatedAt, that.updatedAt) && Objects.equals(this.id, that.id)
            && Objects.equals(this.tenantId, that.tenantId) && Objects.equals(this.jobId, that.jobId)
            && Objects.equals(this.jobName, that.jobName) && Objects.equals(this.inputId, that.inputId)
            && Objects.equals(this.outputId, that.outputId) && Objects.equals(this.startTime, that.startTime)
            && Objects.equals(this.endTime, that.endTime) && Objects.equals(this.clusterId, that.clusterId)
            && Objects.equals(this.engineJobId, that.engineJobId) && Objects.equals(this.returnCode, that.returnCode)
            && Objects.equals(this.isPublic, that.isPublic) && Objects.equals(this.isProtected, that.isProtected)
            && Objects.equals(this.groupId, that.groupId) && Objects.equals(this.jarPath, that.jarPath)
            && Objects.equals(this.input, that.input) && Objects.equals(this.output, that.output)
            && Objects.equals(this.jobLog, that.jobLog) && Objects.equals(this.jobType, that.jobType)
            && Objects.equals(this.fileAction, that.fileAction) && Objects.equals(this.arguments, that.arguments)
            && Objects.equals(this.hql, that.hql) && Objects.equals(this.jobState, that.jobState)
            && Objects.equals(this.jobFinalStatus, that.jobFinalStatus)
            ...
            && Objects.equals(this.credentials, that.credentials) && Objects.equals(this.userId, that.userId)
            && Objects.equals(this.jobConfigs, that.jobConfigs) && Objects.equals(this.extra, that.extra)
            && Objects.equals(this.dataSourceUrls, that.dataSourceUrls) && Objects.equals(this.info, that.info);
    }

    @Override
    public int hashCode() {
        return Objects.hash(templated,
            createdAt,
            updatedAt,
            id,
            tenantId,
