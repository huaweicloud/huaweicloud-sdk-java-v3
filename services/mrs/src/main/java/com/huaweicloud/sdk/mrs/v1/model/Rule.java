...
public class Rule {
    ...
    public static final class AdjustmentTypeEnum {
        ...
        public static AdjustmentTypeEnum fromValue(String value) {
            ...
            return java.util.Optional.ofNullable(STATIC_FIELDS.get(value)).orElse(new AdjustmentTypeEnum(value));
        }
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        return Objects.equals(this.name, that.name) && Objects.equals(this.description, that.description)
            ...
            && Objects.equals(this.coolDownMinutes, that.coolDownMinutes)
            && Objects.equals(this.scalingAdjustment, that.scalingAdjustment)
