...
public class HealthCodeRequestBody {
    ...
    public HealthCodeRequestBody withImage(String image) {
        this.image = image;
        return this;
    }
    ...
    public HealthCodeRequestBody withUrl(String url) {
        this.url = url;
        return this;
    }
    ...
    public HealthCodeRequestBody withDetectDirection(Boolean detectDirection) {
