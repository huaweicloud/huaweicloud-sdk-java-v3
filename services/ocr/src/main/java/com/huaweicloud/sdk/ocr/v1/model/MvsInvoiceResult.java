...
public class MvsInvoiceResult  {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        return Objects.equals(this.code, mvsInvoiceResult.code) &&
            Objects.equals(this.number, mvsInvoiceResult.number) &&
            ...
            Objects.equals(this.taxRate, mvsInvoiceResult.taxRate) &&
            Objects.equals(this.tax, mvsInvoiceResult.tax) &&
    ...
    @Override
    public int hashCode() {
        return Objects.hash(code, number, machinePrintedCode, machinePrintedNumber, issueDate, machineNumber, buyerName, buyerOrganizationNumber, buyerId, sellerName, sellerPhone, sellerId, sellerAccount, sellerAddress, sellerBank, vehicleType, brandModel, manufacturingLocation, qualityCertificate, importCertificate, inspectionNumber, engineNumber, vehicleIdentificationNumber, tonnage, seatingCapacity, taxAuthority, taxAuthorityCode, taxPaymentReceipt, taxRate, tax, taxExclusivePrice, total, totalChinese, fiscalCode);
    }
    @Override
