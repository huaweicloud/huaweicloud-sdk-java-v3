 ...
 * Request Object
 */
public class RecognizeCambodianIdCardRequest {
    ...
    private CambodianIdCardRequestBody body;

    public RecognizeCambodianIdCardRequest withEnterpriseProjectId(String enterpriseProjectId) {
    ...
    public RecognizeCambodianIdCardRequest withBody(CambodianIdCardRequestBody body) {
        this.body = body;
        return this;
    }

    public RecognizeCambodianIdCardRequest withBody(Consumer<CambodianIdCardRequestBody> bodySetter) {
        if (this.body == null) {
            this.body = new CambodianIdCardRequestBody();
     ...
     * @return body
     */
    public CambodianIdCardRequestBody getBody() {
        return body;
    }

    public void setBody(CambodianIdCardRequestBody body) {
        this.body = body;
    }
    ...
    public String toString() {
        ...
        sb.append("class RecognizeCambodianIdCardRequest {\n");
