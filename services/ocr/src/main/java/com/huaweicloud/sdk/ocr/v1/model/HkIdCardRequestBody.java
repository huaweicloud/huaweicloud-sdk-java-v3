 ...
 * HkIdCardRequestBody
 */
public class HkIdCardRequestBody {
    ...
    public HkIdCardRequestBody withImage(String image) {
        this.image = image;
        return this;
    }
    ...
    public HkIdCardRequestBody withUrl(String url) {
        this.url = url;
        return this;
    }
    ...
    public HkIdCardRequestBody withReturnPortraitImage(Boolean returnPortraitImage) {
    ...
    public HkIdCardRequestBody withReturnPortraitLocation(Boolean returnPortraitLocation) {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        HkIdCardRequestBody hkIdCardRequestBody = (HkIdCardRequestBody) o;
        return Objects.equals(this.image, hkIdCardRequestBody.image)
            && Objects.equals(this.url, hkIdCardRequestBody.url)
            && Objects.equals(this.returnPortraitImage, hkIdCardRequestBody.returnPortraitImage)
            && Objects.equals(this.returnPortraitLocation, hkIdCardRequestBody.returnPortraitLocation);
    }
    ...
    public String toString() {
        ...
        sb.append("class HkIdCardRequestBody {\n");
