...
public class RecognizeBankcardRequest {
    ...
    private BankcardRequestBody body;

    public RecognizeBankcardRequest withEnterpriseProjectId(String enterpriseProjectId) {
    ...
    public RecognizeBankcardRequest withBody(BankcardRequestBody body) {
        this.body = body;
        return this;
    }

    public RecognizeBankcardRequest withBody(Consumer<BankcardRequestBody> bodySetter) {
        if (this.body == null) {
            this.body = new BankcardRequestBody();
     ...
     * @return body
     */
    public BankcardRequestBody getBody() {
        return body;
    }

    public void setBody(BankcardRequestBody body) {
        this.body = body;
    }
    ...
    public String toString() {
        ...
        sb.append("class RecognizeBankcardRequest {\n");
