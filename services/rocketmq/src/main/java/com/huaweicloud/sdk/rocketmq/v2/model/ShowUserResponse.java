...
public class ShowUserResponse extends SdkResponse {
    ...
    public ShowUserResponse withGroupPerms(List<UserRespGroupPerms> groupPerms) {
        this.groupPerms = groupPerms;
        return this;
    }

    public ShowUserResponse addGroupPermsItem(UserRespGroupPerms groupPermsItem) {
    ...
    public ShowUserResponse withGroupPerms(Consumer<List<UserRespGroupPerms>> groupPermsSetter) {
        if (this.groupPerms == null) {
            this.groupPerms = new ArrayList<>();
        }
