...
public class CreateUserResponse extends SdkResponse {
    ...
    public CreateUserResponse withSecretKey(String secretKey) {
    ...
    public CreateUserResponse withWhiteRemoteAddress(String whiteRemoteAddress) {
    ...
    public CreateUserResponse withAdmin(Boolean admin) {
        this.admin = admin;
        return this;
    }
    ...
    public CreateUserResponse withDefaultTopicPerm(DefaultTopicPermEnum defaultTopicPerm) {
    ...
    public CreateUserResponse withDefaultGroupPerm(DefaultGroupPermEnum defaultGroupPerm) {
    ...
    public CreateUserResponse withTopicPerms(List<UserTopicPerms> topicPerms) {
        this.topicPerms = topicPerms;
        return this;
    }

    public CreateUserResponse addTopicPermsItem(UserTopicPerms topicPermsItem) {
    ...
    public CreateUserResponse withTopicPerms(Consumer<List<UserTopicPerms>> topicPermsSetter) {
        if (this.topicPerms == null) {
            this.topicPerms = new ArrayList<>();
        }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        return Objects.equals(this.accessKey, createUserResponse.accessKey)
            && Objects.equals(this.secretKey, createUserResponse.secretKey)
            && Objects.equals(this.whiteRemoteAddress, createUserResponse.whiteRemoteAddress)
            && Objects.equals(this.admin, createUserResponse.admin)
            && Objects.equals(this.defaultTopicPerm, createUserResponse.defaultTopicPerm)
            && Objects.equals(this.defaultGroupPerm, createUserResponse.defaultGroupPerm)
            && Objects.equals(this.topicPerms, createUserResponse.topicPerms)
            && Objects.equals(this.groupPerms, createUserResponse.groupPerms);
    }
