...
public class ProductEntityProperties {
    ...
    public ProductEntityProperties withMaxTopic(String maxTopic) {
    ...
    public ProductEntityProperties withBrokerNum(String brokerNum) {
    ...
    public ProductEntityProperties withCore(String core) {
        this.core = core;
        return this;
    }
    ...
    public ProductEntityProperties withMaxConsumer(String maxConsumer) {
    ...
    public ProductEntityProperties withRcu(String rcu) {
        this.rcu = rcu;
        return this;
    }
    ...
    public ProductEntityProperties withMaxStorage(String maxStorage) {
    ...
    public ProductEntityProperties withMaxStoragePerNode(String maxStoragePerNode) {
    ...
    public ProductEntityProperties withProductAlias(String productAlias) {
    ...
    public ProductEntityProperties withMaxTpsPerRcu(String maxTpsPerRcu) {
    ...
    public ProductEntityProperties withMinStorage(String minStorage) {
    ...
    public ProductEntityProperties withMinStoragePerNode(String minStoragePerNode) {
    ...
    public ProductEntityProperties withMaxBroker(String maxBroker) {
    ...
    public ProductEntityProperties withMaxTopicPerBroker(String maxTopicPerBroker) {
    ...
    public ProductEntityProperties withMaxConsumerPerBroker(String maxConsumerPerBroker) {
    ...
    public ProductEntityProperties withMinBroker(String minBroker) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ProductEntityProperties that = (ProductEntityProperties) obj;
        return Objects.equals(this.maxTopic, that.maxTopic) && Objects.equals(this.brokerNum, that.brokerNum)
