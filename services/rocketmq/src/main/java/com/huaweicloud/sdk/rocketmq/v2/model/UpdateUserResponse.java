...
public class UpdateUserResponse extends SdkResponse {
    ...
    public UpdateUserResponse withGroupPerms(List<UserRespGroupPerms> groupPerms) {
        this.groupPerms = groupPerms;
        return this;
    }

    public UpdateUserResponse addGroupPermsItem(UserRespGroupPerms groupPermsItem) {
    ...
    public UpdateUserResponse withGroupPerms(Consumer<List<UserRespGroupPerms>> groupPermsSetter) {
        if (this.groupPerms == null) {
            this.groupPerms = new ArrayList<>();
        }
