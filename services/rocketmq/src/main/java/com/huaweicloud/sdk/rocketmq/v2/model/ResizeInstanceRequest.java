...
public class ResizeInstanceRequest {
    ...
    public ResizeInstanceRequest withEngine(String engine) {
        this.engine = engine;
        return this;
    }
    ...
    public ResizeInstanceRequest withBody(ResizeEngineInstanceReq body) {
        this.body = body;
        return this;
    }

    public ResizeInstanceRequest withBody(Consumer<ResizeEngineInstanceReq> bodySetter) {
        if (this.body == null) {
