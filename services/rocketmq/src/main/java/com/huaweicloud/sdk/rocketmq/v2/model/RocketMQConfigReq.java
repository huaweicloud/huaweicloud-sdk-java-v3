...
public class RocketMQConfigReq {
    ...
    public static final class NameEnum {
         ...
         */
        public static final NameEnum FILERESERVEDTIME = new NameEnum("fileReservedTime");
        ...
        private static Map<String, NameEnum> createStaticFields() {
            ...
            map.put("fileReservedTime", FILERESERVEDTIME);
    ...
    public RocketMQConfigReq withName(NameEnum name) {
        this.name = name;
        return this;
    }
    ...
    public RocketMQConfigReq withValue(String value) {
        this.value = value;
        return this;
    }
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        RocketMQConfigReq that = (RocketMQConfigReq) obj;
