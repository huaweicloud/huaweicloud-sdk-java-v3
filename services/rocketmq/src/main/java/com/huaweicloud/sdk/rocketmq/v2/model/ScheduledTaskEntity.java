...
public class ScheduledTaskEntity {
    ...
    public ScheduledTaskEntity withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public ScheduledTaskEntity withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public ScheduledTaskEntity withUserName(String userName) {
    ...
    public ScheduledTaskEntity withUserId(String userId) {
        this.userId = userId;
        return this;
    }
    ...
    public ScheduledTaskEntity withParams(String params) {
        this.params = params;
        return this;
    }
    ...
    public ScheduledTaskEntity withStatus(String status) {
        this.status = status;
        return this;
    }
    ...
    public ScheduledTaskEntity withCreatedAt(String createdAt) {
    ...
    public ScheduledTaskEntity withUpdatedAt(String updatedAt) {
    ...
    public ScheduledTaskEntity withScheduleAt(String scheduleAt) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ScheduledTaskEntity that = (ScheduledTaskEntity) obj;
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, name, userName, userId, params, status, createdAt, updatedAt, scheduleAt);
    }
