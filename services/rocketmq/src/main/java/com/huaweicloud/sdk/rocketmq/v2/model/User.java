...
public class User {
    ...
    public User withWhiteRemoteAddress(String whiteRemoteAddress) {
    ...
    public User withDefaultTopicPerm(DefaultTopicPermEnum defaultTopicPerm) {
    ...
    public User withDefaultGroupPerm(DefaultGroupPermEnum defaultGroupPerm) {
    ...
    public User withTopicPerms(List<UserTopicPerms> topicPerms) {
        this.topicPerms = topicPerms;
        return this;
    }

    public User addTopicPermsItem(UserTopicPerms topicPermsItem) {
    ...
    public User withTopicPerms(Consumer<List<UserTopicPerms>> topicPermsSetter) {
        if (this.topicPerms == null) {
            this.topicPerms = new ArrayList<>();
        }
    ...
    public User withGroupPerms(List<UserGroupPerms> groupPerms) {
        this.groupPerms = groupPerms;
        return this;
    }

    public User addGroupPermsItem(UserGroupPerms groupPermsItem) {
    ...
    public User withGroupPerms(Consumer<List<UserGroupPerms>> groupPermsSetter) {
        if (this.groupPerms == null) {
            this.groupPerms = new ArrayList<>();
        }
