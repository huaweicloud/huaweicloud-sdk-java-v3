...
public class UserResp {
    ...
    public UserResp withAccessKey(String accessKey) {
    ...
    public UserResp withSecretKey(String secretKey) {
    ...
    public UserResp withWhiteRemoteAddress(String whiteRemoteAddress) {
    ...
    public UserResp withAdmin(Boolean admin) {
        this.admin = admin;
        return this;
    }
    ...
    public UserResp withDefaultTopicPerm(DefaultTopicPermEnum defaultTopicPerm) {
    ...
    public UserResp withDefaultGroupPerm(DefaultGroupPermEnum defaultGroupPerm) {
    ...
    public UserResp withTopicPerms(List<UserTopicPerms> topicPerms) {
        this.topicPerms = topicPerms;
        return this;
    }

    public UserResp addTopicPermsItem(UserTopicPerms topicPermsItem) {
    ...
    public UserResp withTopicPerms(Consumer<List<UserTopicPerms>> topicPermsSetter) {
        if (this.topicPerms == null) {
            this.topicPerms = new ArrayList<>();
        }
    ...
    public UserResp withGroupPerms(List<UserRespGroupPerms> groupPerms) {
        this.groupPerms = groupPerms;
        return this;
    }

    public UserResp addGroupPermsItem(UserRespGroupPerms groupPermsItem) {
    ...
    public UserResp withGroupPerms(Consumer<List<UserRespGroupPerms>> groupPermsSetter) {
        if (this.groupPerms == null) {
            this.groupPerms = new ArrayList<>();
        }
