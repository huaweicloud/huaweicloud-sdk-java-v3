...
public class ExtendInfoResp {
    ...
    public ExtendInfoResp withFilter(FilterEnum filter) {
        this.filter = filter;
        return this;
    }
    ...
    public ExtendInfoResp withPeriod(String period) {
        this.period = period;
        return this;
    }
    ...
    public ExtendInfoResp withDisplayTime(DisplayTimeEnum displayTime) {
    ...
    public ExtendInfoResp withRefreshTime(RefreshTimeEnum refreshTime) {
    ...
    public ExtendInfoResp withFrom(Long from) {
        this.from = from;
        return this;
    }
    ...
    public ExtendInfoResp withTo(Long to) {
        this.to = to;
        return this;
    }
    ...
    public ExtendInfoResp withScreenColor(String screenColor) {
    ...
    public ExtendInfoResp withEnableScreenAutoPlay(Boolean enableScreenAutoPlay) {
    ...
    public ExtendInfoResp withTimeInterval(TimeIntervalEnum timeInterval) {
    ...
    public ExtendInfoResp withEnableLegend(Boolean enableLegend) {
    ...
    public ExtendInfoResp withFullScreenWidgetNum(Integer fullScreenWidgetNum) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ExtendInfoResp that = (ExtendInfoResp) obj;
    ...
    public String toString() {
        ...
        sb.append("class ExtendInfoResp {\n");
