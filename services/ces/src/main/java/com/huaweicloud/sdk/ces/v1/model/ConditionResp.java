...
public class ConditionResp {
    ...
    public ConditionResp withComparisonOperator(String comparisonOperator) {
    ...
    public ConditionResp withCount(Integer count) {
        this.count = count;
        return this;
    }
    ...
    public ConditionResp withFilter(FilterResp filter) {
        this.filter = filter;
        return this;
    }
    ...
    public ConditionResp withPeriod(PeriodResp period) {
        this.period = period;
        return this;
    }
    ...
    public ConditionResp withUnit(String unit) {
        this.unit = unit;
        return this;
    }
    ...
    public ConditionResp withValue(Double value) {
        this.value = value;
        return this;
    }
    ...
    public ConditionResp withSuppressDuration(SuppressDurationResp suppressDuration) {
