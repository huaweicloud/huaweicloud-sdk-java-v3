 ...
 * **参数解释**： 告警策略附加信息。 
 */
public class MetricExtraInfoResp {
    ...
    public MetricExtraInfoResp withOriginMetricName(String originMetricName) {
    ...
    public MetricExtraInfoResp withMetricPrefix(String metricPrefix) {
    ...
    public MetricExtraInfoResp withCustomProcName(String customProcName) {
    ...
    public MetricExtraInfoResp withMetricType(String metricType) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        MetricExtraInfoResp that = (MetricExtraInfoResp) obj;
    ...
    public String toString() {
        ...
        sb.append("class MetricExtraInfoResp {\n");
