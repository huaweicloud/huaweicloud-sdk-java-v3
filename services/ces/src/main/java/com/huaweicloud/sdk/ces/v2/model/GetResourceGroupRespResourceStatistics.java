 ...
 * 资源数量统计信息
 */
public class GetResourceGroupRespResourceStatistics {
    ...
    public GetResourceGroupRespResourceStatistics withUnhealthy(Integer unhealthy) {
    ...
    public GetResourceGroupRespResourceStatistics withTotal(Integer total) {
        this.total = total;
        return this;
    }
    ...
    public GetResourceGroupRespResourceStatistics withEventUnhealthy(Integer eventUnhealthy) {
    ...
    public GetResourceGroupRespResourceStatistics withNamespaces(Integer namespaces) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        GetResourceGroupRespResourceStatistics that = (GetResourceGroupRespResourceStatistics) obj;
    ...
    public String toString() {
        ...
        sb.append("class GetResourceGroupRespResourceStatistics {\n");
