...
public class BaseWidgetInfoProperties {
    ...
    public BaseWidgetInfoProperties withDescription(String description) {
    ...
    public BaseWidgetInfoProperties withLastWeekCompareEnable(Boolean lastWeekCompareEnable) {
    ...
    public BaseWidgetInfoProperties withYesterdayCompareEnable(Boolean yesterdayCompareEnable) {
    ...
    public BaseWidgetInfoProperties withLegendLocation(LegendLocationEnum legendLocation) {
    ...
    public BaseWidgetInfoProperties withLegendValues(List<LegendValuesEnum> legendValues) {
        this.legendValues = legendValues;
        return this;
    }

    public BaseWidgetInfoProperties addLegendValuesItem(LegendValuesEnum legendValuesItem) {
    ...
    public BaseWidgetInfoProperties withLegendValues(Consumer<List<LegendValuesEnum>> legendValuesSetter) {
        if (this.legendValues == null) {
            this.legendValues = new ArrayList<>();
        }
    ...
    public BaseWidgetInfoProperties withThresholds(List<ThresholdInfo> thresholds) {
        this.thresholds = thresholds;
        return this;
    }

    public BaseWidgetInfoProperties addThresholdsItem(ThresholdInfo thresholdsItem) {
    ...
    public BaseWidgetInfoProperties withThresholds(Consumer<List<ThresholdInfo>> thresholdsSetter) {
        if (this.thresholds == null) {
            this.thresholds = new ArrayList<>();
        }
    ...
    public BaseWidgetInfoProperties withIsAllCompareEnable(Boolean isAllCompareEnable) {
