...
public class UpdateAlarmTemplatePolicies {
    ...
    public UpdateAlarmTemplatePolicies withNamespace(String namespace) {
    ...
    public UpdateAlarmTemplatePolicies withDimensionName(String dimensionName) {
    ...
    public UpdateAlarmTemplatePolicies withMetricName(String metricName) {
    ...
    public UpdateAlarmTemplatePolicies withPeriod(Period period) {
        this.period = period;
        return this;
    }
    ...
    public UpdateAlarmTemplatePolicies withFilter(String filter) {
        this.filter = filter;
        return this;
    }
    ...
    public UpdateAlarmTemplatePolicies withComparisonOperator(String comparisonOperator) {
    ...
    public UpdateAlarmTemplatePolicies withValue(Double value) {
        this.value = value;
        return this;
    }
    ...
    public UpdateAlarmTemplatePolicies withHierarchicalValue(HierarchicalValue hierarchicalValue) {
        this.hierarchicalValue = hierarchicalValue;
        return this;
    }

    public UpdateAlarmTemplatePolicies withHierarchicalValue(Consumer<HierarchicalValue> hierarchicalValueSetter) {
    ...
    public UpdateAlarmTemplatePolicies withUnit(String unit) {
        this.unit = unit;
        return this;
    }
    ...
    public UpdateAlarmTemplatePolicies withSelectedUnit(String selectedUnit) {
    ...
    public UpdateAlarmTemplatePolicies withCount(Integer count) {
        this.count = count;
        return this;
    }
    ...
    public UpdateAlarmTemplatePolicies withSuppressDuration(SuppressDuration suppressDuration) {
    ...
    public UpdateAlarmTemplatePolicies withAlarmLevel(Integer alarmLevel) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        UpdateAlarmTemplatePolicies that = (UpdateAlarmTemplatePolicies) obj;
