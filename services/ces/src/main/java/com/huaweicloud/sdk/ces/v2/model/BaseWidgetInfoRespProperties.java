...
public class BaseWidgetInfoRespProperties {
    ...
    /**
     * **参数解释** 统计值名称 **取值范围** - last:当前值 - max:最大值 - min:最小值 - avg:平均值 - sum:求和值 
     */
    ...
    private List<ThresholdInfoResp> thresholds = null;
    ...
    public BaseWidgetInfoRespProperties withFilter(FilterEnum filter) {
        this.filter = filter;
        return this;
    }
    ...
    public BaseWidgetInfoRespProperties withTopN(Integer topN) {
        this.topN = topN;
        return this;
    }
    ...
    public BaseWidgetInfoRespProperties withOrder(OrderEnum order) {
        this.order = order;
        return this;
    }
    ...
    public BaseWidgetInfoRespProperties withDescription(String description) {
    ...
    public BaseWidgetInfoRespProperties withLastWeekCompareEnable(Boolean lastWeekCompareEnable) {
    ...
    public BaseWidgetInfoRespProperties withYesterdayCompareEnable(Boolean yesterdayCompareEnable) {
    ...
    public BaseWidgetInfoRespProperties withLegendLocation(LegendLocationEnum legendLocation) {
    ...
    public BaseWidgetInfoRespProperties withLegendValues(List<LegendValuesEnum> legendValues) {
        this.legendValues = legendValues;
        return this;
    }

    public BaseWidgetInfoRespProperties addLegendValuesItem(LegendValuesEnum legendValuesItem) {
    ...
    public BaseWidgetInfoRespProperties withLegendValues(Consumer<List<LegendValuesEnum>> legendValuesSetter) {
        if (this.legendValues == null) {
            this.legendValues = new ArrayList<>();
        }
    ...
    public BaseWidgetInfoRespProperties withThresholds(List<ThresholdInfoResp> thresholds) {
        this.thresholds = thresholds;
        return this;
    }

    public BaseWidgetInfoRespProperties addThresholdsItem(ThresholdInfoResp thresholdsItem) {
    ...
    public BaseWidgetInfoRespProperties withThresholds(Consumer<List<ThresholdInfoResp>> thresholdsSetter) {
        if (this.thresholds == null) {
            this.thresholds = new ArrayList<>();
        }
     ...
     * @return thresholds
     */
    public List<ThresholdInfoResp> getThresholds() {
        return thresholds;
    }

    public void setThresholds(List<ThresholdInfoResp> thresholds) {
        this.thresholds = thresholds;
    }

    public BaseWidgetInfoRespProperties withIsAllCompareEnable(Boolean isAllCompareEnable) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        BaseWidgetInfoRespProperties that = (BaseWidgetInfoRespProperties) obj;
    ...
    public String toString() {
        ...
        sb.append("class BaseWidgetInfoRespProperties {\n");
