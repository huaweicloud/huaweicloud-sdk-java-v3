...
public class CesClient {
     ...
     * @return BatchListSpecifiedMetricDataResponse
     */
    public BatchListSpecifiedMetricDataResponse batchListSpecifiedMetricData(
        BatchListSpecifiedMetricDataRequest request) {
        return hcClient.syncInvokeHttp(request, CesMeta.batchListSpecifiedMetricData);
    }
     ...
     *
     * @param request BatchListSpecifiedMetricDataRequest 请求对象
     * @return SyncInvoker<BatchListSpecifiedMetricDataRequest, BatchListSpecifiedMetricDataResponse>
     */
    public SyncInvoker<BatchListSpecifiedMetricDataRequest, BatchListSpecifiedMetricDataResponse> batchListSpecifiedMetricDataInvoker(
        BatchListSpecifiedMetricDataRequest request) {
        return new SyncInvoker<>(request, CesMeta.batchListSpecifiedMetricData, hcClient);
    }
