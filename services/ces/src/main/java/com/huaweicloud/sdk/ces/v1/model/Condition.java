...
public class Condition {
    ...
    public Condition withFilter(Filter filter) {
        this.filter = filter;
        return this;
    }
    ...
    public Condition withPeriod(PeriodEnum period) {
        this.period = period;
        return this;
    }
    ...
    public Condition withSuppressDuration(SuppressDurationEnum suppressDuration) {
