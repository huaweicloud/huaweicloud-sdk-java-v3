...
public class ShowEventItemDetail {
    ...
    public ShowEventItemDetail withContent(String content) {
    ...
    public ShowEventItemDetail withGroupId(String groupId) {
    ...
    public ShowEventItemDetail withResourceId(String resourceId) {
    ...
    public ShowEventItemDetail withResourceName(String resourceName) {
    ...
    public ShowEventItemDetail withEventState(EventStateEnum eventState) {
    ...
    public ShowEventItemDetail withEventLevel(EventLevelEnum eventLevel) {
    ...
    public ShowEventItemDetail withEventUser(String eventUser) {
    ...
    public ShowEventItemDetail withEventType(String eventType) {
    ...
    public ShowEventItemDetail withDimensions(List<MetricsDimension> dimensions) {
        this.dimensions = dimensions;
        return this;
    }

    public ShowEventItemDetail addDimensionsItem(MetricsDimension dimensionsItem) {
    ...
    public ShowEventItemDetail withDimensions(Consumer<List<MetricsDimension>> dimensionsSetter) {
        if (this.dimensions == null) {
            this.dimensions = new ArrayList<>();
        }
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ShowEventItemDetail that = (ShowEventItemDetail) obj;
