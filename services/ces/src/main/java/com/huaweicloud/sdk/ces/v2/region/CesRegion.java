package com.huaweicloud.sdk.ces.v2.region;
...
public class CesRegion {
    ...
    public static final Region EU_WEST_101 = new Region("eu-west-101", "https://ces.eu-west-101.myhuaweicloud.com");
    ...
    public static final Region CN_EAST_4 = new Region("cn-east-4", "https://ces.cn-east-4.myhuaweicloud.com");

    public static final Region AF_NORTH_1 = new Region("af-north-1", "https://ces.af-north-1.myhuaweicloud.com");

    public static final Region MY_KUALALUMPUR_1 =
        new Region("my-kualalumpur-1", "https://ces.my-kualalumpur-1.myhuaweicloud.com");

    public static final Region AP_SOUTHEAST_5 =
        new Region("ap-southeast-5", "https://ces.ap-southeast-5.myhuaweicloud.com");

    public static final Region CN_NORTH_12 = new Region("cn-north-12", "https://ces.cn-north-12.myhuaweicloud.com");

    public static final Region CN_NORTH_11 = new Region("cn-north-11", "https://ces.cn-north-11.myhuaweicloud.com");

    public static final Region CN_SOUTHWEST_3 =
        new Region("cn-southwest-3", "https://ces.cn-southwest-3.myhuaweicloud.com");

    public static final Region SA_PERU_1 = new Region("sa-peru-1", "https://ces.sa-peru-1.myhuaweicloud.com");
