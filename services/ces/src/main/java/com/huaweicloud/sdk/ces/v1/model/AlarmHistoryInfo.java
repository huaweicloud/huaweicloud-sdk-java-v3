...
import com.huaweicloud.sdk.ces.v1.model.AdditionalInfo;
import com.huaweicloud.sdk.ces.v1.model.AlarmActions;
import com.huaweicloud.sdk.ces.v1.model.Condition;
import com.huaweicloud.sdk.ces.v1.model.DataPointForAlarmHistory;
...
public class AlarmHistoryInfo  {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(alarmId, alarmName, alarmDescription, metric, condition, alarmLevel, alarmType, alarmEnabled, alarmActionEnabled, alarmActions, okActions, insufficientdataActions, updateTime, enterpriseProjectId, triggerTime, alarmStatus, datapoints, additionalInfo);
    }
    @Override
