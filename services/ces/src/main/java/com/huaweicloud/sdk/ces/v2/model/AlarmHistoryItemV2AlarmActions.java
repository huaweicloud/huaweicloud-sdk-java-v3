...
/**
 * AlarmHistoryItemV2AlarmActions
 */
public class AlarmHistoryItemV2AlarmActions {
    ...
    public AlarmHistoryItemV2AlarmActions withType(TypeEnum type) {
        this.type = type;
        return this;
    }
    ...
    public AlarmHistoryItemV2AlarmActions withNotificationList(List<String> notificationList) {
        this.notificationList = notificationList;
        return this;
    }

    public AlarmHistoryItemV2AlarmActions addNotificationListItem(String notificationListItem) {
    ...
    public AlarmHistoryItemV2AlarmActions withNotificationList(Consumer<List<String>> notificationListSetter) {
        if (this.notificationList == null) {
            this.notificationList = new ArrayList<>();
        }
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        AlarmHistoryItemV2AlarmActions that = (AlarmHistoryItemV2AlarmActions) obj;
    ...
    public String toString() {
        ...
        sb.append("class AlarmHistoryItemV2AlarmActions {\n");
