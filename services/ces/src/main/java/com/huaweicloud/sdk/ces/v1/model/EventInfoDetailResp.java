...
public class EventInfoDetailResp {
    ...
    private ShowEventItemDetailResp detail;
    ...
    public EventInfoDetailResp withEventName(String eventName) {
    ...
    public EventInfoDetailResp withEventSource(String eventSource) {
    ...
    public EventInfoDetailResp withTime(Long time) {
        this.time = time;
        return this;
    }
    ...
    public EventInfoDetailResp withDetail(ShowEventItemDetailResp detail) {
        this.detail = detail;
        return this;
    }

    public EventInfoDetailResp withDetail(Consumer<ShowEventItemDetailResp> detailSetter) {
        if (this.detail == null) {
            this.detail = new ShowEventItemDetailResp();
     ...
     * @return detail
     */
    public ShowEventItemDetailResp getDetail() {
        return detail;
    }

    public void setDetail(ShowEventItemDetailResp detail) {
        this.detail = detail;
    }

    public EventInfoDetailResp withEventId(String eventId) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        EventInfoDetailResp that = (EventInfoDetailResp) obj;
