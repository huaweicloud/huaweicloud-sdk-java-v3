...
public class ShowEventItem {
    ...
    public ShowEventItem withEventName(String eventName) {
    ...
    public ShowEventItem withEventSource(String eventSource) {
    ...
    public ShowEventItem withTime(Long time) {
        this.time = time;
        return this;
    }
    ...
    public ShowEventItem withDetail(ShowEventItemDetail detail) {
        this.detail = detail;
        return this;
    }

    public ShowEventItem withDetail(Consumer<ShowEventItemDetail> detailSetter) {
        if (this.detail == null) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ShowEventItem that = (ShowEventItem) obj;
