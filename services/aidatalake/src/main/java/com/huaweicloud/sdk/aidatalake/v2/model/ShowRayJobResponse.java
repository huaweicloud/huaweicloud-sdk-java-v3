 ...
 * Response Object
 */
public class ShowRayJobResponse extends SdkResponse {
    ...
    public ShowRayJobResponse withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public ShowRayJobResponse withEndpointName(String endpointName) {
    ...
    public ShowRayJobResponse withConfig(RayJobConfig config) {
        this.config = config;
        return this;
    }

    public ShowRayJobResponse withConfig(Consumer<RayJobConfig> configSetter) {
        if (this.config == null) {
    ...
    public ShowRayJobResponse withDescription(String description) {
    ...
    public ShowRayJobResponse withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public ShowRayJobResponse withDuration(Long duration) {
    ...
    public ShowRayJobResponse withSubmissionId(String submissionId) {
    ...
    public ShowRayJobResponse withEndpointType(String endpointType) {
    ...
    public ShowRayJobResponse withEndpointId(String endpointId) {
    ...
    public ShowRayJobResponse withFederationId(String federationId) {
    ...
    public ShowRayJobResponse withFederationName(String federationName) {
    ...
    public ShowRayJobResponse withCreateTime(OffsetDateTime createTime) {
    ...
    public ShowRayJobResponse withUpdateTime(OffsetDateTime updateTime) {
    ...
    public ShowRayJobResponse withStartTime(OffsetDateTime startTime) {
    ...
    public ShowRayJobResponse withEndTime(OffsetDateTime endTime) {
    ...
    public ShowRayJobResponse withStatus(StatusEnum status) {
        this.status = status;
        return this;
    }
    ...
    public ShowRayJobResponse withCreateUser(User createUser) {
        this.createUser = createUser;
        return this;
    }

    public ShowRayJobResponse withCreateUser(Consumer<User> createUserSetter) {
    ...
    public ShowRayJobResponse withError(ErrorMessage error) {
        this.error = error;
        return this;
    }

    public ShowRayJobResponse withError(Consumer<ErrorMessage> errorSetter) {
        if (this.error == null) {
    ...
    public ShowRayJobResponse withHistoryServerEnabled(Boolean historyServerEnabled) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ShowRayJobResponse that = (ShowRayJobResponse) obj;
    ...
    public String toString() {
        ...
        sb.append("class ShowRayJobResponse {\n");
