...
public class ProductRspSoar {
    ...
    public ProductRspSoar withCloudServiceType(String cloudServiceType) {
    ...
    public ProductRspSoar withResourceType(String resourceType) {
    ...
    public ProductRspSoar withResourceSpecCode(String resourceSpecCode) {
    ...
    public ProductRspSoar withResourceSizeMeasureId(Integer resourceSizeMeasureId) {
    ...
    public ProductRspSoar withUsageFactor(String usageFactor) {
    ...
    public ProductRspSoar withUsageMeasureId(Integer usageMeasureId) {
    ...
    public ProductRspSoar withRegionId(String regionId) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ProductRspSoar that = (ProductRspSoar) obj;
    ...
    public String toString() {
        ...
        sb.append("class ProductRspSoar {\n");
