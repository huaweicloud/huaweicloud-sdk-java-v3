...
public class CreateDataobjectRelationResponse extends SdkResponse {
    ...
    public CreateDataobjectRelationResponse withData(BatchOperateDataobjectResult data) {
        this.data = data;
        return this;
    }

    public CreateDataobjectRelationResponse withData(Consumer<BatchOperateDataobjectResult> dataSetter) {
        if (this.data == null) {
