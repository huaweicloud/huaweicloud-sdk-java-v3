 ...
 * Response Object
 */
public class CreateDataspaceResponse extends SdkResponse {
    ...
    public CreateDataspaceResponse withDomainId(String domainId) {
    ...
    public CreateDataspaceResponse withRegionId(String regionId) {
    ...
    public CreateDataspaceResponse withProjectId(String projectId) {
    ...
    public CreateDataspaceResponse withDataspaceId(String dataspaceId) {
    ...
    public CreateDataspaceResponse withDataspaceName(String dataspaceName) {
    ...
    public CreateDataspaceResponse withDataspaceType(DataspaceTypeEnum dataspaceType) {
    ...
    public CreateDataspaceResponse withDescription(String description) {
    ...
    public CreateDataspaceResponse withCreateBy(String createBy) {
    ...
    public CreateDataspaceResponse withCreateTime(Long createTime) {
    ...
    public CreateDataspaceResponse withUpdateBy(String updateBy) {
    ...
    public CreateDataspaceResponse withUpdateTime(Long updateTime) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        CreateDataspaceResponse that = (CreateDataspaceResponse) obj;
        return Objects.equals(this.domainId, that.domainId) && Objects.equals(this.regionId, that.regionId)
            && Objects.equals(this.projectId, that.projectId) && Objects.equals(this.dataspaceId, that.dataspaceId)
    ...
    public String toString() {
        ...
        sb.append("class CreateDataspaceResponse {\n");
