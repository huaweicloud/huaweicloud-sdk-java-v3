...
/**
 * ImportIncidentsRequestBody
 */
public class ImportIncidentsRequestBody implements SdkFormDataBody {

    @JsonProperty(value = "uploadFile", access = JsonProperty.Access.WRITE_ONLY)

    private FormDataFilePart uploadFile;

    public ImportIncidentsRequestBody withUploadFile(FormDataFilePart uploadFile) {
    ...
    public ImportIncidentsRequestBody withUploadFile(InputStream inputStream, String fileName, String contentType) {
        this.uploadFile = new FormDataFilePart(inputStream, fileName).withContentType(contentType);
        return this;
    }

    public ImportIncidentsRequestBody withUploadFile(InputStream inputStream, String fileName) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ImportIncidentsRequestBody that = (ImportIncidentsRequestBody) obj;
    ...
    public String toString() {
        ...
        sb.append("class ImportIncidentsRequestBody {\n");
