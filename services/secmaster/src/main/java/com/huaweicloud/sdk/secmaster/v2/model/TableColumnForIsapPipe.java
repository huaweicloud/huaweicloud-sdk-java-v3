 ...
 * 管道对应表的列详情
 */
public class TableColumnForIsapPipe {
    ...
    public TableColumnForIsapPipe withColumnName(String columnName) {
    ...
    public TableColumnForIsapPipe withColumnDataType(ColumnDataTypeEnum columnDataType) {
    ...
    public TableColumnForIsapPipe withColumnDataTypeSetting(String columnDataTypeSetting) {
    ...
    public TableColumnForIsapPipe withColumnType(ColumnTypeEnum columnType) {
    ...
    public TableColumnForIsapPipe withColumnTypeSetting(String columnTypeSetting) {
    ...
    public TableColumnForIsapPipe withDefaultValue(String defaultValue) {
    ...
    public TableColumnForIsapPipe withNullable(Boolean nullable) {
    ...
    public TableColumnForIsapPipe withArray(Boolean array) {
        this.array = array;
        return this;
    }
    ...
    public TableColumnForIsapPipe withDepth(Long depth) {
        this.depth = depth;
        return this;
    }
    ...
    public TableColumnForIsapPipe withParentName(String parentName) {
    ...
    public TableColumnForIsapPipe withOwnName(String ownName) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        TableColumnForIsapPipe that = (TableColumnForIsapPipe) obj;
        return Objects.equals(this.columnName, that.columnName)
            ...
            && Objects.equals(this.defaultValue, that.defaultValue) && Objects.equals(this.nullable, that.nullable)
            && Objects.equals(this.array, that.array) && Objects.equals(this.depth, that.depth)
            && Objects.equals(this.parentName, that.parentName) && Objects.equals(this.ownName, that.ownName);
    }
    ...
    public String toString() {
        ...
        sb.append("class TableColumnForIsapPipe {\n");
