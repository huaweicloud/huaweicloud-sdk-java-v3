 ...
 * 统计数据
 */
public class ListCollectConfigResponseBodyCofingStatistics {
    ...
    public ListCollectConfigResponseBodyCofingStatistics withAccountNum(BigDecimal accountNum) {
    ...
    public ListCollectConfigResponseBodyCofingStatistics withDailyTraffic(BigDecimal dailyTraffic) {
    ...
    public ListCollectConfigResponseBodyCofingStatistics withLogNum(BigDecimal logNum) {
        this.logNum = logNum;
        return this;
    }
    ...
    public ListCollectConfigResponseBodyCofingStatistics withProductAllNum(BigDecimal productAllNum) {
    ...
    public ListCollectConfigResponseBodyCofingStatistics withProductInNum(BigDecimal productInNum) {
    ...
    public ListCollectConfigResponseBodyCofingStatistics withVendorNum(BigDecimal vendorNum) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ListCollectConfigResponseBodyCofingStatistics that = (ListCollectConfigResponseBodyCofingStatistics) obj;
    ...
    public String toString() {
        ...
        sb.append("class ListCollectConfigResponseBodyCofingStatistics {\n");
