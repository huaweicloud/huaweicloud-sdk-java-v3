 ...
 * 创建布局字段请求体
 */
public class CreateLayoutFieldRequestBody {
    ...
    public CreateLayoutFieldRequestBody withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public CreateLayoutFieldRequestBody withFieldKey(String fieldKey) {
    ...
    public CreateLayoutFieldRequestBody withDescription(String description) {
    ...
    public CreateLayoutFieldRequestBody withLayoutId(String layoutId) {
    ...
    public CreateLayoutFieldRequestBody withWizardId(String wizardId) {
    ...
    public CreateLayoutFieldRequestBody withAopworkflowId(String aopworkflowId) {
    ...
    public CreateLayoutFieldRequestBody withAopworkflowVersionId(String aopworkflowVersionId) {
    ...
    public CreateLayoutFieldRequestBody withPlaybookId(String playbookId) {
    ...
    public CreateLayoutFieldRequestBody withPlaybookVersionId(String playbookVersionId) {
    ...
    public CreateLayoutFieldRequestBody withDefaultValue(String defaultValue) {
    ...
    public CreateLayoutFieldRequestBody withDisplayType(String displayType) {
    ...
    public CreateLayoutFieldRequestBody withFieldType(String fieldType) {
    ...
    public CreateLayoutFieldRequestBody withExtraJson(String extraJson) {
    ...
    public CreateLayoutFieldRequestBody withFieldTooltip(String fieldTooltip) {
    ...
    public CreateLayoutFieldRequestBody withJsonSchema(String jsonSchema) {
    ...
    public CreateLayoutFieldRequestBody withReadonly(Boolean readonly) {
    ...
    public CreateLayoutFieldRequestBody withRequired(Boolean required) {
    ...
    public CreateLayoutFieldRequestBody withSearchable(Boolean searchable) {
    ...
    public CreateLayoutFieldRequestBody withVisible(Boolean visible) {
    ...
    public CreateLayoutFieldRequestBody withMaintainable(Boolean maintainable) {
    ...
    public CreateLayoutFieldRequestBody withEditable(Boolean editable) {
    ...
    public CreateLayoutFieldRequestBody withCreatable(Boolean creatable) {
    ...
    public CreateLayoutFieldRequestBody withBoaVersion(String boaVersion) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        CreateLayoutFieldRequestBody that = (CreateLayoutFieldRequestBody) obj;
        return Objects.equals(this.name, that.name) && Objects.equals(this.fieldKey, that.fieldKey)
            && Objects.equals(this.description, that.description) && Objects.equals(this.layoutId, that.layoutId)
            && Objects.equals(this.wizardId, that.wizardId) && Objects.equals(this.aopworkflowId, that.aopworkflowId)
    ...
    public String toString() {
        ...
        sb.append("class CreateLayoutFieldRequestBody {\n");
