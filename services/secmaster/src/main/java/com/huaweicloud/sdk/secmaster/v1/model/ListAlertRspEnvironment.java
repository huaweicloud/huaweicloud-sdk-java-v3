 ...
 * 告警产生的环境坐标信息
 */
public class ListAlertRspEnvironment {
    ...
    public ListAlertRspEnvironment withVendorType(String vendorType) {
    ...
    public ListAlertRspEnvironment withDomainId(String domainId) {
    ...
    public ListAlertRspEnvironment withRegionId(String regionId) {
    ...
    public ListAlertRspEnvironment withCrossWorkspaceId(String crossWorkspaceId) {
    ...
    public ListAlertRspEnvironment withProjectId(String projectId) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ListAlertRspEnvironment that = (ListAlertRspEnvironment) obj;
    ...
    public String toString() {
        ...
        sb.append("class ListAlertRspEnvironment {\n");
