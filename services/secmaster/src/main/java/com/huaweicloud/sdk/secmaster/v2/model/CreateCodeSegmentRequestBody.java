...
/**
 * CreateCodeSegmentRequestBody
 */
public class CreateCodeSegmentRequestBody {
    ...
    public CreateCodeSegmentRequestBody withCodeSegmentName(String codeSegmentName) {
    ...
    public CreateCodeSegmentRequestBody withDescription(String description) {
    ...
    public CreateCodeSegmentRequestBody withCode(String code) {
        this.code = code;
        return this;
    }
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        CreateCodeSegmentRequestBody that = (CreateCodeSegmentRequestBody) obj;
    ...
    public String toString() {
        ...
        sb.append("class CreateCodeSegmentRequestBody {\n");
