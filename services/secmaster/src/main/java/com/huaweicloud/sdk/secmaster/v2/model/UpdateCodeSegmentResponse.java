 ...
 * Response Object
 */
public class UpdateCodeSegmentResponse extends SdkResponse {
    ...
    public UpdateCodeSegmentResponse withCodeSegmentId(String codeSegmentId) {
    ...
    public UpdateCodeSegmentResponse withProjectId(String projectId) {
    ...
    public UpdateCodeSegmentResponse withWorkspaceId(String workspaceId) {
    ...
    public UpdateCodeSegmentResponse withCodeSegmentName(String codeSegmentName) {
    ...
    public UpdateCodeSegmentResponse withDescription(String description) {
    ...
    public UpdateCodeSegmentResponse withCode(String code) {
        this.code = code;
        return this;
    }
    ...
    public UpdateCodeSegmentResponse withCreateBy(String createBy) {
    ...
    public UpdateCodeSegmentResponse withCreateTime(Long createTime) {
    ...
    public UpdateCodeSegmentResponse withUpdateBy(String updateBy) {
    ...
    public UpdateCodeSegmentResponse withUpdateTime(Long updateTime) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        UpdateCodeSegmentResponse that = (UpdateCodeSegmentResponse) obj;
    ...
    public String toString() {
        ...
        sb.append("class UpdateCodeSegmentResponse {\n");
