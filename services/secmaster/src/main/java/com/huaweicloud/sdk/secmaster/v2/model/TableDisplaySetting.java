...
public class TableDisplaySetting {
    ...
    public TableDisplaySetting withColumns(List<TableColumnDisplaySetting> columns) {
        this.columns = columns;
        return this;
    }

    public TableDisplaySetting addColumnsItem(TableColumnDisplaySetting columnsItem) {
    ...
    public TableDisplaySetting withColumns(Consumer<List<TableColumnDisplaySetting>> columnsSetter) {
        if (this.columns == null) {
            this.columns = new ArrayList<>();
        }
     ...
     * @return columns
     */
    public List<TableColumnDisplaySetting> getColumns() {
        return columns;
    }

    public void setColumns(List<TableColumnDisplaySetting> columns) {
        this.columns = columns;
    }

    public TableDisplaySetting withFormat(FormatEnum format) {
        this.format = format;
        return this;
    }
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        TableDisplaySetting that = (TableDisplaySetting) obj;
    ...
    public String toString() {
        ...
        sb.append("class TableDisplaySetting {\n");
