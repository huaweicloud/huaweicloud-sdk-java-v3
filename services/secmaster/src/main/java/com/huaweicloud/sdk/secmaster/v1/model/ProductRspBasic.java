...
public class ProductRspBasic {
    ...
    public ProductRspBasic withCloudServiceType(String cloudServiceType) {
    ...
    public ProductRspBasic withResourceType(String resourceType) {
    ...
    public ProductRspBasic withResourceSpecCode(String resourceSpecCode) {
    ...
    public ProductRspBasic withResourceSizeMeasureId(Integer resourceSizeMeasureId) {
    ...
    public ProductRspBasic withUsageFactor(String usageFactor) {
    ...
    public ProductRspBasic withUsageMeasureId(Integer usageMeasureId) {
    ...
    public ProductRspBasic withRegionId(String regionId) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ProductRspBasic that = (ProductRspBasic) obj;
    ...
    public String toString() {
        ...
        sb.append("class ProductRspBasic {\n");
