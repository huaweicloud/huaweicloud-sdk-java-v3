 ...
 * Response Object
 */
public class ShowCodeSegmentResponse extends SdkResponse {
    ...
    public ShowCodeSegmentResponse withCodeSegmentId(String codeSegmentId) {
    ...
    public ShowCodeSegmentResponse withProjectId(String projectId) {
    ...
    public ShowCodeSegmentResponse withWorkspaceId(String workspaceId) {
    ...
    public ShowCodeSegmentResponse withCodeSegmentName(String codeSegmentName) {
    ...
    public ShowCodeSegmentResponse withDescription(String description) {
    ...
    public ShowCodeSegmentResponse withCode(String code) {
        this.code = code;
        return this;
    }
    ...
    public ShowCodeSegmentResponse withCreateBy(String createBy) {
    ...
    public ShowCodeSegmentResponse withCreateTime(Long createTime) {
    ...
    public ShowCodeSegmentResponse withUpdateBy(String updateBy) {
    ...
    public ShowCodeSegmentResponse withUpdateTime(Long updateTime) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ShowCodeSegmentResponse that = (ShowCodeSegmentResponse) obj;
    ...
    public String toString() {
        ...
        sb.append("class ShowCodeSegmentResponse {\n");
