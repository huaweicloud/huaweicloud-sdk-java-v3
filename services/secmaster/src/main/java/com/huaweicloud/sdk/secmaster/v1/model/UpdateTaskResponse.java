...
public class UpdateTaskResponse extends SdkResponse {
    ...
    public UpdateTaskResponse withSuccess(Boolean success) {
    ...
    public UpdateTaskResponse withData(TaskInfo data) {
        this.data = data;
        return this;
    }

    public UpdateTaskResponse withData(Consumer<TaskInfo> dataSetter) {
        if (this.data == null) {
            this.data = new TaskInfo();
