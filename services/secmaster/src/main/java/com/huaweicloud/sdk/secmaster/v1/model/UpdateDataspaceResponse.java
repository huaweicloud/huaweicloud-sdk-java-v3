 ...
 * Response Object
 */
public class UpdateDataspaceResponse extends SdkResponse {
    ...
    public UpdateDataspaceResponse withCreateBy(String createBy) {
    ...
    public UpdateDataspaceResponse withCreateTime(Long createTime) {
    ...
    public UpdateDataspaceResponse withDataspaceId(String dataspaceId) {
    ...
    public UpdateDataspaceResponse withDataspaceName(String dataspaceName) {
    ...
    public UpdateDataspaceResponse withDataspaceType(DataspaceTypeEnum dataspaceType) {
    ...
    public UpdateDataspaceResponse withDescription(String description) {
    ...
    public UpdateDataspaceResponse withDomainId(String domainId) {
    ...
    public UpdateDataspaceResponse withProjectId(String projectId) {
    ...
    public UpdateDataspaceResponse withRegionId(String regionId) {
    ...
    public UpdateDataspaceResponse withUpdateBy(String updateBy) {
    ...
    public UpdateDataspaceResponse withUpdateTime(Long updateTime) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        UpdateDataspaceResponse that = (UpdateDataspaceResponse) obj;
    ...
    public String toString() {
        ...
        sb.append("class UpdateDataspaceResponse {\n");
