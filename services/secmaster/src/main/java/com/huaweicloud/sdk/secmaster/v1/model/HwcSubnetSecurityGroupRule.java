 ...
 * 安全组规则
 */
public class HwcSubnetSecurityGroupRule {
    ...
    public HwcSubnetSecurityGroupRule withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public HwcSubnetSecurityGroupRule withDescription(String description) {
    ...
    public HwcSubnetSecurityGroupRule withSecurityGroupId(String securityGroupId) {
    ...
    public HwcSubnetSecurityGroupRule withDirection(String direction) {
    ...
    public HwcSubnetSecurityGroupRule withProtocol(String protocol) {
    ...
    public HwcSubnetSecurityGroupRule withEthertype(String ethertype) {
    ...
    public HwcSubnetSecurityGroupRule withMultiport(String multiport) {
    ...
    public HwcSubnetSecurityGroupRule withAction(String action) {
        this.action = action;
        return this;
    }
    ...
    public HwcSubnetSecurityGroupRule withPriority(Integer priority) {
    ...
    public HwcSubnetSecurityGroupRule withRemoteGroupId(String remoteGroupId) {
    ...
    public HwcSubnetSecurityGroupRule withRemoteIpPrefix(String remoteIpPrefix) {
    ...
    public HwcSubnetSecurityGroupRule withRemoteAddressGroupId(String remoteAddressGroupId) {
    ...
    public HwcSubnetSecurityGroupRule withCreatedAt(String createdAt) {
    ...
    public HwcSubnetSecurityGroupRule withUpdatedAt(String updatedAt) {
    ...
    public HwcSubnetSecurityGroupRule withProjectId(String projectId) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        HwcSubnetSecurityGroupRule that = (HwcSubnetSecurityGroupRule) obj;
        return Objects.equals(this.id, that.id) && Objects.equals(this.description, that.description)
            ...
            && Objects.equals(this.ethertype, that.ethertype) && Objects.equals(this.multiport, that.multiport)
    ...
    public String toString() {
        ...
        sb.append("class HwcSubnetSecurityGroupRule {\n");
