 ...
 * Response Object
 */
public class ShowIsapComponentResponse extends SdkResponse {
    ...
    public ShowIsapComponentResponse withComponentId(String componentId) {
    ...
    public ShowIsapComponentResponse withComponentName(String componentName) {
    ...
    public ShowIsapComponentResponse withCreateTime(Long createTime) {
    ...
    public ShowIsapComponentResponse withDescription(String description) {
    ...
    public ShowIsapComponentResponse withHistoryVersion(String historyVersion) {
    ...
    public ShowIsapComponentResponse withMaintainer(String maintainer) {
    ...
    public ShowIsapComponentResponse withTimeZone(String timeZone) {
    ...
    public ShowIsapComponentResponse withUpdateTime(Long updateTime) {
    ...
    public ShowIsapComponentResponse withUpgrade(UpgradeEnum upgrade) {
    ...
    public ShowIsapComponentResponse withUpgradeFailMessage(String upgradeFailMessage) {
    ...
    public ShowIsapComponentResponse withVersion(String version) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ShowIsapComponentResponse that = (ShowIsapComponentResponse) obj;
    ...
    public String toString() {
        ...
        sb.append("class ShowIsapComponentResponse {\n");
