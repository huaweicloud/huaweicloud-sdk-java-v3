...
public class CreateTableResponse extends SdkResponse {
    ...
    public CreateTableResponse withProjectId(String projectId) {
    ...
    public CreateTableResponse withWorkspaceId(String workspaceId) {
    ...
    public CreateTableResponse withPipeId(String pipeId) {
        this.pipeId = pipeId;
        return this;
    }
    ...
    public CreateTableResponse withDirectory(String directory) {
    ...
    public CreateTableResponse withCategory(IsapTableCategory category) {
    ...
    public CreateTableResponse withLockStatus(TableLockStatus lockStatus) {
    ...
    public CreateTableResponse withProcessStatus(IsapTableProcessStatus processStatus) {
    ...
    public CreateTableResponse withProcessError(IsapTableProcessError processError) {
    ...
    public CreateTableResponse withFormat(TableFormat format) {
        this.format = format;
        return this;
    }
    ...
    public CreateTableResponse withRwType(TableRWType rwType) {
        this.rwType = rwType;
        return this;
    }
    ...
    public CreateTableResponse withOwnerType(TableOwnerType ownerType) {
    ...
    public CreateTableResponse withDataLayering(DataLayering dataLayering) {
    ...
    public CreateTableResponse withDataClassification(DataClassification dataClassification) {
    ...
    public CreateTableResponse withSchema(IsapTableSchema schema) {
        this.schema = schema;
        return this;
    }

    public CreateTableResponse withSchema(Consumer<IsapTableSchema> schemaSetter) {
        if (this.schema == null) {
    ...
    public CreateTableResponse withStorageSetting(TableStorageSetting storageSetting) {
        this.storageSetting = storageSetting;
        return this;
    }

    public CreateTableResponse withStorageSetting(Consumer<TableStorageSetting> storageSettingSetter) {
    ...
    public CreateTableResponse withDisplaySetting(TableDisplaySetting displaySetting) {
        this.displaySetting = displaySetting;
        return this;
    }

    public CreateTableResponse withDisplaySetting(Consumer<TableDisplaySetting> displaySettingSetter) {
    ...
    public CreateTableResponse withCreateTime(Long createTime) {
    ...
    public CreateTableResponse withUpdateTime(Long updateTime) {
    ...
    public CreateTableResponse withDeleteTime(Long deleteTime) {
