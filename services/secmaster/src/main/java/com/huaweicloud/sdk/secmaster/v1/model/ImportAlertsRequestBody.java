...
/**
 * ImportAlertsRequestBody
 */
public class ImportAlertsRequestBody implements SdkFormDataBody {

    @JsonProperty(value = "uploadFile", access = JsonProperty.Access.WRITE_ONLY)

    private FormDataFilePart uploadFile;

    public ImportAlertsRequestBody withUploadFile(FormDataFilePart uploadFile) {
    ...
    public ImportAlertsRequestBody withUploadFile(InputStream inputStream, String fileName, String contentType) {
        this.uploadFile = new FormDataFilePart(inputStream, fileName).withContentType(contentType);
        return this;
    }

    public ImportAlertsRequestBody withUploadFile(InputStream inputStream, String fileName) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ImportAlertsRequestBody that = (ImportAlertsRequestBody) obj;
    ...
    public String toString() {
        ...
        sb.append("class ImportAlertsRequestBody {\n");
