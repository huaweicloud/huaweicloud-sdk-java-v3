...
/**
 * UpdateWorkspaceResponseBodyWorkspaceAgencyList
 */
public class UpdateWorkspaceResponseBodyWorkspaceAgencyList {
    ...
    public UpdateWorkspaceResponseBodyWorkspaceAgencyList withProjectId(String projectId) {
    ...
    public UpdateWorkspaceResponseBodyWorkspaceAgencyList withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public UpdateWorkspaceResponseBodyWorkspaceAgencyList withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public UpdateWorkspaceResponseBodyWorkspaceAgencyList withRegionId(String regionId) {
    ...
    public UpdateWorkspaceResponseBodyWorkspaceAgencyList withWorkspaceAttribution(
    ...
    public UpdateWorkspaceResponseBodyWorkspaceAgencyList withAgencyVersion(String agencyVersion) {
    ...
    public UpdateWorkspaceResponseBodyWorkspaceAgencyList withDomainId(String domainId) {
    ...
    public UpdateWorkspaceResponseBodyWorkspaceAgencyList withDomainName(String domainName) {
    ...
    public UpdateWorkspaceResponseBodyWorkspaceAgencyList withIamAgencyId(String iamAgencyId) {
    ...
    public UpdateWorkspaceResponseBodyWorkspaceAgencyList withIamAgencyName(String iamAgencyName) {
    ...
    public UpdateWorkspaceResponseBodyWorkspaceAgencyList withResourceSpecCode(List<String> resourceSpecCode) {
        this.resourceSpecCode = resourceSpecCode;
        return this;
    }

    public UpdateWorkspaceResponseBodyWorkspaceAgencyList addResourceSpecCodeItem(String resourceSpecCodeItem) {
    ...
    public UpdateWorkspaceResponseBodyWorkspaceAgencyList withResourceSpecCode(
    ...
    public UpdateWorkspaceResponseBodyWorkspaceAgencyList withSelected(Boolean selected) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        UpdateWorkspaceResponseBodyWorkspaceAgencyList that = (UpdateWorkspaceResponseBodyWorkspaceAgencyList) obj;
    ...
    public String toString() {
        ...
        sb.append("class UpdateWorkspaceResponseBodyWorkspaceAgencyList {\n");
