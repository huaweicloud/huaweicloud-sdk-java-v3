 ...
 * 名称和描述
 */
public class ListCollectConfigResponseBodyReference {
    ...
    public ListCollectConfigResponseBodyReference withCsvcDisplay(String csvcDisplay) {
    ...
    public ListCollectConfigResponseBodyReference withSourceDisplay(String sourceDisplay) {
    ...
    public ListCollectConfigResponseBodyReference withSourceHelp(String sourceHelp) {
