 ...
 * 标准版商品编码对象
 */
public class ProductRspStandard {
    ...
    public ProductRspStandard withCloudServiceType(String cloudServiceType) {
    ...
    public ProductRspStandard withResourceType(String resourceType) {
    ...
    public ProductRspStandard withResourceSpecCode(String resourceSpecCode) {
    ...
    public ProductRspStandard withResourceSizeMeasureId(Integer resourceSizeMeasureId) {
    ...
    public ProductRspStandard withUsageFactor(String usageFactor) {
    ...
    public ProductRspStandard withUsageMeasureId(Integer usageMeasureId) {
    ...
    public ProductRspStandard withRegionId(String regionId) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ProductRspStandard that = (ProductRspStandard) obj;
    ...
    public String toString() {
        ...
        sb.append("class ProductRspStandard {\n");
