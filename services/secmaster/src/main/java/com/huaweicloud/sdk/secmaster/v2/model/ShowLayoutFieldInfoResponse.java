 ...
 * Response Object
 */
public class ShowLayoutFieldInfoResponse extends SdkResponse {
    ...
    public ShowLayoutFieldInfoResponse withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public ShowLayoutFieldInfoResponse withCloudPackId(String cloudPackId) {
    ...
    public ShowLayoutFieldInfoResponse withCloudPackName(String cloudPackName) {
    ...
    public ShowLayoutFieldInfoResponse withDataclassId(String dataclassId) {
    ...
    public ShowLayoutFieldInfoResponse withCloudPackVersion(String cloudPackVersion) {
    ...
    public ShowLayoutFieldInfoResponse withFieldKey(String fieldKey) {
    ...
    public ShowLayoutFieldInfoResponse withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public ShowLayoutFieldInfoResponse withDescription(String description) {
    ...
    public ShowLayoutFieldInfoResponse withEnDescription(String enDescription) {
    ...
    public ShowLayoutFieldInfoResponse withDefaultValue(String defaultValue) {
    ...
    public ShowLayoutFieldInfoResponse withEnDefaultValue(String enDefaultValue) {
    ...
    public ShowLayoutFieldInfoResponse withFieldType(String fieldType) {
    ...
    public ShowLayoutFieldInfoResponse withExtraJson(String extraJson) {
    ...
    public ShowLayoutFieldInfoResponse withFieldTooltip(String fieldTooltip) {
    ...
    public ShowLayoutFieldInfoResponse withEnFieldTooltip(String enFieldTooltip) {
    ...
    public ShowLayoutFieldInfoResponse withJsonSchema(String jsonSchema) {
    ...
    public ShowLayoutFieldInfoResponse withIsBuiltIn(Boolean isBuiltIn) {
    ...
    public ShowLayoutFieldInfoResponse withReadOnly(Boolean readOnly) {
    ...
    public ShowLayoutFieldInfoResponse withRequired(Boolean required) {
    ...
    public ShowLayoutFieldInfoResponse withSearchable(Boolean searchable) {
    ...
    public ShowLayoutFieldInfoResponse withVisible(Boolean visible) {
    ...
    public ShowLayoutFieldInfoResponse withMaintainable(Boolean maintainable) {
    ...
    public ShowLayoutFieldInfoResponse withEditable(Boolean editable) {
    ...
    public ShowLayoutFieldInfoResponse withCreatable(Boolean creatable) {
    ...
    public ShowLayoutFieldInfoResponse withCreatorId(String creatorId) {
    ...
    public ShowLayoutFieldInfoResponse withCreatorName(String creatorName) {
    ...
    public ShowLayoutFieldInfoResponse withModifierId(String modifierId) {
    ...
    public ShowLayoutFieldInfoResponse withModifierName(String modifierName) {
    ...
    public ShowLayoutFieldInfoResponse withCreateTime(String createTime) {
    ...
    public ShowLayoutFieldInfoResponse withUpdateTime(String updateTime) {
    ...
    public ShowLayoutFieldInfoResponse withWizardId(String wizardId) {
    ...
    public ShowLayoutFieldInfoResponse withAopworkflowId(String aopworkflowId) {
    ...
    public ShowLayoutFieldInfoResponse withAopworkflowVersionId(String aopworkflowVersionId) {
    ...
    public ShowLayoutFieldInfoResponse withPlaybookId(String playbookId) {
    ...
    public ShowLayoutFieldInfoResponse withPlaybookVersionId(String playbookVersionId) {
    ...
    public ShowLayoutFieldInfoResponse withBoaVersion(String boaVersion) {
    ...
    public ShowLayoutFieldInfoResponse withVersion(String version) {
    ...
    public ShowLayoutFieldInfoResponse withXRequestId(String xRequestId) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ShowLayoutFieldInfoResponse that = (ShowLayoutFieldInfoResponse) obj;
    ...
    public String toString() {
        ...
        sb.append("class ShowLayoutFieldInfoResponse {\n");
