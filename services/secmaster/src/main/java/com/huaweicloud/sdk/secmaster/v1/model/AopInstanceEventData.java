 ...
 * 操作流程实例的请求信息
 */
public class AopInstanceEventData {
    ...
    public AopInstanceEventData withCommandType(CommandTypeEnum commandType) {
    ...
    public AopInstanceEventData withActionType(ActionTypeEnum actionType) {
    ...
    public AopInstanceEventData withActionId(String actionId) {
    ...
    public AopInstanceEventData withActionInstanceId(String actionInstanceId) {
    ...
    public AopInstanceEventData withPlaybookContext(PlaybookcontextRef playbookContext) {
        this.playbookContext = playbookContext;
        return this;
    }

    public AopInstanceEventData withPlaybookContext(Consumer<PlaybookcontextRef> playbookContextSetter) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        AopInstanceEventData that = (AopInstanceEventData) obj;
    ...
    public String toString() {
        ...
        sb.append("class AopInstanceEventData {\n");
