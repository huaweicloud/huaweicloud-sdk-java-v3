 ...
 * 专业版商品编码对象
 */
public class ProductRspProfessional {
    ...
    public ProductRspProfessional withCloudServiceType(String cloudServiceType) {
    ...
    public ProductRspProfessional withResourceType(String resourceType) {
    ...
    public ProductRspProfessional withResourceSpecCode(String resourceSpecCode) {
    ...
    public ProductRspProfessional withResourceSizeMeasureId(Integer resourceSizeMeasureId) {
    ...
    public ProductRspProfessional withUsageFactor(String usageFactor) {
    ...
    public ProductRspProfessional withUsageMeasureId(Integer usageMeasureId) {
    ...
    public ProductRspProfessional withRegionId(String regionId) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ProductRspProfessional that = (ProductRspProfessional) obj;
    ...
    public String toString() {
        ...
        sb.append("class ProductRspProfessional {\n");
