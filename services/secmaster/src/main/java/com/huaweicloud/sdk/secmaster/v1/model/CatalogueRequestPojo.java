 ...
 * 新增、编辑目录pojo
 */
public class CatalogueRequestPojo {
    ...
    @JsonInclude(JsonInclude.Include.NON_NULL)
    @JsonProperty(value = "second_catalogue_code")

    private String secondCatalogueCode;
    ...
    public CatalogueRequestPojo withParentCatalogue(String parentCatalogue) {
    ...
    public CatalogueRequestPojo withParentAliasEn(String parentAliasEn) {
    ...
    public CatalogueRequestPojo withParentAliasZh(String parentAliasZh) {
    ...
    public CatalogueRequestPojo withSecondCatalogue(String secondCatalogue) {
    ...
    public CatalogueRequestPojo withSecondAliasEn(String secondAliasEn) {
    ...
    public CatalogueRequestPojo withSecondAliasZh(String secondAliasZh) {
    ...
    public CatalogueRequestPojo withSecondCatalogueCode(String secondCatalogueCode) {
        this.secondCatalogueCode = secondCatalogueCode;
        return this;
    }

    /**
     * 目录编码
     * @return secondCatalogueCode
     */
    public String getSecondCatalogueCode() {
        return secondCatalogueCode;
    }

    public void setSecondCatalogueCode(String secondCatalogueCode) {
        this.secondCatalogueCode = secondCatalogueCode;
    }

    public CatalogueRequestPojo withLayoutId(String layoutId) {
    ...
    public CatalogueRequestPojo withLayoutName(String layoutName) {
    ...
    public CatalogueRequestPojo withCatalogueAddress(String catalogueAddress) {
    ...
    public CatalogueRequestPojo withPublisherName(String publisherName) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        CatalogueRequestPojo that = (CatalogueRequestPojo) obj;
        return Objects.equals(this.parentCatalogue, that.parentCatalogue)
            ...
            && Objects.equals(this.secondCatalogueCode, that.secondCatalogueCode)
    ...
    public String toString() {
        ...
        sb.append("class CatalogueRequestPojo {\n");
        ...
        sb.append("    secondCatalogueCode: ").append(toIndentedString(secondCatalogueCode)).append("\n");
