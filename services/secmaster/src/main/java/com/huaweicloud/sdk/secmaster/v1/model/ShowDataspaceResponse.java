 ...
 * Response Object
 */
public class ShowDataspaceResponse extends SdkResponse {
    ...
    public ShowDataspaceResponse withCreateBy(String createBy) {
    ...
    public ShowDataspaceResponse withCreateTime(Long createTime) {
    ...
    public ShowDataspaceResponse withDataspaceId(String dataspaceId) {
    ...
    public ShowDataspaceResponse withDataspaceName(String dataspaceName) {
    ...
    public ShowDataspaceResponse withDataspaceType(DataspaceTypeEnum dataspaceType) {
    ...
    public ShowDataspaceResponse withDescription(String description) {
    ...
    public ShowDataspaceResponse withDomainId(String domainId) {
    ...
    public ShowDataspaceResponse withProjectId(String projectId) {
    ...
    public ShowDataspaceResponse withRegionId(String regionId) {
    ...
    public ShowDataspaceResponse withUpdateBy(String updateBy) {
    ...
    public ShowDataspaceResponse withUpdateTime(Long updateTime) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ShowDataspaceResponse that = (ShowDataspaceResponse) obj;
    ...
    public String toString() {
        ...
        sb.append("class ShowDataspaceResponse {\n");
