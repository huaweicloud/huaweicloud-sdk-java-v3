 ...
 * 日志采集商品编码对象
 */
public class ProductRspLogCollection {
    ...
    public ProductRspLogCollection withCloudServiceType(String cloudServiceType) {
    ...
    public ProductRspLogCollection withResourceType(String resourceType) {
    ...
    public ProductRspLogCollection withResourceSpecCode(String resourceSpecCode) {
    ...
    public ProductRspLogCollection withResourceSizeMeasureId(Integer resourceSizeMeasureId) {
    ...
    public ProductRspLogCollection withUsageFactor(String usageFactor) {
    ...
    public ProductRspLogCollection withUsageMeasureId(Integer usageMeasureId) {
    ...
    public ProductRspLogCollection withRegionId(String regionId) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ProductRspLogCollection that = (ProductRspLogCollection) obj;
    ...
    public String toString() {
        ...
        sb.append("class ProductRspLogCollection {\n");
