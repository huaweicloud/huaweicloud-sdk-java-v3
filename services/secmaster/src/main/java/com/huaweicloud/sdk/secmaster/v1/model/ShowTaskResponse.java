...
public class ShowTaskResponse extends SdkResponse {
    ...
    public ShowTaskResponse withSuccess(Boolean success) {
    ...
    public ShowTaskResponse withData(TaskInfo data) {
        this.data = data;
        return this;
    }

    public ShowTaskResponse withData(Consumer<TaskInfo> dataSetter) {
        if (this.data == null) {
