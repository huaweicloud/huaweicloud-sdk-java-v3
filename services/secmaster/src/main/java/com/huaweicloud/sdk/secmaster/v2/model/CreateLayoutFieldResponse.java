 ...
 * Response Object
 */
public class CreateLayoutFieldResponse extends SdkResponse {
    ...
    public CreateLayoutFieldResponse withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public CreateLayoutFieldResponse withCloudPackId(String cloudPackId) {
    ...
    public CreateLayoutFieldResponse withCloudPackName(String cloudPackName) {
    ...
    public CreateLayoutFieldResponse withDataclassId(String dataclassId) {
    ...
    public CreateLayoutFieldResponse withCloudPackVersion(String cloudPackVersion) {
    ...
    public CreateLayoutFieldResponse withFieldKey(String fieldKey) {
    ...
    public CreateLayoutFieldResponse withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public CreateLayoutFieldResponse withDescription(String description) {
    ...
    public CreateLayoutFieldResponse withEnDescription(String enDescription) {
    ...
    public CreateLayoutFieldResponse withDefaultValue(String defaultValue) {
    ...
    public CreateLayoutFieldResponse withEnDefaultValue(String enDefaultValue) {
    ...
    public CreateLayoutFieldResponse withFieldType(String fieldType) {
    ...
    public CreateLayoutFieldResponse withExtraJson(String extraJson) {
    ...
    public CreateLayoutFieldResponse withFieldTooltip(String fieldTooltip) {
    ...
    public CreateLayoutFieldResponse withEnFieldTooltip(String enFieldTooltip) {
    ...
    public CreateLayoutFieldResponse withJsonSchema(String jsonSchema) {
    ...
    public CreateLayoutFieldResponse withIsBuiltIn(Boolean isBuiltIn) {
    ...
    public CreateLayoutFieldResponse withReadOnly(Boolean readOnly) {
    ...
    public CreateLayoutFieldResponse withRequired(Boolean required) {
    ...
    public CreateLayoutFieldResponse withSearchable(Boolean searchable) {
    ...
    public CreateLayoutFieldResponse withVisible(Boolean visible) {
    ...
    public CreateLayoutFieldResponse withMaintainable(Boolean maintainable) {
    ...
    public CreateLayoutFieldResponse withEditable(Boolean editable) {
    ...
    public CreateLayoutFieldResponse withCreatable(Boolean creatable) {
    ...
    public CreateLayoutFieldResponse withCreatorId(String creatorId) {
    ...
    public CreateLayoutFieldResponse withCreatorName(String creatorName) {
    ...
    public CreateLayoutFieldResponse withModifierId(String modifierId) {
    ...
    public CreateLayoutFieldResponse withModifierName(String modifierName) {
    ...
    public CreateLayoutFieldResponse withCreateTime(String createTime) {
    ...
    public CreateLayoutFieldResponse withUpdateTime(String updateTime) {
    ...
    public CreateLayoutFieldResponse withWizardId(String wizardId) {
    ...
    public CreateLayoutFieldResponse withAopworkflowId(String aopworkflowId) {
    ...
    public CreateLayoutFieldResponse withAopworkflowVersionId(String aopworkflowVersionId) {
    ...
    public CreateLayoutFieldResponse withPlaybookId(String playbookId) {
    ...
    public CreateLayoutFieldResponse withPlaybookVersionId(String playbookVersionId) {
    ...
    public CreateLayoutFieldResponse withBoaVersion(String boaVersion) {
    ...
    public CreateLayoutFieldResponse withVersion(String version) {
    ...
    public CreateLayoutFieldResponse withXRequestId(String xRequestId) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        CreateLayoutFieldResponse that = (CreateLayoutFieldResponse) obj;
    ...
    public String toString() {
        ...
        sb.append("class CreateLayoutFieldResponse {\n");
