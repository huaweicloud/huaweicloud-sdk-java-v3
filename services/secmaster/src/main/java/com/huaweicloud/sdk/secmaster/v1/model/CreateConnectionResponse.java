...
public class CreateConnectionResponse extends SdkResponse {
    ...
    public CreateConnectionResponse withCode(String code) {
        this.code = code;
        return this;
    }
    ...
    public CreateConnectionResponse withMessage(String message) {
    ...
    public CreateConnectionResponse withAsset(AssetInfoResponseBody asset) {
        this.asset = asset;
        return this;
    }

    public CreateConnectionResponse withAsset(Consumer<AssetInfoResponseBody> assetSetter) {
        if (this.asset == null) {
