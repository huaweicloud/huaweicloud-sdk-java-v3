...
public class Parser {
    ...
    public Parser withChannelReferCount(Long channelReferCount) {
    ...
    public Parser withDescription(String description) {
    ...
    public Parser withParserId(String parserId) {
    ...
    public Parser withTitle(String title) {
        this.title = title;
        return this;
    }
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        return Objects.equals(this.channelReferCount, that.channelReferCount)
            && Objects.equals(this.description, that.description) && Objects.equals(this.parserId, that.parserId)
            && Objects.equals(this.title, that.title);
    }

    @Override
    public int hashCode() {
        return Objects.hash(channelReferCount, description, parserId, title);
    }
