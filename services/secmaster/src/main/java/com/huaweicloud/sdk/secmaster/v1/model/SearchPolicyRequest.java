...
public class SearchPolicyRequest {
    ...
    public SearchPolicyRequest withXSecmasterVersion(String xSecmasterVersion) {
    ...
    public SearchPolicyRequest withWorkspaceId(String workspaceId) {
    ...
    public SearchPolicyRequest withBody(SearchPolicyRequestBody body) {
        this.body = body;
        return this;
    }

    public SearchPolicyRequest withBody(Consumer<SearchPolicyRequestBody> bodySetter) {
        if (this.body == null) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        SearchPolicyRequest that = (SearchPolicyRequest) obj;
    ...
    public String toString() {
        ...
        sb.append("class SearchPolicyRequest {\n");
