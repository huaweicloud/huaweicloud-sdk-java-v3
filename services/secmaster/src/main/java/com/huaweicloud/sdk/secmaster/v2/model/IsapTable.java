...
public class IsapTable {
    ...
    public IsapTable withProjectId(String projectId) {
    ...
    public IsapTable withWorkspaceId(String workspaceId) {
    ...
    public IsapTable withTableId(String tableId) {
    ...
    public IsapTable withPipeId(String pipeId) {
        this.pipeId = pipeId;
        return this;
    }
    ...
    public IsapTable withTableName(String tableName) {
    ...
    public IsapTable withTableAlias(String tableAlias) {
    ...
    public IsapTable withDescription(String description) {
    ...
    public IsapTable withDirectory(String directory) {
    ...
    public IsapTable withCategory(IsapTableCategory category) {
    ...
    public IsapTable withLockStatus(TableLockStatus lockStatus) {
    ...
    public IsapTable withProcessStatus(IsapTableProcessStatus processStatus) {
    ...
    public IsapTable withProcessError(IsapTableProcessError processError) {
    ...
    public IsapTable withFormat(TableFormat format) {
        this.format = format;
        return this;
    }
    ...
    public IsapTable withRwType(TableRWType rwType) {
        this.rwType = rwType;
        return this;
    }
    ...
    public IsapTable withOwnerType(TableOwnerType ownerType) {
    ...
    public IsapTable withDataLayering(DataLayering dataLayering) {
    ...
    public IsapTable withDataClassification(DataClassification dataClassification) {
    ...
    public IsapTable withSchema(IsapTableSchema schema) {
        this.schema = schema;
        return this;
    }

    public IsapTable withSchema(Consumer<IsapTableSchema> schemaSetter) {
        if (this.schema == null) {
    ...
    public IsapTable withStorageSetting(TableStorageSetting storageSetting) {
        this.storageSetting = storageSetting;
        return this;
    }

    public IsapTable withStorageSetting(Consumer<TableStorageSetting> storageSettingSetter) {
    ...
    public IsapTable withDisplaySetting(TableDisplaySetting displaySetting) {
        this.displaySetting = displaySetting;
        return this;
    }

    public IsapTable withDisplaySetting(Consumer<TableDisplaySetting> displaySettingSetter) {
    ...
    public IsapTable withCreateTime(Long createTime) {
    ...
    public IsapTable withUpdateTime(Long updateTime) {
    ...
    public IsapTable withDeleteTime(Long deleteTime) {
