...
public class DataobjectInfo {
    ...
    public DataobjectInfo withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public DataobjectInfo withCreateTime(String createTime) {
    ...
    public DataobjectInfo withUpdateTime(String updateTime) {
    ...
    public DataobjectInfo withProjectId(String projectId) {
    ...
    public DataobjectInfo withDataclassId(String dataclassId) {
    ...
    public DataobjectInfo withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append("class DataobjectInfo {\n");
