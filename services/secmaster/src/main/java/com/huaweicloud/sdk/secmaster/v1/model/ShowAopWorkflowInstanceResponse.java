 ...
 * Response Object
 */
public class ShowAopWorkflowInstanceResponse extends SdkResponse {
    ...
    public ShowAopWorkflowInstanceResponse withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public ShowAopWorkflowInstanceResponse withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public ShowAopWorkflowInstanceResponse withWorkflow(AopworkflowInstanceDetailWorkflow workflow) {
        this.workflow = workflow;
        return this;
    }

    public ShowAopWorkflowInstanceResponse withWorkflow(Consumer<AopworkflowInstanceDetailWorkflow> workflowSetter) {
    ...
    public ShowAopWorkflowInstanceResponse withDataclass(AopworkflowInstanceDetailDataclass dataclass) {
        this.dataclass = dataclass;
        return this;
    }

    public ShowAopWorkflowInstanceResponse withDataclass(Consumer<AopworkflowInstanceDetailDataclass> dataclassSetter) {
    ...
    public ShowAopWorkflowInstanceResponse withPlaybook(AopworkflowInstanceDetailPlaybook playbook) {
        this.playbook = playbook;
        return this;
    }

    public ShowAopWorkflowInstanceResponse withPlaybook(Consumer<AopworkflowInstanceDetailPlaybook> playbookSetter) {
    ...
    public ShowAopWorkflowInstanceResponse withTriggerType(String triggerType) {
    ...
    public ShowAopWorkflowInstanceResponse withStatus(StatusEnum status) {
        this.status = status;
        return this;
    }
    ...
    public ShowAopWorkflowInstanceResponse withStartTime(String startTime) {
    ...
    public ShowAopWorkflowInstanceResponse withEndTime(String endTime) {
    ...
    public ShowAopWorkflowInstanceResponse withRetryCount(Integer retryCount) {
    ...
    public ShowAopWorkflowInstanceResponse withDefenseId(String defenseId) {
    ...
    public ShowAopWorkflowInstanceResponse withDataobjectId(String dataobjectId) {
    ...
    public ShowAopWorkflowInstanceResponse withTopology(WorkflowInstanceTopology topology) {
        this.topology = topology;
        return this;
    }

    public ShowAopWorkflowInstanceResponse withTopology(Consumer<WorkflowInstanceTopology> topologySetter) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ShowAopWorkflowInstanceResponse that = (ShowAopWorkflowInstanceResponse) obj;
    ...
    public String toString() {
        ...
        sb.append("class ShowAopWorkflowInstanceResponse {\n");
