...
/**
 * ImportVulnerabilitiesRequestBody
 */
public class ImportVulnerabilitiesRequestBody implements SdkFormDataBody {

    @JsonProperty(value = "uploadFile", access = JsonProperty.Access.WRITE_ONLY)

    private FormDataFilePart uploadFile;

    public ImportVulnerabilitiesRequestBody withUploadFile(FormDataFilePart uploadFile) {
    ...
    public ImportVulnerabilitiesRequestBody withUploadFile(InputStream inputStream, String fileName,
        String contentType) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ImportVulnerabilitiesRequestBody that = (ImportVulnerabilitiesRequestBody) obj;
    ...
    public String toString() {
        ...
        sb.append("class ImportVulnerabilitiesRequestBody {\n");
