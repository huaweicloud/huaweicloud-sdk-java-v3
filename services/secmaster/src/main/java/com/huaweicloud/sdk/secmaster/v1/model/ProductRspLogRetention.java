 ...
 * 日志保留商品编码对象
 */
public class ProductRspLogRetention {
    ...
    public ProductRspLogRetention withCloudServiceType(String cloudServiceType) {
    ...
    public ProductRspLogRetention withResourceType(String resourceType) {
    ...
    public ProductRspLogRetention withResourceSpecCode(String resourceSpecCode) {
    ...
    public ProductRspLogRetention withResourceSizeMeasureId(Integer resourceSizeMeasureId) {
    ...
    public ProductRspLogRetention withUsageFactor(String usageFactor) {
    ...
    public ProductRspLogRetention withUsageMeasureId(Integer usageMeasureId) {
    ...
    public ProductRspLogRetention withRegionId(String regionId) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ProductRspLogRetention that = (ProductRspLogRetention) obj;
    ...
    public String toString() {
        ...
        sb.append("class ProductRspLogRetention {\n");
