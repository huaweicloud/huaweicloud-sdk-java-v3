...
public class DeleteDataobjectRelationRequest {
    ...
    public DeleteDataobjectRelationRequest withBody(CreateDataobjectRelationRequestBody body) {
        this.body = body;
        return this;
    }

    public DeleteDataobjectRelationRequest withBody(Consumer<CreateDataobjectRelationRequestBody> bodySetter) {
        if (this.body == null) {
