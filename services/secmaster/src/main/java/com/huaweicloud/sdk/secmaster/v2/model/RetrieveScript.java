...
public class RetrieveScript {
    ...
    public RetrieveScript withScriptId(String scriptId) {
    ...
    public RetrieveScript withProjectId(String projectId) {
    ...
    public RetrieveScript withWorkspaceId(String workspaceId) {
    ...
    public RetrieveScript withScriptName(String scriptName) {
    ...
    public RetrieveScript withTableId(String tableId) {
    ...
    public RetrieveScript withCategory(ScriptCategory category) {
    ...
    public RetrieveScript withDirectory(String directory) {
    ...
    public RetrieveScript withDescription(String description) {
    ...
    public RetrieveScript withScript(String script) {
        this.script = script;
        return this;
    }
    ...
    public RetrieveScript withCreateBy(String createBy) {
    ...
    public RetrieveScript withCreateTime(Long createTime) {
    ...
    public RetrieveScript withUpdateBy(String updateBy) {
    ...
    public RetrieveScript withUpdateTime(Long updateTime) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        RetrieveScript that = (RetrieveScript) obj;
    ...
    public String toString() {
        ...
        sb.append("class RetrieveScript {\n");
