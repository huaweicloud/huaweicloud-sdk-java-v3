 ...
 * 表存储设置数据传输对象
 */
public class IsapTableStorageSettingDto {
    ...
    public IsapTableStorageSettingDto withApplicationIndex(String applicationIndex) {
    ...
    public IsapTableStorageSettingDto withApplicationTopic(String applicationTopic) {
    ...
    public IsapTableStorageSettingDto withApplicationDataClassId(String applicationDataClassId) {
    ...
    public IsapTableStorageSettingDto withStreamingBandwidth(BigDecimal streamingBandwidth) {
    ...
    public IsapTableStorageSettingDto withStreamingPartition(Integer streamingPartition) {
    ...
    public IsapTableStorageSettingDto withStreamingDataspaceId(String streamingDataspaceId) {
    ...
    public IsapTableStorageSettingDto withIndexStoragePeriod(Integer indexStoragePeriod) {
    ...
    public IsapTableStorageSettingDto withIndexStorageSize(Integer indexStorageSize) {
    ...
    public IsapTableStorageSettingDto withIndexShards(Integer indexShards) {
    ...
    public IsapTableStorageSettingDto withLakeStoragePeriod(Long lakeStoragePeriod) {
    ...
    public IsapTableStorageSettingDto withLakePartitionSetting(LakePartitionSettingEnum lakePartitionSetting) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        IsapTableStorageSettingDto that = (IsapTableStorageSettingDto) obj;
    ...
    public String toString() {
        ...
        sb.append("class IsapTableStorageSettingDto {\n");
