 ...
 * 日志分析商品编码对象
 */
public class ProductRspLogAnalysis {
    ...
    public ProductRspLogAnalysis withCloudServiceType(String cloudServiceType) {
    ...
    public ProductRspLogAnalysis withResourceType(String resourceType) {
    ...
    public ProductRspLogAnalysis withResourceSpecCode(String resourceSpecCode) {
    ...
    public ProductRspLogAnalysis withResourceSizeMeasureId(Integer resourceSizeMeasureId) {
    ...
    public ProductRspLogAnalysis withUsageFactor(String usageFactor) {
    ...
    public ProductRspLogAnalysis withUsageMeasureId(Integer usageMeasureId) {
    ...
    public ProductRspLogAnalysis withRegionId(String regionId) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ProductRspLogAnalysis that = (ProductRspLogAnalysis) obj;
    ...
    public String toString() {
        ...
        sb.append("class ProductRspLogAnalysis {\n");
