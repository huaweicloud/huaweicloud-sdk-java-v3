 ...
 * Response Object
 */
public class ShowDataClassInfoResponse extends SdkResponse {
    ...
    public ShowDataClassInfoResponse withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public ShowDataClassInfoResponse withCreateTime(String createTime) {
    ...
    public ShowDataClassInfoResponse withUpdateTime(String updateTime) {
    ...
    public ShowDataClassInfoResponse withCreatorId(String creatorId) {
    ...
    public ShowDataClassInfoResponse withCreatorName(String creatorName) {
    ...
    public ShowDataClassInfoResponse withModifierId(String modifierId) {
    ...
    public ShowDataClassInfoResponse withModifierName(String modifierName) {
    ...
    public ShowDataClassInfoResponse withCloudPackVersion(String cloudPackVersion) {
    ...
    public ShowDataClassInfoResponse withRegionId(String regionId) {
    ...
    public ShowDataClassInfoResponse withProjectId(String projectId) {
    ...
    public ShowDataClassInfoResponse withWorkspaceId(String workspaceId) {
    ...
    public ShowDataClassInfoResponse withDomainId(String domainId) {
    ...
    public ShowDataClassInfoResponse withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public ShowDataClassInfoResponse withBusinessCode(String businessCode) {
    ...
    public ShowDataClassInfoResponse withDescription(String description) {
    ...
    public ShowDataClassInfoResponse withIsBuiltIn(Boolean isBuiltIn) {
    ...
    public ShowDataClassInfoResponse withParentId(String parentId) {
    ...
    public ShowDataClassInfoResponse withTypeNum(BigDecimal typeNum) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ShowDataClassInfoResponse that = (ShowDataClassInfoResponse) obj;
    ...
    public String toString() {
        ...
        sb.append("class ShowDataClassInfoResponse {\n");
