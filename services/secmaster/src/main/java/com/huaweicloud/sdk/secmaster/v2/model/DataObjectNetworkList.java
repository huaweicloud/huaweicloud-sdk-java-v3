...
/**
 * DataObjectNetworkList
 */
public class DataObjectNetworkList {
    ...
    public DataObjectNetworkList withDirection(DirectionEnum direction) {
    ...
    public DataObjectNetworkList withProtocol(String protocol) {
    ...
    public DataObjectNetworkList withSrcIp(String srcIp) {
        this.srcIp = srcIp;
        return this;
    }
    ...
    public DataObjectNetworkList withSrcPort(Integer srcPort) {
    ...
    public DataObjectNetworkList withSrcDomain(String srcDomain) {
    ...
    public DataObjectNetworkList withSrcGeo(AlertSrcGeo srcGeo) {
        this.srcGeo = srcGeo;
        return this;
    }

    public DataObjectNetworkList withSrcGeo(Consumer<AlertSrcGeo> srcGeoSetter) {
        if (this.srcGeo == null) {
    ...
    public DataObjectNetworkList withDestIp(String destIp) {
        this.destIp = destIp;
        return this;
    }
    ...
    public DataObjectNetworkList withDestPort(String destPort) {
    ...
    public DataObjectNetworkList withDestDomain(String destDomain) {
    ...
    public DataObjectNetworkList withDestGeo(AlertDestGeo destGeo) {
        this.destGeo = destGeo;
        return this;
    }

    public DataObjectNetworkList withDestGeo(Consumer<AlertDestGeo> destGeoSetter) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        DataObjectNetworkList that = (DataObjectNetworkList) obj;
    ...
    public String toString() {
        ...
        sb.append("class DataObjectNetworkList {\n");
