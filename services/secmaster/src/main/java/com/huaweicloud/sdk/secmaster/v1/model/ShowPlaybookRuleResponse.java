 ...
 * Response Object
 */
public class ShowPlaybookRuleResponse extends SdkResponse {
    ...
    public ShowPlaybookRuleResponse withCode(String code) {
        this.code = code;
        return this;
    }
    ...
    public ShowPlaybookRuleResponse withMessage(String message) {
    ...
    public ShowPlaybookRuleResponse withData(RuleInfo data) {
        this.data = data;
        return this;
    }

    public ShowPlaybookRuleResponse withData(Consumer<RuleInfo> dataSetter) {
        if (this.data == null) {
    ...
    public ShowPlaybookRuleResponse withXRequestId(String xRequestId) {
    ...
    public ShowPlaybookRuleResponse withXAPIDeprecationInfo(String xAPIDeprecationInfo) {
    ...
    public ShowPlaybookRuleResponse withXAPIDeprecationDate(String xAPIDeprecationDate) {
    ...
    public String toString() {
        ...
        sb.append("class ShowPlaybookRuleResponse {\n");
