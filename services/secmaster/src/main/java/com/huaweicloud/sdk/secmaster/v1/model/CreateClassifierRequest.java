...
public class CreateClassifierRequest {
    ...
    public CreateClassifierRequest withWorkspaceId(String workspaceId) {
    ...
    public CreateClassifierRequest withBody(CreateDpeClassifyRequestBody body) {
        this.body = body;
        return this;
    }

    public CreateClassifierRequest withBody(Consumer<CreateDpeClassifyRequestBody> bodySetter) {
        if (this.body == null) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        CreateClassifierRequest that = (CreateClassifierRequest) obj;
