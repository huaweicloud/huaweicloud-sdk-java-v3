...
public class ShowTableResponse extends SdkResponse {
    ...
    public ShowTableResponse withProjectId(String projectId) {
    ...
    public ShowTableResponse withWorkspaceId(String workspaceId) {
    ...
    public ShowTableResponse withTableId(String tableId) {
    ...
    public ShowTableResponse withPipeId(String pipeId) {
        this.pipeId = pipeId;
        return this;
    }
    ...
    public ShowTableResponse withTableAlias(String tableAlias) {
    ...
    public ShowTableResponse withDescription(String description) {
    ...
    public ShowTableResponse withDirectory(String directory) {
    ...
    public ShowTableResponse withCategory(IsapTableCategory category) {
    ...
    public ShowTableResponse withLockStatus(TableLockStatus lockStatus) {
    ...
    public ShowTableResponse withProcessStatus(IsapTableProcessStatus processStatus) {
    ...
    public ShowTableResponse withProcessError(IsapTableProcessError processError) {
    ...
    public ShowTableResponse withFormat(TableFormat format) {
        this.format = format;
        return this;
    }
    ...
    public ShowTableResponse withRwType(TableRWType rwType) {
        this.rwType = rwType;
        return this;
    }
    ...
    public ShowTableResponse withOwnerType(TableOwnerType ownerType) {
    ...
    public ShowTableResponse withDataLayering(DataLayering dataLayering) {
    ...
    public ShowTableResponse withDataClassification(DataClassification dataClassification) {
    ...
    public ShowTableResponse withSchema(IsapTableSchema schema) {
        this.schema = schema;
        return this;
    }

    public ShowTableResponse withSchema(Consumer<IsapTableSchema> schemaSetter) {
        if (this.schema == null) {
    ...
    public ShowTableResponse withStorageSetting(TableStorageSetting storageSetting) {
        this.storageSetting = storageSetting;
        return this;
    }

    public ShowTableResponse withStorageSetting(Consumer<TableStorageSetting> storageSettingSetter) {
    ...
    public ShowTableResponse withDisplaySetting(TableDisplaySetting displaySetting) {
        this.displaySetting = displaySetting;
        return this;
    }

    public ShowTableResponse withDisplaySetting(Consumer<TableDisplaySetting> displaySettingSetter) {
    ...
    public ShowTableResponse withCreateTime(Long createTime) {
    ...
    public ShowTableResponse withUpdateTime(Long updateTime) {
    ...
    public ShowTableResponse withDeleteTime(Long deleteTime) {
