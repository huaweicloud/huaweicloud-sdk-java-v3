...
public class ListDataobjectRelationRequest {
    ...
    public ListDataobjectRelationRequest withWorkspaceId(String workspaceId) {
    ...
    public ListDataobjectRelationRequest withDataclassType(String dataclassType) {
    ...
    public ListDataobjectRelationRequest withDataObjectId(String dataObjectId) {
    ...
    public ListDataobjectRelationRequest withRelatedDataclassType(String relatedDataclassType) {
    ...
    public ListDataobjectRelationRequest withBody(DataobjectSearch body) {
        this.body = body;
        return this;
    }

    public ListDataobjectRelationRequest withBody(Consumer<DataobjectSearch> bodySetter) {
        if (this.body == null) {
