...
public class Pipe {
    ...
    public Pipe withCreateBy(String createBy) {
    ...
    public Pipe withCreateTime(Long createTime) {
    ...
    public Pipe withDataspaceId(String dataspaceId) {
    ...
    public Pipe withDataspaceName(String dataspaceName) {
    ...
    public Pipe withDescription(String description) {
    ...
    public Pipe withDomainId(String domainId) {
    ...
    public Pipe withPipeId(String pipeId) {
        this.pipeId = pipeId;
        return this;
    }
    ...
    public Pipe withPipeName(String pipeName) {
    ...
    public Pipe withPipeType(PipeTypeEnum pipeType) {
    ...
    public Pipe withProjectId(String projectId) {
    ...
    public Pipe withShards(Integer shards) {
        this.shards = shards;
        return this;
    }
    ...
    public Pipe withStoragePeriod(Integer storagePeriod) {
    ...
    public Pipe withUpdateBy(String updateBy) {
    ...
    public Pipe withUpdateTime(Long updateTime) {
