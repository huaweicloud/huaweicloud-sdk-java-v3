...
public class UpdateConnectionResponse extends SdkResponse {
    ...
    public UpdateConnectionResponse withCode(String code) {
        this.code = code;
        return this;
    }
    ...
    public UpdateConnectionResponse withMessage(String message) {
    ...
    public UpdateConnectionResponse withAsset(AssetInfoResponseBody asset) {
        this.asset = asset;
        return this;
    }

    public UpdateConnectionResponse withAsset(Consumer<AssetInfoResponseBody> assetSetter) {
        if (this.asset == null) {
