 ...
 * Request Object
 */
public class CreateDataobjectRelationsRequest {
    ...
    public CreateDataobjectRelationsRequest withWorkspaceId(String workspaceId) {
    ...
    public CreateDataobjectRelationsRequest withDataclassType(String dataclassType) {
    ...
    public CreateDataobjectRelationsRequest withDataObjectId(String dataObjectId) {
    ...
    public CreateDataobjectRelationsRequest withRelatedDataclassType(String relatedDataclassType) {
    ...
    public CreateDataobjectRelationsRequest withBody(CreateDataobjectRelationsRequestBody body) {
        this.body = body;
        return this;
    }

    public CreateDataobjectRelationsRequest withBody(Consumer<CreateDataobjectRelationsRequestBody> bodySetter) {
        if (this.body == null) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        CreateDataobjectRelationsRequest that = (CreateDataobjectRelationsRequest) obj;
    ...
    public String toString() {
        ...
        sb.append("class CreateDataobjectRelationsRequest {\n");
