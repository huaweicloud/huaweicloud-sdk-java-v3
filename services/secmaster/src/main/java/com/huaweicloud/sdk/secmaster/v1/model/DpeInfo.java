...
public class DpeInfo {
    ...
    @JsonInclude(JsonInclude.Include.NON_NULL)
    @JsonProperty(value = "complete_degree")
    ...
    public DpeInfo withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public DpeInfo withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public DpeInfo withProjectId(String projectId) {
    ...
    public DpeInfo withWorkspaceId(String workspaceId) {
    ...
    public DpeInfo withDataclassId(String dataclassId) {
    ...
    public DpeInfo withDataclassName(String dataclassName) {
    ...
    public DpeInfo withClassifierId(String classifierId) {
    ...
    public DpeInfo withStatus(String status) {
        this.status = status;
        return this;
    }
    ...
    public DpeInfo withCompleteDegree(String completeDegree) {
    ...
    public DpeInfo withInstanceNum(String instanceNum) {
    ...
    public DpeInfo withUpdateTime(String updateTime) {
    ...
    public DpeInfo withCreateTime(String createTime) {
    ...
    public DpeInfo withCreatorId(String creatorId) {
    ...
    public DpeInfo withCreatorName(String creatorName) {
    ...
    public DpeInfo withModifierId(String modifierId) {
    ...
    public DpeInfo withModifierName(String modifierName) {
