...
public class HwcEcsVolume {
    ...
    public HwcEcsVolume withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public HwcEcsVolume withDeleteOnTermination(String deleteOnTermination) {
    ...
    public HwcEcsVolume withBootIndex(String bootIndex) {
    ...
    public HwcEcsVolume withDevice(String device) {
        this.device = device;
        return this;
    }
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        HwcEcsVolume that = (HwcEcsVolume) obj;
