...
/**
 * ImportDataobjectsRequestBody
 */
public class ImportDataobjectsRequestBody implements SdkFormDataBody {

    @JsonProperty(value = "uploadFile", access = JsonProperty.Access.WRITE_ONLY)

    private FormDataFilePart uploadFile;

    public ImportDataobjectsRequestBody withUploadFile(FormDataFilePart uploadFile) {
    ...
    public ImportDataobjectsRequestBody withUploadFile(InputStream inputStream, String fileName, String contentType) {
        this.uploadFile = new FormDataFilePart(inputStream, fileName).withContentType(contentType);
        return this;
    }

    public ImportDataobjectsRequestBody withUploadFile(InputStream inputStream, String fileName) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ImportDataobjectsRequestBody that = (ImportDataobjectsRequestBody) obj;
    ...
    public String toString() {
        ...
        sb.append("class ImportDataobjectsRequestBody {\n");
