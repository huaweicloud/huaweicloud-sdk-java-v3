...
public class ListDataobjectsRequest {
    ...
    public ListDataobjectsRequest withWorkspaceId(String workspaceId) {
    ...
    public ListDataobjectsRequest withDataclassName(String dataclassName) {
    ...
    public ListDataobjectsRequest withBody(DataobjectSearch body) {
        this.body = body;
        return this;
    }

    public ListDataobjectsRequest withBody(Consumer<DataobjectSearch> bodySetter) {
        if (this.body == null) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ListDataobjectsRequest that = (ListDataobjectsRequest) obj;
