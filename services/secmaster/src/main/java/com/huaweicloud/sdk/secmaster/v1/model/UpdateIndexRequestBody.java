...
public class UpdateIndexRequestBody {
    ...
    public UpdateIndexRequestBody withMapping(Map<String, KeyIndex> mapping) {
        this.mapping = mapping;
        return this;
    }

    public UpdateIndexRequestBody putMappingItem(String key, KeyIndex mappingItem) {
    ...
    public UpdateIndexRequestBody withMapping(Consumer<Map<String, KeyIndex>> mappingSetter) {
        if (this.mapping == null) {
            this.mapping = new HashMap<>();
        }
    ...
    public UpdateIndexRequestBody withPipeId(String pipeId) {
        this.pipeId = pipeId;
        return this;
    }
    ...
    public UpdateIndexRequestBody withStatus(StatusEnum status) {
        this.status = status;
        return this;
    }
    ...
    public UpdateIndexRequestBody withTimestampField(String timestampField) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        UpdateIndexRequestBody that = (UpdateIndexRequestBody) obj;
    ...
    public String toString() {
        ...
        sb.append("class UpdateIndexRequestBody {\n");
