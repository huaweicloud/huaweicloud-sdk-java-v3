 ...
 * Response Object
 */
public class ShowPipeIndexResponse extends SdkResponse {
    ...
    public ShowPipeIndexResponse withMapping(Map<String, KeyIndex> mapping) {
        this.mapping = mapping;
        return this;
    }

    public ShowPipeIndexResponse putMappingItem(String key, KeyIndex mappingItem) {
    ...
    public ShowPipeIndexResponse withMapping(Consumer<Map<String, KeyIndex>> mappingSetter) {
        if (this.mapping == null) {
            this.mapping = new HashMap<>();
        }
    ...
    public ShowPipeIndexResponse withPipeId(String pipeId) {
        this.pipeId = pipeId;
        return this;
    }
    ...
    public ShowPipeIndexResponse withStatus(StatusEnum status) {
        this.status = status;
        return this;
    }
    ...
    public ShowPipeIndexResponse withTimestampField(String timestampField) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ShowPipeIndexResponse that = (ShowPipeIndexResponse) obj;
    ...
    public String toString() {
        ...
        sb.append("class ShowPipeIndexResponse {\n");
