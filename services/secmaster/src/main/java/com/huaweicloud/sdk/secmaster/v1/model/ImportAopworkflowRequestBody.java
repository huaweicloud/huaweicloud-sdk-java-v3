...
/**
 * ImportAopworkflowRequestBody
 */
public class ImportAopworkflowRequestBody implements SdkFormDataBody {

    @JsonProperty(value = "uploadFile", access = JsonProperty.Access.WRITE_ONLY)

    private FormDataFilePart uploadFile;

    public ImportAopworkflowRequestBody withUploadFile(FormDataFilePart uploadFile) {
    ...
    public ImportAopworkflowRequestBody withUploadFile(InputStream inputStream, String fileName, String contentType) {
        this.uploadFile = new FormDataFilePart(inputStream, fileName).withContentType(contentType);
        return this;
    }

    public ImportAopworkflowRequestBody withUploadFile(InputStream inputStream, String fileName) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ImportAopworkflowRequestBody that = (ImportAopworkflowRequestBody) obj;
    ...
    public String toString() {
        ...
        sb.append("class ImportAopworkflowRequestBody {\n");
