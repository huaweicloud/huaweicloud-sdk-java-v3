...
public class CreateDataobjectRelationRequest {
    ...
    private CreateDataobjectRelationRequestBody body;
    ...
    public CreateDataobjectRelationRequest withBody(CreateDataobjectRelationRequestBody body) {
        this.body = body;
        return this;
    }

    public CreateDataobjectRelationRequest withBody(Consumer<CreateDataobjectRelationRequestBody> bodySetter) {
        if (this.body == null) {
            this.body = new CreateDataobjectRelationRequestBody();
     ...
     * @return body
     */
    public CreateDataobjectRelationRequestBody getBody() {
        return body;
    }

    public void setBody(CreateDataobjectRelationRequestBody body) {
        this.body = body;
    }
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        CreateDataobjectRelationRequest that = (CreateDataobjectRelationRequest) obj;
