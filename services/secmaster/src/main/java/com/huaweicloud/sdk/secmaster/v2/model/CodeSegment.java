...
public class CodeSegment {
    ...
    public CodeSegment withCodeSegmentId(String codeSegmentId) {
    ...
    public CodeSegment withProjectId(String projectId) {
    ...
    public CodeSegment withWorkspaceId(String workspaceId) {
    ...
    public CodeSegment withCodeSegmentName(String codeSegmentName) {
    ...
    public CodeSegment withDescription(String description) {
    ...
    public CodeSegment withCode(String code) {
        this.code = code;
        return this;
    }
    ...
    public CodeSegment withCreateBy(String createBy) {
    ...
    public CodeSegment withCreateTime(Long createTime) {
    ...
    public CodeSegment withUpdateBy(String updateBy) {
    ...
    public CodeSegment withUpdateTime(Long updateTime) {
