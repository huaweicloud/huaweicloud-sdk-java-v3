 ...
 * 表格列数据传输对象
 */
public class IsapTableColumnDto {
    ...
    public IsapTableColumnDto withColumnName(String columnName) {
    ...
    public IsapTableColumnDto withColumnType(ColumnTypeEnum columnType) {
    ...
    public IsapTableColumnDto withColumnTypeSetting(String columnTypeSetting) {
    ...
    public IsapTableColumnDto withColumnDataType(ColumnDataTypeEnum columnDataType) {
    ...
    public IsapTableColumnDto withColumnDataTypeSetting(String columnDataTypeSetting) {
    ...
    public IsapTableColumnDto withNullable(Boolean nullable) {
    ...
    public IsapTableColumnDto withArray(Boolean array) {
        this.array = array;
        return this;
    }
    ...
    public IsapTableColumnDto withColumnDisplaySetting(ColumnDisplaySetting columnDisplaySetting) {
        this.columnDisplaySetting = columnDisplaySetting;
        return this;
    }

    public IsapTableColumnDto withColumnDisplaySetting(Consumer<ColumnDisplaySetting> columnDisplaySettingSetter) {
    ...
    public IsapTableColumnDto withColumnSequenceNumber(Integer columnSequenceNumber) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        IsapTableColumnDto that = (IsapTableColumnDto) obj;
    ...
    public String toString() {
        ...
        sb.append("class IsapTableColumnDto {\n");
