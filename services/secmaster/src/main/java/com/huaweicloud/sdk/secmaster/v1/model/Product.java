...
public class Product {
    ...
    public Product withResourceSpecCode(String resourceSpecCode) {
    ...
    public Product withResourceSize(Integer resourceSize) {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(resourceType, resourceSpecCode, resourceSize);
    }
