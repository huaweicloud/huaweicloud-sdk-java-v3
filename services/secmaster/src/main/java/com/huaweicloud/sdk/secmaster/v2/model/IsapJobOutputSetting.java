 ...
 * 作业输出设置
 */
public class IsapJobOutputSetting {
    ...
    public IsapJobOutputSetting withAlertCustomProperties(Map<String, String> alertCustomProperties) {
        this.alertCustomProperties = alertCustomProperties;
        return this;
    }

    public IsapJobOutputSetting putAlertCustomPropertiesItem(String key, String alertCustomPropertiesItem) {
    ...
    public IsapJobOutputSetting withAlertCustomProperties(Consumer<Map<String, String>> alertCustomPropertiesSetter) {
        if (this.alertCustomProperties == null) {
            this.alertCustomProperties = new HashMap<>();
        }
    ...
    public IsapJobOutputSetting withAlertDescription(String alertDescription) {
    ...
    public IsapJobOutputSetting withAlertGrouping(Boolean alertGrouping) {
    ...
    public IsapJobOutputSetting withAlertMapping(Map<String, String> alertMapping) {
        this.alertMapping = alertMapping;
        return this;
    }

    public IsapJobOutputSetting putAlertMappingItem(String key, String alertMappingItem) {
    ...
    public IsapJobOutputSetting withAlertMapping(Consumer<Map<String, String>> alertMappingSetter) {
        if (this.alertMapping == null) {
            this.alertMapping = new HashMap<>();
        }
    ...
    public IsapJobOutputSetting withAlertName(String alertName) {
    ...
    public IsapJobOutputSetting withAlertRemediation(String alertRemediation) {
    ...
    public IsapJobOutputSetting withAlertSeverity(IsapAlertSeverity alertSeverity) {
    ...
    public IsapJobOutputSetting withAlertSuppression(Boolean alertSuppression) {
    ...
    public IsapJobOutputSetting withAlertType(Map<String, String> alertType) {
        this.alertType = alertType;
        return this;
    }

    public IsapJobOutputSetting putAlertTypeItem(String key, String alertTypeItem) {
    ...
    public IsapJobOutputSetting withAlertType(Consumer<Map<String, String>> alertTypeSetter) {
        if (this.alertType == null) {
            this.alertType = new HashMap<>();
        }
    ...
    public IsapJobOutputSetting withEntityExtraction(Map<String, String> entityExtraction) {
        this.entityExtraction = entityExtraction;
        return this;
    }

    public IsapJobOutputSetting putEntityExtractionItem(String key, String entityExtractionItem) {
    ...
    public IsapJobOutputSetting withEntityExtraction(Consumer<Map<String, String>> entityExtractionSetter) {
        if (this.entityExtraction == null) {
            this.entityExtraction = new HashMap<>();
        }
    ...
    public IsapJobOutputSetting withFieldMapping(Map<String, String> fieldMapping) {
        this.fieldMapping = fieldMapping;
        return this;
    }

    public IsapJobOutputSetting putFieldMappingItem(String key, String fieldMappingItem) {
    ...
    public IsapJobOutputSetting withFieldMapping(Consumer<Map<String, String>> fieldMappingSetter) {
        if (this.fieldMapping == null) {
            this.fieldMapping = new HashMap<>();
        }
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        IsapJobOutputSetting that = (IsapJobOutputSetting) obj;
    ...
    public String toString() {
        ...
        sb.append("class IsapJobOutputSetting {\n");
