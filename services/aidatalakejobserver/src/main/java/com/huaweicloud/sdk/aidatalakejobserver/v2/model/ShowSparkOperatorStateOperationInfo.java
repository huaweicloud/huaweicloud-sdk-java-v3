 ...
 * **参数解释**：operator操作信息。 
 */
public class ShowSparkOperatorStateOperationInfo {
    ...
    public static final class TypeEnum {
        ...
        /**
         * Enum RESTART_CLUSTER for value: "RESTART_CLUSTER"
         */
        public static final TypeEnum RESTART_CLUSTER = new TypeEnum("RESTART_CLUSTER");

        private static final Map<String, TypeEnum> STATIC_FIELDS = createStaticFields();

        private static Map<String, TypeEnum> createStaticFields() {
            Map<String, TypeEnum> map = new HashMap<>();
            map.put("RESTART_CLUSTER", RESTART_CLUSTER);
    ...
    public ShowSparkOperatorStateOperationInfo withType(TypeEnum type) {
        this.type = type;
        return this;
    }
    ...
    public ShowSparkOperatorStateOperationInfo withEndpointName(String endpointName) {
    ...
    public ShowSparkOperatorStateOperationInfo withRestartStrategy(RestartStrategyEnum restartStrategy) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ShowSparkOperatorStateOperationInfo that = (ShowSparkOperatorStateOperationInfo) obj;
    ...
    public String toString() {
        ...
        sb.append("class ShowSparkOperatorStateOperationInfo {\n");
