...
public class UpdateSignatureRequest {
    ...
    public UpdateSignatureRequest withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public UpdateSignatureRequest withBody(SmsSignatureReq body) {
        this.body = body;
        return this;
    }

    public UpdateSignatureRequest withBody(Consumer<SmsSignatureReq> bodySetter) {
        if (this.body == null) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        UpdateSignatureRequest that = (UpdateSignatureRequest) obj;
