...
public class BssAsyncClient {
     ...
     * Please refer to HUAWEI cloud API Explorer for details.
     *
     * @param request ListCustomerCouponChangeRecordsRequest 请求对象
     * @return CompletableFuture<ListCustomerCouponChangeRecordsResponse>
     */
    public CompletableFuture<ListCustomerCouponChangeRecordsResponse> listCustomerCouponChangeRecordsAsync(
        ListCustomerCouponChangeRecordsRequest request) {
        return hcClient.asyncInvokeHttp(request, BssMeta.listCustomerCouponChangeRecords);
    }
     ...
     *
     * @param request ListCustomerCouponChangeRecordsRequest 请求对象
     * @return AsyncInvoker<ListCustomerCouponChangeRecordsRequest, ListCustomerCouponChangeRecordsResponse>
     */
    public AsyncInvoker<ListCustomerCouponChangeRecordsRequest, ListCustomerCouponChangeRecordsResponse> listCustomerCouponChangeRecordsAsyncInvoker(
        ListCustomerCouponChangeRecordsRequest request) {
        return new AsyncInvoker<>(request, BssMeta.listCustomerCouponChangeRecords, hcClient);
    }
    ...
    public CompletableFuture<ListResourceSpecsResponse> listResourceSpecsAsync(ListResourceSpecsRequest request) {
        return hcClient.asyncInvokeHttp(request, BssMeta.listResourceSpecs);
    }
    ...
    public AsyncInvoker<ListResourceSpecsRequest, ListResourceSpecsResponse> listResourceSpecsAsyncInvoker(
        ...
        return new AsyncInvoker<>(request, BssMeta.listResourceSpecs, hcClient);
    }
     ...
     * @return CompletableFuture<ShowRealNameAuthQrCodeResponse>
     */
    public CompletableFuture<ShowRealNameAuthQrCodeResponse> showRealNameAuthQrCodeAsync(
        ShowRealNameAuthQrCodeRequest request) {
        return hcClient.asyncInvokeHttp(request, BssMeta.showRealNameAuthQrCode);
    }
     ...
     *
     * @param request ShowRealNameAuthQrCodeRequest 请求对象
     * @return AsyncInvoker<ShowRealNameAuthQrCodeRequest, ShowRealNameAuthQrCodeResponse>
     */
    public AsyncInvoker<ShowRealNameAuthQrCodeRequest, ShowRealNameAuthQrCodeResponse> showRealNameAuthQrCodeAsyncInvoker(
        ShowRealNameAuthQrCodeRequest request) {
        return new AsyncInvoker<>(request, BssMeta.showRealNameAuthQrCode, hcClient);
    }
     ...
     * @return CompletableFuture<ShowRealNameAuthStatusResponse>
     */
    public CompletableFuture<ShowRealNameAuthStatusResponse> showRealNameAuthStatusAsync(
        ShowRealNameAuthStatusRequest request) {
        return hcClient.asyncInvokeHttp(request, BssMeta.showRealNameAuthStatus);
    }
     ...
     *
     * @param request ShowRealNameAuthStatusRequest 请求对象
     * @return AsyncInvoker<ShowRealNameAuthStatusRequest, ShowRealNameAuthStatusResponse>
     */
    public AsyncInvoker<ShowRealNameAuthStatusRequest, ShowRealNameAuthStatusResponse> showRealNameAuthStatusAsyncInvoker(
        ShowRealNameAuthStatusRequest request) {
        return new AsyncInvoker<>(request, BssMeta.showRealNameAuthStatus, hcClient);
    }
     ...
     * @return CompletableFuture<UpdatePeriodToOnDemandInstantlyResponse>
     */
    public CompletableFuture<UpdatePeriodToOnDemandInstantlyResponse> updatePeriodToOnDemandInstantlyAsync(
        UpdatePeriodToOnDemandInstantlyRequest request) {
        return hcClient.asyncInvokeHttp(request, BssMeta.updatePeriodToOnDemandInstantly);
    }
     ...
     *
     * @param request UpdatePeriodToOnDemandInstantlyRequest 请求对象
     * @return AsyncInvoker<UpdatePeriodToOnDemandInstantlyRequest, UpdatePeriodToOnDemandInstantlyResponse>
     */
    public AsyncInvoker<UpdatePeriodToOnDemandInstantlyRequest, UpdatePeriodToOnDemandInstantlyResponse> updatePeriodToOnDemandInstantlyAsyncInvoker(
        UpdatePeriodToOnDemandInstantlyRequest request) {
        return new AsyncInvoker<>(request, BssMeta.updatePeriodToOnDemandInstantly, hcClient);
    }
