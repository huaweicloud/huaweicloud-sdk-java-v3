...
import com.huaweicloud.sdk.bss.v2.model.SubCustomerInfoV2;
...
public class ListEnterpriseSubCustomersResponse extends SdkResponse {
    ...
    public ListEnterpriseSubCustomersResponse withSubCustomerInfos(Consumer<List<SubCustomerInfoV2>> subCustomerInfosSetter) {
        if(this.subCustomerInfos == null ){
            this.subCustomerInfos = new ArrayList<>();
        }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ListEnterpriseSubCustomersResponse listEnterpriseSubCustomersResponse = (ListEnterpriseSubCustomersResponse) o;
        return Objects.equals(this.totalCount, listEnterpriseSubCustomersResponse.totalCount) &&
            Objects.equals(this.subCustomerInfos, listEnterpriseSubCustomersResponse.subCustomerInfos);
    }
    @Override
    public int hashCode() {
