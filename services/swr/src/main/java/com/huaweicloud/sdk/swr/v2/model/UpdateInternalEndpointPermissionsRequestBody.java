...
/**
 * UpdateInternalEndpointPermissionsRequestBody
 */
public class UpdateInternalEndpointPermissionsRequestBody {
    ...
    public UpdateInternalEndpointPermissionsRequestBody withPermissions(List<String> permissions) {
        this.permissions = permissions;
        return this;
    }

    public UpdateInternalEndpointPermissionsRequestBody addPermissionsItem(String permissionsItem) {
    ...
    public UpdateInternalEndpointPermissionsRequestBody withPermissions(Consumer<List<String>> permissionsSetter) {
        if (this.permissions == null) {
            this.permissions = new ArrayList<>();
        }
    ...
    public UpdateInternalEndpointPermissionsRequestBody withAction(ActionEnum action) {
        this.action = action;
        return this;
    }
    ...
    public UpdateInternalEndpointPermissionsRequestBody withPermissionType(PermissionTypeEnum permissionType) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        UpdateInternalEndpointPermissionsRequestBody that = (UpdateInternalEndpointPermissionsRequestBody) obj;
        return Objects.equals(this.permissions, that.permissions) && Objects.equals(this.action, that.action)
            && Objects.equals(this.permissionType, that.permissionType);
    }

    @Override
    public int hashCode() {
        return Objects.hash(permissions, action, permissionType);
    }
