...
public class ListSubResourceTagsRequest {
    ...
    public ListSubResourceTagsRequest withResourceType(ResourceTypeEnum resourceType) {
    ...
    public ListSubResourceTagsRequest withResourceId(String resourceId) {
    ...
    public ListSubResourceTagsRequest withSubResourceType(SubResourceTypeEnum subResourceType) {
    ...
    public ListSubResourceTagsRequest withSubResourceId(String subResourceId) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ListSubResourceTagsRequest that = (ListSubResourceTagsRequest) obj;
    ...
    @Override
    public int hashCode() {
        return Objects.hash(resourceType, resourceId, subResourceType, subResourceId);
    }
