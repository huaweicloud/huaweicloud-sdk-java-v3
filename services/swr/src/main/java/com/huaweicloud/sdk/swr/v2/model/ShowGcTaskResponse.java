 ...
 * Response Object
 */
public class ShowGcTaskResponse extends SdkResponse {
    ...
    public ShowGcTaskResponse withId(Integer id) {
        this.id = id;
        return this;
    }
    ...
    public ShowGcTaskResponse withJobName(String jobName) {
    ...
    public ShowGcTaskResponse withJobKind(JobKindEnum jobKind) {
    ...
    public ShowGcTaskResponse withJobParameters(JobParameters jobParameters) {
        this.jobParameters = jobParameters;
        return this;
    }

    public ShowGcTaskResponse withJobParameters(Consumer<JobParameters> jobParametersSetter) {
    ...
    public ShowGcTaskResponse withJobStatus(JobStatusEnum jobStatus) {
    ...
    public ShowGcTaskResponse withCreationTime(String creationTime) {
    ...
    public ShowGcTaskResponse withUpdateTime(String updateTime) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ShowGcTaskResponse that = (ShowGcTaskResponse) obj;
    ...
    public String toString() {
        ...
        sb.append("class ShowGcTaskResponse {\n");
