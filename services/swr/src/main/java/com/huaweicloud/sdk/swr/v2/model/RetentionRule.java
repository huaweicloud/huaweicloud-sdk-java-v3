...
public class RetentionRule {
    ...
    public RetentionRule withPriority(Integer priority) {
    ...
    public RetentionRule withDisabled(Boolean disabled) {
    ...
    public RetentionRule withAction(String action) {
        this.action = action;
        return this;
    }
    ...
    public RetentionRule withTemplate(String template) {
    ...
    public RetentionRule withParams(Map<String, Object> params) {
        this.params = params;
        return this;
    }
    ...
    public RetentionRule withParams(Consumer<Map<String, Object>> paramsSetter) {
        if (this.params == null) {
            this.params = new HashMap<>();
        }
    ...
    public RetentionRule withTagSelectors(List<RetentionSelector> tagSelectors) {
    ...
    public RetentionRule withTagSelectors(Consumer<List<RetentionSelector>> tagSelectorsSetter) {
        if (this.tagSelectors == null) {
            this.tagSelectors = new ArrayList<>();
        }
    ...
    public RetentionRule withScopeSelectors(Map<String, List<RetentionSelector>> scopeSelectors) {
    ...
    public RetentionRule withScopeSelectors(Consumer<Map<String, List<RetentionSelector>>> scopeSelectorsSetter) {
        if (this.scopeSelectors == null) {
            this.scopeSelectors = new HashMap<>();
        }
    ...
    public RetentionRule withRepoScopeMode(String repoScopeMode) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        RetentionRule that = (RetentionRule) obj;
        return Objects.equals(this.priority, that.priority) && Objects.equals(this.disabled, that.disabled)
            ...
            && Objects.equals(this.params, that.params) && Objects.equals(this.tagSelectors, that.tagSelectors)
    ...
    @Override
    public int hashCode() {
        return Objects.hash(priority, disabled, action, template, params, tagSelectors, scopeSelectors, repoScopeMode);
    }
