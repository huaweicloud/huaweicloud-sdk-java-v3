 ...
 * Request Object
 */
public class ShowSubResourceInstancesCountRequest {
    ...
    public ShowSubResourceInstancesCountRequest withResourceType(ResourceTypeEnum resourceType) {
    ...
    public ShowSubResourceInstancesCountRequest withResourceId(String resourceId) {
    ...
    public ShowSubResourceInstancesCountRequest withSubResourceType(SubResourceTypeEnum subResourceType) {
    ...
    public ShowSubResourceInstancesCountRequest withBody(ListResourceInstancesRequestBody body) {
        this.body = body;
        return this;
    }

    public ShowSubResourceInstancesCountRequest withBody(Consumer<ListResourceInstancesRequestBody> bodySetter) {
        if (this.body == null) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ShowSubResourceInstancesCountRequest that = (ShowSubResourceInstancesCountRequest) obj;
        return Objects.equals(this.resourceType, that.resourceType) && Objects.equals(this.resourceId, that.resourceId)
            && Objects.equals(this.subResourceType, that.subResourceType) && Objects.equals(this.body, that.body);
    }

    @Override
    public int hashCode() {
        return Objects.hash(resourceType, resourceId, subResourceType, body);
    }

    @Override
    public String toString() {
        StringBuilder sb = new StringBuilder();
        sb.append("class ShowSubResourceInstancesCountRequest {\n");
