...
/**
 * UpdateSignaturePolicyRequestBody
 */
public class UpdateSignaturePolicyRequestBody {
    ...
    public UpdateSignaturePolicyRequestBody withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public UpdateSignaturePolicyRequestBody withDescription(String description) {
    ...
    public UpdateSignaturePolicyRequestBody withEnabled(Boolean enabled) {
    ...
    public UpdateSignaturePolicyRequestBody withSignatureMethod(SignatureMethodEnum signatureMethod) {
    ...
    public UpdateSignaturePolicyRequestBody withSignatureAlgorithm(SignatureAlgorithmEnum signatureAlgorithm) {
    ...
    public UpdateSignaturePolicyRequestBody withSignatureKey(String signatureKey) {
    ...
    public UpdateSignaturePolicyRequestBody withTrigger(TriggerConfig trigger) {
        this.trigger = trigger;
        return this;
    }

    public UpdateSignaturePolicyRequestBody withTrigger(Consumer<TriggerConfig> triggerSetter) {
    ...
    public UpdateSignaturePolicyRequestBody withScopeRules(List<SignScopeRule> scopeRules) {
        this.scopeRules = scopeRules;
        return this;
    }

    public UpdateSignaturePolicyRequestBody addScopeRulesItem(SignScopeRule scopeRulesItem) {
    ...
    public UpdateSignaturePolicyRequestBody withScopeRules(Consumer<List<SignScopeRule>> scopeRulesSetter) {
        if (this.scopeRules == null) {
            this.scopeRules = new ArrayList<>();
        }
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        UpdateSignaturePolicyRequestBody that = (UpdateSignaturePolicyRequestBody) obj;
