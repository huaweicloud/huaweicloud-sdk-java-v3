...
public class UpdateImmutableRuleBody {
    ...
    public UpdateImmutableRuleBody withPriority(Integer priority) {
    ...
    public UpdateImmutableRuleBody withDisabled(Boolean disabled) {
    ...
    public UpdateImmutableRuleBody withAction(String action) {
        this.action = action;
        return this;
    }
    ...
    public UpdateImmutableRuleBody withTemplate(String template) {
    ...
    public UpdateImmutableRuleBody withTagSelectors(List<RuleSelector> tagSelectors) {
        this.tagSelectors = tagSelectors;
        return this;
    }

    public UpdateImmutableRuleBody addTagSelectorsItem(RuleSelector tagSelectorsItem) {
    ...
    public UpdateImmutableRuleBody withTagSelectors(Consumer<List<RuleSelector>> tagSelectorsSetter) {
        if (this.tagSelectors == null) {
            this.tagSelectors = new ArrayList<>();
        }
    ...
    public UpdateImmutableRuleBody withScopeSelectors(Map<String, List<RuleSelector>> scopeSelectors) {
        this.scopeSelectors = scopeSelectors;
        return this;
    }

    public UpdateImmutableRuleBody putScopeSelectorsItem(String key, List<RuleSelector> scopeSelectorsItem) {
    ...
    public UpdateImmutableRuleBody withScopeSelectors(Consumer<Map<String, List<RuleSelector>>> scopeSelectorsSetter) {
        if (this.scopeSelectors == null) {
            this.scopeSelectors = new HashMap<>();
        }
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        UpdateImmutableRuleBody that = (UpdateImmutableRuleBody) obj;
