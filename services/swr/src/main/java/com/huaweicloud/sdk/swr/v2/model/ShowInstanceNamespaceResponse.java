...
public class ShowInstanceNamespaceResponse extends SdkResponse {
    ...
    public ShowInstanceNamespaceResponse withCveAllowlist(CVEAllowlist cveAllowlist) {
        this.cveAllowlist = cveAllowlist;
        return this;
    }

    public ShowInstanceNamespaceResponse withCveAllowlist(Consumer<CVEAllowlist> cveAllowlistSetter) {
