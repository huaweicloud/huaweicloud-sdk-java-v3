 ...
 * Request Object
 */
public class ListRetentionsRequest  {
    ...
    public ListRetentionsRequest withNamespace(String namespace) {
    ...
    public ListRetentionsRequest withRepository(String repository) {
    ...
    public String toString() {
        ...
        sb.append("class ListRetentionsRequest {\n");
