 ...
 * Request Object
 */
public class DeleteSubResourceTagsRequest {
    ...
    private DeleteResourceTagsRequestBody body;

    public DeleteSubResourceTagsRequest withResourceType(ResourceTypeEnum resourceType) {
    ...
    public DeleteSubResourceTagsRequest withResourceId(String resourceId) {
    ...
    public DeleteSubResourceTagsRequest withSubResourceType(SubResourceTypeEnum subResourceType) {
    ...
    public DeleteSubResourceTagsRequest withSubResourceId(String subResourceId) {
    ...
    public DeleteSubResourceTagsRequest withBody(DeleteResourceTagsRequestBody body) {
        this.body = body;
        return this;
    }

    public DeleteSubResourceTagsRequest withBody(Consumer<DeleteResourceTagsRequestBody> bodySetter) {
        if (this.body == null) {
            this.body = new DeleteResourceTagsRequestBody();
     ...
     * @return body
     */
    public DeleteResourceTagsRequestBody getBody() {
        return body;
    }

    public void setBody(DeleteResourceTagsRequestBody body) {
        this.body = body;
    }
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        DeleteSubResourceTagsRequest that = (DeleteSubResourceTagsRequest) obj;
    ...
    public String toString() {
        ...
        sb.append("class DeleteSubResourceTagsRequest {\n");
