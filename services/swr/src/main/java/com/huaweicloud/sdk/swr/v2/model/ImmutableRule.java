...
public class ImmutableRule {
    ...
    public ImmutableRule withId(Integer id) {
        this.id = id;
        return this;
    }
    ...
    public ImmutableRule withNamespaceId(Integer namespaceId) {
    ...
    public ImmutableRule withNamespaceName(String namespaceName) {
    ...
    public ImmutableRule withPriority(Integer priority) {
    ...
    public ImmutableRule withDisabled(Boolean disabled) {
    ...
    public ImmutableRule withAction(String action) {
        this.action = action;
        return this;
    }
    ...
    public ImmutableRule withTemplate(String template) {
    ...
    public ImmutableRule withTagSelectors(List<RuleSelector> tagSelectors) {
        this.tagSelectors = tagSelectors;
        return this;
    }

    public ImmutableRule addTagSelectorsItem(RuleSelector tagSelectorsItem) {
    ...
    public ImmutableRule withTagSelectors(Consumer<List<RuleSelector>> tagSelectorsSetter) {
        if (this.tagSelectors == null) {
            this.tagSelectors = new ArrayList<>();
        }
    ...
    public ImmutableRule withScopeSelectors(Map<String, List<RuleSelector>> scopeSelectors) {
        this.scopeSelectors = scopeSelectors;
        return this;
    }

    public ImmutableRule putScopeSelectorsItem(String key, List<RuleSelector> scopeSelectorsItem) {
    ...
    public ImmutableRule withScopeSelectors(Consumer<Map<String, List<RuleSelector>>> scopeSelectorsSetter) {
        if (this.scopeSelectors == null) {
            this.scopeSelectors = new HashMap<>();
        }
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ImmutableRule that = (ImmutableRule) obj;
        return Objects.equals(this.id, that.id) && Objects.equals(this.namespaceId, that.namespaceId)
            && Objects.equals(this.namespaceName, that.namespaceName) && Objects.equals(this.priority, that.priority)
            && Objects.equals(this.disabled, that.disabled) && Objects.equals(this.action, that.action)
            && Objects.equals(this.template, that.template) && Objects.equals(this.tagSelectors, that.tagSelectors)
    ...
    public int hashCode() {
        return Objects
            .hash(id, namespaceId, namespaceName, priority, disabled, action, template, tagSelectors, scopeSelectors);
    }
