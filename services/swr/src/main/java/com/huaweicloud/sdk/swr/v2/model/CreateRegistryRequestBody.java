...
public class CreateRegistryRequestBody {
    ...
    public CreateRegistryRequestBody withDescription(String description) {
    ...
    public CreateRegistryRequestBody withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public CreateRegistryRequestBody withProjectId(String projectId) {
    ...
    public CreateRegistryRequestBody withRegionId(String regionId) {
    ...
    public CreateRegistryRequestBody withInstanceId(String instanceId) {
    ...
    public CreateRegistryRequestBody withUrl(String url) {
        this.url = url;
        return this;
    }
    ...
    public CreateRegistryRequestBody withCredential(Credential credential) {
        this.credential = credential;
        return this;
    }

    public CreateRegistryRequestBody withCredential(Consumer<Credential> credentialSetter) {
    ...
    public CreateRegistryRequestBody withDnsConf(DnsConf dnsConf) {
        this.dnsConf = dnsConf;
        return this;
    }

    public CreateRegistryRequestBody withDnsConf(Consumer<DnsConf> dnsConfSetter) {
    ...
    public CreateRegistryRequestBody withInsecure(Boolean insecure) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        CreateRegistryRequestBody that = (CreateRegistryRequestBody) obj;
