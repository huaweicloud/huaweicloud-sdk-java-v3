...
public class JobDetail {
    ...
    public JobDetail withInstanceId(String instanceId) {
    ...
    public JobDetail withResourceId(String resourceId) {
    ...
    public JobDetail withResourceName(String resourceName) {
    ...
    public JobDetail withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public JobDetail withReason(String reason) {
        this.reason = reason;
        return this;
    }
    ...
    public JobDetail withCreatedAt(String createdAt) {
    ...
    public JobDetail withUpdatedAt(String updatedAt) {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, instanceId, resourceId, resourceName, type, status, reason, createdAt, updatedAt);
    }
