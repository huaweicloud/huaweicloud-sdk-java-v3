...
public class PermissionItem {
    ...
    public PermissionItem withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public PermissionItem withPermission(String permission) {
    ...
    public PermissionItem withPermissionType(PermissionTypeEnum permissionType) {
    ...
    public PermissionItem withCreatedAt(String createdAt) {
    ...
    public PermissionItem withProtected(Boolean _protected) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        return Objects.equals(this.id, that.id) && Objects.equals(this.permission, that.permission)
            ...
            && Objects.equals(this.createdAt, that.createdAt) && Objects.equals(this._protected, that._protected);
    }

    @Override
    public int hashCode() {
        return Objects.hash(id, permission, permissionType, createdAt, _protected);
    }
