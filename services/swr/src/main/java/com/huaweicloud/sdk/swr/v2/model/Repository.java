...
public class Repository {
    ...
    public Repository withId(Integer id) {
        this.id = id;
        return this;
    }
    ...
    public Repository withNamespaceName(String namespaceName) {
    ...
    public Repository withNamespaceId(Integer namespaceId) {
    ...
    public Repository withTagCount(Integer tagCount) {
    ...
    public Repository withPullCount(Integer pullCount) {
    ...
    public Repository withArtifactCount(Integer artifactCount) {
    ...
    public Repository withCreatedAt(String createdAt) {
