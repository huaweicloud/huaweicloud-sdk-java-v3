...
public class DeleteInstanceArtifactRequest {
    ...
    public DeleteInstanceArtifactRequest withInstanceId(String instanceId) {
    ...
    public DeleteInstanceArtifactRequest withNamespaceName(String namespaceName) {
    ...
    public DeleteInstanceArtifactRequest withRepositoryName(String repositoryName) {
    ...
    public DeleteInstanceArtifactRequest withReference(String reference) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        DeleteInstanceArtifactRequest that = (DeleteInstanceArtifactRequest) obj;
