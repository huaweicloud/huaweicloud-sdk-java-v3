...
public class RetentionSelector {
    ...
    public RetentionSelector withKind(String kind) {
        this.kind = kind;
        return this;
    }
    ...
    public RetentionSelector withDecoration(String decoration) {
    ...
    public RetentionSelector withPattern(String pattern) {
    ...
    public RetentionSelector withExtras(String extras) {
        this.extras = extras;
        return this;
    }
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        RetentionSelector that = (RetentionSelector) obj;
