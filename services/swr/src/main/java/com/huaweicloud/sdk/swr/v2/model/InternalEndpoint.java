...
public class InternalEndpoint {
    ...
    public InternalEndpoint withVpcepEndpointId(String vpcepEndpointId) {
    ...
    public InternalEndpoint withProjectId(String projectId) {
    ...
    public InternalEndpoint withProjectName(String projectName) {
    ...
    public InternalEndpoint withVpcId(String vpcId) {
        this.vpcId = vpcId;
        return this;
    }
    ...
    public InternalEndpoint withVpcName(String vpcName) {
    ...
    public InternalEndpoint withVpcCidr(String vpcCidr) {
    ...
    public InternalEndpoint withSubnetId(String subnetId) {
    ...
    public InternalEndpoint withSubnetName(String subnetName) {
    ...
    public InternalEndpoint withSubnetCidr(String subnetCidr) {
    ...
    public InternalEndpoint withEndpointIp(String endpointIp) {
    ...
    public InternalEndpoint withDescription(String description) {
    ...
    public InternalEndpoint withStatus(StatusEnum status) {
        this.status = status;
        return this;
    }
    ...
    public InternalEndpoint withStatusText(String statusText) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        InternalEndpoint that = (InternalEndpoint) obj;
    ...
    public String toString() {
        ...
        sb.append("class InternalEndpoint {\n");
