...
public class ShowInstanceResponse extends SdkResponse {
    ...
    public ShowInstanceResponse withSpec(String spec) {
        this.spec = spec;
        return this;
    }
    ...
    public ShowInstanceResponse withVersion(String version) {
    ...
    public ShowInstanceResponse withChargeMode(ChargeModeEnum chargeMode) {
    ...
    public ShowInstanceResponse withAccessAddress(String accessAddress) {
    ...
    public ShowInstanceResponse withUpdatedAt(String updatedAt) {
    ...
    public ShowInstanceResponse withExpiresAt(String expiresAt) {
    ...
    public ShowInstanceResponse withObsBucketName(String obsBucketName) {
    ...
    public ShowInstanceResponse withUserDefObs(Boolean userDefObs) {
    ...
    public ShowInstanceResponse withVpcCidr(String vpcCidr) {
