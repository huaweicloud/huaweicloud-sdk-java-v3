...
public class PolicyResource {
    ...
    public PolicyResource withResourceId(String resourceId) {
    ...
    public PolicyResource withResourceName(String resourceName) {
    ...
    public PolicyResource withResourceProvider(String resourceProvider) {
    ...
    public PolicyResource withResourceType(String resourceType) {
    ...
    public PolicyResource withRegionId(String regionId) {
    ...
    public PolicyResource withDomainId(String domainId) {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(resourceId, resourceName, resourceProvider, resourceType, regionId, domainId);
    }
