 ...
 * 日志接入采集Windows事件日志
 */
public class AccessConfigWindowsLogInfoUpdate {
    ...
    public AccessConfigWindowsLogInfoUpdate withCategorys(List<CategorysEnum> categorys) {
        this.categorys = categorys;
        return this;
    }

    public AccessConfigWindowsLogInfoUpdate addCategorysItem(CategorysEnum categorysItem) {
    ...
    public AccessConfigWindowsLogInfoUpdate withCategorys(Consumer<List<CategorysEnum>> categorysSetter) {
        if (this.categorys == null) {
            this.categorys = new ArrayList<>();
        }
    ...
    public AccessConfigWindowsLogInfoUpdate withTimeOffset(AccessConfigTimeOffsetCreate timeOffset) {
        this.timeOffset = timeOffset;
        return this;
    }

    public AccessConfigWindowsLogInfoUpdate withTimeOffset(Consumer<AccessConfigTimeOffsetCreate> timeOffsetSetter) {
    ...
    public AccessConfigWindowsLogInfoUpdate withEventLevel(List<EventLevelEnum> eventLevel) {
        this.eventLevel = eventLevel;
        return this;
    }

    public AccessConfigWindowsLogInfoUpdate addEventLevelItem(EventLevelEnum eventLevelItem) {
    ...
    public AccessConfigWindowsLogInfoUpdate withEventLevel(Consumer<List<EventLevelEnum>> eventLevelSetter) {
        if (this.eventLevel == null) {
            this.eventLevel = new ArrayList<>();
        }
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        AccessConfigWindowsLogInfoUpdate that = (AccessConfigWindowsLogInfoUpdate) obj;
    ...
    public String toString() {
        ...
        sb.append("class AccessConfigWindowsLogInfoUpdate {\n");
