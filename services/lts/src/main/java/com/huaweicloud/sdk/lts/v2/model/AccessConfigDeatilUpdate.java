...
public class AccessConfigDeatilUpdate {
    ...
    public AccessConfigDeatilUpdate withCombineStdout(Boolean combineStdout) {
    ...
    public AccessConfigDeatilUpdate withSystemFields(List<String> systemFields) {
        this.systemFields = systemFields;
        return this;
    }

    public AccessConfigDeatilUpdate addSystemFieldsItem(String systemFieldsItem) {
    ...
    public AccessConfigDeatilUpdate withSystemFields(Consumer<List<String>> systemFieldsSetter) {
        if (this.systemFields == null) {
            this.systemFields = new ArrayList<>();
        }
    ...
    public AccessConfigDeatilUpdate withCustomKeyValue(Map<String, String> customKeyValue) {
        this.customKeyValue = customKeyValue;
        return this;
    }

    public AccessConfigDeatilUpdate putCustomKeyValueItem(String key, String customKeyValueItem) {
    ...
    public AccessConfigDeatilUpdate withCustomKeyValue(Consumer<Map<String, String>> customKeyValueSetter) {
        if (this.customKeyValue == null) {
            this.customKeyValue = new HashMap<>();
        }
    ...
    public AccessConfigDeatilUpdate withIncludeLabelsLogical(String includeLabelsLogical) {
    ...
    public AccessConfigDeatilUpdate withExcludeLabelsLogical(String excludeLabelsLogical) {
    ...
    public AccessConfigDeatilUpdate withIncludeK8sLabelsLogical(String includeK8sLabelsLogical) {
    ...
    public AccessConfigDeatilUpdate withExcludeK8sLabelsLogical(String excludeK8sLabelsLogical) {
    ...
    public AccessConfigDeatilUpdate withIncludeEnvsLogical(String includeEnvsLogical) {
    ...
    public AccessConfigDeatilUpdate withExcludeEnvsLogical(String excludeEnvsLogical) {
