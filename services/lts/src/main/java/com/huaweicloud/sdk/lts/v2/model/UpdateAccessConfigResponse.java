...
public class UpdateAccessConfigResponse extends SdkResponse {
    ...
    public UpdateAccessConfigResponse withLogSplitSize(Integer logSplitSize) {
    ...
    public UpdateAccessConfigResponse withRecursiveDepth(Integer recursiveDepth) {
    ...
    public UpdateAccessConfigResponse withAccessConfigTypeSource(String accessConfigTypeSource) {
