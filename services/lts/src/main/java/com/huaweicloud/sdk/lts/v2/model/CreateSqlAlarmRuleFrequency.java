...
public class CreateSqlAlarmRuleFrequency {
    ...
    public CreateSqlAlarmRuleFrequency withType(TypeEnum type) {
        this.type = type;
        return this;
    }
    ...
    public CreateSqlAlarmRuleFrequency withCronExpr(String cronExpr) {
    ...
    public CreateSqlAlarmRuleFrequency withHourOfDay(Integer hourOfDay) {
    ...
    public CreateSqlAlarmRuleFrequency withDayOfWeek(Integer dayOfWeek) {
    ...
    public CreateSqlAlarmRuleFrequency withFixedRate(Integer fixedRate) {
    ...
    public CreateSqlAlarmRuleFrequency withFixedRateUnit(FixedRateUnitEnum fixedRateUnit) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        CreateSqlAlarmRuleFrequency that = (CreateSqlAlarmRuleFrequency) obj;
