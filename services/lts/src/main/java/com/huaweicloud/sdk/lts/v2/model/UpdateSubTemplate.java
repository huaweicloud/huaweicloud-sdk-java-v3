 ...
 * UpdateSubTemplate
 */
public class UpdateSubTemplate {
    ...
    public static final class SubTypeEnum {
         ...
         */
        public static final SubTypeEnum VOICE = new SubTypeEnum("voice");
    ...
    public UpdateSubTemplate withSubType(SubTypeEnum subType) {
    ...
    public UpdateSubTemplate withContent(String content) {
    ...
    public UpdateSubTemplate withTopic(String topic) {
        this.topic = topic;
        return this;
    }
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        UpdateSubTemplate that = (UpdateSubTemplate) obj;
    ...
    public String toString() {
        ...
        sb.append("class UpdateSubTemplate {\n");
