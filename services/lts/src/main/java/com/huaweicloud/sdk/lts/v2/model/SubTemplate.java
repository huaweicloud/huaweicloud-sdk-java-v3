...
public class SubTemplate {
     ...
     * 目前两种告警类型有共同变量如下：告警级别：${event_severity};发生时间：${starts_at};告警源：$event.metadata.resource_provider;资源类型：$event.metadata.resource_type;资源标识：${resources};统计类型：关键词统计;表达式：$event.annotations.condition_expression;当前值:
     * $event.annotations.current_value;统计周期：$event.annotations.frequency;
    ...
    public boolean equals(java.lang.Object o) {
        ...
        SubTemplate subTemplate = (SubTemplate) o;
        return Objects.equals(this.subType, subTemplate.subType) && Objects.equals(this.content, subTemplate.content);
    }
