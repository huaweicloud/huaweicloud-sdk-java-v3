...
public class AccessConfigInfo {
    ...
    public AccessConfigInfo withAccessConfigDetail(AccessConfigDeatilCreate accessConfigDetail) {
        this.accessConfigDetail = accessConfigDetail;
        return this;
    }

    public AccessConfigInfo withAccessConfigDetail(Consumer<AccessConfigDeatilCreate> accessConfigDetailSetter) {
    ...
    public AccessConfigInfo withLogSplit(Boolean logSplit) {
    ...
    public AccessConfigInfo withBinaryCollect(Boolean binaryCollect) {
    ...
    public AccessConfigInfo withClusterId(String clusterId) {
    ...
    public AccessConfigInfo withEncodingFormat(String encodingFormat) {
    ...
    public AccessConfigInfo withIncrementalCollect(Boolean incrementalCollect) {
    ...
    public AccessConfigInfo withProcessorType(String processorType) {
    ...
    public AccessConfigInfo withDemoLog(String demoLog) {
    ...
    public AccessConfigInfo withDemoFields(List<DemoFieldAccess> demoFields) {
        this.demoFields = demoFields;
        return this;
    }

    public AccessConfigInfo addDemoFieldsItem(DemoFieldAccess demoFieldsItem) {
    ...
    public AccessConfigInfo withDemoFields(Consumer<List<DemoFieldAccess>> demoFieldsSetter) {
        if (this.demoFields == null) {
            this.demoFields = new ArrayList<>();
        }
    ...
    public AccessConfigInfo withProcessors(List<Processor> processors) {
        this.processors = processors;
        return this;
    }

    public AccessConfigInfo addProcessorsItem(Processor processorsItem) {
    ...
    public AccessConfigInfo withProcessors(Consumer<List<Processor>> processorsSetter) {
        if (this.processors == null) {
            this.processors = new ArrayList<>();
        }
    ...
    public AccessConfigInfo withLogSplitSize(Integer logSplitSize) {
    ...
    public AccessConfigInfo withRecursiveDepth(Integer recursiveDepth) {
    ...
    public AccessConfigInfo withAccessConfigTypeSource(String accessConfigTypeSource) {
    ...
    public AccessConfigInfo withApplicationId(String applicationId) {
    ...
    public AccessConfigInfo withEnvironmentId(String environmentId) {
    ...
    public AccessConfigInfo withComponentId(List<String> componentId) {
        this.componentId = componentId;
        return this;
    }

    public AccessConfigInfo addComponentIdItem(String componentIdItem) {
    ...
    public AccessConfigInfo withComponentId(Consumer<List<String>> componentIdSetter) {
        if (this.componentId == null) {
            this.componentId = new ArrayList<>();
        }
