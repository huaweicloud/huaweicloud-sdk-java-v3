...
public class LtsRegion {
    ...
    public static final Region CN_SOUTHWEST_2 = new Region("cn-southwest-2", "https://lts.cn-southwest-2.myhuaweicloud.com");
    public static final Region AF_SOUTH_1 = new Region("af-south-1", "https://lts.af-south-1.myhuaweicloud.com");
    public static final Region AP_SOUTHEAST_1 = new Region("ap-southeast-1", "https://lts.ap-southeast-1.myhuaweicloud.com");
    public static final Region AP_SOUTHEAST_2 = new Region("ap-southeast-2", "https://lts.ap-southeast-2.myhuaweicloud.com");
    public static final Region AP_SOUTHEAST_3 = new Region("ap-southeast-3", "https://lts.ap-southeast-3.myhuaweicloud.com");
