...
public class UpdateHostGroupResponse extends SdkResponse {
    ...
    public UpdateHostGroupResponse withHostGroupName(String hostGroupName) {
    ...
    public UpdateHostGroupResponse withHostGroupType(HostGroupTypeEnum hostGroupType) {
    ...
    public UpdateHostGroupResponse withHostIdList(List<String> hostIdList) {
        this.hostIdList = hostIdList;
        return this;
    }

    public UpdateHostGroupResponse addHostIdListItem(String hostIdListItem) {
    ...
    public UpdateHostGroupResponse withHostIdList(Consumer<List<String>> hostIdListSetter) {
        if (this.hostIdList == null) {
            this.hostIdList = new ArrayList<>();
        }
    ...
    public UpdateHostGroupResponse withHostGroupTag(List<HostGroupTag> hostGroupTag) {
        this.hostGroupTag = hostGroupTag;
        return this;
    }

    public UpdateHostGroupResponse addHostGroupTagItem(HostGroupTag hostGroupTagItem) {
    ...
    public UpdateHostGroupResponse withHostGroupTag(Consumer<List<HostGroupTag>> hostGroupTagSetter) {
        if (this.hostGroupTag == null) {
            this.hostGroupTag = new ArrayList<>();
        }
    ...
    public UpdateHostGroupResponse withCreateTime(Long createTime) {
    ...
    public UpdateHostGroupResponse withUpdateTime(Long updateTime) {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        UpdateHostGroupResponse updateHostGroupResponse = (UpdateHostGroupResponse) o;
        return Objects.equals(this.hostGroupId, updateHostGroupResponse.hostGroupId)
            && Objects.equals(this.hostGroupName, updateHostGroupResponse.hostGroupName)
            && Objects.equals(this.hostGroupType, updateHostGroupResponse.hostGroupType)
            && Objects.equals(this.hostIdList, updateHostGroupResponse.hostIdList)
            && Objects.equals(this.hostGroupTag, updateHostGroupResponse.hostGroupTag)
            && Objects.equals(this.createTime, updateHostGroupResponse.createTime)
            && Objects.equals(this.updateTime, updateHostGroupResponse.updateTime);
    }
