...
public class AccessConfigFormatMutilCreate {
    ...
    public AccessConfigFormatMutilCreate withMode(ModeEnum mode) {
        this.mode = mode;
        return this;
    }
    ...
    public AccessConfigFormatMutilCreate withValue(String value) {
        this.value = value;
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append("class AccessConfigFormatMutilCreate {\n");
