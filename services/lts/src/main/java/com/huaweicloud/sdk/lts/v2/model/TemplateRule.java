...
public class TemplateRule {
     ...
     * 手动正则为json字符串，包含keyObject对象和regex_rules对象，keyObject内为键值对，键为demo_fields数组中元素的index，值为field_name，regex_rules对象为正则表达式字符串，整体例子为{\\\"keyObject\\\":{\\\"1\\\":\\\"date\\\",\\\"2\\\":\\\"num\\\"},\\\"regex_rules\\\":\\\"^(?<date>[^/]+)(?:[^
     * ]* ){8}(?<num>\\\\\\\\d+)\\\"}；
    ...
    public boolean equals(java.lang.Object o) {
        ...
        TemplateRule templateRule = (TemplateRule) o;
        return Objects.equals(this.type, templateRule.type) && Objects.equals(this.param, templateRule.param);
    }
