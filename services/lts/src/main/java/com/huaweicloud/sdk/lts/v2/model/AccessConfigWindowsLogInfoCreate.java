...
public class AccessConfigWindowsLogInfoCreate {
    ...
    public AccessConfigWindowsLogInfoCreate withCategorys(List<CategorysEnum> categorys) {
        this.categorys = categorys;
        return this;
    }

    public AccessConfigWindowsLogInfoCreate addCategorysItem(CategorysEnum categorysItem) {
    ...
    public AccessConfigWindowsLogInfoCreate withCategorys(Consumer<List<CategorysEnum>> categorysSetter) {
        if (this.categorys == null) {
            this.categorys = new ArrayList<>();
        }
    ...
    public AccessConfigWindowsLogInfoCreate withEventLevel(List<EventLevelEnum> eventLevel) {
        this.eventLevel = eventLevel;
        return this;
    }

    public AccessConfigWindowsLogInfoCreate addEventLevelItem(EventLevelEnum eventLevelItem) {
    ...
    public AccessConfigWindowsLogInfoCreate withEventLevel(Consumer<List<EventLevelEnum>> eventLevelSetter) {
        if (this.eventLevel == null) {
            this.eventLevel = new ArrayList<>();
        }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        AccessConfigWindowsLogInfoCreate accessConfigWindowsLogInfoCreate = (AccessConfigWindowsLogInfoCreate) o;
        return Objects.equals(this.categorys, accessConfigWindowsLogInfoCreate.categorys)
            && Objects.equals(this.timeOffset, accessConfigWindowsLogInfoCreate.timeOffset)
            && Objects.equals(this.eventLevel, accessConfigWindowsLogInfoCreate.eventLevel);
    }
