...
public class KeywordsResBody {
    ...
    public KeywordsResBody withLogStreamId(String logStreamId) {
    ...
    public KeywordsResBody withLogStreamName(String logStreamName) {
    ...
    public KeywordsResBody withLogGroupId(String logGroupId) {
    ...
    public KeywordsResBody withLogGroupName(String logGroupName) {
    ...
    public KeywordsResBody withKeywords(String keywords) {
    ...
    public KeywordsResBody withCondition(ConditionEnum condition) {
    ...
    public KeywordsResBody withNumber(Integer number) {
        this.number = number;
        return this;
    }
    ...
    public KeywordsResBody withSearchTimeRange(Integer searchTimeRange) {
    ...
    public KeywordsResBody withSearchTimeRangeUnit(String searchTimeRangeUnit) {
    ...
    public KeywordsResBody withCustomDate(CustomDate customDate) {
        this.customDate = customDate;
        return this;
    }

    public KeywordsResBody withCustomDate(Consumer<CustomDate> customDateSetter) {
    ...
    public KeywordsResBody withIsTimeRangeRelative(Boolean isTimeRangeRelative) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        KeywordsResBody that = (KeywordsResBody) obj;
    ...
    public String toString() {
        ...
        sb.append("class KeywordsResBody {\n");
