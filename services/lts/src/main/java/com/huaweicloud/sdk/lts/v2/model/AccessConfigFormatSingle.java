...
public class AccessConfigFormatSingle {
    ...
    public AccessConfigFormatSingle withMode(ModeEnum mode) {
        this.mode = mode;
        return this;
    }
    ...
    public AccessConfigFormatSingle withValue(String value) {
        this.value = value;
        return this;
    }

    /** 日志时间。 当mode为”system”，则填入当前时间戳。
     * 当mode为\"wildcard\"，则时间通配符：用日志打印时间来标识一条日志数据，通过时间通配符来匹配日志，每条日志的行首显示日志的打印时间；如果日志中的时间格式为：2019-01-01
    ...
    public boolean equals(java.lang.Object o) {
        ...
        AccessConfigFormatSingle accessConfigFormatSingle = (AccessConfigFormatSingle) o;
        return Objects.equals(this.mode, accessConfigFormatSingle.mode)
            && Objects.equals(this.value, accessConfigFormatSingle.value);
    }
