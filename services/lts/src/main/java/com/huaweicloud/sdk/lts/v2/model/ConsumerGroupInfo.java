...
public class ConsumerGroupInfo {
    ...
    public ConsumerGroupInfo withConsumerGroupName(String consumerGroupName) {
    ...
    public ConsumerGroupInfo withCreateTime(Long createTime) {
    ...
    public ConsumerGroupInfo withLogGroupId(String logGroupId) {
    ...
    public ConsumerGroupInfo withLogStreamId(String logStreamId) {
    ...
    public ConsumerGroupInfo withProjectId(String projectId) {
    ...
    public ConsumerGroupInfo withTimeout(Integer timeout) {
