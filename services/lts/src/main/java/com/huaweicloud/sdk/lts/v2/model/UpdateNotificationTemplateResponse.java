...
public class UpdateNotificationTemplateResponse extends SdkResponse {
    ...
    public UpdateNotificationTemplateResponse withLocale(LocaleEnum locale) {
        this.locale = locale;
        return this;
    }
    ...
    public UpdateNotificationTemplateResponse withTemplates(List<SubTemplate> templates) {
        this.templates = templates;
        return this;
    }

    public UpdateNotificationTemplateResponse addTemplatesItem(SubTemplate templatesItem) {
    ...
    public UpdateNotificationTemplateResponse withTemplates(Consumer<List<SubTemplate>> templatesSetter) {
        if (this.templates == null) {
            this.templates = new ArrayList<>();
        }
