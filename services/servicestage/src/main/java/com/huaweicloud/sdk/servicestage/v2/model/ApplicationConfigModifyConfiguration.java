...
import com.huaweicloud.sdk.servicestage.v2.model.ApplicationConfigModifyConfigurationEnv;
...
public class ApplicationConfigModifyConfiguration  {
    ...
    public ApplicationConfigModifyConfiguration withEnv(Consumer<List<ApplicationConfigModifyConfigurationEnv>> envSetter) {
        if(this.env == null) {
            this.env = new ArrayList<>();
        }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ApplicationConfigModifyConfiguration applicationConfigModifyConfiguration = (ApplicationConfigModifyConfiguration) o;
