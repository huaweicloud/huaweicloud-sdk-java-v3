...
public class ListTagsRequest {
    ...
    public ListTagsRequest withXRepoAuth(String xRepoAuth) {
    ...
    public ListTagsRequest withNamespace(String namespace) {
    ...
    public ListTagsRequest withProject(String project) {
