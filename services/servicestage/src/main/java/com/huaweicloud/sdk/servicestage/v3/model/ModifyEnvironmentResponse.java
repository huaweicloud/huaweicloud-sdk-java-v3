 ...
 * Response Object
 */
public class ModifyEnvironmentResponse extends SdkResponse {
    ...
    public ModifyEnvironmentResponse withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public ModifyEnvironmentResponse withProjectId(String projectId) {
    ...
    public ModifyEnvironmentResponse withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public ModifyEnvironmentResponse withDescription(String description) {
    ...
    public ModifyEnvironmentResponse withEnterpriseProjectId(String enterpriseProjectId) {
    ...
    public ModifyEnvironmentResponse withVpcId(String vpcId) {
        this.vpcId = vpcId;
        return this;
    }
    ...
    public ModifyEnvironmentResponse withCreator(String creator) {
    ...
    public ModifyEnvironmentResponse withCreateTime(Long createTime) {
    ...
    public ModifyEnvironmentResponse withUpdateTime(Long updateTime) {
    ...
    public ModifyEnvironmentResponse withDeployMode(DeployModeEnum deployMode) {
    ...
    public ModifyEnvironmentResponse withResources(List<Resource> resources) {
        this.resources = resources;
        return this;
    }

    public ModifyEnvironmentResponse addResourcesItem(Resource resourcesItem) {
    ...
    public ModifyEnvironmentResponse withResources(Consumer<List<Resource>> resourcesSetter) {
        if (this.resources == null) {
            this.resources = new ArrayList<>();
        }
    ...
    public ModifyEnvironmentResponse withLabels(List<EnvironmentViewLabels> labels) {
        this.labels = labels;
        return this;
    }

    public ModifyEnvironmentResponse addLabelsItem(EnvironmentViewLabels labelsItem) {
        if (this.labels == null) {
    ...
    public ModifyEnvironmentResponse withLabels(Consumer<List<EnvironmentViewLabels>> labelsSetter) {
        if (this.labels == null) {
            this.labels = new ArrayList<>();
        }
    ...
    public String toString() {
        ...
        sb.append("class ModifyEnvironmentResponse {\n");
