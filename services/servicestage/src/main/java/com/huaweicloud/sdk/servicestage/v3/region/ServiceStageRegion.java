package com.huaweicloud.sdk.servicestage.v3.region;
...
public class ServiceStageRegion {
    ...
    public static final Region CN_NORTH_12 =
        new Region("cn-north-12", "https://servicestage.cn-north-12.myhuaweicloud.com");

    public static final Region CN_SOUTH_4 =
        new Region("cn-south-4", "https://servicestage.cn-south-4.myhuaweicloud.com");

    public static final Region CN_EAST_4 = new Region("cn-east-4", "https://servicestage.cn-east-4.myhuaweicloud.com");

    public static final Region CN_NORTH_9 =
        new Region("cn-north-9", "https://servicestage.cn-north-9.myhuaweicloud.com");

    public static final Region ME_EAST_1 = new Region("me-east-1", "https://servicestage.me-east-1.myhuaweicloud.com");
