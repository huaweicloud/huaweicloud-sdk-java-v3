 ...
 * Response Object
 */
public class ShowApplicationDetailResponse extends SdkResponse {

    @JsonInclude(JsonInclude.Include.NON_NULL)
    @JsonProperty(value = "component_count")

    @JacksonXmlProperty(localName = "component_count")
    ...
    public ShowApplicationDetailResponse withComponentCount(Integer componentCount) {
