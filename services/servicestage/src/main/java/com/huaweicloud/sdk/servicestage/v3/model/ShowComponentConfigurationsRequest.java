 ...
 * Request Object
 */
public class ShowComponentConfigurationsRequest {
    ...
    public ShowComponentConfigurationsRequest withComponentId(String componentId) {
    ...
    public ShowComponentConfigurationsRequest withApplicationId(String applicationId) {
    ...
    public ShowComponentConfigurationsRequest withLimit(Integer limit) {
        this.limit = limit;
        return this;
    }
    ...
    public ShowComponentConfigurationsRequest withOffset(Integer offset) {
        this.offset = offset;
        return this;
    }
    ...
    public ShowComponentConfigurationsRequest withOrderBy(String orderBy) {
    ...
    public ShowComponentConfigurationsRequest withOrder(OrderEnum order) {
        this.order = order;
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append("class ShowComponentConfigurationsRequest {\n");
