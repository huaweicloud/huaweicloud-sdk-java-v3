...
public class EndpointResp {
    ...
    public EndpointResp withServiceType(ServiceTypeEnum serviceType) {
    ...
    public EndpointResp withStatus(StatusEnum status) {
        this.status = status;
        return this;
    }
    ...
    public EndpointResp withActiveStatus(List<String> activeStatus) {
        this.activeStatus = activeStatus;
        return this;
    }

    public EndpointResp addActiveStatusItem(String activeStatusItem) {
    ...
    public EndpointResp withActiveStatus(Consumer<List<String>> activeStatusSetter) {
        if (this.activeStatus == null) {
            this.activeStatus = new ArrayList<>();
        }
    ...
    public EndpointResp withEndpointServiceName(String endpointServiceName) {
    ...
    public EndpointResp withMarkerId(Integer markerId) {
    ...
    public EndpointResp withEndpointServiceId(String endpointServiceId) {
    ...
    public EndpointResp withEnableDns(Boolean enableDns) {
    ...
    public EndpointResp withDnsNames(List<String> dnsNames) {
        this.dnsNames = dnsNames;
        return this;
    }

    public EndpointResp addDnsNamesItem(String dnsNamesItem) {
    ...
    public EndpointResp withDnsNames(Consumer<List<String>> dnsNamesSetter) {
        if (this.dnsNames == null) {
            this.dnsNames = new ArrayList<>();
        }
    ...
    public EndpointResp withProjectId(String projectId) {
    ...
    public EndpointResp withTags(List<TagList> tags) {
        this.tags = tags;
        return this;
    }

    public EndpointResp addTagsItem(TagList tagsItem) {
        if (this.tags == null) {
    ...
    public EndpointResp withTags(Consumer<List<TagList>> tagsSetter) {
        if (this.tags == null) {
            this.tags = new ArrayList<>();
        }
    ...
    public EndpointResp addWhitelistItem(String whitelistItem) {
    ...
    public EndpointResp withWhitelist(Consumer<List<String>> whitelistSetter) {
        if (this.whitelist == null) {
            this.whitelist = new ArrayList<>();
        }
    ...
    public EndpointResp withEnableWhitelist(Boolean enableWhitelist) {
    ...
    public EndpointResp withRoutetables(List<String> routetables) {
        this.routetables = routetables;
        return this;
    }

    public EndpointResp addRoutetablesItem(String routetablesItem) {
    ...
    public EndpointResp withRoutetables(Consumer<List<String>> routetablesSetter) {
        if (this.routetables == null) {
            this.routetables = new ArrayList<>();
        }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        return Objects.equals(this.id, endpointResp.id) && Objects.equals(this.serviceType, endpointResp.serviceType)
            && Objects.equals(this.status, endpointResp.status)
            && Objects.equals(this.activeStatus, endpointResp.activeStatus)
            && Objects.equals(this.endpointServiceName, endpointResp.endpointServiceName)
