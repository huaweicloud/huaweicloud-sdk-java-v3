...
public class DeleteEndpointPolicyResponse extends SdkResponse {
    ...
    public DeleteEndpointPolicyResponse withServiceType(ServiceTypeEnum serviceType) {
    ...
    public DeleteEndpointPolicyResponse withStatus(StatusEnum status) {
        this.status = status;
        return this;
    }
    ...
    public DeleteEndpointPolicyResponse withEnableDns(Boolean enableDns) {
    ...
    public DeleteEndpointPolicyResponse withDnsNames(List<String> dnsNames) {
        this.dnsNames = dnsNames;
        return this;
    }

    public DeleteEndpointPolicyResponse addDnsNamesItem(String dnsNamesItem) {
    ...
    public DeleteEndpointPolicyResponse withDnsNames(Consumer<List<String>> dnsNamesSetter) {
        if (this.dnsNames == null) {
            this.dnsNames = new ArrayList<>();
        }
    ...
    public DeleteEndpointPolicyResponse withSubnetId(String subnetId) {
    ...
    public DeleteEndpointPolicyResponse withCreatedAt(String createdAt) {
    ...
    public DeleteEndpointPolicyResponse withUpdatedAt(String updatedAt) {
