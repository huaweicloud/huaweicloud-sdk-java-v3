...
public class EndpointServiceS {
    ...
    /** 终端节点服务类型。 ● gataway：由运维人员配置。用 户无需创建，可直接使用。 ● interface：包括运维人员配置的 云服务和用户自己创建的私有服 务。其中，运维人员配置的云服 务无需创建，用户可直接使用。
     * 您可以通过创建终端节点创建访问 Gateway和Interface类型终端节点 服务的终端节点。 */
    ...
    public EndpointServiceS withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public EndpointServiceS withOwner(String owner) {
        this.owner = owner;
        return this;
    }
    ...
    public EndpointServiceS withServiceName(String serviceName) {
    ...
    public EndpointServiceS withServiceType(ServiceTypeEnum serviceType) {
    ...
    public EndpointServiceS withCreatedAt(OffsetDateTime createdAt) {
    ...
    public EndpointServiceS withIsCharge(Boolean isCharge) {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        EndpointServiceS endpointServiceS = (EndpointServiceS) o;
        return Objects.equals(this.id, endpointServiceS.id) && Objects.equals(this.owner, endpointServiceS.owner)
            && Objects.equals(this.serviceName, endpointServiceS.serviceName)
            && Objects.equals(this.serviceType, endpointServiceS.serviceType)
            && Objects.equals(this.createdAt, endpointServiceS.createdAt)
            && Objects.equals(this.isCharge, endpointServiceS.isCharge);
    }
    ...
    public String toString() {
        ...
        sb.append("class EndpointServiceS {\n");
