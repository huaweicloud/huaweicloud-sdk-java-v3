...
public class BatchAddEndpointServicePermissionsRequestBody {
    ...
    public BatchAddEndpointServicePermissionsRequestBody withPermissions(List<EpsAddPermissionRequest> permissions) {
        this.permissions = permissions;
        return this;
    }

    public BatchAddEndpointServicePermissionsRequestBody addPermissionsItem(EpsAddPermissionRequest permissionsItem) {
    ...
    public BatchAddEndpointServicePermissionsRequestBody withPermissions(
        Consumer<List<EpsAddPermissionRequest>> permissionsSetter) {
        if (this.permissions == null) {
            this.permissions = new ArrayList<>();
        }
    ...
    public BatchAddEndpointServicePermissionsRequestBody withPermissionType(PermissionTypeEnum permissionType) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        BatchAddEndpointServicePermissionsRequestBody that = (BatchAddEndpointServicePermissionsRequestBody) obj;
