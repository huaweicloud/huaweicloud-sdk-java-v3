...
public class VpcepRegion {
    ...
    public static final Region AP_SOUTHEAST_5 =
        new Region("ap-southeast-5", "https://vpcep.ap-southeast-5.myhuaweicloud.com");

    public static final Region CN_NORTH_12 = new Region("cn-north-12", "https://vpcep.cn-north-12.myhuaweicloud.com");

    public static final Region CN_SOUTHWEST_3 =
        new Region("cn-southwest-3", "https://vpcep.cn-southwest-3.myhuaweicloud.com");
