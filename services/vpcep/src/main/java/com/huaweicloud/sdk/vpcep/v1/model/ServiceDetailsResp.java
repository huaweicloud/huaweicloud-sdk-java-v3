...
/** ServiceDetailsResp */
public class ServiceDetailsResp {
    ...
    public ServiceDetailsResp withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public ServiceDetailsResp withPortId(String portId) {
        this.portId = portId;
        return this;
    }
    ...
    public ServiceDetailsResp withVipPortId(String vipPortId) {
    ...
    public ServiceDetailsResp withServiceName(String serviceName) {
    ...
    public ServiceDetailsResp withServiceType(String serviceType) {
    ...
    public ServiceDetailsResp withVpcId(String vpcId) {
        this.vpcId = vpcId;
        return this;
    }
    ...
    public ServiceDetailsResp withApprovalEnabled(Boolean approvalEnabled) {
    ...
    public ServiceDetailsResp withStatus(StatusEnum status) {
        this.status = status;
        return this;
    }
    ...
    public ServiceDetailsResp withServerType(ServerTypeEnum serverType) {
    ...
    public ServiceDetailsResp withCreatedAt(OffsetDateTime createdAt) {
    ...
    public ServiceDetailsResp withUpdatedAt(OffsetDateTime updatedAt) {
    ...
    public ServiceDetailsResp withProjectId(String projectId) {
    ...
    public ServiceDetailsResp withCidrType(CidrTypeEnum cidrType) {
    ...
    public ServiceDetailsResp withPorts(List<PortList> ports) {
        this.ports = ports;
        return this;
    }

    public ServiceDetailsResp addPortsItem(PortList portsItem) {
        if (this.ports == null) {
    ...
    public ServiceDetailsResp withPorts(Consumer<List<PortList>> portsSetter) {
        if (this.ports == null) {
            this.ports = new ArrayList<>();
        }
    ...
    public ServiceDetailsResp withTcpProxy(TcpProxyEnum tcpProxy) {
    ...
    public ServiceDetailsResp withTags(List<TagList> tags) {
        this.tags = tags;
        return this;
    }

    public ServiceDetailsResp addTagsItem(TagList tagsItem) {
        if (this.tags == null) {
    ...
    public ServiceDetailsResp withTags(Consumer<List<TagList>> tagsSetter) {
        if (this.tags == null) {
            this.tags = new ArrayList<>();
        }
    ...
    public ServiceDetailsResp withError(List<QueryError> error) {
        this.error = error;
        return this;
    }

    public ServiceDetailsResp addErrorItem(QueryError errorItem) {
        if (this.error == null) {
    ...
    public ServiceDetailsResp withError(Consumer<List<QueryError>> errorSetter) {
        if (this.error == null) {
            this.error = new ArrayList<>();
        }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ServiceDetailsResp serviceDetailsResp = (ServiceDetailsResp) o;
        return Objects.equals(this.id, serviceDetailsResp.id) && Objects.equals(this.portId, serviceDetailsResp.portId)
            && Objects.equals(this.vipPortId, serviceDetailsResp.vipPortId)
            && Objects.equals(this.serviceName, serviceDetailsResp.serviceName)
            && Objects.equals(this.serviceType, serviceDetailsResp.serviceType)
            && Objects.equals(this.vpcId, serviceDetailsResp.vpcId)
            && Objects.equals(this.approvalEnabled, serviceDetailsResp.approvalEnabled)
            && Objects.equals(this.status, serviceDetailsResp.status)
            && Objects.equals(this.serverType, serviceDetailsResp.serverType)
            && Objects.equals(this.createdAt, serviceDetailsResp.createdAt)
            && Objects.equals(this.updatedAt, serviceDetailsResp.updatedAt)
            && Objects.equals(this.projectId, serviceDetailsResp.projectId)
            && Objects.equals(this.cidrType, serviceDetailsResp.cidrType)
            && Objects.equals(this.ports, serviceDetailsResp.ports)
            && Objects.equals(this.tcpProxy, serviceDetailsResp.tcpProxy)
            && Objects.equals(this.tags, serviceDetailsResp.tags)
            && Objects.equals(this.error, serviceDetailsResp.error);
    }
    ...
    public String toString() {
        ...
        sb.append("class ServiceDetailsResp {\n");
