...
public class ShowFileInfoRequest {
    ...
    public ShowFileInfoRequest withBody(Consumer<FilePath> bodySetter) {
        if (this.body == null) {
            this.body = new FilePath();
     ...
     * @return body
     */
    public FilePath getBody() {
        return body;
    }

    public void setBody(FilePath body) {
        this.body = body;
    }
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ShowFileInfoRequest that = (ShowFileInfoRequest) obj;
