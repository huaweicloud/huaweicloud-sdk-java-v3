package com.huaweicloud.sdk.dlf.v1.region;
...
public class DlfRegion {
    ...
    public static final Region AP_SOUTHEAST_1 =
        new Region("ap-southeast-1", "https://dayu-dlf.ap-southeast-1.myhuaweicloud.com");
    ...
    private static final IRegionProvider PROVIDER = RegionProviderChain.getDefaultRegionProviderChain("DLF");
    ...
    public static Region valueOf(String regionId) {
        ...
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "region id '%s' is not in the following supported regions of service DLF: [%s]",
            regionId,
