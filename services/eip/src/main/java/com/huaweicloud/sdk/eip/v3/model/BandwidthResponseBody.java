...
public class BandwidthResponseBody {
    ...
    public BandwidthResponseBody withAdminState(String adminState) {
    ...
    public BandwidthResponseBody withIngressSize(Integer ingressSize) {
    ...
    public BandwidthResponseBody withRuleQuota(Integer ruleQuota) {
    ...
    public BandwidthResponseBody withRatio95peakPlus(Integer ratio95peakPlus) {
    ...
    public BandwidthResponseBody withEnableBandwidthRules(Boolean enableBandwidthRules) {
    ...
    public BandwidthResponseBody withBandwidthRules(List<BandWidthRules> bandwidthRules) {
        this.bandwidthRules = bandwidthRules;
        return this;
    }

    public BandwidthResponseBody addBandwidthRulesItem(BandWidthRules bandwidthRulesItem) {
    ...
    public BandwidthResponseBody withBandwidthRules(Consumer<List<BandWidthRules>> bandwidthRulesSetter) {
        if (this.bandwidthRules == null) {
            this.bandwidthRules = new ArrayList<>();
        }
    ...
    public BandwidthResponseBody withPublicBorderGroup(String publicBorderGroup) {
    ...
    public BandwidthResponseBody withBandwidthType(String bandwidthType) {
    ...
    public BandwidthResponseBody withBillinginfo(String billinginfo) {
    ...
    public BandwidthResponseBody withId(UUID id) {
        this.id = id;
        return this;
    }
    ...
    public BandwidthResponseBody withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public BandwidthResponseBody withPublicipInfo(List<PublicipInfoResponseBody> publicipInfo) {
        this.publicipInfo = publicipInfo;
        return this;
    }

    public BandwidthResponseBody addPublicipInfoItem(PublicipInfoResponseBody publicipInfoItem) {
    ...
    public BandwidthResponseBody withPublicipInfo(Consumer<List<PublicipInfoResponseBody>> publicipInfoSetter) {
        if (this.publicipInfo == null) {
            this.publicipInfo = new ArrayList<>();
        }
    ...
    public BandwidthResponseBody withType(TypeEnum type) {
        this.type = type;
        return this;
    }
    ...
    public BandwidthResponseBody withSize(Integer size) {
        this.size = size;
        return this;
    }
    ...
    public BandwidthResponseBody withProjectId(UUID projectId) {
    ...
    public BandwidthResponseBody withTags(List<String> tags) {
        this.tags = tags;
        return this;
    }

    public BandwidthResponseBody addTagsItem(String tagsItem) {
        if (this.tags == null) {
    ...
    public BandwidthResponseBody withTags(Consumer<List<String>> tagsSetter) {
        if (this.tags == null) {
            this.tags = new ArrayList<>();
        }
    ...
    public BandwidthResponseBody withCreatedAt(OffsetDateTime createdAt) {
    ...
    public BandwidthResponseBody withUpdatedAt(OffsetDateTime updatedAt) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        BandwidthResponseBody that = (BandwidthResponseBody) obj;
