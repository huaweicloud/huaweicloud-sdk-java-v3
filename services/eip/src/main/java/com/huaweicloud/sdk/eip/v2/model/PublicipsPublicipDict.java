 ...
 * 创建弹性公网IP的IP对象
 */
public class PublicipsPublicipDict  {
    ...
    private IpVersionEnum ipVersion = IpVersionEnum.NUMBER_4;

    public PublicipsPublicipDict withIpAddress(String ipAddress) {
    ...
    public PublicipsPublicipDict withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public PublicipsPublicipDict withIpVersion(IpVersionEnum ipVersion) {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        PublicipsPublicipDict publicipsPublicipDict = (PublicipsPublicipDict) o;
        return Objects.equals(this.ipAddress, publicipsPublicipDict.ipAddress) &&
            Objects.equals(this.type, publicipsPublicipDict.type) &&
            Objects.equals(this.ipVersion, publicipsPublicipDict.ipVersion);
    }
    @Override
    public int hashCode() {
    ...
    public String toString() {
        ...
        sb.append("class PublicipsPublicipDict {\n");
