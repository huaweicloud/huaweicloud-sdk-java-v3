 ...
 * 创建包周期弹性公网IP的订单信息
 */
public class PublicipExtendParamDict  {
    ...
    public PublicipExtendParamDict withChargeMode(ChargeModeEnum chargeMode) {
    ...
    public PublicipExtendParamDict withPeriodType(PeriodTypeEnum periodType) {
    ...
    public PublicipExtendParamDict withPeriodNum(Integer periodNum) {
    ...
    public PublicipExtendParamDict withIsAutoRenew(Boolean isAutoRenew) {
    ...
    public PublicipExtendParamDict withIsAutoPay(Boolean isAutoPay) {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        PublicipExtendParamDict publicipExtendParamDict = (PublicipExtendParamDict) o;
        return Objects.equals(this.chargeMode, publicipExtendParamDict.chargeMode) &&
            Objects.equals(this.periodType, publicipExtendParamDict.periodType) &&
            Objects.equals(this.periodNum, publicipExtendParamDict.periodNum) &&
            Objects.equals(this.isAutoRenew, publicipExtendParamDict.isAutoRenew) &&
            Objects.equals(this.isAutoPay, publicipExtendParamDict.isAutoPay);
    }
    @Override
    public int hashCode() {
    ...
    public String toString() {
        ...
        sb.append("class PublicipExtendParamDict {\n");
