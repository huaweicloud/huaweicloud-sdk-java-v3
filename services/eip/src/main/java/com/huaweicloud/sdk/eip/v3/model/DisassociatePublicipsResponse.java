...
public class DisassociatePublicipsResponse extends SdkResponse {
    ...
    public DisassociatePublicipsResponse withRequestId(String requestId) {
    ...
    public DisassociatePublicipsResponse withPublicip(PublicipInstanceResp publicip) {
        this.publicip = publicip;
        return this;
    }

    public DisassociatePublicipsResponse withPublicip(Consumer<PublicipInstanceResp> publicipSetter) {
