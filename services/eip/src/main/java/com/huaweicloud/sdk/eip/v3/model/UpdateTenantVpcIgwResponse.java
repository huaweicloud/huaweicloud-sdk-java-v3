 ...
 * Response Object
 */
public class UpdateTenantVpcIgwResponse extends SdkResponse {
    ...
    public UpdateTenantVpcIgwResponse withVpcIgw(VpcIgwsTenantResp vpcIgw) {
        this.vpcIgw = vpcIgw;
        return this;
    }

    public UpdateTenantVpcIgwResponse withVpcIgw(Consumer<VpcIgwsTenantResp> vpcIgwSetter) {
        if (this.vpcIgw == null) {
    ...
    public UpdateTenantVpcIgwResponse withRequestId(String requestId) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        UpdateTenantVpcIgwResponse that = (UpdateTenantVpcIgwResponse) obj;
