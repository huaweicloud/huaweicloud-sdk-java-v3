 ...
 * 创建带宽的请求体
 */
public class SharedBandwidthDict  {
    ...
    public SharedBandwidthDict withEnterpriseProjectId(String enterpriseProjectId) {
    ...
    public SharedBandwidthDict withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public SharedBandwidthDict withSize(Integer size) {
        this.size = size;
        return this;
    }
    ...
    public SharedBandwidthDict withChargeMode(ChargeModeEnum chargeMode) {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        SharedBandwidthDict sharedBandwidthDict = (SharedBandwidthDict) o;
        return Objects.equals(this.enterpriseProjectId, sharedBandwidthDict.enterpriseProjectId) &&
            Objects.equals(this.name, sharedBandwidthDict.name) &&
            Objects.equals(this.size, sharedBandwidthDict.size) &&
            Objects.equals(this.chargeMode, sharedBandwidthDict.chargeMode);
    }
    @Override
    public int hashCode() {
    ...
    public String toString() {
        ...
        sb.append("class SharedBandwidthDict {\n");
