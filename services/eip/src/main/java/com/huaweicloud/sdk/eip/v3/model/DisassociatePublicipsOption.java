...
public class DisassociatePublicipsOption {
    ...
    public DisassociatePublicipsOption withAssociateInstanceType(AssociateInstanceTypeEnum associateInstanceType) {
    ...
    public DisassociatePublicipsOption withAssociateInstanceId(String associateInstanceId) {
    ...
    public String toString() {
        ...
        sb.append("class DisassociatePublicipsOption {\n");
