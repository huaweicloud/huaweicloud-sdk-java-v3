...
public class PublicipUpdateResp {
    ...
    public PublicipUpdateResp withBandwidthName(String bandwidthName) {
    ...
    public PublicipUpdateResp withBandwidthShareType(BandwidthShareTypeEnum bandwidthShareType) {
    ...
    public PublicipUpdateResp withBandwidthSize(Integer bandwidthSize) {
    ...
    public PublicipUpdateResp withCreateTime(OffsetDateTime createTime) {
    ...
    public PublicipUpdateResp withEnterpriseProjectId(String enterpriseProjectId) {
    ...
    public PublicipUpdateResp withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public PublicipUpdateResp withPortId(String portId) {
        this.portId = portId;
        return this;
    }
    ...
    public PublicipUpdateResp withPrivateIpAddress(String privateIpAddress) {
    ...
    public PublicipUpdateResp withProfile(ProfileResp profile) {
        this.profile = profile;
        return this;
    }

    public PublicipUpdateResp withProfile(Consumer<ProfileResp> profileSetter) {
    ...
    public PublicipUpdateResp withPublicIpAddress(String publicIpAddress) {
    ...
    public PublicipUpdateResp withStatus(StatusEnum status) {
        this.status = status;
        return this;
    }
    ...
    public PublicipUpdateResp withTenantId(String tenantId) {
    ...
    public PublicipUpdateResp withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public PublicipUpdateResp withPublicIpv6Address(String publicIpv6Address) {
    ...
    public PublicipUpdateResp withIpVersion(IpVersionEnum ipVersion) {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        PublicipUpdateResp publicipUpdateResp = (PublicipUpdateResp) o;
        return Objects.equals(this.bandwidthId, publicipUpdateResp.bandwidthId)
            && Objects.equals(this.bandwidthName, publicipUpdateResp.bandwidthName)
            && Objects.equals(this.bandwidthShareType, publicipUpdateResp.bandwidthShareType)
            && Objects.equals(this.bandwidthSize, publicipUpdateResp.bandwidthSize)
            && Objects.equals(this.createTime, publicipUpdateResp.createTime)
            && Objects.equals(this.enterpriseProjectId, publicipUpdateResp.enterpriseProjectId)
            && Objects.equals(this.id, publicipUpdateResp.id) && Objects.equals(this.portId, publicipUpdateResp.portId)
            && Objects.equals(this.privateIpAddress, publicipUpdateResp.privateIpAddress)
            && Objects.equals(this.profile, publicipUpdateResp.profile)
            && Objects.equals(this.publicIpAddress, publicipUpdateResp.publicIpAddress)
            && Objects.equals(this.status, publicipUpdateResp.status)
