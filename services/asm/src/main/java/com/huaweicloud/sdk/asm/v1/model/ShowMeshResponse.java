...
public class ShowMeshResponse extends SdkResponse {
    ...
    public ShowMeshResponse withApiVersion(String apiVersion) {
    ...
    public ShowMeshResponse withKind(String kind) {
        this.kind = kind;
        return this;
    }
    ...
    public ShowMeshResponse withMetadata(MeshMetadata metadata) {
        this.metadata = metadata;
        return this;
    }

    public ShowMeshResponse withMetadata(Consumer<MeshMetadata> metadataSetter) {
    ...
    public ShowMeshResponse withSpec(MeshSpec spec) {
        this.spec = spec;
        return this;
    }

    public ShowMeshResponse withSpec(Consumer<MeshSpec> specSetter) {
        if (this.spec == null) {
    ...
    public ShowMeshResponse withStatus(MeshStatus status) {
        this.status = status;
        return this;
    }

    public ShowMeshResponse withStatus(Consumer<MeshStatus> statusSetter) {
        if (this.status == null) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ShowMeshResponse that = (ShowMeshResponse) obj;
