...
public class CreateTemplateRequestBody {
    ...
    public CreateTemplateRequestBody withTemplateFileName(String templateFileName) {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(templateName, templateType, templateDescription, templateBody, templateFileName);
    }
