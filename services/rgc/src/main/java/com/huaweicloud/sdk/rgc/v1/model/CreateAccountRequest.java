...
public class CreateAccountRequest {
    ...
    public CreateAccountRequest withBody(CreateManagedAccountRequest body) {
        this.body = body;
        return this;
    }

    public CreateAccountRequest withBody(Consumer<CreateManagedAccountRequest> bodySetter) {
        if (this.body == null) {
