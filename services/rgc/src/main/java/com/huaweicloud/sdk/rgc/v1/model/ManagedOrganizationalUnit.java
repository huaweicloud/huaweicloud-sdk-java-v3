 ...
 */
public class ManagedOrganizationalUnit {
    ...
    public ManagedOrganizationalUnit withManageAccountId(String manageAccountId) {
    ...
    public ManagedOrganizationalUnit withOrganizationalUnitId(String organizationalUnitId) {
    ...
    public ManagedOrganizationalUnit withOrganizationalUnitName(String organizationalUnitName) {
    ...
    public ManagedOrganizationalUnit withOrganizationalUnitStatus(String organizationalUnitStatus) {
    ...
    public ManagedOrganizationalUnit withOrganizationalUnitType(OrganizationalUnitType organizationalUnitType) {
    ...
    public ManagedOrganizationalUnit withParentOrganizationalUnitId(String parentOrganizationalUnitId) {
    ...
    public ManagedOrganizationalUnit withParentOrganizationalUnitName(String parentOrganizationalUnitName) {
    ...
    public ManagedOrganizationalUnit withCreatedAt(OffsetDateTime createdAt) {
    ...
    public ManagedOrganizationalUnit withLandingZoneVersion(String landingZoneVersion) {
    ...
    public ManagedOrganizationalUnit withUpdatedAt(OffsetDateTime updatedAt) {
    ...
    public ManagedOrganizationalUnit withMessage(String message) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ManagedOrganizationalUnit that = (ManagedOrganizationalUnit) obj;
    ...
    public String toString() {
        ...
        sb.append("class ManagedOrganizationalUnit {\n");
