 ...
 * Response Object
 */
public class CreateManagedOrganizationalUnitResponse extends SdkResponse {
    ...
    public CreateManagedOrganizationalUnitResponse withManageAccountId(String manageAccountId) {
    ...
    public CreateManagedOrganizationalUnitResponse withOrganizationalUnitId(String organizationalUnitId) {
    ...
    public CreateManagedOrganizationalUnitResponse withOrganizationalUnitName(String organizationalUnitName) {
    ...
    public CreateManagedOrganizationalUnitResponse withOrganizationalUnitStatus(String organizationalUnitStatus) {
    ...
    public CreateManagedOrganizationalUnitResponse withOrganizationalUnitType(
    ...
    public CreateManagedOrganizationalUnitResponse withParentOrganizationalUnitId(String parentOrganizationalUnitId) {
    ...
    public CreateManagedOrganizationalUnitResponse withParentOrganizationalUnitName(
        String parentOrganizationalUnitName) {
    ...
    public CreateManagedOrganizationalUnitResponse withCreatedAt(OffsetDateTime createdAt) {
    ...
    public CreateManagedOrganizationalUnitResponse withLandingZoneVersion(String landingZoneVersion) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        CreateManagedOrganizationalUnitResponse that = (CreateManagedOrganizationalUnitResponse) obj;
