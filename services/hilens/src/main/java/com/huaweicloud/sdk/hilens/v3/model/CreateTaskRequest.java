...
public class CreateTaskRequest {
    ...
    public CreateTaskRequest withDeploymentId(String deploymentId) {
    ...
    public CreateTaskRequest withBody(TaskRequest body) {
        this.body = body;
        return this;
    }

    public CreateTaskRequest withBody(Consumer<TaskRequest> bodySetter) {
        if (this.body == null) {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        return Objects.equals(this.deploymentId, createTaskRequest.deploymentId)
