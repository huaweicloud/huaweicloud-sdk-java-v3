...
public class UpdateWorkSpaceRequest {
    ...
    private UpdateDescription body;
    ...
    public UpdateWorkSpaceRequest withBody(UpdateDescription body) {
        this.body = body;
        return this;
    }

    public UpdateWorkSpaceRequest withBody(Consumer<UpdateDescription> bodySetter) {
        if (this.body == null) {
            this.body = new UpdateDescription();
     ...
     * @return body
     */
    public UpdateDescription getBody() {
        return body;
    }

    public void setBody(UpdateDescription body) {
        this.body = body;
    }
