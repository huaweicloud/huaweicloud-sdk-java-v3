...
public class ShowNodesRequest {
    ...
    public ShowNodesRequest withOffset(Integer offset) {
        this.offset = offset;
        return this;
    }
    ...
    public ShowNodesRequest withLimit(Integer limit) {
        this.limit = limit;
        return this;
    }
    ...
    public ShowNodesRequest withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public ShowNodesRequest withWorkspaceId(String workspaceId) {
    ...
    public ShowNodesRequest withAppName(String appName) {
    ...
    public ShowNodesRequest withTags(String tags) {
        this.tags = tags;
        return this;
    }
    ...
    public ShowNodesRequest withProvider(String provider) {
    ...
    public ShowNodesRequest withClusterId(String clusterId) {
    ...
    public ShowNodesRequest withStatus(String status) {
        this.status = status;
        return this;
    }
    ...
    public ShowNodesRequest withActiveStatus(String activeStatus) {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(offset, limit, name, workspaceId, appName, tags, provider, clusterId, status, activeStatus);
    }
