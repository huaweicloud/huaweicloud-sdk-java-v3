...
public class AsRegion {
    ...
    public static final Region CN_SOUTHWEST_2 = new Region("cn-southwest-2", "https://as.cn-southwest-2.myhuaweicloud.com");
    public static final Region AP_SOUTHEAST_2 = new Region("ap-southeast-2", "https://as.ap-southeast-2.myhuaweicloud.com");
    public static final Region AP_SOUTHEAST_1 = new Region("ap-southeast-1", "https://as.ap-southeast-1.myhwclouds.com");
    public static final Region AP_SOUTHEAST_3 = new Region("ap-southeast-3", "https://as.ap-southeast-3.myhuaweicloud.com");
    public static final Region CN_NORTH_2 = new Region("cn-north-2", "https://as.cn-north-2.myhuaweicloud.com");
    public static final Region RU_NORTHWEST_2 = new Region("ru-northwest-2", "https://as.ru-northwest-2.myhuaweicloud.com");
