...
public class UpdateScalingV2PolicyOption  {
    ...
    public UpdateScalingV2PolicyOption withScalingPolicyName(String scalingPolicyName) {
    ...
    public UpdateScalingV2PolicyOption withScalingResourceId(String scalingResourceId) {
    ...
    public UpdateScalingV2PolicyOption withScalingResourceType(ScalingResourceTypeEnum scalingResourceType) {
    ...
    public UpdateScalingV2PolicyOption withScalingPolicyType(ScalingPolicyTypeEnum scalingPolicyType) {
    ...
    public UpdateScalingV2PolicyOption withAlarmId(String alarmId) {
    ...
    public UpdateScalingV2PolicyOption withScheduledPolicy(ScheduledPolicy scheduledPolicy) {
        this.scheduledPolicy = scheduledPolicy;
        return this;
    }

    public UpdateScalingV2PolicyOption withScheduledPolicy(Consumer<ScheduledPolicy> scheduledPolicySetter) {
    ...
    public UpdateScalingV2PolicyOption withScalingPolicyAction(ScalingPolicyActionV2 scalingPolicyAction) {
        this.scalingPolicyAction = scalingPolicyAction;
        return this;
    }

    public UpdateScalingV2PolicyOption withScalingPolicyAction(Consumer<ScalingPolicyActionV2> scalingPolicyActionSetter) {
    ...
    public UpdateScalingV2PolicyOption withCoolDownTime(Integer coolDownTime) {
    ...
    public UpdateScalingV2PolicyOption withDescription(String description) {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        UpdateScalingV2PolicyOption updateScalingV2PolicyOption = (UpdateScalingV2PolicyOption) o;
        return Objects.equals(this.scalingPolicyName, updateScalingV2PolicyOption.scalingPolicyName) &&
            Objects.equals(this.scalingResourceId, updateScalingV2PolicyOption.scalingResourceId) &&
            Objects.equals(this.scalingResourceType, updateScalingV2PolicyOption.scalingResourceType) &&
            Objects.equals(this.scalingPolicyType, updateScalingV2PolicyOption.scalingPolicyType) &&
            Objects.equals(this.alarmId, updateScalingV2PolicyOption.alarmId) &&
            Objects.equals(this.scheduledPolicy, updateScalingV2PolicyOption.scheduledPolicy) &&
            Objects.equals(this.scalingPolicyAction, updateScalingV2PolicyOption.scalingPolicyAction) &&
            Objects.equals(this.coolDownTime, updateScalingV2PolicyOption.coolDownTime) &&
            Objects.equals(this.description, updateScalingV2PolicyOption.description);
    }
    @Override
    public int hashCode() {
