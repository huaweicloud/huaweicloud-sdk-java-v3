...
public class BatchProtectInstancesOption {
    ...
    public BatchProtectInstancesOption withInstancesId(List<String> instancesId) {
        this.instancesId = instancesId;
        return this;
    }

    public BatchProtectInstancesOption addInstancesIdItem(String instancesIdItem) {
    ...
    public BatchProtectInstancesOption withInstancesId(Consumer<List<String>> instancesIdSetter) {
        if (this.instancesId == null) {
            this.instancesId = new ArrayList<>();
        }
    ...
    public BatchProtectInstancesOption withInstanceDelete(InstanceDeleteEnum instanceDelete) {
    ...
    public BatchProtectInstancesOption withAction(ActionEnum action) {
        this.action = action;
        return this;
    }
    ...
    public BatchProtectInstancesOption withInstanceAppend(InstanceAppendEnum instanceAppend) {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        BatchProtectInstancesOption batchProtectInstancesOption = (BatchProtectInstancesOption) o;
        return Objects.equals(this.instancesId, batchProtectInstancesOption.instancesId)
            && Objects.equals(this.instanceDelete, batchProtectInstancesOption.instanceDelete)
            && Objects.equals(this.action, batchProtectInstancesOption.action)
            && Objects.equals(this.instanceAppend, batchProtectInstancesOption.instanceAppend);
    }
