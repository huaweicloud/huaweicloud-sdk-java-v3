 ...
 * 标签列表
 */
public class DeleteScalingTagsRequestBody  {
    ...
    public DeleteScalingTagsRequestBody withTags(Consumer<List<TagsSingleValue>> tagsSetter) {
        if(this.tags == null ){
            this.tags = new ArrayList<>();
        }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        DeleteScalingTagsRequestBody deleteScalingTagsRequestBody = (DeleteScalingTagsRequestBody) o;
        return Objects.equals(this.tags, deleteScalingTagsRequestBody.tags) &&
            Objects.equals(this.action, deleteScalingTagsRequestBody.action);
    }
    @Override
    public int hashCode() {
    ...
    public String toString() {
        ...
        sb.append("class DeleteScalingTagsRequestBody {\n");
