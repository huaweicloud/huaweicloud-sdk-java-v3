 ...
 * 批量添加实例
 */
public class BatchAddInstancesOption {
    ...
    public BatchAddInstancesOption withInstancesId(List<String> instancesId) {
        this.instancesId = instancesId;
        return this;
    }

    public BatchAddInstancesOption addInstancesIdItem(String instancesIdItem) {
    ...
    public BatchAddInstancesOption withInstancesId(Consumer<List<String>> instancesIdSetter) {
        if (this.instancesId == null) {
            this.instancesId = new ArrayList<>();
        }
    ...
    public BatchAddInstancesOption withInstanceDelete(InstanceDeleteEnum instanceDelete) {
    ...
    public BatchAddInstancesOption withAction(ActionEnum action) {
        this.action = action;
        return this;
    }
    ...
    public BatchAddInstancesOption withInstanceAppend(InstanceAppendEnum instanceAppend) {
    ...
    public String toString() {
        ...
        sb.append("class BatchAddInstancesOption {\n");
