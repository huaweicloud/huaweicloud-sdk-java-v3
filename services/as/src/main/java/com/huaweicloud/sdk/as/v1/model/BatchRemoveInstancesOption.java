...
public class BatchRemoveInstancesOption {
    ...
    public BatchRemoveInstancesOption withInstancesId(List<String> instancesId) {
        this.instancesId = instancesId;
        return this;
    }

    public BatchRemoveInstancesOption addInstancesIdItem(String instancesIdItem) {
    ...
    public BatchRemoveInstancesOption withInstancesId(Consumer<List<String>> instancesIdSetter) {
        if (this.instancesId == null) {
            this.instancesId = new ArrayList<>();
        }
    ...
    public BatchRemoveInstancesOption withInstanceDelete(InstanceDeleteEnum instanceDelete) {
    ...
    public BatchRemoveInstancesOption withAction(ActionEnum action) {
        this.action = action;
        return this;
    }
    ...
    public BatchRemoveInstancesOption withInstanceAppend(InstanceAppendEnum instanceAppend) {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        BatchRemoveInstancesOption batchRemoveInstancesOption = (BatchRemoveInstancesOption) o;
        return Objects.equals(this.instancesId, batchRemoveInstancesOption.instancesId)
            && Objects.equals(this.instanceDelete, batchRemoveInstancesOption.instanceDelete)
            && Objects.equals(this.action, batchRemoveInstancesOption.action)
            && Objects.equals(this.instanceAppend, batchRemoveInstancesOption.instanceAppend);
    }
