...
public class BatchResumeScalingPoliciesOption  {
    ...
    public BatchResumeScalingPoliciesOption withScalingPolicyId(List<String> scalingPolicyId) {
        this.scalingPolicyId = scalingPolicyId;
        return this;
    }

    
    public BatchResumeScalingPoliciesOption addScalingPolicyIdItem(String scalingPolicyIdItem) {
    ...
    public BatchResumeScalingPoliciesOption withScalingPolicyId(Consumer<List<String>> scalingPolicyIdSetter) {
        if(this.scalingPolicyId == null) {
            this.scalingPolicyId = new ArrayList<>();
        }
    ...
    public BatchResumeScalingPoliciesOption withForceDelete(ForceDeleteEnum forceDelete) {
    ...
    public BatchResumeScalingPoliciesOption withAction(ActionEnum action) {
        this.action = action;
        return this;
    }
    ...
    public BatchResumeScalingPoliciesOption withDeleteAlarm(String deleteAlarm) {
