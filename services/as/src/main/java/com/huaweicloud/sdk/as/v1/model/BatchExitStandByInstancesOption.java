...
/** 批量将实例移出备用状态 */
public class BatchExitStandByInstancesOption {
    ...
    public BatchExitStandByInstancesOption withInstancesId(List<String> instancesId) {
        this.instancesId = instancesId;
        return this;
    }

    public BatchExitStandByInstancesOption addInstancesIdItem(String instancesIdItem) {
    ...
    public BatchExitStandByInstancesOption withInstancesId(Consumer<List<String>> instancesIdSetter) {
        if (this.instancesId == null) {
            this.instancesId = new ArrayList<>();
        }
    ...
    public BatchExitStandByInstancesOption withInstanceDelete(InstanceDeleteEnum instanceDelete) {
    ...
    public BatchExitStandByInstancesOption withAction(ActionEnum action) {
        this.action = action;
        return this;
    }
    ...
    public BatchExitStandByInstancesOption withInstanceAppend(InstanceAppendEnum instanceAppend) {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        BatchExitStandByInstancesOption batchExitStandByInstancesOption = (BatchExitStandByInstancesOption) o;
        return Objects.equals(this.instancesId, batchExitStandByInstancesOption.instancesId)
            && Objects.equals(this.instanceDelete, batchExitStandByInstancesOption.instanceDelete)
            && Objects.equals(this.action, batchExitStandByInstancesOption.action)
            && Objects.equals(this.instanceAppend, batchExitStandByInstancesOption.instanceAppend);
    }
    ...
    public String toString() {
        ...
        sb.append("class BatchExitStandByInstancesOption {\n");
