 ...
 * 修改伸缩策略
 */
public class UpdateScalingV2PolicyRequestBody  {
    ...
    public UpdateScalingV2PolicyRequestBody withScalingPolicyName(String scalingPolicyName) {
    ...
    public UpdateScalingV2PolicyRequestBody withScalingResourceId(String scalingResourceId) {
    ...
    public UpdateScalingV2PolicyRequestBody withScalingResourceType(ScalingResourceTypeEnum scalingResourceType) {
    ...
    public UpdateScalingV2PolicyRequestBody withScalingPolicyType(ScalingPolicyTypeEnum scalingPolicyType) {
    ...
    public UpdateScalingV2PolicyRequestBody withAlarmId(String alarmId) {
    ...
    public UpdateScalingV2PolicyRequestBody withScheduledPolicy(ScheduledPolicy scheduledPolicy) {
        this.scheduledPolicy = scheduledPolicy;
        return this;
    }

    public UpdateScalingV2PolicyRequestBody withScheduledPolicy(Consumer<ScheduledPolicy> scheduledPolicySetter) {
    ...
    public UpdateScalingV2PolicyRequestBody withScalingPolicyAction(ScalingPolicyActionV2 scalingPolicyAction) {
        this.scalingPolicyAction = scalingPolicyAction;
        return this;
    }

    public UpdateScalingV2PolicyRequestBody withScalingPolicyAction(Consumer<ScalingPolicyActionV2> scalingPolicyActionSetter) {
    ...
    public UpdateScalingV2PolicyRequestBody withCoolDownTime(Integer coolDownTime) {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        UpdateScalingV2PolicyRequestBody updateScalingV2PolicyRequestBody = (UpdateScalingV2PolicyRequestBody) o;
        return Objects.equals(this.scalingPolicyName, updateScalingV2PolicyRequestBody.scalingPolicyName) &&
            Objects.equals(this.scalingResourceId, updateScalingV2PolicyRequestBody.scalingResourceId) &&
            Objects.equals(this.scalingResourceType, updateScalingV2PolicyRequestBody.scalingResourceType) &&
            Objects.equals(this.scalingPolicyType, updateScalingV2PolicyRequestBody.scalingPolicyType) &&
            Objects.equals(this.alarmId, updateScalingV2PolicyRequestBody.alarmId) &&
            Objects.equals(this.scheduledPolicy, updateScalingV2PolicyRequestBody.scheduledPolicy) &&
            Objects.equals(this.scalingPolicyAction, updateScalingV2PolicyRequestBody.scalingPolicyAction) &&
            Objects.equals(this.coolDownTime, updateScalingV2PolicyRequestBody.coolDownTime);
    }
    @Override
    public int hashCode() {
    ...
    public String toString() {
        ...
        sb.append("class UpdateScalingV2PolicyRequestBody {\n");
