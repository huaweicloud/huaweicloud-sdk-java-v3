 ...
 * Response Object
 */
public class ShowDispatchesResponse extends SdkResponse {
    ...
    public ShowDispatchesResponse withDispatchId(String dispatchId) {
    ...
    public ShowDispatchesResponse withTaskId(String taskId) {
        this.taskId = taskId;
        return this;
    }
    ...
    public ShowDispatchesResponse withStartDatetime(Long startDatetime) {
    ...
    public ShowDispatchesResponse withPeriod(PeriodEnum period) {
        this.period = period;
        return this;
    }
    ...
    public ShowDispatchesResponse withDispatchInterval(Long dispatchInterval) {
    ...
    public ShowDispatchesResponse withCreatedDate(Long createdDate) {
    ...
    public ShowDispatchesResponse withLastModifiedDate(Long lastModifiedDate) {
    ...
    public ShowDispatchesResponse withRemark(String remark) {
        this.remark = remark;
        return this;
    }
    ...
    public ShowDispatchesResponse withUseQuartzCron(Boolean useQuartzCron) {
    ...
    public ShowDispatchesResponse withCron(String cron) {
        this.cron = cron;
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append("class ShowDispatchesResponse {\n");
