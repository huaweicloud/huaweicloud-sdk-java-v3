...
public class ProjectVpcCreate {
    ...
    public ProjectVpcCreate withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public ProjectVpcCreate withPort(Integer port) {
        this.port = port;
        return this;
    }
    ...
    public ProjectVpcCreate withBalanceStrategy(BalanceStrategyEnum balanceStrategy) {
    ...
    public ProjectVpcCreate withMemberType(MemberTypeEnum memberType) {
    ...
    public ProjectVpcCreate withMemberGroups(List<MemberGroupCreate> memberGroups) {
        this.memberGroups = memberGroups;
        return this;
    }

    public ProjectVpcCreate addMemberGroupsItem(MemberGroupCreate memberGroupsItem) {
    ...
    public ProjectVpcCreate withMemberGroups(Consumer<List<MemberGroupCreate>> memberGroupsSetter) {
        if (this.memberGroups == null) {
            this.memberGroups = new ArrayList<>();
        }
    ...
    public ProjectVpcCreate withMembers(List<MemberInfo> members) {
        this.members = members;
        return this;
    }

    public ProjectVpcCreate addMembersItem(MemberInfo membersItem) {
    ...
    public ProjectVpcCreate withMembers(Consumer<List<MemberInfo>> membersSetter) {
        if (this.members == null) {
            this.members = new ArrayList<>();
        }
    ...
    public ProjectVpcCreate withVpcHealthConfig(VpcHealthConfig vpcHealthConfig) {
        this.vpcHealthConfig = vpcHealthConfig;
        return this;
    }

    public ProjectVpcCreate withVpcHealthConfig(Consumer<VpcHealthConfig> vpcHealthConfigSetter) {
    ...
    public ProjectVpcCreate addInstanceIdsItem(String instanceIdsItem) {
    ...
    public ProjectVpcCreate withInstanceIds(Consumer<List<String>> instanceIdsSetter) {
        if (this.instanceIds == null) {
            this.instanceIds = new ArrayList<>();
        }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ProjectVpcCreate projectVpcCreate = (ProjectVpcCreate) o;
        return Objects.equals(this.name, projectVpcCreate.name) && Objects.equals(this.port, projectVpcCreate.port)
            && Objects.equals(this.balanceStrategy, projectVpcCreate.balanceStrategy)
            && Objects.equals(this.memberType, projectVpcCreate.memberType)
            && Objects.equals(this.dictCode, projectVpcCreate.dictCode)
            && Objects.equals(this.memberGroups, projectVpcCreate.memberGroups)
            && Objects.equals(this.members, projectVpcCreate.members)
            && Objects.equals(this.vpcHealthConfig, projectVpcCreate.vpcHealthConfig)
            && Objects.equals(this.instanceIds, projectVpcCreate.instanceIds);
    }
    ...
    public String toString() {
        ...
        sb.append("class ProjectVpcCreate {\n");
