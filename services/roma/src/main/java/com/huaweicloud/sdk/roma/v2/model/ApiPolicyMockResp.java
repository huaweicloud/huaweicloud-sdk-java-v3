...
public class ApiPolicyMockResp {
    ...
    */
    ...
    public ApiPolicyMockResp withStatusCode(StatusCodeEnum statusCode) {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        return Objects.equals(this.id, apiPolicyMockResp.id) && Objects.equals(this.name, apiPolicyMockResp.name)
            ...
            && Objects.equals(this.statusCode, apiPolicyMockResp.statusCode)
            && Objects.equals(this.header, apiPolicyMockResp.header);
    }

    @Override
    public int hashCode() {
        return Objects
            .hash(id, name, conditions, backendParams, effectMode, authorizerId, resultContent, statusCode, header);
    }
