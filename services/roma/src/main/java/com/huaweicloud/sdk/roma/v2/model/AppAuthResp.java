...
import com.huaweicloud.sdk.roma.v2.model.AuthResultResp;
...
public class AppAuthResp  {
    ...
    public AppAuthResp withAuthTunnel(String authTunnel) {
    ...
    public AppAuthResp withVisitParams(String visitParams) {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        return Objects.equals(this.apiId, appAuthResp.apiId) &&
            ...
            Objects.equals(this.visitParams, appAuthResp.visitParams);
    }
    @Override
    public int hashCode() {
        return Objects.hash(apiId, authResult, authTime, id, appId, authRole, authTunnel, authWhitelist, authBlacklist, visitParams);
    }
    @Override
    public String toString() {
