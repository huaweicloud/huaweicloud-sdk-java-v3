...
public class TaskMonitorDetailLog {
    ...
    /** 任务当前步骤的状态，允许如下值：NORMAL-正在运行, NODE_END-本节点正常结束, RUNTIME_CANCEL-任务被取消, TASK_END-本任务正常结束, RUNTIME_ERR-运行时异常,
     * INTERNAL_ERR-内部程序异常 */
    ...
    /** 本次步骤启动时间，格式timestamp(ms)，使用UTC时区 minimum: 1 maximum: 9999999999999
     * 
    ...
    /** 本次步骤结束时间，格式timestamp(ms)，使用UTC时区 minimum: 1 maximum: 9999999999999
     * 
     * @return stepEndTime */
