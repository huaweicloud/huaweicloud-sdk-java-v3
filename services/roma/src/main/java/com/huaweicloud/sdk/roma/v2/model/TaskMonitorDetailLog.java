...
public class TaskMonitorDetailLog  {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, status, position, positionStatus, stage, dirtyDataCount, dataCount, dataSize, dataSizeUnit, spendTime, remarks, stepBeginTime, stepEndTime);
    }
    @Override
    public String toString() {
