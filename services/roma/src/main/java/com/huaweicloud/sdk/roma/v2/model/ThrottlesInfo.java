...
public class ThrottlesInfo  {
    ...
    public ThrottlesInfo withType(TypeEnum type) {
        this.type = type;
        return this;
    }
    ...
    public ThrottlesInfo withIsIncluSpecialThrottle(IsIncluSpecialThrottleEnum isIncluSpecialThrottle) {
