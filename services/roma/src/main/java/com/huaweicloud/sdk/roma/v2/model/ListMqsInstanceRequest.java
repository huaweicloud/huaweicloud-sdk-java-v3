...
public class ListMqsInstanceRequest {
    ...
    public static final class IncludeInternalEnum {
        ...
        public static IncludeInternalEnum fromValue(String value) {
            ...
            return java.util.Optional.ofNullable(STATIC_FIELDS.get(value)).orElse(new IncludeInternalEnum(value));
        }
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ListMqsInstanceRequest that = (ListMqsInstanceRequest) obj;
        return Objects.equals(this.includeInternal, that.includeInternal);
    }
