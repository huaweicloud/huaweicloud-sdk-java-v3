 ...
 */
public class PropertyResponseBody {
    ...
    public PropertyResponseBody withPropertyId(Integer propertyId) {
    ...
    public PropertyResponseBody withPropertyName(String propertyName) {
    ...
    public PropertyResponseBody withDescription(String description) {
    ...
    public PropertyResponseBody withDataType(DataTypeEnum dataType) {
    ...
    public PropertyResponseBody withRequired(RequiredEnum required) {
    ...
    public PropertyResponseBody withMin(String min) {
        this.min = min;
        return this;
    }
    ...
    public PropertyResponseBody withMax(String max) {
        this.max = max;
        return this;
    }
    ...
    public PropertyResponseBody withStep(String step) {
        this.step = step;
        return this;
    }
    ...
    public PropertyResponseBody withMaxLength(Integer maxLength) {
    ...
    public PropertyResponseBody withUnit(String unit) {
        this.unit = unit;
        return this;
    }
    ...
    public PropertyResponseBody withEnumList(String enumList) {
    ...
    public PropertyResponseBody withEnumDict(PropertyDataEnum enumDict) {
        this.enumDict = enumDict;
        return this;
    }

    public PropertyResponseBody withEnumDict(Consumer<PropertyDataEnum> enumDictSetter) {
    ...
    public PropertyResponseBody withMethod(String method) {
        this.method = method;
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append("class PropertyResponseBody {\n");
