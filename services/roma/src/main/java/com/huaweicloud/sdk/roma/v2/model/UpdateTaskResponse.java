...
public class UpdateTaskResponse extends SdkResponse {
    ...
    public UpdateTaskResponse withTask(TaskBasicRsp task) {
        this.task = task;
        return this;
    }

    public UpdateTaskResponse withTask(Consumer<TaskBasicRsp> taskSetter) {
        if (this.task == null) {
    ...
    public UpdateTaskResponse withTaskDetail(String taskDetail) {
