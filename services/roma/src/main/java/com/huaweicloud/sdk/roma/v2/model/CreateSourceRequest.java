...
public class CreateSourceRequest  {
    ...
    public CreateSourceRequest withBody(Consumer<CreateSourceRequestBody> bodySetter) {
        if(this.body == null ){
            this.body = new CreateSourceRequestBody();
     ...
     * @return body
     */
    public CreateSourceRequestBody getBody() {
        return body;
    }
