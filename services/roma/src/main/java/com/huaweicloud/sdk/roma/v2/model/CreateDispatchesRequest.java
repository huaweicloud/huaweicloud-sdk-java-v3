...
public class CreateDispatchesRequest {
    ...
    public CreateDispatchesRequest withInstanceId(String instanceId) {
    ...
    public CreateDispatchesRequest withTaskId(String taskId) {
        this.taskId = taskId;
        return this;
    }
    ...
    public CreateDispatchesRequest withBody(TaskDispatch body) {
        this.body = body;
        return this;
    }

    public CreateDispatchesRequest withBody(Consumer<TaskDispatch> bodySetter) {
        if (this.body == null) {
    ...
    public String toString() {
        ...
        sb.append("class CreateDispatchesRequest {\n");
