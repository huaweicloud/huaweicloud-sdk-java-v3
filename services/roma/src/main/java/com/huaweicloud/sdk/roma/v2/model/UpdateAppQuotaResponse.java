 ...
 * Response Object
 */
public class UpdateAppQuotaResponse extends SdkResponse {
    ...
    @JacksonXmlProperty(localName = "bound_app_num")

    private Integer boundAppNum;

    public UpdateAppQuotaResponse withAppQuotaId(String appQuotaId) {
    ...
    public UpdateAppQuotaResponse withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public UpdateAppQuotaResponse withCallLimits(Integer callLimits) {
    ...
    public UpdateAppQuotaResponse withTimeUnit(TimeUnitEnum timeUnit) {
    ...
    public UpdateAppQuotaResponse withTimeInterval(Integer timeInterval) {
    ...
    public UpdateAppQuotaResponse withRemark(String remark) {
        this.remark = remark;
        return this;
    }
    ...
    public UpdateAppQuotaResponse withResetTime(String resetTime) {
    ...
    public UpdateAppQuotaResponse withCreateTime(OffsetDateTime createTime) {
    ...
    public UpdateAppQuotaResponse withBoundAppNum(Integer boundAppNum) {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        UpdateAppQuotaResponse updateAppQuotaResponse = (UpdateAppQuotaResponse) o;
        return Objects.equals(this.appQuotaId, updateAppQuotaResponse.appQuotaId)
            && Objects.equals(this.name, updateAppQuotaResponse.name)
            && Objects.equals(this.callLimits, updateAppQuotaResponse.callLimits)
            && Objects.equals(this.timeUnit, updateAppQuotaResponse.timeUnit)
            && Objects.equals(this.timeInterval, updateAppQuotaResponse.timeInterval)
            && Objects.equals(this.remark, updateAppQuotaResponse.remark)
            && Objects.equals(this.resetTime, updateAppQuotaResponse.resetTime)
            && Objects.equals(this.createTime, updateAppQuotaResponse.createTime)
            && Objects.equals(this.boundAppNum, updateAppQuotaResponse.boundAppNum);
    }
    ...
    public String toString() {
        ...
        sb.append("class UpdateAppQuotaResponse {\n");
