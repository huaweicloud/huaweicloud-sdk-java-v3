 ...
 * Response Object
 */
public class CreateRequestPropertyResponse extends SdkResponse {
    ...
    public CreateRequestPropertyResponse withPropertyId(Integer propertyId) {
    ...
    public CreateRequestPropertyResponse withPropertyName(String propertyName) {
    ...
    public CreateRequestPropertyResponse withDescription(String description) {
    ...
    public CreateRequestPropertyResponse withDataType(DataTypeEnum dataType) {
    ...
    public CreateRequestPropertyResponse withRequired(RequiredEnum required) {
    ...
    public CreateRequestPropertyResponse withMin(String min) {
        this.min = min;
        return this;
    }
    ...
    public CreateRequestPropertyResponse withMax(String max) {
        this.max = max;
        return this;
    }
    ...
    public CreateRequestPropertyResponse withStep(String step) {
        this.step = step;
        return this;
    }
    ...
    public CreateRequestPropertyResponse withMaxLength(Integer maxLength) {
    ...
    public CreateRequestPropertyResponse withUnit(String unit) {
        this.unit = unit;
        return this;
    }
    ...
    public CreateRequestPropertyResponse withEnumList(String enumList) {
    ...
    public CreateRequestPropertyResponse withEnumDict(PropertyDataEnum enumDict) {
        this.enumDict = enumDict;
        return this;
    }

    public CreateRequestPropertyResponse withEnumDict(Consumer<PropertyDataEnum> enumDictSetter) {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        CreateRequestPropertyResponse createRequestPropertyResponse = (CreateRequestPropertyResponse) o;
        return Objects.equals(this.propertyId, createRequestPropertyResponse.propertyId)
            && Objects.equals(this.propertyName, createRequestPropertyResponse.propertyName)
            && Objects.equals(this.description, createRequestPropertyResponse.description)
            && Objects.equals(this.dataType, createRequestPropertyResponse.dataType)
            && Objects.equals(this.required, createRequestPropertyResponse.required)
            && Objects.equals(this.min, createRequestPropertyResponse.min)
            && Objects.equals(this.max, createRequestPropertyResponse.max)
            && Objects.equals(this.step, createRequestPropertyResponse.step)
            && Objects.equals(this.maxLength, createRequestPropertyResponse.maxLength)
            && Objects.equals(this.unit, createRequestPropertyResponse.unit)
            && Objects.equals(this.enumList, createRequestPropertyResponse.enumList)
            && Objects.equals(this.enumDict, createRequestPropertyResponse.enumDict);
    }
    ...
    public String toString() {
        ...
        sb.append("class CreateRequestPropertyResponse {\n");
