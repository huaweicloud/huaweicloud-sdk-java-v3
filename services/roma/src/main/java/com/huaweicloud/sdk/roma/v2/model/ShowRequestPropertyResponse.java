 ...
 * Response Object
 */
public class ShowRequestPropertyResponse extends SdkResponse {
    ...
    public ShowRequestPropertyResponse withPropertyId(Integer propertyId) {
    ...
    public ShowRequestPropertyResponse withPropertyName(String propertyName) {
    ...
    public ShowRequestPropertyResponse withDescription(String description) {
    ...
    public ShowRequestPropertyResponse withDataType(DataTypeEnum dataType) {
    ...
    public ShowRequestPropertyResponse withRequired(RequiredEnum required) {
    ...
    public ShowRequestPropertyResponse withMin(String min) {
        this.min = min;
        return this;
    }
    ...
    public ShowRequestPropertyResponse withMax(String max) {
        this.max = max;
        return this;
    }
    ...
    public ShowRequestPropertyResponse withStep(String step) {
        this.step = step;
        return this;
    }
    ...
    public ShowRequestPropertyResponse withMaxLength(Integer maxLength) {
    ...
    public ShowRequestPropertyResponse withUnit(String unit) {
        this.unit = unit;
        return this;
    }
    ...
    public ShowRequestPropertyResponse withEnumList(String enumList) {
    ...
    public ShowRequestPropertyResponse withEnumDict(PropertyDataEnum enumDict) {
        this.enumDict = enumDict;
        return this;
    }

    public ShowRequestPropertyResponse withEnumDict(Consumer<PropertyDataEnum> enumDictSetter) {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ShowRequestPropertyResponse showRequestPropertyResponse = (ShowRequestPropertyResponse) o;
        return Objects.equals(this.propertyId, showRequestPropertyResponse.propertyId)
            && Objects.equals(this.propertyName, showRequestPropertyResponse.propertyName)
            && Objects.equals(this.description, showRequestPropertyResponse.description)
            && Objects.equals(this.dataType, showRequestPropertyResponse.dataType)
            && Objects.equals(this.required, showRequestPropertyResponse.required)
            && Objects.equals(this.min, showRequestPropertyResponse.min)
            && Objects.equals(this.max, showRequestPropertyResponse.max)
            && Objects.equals(this.step, showRequestPropertyResponse.step)
            && Objects.equals(this.maxLength, showRequestPropertyResponse.maxLength)
            && Objects.equals(this.unit, showRequestPropertyResponse.unit)
            && Objects.equals(this.enumList, showRequestPropertyResponse.enumList)
            && Objects.equals(this.enumDict, showRequestPropertyResponse.enumDict);
    }
    ...
    public String toString() {
        ...
        sb.append("class ShowRequestPropertyResponse {\n");
