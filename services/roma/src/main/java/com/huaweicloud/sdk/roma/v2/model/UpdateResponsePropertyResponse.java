 ...
 * Response Object
 */
public class UpdateResponsePropertyResponse extends SdkResponse {
    ...
    public UpdateResponsePropertyResponse withPropertyName(String propertyName) {
    ...
    public UpdateResponsePropertyResponse withDescription(String description) {
    ...
    public UpdateResponsePropertyResponse withDataType(DataTypeEnum dataType) {
    ...
    public UpdateResponsePropertyResponse withMin(String min) {
        this.min = min;
        return this;
    }
    ...
    public UpdateResponsePropertyResponse withMax(String max) {
        this.max = max;
        return this;
    }
    ...
    public UpdateResponsePropertyResponse withStep(String step) {
        this.step = step;
        return this;
    }
    ...
    public UpdateResponsePropertyResponse withMaxLength(Integer maxLength) {
    ...
    public UpdateResponsePropertyResponse withUnit(String unit) {
        this.unit = unit;
        return this;
    }
    ...
    public UpdateResponsePropertyResponse withEnumList(String enumList) {
    ...
    public UpdateResponsePropertyResponse withEnumDict(Object enumDict) {
    ...
    public String toString() {
        ...
        sb.append("class UpdateResponsePropertyResponse {\n");
