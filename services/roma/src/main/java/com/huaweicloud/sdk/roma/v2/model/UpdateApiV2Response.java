...
public class UpdateApiV2Response extends SdkResponse {
    ...
    public UpdateApiV2Response withContentType(ContentTypeEnum contentType) {
    ...
    public UpdateApiV2Response withStatus(StatusEnum status) {
        this.status = status;
        return this;
    }
    ...
    public UpdateApiV2Response withPublishTime(String publishTime) {
    ...
    public UpdateApiV2Response withRomaAppName(String romaAppName) {
    ...
    public UpdateApiV2Response withLdApiId(String ldApiId) {
    ...
    public UpdateApiV2Response withApiGroupInfo(ApiGroupCommonInfo apiGroupInfo) {
        this.apiGroupInfo = apiGroupInfo;
        return this;
    }

    public UpdateApiV2Response withApiGroupInfo(Consumer<ApiGroupCommonInfo> apiGroupInfoSetter) {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        return Objects.equals(this.name, updateApiV2Response.name)
            ...
            && Objects.equals(this.contentType, updateApiV2Response.contentType)
            ...
            && Objects.equals(this.publishTime, updateApiV2Response.publishTime)
            && Objects.equals(this.romaAppName, updateApiV2Response.romaAppName)
            && Objects.equals(this.ldApiId, updateApiV2Response.ldApiId)
            && Objects.equals(this.backendApi, updateApiV2Response.backendApi)
            && Objects.equals(this.apiGroupInfo, updateApiV2Response.apiGroupInfo)
