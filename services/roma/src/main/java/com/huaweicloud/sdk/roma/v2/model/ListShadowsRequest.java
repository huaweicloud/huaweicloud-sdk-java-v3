...
/** Request Object */
public class ListShadowsRequest {
    ...
    public ListShadowsRequest withInstanceId(String instanceId) {
    ...
    public ListShadowsRequest withDeviceId(Integer deviceId) {
    ...
    public String toString() {
        ...
        sb.append("class ListShadowsRequest {\n");
