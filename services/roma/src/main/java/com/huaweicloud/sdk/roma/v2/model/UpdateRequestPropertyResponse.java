 ...
 * Response Object
 */
public class UpdateRequestPropertyResponse extends SdkResponse {
    ...
    public UpdateRequestPropertyResponse withPropertyId(Integer propertyId) {
    ...
    public UpdateRequestPropertyResponse withPropertyName(String propertyName) {
    ...
    public UpdateRequestPropertyResponse withDescription(String description) {
    ...
    public UpdateRequestPropertyResponse withDataType(DataTypeEnum dataType) {
    ...
    public UpdateRequestPropertyResponse withRequired(RequiredEnum required) {
    ...
    public UpdateRequestPropertyResponse withMin(String min) {
        this.min = min;
        return this;
    }
    ...
    public UpdateRequestPropertyResponse withMax(String max) {
        this.max = max;
        return this;
    }
    ...
    public UpdateRequestPropertyResponse withStep(String step) {
        this.step = step;
        return this;
    }
    ...
    public UpdateRequestPropertyResponse withMaxLength(Integer maxLength) {
    ...
    public UpdateRequestPropertyResponse withUnit(String unit) {
        this.unit = unit;
        return this;
    }
    ...
    public UpdateRequestPropertyResponse withEnumList(String enumList) {
    ...
    public UpdateRequestPropertyResponse withEnumDict(PropertyDataEnum enumDict) {
        this.enumDict = enumDict;
        return this;
    }

    public UpdateRequestPropertyResponse withEnumDict(Consumer<PropertyDataEnum> enumDictSetter) {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        UpdateRequestPropertyResponse updateRequestPropertyResponse = (UpdateRequestPropertyResponse) o;
        return Objects.equals(this.propertyId, updateRequestPropertyResponse.propertyId)
            && Objects.equals(this.propertyName, updateRequestPropertyResponse.propertyName)
            && Objects.equals(this.description, updateRequestPropertyResponse.description)
            && Objects.equals(this.dataType, updateRequestPropertyResponse.dataType)
            && Objects.equals(this.required, updateRequestPropertyResponse.required)
            && Objects.equals(this.min, updateRequestPropertyResponse.min)
            && Objects.equals(this.max, updateRequestPropertyResponse.max)
            && Objects.equals(this.step, updateRequestPropertyResponse.step)
            && Objects.equals(this.maxLength, updateRequestPropertyResponse.maxLength)
            && Objects.equals(this.unit, updateRequestPropertyResponse.unit)
            && Objects.equals(this.enumList, updateRequestPropertyResponse.enumList)
            && Objects.equals(this.enumDict, updateRequestPropertyResponse.enumDict);
    }
    ...
    public String toString() {
        ...
        sb.append("class UpdateRequestPropertyResponse {\n");
