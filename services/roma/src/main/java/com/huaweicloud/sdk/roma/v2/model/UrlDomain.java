...
public class UrlDomain {
    ...
    @JacksonXmlProperty(localName = "cname_status")
    ...
    @JacksonXmlProperty(localName = "ssl_id")
    ...
    @JacksonXmlProperty(localName = "ssl_name")
    ...
    @JacksonXmlProperty(localName = "min_ssl_version")
