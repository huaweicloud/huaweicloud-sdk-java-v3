...
public class MockApiBaseInfo {
    ...
    public MockApiBaseInfo withRemark(String remark) {
        this.remark = remark;
        return this;
    }
    ...
    public MockApiBaseInfo withResultContent(String resultContent) {
    ...
    public MockApiBaseInfo withVersion(String version) {
    ...
    public MockApiBaseInfo withAuthorizerId(String authorizerId) {
    ...
    public MockApiBaseInfo withStatusCode(StatusCodeEnum statusCode) {
    ...
    public MockApiBaseInfo withHeader(List<MockApiBaseInfoHeader> header) {
        this.header = header;
        return this;
    }

    public MockApiBaseInfo addHeaderItem(MockApiBaseInfoHeader headerItem) {
        if (this.header == null) {
    ...
    public MockApiBaseInfo withHeader(Consumer<List<MockApiBaseInfoHeader>> headerSetter) {
        if (this.header == null) {
            this.header = new ArrayList<>();
        }
    ...
    @Override
    public int hashCode() {
        return Objects.hash(remark, resultContent, version, authorizerId, statusCode, header);
    }

    @Override
    public String toString() {
        StringBuilder sb = new StringBuilder();
        sb.append("class MockApiBaseInfo {\n");
