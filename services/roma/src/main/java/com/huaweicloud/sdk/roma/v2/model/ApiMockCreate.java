...
public class ApiMockCreate {
    ...
    public ApiMockCreate withStatusCode(StatusCodeEnum statusCode) {
    ...
    public ApiMockCreate withHeader(List<MockApiBaseInfoHeader> header) {
        this.header = header;
        return this;
    }

    public ApiMockCreate addHeaderItem(MockApiBaseInfoHeader headerItem) {
        if (this.header == null) {
    ...
    public ApiMockCreate withHeader(Consumer<List<MockApiBaseInfoHeader>> headerSetter) {
        if (this.header == null) {
            this.header = new ArrayList<>();
        }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        return Objects.equals(this.remark, apiMockCreate.remark)
            ...
            && Objects.equals(this.statusCode, apiMockCreate.statusCode)
            && Objects.equals(this.header, apiMockCreate.header);
    }
