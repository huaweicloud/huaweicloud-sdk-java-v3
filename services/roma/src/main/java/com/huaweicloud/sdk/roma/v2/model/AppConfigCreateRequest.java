 ...
 */
public class AppConfigCreateRequest  {
    ...
    public AppConfigCreateRequest withConfigType(ConfigTypeEnum configType) {
    ...
    public AppConfigCreateRequest withConfigValue(String configValue) {
    ...
    public AppConfigCreateRequest withDescription(String description) {
    ...
    public AppConfigCreateRequest withConfigName(String configName) {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        AppConfigCreateRequest appConfigCreateRequest = (AppConfigCreateRequest) o;
        return Objects.equals(this.configType, appConfigCreateRequest.configType) &&
            Objects.equals(this.configValue, appConfigCreateRequest.configValue) &&
            Objects.equals(this.description, appConfigCreateRequest.description) &&
            Objects.equals(this.configName, appConfigCreateRequest.configName);
    }
    @Override
    public int hashCode() {
    ...
    public String toString() {
        ...
        sb.append("class AppConfigCreateRequest {\n");
