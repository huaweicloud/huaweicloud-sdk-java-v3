...
import com.huaweicloud.sdk.roma.v2.model.VpcChannelInfo;
import com.huaweicloud.sdk.roma.v2.model.VpcHealthConfigInfo;
...
public class ShowDetailsOfVpcChannelV2Response extends SdkResponse {
    ...
    public ShowDetailsOfVpcChannelV2Response withBalanceStrategy(Integer balanceStrategy) {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(name, type, port, balanceStrategy, memberType, createTime, id, status, elbId, members, vpcHealthConfig);
    }
    @Override
    public String toString() {
