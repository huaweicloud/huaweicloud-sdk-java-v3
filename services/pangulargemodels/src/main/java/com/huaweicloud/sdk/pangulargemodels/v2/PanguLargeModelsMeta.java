...
import com.huaweicloud.sdk.pangulargemodels.v2.model.ChatCompletionReq;
...
import com.huaweicloud.sdk.pangulargemodels.v2.model.TextCompletionReq;
...
public class PanguLargeModelsMeta {
    ...
    private static HttpRequestDef<ExecuteChatCompletionRequest, ExecuteChatCompletionResponse> genForExecuteChatCompletion() {
        ...
        HttpRequestDef.Builder<ExecuteChatCompletionRequest, ExecuteChatCompletionResponse> builder = HttpRequestDef
            ...
            .withUri("/v2/{project_id}/pools/{pool_id}/deployments/{deployment_id}/chat/completions")
        ...
        builder.<String>withRequestField("pool_id",
            ...
            f -> f.withMarshaller(ExecuteChatCompletionRequest::getPoolId, ExecuteChatCompletionRequest::setPoolId));
    ...
    private static HttpRequestDef<ExecuteTextCompletionRequest, ExecuteTextCompletionResponse> genForExecuteTextCompletion() {
        ...
        HttpRequestDef.Builder<ExecuteTextCompletionRequest, ExecuteTextCompletionResponse> builder = HttpRequestDef
            ...
            .withUri("/v2/{project_id}/pools/{pool_id}/deployments/{deployment_id}/text/completions")
            .withContentType("application/json");
        ...
        builder.<String>withRequestField("pool_id",
            ...
            FieldExistence.NON_NULL_NON_EMPTY,
            TypeCasts.uncheckedConversion(String.class),
            f -> f.withMarshaller(ExecuteTextCompletionRequest::getPoolId, ExecuteTextCompletionRequest::setPoolId));
        builder.<String>withRequestField("deployment_id",
            LocationType.Path,
            FieldExistence.NON_NULL_NON_EMPTY,
            TypeCasts.uncheckedConversion(String.class),
