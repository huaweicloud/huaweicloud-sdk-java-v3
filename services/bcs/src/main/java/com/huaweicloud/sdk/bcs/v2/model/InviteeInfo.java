...
public class InviteeInfo {
    ...
    @JacksonXmlProperty(localName = "invitee_id")
    ...
    @JacksonXmlProperty(localName = "invitee_name")
    ...
    @JacksonXmlProperty(localName = "invitee_bcs_name")
    ...
    @JacksonXmlProperty(localName = "invitee_project_id")
