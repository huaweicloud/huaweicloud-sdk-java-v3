...
public class UnfreezeCertRequest {
    ...
    private UnfreezeCertRequestBody body;
    ...
    public UnfreezeCertRequest withBody(UnfreezeCertRequestBody body) {
        this.body = body;
        return this;
    }

    public UnfreezeCertRequest withBody(Consumer<UnfreezeCertRequestBody> bodySetter) {
        if (this.body == null) {
            this.body = new UnfreezeCertRequestBody();
     ...
     * @return body
     */
    public UnfreezeCertRequestBody getBody() {
        return body;
    }

    public void setBody(UnfreezeCertRequestBody body) {
        this.body = body;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        return Objects.equals(this.userName, unfreezeCertRequest.userName)
            ...
            && Objects.equals(this.body, unfreezeCertRequest.body);
    }
