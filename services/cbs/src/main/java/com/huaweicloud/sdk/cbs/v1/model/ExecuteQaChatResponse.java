...
public class ExecuteQaChatResponse extends SdkResponse {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ExecuteQaChatResponse that = (ExecuteQaChatResponse) obj;
        return Objects.equals(this.replyType, that.replyType) && Objects.equals(this.qabotAnswers, that.qabotAnswers)
            && Objects.equals(this.chatAnswers, that.chatAnswers)
            && Objects.equals(this.taskbotAnswers, that.taskbotAnswers)
            && Objects.equals(this.docqaAnswers, that.docqaAnswers)
            && Objects.equals(this.tableqaAnswers, that.tableqaAnswers)
            && Objects.equals(this.sessionId, that.sessionId) && Objects.equals(this.kbqaAnswers, that.kbqaAnswers)
            && Objects.equals(this.requestId, that.requestId);
    }

    @Override
    public int hashCode() {
        return Objects.hash(replyType,
            qabotAnswers,
            chatAnswers,
            taskbotAnswers,
            docqaAnswers,
