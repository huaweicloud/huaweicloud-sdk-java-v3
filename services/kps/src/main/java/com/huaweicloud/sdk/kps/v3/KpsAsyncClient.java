...
public class KpsAsyncClient {
     ...
     */
    public AsyncInvoker<AssociateKeypairRequest, AssociateKeypairResponse> associateKeypairAsyncInvoker(AssociateKeypairRequest request) {
        return new AsyncInvoker<AssociateKeypairRequest, AssociateKeypairResponse>(request, KpsMeta.associateKeypair, hcClient);
    }
     ...
     */
    public AsyncInvoker<DeleteAllFailedTaskRequest, DeleteAllFailedTaskResponse> deleteAllFailedTaskAsyncInvoker(DeleteAllFailedTaskRequest request) {
        return new AsyncInvoker<DeleteAllFailedTaskRequest, DeleteAllFailedTaskResponse>(request, KpsMeta.deleteAllFailedTask, hcClient);
    }
     ...
     */
    public AsyncInvoker<DeleteFailedTaskRequest, DeleteFailedTaskResponse> deleteFailedTaskAsyncInvoker(DeleteFailedTaskRequest request) {
        return new AsyncInvoker<DeleteFailedTaskRequest, DeleteFailedTaskResponse>(request, KpsMeta.deleteFailedTask, hcClient);
    }
     ...
     */
    public AsyncInvoker<DisassociateKeypairRequest, DisassociateKeypairResponse> disassociateKeypairAsyncInvoker(DisassociateKeypairRequest request) {
        return new AsyncInvoker<DisassociateKeypairRequest, DisassociateKeypairResponse>(request, KpsMeta.disassociateKeypair, hcClient);
    }
     ...
     */
    public AsyncInvoker<ListFailedTaskRequest, ListFailedTaskResponse> listFailedTaskAsyncInvoker(ListFailedTaskRequest request) {
        return new AsyncInvoker<ListFailedTaskRequest, ListFailedTaskResponse>(request, KpsMeta.listFailedTask, hcClient);
    }
     ...
     */
    public AsyncInvoker<ListKeypairDetailRequest, ListKeypairDetailResponse> listKeypairDetailAsyncInvoker(ListKeypairDetailRequest request) {
        return new AsyncInvoker<ListKeypairDetailRequest, ListKeypairDetailResponse>(request, KpsMeta.listKeypairDetail, hcClient);
    }
     ...
     */
    public AsyncInvoker<ListKeypairTaskRequest, ListKeypairTaskResponse> listKeypairTaskAsyncInvoker(ListKeypairTaskRequest request) {
        return new AsyncInvoker<ListKeypairTaskRequest, ListKeypairTaskResponse>(request, KpsMeta.listKeypairTask, hcClient);
    }
     ...
     */
    public AsyncInvoker<ListRunningTaskRequest, ListRunningTaskResponse> listRunningTaskAsyncInvoker(ListRunningTaskRequest request) {
        return new AsyncInvoker<ListRunningTaskRequest, ListRunningTaskResponse>(request, KpsMeta.listRunningTask, hcClient);
    }
     ...
     */
    public CompletableFuture<UpdateKeypairDescriptionResponse> updateKeypairDescriptionAsync(UpdateKeypairDescriptionRequest request) {
     ...
     */
    public AsyncInvoker<UpdateKeypairDescriptionRequest, UpdateKeypairDescriptionResponse> updateKeypairDescriptionAsyncInvoker(UpdateKeypairDescriptionRequest request) {
        return new AsyncInvoker<UpdateKeypairDescriptionRequest, UpdateKeypairDescriptionResponse>(request, KpsMeta.updateKeypairDescription, hcClient);
    }
