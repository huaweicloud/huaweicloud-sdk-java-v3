...
public class DisassociateKeypairResponse extends SdkResponse {
    ...
    public DisassociateKeypairResponse withServerId(String serverId) {
    ...
    public DisassociateKeypairResponse withStatus(StatusEnum status) {
        this.status = status;
        return this;
    }
    ...
    public DisassociateKeypairResponse withErrorCode(String errorCode) {
    ...
    public DisassociateKeypairResponse withErrorMsg(String errorMsg) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        DisassociateKeypairResponse that = (DisassociateKeypairResponse) obj;
