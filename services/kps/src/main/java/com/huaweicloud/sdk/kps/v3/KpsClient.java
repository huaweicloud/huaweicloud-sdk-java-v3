...
public class KpsClient {
     ...
     */
    public SyncInvoker<AssociateKeypairRequest, AssociateKeypairResponse> associateKeypairInvoker(AssociateKeypairRequest request) {
        return new SyncInvoker<AssociateKeypairRequest, AssociateKeypairResponse>(request, KpsMeta.associateKeypair, hcClient);
    }
     ...
     */
    public SyncInvoker<DeleteAllFailedTaskRequest, DeleteAllFailedTaskResponse> deleteAllFailedTaskInvoker(DeleteAllFailedTaskRequest request) {
        return new SyncInvoker<DeleteAllFailedTaskRequest, DeleteAllFailedTaskResponse>(request, KpsMeta.deleteAllFailedTask, hcClient);
    }
     ...
     */
    public SyncInvoker<DeleteFailedTaskRequest, DeleteFailedTaskResponse> deleteFailedTaskInvoker(DeleteFailedTaskRequest request) {
        return new SyncInvoker<DeleteFailedTaskRequest, DeleteFailedTaskResponse>(request, KpsMeta.deleteFailedTask, hcClient);
    }
     ...
     */
    public SyncInvoker<DisassociateKeypairRequest, DisassociateKeypairResponse> disassociateKeypairInvoker(DisassociateKeypairRequest request) {
        return new SyncInvoker<DisassociateKeypairRequest, DisassociateKeypairResponse>(request, KpsMeta.disassociateKeypair, hcClient);
    }
     ...
     */
    public SyncInvoker<ListFailedTaskRequest, ListFailedTaskResponse> listFailedTaskInvoker(ListFailedTaskRequest request) {
        return new SyncInvoker<ListFailedTaskRequest, ListFailedTaskResponse>(request, KpsMeta.listFailedTask, hcClient);
    }
     ...
     */
    public SyncInvoker<ListKeypairDetailRequest, ListKeypairDetailResponse> listKeypairDetailInvoker(ListKeypairDetailRequest request) {
        return new SyncInvoker<ListKeypairDetailRequest, ListKeypairDetailResponse>(request, KpsMeta.listKeypairDetail, hcClient);
    }
     ...
     */
    public SyncInvoker<ListKeypairTaskRequest, ListKeypairTaskResponse> listKeypairTaskInvoker(ListKeypairTaskRequest request) {
        return new SyncInvoker<ListKeypairTaskRequest, ListKeypairTaskResponse>(request, KpsMeta.listKeypairTask, hcClient);
    }
     ...
     */
    public SyncInvoker<ListRunningTaskRequest, ListRunningTaskResponse> listRunningTaskInvoker(ListRunningTaskRequest request) {
        return new SyncInvoker<ListRunningTaskRequest, ListRunningTaskResponse>(request, KpsMeta.listRunningTask, hcClient);
    }
     ...
     */
    public SyncInvoker<UpdateKeypairDescriptionRequest, UpdateKeypairDescriptionResponse> updateKeypairDescriptionInvoker(UpdateKeypairDescriptionRequest request) {
        return new SyncInvoker<UpdateKeypairDescriptionRequest, UpdateKeypairDescriptionResponse>(request, KpsMeta.updateKeypairDescription, hcClient);
    }
