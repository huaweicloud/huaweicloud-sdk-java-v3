...
public class ImportPrivateKeyAction {
    ...
    public ImportPrivateKeyAction withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public ImportPrivateKeyAction withUserId(String userId) {
        this.userId = userId;
        return this;
    }
    ...
    public ImportPrivateKeyAction withKeyProtection(KeyProtection keyProtection) {
        this.keyProtection = keyProtection;
        return this;
    }

    public ImportPrivateKeyAction withKeyProtection(Consumer<KeyProtection> keyProtectionSetter) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ImportPrivateKeyAction that = (ImportPrivateKeyAction) obj;
