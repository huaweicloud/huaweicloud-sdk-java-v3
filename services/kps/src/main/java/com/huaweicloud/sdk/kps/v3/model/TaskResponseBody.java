...
public class TaskResponseBody {
    ...
    public TaskResponseBody withTaskId(String taskId) {
        this.taskId = taskId;
        return this;
    }
    ...
    public TaskResponseBody withServerId(String serverId) {
    ...
    public TaskResponseBody withStatus(StatusEnum status) {
        this.status = status;
        return this;
    }
    ...
    public TaskResponseBody withErrorCode(String errorCode) {
    ...
    public TaskResponseBody withErrorMsg(String errorMsg) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        TaskResponseBody that = (TaskResponseBody) obj;
