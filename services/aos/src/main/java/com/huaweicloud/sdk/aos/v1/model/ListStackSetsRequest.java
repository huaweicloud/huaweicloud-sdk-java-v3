 ...
 * Request Object
 */
public class ListStackSetsRequest {
    ...
    public ListStackSetsRequest withFilter(String filter) {
        this.filter = filter;
        return this;
    }
    ...
    public ListStackSetsRequest withSortKey(List<SortKeyEnum> sortKey) {
        this.sortKey = sortKey;
        return this;
    }

    public ListStackSetsRequest addSortKeyItem(SortKeyEnum sortKeyItem) {
    ...
    public ListStackSetsRequest withSortKey(Consumer<List<SortKeyEnum>> sortKeySetter) {
        if (this.sortKey == null) {
            this.sortKey = new ArrayList<>();
        }
    ...
    public ListStackSetsRequest withSortDir(List<SortDirEnum> sortDir) {
        this.sortDir = sortDir;
        return this;
    }

    public ListStackSetsRequest addSortDirItem(SortDirEnum sortDirItem) {
    ...
    public ListStackSetsRequest withSortDir(Consumer<List<SortDirEnum>> sortDirSetter) {
        if (this.sortDir == null) {
            this.sortDir = new ArrayList<>();
        }
    ...
    public ListStackSetsRequest withMarker(String marker) {
        this.marker = marker;
        return this;
    }
    ...
    public ListStackSetsRequest withLimit(Integer limit) {
        this.limit = limit;
        return this;
    }
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        return Objects.equals(this.clientRequestId, that.clientRequestId) && Objects.equals(this.filter, that.filter)
            ...
            && Objects.equals(this.callIdentity, that.callIdentity) && Objects.equals(this.marker, that.marker)
            && Objects.equals(this.limit, that.limit);
    }

    @Override
    public int hashCode() {
        return Objects.hash(clientRequestId, filter, sortKey, sortDir, callIdentity, marker, limit);
    }

    @Override
    public String toString() {
        StringBuilder sb = new StringBuilder();
        sb.append("class ListStackSetsRequest {\n");
