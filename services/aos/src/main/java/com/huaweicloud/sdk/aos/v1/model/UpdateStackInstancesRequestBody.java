...
public class UpdateStackInstancesRequestBody {
    ...
    public UpdateStackInstancesRequestBody withOperationPreferences(OperationPreferences operationPreferences) {
        this.operationPreferences = operationPreferences;
        return this;
    }

    public UpdateStackInstancesRequestBody withOperationPreferences(
    ...
    public UpdateStackInstancesRequestBody withCallIdentity(CallIdentityEnum callIdentity) {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(stackSetId, deploymentTargets, varOverrides, operationPreferences, callIdentity);
    }
