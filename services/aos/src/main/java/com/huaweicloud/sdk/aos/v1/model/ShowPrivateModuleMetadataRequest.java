 ...
 * Request Object
 */
public class ShowPrivateModuleMetadataRequest {
    ...
    public ShowPrivateModuleMetadataRequest withClientRequestId(String clientRequestId) {
    ...
    public ShowPrivateModuleMetadataRequest withModuleName(String moduleName) {
    ...
    public ShowPrivateModuleMetadataRequest withModuleId(String moduleId) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ShowPrivateModuleMetadataRequest that = (ShowPrivateModuleMetadataRequest) obj;
    ...
    @Override
    public int hashCode() {
        return Objects.hash(clientRequestId, moduleName, moduleId);
    }

    @Override
    public String toString() {
        StringBuilder sb = new StringBuilder();
        sb.append("class ShowPrivateModuleMetadataRequest {\n");
