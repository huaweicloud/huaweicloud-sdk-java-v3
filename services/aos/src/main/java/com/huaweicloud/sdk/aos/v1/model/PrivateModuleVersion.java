 ...
 */
public class PrivateModuleVersion {
    ...
    public PrivateModuleVersion withModuleName(String moduleName) {
    ...
    public PrivateModuleVersion withModuleId(String moduleId) {
    ...
    public PrivateModuleVersion withModuleVersion(String moduleVersion) {
    ...
    public PrivateModuleVersion withVersionDescription(String versionDescription) {
    ...
    public PrivateModuleVersion withCreateTime(String createTime) {
    ...
    public PrivateModuleVersion withModuleSource(String moduleSource) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        PrivateModuleVersion that = (PrivateModuleVersion) obj;
    ...
    public String toString() {
        ...
        sb.append("class PrivateModuleVersion {\n");
