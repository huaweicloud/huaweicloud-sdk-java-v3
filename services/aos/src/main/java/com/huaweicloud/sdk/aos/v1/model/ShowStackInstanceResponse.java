 ...
 * Response Object
 */
public class ShowStackInstanceResponse extends SdkResponse {
    ...
    private Object varOverrides;

    public ShowStackInstanceResponse withStackSetId(String stackSetId) {
    ...
    public ShowStackInstanceResponse withStackSetName(String stackSetName) {
    ...
    public ShowStackInstanceResponse withStatus(StatusEnum status) {
        this.status = status;
        return this;
    }
    ...
    public ShowStackInstanceResponse withStatusMessage(String statusMessage) {
    ...
    public ShowStackInstanceResponse withStackId(String stackId) {
    ...
    public ShowStackInstanceResponse withStackName(String stackName) {
    ...
    public ShowStackInstanceResponse withStackDomainId(String stackDomainId) {
    ...
    public ShowStackInstanceResponse withLatestStackSetOperationId(String latestStackSetOperationId) {
    ...
    public ShowStackInstanceResponse withRegion(String region) {
        this.region = region;
        return this;
    }
    ...
    public ShowStackInstanceResponse withCreateTime(String createTime) {
    ...
    public ShowStackInstanceResponse withUpdateTime(String updateTime) {
    ...
    public ShowStackInstanceResponse withVarOverrides(Object varOverrides) {
        this.varOverrides = varOverrides;
        return this;
    }

    public ShowStackInstanceResponse withVarOverrides(Consumer<Object> varOverridesSetter) {
        if (this.varOverrides == null) {
            this.varOverrides = new Object();
     ...
     * @return varOverrides
     */
    public Object getVarOverrides() {
        return varOverrides;
    }

    public void setVarOverrides(Object varOverrides) {
        this.varOverrides = varOverrides;
    }
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ShowStackInstanceResponse that = (ShowStackInstanceResponse) obj;
        return Objects.equals(this.stackSetId, that.stackSetId) && Objects.equals(this.stackSetName, that.stackSetName)
            ...
            && Objects.equals(this.updateTime, that.updateTime) && Objects.equals(this.varOverrides, that.varOverrides);
    }
