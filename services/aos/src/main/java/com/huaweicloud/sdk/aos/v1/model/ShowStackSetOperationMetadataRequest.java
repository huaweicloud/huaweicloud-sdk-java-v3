 ...
 * Request Object
 */
public class ShowStackSetOperationMetadataRequest {
    ...
    public ShowStackSetOperationMetadataRequest withClientRequestId(String clientRequestId) {
    ...
    public ShowStackSetOperationMetadataRequest withStackSetName(String stackSetName) {
    ...
    public ShowStackSetOperationMetadataRequest withStackSetId(String stackSetId) {
    ...
    public ShowStackSetOperationMetadataRequest withStackSetOperationId(String stackSetOperationId) {
    ...
    public ShowStackSetOperationMetadataRequest withCallIdentity(CallIdentityEnum callIdentity) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ShowStackSetOperationMetadataRequest that = (ShowStackSetOperationMetadataRequest) obj;
        return Objects.equals(this.clientRequestId, that.clientRequestId)
            ...
            && Objects.equals(this.stackSetOperationId, that.stackSetOperationId)
            && Objects.equals(this.callIdentity, that.callIdentity);
    }

    @Override
    public int hashCode() {
        return Objects.hash(clientRequestId, stackSetName, stackSetId, stackSetOperationId, callIdentity);
    }

    @Override
    public String toString() {
        StringBuilder sb = new StringBuilder();
        sb.append("class ShowStackSetOperationMetadataRequest {\n");
