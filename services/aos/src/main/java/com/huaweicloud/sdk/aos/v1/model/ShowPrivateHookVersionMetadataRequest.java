...
public class ShowPrivateHookVersionMetadataRequest {
    ...
    public ShowPrivateHookVersionMetadataRequest withClientRequestId(String clientRequestId) {
    ...
    public ShowPrivateHookVersionMetadataRequest withHookName(String hookName) {
    ...
    public ShowPrivateHookVersionMetadataRequest withHookVersion(String hookVersion) {
    ...
    public ShowPrivateHookVersionMetadataRequest withHookId(String hookId) {
        this.hookId = hookId;
        return this;
    }
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ShowPrivateHookVersionMetadataRequest that = (ShowPrivateHookVersionMetadataRequest) obj;
