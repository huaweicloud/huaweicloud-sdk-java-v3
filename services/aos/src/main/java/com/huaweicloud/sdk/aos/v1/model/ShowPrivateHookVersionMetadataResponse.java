 ...
 * Response Object
 */
public class ShowPrivateHookVersionMetadataResponse extends SdkResponse {
    ...
    public ShowPrivateHookVersionMetadataResponse withHookName(String hookName) {
    ...
    public ShowPrivateHookVersionMetadataResponse withHookId(String hookId) {
        this.hookId = hookId;
        return this;
    }
    ...
    public ShowPrivateHookVersionMetadataResponse withHookVersion(String hookVersion) {
    ...
    public ShowPrivateHookVersionMetadataResponse withHookVersionDescription(String hookVersionDescription) {
    ...
    public ShowPrivateHookVersionMetadataResponse withCreateTime(String createTime) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ShowPrivateHookVersionMetadataResponse that = (ShowPrivateHookVersionMetadataResponse) obj;
    ...
    public String toString() {
        ...
        sb.append("class ShowPrivateHookVersionMetadataResponse {\n");
