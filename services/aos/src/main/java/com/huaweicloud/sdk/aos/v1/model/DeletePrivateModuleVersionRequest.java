 ...
 * Request Object
 */
public class DeletePrivateModuleVersionRequest {
    ...
    public DeletePrivateModuleVersionRequest withClientRequestId(String clientRequestId) {
    ...
    public DeletePrivateModuleVersionRequest withModuleName(String moduleName) {
    ...
    public DeletePrivateModuleVersionRequest withModuleVersion(String moduleVersion) {
    ...
    public DeletePrivateModuleVersionRequest withModuleId(String moduleId) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        DeletePrivateModuleVersionRequest that = (DeletePrivateModuleVersionRequest) obj;
    ...
    public String toString() {
        ...
        sb.append("class DeletePrivateModuleVersionRequest {\n");
