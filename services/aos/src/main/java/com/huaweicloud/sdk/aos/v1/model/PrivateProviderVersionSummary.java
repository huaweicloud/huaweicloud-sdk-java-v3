...
public class PrivateProviderVersionSummary {
    ...
    public PrivateProviderVersionSummary withProviderId(String providerId) {
    ...
    public PrivateProviderVersionSummary withProviderName(String providerName) {
    ...
    public PrivateProviderVersionSummary withProviderVersion(String providerVersion) {
    ...
    public PrivateProviderVersionSummary withVersionDescription(String versionDescription) {
    ...
    public PrivateProviderVersionSummary withFunctionGraphUrn(String functionGraphUrn) {
    ...
    public PrivateProviderVersionSummary withCreateTime(String createTime) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        PrivateProviderVersionSummary that = (PrivateProviderVersionSummary) obj;
    ...
    public int hashCode() {
        return Objects
            .hash(providerId, providerName, providerVersion, versionDescription, functionGraphUrn, createTime);
    }
