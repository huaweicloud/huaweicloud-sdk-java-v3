 ...
 * Request Object
 */
public class ShowPrivateProviderVersionMetadataRequest {
    ...
    public ShowPrivateProviderVersionMetadataRequest withClientRequestId(String clientRequestId) {
    ...
    public ShowPrivateProviderVersionMetadataRequest withProviderName(String providerName) {
    ...
    public ShowPrivateProviderVersionMetadataRequest withProviderVersion(String providerVersion) {
    ...
    public ShowPrivateProviderVersionMetadataRequest withProviderId(String providerId) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ShowPrivateProviderVersionMetadataRequest that = (ShowPrivateProviderVersionMetadataRequest) obj;
    ...
    @Override
    public int hashCode() {
        return Objects.hash(clientRequestId, providerName, providerVersion, providerId);
    }

    @Override
    public String toString() {
        StringBuilder sb = new StringBuilder();
        sb.append("class ShowPrivateProviderVersionMetadataRequest {\n");
