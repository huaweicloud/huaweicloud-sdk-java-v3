...
public class LargestKeyPrefix {
    ...
    public LargestKeyPrefix withKeyPrefix(String keyPrefix) {
    ...
    public LargestKeyPrefix withType(TypeEnum type) {
        this.type = type;
        return this;
    }
    ...
    public LargestKeyPrefix withBytes(Integer bytes) {
        this.bytes = bytes;
        return this;
    }
    ...
    public LargestKeyPrefix withNum(Integer num) {
        this.num = num;
        return this;
    }
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        LargestKeyPrefix that = (LargestKeyPrefix) obj;
        return Objects.equals(this.keyPrefix, that.keyPrefix) && Objects.equals(this.type, that.type)
            && Objects.equals(this.bytes, that.bytes) && Objects.equals(this.num, that.num);
    }

    @Override
    public int hashCode() {
        return Objects.hash(keyPrefix, type, bytes, num);
    }

    @Override
    public String toString() {
        StringBuilder sb = new StringBuilder();
        sb.append("class LargestKeyPrefix {\n");
