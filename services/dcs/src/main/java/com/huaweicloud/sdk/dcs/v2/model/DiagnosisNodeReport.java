...
public class DiagnosisNodeReport {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        DiagnosisNodeReport that = (DiagnosisNodeReport) obj;
        return Objects.equals(this.nodeIp, that.nodeIp) && Objects.equals(this.azCode, that.azCode)
            && Objects.equals(this.groupName, that.groupName) && Objects.equals(this.abnormalSum, that.abnormalSum)
            && Objects.equals(this.failedSum, that.failedSum) && Objects.equals(this.role, that.role)
            && Objects.equals(this.diagnosisDimensionList, that.diagnosisDimensionList)
            && Objects.equals(this.commandTimeTakenList, that.commandTimeTakenList);
    }
