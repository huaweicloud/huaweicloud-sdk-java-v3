 ...
 * Response Object
 */
public class UpdateExpireAutoScanConfigResponse extends SdkResponse {
    ...
    public UpdateExpireAutoScanConfigResponse withInstanceId(String instanceId) {
    ...
    public UpdateExpireAutoScanConfigResponse withEnableAutoScan(Boolean enableAutoScan) {
    ...
    public UpdateExpireAutoScanConfigResponse withFirstScanAt(String firstScanAt) {
    ...
    public UpdateExpireAutoScanConfigResponse withInterval(Integer interval) {
    ...
    public UpdateExpireAutoScanConfigResponse withTimeout(Integer timeout) {
    ...
    public UpdateExpireAutoScanConfigResponse withScanKeysCount(Integer scanKeysCount) {
    ...
    public UpdateExpireAutoScanConfigResponse withUpdatedAt(String updatedAt) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        UpdateExpireAutoScanConfigResponse that = (UpdateExpireAutoScanConfigResponse) obj;
