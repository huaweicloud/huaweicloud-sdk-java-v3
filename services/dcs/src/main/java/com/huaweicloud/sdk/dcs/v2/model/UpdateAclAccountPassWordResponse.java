 ...
 * Response Object
 */
public class UpdateAclAccountPassWordResponse extends SdkResponse {
    ...
    public UpdateAclAccountPassWordResponse withLockTime(String lockTime) {
    ...
    public UpdateAclAccountPassWordResponse withResult(ResultEnum result) {
        this.result = result;
        return this;
    }
    ...
    public UpdateAclAccountPassWordResponse withLockTimeLeft(String lockTimeLeft) {
    ...
    public UpdateAclAccountPassWordResponse withRetryTimesLeft(String retryTimesLeft) {
    ...
    public UpdateAclAccountPassWordResponse withMessage(String message) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        UpdateAclAccountPassWordResponse that = (UpdateAclAccountPassWordResponse) obj;
    ...
    public String toString() {
        ...
        sb.append("class UpdateAclAccountPassWordResponse {\n");
