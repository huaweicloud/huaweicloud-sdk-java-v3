 ...
 * Response Object
 */
public class ShowInstanceBandwidthAutoScalingPolicyResponse extends SdkResponse {
    ...
    public ShowInstanceBandwidthAutoScalingPolicyResponse withWindowSize(WindowSizeEnum windowSize) {
    ...
    public ShowInstanceBandwidthAutoScalingPolicyResponse withBandwidthUsageUpperThreshold(
    ...
    public ShowInstanceBandwidthAutoScalingPolicyResponse withScaleOutCooldown(Integer scaleOutCooldown) {
    ...
    public ShowInstanceBandwidthAutoScalingPolicyResponse withScaleInEnabled(Boolean scaleInEnabled) {
    ...
    public ShowInstanceBandwidthAutoScalingPolicyResponse withBandwidthUsageLowerThreshold(
    ...
    public ShowInstanceBandwidthAutoScalingPolicyResponse withScaleInCooldown(Integer scaleInCooldown) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ShowInstanceBandwidthAutoScalingPolicyResponse that = (ShowInstanceBandwidthAutoScalingPolicyResponse) obj;
    ...
    public String toString() {
        ...
        sb.append("class ShowInstanceBandwidthAutoScalingPolicyResponse {\n");
