...
public class BatchDeleteDCSInstancesRequest  {
    ...
    public BatchDeleteDCSInstancesRequest withAllFailure(Boolean allFailure) {
    ...
    public BatchDeleteDCSInstancesRequest withBody(BatchDeleteBody body) {
        this.body = body;
        return this;
    }

    public BatchDeleteDCSInstancesRequest withBody(Consumer<BatchDeleteBody> bodySetter) {
        if(this.body == null ){
    ...
    public boolean equals(java.lang.Object o) {
        ...
        BatchDeleteDCSInstancesRequest batchDeleteDCSInstancesRequest = (BatchDeleteDCSInstancesRequest) o;
        return Objects.equals(this.allFailure, batchDeleteDCSInstancesRequest.allFailure) &&
            Objects.equals(this.body, batchDeleteDCSInstancesRequest.body);
    }
    @Override
    public int hashCode() {
