 ...
 * 带宽弹性伸缩策略。
 */
public class BandwidthAutoScalingPolicy {
    ...
    public BandwidthAutoScalingPolicy withWindowSize(WindowSizeEnum windowSize) {
    ...
    public BandwidthAutoScalingPolicy withBandwidthUsageUpperThreshold(
    ...
    public BandwidthAutoScalingPolicy withScaleOutCooldown(Integer scaleOutCooldown) {
    ...
    public BandwidthAutoScalingPolicy withScaleInEnabled(Boolean scaleInEnabled) {
    ...
    public BandwidthAutoScalingPolicy withBandwidthUsageLowerThreshold(Integer bandwidthUsageLowerThreshold) {
    ...
    public BandwidthAutoScalingPolicy withScaleInCooldown(Integer scaleInCooldown) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        BandwidthAutoScalingPolicy that = (BandwidthAutoScalingPolicy) obj;
    ...
    public String toString() {
        ...
        sb.append("class BandwidthAutoScalingPolicy {\n");
