...
public class ListClientsRequest {
    ...
    public ListClientsRequest withInstanceId(String instanceId) {
    ...
    public ListClientsRequest withNodeId(String nodeId) {
        this.nodeId = nodeId;
        return this;
    }
    ...
    public ListClientsRequest withOffset(Integer offset) {
        this.offset = offset;
        return this;
    }
    ...
    public ListClientsRequest withLimit(Integer limit) {
        this.limit = limit;
        return this;
    }
    ...
    public ListClientsRequest withAddr(String addr) {
        this.addr = addr;
        return this;
    }
    ...
    public ListClientsRequest withSort(String sort) {
        this.sort = sort;
        return this;
    }
    ...
    public ListClientsRequest withOrder(OrderEnum order) {
        this.order = order;
        return this;
    }
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ListClientsRequest that = (ListClientsRequest) obj;
        return Objects.equals(this.instanceId, that.instanceId) && Objects.equals(this.nodeId, that.nodeId)
            && Objects.equals(this.offset, that.offset) && Objects.equals(this.limit, that.limit)
            && Objects.equals(this.addr, that.addr) && Objects.equals(this.sort, that.sort)
            && Objects.equals(this.order, that.order);
    }

    @Override
    public int hashCode() {
        return Objects.hash(instanceId, nodeId, offset, limit, addr, sort, order);
    }
