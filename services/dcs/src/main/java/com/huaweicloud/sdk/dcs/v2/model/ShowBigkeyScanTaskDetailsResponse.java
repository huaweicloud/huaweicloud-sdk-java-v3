...
public class ShowBigkeyScanTaskDetailsResponse extends SdkResponse {
    ...
    public ShowBigkeyScanTaskDetailsResponse withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public ShowBigkeyScanTaskDetailsResponse withNum(String num) {
        this.num = num;
        return this;
    }
    ...
    public ShowBigkeyScanTaskDetailsResponse withKeys(Consumer<List<BigkeysBody>> keysSetter) {
        if(this.keys == null ){
            this.keys = new ArrayList<>();
        }
