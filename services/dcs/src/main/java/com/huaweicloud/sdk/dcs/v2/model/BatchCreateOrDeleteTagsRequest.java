...
public class BatchCreateOrDeleteTagsRequest {
    ...
    private CreateOrDeleteInstanceTags body;

    public BatchCreateOrDeleteTagsRequest withInstanceId(String instanceId) {
    ...
    public BatchCreateOrDeleteTagsRequest withBody(CreateOrDeleteInstanceTags body) {
        this.body = body;
        return this;
    }

    public BatchCreateOrDeleteTagsRequest withBody(Consumer<CreateOrDeleteInstanceTags> bodySetter) {
        if (this.body == null) {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        return Objects.equals(this.instanceId, batchCreateOrDeleteTagsRequest.instanceId)
