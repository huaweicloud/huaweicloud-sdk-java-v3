...
public class InstanceRestoreInfo {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        InstanceRestoreInfo that = (InstanceRestoreInfo) obj;
        return Objects.equals(this.backupId, that.backupId) && Objects.equals(this.restoreId, that.restoreId)
            && Objects.equals(this.backupName, that.backupName) && Objects.equals(this.updatedAt, that.updatedAt)
            && Objects.equals(this.restoreRemark, that.restoreRemark) && Objects.equals(this.createdAt, that.createdAt)
            && Objects.equals(this.progress, that.progress) && Objects.equals(this.errorCode, that.errorCode)
            && Objects.equals(this.restoreName, that.restoreName)
            && Objects.equals(this.backupRemark, that.backupRemark) && Objects.equals(this.status, that.status);
    }
