...
import com.huaweicloud.sdk.dcs.v2.model.DiagnosisReportInfo;
...
public class ListDiagnosisTasksResponse extends SdkResponse {
    ...
    public ListDiagnosisTasksResponse withDiagnosisReportList(Consumer<List<DiagnosisReportInfo>> diagnosisReportListSetter) {
        if(this.diagnosisReportList == null) {
            this.diagnosisReportList = new ArrayList<>();
        }
