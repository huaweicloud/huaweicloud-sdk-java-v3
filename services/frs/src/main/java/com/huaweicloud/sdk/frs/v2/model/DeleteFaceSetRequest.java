 ...
 * Request Object
 */
public class DeleteFaceSetRequest {
    ...
    public DeleteFaceSetRequest withEnterpriseProjectId(String enterpriseProjectId) {
    ...
    public DeleteFaceSetRequest withFaceSetName(String faceSetName) {
    ...
    public String toString() {
        ...
        sb.append("class DeleteFaceSetRequest {\n");
