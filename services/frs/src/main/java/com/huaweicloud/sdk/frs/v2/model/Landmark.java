...
public class Landmark {
    ...
    private List<Map<String, Point>> eyebrowContour = null;
    ...
    public Landmark withEyebrowContour(List<Map<String, Point>> eyebrowContour) {
        this.eyebrowContour = eyebrowContour;
        return this;
    }

    public Landmark addEyebrowContourItem(Map<String, Point> eyebrowContourItem) {
    ...
    public Landmark withEyebrowContour(Consumer<List<Map<String, Point>>> eyebrowContourSetter) {
        if (this.eyebrowContour == null) {
            this.eyebrowContour = new ArrayList<>();
        }
    ...
    public List<Map<String, Point>> getEyebrowContour() {
        return eyebrowContour;
    }

    public void setEyebrowContour(List<Map<String, Point>> eyebrowContour) {
        this.eyebrowContour = eyebrowContour;
    }
