 ...
 * Response Object
 */
public class CompareFaceByFileResponse extends SdkResponse {
    ...
    public CompareFaceByFileResponse withImage1Face(CompareFace image1Face) {
        this.image1Face = image1Face;
        return this;
    }

    public CompareFaceByFileResponse withImage1Face(Consumer<CompareFace> image1FaceSetter) {
    ...
    public CompareFaceByFileResponse withImage2Face(CompareFace image2Face) {
        this.image2Face = image2Face;
        return this;
    }

    public CompareFaceByFileResponse withImage2Face(Consumer<CompareFace> image2FaceSetter) {
    ...
    public CompareFaceByFileResponse withSimilarity(Double similarity) {
    ...
    public CompareFaceByFileResponse withXRequestId(String xRequestId) {
    ...
    public String toString() {
        ...
        sb.append("class CompareFaceByFileResponse {\n");
