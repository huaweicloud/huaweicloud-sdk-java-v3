...
public class DeleteFaceByExternalImageIdResponse extends SdkResponse {
    ...
    public DeleteFaceByExternalImageIdResponse withFaceNumber(Integer faceNumber) {
    ...
    public DeleteFaceByExternalImageIdResponse withFaceSetId(String faceSetId) {
    ...
    public DeleteFaceByExternalImageIdResponse withFaceSetName(String faceSetName) {
    ...
    public DeleteFaceByExternalImageIdResponse withXRequestId(String xRequestId) {
    ...
    public String toString() {
        ...
        sb.append("class DeleteFaceByExternalImageIdResponse {\n");
