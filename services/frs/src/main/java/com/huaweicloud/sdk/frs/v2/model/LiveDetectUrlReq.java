...
public class LiveDetectUrlReq {
    ...
    /** 视频的URL路径，目前仅支持华为云上OBS的URL，且人脸识别服务有权限读取该OBS桶的数据。 开通读取权限的操作请参见[服务授权](zh-cn_topic_0107696818.xml)。视频要求： •
     * 视频Base64编码后大小不超过8MB。 • 限制视频时长1～15秒。 • 建议帧率10fps～30fps。 • 封装格式：mp4、avi、flv、webm、asf、mov。 • 视频编码格式：
     * h261、h263、h264、hevc、vc1、vp8、vp9、wmv3。
     * 
     * @return videoUrl */
