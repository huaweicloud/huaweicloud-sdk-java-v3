 ...
 * Request Object
 */
public class DetectFaceByUrlIntlRequest {
    ...
    public DetectFaceByUrlIntlRequest withEnterpriseProjectId(String enterpriseProjectId) {
    ...
    public DetectFaceByUrlIntlRequest withBody(FaceDetectUrlReq body) {
        this.body = body;
        return this;
    }

    public DetectFaceByUrlIntlRequest withBody(Consumer<FaceDetectUrlReq> bodySetter) {
        if (this.body == null) {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        DetectFaceByUrlIntlRequest detectFaceByUrlIntlRequest = (DetectFaceByUrlIntlRequest) o;
        return Objects.equals(this.enterpriseProjectId, detectFaceByUrlIntlRequest.enterpriseProjectId)
            && Objects.equals(this.body, detectFaceByUrlIntlRequest.body);
    }
    ...
    public String toString() {
        ...
        sb.append("class DetectFaceByUrlIntlRequest {\n");
