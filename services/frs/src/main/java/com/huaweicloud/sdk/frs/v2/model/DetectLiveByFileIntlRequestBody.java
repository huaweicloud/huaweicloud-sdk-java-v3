...
public class DetectLiveByFileIntlRequestBody implements SdkFormDataBody {
    ...
    public DetectLiveByFileIntlRequestBody withVideoFile(FormDataFilePart videoFile) {
    ...
    public DetectLiveByFileIntlRequestBody withActions(String actions) {
    ...
    public DetectLiveByFileIntlRequestBody withActionTime(String actionTime) {
    ...
    public DetectLiveByFileIntlRequestBody withNodThreshold(Double nodThreshold) {
    ...
    public DetectLiveByFileIntlRequestBody withVideoFile(InputStream inputStream, String fileName, String contentType) {
        this.videoFile = new FormDataFilePart(inputStream, fileName).withContentType(contentType);
        return this;
    }

    public DetectLiveByFileIntlRequestBody withVideoFile(InputStream inputStream, String fileName) {
