package com.huaweicloud.sdk.css.v2.region;
...
public class CssRegion {
    ...
    public static final Region CN_SOUTHWEST_2 =
        new Region("cn-southwest-2", "https://css.cn-southwest-2.myhuaweicloud.com");

    public static final Region AP_SOUTHEAST_2 =
        new Region("ap-southeast-2", "https://css.ap-southeast-2.myhuaweicloud.com");

    public static final Region AP_SOUTHEAST_3 =
        new Region("ap-southeast-3", "https://css.ap-southeast-3.myhuaweicloud.com");

    public static final Region AP_SOUTHEAST_1 =
        new Region("ap-southeast-1", "https://css.ap-southeast-1.myhuaweicloud.com");

    public static final Region SA_BRAZIL_1 = new Region("sa-brazil-1", "https://css.sa-brazil-1.myhuaweicloud.com");

    public static final Region NA_MEXICO_1 = new Region("na-mexico-1", "https://css.na-mexico-1.myhuaweicloud.com");

    public static final Region LA_NORTH_2 = new Region("la-north-2", "https://css.la-north-2.myhuaweicloud.com");

    public static final Region AF_SOUTH_1 = new Region("af-south-1", "https://css.af-south-1.myhuaweicloud.com");

    public static final Region LA_SOUTH_2 = new Region("la-south-2", "https://css.la-south-2.myhuaweicloud.com");

    public static final Region CN_SOUTH_2 = new Region("cn-south-2", "https://css.cn-south-2.myhuaweicloud.com");

    public static final Region TR_WEST_1 = new Region("tr-west-1", "https://css.tr-west-1.myhuaweicloud.com");

    public static final Region AP_SOUTHEAST_4 =
        new Region("ap-southeast-4", "https://css.ap-southeast-4.myhuaweicloud.com");
    ...
    public static final Region ME_EAST_1 = new Region("me-east-1", "https://css.me-east-1.myhuaweicloud.com");

    public static final Region AP_SOUTHEAST_5 =
        new Region("ap-southeast-5", "https://css.ap-southeast-5.myhuaweicloud.com");

    public static final Region CN_EAST_4 = new Region("cn-east-4", "https://css.cn-east-4.myhuaweicloud.com");

    public static final Region CN_NORTH_11 = new Region("cn-north-11", "https://css.cn-north-11.myhuaweicloud.com");

    public static final Region CN_NORTH_12 = new Region("cn-north-12", "https://css.cn-north-12.myhuaweicloud.com");

    public static final Region CN_SOUTHWEST_3 =
        new Region("cn-southwest-3", "https://css.cn-southwest-3.myhuaweicloud.com");
