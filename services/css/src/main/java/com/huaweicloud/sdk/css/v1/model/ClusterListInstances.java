...
public class ClusterListInstances {
    ...
    public ClusterListInstances withSubnetId(String subnetId) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        return Objects.equals(this.status, that.status) && Objects.equals(this.type, that.type)
            ...
            && Objects.equals(this.resourceId, that.resourceId) && Objects.equals(this.subnetId, that.subnetId);
    }

    @Override
    public int hashCode() {
        return Objects.hash(status, type, id, name, specCode, azCode, ip, volume, resourceId, subnetId);
    }
