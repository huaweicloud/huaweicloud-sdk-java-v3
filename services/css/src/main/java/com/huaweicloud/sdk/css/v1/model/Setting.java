...
public class Setting {
    ...
    public Setting withWorkers(Integer workers) {
    ...
    public Setting withBatchSize(Integer batchSize) {
    ...
    public Setting withBatchDelayMs(Integer batchDelayMs) {
    ...
    public Setting withQueueType(String queueType) {
    ...
    public Setting withQueueCheckPointWrites(Integer queueCheckPointWrites) {
    ...
    public Setting withQueueMaxBytesMb(Integer queueMaxBytesMb) {
