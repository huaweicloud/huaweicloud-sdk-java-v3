...
public class QueryReq {
    ...
    public QueryReq withInstanceId(String instanceId) {
    ...
    public QueryReq withStartAt(Long startAt) {
    ...
    public QueryReq withEndAt(Long endAt) {
        this.endAt = endAt;
        return this;
    }
    ...
    public QueryReq withNodeId(String nodeId) {
        this.nodeId = nodeId;
        return this;
    }
    ...
    public QueryReq withKeyword(String keyword) {
    ...
    public QueryReq withUserList(String userList) {
    ...
    public QueryReq withDbList(String dbList) {
        this.dbList = dbList;
        return this;
    }
    ...
    public QueryReq withOperationList(String operationList) {
    ...
    public QueryReq withThreadIdList(String threadIdList) {
    ...
    public QueryReq withTrxIdList(String trxIdList) {
    ...
    public QueryReq withStatusList(String statusList) {
    ...
    public QueryReq withSqlTemplateIds(String sqlTemplateIds) {
