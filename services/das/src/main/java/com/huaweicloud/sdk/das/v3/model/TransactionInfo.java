...
public class TransactionInfo {
    ...
    public TransactionInfo withLastSec(Integer lastSec) {
    ...
    public TransactionInfo withWaitLocks(Integer waitLocks) {
    ...
    public TransactionInfo withHoldLocks(Integer holdLocks) {
    ...
    public TransactionInfo withOccurrenceTime(Long occurrenceTime) {
    ...
    public TransactionInfo withDetail(String detail) {
        this.detail = detail;
        return this;
    }
    ...
    public TransactionInfo withCollectTime(Long collectTime) {
