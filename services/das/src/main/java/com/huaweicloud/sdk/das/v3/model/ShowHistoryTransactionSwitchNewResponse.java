 ...
 * Response Object
 */
public class ShowHistoryTransactionSwitchNewResponse extends SdkResponse {
    ...
    public ShowHistoryTransactionSwitchNewResponse withSwitchOn(Boolean switchOn) {
    ...
    public ShowHistoryTransactionSwitchNewResponse withRetentionHours(Long retentionHours) {
    ...
    public ShowHistoryTransactionSwitchNewResponse withCanOpen(Boolean canOpen) {
    ...
    public ShowHistoryTransactionSwitchNewResponse withCantOpenMsg(String cantOpenMsg) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ShowHistoryTransactionSwitchNewResponse that = (ShowHistoryTransactionSwitchNewResponse) obj;
    ...
    public String toString() {
        ...
        sb.append("class ShowHistoryTransactionSwitchNewResponse {\n");
