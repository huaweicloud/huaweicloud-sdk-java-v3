...
public class AddRequestBody {
    ...
    public AddRequestBody withInstanceId(String instanceId) {
    ...
    public AddRequestBody withStartAt(Long startAt) {
    ...
    public AddRequestBody withEndAt(Long endAt) {
        this.endAt = endAt;
        return this;
    }
    ...
    public AddRequestBody withNodeId(String nodeId) {
        this.nodeId = nodeId;
        return this;
    }
    ...
    public AddRequestBody withKeyword(String keyword) {
    ...
    public AddRequestBody withUserList(String userList) {
    ...
    public AddRequestBody withDbList(String dbList) {
        this.dbList = dbList;
        return this;
    }
    ...
    public AddRequestBody withOperationList(String operationList) {
    ...
    public AddRequestBody withThreadIdList(String threadIdList) {
    ...
    public AddRequestBody withTrxIdList(String trxIdList) {
    ...
    public AddRequestBody withStatusList(String statusList) {
    ...
    public AddRequestBody withSqlTemplateIds(String sqlTemplateIds) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        AddRequestBody that = (AddRequestBody) obj;
    ...
    public String toString() {
        ...
        sb.append("class AddRequestBody {\n");
