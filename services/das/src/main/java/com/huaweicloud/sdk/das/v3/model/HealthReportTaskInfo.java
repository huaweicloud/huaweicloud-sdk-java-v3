 ...
 * 健康报告任务信息
 */
public class HealthReportTaskInfo {
    ...
    public HealthReportTaskInfo withTaskId(String taskId) {
        this.taskId = taskId;
        return this;
    }
    ...
    public HealthReportTaskInfo withInstanceId(String instanceId) {
    ...
    public HealthReportTaskInfo withCreateAt(Long createAt) {
    ...
    public HealthReportTaskInfo withReportStatus(String reportStatus) {
    ...
    public HealthReportTaskInfo withRiskCount(Integer riskCount) {
    ...
    public HealthReportTaskInfo withOrigin(String origin) {
        this.origin = origin;
        return this;
    }
    ...
    public HealthReportTaskInfo withStartAt(Long startAt) {
    ...
    public HealthReportTaskInfo withEndAt(Long endAt) {
        this.endAt = endAt;
        return this;
    }
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        HealthReportTaskInfo that = (HealthReportTaskInfo) obj;
    ...
    public String toString() {
        ...
        sb.append("class HealthReportTaskInfo {\n");
