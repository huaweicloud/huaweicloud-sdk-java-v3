 ...
 * Response Object
 */
public class ShowFullDeadLockSwitchNewResponse extends SdkResponse {
    ...
    public ShowFullDeadLockSwitchNewResponse withSwitchOn(Boolean switchOn) {
    ...
    public ShowFullDeadLockSwitchNewResponse withRetentionHours(Long retentionHours) {
    ...
    public ShowFullDeadLockSwitchNewResponse withCanOpen(Boolean canOpen) {
    ...
    public ShowFullDeadLockSwitchNewResponse withCantOpenMsg(String cantOpenMsg) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ShowFullDeadLockSwitchNewResponse that = (ShowFullDeadLockSwitchNewResponse) obj;
    ...
    public String toString() {
        ...
        sb.append("class ShowFullDeadLockSwitchNewResponse {\n");
