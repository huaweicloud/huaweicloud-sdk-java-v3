 ...
 * Response Object
 */
public class ShowMissingIndexSwitchResponse extends SdkResponse {
    ...
    public ShowMissingIndexSwitchResponse withSwitchOn(Boolean switchOn) {
    ...
    public ShowMissingIndexSwitchResponse withRetentionHours(Long retentionHours) {
    ...
    public ShowMissingIndexSwitchResponse withCanOpen(Boolean canOpen) {
    ...
    public ShowMissingIndexSwitchResponse withCantOpenMsg(String cantOpenMsg) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ShowMissingIndexSwitchResponse that = (ShowMissingIndexSwitchResponse) obj;
    ...
    public String toString() {
        ...
        sb.append("class ShowMissingIndexSwitchResponse {\n");
