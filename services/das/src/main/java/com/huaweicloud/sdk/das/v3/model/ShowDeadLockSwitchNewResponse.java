 ...
 * Response Object
 */
public class ShowDeadLockSwitchNewResponse extends SdkResponse {
    ...
    public ShowDeadLockSwitchNewResponse withSuccess(Boolean success) {
    ...
    public ShowDeadLockSwitchNewResponse withSwitchOn(Boolean switchOn) {
    ...
    public ShowDeadLockSwitchNewResponse withRetentionHours(Long retentionHours) {
    ...
    public ShowDeadLockSwitchNewResponse withRetry(Boolean retry) {
        this.retry = retry;
        return this;
    }
    ...
    public ShowDeadLockSwitchNewResponse withErrorMsg(String errorMsg) {
    ...
    public ShowDeadLockSwitchNewResponse withCanOpen(Boolean canOpen) {
    ...
    public ShowDeadLockSwitchNewResponse withCantOpenMsg(String cantOpenMsg) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ShowDeadLockSwitchNewResponse that = (ShowDeadLockSwitchNewResponse) obj;
    ...
    public String toString() {
        ...
        sb.append("class ShowDeadLockSwitchNewResponse {\n");
