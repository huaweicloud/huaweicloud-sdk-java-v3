...
public class SlowLogStatistics {
    ...
    public SlowLogStatistics withExecuteCount(Long executeCount) {
    ...
    public SlowLogStatistics withAvgExecuteTime(Double avgExecuteTime) {
    ...
    public SlowLogStatistics withMaxExecuteTime(Double maxExecuteTime) {
    ...
    public SlowLogStatistics withAvgLockWaitTime(Double avgLockWaitTime) {
    ...
    public SlowLogStatistics withMaxLockWaitTime(Double maxLockWaitTime) {
    ...
    public SlowLogStatistics withAvgRowsExamined(Double avgRowsExamined) {
    ...
    public SlowLogStatistics withMaxRowsExamined(Double maxRowsExamined) {
    ...
    public SlowLogStatistics withAvgRowsSent(Double avgRowsSent) {
    ...
    public SlowLogStatistics withMaxRowsSent(Double maxRowsSent) {
    ...
    public SlowLogStatistics withAvgKeyExamined(Double avgKeyExamined) {
    ...
    public SlowLogStatistics withMaxKeyExamined(Double maxKeyExamined) {
    ...
    public SlowLogStatistics withNodeId(String nodeId) {
        this.nodeId = nodeId;
        return this;
    }
    ...
    public SlowLogStatistics withNodeName(String nodeName) {
    ...
    public SlowLogStatistics withSqlType(String sqlType) {
    ...
    public SlowLogStatistics withDbName(String dbName) {
        this.dbName = dbName;
        return this;
    }
    ...
    public SlowLogStatistics withCollection(String collection) {
    ...
    public SlowLogStatistics withUser(String user) {
        this.user = user;
        return this;
    }
    ...
    public SlowLogStatistics withClient(String client) {
        this.client = client;
        return this;
    }
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        SlowLogStatistics that = (SlowLogStatistics) obj;
