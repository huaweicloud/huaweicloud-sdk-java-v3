...
public class DasConnInfo {
    ...
    @JsonInclude(JsonInclude.Include.NON_NULL)
    @JsonProperty(value = "shared_count")
    ...
    public DasConnInfo withConnectionId(String connectionId) {
    ...
    public DasConnInfo withInstanceId(String instanceId) {
    ...
    public DasConnInfo withInstanceName(String instanceName) {
    ...
    public DasConnInfo withNetworkType(String networkType) {
    ...
    public DasConnInfo withEngineType(String engineType) {
    ...
    public DasConnInfo withDatastoreVersion(String datastoreVersion) {
    ...
    public DasConnInfo withUserName(String userName) {
    ...
    public DasConnInfo withDatabaseName(String databaseName) {
    ...
    public DasConnInfo withIsSavePassword(Boolean isSavePassword) {
    ...
    public DasConnInfo withIpAddress(String ipAddress) {
    ...
    public DasConnInfo withPort(Integer port) {
        this.port = port;
        return this;
    }
    ...
    public DasConnInfo withRemarks(String remarks) {
    ...
    public DasConnInfo withInstanceType(String instanceType) {
    ...
    public DasConnInfo withCreateAt(Long createAt) {
    ...
    public DasConnInfo withStatus(String status) {
        this.status = status;
        return this;
    }
    ...
    public DasConnInfo withSqlRecordFlag(Boolean sqlRecordFlag) {
    ...
    public DasConnInfo withConnShareType(String connShareType) {
    ...
    public DasConnInfo withSharedCount(Integer sharedCount) {
    ...
    public DasConnInfo withServiceType(String serviceType) {
    ...
    public DasConnInfo withSharedUserName(String sharedUserName) {
    ...
    public DasConnInfo withSharedUserId(String sharedUserId) {
    ...
    public DasConnInfo withExpiredTime(Long expiredTime) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        DasConnInfo that = (DasConnInfo) obj;
        return Objects.equals(this.connectionId, that.connectionId) && Objects.equals(this.instanceId, that.instanceId)
            ...
            && Objects.equals(this.remarks, that.remarks) && Objects.equals(this.instanceType, that.instanceType)
            ...
            && Objects.equals(this.connShareType, that.connShareType)
            && Objects.equals(this.sharedCount, that.sharedCount) && Objects.equals(this.serviceType, that.serviceType)
