...
/**
 * ShowAnalysisSessionResultRespTopTransactionDuration
 */
public class ShowAnalysisSessionResultRespTopTransactionDuration {
    ...
    public ShowAnalysisSessionResultRespTopTransactionDuration withSessionId(String sessionId) {
    ...
    public ShowAnalysisSessionResultRespTopTransactionDuration withUser(String user) {
        this.user = user;
        return this;
    }
    ...
    public ShowAnalysisSessionResultRespTopTransactionDuration withHost(String host) {
        this.host = host;
        return this;
    }
    ...
    public ShowAnalysisSessionResultRespTopTransactionDuration withDatabaseName(String databaseName) {
    ...
    public ShowAnalysisSessionResultRespTopTransactionDuration withExecutionStatus(String executionStatus) {
    ...
    public ShowAnalysisSessionResultRespTopTransactionDuration withCommand(String command) {
    ...
    public ShowAnalysisSessionResultRespTopTransactionDuration withSqlStatement(String sqlStatement) {
    ...
    public ShowAnalysisSessionResultRespTopTransactionDuration withStateDuration(String stateDuration) {
    ...
    public ShowAnalysisSessionResultRespTopTransactionDuration withTransactionDuration(String transactionDuration) {
    ...
    public ShowAnalysisSessionResultRespTopTransactionDuration withTransactionId(String transactionId) {
    ...
    public ShowAnalysisSessionResultRespTopTransactionDuration withTransactionLockWaitTime(
        String transactionLockWaitTime) {
    ...
    public ShowAnalysisSessionResultRespTopTransactionDuration withTransactionStatus(String transactionStatus) {
    ...
    public ShowAnalysisSessionResultRespTopTransactionDuration withRowsLockedByTransactions(
        String rowsLockedByTransactions) {
    ...
    public ShowAnalysisSessionResultRespTopTransactionDuration withTablesLockedByTransactions(
    ...
    public ShowAnalysisSessionResultRespTopTransactionDuration withRowsUpdatedByTransactions(
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ShowAnalysisSessionResultRespTopTransactionDuration that =
            (ShowAnalysisSessionResultRespTopTransactionDuration) obj;
    ...
    public String toString() {
        ...
        sb.append("class ShowAnalysisSessionResultRespTopTransactionDuration {\n");
