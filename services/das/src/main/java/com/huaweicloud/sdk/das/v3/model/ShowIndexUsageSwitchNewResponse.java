 ...
 * Response Object
 */
public class ShowIndexUsageSwitchNewResponse extends SdkResponse {
    ...
    public ShowIndexUsageSwitchNewResponse withSwitchOn(Boolean switchOn) {
    ...
    public ShowIndexUsageSwitchNewResponse withRetentionHours(Long retentionHours) {
    ...
    public ShowIndexUsageSwitchNewResponse withCanOpen(Boolean canOpen) {
    ...
    public ShowIndexUsageSwitchNewResponse withCantOpenMsg(String cantOpenMsg) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ShowIndexUsageSwitchNewResponse that = (ShowIndexUsageSwitchNewResponse) obj;
    ...
    public String toString() {
        ...
        sb.append("class ShowIndexUsageSwitchNewResponse {\n");
