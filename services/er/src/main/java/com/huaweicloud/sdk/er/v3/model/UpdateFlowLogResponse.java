...
public class UpdateFlowLogResponse extends SdkResponse {
    ...
    public UpdateFlowLogResponse withFlowLog(FlowLog flowLog) {
        this.flowLog = flowLog;
        return this;
    }

    public UpdateFlowLogResponse withFlowLog(Consumer<FlowLog> flowLogSetter) {
    ...
    public UpdateFlowLogResponse withRequestId(String requestId) {
