 ...
 * Response Object
 */
public class RunTestCaseResponse extends SdkResponse {
    ...
    public RunTestCaseResponse withErrorCode(String errorCode) {
    ...
    public RunTestCaseResponse withErrorMsg(String errorMsg) {
    ...
    public RunTestCaseResponse withErrorDetail(ErrorDetailInfo errorDetail) {
        this.errorDetail = errorDetail;
        return this;
    }

    public RunTestCaseResponse withErrorDetail(Consumer<ErrorDetailInfo> errorDetailSetter) {
    ...
    public String toString() {
        ...
        sb.append("class RunTestCaseResponse {\n");
