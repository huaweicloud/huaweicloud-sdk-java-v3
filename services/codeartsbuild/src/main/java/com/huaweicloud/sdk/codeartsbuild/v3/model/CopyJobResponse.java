...
public class CopyJobResponse extends SdkResponse {
    ...
    public CopyJobResponse withResult(CreateBuildJobResponseBodyResult result) {
        this.result = result;
        return this;
    }

    public CopyJobResponse withResult(Consumer<CreateBuildJobResponseBodyResult> resultSetter) {
        if (this.result == null) {
    ...
    public CopyJobResponse withError(String error) {
        this.error = error;
        return this;
    }
