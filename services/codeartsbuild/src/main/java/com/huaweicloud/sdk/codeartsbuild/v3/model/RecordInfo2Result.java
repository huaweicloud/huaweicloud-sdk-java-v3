 ...
 * 结果
 */
public class RecordInfo2Result {
    ...
    public RecordInfo2Result withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public RecordInfo2Result withBuildProjectId(String buildProjectId) {
    ...
    public RecordInfo2Result withBuildRecordId(String buildRecordId) {
    ...
    public RecordInfo2Result withParentRecordId(String parentRecordId) {
    ...
    public RecordInfo2Result withDevcloudProjectId(String devcloudProjectId) {
    ...
    public RecordInfo2Result withCodeciJobId(String codeciJobId) {
    ...
    public RecordInfo2Result withUserId(String userId) {
        this.userId = userId;
        return this;
    }
    ...
    public RecordInfo2Result withBuildNo(Integer buildNo) {
    ...
    public RecordInfo2Result withDailyBuildNum(String dailyBuildNum) {
    ...
    public RecordInfo2Result withExecutionId(String executionId) {
    ...
    public RecordInfo2Result withRepoName(String repoName) {
    ...
    public RecordInfo2Result withRepoId(String repoId) {
        this.repoId = repoId;
        return this;
    }
    ...
    public RecordInfo2Result withBranch(String branch) {
        this.branch = branch;
        return this;
    }
    ...
    public RecordInfo2Result withTag(String tag) {
        this.tag = tag;
        return this;
    }
    ...
    public RecordInfo2Result withCommit(String commit) {
        this.commit = commit;
        return this;
    }
    ...
    public RecordInfo2Result withCommitMessage(String commitMessage) {
    ...
    public RecordInfo2Result withCommitCreateTime(String commitCreateTime) {
    ...
    public RecordInfo2Result withTriggerType(String triggerType) {
    ...
    public RecordInfo2Result withBuildType(String buildType) {
    ...
    public RecordInfo2Result withStatus(String status) {
        this.status = status;
        return this;
    }
    ...
    public RecordInfo2Result withDomainId(String domainId) {
    ...
    public RecordInfo2Result withCreateTime(String createTime) {
    ...
    public RecordInfo2Result withScheduleTime(String scheduleTime) {
    ...
    public RecordInfo2Result withQueuedTime(String queuedTime) {
    ...
    public RecordInfo2Result withStartTime(String startTime) {
    ...
    public RecordInfo2Result withRunnableTime(String runnableTime) {
    ...
    public RecordInfo2Result withFinishTime(String finishTime) {
    ...
    public RecordInfo2Result withDuration(Integer duration) {
    ...
    public RecordInfo2Result withRecordStatus(String recordStatus) {
    ...
    public RecordInfo2Result withUsePrivateSlave(Integer usePrivateSlave) {
    ...
    public RecordInfo2Result withRegion(String region) {
        this.region = region;
        return this;
    }
    ...
    public RecordInfo2Result withErrMsg(String errMsg) {
        this.errMsg = errMsg;
        return this;
    }
    ...
    public RecordInfo2Result withBuildConfigType(String buildConfigType) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        RecordInfo2Result that = (RecordInfo2Result) obj;
    ...
    public String toString() {
        ...
        sb.append("class RecordInfo2Result {\n");
