...
public class Real3DSubTaskDto {
    ...
    public Real3DSubTaskDto withSubtaskId(String subtaskId) {
    ...
    public Real3DSubTaskDto withTaskId(String taskId) {
        this.taskId = taskId;
        return this;
    }
    ...
    public Real3DSubTaskDto withSubtaskName(String subtaskName) {
    ...
    public Real3DSubTaskDto withTaskName(String taskName) {
    ...
    public Real3DSubTaskDto withWorkspaceId(String workspaceId) {
    ...
    public Real3DSubTaskDto withModelingParams(ModelingParams modelingParams) {
        this.modelingParams = modelingParams;
        return this;
    }

    public Real3DSubTaskDto withModelingParams(Consumer<ModelingParams> modelingParamsSetter) {
    ...
    public Real3DSubTaskDto withSubtaskStatus(String subtaskStatus) {
    ...
    public Real3DSubTaskDto withModelPath(String modelPath) {
    ...
    public Real3DSubTaskDto withRefineProductId(String refineProductId) {
    ...
    public Real3DSubTaskDto withCreateTime(String createTime) {
    ...
    public Real3DSubTaskDto withUpdateTime(String updateTime) {
    ...
    public Real3DSubTaskDto withTenantDomainId(String tenantDomainId) {
    ...
    public Real3DSubTaskDto withCreator(String creator) {
    ...
    public Real3DSubTaskDto withLatestOperator(String latestOperator) {
    ...
    public Real3DSubTaskDto withSubtaskProgress(String subtaskProgress) {
    ...
    public Real3DSubTaskDto withExecStartTime(String execStartTime) {
    ...
    public Real3DSubTaskDto withExecStopTime(String execStopTime) {
    ...
    public Real3DSubTaskDto withFailMessage(String failMessage) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        Real3DSubTaskDto that = (Real3DSubTaskDto) obj;
    ...
    public String toString() {
        ...
        sb.append("class Real3DSubTaskDto {\n");
