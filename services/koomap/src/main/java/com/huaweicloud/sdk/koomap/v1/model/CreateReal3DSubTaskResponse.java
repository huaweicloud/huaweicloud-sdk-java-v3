 ...
 * Response Object
 */
public class CreateReal3DSubTaskResponse extends SdkResponse {
    ...
    public CreateReal3DSubTaskResponse withSubtaskId(String subtaskId) {
    ...
    public CreateReal3DSubTaskResponse withTaskId(String taskId) {
        this.taskId = taskId;
        return this;
    }
    ...
    public CreateReal3DSubTaskResponse withSubtaskName(String subtaskName) {
    ...
    public CreateReal3DSubTaskResponse withTaskName(String taskName) {
    ...
    public CreateReal3DSubTaskResponse withWorkspaceId(String workspaceId) {
    ...
    public CreateReal3DSubTaskResponse withModelingParams(ModelingParams modelingParams) {
        this.modelingParams = modelingParams;
        return this;
    }

    public CreateReal3DSubTaskResponse withModelingParams(Consumer<ModelingParams> modelingParamsSetter) {
    ...
    public CreateReal3DSubTaskResponse withSubtaskStatus(String subtaskStatus) {
    ...
    public CreateReal3DSubTaskResponse withModelPath(String modelPath) {
    ...
    public CreateReal3DSubTaskResponse withRefineProductId(String refineProductId) {
    ...
    public CreateReal3DSubTaskResponse withCreateTime(String createTime) {
    ...
    public CreateReal3DSubTaskResponse withUpdateTime(String updateTime) {
    ...
    public CreateReal3DSubTaskResponse withTenantDomainId(String tenantDomainId) {
    ...
    public CreateReal3DSubTaskResponse withCreator(String creator) {
    ...
    public CreateReal3DSubTaskResponse withLatestOperator(String latestOperator) {
    ...
    public CreateReal3DSubTaskResponse withSubtaskProgress(String subtaskProgress) {
    ...
    public CreateReal3DSubTaskResponse withExecStartTime(String execStartTime) {
    ...
    public CreateReal3DSubTaskResponse withExecStopTime(String execStopTime) {
    ...
    public CreateReal3DSubTaskResponse withFailMessage(String failMessage) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        CreateReal3DSubTaskResponse that = (CreateReal3DSubTaskResponse) obj;
    ...
    public String toString() {
        ...
        sb.append("class CreateReal3DSubTaskResponse {\n");
