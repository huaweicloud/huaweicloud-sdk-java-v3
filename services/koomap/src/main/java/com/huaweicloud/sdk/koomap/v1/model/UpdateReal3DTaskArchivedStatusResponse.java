 ...
 * Response Object
 */
public class UpdateReal3DTaskArchivedStatusResponse extends SdkResponse {
    ...
    public UpdateReal3DTaskArchivedStatusResponse withTaskId(String taskId) {
        this.taskId = taskId;
        return this;
    }
    ...
    public UpdateReal3DTaskArchivedStatusResponse withTaskName(String taskName) {
    ...
    public UpdateReal3DTaskArchivedStatusResponse withTaskType(String taskType) {
    ...
    public UpdateReal3DTaskArchivedStatusResponse withModelingType(String modelingType) {
    ...
    public UpdateReal3DTaskArchivedStatusResponse withTaskDescription(String taskDescription) {
    ...
    public UpdateReal3DTaskArchivedStatusResponse withWorkspaceId(String workspaceId) {
    ...
    public UpdateReal3DTaskArchivedStatusResponse withModelingParams(ModelingParams modelingParams) {
        this.modelingParams = modelingParams;
        return this;
    }

    public UpdateReal3DTaskArchivedStatusResponse withModelingParams(Consumer<ModelingParams> modelingParamsSetter) {
    ...
    public UpdateReal3DTaskArchivedStatusResponse withCoordinateSys(String coordinateSys) {
    ...
    public UpdateReal3DTaskArchivedStatusResponse withHasMarker(Boolean hasMarker) {
    ...
    public UpdateReal3DTaskArchivedStatusResponse withFolderCode(String folderCode) {
    ...
    public UpdateReal3DTaskArchivedStatusResponse withCreateTime(String createTime) {
    ...
    public UpdateReal3DTaskArchivedStatusResponse withUpdateTime(String updateTime) {
    ...
    public UpdateReal3DTaskArchivedStatusResponse withTenantDomainId(String tenantDomainId) {
    ...
    public UpdateReal3DTaskArchivedStatusResponse withCreator(String creator) {
    ...
    public UpdateReal3DTaskArchivedStatusResponse withLatestOperator(String latestOperator) {
    ...
    public UpdateReal3DTaskArchivedStatusResponse withTaskStatus(String taskStatus) {
    ...
    public UpdateReal3DTaskArchivedStatusResponse withCompleteStage(Integer completeStage) {
    ...
    public UpdateReal3DTaskArchivedStatusResponse withTotalStage(Integer totalStage) {
    ...
    public UpdateReal3DTaskArchivedStatusResponse withTaskProgress(String taskProgress) {
    ...
    public UpdateReal3DTaskArchivedStatusResponse withExecStartTime(String execStartTime) {
    ...
    public UpdateReal3DTaskArchivedStatusResponse withExecStopTime(String execStopTime) {
    ...
    public UpdateReal3DTaskArchivedStatusResponse withFailMessage(String failMessage) {
    ...
    public UpdateReal3DTaskArchivedStatusResponse withAtProgress(String atProgress) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        UpdateReal3DTaskArchivedStatusResponse that = (UpdateReal3DTaskArchivedStatusResponse) obj;
    ...
    public String toString() {
        ...
        sb.append("class UpdateReal3DTaskArchivedStatusResponse {\n");
