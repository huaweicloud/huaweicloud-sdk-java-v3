 ...
 * Response Object
 */
public class UpdateReal3DTaskResponse extends SdkResponse {
    ...
    public UpdateReal3DTaskResponse withTaskId(String taskId) {
        this.taskId = taskId;
        return this;
    }
    ...
    public UpdateReal3DTaskResponse withTaskName(String taskName) {
    ...
    public UpdateReal3DTaskResponse withTaskType(String taskType) {
    ...
    public UpdateReal3DTaskResponse withModelingType(String modelingType) {
    ...
    public UpdateReal3DTaskResponse withTaskDescription(String taskDescription) {
    ...
    public UpdateReal3DTaskResponse withWorkspaceId(String workspaceId) {
    ...
    public UpdateReal3DTaskResponse withModelingParams(ModelingParams modelingParams) {
        this.modelingParams = modelingParams;
        return this;
    }

    public UpdateReal3DTaskResponse withModelingParams(Consumer<ModelingParams> modelingParamsSetter) {
    ...
    public UpdateReal3DTaskResponse withCoordinateSys(String coordinateSys) {
    ...
    public UpdateReal3DTaskResponse withHasMarker(Boolean hasMarker) {
    ...
    public UpdateReal3DTaskResponse withFolderCode(String folderCode) {
    ...
    public UpdateReal3DTaskResponse withCreateTime(String createTime) {
    ...
    public UpdateReal3DTaskResponse withUpdateTime(String updateTime) {
    ...
    public UpdateReal3DTaskResponse withTenantDomainId(String tenantDomainId) {
    ...
    public UpdateReal3DTaskResponse withCreator(String creator) {
    ...
    public UpdateReal3DTaskResponse withLatestOperator(String latestOperator) {
    ...
    public UpdateReal3DTaskResponse withTaskStatus(String taskStatus) {
    ...
    public UpdateReal3DTaskResponse withCompleteStage(Integer completeStage) {
    ...
    public UpdateReal3DTaskResponse withTotalStage(Integer totalStage) {
    ...
    public UpdateReal3DTaskResponse withTaskProgress(String taskProgress) {
    ...
    public UpdateReal3DTaskResponse withExecStartTime(String execStartTime) {
    ...
    public UpdateReal3DTaskResponse withExecStopTime(String execStopTime) {
    ...
    public UpdateReal3DTaskResponse withFailMessage(String failMessage) {
    ...
    public UpdateReal3DTaskResponse withAtProgress(String atProgress) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        UpdateReal3DTaskResponse that = (UpdateReal3DTaskResponse) obj;
    ...
    public String toString() {
        ...
        sb.append("class UpdateReal3DTaskResponse {\n");
