...
public class Real3DTaskDto {
    ...
    public Real3DTaskDto withTaskId(String taskId) {
        this.taskId = taskId;
        return this;
    }
    ...
    public Real3DTaskDto withTaskName(String taskName) {
    ...
    public Real3DTaskDto withTaskType(String taskType) {
    ...
    public Real3DTaskDto withModelingType(String modelingType) {
    ...
    public Real3DTaskDto withTaskDescription(String taskDescription) {
    ...
    public Real3DTaskDto withWorkspaceId(String workspaceId) {
    ...
    public Real3DTaskDto withModelingParams(ModelingParams modelingParams) {
        this.modelingParams = modelingParams;
        return this;
    }

    public Real3DTaskDto withModelingParams(Consumer<ModelingParams> modelingParamsSetter) {
    ...
    public Real3DTaskDto withCoordinateSys(String coordinateSys) {
    ...
    public Real3DTaskDto withHasMarker(Boolean hasMarker) {
    ...
    public Real3DTaskDto withFolderCode(String folderCode) {
    ...
    public Real3DTaskDto withCreateTime(String createTime) {
    ...
    public Real3DTaskDto withUpdateTime(String updateTime) {
    ...
    public Real3DTaskDto withTenantDomainId(String tenantDomainId) {
    ...
    public Real3DTaskDto withCreator(String creator) {
    ...
    public Real3DTaskDto withLatestOperator(String latestOperator) {
    ...
    public Real3DTaskDto withTaskStatus(String taskStatus) {
    ...
    public Real3DTaskDto withCompleteStage(Integer completeStage) {
    ...
    public Real3DTaskDto withTotalStage(Integer totalStage) {
    ...
    public Real3DTaskDto withTaskProgress(String taskProgress) {
    ...
    public Real3DTaskDto withExecStartTime(String execStartTime) {
    ...
    public Real3DTaskDto withExecStopTime(String execStopTime) {
    ...
    public Real3DTaskDto withFailMessage(String failMessage) {
    ...
    public Real3DTaskDto withAtProgress(String atProgress) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        Real3DTaskDto that = (Real3DTaskDto) obj;
