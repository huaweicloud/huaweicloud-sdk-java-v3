...
public class WorkspaceDto {
    ...
    public WorkspaceDto withWorkspaceId(String workspaceId) {
    ...
    public WorkspaceDto withWorkspaceName(String workspaceName) {
    ...
    public WorkspaceDto withWorkspaceDescription(String workspaceDescription) {
    ...
    public WorkspaceDto withTenantDomainId(String tenantDomainId) {
    ...
    public WorkspaceDto withCreator(String creator) {
    ...
    public WorkspaceDto withLatestOperator(String latestOperator) {
    ...
    public WorkspaceDto withCreateTime(String createTime) {
    ...
    public WorkspaceDto withUpdateTime(String updateTime) {
    ...
    public WorkspaceDto withStar(Integer star) {
        this.star = star;
        return this;
    }
    ...
    public WorkspaceDto withCanDelete(Boolean canDelete) {
