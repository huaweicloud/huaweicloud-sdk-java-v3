 ...
 * Response Object
 */
public class CreateReal3DTaskResponse extends SdkResponse {
    ...
    public CreateReal3DTaskResponse withTaskId(String taskId) {
        this.taskId = taskId;
        return this;
    }
    ...
    public CreateReal3DTaskResponse withTaskName(String taskName) {
    ...
    public CreateReal3DTaskResponse withTaskType(String taskType) {
    ...
    public CreateReal3DTaskResponse withModelingType(String modelingType) {
    ...
    public CreateReal3DTaskResponse withTaskDescription(String taskDescription) {
    ...
    public CreateReal3DTaskResponse withWorkspaceId(String workspaceId) {
    ...
    public CreateReal3DTaskResponse withModelingParams(ModelingParams modelingParams) {
        this.modelingParams = modelingParams;
        return this;
    }

    public CreateReal3DTaskResponse withModelingParams(Consumer<ModelingParams> modelingParamsSetter) {
    ...
    public CreateReal3DTaskResponse withCoordinateSys(String coordinateSys) {
    ...
    public CreateReal3DTaskResponse withHasMarker(Boolean hasMarker) {
    ...
    public CreateReal3DTaskResponse withFolderCode(String folderCode) {
    ...
    public CreateReal3DTaskResponse withCreateTime(String createTime) {
    ...
    public CreateReal3DTaskResponse withUpdateTime(String updateTime) {
    ...
    public CreateReal3DTaskResponse withTenantDomainId(String tenantDomainId) {
    ...
    public CreateReal3DTaskResponse withCreator(String creator) {
    ...
    public CreateReal3DTaskResponse withLatestOperator(String latestOperator) {
    ...
    public CreateReal3DTaskResponse withTaskStatus(String taskStatus) {
    ...
    public CreateReal3DTaskResponse withCompleteStage(Integer completeStage) {
    ...
    public CreateReal3DTaskResponse withTotalStage(Integer totalStage) {
    ...
    public CreateReal3DTaskResponse withTaskProgress(String taskProgress) {
    ...
    public CreateReal3DTaskResponse withExecStartTime(String execStartTime) {
    ...
    public CreateReal3DTaskResponse withExecStopTime(String execStopTime) {
    ...
    public CreateReal3DTaskResponse withFailMessage(String failMessage) {
    ...
    public CreateReal3DTaskResponse withAtProgress(String atProgress) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        CreateReal3DTaskResponse that = (CreateReal3DTaskResponse) obj;
    ...
    public String toString() {
        ...
        sb.append("class CreateReal3DTaskResponse {\n");
