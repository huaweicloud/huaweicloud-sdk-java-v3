 ...
 * Response Object
 */
public class UpdateCommonWorkspaceResponse extends SdkResponse {
    ...
    public UpdateCommonWorkspaceResponse withWorkspaceId(String workspaceId) {
    ...
    public UpdateCommonWorkspaceResponse withWorkspaceName(String workspaceName) {
    ...
    public UpdateCommonWorkspaceResponse withWorkspaceDescription(String workspaceDescription) {
    ...
    public UpdateCommonWorkspaceResponse withTenantDomainId(String tenantDomainId) {
    ...
    public UpdateCommonWorkspaceResponse withCreator(String creator) {
    ...
    public UpdateCommonWorkspaceResponse withLatestOperator(String latestOperator) {
    ...
    public UpdateCommonWorkspaceResponse withCreateTime(String createTime) {
    ...
    public UpdateCommonWorkspaceResponse withUpdateTime(String updateTime) {
    ...
    public UpdateCommonWorkspaceResponse withStar(Integer star) {
        this.star = star;
        return this;
    }
    ...
    public UpdateCommonWorkspaceResponse withCanDelete(Boolean canDelete) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        UpdateCommonWorkspaceResponse that = (UpdateCommonWorkspaceResponse) obj;
    ...
    public String toString() {
        ...
        sb.append("class UpdateCommonWorkspaceResponse {\n");
