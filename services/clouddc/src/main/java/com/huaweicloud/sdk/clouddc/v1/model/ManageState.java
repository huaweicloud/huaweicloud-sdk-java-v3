...
public class ManageState {
     ...
     */
    public static final ManageState OS_READY = new ManageState("os-ready");
     ...
     */
    public static final ManageState MAINTAIN = new ManageState("maintain");
