...
public class UpdateCondition {
    ...
    public UpdateCondition withEnvironment(Integer environment) {
    ...
    public UpdateCondition withSpace(Integer space) {
        this.space = space;
        return this;
    }
    ...
    public UpdateCondition withTransport(Integer transport) {
    ...
    public UpdateCondition withInstallation(InstallationEnum installation) {
