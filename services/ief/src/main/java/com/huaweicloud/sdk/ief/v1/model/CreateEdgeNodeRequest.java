...
public class CreateEdgeNodeRequest {
    ...
    public CreateEdgeNodeRequest withIefInstanceId(String iefInstanceId) {
    ...
    public CreateEdgeNodeRequest withBody(Node body) {
        this.body = body;
        return this;
    }

    public CreateEdgeNodeRequest withBody(Consumer<Node> bodySetter) {
        if (this.body == null) {
            this.body = new Node();
