 ...
 * Request Object
 */
public class ShowEdgeGroupCertDetailRequest {
    ...
    public ShowEdgeGroupCertDetailRequest withIefInstanceId(String iefInstanceId) {
    ...
    public ShowEdgeGroupCertDetailRequest withGroupId(String groupId) {
    ...
    public ShowEdgeGroupCertDetailRequest withGroupCertId(String groupCertId) {
    ...
    public String toString() {
        ...
        sb.append("class ShowEdgeGroupCertDetailRequest {\n");
