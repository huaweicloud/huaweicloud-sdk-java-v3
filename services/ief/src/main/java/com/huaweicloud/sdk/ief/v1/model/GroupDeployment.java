...
public class GroupDeployment {
    ...
    public GroupDeployment withId(UUID id) {
        this.id = id;
        return this;
    }
    ...
    public GroupDeployment withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public GroupDeployment withDescription(String description) {
    ...
    public GroupDeployment withProjectId(String projectId) {
    ...
    public GroupDeployment withCreatedAt(String createdAt) {
    ...
    public GroupDeployment withUpdatedAt(String updatedAt) {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, name, description, projectId, createdAt, updatedAt);
    }

    @Override
    public String toString() {
        StringBuilder sb = new StringBuilder();
        sb.append("class GroupDeployment {\n");
