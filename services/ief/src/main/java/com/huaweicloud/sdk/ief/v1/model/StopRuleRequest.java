...
public class StopRuleRequest {
    ...
    public StopRuleRequest withIefInstanceId(String iefInstanceId) {
    ...
    public StopRuleRequest withRuleId(String ruleId) {
        this.ruleId = ruleId;
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append("class StopRuleRequest {\n");
