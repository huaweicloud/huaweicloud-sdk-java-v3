...
public class CreateTagRequestBody {
    ...
    public CreateTagRequestBody withTag(ResourceTag tag) {
        this.tag = tag;
        return this;
    }

    public CreateTagRequestBody withTag(Consumer<ResourceTag> tagSetter) {
        if (this.tag == null) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        CreateTagRequestBody that = (CreateTagRequestBody) obj;
