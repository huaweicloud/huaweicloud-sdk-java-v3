...
public class SessionPersistence {
     ...
     * 只有当type为APP_COOKIE时才有效。](tag:hws,hws_hk,ocb,tlf,ctc,hcso,sbc,g42,tm,cmcc,hk-g42,dt,dt_test)
     ...
     * ](tag:hws,hws_hk,ocb,tlf,ctc,hcso,sbc,g42,tm,cmcc,hk-g42,dt,dt_test) [-
     * 当pool的protocol为HTTP、HTTPS时，type只能为HTTP_COOKIE，其他取值会话保持失效。](tag:hcso_dt) [不支持APP_COOKIE，请勿使用。](tag:hcso_dt)
     * 
     * @return type */
    ...
    /** 会话保持的时间。[当type为APP_COOKIE时不生效。](tag:hws,hws_hk,ocb,tlf,ctc,hcso,sbc,g42,tm,cmcc,hk-g42,dt,dt_test)
