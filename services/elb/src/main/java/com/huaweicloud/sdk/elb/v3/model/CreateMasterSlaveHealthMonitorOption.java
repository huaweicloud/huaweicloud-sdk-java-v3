...
public class CreateMasterSlaveHealthMonitorOption {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        CreateMasterSlaveHealthMonitorOption createMasterSlaveHealthMonitorOption =
            (CreateMasterSlaveHealthMonitorOption) o;
        return Objects.equals(this.delay, createMasterSlaveHealthMonitorOption.delay)
            && Objects.equals(this.domainName, createMasterSlaveHealthMonitorOption.domainName)
            && Objects.equals(this.expectedCodes, createMasterSlaveHealthMonitorOption.expectedCodes)
            && Objects.equals(this.httpMethod, createMasterSlaveHealthMonitorOption.httpMethod)
            && Objects.equals(this.maxRetries, createMasterSlaveHealthMonitorOption.maxRetries)
            && Objects.equals(this.maxRetriesDown, createMasterSlaveHealthMonitorOption.maxRetriesDown)
            && Objects.equals(this.monitorPort, createMasterSlaveHealthMonitorOption.monitorPort)
            && Objects.equals(this.name, createMasterSlaveHealthMonitorOption.name)
            && Objects.equals(this.timeout, createMasterSlaveHealthMonitorOption.timeout)
            && Objects.equals(this.type, createMasterSlaveHealthMonitorOption.type)
            && Objects.equals(this.urlPath, createMasterSlaveHealthMonitorOption.urlPath);
    }
