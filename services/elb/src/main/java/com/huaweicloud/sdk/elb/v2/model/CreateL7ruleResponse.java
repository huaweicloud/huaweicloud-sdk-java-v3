...
public class CreateL7ruleResponse extends SdkResponse {
    ...
    public CreateL7ruleResponse withRule(L7ruleV2Resp rule) {
        this.rule = rule;
        return this;
    }

    public CreateL7ruleResponse withRule(Consumer<L7ruleV2Resp> ruleSetter) {
        if(this.rule == null ){
    ...
    public boolean equals(java.lang.Object o) {
        ...
        return Objects.equals(this.rule, createL7ruleResponse.rule);
    }
    @Override
    public int hashCode() {
