...
public class MainJob {
    ...
    public MainJob withStatus(StatusEnum status) {
        this.status = status;
        return this;
    }
    ...
    public MainJob withBeginTime(String beginTime) {
    ...
    public MainJob withEndTime(String endTime) {
    ...
    public MainJob withJobId(String jobId) {
        this.jobId = jobId;
        return this;
    }
    ...
    public MainJob withJobType(String jobType) {
    ...
    public MainJob withErrorCode(String errorCode) {
    ...
    public MainJob withErrorMsg(String errorMsg) {
    ...
    public MainJob withProjectId(String projectId) {
    ...
    public MainJob withResourceId(String resourceId) {
    ...
    public MainJob withSubJobs(List<SubJob> subJobs) {
        this.subJobs = subJobs;
        return this;
    }

    public MainJob addSubJobsItem(SubJob subJobsItem) {
    ...
    public MainJob withSubJobs(Consumer<List<SubJob>> subJobsSetter) {
        if (this.subJobs == null) {
            this.subJobs = new ArrayList<>();
        }
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        return Objects.equals(this.status, that.status) && Objects.equals(this.beginTime, that.beginTime)
            ...
            && Objects.equals(this.resourceId, that.resourceId) && Objects.equals(this.subJobs, that.subJobs);
    }

    @Override
    public int hashCode() {
        return Objects
            .hash(status, beginTime, endTime, jobId, jobType, errorCode, errorMsg, projectId, resourceId, subJobs);
    }

    @Override
    public String toString() {
        StringBuilder sb = new StringBuilder();
        sb.append("class MainJob {\n");
