...
public class ListHealthMonitorsRequest  {
    ...
    public ListHealthMonitorsRequest withEnterpriseProjectId(String enterpriseProjectId) {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(marker, limit, pageReverse, id, monitorPort, domainName, name, delay, maxRetries, adminStateUp, timeout, type, expectedCodes, urlPath, httpMethod, enterpriseProjectId);
    }
    @Override
