...
public class PoolV2Resp  {
    ...
    public PoolV2Resp withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public PoolV2Resp withProjectId(String projectId) {
    ...
    public PoolV2Resp withTenantId(String tenantId) {
    ...
    public PoolV2Resp withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public PoolV2Resp withDescription(String description) {
    ...
    public PoolV2Resp withAdminStateUp(Boolean adminStateUp) {
    ...
    public PoolV2Resp withLoadbalancers(List<ResourceList> loadbalancers) {
        this.loadbalancers = loadbalancers;
        return this;
    }

    
    public PoolV2Resp addLoadbalancersItem(ResourceList loadbalancersItem) {
        this.loadbalancers.add(loadbalancersItem);
        return this;
    }

    public PoolV2Resp withLoadbalancers(Consumer<List<ResourceList>> loadbalancersSetter) {
    ...
    public PoolV2Resp withListeners(List<ResourceList> listeners) {
        this.listeners = listeners;
        return this;
    }

    
    public PoolV2Resp addListenersItem(ResourceList listenersItem) {
        this.listeners.add(listenersItem);
        return this;
    }

    public PoolV2Resp withListeners(Consumer<List<ResourceList>> listenersSetter) {
    ...
    public PoolV2Resp withMembers(List<ResourceList> members) {
        this.members = members;
        return this;
    }

    
    public PoolV2Resp addMembersItem(ResourceList membersItem) {
        this.members.add(membersItem);
        return this;
    }

    public PoolV2Resp withMembers(Consumer<List<ResourceList>> membersSetter) {
    ...
    public PoolV2Resp withHealthmonitorId(String healthmonitorId) {
    ...
    public PoolV2Resp withSessionPersistence(SessionPersistence sessionPersistence) {
        this.sessionPersistence = sessionPersistence;
        return this;
    }

    public PoolV2Resp withSessionPersistence(Consumer<SessionPersistence> sessionPersistenceSetter) {
    ...
    public PoolV2Resp withProtocol(ProtocolEnum protocol) {
    ...
    public PoolV2Resp withLbAlgorithm(LbAlgorithmEnum lbAlgorithm) {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        PoolV2Resp poolV2Resp = (PoolV2Resp) o;
        return Objects.equals(this.id, poolV2Resp.id) &&
            Objects.equals(this.projectId, poolV2Resp.projectId) &&
            Objects.equals(this.tenantId, poolV2Resp.tenantId) &&
            Objects.equals(this.name, poolV2Resp.name) &&
            Objects.equals(this.description, poolV2Resp.description) &&
            Objects.equals(this.adminStateUp, poolV2Resp.adminStateUp) &&
            Objects.equals(this.loadbalancers, poolV2Resp.loadbalancers) &&
            Objects.equals(this.listeners, poolV2Resp.listeners) &&
            Objects.equals(this.members, poolV2Resp.members) &&
            Objects.equals(this.healthmonitorId, poolV2Resp.healthmonitorId) &&
            Objects.equals(this.sessionPersistence, poolV2Resp.sessionPersistence) &&
            Objects.equals(this.protocol, poolV2Resp.protocol) &&
            Objects.equals(this.lbAlgorithm, poolV2Resp.lbAlgorithm);
    }
    @Override
    public int hashCode() {
