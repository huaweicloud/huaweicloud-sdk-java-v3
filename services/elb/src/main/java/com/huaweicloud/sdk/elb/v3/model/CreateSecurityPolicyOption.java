...
public class CreateSecurityPolicyOption {
    ...
    public CreateSecurityPolicyOption withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public CreateSecurityPolicyOption withDescription(String description) {
    ...
    public CreateSecurityPolicyOption withEnterpriseProjectId(String enterpriseProjectId) {
    ...
    public CreateSecurityPolicyOption withProtocols(List<String> protocols) {
        this.protocols = protocols;
        return this;
    }

    public CreateSecurityPolicyOption addProtocolsItem(String protocolsItem) {
    ...
    public CreateSecurityPolicyOption withProtocols(Consumer<List<String>> protocolsSetter) {
        if (this.protocols == null) {
            this.protocols = new ArrayList<>();
        }
    ...
    public CreateSecurityPolicyOption withCiphers(List<CiphersEnum> ciphers) {
        this.ciphers = ciphers;
        return this;
    }

    public CreateSecurityPolicyOption addCiphersItem(CiphersEnum ciphersItem) {
    ...
    public CreateSecurityPolicyOption withCiphers(Consumer<List<CiphersEnum>> ciphersSetter) {
        if (this.ciphers == null) {
            this.ciphers = new ArrayList<>();
        }
    ...
    @Override
    public int hashCode() {
        return Objects.hash(name, description, enterpriseProjectId, protocols, ciphers);
    }
