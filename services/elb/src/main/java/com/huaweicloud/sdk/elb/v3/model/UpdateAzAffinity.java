...
public class UpdateAzAffinity {
    ...
    public UpdateAzAffinity withEnable(Boolean enable) {
        this.enable = enable;
        return this;
    }
    ...
    public UpdateAzAffinity withAzMinimumHealthyMemberPercentage(Integer azMinimumHealthyMemberPercentage) {
    ...
    public UpdateAzAffinity withAzMinimumHealthyMemberCount(Integer azMinimumHealthyMemberCount) {
    ...
    public UpdateAzAffinity withAzUnhealthyFallbackStrategy(String azUnhealthyFallbackStrategy) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        UpdateAzAffinity that = (UpdateAzAffinity) obj;
