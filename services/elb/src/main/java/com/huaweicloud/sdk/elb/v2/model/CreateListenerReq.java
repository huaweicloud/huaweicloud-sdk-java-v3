...
public class CreateListenerReq {
    ...
    public CreateListenerReq withProtectionStatus(ProtectionStatusEnum protectionStatus) {
    ...
    public CreateListenerReq withProtectionReason(String protectionReason) {
