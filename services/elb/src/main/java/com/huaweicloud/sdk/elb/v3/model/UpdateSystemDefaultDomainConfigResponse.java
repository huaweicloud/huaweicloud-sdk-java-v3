 ...
 * Response Object
 */
public class UpdateSystemDefaultDomainConfigResponse extends SdkResponse {
    ...
    public UpdateSystemDefaultDomainConfigResponse withLoadbalancer(
        Consumer<DnsConfigResponseBody> loadbalancerSetter) {
        if (this.loadbalancer == null) {
            this.loadbalancer = new DnsConfigResponseBody();
     ...
     * @return loadbalancer
     */
    public DnsConfigResponseBody getLoadbalancer() {
        return loadbalancer;
    }

    public void setLoadbalancer(DnsConfigResponseBody loadbalancer) {
        this.loadbalancer = loadbalancer;
    }
