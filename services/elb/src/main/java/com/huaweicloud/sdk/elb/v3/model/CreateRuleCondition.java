...
public class CreateRuleCondition {
    ...
    /** 匹配项的名称。[该字段固定为空字符串](tag:dt,dt_test,hcso_dt) [当type为HOST_NAME、PATH、METHOD、SOURCE_IP时，该字段固定为空字符串。
     ...
     * 当type为SOURCE_IP时，key固定为空字符串，value表示请求源地址。value为CIDR格式，支持ipv4，ipv6。例如:
     * 192.168.0.2/32，2049::49/64。](tag:hws,hws_hk,ocb,tlf,ctc,hcso,sbc,g42,tm,cmcc,hk-g42)
     * 
     * @return value */
