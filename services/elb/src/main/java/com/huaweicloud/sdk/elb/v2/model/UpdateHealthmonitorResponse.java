...
public class UpdateHealthmonitorResponse extends SdkResponse {
    ...
    public UpdateHealthmonitorResponse withHealthmonitor(HealthmonitorV2Resp healthmonitor) {
        this.healthmonitor = healthmonitor;
        return this;
    }

    public UpdateHealthmonitorResponse withHealthmonitor(Consumer<HealthmonitorV2Resp> healthmonitorSetter) {
