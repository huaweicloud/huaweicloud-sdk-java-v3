...
public class CreateLoadbalancerResponse extends SdkResponse {
    ...
    public CreateLoadbalancerResponse withLoadbalancer(LoadbalancerV2Resp loadbalancer) {
        this.loadbalancer = loadbalancer;
        return this;
    }

    public CreateLoadbalancerResponse withLoadbalancer(Consumer<LoadbalancerV2Resp> loadbalancerSetter) {
