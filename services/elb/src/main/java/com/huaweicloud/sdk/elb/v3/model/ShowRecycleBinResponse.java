...
public class ShowRecycleBinResponse extends SdkResponse {
    ...
    public ShowRecycleBinResponse withRecycleBin(RecycleBinResponseBody recycleBin) {
        this.recycleBin = recycleBin;
        return this;
    }

    public ShowRecycleBinResponse withRecycleBin(Consumer<RecycleBinResponseBody> recycleBinSetter) {
