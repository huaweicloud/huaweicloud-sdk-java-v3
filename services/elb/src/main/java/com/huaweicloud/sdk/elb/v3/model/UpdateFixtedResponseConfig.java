...
/**
 * 参数解释：固定返回页面的配置。  约束限制： - 当监听器的高级转发策略功能（enhance_l7policy_enable）开启后才会生效，未开启传入该字段会报错。 - 当action为FIXED_RESPONSE时生效。其他action不可指定，否则报错。 [- 共享型负载均衡器下的转发策略不支持该字段，传入会报错。 ](tag:hws,hws_hk,ocb,ctc,g42,tm,cmcc,hk_g42,hws_ocb,hk_vdf,srg,fcs,dt,hk_tm)  [不支持该字段，请勿使用。](tag:hcso_dt)  [荷兰region不支持该字段，请勿使用。](tag:dt,dt_test)
 */
public class UpdateFixtedResponseConfig {
    ...
    public UpdateFixtedResponseConfig withInsertHeadersConfig(UpdateInsertHeadersConfig insertHeadersConfig) {
        this.insertHeadersConfig = insertHeadersConfig;
        return this;
    }

    public UpdateFixtedResponseConfig withInsertHeadersConfig(
    ...
    public UpdateFixtedResponseConfig withRemoveHeadersConfig(UpdateRemoveHeadersConfig removeHeadersConfig) {
        this.removeHeadersConfig = removeHeadersConfig;
        return this;
    }

    public UpdateFixtedResponseConfig withRemoveHeadersConfig(
    ...
    public UpdateFixtedResponseConfig withTrafficLimitConfig(UpdateTrafficLimitConfig trafficLimitConfig) {
        this.trafficLimitConfig = trafficLimitConfig;
        return this;
    }

    public UpdateFixtedResponseConfig withTrafficLimitConfig(
