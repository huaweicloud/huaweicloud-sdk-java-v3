...
public class CreateCertificateResponse extends SdkResponse {
    ...
    public CreateCertificateResponse withSource(String source) {
        this.source = source;
        return this;
    }
    ...
    public CreateCertificateResponse withProtectionStatus(ProtectionStatusEnum protectionStatus) {
    ...
    public CreateCertificateResponse withProtectionReason(String protectionReason) {
