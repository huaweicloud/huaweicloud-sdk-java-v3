...
import com.huaweicloud.sdk.elb.v3.model.UpdatePoolSessionPersistenceOption;
import com.huaweicloud.sdk.elb.v3.model.UpdatePoolSlowStartOption;
...
public class UpdatePoolOption  {
    ...
    public UpdatePoolOption withSessionPersistence(Consumer<UpdatePoolSessionPersistenceOption> sessionPersistenceSetter) {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(adminStateUp, description, lbAlgorithm, name, sessionPersistence, slowStart, memberDeletionProtectionEnable);
    }
    @Override
