...
public class UpdateL7policyV2Req  {
    ...
    public UpdateL7policyV2Req withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public UpdateL7policyV2Req withAdminStateUp(Boolean adminStateUp) {
    ...
    public UpdateL7policyV2Req withDescription(String description) {
    ...
    public UpdateL7policyV2Req withRedirectListenerId(String redirectListenerId) {
    ...
    public UpdateL7policyV2Req withRedirectPoolId(String redirectPoolId) {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        UpdateL7policyV2Req updateL7policyV2Req = (UpdateL7policyV2Req) o;
        return Objects.equals(this.name, updateL7policyV2Req.name) &&
            Objects.equals(this.adminStateUp, updateL7policyV2Req.adminStateUp) &&
            Objects.equals(this.description, updateL7policyV2Req.description) &&
            Objects.equals(this.redirectListenerId, updateL7policyV2Req.redirectListenerId) &&
            Objects.equals(this.redirectPoolId, updateL7policyV2Req.redirectPoolId);
    }
    @Override
    public int hashCode() {
