...
public class MasterSlaveHealthMonitor {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        MasterSlaveHealthMonitor masterSlaveHealthMonitor = (MasterSlaveHealthMonitor) o;
        return Objects.equals(this.adminStateUp, masterSlaveHealthMonitor.adminStateUp)
            && Objects.equals(this.delay, masterSlaveHealthMonitor.delay)
            && Objects.equals(this.domainName, masterSlaveHealthMonitor.domainName)
            && Objects.equals(this.expectedCodes, masterSlaveHealthMonitor.expectedCodes)
            && Objects.equals(this.httpMethod, masterSlaveHealthMonitor.httpMethod)
            && Objects.equals(this.id, masterSlaveHealthMonitor.id)
            && Objects.equals(this.maxRetries, masterSlaveHealthMonitor.maxRetries)
            && Objects.equals(this.maxRetriesDown, masterSlaveHealthMonitor.maxRetriesDown)
            && Objects.equals(this.monitorPort, masterSlaveHealthMonitor.monitorPort)
            && Objects.equals(this.name, masterSlaveHealthMonitor.name)
            && Objects.equals(this.timeout, masterSlaveHealthMonitor.timeout)
            && Objects.equals(this.type, masterSlaveHealthMonitor.type)
            && Objects.equals(this.urlPath, masterSlaveHealthMonitor.urlPath);
    }
