...
public class CertificateResp {
    ...
    public CertificateResp withSource(String source) {
        this.source = source;
        return this;
    }
    ...
    public CertificateResp withProtectionStatus(ProtectionStatusEnum protectionStatus) {
    ...
    public CertificateResp withProtectionReason(String protectionReason) {
