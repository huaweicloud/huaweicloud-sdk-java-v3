...
/** 固定返回页面的配置。当监听器的高级转发策略功能（enhance_l7policy_enable）开启后才会生效，未开启传入该字段会报错。[共享型负载均衡器下的转发策略不支持该字段，传入会报错。](tag:hws,hws_hk,ocb,tlf,ctc,hcso,sbc,g42,tm,cmcc,hk-g42,dt,dt_test)
 * [当action为FIXED_RESPONSE时生效，且为必选字段，其他action不可指定。](tag:hws,ocb,tlf,ctc,hcso,sbc,g42,tm,cmcc,hk-g42)
...
public class CreateFixtedResponseConfig {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        CreateFixtedResponseConfig createFixtedResponseConfig = (CreateFixtedResponseConfig) o;
        return Objects.equals(this.statusCode, createFixtedResponseConfig.statusCode)
            && Objects.equals(this.contentType, createFixtedResponseConfig.contentType)
            && Objects.equals(this.messageBody, createFixtedResponseConfig.messageBody);
    }
