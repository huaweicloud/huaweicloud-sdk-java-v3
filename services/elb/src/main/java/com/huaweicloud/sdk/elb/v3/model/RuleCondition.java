...
public class RuleCondition {
    ...
    public RuleCondition withKey(String key) {
        this.key = key;
        return this;
    }

    /** 匹配项的名称。[该字段固定为空字符串](tag:dt,dt_test,hcso_dt) [匹配项的名称。 当type为HOST_NAME、PATH、METHOD、SOURCE_IP时，该字段固定为空字符串。
    ...
    public RuleCondition withValue(String value) {
        this.value = value;
        return this;
    }
