...
public class ListApiVersionsResponse extends SdkResponse {
    ...
    public ListApiVersionsResponse withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public ListApiVersionsResponse withStatus(StatusEnum status) {
        this.status = status;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        return Objects.equals(this.id, listApiVersionsResponse.id)
            && Objects.equals(this.status, listApiVersionsResponse.status);
    }
