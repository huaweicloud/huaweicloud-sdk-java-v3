...
public class UpdateCertificateResponse extends SdkResponse {
    ...
    public UpdateCertificateResponse withSource(String source) {
        this.source = source;
        return this;
    }
    ...
    public UpdateCertificateResponse withProtectionStatus(ProtectionStatusEnum protectionStatus) {
    ...
    public UpdateCertificateResponse withProtectionReason(String protectionReason) {
