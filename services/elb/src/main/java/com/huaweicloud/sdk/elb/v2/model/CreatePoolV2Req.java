...
public class CreatePoolV2Req  {
    ...
    public CreatePoolV2Req withProtocol(ProtocolEnum protocol) {
    ...
    public CreatePoolV2Req withLbAlgorithm(String lbAlgorithm) {
    ...
    public CreatePoolV2Req withLoadbalancerId(String loadbalancerId) {
    ...
    public CreatePoolV2Req withListenerId(String listenerId) {
    ...
    public CreatePoolV2Req withTenantId(String tenantId) {
    ...
    public CreatePoolV2Req withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public CreatePoolV2Req withDescription(String description) {
    ...
    public CreatePoolV2Req withAdminStateUp(Boolean adminStateUp) {
    ...
    public CreatePoolV2Req withSessionPersistence(SessionPersistence sessionPersistence) {
        this.sessionPersistence = sessionPersistence;
        return this;
    }

    public CreatePoolV2Req withSessionPersistence(Consumer<SessionPersistence> sessionPersistenceSetter) {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        CreatePoolV2Req createPoolV2Req = (CreatePoolV2Req) o;
        return Objects.equals(this.protocol, createPoolV2Req.protocol) &&
            Objects.equals(this.lbAlgorithm, createPoolV2Req.lbAlgorithm) &&
            Objects.equals(this.loadbalancerId, createPoolV2Req.loadbalancerId) &&
            Objects.equals(this.listenerId, createPoolV2Req.listenerId) &&
            Objects.equals(this.tenantId, createPoolV2Req.tenantId) &&
            Objects.equals(this.name, createPoolV2Req.name) &&
            Objects.equals(this.description, createPoolV2Req.description) &&
            Objects.equals(this.adminStateUp, createPoolV2Req.adminStateUp) &&
            Objects.equals(this.sessionPersistence, createPoolV2Req.sessionPersistence);
    }
    @Override
    public int hashCode() {
