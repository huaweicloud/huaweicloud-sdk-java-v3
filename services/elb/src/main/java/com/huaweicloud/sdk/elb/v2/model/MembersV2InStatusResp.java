 ...
 * 后端云服务器对象列表，用于状态树中
 */
public class MembersV2InStatusResp  {
    ...
    public MembersV2InStatusResp withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public MembersV2InStatusResp withAddress(String address) {
    ...
    public MembersV2InStatusResp withProtocolPort(Integer protocolPort) {
    ...
    public MembersV2InStatusResp withOperatingStatus(OperatingStatusEnum operatingStatus) {
    ...
    public MembersV2InStatusResp withProvisioningStatus(String provisioningStatus) {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        MembersV2InStatusResp membersV2InStatusResp = (MembersV2InStatusResp) o;
        return Objects.equals(this.id, membersV2InStatusResp.id) &&
            Objects.equals(this.address, membersV2InStatusResp.address) &&
            Objects.equals(this.protocolPort, membersV2InStatusResp.protocolPort) &&
            Objects.equals(this.operatingStatus, membersV2InStatusResp.operatingStatus) &&
            Objects.equals(this.provisioningStatus, membersV2InStatusResp.provisioningStatus);
    }
    @Override
    public int hashCode() {
    ...
    public String toString() {
        ...
        sb.append("class MembersV2InStatusResp {\n");
