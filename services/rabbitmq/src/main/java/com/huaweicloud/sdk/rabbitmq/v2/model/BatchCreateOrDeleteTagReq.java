...
public class BatchCreateOrDeleteTagReq  {
    ...
    public BatchCreateOrDeleteTagReq withTags(List<CreateInstanceReqTags> tags) {
        this.tags = tags;
        return this;
    }

    
    public BatchCreateOrDeleteTagReq addTagsItem(CreateInstanceReqTags tagsItem) {
        if(this.tags == null) {
    ...
    public BatchCreateOrDeleteTagReq withTags(Consumer<List<CreateInstanceReqTags>> tagsSetter) {
        if(this.tags == null) {
            this.tags = new ArrayList<>();
        }
