...
public class UpdateInstanceReq {
     ...
     * 维护时间窗开始和结束时间必须为指定的时间段，可参考[查询维护时间窗时间段](https://support.huaweicloud.com/api-rabbitmq/ShowMaintainWindows.html)。 -
    ...
    /** RabbitMQ实例绑定的弹性IP地址的id。 如果开启了公网访问功能（即enable_publicip为true），该字段为必选。 获取方法： -
     * 方法1：登录弹性公网IP和带宽的控制台界面，在弹性公网IP的详情页面查的基本信息栏找ID。 - 方法2：通过弹性公网IP的API接口查询，具体操作可参考[查询公网IP
     * ID](https://support.huaweicloud.com/api-eip/eip_api_0003.html)。
     * 
     * @return publicipId */
