...
public class ShowInstanceTagsResponse extends SdkResponse {
    ...
    public ShowInstanceTagsResponse withTags(List<CreateInstanceReqTags> tags) {
        this.tags = tags;
        return this;
    }

    
    public ShowInstanceTagsResponse addTagsItem(CreateInstanceReqTags tagsItem) {
        this.tags.add(tagsItem);
        return this;
    }

    public ShowInstanceTagsResponse withTags(Consumer<List<CreateInstanceReqTags>> tagsSetter) {
        if(this.tags == null ){
