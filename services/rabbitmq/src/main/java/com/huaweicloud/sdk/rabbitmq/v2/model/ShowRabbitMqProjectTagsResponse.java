...
import com.huaweicloud.sdk.rabbitmq.v2.model.ShowProjectTagsRespTags;
...
public class ShowRabbitMqProjectTagsResponse extends SdkResponse {
    ...
    public ShowRabbitMqProjectTagsResponse withTags(List<ShowProjectTagsRespTags> tags) {
        this.tags = tags;
        return this;
    }

    
    public ShowRabbitMqProjectTagsResponse addTagsItem(ShowProjectTagsRespTags tagsItem) {
        if(this.tags == null) {
    ...
    public ShowRabbitMqProjectTagsResponse withTags(Consumer<List<ShowProjectTagsRespTags>> tagsSetter) {
        if(this.tags == null) {
            this.tags = new ArrayList<>();
        }
