...
public class RabbitMQAsyncClient {
    ...
    public AsyncInvoker<BatchRestartOrDeleteInstancesRequest, BatchRestartOrDeleteInstancesResponse> batchRestartOrDeleteInstancesAsyncInvoker(BatchRestartOrDeleteInstancesRequest request) {
        return new AsyncInvoker<BatchRestartOrDeleteInstancesRequest, BatchRestartOrDeleteInstancesResponse>(request, RabbitMQMeta.batchRestartOrDeleteInstances, hcClient);
    }
    ...
    public AsyncInvoker<CreatePostPaidInstanceRequest, CreatePostPaidInstanceResponse> createPostPaidInstanceAsyncInvoker(CreatePostPaidInstanceRequest request) {
        return new AsyncInvoker<CreatePostPaidInstanceRequest, CreatePostPaidInstanceResponse>(request, RabbitMQMeta.createPostPaidInstance, hcClient);
    }
    ...
    public AsyncInvoker<DeleteBackgroundTaskRequest, DeleteBackgroundTaskResponse> deleteBackgroundTaskAsyncInvoker(DeleteBackgroundTaskRequest request) {
        return new AsyncInvoker<DeleteBackgroundTaskRequest, DeleteBackgroundTaskResponse>(request, RabbitMQMeta.deleteBackgroundTask, hcClient);
    }
    ...
    public AsyncInvoker<DeleteInstanceRequest, DeleteInstanceResponse> deleteInstanceAsyncInvoker(DeleteInstanceRequest request) {
        return new AsyncInvoker<DeleteInstanceRequest, DeleteInstanceResponse>(request, RabbitMQMeta.deleteInstance, hcClient);
    }
    ...
    public AsyncInvoker<ListAvailableZonesRequest, ListAvailableZonesResponse> listAvailableZonesAsyncInvoker(ListAvailableZonesRequest request) {
        return new AsyncInvoker<ListAvailableZonesRequest, ListAvailableZonesResponse>(request, RabbitMQMeta.listAvailableZones, hcClient);
    }
    ...
    public AsyncInvoker<ListBackgroundTasksRequest, ListBackgroundTasksResponse> listBackgroundTasksAsyncInvoker(ListBackgroundTasksRequest request) {
        return new AsyncInvoker<ListBackgroundTasksRequest, ListBackgroundTasksResponse>(request, RabbitMQMeta.listBackgroundTasks, hcClient);
    }
    ...
    public AsyncInvoker<ListInstancesDetailsRequest, ListInstancesDetailsResponse> listInstancesDetailsAsyncInvoker(ListInstancesDetailsRequest request) {
        return new AsyncInvoker<ListInstancesDetailsRequest, ListInstancesDetailsResponse>(request, RabbitMQMeta.listInstancesDetails, hcClient);
    }
    ...
    public AsyncInvoker<ListProductsRequest, ListProductsResponse> listProductsAsyncInvoker(ListProductsRequest request) {
        return new AsyncInvoker<ListProductsRequest, ListProductsResponse>(request, RabbitMQMeta.listProducts, hcClient);
    }
    ...
    public AsyncInvoker<ResetPasswordRequest, ResetPasswordResponse> resetPasswordAsyncInvoker(ResetPasswordRequest request) {
        return new AsyncInvoker<ResetPasswordRequest, ResetPasswordResponse>(request, RabbitMQMeta.resetPassword, hcClient);
    }
    ...
    public AsyncInvoker<ResizeInstanceRequest, ResizeInstanceResponse> resizeInstanceAsyncInvoker(ResizeInstanceRequest request) {
        return new AsyncInvoker<ResizeInstanceRequest, ResizeInstanceResponse>(request, RabbitMQMeta.resizeInstance, hcClient);
    }
    ...
    public AsyncInvoker<ShowBackgroundTaskRequest, ShowBackgroundTaskResponse> showBackgroundTaskAsyncInvoker(ShowBackgroundTaskRequest request) {
        return new AsyncInvoker<ShowBackgroundTaskRequest, ShowBackgroundTaskResponse>(request, RabbitMQMeta.showBackgroundTask, hcClient);
    }
    ...
    public AsyncInvoker<ShowInstanceRequest, ShowInstanceResponse> showInstanceAsyncInvoker(ShowInstanceRequest request) {
        return new AsyncInvoker<ShowInstanceRequest, ShowInstanceResponse>(request, RabbitMQMeta.showInstance, hcClient);
    }
    ...
    public AsyncInvoker<ShowInstanceExtendProductInfoRequest, ShowInstanceExtendProductInfoResponse> showInstanceExtendProductInfoAsyncInvoker(ShowInstanceExtendProductInfoRequest request) {
        return new AsyncInvoker<ShowInstanceExtendProductInfoRequest, ShowInstanceExtendProductInfoResponse>(request, RabbitMQMeta.showInstanceExtendProductInfo, hcClient);
    }
    ...
    public AsyncInvoker<ShowMaintainWindowsRequest, ShowMaintainWindowsResponse> showMaintainWindowsAsyncInvoker(ShowMaintainWindowsRequest request) {
        return new AsyncInvoker<ShowMaintainWindowsRequest, ShowMaintainWindowsResponse>(request, RabbitMQMeta.showMaintainWindows, hcClient);
    }
    ...
    public AsyncInvoker<UpdateInstanceRequest, UpdateInstanceResponse> updateInstanceAsyncInvoker(UpdateInstanceRequest request) {
        return new AsyncInvoker<UpdateInstanceRequest, UpdateInstanceResponse>(request, RabbitMQMeta.updateInstance, hcClient);
    }
     ...
     */
    public AsyncInvoker<UpdatePluginsRequest, UpdatePluginsResponse> updatePluginsAsyncInvoker(UpdatePluginsRequest request) {
        return new AsyncInvoker<UpdatePluginsRequest, UpdatePluginsResponse>(request, RabbitMQMeta.updatePlugins, hcClient);
    }
