...
public class CreateQueueResponse extends SdkResponse {
    ...
    public CreateQueueResponse withAutoDelete(Boolean autoDelete) {
    ...
    public CreateQueueResponse withDurable(Boolean durable) {
    ...
    public CreateQueueResponse withDeadLetterExchange(String deadLetterExchange) {
    ...
    public CreateQueueResponse withDeadLetterRoutingKey(String deadLetterRoutingKey) {
    ...
    public CreateQueueResponse withMessageTtl(Long messageTtl) {
    ...
    public CreateQueueResponse withLazyMode(String lazyMode) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        CreateQueueResponse that = (CreateQueueResponse) obj;
