...
public class UpdateInstanceRequest  {
    ...
    private UpdateInstanceReq body = null;
    ...
    public UpdateInstanceRequest withBody(UpdateInstanceReq body) {
        this.body = body;
        return this;
    }

    public UpdateInstanceRequest withBody(Consumer<UpdateInstanceReq> bodySetter) {
        if(this.body == null ){
            this.body = new UpdateInstanceReq();
     ...
     * @return body
     */
    public UpdateInstanceReq getBody() {
        return body;
    }

    public void setBody(UpdateInstanceReq body) {
        this.body = body;
    }
    @Override
