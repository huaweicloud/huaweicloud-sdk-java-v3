...
public class UpdateAclRuleRequest {
    ...
    public UpdateAclRuleRequest withAclRuleId(String aclRuleId) {
    ...
    public UpdateAclRuleRequest withEnterpriseProjectId(String enterpriseProjectId) {
    ...
    public UpdateAclRuleRequest withFwInstanceId(String fwInstanceId) {
    ...
    public UpdateAclRuleRequest withBody(UpdateRuleAclDto body) {
        this.body = body;
        return this;
    }

    public UpdateAclRuleRequest withBody(Consumer<UpdateRuleAclDto> bodySetter) {
        if (this.body == null) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        UpdateAclRuleRequest that = (UpdateAclRuleRequest) obj;
