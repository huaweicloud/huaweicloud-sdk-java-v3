...
public class ChangeIpsSwitchStatusRequest {
    ...
    public ChangeIpsSwitchStatusRequest withEnterpriseProjectId(String enterpriseProjectId) {
    ...
    public ChangeIpsSwitchStatusRequest withFwInstanceId(String fwInstanceId) {
    ...
    public ChangeIpsSwitchStatusRequest withBody(Consumer<IpsSwitchDTO> bodySetter) {
        if (this.body == null) {
