...
public class AddAddressItemsUsingPostRequest {
    ...
    public AddAddressItemsUsingPostRequest withEnterpriseProjectId(String enterpriseProjectId) {
    ...
    public AddAddressItemsUsingPostRequest withFwInstanceId(String fwInstanceId) {
