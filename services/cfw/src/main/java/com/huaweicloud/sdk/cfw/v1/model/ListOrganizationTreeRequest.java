...
public class ListOrganizationTreeRequest {
    ...
    public ListOrganizationTreeRequest withFwInstanceId(String fwInstanceId) {
    ...
    public ListOrganizationTreeRequest withParentId(String parentId) {
    ...
    public ListOrganizationTreeRequest withLimit(Integer limit) {
        this.limit = limit;
        return this;
    }
    ...
    public ListOrganizationTreeRequest withMarker(String marker) {
        this.marker = marker;
        return this;
    }
