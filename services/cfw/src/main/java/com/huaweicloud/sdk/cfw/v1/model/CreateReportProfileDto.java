...
public class CreateReportProfileDto {
    ...
    public CreateReportProfileDto withCategory(CategoryEnum category) {
    ...
    public CreateReportProfileDto withDescription(String description) {
    ...
    public CreateReportProfileDto withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public CreateReportProfileDto withSendPeriod(Integer sendPeriod) {
    ...
    public CreateReportProfileDto withSendWeekDay(Integer sendWeekDay) {
    ...
    public CreateReportProfileDto withStatisticPeriod(StatisticPeriod statisticPeriod) {
        this.statisticPeriod = statisticPeriod;
        return this;
    }

    public CreateReportProfileDto withStatisticPeriod(Consumer<StatisticPeriod> statisticPeriodSetter) {
    ...
    public CreateReportProfileDto withStatus(StatusEnum status) {
        this.status = status;
        return this;
    }
    ...
    public CreateReportProfileDto withTopicUrn(String topicUrn) {
    ...
    public CreateReportProfileDto withSubscriptionType(SubscriptionTypeEnum subscriptionType) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        CreateReportProfileDto that = (CreateReportProfileDto) obj;
