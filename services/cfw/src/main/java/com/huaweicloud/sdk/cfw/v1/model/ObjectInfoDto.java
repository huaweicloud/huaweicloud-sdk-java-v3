...
public class ObjectInfoDto {
    ...
    public ObjectInfoDto withDescription(String description) {
    ...
    public ObjectInfoDto withFwInstanceId(String fwInstanceId) {
    ...
    public ObjectInfoDto withItemId(String itemId) {
        this.itemId = itemId;
        return this;
    }
    ...
    public ObjectInfoDto withSetId(String setId) {
        this.setId = setId;
        return this;
    }
    ...
    public ObjectInfoDto withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ObjectInfoDto that = (ObjectInfoDto) obj;
        return Objects.equals(this.description, that.description)
            && Objects.equals(this.fwInstanceId, that.fwInstanceId) && Objects.equals(this.itemId, that.itemId)
            && Objects.equals(this.setId, that.setId) && Objects.equals(this.type, that.type);
    }

    @Override
    public int hashCode() {
        return Objects.hash(description, fwInstanceId, itemId, setId, type);
    }
