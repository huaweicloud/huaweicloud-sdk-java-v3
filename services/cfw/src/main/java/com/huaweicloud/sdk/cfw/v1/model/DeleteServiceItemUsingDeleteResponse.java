...
public class DeleteServiceItemUsingDeleteResponse extends SdkResponse {
    ...
    public DeleteServiceItemUsingDeleteResponse withData(IdObject data) {
        this.data = data;
        return this;
    }

    public DeleteServiceItemUsingDeleteResponse withData(Consumer<IdObject> dataSetter) {
        if (this.data == null) {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        DeleteServiceItemUsingDeleteResponse deleteServiceItemUsingDeleteResponse =
            (DeleteServiceItemUsingDeleteResponse) o;
        return Objects.equals(this.data, deleteServiceItemUsingDeleteResponse.data);
    }
