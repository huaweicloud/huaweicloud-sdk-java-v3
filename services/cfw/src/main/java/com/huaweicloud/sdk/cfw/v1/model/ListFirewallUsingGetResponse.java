...
public class ListFirewallUsingGetResponse extends SdkResponse {
    ...
    */
    ...
    public ListFirewallUsingGetResponse withFwInstanceId(String fwInstanceId) {
    ...
    public ListFirewallUsingGetResponse withResourceId(String resourceId) {
    ...
    public ListFirewallUsingGetResponse withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public ListFirewallUsingGetResponse withHaType(Integer haType) {
        this.haType = haType;
        return this;
    }
    ...
    public ListFirewallUsingGetResponse withChargeMode(Integer chargeMode) {
    ...
    public ListFirewallUsingGetResponse withServiceType(Integer serviceType) {
    ...
    public ListFirewallUsingGetResponse withEngineType(String engineType) {
    ...
    public ListFirewallUsingGetResponse withFlavor(Flavor flavor) {
        this.flavor = flavor;
        return this;
    }

    public ListFirewallUsingGetResponse withFlavor(Consumer<Flavor> flavorSetter) {
        if (this.flavor == null) {
    ...
    public ListFirewallUsingGetResponse withProtectObjects(List<ProtectObjectVO> protectObjects) {
        this.protectObjects = protectObjects;
        return this;
    }

    public ListFirewallUsingGetResponse addProtectObjectsItem(ProtectObjectVO protectObjectsItem) {
    ...
    public ListFirewallUsingGetResponse withProtectObjects(Consumer<List<ProtectObjectVO>> protectObjectsSetter) {
        if (this.protectObjects == null) {
            this.protectObjects = new ArrayList<>();
        }
    ...
    public ListFirewallUsingGetResponse withStatus(StatusEnum status) {
        this.status = status;
        return this;
    }
    ...
    public ListFirewallUsingGetResponse withDescription(String description) {
    ...
    public ListFirewallUsingGetResponse withIsOldFirewallInstance(Boolean isOldFirewallInstance) {
    ...
    public ListFirewallUsingGetResponse withSupportIpv6(Boolean supportIpv6) {
    ...
    public ListFirewallUsingGetResponse withFeatureToggle(Map<String, Boolean> featureToggle) {
        this.featureToggle = featureToggle;
        return this;
    }

    public ListFirewallUsingGetResponse putFeatureToggleItem(String key, Boolean featureToggleItem) {
    ...
    public ListFirewallUsingGetResponse withFeatureToggle(Consumer<Map<String, Boolean>> featureToggleSetter) {
        if (this.featureToggle == null) {
            this.featureToggle = new HashMap<>();
        }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        return Objects.equals(this.fwInstanceId, listFirewallUsingGetResponse.fwInstanceId)
            && Objects.equals(this.resourceId, listFirewallUsingGetResponse.resourceId)
            && Objects.equals(this.name, listFirewallUsingGetResponse.name)
            && Objects.equals(this.haType, listFirewallUsingGetResponse.haType)
            && Objects.equals(this.chargeMode, listFirewallUsingGetResponse.chargeMode)
            && Objects.equals(this.serviceType, listFirewallUsingGetResponse.serviceType)
            && Objects.equals(this.engineType, listFirewallUsingGetResponse.engineType)
            && Objects.equals(this.flavor, listFirewallUsingGetResponse.flavor)
            && Objects.equals(this.protectObjects, listFirewallUsingGetResponse.protectObjects)
            && Objects.equals(this.status, listFirewallUsingGetResponse.status)
            && Objects.equals(this.description, listFirewallUsingGetResponse.description)
            && Objects.equals(this.isOldFirewallInstance, listFirewallUsingGetResponse.isOldFirewallInstance)
            && Objects.equals(this.supportIpv6, listFirewallUsingGetResponse.supportIpv6)
            && Objects.equals(this.featureToggle, listFirewallUsingGetResponse.featureToggle);
    }
