...
public class ListServiceSetDetailsRequest {
    ...
    public ListServiceSetDetailsRequest withEnterpriseProjectId(String enterpriseProjectId) {
    ...
    public ListServiceSetDetailsRequest withFwInstanceId(String fwInstanceId) {
