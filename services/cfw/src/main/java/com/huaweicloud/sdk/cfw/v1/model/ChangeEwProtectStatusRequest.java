...
public class ChangeEwProtectStatusRequest {
    ...
    public ChangeEwProtectStatusRequest withEnterpriseProjectId(String enterpriseProjectId) {
    ...
    public ChangeEwProtectStatusRequest withFwInstanceId(String fwInstanceId) {
