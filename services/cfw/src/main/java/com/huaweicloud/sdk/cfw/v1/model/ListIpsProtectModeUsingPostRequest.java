...
public class ListIpsProtectModeUsingPostRequest {
    ...
    public ListIpsProtectModeUsingPostRequest withEnterpriseProjectId(String enterpriseProjectId) {
    ...
    public ListIpsProtectModeUsingPostRequest withFwInstanceId(String fwInstanceId) {
