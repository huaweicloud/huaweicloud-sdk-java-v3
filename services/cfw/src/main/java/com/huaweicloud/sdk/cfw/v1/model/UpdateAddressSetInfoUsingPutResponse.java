 ...
 * Response Object
 */
public class UpdateAddressSetInfoUsingPutResponse extends SdkResponse {
    ...
    public UpdateAddressSetInfoUsingPutResponse withData(IdObject data) {
        this.data = data;
        return this;
    }

    public UpdateAddressSetInfoUsingPutResponse withData(Consumer<IdObject> dataSetter) {
        if (this.data == null) {
    ...
    public String toString() {
        ...
        sb.append("class UpdateAddressSetInfoUsingPutResponse {\n");
