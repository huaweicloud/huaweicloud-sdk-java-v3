...
public class ListServiceItemsDetailsRequest {
    ...
    public ListServiceItemsDetailsRequest withSetId(String setId) {
        this.setId = setId;
        return this;
    }
    ...
    public ListServiceItemsDetailsRequest withKeyWord(String keyWord) {
    ...
    public ListServiceItemsDetailsRequest withLimit(Integer limit) {
        this.limit = limit;
        return this;
    }
    ...
    public ListServiceItemsDetailsRequest withOffset(Integer offset) {
        this.offset = offset;
        return this;
    }
    ...
    public ListServiceItemsDetailsRequest withEnterpriseProjectId(String enterpriseProjectId) {
    ...
    public ListServiceItemsDetailsRequest withFwInstanceId(String fwInstanceId) {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(setId, keyWord, limit, offset, enterpriseProjectId, fwInstanceId);
    }
