 ...
 * Request Object
 */
public class ListFlowStatisticRequest {
    ...
    public ListFlowStatisticRequest withFwInstanceId(String fwInstanceId) {
    ...
    public ListFlowStatisticRequest withRange(RangeEnum range) {
        this.range = range;
        return this;
    }
    ...
    public ListFlowStatisticRequest withLogType(LogTypeEnum logType) {
    ...
    public ListFlowStatisticRequest withDirection(DirectionEnum direction) {
    ...
    public ListFlowStatisticRequest withStartTime(Long startTime) {
    ...
    public ListFlowStatisticRequest withEndTime(Long endTime) {
    ...
    public ListFlowStatisticRequest withVgwId(List<String> vgwId) {
        this.vgwId = vgwId;
        return this;
    }

    public ListFlowStatisticRequest addVgwIdItem(String vgwIdItem) {
        if (this.vgwId == null) {
    ...
    public ListFlowStatisticRequest withVgwId(Consumer<List<String>> vgwIdSetter) {
        if (this.vgwId == null) {
            this.vgwId = new ArrayList<>();
        }
    ...
    public ListFlowStatisticRequest withAssetType(AssetTypeEnum assetType) {
    ...
    public ListFlowStatisticRequest withItem(ItemEnum item) {
        this.item = item;
        return this;
    }
    ...
    public ListFlowStatisticRequest withSize(Integer size) {
        this.size = size;
        return this;
    }
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ListFlowStatisticRequest that = (ListFlowStatisticRequest) obj;
        return Objects.equals(this.fwInstanceId, that.fwInstanceId) && Objects.equals(this.range, that.range)
            ...
            && Objects.equals(this.item, that.item) && Objects.equals(this.size, that.size);
    }

    @Override
    public int hashCode() {
        return Objects.hash(fwInstanceId, range, logType, direction, startTime, endTime, vgwId, assetType, item, size);
    }

    @Override
    public String toString() {
        StringBuilder sb = new StringBuilder();
        sb.append("class ListFlowStatisticRequest {\n");
