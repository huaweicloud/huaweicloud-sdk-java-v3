...
public class ListAddressItemsUsingGetRequest {
    ...
    public ListAddressItemsUsingGetRequest withSetId(String setId) {
        this.setId = setId;
        return this;
    }
    ...
    public ListAddressItemsUsingGetRequest withKeyWord(String keyWord) {
    ...
    public ListAddressItemsUsingGetRequest withLimit(Integer limit) {
        this.limit = limit;
        return this;
    }
    ...
    public ListAddressItemsUsingGetRequest withOffset(Integer offset) {
        this.offset = offset;
        return this;
    }
    ...
    public ListAddressItemsUsingGetRequest withAddress(String address) {
    ...
    public ListAddressItemsUsingGetRequest withEnterpriseProjectId(String enterpriseProjectId) {
    ...
    public ListAddressItemsUsingGetRequest withFwInstanceId(String fwInstanceId) {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(setId, keyWord, limit, offset, address, enterpriseProjectId, fwInstanceId);
    }
