 ...
 * Request Object
 */
public class ShowTrafficTrendRequest {
     ...
     */
    public static final class AggTypeEnum {

        /**
         * Enum AVG for value: "avg"
         */
        public static final AggTypeEnum AVG = new AggTypeEnum("avg");

        /**
         * Enum MAX for value: "max"
         */
        public static final AggTypeEnum MAX = new AggTypeEnum("max");

        private static final Map<String, AggTypeEnum> STATIC_FIELDS = createStaticFields();

        private static Map<String, AggTypeEnum> createStaticFields() {
            Map<String, AggTypeEnum> map = new HashMap<>();
            map.put("avg", AVG);
            map.put("max", MAX);
            return Collections.unmodifiableMap(map);
        }
        ...
        @JsonCreator
        public static AggTypeEnum fromValue(String value) {
            if (value == null) {
                return null;
            }
            return java.util.Optional.ofNullable(STATIC_FIELDS.get(value)).orElse(new AggTypeEnum(value));
        }

        public static AggTypeEnum valueOf(String value) {
            if (value == null) {
                return null;
            }
            return java.util.Optional.ofNullable(STATIC_FIELDS.get(value))
        ...
        @Override
        public boolean equals(Object obj) {
            if (obj instanceof AggTypeEnum) {
                return this.value.equals(((AggTypeEnum) obj).value);
            }
            return false;
        }
    ...
    public ShowTrafficTrendRequest withFwInstanceId(String fwInstanceId) {
    ...
    public ShowTrafficTrendRequest withRange(RangeEnum range) {
        this.range = range;
        return this;
    }
    ...
    public ShowTrafficTrendRequest withLogType(LogTypeEnum logType) {
    ...
    public ShowTrafficTrendRequest withStartTime(Long startTime) {
    ...
    public ShowTrafficTrendRequest withEndTime(Long endTime) {
    ...
    public ShowTrafficTrendRequest withVgwId(List<String> vgwId) {
        this.vgwId = vgwId;
        return this;
    }

    public ShowTrafficTrendRequest addVgwIdItem(String vgwIdItem) {
        if (this.vgwId == null) {
    ...
    public ShowTrafficTrendRequest withVgwId(Consumer<List<String>> vgwIdSetter) {
        if (this.vgwId == null) {
            this.vgwId = new ArrayList<>();
        }
    ...
    public ShowTrafficTrendRequest withAggType(AggTypeEnum aggType) {
    ...
    public ShowTrafficTrendRequest withIp(List<String> ip) {
        this.ip = ip;
        return this;
    }

    public ShowTrafficTrendRequest addIpItem(String ipItem) {
        if (this.ip == null) {
    ...
    public ShowTrafficTrendRequest withIp(Consumer<List<String>> ipSetter) {
        if (this.ip == null) {
            this.ip = new ArrayList<>();
        }
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ShowTrafficTrendRequest that = (ShowTrafficTrendRequest) obj;
        return Objects.equals(this.fwInstanceId, that.fwInstanceId) && Objects.equals(this.range, that.range)
            ...
            && Objects.equals(this.aggType, that.aggType) && Objects.equals(this.ip, that.ip);
    }

    @Override
    public int hashCode() {
        return Objects.hash(fwInstanceId, range, logType, startTime, endTime, vgwId, aggType, ip);
    }

    @Override
    public String toString() {
        StringBuilder sb = new StringBuilder();
        sb.append("class ShowTrafficTrendRequest {\n");
