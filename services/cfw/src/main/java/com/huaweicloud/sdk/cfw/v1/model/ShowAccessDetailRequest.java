 ...
 * Request Object
 */
public class ShowAccessDetailRequest {
    ...
    public ShowAccessDetailRequest withFwInstanceId(String fwInstanceId) {
    ...
    public ShowAccessDetailRequest withRange(RangeEnum range) {
        this.range = range;
        return this;
    }
    ...
    public ShowAccessDetailRequest withDirection(DirectionEnum direction) {
    ...
    public ShowAccessDetailRequest withStartTime(Long startTime) {
    ...
    public ShowAccessDetailRequest withEndTime(Long endTime) {
    ...
    public ShowAccessDetailRequest withVgwId(List<String> vgwId) {
        this.vgwId = vgwId;
        return this;
    }

    public ShowAccessDetailRequest addVgwIdItem(String vgwIdItem) {
        if (this.vgwId == null) {
    ...
    public ShowAccessDetailRequest withVgwId(Consumer<List<String>> vgwIdSetter) {
        if (this.vgwId == null) {
            this.vgwId = new ArrayList<>();
        }
    ...
    public ShowAccessDetailRequest withLogType(LogTypeEnum logType) {
    ...
    public ShowAccessDetailRequest withItem(ItemEnum item) {
        this.item = item;
        return this;
    }
    ...
    public ShowAccessDetailRequest withItemId(String itemId) {
        this.itemId = itemId;
        return this;
    }
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ShowAccessDetailRequest that = (ShowAccessDetailRequest) obj;
    ...
    @Override
    public int hashCode() {
        return Objects.hash(fwInstanceId, range, direction, startTime, endTime, vgwId, logType, item, itemId);
    }

    @Override
    public String toString() {
        StringBuilder sb = new StringBuilder();
        sb.append("class ShowAccessDetailRequest {\n");
