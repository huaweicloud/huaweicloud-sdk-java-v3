 ...
 * Request Object
 */
public class ShowAttackTotalRequest {
    ...
    public ShowAttackTotalRequest withFwInstanceId(String fwInstanceId) {
    ...
    public ShowAttackTotalRequest withRange(RangeEnum range) {
        this.range = range;
        return this;
    }
    ...
    public ShowAttackTotalRequest withLogType(LogTypeEnum logType) {
    ...
    public ShowAttackTotalRequest withStartTime(Long startTime) {
    ...
    public ShowAttackTotalRequest withEndTime(Long endTime) {
    ...
    public ShowAttackTotalRequest withVgwId(List<String> vgwId) {
        this.vgwId = vgwId;
        return this;
    }

    public ShowAttackTotalRequest addVgwIdItem(String vgwIdItem) {
        if (this.vgwId == null) {
    ...
    public ShowAttackTotalRequest withVgwId(Consumer<List<String>> vgwIdSetter) {
        if (this.vgwId == null) {
            this.vgwId = new ArrayList<>();
        }
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ShowAttackTotalRequest that = (ShowAttackTotalRequest) obj;
    ...
    public String toString() {
        ...
        sb.append("class ShowAttackTotalRequest {\n");
