...
public class DeleteServiceSetUsingDeleteRequest {
    ...
    public DeleteServiceSetUsingDeleteRequest withEnterpriseProjectId(String enterpriseProjectId) {
    ...
    public DeleteServiceSetUsingDeleteRequest withFwInstanceId(String fwInstanceId) {
