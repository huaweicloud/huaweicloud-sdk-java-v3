...
public class ListIpsSwitchStatusUsingGetRequest {
    ...
    public ListIpsSwitchStatusUsingGetRequest withEnterpriseProjectId(String enterpriseProjectId) {
    ...
    public ListIpsSwitchStatusUsingGetRequest withFwInstanceId(String fwInstanceId) {
