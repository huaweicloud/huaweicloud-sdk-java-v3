 ...
 * Request Object
 */
public class ShowFlowTrendRequest {
    ...
    public ShowFlowTrendRequest withFwInstanceId(String fwInstanceId) {
    ...
    public ShowFlowTrendRequest withRange(RangeEnum range) {
        this.range = range;
        return this;
    }
    ...
    public ShowFlowTrendRequest withLogType(LogTypeEnum logType) {
    ...
    public ShowFlowTrendRequest withDirection(DirectionEnum direction) {
    ...
    public ShowFlowTrendRequest withStartTime(Long startTime) {
    ...
    public ShowFlowTrendRequest withEndTime(Long endTime) {
    ...
    public ShowFlowTrendRequest withVgwId(List<String> vgwId) {
        this.vgwId = vgwId;
        return this;
    }

    public ShowFlowTrendRequest addVgwIdItem(String vgwIdItem) {
        if (this.vgwId == null) {
    ...
    public ShowFlowTrendRequest withVgwId(Consumer<List<String>> vgwIdSetter) {
        if (this.vgwId == null) {
            this.vgwId = new ArrayList<>();
        }
    ...
    public ShowFlowTrendRequest withAssetType(AssetTypeEnum assetType) {
    ...
    public ShowFlowTrendRequest withIp(List<String> ip) {
        this.ip = ip;
        return this;
    }

    public ShowFlowTrendRequest addIpItem(String ipItem) {
        if (this.ip == null) {
    ...
    public ShowFlowTrendRequest withIp(Consumer<List<String>> ipSetter) {
        if (this.ip == null) {
            this.ip = new ArrayList<>();
        }
    ...
    public ShowFlowTrendRequest withVpc(List<String> vpc) {
        this.vpc = vpc;
        return this;
    }

    public ShowFlowTrendRequest addVpcItem(String vpcItem) {
        if (this.vpc == null) {
    ...
    public ShowFlowTrendRequest withVpc(Consumer<List<String>> vpcSetter) {
        if (this.vpc == null) {
            this.vpc = new ArrayList<>();
        }
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ShowFlowTrendRequest that = (ShowFlowTrendRequest) obj;
        return Objects.equals(this.fwInstanceId, that.fwInstanceId) && Objects.equals(this.range, that.range)
            ...
            && Objects.equals(this.ip, that.ip) && Objects.equals(this.vpc, that.vpc);
    }

    @Override
    public int hashCode() {
        return Objects.hash(fwInstanceId, range, logType, direction, startTime, endTime, vgwId, assetType, ip, vpc);
    }

    @Override
    public String toString() {
        StringBuilder sb = new StringBuilder();
        sb.append("class ShowFlowTrendRequest {\n");
