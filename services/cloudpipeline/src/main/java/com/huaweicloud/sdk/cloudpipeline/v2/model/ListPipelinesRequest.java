...
public class ListPipelinesRequest {
    ...
    public ListPipelinesRequest withProjectId(String projectId) {
    ...
    public ListPipelinesRequest withBody(Consumer<ListPipelineQuery> bodySetter) {
        if (this.body == null) {
            this.body = new ListPipelineQuery();
     ...
     * @return body
     */
    public ListPipelineQuery getBody() {
        return body;
    }

    public void setBody(ListPipelineQuery body) {
        this.body = body;
    }
