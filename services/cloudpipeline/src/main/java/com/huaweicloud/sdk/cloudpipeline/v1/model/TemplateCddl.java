...
import com.huaweicloud.sdk.cloudpipeline.v1.model.TemplateState;
import com.huaweicloud.sdk.cloudpipeline.v1.model.Workflow;
...
public class TemplateCddl  {
    ...
    private Map<String, TemplateState> states = new HashMap<>();
