...
public class CloudPipelineAsyncClient {
    ...
    /** 基于模板快速创建流水线及流水线内任务 基于模板快速创建流水线及流水线内任务
     *
    ...
    /** 查询模板列表 查询模板列表，支持分页查询,支持模板名字模糊查询
     *
