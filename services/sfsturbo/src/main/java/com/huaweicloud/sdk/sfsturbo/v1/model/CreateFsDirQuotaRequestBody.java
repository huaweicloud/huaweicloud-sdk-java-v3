...
public class CreateFsDirQuotaRequestBody {
    ...
    public CreateFsDirQuotaRequestBody withPath(String path) {
        this.path = path;
        return this;
    }
    ...
    public CreateFsDirQuotaRequestBody withCapacity(Integer capacity) {
    ...
    public CreateFsDirQuotaRequestBody withInode(Integer inode) {
        this.inode = inode;
        return this;
    }
