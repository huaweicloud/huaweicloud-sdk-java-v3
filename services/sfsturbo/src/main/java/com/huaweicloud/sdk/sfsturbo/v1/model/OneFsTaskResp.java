...
public class OneFsTaskResp {
    ...
    public OneFsTaskResp withTaskId(String taskId) {
        this.taskId = taskId;
        return this;
    }
    ...
    public OneFsTaskResp withStatus(StatusEnum status) {
        this.status = status;
        return this;
    }
    ...
    public OneFsTaskResp withDirUsage(FsDuInfo dirUsage) {
        this.dirUsage = dirUsage;
        return this;
    }

    public OneFsTaskResp withDirUsage(Consumer<FsDuInfo> dirUsageSetter) {
    ...
    public OneFsTaskResp withBeginTime(String beginTime) {
    ...
    public OneFsTaskResp withEndTime(String endTime) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        OneFsTaskResp that = (OneFsTaskResp) obj;
