...
public class ShowBackendTargetInfoResponseBody {
    ...
    public ShowBackendTargetInfoResponseBody withTargetId(String targetId) {
    ...
    public ShowBackendTargetInfoResponseBody withCreationTime(String creationTime) {
    ...
    public ShowBackendTargetInfoResponseBody withFileSystemPath(String fileSystemPath) {
    ...
    public ShowBackendTargetInfoResponseBody withFailureDetails(FailureDetailsMessage failureDetails) {
        this.failureDetails = failureDetails;
        return this;
    }

    public ShowBackendTargetInfoResponseBody withFailureDetails(Consumer<FailureDetailsMessage> failureDetailsSetter) {
    ...
    public ShowBackendTargetInfoResponseBody withLifecycle(LifecycleEnum lifecycle) {
    ...
    public ShowBackendTargetInfoResponseBody withObs(ObsDataRepository obs) {
        this.obs = obs;
        return this;
    }

    public ShowBackendTargetInfoResponseBody withObs(Consumer<ObsDataRepository> obsSetter) {
        if (this.obs == null) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ShowBackendTargetInfoResponseBody that = (ShowBackendTargetInfoResponseBody) obj;
    ...
    @Override
    public int hashCode() {
        return Objects.hash(targetId, creationTime, fileSystemPath, failureDetails, lifecycle, obs);
    }

    @Override
    public String toString() {
        StringBuilder sb = new StringBuilder();
        sb.append("class ShowBackendTargetInfoResponseBody {\n");
