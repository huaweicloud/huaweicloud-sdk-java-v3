 ...
 * Response Object
 */
public class ShowFsDirQuotaResponse extends SdkResponse {
    ...
    public ShowFsDirQuotaResponse withPath(String path) {
        this.path = path;
        return this;
    }
    ...
    public ShowFsDirQuotaResponse withCapacity(Integer capacity) {
    ...
    public ShowFsDirQuotaResponse withInode(Integer inode) {
        this.inode = inode;
        return this;
    }
    ...
    public ShowFsDirQuotaResponse withUsedCapacity(Integer usedCapacity) {
    ...
    public ShowFsDirQuotaResponse withUsedInode(Integer usedInode) {
    ...
    public String toString() {
        ...
        sb.append("class ShowFsDirQuotaResponse {\n");
