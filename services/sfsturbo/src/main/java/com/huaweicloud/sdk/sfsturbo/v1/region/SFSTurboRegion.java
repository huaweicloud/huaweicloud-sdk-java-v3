...
public class SFSTurboRegion {
    ...
    public static final Region CN_SOUTH_4 = new Region("cn-south-4", "https://sfs-turbo.cn-south-4.myhuaweicloud.com");

    public static final Region RU_MOSCOW_1 =
        new Region("ru-moscow-1", "https://sfs-turbo.ru-moscow-1.myhuaweicloud.com");

    public static final Region MY_KUALALUMPUR_1 =
        new Region("my-kualalumpur-1", "https://sfs-turbo.my-kualalumpur-1.myhuaweicloud.com");
    ...
    public static final Region CN_NORTH_11 =
        new Region("cn-north-11", "https://sfs-turbo.cn-north-11.myhuaweicloud.com");

    public static final Region AF_NORTH_1 = new Region("af-north-1", "https://sfs-turbo.af-north-1.myhuaweicloud.com");

    public static final Region CN_NORTH_12 =
        new Region("cn-north-12", "https://sfs-turbo.cn-north-12.myhuaweicloud.com");

    public static final Region CN_SOUTHWEST_3 =
        new Region("cn-southwest-3", "https://sfs-turbo.cn-southwest-3.myhuaweicloud.com");

    public static final Region AP_SOUTHEAST_5 =
        new Region("ap-southeast-5", "https://sfs-turbo.ap-southeast-5.myhuaweicloud.com");
