...
public class ShareInfo {
    ...
    public ShareInfo withEnterpriseProjectId(String enterpriseProjectId) {
    ...
    public ShareInfo withTags(List<ResourceTag> tags) {
        this.tags = tags;
        return this;
    }

    public ShareInfo addTagsItem(ResourceTag tagsItem) {
        if (this.tags == null) {
    ...
    public ShareInfo withTags(Consumer<List<ResourceTag>> tagsSetter) {
        if (this.tags == null) {
            this.tags = new ArrayList<>();
        }
