...
/** 标签 */
public class CreateSharedTagRequestBody {
    ...
    public CreateSharedTagRequestBody withTag(ResourceTag tag) {
        this.tag = tag;
        return this;
    }

    public CreateSharedTagRequestBody withTag(Consumer<ResourceTag> tagSetter) {
        if (this.tag == null) {
    ...
    public String toString() {
        ...
        sb.append("class CreateSharedTagRequestBody {\n");
