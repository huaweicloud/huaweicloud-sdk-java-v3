 ...
 * Request Object
 */
public class DeleteStackInstanceRequest {
    ...
    public DeleteStackInstanceRequest withClientRequestId(String clientRequestId) {
    ...
    public DeleteStackInstanceRequest withStackSetName(String stackSetName) {
    ...
    public DeleteStackInstanceRequest withBody(DeleteStackInstanceRequestBody body) {
        this.body = body;
        return this;
    }

    public DeleteStackInstanceRequest withBody(Consumer<DeleteStackInstanceRequestBody> bodySetter) {
        if (this.body == null) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        DeleteStackInstanceRequest that = (DeleteStackInstanceRequest) obj;
    ...
    public String toString() {
        ...
        sb.append("class DeleteStackInstanceRequest {\n");
