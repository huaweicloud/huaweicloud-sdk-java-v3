 ...
 * Request Object
 */
public class ShowPrivateHookVersionPolicyRequest {
    ...
    public ShowPrivateHookVersionPolicyRequest withClientRequestId(String clientRequestId) {
    ...
    public ShowPrivateHookVersionPolicyRequest withHookName(String hookName) {
    ...
    public ShowPrivateHookVersionPolicyRequest withHookVersion(String hookVersion) {
    ...
    public ShowPrivateHookVersionPolicyRequest withHookId(String hookId) {
        this.hookId = hookId;
        return this;
    }
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ShowPrivateHookVersionPolicyRequest that = (ShowPrivateHookVersionPolicyRequest) obj;
        return Objects.equals(this.clientRequestId, that.clientRequestId)
            && Objects.equals(this.hookName, that.hookName) && Objects.equals(this.hookVersion, that.hookVersion)
            && Objects.equals(this.hookId, that.hookId);
    }

    @Override
    public int hashCode() {
        return Objects.hash(clientRequestId, hookName, hookVersion, hookId);
    }

    @Override
    public String toString() {
        StringBuilder sb = new StringBuilder();
        sb.append("class ShowPrivateHookVersionPolicyRequest {\n");
