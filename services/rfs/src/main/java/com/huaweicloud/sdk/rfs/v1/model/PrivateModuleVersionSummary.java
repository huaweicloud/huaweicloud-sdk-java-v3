 ...
 */
public class PrivateModuleVersionSummary {
    ...
    public PrivateModuleVersionSummary withModuleName(String moduleName) {
    ...
    public PrivateModuleVersionSummary withModuleId(String moduleId) {
    ...
    public PrivateModuleVersionSummary withModuleVersion(String moduleVersion) {
    ...
    public PrivateModuleVersionSummary withVersionDescription(String versionDescription) {
    ...
    public PrivateModuleVersionSummary withCreateTime(String createTime) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        PrivateModuleVersionSummary that = (PrivateModuleVersionSummary) obj;
    ...
    @Override
    public int hashCode() {
        return Objects.hash(moduleName, moduleId, moduleVersion, versionDescription, createTime);
    }

    @Override
    public String toString() {
        StringBuilder sb = new StringBuilder();
        sb.append("class PrivateModuleVersionSummary {\n");
