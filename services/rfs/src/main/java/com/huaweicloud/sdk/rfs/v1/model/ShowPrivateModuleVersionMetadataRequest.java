 ...
 * Request Object
 */
public class ShowPrivateModuleVersionMetadataRequest {
    ...
    public ShowPrivateModuleVersionMetadataRequest withClientRequestId(String clientRequestId) {
    ...
    public ShowPrivateModuleVersionMetadataRequest withModuleName(String moduleName) {
    ...
    public ShowPrivateModuleVersionMetadataRequest withModuleId(String moduleId) {
    ...
    public ShowPrivateModuleVersionMetadataRequest withModuleVersion(String moduleVersion) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ShowPrivateModuleVersionMetadataRequest that = (ShowPrivateModuleVersionMetadataRequest) obj;
    ...
    @Override
    public int hashCode() {
        return Objects.hash(clientRequestId, moduleName, moduleId, moduleVersion);
    }

    @Override
    public String toString() {
        StringBuilder sb = new StringBuilder();
        sb.append("class ShowPrivateModuleVersionMetadataRequest {\n");
