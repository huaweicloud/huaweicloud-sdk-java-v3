...
/**
 * PrivateModuleSummary
 */
public class PrivateModuleSummary {
    ...
    public PrivateModuleSummary withModuleName(String moduleName) {
    ...
    public PrivateModuleSummary withModuleId(String moduleId) {
    ...
    public PrivateModuleSummary withModuleDescription(String moduleDescription) {
    ...
    public PrivateModuleSummary withCreateTime(String createTime) {
    ...
    public PrivateModuleSummary withUpdateTime(String updateTime) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        PrivateModuleSummary that = (PrivateModuleSummary) obj;
    ...
    public String toString() {
        ...
        sb.append("class PrivateModuleSummary {\n");
