 ...
 * Request Object
 */
public class DeletePrivateProviderVersionRequest {
    ...
    public DeletePrivateProviderVersionRequest withClientRequestId(String clientRequestId) {
    ...
    public DeletePrivateProviderVersionRequest withProviderName(String providerName) {
    ...
    public DeletePrivateProviderVersionRequest withProviderVersion(String providerVersion) {
    ...
    public DeletePrivateProviderVersionRequest withProviderId(String providerId) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        DeletePrivateProviderVersionRequest that = (DeletePrivateProviderVersionRequest) obj;
    ...
    public String toString() {
        ...
        sb.append("class DeletePrivateProviderVersionRequest {\n");
