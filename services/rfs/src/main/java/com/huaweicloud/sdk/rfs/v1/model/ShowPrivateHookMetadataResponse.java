 ...
 * Response Object
 */
public class ShowPrivateHookMetadataResponse extends SdkResponse {
    ...
    public ShowPrivateHookMetadataResponse withHookName(String hookName) {
    ...
    public ShowPrivateHookMetadataResponse withHookId(String hookId) {
        this.hookId = hookId;
        return this;
    }
    ...
    public ShowPrivateHookMetadataResponse withHookDescription(String hookDescription) {
    ...
    public ShowPrivateHookMetadataResponse withDefaultVersion(String defaultVersion) {
    ...
    public ShowPrivateHookMetadataResponse withConfiguration(
    ...
    public ShowPrivateHookMetadataResponse withCreateTime(String createTime) {
    ...
    public ShowPrivateHookMetadataResponse withUpdateTime(String updateTime) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ShowPrivateHookMetadataResponse that = (ShowPrivateHookMetadataResponse) obj;
    ...
    public String toString() {
        ...
        sb.append("class ShowPrivateHookMetadataResponse {\n");
