...
public class ListRootsRequest {
    ...
    public ListRootsRequest withXSecurityToken(String xSecurityToken) {
    ...
    public ListRootsRequest withLimit(Integer limit) {
        this.limit = limit;
        return this;
    }
    ...
    public ListRootsRequest withMarker(String marker) {
        this.marker = marker;
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append("class ListRootsRequest {\n");
