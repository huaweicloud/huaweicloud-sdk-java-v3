...
public class ExportTask {
    ...
    public ExportTask withResourceType(String resourceType) {
    ...
    public ExportTask withResourceCondition(Object resourceCondition) {
    ...
    public ExportTask withExportFormat(String exportFormat) {
    ...
    public ExportTask withExportCount(Long exportCount) {
    ...
    public ExportTask withProgress(Integer progress) {
    ...
    public ExportTask withCreateTime(String createTime) {
    ...
    public ExportTask withEndTime(String endTime) {
    ...
    public ExportTask withAppType(String appType) {
    ...
    public ExportTask withAppId(String appId) {
        this.appId = appId;
        return this;
    }
