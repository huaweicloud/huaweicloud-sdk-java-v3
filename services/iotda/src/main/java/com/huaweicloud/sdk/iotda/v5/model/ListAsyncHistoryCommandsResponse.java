...
public class ListAsyncHistoryCommandsResponse extends SdkResponse {
    ...
    public ListAsyncHistoryCommandsResponse withPage(Consumer<Page> pageSetter) {
        if(this.page == null ){
            this.page = new Page();
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ListAsyncHistoryCommandsResponse listAsyncHistoryCommandsResponse = (ListAsyncHistoryCommandsResponse) o;
        return Objects.equals(this.commands, listAsyncHistoryCommandsResponse.commands) &&
            Objects.equals(this.page, listAsyncHistoryCommandsResponse.page);
    }
    @Override
    public int hashCode() {
