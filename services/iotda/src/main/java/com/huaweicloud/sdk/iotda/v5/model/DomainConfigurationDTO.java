...
public class DomainConfigurationDTO {
    ...
    public DomainConfigurationDTO withConfigurationId(String configurationId) {
    ...
    public DomainConfigurationDTO withDomainName(String domainName) {
    ...
    public DomainConfigurationDTO withAccessProtocol(String accessProtocol) {
    ...
    public DomainConfigurationDTO withServerCertificateId(String serverCertificateId) {
    ...
    public DomainConfigurationDTO withServerCertificateConfig(ServerCertificateConfig serverCertificateConfig) {
        this.serverCertificateConfig = serverCertificateConfig;
        return this;
    }

    public DomainConfigurationDTO withServerCertificateConfig(
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        DomainConfigurationDTO that = (DomainConfigurationDTO) obj;
    ...
    public String toString() {
        ...
        sb.append("class DomainConfigurationDTO {\n");
