 ...
 * Request Object
 */
public class RetryBatchTaskRequest {
    ...
    public RetryBatchTaskRequest withInstanceId(String instanceId) {
    ...
    public RetryBatchTaskRequest withTaskId(String taskId) {
        this.taskId = taskId;
        return this;
    }
    ...
    public RetryBatchTaskRequest withBody(BatchTargets body) {
        this.body = body;
        return this;
    }

    public RetryBatchTaskRequest withBody(Consumer<BatchTargets> bodySetter) {
        if (this.body == null) {
    ...
    public String toString() {
        ...
        sb.append("class RetryBatchTaskRequest {\n");
