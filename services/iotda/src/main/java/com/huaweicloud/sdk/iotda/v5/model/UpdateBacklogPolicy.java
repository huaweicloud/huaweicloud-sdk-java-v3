 ...
 * 修改数据流转积压策略请求结构体
 */
public class UpdateBacklogPolicy {
    ...
    public UpdateBacklogPolicy withPolicyName(String policyName) {
    ...
    public UpdateBacklogPolicy withDescription(String description) {
    ...
    public UpdateBacklogPolicy withBacklogSize(Integer backlogSize) {
    ...
    public UpdateBacklogPolicy withBacklogTime(Integer backlogTime) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        UpdateBacklogPolicy that = (UpdateBacklogPolicy) obj;
    ...
    public String toString() {
        ...
        sb.append("class UpdateBacklogPolicy {\n");
