 ...
 * 数据流转流控策略结构体
 */
public class FlowControlPolicyInfo {
    ...
    public FlowControlPolicyInfo withPolicyId(String policyId) {
    ...
    public FlowControlPolicyInfo withPolicyName(String policyName) {
    ...
    public FlowControlPolicyInfo withDescription(String description) {
    ...
    public FlowControlPolicyInfo withScope(String scope) {
        this.scope = scope;
        return this;
    }
    ...
    public FlowControlPolicyInfo withScopeValue(String scopeValue) {
    ...
    public FlowControlPolicyInfo withLimit(Integer limit) {
        this.limit = limit;
        return this;
    }
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        FlowControlPolicyInfo that = (FlowControlPolicyInfo) obj;
    ...
    public String toString() {
        ...
        sb.append("class FlowControlPolicyInfo {\n");
