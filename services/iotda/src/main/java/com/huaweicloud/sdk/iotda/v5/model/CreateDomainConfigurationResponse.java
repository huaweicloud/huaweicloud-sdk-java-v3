 ...
 * Response Object
 */
public class CreateDomainConfigurationResponse extends SdkResponse {
    ...
    public CreateDomainConfigurationResponse withConfigurationId(String configurationId) {
    ...
    public CreateDomainConfigurationResponse withDomainName(String domainName) {
    ...
    public CreateDomainConfigurationResponse withAccessProtocol(String accessProtocol) {
    ...
    public CreateDomainConfigurationResponse withServerCertificateId(String serverCertificateId) {
    ...
    public CreateDomainConfigurationResponse withServerCertificateConfig(
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        CreateDomainConfigurationResponse that = (CreateDomainConfigurationResponse) obj;
