...
public class ShowCertificateResponse extends SdkResponse {
    ...
    public ShowCertificateResponse withCnName(String cnName) {
        this.cnName = cnName;
        return this;
    }
    ...
    public ShowCertificateResponse withOwner(String owner) {
        this.owner = owner;
        return this;
    }
    ...
    public ShowCertificateResponse withStatus(Boolean status) {
        this.status = status;
        return this;
    }
    ...
    public ShowCertificateResponse withVerifyCode(String verifyCode) {
    ...
    public ShowCertificateResponse withProvisionEnable(Boolean provisionEnable) {
    ...
    public ShowCertificateResponse withTemplateId(String templateId) {
    ...
    public ShowCertificateResponse withOcspEnable(Boolean ocspEnable) {
    ...
    public ShowCertificateResponse withOcspServerCaId(String ocspServerCaId) {
    ...
    public ShowCertificateResponse withOcspSslEnable(Boolean ocspSslEnable) {
    ...
    public ShowCertificateResponse withCreateDate(String createDate) {
    ...
    public ShowCertificateResponse withEffectiveDate(String effectiveDate) {
    ...
    public ShowCertificateResponse withExpiryDate(String expiryDate) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        return Objects.equals(this.certificateId, that.certificateId) && Objects.equals(this.name, that.name)
            && Objects.equals(this.cnName, that.cnName) && Objects.equals(this.owner, that.owner)
            && Objects.equals(this.status, that.status) && Objects.equals(this.verifyCode, that.verifyCode)
            ...
            && Objects.equals(this.expiryDate, that.expiryDate) && Objects.equals(this.content, that.content);
    }
