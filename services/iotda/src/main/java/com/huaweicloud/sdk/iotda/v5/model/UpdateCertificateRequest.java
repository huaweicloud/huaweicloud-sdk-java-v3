...
public class UpdateCertificateRequest {
    ...
    private UpdateCertificateDTO body;

    public UpdateCertificateRequest withInstanceId(String instanceId) {
    ...
    public UpdateCertificateRequest withBody(UpdateCertificateDTO body) {
        this.body = body;
        return this;
    }

    public UpdateCertificateRequest withBody(Consumer<UpdateCertificateDTO> bodySetter) {
        if (this.body == null) {
            this.body = new UpdateCertificateDTO();
     ...
     * @return body
     */
    public UpdateCertificateDTO getBody() {
        return body;
    }

    public void setBody(UpdateCertificateDTO body) {
        this.body = body;
    }
