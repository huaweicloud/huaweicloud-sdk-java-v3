...
public class OtaModuleInfo {
    ...
    public OtaModuleInfo withModuleId(String moduleId) {
    ...
    public OtaModuleInfo withAppId(String appId) {
        this.appId = appId;
        return this;
    }
    ...
    public OtaModuleInfo withProductId(String productId) {
    ...
    public OtaModuleInfo withProductName(String productName) {
    ...
    public OtaModuleInfo withModuleName(String moduleName) {
    ...
    public OtaModuleInfo withAliasName(String aliasName) {
    ...
    public OtaModuleInfo withDescription(String description) {
    ...
    public OtaModuleInfo withCreateTime(String createTime) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        OtaModuleInfo that = (OtaModuleInfo) obj;
