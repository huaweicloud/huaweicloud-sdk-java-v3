 ...
 * Request Object
 */
public class ListDeviceCertificateRequest {
    ...
    public ListDeviceCertificateRequest withInstanceId(String instanceId) {
    ...
    public ListDeviceCertificateRequest withCommonName(String commonName) {
    ...
    public ListDeviceCertificateRequest withFingerprint(String fingerprint) {
    ...
    public ListDeviceCertificateRequest withLimit(Integer limit) {
        this.limit = limit;
        return this;
    }
    ...
    public ListDeviceCertificateRequest withMarker(String marker) {
        this.marker = marker;
        return this;
    }
    ...
    public ListDeviceCertificateRequest withOffset(Integer offset) {
        this.offset = offset;
        return this;
    }
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ListDeviceCertificateRequest that = (ListDeviceCertificateRequest) obj;
        return Objects.equals(this.instanceId, that.instanceId) && Objects.equals(this.commonName, that.commonName)
            && Objects.equals(this.fingerprint, that.fingerprint) && Objects.equals(this.limit, that.limit)
            && Objects.equals(this.marker, that.marker) && Objects.equals(this.offset, that.offset);
    }

    @Override
    public int hashCode() {
        return Objects.hash(instanceId, commonName, fingerprint, limit, marker, offset);
    }

    @Override
    public String toString() {
        StringBuilder sb = new StringBuilder();
        sb.append("class ListDeviceCertificateRequest {\n");
