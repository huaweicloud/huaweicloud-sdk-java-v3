...
public class UpdateApplicationResponse extends SdkResponse {
    ...
    public UpdateApplicationResponse withAppId(String appId) {
        this.appId = appId;
        return this;
    }
    ...
    public UpdateApplicationResponse withAppName(String appName) {
    ...
    public UpdateApplicationResponse withCreateTime(String createTime) {
    ...
    public UpdateApplicationResponse withDefaultApp(Boolean defaultApp) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        UpdateApplicationResponse that = (UpdateApplicationResponse) obj;
