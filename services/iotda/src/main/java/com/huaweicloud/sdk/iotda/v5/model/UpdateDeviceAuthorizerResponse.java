 ...
 * Response Object
 */
public class UpdateDeviceAuthorizerResponse extends SdkResponse {
    ...
    public UpdateDeviceAuthorizerResponse withAuthorizerId(String authorizerId) {
    ...
    public UpdateDeviceAuthorizerResponse withAuthorizerName(String authorizerName) {
    ...
    public UpdateDeviceAuthorizerResponse withFuncName(String funcName) {
    ...
    public UpdateDeviceAuthorizerResponse withFuncUrn(String funcUrn) {
    ...
    public UpdateDeviceAuthorizerResponse withSigningEnable(Boolean signingEnable) {
    ...
    public UpdateDeviceAuthorizerResponse withSigningToken(String signingToken) {
    ...
    public UpdateDeviceAuthorizerResponse withSigningPublicKey(String signingPublicKey) {
    ...
    public UpdateDeviceAuthorizerResponse withDefaultAuthorizer(Boolean defaultAuthorizer) {
    ...
    public UpdateDeviceAuthorizerResponse withStatus(String status) {
        this.status = status;
        return this;
    }
    ...
    public UpdateDeviceAuthorizerResponse withCacheEnable(Boolean cacheEnable) {
    ...
    public UpdateDeviceAuthorizerResponse withCreateTime(String createTime) {
    ...
    public UpdateDeviceAuthorizerResponse withUpdateTime(String updateTime) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        UpdateDeviceAuthorizerResponse that = (UpdateDeviceAuthorizerResponse) obj;
    ...
    public String toString() {
        ...
        sb.append("class UpdateDeviceAuthorizerResponse {\n");
