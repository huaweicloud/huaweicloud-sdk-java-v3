 ...
 * Response Object
 */
public class ShowDeviceTunnelResponse extends SdkResponse {
    ...
    public ShowDeviceTunnelResponse withTunnelId(String tunnelId) {
    ...
    public ShowDeviceTunnelResponse withDeviceId(String deviceId) {
    ...
    public ShowDeviceTunnelResponse withCreateTime(String createTime) {
    ...
    public ShowDeviceTunnelResponse withClosedTime(String closedTime) {
    ...
    public ShowDeviceTunnelResponse withStatus(String status) {
        this.status = status;
        return this;
    }
    ...
    public ShowDeviceTunnelResponse withSourceConnectState(ConnectState sourceConnectState) {
        this.sourceConnectState = sourceConnectState;
        return this;
    }

    public ShowDeviceTunnelResponse withSourceConnectState(Consumer<ConnectState> sourceConnectStateSetter) {
    ...
    public ShowDeviceTunnelResponse withDeviceConnectState(ConnectState deviceConnectState) {
        this.deviceConnectState = deviceConnectState;
        return this;
    }

    public ShowDeviceTunnelResponse withDeviceConnectState(Consumer<ConnectState> deviceConnectStateSetter) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ShowDeviceTunnelResponse that = (ShowDeviceTunnelResponse) obj;
