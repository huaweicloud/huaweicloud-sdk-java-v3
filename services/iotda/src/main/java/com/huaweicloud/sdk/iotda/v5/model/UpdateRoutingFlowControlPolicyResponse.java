 ...
 * Response Object
 */
public class UpdateRoutingFlowControlPolicyResponse extends SdkResponse {
    ...
    public UpdateRoutingFlowControlPolicyResponse withPolicyId(String policyId) {
    ...
    public UpdateRoutingFlowControlPolicyResponse withPolicyName(String policyName) {
    ...
    public UpdateRoutingFlowControlPolicyResponse withDescription(String description) {
    ...
    public UpdateRoutingFlowControlPolicyResponse withScope(String scope) {
        this.scope = scope;
        return this;
    }
    ...
    public UpdateRoutingFlowControlPolicyResponse withScopeValue(String scopeValue) {
    ...
    public UpdateRoutingFlowControlPolicyResponse withLimit(Integer limit) {
        this.limit = limit;
        return this;
    }
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        UpdateRoutingFlowControlPolicyResponse that = (UpdateRoutingFlowControlPolicyResponse) obj;
    ...
    public String toString() {
        ...
        sb.append("class UpdateRoutingFlowControlPolicyResponse {\n");
