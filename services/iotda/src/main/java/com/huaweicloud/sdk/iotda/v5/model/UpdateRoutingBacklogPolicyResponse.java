 ...
 * Response Object
 */
public class UpdateRoutingBacklogPolicyResponse extends SdkResponse {
    ...
    public UpdateRoutingBacklogPolicyResponse withPolicyId(String policyId) {
    ...
    public UpdateRoutingBacklogPolicyResponse withPolicyName(String policyName) {
    ...
    public UpdateRoutingBacklogPolicyResponse withDescription(String description) {
    ...
    public UpdateRoutingBacklogPolicyResponse withBacklogSize(Integer backlogSize) {
    ...
    public UpdateRoutingBacklogPolicyResponse withBacklogTime(Integer backlogTime) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        UpdateRoutingBacklogPolicyResponse that = (UpdateRoutingBacklogPolicyResponse) obj;
    ...
    public String toString() {
        ...
        sb.append("class UpdateRoutingBacklogPolicyResponse {\n");
