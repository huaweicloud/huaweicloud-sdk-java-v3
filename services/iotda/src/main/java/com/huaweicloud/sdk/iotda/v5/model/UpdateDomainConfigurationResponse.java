 ...
 * Response Object
 */
public class UpdateDomainConfigurationResponse extends SdkResponse {
    ...
    public UpdateDomainConfigurationResponse withConfigurationId(String configurationId) {
    ...
    public UpdateDomainConfigurationResponse withDomainName(String domainName) {
    ...
    public UpdateDomainConfigurationResponse withAccessProtocol(String accessProtocol) {
    ...
    public UpdateDomainConfigurationResponse withServerCertificateId(String serverCertificateId) {
    ...
    public UpdateDomainConfigurationResponse withServerCertificateConfig(
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        UpdateDomainConfigurationResponse that = (UpdateDomainConfigurationResponse) obj;
    ...
    public String toString() {
        ...
        sb.append("class UpdateDomainConfigurationResponse {\n");
