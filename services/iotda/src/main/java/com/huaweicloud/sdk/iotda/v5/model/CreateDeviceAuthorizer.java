 ...
 * 创建自定义鉴权请求体。
 */
public class CreateDeviceAuthorizer {
    ...
    public CreateDeviceAuthorizer withAuthorizerName(String authorizerName) {
    ...
    public CreateDeviceAuthorizer withFuncUrn(String funcUrn) {
    ...
    public CreateDeviceAuthorizer withSigningEnable(Boolean signingEnable) {
    ...
    public CreateDeviceAuthorizer withSigningToken(String signingToken) {
    ...
    public CreateDeviceAuthorizer withSigningPublicKey(String signingPublicKey) {
    ...
    public CreateDeviceAuthorizer withDefaultAuthorizer(Boolean defaultAuthorizer) {
    ...
    public CreateDeviceAuthorizer withStatus(String status) {
        this.status = status;
        return this;
    }
    ...
    public CreateDeviceAuthorizer withCacheEnable(Boolean cacheEnable) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        CreateDeviceAuthorizer that = (CreateDeviceAuthorizer) obj;
    ...
    public String toString() {
        ...
        sb.append("class CreateDeviceAuthorizer {\n");
