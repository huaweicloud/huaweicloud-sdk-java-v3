 ...
 * Response Object
 */
public class UpdateProvisioningTemplateResponse extends SdkResponse {
    ...
    public UpdateProvisioningTemplateResponse withTemplateId(String templateId) {
    ...
    public UpdateProvisioningTemplateResponse withTemplateName(String templateName) {
    ...
    public UpdateProvisioningTemplateResponse withDescription(String description) {
    ...
    public UpdateProvisioningTemplateResponse withTemplateBody(ProvisioningTemplateBody templateBody) {
        this.templateBody = templateBody;
        return this;
    }

    public UpdateProvisioningTemplateResponse withTemplateBody(Consumer<ProvisioningTemplateBody> templateBodySetter) {
    ...
    public UpdateProvisioningTemplateResponse withCreateTime(String createTime) {
    ...
    public UpdateProvisioningTemplateResponse withUpdateTime(String updateTime) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        UpdateProvisioningTemplateResponse that = (UpdateProvisioningTemplateResponse) obj;
