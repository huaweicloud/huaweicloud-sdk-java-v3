 ...
 * Response Object
 */
public class CreateDeviceAuthorizerResponse extends SdkResponse {
    ...
    public CreateDeviceAuthorizerResponse withAuthorizerId(String authorizerId) {
    ...
    public CreateDeviceAuthorizerResponse withAuthorizerName(String authorizerName) {
    ...
    public CreateDeviceAuthorizerResponse withFuncName(String funcName) {
    ...
    public CreateDeviceAuthorizerResponse withFuncUrn(String funcUrn) {
    ...
    public CreateDeviceAuthorizerResponse withSigningEnable(Boolean signingEnable) {
    ...
    public CreateDeviceAuthorizerResponse withSigningToken(String signingToken) {
    ...
    public CreateDeviceAuthorizerResponse withSigningPublicKey(String signingPublicKey) {
    ...
    public CreateDeviceAuthorizerResponse withDefaultAuthorizer(Boolean defaultAuthorizer) {
    ...
    public CreateDeviceAuthorizerResponse withStatus(String status) {
        this.status = status;
        return this;
    }
    ...
    public CreateDeviceAuthorizerResponse withCacheEnable(Boolean cacheEnable) {
    ...
    public CreateDeviceAuthorizerResponse withCreateTime(String createTime) {
    ...
    public CreateDeviceAuthorizerResponse withUpdateTime(String updateTime) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        CreateDeviceAuthorizerResponse that = (CreateDeviceAuthorizerResponse) obj;
