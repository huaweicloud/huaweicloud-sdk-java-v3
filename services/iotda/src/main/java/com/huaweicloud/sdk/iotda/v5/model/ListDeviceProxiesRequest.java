 ...
 * Request Object
 */
public class ListDeviceProxiesRequest {
    ...
    public ListDeviceProxiesRequest withInstanceId(String instanceId) {
    ...
    public ListDeviceProxiesRequest withAppId(String appId) {
        this.appId = appId;
        return this;
    }
    ...
    public ListDeviceProxiesRequest withProxyName(String proxyName) {
    ...
    public ListDeviceProxiesRequest withLimit(Integer limit) {
        this.limit = limit;
        return this;
    }
    ...
    public ListDeviceProxiesRequest withMarker(String marker) {
        this.marker = marker;
        return this;
    }
    ...
    public ListDeviceProxiesRequest withOffset(Integer offset) {
        this.offset = offset;
        return this;
    }
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ListDeviceProxiesRequest that = (ListDeviceProxiesRequest) obj;
        return Objects.equals(this.instanceId, that.instanceId) && Objects.equals(this.appId, that.appId)
            && Objects.equals(this.proxyName, that.proxyName) && Objects.equals(this.limit, that.limit)
            && Objects.equals(this.marker, that.marker) && Objects.equals(this.offset, that.offset);
    }

    @Override
    public int hashCode() {
        return Objects.hash(instanceId, appId, proxyName, limit, marker, offset);
    }

    @Override
    public String toString() {
        StringBuilder sb = new StringBuilder();
        sb.append("class ListDeviceProxiesRequest {\n");
