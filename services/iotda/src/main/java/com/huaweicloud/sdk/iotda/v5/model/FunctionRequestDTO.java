...
public class FunctionRequestDTO {
    ...
    public FunctionRequestDTO withAppId(String appId) {
        this.appId = appId;
        return this;
    }
    ...
    public FunctionRequestDTO withProductId(String productId) {
    ...
    public FunctionRequestDTO withUrn(String urn) {
        this.urn = urn;
        return this;
    }
    ...
    public FunctionRequestDTO withDescription(String description) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        FunctionRequestDTO that = (FunctionRequestDTO) obj;
        return Objects.equals(this.appId, that.appId) && Objects.equals(this.productId, that.productId)
            && Objects.equals(this.urn, that.urn) && Objects.equals(this.description, that.description);
    }

    @Override
    public int hashCode() {
        return Objects.hash(appId, productId, urn, description);
    }

    @Override
    public String toString() {
        StringBuilder sb = new StringBuilder();
        sb.append("class FunctionRequestDTO {\n");
