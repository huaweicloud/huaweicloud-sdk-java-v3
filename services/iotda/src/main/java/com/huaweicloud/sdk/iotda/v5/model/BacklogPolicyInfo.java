...
public class BacklogPolicyInfo {
    ...
    public BacklogPolicyInfo withPolicyId(String policyId) {
    ...
    public BacklogPolicyInfo withPolicyName(String policyName) {
    ...
    public BacklogPolicyInfo withDescription(String description) {
    ...
    public BacklogPolicyInfo withBacklogSize(Integer backlogSize) {
    ...
    public BacklogPolicyInfo withBacklogTime(Integer backlogTime) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        BacklogPolicyInfo that = (BacklogPolicyInfo) obj;
