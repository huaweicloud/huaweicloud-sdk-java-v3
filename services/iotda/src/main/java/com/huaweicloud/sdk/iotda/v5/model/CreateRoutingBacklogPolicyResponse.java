 ...
 * Response Object
 */
public class CreateRoutingBacklogPolicyResponse extends SdkResponse {
    ...
    public CreateRoutingBacklogPolicyResponse withPolicyId(String policyId) {
    ...
    public CreateRoutingBacklogPolicyResponse withPolicyName(String policyName) {
    ...
    public CreateRoutingBacklogPolicyResponse withDescription(String description) {
    ...
    public CreateRoutingBacklogPolicyResponse withBacklogSize(Integer backlogSize) {
    ...
    public CreateRoutingBacklogPolicyResponse withBacklogTime(Integer backlogTime) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        CreateRoutingBacklogPolicyResponse that = (CreateRoutingBacklogPolicyResponse) obj;
        return Objects.equals(this.policyId, that.policyId) && Objects.equals(this.policyName, that.policyName)
            && Objects.equals(this.description, that.description) && Objects.equals(this.backlogSize, that.backlogSize)
            && Objects.equals(this.backlogTime, that.backlogTime);
    }

    @Override
    public int hashCode() {
        return Objects.hash(policyId, policyName, description, backlogSize, backlogTime);
    }

    @Override
    public String toString() {
        StringBuilder sb = new StringBuilder();
        sb.append("class CreateRoutingBacklogPolicyResponse {\n");
