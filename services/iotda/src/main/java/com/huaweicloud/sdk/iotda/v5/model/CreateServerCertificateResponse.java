 ...
 * Response Object
 */
public class CreateServerCertificateResponse extends SdkResponse {
    ...
    public CreateServerCertificateResponse withServerCertificateId(String serverCertificateId) {
    ...
    public CreateServerCertificateResponse withCommonName(String commonName) {
    ...
    public CreateServerCertificateResponse withEffectiveDate(String effectiveDate) {
    ...
    public CreateServerCertificateResponse withExpiryDate(String expiryDate) {
    ...
    public CreateServerCertificateResponse withCertificateOwner(String certificateOwner) {
    ...
    public CreateServerCertificateResponse withCertificateIssuer(String certificateIssuer) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        CreateServerCertificateResponse that = (CreateServerCertificateResponse) obj;
