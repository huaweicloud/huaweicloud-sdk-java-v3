 ...
 */
public class ListDeviceGroupSummary {
    ...
    public ListDeviceGroupSummary withGroupId(String groupId) {
    ...
    public ListDeviceGroupSummary withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public ListDeviceGroupSummary withDescription(String description) {
    ...
    public ListDeviceGroupSummary withSuperGroupId(String superGroupId) {
    ...
    public ListDeviceGroupSummary withGroupType(String groupType) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ListDeviceGroupSummary that = (ListDeviceGroupSummary) obj;
    ...
    public String toString() {
        ...
        sb.append("class ListDeviceGroupSummary {\n");
