 ...
 * Response Object
 */
public class CreateProvisioningTemplateResponse extends SdkResponse {
    ...
    public CreateProvisioningTemplateResponse withTemplateId(String templateId) {
    ...
    public CreateProvisioningTemplateResponse withDescription(String description) {
    ...
    public CreateProvisioningTemplateResponse withTemplateBody(ProvisioningTemplateBody templateBody) {
        this.templateBody = templateBody;
        return this;
    }

    public CreateProvisioningTemplateResponse withTemplateBody(Consumer<ProvisioningTemplateBody> templateBodySetter) {
    ...
    public CreateProvisioningTemplateResponse withCreateTime(String createTime) {
    ...
    public CreateProvisioningTemplateResponse withUpdateTime(String updateTime) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        CreateProvisioningTemplateResponse that = (CreateProvisioningTemplateResponse) obj;
    ...
    public String toString() {
        ...
        sb.append("class CreateProvisioningTemplateResponse {\n");
