...
public class ShowCertificateRequest {
    ...
    public ShowCertificateRequest withSpAuthToken(String spAuthToken) {
    ...
    public ShowCertificateRequest withStageAuthToken(String stageAuthToken) {
    ...
    public ShowCertificateRequest withInstanceId(String instanceId) {
