 ...
 * Response Object
 */
public class CreateOtaModuleResponse extends SdkResponse {
    ...
    public CreateOtaModuleResponse withModuleId(String moduleId) {
    ...
    public CreateOtaModuleResponse withAppId(String appId) {
        this.appId = appId;
        return this;
    }
    ...
    public CreateOtaModuleResponse withProductId(String productId) {
    ...
    public CreateOtaModuleResponse withProductName(String productName) {
    ...
    public CreateOtaModuleResponse withModuleName(String moduleName) {
    ...
    public CreateOtaModuleResponse withAliasName(String aliasName) {
    ...
    public CreateOtaModuleResponse withDescription(String description) {
    ...
    public CreateOtaModuleResponse withCreateTime(String createTime) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        CreateOtaModuleResponse that = (CreateOtaModuleResponse) obj;
