...
public class KooPhoneClient {
     ...
     * @return ListInstanceAppResponse
     */
    public ListInstanceAppResponse listInstanceApp(ListInstanceAppRequest request) {
        return hcClient.syncInvokeHttp(request, KooPhoneMeta.listInstanceApp);
    }
     ...
     *
     * @param request ListInstanceAppRequest 请求对象
     * @return SyncInvoker<ListInstanceAppRequest, ListInstanceAppResponse>
     */
    public SyncInvoker<ListInstanceAppRequest, ListInstanceAppResponse> listInstanceAppInvoker(
        ListInstanceAppRequest request) {
        return new SyncInvoker<>(request, KooPhoneMeta.listInstanceApp, hcClient);
    }
