...
public class BatchShowInstanceRequest {
    ...
    public BatchShowInstanceRequest withBody(Consumer<InstanceStatusReq> bodySetter) {
        if (this.body == null) {
            this.body = new InstanceStatusReq();
     ...
     * @return body
     */
    public InstanceStatusReq getBody() {
        return body;
    }

    public void setBody(InstanceStatusReq body) {
        this.body = body;
    }
