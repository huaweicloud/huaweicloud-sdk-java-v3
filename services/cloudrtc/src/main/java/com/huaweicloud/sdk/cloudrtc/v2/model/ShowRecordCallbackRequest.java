 ...
 * Request Object
 */
public class ShowRecordCallbackRequest {
    ...
    public ShowRecordCallbackRequest withAuthorization(String authorization) {
    ...
    public ShowRecordCallbackRequest withXSdkDate(String xSdkDate) {
    ...
    public ShowRecordCallbackRequest withXProjectId(String xProjectId) {
    ...
    public ShowRecordCallbackRequest withAppId(String appId) {
        this.appId = appId;
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append("class ShowRecordCallbackRequest {\n");
