...
public class RemoveUsersRequest {
    ...
    public RemoveUsersRequest withAuthorization(String authorization) {
    ...
    public RemoveUsersRequest withXSdkDate(String xSdkDate) {
    ...
    public RemoveUsersRequest withXProjectId(String xProjectId) {
    ...
    public RemoveUsersRequest withAppId(String appId) {
        this.appId = appId;
        return this;
    }
    ...
    public RemoveUsersRequest withRoomId(String roomId) {
        this.roomId = roomId;
        return this;
    }
    ...
    public RemoveUsersRequest withBody(RemoveUsersReq body) {
        this.body = body;
        return this;
    }

    public RemoveUsersRequest withBody(Consumer<RemoveUsersReq> bodySetter) {
        if (this.body == null) {
    ...
    public void setBody(RemoveUsersReq body) {
        this.body = body;
    }
    ...
    @Override
    public int hashCode() {
        return Objects.hash(authorization, xSdkDate, xProjectId, appId, roomId, body);
    }
