...
public class ListAppsRequest {
    ...
    public ListAppsRequest withAuthorization(String authorization) {
    ...
    public ListAppsRequest withXSdkDate(String xSdkDate) {
    ...
    public ListAppsRequest withXProjectId(String xProjectId) {
    ...
    public ListAppsRequest withState(StateEnum state) {
        this.state = state;
        return this;
    }
    ...
    @Override
    public int hashCode() {
        return Objects.hash(authorization, xSdkDate, xProjectId, state, offset, limit);
    }
