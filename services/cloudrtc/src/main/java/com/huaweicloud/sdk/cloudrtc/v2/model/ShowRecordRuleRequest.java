 ...
 * Request Object
 */
public class ShowRecordRuleRequest {
    ...
    public ShowRecordRuleRequest withAuthorization(String authorization) {
    ...
    public ShowRecordRuleRequest withXSdkDate(String xSdkDate) {
    ...
    public ShowRecordRuleRequest withXProjectId(String xProjectId) {
    ...
    public ShowRecordRuleRequest withAppId(String appId) {
        this.appId = appId;
        return this;
    }
    ...
    public ShowRecordRuleRequest withRuleId(String ruleId) {
        this.ruleId = ruleId;
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append("class ShowRecordRuleRequest {\n");
