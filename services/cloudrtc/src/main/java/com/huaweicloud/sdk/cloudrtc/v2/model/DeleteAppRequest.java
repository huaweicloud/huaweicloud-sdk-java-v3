...
public class DeleteAppRequest {
    ...
    public DeleteAppRequest withAuthorization(String authorization) {
    ...
    public DeleteAppRequest withXSdkDate(String xSdkDate) {
    ...
    public DeleteAppRequest withXProjectId(String xProjectId) {
