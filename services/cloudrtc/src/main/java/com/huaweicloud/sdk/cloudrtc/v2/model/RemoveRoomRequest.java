...
public class RemoveRoomRequest {
    ...
    public RemoveRoomRequest withAuthorization(String authorization) {
    ...
    public RemoveRoomRequest withXSdkDate(String xSdkDate) {
    ...
    public RemoveRoomRequest withXProjectId(String xProjectId) {
    ...
    public RemoveRoomRequest withAppId(String appId) {
        this.appId = appId;
        return this;
    }
    ...
    public RemoveRoomRequest withRoomId(String roomId) {
        this.roomId = roomId;
        return this;
    }
    ...
    @Override
    public int hashCode() {
        return Objects.hash(authorization, xSdkDate, xProjectId, appId, roomId);
    }

    @Override
    public String toString() {
        StringBuilder sb = new StringBuilder();
        sb.append("class RemoveRoomRequest {\n");
