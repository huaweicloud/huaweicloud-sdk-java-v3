...
public class UpdateRecordRuleResponse extends SdkResponse {
    ...
    public UpdateRecordRuleResponse withRuleId(String ruleId) {
        this.ruleId = ruleId;
        return this;
    }
    ...
    public UpdateRecordRuleResponse withAppId(String appId) {
        this.appId = appId;
        return this;
    }
    ...
    public UpdateRecordRuleResponse withObsAddr(RecordObsFileAddr obsAddr) {
        this.obsAddr = obsAddr;
        return this;
    }

    public UpdateRecordRuleResponse withObsAddr(Consumer<RecordObsFileAddr> obsAddrSetter) {
    ...
    public UpdateRecordRuleResponse withRecordFormats(List<RecordFormatsEnum> recordFormats) {
        this.recordFormats = recordFormats;
        return this;
    }

    public UpdateRecordRuleResponse addRecordFormatsItem(RecordFormatsEnum recordFormatsItem) {
    ...
    public UpdateRecordRuleResponse withRecordFormats(Consumer<List<RecordFormatsEnum>> recordFormatsSetter) {
        if (this.recordFormats == null) {
            this.recordFormats = new ArrayList<>();
        }
    ...
    public UpdateRecordRuleResponse withHlsConfig(HLSRecordConfig hlsConfig) {
        this.hlsConfig = hlsConfig;
        return this;
    }

    public UpdateRecordRuleResponse withHlsConfig(Consumer<HLSRecordConfig> hlsConfigSetter) {
    ...
    public UpdateRecordRuleResponse withMp4Config(MP4RecordConfig mp4Config) {
        this.mp4Config = mp4Config;
        return this;
    }

    public UpdateRecordRuleResponse withMp4Config(Consumer<MP4RecordConfig> mp4ConfigSetter) {
    ...
    public UpdateRecordRuleResponse withCreateTime(String createTime) {
    ...
    public UpdateRecordRuleResponse withUpdateTime(String updateTime) {
    ...
    public UpdateRecordRuleResponse withXRequestId(String xRequestId) {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        return Objects.equals(this.ruleId, updateRecordRuleResponse.ruleId)
            && Objects.equals(this.appId, updateRecordRuleResponse.appId)
            && Objects.equals(this.obsAddr, updateRecordRuleResponse.obsAddr)
            && Objects.equals(this.recordFormats, updateRecordRuleResponse.recordFormats)
            && Objects.equals(this.hlsConfig, updateRecordRuleResponse.hlsConfig)
            && Objects.equals(this.mp4Config, updateRecordRuleResponse.mp4Config)
            ...
            && Objects.equals(this.xRequestId, updateRecordRuleResponse.xRequestId);
    }
