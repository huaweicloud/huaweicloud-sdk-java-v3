 ...
 */
public class ElbClusterPortReponseBody {
    ...
    public ElbClusterPortReponseBody withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public ElbClusterPortReponseBody withClusterId(String clusterId) {
    ...
    public ElbClusterPortReponseBody withElbId(String elbId) {
        this.elbId = elbId;
        return this;
    }
    ...
    public ElbClusterPortReponseBody withElbIp(String elbIp) {
        this.elbIp = elbIp;
        return this;
    }
    ...
    public ElbClusterPortReponseBody withMode(ModeEnum mode) {
        this.mode = mode;
        return this;
    }
    ...
    public ElbClusterPortReponseBody withListenerPort(Integer listenerPort) {
    ...
    public ElbClusterPortReponseBody withListenerId(String listenerId) {
    ...
    public ElbClusterPortReponseBody withServerGroupPort(Integer serverGroupPort) {
    ...
    public ElbClusterPortReponseBody withServerGroupId(String serverGroupId) {
    ...
    public ElbClusterPortReponseBody withProjectId(String projectId) {
    ...
    public ElbClusterPortReponseBody withValidateTime(String validateTime) {
    ...
    public ElbClusterPortReponseBody withWrong(Boolean wrong) {
        this.wrong = wrong;
        return this;
    }
    ...
    public ElbClusterPortReponseBody withWrongMsg(String wrongMsg) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ElbClusterPortReponseBody that = (ElbClusterPortReponseBody) obj;
    ...
    public String toString() {
        ...
        sb.append("class ElbClusterPortReponseBody {\n");
