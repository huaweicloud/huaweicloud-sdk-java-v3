...
public class ShowAppAccessKeyListRequest {
    ...
    public ShowAppAccessKeyListRequest withAppId(String appId) {
        this.appId = appId;
        return this;
    }
    ...
    public ShowAppAccessKeyListRequest withSortKey(String sortKey) {
    ...
    public ShowAppAccessKeyListRequest withSortDir(String sortDir) {
