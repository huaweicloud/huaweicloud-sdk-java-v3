 ...
 * Response Object
 */
public class CheckClusterPortResponse extends SdkResponse {
    ...
    public CheckClusterPortResponse withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public CheckClusterPortResponse withClusterId(String clusterId) {
    ...
    public CheckClusterPortResponse withElbId(String elbId) {
        this.elbId = elbId;
        return this;
    }
    ...
    public CheckClusterPortResponse withElbIp(String elbIp) {
        this.elbIp = elbIp;
        return this;
    }
    ...
    public CheckClusterPortResponse withMode(ModeEnum mode) {
        this.mode = mode;
        return this;
    }
    ...
    public CheckClusterPortResponse withListenerPort(Integer listenerPort) {
    ...
    public CheckClusterPortResponse withListenerId(String listenerId) {
    ...
    public CheckClusterPortResponse withServerGroupPort(Integer serverGroupPort) {
    ...
    public CheckClusterPortResponse withServerGroupId(String serverGroupId) {
    ...
    public CheckClusterPortResponse withProjectId(String projectId) {
    ...
    public CheckClusterPortResponse withValidateTime(String validateTime) {
    ...
    public CheckClusterPortResponse withWrong(Boolean wrong) {
        this.wrong = wrong;
        return this;
    }
    ...
    public CheckClusterPortResponse withWrongMsg(String wrongMsg) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        CheckClusterPortResponse that = (CheckClusterPortResponse) obj;
