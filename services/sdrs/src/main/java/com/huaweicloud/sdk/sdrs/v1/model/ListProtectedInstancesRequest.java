...
public class ListProtectedInstancesRequest {
    ...
    public ListProtectedInstancesRequest withServerGroupId(String serverGroupId) {
    ...
    public ListProtectedInstancesRequest withServerGroupIds(String serverGroupIds) {
    ...
    public ListProtectedInstancesRequest withProtectedInstanceIds(String protectedInstanceIds) {
    ...
    public ListProtectedInstancesRequest withLimit(Integer limit) {
        this.limit = limit;
        return this;
    }
    ...
    public ListProtectedInstancesRequest withOffset(Integer offset) {
        this.offset = offset;
        return this;
    }
    ...
    public ListProtectedInstancesRequest withStatus(String status) {
        this.status = status;
        return this;
    }
    ...
    public ListProtectedInstancesRequest withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public ListProtectedInstancesRequest withQueryType(QueryTypeEnum queryType) {
    ...
    public ListProtectedInstancesRequest withAvailabilityZone(String availabilityZone) {
