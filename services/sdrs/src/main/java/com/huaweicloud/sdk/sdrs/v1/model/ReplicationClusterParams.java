...
/** 复制集群相关参数 */
public class ReplicationClusterParams {
    ...
    public ReplicationClusterParams withAvailabilityZone(String availabilityZone) {
    ...
    public String toString() {
        ...
        sb.append("class ReplicationClusterParams {\n");
