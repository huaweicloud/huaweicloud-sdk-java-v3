...
public class PostPaidServerDataVolume {
    ...
    public PostPaidServerDataVolume withIops(Integer iops) {
        this.iops = iops;
        return this;
    }
    ...
    public PostPaidServerDataVolume withThroughput(Integer throughput) {
    ...
    public PostPaidServerDataVolume withDeleteOnTermination(Boolean deleteOnTermination) {
