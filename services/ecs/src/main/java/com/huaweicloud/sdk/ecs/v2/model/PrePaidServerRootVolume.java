...
public class PrePaidServerRootVolume {
    ...
    public PrePaidServerRootVolume withIops(Integer iops) {
        this.iops = iops;
        return this;
    }
    ...
    public PrePaidServerRootVolume withThroughput(Integer throughput) {
    ...
    public int hashCode() {
        return Objects
            .hash(volumetype, size, iops, throughput, extendparam, metadata, clusterType, clusterId, hwPassthrough);
    }
