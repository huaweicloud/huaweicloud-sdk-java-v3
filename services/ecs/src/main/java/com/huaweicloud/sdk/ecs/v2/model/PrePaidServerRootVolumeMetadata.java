 ...
 * 
 */
public class PrePaidServerRootVolumeMetadata {
    ...
    public PrePaidServerRootVolumeMetadata withSystemEncrypted(String systemEncrypted) {
    ...
    public PrePaidServerRootVolumeMetadata withSystemCmkid(String systemCmkid) {
    ...
    public String toString() {
        ...
        sb.append("class PrePaidServerRootVolumeMetadata {\n");
