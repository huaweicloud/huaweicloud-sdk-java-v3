...
public class RegisterServerMonitorRequestBody {
    ...
    public static final class MonitorMetricsEnum {
        ...
        public static MonitorMetricsEnum fromValue(String value) {
            ...
            return java.util.Optional.ofNullable(STATIC_FIELDS.get(value)).orElse(new MonitorMetricsEnum(value));
        }
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        RegisterServerMonitorRequestBody that = (RegisterServerMonitorRequestBody) obj;
        return Objects.equals(this.monitorMetrics, that.monitorMetrics);
    }
