 ...
 * 
 */
public class PostPaidServerRootVolumeMetadata {
    ...
    public PostPaidServerRootVolumeMetadata withSystemEncrypted(String systemEncrypted) {
    ...
    public PostPaidServerRootVolumeMetadata withSystemCmkid(String systemCmkid) {
    ...
    public String toString() {
        ...
        sb.append("class PostPaidServerRootVolumeMetadata {\n");
