 ...
 * 云服务器元数据配置请求体。
 */
public class UpdateServerMetadataOptionsRequestBody {
    ...
    public UpdateServerMetadataOptionsRequestBody withHttpEndpoint(HttpEndpointEnum httpEndpoint) {
    ...
    public UpdateServerMetadataOptionsRequestBody withHttpTokens(HttpTokensEnum httpTokens) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        UpdateServerMetadataOptionsRequestBody that = (UpdateServerMetadataOptionsRequestBody) obj;
    ...
    public String toString() {
        ...
        sb.append("class UpdateServerMetadataOptionsRequestBody {\n");
