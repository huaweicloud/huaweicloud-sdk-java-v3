...
public class StsClient {
     ...
     * @return AssumeAgencyWithOIDCResponse
     */
    public AssumeAgencyWithOIDCResponse assumeAgencyWithOIDC(AssumeAgencyWithOIDCRequest request) {
        return hcClient.syncInvokeHttp(request, StsMeta.assumeAgencyWithOIDC);
    }
     ...
     *
     * @param request AssumeAgencyWithOIDCRequest 请求对象
     * @return SyncInvoker<AssumeAgencyWithOIDCRequest, AssumeAgencyWithOIDCResponse>
     */
    public SyncInvoker<AssumeAgencyWithOIDCRequest, AssumeAgencyWithOIDCResponse> assumeAgencyWithOIDCInvoker(
        AssumeAgencyWithOIDCRequest request) {
        return new SyncInvoker<>(request, StsMeta.assumeAgencyWithOIDC, hcClient);
    }
     ...
     * @return AssumeAgencyWithSAMLResponse
     */
    public AssumeAgencyWithSAMLResponse assumeAgencyWithSAML(AssumeAgencyWithSAMLRequest request) {
        return hcClient.syncInvokeHttp(request, StsMeta.assumeAgencyWithSAML);
    }
     ...
     *
     * @param request AssumeAgencyWithSAMLRequest 请求对象
     * @return SyncInvoker<AssumeAgencyWithSAMLRequest, AssumeAgencyWithSAMLResponse>
     */
    public SyncInvoker<AssumeAgencyWithSAMLRequest, AssumeAgencyWithSAMLResponse> assumeAgencyWithSAMLInvoker(
        AssumeAgencyWithSAMLRequest request) {
        return new SyncInvoker<>(request, StsMeta.assumeAgencyWithSAML, hcClient);
    }
