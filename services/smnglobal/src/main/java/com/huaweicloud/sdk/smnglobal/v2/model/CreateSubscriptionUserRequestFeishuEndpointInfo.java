 ...
 */
public class CreateSubscriptionUserRequestFeishuEndpointInfo {
    ...
    public CreateSubscriptionUserRequestFeishuEndpointInfo withEndpoint(String endpoint) {
    ...
    public CreateSubscriptionUserRequestFeishuEndpointInfo withKeyword(String keyword) {
    ...
    public CreateSubscriptionUserRequestFeishuEndpointInfo withSignSecret(String signSecret) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        CreateSubscriptionUserRequestFeishuEndpointInfo that = (CreateSubscriptionUserRequestFeishuEndpointInfo) obj;
    ...
    public String toString() {
        ...
        sb.append("class CreateSubscriptionUserRequestFeishuEndpointInfo {\n");
