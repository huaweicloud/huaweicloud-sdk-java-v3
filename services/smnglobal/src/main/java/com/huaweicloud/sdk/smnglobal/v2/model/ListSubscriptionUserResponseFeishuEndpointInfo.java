...
public class ListSubscriptionUserResponseFeishuEndpointInfo {
    ...
    public ListSubscriptionUserResponseFeishuEndpointInfo withEndpoint(String endpoint) {
    ...
    public ListSubscriptionUserResponseFeishuEndpointInfo withKeyword(String keyword) {
    ...
    public ListSubscriptionUserResponseFeishuEndpointInfo withSignSecret(String signSecret) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ListSubscriptionUserResponseFeishuEndpointInfo that = (ListSubscriptionUserResponseFeishuEndpointInfo) obj;
