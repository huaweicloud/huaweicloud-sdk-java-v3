 ...
 * 支付属性
 */
public class UpdatePrepaidOptions {
    ...
    public UpdatePrepaidOptions withPeriodType(PeriodTypeEnum periodType) {
    ...
    public UpdatePrepaidOptions withPeriodNum(Integer periodNum) {
    ...
    public UpdatePrepaidOptions withIsAutoRenew(Boolean isAutoRenew) {
    ...
    public UpdatePrepaidOptions withIsAutoPay(Boolean isAutoPay) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        UpdatePrepaidOptions that = (UpdatePrepaidOptions) obj;
    ...
    public String toString() {
        ...
        sb.append("class UpdatePrepaidOptions {\n");
