...
public class EnterpriseRouterId {
    ...
    public EnterpriseRouterId withEnterpriseRouterId(String enterpriseRouterId) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        EnterpriseRouterId that = (EnterpriseRouterId) obj;
        return Objects.equals(this.enterpriseRouterId, that.enterpriseRouterId);
    }

    @Override
    public int hashCode() {
        return Objects.hash(enterpriseRouterId);
    }
