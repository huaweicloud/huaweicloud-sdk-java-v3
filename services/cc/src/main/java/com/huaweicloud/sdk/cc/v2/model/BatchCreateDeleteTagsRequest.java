...
public class BatchCreateDeleteTagsRequest {
    ...
    public BatchCreateDeleteTagsRequest withBody(ResourceTags body) {
        this.body = body;
        return this;
    }

    public BatchCreateDeleteTagsRequest withBody(Consumer<ResourceTags> bodySetter) {
        if (this.body == null) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        BatchCreateDeleteTagsRequest that = (BatchCreateDeleteTagsRequest) obj;
