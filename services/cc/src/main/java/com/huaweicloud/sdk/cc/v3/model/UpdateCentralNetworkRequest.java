...
public class UpdateCentralNetworkRequest {
    ...
    private UpdateCentralNetworkRequestBody body;

    public UpdateCentralNetworkRequest withCentralNetworkId(String centralNetworkId) {
    ...
    public UpdateCentralNetworkRequest withBody(UpdateCentralNetworkRequestBody body) {
        this.body = body;
        return this;
    }

    public UpdateCentralNetworkRequest withBody(Consumer<UpdateCentralNetworkRequestBody> bodySetter) {
        if (this.body == null) {
            this.body = new UpdateCentralNetworkRequestBody();
     ...
     * @return body
     */
    public UpdateCentralNetworkRequestBody getBody() {
        return body;
    }

    public void setBody(UpdateCentralNetworkRequestBody body) {
        this.body = body;
    }
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        UpdateCentralNetworkRequest that = (UpdateCentralNetworkRequest) obj;
