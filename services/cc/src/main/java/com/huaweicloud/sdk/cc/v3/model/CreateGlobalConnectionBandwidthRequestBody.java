...
public class CreateGlobalConnectionBandwidthRequestBody {
    ...
    private CreateGlobalConnectionBandwidth globalconnectionBandwidth;

    public CreateGlobalConnectionBandwidthRequestBody withGlobalconnectionBandwidth(
        CreateGlobalConnectionBandwidth globalconnectionBandwidth) {
        this.globalconnectionBandwidth = globalconnectionBandwidth;
        return this;
    }

    public CreateGlobalConnectionBandwidthRequestBody withGlobalconnectionBandwidth(
        Consumer<CreateGlobalConnectionBandwidth> globalconnectionBandwidthSetter) {
        if (this.globalconnectionBandwidth == null) {
            this.globalconnectionBandwidth = new CreateGlobalConnectionBandwidth();
     ...
     */
    public CreateGlobalConnectionBandwidth getGlobalconnectionBandwidth() {
        return globalconnectionBandwidth;
    }

    public void setGlobalconnectionBandwidth(CreateGlobalConnectionBandwidth globalconnectionBandwidth) {
        this.globalconnectionBandwidth = globalconnectionBandwidth;
    }
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        CreateGlobalConnectionBandwidthRequestBody that = (CreateGlobalConnectionBandwidthRequestBody) obj;
