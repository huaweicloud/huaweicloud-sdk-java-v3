 ...
 * Response Object
 */
public class ShowCentralNetworkResponse extends SdkResponse {
    ...
    public ShowCentralNetworkResponse withRequestId(String requestId) {
    ...
    public ShowCentralNetworkResponse withCentralNetwork(CentralNetwork centralNetwork) {
        this.centralNetwork = centralNetwork;
        return this;
    }

    public ShowCentralNetworkResponse withCentralNetwork(Consumer<CentralNetwork> centralNetworkSetter) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ShowCentralNetworkResponse that = (ShowCentralNetworkResponse) obj;
