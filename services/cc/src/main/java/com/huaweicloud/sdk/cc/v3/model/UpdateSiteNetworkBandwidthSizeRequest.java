...
public class UpdateSiteNetworkBandwidthSizeRequest {
    ...
    private UpdateSiteConnectionBandwidthSizeRequestBody body;

    public UpdateSiteNetworkBandwidthSizeRequest withSiteNetworkId(String siteNetworkId) {
    ...
    public UpdateSiteNetworkBandwidthSizeRequest withSiteConnectionId(String siteConnectionId) {
    ...
    public UpdateSiteNetworkBandwidthSizeRequest withBody(UpdateSiteConnectionBandwidthSizeRequestBody body) {
        this.body = body;
        return this;
    }

    public UpdateSiteNetworkBandwidthSizeRequest withBody(
        Consumer<UpdateSiteConnectionBandwidthSizeRequestBody> bodySetter) {
        if (this.body == null) {
            this.body = new UpdateSiteConnectionBandwidthSizeRequestBody();
     ...
     * @return body
     */
    public UpdateSiteConnectionBandwidthSizeRequestBody getBody() {
        return body;
    }

    public void setBody(UpdateSiteConnectionBandwidthSizeRequestBody body) {
        this.body = body;
    }
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        UpdateSiteNetworkBandwidthSizeRequest that = (UpdateSiteNetworkBandwidthSizeRequest) obj;
