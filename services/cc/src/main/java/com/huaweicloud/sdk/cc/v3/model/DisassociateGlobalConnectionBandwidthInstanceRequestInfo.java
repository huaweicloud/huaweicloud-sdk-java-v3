 ...
 */
public class DisassociateGlobalConnectionBandwidthInstanceRequestInfo {
    ...
    public DisassociateGlobalConnectionBandwidthInstanceRequestInfo withResourceType(String resourceType) {
