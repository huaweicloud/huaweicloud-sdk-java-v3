 ...
 * 支付属性
 */
public class CreatePrepaidOptions {
    ...
    public CreatePrepaidOptions withPeriodType(PeriodTypeEnum periodType) {
    ...
    public CreatePrepaidOptions withPeriodNum(Integer periodNum) {
    ...
    public CreatePrepaidOptions withIsAutoRenew(Boolean isAutoRenew) {
    ...
    public CreatePrepaidOptions withIsAutoPay(Boolean isAutoPay) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        CreatePrepaidOptions that = (CreatePrepaidOptions) obj;
    ...
    public String toString() {
        ...
        sb.append("class CreatePrepaidOptions {\n");
