...
public class DisassociateGlobalConnectionBandwidthInstanceResponseInfo {
    ...
    public DisassociateGlobalConnectionBandwidthInstanceResponseInfo withResourceId(String resourceId) {
    ...
    public DisassociateGlobalConnectionBandwidthInstanceResponseInfo withResourceType(String resourceType) {
    ...
    public DisassociateGlobalConnectionBandwidthInstanceResponseInfo withRegionId(String regionId) {
    ...
    public DisassociateGlobalConnectionBandwidthInstanceResponseInfo withProjectId(String projectId) {
    ...
    public DisassociateGlobalConnectionBandwidthInstanceResponseInfo withResult(ResultEnum result) {
        this.result = result;
        return this;
    }
    ...
    public DisassociateGlobalConnectionBandwidthInstanceResponseInfo withMessage(String message) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        DisassociateGlobalConnectionBandwidthInstanceResponseInfo that =
            (DisassociateGlobalConnectionBandwidthInstanceResponseInfo) obj;
