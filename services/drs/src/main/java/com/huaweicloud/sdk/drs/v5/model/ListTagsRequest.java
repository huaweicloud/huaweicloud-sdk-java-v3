...
public class ListTagsRequest {
    ...
    public ListTagsRequest withResourceType(ResourceTypeEnum resourceType) {
    ...
    public ListTagsRequest withXLanguage(XLanguageEnum xLanguage) {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(resourceType, xLanguage);
    }
