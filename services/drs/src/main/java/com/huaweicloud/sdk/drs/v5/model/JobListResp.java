...
public class JobListResp {
    ...
    private List<ChildrenJobListResp> children = null;

    public JobListResp withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public JobListResp withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public JobListResp withStatus(StatusEnum status) {
        this.status = status;
        return this;
    }
    ...
    public JobListResp withDescription(String description) {
    ...
    public JobListResp withCreateTime(String createTime) {
    ...
    public JobListResp withEngineType(EngineTypeEnum engineType) {
    ...
    public JobListResp withNetType(NetTypeEnum netType) {
    ...
    public JobListResp withChargingMode(ChargingModeEnum chargingMode) {
    ...
    public JobListResp withBillingTag(Boolean billingTag) {
    ...
    public JobListResp withJobDirection(JobDirectionEnum jobDirection) {
    ...
    public JobListResp withJobType(JobTypeEnum jobType) {
    ...
    public JobListResp withTaskType(TaskTypeEnum taskType) {
    ...
    public JobListResp withEnterpriseProjectId(String enterpriseProjectId) {
    ...
    public JobListResp withJobMode(JobModeEnum jobMode) {
    ...
    public JobListResp withJobModeRole(JobModeRoleEnum jobModeRole) {
    ...
    public JobListResp withIsMultiAz(Boolean isMultiAz) {
    ...
    public JobListResp withNodeRole(String nodeRole) {
    ...
    public JobListResp withNodeNewFramework(Boolean nodeNewFramework) {
    ...
    public JobListResp withJobAction(JobActions jobAction) {
        this.jobAction = jobAction;
        return this;
    }

    public JobListResp withJobAction(Consumer<JobActions> jobActionSetter) {
    ...
    public JobListResp withChildren(List<ChildrenJobListResp> children) {
        this.children = children;
        return this;
    }

    public JobListResp addChildrenItem(ChildrenJobListResp childrenItem) {
    ...
    public JobListResp withChildren(Consumer<List<ChildrenJobListResp>> childrenSetter) {
        if (this.children == null) {
            this.children = new ArrayList<>();
        }
     ...
     * @return children
     */
    public List<ChildrenJobListResp> getChildren() {
        return children;
    }

    public void setChildren(List<ChildrenJobListResp> children) {
        this.children = children;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        JobListResp jobListResp = (JobListResp) o;
        return Objects.equals(this.id, jobListResp.id) && Objects.equals(this.name, jobListResp.name)
            && Objects.equals(this.status, jobListResp.status)
            && Objects.equals(this.description, jobListResp.description)
            && Objects.equals(this.createTime, jobListResp.createTime)
            && Objects.equals(this.engineType, jobListResp.engineType)
            && Objects.equals(this.netType, jobListResp.netType)
            && Objects.equals(this.chargingMode, jobListResp.chargingMode)
            && Objects.equals(this.billingTag, jobListResp.billingTag)
            && Objects.equals(this.jobDirection, jobListResp.jobDirection)
            && Objects.equals(this.jobType, jobListResp.jobType) && Objects.equals(this.taskType, jobListResp.taskType)
            && Objects.equals(this.enterpriseProjectId, jobListResp.enterpriseProjectId)
            && Objects.equals(this.jobMode, jobListResp.jobMode)
            && Objects.equals(this.jobModeRole, jobListResp.jobModeRole)
            && Objects.equals(this.isMultiAz, jobListResp.isMultiAz)
            && Objects.equals(this.nodeRole, jobListResp.nodeRole)
            && Objects.equals(this.nodeNewFramework, jobListResp.nodeNewFramework)
            && Objects.equals(this.jobAction, jobListResp.jobAction)
            && Objects.equals(this.children, jobListResp.children);
    }
