...
public class CollectDbObjectsAsyncRequest {
    ...
    public static final class TypeEnum {
         ...
         */
        public static final TypeEnum MODIFIED = new TypeEnum("modified");
    ...
    public CollectDbObjectsAsyncRequest withJobId(String jobId) {
        this.jobId = jobId;
        return this;
    }
    ...
    public CollectDbObjectsAsyncRequest withXLanguage(XLanguageEnum xLanguage) {
    ...
    public CollectDbObjectsAsyncRequest withOffset(Integer offset) {
        this.offset = offset;
        return this;
    }
    ...
    public CollectDbObjectsAsyncRequest withLimit(Integer limit) {
        this.limit = limit;
        return this;
    }
    ...
    public CollectDbObjectsAsyncRequest withType(TypeEnum type) {
        this.type = type;
        return this;
    }
    ...
    public CollectDbObjectsAsyncRequest withIsRefresh(Boolean isRefresh) {
    ...
    public CollectDbObjectsAsyncRequest withDbNames(List<String> dbNames) {
        this.dbNames = dbNames;
        return this;
    }

    public CollectDbObjectsAsyncRequest addDbNamesItem(String dbNamesItem) {
    ...
    public CollectDbObjectsAsyncRequest withDbNames(Consumer<List<String>> dbNamesSetter) {
        if (this.dbNames == null) {
            this.dbNames = new ArrayList<>();
        }
    ...
    @Override
    public int hashCode() {
        return Objects.hash(jobId, xLanguage, offset, limit, type, isRefresh, dbNames);
    }
