...
import com.huaweicloud.sdk.drs.v3.model.ContentCompareResultDetails;
import com.huaweicloud.sdk.drs.v3.model.ContentCompareResultDiffs;
import com.huaweicloud.sdk.drs.v3.model.ContentCompareResultOverview;
...
public class ContentCompareResult  {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(compareTaskId, contentCompareOverview, contentCompareOverviewCount, contentCompareDetails, contentCompareDiffs, errorCode, errorMsg);
    }
    @Override
    public String toString() {
        ...
        sb.append("    contentCompareOverviewCount: ").append(toIndentedString(contentCompareOverviewCount)).append("\n");
