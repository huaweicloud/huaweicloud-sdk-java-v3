...
public class ShowChildNumRequest {
    ...
    public ShowChildNumRequest withInstanceId(String instanceId) {
    ...
    public ShowChildNumRequest withRegion(String region) {
        this.region = region;
        return this;
    }
    ...
    public ShowChildNumRequest withXLanguage(XLanguageEnum xLanguage) {
    ...
    public ShowChildNumRequest withDbType(DbTypeEnum dbType) {
        this.dbType = dbType;
        return this;
    }
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ShowChildNumRequest that = (ShowChildNumRequest) obj;
        return Objects.equals(this.instanceId, that.instanceId) && Objects.equals(this.region, that.region)
            && Objects.equals(this.xLanguage, that.xLanguage) && Objects.equals(this.dbType, that.dbType);
    }

    @Override
    public int hashCode() {
        return Objects.hash(instanceId, region, xLanguage, dbType);
    }
