...
public class ObjectCompareResult {
    ...
    @JacksonXmlProperty(localName = "object_compare_overview")
    ...
    @JacksonXmlProperty(localName = "object_compare_details")
    ...
    public ObjectCompareResult withObjectCompareOverview(
        Consumer<List<ObjectCompareResultOverview>> objectCompareOverviewSetter) {
        if (this.objectCompareOverview == null) {
            this.objectCompareOverview = new ArrayList<>();
        }
    ...
    public ObjectCompareResult withObjectCompareDetails(
        Map<String, List<ObjectCompareResultDetails>> objectCompareDetails) {
        this.objectCompareDetails = objectCompareDetails;
        return this;
    }

    public ObjectCompareResult putObjectCompareDetailsItem(String key,
        List<ObjectCompareResultDetails> objectCompareDetailsItem) {
    ...
    public ObjectCompareResult withObjectCompareDetails(
        Consumer<Map<String, List<ObjectCompareResultDetails>>> objectCompareDetailsSetter) {
        if (this.objectCompareDetails == null) {
            this.objectCompareDetails = new HashMap<>();
        }
