 ...
 * Request Object
 */
public class CountInstanceByTagsRequest {
    ...
    public CountInstanceByTagsRequest withResourceType(ResourceTypeEnum resourceType) {
    ...
    public CountInstanceByTagsRequest withXLanguage(XLanguageEnum xLanguage) {
    ...
    public CountInstanceByTagsRequest withBody(QueryInstanceByTagReq body) {
        this.body = body;
        return this;
    }

    public CountInstanceByTagsRequest withBody(Consumer<QueryInstanceByTagReq> bodySetter) {
        if (this.body == null) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        CountInstanceByTagsRequest that = (CountInstanceByTagsRequest) obj;
    ...
    @Override
    public int hashCode() {
        return Objects.hash(resourceType, xLanguage, body);
    }

    @Override
    public String toString() {
        StringBuilder sb = new StringBuilder();
        sb.append("class CountInstanceByTagsRequest {\n");
