...
public class CreateCompareTaskReq {
    ...
    public static final class ObjectLevelCompareTypeEnum {
        ...
        public static ObjectLevelCompareTypeEnum fromValue(String value) {
            ...
            return java.util.Optional.ofNullable(STATIC_FIELDS.get(value))
                .orElse(new ObjectLevelCompareTypeEnum(value));
        }
        ...
        public boolean equals(Object obj) {
            if (obj instanceof ObjectLevelCompareTypeEnum) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        CreateCompareTaskReq that = (CreateCompareTaskReq) obj;
        return Objects.equals(this.jobId, that.jobId)
            && Objects.equals(this.objectLevelCompareType, that.objectLevelCompareType)
            && Objects.equals(this.dataLevelCompareInfo, that.dataLevelCompareInfo);
    }
