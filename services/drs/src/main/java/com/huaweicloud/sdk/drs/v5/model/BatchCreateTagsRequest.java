...
public class BatchCreateTagsRequest {
    ...
    public BatchCreateTagsRequest withXLanguage(XLanguageEnum xLanguage) {
    ...
    public BatchCreateTagsRequest withBody(BatchAddTagReq body) {
        this.body = body;
        return this;
    }

    public BatchCreateTagsRequest withBody(Consumer<BatchAddTagReq> bodySetter) {
        if (this.body == null) {
            this.body = new BatchAddTagReq();
     ...
     * @return body
     */
    public BatchAddTagReq getBody() {
        return body;
    }

    public void setBody(BatchAddTagReq body) {
        this.body = body;
    }
    ...
    @Override
    public int hashCode() {
        return Objects.hash(resourceType, xLanguage, resourceId, body);
    }
