...
public class BatchDeleteTagsRequest {
    ...
    public BatchDeleteTagsRequest withResourceType(ResourceTypeEnum resourceType) {
    ...
    public BatchDeleteTagsRequest withXLanguage(XLanguageEnum xLanguage) {
    ...
    public BatchDeleteTagsRequest withBody(BatchDeleteTagReq body) {
        this.body = body;
        return this;
    }

    public BatchDeleteTagsRequest withBody(Consumer<BatchDeleteTagReq> bodySetter) {
        if (this.body == null) {
