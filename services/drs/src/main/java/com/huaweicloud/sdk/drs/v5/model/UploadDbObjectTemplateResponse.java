 ...
 * Response Object
 */
public class UploadDbObjectTemplateResponse extends SdkResponse {
    ...
    public UploadDbObjectTemplateResponse withSendSuccess(Boolean sendSuccess) {
    ...
    public UploadDbObjectTemplateResponse withProcessStatus(String processStatus) {
    ...
    public UploadDbObjectTemplateResponse withParsedSuccessNumber(String parsedSuccessNumber) {
