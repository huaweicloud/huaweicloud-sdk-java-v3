...
public class ShowInstanceTagsRequest {
    ...
    public ShowInstanceTagsRequest withResourceType(ResourceTypeEnum resourceType) {
    ...
    public ShowInstanceTagsRequest withJobId(String jobId) {
        this.jobId = jobId;
        return this;
    }
    ...
    public ShowInstanceTagsRequest withXLanguage(XLanguageEnum xLanguage) {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(resourceType, jobId, xLanguage);
    }
