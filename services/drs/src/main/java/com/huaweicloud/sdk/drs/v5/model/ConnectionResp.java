...
public class ConnectionResp {
    ...
    public ConnectionResp withConnectionId(String connectionId) {
    ...
    public ConnectionResp withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public ConnectionResp withCreateTime(Long createTime) {
    ...
    public ConnectionResp withDbType(String dbType) {
        this.dbType = dbType;
        return this;
    }
    ...
    public ConnectionResp withConfig(ConnectionConfig config) {
        this.config = config;
        return this;
    }

    public ConnectionResp withConfig(Consumer<ConnectionConfig> configSetter) {
        if (this.config == null) {
    ...
    public ConnectionResp withEndpoint(BaseEndpoint endpoint) {
        this.endpoint = endpoint;
        return this;
    }

    public ConnectionResp withEndpoint(Consumer<BaseEndpoint> endpointSetter) {
    ...
    public ConnectionResp withVpc(CloudVpcInfo vpc) {
        this.vpc = vpc;
        return this;
    }

    public ConnectionResp withVpc(Consumer<CloudVpcInfo> vpcSetter) {
        if (this.vpc == null) {
    ...
    public ConnectionResp withSsl(EndpointSslConfig ssl) {
        this.ssl = ssl;
        return this;
    }

    public ConnectionResp withSsl(Consumer<EndpointSslConfig> sslSetter) {
        if (this.ssl == null) {
    ...
    public ConnectionResp withEnterpriseProjectId(String enterpriseProjectId) {
    ...
    public ConnectionResp withDescription(String description) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ConnectionResp that = (ConnectionResp) obj;
