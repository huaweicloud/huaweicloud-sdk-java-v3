...
public class ChargeInfoVo {
    ...
    public ChargeInfoVo withChargeMode(String chargeMode) {
    ...
    public ChargeInfoVo withPeriodType(String periodType) {
    ...
    public ChargeInfoVo withPeriodNum(Integer periodNum) {
    ...
    public ChargeInfoVo withIsAutoRenew(Boolean isAutoRenew) {
    ...
    public ChargeInfoVo withIsAutoPay(Boolean isAutoPay) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ChargeInfoVo that = (ChargeInfoVo) obj;
