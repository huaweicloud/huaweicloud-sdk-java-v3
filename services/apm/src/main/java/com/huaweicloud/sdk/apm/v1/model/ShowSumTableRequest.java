...
public class ShowSumTableRequest {
    ...
    public ShowSumTableRequest withXBusinessId(Long xBusinessId) {
    ...
    public ShowSumTableRequest withBody(SumTableParam body) {
        this.body = body;
        return this;
    }

    public ShowSumTableRequest withBody(Consumer<SumTableParam> bodySetter) {
        if (this.body == null) {
    ...
    public void setBody(SumTableParam body) {
        this.body = body;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ShowSumTableRequest showSumTableRequest = (ShowSumTableRequest) o;
        return Objects.equals(this.xBusinessId, showSumTableRequest.xBusinessId)
            && Objects.equals(this.body, showSumTableRequest.body);
    }
