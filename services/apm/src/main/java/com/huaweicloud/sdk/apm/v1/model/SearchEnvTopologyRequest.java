 ...
 * Request Object
 */
public class SearchEnvTopologyRequest {
    ...
    private EnvTopoRequest body;

    public SearchEnvTopologyRequest withXBusinessId(Long xBusinessId) {
    ...
    public SearchEnvTopologyRequest withBody(EnvTopoRequest body) {
        this.body = body;
        return this;
    }

    public SearchEnvTopologyRequest withBody(Consumer<EnvTopoRequest> bodySetter) {
        if (this.body == null) {
            this.body = new EnvTopoRequest();
     ...
     * @return body
     */
    public EnvTopoRequest getBody() {
        return body;
    }

    public void setBody(EnvTopoRequest body) {
        this.body = body;
    }
    ...
    public String toString() {
        ...
        sb.append("class SearchEnvTopologyRequest {\n");
