 ...
 * Response Object
 */
public class SearchBusinessTopologyResponse extends SdkResponse {
    ...
    public SearchBusinessTopologyResponse withNodeList(List<TopoNode> nodeList) {
        this.nodeList = nodeList;
        return this;
    }

    public SearchBusinessTopologyResponse addNodeListItem(TopoNode nodeListItem) {
    ...
    public SearchBusinessTopologyResponse withNodeList(Consumer<List<TopoNode>> nodeListSetter) {
        if (this.nodeList == null) {
            this.nodeList = new ArrayList<>();
        }
    ...
    public SearchBusinessTopologyResponse withLineList(List<TopoLine> lineList) {
        this.lineList = lineList;
        return this;
    }

    public SearchBusinessTopologyResponse addLineListItem(TopoLine lineListItem) {
    ...
    public SearchBusinessTopologyResponse withLineList(Consumer<List<TopoLine>> lineListSetter) {
        if (this.lineList == null) {
            this.lineList = new ArrayList<>();
        }
    ...
    public SearchBusinessTopologyResponse withCollectorConfig(Map<String, CollectorConfigModel> collectorConfig) {
        this.collectorConfig = collectorConfig;
        return this;
    }

    public SearchBusinessTopologyResponse putCollectorConfigItem(String key, CollectorConfigModel collectorConfigItem) {
    ...
    public SearchBusinessTopologyResponse withCollectorConfig(
    ...
    public SearchBusinessTopologyResponse withRealStartTime(Long realStartTime) {
    ...
    public SearchBusinessTopologyResponse withRealEndTime(Long realEndTime) {
    ...
    public String toString() {
        ...
        sb.append("class SearchBusinessTopologyResponse {\n");
