...
public class ShowFlameLineTreeRequest {
    ...
    public ShowFlameLineTreeRequest withBody(Consumer<FlameLineTreeInfo> bodySetter) {
        if (this.body == null) {
            this.body = new FlameLineTreeInfo();
     ...
     * @return body
     */
    public FlameLineTreeInfo getBody() {
        return body;
    }

    public void setBody(FlameLineTreeInfo body) {
        this.body = body;
    }
