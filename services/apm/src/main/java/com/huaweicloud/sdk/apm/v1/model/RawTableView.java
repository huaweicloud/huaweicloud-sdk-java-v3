...
public class RawTableView {
    ...
    public RawTableView withViewType(ViewTypeEnum viewType) {
    ...
    public RawTableView withCollectorName(String collectorName) {
    ...
    public RawTableView withMetricSet(String metricSet) {
    ...
    public RawTableView withTitle(String title) {
        this.title = title;
        return this;
    }
    ...
    public RawTableView withTableDirection(TableDirectionEnum tableDirection) {
    ...
    public RawTableView withGroupBy(String groupBy) {
    ...
    public RawTableView withFilter(String filter) {
        this.filter = filter;
        return this;
    }
    ...
    public RawTableView withFieldItemList(List<FieldItem> fieldItemList) {
        this.fieldItemList = fieldItemList;
        return this;
    }

    public RawTableView addFieldItemListItem(FieldItem fieldItemListItem) {
    ...
    public RawTableView withFieldItemList(Consumer<List<FieldItem>> fieldItemListSetter) {
        if (this.fieldItemList == null) {
            this.fieldItemList = new ArrayList<>();
        }
    ...
    public RawTableView withSpan(Boolean span) {
        this.span = span;
        return this;
    }
    ...
    public RawTableView withSpanField(String spanField) {
    ...
    public RawTableView withOrderBy(String orderBy) {
    ...
    public RawTableView withLatest(Boolean latest) {
        this.latest = latest;
        return this;
    }
