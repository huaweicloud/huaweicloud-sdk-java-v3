package com.huaweicloud.sdk.cts.v3.region;
...
public class CtsRegion {
    ...
    public static final Region AP_SOUTHEAST_5 = new Region("ap-southeast-5",
        "https://cts.ap-southeast-5.myhuaweicloud.com", "https://cts.ap-southeast-5.myhuaweicloud.asia");

    public static final Region AF_NORTH_1 = new Region("af-north-1", "https://cts.af-north-1.myhuaweicloud.com",
    ...
    public static final Region CN_EAST_5 =
        new Region("cn-east-5", "https://cts.cn-east-5.myhuaweicloud.com", "https://cts.cn-east-5.myhuaweicloud.cn");

    public static final Region CN_NORTH_12 = new Region("cn-north-12", "https://cts.cn-north-12.myhuaweicloud.com",
        "https://cts.cn-north-12.myhuaweicloud.cn");

    public static final Region CN_SOUTHWEST_3 = new Region("cn-southwest-3",
        "https://cts.cn-southwest-3.myhuaweicloud.com", "https://cts.cn-southwest-3.myhuaweicloud.cn");

    public static final Region CN_NORTH_11 = new Region("cn-north-11", "https://cts.cn-north-11.myhuaweicloud.com",
        "https://cts.cn-north-11.myhuaweicloud.cn");

    public static final Region CN_EAST_4 =
        new Region("cn-east-4", "https://cts.cn-east-4.myhuaweicloud.com", "https://cts.cn-east-4.myhuaweicloud.cn");

    public static final Region ME_EAST_1 = new Region("me-east-1", "https://cts.me-east-1.myhuaweicloud.com");

    public static final Region EU_WEST_0 = new Region("eu-west-0", "https://cts.eu-west-0.myhuaweicloud.com");

    public static final Region MY_KUALALUMPUR_1 =
        new Region("my-kualalumpur-1", "https://cts.my-kualalumpur-1.myhuaweicloud.com");
    ...
    public static Region valueOf(String regionId) {
        ...
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "region id '%s' is not in the following supported regions of service CTS: [%s]",
            regionId,
