...
public class NotificationsResponseBody {
    ...
    */
    ...
    public NotificationsResponseBody withFilter(Filter filter) {
        this.filter = filter;
        return this;
    }

    public NotificationsResponseBody withFilter(Consumer<Filter> filterSetter) {
        if (this.filter == null) {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        return Objects.equals(this.notificationName, notificationsResponseBody.notificationName)
            ...
            && Objects.equals(this.filter, notificationsResponseBody.filter);
    }
