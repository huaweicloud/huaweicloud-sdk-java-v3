 ...
 * Response Object
 */
public class UpdateAcceleratorResponse extends SdkResponse {
    ...
    public UpdateAcceleratorResponse withAccelerator(AcceleratorDetail accelerator) {
        this.accelerator = accelerator;
        return this;
    }

    public UpdateAcceleratorResponse withAccelerator(Consumer<AcceleratorDetail> acceleratorSetter) {
    ...
    public UpdateAcceleratorResponse withRequestId(String requestId) {
