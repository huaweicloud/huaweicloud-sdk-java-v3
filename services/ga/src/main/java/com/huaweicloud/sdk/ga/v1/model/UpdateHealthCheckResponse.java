...
public class UpdateHealthCheckResponse extends SdkResponse {
    ...
    public UpdateHealthCheckResponse withHealthCheck(HealthCheckDetail healthCheck) {
        this.healthCheck = healthCheck;
        return this;
    }

    public UpdateHealthCheckResponse withHealthCheck(Consumer<HealthCheckDetail> healthCheckSetter) {
    ...
    public UpdateHealthCheckResponse withRequestId(String requestId) {
