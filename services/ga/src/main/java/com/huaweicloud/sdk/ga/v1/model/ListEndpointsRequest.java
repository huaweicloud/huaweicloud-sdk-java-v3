...
public class ListEndpointsRequest {
    ...
    public ListEndpointsRequest withEndpointGroupId(String endpointGroupId) {
    ...
    public ListEndpointsRequest withMarker(String marker) {
        this.marker = marker;
        return this;
    }
    ...
    public ListEndpointsRequest withPageReverse(Boolean pageReverse) {
    ...
    public ListEndpointsRequest withStatus(StatusEnum status) {
        this.status = status;
        return this;
    }
    ...
    @Override
    public int hashCode() {
        return Objects.hash(endpointGroupId, limit, marker, pageReverse, id, status);
    }
