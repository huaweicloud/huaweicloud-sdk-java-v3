...
public class ModelServiceRsp {
    ...
    public ModelServiceRsp withServiceId(String serviceId) {
    ...
    public ModelServiceRsp withServiceName(String serviceName) {
    ...
    public ModelServiceRsp withServiceDesc(String serviceDesc) {
    ...
    public ModelServiceRsp withStatus(String status) {
        this.status = status;
        return this;
    }
    ...
    public ModelServiceRsp withInferType(String inferType) {
    ...
    public ModelServiceRsp withDeviceType(String deviceType) {
    ...
    public ModelServiceRsp withChipType(String chipType) {
    ...
    public ModelServiceRsp withRequestMode(String requestMode) {
    ...
    public ModelServiceRsp withAssetId(String assetId) {
    ...
    public ModelServiceRsp withAssetName(String assetName) {
    ...
    public ModelServiceRsp withAssetType(String assetType) {
    ...
    public ModelServiceRsp withAssetSubType(String assetSubType) {
    ...
    public ModelServiceRsp withApiUrl(String apiUrl) {
        this.apiUrl = apiUrl;
        return this;
    }
    ...
    public ModelServiceRsp withChatId(String chatId) {
        this.chatId = chatId;
        return this;
    }
    ...
    public ModelServiceRsp withUserId(String userId) {
        this.userId = userId;
        return this;
    }
    ...
    public ModelServiceRsp withUserName(String userName) {
    ...
    public ModelServiceRsp withPlatform(String platform) {
    ...
    public ModelServiceRsp withTrainObsOutput(String trainObsOutput) {
    ...
    public ModelServiceRsp withUseType(String useType) {
    ...
    public ModelServiceRsp withServiceConfig(ModelServiceConfig serviceConfig) {
        this.serviceConfig = serviceConfig;
        return this;
    }

    public ModelServiceRsp withServiceConfig(Consumer<ModelServiceConfig> serviceConfigSetter) {
    ...
    public ModelServiceRsp withCreateTime(Long createTime) {
    ...
    public ModelServiceRsp withUpdateTime(Long updateTime) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ModelServiceRsp that = (ModelServiceRsp) obj;
