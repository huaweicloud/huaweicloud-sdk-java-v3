 ...
 * Response Object
 */
public class ShowModelAssetDetailResponse extends SdkResponse {
    ...
    public ShowModelAssetDetailResponse withAssetId(String assetId) {
    ...
    public ShowModelAssetDetailResponse withRootAssetId(String rootAssetId) {
    ...
    public ShowModelAssetDetailResponse withAssetName(String assetName) {
    ...
    public ShowModelAssetDetailResponse withAssetVersion(String assetVersion) {
    ...
    public ShowModelAssetDetailResponse withExternalVersion(String externalVersion) {
    ...
    public ShowModelAssetDetailResponse withIsAvailable(String isAvailable) {
    ...
    public ShowModelAssetDetailResponse withAssetLocation(String assetLocation) {
    ...
    public ShowModelAssetDetailResponse withAssetDesc(String assetDesc) {
    ...
    public ShowModelAssetDetailResponse withAssetType(String assetType) {
    ...
    public ShowModelAssetDetailResponse withSubAssetType(String subAssetType) {
    ...
    public ShowModelAssetDetailResponse withAssetCode(String assetCode) {
    ...
    public ShowModelAssetDetailResponse withAssetSource(String assetSource) {
    ...
    public ShowModelAssetDetailResponse withAssetActions(String assetActions) {
    ...
    public ShowModelAssetDetailResponse withUpdateTime(Long updateTime) {
    ...
    public ShowModelAssetDetailResponse withCreateTime(Long createTime) {
    ...
    public ShowModelAssetDetailResponse withCreator(String creator) {
    ...
    public ShowModelAssetDetailResponse withUserId(String userId) {
        this.userId = userId;
        return this;
    }
    ...
    public ShowModelAssetDetailResponse withTrainObsUrl(String trainObsUrl) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ShowModelAssetDetailResponse that = (ShowModelAssetDetailResponse) obj;
    ...
    public String toString() {
        ...
        sb.append("class ShowModelAssetDetailResponse {\n");
