 ...
 * Response Object
 */
public class CreateModelServiceResponse extends SdkResponse {
    ...
    public CreateModelServiceResponse withServiceId(String serviceId) {
    ...
    public CreateModelServiceResponse withServiceName(String serviceName) {
    ...
    public CreateModelServiceResponse withServiceDesc(String serviceDesc) {
    ...
    public CreateModelServiceResponse withStatus(String status) {
        this.status = status;
        return this;
    }
    ...
    public CreateModelServiceResponse withInferType(String inferType) {
    ...
    public CreateModelServiceResponse withDeviceType(String deviceType) {
    ...
    public CreateModelServiceResponse withChipType(String chipType) {
    ...
    public CreateModelServiceResponse withRequestMode(String requestMode) {
    ...
    public CreateModelServiceResponse withAssetId(String assetId) {
    ...
    public CreateModelServiceResponse withAssetName(String assetName) {
    ...
    public CreateModelServiceResponse withAssetType(String assetType) {
    ...
    public CreateModelServiceResponse withAssetSubType(String assetSubType) {
    ...
    public CreateModelServiceResponse withApiUrl(String apiUrl) {
        this.apiUrl = apiUrl;
        return this;
    }
    ...
    public CreateModelServiceResponse withChatId(String chatId) {
        this.chatId = chatId;
        return this;
    }
    ...
    public CreateModelServiceResponse withUserId(String userId) {
        this.userId = userId;
        return this;
    }
    ...
    public CreateModelServiceResponse withUserName(String userName) {
    ...
    public CreateModelServiceResponse withPlatform(String platform) {
    ...
    public CreateModelServiceResponse withTrainObsOutput(String trainObsOutput) {
    ...
    public CreateModelServiceResponse withUseType(String useType) {
    ...
    public CreateModelServiceResponse withServiceConfig(ModelServiceConfig serviceConfig) {
        this.serviceConfig = serviceConfig;
        return this;
    }

    public CreateModelServiceResponse withServiceConfig(Consumer<ModelServiceConfig> serviceConfigSetter) {
    ...
    public CreateModelServiceResponse withCreateTime(Long createTime) {
    ...
    public CreateModelServiceResponse withUpdateTime(Long updateTime) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        CreateModelServiceResponse that = (CreateModelServiceResponse) obj;
