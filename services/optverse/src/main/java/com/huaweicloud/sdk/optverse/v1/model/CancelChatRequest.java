...
public class CancelChatRequest {
    ...
    public CancelChatRequest withXChatRouteId(String xChatRouteId) {
    ...
    public CancelChatRequest withChatId(String chatId) {
        this.chatId = chatId;
        return this;
    }
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        CancelChatRequest that = (CancelChatRequest) obj;
        return Objects.equals(this.xChatRouteId, that.xChatRouteId) && Objects.equals(this.chatId, that.chatId);
    }

    @Override
    public int hashCode() {
        return Objects.hash(xChatRouteId, chatId);
    }

    @Override
    public String toString() {
        StringBuilder sb = new StringBuilder();
        sb.append("class CancelChatRequest {\n");
