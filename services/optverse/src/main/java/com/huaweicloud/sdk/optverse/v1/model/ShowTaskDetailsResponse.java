...
public class ShowTaskDetailsResponse extends SdkResponse {
    ...
    public ShowTaskDetailsResponse withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public ShowTaskDetailsResponse withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public ShowTaskDetailsResponse withDescription(String description) {
    ...
    public ShowTaskDetailsResponse withUserId(String userId) {
        this.userId = userId;
        return this;
    }
    ...
    public ShowTaskDetailsResponse withUserName(String userName) {
    ...
    public ShowTaskDetailsResponse withOutputPath(String outputPath) {
    ...
    public ShowTaskDetailsResponse withAlgorithmId(String algorithmId) {
    ...
    public ShowTaskDetailsResponse withAlgorithmFile(String algorithmFile) {
    ...
    public ShowTaskDetailsResponse withAlgorithmFuncName(String algorithmFuncName) {
    ...
    public ShowTaskDetailsResponse withTaskProgress(Float taskProgress) {
    ...
    public ShowTaskDetailsResponse withEvaluatorFile(String evaluatorFile) {
    ...
    public ShowTaskDetailsResponse withEvaluatorFuncName(String evaluatorFuncName) {
    ...
    public ShowTaskDetailsResponse withEvaluatorBaseline(String evaluatorBaseline) {
    ...
    public ShowTaskDetailsResponse withEvaluatorBaselineFuncName(String evaluatorBaselineFuncName) {
    ...
    public ShowTaskDetailsResponse withEvaluatorParameter(EvaluatorParameter evaluatorParameter) {
        this.evaluatorParameter = evaluatorParameter;
        return this;
    }

    public ShowTaskDetailsResponse withEvaluatorParameter(Consumer<EvaluatorParameter> evaluatorParameterSetter) {
    ...
    public ShowTaskDetailsResponse withClusterId(String clusterId) {
    ...
    public ShowTaskDetailsResponse withMetaCreateAt(Long metaCreateAt) {
    ...
    public ShowTaskDetailsResponse withMetaStartAt(Long metaStartAt) {
    ...
    public ShowTaskDetailsResponse withMetaFinishAt(Long metaFinishAt) {
    ...
    public ShowTaskDetailsResponse withVisibility(String visibility) {
