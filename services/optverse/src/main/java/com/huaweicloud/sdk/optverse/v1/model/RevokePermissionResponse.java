 ...
 * Response Object
 */
public class RevokePermissionResponse extends SdkResponse {
    ...
    public RevokePermissionResponse withMetaInfo(MetaInfo metaInfo) {
        this.metaInfo = metaInfo;
        return this;
    }

    public RevokePermissionResponse withMetaInfo(Consumer<MetaInfo> metaInfoSetter) {
    ...
    public RevokePermissionResponse withPayload(PayloadObject payload) {
        this.payload = payload;
        return this;
    }

    public RevokePermissionResponse withPayload(Consumer<PayloadObject> payloadSetter) {
