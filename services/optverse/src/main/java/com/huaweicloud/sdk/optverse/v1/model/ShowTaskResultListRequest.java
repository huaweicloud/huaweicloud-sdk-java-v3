 ...
 * Request Object
 */
public class ShowTaskResultListRequest {
    ...
    public ShowTaskResultListRequest withEvolveTaskId(String evolveTaskId) {
    ...
    public ShowTaskResultListRequest withIteration(Integer iteration) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ShowTaskResultListRequest that = (ShowTaskResultListRequest) obj;
        return Objects.equals(this.evolveTaskId, that.evolveTaskId) && Objects.equals(this.iteration, that.iteration);
    }

    @Override
    public int hashCode() {
        return Objects.hash(evolveTaskId, iteration);
    }

    @Override
    public String toString() {
        StringBuilder sb = new StringBuilder();
        sb.append("class ShowTaskResultListRequest {\n");
