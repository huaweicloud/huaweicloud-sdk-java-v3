...
public class ListAlgorithmsResponse extends SdkResponse {
    ...
    public ListAlgorithmsResponse withMetaInfo(MetaInfo metaInfo) {
        this.metaInfo = metaInfo;
        return this;
    }

    public ListAlgorithmsResponse withMetaInfo(Consumer<MetaInfo> metaInfoSetter) {
    ...
    public ListAlgorithmsResponse withPayload(PayloadObject payload) {
        this.payload = payload;
        return this;
    }

    public ListAlgorithmsResponse withPayload(Consumer<PayloadObject> payloadSetter) {
