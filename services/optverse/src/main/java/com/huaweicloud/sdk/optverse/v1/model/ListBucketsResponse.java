...
public class ListBucketsResponse extends SdkResponse {
    ...
    public ListBucketsResponse withMetaInfo(MetaInfo metaInfo) {
        this.metaInfo = metaInfo;
        return this;
    }

    public ListBucketsResponse withMetaInfo(Consumer<MetaInfo> metaInfoSetter) {
    ...
    public ListBucketsResponse withPayload(PayloadObject payload) {
        this.payload = payload;
        return this;
    }

    public ListBucketsResponse withPayload(Consumer<PayloadObject> payloadSetter) {
