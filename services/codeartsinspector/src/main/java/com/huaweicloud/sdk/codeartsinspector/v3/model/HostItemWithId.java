...
public class HostItemWithId {
    ...
    public HostItemWithId withIp(String ip) {
        this.ip = ip;
        return this;
    }
    ...
    public HostItemWithId withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public HostItemWithId withOsType(OsTypeEnum osType) {
        this.osType = osType;
        return this;
    }
    ...
    public HostItemWithId withGroupId(String groupId) {
    ...
    public HostItemWithId withSshCredentialId(String sshCredentialId) {
    ...
    public HostItemWithId withJumperServerId(String jumperServerId) {
    ...
    public HostItemWithId withSmbCredentialId(String smbCredentialId) {
    ...
    public HostItemWithId withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        HostItemWithId that = (HostItemWithId) obj;
        return Objects.equals(this.ip, that.ip) && Objects.equals(this.name, that.name)
            ...
            && Objects.equals(this.smbCredentialId, that.smbCredentialId) && Objects.equals(this.id, that.id);
    }

    @Override
    public int hashCode() {
        return Objects.hash(ip, name, osType, groupId, sshCredentialId, jumperServerId, smbCredentialId, id);
    }
