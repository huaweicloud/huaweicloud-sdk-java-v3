...
public class ShowTasksResponse extends SdkResponse {
    ...
    public ShowTasksResponse withTaskSettings(Consumer<TaskSettings> taskSettingsSetter) {
    ...
    public ShowTasksResponse withStatistics(Consumer<VulnsLevel> statisticsSetter) {
