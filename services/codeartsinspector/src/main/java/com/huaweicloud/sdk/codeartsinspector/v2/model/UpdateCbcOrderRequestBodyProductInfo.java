 ...
 * product_info
 */
public class UpdateCbcOrderRequestBodyProductInfo {
    ...
    public UpdateCbcOrderRequestBodyProductInfo withCloudServiceType(String cloudServiceType) {
    ...
    public UpdateCbcOrderRequestBodyProductInfo withProductId(String productId) {
    ...
    public UpdateCbcOrderRequestBodyProductInfo withResourceSpeccode(String resourceSpeccode) {
    ...
    public UpdateCbcOrderRequestBodyProductInfo withResourceType(String resourceType) {
    ...
    public UpdateCbcOrderRequestBodyProductInfo withResouceSizeMeasureId(Integer resouceSizeMeasureId) {
    ...
    public UpdateCbcOrderRequestBodyProductInfo withResourceSize(Integer resourceSize) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        UpdateCbcOrderRequestBodyProductInfo that = (UpdateCbcOrderRequestBodyProductInfo) obj;
    ...
    public String toString() {
        ...
        sb.append("class UpdateCbcOrderRequestBodyProductInfo {\n");
