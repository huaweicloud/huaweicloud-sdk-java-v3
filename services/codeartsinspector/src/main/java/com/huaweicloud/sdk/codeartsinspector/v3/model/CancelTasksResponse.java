...
public class CancelTasksResponse extends SdkResponse {
    ...
    public CancelTasksResponse withInfoCode(InfoCodeEnum infoCode) {
    ...
    public CancelTasksResponse withInfoDescription(String infoDescription) {
    ...
    public CancelTasksResponse withTaskId(String taskId) {
        this.taskId = taskId;
        return this;
    }
    ...
    public CancelTasksResponse withTaskStatus(TaskStatusEnum taskStatus) {
