 ...
 * Response Object
 */
public class AddAppConfigsTemplatesResponse extends SdkResponse {
    ...
    public AddAppConfigsTemplatesResponse withTplId(String tplId) {
        this.tplId = tplId;
        return this;
    }
    ...
    public AddAppConfigsTemplatesResponse withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public AddAppConfigsTemplatesResponse withDescription(String description) {
    ...
    public AddAppConfigsTemplatesResponse withConfigTabs(Object configTabs) {
    ...
    public AddAppConfigsTemplatesResponse withDefaultValues(Object defaultValues) {
    ...
    public AddAppConfigsTemplatesResponse withCreateTime(String createTime) {
    ...
    public AddAppConfigsTemplatesResponse withUpdateTime(String updateTime) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        AddAppConfigsTemplatesResponse that = (AddAppConfigsTemplatesResponse) obj;
    ...
    public String toString() {
        ...
        sb.append("class AddAppConfigsTemplatesResponse {\n");
