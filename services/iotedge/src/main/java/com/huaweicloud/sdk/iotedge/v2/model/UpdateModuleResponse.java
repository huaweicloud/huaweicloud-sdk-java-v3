 ...
 * Response Object
 */
public class UpdateModuleResponse extends SdkResponse {
    ...
    public UpdateModuleResponse withEdgeAppId(String edgeAppId) {
    ...
    public UpdateModuleResponse withAppVersion(String appVersion) {
    ...
    public UpdateModuleResponse withState(StateEnum state) {
        this.state = state;
        return this;
    }
    ...
    public UpdateModuleResponse withNodeId(String nodeId) {
        this.nodeId = nodeId;
        return this;
    }
    ...
    public UpdateModuleResponse withModuleName(String moduleName) {
    ...
    public UpdateModuleResponse withModuleId(String moduleId) {
    ...
    public UpdateModuleResponse withCreateTime(String createTime) {
    ...
    public UpdateModuleResponse withUpdateTime(String updateTime) {
    ...
    public UpdateModuleResponse withAppType(AppTypeEnum appType) {
    ...
    public UpdateModuleResponse withFunctionType(FunctionTypeEnum functionType) {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        return Objects.equals(this.edgeAppId, updateModuleResponse.edgeAppId) &&
            ...
            Objects.equals(this.createTime, updateModuleResponse.createTime) &&
            Objects.equals(this.updateTime, updateModuleResponse.updateTime) &&
            Objects.equals(this.appType, updateModuleResponse.appType) &&
            Objects.equals(this.functionType, updateModuleResponse.functionType);
    }
    @Override
    public int hashCode() {
