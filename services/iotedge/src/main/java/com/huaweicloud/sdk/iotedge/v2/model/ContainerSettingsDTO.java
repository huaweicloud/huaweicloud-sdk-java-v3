...
public class ContainerSettingsDTO {
    ...
    public static final class NpuTypeEnum {
        ...
        public static NpuTypeEnum fromValue(String value) {
            ...
            return java.util.Optional.ofNullable(STATIC_FIELDS.get(value)).orElse(new NpuTypeEnum(value));
        }
    ...
    public static final class VnpuTemplateEnum {
        ...
        public static VnpuTemplateEnum fromValue(String value) {
            ...
            return java.util.Optional.ofNullable(STATIC_FIELDS.get(value)).orElse(new VnpuTemplateEnum(value));
        }
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        return Objects.equals(this.configs, that.configs) && Objects.equals(this.imageUrl, that.imageUrl)
            ...
            && Objects.equals(this.npuType, that.npuType) && Objects.equals(this.vnpuTemplate, that.vnpuTemplate)
