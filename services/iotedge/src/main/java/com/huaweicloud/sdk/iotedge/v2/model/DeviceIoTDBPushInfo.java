 ...
 * 创建设备数据推送IoTDB
 */
public class DeviceIoTDBPushInfo {
    ...
    public DeviceIoTDBPushInfo withStorageGroup(String storageGroup) {
    ...
    public DeviceIoTDBPushInfo withFormat(String format) {
        this.format = format;
        return this;
    }
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        DeviceIoTDBPushInfo that = (DeviceIoTDBPushInfo) obj;
    ...
    public String toString() {
        ...
        sb.append("class DeviceIoTDBPushInfo {\n");
