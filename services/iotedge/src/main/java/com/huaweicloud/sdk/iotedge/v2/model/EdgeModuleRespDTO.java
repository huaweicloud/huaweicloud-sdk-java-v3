 ...
 * 创建边缘模块响应结构体
 */
public class EdgeModuleRespDTO  {
    ...
    public EdgeModuleRespDTO withEdgeAppId(String edgeAppId) {
    ...
    public EdgeModuleRespDTO withAppVersion(String appVersion) {
    ...
    public EdgeModuleRespDTO withState(StateEnum state) {
        this.state = state;
        return this;
    }
    ...
    public EdgeModuleRespDTO withNodeId(String nodeId) {
        this.nodeId = nodeId;
        return this;
    }
    ...
    public EdgeModuleRespDTO withModuleName(String moduleName) {
    ...
    public EdgeModuleRespDTO withModuleId(String moduleId) {
    ...
    public EdgeModuleRespDTO withCreateTime(String createTime) {
    ...
    public EdgeModuleRespDTO withUpdateTime(String updateTime) {
    ...
    public EdgeModuleRespDTO withAppType(AppTypeEnum appType) {
    ...
    public EdgeModuleRespDTO withFunctionType(FunctionTypeEnum functionType) {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        EdgeModuleRespDTO edgeModuleRespDTO = (EdgeModuleRespDTO) o;
        return Objects.equals(this.edgeAppId, edgeModuleRespDTO.edgeAppId) &&
            Objects.equals(this.appVersion, edgeModuleRespDTO.appVersion) &&
            Objects.equals(this.state, edgeModuleRespDTO.state) &&
            Objects.equals(this.nodeId, edgeModuleRespDTO.nodeId) &&
            Objects.equals(this.moduleName, edgeModuleRespDTO.moduleName) &&
            Objects.equals(this.moduleId, edgeModuleRespDTO.moduleId) &&
            Objects.equals(this.createTime, edgeModuleRespDTO.createTime) &&
            Objects.equals(this.updateTime, edgeModuleRespDTO.updateTime) &&
            Objects.equals(this.appType, edgeModuleRespDTO.appType) &&
            Objects.equals(this.functionType, edgeModuleRespDTO.functionType);
    }
    @Override
    public int hashCode() {
    ...
    public String toString() {
        ...
        sb.append("class EdgeModuleRespDTO {\n");
