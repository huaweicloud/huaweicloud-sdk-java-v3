...
public class CphClient {
     ...
     * @return AttachShareFilesystemResponse
     */
    public AttachShareFilesystemResponse attachShareFilesystem(AttachShareFilesystemRequest request) {
        return hcClient.syncInvokeHttp(request, CphMeta.attachShareFilesystem);
    }
     ...
     *
     * @param request AttachShareFilesystemRequest 请求对象
     * @return SyncInvoker<AttachShareFilesystemRequest, AttachShareFilesystemResponse>
     */
    public SyncInvoker<AttachShareFilesystemRequest, AttachShareFilesystemResponse> attachShareFilesystemInvoker(
        AttachShareFilesystemRequest request) {
        return new SyncInvoker<>(request, CphMeta.attachShareFilesystem, hcClient);
    }
     ...
     * @return AuthorizeScheduledEventResponse
     */
    public AuthorizeScheduledEventResponse authorizeScheduledEvent(AuthorizeScheduledEventRequest request) {
        return hcClient.syncInvokeHttp(request, CphMeta.authorizeScheduledEvent);
    }
     ...
     *
     * @param request AuthorizeScheduledEventRequest 请求对象
     * @return SyncInvoker<AuthorizeScheduledEventRequest, AuthorizeScheduledEventResponse>
     */
    public SyncInvoker<AuthorizeScheduledEventRequest, AuthorizeScheduledEventResponse> authorizeScheduledEventInvoker(
        AuthorizeScheduledEventRequest request) {
        return new SyncInvoker<>(request, CphMeta.authorizeScheduledEvent, hcClient);
    }
     ...
     * @return DetachShareFilesystemResponse
     */
    public DetachShareFilesystemResponse detachShareFilesystem(DetachShareFilesystemRequest request) {
        return hcClient.syncInvokeHttp(request, CphMeta.detachShareFilesystem);
    }
     ...
     *
     * @param request DetachShareFilesystemRequest 请求对象
     * @return SyncInvoker<DetachShareFilesystemRequest, DetachShareFilesystemResponse>
     */
    public SyncInvoker<DetachShareFilesystemRequest, DetachShareFilesystemResponse> detachShareFilesystemInvoker(
        DetachShareFilesystemRequest request) {
        return new SyncInvoker<>(request, CphMeta.detachShareFilesystem, hcClient);
    }
     ...
     * @return ListCloudPhoneServerModelOfferingsResponse
     */
    public ListCloudPhoneServerModelOfferingsResponse listCloudPhoneServerModelOfferings(
        ListCloudPhoneServerModelOfferingsRequest request) {
        return hcClient.syncInvokeHttp(request, CphMeta.listCloudPhoneServerModelOfferings);
    }
     ...
     *
     * @param request ListCloudPhoneServerModelOfferingsRequest 请求对象
     * @return SyncInvoker<ListCloudPhoneServerModelOfferingsRequest, ListCloudPhoneServerModelOfferingsResponse>
     */
    public SyncInvoker<ListCloudPhoneServerModelOfferingsRequest, ListCloudPhoneServerModelOfferingsResponse> listCloudPhoneServerModelOfferingsInvoker(
        ListCloudPhoneServerModelOfferingsRequest request) {
        return new SyncInvoker<>(request, CphMeta.listCloudPhoneServerModelOfferings, hcClient);
    }
    ...
    public ListScheduledEventsResponse listScheduledEvents(ListScheduledEventsRequest request) {
        return hcClient.syncInvokeHttp(request, CphMeta.listScheduledEvents);
    }
    ...
    public SyncInvoker<ListScheduledEventsRequest, ListScheduledEventsResponse> listScheduledEventsInvoker(
        ...
        return new SyncInvoker<>(request, CphMeta.listScheduledEvents, hcClient);
    }
     ...
     * @return ListShareAppsSnapshotResponse
     */
    public ListShareAppsSnapshotResponse listShareAppsSnapshot(ListShareAppsSnapshotRequest request) {
        return hcClient.syncInvokeHttp(request, CphMeta.listShareAppsSnapshot);
    }
     ...
     *
     * @param request ListShareAppsSnapshotRequest 请求对象
     * @return SyncInvoker<ListShareAppsSnapshotRequest, ListShareAppsSnapshotResponse>
     */
    public SyncInvoker<ListShareAppsSnapshotRequest, ListShareAppsSnapshotResponse> listShareAppsSnapshotInvoker(
        ListShareAppsSnapshotRequest request) {
        return new SyncInvoker<>(request, CphMeta.listShareAppsSnapshot, hcClient);
    }
    ...
    public UpdateScheduledEventResponse updateScheduledEvent(UpdateScheduledEventRequest request) {
        return hcClient.syncInvokeHttp(request, CphMeta.updateScheduledEvent);
    }
    ...
    public SyncInvoker<UpdateScheduledEventRequest, UpdateScheduledEventResponse> updateScheduledEventInvoker(
        ...
        return new SyncInvoker<>(request, CphMeta.updateScheduledEvent, hcClient);
    }
