 ...
 * 云手机使用的带宽信息。
 */
public class ChangeCloudPhoneServerRequestBodyBandWidth {
    ...
    public ChangeCloudPhoneServerRequestBodyBandWidth withBandWidthId(String bandWidthId) {
    ...
    public ChangeCloudPhoneServerRequestBodyBandWidth withBandWidthSize(Integer bandWidthSize) {
    ...
    public ChangeCloudPhoneServerRequestBodyBandWidth withBandWidthChargeMode(Integer bandWidthChargeMode) {
    ...
    public ChangeCloudPhoneServerRequestBodyBandWidth withBandWidthShareType(Integer bandWidthShareType) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ChangeCloudPhoneServerRequestBodyBandWidth that = (ChangeCloudPhoneServerRequestBodyBandWidth) obj;
    ...
    public String toString() {
        ...
        sb.append("class ChangeCloudPhoneServerRequestBodyBandWidth {\n");
