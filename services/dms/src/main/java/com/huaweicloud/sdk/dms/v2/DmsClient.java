...
public class DmsClient {
     ...
     */
    public SyncInvoker<BatchCreateOrDeleteQueueTagRequest, BatchCreateOrDeleteQueueTagResponse> batchCreateOrDeleteQueueTagInvoker(BatchCreateOrDeleteQueueTagRequest request) {
        return new SyncInvoker<BatchCreateOrDeleteQueueTagRequest, BatchCreateOrDeleteQueueTagResponse>(request, DmsMeta.batchCreateOrDeleteQueueTag, hcClient);
    }
     ...
     */
    public SyncInvoker<ConfirmConsumptionMessagesRequest, ConfirmConsumptionMessagesResponse> confirmConsumptionMessagesInvoker(ConfirmConsumptionMessagesRequest request) {
        return new SyncInvoker<ConfirmConsumptionMessagesRequest, ConfirmConsumptionMessagesResponse>(request, DmsMeta.confirmConsumptionMessages, hcClient);
    }
     ...
     */
    public SyncInvoker<ConfirmDeadLettersMessagesRequest, ConfirmDeadLettersMessagesResponse> confirmDeadLettersMessagesInvoker(ConfirmDeadLettersMessagesRequest request) {
        return new SyncInvoker<ConfirmDeadLettersMessagesRequest, ConfirmDeadLettersMessagesResponse>(request, DmsMeta.confirmDeadLettersMessages, hcClient);
    }
     ...
     */
    public SyncInvoker<ConsumeDeadlettersMessageRequest, ConsumeDeadlettersMessageResponse> consumeDeadlettersMessageInvoker(ConsumeDeadlettersMessageRequest request) {
        return new SyncInvoker<ConsumeDeadlettersMessageRequest, ConsumeDeadlettersMessageResponse>(request, DmsMeta.consumeDeadlettersMessage, hcClient);
    }
     ...
     */
    public SyncInvoker<ConsumeMessagesRequest, ConsumeMessagesResponse> consumeMessagesInvoker(ConsumeMessagesRequest request) {
        return new SyncInvoker<ConsumeMessagesRequest, ConsumeMessagesResponse>(request, DmsMeta.consumeMessages, hcClient);
    }
     ...
     */
    public SyncInvoker<CreateConsumerGroupRequest, CreateConsumerGroupResponse> createConsumerGroupInvoker(CreateConsumerGroupRequest request) {
        return new SyncInvoker<CreateConsumerGroupRequest, CreateConsumerGroupResponse>(request, DmsMeta.createConsumerGroup, hcClient);
    }
     ...
     */
    public SyncInvoker<DeleteSpecifiedConsumerGroupRequest, DeleteSpecifiedConsumerGroupResponse> deleteSpecifiedConsumerGroupInvoker(DeleteSpecifiedConsumerGroupRequest request) {
        return new SyncInvoker<DeleteSpecifiedConsumerGroupRequest, DeleteSpecifiedConsumerGroupResponse>(request, DmsMeta.deleteSpecifiedConsumerGroup, hcClient);
    }
     ...
     */
    public SyncInvoker<ListConsumerGroupsRequest, ListConsumerGroupsResponse> listConsumerGroupsInvoker(ListConsumerGroupsRequest request) {
        return new SyncInvoker<ListConsumerGroupsRequest, ListConsumerGroupsResponse>(request, DmsMeta.listConsumerGroups, hcClient);
    }
