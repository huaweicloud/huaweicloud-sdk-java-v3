...
public class DmsAsyncClient {
     ...
     */
    public AsyncInvoker<BatchCreateOrDeleteQueueTagRequest, BatchCreateOrDeleteQueueTagResponse> batchCreateOrDeleteQueueTagAsyncInvoker(BatchCreateOrDeleteQueueTagRequest request) {
        return new AsyncInvoker<BatchCreateOrDeleteQueueTagRequest, BatchCreateOrDeleteQueueTagResponse>(request, DmsMeta.batchCreateOrDeleteQueueTag, hcClient);
    }
     ...
     */
    public AsyncInvoker<ConfirmConsumptionMessagesRequest, ConfirmConsumptionMessagesResponse> confirmConsumptionMessagesAsyncInvoker(ConfirmConsumptionMessagesRequest request) {
        return new AsyncInvoker<ConfirmConsumptionMessagesRequest, ConfirmConsumptionMessagesResponse>(request, DmsMeta.confirmConsumptionMessages, hcClient);
    }
     ...
     */
    public AsyncInvoker<ConfirmDeadLettersMessagesRequest, ConfirmDeadLettersMessagesResponse> confirmDeadLettersMessagesAsyncInvoker(ConfirmDeadLettersMessagesRequest request) {
        return new AsyncInvoker<ConfirmDeadLettersMessagesRequest, ConfirmDeadLettersMessagesResponse>(request, DmsMeta.confirmDeadLettersMessages, hcClient);
    }
     ...
     */
    public AsyncInvoker<ConsumeDeadlettersMessageRequest, ConsumeDeadlettersMessageResponse> consumeDeadlettersMessageAsyncInvoker(ConsumeDeadlettersMessageRequest request) {
        return new AsyncInvoker<ConsumeDeadlettersMessageRequest, ConsumeDeadlettersMessageResponse>(request, DmsMeta.consumeDeadlettersMessage, hcClient);
    }
     ...
     */
    public AsyncInvoker<ConsumeMessagesRequest, ConsumeMessagesResponse> consumeMessagesAsyncInvoker(ConsumeMessagesRequest request) {
        return new AsyncInvoker<ConsumeMessagesRequest, ConsumeMessagesResponse>(request, DmsMeta.consumeMessages, hcClient);
    }
     ...
     */
    public AsyncInvoker<CreateConsumerGroupRequest, CreateConsumerGroupResponse> createConsumerGroupAsyncInvoker(CreateConsumerGroupRequest request) {
        return new AsyncInvoker<CreateConsumerGroupRequest, CreateConsumerGroupResponse>(request, DmsMeta.createConsumerGroup, hcClient);
    }
     ...
     */
    public AsyncInvoker<DeleteSpecifiedConsumerGroupRequest, DeleteSpecifiedConsumerGroupResponse> deleteSpecifiedConsumerGroupAsyncInvoker(DeleteSpecifiedConsumerGroupRequest request) {
        return new AsyncInvoker<DeleteSpecifiedConsumerGroupRequest, DeleteSpecifiedConsumerGroupResponse>(request, DmsMeta.deleteSpecifiedConsumerGroup, hcClient);
    }
     ...
     */
    public AsyncInvoker<ListConsumerGroupsRequest, ListConsumerGroupsResponse> listConsumerGroupsAsyncInvoker(ListConsumerGroupsRequest request) {
        return new AsyncInvoker<ListConsumerGroupsRequest, ListConsumerGroupsResponse>(request, DmsMeta.listConsumerGroups, hcClient);
    }
     ...
     */
    public AsyncInvoker<SendMessagesRequest, SendMessagesResponse> sendMessagesAsyncInvoker(SendMessagesRequest request) {
     ...
     */
    public AsyncInvoker<ShowQueueTagsRequest, ShowQueueTagsResponse> showQueueTagsAsyncInvoker(ShowQueueTagsRequest request) {
