...
/** Response Object */
public class CreateExtensionAuthorizationResponse extends SdkResponse {
    ...
    public CreateExtensionAuthorizationResponse withResult(Boolean result) {
        this.result = result;
        return this;
    }
    ...
    public CreateExtensionAuthorizationResponse withStatus(String status) {
        this.status = status;
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append("class CreateExtensionAuthorizationResponse {\n");
