 ...
 * Response Object
 */
public class CheckInstanceAccessResponse extends SdkResponse {
    ...
    public CheckInstanceAccessResponse withResult(Boolean result) {
        this.result = result;
        return this;
    }
    ...
    public CheckInstanceAccessResponse withStatus(String status) {
        this.status = status;
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append("class CheckInstanceAccessResponse {\n");
