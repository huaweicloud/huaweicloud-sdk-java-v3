 ...
 * Request Object
 */
public class ListBackPoolsRequest {
    ...
    public ListBackPoolsRequest withPoolName(String poolName) {
    ...
    public ListBackPoolsRequest withLimit(Long limit) {
        this.limit = limit;
        return this;
    }
    ...
    public ListBackPoolsRequest withOffset(Long offset) {
        this.offset = offset;
        return this;
    }
    ...
    public ListBackPoolsRequest withBillingCycle(String billingCycle) {
    ...
    public ListBackPoolsRequest withAllBillingCycle(Boolean allBillingCycle) {
    ...
    public String toString() {
        ...
        sb.append("class ListBackPoolsRequest {\n");
