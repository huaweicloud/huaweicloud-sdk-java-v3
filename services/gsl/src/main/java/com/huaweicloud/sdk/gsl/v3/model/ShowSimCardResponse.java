...
public class ShowSimCardResponse extends SdkResponse {
    ...
    public ShowSimCardResponse withSimCardId(Long simCardId) {
    ...
    public ShowSimCardResponse withAccountId(String accountId) {
    ...
    public ShowSimCardResponse withCid(String cid) {
        this.cid = cid;
        return this;
    }
    ...
    public ShowSimCardResponse withSimPoolId(Long simPoolId) {
    ...
    public ShowSimCardResponse withSimStatus(Integer simStatus) {
    ...
    public ShowSimCardResponse withDeviceStatus(Integer deviceStatus) {
    ...
    public ShowSimCardResponse withDeviceModel(String deviceModel) {
    ...
    public ShowSimCardResponse withIccid(String iccid) {
        this.iccid = iccid;
        return this;
    }
    ...
    public ShowSimCardResponse withDbm(String dbm) {
        this.dbm = dbm;
        return this;
    }
    ...
    public ShowSimCardResponse withSignalLevel(String signalLevel) {
    ...
    public ShowSimCardResponse withSimType(Integer simType) {
    ...
    public ShowSimCardResponse withOrderId(Long orderId) {
    ...
    public ShowSimCardResponse withPricePlanName(String pricePlanName) {
    ...
    public ShowSimCardResponse withSimPricePlanId(Long simPricePlanId) {
    ...
    public ShowSimCardResponse withFlowLeft(Double flowLeft) {
    ...
    public ShowSimCardResponse withFlowUsed(Double flowUsed) {
    ...
    public ShowSimCardResponse withOperatorStatus(Integer operatorStatus) {
    ...
    public ShowSimCardResponse withMsisdn(String msisdn) {
        this.msisdn = msisdn;
        return this;
    }
    ...
    public ShowSimCardResponse withImsi(String imsi) {
        this.imsi = imsi;
        return this;
    }
    ...
    public ShowSimCardResponse withCustomerAttribute1(String customerAttribute1) {
    ...
    public ShowSimCardResponse withCustomerAttribute2(String customerAttribute2) {
    ...
    public ShowSimCardResponse withCustomerAttribute3(String customerAttribute3) {
    ...
    public ShowSimCardResponse withCustomerAttribute4(String customerAttribute4) {
    ...
    public ShowSimCardResponse withCustomerAttribute5(String customerAttribute5) {
    ...
    public ShowSimCardResponse withCustomerAttribute6(String customerAttribute6) {
    ...
    public ShowSimCardResponse withRealNamed(Boolean realNamed) {
    ...
    public ShowSimCardResponse withCutNetFlag(Boolean cutNetFlag) {
    ...
    public ShowSimCardResponse withExceedCutNetFlag(Boolean exceedCutNetFlag) {
    ...
    public ShowSimCardResponse withExceedCutNetQuota(Integer exceedCutNetQuota) {
    ...
    public ShowSimCardResponse withImeiBindRemainTimes(Integer imeiBindRemainTimes) {
    ...
    public ShowSimCardResponse withSpeedValue(Integer speedValue) {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ShowSimCardResponse showSimCardResponse = (ShowSimCardResponse) o;
        return Objects.equals(this.simCardId, showSimCardResponse.simCardId)
            ...
            && Objects.equals(this.pricePlanName, showSimCardResponse.pricePlanName)
            && Objects.equals(this.simPricePlanId, showSimCardResponse.simPricePlanId)
            && Objects.equals(this.flowLeft, showSimCardResponse.flowLeft)
            && Objects.equals(this.flowUsed, showSimCardResponse.flowUsed)
            && Objects.equals(this.operatorStatus, showSimCardResponse.operatorStatus)
            && Objects.equals(this.msisdn, showSimCardResponse.msisdn)
            && Objects.equals(this.imsi, showSimCardResponse.imsi)
            && Objects.equals(this.customerAttribute1, showSimCardResponse.customerAttribute1)
            && Objects.equals(this.customerAttribute2, showSimCardResponse.customerAttribute2)
            && Objects.equals(this.customerAttribute3, showSimCardResponse.customerAttribute3)
            && Objects.equals(this.customerAttribute4, showSimCardResponse.customerAttribute4)
            && Objects.equals(this.customerAttribute5, showSimCardResponse.customerAttribute5)
            && Objects.equals(this.customerAttribute6, showSimCardResponse.customerAttribute6)
            && Objects.equals(this.realNamed, showSimCardResponse.realNamed)
            && Objects.equals(this.cutNetFlag, showSimCardResponse.cutNetFlag)
            && Objects.equals(this.exceedCutNetFlag, showSimCardResponse.exceedCutNetFlag)
            && Objects.equals(this.exceedCutNetQuota, showSimCardResponse.exceedCutNetQuota)
            && Objects.equals(this.imeiBindRemainTimes, showSimCardResponse.imeiBindRemainTimes)
            && Objects.equals(this.speedValue, showSimCardResponse.speedValue);
    }
