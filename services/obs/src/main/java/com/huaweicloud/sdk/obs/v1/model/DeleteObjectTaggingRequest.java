 ...
 * Request Object
 */
@JacksonXmlRootElement(localName = "DeleteObjectTaggingRequest")
public class DeleteObjectTaggingRequest {
    ...
    public DeleteObjectTaggingRequest withDate(String date) {
        this.date = date;
        return this;
    }
    ...
    public DeleteObjectTaggingRequest withObjectKey(String objectKey) {
    ...
    public DeleteObjectTaggingRequest withTagging(String tagging) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        DeleteObjectTaggingRequest that = (DeleteObjectTaggingRequest) obj;
    ...
    public String toString() {
        ...
        sb.append("class DeleteObjectTaggingRequest {\n");
