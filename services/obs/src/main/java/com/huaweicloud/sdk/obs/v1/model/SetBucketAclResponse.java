 ...
 * Response Object
 */
@JacksonXmlRootElement(localName = "SetBucketAclResponse")
public class SetBucketAclResponse extends SdkResponse {
    ...
    public SetBucketAclResponse withXObsId2(String xObsId2) {
    ...
    public SetBucketAclResponse withXObsRequestId(String xObsRequestId) {
    ...
    public SetBucketAclResponse withEtag(String etag) {
        this.etag = etag;
        return this;
    }
    ...
    public SetBucketAclResponse withConnection(String connection) {
    ...
    public SetBucketAclResponse withContentLength(String contentLength) {
    ...
    public SetBucketAclResponse withDate(String date) {
        this.date = date;
        return this;
    }
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        SetBucketAclResponse that = (SetBucketAclResponse) obj;
    ...
    public String toString() {
        ...
        sb.append("class SetBucketAclResponse {\n");
