...
public class ObsClient {
    ...
    public SyncInvoker<CopyObjectRequest, CopyObjectResponse> copyObjectInvoker(CopyObjectRequest request) {
        return new SyncInvoker<>(request, ObsMeta.copyObject, hcClient);
    }
     ...
     * 
     * #### 存储类型 ####
     * 允许用户创建不同默认存储类型的桶。发送创桶请求时携带头域“x-obs-storage-class”来指定桶的默认存储类型。桶内对象的存储类型与桶默认存储类型保持一致。存储类型有4种：STANDARD（标准存储）、WARM（低频访问存储）、COLD（归档存储）、DEEP_ARCHIVE（深度归档）。如果没有携带此头域 ，则创建的桶为标准存储类型。
     * 
    ...
    public CreateBucketResponse createBucket(CreateBucketRequest request) {
        return hcClient.syncInvokeHttp(request, ObsMeta.createBucket);
    }
     ...
     *
     * @param request CreateBucketRequest 请求对象
     * @return SyncInvoker<CreateBucketRequest, CreateBucketResponse>
     */
    public SyncInvoker<CreateBucketRequest, CreateBucketResponse> createBucketInvoker(CreateBucketRequest request) {
        return new SyncInvoker<>(request, ObsMeta.createBucket, hcClient);
    }
    ...
    public DeleteBucketResponse deleteBucket(DeleteBucketRequest request) {
        return hcClient.syncInvokeHttp(request, ObsMeta.deleteBucket);
    }
    ...
    public SyncInvoker<DeleteBucketRequest, DeleteBucketResponse> deleteBucketInvoker(DeleteBucketRequest request) {
        return new SyncInvoker<>(request, ObsMeta.deleteBucket, hcClient);
    }
    ...
    public SyncInvoker<DeleteBucketCustomdomainRequest, DeleteBucketCustomdomainResponse> deleteBucketCustomdomainInvoker(
        ...
        return new SyncInvoker<>(request, ObsMeta.deleteBucketCustomdomain, hcClient);
    }
     ...
     * @return DeleteBucketPublicAccessBlockResponse
     */
    public DeleteBucketPublicAccessBlockResponse deleteBucketPublicAccessBlock(
        DeleteBucketPublicAccessBlockRequest request) {
        return hcClient.syncInvokeHttp(request, ObsMeta.deleteBucketPublicAccessBlock);
    }
     ...
     *
     * @param request DeleteBucketPublicAccessBlockRequest 请求对象
     * @return SyncInvoker<DeleteBucketPublicAccessBlockRequest, DeleteBucketPublicAccessBlockResponse>
     */
    public SyncInvoker<DeleteBucketPublicAccessBlockRequest, DeleteBucketPublicAccessBlockResponse> deleteBucketPublicAccessBlockInvoker(
        DeleteBucketPublicAccessBlockRequest request) {
        return new SyncInvoker<>(request, ObsMeta.deleteBucketPublicAccessBlock, hcClient);
    }
    ...
    public DeleteObjectResponse deleteObject(DeleteObjectRequest request) {
        return hcClient.syncInvokeHttp(request, ObsMeta.deleteObject);
    }
     ...
     *
     * @param request DeleteObjectRequest 请求对象
     * @return SyncInvoker<DeleteObjectRequest, DeleteObjectResponse>
     */
    public SyncInvoker<DeleteObjectRequest, DeleteObjectResponse> deleteObjectInvoker(DeleteObjectRequest request) {
        return new SyncInvoker<>(request, ObsMeta.deleteObject, hcClient);
    }
    ...
    public DeleteObjectTaggingResponse deleteObjectTagging(DeleteObjectTaggingRequest request) {
        return hcClient.syncInvokeHttp(request, ObsMeta.deleteObjectTagging);
    }
     ...
     *
     * @param request DeleteObjectTaggingRequest 请求对象
     * @return SyncInvoker<DeleteObjectTaggingRequest, DeleteObjectTaggingResponse>
     */
    public SyncInvoker<DeleteObjectTaggingRequest, DeleteObjectTaggingResponse> deleteObjectTaggingInvoker(
        DeleteObjectTaggingRequest request) {
        return new SyncInvoker<>(request, ObsMeta.deleteObjectTagging, hcClient);
    }
    ...
    public SyncInvoker<DeleteObjectsRequest, DeleteObjectsResponse> deleteObjectsInvoker(DeleteObjectsRequest request) {
        return new SyncInvoker<>(request, ObsMeta.deleteObjects, hcClient);
    }
    ...
    public GetBucketAclResponse getBucketAcl(GetBucketAclRequest request) {
        return hcClient.syncInvokeHttp(request, ObsMeta.getBucketAcl);
    }
     ...
     *
     * @param request GetBucketAclRequest 请求对象
     * @return SyncInvoker<GetBucketAclRequest, GetBucketAclResponse>
     */
    public SyncInvoker<GetBucketAclRequest, GetBucketAclResponse> getBucketAclInvoker(GetBucketAclRequest request) {
        return new SyncInvoker<>(request, ObsMeta.getBucketAcl, hcClient);
    }
    ...
    public SyncInvoker<GetBucketCustomdomainRequest, GetBucketCustomdomainResponse> getBucketCustomdomainInvoker(
        ...
        return new SyncInvoker<>(request, ObsMeta.getBucketCustomdomain, hcClient);
    }
     ...
     * @return GetBucketMetadataResponse
     */
    public GetBucketMetadataResponse getBucketMetadata(GetBucketMetadataRequest request) {
        return hcClient.syncInvokeHttp(request, ObsMeta.getBucketMetadata);
    }
     ...
     *
     * @param request GetBucketMetadataRequest 请求对象
     * @return SyncInvoker<GetBucketMetadataRequest, GetBucketMetadataResponse>
     */
    public SyncInvoker<GetBucketMetadataRequest, GetBucketMetadataResponse> getBucketMetadataInvoker(
        GetBucketMetadataRequest request) {
        return new SyncInvoker<>(request, ObsMeta.getBucketMetadata, hcClient);
    }
    ...
    public GetBucketNotificationResponse getBucketNotification(GetBucketNotificationRequest request) {
        return hcClient.syncInvokeHttp(request, ObsMeta.getBucketNotification);
    }
     ...
     *
     * @param request GetBucketNotificationRequest 请求对象
     * @return SyncInvoker<GetBucketNotificationRequest, GetBucketNotificationResponse>
     */
    public SyncInvoker<GetBucketNotificationRequest, GetBucketNotificationResponse> getBucketNotificationInvoker(
        GetBucketNotificationRequest request) {
        return new SyncInvoker<>(request, ObsMeta.getBucketNotification, hcClient);
    }
     ...
     */
    public GetBucketObjectLockResponse getBucketObjectLock(GetBucketObjectLockRequest request) {
        return hcClient.syncInvokeHttp(request, ObsMeta.getBucketObjectLock);
    }
     ...
     *
     * @param request GetBucketObjectLockRequest 请求对象
     * @return SyncInvoker<GetBucketObjectLockRequest, GetBucketObjectLockResponse>
     */
    public SyncInvoker<GetBucketObjectLockRequest, GetBucketObjectLockResponse> getBucketObjectLockInvoker(
        GetBucketObjectLockRequest request) {
        return new SyncInvoker<>(request, ObsMeta.getBucketObjectLock, hcClient);
    }
     ...
     * @return GetBucketPolicyPublicStatusResponse
     */
    public GetBucketPolicyPublicStatusResponse getBucketPolicyPublicStatus(GetBucketPolicyPublicStatusRequest request) {
        return hcClient.syncInvokeHttp(request, ObsMeta.getBucketPolicyPublicStatus);
    }
     ...
     *
     * @param request GetBucketPolicyPublicStatusRequest 请求对象
     * @return SyncInvoker<GetBucketPolicyPublicStatusRequest, GetBucketPolicyPublicStatusResponse>
     */
    public SyncInvoker<GetBucketPolicyPublicStatusRequest, GetBucketPolicyPublicStatusResponse> getBucketPolicyPublicStatusInvoker(
        GetBucketPolicyPublicStatusRequest request) {
        return new SyncInvoker<>(request, ObsMeta.getBucketPolicyPublicStatus, hcClient);
    }
     ...
     * @return GetBucketPublicAccessBlockResponse
     */
    public GetBucketPublicAccessBlockResponse getBucketPublicAccessBlock(GetBucketPublicAccessBlockRequest request) {
        return hcClient.syncInvokeHttp(request, ObsMeta.getBucketPublicAccessBlock);
    }
     ...
     *
     * @param request GetBucketPublicAccessBlockRequest 请求对象
     * @return SyncInvoker<GetBucketPublicAccessBlockRequest, GetBucketPublicAccessBlockResponse>
     */
    public SyncInvoker<GetBucketPublicAccessBlockRequest, GetBucketPublicAccessBlockResponse> getBucketPublicAccessBlockInvoker(
        GetBucketPublicAccessBlockRequest request) {
        return new SyncInvoker<>(request, ObsMeta.getBucketPublicAccessBlock, hcClient);
    }
     ...
     * @return GetBucketPublicStatusResponse
     */
    public GetBucketPublicStatusResponse getBucketPublicStatus(GetBucketPublicStatusRequest request) {
        return hcClient.syncInvokeHttp(request, ObsMeta.getBucketPublicStatus);
    }
     ...
     *
     * @param request GetBucketPublicStatusRequest 请求对象
     * @return SyncInvoker<GetBucketPublicStatusRequest, GetBucketPublicStatusResponse>
     */
    public SyncInvoker<GetBucketPublicStatusRequest, GetBucketPublicStatusResponse> getBucketPublicStatusInvoker(
        GetBucketPublicStatusRequest request) {
        return new SyncInvoker<>(request, ObsMeta.getBucketPublicStatus, hcClient);
    }
    ...
    public GetObjectResponse getObject(GetObjectRequest request) {
        return hcClient.syncInvokeHttp(request, ObsMeta.getObject);
    }
     ...
     *
     * @param request GetObjectRequest 请求对象
     * @return SyncInvoker<GetObjectRequest, GetObjectResponse>
     */
    public SyncInvoker<GetObjectRequest, GetObjectResponse> getObjectInvoker(GetObjectRequest request) {
        return new SyncInvoker<>(request, ObsMeta.getObject, hcClient);
    }
    ...
    public GetObjectTaggingResponse getObjectTagging(GetObjectTaggingRequest request) {
        return hcClient.syncInvokeHttp(request, ObsMeta.getObjectTagging);
    }
     ...
     *
     * @param request GetObjectTaggingRequest 请求对象
     * @return SyncInvoker<GetObjectTaggingRequest, GetObjectTaggingResponse>
     */
    public SyncInvoker<GetObjectTaggingRequest, GetObjectTaggingResponse> getObjectTaggingInvoker(
        GetObjectTaggingRequest request) {
        return new SyncInvoker<>(request, ObsMeta.getObjectTagging, hcClient);
    }
    ...
    public HeadObjectResponse headObject(HeadObjectRequest request) {
        return hcClient.syncInvokeHttp(request, ObsMeta.headObject);
    }
     ...
     *
     * @param request HeadObjectRequest 请求对象
     * @return SyncInvoker<HeadObjectRequest, HeadObjectResponse>
     */
    public SyncInvoker<HeadObjectRequest, HeadObjectResponse> headObjectInvoker(HeadObjectRequest request) {
        return new SyncInvoker<>(request, ObsMeta.headObject, hcClient);
    }
    ...
    public ListBucketsResponse listBuckets(ListBucketsRequest request) {
        return hcClient.syncInvokeHttp(request, ObsMeta.listBuckets);
    }
    ...
    public SyncInvoker<ListBucketsRequest, ListBucketsResponse> listBucketsInvoker(ListBucketsRequest request) {
        return new SyncInvoker<>(request, ObsMeta.listBuckets, hcClient);
    }
    ...
    public ListObjectsResponse listObjects(ListObjectsRequest request) {
        return hcClient.syncInvokeHttp(request, ObsMeta.listObjects);
    }
     ...
     *
     * @param request ListObjectsRequest 请求对象
     * @return SyncInvoker<ListObjectsRequest, ListObjectsResponse>
     */
    public SyncInvoker<ListObjectsRequest, ListObjectsResponse> listObjectsInvoker(ListObjectsRequest request) {
        return new SyncInvoker<>(request, ObsMeta.listObjects, hcClient);
    }
    ...
    public PutObjectResponse putObject(PutObjectRequest request) {
        return hcClient.syncInvokeHttp(request, ObsMeta.putObject);
    }
     ...
     *
     * @param request PutObjectRequest 请求对象
     * @return SyncInvoker<PutObjectRequest, PutObjectResponse>
     */
    public SyncInvoker<PutObjectRequest, PutObjectResponse> putObjectInvoker(PutObjectRequest request) {
        return new SyncInvoker<>(request, ObsMeta.putObject, hcClient);
    }
    ...
    public PutObjectTaggingResponse putObjectTagging(PutObjectTaggingRequest request) {
        return hcClient.syncInvokeHttp(request, ObsMeta.putObjectTagging);
    }
     ...
     *
     * @param request PutObjectTaggingRequest 请求对象
     * @return SyncInvoker<PutObjectTaggingRequest, PutObjectTaggingResponse>
     */
    public SyncInvoker<PutObjectTaggingRequest, PutObjectTaggingResponse> putObjectTaggingInvoker(
        PutObjectTaggingRequest request) {
        return new SyncInvoker<>(request, ObsMeta.putObjectTagging, hcClient);
    }
    ...
    public SetBucketAclResponse setBucketAcl(SetBucketAclRequest request) {
        return hcClient.syncInvokeHttp(request, ObsMeta.setBucketAcl);
    }
     ...
     *
     * @param request SetBucketAclRequest 请求对象
     * @return SyncInvoker<SetBucketAclRequest, SetBucketAclResponse>
     */
    public SyncInvoker<SetBucketAclRequest, SetBucketAclResponse> setBucketAclInvoker(SetBucketAclRequest request) {
        return new SyncInvoker<>(request, ObsMeta.setBucketAcl, hcClient);
    }
    ...
    public SyncInvoker<SetBucketCustomedomainRequest, SetBucketCustomedomainResponse> setBucketCustomedomainInvoker(
        ...
        return new SyncInvoker<>(request, ObsMeta.setBucketCustomedomain, hcClient);
    }
     ...
     * @return SetBucketNotificationResponse
     */
    public SetBucketNotificationResponse setBucketNotification(SetBucketNotificationRequest request) {
        return hcClient.syncInvokeHttp(request, ObsMeta.setBucketNotification);
    }
     ...
     *
     * @param request SetBucketNotificationRequest 请求对象
     * @return SyncInvoker<SetBucketNotificationRequest, SetBucketNotificationResponse>
     */
     ...
     * @return SetBucketObjectLockResponse
     */
    public SetBucketObjectLockResponse setBucketObjectLock(SetBucketObjectLockRequest request) {
        return hcClient.syncInvokeHttp(request, ObsMeta.setBucketObjectLock);
    }
     ...
     *
     * @param request SetBucketObjectLockRequest 请求对象
     * @return SyncInvoker<SetBucketObjectLockRequest, SetBucketObjectLockResponse>
     */
    public SyncInvoker<SetBucketObjectLockRequest, SetBucketObjectLockResponse> setBucketObjectLockInvoker(
        SetBucketObjectLockRequest request) {
        return new SyncInvoker<>(request, ObsMeta.setBucketObjectLock, hcClient);
    }
     ...
     * @return SetBucketPolicyResponse
     */
    public SetBucketPolicyResponse setBucketPolicy(SetBucketPolicyRequest request) {
        return hcClient.syncInvokeHttp(request, ObsMeta.setBucketPolicy);
    }
     ...
     *
     * @param request SetBucketPolicyRequest 请求对象
     * @return SyncInvoker<SetBucketPolicyRequest, SetBucketPolicyResponse>
     */
    public SyncInvoker<SetBucketPolicyRequest, SetBucketPolicyResponse> setBucketPolicyInvoker(
        SetBucketPolicyRequest request) {
        return new SyncInvoker<>(request, ObsMeta.setBucketPolicy, hcClient);
    }
     ...
     * @return SetBucketPublicAccessBlockResponse
     */
    public SetBucketPublicAccessBlockResponse setBucketPublicAccessBlock(SetBucketPublicAccessBlockRequest request) {
        return hcClient.syncInvokeHttp(request, ObsMeta.setBucketPublicAccessBlock);
    }
     ...
     *
     * @param request SetBucketPublicAccessBlockRequest 请求对象
     * @return SyncInvoker<SetBucketPublicAccessBlockRequest, SetBucketPublicAccessBlockResponse>
     */
    public SyncInvoker<SetBucketPublicAccessBlockRequest, SetBucketPublicAccessBlockResponse> setBucketPublicAccessBlockInvoker(
        SetBucketPublicAccessBlockRequest request) {
        return new SyncInvoker<>(request, ObsMeta.setBucketPublicAccessBlock, hcClient);
    }
    ...
    public SetBucketVersioningResponse setBucketVersioning(SetBucketVersioningRequest request) {
        return hcClient.syncInvokeHttp(request, ObsMeta.setBucketVersioning);
    }
     ...
     *
     * @param request SetBucketVersioningRequest 请求对象
     * @return SyncInvoker<SetBucketVersioningRequest, SetBucketVersioningResponse>
     */
    public SyncInvoker<SetBucketVersioningRequest, SetBucketVersioningResponse> setBucketVersioningInvoker(
        SetBucketVersioningRequest request) {
        return new SyncInvoker<>(request, ObsMeta.setBucketVersioning, hcClient);
    }
     ...
     * @return SetObjectLockResponse
     */
    public SetObjectLockResponse setObjectLock(SetObjectLockRequest request) {
        return hcClient.syncInvokeHttp(request, ObsMeta.setObjectLock);
    }
     ...
     *
     * @param request SetObjectLockRequest 请求对象
     * @return SyncInvoker<SetObjectLockRequest, SetObjectLockResponse>
     */
    public SyncInvoker<SetObjectLockRequest, SetObjectLockResponse> setObjectLockInvoker(SetObjectLockRequest request) {
        return new SyncInvoker<>(request, ObsMeta.setObjectLock, hcClient);
    }
