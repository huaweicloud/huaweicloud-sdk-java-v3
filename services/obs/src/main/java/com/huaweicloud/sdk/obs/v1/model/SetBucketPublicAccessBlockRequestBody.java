...
/**
 * PublicAccessBlockConfiguration参数。 
 */
@JacksonXmlRootElement(localName = "PublicAccessBlockConfiguration")
public class SetBucketPublicAccessBlockRequestBody extends SdkXmlBody<SetBucketPublicAccessBlockRequestBody> {
    ...
    public SetBucketPublicAccessBlockRequestBody withBlockPublicAcls(Boolean blockPublicAcls) {
    ...
    public SetBucketPublicAccessBlockRequestBody withBlockPublicPolicy(Boolean blockPublicPolicy) {
    ...
    public SetBucketPublicAccessBlockRequestBody withIgnorePublicAcls(Boolean ignorePublicAcls) {
    ...
    public SetBucketPublicAccessBlockRequestBody withRestrictPublicBuckets(Boolean restrictPublicBuckets) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        SetBucketPublicAccessBlockRequestBody that = (SetBucketPublicAccessBlockRequestBody) obj;
    ...
    public String toString() {
        ...
        sb.append("class SetBucketPublicAccessBlockRequestBody {\n");
