 ...
 * Response Object
 */
@JacksonXmlRootElement(localName = "PutObjectTaggingResponse")
public class PutObjectTaggingResponse extends SdkResponse {
    ...
    public PutObjectTaggingResponse withXObsId2(String xObsId2) {
    ...
    public PutObjectTaggingResponse withXObsRequestId(String xObsRequestId) {
    ...
    public PutObjectTaggingResponse withConnection(String connection) {
    ...
    public PutObjectTaggingResponse withContentLength(String contentLength) {
    ...
    public PutObjectTaggingResponse withDate(String date) {
        this.date = date;
        return this;
    }
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        PutObjectTaggingResponse that = (PutObjectTaggingResponse) obj;
    ...
    public String toString() {
        ...
        sb.append("class PutObjectTaggingResponse {\n");
