 ...
 * Response Object
 */
@JacksonXmlRootElement(localName = "SetDisPolicyResponse")
public class SetDisPolicyResponse extends SdkResponse {
    ...
    public SetDisPolicyResponse withXObsId2(String xObsId2) {
    ...
    public SetDisPolicyResponse withXObsRequestId(String xObsRequestId) {
    ...
    public SetDisPolicyResponse withEtag(String etag) {
        this.etag = etag;
        return this;
    }
    ...
    public SetDisPolicyResponse withConnection(String connection) {
    ...
    public SetDisPolicyResponse withContentLength(String contentLength) {
    ...
    public SetDisPolicyResponse withDate(String date) {
        this.date = date;
        return this;
    }
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        SetDisPolicyResponse that = (SetDisPolicyResponse) obj;
    ...
    public String toString() {
        ...
        sb.append("class SetDisPolicyResponse {\n");
