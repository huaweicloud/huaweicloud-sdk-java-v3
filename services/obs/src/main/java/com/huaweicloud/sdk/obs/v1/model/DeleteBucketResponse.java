 ...
 * Response Object
 */
@JacksonXmlRootElement(localName = "DeleteBucketResponse")
public class DeleteBucketResponse extends SdkResponse {
    ...
    public DeleteBucketResponse withXObsId2(String xObsId2) {
    ...
    public DeleteBucketResponse withXObsRequestId(String xObsRequestId) {
    ...
    public DeleteBucketResponse withEtag(String etag) {
        this.etag = etag;
        return this;
    }
    ...
    public DeleteBucketResponse withConnection(String connection) {
    ...
    public DeleteBucketResponse withContentLength(String contentLength) {
    ...
    public DeleteBucketResponse withDate(String date) {
        this.date = date;
        return this;
    }
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        DeleteBucketResponse that = (DeleteBucketResponse) obj;
