 ...
 * Response Object
 */
@JacksonXmlRootElement(localName = "SetBucketNotificationResponse")
public class SetBucketNotificationResponse extends SdkResponse {
    ...
    public SetBucketNotificationResponse withXObsId2(String xObsId2) {
    ...
    public SetBucketNotificationResponse withXObsRequestId(String xObsRequestId) {
    ...
    public SetBucketNotificationResponse withEtag(String etag) {
        this.etag = etag;
        return this;
    }
    ...
    public SetBucketNotificationResponse withConnection(String connection) {
    ...
    public SetBucketNotificationResponse withContentLength(String contentLength) {
    ...
    public SetBucketNotificationResponse withDate(String date) {
        this.date = date;
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append("class SetBucketNotificationResponse {\n");
