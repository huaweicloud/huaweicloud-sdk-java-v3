 ...
 * Response Object
 */
@JacksonXmlRootElement(localName = "GetBucketPublicStatusResponse")
public class GetBucketPublicStatusResponse extends SdkXmlResponse<GetBucketPublicStatusResponse> {
    ...
    public GetBucketPublicStatusResponse withIsPublic(Boolean isPublic) {
    ...
    public GetBucketPublicStatusResponse withXObsId2(String xObsId2) {
    ...
    public GetBucketPublicStatusResponse withXObsRequestId(String xObsRequestId) {
    ...
    public GetBucketPublicStatusResponse withXObsBucketType(String xObsBucketType) {
    ...
    public GetBucketPublicStatusResponse withConnection(String connection) {
    ...
    public GetBucketPublicStatusResponse withContentLength(String contentLength) {
    ...
    public GetBucketPublicStatusResponse withDate(String date) {
        this.date = date;
        return this;
    }
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        GetBucketPublicStatusResponse that = (GetBucketPublicStatusResponse) obj;
    ...
    public String toString() {
        ...
        sb.append("class GetBucketPublicStatusResponse {\n");
