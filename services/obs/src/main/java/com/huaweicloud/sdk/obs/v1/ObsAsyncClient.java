...
public class ObsAsyncClient {
     ...
     * @return CompletableFuture<DeleteDisPolicyResponse>
     */
    public CompletableFuture<DeleteDisPolicyResponse> deleteDisPolicyAsync(DeleteDisPolicyRequest request) {
        return hcClient.asyncInvokeHttp(request, ObsMeta.deleteDisPolicy);
    }
     ...
     *
     * @param request DeleteDisPolicyRequest 请求对象
     * @return AsyncInvoker<DeleteDisPolicyRequest, DeleteDisPolicyResponse>
     */
    public AsyncInvoker<DeleteDisPolicyRequest, DeleteDisPolicyResponse> deleteDisPolicyAsyncInvoker(
        DeleteDisPolicyRequest request) {
        return new AsyncInvoker<>(request, ObsMeta.deleteDisPolicy, hcClient);
    }
     ...
     * @return CompletableFuture<GetDisPolicyResponse>
     */
    public CompletableFuture<GetDisPolicyResponse> getDisPolicyAsync(GetDisPolicyRequest request) {
        return hcClient.asyncInvokeHttp(request, ObsMeta.getDisPolicy);
    }
     ...
     *
     * @param request GetDisPolicyRequest 请求对象
     * @return AsyncInvoker<GetDisPolicyRequest, GetDisPolicyResponse>
     */
    public AsyncInvoker<GetDisPolicyRequest, GetDisPolicyResponse> getDisPolicyAsyncInvoker(
        GetDisPolicyRequest request) {
        return new AsyncInvoker<>(request, ObsMeta.getDisPolicy, hcClient);
    }
     ...
     * @return CompletableFuture<SetDisPolicyResponse>
     */
    public CompletableFuture<SetDisPolicyResponse> setDisPolicyAsync(SetDisPolicyRequest request) {
        return hcClient.asyncInvokeHttp(request, ObsMeta.setDisPolicy);
    }
     ...
     *
     * @param request SetDisPolicyRequest 请求对象
     * @return AsyncInvoker<SetDisPolicyRequest, SetDisPolicyResponse>
     */
