package com.huaweicloud.sdk.obs.v1.region;
...
public class ObsRegion {

    public static final Region AF_SOUTH_1 = new Region("af-south-1", "https://obs.af-south-1.myhuaweicloud.com");

    public static final Region CN_NORTH_4 = new Region("cn-north-4", "https://obs.cn-north-4.myhuaweicloud.com");

    public static final Region CN_NORTH_1 = new Region("cn-north-1", "https://obs.cn-north-1.myhuaweicloud.com");

    public static final Region CN_NORTH_9 = new Region("cn-north-9", "https://obs.cn-north-9.myhuaweicloud.com");

    public static final Region CN_EAST_2 = new Region("cn-east-2", "https://obs.cn-east-2.myhuaweicloud.com");

    public static final Region CN_EAST_3 = new Region("cn-east-3", "https://obs.cn-east-3.myhuaweicloud.com");
    ...
    public static final Region SA_BRAZIL_1 = new Region("sa-brazil-1", "https://obs.sa-brazil-1.myhuaweicloud.com");

    public static final Region LA_SOUTH_2 = new Region("la-south-2", "https://obs.la-south-2.myhuaweicloud.com");

    public static final Region CN_SOUTHWEST_2 =
        new Region("cn-southwest-2", "https://obs.cn-southwest-2.myhuaweicloud.com");

    public static final Region AP_SOUTHEAST_2 =
        new Region("ap-southeast-2", "https://obs.ap-southeast-2.myhuaweicloud.com");
    ...
    public static Region valueOf(String regionId) {
        ...
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "region id '%s' is not in the following supported regions of service OBS: [%s]",
            regionId,
