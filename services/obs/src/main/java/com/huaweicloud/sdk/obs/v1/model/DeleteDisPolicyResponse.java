 ...
 * Response Object
 */
@JacksonXmlRootElement(localName = "DeleteDisPolicyResponse")
public class DeleteDisPolicyResponse extends SdkResponse {
    ...
    public DeleteDisPolicyResponse withXObsId2(String xObsId2) {
    ...
    public DeleteDisPolicyResponse withXObsRequestId(String xObsRequestId) {
    ...
    public DeleteDisPolicyResponse withEtag(String etag) {
        this.etag = etag;
        return this;
    }
    ...
    public DeleteDisPolicyResponse withConnection(String connection) {
    ...
    public DeleteDisPolicyResponse withContentLength(String contentLength) {
    ...
    public DeleteDisPolicyResponse withDate(String date) {
        this.date = date;
        return this;
    }
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        DeleteDisPolicyResponse that = (DeleteDisPolicyResponse) obj;
    ...
    public String toString() {
        ...
        sb.append("class DeleteDisPolicyResponse {\n");
