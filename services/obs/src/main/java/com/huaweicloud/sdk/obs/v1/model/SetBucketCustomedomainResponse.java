 ...
 * Response Object
 */
@JacksonXmlRootElement(localName = "SetBucketCustomedomainResponse")
public class SetBucketCustomedomainResponse extends SdkResponse {
    ...
    public SetBucketCustomedomainResponse withXObsId2(String xObsId2) {
    ...
    public SetBucketCustomedomainResponse withXObsRequestId(String xObsRequestId) {
    ...
    public SetBucketCustomedomainResponse withEtag(String etag) {
        this.etag = etag;
        return this;
    }
    ...
    public SetBucketCustomedomainResponse withConnection(String connection) {
    ...
    public SetBucketCustomedomainResponse withContentLength(String contentLength) {
    ...
    public SetBucketCustomedomainResponse withDate(String date) {
        this.date = date;
        return this;
    }
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        SetBucketCustomedomainResponse that = (SetBucketCustomedomainResponse) obj;
    ...
    public String toString() {
        ...
        sb.append("class SetBucketCustomedomainResponse {\n");
