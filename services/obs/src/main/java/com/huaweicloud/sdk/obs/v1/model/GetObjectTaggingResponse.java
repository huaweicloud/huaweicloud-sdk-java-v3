 ...
 * Response Object
 */
@JacksonXmlRootElement(localName = "GetObjectTaggingResponse")
public class GetObjectTaggingResponse extends SdkXmlResponse<GetObjectTaggingResponse> {
    ...
    private PutObjectTaggingRequestBody tagging;
    ...
    public GetObjectTaggingResponse withTagging(PutObjectTaggingRequestBody tagging) {
        this.tagging = tagging;
        return this;
    }

    public GetObjectTaggingResponse withTagging(Consumer<PutObjectTaggingRequestBody> taggingSetter) {
        if (this.tagging == null) {
            this.tagging = new PutObjectTaggingRequestBody();
            taggingSetter.accept(this.tagging);
        }
     ...
     * @return tagging
     */
    public PutObjectTaggingRequestBody getTagging() {
        return tagging;
    }

    public void setTagging(PutObjectTaggingRequestBody tagging) {
        this.tagging = tagging;
    }

    public GetObjectTaggingResponse withXObsId2(String xObsId2) {
    ...
    public GetObjectTaggingResponse withXObsRequestId(String xObsRequestId) {
    ...
    public GetObjectTaggingResponse withConnection(String connection) {
    ...
    public GetObjectTaggingResponse withContentLength(String contentLength) {
    ...
    public GetObjectTaggingResponse withDate(String date) {
        this.date = date;
        return this;
    }
    ...
    public GetObjectTaggingResponse withXObsVersionId(String xObsVersionId) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        GetObjectTaggingResponse that = (GetObjectTaggingResponse) obj;
        return Objects.equals(this.tagging, that.tagging) && Objects.equals(this.xObsId2, that.xObsId2)
    ...
    @Override
    public int hashCode() {
        return Objects.hash(tagging, xObsId2, xObsRequestId, connection, contentLength, date, xObsVersionId);
    }

    @Override
    public String toString() {
        StringBuilder sb = new StringBuilder();
        sb.append("class GetObjectTaggingResponse {\n");
