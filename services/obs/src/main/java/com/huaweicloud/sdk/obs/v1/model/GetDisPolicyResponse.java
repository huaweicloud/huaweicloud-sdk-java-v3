 ...
 * Response Object
 */
@JacksonXmlRootElement(localName = "GetDisPolicyResponse")
public class GetDisPolicyResponse extends SdkResponse {
    ...
    public GetDisPolicyResponse withXObsId2(String xObsId2) {
    ...
    public GetDisPolicyResponse withXObsRequestId(String xObsRequestId) {
    ...
    public GetDisPolicyResponse withEtag(String etag) {
        this.etag = etag;
        return this;
    }
    ...
    public GetDisPolicyResponse withConnection(String connection) {
    ...
    public GetDisPolicyResponse withContentLength(String contentLength) {
    ...
    public GetDisPolicyResponse withDate(String date) {
        this.date = date;
        return this;
    }
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        GetDisPolicyResponse that = (GetDisPolicyResponse) obj;
    ...
    public String toString() {
        ...
        sb.append("class GetDisPolicyResponse {\n");
