 ...
 * Response Object
 */
@JacksonXmlRootElement(localName = "SetBucketPublicAccessBlockResponse")
public class SetBucketPublicAccessBlockResponse extends SdkResponse {
    ...
    public SetBucketPublicAccessBlockResponse withXObsId2(String xObsId2) {
    ...
    public SetBucketPublicAccessBlockResponse withXObsRequestId(String xObsRequestId) {
    ...
    public SetBucketPublicAccessBlockResponse withConnection(String connection) {
    ...
    public SetBucketPublicAccessBlockResponse withContentLength(String contentLength) {
    ...
    public SetBucketPublicAccessBlockResponse withDate(String date) {
        this.date = date;
        return this;
    }
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        SetBucketPublicAccessBlockResponse that = (SetBucketPublicAccessBlockResponse) obj;
    ...
    public String toString() {
        ...
        sb.append("class SetBucketPublicAccessBlockResponse {\n");
