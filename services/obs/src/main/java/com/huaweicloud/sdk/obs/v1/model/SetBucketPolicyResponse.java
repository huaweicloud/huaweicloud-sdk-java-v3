 ...
 * Response Object
 */
@JacksonXmlRootElement(localName = "SetBucketPolicyResponse")
public class SetBucketPolicyResponse extends SdkResponse {
    ...
    public SetBucketPolicyResponse withXObsId2(String xObsId2) {
    ...
    public SetBucketPolicyResponse withXObsRequestId(String xObsRequestId) {
    ...
    public SetBucketPolicyResponse withEtag(String etag) {
        this.etag = etag;
        return this;
    }
    ...
    public SetBucketPolicyResponse withConnection(String connection) {
    ...
    public SetBucketPolicyResponse withContentLength(String contentLength) {
    ...
    public SetBucketPolicyResponse withDate(String date) {
        this.date = date;
        return this;
    }
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        SetBucketPolicyResponse that = (SetBucketPolicyResponse) obj;
    ...
    public String toString() {
        ...
        sb.append("class SetBucketPolicyResponse {\n");
