 ...
 * Request Object
 */
@JacksonXmlRootElement(localName = "DeleteDisPolicyRequest")
public class DeleteDisPolicyRequest {
    ...
    public DeleteDisPolicyRequest withDate(String date) {
        this.date = date;
        return this;
    }
    ...
    public DeleteDisPolicyRequest withBucketName(String bucketName) {
    ...
    public DeleteDisPolicyRequest withDisPolicy(String disPolicy) {
    ...
    public DeleteDisPolicyRequest withHost(String host) {
        this.host = host;
        return this;
    }
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        DeleteDisPolicyRequest that = (DeleteDisPolicyRequest) obj;
    ...
    public String toString() {
        ...
        sb.append("class DeleteDisPolicyRequest {\n");
