 ...
 * Response Object
 */
@JacksonXmlRootElement(localName = "SetObjectLockResponse")
public class SetObjectLockResponse extends SdkResponse {
    ...
    public SetObjectLockResponse withXObsId2(String xObsId2) {
    ...
    public SetObjectLockResponse withXObsRequestId(String xObsRequestId) {
    ...
    public SetObjectLockResponse withEtag(String etag) {
        this.etag = etag;
        return this;
    }
    ...
    public SetObjectLockResponse withConnection(String connection) {
    ...
    public SetObjectLockResponse withContentLength(String contentLength) {
    ...
    public SetObjectLockResponse withDate(String date) {
        this.date = date;
        return this;
    }
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        SetObjectLockResponse that = (SetObjectLockResponse) obj;
    ...
    public String toString() {
        ...
        sb.append("class SetObjectLockResponse {\n");
