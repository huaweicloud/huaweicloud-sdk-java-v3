 ...
 * Response Object
 */
@JacksonXmlRootElement(localName = "DeleteBucketPublicAccessBlockResponse")
public class DeleteBucketPublicAccessBlockResponse extends SdkResponse {
    ...
    public DeleteBucketPublicAccessBlockResponse withXObsId2(String xObsId2) {
    ...
    public DeleteBucketPublicAccessBlockResponse withXObsRequestId(String xObsRequestId) {
    ...
    public DeleteBucketPublicAccessBlockResponse withConnection(String connection) {
    ...
    public DeleteBucketPublicAccessBlockResponse withContentLength(String contentLength) {
    ...
    public DeleteBucketPublicAccessBlockResponse withDate(String date) {
        this.date = date;
        return this;
    }
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        DeleteBucketPublicAccessBlockResponse that = (DeleteBucketPublicAccessBlockResponse) obj;
    ...
    @Override
    public int hashCode() {
        return Objects.hash(xObsId2, xObsRequestId, connection, contentLength, date);
    }

    @Override
    public String toString() {
        StringBuilder sb = new StringBuilder();
        sb.append("class DeleteBucketPublicAccessBlockResponse {\n");
