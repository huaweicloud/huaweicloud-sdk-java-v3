 ...
 * Response Object
 */
@JacksonXmlRootElement(localName = "DeleteObjectTaggingResponse")
public class DeleteObjectTaggingResponse extends SdkResponse {
    ...
    public DeleteObjectTaggingResponse withXObsId2(String xObsId2) {
    ...
    public DeleteObjectTaggingResponse withXObsRequestId(String xObsRequestId) {
    ...
    public DeleteObjectTaggingResponse withConnection(String connection) {
    ...
    public DeleteObjectTaggingResponse withContentLength(String contentLength) {
    ...
    public DeleteObjectTaggingResponse withDate(String date) {
        this.date = date;
        return this;
    }
    ...
    public DeleteObjectTaggingResponse withXObsVersionId(String xObsVersionId) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        DeleteObjectTaggingResponse that = (DeleteObjectTaggingResponse) obj;
    ...
    @Override
    public int hashCode() {
        return Objects.hash(xObsId2, xObsRequestId, connection, contentLength, date, xObsVersionId);
    }

    @Override
    public String toString() {
        StringBuilder sb = new StringBuilder();
        sb.append("class DeleteObjectTaggingResponse {\n");
