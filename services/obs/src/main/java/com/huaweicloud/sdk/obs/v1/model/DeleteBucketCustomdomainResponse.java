 ...
 * Response Object
 */
@JacksonXmlRootElement(localName = "DeleteBucketCustomdomainResponse")
public class DeleteBucketCustomdomainResponse extends SdkResponse {
    ...
    public DeleteBucketCustomdomainResponse withXObsId2(String xObsId2) {
    ...
    public DeleteBucketCustomdomainResponse withXObsRequestId(String xObsRequestId) {
    ...
    public DeleteBucketCustomdomainResponse withEtag(String etag) {
        this.etag = etag;
        return this;
    }
    ...
    public DeleteBucketCustomdomainResponse withConnection(String connection) {
    ...
    public DeleteBucketCustomdomainResponse withContentLength(String contentLength) {
    ...
    public DeleteBucketCustomdomainResponse withDate(String date) {
        this.date = date;
        return this;
    }
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        DeleteBucketCustomdomainResponse that = (DeleteBucketCustomdomainResponse) obj;
    ...
    @Override
    public int hashCode() {
        return Objects.hash(xObsId2, xObsRequestId, etag, connection, contentLength, date);
    }

    @Override
    public String toString() {
        StringBuilder sb = new StringBuilder();
        sb.append("class DeleteBucketCustomdomainResponse {\n");
