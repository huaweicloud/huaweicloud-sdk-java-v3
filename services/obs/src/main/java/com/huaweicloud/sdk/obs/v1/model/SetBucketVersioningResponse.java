 ...
 * Response Object
 */
@JacksonXmlRootElement(localName = "SetBucketVersioningResponse")
public class SetBucketVersioningResponse extends SdkResponse {
    ...
    public SetBucketVersioningResponse withXObsId2(String xObsId2) {
    ...
    public SetBucketVersioningResponse withXObsRequestId(String xObsRequestId) {
    ...
    public SetBucketVersioningResponse withEtag(String etag) {
        this.etag = etag;
        return this;
    }
    ...
    public SetBucketVersioningResponse withConnection(String connection) {
    ...
    public SetBucketVersioningResponse withContentLength(String contentLength) {
    ...
    public SetBucketVersioningResponse withDate(String date) {
        this.date = date;
        return this;
    }
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        SetBucketVersioningResponse that = (SetBucketVersioningResponse) obj;
    ...
    public String toString() {
        ...
        sb.append("class SetBucketVersioningResponse {\n");
