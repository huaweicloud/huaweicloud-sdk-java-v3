 ...
 * Response Object
 */
@JacksonXmlRootElement(localName = "SetBucketObjectLockResponse")
public class SetBucketObjectLockResponse extends SdkResponse {
    ...
    public SetBucketObjectLockResponse withXObsId2(String xObsId2) {
    ...
    public SetBucketObjectLockResponse withXObsRequestId(String xObsRequestId) {
    ...
    public SetBucketObjectLockResponse withEtag(String etag) {
        this.etag = etag;
        return this;
    }
    ...
    public SetBucketObjectLockResponse withConnection(String connection) {
    ...
    public SetBucketObjectLockResponse withContentLength(String contentLength) {
    ...
    public SetBucketObjectLockResponse withDate(String date) {
        this.date = date;
        return this;
    }
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        SetBucketObjectLockResponse that = (SetBucketObjectLockResponse) obj;
    ...
    public String toString() {
        ...
        sb.append("class SetBucketObjectLockResponse {\n");
