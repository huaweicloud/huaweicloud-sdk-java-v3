...
public class UpdateCcRuleResponse extends SdkResponse {
    ...
    public UpdateCcRuleResponse withPolicyid(String policyid) {
    ...
    public UpdateCcRuleResponse withPrefix(Boolean prefix) {
        this.prefix = prefix;
        return this;
    }
    ...
    public UpdateCcRuleResponse withConditions(List<CcCondition> conditions) {
        this.conditions = conditions;
        return this;
    }

    public UpdateCcRuleResponse addConditionsItem(CcCondition conditionsItem) {
    ...
    public UpdateCcRuleResponse withConditions(Consumer<List<CcCondition>> conditionsSetter) {
        if (this.conditions == null) {
            this.conditions = new ArrayList<>();
        }
    ...
    public UpdateCcRuleResponse withTagType(TagTypeEnum tagType) {
    ...
    public UpdateCcRuleResponse withTagCondition(CcrulesListInfoTagCondition tagCondition) {
        this.tagCondition = tagCondition;
        return this;
    }

    public UpdateCcRuleResponse withTagCondition(Consumer<CcrulesListInfoTagCondition> tagConditionSetter) {
    ...
    public UpdateCcRuleResponse withUnlockNum(Integer unlockNum) {
    ...
    public UpdateCcRuleResponse withLockTime(Integer lockTime) {
    ...
    public UpdateCcRuleResponse withDomainAggregation(Boolean domainAggregation) {
    ...
    public UpdateCcRuleResponse withRegionAggregation(Boolean regionAggregation) {
    ...
    public UpdateCcRuleResponse withDescription(String description) {
    ...
    public UpdateCcRuleResponse withTotalNum(Integer totalNum) {
    ...
    public UpdateCcRuleResponse withUnaggregation(Boolean unaggregation) {
    ...
    public UpdateCcRuleResponse withAgingTime(Integer agingTime) {
    ...
    public UpdateCcRuleResponse withProducer(Integer producer) {
    ...
    public UpdateCcRuleResponse withPriority(Integer priority) {
    ...
    public UpdateCcRuleResponse withCcPriority(Integer ccPriority) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        return Objects.equals(this.name, that.name) && Objects.equals(this.id, that.id)
            ...
            && Objects.equals(this.producer, that.producer) && Objects.equals(this.priority, that.priority)
