 ...
 * Response Object
 */
public class ShowSecurityReportSubscriptionResponse extends SdkResponse {
    ...
    public ShowSecurityReportSubscriptionResponse withSubscriptionId(String subscriptionId) {
    ...
    public ShowSecurityReportSubscriptionResponse withSendingPeriod(String sendingPeriod) {
    ...
    public ShowSecurityReportSubscriptionResponse withReportName(String reportName) {
    ...
    public ShowSecurityReportSubscriptionResponse withReportCategory(String reportCategory) {
    ...
    public ShowSecurityReportSubscriptionResponse withTopicUrn(String topicUrn) {
    ...
    public ShowSecurityReportSubscriptionResponse withSubscriptionType(String subscriptionType) {
    ...
    public ShowSecurityReportSubscriptionResponse withReportContentSubscription(
    ...
    public ShowSecurityReportSubscriptionResponse withStatPeriod(
    ...
    public ShowSecurityReportSubscriptionResponse withIsAllEnterpriseProject(Boolean isAllEnterpriseProject) {
    ...
    public ShowSecurityReportSubscriptionResponse withEnterpriseProjectId(String enterpriseProjectId) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ShowSecurityReportSubscriptionResponse that = (ShowSecurityReportSubscriptionResponse) obj;
    ...
    public String toString() {
        ...
        sb.append("class ShowSecurityReportSubscriptionResponse {\n");
