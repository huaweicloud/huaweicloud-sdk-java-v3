...
public class UpdateCertificateResponse extends SdkResponse {
    ...
    public UpdateCertificateResponse withContent(String content) {
    ...
    public UpdateCertificateResponse withKey(String key) {
        this.key = key;
        return this;
    }
    ...
    public UpdateCertificateResponse withExpStatus(ExpStatusEnum expStatus) {
    ...
    public UpdateCertificateResponse withBindHost(List<BindHost> bindHost) {
        this.bindHost = bindHost;
        return this;
    }

    
    public UpdateCertificateResponse addBindHostItem(BindHost bindHostItem) {
    ...
    public UpdateCertificateResponse withBindHost(Consumer<List<BindHost>> bindHostSetter) {
        if(this.bindHost == null) {
            this.bindHost = new ArrayList<>();
        }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        return Objects.equals(this.id, updateCertificateResponse.id) &&
            ...
            Objects.equals(this.content, updateCertificateResponse.content) &&
            Objects.equals(this.key, updateCertificateResponse.key) &&
            Objects.equals(this.expireTime, updateCertificateResponse.expireTime) &&
            Objects.equals(this.expStatus, updateCertificateResponse.expStatus) &&
            Objects.equals(this.timestamp, updateCertificateResponse.timestamp) &&
            Objects.equals(this.bindHost, updateCertificateResponse.bindHost);
    }
    @Override
    public int hashCode() {
