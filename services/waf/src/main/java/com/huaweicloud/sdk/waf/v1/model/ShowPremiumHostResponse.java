...
public class ShowPremiumHostResponse extends SdkResponse {
    ...
    public ShowPremiumHostResponse withLoadbalancerId(String loadbalancerId) {
    ...
    public ShowPremiumHostResponse withListenerId(String listenerId) {
    ...
    public ShowPremiumHostResponse withProtocolPort(Integer protocolPort) {
    ...
    public ShowPremiumHostResponse withProtectStatus(ProtectStatusEnum protectStatus) {
    ...
    public ShowPremiumHostResponse withAccessStatus(AccessStatusEnum accessStatus) {
