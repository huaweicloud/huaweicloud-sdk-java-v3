...
public class BatchCreateAntileakageRuleRequestBody {
    ...
    public BatchCreateAntileakageRuleRequestBody withAction(BatchCreateAntileakageRuleRequestBodyAction action) {
        this.action = action;
        return this;
    }

    public BatchCreateAntileakageRuleRequestBody withAction(
