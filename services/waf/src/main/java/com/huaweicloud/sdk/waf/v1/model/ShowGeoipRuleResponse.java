...
public class ShowGeoipRuleResponse extends SdkResponse {
    ...
    public ShowGeoipRuleResponse withPolicyid(String policyid) {
    ...
    public ShowGeoipRuleResponse withStatus(Integer status) {
        this.status = status;
        return this;
    }
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, policyid, geoip, white, status, timestamp);
    }
