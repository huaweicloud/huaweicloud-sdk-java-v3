...
public class ShowPolicyResponse extends SdkResponse {
    ...
    public ShowPolicyResponse withRobotAction(Action robotAction) {
        this.robotAction = robotAction;
        return this;
    }

    public ShowPolicyResponse withRobotAction(Consumer<Action> robotActionSetter) {
    ...
    public ShowPolicyResponse withModulexOptions(Map<String, Object> modulexOptions) {
        this.modulexOptions = modulexOptions;
        return this;
    }

    public ShowPolicyResponse putModulexOptionsItem(String key, Object modulexOptionsItem) {
    ...
    public ShowPolicyResponse withModulexOptions(Consumer<Map<String, Object>> modulexOptionsSetter) {
        if (this.modulexOptions == null) {
            this.modulexOptions = new HashMap<>();
        }
    ...
    public ShowPolicyResponse withHosts(List<String> hosts) {
        this.hosts = hosts;
        return this;
    }

    public ShowPolicyResponse addHostsItem(String hostsItem) {
        if (this.hosts == null) {
    ...
    public ShowPolicyResponse withHosts(Consumer<List<String>> hostsSetter) {
        if (this.hosts == null) {
            this.hosts = new ArrayList<>();
        }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        return Objects.equals(this.id, showPolicyResponse.id) && Objects.equals(this.name, showPolicyResponse.name)
            ...
            && Objects.equals(this.robotAction, showPolicyResponse.robotAction)
            && Objects.equals(this.action, showPolicyResponse.action)
            && Objects.equals(this.options, showPolicyResponse.options)
            && Objects.equals(this.modulexOptions, showPolicyResponse.modulexOptions)
            && Objects.equals(this.hosts, showPolicyResponse.hosts)
