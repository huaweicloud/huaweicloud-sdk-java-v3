...
public class UpdatePrivacyRuleResponse extends SdkResponse {
    ...
    public UpdatePrivacyRuleResponse withTimestamp(Long timestamp) {
    ...
    public UpdatePrivacyRuleResponse withStatus(Integer status) {
        this.status = status;
        return this;
    }
    ...
    public UpdatePrivacyRuleResponse withDescription(String description) {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        return Objects.equals(this.id, updatePrivacyRuleResponse.id)
            ...
            && Objects.equals(this.timestamp, updatePrivacyRuleResponse.timestamp)
            && Objects.equals(this.status, updatePrivacyRuleResponse.status)
            ...
            && Objects.equals(this.description, updatePrivacyRuleResponse.description);
    }
    ...
    public String toString() {
        ...
        sb.append("class UpdatePrivacyRuleResponse {\n");
