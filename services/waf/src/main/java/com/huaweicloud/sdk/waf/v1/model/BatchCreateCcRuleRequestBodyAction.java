 ...
 * 请求次数限制到达后采取的防护动作
 */
public class BatchCreateCcRuleRequestBodyAction {
    ...
    private CreateCcRuleRequestBodyActionDetail detail;

    public BatchCreateCcRuleRequestBodyAction withCategory(CategoryEnum category) {
    ...
    public BatchCreateCcRuleRequestBodyAction withDetail(CreateCcRuleRequestBodyActionDetail detail) {
        this.detail = detail;
        return this;
    }

    public BatchCreateCcRuleRequestBodyAction withDetail(Consumer<CreateCcRuleRequestBodyActionDetail> detailSetter) {
        if (this.detail == null) {
            this.detail = new CreateCcRuleRequestBodyActionDetail();
     ...
     * @return detail
     */
    public CreateCcRuleRequestBodyActionDetail getDetail() {
        return detail;
    }

    public void setDetail(CreateCcRuleRequestBodyActionDetail detail) {
        this.detail = detail;
    }
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        BatchCreateCcRuleRequestBodyAction that = (BatchCreateCcRuleRequestBodyAction) obj;
    ...
    public String toString() {
        ...
        sb.append("class BatchCreateCcRuleRequestBodyAction {\n");
