...
public class UpdateCcRuleRequestBody {
    ...
    public UpdateCcRuleRequestBody withUrl(String url) {
        this.url = url;
        return this;
    }
    ...
    public UpdateCcRuleRequestBody withConditions(List<CcCondition> conditions) {
        this.conditions = conditions;
        return this;
    }

    public UpdateCcRuleRequestBody addConditionsItem(CcCondition conditionsItem) {
    ...
    public UpdateCcRuleRequestBody withConditions(Consumer<List<CcCondition>> conditionsSetter) {
        if (this.conditions == null) {
            this.conditions = new ArrayList<>();
        }
    ...
    public UpdateCcRuleRequestBody withAction(CreateCcRuleRequestBodyAction action) {
        this.action = action;
        return this;
    }

    public UpdateCcRuleRequestBody withAction(Consumer<CreateCcRuleRequestBodyAction> actionSetter) {
        if (this.action == null) {
    ...
    public UpdateCcRuleRequestBody withTagType(TagTypeEnum tagType) {
    ...
    public UpdateCcRuleRequestBody withTagIndex(String tagIndex) {
    ...
    public UpdateCcRuleRequestBody withTagCondition(CcrulesListInfoTagCondition tagCondition) {
        this.tagCondition = tagCondition;
        return this;
    }

    public UpdateCcRuleRequestBody withTagCondition(Consumer<CcrulesListInfoTagCondition> tagConditionSetter) {
    ...
    public UpdateCcRuleRequestBody withLimitNum(Integer limitNum) {
    ...
    public UpdateCcRuleRequestBody withLimitPeriod(Integer limitPeriod) {
    ...
    public UpdateCcRuleRequestBody withUnlockNum(Integer unlockNum) {
    ...
    public UpdateCcRuleRequestBody withLockTime(Integer lockTime) {
    ...
    public UpdateCcRuleRequestBody withDomainAggregation(Boolean domainAggregation) {
    ...
    public UpdateCcRuleRequestBody withRegionAggregation(Boolean regionAggregation) {
    ...
    public UpdateCcRuleRequestBody withDescription(String description) {
