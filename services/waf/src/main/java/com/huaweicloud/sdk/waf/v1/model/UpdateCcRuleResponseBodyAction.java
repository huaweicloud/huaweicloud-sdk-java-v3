 ...
 * 请求次数限制到达后采取的防护动作
 */
public class UpdateCcRuleResponseBodyAction {
    ...
    public UpdateCcRuleResponseBodyAction withCategory(CategoryEnum category) {
    ...
    public UpdateCcRuleResponseBodyAction withDetail(CcrulesListInfoActionDetail detail) {
        this.detail = detail;
        return this;
    }

    public UpdateCcRuleResponseBodyAction withDetail(Consumer<CcrulesListInfoActionDetail> detailSetter) {
        if (this.detail == null) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        UpdateCcRuleResponseBodyAction that = (UpdateCcRuleResponseBodyAction) obj;
    ...
    public String toString() {
        ...
        sb.append("class UpdateCcRuleResponseBodyAction {\n");
