 ...
 * Request Object
 */
public class ListIpReputationPolicyRulesRequest {
    ...
    public ListIpReputationPolicyRulesRequest withProjectid(String projectid) {
    ...
    public ListIpReputationPolicyRulesRequest withPolicyids(String policyids) {
    ...
    public ListIpReputationPolicyRulesRequest withEnterpriseProjectId(String enterpriseProjectId) {
    ...
    public ListIpReputationPolicyRulesRequest withPage(Integer page) {
        this.page = page;
        return this;
    }
    ...
    public ListIpReputationPolicyRulesRequest withPagesize(Integer pagesize) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ListIpReputationPolicyRulesRequest that = (ListIpReputationPolicyRulesRequest) obj;
    ...
    public String toString() {
        ...
        sb.append("class ListIpReputationPolicyRulesRequest {\n");
