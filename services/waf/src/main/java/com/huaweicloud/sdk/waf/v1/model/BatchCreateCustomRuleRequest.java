...
public class BatchCreateCustomRuleRequest {
    ...
    public BatchCreateCustomRuleRequest withProjectid(String projectid) {
    ...
    public BatchCreateCustomRuleRequest withBody(Consumer<BatchCreateCustomRuleRequestBody> bodySetter) {
        if (this.body == null) {
            this.body = new BatchCreateCustomRuleRequestBody();
     ...
     * @return body
     */
    public BatchCreateCustomRuleRequestBody getBody() {
        return body;
    }

    public void setBody(BatchCreateCustomRuleRequestBody body) {
        this.body = body;
    }
