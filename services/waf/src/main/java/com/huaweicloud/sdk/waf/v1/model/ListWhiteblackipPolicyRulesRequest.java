 ...
 * Request Object
 */
public class ListWhiteblackipPolicyRulesRequest {
    ...
    public ListWhiteblackipPolicyRulesRequest withProjectid(String projectid) {
    ...
    public ListWhiteblackipPolicyRulesRequest withPolicyids(String policyids) {
    ...
    public ListWhiteblackipPolicyRulesRequest withEnterpriseProjectId(String enterpriseProjectId) {
    ...
    public ListWhiteblackipPolicyRulesRequest withPage(Integer page) {
        this.page = page;
        return this;
    }
    ...
    public ListWhiteblackipPolicyRulesRequest withPagesize(Integer pagesize) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ListWhiteblackipPolicyRulesRequest that = (ListWhiteblackipPolicyRulesRequest) obj;
    ...
    public String toString() {
        ...
        sb.append("class ListWhiteblackipPolicyRulesRequest {\n");
