...
public class CreatePolicyResponse extends SdkResponse {
    ...
    public CreatePolicyResponse withRobotAction(Action robotAction) {
        this.robotAction = robotAction;
        return this;
    }

    public CreatePolicyResponse withRobotAction(Consumer<Action> robotActionSetter) {
    ...
    public CreatePolicyResponse withModulexOptions(Map<String, Object> modulexOptions) {
        this.modulexOptions = modulexOptions;
        return this;
    }

    public CreatePolicyResponse putModulexOptionsItem(String key, Object modulexOptionsItem) {
    ...
    public CreatePolicyResponse withModulexOptions(Consumer<Map<String, Object>> modulexOptionsSetter) {
        if (this.modulexOptions == null) {
            this.modulexOptions = new HashMap<>();
        }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        return Objects.equals(this.id, createPolicyResponse.id) && Objects.equals(this.name, createPolicyResponse.name)
            ...
            && Objects.equals(this.robotAction, createPolicyResponse.robotAction)
            && Objects.equals(this.action, createPolicyResponse.action)
            && Objects.equals(this.options, createPolicyResponse.options)
            && Objects.equals(this.modulexOptions, createPolicyResponse.modulexOptions)
