...
public class ShowCompositeHostResponse extends SdkResponse {
    ...
    public ShowCompositeHostResponse withPaidType(PaidTypeEnum paidType) {
    ...
    public ShowCompositeHostResponse withEnterpriseProjectId(String enterpriseProjectId) {
