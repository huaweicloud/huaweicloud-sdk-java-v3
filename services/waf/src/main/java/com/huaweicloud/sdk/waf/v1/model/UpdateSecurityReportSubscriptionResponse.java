 ...
 * Response Object
 */
public class UpdateSecurityReportSubscriptionResponse extends SdkResponse {
    ...
    public UpdateSecurityReportSubscriptionResponse withSubscriptionId(String subscriptionId) {
    ...
    public UpdateSecurityReportSubscriptionResponse withSendingPeriod(String sendingPeriod) {
    ...
    public UpdateSecurityReportSubscriptionResponse withReportName(String reportName) {
    ...
    public UpdateSecurityReportSubscriptionResponse withReportCategory(String reportCategory) {
    ...
    public UpdateSecurityReportSubscriptionResponse withTopicUrn(String topicUrn) {
    ...
    public UpdateSecurityReportSubscriptionResponse withSubscriptionType(String subscriptionType) {
    ...
    public UpdateSecurityReportSubscriptionResponse withReportContentSubscription(
    ...
    public UpdateSecurityReportSubscriptionResponse withStatPeriod(
    ...
    public UpdateSecurityReportSubscriptionResponse withIsAllEnterpriseProject(Boolean isAllEnterpriseProject) {
    ...
    public UpdateSecurityReportSubscriptionResponse withEnterpriseProjectId(String enterpriseProjectId) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        UpdateSecurityReportSubscriptionResponse that = (UpdateSecurityReportSubscriptionResponse) obj;
    ...
    public String toString() {
        ...
        sb.append("class UpdateSecurityReportSubscriptionResponse {\n");
