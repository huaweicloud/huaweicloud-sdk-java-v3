...
public class ListThreatsRequest {
    ...
    public ListThreatsRequest withRecent(RecentEnum recent) {
        this.recent = recent;
        return this;
    }
    ...
    public ListThreatsRequest withFrom(Integer from) {
        this.from = from;
        return this;
    }
    ...
    public ListThreatsRequest withTo(Integer to) {
        this.to = to;
        return this;
    }
    ...
    public ListThreatsRequest withInstances(List<String> instances) {
        this.instances = instances;
        return this;
    }

    public ListThreatsRequest addInstancesItem(String instancesItem) {
    ...
    public ListThreatsRequest withInstances(Consumer<List<String>> instancesSetter) {
        if (this.instances == null) {
            this.instances = new ArrayList<>();
        }
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        return Objects.equals(this.recent, that.recent) && Objects.equals(this.from, that.from)
            && Objects.equals(this.to, that.to) && Objects.equals(this.hosts, that.hosts)
            && Objects.equals(this.instances, that.instances);
    }

    @Override
    public int hashCode() {
        return Objects.hash(recent, from, to, hosts, instances);
    }
