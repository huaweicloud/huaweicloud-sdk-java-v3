...
public class UpdatePremiumHostResponse extends SdkResponse {
    ...
    public UpdatePremiumHostResponse withLoadbalancerId(String loadbalancerId) {
    ...
    public UpdatePremiumHostResponse withListenerId(String listenerId) {
    ...
    public UpdatePremiumHostResponse withProtocolPort(Integer protocolPort) {
    ...
    public UpdatePremiumHostResponse withForwardHeaderMap(Map<String, String> forwardHeaderMap) {
        this.forwardHeaderMap = forwardHeaderMap;
        return this;
    }

    public UpdatePremiumHostResponse putForwardHeaderMapItem(String key, String forwardHeaderMapItem) {
    ...
    public UpdatePremiumHostResponse withForwardHeaderMap(Consumer<Map<String, String>> forwardHeaderMapSetter) {
        if (this.forwardHeaderMap == null) {
            this.forwardHeaderMap = new HashMap<>();
        }
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        UpdatePremiumHostResponse that = (UpdatePremiumHostResponse) obj;
        return Objects.equals(this.id, that.id) && Objects.equals(this.hostname, that.hostname)
            ...
            && Objects.equals(this.lbAlgorithm, that.lbAlgorithm) && Objects.equals(this.blockPage, that.blockPage)
