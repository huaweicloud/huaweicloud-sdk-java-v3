...
public class DeleteWhiteBlackIpRuleResponse extends SdkResponse {
    ...
    public DeleteWhiteBlackIpRuleResponse withTimeMode(String timeMode) {
    ...
    public DeleteWhiteBlackIpRuleResponse withStart(Long start) {
        this.start = start;
        return this;
    }
    ...
    public DeleteWhiteBlackIpRuleResponse withTerminal(Long terminal) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        DeleteWhiteBlackIpRuleResponse that = (DeleteWhiteBlackIpRuleResponse) obj;
    ...
    public int hashCode() {
        return Objects
            .hash(id, policyid, name, timestamp, description, status, addr, white, timeMode, start, terminal, ipGroup);
    }
