 ...
 * Request Object
 */
public class ListPrivacyPolicyRulesRequest {
    ...
    public ListPrivacyPolicyRulesRequest withProjectid(String projectid) {
    ...
    public ListPrivacyPolicyRulesRequest withPolicyids(String policyids) {
    ...
    public ListPrivacyPolicyRulesRequest withEnterpriseProjectId(String enterpriseProjectId) {
    ...
    public ListPrivacyPolicyRulesRequest withPage(Integer page) {
        this.page = page;
        return this;
    }
    ...
    public ListPrivacyPolicyRulesRequest withPagesize(Integer pagesize) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ListPrivacyPolicyRulesRequest that = (ListPrivacyPolicyRulesRequest) obj;
    ...
    public String toString() {
        ...
        sb.append("class ListPrivacyPolicyRulesRequest {\n");
