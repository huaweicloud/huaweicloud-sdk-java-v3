 ...
 * Response Object
 */
public class UpdateAnticrawlerRuleResponse extends SdkResponse {
    ...
    public UpdateAnticrawlerRuleResponse withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public UpdateAnticrawlerRuleResponse withPolicyid(String policyid) {
    ...
    public UpdateAnticrawlerRuleResponse withConditions(List<AnticrawlerCondition> conditions) {
        this.conditions = conditions;
        return this;
    }

    public UpdateAnticrawlerRuleResponse addConditionsItem(AnticrawlerCondition conditionsItem) {
    ...
    public UpdateAnticrawlerRuleResponse withConditions(Consumer<List<AnticrawlerCondition>> conditionsSetter) {
        if (this.conditions == null) {
            this.conditions = new ArrayList<>();
        }
    ...
    public UpdateAnticrawlerRuleResponse withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public UpdateAnticrawlerRuleResponse withType(TypeEnum type) {
        this.type = type;
        return this;
    }
    ...
    public UpdateAnticrawlerRuleResponse withTimestamp(Long timestamp) {
    ...
    public UpdateAnticrawlerRuleResponse withStatus(Integer status) {
        this.status = status;
        return this;
    }
    ...
    public UpdateAnticrawlerRuleResponse withPriority(Integer priority) {
    ...
    public String toString() {
        ...
        sb.append("class UpdateAnticrawlerRuleResponse {\n");
