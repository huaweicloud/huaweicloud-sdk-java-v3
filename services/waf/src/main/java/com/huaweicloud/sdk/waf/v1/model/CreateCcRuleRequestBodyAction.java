...
public class CreateCcRuleRequestBodyAction {
    ...
    public CreateCcRuleRequestBodyAction withCategory(CategoryEnum category) {
    ...
    public CreateCcRuleRequestBodyAction withDetail(CreateCcRuleRequestBodyActionDetail detail) {
        this.detail = detail;
        return this;
    }

    public CreateCcRuleRequestBodyAction withDetail(Consumer<CreateCcRuleRequestBodyActionDetail> detailSetter) {
        if (this.detail == null) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        CreateCcRuleRequestBodyAction that = (CreateCcRuleRequestBodyAction) obj;
