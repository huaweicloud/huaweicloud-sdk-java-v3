...
/**
 * BatchCreatePrivacyRuleRequestBody
 */
public class BatchCreatePrivacyRuleRequestBody {
    ...
    public BatchCreatePrivacyRuleRequestBody withUrl(String url) {
        this.url = url;
        return this;
    }
    ...
    public BatchCreatePrivacyRuleRequestBody withCategory(CategoryEnum category) {
    ...
    public BatchCreatePrivacyRuleRequestBody withIndex(String index) {
        this.index = index;
        return this;
    }
    ...
    public BatchCreatePrivacyRuleRequestBody withDescription(String description) {
    ...
    public BatchCreatePrivacyRuleRequestBody withPolicyIds(List<String> policyIds) {
        this.policyIds = policyIds;
        return this;
    }

    public BatchCreatePrivacyRuleRequestBody addPolicyIdsItem(String policyIdsItem) {
    ...
    public BatchCreatePrivacyRuleRequestBody withPolicyIds(Consumer<List<String>> policyIdsSetter) {
        if (this.policyIds == null) {
            this.policyIds = new ArrayList<>();
        }
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        BatchCreatePrivacyRuleRequestBody that = (BatchCreatePrivacyRuleRequestBody) obj;
    ...
    @Override
    public int hashCode() {
        return Objects.hash(url, category, index, description, policyIds);
    }

    @Override
    public String toString() {
        StringBuilder sb = new StringBuilder();
        sb.append("class BatchCreatePrivacyRuleRequestBody {\n");
