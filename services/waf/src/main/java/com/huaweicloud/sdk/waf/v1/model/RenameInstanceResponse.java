...
public class RenameInstanceResponse extends SdkResponse {
    ...
    public RenameInstanceResponse withStatus(StatusEnum status) {
        this.status = status;
        return this;
    }
    ...
    public RenameInstanceResponse withRunStatus(RunStatusEnum runStatus) {
    ...
    public RenameInstanceResponse withAccessStatus(AccessStatusEnum accessStatus) {
