...
public class ShowWebProtectionRuleRequest {
    ...
    public ShowWebProtectionRuleRequest withXLanguage(XLanguageEnum xLanguage) {
    ...
    public ShowWebProtectionRuleRequest withEnterpriseProjectId(String enterpriseProjectId) {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(xLanguage, enterpriseProjectId, ruleId);
    }
