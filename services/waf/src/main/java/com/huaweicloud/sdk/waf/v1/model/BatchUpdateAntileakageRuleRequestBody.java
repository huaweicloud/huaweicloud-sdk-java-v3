...
public class BatchUpdateAntileakageRuleRequestBody {
    ...
    public BatchUpdateAntileakageRuleRequestBody withAction(LeakageListInfoAction action) {
        this.action = action;
        return this;
    }

    public BatchUpdateAntileakageRuleRequestBody withAction(Consumer<LeakageListInfoAction> actionSetter) {
        if (this.action == null) {
