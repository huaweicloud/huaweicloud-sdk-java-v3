...
public class CreateAlertNoticeConfigRequest {
    ...
    private CreateAlertNoticeConfigBody body;
    ...
    public CreateAlertNoticeConfigRequest withBody(CreateAlertNoticeConfigBody body) {
        this.body = body;
        return this;
    }

    public CreateAlertNoticeConfigRequest withBody(Consumer<CreateAlertNoticeConfigBody> bodySetter) {
        if (this.body == null) {
            this.body = new CreateAlertNoticeConfigBody();
     ...
     * @return body
     */
    public CreateAlertNoticeConfigBody getBody() {
        return body;
    }

    public void setBody(CreateAlertNoticeConfigBody body) {
        this.body = body;
    }
