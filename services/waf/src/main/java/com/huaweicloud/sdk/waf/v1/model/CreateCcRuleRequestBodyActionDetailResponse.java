 ...
 * 返回页面
 */
public class CreateCcRuleRequestBodyActionDetailResponse {
    ...
    public CreateCcRuleRequestBodyActionDetailResponse withContentType(ContentTypeEnum contentType) {
    ...
    public CreateCcRuleRequestBodyActionDetailResponse withContent(String content) {
    ...
    public String toString() {
        ...
        sb.append("class CreateCcRuleRequestBodyActionDetailResponse {\n");
