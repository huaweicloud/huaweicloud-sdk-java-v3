...
public class UpdateCustomRuleResponse extends SdkResponse {
    ...
    public UpdateCustomRuleResponse withStart(Integer start) {
        this.start = start;
        return this;
    }
    ...
    public UpdateCustomRuleResponse withTerminal(Integer terminal) {
    ...
    public UpdateCustomRuleResponse withConditions(List<CustomConditions> conditions) {
        this.conditions = conditions;
        return this;
    }

    
    public UpdateCustomRuleResponse addConditionsItem(CustomConditions conditionsItem) {
    ...
    public UpdateCustomRuleResponse withConditions(Consumer<List<CustomConditions>> conditionsSetter) {
        if(this.conditions == null) {
            this.conditions = new ArrayList<>();
        }
