 ...
 */
public class UpdatePunishmentRuleRequestBody {
    ...
    public UpdatePunishmentRuleRequestBody withCategory(CategoryEnum category) {
    ...
    public UpdatePunishmentRuleRequestBody withBlockTime(Integer blockTime) {
    ...
    public UpdatePunishmentRuleRequestBody withDescription(String description) {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        UpdatePunishmentRuleRequestBody updatePunishmentRuleRequestBody = (UpdatePunishmentRuleRequestBody) o;
        return Objects.equals(this.category, updatePunishmentRuleRequestBody.category)
            && Objects.equals(this.blockTime, updatePunishmentRuleRequestBody.blockTime)
            && Objects.equals(this.description, updatePunishmentRuleRequestBody.description);
    }
    ...
    public String toString() {
        ...
        sb.append("class UpdatePunishmentRuleRequestBody {\n");
