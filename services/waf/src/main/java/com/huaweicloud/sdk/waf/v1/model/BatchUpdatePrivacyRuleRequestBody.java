...
public class BatchUpdatePrivacyRuleRequestBody {
    ...
    private List<BatchUpdatePrivacyRuleRequestBodyPolicyRuleIds> policyRuleIds = null;
    ...
    public BatchUpdatePrivacyRuleRequestBody withPolicyRuleIds(
        List<BatchUpdatePrivacyRuleRequestBodyPolicyRuleIds> policyRuleIds) {
        this.policyRuleIds = policyRuleIds;
        return this;
    }

    public BatchUpdatePrivacyRuleRequestBody addPolicyRuleIdsItem(
        BatchUpdatePrivacyRuleRequestBodyPolicyRuleIds policyRuleIdsItem) {
    ...
    public BatchUpdatePrivacyRuleRequestBody withPolicyRuleIds(
        Consumer<List<BatchUpdatePrivacyRuleRequestBodyPolicyRuleIds>> policyRuleIdsSetter) {
        if (this.policyRuleIds == null) {
            this.policyRuleIds = new ArrayList<>();
        }
     ...
     */
    public List<BatchUpdatePrivacyRuleRequestBodyPolicyRuleIds> getPolicyRuleIds() {
        return policyRuleIds;
    }

    public void setPolicyRuleIds(List<BatchUpdatePrivacyRuleRequestBodyPolicyRuleIds> policyRuleIds) {
        this.policyRuleIds = policyRuleIds;
    }
