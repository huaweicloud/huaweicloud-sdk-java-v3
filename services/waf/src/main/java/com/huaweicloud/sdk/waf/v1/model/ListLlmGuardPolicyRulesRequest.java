 ...
 * Request Object
 */
public class ListLlmGuardPolicyRulesRequest {
    ...
    public ListLlmGuardPolicyRulesRequest withProjectid(String projectid) {
    ...
    public ListLlmGuardPolicyRulesRequest withPolicyids(String policyids) {
    ...
    public ListLlmGuardPolicyRulesRequest withEnterpriseProjectId(String enterpriseProjectId) {
    ...
    public ListLlmGuardPolicyRulesRequest withPage(Integer page) {
        this.page = page;
        return this;
    }
    ...
    public ListLlmGuardPolicyRulesRequest withPagesize(Integer pagesize) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ListLlmGuardPolicyRulesRequest that = (ListLlmGuardPolicyRulesRequest) obj;
    ...
    public String toString() {
        ...
        sb.append("class ListLlmGuardPolicyRulesRequest {\n");
