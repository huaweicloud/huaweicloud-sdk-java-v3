...
public class BatchDeleteAlertNoticeConfigRequest {
    ...
    private BatchDeleteAlertNoticeConfigBody body;
    ...
    public BatchDeleteAlertNoticeConfigRequest withBody(BatchDeleteAlertNoticeConfigBody body) {
        this.body = body;
        return this;
    }

    public BatchDeleteAlertNoticeConfigRequest withBody(Consumer<BatchDeleteAlertNoticeConfigBody> bodySetter) {
        if (this.body == null) {
            this.body = new BatchDeleteAlertNoticeConfigBody();
     ...
     * @return body
     */
    public BatchDeleteAlertNoticeConfigBody getBody() {
        return body;
    }

    public void setBody(BatchDeleteAlertNoticeConfigBody body) {
        this.body = body;
    }
