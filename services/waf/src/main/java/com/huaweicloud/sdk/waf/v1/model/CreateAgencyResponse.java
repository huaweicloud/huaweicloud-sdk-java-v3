...
public class CreateAgencyResponse extends SdkResponse {
    ...
    public CreateAgencyResponse withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public CreateAgencyResponse withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public CreateAgencyResponse withVersion(String version) {
    ...
    public CreateAgencyResponse withDuration(String duration) {
    ...
    public CreateAgencyResponse withDomainId(String domainId) {
    ...
    public CreateAgencyResponse withIsValid(Boolean isValid) {
