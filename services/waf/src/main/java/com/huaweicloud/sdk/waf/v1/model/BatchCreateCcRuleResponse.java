 ...
 * Response Object
 */
public class BatchCreateCcRuleResponse extends SdkResponse {
    ...
    public BatchCreateCcRuleResponse withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public BatchCreateCcRuleResponse withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public BatchCreateCcRuleResponse withPolicyid(String policyid) {
    ...
    public BatchCreateCcRuleResponse withUrl(String url) {
        this.url = url;
        return this;
    }
    ...
    public BatchCreateCcRuleResponse withPrefix(Boolean prefix) {
        this.prefix = prefix;
        return this;
    }
    ...
    public BatchCreateCcRuleResponse withMode(Integer mode) {
        this.mode = mode;
        return this;
    }
    ...
    public BatchCreateCcRuleResponse withStatus(Integer status) {
        this.status = status;
        return this;
    }
    ...
    public BatchCreateCcRuleResponse withConditions(List<CcCondition> conditions) {
        this.conditions = conditions;
        return this;
    }

    public BatchCreateCcRuleResponse addConditionsItem(CcCondition conditionsItem) {
    ...
    public BatchCreateCcRuleResponse withConditions(Consumer<List<CcCondition>> conditionsSetter) {
        if (this.conditions == null) {
            this.conditions = new ArrayList<>();
        }
    ...
    public BatchCreateCcRuleResponse withAction(CcrulesListInfoAction action) {
        this.action = action;
        return this;
    }

    public BatchCreateCcRuleResponse withAction(Consumer<CcrulesListInfoAction> actionSetter) {
        if (this.action == null) {
    ...
    public BatchCreateCcRuleResponse withTagType(TagTypeEnum tagType) {
    ...
    public BatchCreateCcRuleResponse withTagIndex(String tagIndex) {
    ...
    public BatchCreateCcRuleResponse withTagCondition(CcrulesListInfoTagCondition tagCondition) {
        this.tagCondition = tagCondition;
        return this;
    }

    public BatchCreateCcRuleResponse withTagCondition(Consumer<CcrulesListInfoTagCondition> tagConditionSetter) {
    ...
    public BatchCreateCcRuleResponse withLimitNum(Integer limitNum) {
    ...
    public BatchCreateCcRuleResponse withLimitPeriod(Integer limitPeriod) {
    ...
    public BatchCreateCcRuleResponse withUnlockNum(Integer unlockNum) {
    ...
    public BatchCreateCcRuleResponse withLockTime(Integer lockTime) {
    ...
    public BatchCreateCcRuleResponse withDomainAggregation(Boolean domainAggregation) {
    ...
    public BatchCreateCcRuleResponse withRegionAggregation(Boolean regionAggregation) {
    ...
    public BatchCreateCcRuleResponse withDescription(String description) {
    ...
    public BatchCreateCcRuleResponse withTotalNum(Integer totalNum) {
    ...
    public BatchCreateCcRuleResponse withUnaggregation(Boolean unaggregation) {
    ...
    public BatchCreateCcRuleResponse withAgingTime(Integer agingTime) {
    ...
    public BatchCreateCcRuleResponse withProducer(Integer producer) {
    ...
    public BatchCreateCcRuleResponse withTimestamp(Long timestamp) {
    ...
    public BatchCreateCcRuleResponse withPriority(Integer priority) {
    ...
    public BatchCreateCcRuleResponse withCcPriority(Integer ccPriority) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        BatchCreateCcRuleResponse that = (BatchCreateCcRuleResponse) obj;
    ...
    public String toString() {
        ...
        sb.append("class BatchCreateCcRuleResponse {\n");
