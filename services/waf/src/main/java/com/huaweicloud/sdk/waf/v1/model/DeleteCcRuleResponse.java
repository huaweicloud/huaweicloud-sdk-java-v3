...
public class DeleteCcRuleResponse extends SdkResponse {
    ...
    public DeleteCcRuleResponse withAction(UpdateCcRuleResponseBodyAction action) {
        this.action = action;
        return this;
    }

    public DeleteCcRuleResponse withAction(Consumer<UpdateCcRuleResponseBodyAction> actionSetter) {
        if (this.action == null) {
    ...
    public DeleteCcRuleResponse withPriority(Integer priority) {
    ...
    public DeleteCcRuleResponse withCcPriority(Integer ccPriority) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        DeleteCcRuleResponse that = (DeleteCcRuleResponse) obj;
