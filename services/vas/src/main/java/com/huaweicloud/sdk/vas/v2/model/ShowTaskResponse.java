...
public class ShowTaskResponse extends SdkResponse {
    ...
    public ShowTaskResponse withTimingStatus(TimingStatusEnum timingStatus) {
    ...
    public ShowTaskResponse withTiming(TaskTiming timing) {
        this.timing = timing;
        return this;
    }

    public ShowTaskResponse withTiming(Consumer<TaskTiming> timingSetter) {
        if (this.timing == null) {
    ...
    public ShowTaskResponse withHostingResult(TaskHostingResultHostingResult hostingResult) {
        this.hostingResult = hostingResult;
        return this;
    }

    public ShowTaskResponse withHostingResult(Consumer<TaskHostingResultHostingResult> hostingResultSetter) {
