...
public class UpdateTaskResponse extends SdkResponse {
    ...
    @JacksonXmlProperty(localName = "service_title")
    ...
    @JacksonXmlProperty(localName = "timing_status")
    ...
    public UpdateTaskResponse withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public UpdateTaskResponse withCreator(String creator) {
    ...
    public UpdateTaskResponse withProjectId(String projectId) {
    ...
    public UpdateTaskResponse withDescription(String description) {
    ...
    public UpdateTaskResponse withServiceName(String serviceName) {
    ...
    public UpdateTaskResponse withServiceVersion(String serviceVersion) {
    ...
    public UpdateTaskResponse withServiceTitle(TaskDetailsServiceTitle serviceTitle) {
        this.serviceTitle = serviceTitle;
        return this;
    }

    public UpdateTaskResponse withServiceTitle(Consumer<TaskDetailsServiceTitle> serviceTitleSetter) {
    ...
    public UpdateTaskResponse withEdgePoolId(String edgePoolId) {
    ...
    public UpdateTaskResponse withResourceOrderId(String resourceOrderId) {
    ...
    public UpdateTaskResponse withCreatedAt(OffsetDateTime createdAt) {
    ...
    public UpdateTaskResponse withUpdatedAt(OffsetDateTime updatedAt) {
    ...
    public UpdateTaskResponse withState(StateEnum state) {
        this.state = state;
        return this;
    }
    ...
    public UpdateTaskResponse withStatus(String status) {
        this.status = status;
        return this;
    }
    ...
    public UpdateTaskResponse withError(TaskDetailsError error) {
        this.error = error;
        return this;
    }

    public UpdateTaskResponse withError(Consumer<TaskDetailsError> errorSetter) {
        if (this.error == null) {
    ...
    public UpdateTaskResponse withTimingStatus(TimingStatusEnum timingStatus) {
    ...
    public UpdateTaskResponse withTiming(TaskTiming timing) {
        this.timing = timing;
        return this;
    }

    public UpdateTaskResponse withTiming(Consumer<TaskTiming> timingSetter) {
        if (this.timing == null) {
    ...
    public UpdateTaskResponse withInput(TaskInput input) {
        this.input = input;
        return this;
    }

    public UpdateTaskResponse withInput(Consumer<TaskInput> inputSetter) {
        if (this.input == null) {
    ...
    public UpdateTaskResponse withOutput(TaskOutputForDisplay output) {
        this.output = output;
        return this;
    }

    public UpdateTaskResponse withOutput(Consumer<TaskOutputForDisplay> outputSetter) {
        if (this.output == null) {
    ...
    public UpdateTaskResponse withServiceConfig(TaskServiceConfig serviceConfig) {
        this.serviceConfig = serviceConfig;
        return this;
    }

    public UpdateTaskResponse withServiceConfig(Consumer<TaskServiceConfig> serviceConfigSetter) {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        return Objects.equals(this.id, updateTaskResponse.id) && Objects.equals(this.name, updateTaskResponse.name)
            && Objects.equals(this.creator, updateTaskResponse.creator)
            && Objects.equals(this.projectId, updateTaskResponse.projectId)
            && Objects.equals(this.description, updateTaskResponse.description)
            && Objects.equals(this.serviceName, updateTaskResponse.serviceName)
            && Objects.equals(this.serviceVersion, updateTaskResponse.serviceVersion)
            && Objects.equals(this.serviceTitle, updateTaskResponse.serviceTitle)
            && Objects.equals(this.edgePoolId, updateTaskResponse.edgePoolId)
            && Objects.equals(this.resourceOrderId, updateTaskResponse.resourceOrderId)
            && Objects.equals(this.createdAt, updateTaskResponse.createdAt)
            && Objects.equals(this.updatedAt, updateTaskResponse.updatedAt)
            && Objects.equals(this.state, updateTaskResponse.state)
            && Objects.equals(this.status, updateTaskResponse.status)
            && Objects.equals(this.error, updateTaskResponse.error)
            && Objects.equals(this.timingStatus, updateTaskResponse.timingStatus)
            && Objects.equals(this.timing, updateTaskResponse.timing)
            && Objects.equals(this.input, updateTaskResponse.input)
            && Objects.equals(this.output, updateTaskResponse.output)
            && Objects.equals(this.serviceConfig, updateTaskResponse.serviceConfig);
    }
