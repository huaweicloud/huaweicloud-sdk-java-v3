...
public class CreateTrainJobTagsRequest {
    ...
    public CreateTrainJobTagsRequest withTrainingJobId(String trainingJobId) {
    ...
    public CreateTrainJobTagsRequest withBody(CreateTmsTagsRequest body) {
        this.body = body;
        return this;
    }

    public CreateTrainJobTagsRequest withBody(Consumer<CreateTmsTagsRequest> bodySetter) {
        if (this.body == null) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        CreateTrainJobTagsRequest that = (CreateTrainJobTagsRequest) obj;
