...
public class ServerHyperinstanceResponse {
    ...
    public ServerHyperinstanceResponse withCreateAt(Long createAt) {
    ...
    public ServerHyperinstanceResponse withHpsClusterId(String hpsClusterId) {
    ...
    public ServerHyperinstanceResponse withHpsId(String hpsId) {
        this.hpsId = hpsId;
        return this;
    }
    ...
    public ServerHyperinstanceResponse withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public ServerHyperinstanceResponse withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public ServerHyperinstanceResponse withOrderId(String orderId) {
    ...
    public ServerHyperinstanceResponse withStatus(StatusEnum status) {
        this.status = status;
        return this;
    }
    ...
    public ServerHyperinstanceResponse withServers(List<ServerResponse> servers) {
        this.servers = servers;
        return this;
    }

    public ServerHyperinstanceResponse addServersItem(ServerResponse serversItem) {
    ...
    public ServerHyperinstanceResponse withServers(Consumer<List<ServerResponse>> serversSetter) {
        if (this.servers == null) {
            this.servers = new ArrayList<>();
        }
    ...
    public ServerHyperinstanceResponse withUpdateAt(Long updateAt) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ServerHyperinstanceResponse that = (ServerHyperinstanceResponse) obj;
