...
public class WorkflowParam {
    ...
    public WorkflowParam withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public WorkflowParam withDescription(String description) {
    ...
    public WorkflowParam withSteps(List<WorkflowStep> steps) {
        this.steps = steps;
        return this;
    }

    public WorkflowParam addStepsItem(WorkflowStep stepsItem) {
        if (this.steps == null) {
    ...
    public WorkflowParam withSteps(Consumer<List<WorkflowStep>> stepsSetter) {
        if (this.steps == null) {
            this.steps = new ArrayList<>();
        }
    ...
    public WorkflowParam withUserName(String userName) {
    ...
    public WorkflowParam withWorkspaceId(String workspaceId) {
    ...
    public WorkflowParam withDataRequirements(List<DataRequirement> dataRequirements) {
        this.dataRequirements = dataRequirements;
        return this;
    }

    public WorkflowParam addDataRequirementsItem(DataRequirement dataRequirementsItem) {
    ...
    public WorkflowParam withDataRequirements(Consumer<List<DataRequirement>> dataRequirementsSetter) {
        if (this.dataRequirements == null) {
            this.dataRequirements = new ArrayList<>();
        }
    ...
    public WorkflowParam withData(List<Data> data) {
        this.data = data;
        return this;
    }

    public WorkflowParam addDataItem(Data dataItem) {
        if (this.data == null) {
    ...
    public WorkflowParam withData(Consumer<List<Data>> dataSetter) {
        if (this.data == null) {
            this.data = new ArrayList<>();
        }
    ...
    public WorkflowParam withParameters(List<WorkflowParameter> parameters) {
        this.parameters = parameters;
        return this;
    }

    public WorkflowParam addParametersItem(WorkflowParameter parametersItem) {
    ...
    public WorkflowParam withParameters(Consumer<List<WorkflowParameter>> parametersSetter) {
        if (this.parameters == null) {
            this.parameters = new ArrayList<>();
        }
    ...
    public WorkflowParam withSourceWorkflowId(String sourceWorkflowId) {
    ...
    public WorkflowParam withGallerySubscription(WorkflowGallerySubscription gallerySubscription) {
        this.gallerySubscription = gallerySubscription;
        return this;
    }

    public WorkflowParam withGallerySubscription(Consumer<WorkflowGallerySubscription> gallerySubscriptionSetter) {
    ...
    public WorkflowParam withLatestExecution(ExecutionBrief latestExecution) {
        this.latestExecution = latestExecution;
        return this;
    }

    public WorkflowParam withLatestExecution(Consumer<ExecutionBrief> latestExecutionSetter) {
    ...
    public WorkflowParam withRunCount(Integer runCount) {
    ...
    public WorkflowParam withParamReady(Boolean paramReady) {
    ...
    public WorkflowParam withSource(String source) {
        this.source = source;
        return this;
    }
    ...
    public WorkflowParam withStorages(List<WorkflowStorage> storages) {
        this.storages = storages;
        return this;
    }

    public WorkflowParam addStoragesItem(WorkflowStorage storagesItem) {
    ...
    public WorkflowParam withStorages(Consumer<List<WorkflowStorage>> storagesSetter) {
        if (this.storages == null) {
            this.storages = new ArrayList<>();
        }
    ...
    public WorkflowParam withLabels(List<String> labels) {
        this.labels = labels;
        return this;
    }

    public WorkflowParam addLabelsItem(String labelsItem) {
        if (this.labels == null) {
    ...
    public WorkflowParam withLabels(Consumer<List<String>> labelsSetter) {
        if (this.labels == null) {
            this.labels = new ArrayList<>();
        }
    ...
    public WorkflowParam withAssets(List<WorkflowAsset> assets) {
        this.assets = assets;
        return this;
    }

    public WorkflowParam addAssetsItem(WorkflowAsset assetsItem) {
        if (this.assets == null) {
    ...
    public WorkflowParam withAssets(Consumer<List<WorkflowAsset>> assetsSetter) {
        if (this.assets == null) {
            this.assets = new ArrayList<>();
        }
    ...
    public WorkflowParam withSubGraphs(List<WorkflowSubgraph> subGraphs) {
        this.subGraphs = subGraphs;
        return this;
    }

    public WorkflowParam addSubGraphsItem(WorkflowSubgraph subGraphsItem) {
    ...
    public WorkflowParam withSubGraphs(Consumer<List<WorkflowSubgraph>> subGraphsSetter) {
        if (this.subGraphs == null) {
            this.subGraphs = new ArrayList<>();
        }
    ...
    public WorkflowParam withExtend(Map<String, Object> extend) {
        this.extend = extend;
        return this;
    }

    public WorkflowParam putExtendItem(String key, Object extendItem) {
        if (this.extend == null) {
    ...
    public WorkflowParam withExtend(Consumer<Map<String, Object>> extendSetter) {
        if (this.extend == null) {
            this.extend = new HashMap<>();
        }
    ...
    public WorkflowParam withPolicy(WorkflowPolicy policy) {
        this.policy = policy;
        return this;
    }

    public WorkflowParam withPolicy(Consumer<WorkflowPolicy> policySetter) {
        if (this.policy == null) {
    ...
    public WorkflowParam withWithSubscription(Boolean withSubscription) {
    ...
    public WorkflowParam withSmnSwitch(Boolean smnSwitch) {
    ...
    public WorkflowParam withSubscriptionId(String subscriptionId) {
    ...
    public WorkflowParam withExemlTemplateId(String exemlTemplateId) {
    ...
    public WorkflowParam withLastModifiedAt(String lastModifiedAt) {
    ...
    public WorkflowParam withPackage(WorkflowServicePackege _package) {
        this._package = _package;
        return this;
    }

    public WorkflowParam withPackage(Consumer<WorkflowServicePackege> _packageSetter) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        WorkflowParam that = (WorkflowParam) obj;
