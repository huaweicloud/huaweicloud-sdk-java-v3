...
public class PatchNodePoolAnnotations {
    ...
    public PatchNodePoolAnnotations withOsModelartsBillingMode(String osModelartsBillingMode) {
    ...
    public PatchNodePoolAnnotations withOsModelartsPeriodNum(String osModelartsPeriodNum) {
    ...
    public PatchNodePoolAnnotations withOsModelartsPeriodType(String osModelartsPeriodType) {
    ...
    public PatchNodePoolAnnotations withOsModelartsAutoRenew(String osModelartsAutoRenew) {
    ...
    public PatchNodePoolAnnotations withOsModelartsPromotionInfo(String osModelartsPromotionInfo) {
    ...
    public PatchNodePoolAnnotations withOsModelartsServiceConsoleUrl(String osModelartsServiceConsoleUrl) {
    ...
    public PatchNodePoolAnnotations withOsModelartsOrderId(String osModelartsOrderId) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        PatchNodePoolAnnotations that = (PatchNodePoolAnnotations) obj;
