 ...
 * Response Object
 */
public class DetachDynamicStorageResponse extends SdkResponse {
    ...
    public DetachDynamicStorageResponse withCategory(CategoryEnum category) {
    ...
    public DetachDynamicStorageResponse withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public DetachDynamicStorageResponse withMountPath(String mountPath) {
    ...
    public DetachDynamicStorageResponse withStatus(String status) {
        this.status = status;
        return this;
    }
    ...
    public DetachDynamicStorageResponse withUri(String uri) {
        this.uri = uri;
        return this;
    }
    ...
    public DetachDynamicStorageResponse withFailureReason(String failureReason) {
    ...
    public DetachDynamicStorageResponse withEfsId(String efsId) {
        this.efsId = efsId;
        return this;
    }
    ...
    public DetachDynamicStorageResponse withMountType(String mountType) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        DetachDynamicStorageResponse that = (DetachDynamicStorageResponse) obj;
    ...
    public String toString() {
        ...
        sb.append("class DetachDynamicStorageResponse {\n");
