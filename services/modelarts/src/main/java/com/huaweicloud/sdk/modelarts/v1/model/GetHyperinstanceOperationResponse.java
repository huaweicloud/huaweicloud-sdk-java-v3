 ...
 * Response Object
 */
public class GetHyperinstanceOperationResponse extends SdkResponse {
    ...
    public GetHyperinstanceOperationResponse withOperationId(String operationId) {
    ...
    public GetHyperinstanceOperationResponse withOperationStatus(String operationStatus) {
    ...
    public GetHyperinstanceOperationResponse withOperationType(String operationType) {
    ...
    public GetHyperinstanceOperationResponse withOperationError(ServerOperationError operationError) {
        this.operationError = operationError;
        return this;
    }

    public GetHyperinstanceOperationResponse withOperationError(Consumer<ServerOperationError> operationErrorSetter) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        GetHyperinstanceOperationResponse that = (GetHyperinstanceOperationResponse) obj;
    ...
    public String toString() {
        ...
        sb.append("class GetHyperinstanceOperationResponse {\n");
