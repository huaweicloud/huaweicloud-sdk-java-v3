 ...
 * **参数解释**：日志诊断作业信息。
 */
public class LogDiagnosisJobInfo {
    ...
    public LogDiagnosisJobInfo withCreateTime(OffsetDateTime createTime) {
    ...
    public LogDiagnosisJobInfo withCreator(String creator) {
    ...
    public LogDiagnosisJobInfo withDescription(String description) {
    ...
    public LogDiagnosisJobInfo withDiagnosisConclusion(ResultStatus diagnosisConclusion) {
    ...
    public LogDiagnosisJobInfo withDiagnosisTime(Long diagnosisTime) {
    ...
    public LogDiagnosisJobInfo withEstimatedTime(Integer estimatedTime) {
    ...
    public LogDiagnosisJobInfo withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public LogDiagnosisJobInfo withJobStatus(LogJobStatus jobStatus) {
    ...
    public LogDiagnosisJobInfo withMessage(String message) {
    ...
    public LogDiagnosisJobInfo withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public LogDiagnosisJobInfo withUpdateTime(OffsetDateTime updateTime) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        LogDiagnosisJobInfo that = (LogDiagnosisJobInfo) obj;
    ...
    public String toString() {
        ...
        sb.append("class LogDiagnosisJobInfo {\n");
