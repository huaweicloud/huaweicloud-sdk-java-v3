...
public class ShowPoolResponse extends SdkResponse {
    ...
    public ShowPoolResponse withApiVersion(String apiVersion) {
    ...
    public ShowPoolResponse withKind(String kind) {
        this.kind = kind;
        return this;
    }
    ...
    public ShowPoolResponse withMetadata(PoolMetadata metadata) {
        this.metadata = metadata;
        return this;
    }

    public ShowPoolResponse withMetadata(Consumer<PoolMetadata> metadataSetter) {
    ...
    public ShowPoolResponse withSpec(PoolSpecModel spec) {
        this.spec = spec;
        return this;
    }

    public ShowPoolResponse withSpec(Consumer<PoolSpecModel> specSetter) {
        if (this.spec == null) {
    ...
    public ShowPoolResponse withStatus(PoolStatus status) {
        this.status = status;
        return this;
    }

    public ShowPoolResponse withStatus(Consumer<PoolStatus> statusSetter) {
        if (this.status == null) {
