 ...
 * Response Object
 */
public class ChangeHyperinstanceOSResponse extends SdkResponse {
    ...
    public ChangeHyperinstanceOSResponse withCreateAt(Long createAt) {
    ...
    public ChangeHyperinstanceOSResponse withHpsClusterId(String hpsClusterId) {
    ...
    public ChangeHyperinstanceOSResponse withHpsId(String hpsId) {
        this.hpsId = hpsId;
        return this;
    }
    ...
    public ChangeHyperinstanceOSResponse withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public ChangeHyperinstanceOSResponse withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public ChangeHyperinstanceOSResponse withOrderId(String orderId) {
    ...
    public ChangeHyperinstanceOSResponse withStatus(StatusEnum status) {
        this.status = status;
        return this;
    }
    ...
    public ChangeHyperinstanceOSResponse withServers(List<ServerResponse> servers) {
        this.servers = servers;
        return this;
    }

    public ChangeHyperinstanceOSResponse addServersItem(ServerResponse serversItem) {
    ...
    public ChangeHyperinstanceOSResponse withServers(Consumer<List<ServerResponse>> serversSetter) {
        if (this.servers == null) {
            this.servers = new ArrayList<>();
        }
    ...
    public ChangeHyperinstanceOSResponse withUpdateAt(Long updateAt) {
    ...
    public ChangeHyperinstanceOSResponse withXRequestId(String xRequestId) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ChangeHyperinstanceOSResponse that = (ChangeHyperinstanceOSResponse) obj;
    ...
    public String toString() {
        ...
        sb.append("class ChangeHyperinstanceOSResponse {\n");
