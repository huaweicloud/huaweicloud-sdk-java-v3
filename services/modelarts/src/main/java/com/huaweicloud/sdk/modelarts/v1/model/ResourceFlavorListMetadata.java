 ...
 * **参数解释**：资源规格列表的元信息。
 */
public class ResourceFlavorListMetadata {
    ...
    public ResourceFlavorListMetadata withContinue(String _continue) {
    ...
    public ResourceFlavorListMetadata withRemainingItemCount(Integer remainingItemCount) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ResourceFlavorListMetadata that = (ResourceFlavorListMetadata) obj;
    ...
    public String toString() {
        ...
        sb.append("class ResourceFlavorListMetadata {\n");
