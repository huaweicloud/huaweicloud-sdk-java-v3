...
public class ReqInspectionItemConfig {
    ...
    public ReqInspectionItemConfig withExternalParam(InspectionItemExternalParam externalParam) {
        this.externalParam = externalParam;
        return this;
    }

    public ReqInspectionItemConfig withExternalParam(Consumer<InspectionItemExternalParam> externalParamSetter) {
