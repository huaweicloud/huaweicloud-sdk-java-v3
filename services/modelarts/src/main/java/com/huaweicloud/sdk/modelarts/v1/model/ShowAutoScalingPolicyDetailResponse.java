 ...
 * Response Object
 */
public class ShowAutoScalingPolicyDetailResponse extends SdkResponse {
    ...
    public ShowAutoScalingPolicyDetailResponse withWorkspaceId(String workspaceId) {
    ...
    public ShowAutoScalingPolicyDetailResponse withPolicyName(String policyName) {
    ...
    public ShowAutoScalingPolicyDetailResponse withPolicyId(String policyId) {
    ...
    public ShowAutoScalingPolicyDetailResponse withPolicyType(PolicyTypeEnum policyType) {
    ...
    public ShowAutoScalingPolicyDetailResponse withCreatedAt(String createdAt) {
    ...
    public ShowAutoScalingPolicyDetailResponse withUpdatedAt(String updatedAt) {
    ...
    public ShowAutoScalingPolicyDetailResponse withRules(List<AutoScalingRuleRsp> rules) {
        this.rules = rules;
        return this;
    }

    public ShowAutoScalingPolicyDetailResponse addRulesItem(AutoScalingRuleRsp rulesItem) {
        if (this.rules == null) {
    ...
    public ShowAutoScalingPolicyDetailResponse withRules(Consumer<List<AutoScalingRuleRsp>> rulesSetter) {
        if (this.rules == null) {
            this.rules = new ArrayList<>();
        }
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ShowAutoScalingPolicyDetailResponse that = (ShowAutoScalingPolicyDetailResponse) obj;
    ...
    public String toString() {
        ...
        sb.append("class ShowAutoScalingPolicyDetailResponse {\n");
