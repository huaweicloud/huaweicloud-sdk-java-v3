...
public class WorkflowServicePackage {
    ...
    public WorkflowServicePackage withStatus(String status) {
        this.status = status;
        return this;
    }
    ...
    public WorkflowServicePackage withPoolId(String poolId) {
        this.poolId = poolId;
        return this;
    }
    ...
    public WorkflowServicePackage withServiceId(String serviceId) {
    ...
    public WorkflowServicePackage withWorkflowId(String workflowId) {
    ...
    public WorkflowServicePackage withOrder(WorkflowPoolOrder order) {
        this.order = order;
        return this;
    }

    public WorkflowServicePackage withOrder(Consumer<WorkflowPoolOrder> orderSetter) {
        if (this.order == null) {
    ...
    public WorkflowServicePackage withConsumeLimit(Integer consumeLimit) {
    ...
    public WorkflowServicePackage withCurrentConsume(Integer currentConsume) {
    ...
    public WorkflowServicePackage withCurrentDate(String currentDate) {
    ...
    public WorkflowServicePackage withLimitEnable(Boolean limitEnable) {
    ...
    public WorkflowServicePackage withCreatedAt(String createdAt) {
    ...
    public WorkflowServicePackage withPackageId(String packageId) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        WorkflowServicePackage that = (WorkflowServicePackage) obj;
