 ...
 * Response Object
 */
public class RebootDevServerResponse extends SdkResponse {
    ...
    public RebootDevServerResponse withCreateAt(Long createAt) {
    ...
    public RebootDevServerResponse withUpdateAt(Long updateAt) {
    ...
    public RebootDevServerResponse withChargingMode(ChargingModeEnum chargingMode) {
    ...
    public RebootDevServerResponse withCloudServer(CloudServer cloudServer) {
        this.cloudServer = cloudServer;
        return this;
    }

    public RebootDevServerResponse withCloudServer(Consumer<CloudServer> cloudServerSetter) {
    ...
    public RebootDevServerResponse withEndpointsResponse(List<Endpoints> endpointsResponse) {
        this.endpointsResponse = endpointsResponse;
        return this;
    }

    public RebootDevServerResponse addEndpointsResponseItem(Endpoints endpointsResponseItem) {
    ...
    public RebootDevServerResponse withEndpointsResponse(Consumer<List<Endpoints>> endpointsResponseSetter) {
        if (this.endpointsResponse == null) {
            this.endpointsResponse = new ArrayList<>();
        }
    ...
    public RebootDevServerResponse withFlavor(String flavor) {
        this.flavor = flavor;
        return this;
    }
    ...
    public RebootDevServerResponse withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public RebootDevServerResponse withKeyPairName(String keyPairName) {
    ...
    public RebootDevServerResponse withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public RebootDevServerResponse withOrderId(String orderId) {
    ...
    public RebootDevServerResponse withStatus(StatusEnum status) {
        this.status = status;
        return this;
    }
    ...
    public RebootDevServerResponse withVpcId(String vpcId) {
        this.vpcId = vpcId;
        return this;
    }
    ...
    public RebootDevServerResponse withEndpoints(List<EndpointsRes> endpoints) {
        this.endpoints = endpoints;
        return this;
    }

    public RebootDevServerResponse addEndpointsItem(EndpointsRes endpointsItem) {
    ...
    public RebootDevServerResponse withEndpoints(Consumer<List<EndpointsRes>> endpointsSetter) {
        if (this.endpoints == null) {
            this.endpoints = new ArrayList<>();
        }
    ...
    public RebootDevServerResponse withVolumes(List<ServerVolume> volumes) {
        this.volumes = volumes;
        return this;
    }

    public RebootDevServerResponse addVolumesItem(ServerVolume volumesItem) {
    ...
    public RebootDevServerResponse withVolumes(Consumer<List<ServerVolume>> volumesSetter) {
        if (this.volumes == null) {
            this.volumes = new ArrayList<>();
        }
    ...
    public RebootDevServerResponse withImage(ServerImageResponse image) {
        this.image = image;
        return this;
    }

    public RebootDevServerResponse withImage(Consumer<ServerImageResponse> imageSetter) {
        if (this.image == null) {
    ...
    public RebootDevServerResponse withCategory(CategoryEnum category) {
    ...
    public RebootDevServerResponse withServerHps(ServerHpsInfo serverHps) {
        this.serverHps = serverHps;
        return this;
    }

    public RebootDevServerResponse withServerHps(Consumer<ServerHpsInfo> serverHpsSetter) {
    ...
    public RebootDevServerResponse withSubnetId(String subnetId) {
    ...
    public RebootDevServerResponse withXRequestId(String xRequestId) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        RebootDevServerResponse that = (RebootDevServerResponse) obj;
