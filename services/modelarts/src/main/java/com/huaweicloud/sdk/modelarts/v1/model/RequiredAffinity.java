...
public class RequiredAffinity {
    ...
    private NodeSelector nodeAffinity;

    public RequiredAffinity withAffinityType(String affinityType) {
    ...
    public RequiredAffinity withJobLevel(String jobLevel) {
    ...
    public RequiredAffinity withAffinityGroupSize(Integer affinityGroupSize) {
    ...
    public RequiredAffinity withAffinityGroupLevel(String affinityGroupLevel) {
    ...
    public RequiredAffinity withNodeAffinity(NodeSelector nodeAffinity) {
        this.nodeAffinity = nodeAffinity;
        return this;
    }

    public RequiredAffinity withNodeAffinity(Consumer<NodeSelector> nodeAffinitySetter) {
        if (this.nodeAffinity == null) {
            this.nodeAffinity = new NodeSelector();
     ...
     * @return nodeAffinity
     */
    public NodeSelector getNodeAffinity() {
        return nodeAffinity;
    }

    public void setNodeAffinity(NodeSelector nodeAffinity) {
        this.nodeAffinity = nodeAffinity;
    }
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        RequiredAffinity that = (RequiredAffinity) obj;
        return Objects.equals(this.affinityType, that.affinityType) && Objects.equals(this.jobLevel, that.jobLevel)
            ...
            && Objects.equals(this.nodeAffinity, that.nodeAffinity);
    }

    @Override
    public int hashCode() {
        return Objects.hash(affinityType, jobLevel, affinityGroupSize, affinityGroupLevel, nodeAffinity);
    }
