...
public class FileInfo {
    ...
    public FileInfo withSource(String source) {
        this.source = source;
        return this;
    }
    ...
    public FileInfo withAddress(String address) {
    ...
    public FileInfo withMountPath(String mountPath) {
    ...
    public FileInfo withHostCache(Boolean hostCache) {
    ...
    public FileInfo withEfsSubPath(String efsSubPath) {
    ...
    public FileInfo withReadOnly(Boolean readOnly) {
    ...
    public FileInfo withOsWarmUp(Boolean osWarmUp) {
    ...
    public FileInfo withSourceName(String sourceName) {
