...
public class Health {
    ...
    public Health withCheckMethod(String checkMethod) {
    ...
    public Health withCmd(String cmd) {
        this.cmd = cmd;
        return this;
    }
    ...
    public Health withUrl(String url) {
        this.url = url;
        return this;
    }
    ...
    public Health withProtocol(String protocol) {
    ...
    public Health withInitialDelaySeconds(Integer initialDelaySeconds) {
    ...
    public Health withTimeoutSeconds(Integer timeoutSeconds) {
    ...
    public Health withPeriodSeconds(Integer periodSeconds) {
    ...
    public Health withFailureThreshold(Integer failureThreshold) {
