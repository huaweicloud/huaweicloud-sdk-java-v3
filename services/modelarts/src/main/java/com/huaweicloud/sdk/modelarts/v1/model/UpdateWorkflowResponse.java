...
public class UpdateWorkflowResponse extends SdkResponse {
    ...
    public UpdateWorkflowResponse withWorkflowId(String workflowId) {
    ...
    public UpdateWorkflowResponse withCreatedAt(String createdAt) {
    ...
    public UpdateWorkflowResponse withSteps(List<WorkflowStep> steps) {
        this.steps = steps;
        return this;
    }

    public UpdateWorkflowResponse addStepsItem(WorkflowStep stepsItem) {
        if (this.steps == null) {
    ...
    public UpdateWorkflowResponse withSteps(Consumer<List<WorkflowStep>> stepsSetter) {
        if (this.steps == null) {
            this.steps = new ArrayList<>();
        }
    ...
    public UpdateWorkflowResponse withUserName(String userName) {
    ...
    public UpdateWorkflowResponse withWorkspaceId(String workspaceId) {
    ...
    public UpdateWorkflowResponse withDataRequirements(List<DataRequirement> dataRequirements) {
        this.dataRequirements = dataRequirements;
        return this;
    }

    public UpdateWorkflowResponse addDataRequirementsItem(DataRequirement dataRequirementsItem) {
    ...
    public UpdateWorkflowResponse withDataRequirements(Consumer<List<DataRequirement>> dataRequirementsSetter) {
        if (this.dataRequirements == null) {
            this.dataRequirements = new ArrayList<>();
        }
    ...
    public UpdateWorkflowResponse withData(List<Data> data) {
        this.data = data;
        return this;
    }

    public UpdateWorkflowResponse addDataItem(Data dataItem) {
        if (this.data == null) {
    ...
    public UpdateWorkflowResponse withData(Consumer<List<Data>> dataSetter) {
        if (this.data == null) {
            this.data = new ArrayList<>();
        }
    ...
    public UpdateWorkflowResponse withParameters(List<WorkflowParameter> parameters) {
        this.parameters = parameters;
        return this;
    }

    public UpdateWorkflowResponse addParametersItem(WorkflowParameter parametersItem) {
    ...
    public UpdateWorkflowResponse withParameters(Consumer<List<WorkflowParameter>> parametersSetter) {
        if (this.parameters == null) {
            this.parameters = new ArrayList<>();
        }
    ...
    public UpdateWorkflowResponse withSourceWorkflowId(String sourceWorkflowId) {
    ...
    public UpdateWorkflowResponse withGallerySubscription(WorkflowGallerySubscription gallerySubscription) {
        this.gallerySubscription = gallerySubscription;
        return this;
    }

    public UpdateWorkflowResponse withGallerySubscription(
    ...
    public UpdateWorkflowResponse withLatestExecution(ExecutionBrief latestExecution) {
        this.latestExecution = latestExecution;
        return this;
    }

    public UpdateWorkflowResponse withLatestExecution(Consumer<ExecutionBrief> latestExecutionSetter) {
    ...
    public UpdateWorkflowResponse withRunCount(Integer runCount) {
    ...
    public UpdateWorkflowResponse withParamReady(Boolean paramReady) {
    ...
    public UpdateWorkflowResponse withSource(String source) {
        this.source = source;
        return this;
    }
    ...
    public UpdateWorkflowResponse withStorages(List<WorkflowStorage> storages) {
        this.storages = storages;
        return this;
    }

    public UpdateWorkflowResponse addStoragesItem(WorkflowStorage storagesItem) {
    ...
    public UpdateWorkflowResponse withStorages(Consumer<List<WorkflowStorage>> storagesSetter) {
        if (this.storages == null) {
            this.storages = new ArrayList<>();
        }
    ...
    public UpdateWorkflowResponse withLabels(List<String> labels) {
        this.labels = labels;
        return this;
    }

    public UpdateWorkflowResponse addLabelsItem(String labelsItem) {
        if (this.labels == null) {
    ...
    public UpdateWorkflowResponse withLabels(Consumer<List<String>> labelsSetter) {
        if (this.labels == null) {
            this.labels = new ArrayList<>();
        }
    ...
    public UpdateWorkflowResponse withAssets(List<WorkflowAsset> assets) {
        this.assets = assets;
        return this;
    }

    public UpdateWorkflowResponse addAssetsItem(WorkflowAsset assetsItem) {
        if (this.assets == null) {
    ...
    public UpdateWorkflowResponse withAssets(Consumer<List<WorkflowAsset>> assetsSetter) {
        if (this.assets == null) {
            this.assets = new ArrayList<>();
        }
    ...
    public UpdateWorkflowResponse withSubGraphs(List<WorkflowSubgraph> subGraphs) {
        this.subGraphs = subGraphs;
        return this;
    }

    public UpdateWorkflowResponse addSubGraphsItem(WorkflowSubgraph subGraphsItem) {
    ...
    public UpdateWorkflowResponse withSubGraphs(Consumer<List<WorkflowSubgraph>> subGraphsSetter) {
        if (this.subGraphs == null) {
            this.subGraphs = new ArrayList<>();
        }
    ...
    public UpdateWorkflowResponse withExtend(Map<String, Object> extend) {
        this.extend = extend;
        return this;
    }

    public UpdateWorkflowResponse putExtendItem(String key, Object extendItem) {
        if (this.extend == null) {
    ...
    public UpdateWorkflowResponse withExtend(Consumer<Map<String, Object>> extendSetter) {
        if (this.extend == null) {
            this.extend = new HashMap<>();
        }
    ...
    public UpdateWorkflowResponse withPolicy(WorkflowPolicy policy) {
        this.policy = policy;
        return this;
    }

    public UpdateWorkflowResponse withPolicy(Consumer<WorkflowPolicy> policySetter) {
        if (this.policy == null) {
    ...
    public UpdateWorkflowResponse withWithSubscription(Boolean withSubscription) {
    ...
    public UpdateWorkflowResponse withSmnSwitch(Boolean smnSwitch) {
    ...
    public UpdateWorkflowResponse withSubscriptionId(String subscriptionId) {
    ...
    public UpdateWorkflowResponse withExemlTemplateId(String exemlTemplateId) {
    ...
    public UpdateWorkflowResponse withLastModifiedAt(String lastModifiedAt) {
    ...
    public UpdateWorkflowResponse withPackage(WorkflowServicePackege _package) {
        this._package = _package;
        return this;
    }

    public UpdateWorkflowResponse withPackage(Consumer<WorkflowServicePackege> _packageSetter) {
