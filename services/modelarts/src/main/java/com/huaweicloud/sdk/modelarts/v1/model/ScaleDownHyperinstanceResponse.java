 ...
 * Response Object
 */
public class ScaleDownHyperinstanceResponse extends SdkResponse {
    ...
    public ScaleDownHyperinstanceResponse withCreateAt(Long createAt) {
    ...
    public ScaleDownHyperinstanceResponse withHpsClusterId(String hpsClusterId) {
    ...
    public ScaleDownHyperinstanceResponse withHpsId(String hpsId) {
        this.hpsId = hpsId;
        return this;
    }
    ...
    public ScaleDownHyperinstanceResponse withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public ScaleDownHyperinstanceResponse withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public ScaleDownHyperinstanceResponse withOrderId(String orderId) {
    ...
    public ScaleDownHyperinstanceResponse withStatus(StatusEnum status) {
        this.status = status;
        return this;
    }
    ...
    public ScaleDownHyperinstanceResponse withServers(List<ServerResponse> servers) {
        this.servers = servers;
        return this;
    }

    public ScaleDownHyperinstanceResponse addServersItem(ServerResponse serversItem) {
    ...
    public ScaleDownHyperinstanceResponse withServers(Consumer<List<ServerResponse>> serversSetter) {
        if (this.servers == null) {
            this.servers = new ArrayList<>();
        }
    ...
    public ScaleDownHyperinstanceResponse withUpdateAt(Long updateAt) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ScaleDownHyperinstanceResponse that = (ScaleDownHyperinstanceResponse) obj;
    ...
    @Override
    public int hashCode() {
        return Objects.hash(createAt, hpsClusterId, hpsId, id, name, orderId, status, servers, updateAt);
    }

    @Override
    public String toString() {
        StringBuilder sb = new StringBuilder();
        sb.append("class ScaleDownHyperinstanceResponse {\n");
