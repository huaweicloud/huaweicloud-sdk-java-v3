...
public class AuthorizationRequest {
    ...
    public AuthorizationRequest withUserId(String userId) {
        this.userId = userId;
        return this;
    }
    ...
    public AuthorizationRequest withType(TypeEnum type) {
        this.type = type;
        return this;
    }
    ...
    public AuthorizationRequest withContent(String content) {
    ...
    public AuthorizationRequest withSecretKey(String secretKey) {
    ...
    public AuthorizationRequest withUserType(String userType) {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(userId, type, content, secretKey, userName, userType);
    }
