...
public class Image {
    ...
    public Image withArch(ArchEnum arch) {
        this.arch = arch;
        return this;
    }
    ...
    public Image withCreateAt(Long createAt) {
    ...
    public Image withDevServices(List<DevServicesEnum> devServices) {
        this.devServices = devServices;
        return this;
    }

    public Image addDevServicesItem(DevServicesEnum devServicesItem) {
    ...
    public Image withDevServices(Consumer<List<DevServicesEnum>> devServicesSetter) {
        if (this.devServices == null) {
            this.devServices = new ArrayList<>();
        }
    ...
    public Image withNamespace(String namespace) {
    ...
    public Image withOrigin(OriginEnum origin) {
        this.origin = origin;
        return this;
    }
    ...
    public Image withResourceCategories(List<ResourceCategoriesEnum> resourceCategories) {
        this.resourceCategories = resourceCategories;
        return this;
    }

    public Image addResourceCategoriesItem(ResourceCategoriesEnum resourceCategoriesItem) {
    ...
    public Image withResourceCategories(Consumer<List<ResourceCategoriesEnum>> resourceCategoriesSetter) {
        if (this.resourceCategories == null) {
            this.resourceCategories = new ArrayList<>();
        }
    ...
    public Image withServiceType(ServiceTypeEnum serviceType) {
    ...
    public Image withStatus(StatusEnum status) {
        this.status = status;
        return this;
    }
    ...
    public Image withStatusMessage(String statusMessage) {
    ...
    public Image withSupportResCategories(List<SupportResCategoriesEnum> supportResCategories) {
        this.supportResCategories = supportResCategories;
        return this;
    }

    public Image addSupportResCategoriesItem(SupportResCategoriesEnum supportResCategoriesItem) {
    ...
    public Image withSupportResCategories(Consumer<List<SupportResCategoriesEnum>> supportResCategoriesSetter) {
        if (this.supportResCategories == null) {
            this.supportResCategories = new ArrayList<>();
        }
    ...
    public Image withSwrPath(String swrPath) {
    ...
    public Image withType(TypeEnum type) {
        this.type = type;
        return this;
    }
    ...
    public Image withUpdateAt(Long updateAt) {
    ...
    public Image withVisibility(VisibilityEnum visibility) {
    ...
    public Image withWorkspaceId(String workspaceId) {
    ...
    public Image withFlavorType(String flavorType) {
    ...
    public Image withSwrInstanceId(String swrInstanceId) {
    ...
    public Image withShowName(String showName) {
    ...
    public Image withShowTag(String showTag) {
    ...
    public Image withTags(List<TmsTagResponse> tags) {
        this.tags = tags;
        return this;
    }

    public Image addTagsItem(TmsTagResponse tagsItem) {
        if (this.tags == null) {
    ...
    public Image withTags(Consumer<List<TmsTagResponse>> tagsSetter) {
        if (this.tags == null) {
            this.tags = new ArrayList<>();
        }
