...
public class TaskAlgorithmEngine {
    ...
    public TaskAlgorithmEngine withEngineId(String engineId) {
    ...
    public TaskAlgorithmEngine withEngineName(String engineName) {
    ...
    public TaskAlgorithmEngine withEngineVersion(String engineVersion) {
    ...
    public TaskAlgorithmEngine withImageUrl(String imageUrl) {
    ...
    public TaskAlgorithmEngine withRunUser(String runUser) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        TaskAlgorithmEngine that = (TaskAlgorithmEngine) obj;
