 ...
 * Request Object
 */
public class ListProfilingDiagnosisJobsRequest {
    ...
    /**
     * **参数解释**：作业状态。 **约束限制**：不涉及。 **取值范围**：   - CREATING：创建中   - CREATE_FAILED: 创建失败   - PENDING：排队中   - RUNNING：运行中   - FAILED：作业失败   - SUCCEEDED：作业成功   - TIMEOUT：作业超时 **默认取值**：不涉及。 
     */
    ...
    public ListProfilingDiagnosisJobsRequest withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public ListProfilingDiagnosisJobsRequest withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public ListProfilingDiagnosisJobsRequest withOffset(Integer offset) {
        this.offset = offset;
        return this;
    }
    ...
    public ListProfilingDiagnosisJobsRequest withLimit(Integer limit) {
        this.limit = limit;
        return this;
    }
    ...
    public ListProfilingDiagnosisJobsRequest withStatus(StatusEnum status) {
        this.status = status;
        return this;
    }
    ...
    public ListProfilingDiagnosisJobsRequest withResultStatus(ResultStatusEnum resultStatus) {
    ...
    public ListProfilingDiagnosisJobsRequest withCreator(String creator) {
    ...
    public ListProfilingDiagnosisJobsRequest withCreateStartTime(String createStartTime) {
    ...
    public ListProfilingDiagnosisJobsRequest withCreateEndTime(String createEndTime) {
    ...
    public ListProfilingDiagnosisJobsRequest withUpdateStartTime(String updateStartTime) {
    ...
    public ListProfilingDiagnosisJobsRequest withUpdateEndTime(String updateEndTime) {
    ...
    public ListProfilingDiagnosisJobsRequest withWorkspaceId(String workspaceId) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ListProfilingDiagnosisJobsRequest that = (ListProfilingDiagnosisJobsRequest) obj;
    ...
    public String toString() {
        ...
        sb.append("class ListProfilingDiagnosisJobsRequest {\n");
