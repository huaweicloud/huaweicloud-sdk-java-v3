...
public class ShowWorkflowResponse extends SdkResponse {
    ...
    public ShowWorkflowResponse withWorkflowId(String workflowId) {
    ...
    public ShowWorkflowResponse withCreatedAt(String createdAt) {
    ...
    public ShowWorkflowResponse withSteps(List<WorkflowStep> steps) {
        this.steps = steps;
        return this;
    }

    public ShowWorkflowResponse addStepsItem(WorkflowStep stepsItem) {
        if (this.steps == null) {
    ...
    public ShowWorkflowResponse withSteps(Consumer<List<WorkflowStep>> stepsSetter) {
        if (this.steps == null) {
            this.steps = new ArrayList<>();
        }
    ...
    public ShowWorkflowResponse withWorkspaceId(String workspaceId) {
    ...
    public ShowWorkflowResponse withDataRequirements(List<DataRequirement> dataRequirements) {
        this.dataRequirements = dataRequirements;
        return this;
    }

    public ShowWorkflowResponse addDataRequirementsItem(DataRequirement dataRequirementsItem) {
    ...
    public ShowWorkflowResponse withDataRequirements(Consumer<List<DataRequirement>> dataRequirementsSetter) {
        if (this.dataRequirements == null) {
            this.dataRequirements = new ArrayList<>();
        }
    ...
    public ShowWorkflowResponse withData(List<Data> data) {
        this.data = data;
        return this;
    }

    public ShowWorkflowResponse addDataItem(Data dataItem) {
        if (this.data == null) {
    ...
    public ShowWorkflowResponse withData(Consumer<List<Data>> dataSetter) {
        if (this.data == null) {
            this.data = new ArrayList<>();
        }
    ...
    public ShowWorkflowResponse withParameters(List<WorkflowParameter> parameters) {
        this.parameters = parameters;
        return this;
    }

    public ShowWorkflowResponse addParametersItem(WorkflowParameter parametersItem) {
    ...
    public ShowWorkflowResponse withParameters(Consumer<List<WorkflowParameter>> parametersSetter) {
        if (this.parameters == null) {
            this.parameters = new ArrayList<>();
        }
    ...
    public ShowWorkflowResponse withSourceWorkflowId(String sourceWorkflowId) {
    ...
    public ShowWorkflowResponse withGallerySubscription(WorkflowGallerySubscription gallerySubscription) {
        this.gallerySubscription = gallerySubscription;
        return this;
    }

    public ShowWorkflowResponse withGallerySubscription(
    ...
    public ShowWorkflowResponse withLatestExecution(ExecutionBrief latestExecution) {
        this.latestExecution = latestExecution;
        return this;
    }

    public ShowWorkflowResponse withLatestExecution(Consumer<ExecutionBrief> latestExecutionSetter) {
    ...
    public ShowWorkflowResponse withRunCount(Integer runCount) {
    ...
    public ShowWorkflowResponse withParamReady(Boolean paramReady) {
    ...
    public ShowWorkflowResponse withSource(String source) {
        this.source = source;
        return this;
    }
    ...
    public ShowWorkflowResponse withStorages(List<WorkflowStorage> storages) {
        this.storages = storages;
        return this;
    }

    public ShowWorkflowResponse addStoragesItem(WorkflowStorage storagesItem) {
    ...
    public ShowWorkflowResponse withStorages(Consumer<List<WorkflowStorage>> storagesSetter) {
        if (this.storages == null) {
            this.storages = new ArrayList<>();
        }
    ...
    public ShowWorkflowResponse withAssets(List<WorkflowAsset> assets) {
        this.assets = assets;
        return this;
    }

    public ShowWorkflowResponse addAssetsItem(WorkflowAsset assetsItem) {
        if (this.assets == null) {
    ...
    public ShowWorkflowResponse withAssets(Consumer<List<WorkflowAsset>> assetsSetter) {
        if (this.assets == null) {
            this.assets = new ArrayList<>();
        }
    ...
    public ShowWorkflowResponse withSubGraphs(List<WorkflowSubgraph> subGraphs) {
        this.subGraphs = subGraphs;
        return this;
    }

    public ShowWorkflowResponse addSubGraphsItem(WorkflowSubgraph subGraphsItem) {
    ...
    public ShowWorkflowResponse withSubGraphs(Consumer<List<WorkflowSubgraph>> subGraphsSetter) {
        if (this.subGraphs == null) {
            this.subGraphs = new ArrayList<>();
        }
    ...
    public ShowWorkflowResponse withExtend(Map<String, Object> extend) {
        this.extend = extend;
        return this;
    }

    public ShowWorkflowResponse putExtendItem(String key, Object extendItem) {
        if (this.extend == null) {
    ...
    public ShowWorkflowResponse withExtend(Consumer<Map<String, Object>> extendSetter) {
        if (this.extend == null) {
            this.extend = new HashMap<>();
        }
    ...
    public ShowWorkflowResponse withPolicy(WorkflowPolicy policy) {
        this.policy = policy;
        return this;
    }

    public ShowWorkflowResponse withPolicy(Consumer<WorkflowPolicy> policySetter) {
        if (this.policy == null) {
    ...
    public ShowWorkflowResponse withWithSubscription(Boolean withSubscription) {
    ...
    public ShowWorkflowResponse withSmnSwitch(Boolean smnSwitch) {
    ...
    public ShowWorkflowResponse withSubscriptionId(String subscriptionId) {
    ...
    public ShowWorkflowResponse withExemlTemplateId(String exemlTemplateId) {
    ...
    public ShowWorkflowResponse withLastModifiedAt(String lastModifiedAt) {
    ...
    public ShowWorkflowResponse withPackage(WorkflowServicePackege _package) {
        this._package = _package;
        return this;
    }

    public ShowWorkflowResponse withPackage(Consumer<WorkflowServicePackege> _packageSetter) {
