...
public class InspectionItemConfigDetail {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        return Objects.equals(this.intervalTime, that.intervalTime) && Objects.equals(this.itemType, that.itemType)
            && Objects.equals(this.times, that.times) && Objects.equals(this.inspectionType, that.inspectionType)
            && Objects.equals(this.itemCategory, that.itemCategory);
    }

    @Override
    public int hashCode() {
        return Objects.hash(intervalTime, itemType, times, inspectionType, itemCategory);
    }
