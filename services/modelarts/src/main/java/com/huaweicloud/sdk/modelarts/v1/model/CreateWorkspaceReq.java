...
public class CreateWorkspaceReq {
    ...
    private List<CreateWorkspaceReqGrants> grants = null;
    ...
    public CreateWorkspaceReq withGrants(List<CreateWorkspaceReqGrants> grants) {
        this.grants = grants;
        return this;
    }

    public CreateWorkspaceReq addGrantsItem(CreateWorkspaceReqGrants grantsItem) {
        if (this.grants == null) {
    ...
    public CreateWorkspaceReq withGrants(Consumer<List<CreateWorkspaceReqGrants>> grantsSetter) {
        if (this.grants == null) {
            this.grants = new ArrayList<>();
        }
     ...
     * @return grants
     */
    public List<CreateWorkspaceReqGrants> getGrants() {
        return grants;
    }

    public void setGrants(List<CreateWorkspaceReqGrants> grants) {
        this.grants = grants;
    }

    public CreateWorkspaceReq withAuthType(AuthTypeEnum authType) {
    ...
    public CreateWorkspaceReq withEnterpriseProjectId(String enterpriseProjectId) {
    ...
    public CreateWorkspaceReq withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public CreateWorkspaceReq withDescription(String description) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        CreateWorkspaceReq that = (CreateWorkspaceReq) obj;
    ...
    @Override
    public int hashCode() {
        return Objects.hash(grants, authType, enterpriseProjectId, name, description);
    }
