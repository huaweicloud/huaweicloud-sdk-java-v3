 ...
 * Response Object
 */
public class DeleteDevServerResponse extends SdkResponse {
    ...
    public DeleteDevServerResponse withCreateAt(Long createAt) {
    ...
    public DeleteDevServerResponse withUpdateAt(Long updateAt) {
    ...
    public DeleteDevServerResponse withChargingMode(ChargingModeEnum chargingMode) {
    ...
    public DeleteDevServerResponse withCloudServer(CloudServer cloudServer) {
        this.cloudServer = cloudServer;
        return this;
    }

    public DeleteDevServerResponse withCloudServer(Consumer<CloudServer> cloudServerSetter) {
    ...
    public DeleteDevServerResponse withEndpointsResponse(List<Endpoints> endpointsResponse) {
        this.endpointsResponse = endpointsResponse;
        return this;
    }

    public DeleteDevServerResponse addEndpointsResponseItem(Endpoints endpointsResponseItem) {
    ...
    public DeleteDevServerResponse withEndpointsResponse(Consumer<List<Endpoints>> endpointsResponseSetter) {
        if (this.endpointsResponse == null) {
            this.endpointsResponse = new ArrayList<>();
        }
    ...
    public DeleteDevServerResponse withFlavor(String flavor) {
        this.flavor = flavor;
        return this;
    }
    ...
    public DeleteDevServerResponse withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public DeleteDevServerResponse withKeyPairName(String keyPairName) {
    ...
    public DeleteDevServerResponse withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public DeleteDevServerResponse withOrderId(String orderId) {
    ...
    public DeleteDevServerResponse withStatus(StatusEnum status) {
        this.status = status;
        return this;
    }
    ...
    public DeleteDevServerResponse withVpcId(String vpcId) {
        this.vpcId = vpcId;
        return this;
    }
    ...
    public DeleteDevServerResponse withEndpoints(List<EndpointsRes> endpoints) {
        this.endpoints = endpoints;
        return this;
    }

    public DeleteDevServerResponse addEndpointsItem(EndpointsRes endpointsItem) {
    ...
    public DeleteDevServerResponse withEndpoints(Consumer<List<EndpointsRes>> endpointsSetter) {
        if (this.endpoints == null) {
            this.endpoints = new ArrayList<>();
        }
    ...
    public DeleteDevServerResponse withVolumes(List<ServerVolume> volumes) {
        this.volumes = volumes;
        return this;
    }

    public DeleteDevServerResponse addVolumesItem(ServerVolume volumesItem) {
    ...
    public DeleteDevServerResponse withVolumes(Consumer<List<ServerVolume>> volumesSetter) {
        if (this.volumes == null) {
            this.volumes = new ArrayList<>();
        }
    ...
    public DeleteDevServerResponse withImage(ServerImageResponse image) {
        this.image = image;
        return this;
    }

    public DeleteDevServerResponse withImage(Consumer<ServerImageResponse> imageSetter) {
        if (this.image == null) {
    ...
    public DeleteDevServerResponse withCategory(CategoryEnum category) {
    ...
    public DeleteDevServerResponse withServerHps(ServerHpsInfo serverHps) {
        this.serverHps = serverHps;
        return this;
    }

    public DeleteDevServerResponse withServerHps(Consumer<ServerHpsInfo> serverHpsSetter) {
    ...
    public DeleteDevServerResponse withSubnetId(String subnetId) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        DeleteDevServerResponse that = (DeleteDevServerResponse) obj;
    ...
    public String toString() {
        ...
        sb.append("class DeleteDevServerResponse {\n");
