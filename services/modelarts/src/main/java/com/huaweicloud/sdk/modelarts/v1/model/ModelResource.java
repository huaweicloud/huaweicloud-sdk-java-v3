...
public class ModelResource {
    ...
    public ModelResource withSource(String source) {
        this.source = source;
        return this;
    }
    ...
    public ModelResource withAddress(String address) {
    ...
    public ModelResource withMountPath(String mountPath) {
    ...
    public ModelResource withHostCache(Boolean hostCache) {
    ...
    public ModelResource withEfsSubPath(String efsSubPath) {
    ...
    public ModelResource withReadOnly(Boolean readOnly) {
    ...
    public ModelResource withOsWarmUp(Boolean osWarmUp) {
    ...
    public ModelResource withSourceName(String sourceName) {
    ...
    public ModelResource withAssetId(String assetId) {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(source, address, mountPath, hostCache, efsSubPath, readOnly, osWarmUp, sourceName, assetId);
    }
