...
public class ShowImageResponse extends SdkResponse {
    ...
    public ShowImageResponse withCreateAt(Long createAt) {
    ...
    public ShowImageResponse withDescription(String description) {
    ...
    public ShowImageResponse withDevServices(List<DevServicesEnum> devServices) {
        this.devServices = devServices;
        return this;
    }

    public ShowImageResponse addDevServicesItem(DevServicesEnum devServicesItem) {
    ...
    public ShowImageResponse withDevServices(Consumer<List<DevServicesEnum>> devServicesSetter) {
        if (this.devServices == null) {
            this.devServices = new ArrayList<>();
        }
    ...
    public ShowImageResponse withNamespace(String namespace) {
    ...
    public ShowImageResponse withOrigin(OriginEnum origin) {
        this.origin = origin;
        return this;
    }
    ...
    public ShowImageResponse withResourceCategories(List<ResourceCategoriesEnum> resourceCategories) {
        this.resourceCategories = resourceCategories;
        return this;
    }

    public ShowImageResponse addResourceCategoriesItem(ResourceCategoriesEnum resourceCategoriesItem) {
    ...
    public ShowImageResponse withResourceCategories(Consumer<List<ResourceCategoriesEnum>> resourceCategoriesSetter) {
        if (this.resourceCategories == null) {
            this.resourceCategories = new ArrayList<>();
        }
    ...
    public ShowImageResponse withServiceType(ServiceTypeEnum serviceType) {
    ...
    public ShowImageResponse withSize(Long size) {
        this.size = size;
        return this;
    }
    ...
    public ShowImageResponse withStatusMessage(String statusMessage) {
    ...
    public ShowImageResponse withTag(String tag) {
        this.tag = tag;
        return this;
    }
    ...
    public ShowImageResponse withType(TypeEnum type) {
        this.type = type;
        return this;
    }
    ...
    public ShowImageResponse withUpdateAt(Long updateAt) {
    ...
    public ShowImageResponse withVisibility(VisibilityEnum visibility) {
    ...
    public ShowImageResponse withWorkspaceId(String workspaceId) {
    ...
    public ShowImageResponse withFlavorType(String flavorType) {
    ...
    public ShowImageResponse withSwrInstanceId(String swrInstanceId) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ShowImageResponse that = (ShowImageResponse) obj;
