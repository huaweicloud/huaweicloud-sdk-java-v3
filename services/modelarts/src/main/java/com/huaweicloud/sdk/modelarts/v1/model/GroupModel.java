...
public class GroupModel {
    ...
    public GroupModel withSource(String source) {
        this.source = source;
        return this;
    }
    ...
    public GroupModel withAddress(String address) {
    ...
    public GroupModel withMountPath(String mountPath) {
    ...
    public GroupModel withHostCache(Boolean hostCache) {
    ...
    public GroupModel withEfsSubPath(String efsSubPath) {
    ...
    public GroupModel withReadOnly(Boolean readOnly) {
    ...
    public GroupModel withOsWarmUp(Boolean osWarmUp) {
    ...
    public GroupModel withSourceName(String sourceName) {
    ...
    public GroupModel withAssetId(String assetId) {
