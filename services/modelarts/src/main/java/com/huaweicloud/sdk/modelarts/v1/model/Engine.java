...
public class Engine {
    ...
    public Engine withEngineId(String engineId) {
    ...
    public Engine withEngineName(String engineName) {
    ...
    public Engine withEngineVersion(String engineVersion) {
    ...
    public Engine withV1Compatible(Boolean v1Compatible) {
    ...
    public Engine withRunUser(String runUser) {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(engineId, engineName, engineVersion, v1Compatible, runUser);
    }
