...
public class ScheduledEvent {
    ...
    public ScheduledEvent withCatalog(CatalogEnum catalog) {
    ...
    public ScheduledEvent withType(TypeEnum type) {
        this.type = type;
        return this;
    }
    ...
    public ScheduledEvent withState(StateEnum state) {
        this.state = state;
        return this;
    }
    ...
    public ScheduledEvent withInstanceType(InstanceTypeEnum instanceType) {
