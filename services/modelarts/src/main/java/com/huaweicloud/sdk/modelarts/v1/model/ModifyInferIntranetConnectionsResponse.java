 ...
 * Response Object
 */
public class ModifyInferIntranetConnectionsResponse extends SdkResponse {
    ...
    public ModifyInferIntranetConnectionsResponse withApplicantUserName(String applicantUserName) {
    ...
    public ModifyInferIntranetConnectionsResponse withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public ModifyInferIntranetConnectionsResponse withMessage(String message) {
    ...
    public ModifyInferIntranetConnectionsResponse withOwnerDomainName(String ownerDomainName) {
    ...
    public ModifyInferIntranetConnectionsResponse withScene(String scene) {
        this.scene = scene;
        return this;
    }
    ...
    public ModifyInferIntranetConnectionsResponse withServiceId(String serviceId) {
    ...
    public ModifyInferIntranetConnectionsResponse withServiceName(String serviceName) {
    ...
    public ModifyInferIntranetConnectionsResponse withStatus(String status) {
        this.status = status;
        return this;
    }
    ...
    public ModifyInferIntranetConnectionsResponse withSubnetId(String subnetId) {
    ...
    public ModifyInferIntranetConnectionsResponse withUrlList(List<String> urlList) {
        this.urlList = urlList;
        return this;
    }

    public ModifyInferIntranetConnectionsResponse addUrlListItem(String urlListItem) {
    ...
    public ModifyInferIntranetConnectionsResponse withUrlList(Consumer<List<String>> urlListSetter) {
        if (this.urlList == null) {
            this.urlList = new ArrayList<>();
        }
    ...
    public ModifyInferIntranetConnectionsResponse withCustomUrlList(List<String> customUrlList) {
        this.customUrlList = customUrlList;
        return this;
    }

    public ModifyInferIntranetConnectionsResponse addCustomUrlListItem(String customUrlListItem) {
    ...
    public ModifyInferIntranetConnectionsResponse withCustomUrlList(Consumer<List<String>> customUrlListSetter) {
        if (this.customUrlList == null) {
            this.customUrlList = new ArrayList<>();
        }
    ...
    public ModifyInferIntranetConnectionsResponse withVpcId(String vpcId) {
        this.vpcId = vpcId;
        return this;
    }
    ...
    public ModifyInferIntranetConnectionsResponse withDispatcherGroupId(String dispatcherGroupId) {
    ...
    public ModifyInferIntranetConnectionsResponse withType(TypeEnum type) {
        this.type = type;
        return this;
    }
    ...
    public ModifyInferIntranetConnectionsResponse withMaosNetworkName(String maosNetworkName) {
    ...
    public ModifyInferIntranetConnectionsResponse withServiceType(String serviceType) {
    ...
    public ModifyInferIntranetConnectionsResponse withPoolId(String poolId) {
        this.poolId = poolId;
        return this;
    }
    ...
    public ModifyInferIntranetConnectionsResponse withCreateAt(String createAt) {
    ...
    public ModifyInferIntranetConnectionsResponse withUpdateAt(String updateAt) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ModifyInferIntranetConnectionsResponse that = (ModifyInferIntranetConnectionsResponse) obj;
