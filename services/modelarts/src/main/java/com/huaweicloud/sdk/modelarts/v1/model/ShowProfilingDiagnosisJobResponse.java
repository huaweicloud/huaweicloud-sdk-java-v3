 ...
 * Response Object
 */
public class ShowProfilingDiagnosisJobResponse extends SdkResponse {
    ...
    public ShowProfilingDiagnosisJobResponse withCreateTime(OffsetDateTime createTime) {
    ...
    public ShowProfilingDiagnosisJobResponse withCreator(String creator) {
    ...
    public ShowProfilingDiagnosisJobResponse withDescription(String description) {
    ...
    public ShowProfilingDiagnosisJobResponse withDiagnosisConclusion(ResultStatus diagnosisConclusion) {
    ...
    public ShowProfilingDiagnosisJobResponse withDiagnosisTime(Long diagnosisTime) {
    ...
    public ShowProfilingDiagnosisJobResponse withEstimatedTime(Integer estimatedTime) {
    ...
    public ShowProfilingDiagnosisJobResponse withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public ShowProfilingDiagnosisJobResponse withJobStatus(JobStatus jobStatus) {
    ...
    public ShowProfilingDiagnosisJobResponse withMessage(String message) {
    ...
    public ShowProfilingDiagnosisJobResponse withName(String name) {
        this.name = name;
        return this;
    }

    /**
     * **参数解释**：profiling诊断作业名称。 **取值范围**：长度为 1 到 64 位由数字、中文、英文、下划线（_）或中划线（-）组成的字符。
     * @return name
     */
    ...
    public ShowProfilingDiagnosisJobResponse withObsPath(String obsPath) {
    ...
    public ShowProfilingDiagnosisJobResponse withUpdateTime(OffsetDateTime updateTime) {
    ...
    public ShowProfilingDiagnosisJobResponse withXRequestId(String xRequestId) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ShowProfilingDiagnosisJobResponse that = (ShowProfilingDiagnosisJobResponse) obj;
        return Objects.equals(this.createTime, that.createTime) && Objects.equals(this.creator, that.creator)
            ...
            && Objects.equals(this.name, that.name) && Objects.equals(this.obsPath, that.obsPath)
    ...
    public String toString() {
        ...
        sb.append("class ShowProfilingDiagnosisJobResponse {\n");
