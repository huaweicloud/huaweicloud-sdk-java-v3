 ...
 * Response Object
 */
public class CreateInferIntranetConnectionResponse extends SdkResponse {
    ...
    public CreateInferIntranetConnectionResponse withApplicantUserName(String applicantUserName) {
    ...
    public CreateInferIntranetConnectionResponse withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public CreateInferIntranetConnectionResponse withMessage(String message) {
    ...
    public CreateInferIntranetConnectionResponse withOwnerDomainName(String ownerDomainName) {
    ...
    public CreateInferIntranetConnectionResponse withScene(String scene) {
        this.scene = scene;
        return this;
    }
    ...
    public CreateInferIntranetConnectionResponse withServiceId(String serviceId) {
    ...
    public CreateInferIntranetConnectionResponse withServiceName(String serviceName) {
    ...
    public CreateInferIntranetConnectionResponse withStatus(String status) {
        this.status = status;
        return this;
    }
    ...
    public CreateInferIntranetConnectionResponse withSubnetId(String subnetId) {
    ...
    public CreateInferIntranetConnectionResponse withUrlList(List<String> urlList) {
        this.urlList = urlList;
        return this;
    }

    public CreateInferIntranetConnectionResponse addUrlListItem(String urlListItem) {
    ...
    public CreateInferIntranetConnectionResponse withUrlList(Consumer<List<String>> urlListSetter) {
        if (this.urlList == null) {
            this.urlList = new ArrayList<>();
        }
    ...
    public CreateInferIntranetConnectionResponse withCustomUrlList(List<String> customUrlList) {
        this.customUrlList = customUrlList;
        return this;
    }

    public CreateInferIntranetConnectionResponse addCustomUrlListItem(String customUrlListItem) {
    ...
    public CreateInferIntranetConnectionResponse withCustomUrlList(Consumer<List<String>> customUrlListSetter) {
        if (this.customUrlList == null) {
            this.customUrlList = new ArrayList<>();
        }
    ...
    public CreateInferIntranetConnectionResponse withVpcId(String vpcId) {
        this.vpcId = vpcId;
        return this;
    }
    ...
    public CreateInferIntranetConnectionResponse withDispatcherGroupId(String dispatcherGroupId) {
    ...
    public CreateInferIntranetConnectionResponse withType(TypeEnum type) {
        this.type = type;
        return this;
    }
    ...
    public CreateInferIntranetConnectionResponse withMaosNetworkName(String maosNetworkName) {
    ...
    public CreateInferIntranetConnectionResponse withServiceType(String serviceType) {
    ...
    public CreateInferIntranetConnectionResponse withPoolId(String poolId) {
        this.poolId = poolId;
        return this;
    }
    ...
    public CreateInferIntranetConnectionResponse withCreateAt(String createAt) {
    ...
    public CreateInferIntranetConnectionResponse withUpdateAt(String updateAt) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        CreateInferIntranetConnectionResponse that = (CreateInferIntranetConnectionResponse) obj;
    ...
    public String toString() {
        ...
        sb.append("class CreateInferIntranetConnectionResponse {\n");
