...
public class NotebookResp {
    ...
    public NotebookResp withActionProgress(List<JobProgress> actionProgress) {
        this.actionProgress = actionProgress;
        return this;
    }

    public NotebookResp addActionProgressItem(JobProgress actionProgressItem) {
    ...
    public NotebookResp withActionProgress(Consumer<List<JobProgress>> actionProgressSetter) {
        if (this.actionProgress == null) {
            this.actionProgress = new ArrayList<>();
        }
    ...
    public NotebookResp withDescription(String description) {
    ...
    public NotebookResp withEndpoints(List<EndpointsRes> endpoints) {
        this.endpoints = endpoints;
        return this;
    }

    public NotebookResp addEndpointsItem(EndpointsRes endpointsItem) {
    ...
    public NotebookResp withEndpoints(Consumer<List<EndpointsRes>> endpointsSetter) {
        if (this.endpoints == null) {
            this.endpoints = new ArrayList<>();
        }
    ...
    public NotebookResp withFailReason(String failReason) {
    ...
    public NotebookResp withFlavor(String flavor) {
        this.flavor = flavor;
        return this;
    }
    ...
    public NotebookResp withCustomSpec(NotebookCustomSpecRep customSpec) {
        this.customSpec = customSpec;
        return this;
    }

    public NotebookResp withCustomSpec(Consumer<NotebookCustomSpecRep> customSpecSetter) {
    ...
    public NotebookResp withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public NotebookResp withImage(Image image) {
        this.image = image;
        return this;
    }

    public NotebookResp withImage(Consumer<Image> imageSetter) {
        if (this.image == null) {
    ...
    public NotebookResp withLease(Lease lease) {
        this.lease = lease;
        return this;
    }

    public NotebookResp withLease(Consumer<Lease> leaseSetter) {
        if (this.lease == null) {
    ...
    public NotebookResp withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public NotebookResp withPool(Pool pool) {
        this.pool = pool;
        return this;
    }

    public NotebookResp withPool(Consumer<Pool> poolSetter) {
        if (this.pool == null) {
            this.pool = new Pool();
    ...
    public NotebookResp withStatus(StatusEnum status) {
        this.status = status;
        return this;
    }
    ...
    public NotebookResp withToken(String token) {
        this.token = token;
        return this;
    }
    ...
    public NotebookResp withUrl(String url) {
        this.url = url;
        return this;
    }
    ...
    public NotebookResp withVolume(VolumeRes volume) {
        this.volume = volume;
        return this;
    }

    public NotebookResp withVolume(Consumer<VolumeRes> volumeSetter) {
        if (this.volume == null) {
    ...
    public NotebookResp withWorkspaceId(String workspaceId) {
    ...
    public NotebookResp withFeature(String feature) {
    ...
    public NotebookResp withBillingItems(List<BillingItemsEnum> billingItems) {
        this.billingItems = billingItems;
        return this;
    }

    public NotebookResp addBillingItemsItem(BillingItemsEnum billingItemsItem) {
    ...
    public NotebookResp withBillingItems(Consumer<List<BillingItemsEnum>> billingItemsSetter) {
        if (this.billingItems == null) {
            this.billingItems = new ArrayList<>();
        }
    ...
    public NotebookResp withUser(UserResponse user) {
        this.user = user;
        return this;
    }

    public NotebookResp withUser(Consumer<UserResponse> userSetter) {
        if (this.user == null) {
    ...
    public NotebookResp withAffinity(AffinityType affinity) {
        this.affinity = affinity;
        return this;
    }

    public NotebookResp withAffinity(Consumer<AffinityType> affinitySetter) {
    ...
    public NotebookResp withRunUser(RunUserInfo runUser) {
        this.runUser = runUser;
        return this;
    }

    public NotebookResp withRunUser(Consumer<RunUserInfo> runUserSetter) {
    ...
    public NotebookResp withDataVolumes(List<VolumeResponse> dataVolumes) {
        this.dataVolumes = dataVolumes;
        return this;
    }

    public NotebookResp addDataVolumesItem(VolumeResponse dataVolumesItem) {
    ...
    public NotebookResp withDataVolumes(Consumer<List<VolumeResponse>> dataVolumesSetter) {
        if (this.dataVolumes == null) {
            this.dataVolumes = new ArrayList<>();
        }
    ...
    public NotebookResp withIp(String ip) {
        this.ip = ip;
        return this;
    }
    ...
    public NotebookResp withUserVpc(UserVpcResponse userVpc) {
        this.userVpc = userVpc;
        return this;
    }

    public NotebookResp withUserVpc(Consumer<UserVpcResponse> userVpcSetter) {
    ...
    public NotebookResp withUserId(String userId) {
        this.userId = userId;
        return this;
    }
    ...
    public NotebookResp withIsNeedCredentials(Boolean isNeedCredentials) {
    ...
    public NotebookResp withJupyterVersion(String jupyterVersion) {
    ...
    public NotebookResp withTags(List<TmsTagResponse> tags) {
        this.tags = tags;
        return this;
    }

    public NotebookResp addTagsItem(TmsTagResponse tagsItem) {
        if (this.tags == null) {
    ...
    public NotebookResp withTags(Consumer<List<TmsTagResponse>> tagsSetter) {
        if (this.tags == null) {
            this.tags = new ArrayList<>();
        }
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        NotebookResp that = (NotebookResp) obj;
