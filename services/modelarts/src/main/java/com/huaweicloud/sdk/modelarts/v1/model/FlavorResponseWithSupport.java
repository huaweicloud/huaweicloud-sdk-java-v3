 ...
 */
public class FlavorResponseWithSupport {
    ...
    public FlavorResponseWithSupport withPoolId(String poolId) {
        this.poolId = poolId;
        return this;
    }
    ...
    public FlavorResponseWithSupport withFlavorId(String flavorId) {
    ...
    public FlavorResponseWithSupport withFlavorName(String flavorName) {
    ...
    public FlavorResponseWithSupport withSupportEngines(String supportEngines) {
    ...
    public FlavorResponseWithSupport withSupportGroups(String supportGroups) {
    ...
    public FlavorResponseWithSupport withMaxNum(Integer maxNum) {
        this.maxNum = maxNum;
        return this;
    }
    ...
    public FlavorResponseWithSupport withFlavorType(String flavorType) {
    ...
    public FlavorResponseWithSupport withBilling(BillingInfo billing) {
        this.billing = billing;
        return this;
    }

    public FlavorResponseWithSupport withBilling(Consumer<BillingInfo> billingSetter) {
    ...
    public FlavorResponseWithSupport withFlavorInfo(FlavorInfoResponse flavorInfo) {
        this.flavorInfo = flavorInfo;
        return this;
    }

    public FlavorResponseWithSupport withFlavorInfo(Consumer<FlavorInfoResponse> flavorInfoSetter) {
    ...
    public FlavorResponseWithSupport withAttributes(Map<String, String> attributes) {
        this.attributes = attributes;
        return this;
    }

    public FlavorResponseWithSupport putAttributesItem(String key, String attributesItem) {
    ...
    public FlavorResponseWithSupport withAttributes(Consumer<Map<String, String>> attributesSetter) {
        if (this.attributes == null) {
            this.attributes = new HashMap<>();
        }
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        FlavorResponseWithSupport that = (FlavorResponseWithSupport) obj;
    ...
    public String toString() {
        ...
        sb.append("class FlavorResponseWithSupport {\n");
