...
public class CreateImageRequest {
    ...
    private ImageCreateReq body;

    public CreateImageRequest withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public CreateImageRequest withBody(ImageCreateReq body) {
        this.body = body;
        return this;
    }

    public CreateImageRequest withBody(Consumer<ImageCreateReq> bodySetter) {
        if (this.body == null) {
            this.body = new ImageCreateReq();
     ...
     * @return body
     */
    public ImageCreateReq getBody() {
        return body;
    }

    public void setBody(ImageCreateReq body) {
        this.body = body;
    }
