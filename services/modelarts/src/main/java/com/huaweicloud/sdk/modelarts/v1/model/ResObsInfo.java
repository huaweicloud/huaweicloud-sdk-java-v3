...
public class ResObsInfo {
    ...
    public ResObsInfo withCannPath(String cannPath) {
        this.cannPath = cannPath;
        return this;
    }

    /**
     * **参数解释**：CANN应用类日志路径。 **取值范围**：[0,2048]。
     * @return cannPath
     */
    ...
    public ResObsInfo withDevicePath(String devicePath) {
        this.devicePath = devicePath;
        return this;
    }

    /**
     * **参数解释**：Device侧日志路径。  **取值范围**：[0,2048]。
     * @return devicePath
     */
    ...
    public ResObsInfo withHostPath(String hostPath) {
        this.hostPath = hostPath;
        return this;
    }

    /**
     * **参数解释**：Host OS日志路径。  **取值范围**：[0,2048]。
     * @return hostPath
     */
    ...
    public ResObsInfo withTrainOrInferPath(String trainOrInferPath) {
        this.trainOrInferPath = trainOrInferPath;
        return this;
    }

    /**
     * **参数解释**：训练及推理日志路径。  **取值范围**：[0,2048]。
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ResObsInfo that = (ResObsInfo) obj;
