 ...
 */
public class RuntimeConfigCreateRequest {

    @JsonInclude(JsonInclude.Include.NON_NULL)
    @JsonProperty(value = "service_invoke")

    private ServiceInvokeCreateRequest serviceInvoke;
    ...
    public RuntimeConfigCreateRequest withServiceInvoke(ServiceInvokeCreateRequest serviceInvoke) {
        this.serviceInvoke = serviceInvoke;
        return this;
    }

    public RuntimeConfigCreateRequest withServiceInvoke(Consumer<ServiceInvokeCreateRequest> serviceInvokeSetter) {
        if (this.serviceInvoke == null) {
            this.serviceInvoke = new ServiceInvokeCreateRequest();
     ...
     */
    public ServiceInvokeCreateRequest getServiceInvoke() {
        return serviceInvoke;
    }

    public void setServiceInvoke(ServiceInvokeCreateRequest serviceInvoke) {
        this.serviceInvoke = serviceInvoke;
    }

    public RuntimeConfigCreateRequest withServiceLimit(ServiceLimit serviceLimit) {
        this.serviceLimit = serviceLimit;
        return this;
    }

    public RuntimeConfigCreateRequest withServiceLimit(Consumer<ServiceLimit> serviceLimitSetter) {
    ...
    public RuntimeConfigCreateRequest withServiceSecret(ServiceSecret serviceSecret) {
        this.serviceSecret = serviceSecret;
        return this;
    }

    public RuntimeConfigCreateRequest withServiceSecret(Consumer<ServiceSecret> serviceSecretSetter) {
    ...
    public RuntimeConfigCreateRequest withServerTaskLimit(ServerTaskLimit serverTaskLimit) {
        this.serverTaskLimit = serverTaskLimit;
        return this;
    }

    public RuntimeConfigCreateRequest withServerTaskLimit(Consumer<ServerTaskLimit> serverTaskLimitSetter) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        RuntimeConfigCreateRequest that = (RuntimeConfigCreateRequest) obj;
    ...
    public String toString() {
        ...
        sb.append("class RuntimeConfigCreateRequest {\n");
