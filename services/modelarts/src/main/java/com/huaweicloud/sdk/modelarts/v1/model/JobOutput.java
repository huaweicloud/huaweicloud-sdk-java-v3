...
public class JobOutput {
    ...
    public JobOutput withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public JobOutput withType(TypeEnum type) {
        this.type = type;
        return this;
    }
    ...
    public JobOutput withConfig(Map<String, Object> config) {
        this.config = config;
        return this;
    }

    public JobOutput putConfigItem(String key, Object configItem) {
        if (this.config == null) {
    ...
    public JobOutput withConfig(Consumer<Map<String, Object>> configSetter) {
        if (this.config == null) {
            this.config = new HashMap<>();
        }
