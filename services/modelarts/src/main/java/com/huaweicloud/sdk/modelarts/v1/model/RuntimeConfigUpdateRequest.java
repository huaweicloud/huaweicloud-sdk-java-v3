...
public class RuntimeConfigUpdateRequest {
    ...
    private ServiceInvokeUpdateRequest serviceInvoke;
    ...
    public RuntimeConfigUpdateRequest withServiceInvoke(ServiceInvokeUpdateRequest serviceInvoke) {
        this.serviceInvoke = serviceInvoke;
        return this;
    }

    public RuntimeConfigUpdateRequest withServiceInvoke(Consumer<ServiceInvokeUpdateRequest> serviceInvokeSetter) {
        if (this.serviceInvoke == null) {
            this.serviceInvoke = new ServiceInvokeUpdateRequest();
     ...
     */
    public ServiceInvokeUpdateRequest getServiceInvoke() {
        return serviceInvoke;
    }

    public void setServiceInvoke(ServiceInvokeUpdateRequest serviceInvoke) {
        this.serviceInvoke = serviceInvoke;
    }

    public RuntimeConfigUpdateRequest withServiceLimit(ServiceLimit serviceLimit) {
        this.serviceLimit = serviceLimit;
        return this;
    }

    public RuntimeConfigUpdateRequest withServiceLimit(Consumer<ServiceLimit> serviceLimitSetter) {
    ...
    public RuntimeConfigUpdateRequest withServiceSecret(ServiceSecret serviceSecret) {
        this.serviceSecret = serviceSecret;
        return this;
    }

    public RuntimeConfigUpdateRequest withServiceSecret(Consumer<ServiceSecret> serviceSecretSetter) {
    ...
    public RuntimeConfigUpdateRequest withServerTaskLimit(ServerTaskLimit serverTaskLimit) {
        this.serverTaskLimit = serverTaskLimit;
        return this;
    }

    public RuntimeConfigUpdateRequest withServerTaskLimit(Consumer<ServerTaskLimit> serverTaskLimitSetter) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        RuntimeConfigUpdateRequest that = (RuntimeConfigUpdateRequest) obj;
    ...
    public String toString() {
        ...
        sb.append("class RuntimeConfigUpdateRequest {\n");
