...
public class Network {
    ...
    public Network withApiVersion(String apiVersion) {
    ...
    public Network withMetadata(NetworkMetadata metadata) {
        this.metadata = metadata;
        return this;
    }

    public Network withMetadata(Consumer<NetworkMetadata> metadataSetter) {
    ...
    public Network withSpec(NetworkSpec spec) {
        this.spec = spec;
        return this;
    }

    public Network withSpec(Consumer<NetworkSpec> specSetter) {
        if (this.spec == null) {
    ...
    public Network withStatus(Consumer<NetworkStatus> statusSetter) {
        if (this.status == null) {
