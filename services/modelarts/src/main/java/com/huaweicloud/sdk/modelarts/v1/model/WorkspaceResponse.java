...
public class WorkspaceResponse {
    ...
    public WorkspaceResponse withOwner(String owner) {
        this.owner = owner;
        return this;
    }
    ...
    public WorkspaceResponse withAuthType(String authType) {
    ...
    public WorkspaceResponse withEnterpriseProjectId(String enterpriseProjectId) {
    ...
    public WorkspaceResponse withUpdateTime(Long updateTime) {
    ...
    public WorkspaceResponse withCreateTime(Long createTime) {
    ...
    public WorkspaceResponse withEnterpriseProjectName(String enterpriseProjectName) {
    ...
    public WorkspaceResponse withDescription(String description) {
    ...
    public WorkspaceResponse withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public WorkspaceResponse withStatus(String status) {
        this.status = status;
        return this;
    }
    ...
    public WorkspaceResponse withStatusInfo(String statusInfo) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        WorkspaceResponse that = (WorkspaceResponse) obj;
