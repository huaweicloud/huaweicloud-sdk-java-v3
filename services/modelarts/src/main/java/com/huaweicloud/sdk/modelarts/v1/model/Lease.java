...
public class Lease {
    ...
    public Lease withCreateAt(Long createAt) {
    ...
    public Lease withDuration(Long duration) {
    ...
    public Lease withEnable(Boolean enable) {
        this.enable = enable;
        return this;
    }
    ...
    public Lease withType(TypeEnum type) {
        this.type = type;
        return this;
    }
    ...
    public Lease withUpdateAt(Long updateAt) {
