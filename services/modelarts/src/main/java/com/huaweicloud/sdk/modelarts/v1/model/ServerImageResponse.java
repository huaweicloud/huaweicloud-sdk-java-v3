...
public class ServerImageResponse {
    ...
    public ServerImageResponse withArch(ArchEnum arch) {
        this.arch = arch;
        return this;
    }
    ...
    public ServerImageResponse withImageId(String imageId) {
    ...
    public ServerImageResponse withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public ServerImageResponse withServerType(ServerTypeEnum serverType) {
    ...
    public ServerImageResponse withStatus(String status) {
        this.status = status;
        return this;
    }
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ServerImageResponse that = (ServerImageResponse) obj;
