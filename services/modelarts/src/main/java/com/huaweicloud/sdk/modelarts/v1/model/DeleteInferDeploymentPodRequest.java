 ...
 * Request Object
 */
public class DeleteInferDeploymentPodRequest {
    ...
    public DeleteInferDeploymentPodRequest withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public DeleteInferDeploymentPodRequest withDeploymentName(String deploymentName) {
    ...
    public DeleteInferDeploymentPodRequest withInstanceName(String instanceName) {
    ...
    public DeleteInferDeploymentPodRequest withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public DeleteInferDeploymentPodRequest withForce(Boolean force) {
        this.force = force;
        return this;
    }
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        DeleteInferDeploymentPodRequest that = (DeleteInferDeploymentPodRequest) obj;
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, deploymentName, instanceName, name, force);
    }

    @Override
    public String toString() {
        StringBuilder sb = new StringBuilder();
        sb.append("class DeleteInferDeploymentPodRequest {\n");
