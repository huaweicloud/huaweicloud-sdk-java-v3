...
public class WorkspaceQuotasUpdateResponse {
    ...
    public WorkspaceQuotasUpdateResponse withMaxQuota(Integer maxQuota) {
    ...
    public WorkspaceQuotasUpdateResponse withResource(String resource) {
    ...
    public WorkspaceQuotasUpdateResponse withQuota(Integer quota) {
        this.quota = quota;
        return this;
    }
    ...
    public WorkspaceQuotasUpdateResponse withMinQuota(Integer minQuota) {
    ...
    public WorkspaceQuotasUpdateResponse withNameCn(String nameCn) {
        this.nameCn = nameCn;
        return this;
    }
    ...
    public WorkspaceQuotasUpdateResponse withUnitCn(String unitCn) {
        this.unitCn = unitCn;
        return this;
    }
    ...
    public WorkspaceQuotasUpdateResponse withNameEn(String nameEn) {
        this.nameEn = nameEn;
        return this;
    }
    ...
    public WorkspaceQuotasUpdateResponse withUnitEn(String unitEn) {
        this.unitEn = unitEn;
        return this;
    }
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        WorkspaceQuotasUpdateResponse that = (WorkspaceQuotasUpdateResponse) obj;
        return Objects.equals(this.maxQuota, that.maxQuota) && Objects.equals(this.updateTime, that.updateTime)
            ...
            && Objects.equals(this.unitEn, that.unitEn);
    }

    @Override
    public int hashCode() {
        return Objects.hash(maxQuota, updateTime, resource, quota, minQuota, nameCn, unitCn, nameEn, unitEn);
    }
