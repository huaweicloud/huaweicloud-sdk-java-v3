...
public class JobEngine {
    ...
    public JobEngine withEngineId(String engineId) {
    ...
    public JobEngine withEngineName(String engineName) {
    ...
    public JobEngine withEngineVersion(String engineVersion) {
    ...
    public JobEngine withImageUrl(String imageUrl) {
    ...
    public JobEngine withInstallSysPackages(Boolean installSysPackages) {
    ...
    public JobEngine withImageRepoId(String imageRepoId) {
