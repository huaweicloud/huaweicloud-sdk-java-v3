...
public class Workflow {
    ...
    public Workflow withSteps(List<WorkflowStep> steps) {
        this.steps = steps;
        return this;
    }

    public Workflow addStepsItem(WorkflowStep stepsItem) {
        if (this.steps == null) {
    ...
    public Workflow withSteps(Consumer<List<WorkflowStep>> stepsSetter) {
        if (this.steps == null) {
            this.steps = new ArrayList<>();
        }
    ...
    public Workflow withUserName(String userName) {
    ...
    public Workflow withWorkspaceId(String workspaceId) {
    ...
    public Workflow withDataRequirements(List<DataRequirement> dataRequirements) {
        this.dataRequirements = dataRequirements;
        return this;
    }

    public Workflow addDataRequirementsItem(DataRequirement dataRequirementsItem) {
    ...
    public Workflow withDataRequirements(Consumer<List<DataRequirement>> dataRequirementsSetter) {
        if (this.dataRequirements == null) {
            this.dataRequirements = new ArrayList<>();
        }
    ...
    public Workflow withData(List<Data> data) {
        this.data = data;
        return this;
    }

    public Workflow addDataItem(Data dataItem) {
        if (this.data == null) {
    ...
    public Workflow withData(Consumer<List<Data>> dataSetter) {
        if (this.data == null) {
            this.data = new ArrayList<>();
        }
    ...
    public Workflow withParameters(List<WorkflowParameter> parameters) {
        this.parameters = parameters;
        return this;
    }

    public Workflow addParametersItem(WorkflowParameter parametersItem) {
    ...
    public Workflow withParameters(Consumer<List<WorkflowParameter>> parametersSetter) {
        if (this.parameters == null) {
            this.parameters = new ArrayList<>();
        }
    ...
    public Workflow withSourceWorkflowId(String sourceWorkflowId) {
    ...
    public Workflow withGallerySubscription(WorkflowGallerySubscription gallerySubscription) {
        this.gallerySubscription = gallerySubscription;
        return this;
    }

    public Workflow withGallerySubscription(Consumer<WorkflowGallerySubscription> gallerySubscriptionSetter) {
    ...
    public Workflow withLatestExecution(ExecutionBrief latestExecution) {
        this.latestExecution = latestExecution;
        return this;
    }

    public Workflow withLatestExecution(Consumer<ExecutionBrief> latestExecutionSetter) {
    ...
    public Workflow withRunCount(Integer runCount) {
    ...
    public Workflow withParamReady(Boolean paramReady) {
    ...
    public Workflow withSource(String source) {
        this.source = source;
        return this;
    }
    ...
    public Workflow withStorages(List<WorkflowStorage> storages) {
        this.storages = storages;
        return this;
    }

    public Workflow addStoragesItem(WorkflowStorage storagesItem) {
    ...
    public Workflow withStorages(Consumer<List<WorkflowStorage>> storagesSetter) {
        if (this.storages == null) {
            this.storages = new ArrayList<>();
        }
    ...
    public Workflow withLabels(List<String> labels) {
        this.labels = labels;
        return this;
    }
    ...
    public Workflow withLabels(Consumer<List<String>> labelsSetter) {
        if (this.labels == null) {
            this.labels = new ArrayList<>();
        }
    ...
    public Workflow withAssets(List<WorkflowAsset> assets) {
        this.assets = assets;
        return this;
    }

    public Workflow addAssetsItem(WorkflowAsset assetsItem) {
        if (this.assets == null) {
    ...
    public Workflow withAssets(Consumer<List<WorkflowAsset>> assetsSetter) {
        if (this.assets == null) {
            this.assets = new ArrayList<>();
        }
    ...
    public Workflow withSubGraphs(List<WorkflowSubgraph> subGraphs) {
        this.subGraphs = subGraphs;
        return this;
    }

    public Workflow addSubGraphsItem(WorkflowSubgraph subGraphsItem) {
    ...
    public Workflow withSubGraphs(Consumer<List<WorkflowSubgraph>> subGraphsSetter) {
        if (this.subGraphs == null) {
            this.subGraphs = new ArrayList<>();
        }
    ...
    public Workflow withExtend(Map<String, Object> extend) {
        this.extend = extend;
        return this;
    }

    public Workflow putExtendItem(String key, Object extendItem) {
        if (this.extend == null) {
    ...
    public Workflow withExtend(Consumer<Map<String, Object>> extendSetter) {
        if (this.extend == null) {
            this.extend = new HashMap<>();
        }
    ...
    public Workflow withPolicy(WorkflowPolicy policy) {
        this.policy = policy;
        return this;
    }

    public Workflow withPolicy(Consumer<WorkflowPolicy> policySetter) {
        if (this.policy == null) {
    ...
    public Workflow withWithSubscription(Boolean withSubscription) {
    ...
    public Workflow withSmnSwitch(Boolean smnSwitch) {
    ...
    public Workflow withSubscriptionId(String subscriptionId) {
    ...
    public Workflow withExemlTemplateId(String exemlTemplateId) {
    ...
    public Workflow withLastModifiedAt(String lastModifiedAt) {
    ...
    public Workflow withPackage(WorkflowServicePackege _package) {
        this._package = _package;
        return this;
    }

    public Workflow withPackage(Consumer<WorkflowServicePackege> _packageSetter) {
