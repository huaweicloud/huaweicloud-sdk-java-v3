 ...
 * Response Object
 */
public class DetachDevServerVolumeResponse extends SdkResponse {
    ...
    public DetachDevServerVolumeResponse withOperationId(String operationId) {
    ...
    public DetachDevServerVolumeResponse withOperationStatus(String operationStatus) {
    ...
    public DetachDevServerVolumeResponse withOperationType(String operationType) {
    ...
    public DetachDevServerVolumeResponse withOperationError(ServerOperationError operationError) {
        this.operationError = operationError;
        return this;
    }

    public DetachDevServerVolumeResponse withOperationError(Consumer<ServerOperationError> operationErrorSetter) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        DetachDevServerVolumeResponse that = (DetachDevServerVolumeResponse) obj;
