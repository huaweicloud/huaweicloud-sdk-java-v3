 ...
 * FaceLocationDetail
 */
public class FaceLocationDetail {
    ...
    public FaceLocationDetail withTopLeftX(Integer topLeftX) {
    ...
    public FaceLocationDetail withTopLeftY(Integer topLeftY) {
    ...
    public FaceLocationDetail withBottomRightX(Integer bottomRightX) {
    ...
    public FaceLocationDetail withBottomRightY(Integer bottomRightY) {
    ...
    public String toString() {
        ...
        sb.append("class FaceLocationDetail {\n");
