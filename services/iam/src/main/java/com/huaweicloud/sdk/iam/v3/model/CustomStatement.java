...
public class CustomStatement {
    ...
    public CustomStatement withAction(List<String> action) {
        this.action = action;
        return this;
    }

    public CustomStatement addActionItem(String actionItem) {
        if (this.action == null) {
    ...
    public CustomStatement withAction(Consumer<List<String>> actionSetter) {
        if (this.action == null) {
            this.action = new ArrayList<>();
        }
    ...
    public CustomStatement withEffect(EffectEnum effect) {
        this.effect = effect;
        return this;
    }
    ...
    public CustomStatement withCondition(Map<String, Map<String, List<String>>> condition) {
        this.condition = condition;
        return this;
    }

    public CustomStatement putConditionItem(String key, Map<String, List<String>> conditionItem) {
    ...
    public CustomStatement withCondition(Consumer<Map<String, Map<String, List<String>>>> conditionSetter) {
        if (this.condition == null) {
            this.condition = new HashMap<>();
        }
    ...
    public CustomStatement withResource(Object resource) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        CustomStatement that = (CustomStatement) obj;
