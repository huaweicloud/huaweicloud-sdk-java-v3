...
public class TrustAgency {
    ...
    public TrustAgency withUrn(String urn) {
        this.urn = urn;
        return this;
    }
    ...
    public TrustAgency withTrustPolicy(String trustPolicy) {
    ...
    public TrustAgency withCreatedAt(OffsetDateTime createdAt) {
    ...
    public TrustAgency withDescription(String description) {
    ...
    public TrustAgency withMaxSessionDuration(Integer maxSessionDuration) {
    ...
    public TrustAgency withPath(String path) {
        this.path = path;
        return this;
    }
    ...
    public TrustAgency withAgencyId(String agencyId) {
    ...
    public TrustAgency withAgencyName(String agencyName) {
    ...
    public TrustAgency withTrustDomainId(String trustDomainId) {
    ...
    public TrustAgency withTrustDomainName(String trustDomainName) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        TrustAgency that = (TrustAgency) obj;
