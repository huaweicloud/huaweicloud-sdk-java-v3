...
/**
 * UpdateSAMLProviderReqBody
 */
public class UpdateSAMLProviderReqBody {
    ...
    @JsonInclude(JsonInclude.Include.NON_NULL)
    @JsonProperty(value = "remove_private_key")
    ...
    public UpdateSAMLProviderReqBody withSamlMetadataDocument(String samlMetadataDocument) {
    ...
    public UpdateSAMLProviderReqBody withAssertionEncryptionMode(AssertionEncryptionModeEnum assertionEncryptionMode) {
    ...
    public UpdateSAMLProviderReqBody withAddPrivateKey(String addPrivateKey) {
    ...
    public UpdateSAMLProviderReqBody withRemovePrivateKey(String removePrivateKey) {
     ...
     */
    public String getRemovePrivateKey() {
        return removePrivateKey;
    }

    public void setRemovePrivateKey(String removePrivateKey) {
        this.removePrivateKey = removePrivateKey;
    }

    public UpdateSAMLProviderReqBody withDescription(String description) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        UpdateSAMLProviderReqBody that = (UpdateSAMLProviderReqBody) obj;
        return Objects.equals(this.samlMetadataDocument, that.samlMetadataDocument)
            ...
            && Objects.equals(this.removePrivateKey, that.removePrivateKey)
    ...
    public int hashCode() {
        return Objects
            .hash(samlMetadataDocument, assertionEncryptionMode, addPrivateKey, removePrivateKey, description);
    }

    @Override
    public String toString() {
        StringBuilder sb = new StringBuilder();
        sb.append("class UpdateSAMLProviderReqBody {\n");
        ...
        sb.append("    removePrivateKey: ").append(toIndentedString(removePrivateKey)).append("\n");
