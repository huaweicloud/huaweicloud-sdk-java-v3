...
public class AgencyListResult {
    ...
    public AgencyListResult withCreateTime(String createTime) {
    ...
    public AgencyListResult withDescription(String description) {
    ...
    public AgencyListResult withDomainId(String domainId) {
    ...
    public AgencyListResult withDuration(String duration) {
    ...
    public AgencyListResult withExpireTime(String expireTime) {
    ...
    public AgencyListResult withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public AgencyListResult withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public AgencyListResult withTrustDomainId(String trustDomainId) {
    ...
    public AgencyListResult withTrustDomainName(String trustDomainName) {
    ...
    public AgencyListResult withAgencyUrn(String agencyUrn) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        AgencyListResult that = (AgencyListResult) obj;
