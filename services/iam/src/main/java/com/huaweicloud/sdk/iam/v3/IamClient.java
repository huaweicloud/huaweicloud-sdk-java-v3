...
public class IamClient {
     ...
     */
    public CreateUnscopeTokenByIdpInitiatedResponse createUnscopeTokenByIdpInitiated(
     ...
     */
    public SyncInvoker<CreateUnscopeTokenByIdpInitiatedRequest, CreateUnscopeTokenByIdpInitiatedResponse> createUnscopeTokenByIdpInitiatedInvoker(
        CreateUnscopeTokenByIdpInitiatedRequest request) {
        return new SyncInvoker<>(request, IamMeta.createUnscopeTokenByIdpInitiated, hcClient);
    }
