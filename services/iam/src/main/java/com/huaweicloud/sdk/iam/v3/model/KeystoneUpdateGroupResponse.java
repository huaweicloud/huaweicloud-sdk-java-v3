...
public class KeystoneUpdateGroupResponse extends SdkResponse {
    ...
    public KeystoneUpdateGroupResponse withGroup(KeystoneGroupResult group) {
        this.group = group;
        return this;
    }

    public KeystoneUpdateGroupResponse withGroup(Consumer<KeystoneGroupResult> groupSetter) {
        if(this.group == null ){
