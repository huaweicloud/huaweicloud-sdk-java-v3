...
public class InlineResponse2001SamlProvider {
    ...
    public InlineResponse2001SamlProvider withProviderId(String providerId) {
    ...
    public InlineResponse2001SamlProvider withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public InlineResponse2001SamlProvider withDescription(String description) {
    ...
    public InlineResponse2001SamlProvider withUrn(String urn) {
        this.urn = urn;
        return this;
    }
    ...
    public InlineResponse2001SamlProvider withSamlMetadataDocument(String samlMetadataDocument) {
    ...
    public InlineResponse2001SamlProvider withAssertionEncryptionMode(
    ...
    public InlineResponse2001SamlProvider withPrivateKeys(List<InlineResponse200PrivateKeys> privateKeys) {
        this.privateKeys = privateKeys;
        return this;
    }

    public InlineResponse2001SamlProvider addPrivateKeysItem(InlineResponse200PrivateKeys privateKeysItem) {
    ...
    public InlineResponse2001SamlProvider withPrivateKeys(
    ...
    public InlineResponse2001SamlProvider withTags(List<InlineResponse2001SamlProviderTags> tags) {
        this.tags = tags;
        return this;
    }

    public InlineResponse2001SamlProvider addTagsItem(InlineResponse2001SamlProviderTags tagsItem) {
        if (this.tags == null) {
    ...
    public InlineResponse2001SamlProvider withTags(Consumer<List<InlineResponse2001SamlProviderTags>> tagsSetter) {
        if (this.tags == null) {
            this.tags = new ArrayList<>();
        }
    ...
    public InlineResponse2001SamlProvider withCreatedAt(OffsetDateTime createdAt) {
    ...
    public InlineResponse2001SamlProvider withExpiresAt(OffsetDateTime expiresAt) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        InlineResponse2001SamlProvider that = (InlineResponse2001SamlProvider) obj;
        return Objects.equals(this.providerId, that.providerId) && Objects.equals(this.name, that.name)
            ...
            && Objects.equals(this.privateKeys, that.privateKeys) && Objects.equals(this.tags, that.tags)
            && Objects.equals(this.createdAt, that.createdAt) && Objects.equals(this.expiresAt, that.expiresAt);
    }
