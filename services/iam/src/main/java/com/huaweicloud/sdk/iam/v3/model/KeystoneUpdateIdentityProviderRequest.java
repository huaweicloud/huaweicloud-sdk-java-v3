...
public class KeystoneUpdateIdentityProviderRequest {
    ...
    public KeystoneUpdateIdentityProviderRequest withBody(
        Consumer<KeystoneUpdateIdentityProviderRequestBody> bodySetter) {
        if (this.body == null) {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        KeystoneUpdateIdentityProviderRequest keystoneUpdateIdentityProviderRequest =
            (KeystoneUpdateIdentityProviderRequest) o;
