 ...
 * 
 */
public class AgencyTokenUserDomain  {
    ...
    public AgencyTokenUserDomain withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public AgencyTokenUserDomain withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append("class AgencyTokenUserDomain {\n");
