...
public class ListGlobalEips {
    ...
    public ListGlobalEips withIpVersion(Integer ipVersion) {
    ...
    public ListGlobalEips withInternetBandwidthInfo(Consumer<InternetBandwidthInfo> internetBandwidthInfoSetter) {
    ...
    public ListGlobalEips withAssociateInstanceInfo(Consumer<InstanceInfo> associateInstanceInfoSetter) {
    ...
    public ListGlobalEips withTags(List<Tag> tags) {
        this.tags = tags;
        return this;
    }
    ...
    public ListGlobalEips withTags(Consumer<List<Tag>> tagsSetter) {
        if (this.tags == null) {
            this.tags = new ArrayList<>();
        }
    ...
    public ListGlobalEips withSysTags(List<Tag> sysTags) {
    ...
    public ListGlobalEips withSysTags(Consumer<List<Tag>> sysTagsSetter) {
        if (this.sysTags == null) {
            this.sysTags = new ArrayList<>();
        }
