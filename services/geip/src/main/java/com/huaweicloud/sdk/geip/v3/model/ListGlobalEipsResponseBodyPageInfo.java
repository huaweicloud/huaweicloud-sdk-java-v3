 ...
 * 分页页码信息
 */
public class ListGlobalEipsResponseBodyPageInfo {
    ...
    public ListGlobalEipsResponseBodyPageInfo withNextMarker(String nextMarker) {
    ...
    public ListGlobalEipsResponseBodyPageInfo withPreviousMarker(String previousMarker) {
    ...
    public ListGlobalEipsResponseBodyPageInfo withCurrentCount(Integer currentCount) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ListGlobalEipsResponseBodyPageInfo that = (ListGlobalEipsResponseBodyPageInfo) obj;
    ...
    public String toString() {
        ...
        sb.append("class ListGlobalEipsResponseBodyPageInfo {\n");
