 ...
 */
public class BatchCreateGlobalEip {
    ...
    public BatchCreateGlobalEip withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public BatchCreateGlobalEip withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public BatchCreateGlobalEip withDescription(String description) {
    ...
    public BatchCreateGlobalEip withDomainId(String domainId) {
    ...
    public BatchCreateGlobalEip withAccessSite(String accessSite) {
    ...
    public BatchCreateGlobalEip withGeipPoolName(String geipPoolName) {
    ...
    public BatchCreateGlobalEip withIsp(String isp) {
        this.isp = isp;
        return this;
    }
    ...
    public BatchCreateGlobalEip withIpVersion(IpVersionEnum ipVersion) {
    ...
    public BatchCreateGlobalEip withIpAddress(String ipAddress) {
    ...
    public BatchCreateGlobalEip withIpv6Address(String ipv6Address) {
    ...
    public BatchCreateGlobalEip withFreezen(Boolean freezen) {
    ...
    public BatchCreateGlobalEip withFreezenInfo(String freezenInfo) {
    ...
    public BatchCreateGlobalEip withPolluted(Boolean polluted) {
    ...
    public BatchCreateGlobalEip withStatus(StatusEnum status) {
        this.status = status;
        return this;
    }
    ...
    public BatchCreateGlobalEip withCreatedAt(OffsetDateTime createdAt) {
    ...
    public BatchCreateGlobalEip withUpdatedAt(OffsetDateTime updatedAt) {
    ...
    public BatchCreateGlobalEip withInternetBandwidthInfo(InternetBandwidthInfo internetBandwidthInfo) {
        this.internetBandwidthInfo = internetBandwidthInfo;
        return this;
    }

    public BatchCreateGlobalEip withInternetBandwidthInfo(Consumer<InternetBandwidthInfo> internetBandwidthInfoSetter) {
    ...
    public BatchCreateGlobalEip withGlobalConnectionBandwidthInfo(
    ...
    public BatchCreateGlobalEip withAssociateInstanceInfo(InstanceInfo associateInstanceInfo) {
        this.associateInstanceInfo = associateInstanceInfo;
        return this;
    }

    public BatchCreateGlobalEip withAssociateInstanceInfo(Consumer<InstanceInfo> associateInstanceInfoSetter) {
    ...
    public BatchCreateGlobalEip withIsPrePaid(Boolean isPrePaid) {
    ...
    public BatchCreateGlobalEip withTags(List<Tag> tags) {
        this.tags = tags;
        return this;
    }

    public BatchCreateGlobalEip addTagsItem(Tag tagsItem) {
        if (this.tags == null) {
    ...
    public BatchCreateGlobalEip withTags(Consumer<List<Tag>> tagsSetter) {
        if (this.tags == null) {
            this.tags = new ArrayList<>();
        }
    ...
    public BatchCreateGlobalEip withSysTags(List<Tag> sysTags) {
        this.sysTags = sysTags;
        return this;
    }

    public BatchCreateGlobalEip addSysTagsItem(Tag sysTagsItem) {
    ...
    public BatchCreateGlobalEip withSysTags(Consumer<List<Tag>> sysTagsSetter) {
        if (this.sysTags == null) {
            this.sysTags = new ArrayList<>();
        }
    ...
    public BatchCreateGlobalEip withEnterpriseProjectId(String enterpriseProjectId) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        BatchCreateGlobalEip that = (BatchCreateGlobalEip) obj;
    ...
    public String toString() {
        ...
        sb.append("class BatchCreateGlobalEip {\n");
