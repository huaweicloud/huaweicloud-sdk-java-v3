...
public class ShowGlobalEip {
    ...
    public ShowGlobalEip withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public ShowGlobalEip withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public ShowGlobalEip withDescription(String description) {
    ...
    public ShowGlobalEip withDomainId(String domainId) {
    ...
    public ShowGlobalEip withAccessSite(String accessSite) {
    ...
    public ShowGlobalEip withGeipPoolName(String geipPoolName) {
    ...
    public ShowGlobalEip withIsp(String isp) {
        this.isp = isp;
        return this;
    }
    ...
    public ShowGlobalEip withIpVersion(IpVersionEnum ipVersion) {
    ...
    public ShowGlobalEip withIpAddress(String ipAddress) {
    ...
    public ShowGlobalEip withIpv6Address(String ipv6Address) {
    ...
    public ShowGlobalEip withFreezen(Boolean freezen) {
    ...
    public ShowGlobalEip withFreezenInfo(String freezenInfo) {
    ...
    public ShowGlobalEip withPolluted(Boolean polluted) {
    ...
    public ShowGlobalEip withStatus(StatusEnum status) {
        this.status = status;
        return this;
    }
    ...
    public ShowGlobalEip withCreatedAt(OffsetDateTime createdAt) {
    ...
    public ShowGlobalEip withUpdatedAt(OffsetDateTime updatedAt) {
    ...
    public ShowGlobalEip withInternetBandwidthInfo(InternetBandwidthInfo internetBandwidthInfo) {
        this.internetBandwidthInfo = internetBandwidthInfo;
        return this;
    }

    public ShowGlobalEip withInternetBandwidthInfo(Consumer<InternetBandwidthInfo> internetBandwidthInfoSetter) {
    ...
    public ShowGlobalEip withGlobalConnectionBandwidthInfo(
    ...
    public ShowGlobalEip withAssociateInstanceInfo(InstanceInfo associateInstanceInfo) {
        this.associateInstanceInfo = associateInstanceInfo;
        return this;
    }

    public ShowGlobalEip withAssociateInstanceInfo(Consumer<InstanceInfo> associateInstanceInfoSetter) {
    ...
    public ShowGlobalEip withIsPrePaid(Boolean isPrePaid) {
    ...
    public ShowGlobalEip withTags(List<Tag> tags) {
        this.tags = tags;
        return this;
    }

    public ShowGlobalEip addTagsItem(Tag tagsItem) {
        if (this.tags == null) {
    ...
    public ShowGlobalEip withTags(Consumer<List<Tag>> tagsSetter) {
        if (this.tags == null) {
            this.tags = new ArrayList<>();
        }
    ...
    public ShowGlobalEip withSysTags(List<Tag> sysTags) {
        this.sysTags = sysTags;
        return this;
    }

    public ShowGlobalEip addSysTagsItem(Tag sysTagsItem) {
    ...
    public ShowGlobalEip withSysTags(Consumer<List<Tag>> sysTagsSetter) {
        if (this.sysTags == null) {
            this.sysTags = new ArrayList<>();
        }
    ...
    public ShowGlobalEip withEnterpriseProjectId(String enterpriseProjectId) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ShowGlobalEip that = (ShowGlobalEip) obj;
