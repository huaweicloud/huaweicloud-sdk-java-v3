...
public class ListJobs {
    ...
    public ListJobs withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public ListJobs withAction(String action) {
        this.action = action;
        return this;
    }
    ...
    public ListJobs withStatus(String status) {
        this.status = status;
        return this;
    }
    ...
    public ListJobs withErrorTask(String errorTask) {
    ...
    public ListJobs withErrorCode(String errorCode) {
    ...
    public ListJobs withErrorMessage(String errorMessage) {
    ...
    public ListJobs withStartTime(OffsetDateTime startTime) {
    ...
    public ListJobs withEndTime(OffsetDateTime endTime) {
