...
public class UpdateGlobalEipSegmentRequest {
    ...
    private UpdateGlobalEipSegmentRequestBody body;

    public UpdateGlobalEipSegmentRequest withGlobalEipSegmentId(String globalEipSegmentId) {
    ...
    public UpdateGlobalEipSegmentRequest withBody(UpdateGlobalEipSegmentRequestBody body) {
        this.body = body;
        return this;
    }

    public UpdateGlobalEipSegmentRequest withBody(Consumer<UpdateGlobalEipSegmentRequestBody> bodySetter) {
        if (this.body == null) {
            this.body = new UpdateGlobalEipSegmentRequestBody();
     ...
     * @return body
     */
    public UpdateGlobalEipSegmentRequestBody getBody() {
        return body;
    }

    public void setBody(UpdateGlobalEipSegmentRequestBody body) {
        this.body = body;
    }
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        UpdateGlobalEipSegmentRequest that = (UpdateGlobalEipSegmentRequest) obj;
