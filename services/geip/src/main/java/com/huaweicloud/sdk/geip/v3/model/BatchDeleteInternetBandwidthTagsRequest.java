...
public class BatchDeleteInternetBandwidthTagsRequest {
    ...
    public BatchDeleteInternetBandwidthTagsRequest withResourceId(String resourceId) {
    ...
    public BatchDeleteInternetBandwidthTagsRequest withBody(BatchDeleteV2RequestBody body) {
        this.body = body;
        return this;
    }

    public BatchDeleteInternetBandwidthTagsRequest withBody(Consumer<BatchDeleteV2RequestBody> bodySetter) {
        if (this.body == null) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        BatchDeleteInternetBandwidthTagsRequest that = (BatchDeleteInternetBandwidthTagsRequest) obj;
