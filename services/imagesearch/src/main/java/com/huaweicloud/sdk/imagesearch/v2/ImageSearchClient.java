...
public class ImageSearchClient {
    ...
    public SyncInvoker<RunCheckDataRequest, RunCheckDataResponse> runCheckDataInvoker(RunCheckDataRequest request) {
        return new SyncInvoker<RunCheckDataRequest, RunCheckDataResponse>(request, ImageSearchMeta.runCheckData, hcClient);
    }
    ...
    public SyncInvoker<RunDeleteDataRequest, RunDeleteDataResponse> runDeleteDataInvoker(RunDeleteDataRequest request) {
        return new SyncInvoker<RunDeleteDataRequest, RunDeleteDataResponse>(request, ImageSearchMeta.runDeleteData, hcClient);
    }
    ...
    public SyncInvoker<RunUpdateDataRequest, RunUpdateDataResponse> runUpdateDataInvoker(RunUpdateDataRequest request) {
        return new SyncInvoker<RunUpdateDataRequest, RunUpdateDataResponse>(request, ImageSearchMeta.runUpdateData, hcClient);
    }
