...
public class ImageSearchMeta {
    ...
    public static final HttpRequestDef<RunDeleteDataRequest, RunDeleteDataResponse> runDeleteData = genForrunDeleteData();
    ...
    public static final HttpRequestDef<RunUpdateDataRequest, RunUpdateDataResponse> runUpdateData = genForrunUpdateData();
