...
public class CreateSubscriptionResponse extends SdkResponse {
    ...
    public CreateSubscriptionResponse withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public CreateSubscriptionResponse withDescription(String description) {
    ...
    public CreateSubscriptionResponse withType(TypeEnum type) {
        this.type = type;
        return this;
    }
    ...
    public CreateSubscriptionResponse withStatus(StatusEnum status) {
        this.status = status;
        return this;
    }
    ...
    public CreateSubscriptionResponse withChannelId(String channelId) {
    ...
    public CreateSubscriptionResponse withChannelName(String channelName) {
    ...
    public CreateSubscriptionResponse addSourcesItem(SubscriptionSourceInfo sourcesItem) {
    ...
    public CreateSubscriptionResponse withSources(Consumer<List<SubscriptionSourceInfo>> sourcesSetter) {
        if (this.sources == null) {
            this.sources = new ArrayList<>();
        }
    ...
    public CreateSubscriptionResponse withTargets(List<SubscriptionTargetInfo> targets) {
        this.targets = targets;
        return this;
    }

    public CreateSubscriptionResponse addTargetsItem(SubscriptionTargetInfo targetsItem) {
    ...
    public CreateSubscriptionResponse withTargets(Consumer<List<SubscriptionTargetInfo>> targetsSetter) {
        if (this.targets == null) {
            this.targets = new ArrayList<>();
        }
    ...
    public CreateSubscriptionResponse withCreatedTime(String createdTime) {
    ...
    public CreateSubscriptionResponse withUpdatedTime(String updatedTime) {
