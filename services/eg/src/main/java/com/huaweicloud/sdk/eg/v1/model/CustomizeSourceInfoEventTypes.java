 ...
 */
public class CustomizeSourceInfoEventTypes {
    ...
    public CustomizeSourceInfoEventTypes withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public CustomizeSourceInfoEventTypes withDescription(String description) {
    ...
    public String toString() {
        ...
        sb.append("class CustomizeSourceInfoEventTypes {\n");
