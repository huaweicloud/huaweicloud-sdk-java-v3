...
public class ShowDetailOfSubscriptionTargetResponse extends SdkResponse {
    ...
    public ShowDetailOfSubscriptionTargetResponse withKafkaDetail(KafkaTargetDetail kafkaDetail) {
        this.kafkaDetail = kafkaDetail;
        return this;
    }

    public ShowDetailOfSubscriptionTargetResponse withKafkaDetail(Consumer<KafkaTargetDetail> kafkaDetailSetter) {
    ...
    public ShowDetailOfSubscriptionTargetResponse withSmnDetail(SmnTargetDetail smnDetail) {
        this.smnDetail = smnDetail;
        return this;
    }

    public ShowDetailOfSubscriptionTargetResponse withSmnDetail(Consumer<SmnTargetDetail> smnDetailSetter) {
    ...
    public ShowDetailOfSubscriptionTargetResponse withEgDetail(EgTargetDetail egDetail) {
        this.egDetail = egDetail;
        return this;
    }

    public ShowDetailOfSubscriptionTargetResponse withEgDetail(Consumer<EgTargetDetail> egDetailSetter) {
    ...
    public ShowDetailOfSubscriptionTargetResponse withApigwDetail(ApigwTargetDetail apigwDetail) {
        this.apigwDetail = apigwDetail;
        return this;
    }

    public ShowDetailOfSubscriptionTargetResponse withApigwDetail(Consumer<ApigwTargetDetail> apigwDetailSetter) {
    ...
    public ShowDetailOfSubscriptionTargetResponse withRetryTimes(Integer retryTimes) {
