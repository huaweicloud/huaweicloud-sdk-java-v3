...
public class UpdateEventSchemaResponse extends SdkResponse {
    ...
    public UpdateEventSchemaResponse withDataSample(String dataSample) {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        UpdateEventSchemaResponse updateEventSchemaResponse = (UpdateEventSchemaResponse) o;
        return Objects.equals(this.id, updateEventSchemaResponse.id)
            && Objects.equals(this.name, updateEventSchemaResponse.name)
            && Objects.equals(this.description, updateEventSchemaResponse.description)
            && Objects.equals(this.compatibility, updateEventSchemaResponse.compatibility)
            && Objects.equals(this.providerType, updateEventSchemaResponse.providerType)
            && Objects.equals(this.format, updateEventSchemaResponse.format)
            && Objects.equals(this.numberOfVersions, updateEventSchemaResponse.numberOfVersions)
            && Objects.equals(this.createdTime, updateEventSchemaResponse.createdTime)
            && Objects.equals(this.updatedTime, updateEventSchemaResponse.updatedTime)
            && Objects.equals(this.dataSample, updateEventSchemaResponse.dataSample)
            && Objects.equals(this.version, updateEventSchemaResponse.version)
            && Objects.equals(this.definition, updateEventSchemaResponse.definition)
            && Objects.equals(this.xRequestId, updateEventSchemaResponse.xRequestId);
    }
