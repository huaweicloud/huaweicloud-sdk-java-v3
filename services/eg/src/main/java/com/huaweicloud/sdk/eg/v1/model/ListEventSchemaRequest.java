 ...
 * Request Object
 */
public class ListEventSchemaRequest {
    ...
    public ListEventSchemaRequest withOffset(Integer offset) {
        this.offset = offset;
        return this;
    }
    ...
    public ListEventSchemaRequest withLimit(Integer limit) {
        this.limit = limit;
        return this;
    }
    ...
    public ListEventSchemaRequest withSort(String sort) {
        this.sort = sort;
        return this;
    }
    ...
    public ListEventSchemaRequest withProviderType(ProviderTypeEnum providerType) {
    ...
    public ListEventSchemaRequest withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public ListEventSchemaRequest withFuzzyName(String fuzzyName) {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ListEventSchemaRequest listEventSchemaRequest = (ListEventSchemaRequest) o;
        return Objects.equals(this.offset, listEventSchemaRequest.offset)
            && Objects.equals(this.limit, listEventSchemaRequest.limit)
            && Objects.equals(this.sort, listEventSchemaRequest.sort)
            && Objects.equals(this.providerType, listEventSchemaRequest.providerType)
            && Objects.equals(this.name, listEventSchemaRequest.name)
            && Objects.equals(this.fuzzyName, listEventSchemaRequest.fuzzyName);
    }
    ...
    public String toString() {
        ...
        sb.append("class ListEventSchemaRequest {\n");
