...
public class UpdateGroupRequest {
    ...
    public UpdateGroupRequest withXSecurityToken(String xSecurityToken) {
    ...
    public UpdateGroupRequest withBody(UpdateGroupReqBody body) {
        this.body = body;
        return this;
    }

    public UpdateGroupRequest withBody(Consumer<UpdateGroupReqBody> bodySetter) {
        if (this.body == null) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        UpdateGroupRequest that = (UpdateGroupRequest) obj;
        return Objects.equals(this.xSecurityToken, that.xSecurityToken)
            && Objects.equals(this.identityStoreId, that.identityStoreId) && Objects.equals(this.groupId, that.groupId)
            && Objects.equals(this.body, that.body);
    }

    @Override
    public int hashCode() {
        return Objects.hash(xSecurityToken, identityStoreId, groupId, body);
    }
