...
public class UpdatePasswordPolicyReqBody {
    ...
    public UpdatePasswordPolicyReqBody withPasswordPolicy(PasswordPolicyDto passwordPolicy) {
        this.passwordPolicy = passwordPolicy;
        return this;
    }

    public UpdatePasswordPolicyReqBody withPasswordPolicy(Consumer<PasswordPolicyDto> passwordPolicySetter) {
