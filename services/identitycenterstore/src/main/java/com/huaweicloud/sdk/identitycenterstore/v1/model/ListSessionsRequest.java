...
public class ListSessionsRequest {
    ...
    public ListSessionsRequest withXSecurityToken(String xSecurityToken) {
    ...
    public ListSessionsRequest withIdentityStoreId(String identityStoreId) {
    ...
    public ListSessionsRequest withUserId(String userId) {
        this.userId = userId;
        return this;
    }
