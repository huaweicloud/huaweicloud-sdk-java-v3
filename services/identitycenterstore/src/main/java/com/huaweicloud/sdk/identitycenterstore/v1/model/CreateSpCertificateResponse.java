 ...
 * Response Object
 */
public class CreateSpCertificateResponse extends SdkResponse {
    ...
    public CreateSpCertificateResponse withCertificateId(String certificateId) {
    ...
    public CreateSpCertificateResponse withX509certificate(String x509certificate) {
    ...
    public CreateSpCertificateResponse withAlgorithm(String algorithm) {
    ...
    public CreateSpCertificateResponse withExpiryDate(Long expiryDate) {
    ...
    public CreateSpCertificateResponse withState(StateEnum state) {
        this.state = state;
        return this;
    }
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        CreateSpCertificateResponse that = (CreateSpCertificateResponse) obj;
    ...
    public String toString() {
        ...
        sb.append("class CreateSpCertificateResponse {\n");
