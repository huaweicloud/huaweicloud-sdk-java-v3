...
public class GetUserIdRequest {
    ...
    private GetUserIdReqBody body;

    public GetUserIdRequest withXSecurityToken(String xSecurityToken) {
    ...
    public GetUserIdRequest withBody(GetUserIdReqBody body) {
        this.body = body;
        return this;
    }

    public GetUserIdRequest withBody(Consumer<GetUserIdReqBody> bodySetter) {
        if (this.body == null) {
            this.body = new GetUserIdReqBody();
     ...
     * @return body
     */
    public GetUserIdReqBody getBody() {
        return body;
    }

    public void setBody(GetUserIdReqBody body) {
        this.body = body;
    }
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        GetUserIdRequest that = (GetUserIdRequest) obj;
    ...
    public String toString() {
        ...
        sb.append("class GetUserIdRequest {\n");
