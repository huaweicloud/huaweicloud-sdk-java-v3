...
public class UpdateUserRequest {
    ...
    public UpdateUserRequest withXSecurityToken(String xSecurityToken) {
    ...
    public UpdateUserRequest withBody(UpdateUserReqBody body) {
        this.body = body;
        return this;
    }

    public UpdateUserRequest withBody(Consumer<UpdateUserReqBody> bodySetter) {
        if (this.body == null) {
