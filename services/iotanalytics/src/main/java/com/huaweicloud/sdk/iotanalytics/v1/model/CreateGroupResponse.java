...
public class CreateGroupResponse extends SdkResponse {
    ...
    @JacksonXmlProperty(localName = "warm_data_usage")
    ...
    @JacksonXmlProperty(localName = "data_store_count")
    ...
    @JacksonXmlProperty(localName = "cold_data_usage")
    ...
    @JacksonXmlProperty(localName = "warm_data_retention_policy")
    ...
    @JacksonXmlProperty(localName = "cold_data_retention_policy")
    ...
    public CreateGroupResponse withWarmDataUsage(Long warmDataUsage) {
    ...
    public CreateGroupResponse withDataStoreCount(Long dataStoreCount) {
    ...
    public CreateGroupResponse withColdDataUsage(Long coldDataUsage) {
    ...
    public CreateGroupResponse withWarmDataRetentionPolicy(String warmDataRetentionPolicy) {
    ...
    public CreateGroupResponse withColdDataRetentionPolicy(String coldDataRetentionPolicy) {
    ...
    public CreateGroupResponse withCreatedTime(String createdTime) {
    ...
    public CreateGroupResponse withModifiedTime(String modifiedTime) {
    ...
    public CreateGroupResponse withType(String type) {
        this.type = type;
        return this;
    }
