...
public class CreateBatchJobRequest {
    ...
    public CreateBatchJobRequest withBody(Job body) {
        this.body = body;
        return this;
    }

    public CreateBatchJobRequest withBody(Consumer<Job> bodySetter) {
        if (this.body == null) {
            this.body = new Job();
    ...
    public boolean equals(java.lang.Object o) {
        ...
        return Objects.equals(this.body, createBatchJobRequest.body);
    }
