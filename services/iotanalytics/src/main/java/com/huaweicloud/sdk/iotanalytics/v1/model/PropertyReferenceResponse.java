...
public class PropertyReferenceResponse {
    ...
    public PropertyReferenceResponse withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public PropertyReferenceResponse withAssetModelId(String assetModelId) {
    ...
    public PropertyReferenceResponse withAssetModelName(String assetModelName) {
    ...
    public PropertyReferenceResponse withPropertyName(String propertyName) {
    ...
    public PropertyReferenceResponse withAssetId(String assetId) {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(type, assetModelId, assetModelName, propertyName, assetId);
    }
