...
public class OutputResponse {
    ...
    @JacksonXmlProperty(localName = "output_asset_model_id")
    ...
    public OutputResponse withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public OutputResponse withOutputStaticAssetId(String outputStaticAssetId) {
    ...
    public OutputResponse withOutputDynamicAssetId(String outputDynamicAssetId) {
    ...
    public OutputResponse withOutputAssetModelId(String outputAssetModelId) {
    ...
    public OutputResponse withOutputProperty(String outputProperty) {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(name, outputStaticAssetId, outputDynamicAssetId, outputAssetModelId, outputProperty);
    }
