...
public class CreateRouteTableResponse extends SdkResponse {
    ...
    public CreateRouteTableResponse withRoutetable(RouteTableResp routetable) {
        this.routetable = routetable;
        return this;
    }

    public CreateRouteTableResponse withRoutetable(Consumer<RouteTableResp> routetableSetter) {
