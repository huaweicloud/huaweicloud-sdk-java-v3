...
public class CreateFirewallTagRequestBody {
    ...
    public CreateFirewallTagRequestBody withTag(ResourceTag tag) {
        this.tag = tag;
        return this;
    }

    public CreateFirewallTagRequestBody withTag(Consumer<ResourceTag> tagSetter) {
        if (this.tag == null) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        CreateFirewallTagRequestBody that = (CreateFirewallTagRequestBody) obj;
