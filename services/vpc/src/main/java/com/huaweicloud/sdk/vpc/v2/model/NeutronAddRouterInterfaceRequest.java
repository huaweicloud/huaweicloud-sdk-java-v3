...
public class NeutronAddRouterInterfaceRequest {
    ...
    public NeutronAddRouterInterfaceRequest withRouterId(String routerId) {
    ...
    public NeutronAddRouterInterfaceRequest withBody(RouterInterfaceRequestBody body) {
        this.body = body;
        return this;
    }

    public NeutronAddRouterInterfaceRequest withBody(Consumer<RouterInterfaceRequestBody> bodySetter) {
        if (this.body == null) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        NeutronAddRouterInterfaceRequest that = (NeutronAddRouterInterfaceRequest) obj;
