...
public class CreatePortTagRequestBody {
    ...
    public CreatePortTagRequestBody withTag(ResourceTag tag) {
        this.tag = tag;
        return this;
    }

    public CreatePortTagRequestBody withTag(Consumer<ResourceTag> tagSetter) {
        if (this.tag == null) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        CreatePortTagRequestBody that = (CreatePortTagRequestBody) obj;
