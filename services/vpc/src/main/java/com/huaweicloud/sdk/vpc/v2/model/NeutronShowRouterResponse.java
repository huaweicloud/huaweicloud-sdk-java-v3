 ...
 * Response Object
 */
public class NeutronShowRouterResponse extends SdkResponse {
    ...
    public NeutronShowRouterResponse withRouter(NeutronRouter router) {
        this.router = router;
        return this;
    }

    public NeutronShowRouterResponse withRouter(Consumer<NeutronRouter> routerSetter) {
        if (this.router == null) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        NeutronShowRouterResponse that = (NeutronShowRouterResponse) obj;
    ...
    public String toString() {
        ...
        sb.append("class NeutronShowRouterResponse {\n");
