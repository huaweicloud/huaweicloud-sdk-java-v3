...
public class NeutronFirewallGroup  {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        return Objects.equals(this.id, neutronFirewallGroup.id) &&
            Objects.equals(this.name, neutronFirewallGroup.name) &&
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, name, description, adminStateUp, egressFirewallPolicyId, ingressFirewallPolicyId, ports, _public, status, tenantId, projectId, createdAt, updatedAt);
    }
    @Override
