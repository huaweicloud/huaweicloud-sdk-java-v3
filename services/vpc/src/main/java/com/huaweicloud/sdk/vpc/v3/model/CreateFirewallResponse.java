...
public class CreateFirewallResponse extends SdkResponse {
    ...
    public CreateFirewallResponse withFirewall(FirewallDetail firewall) {
        this.firewall = firewall;
        return this;
    }

    public CreateFirewallResponse withFirewall(Consumer<FirewallDetail> firewallSetter) {
    ...
    public CreateFirewallResponse withRequestId(String requestId) {
