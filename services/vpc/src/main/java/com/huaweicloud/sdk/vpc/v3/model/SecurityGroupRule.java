...
public class SecurityGroupRule  {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, description, securityGroupId, direction, protocol, ethertype, multiport, action, priority, remoteGroupId, remoteIpPrefix, remoteAddressGroupId, createdAt, updatedAt, projectId);
    }
    @Override
