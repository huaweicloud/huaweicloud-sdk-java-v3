 ...
 * 删除路由条目的字段
 */
public class DelRouteTableRoute {
    ...
    public DelRouteTableRoute withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public DelRouteTableRoute withDestination(String destination) {
    ...
    public DelRouteTableRoute withNexthop(String nexthop) {
    ...
    public DelRouteTableRoute withDescription(String description) {
    ...
    public String toString() {
        ...
        sb.append("class DelRouteTableRoute {\n");
