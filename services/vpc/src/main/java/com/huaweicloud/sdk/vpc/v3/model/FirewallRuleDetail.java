...
public class FirewallRuleDetail {
    ...
    public FirewallRuleDetail withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public FirewallRuleDetail withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public FirewallRuleDetail withDescription(String description) {
    ...
    public FirewallRuleDetail withAction(String action) {
        this.action = action;
        return this;
    }
    ...
    public FirewallRuleDetail withIpVersion(Integer ipVersion) {
    ...
    public FirewallRuleDetail withSourceIpAddress(String sourceIpAddress) {
    ...
    public FirewallRuleDetail withDestinationIpAddress(String destinationIpAddress) {
    ...
    public FirewallRuleDetail withSourcePort(String sourcePort) {
    ...
    public FirewallRuleDetail withDestinationPort(String destinationPort) {
    ...
    public FirewallRuleDetail withSourceAddressGroupId(String sourceAddressGroupId) {
    ...
    public FirewallRuleDetail withDestinationAddressGroupId(String destinationAddressGroupId) {
    ...
    public FirewallRuleDetail withEnabled(Boolean enabled) {
