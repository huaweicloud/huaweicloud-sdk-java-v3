 ...
 * Response Object
 */
public class NeutronUpdateRouterResponse extends SdkResponse {
    ...
    public NeutronUpdateRouterResponse withRouter(NeutronRouter router) {
        this.router = router;
        return this;
    }

    public NeutronUpdateRouterResponse withRouter(Consumer<NeutronRouter> routerSetter) {
        if (this.router == null) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        NeutronUpdateRouterResponse that = (NeutronUpdateRouterResponse) obj;
