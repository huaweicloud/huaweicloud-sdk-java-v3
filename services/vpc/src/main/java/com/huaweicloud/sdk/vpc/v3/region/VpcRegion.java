package com.huaweicloud.sdk.vpc.v3.region;
...
public class VpcRegion {
    ...
    public static final Region AF_SOUTH_1 = new Region("af-south-1", "https://vpc.af-south-1.myhuaweicloud.com");

    public static final Region CN_NORTH_4 = new Region("cn-north-4", "https://vpc.cn-north-4.myhuaweicloud.com");

    public static final Region CN_NORTH_1 = new Region("cn-north-1", "https://vpc.cn-north-1.myhuaweicloud.com");

    public static final Region CN_EAST_2 = new Region("cn-east-2", "https://vpc.cn-east-2.myhuaweicloud.com");
    ...
    public static final Region CN_SOUTH_2 = new Region("cn-south-2", "https://vpc.cn-south-2.myhuaweicloud.com");

    public static final Region CN_NORTH_2 = new Region("cn-north-2", "https://vpc.cn-north-2.myhuaweicloud.com");

    public static final Region LA_SOUTH_2 = new Region("la-south-2", "https://vpc.la-south-2.myhuaweicloud.com");

    public static final Region NA_MEXICO_1 = new Region("na-mexico-1", "https://vpc.na-mexico-1.myhuaweicloud.com");

    public static final Region AP_SOUTHEAST_4 =
        new Region("ap-southeast-4", "https://vpc.ap-southeast-4.myhuaweicloud.com");
    ...
    public static final Region RU_MOSCOW_1 = new Region("ru-moscow-1", "https://vpc.ru-moscow-1.myhuaweicloud.com");

    public static final Region CN_EAST_4 = new Region("cn-east-4", "https://vpc.cn-east-4.myhuaweicloud.com");

    public static final Region AF_NORTH_1 = new Region("af-north-1", "https://vpc.af-north-1.myhuaweicloud.com");
    ...
    public static final Region CN_SOUTHWEST_3 =
        new Region("cn-southwest-3", "https://vpc.cn-southwest-3.myhuaweicloud.com");

    public static final Region CN_NORTH_12 = new Region("cn-north-12", "https://vpc.cn-north-12.myhuaweicloud.com");

    private static final IRegionProvider PROVIDER = RegionProviderChain.getDefaultRegionProviderChain("VPC");
    ...
    public static Region valueOf(String regionId) {
        ...
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "region id '%s' is not in the following supported regions of service VPC: [%s]",
            regionId,
