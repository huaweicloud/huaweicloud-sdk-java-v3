 ...
 * 
 */
public class FirewallInsertRuleItemOption {
    ...
    public FirewallInsertRuleItemOption withDescription(String description) {
    ...
    public FirewallInsertRuleItemOption withAction(String action) {
        this.action = action;
        return this;
    }
    ...
    public FirewallInsertRuleItemOption withProtocol(String protocol) {
    ...
    public FirewallInsertRuleItemOption withIpVersion(Integer ipVersion) {
    ...
    public FirewallInsertRuleItemOption withSourceIpAddress(String sourceIpAddress) {
    ...
    public FirewallInsertRuleItemOption withDestinationIpAddress(String destinationIpAddress) {
    ...
    public FirewallInsertRuleItemOption withSourcePort(String sourcePort) {
    ...
    public FirewallInsertRuleItemOption withDestinationPort(String destinationPort) {
    ...
    public FirewallInsertRuleItemOption withSourceAddressGroupId(String sourceAddressGroupId) {
    ...
    public FirewallInsertRuleItemOption withDestinationAddressGroupId(String destinationAddressGroupId) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        FirewallInsertRuleItemOption that = (FirewallInsertRuleItemOption) obj;
        return Objects.equals(this.name, that.name) && Objects.equals(this.description, that.description)
            && Objects.equals(this.action, that.action) && Objects.equals(this.protocol, that.protocol)
    ...
    public String toString() {
        ...
        sb.append("class FirewallInsertRuleItemOption {\n");
