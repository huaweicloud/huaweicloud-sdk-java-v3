 ...
 * 新增路由条目的字段
 */
public class AddRouteTableRoute {
    ...
    public AddRouteTableRoute withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public AddRouteTableRoute withDestination(String destination) {
    ...
    public AddRouteTableRoute withNexthop(String nexthop) {
    ...
    public AddRouteTableRoute withDescription(String description) {
    ...
    public String toString() {
        ...
        sb.append("class AddRouteTableRoute {\n");
