 ...
 */
public class GenerateMacRequestBody {
    ...
    public GenerateMacRequestBody withKeyId(String keyId) {
        this.keyId = keyId;
        return this;
    }
    ...
    public GenerateMacRequestBody withMacAlgorithm(MacAlgorithmEnum macAlgorithm) {
    ...
    public GenerateMacRequestBody withMessage(String message) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        GenerateMacRequestBody that = (GenerateMacRequestBody) obj;
    ...
    @Override
    public int hashCode() {
        return Objects.hash(keyId, macAlgorithm, message);
    }

    @Override
    public String toString() {
        StringBuilder sb = new StringBuilder();
        sb.append("class GenerateMacRequestBody {\n");
