...
public class DisableKeyRotationRequest  {
    ...
    public DisableKeyRotationRequest withVersionId(String versionId) {
    ...
    public DisableKeyRotationRequest withBody(OperateKeyReq body) {
        this.body = body;
        return this;
    }

    public DisableKeyRotationRequest withBody(Consumer<OperateKeyReq> bodySetter) {
        if(this.body == null ){
    ...
    public boolean equals(java.lang.Object o) {
        ...
        return Objects.equals(this.versionId, disableKeyRotationRequest.versionId) &&
            Objects.equals(this.body, disableKeyRotationRequest.body);
    }
    @Override
    public int hashCode() {
