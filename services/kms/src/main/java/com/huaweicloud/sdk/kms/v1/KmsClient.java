...
public class KmsClient {
     ...
     */
    public SyncInvoker<CreateSecretVersionRequest, CreateSecretVersionResponse> createSecretVersionInvoker(CreateSecretVersionRequest request) {
        return new SyncInvoker<CreateSecretVersionRequest, CreateSecretVersionResponse>(request, KmsMeta.createSecretVersion, hcClient);
    }
     ...
     */
    public SyncInvoker<DeleteSecretForScheduleRequest, DeleteSecretForScheduleResponse> deleteSecretForScheduleInvoker(DeleteSecretForScheduleRequest request) {
        return new SyncInvoker<DeleteSecretForScheduleRequest, DeleteSecretForScheduleResponse>(request, KmsMeta.deleteSecretForSchedule, hcClient);
    }
     ...
     */
    public SyncInvoker<DeleteSecretStageRequest, DeleteSecretStageResponse> deleteSecretStageInvoker(DeleteSecretStageRequest request) {
        return new SyncInvoker<DeleteSecretStageRequest, DeleteSecretStageResponse>(request, KmsMeta.deleteSecretStage, hcClient);
    }
     ...
     */
    public SyncInvoker<ListSecretStageRequest, ListSecretStageResponse> listSecretStageInvoker(ListSecretStageRequest request) {
        return new SyncInvoker<ListSecretStageRequest, ListSecretStageResponse>(request, KmsMeta.listSecretStage, hcClient);
    }
     ...
     */
    public SyncInvoker<ListSecretVersionsRequest, ListSecretVersionsResponse> listSecretVersionsInvoker(ListSecretVersionsRequest request) {
        return new SyncInvoker<ListSecretVersionsRequest, ListSecretVersionsResponse>(request, KmsMeta.listSecretVersions, hcClient);
    }
     ...
     */
    public SyncInvoker<ShowSecretVersionRequest, ShowSecretVersionResponse> showSecretVersionInvoker(ShowSecretVersionRequest request) {
        return new SyncInvoker<ShowSecretVersionRequest, ShowSecretVersionResponse>(request, KmsMeta.showSecretVersion, hcClient);
    }
     ...
     */
    public SyncInvoker<UpdateSecretStageRequest, UpdateSecretStageResponse> updateSecretStageInvoker(UpdateSecretStageRequest request) {
        return new SyncInvoker<UpdateSecretStageRequest, UpdateSecretStageResponse>(request, KmsMeta.updateSecretStage, hcClient);
    }
