...
public class EnableKeyRotationRequest  {
    ...
    public EnableKeyRotationRequest withBody(OperateKeyReq body) {
        this.body = body;
        return this;
    }

    public EnableKeyRotationRequest withBody(Consumer<OperateKeyReq> bodySetter) {
        if(this.body == null ){
    ...
    public boolean equals(java.lang.Object o) {
        ...
        return Objects.equals(this.versionId, enableKeyRotationRequest.versionId) &&
            Objects.equals(this.body, enableKeyRotationRequest.body);
    }
    @Override
    public int hashCode() {
