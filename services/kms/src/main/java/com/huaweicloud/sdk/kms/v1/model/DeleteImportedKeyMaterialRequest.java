...
public class DeleteImportedKeyMaterialRequest  {
    ...
    public DeleteImportedKeyMaterialRequest withVersionId(String versionId) {
    ...
    public DeleteImportedKeyMaterialRequest withBody(OperateKeyReq body) {
        this.body = body;
        return this;
    }

    public DeleteImportedKeyMaterialRequest withBody(Consumer<OperateKeyReq> bodySetter) {
        if(this.body == null ){
    ...
    public boolean equals(java.lang.Object o) {
        ...
        return Objects.equals(this.versionId, deleteImportedKeyMaterialRequest.versionId) &&
            Objects.equals(this.body, deleteImportedKeyMaterialRequest.body);
    }
    @Override
    public int hashCode() {
