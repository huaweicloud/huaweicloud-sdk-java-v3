...
public class CreateShortChainParam {
    ...
    public CreateShortChainParam withDyncParams(Map<String, String> dyncParams) {
    ...
    public CreateShortChainParam withDyncParams(Consumer<Map<String, String>> dyncParamsSetter) {
        if (this.dyncParams == null) {
            this.dyncParams = new HashMap<>();
        }
    ...
    public CreateShortChainParam withCustomUrl(String customUrl) {
    ...
    public CreateShortChainParam withCustomShortCode(String customShortCode) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        CreateShortChainParam that = (CreateShortChainParam) obj;
    ...
    public String toString() {
        ...
        sb.append("class CreateShortChainParam {\n");
