...
public class SmsSignatureInfo {
    ...
    public SmsSignatureInfo withSignatureName(String signatureName) {
    ...
    public SmsSignatureInfo withSignatureId(String signatureId) {
    ...
    public SmsSignatureInfo withSignatureType(String signatureType) {
    ...
    public SmsSignatureInfo withAppName(String appName) {
    ...
    public SmsSignatureInfo withAppId(String appId) {
        this.appId = appId;
        return this;
    }
    ...
    public SmsSignatureInfo withApplyDesc(String applyDesc) {
    ...
    public SmsSignatureInfo withChannelNum(String channelNum) {
    ...
    public SmsSignatureInfo withFileId(String fileId) {
        this.fileId = fileId;
        return this;
    }
    ...
    public SmsSignatureInfo withStatus(StatusEnum status) {
        this.status = status;
        return this;
    }
    ...
    public SmsSignatureInfo withSignatureSource(Integer signatureSource) {
    ...
    public SmsSignatureInfo withIsInvolvedThird(String isInvolvedThird) {
    ...
    public SmsSignatureInfo withPowerAttorneyFileId(String powerAttorneyFileId) {
    ...
    public SmsSignatureInfo withUrgeStatus(String urgeStatus) {
    ...
    public SmsSignatureInfo withUrgeTime(String urgeTime) {
    ...
    public SmsSignatureInfo withUrgeDesc(String urgeDesc) {
    ...
    public SmsSignatureInfo withReviewDesc(String reviewDesc) {
    ...
    public SmsSignatureInfo withSourceTitleContent(String sourceTitleContent) {
    ...
    public SmsSignatureInfo withCreateTime(String createTime) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        SmsSignatureInfo that = (SmsSignatureInfo) obj;
    ...
    public String toString() {
        ...
        sb.append("class SmsSignatureInfo {\n");
