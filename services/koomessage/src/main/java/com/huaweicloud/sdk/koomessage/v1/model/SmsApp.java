...
public class SmsApp {
    ...
    public SmsApp withAppId(String appId) {
        this.appId = appId;
        return this;
    }
    ...
    public SmsApp withAppName(String appName) {
    ...
    public SmsApp withStatus(StatusEnum status) {
        this.status = status;
        return this;
    }
    ...
    public SmsApp withRegion(String region) {
        this.region = region;
        return this;
    }
    ...
    public SmsApp withCreateTime(String createTime) {
    ...
    public SmsApp withUpLinkAddr(String upLinkAddr) {
