 ...
 * Response Object
 */
public class ShowAimMsgTemplateDetailResponse extends SdkResponse {
    ...
    public ShowAimMsgTemplateDetailResponse withTemplateId(String templateId) {
    ...
    public ShowAimMsgTemplateDetailResponse withTemplateName(String templateName) {
    ...
    public ShowAimMsgTemplateDetailResponse withCreateTime(String createTime) {
    ...
    public ShowAimMsgTemplateDetailResponse withTemplateType(String templateType) {
    ...
    public ShowAimMsgTemplateDetailResponse withAppId(String appId) {
        this.appId = appId;
        return this;
    }
    ...
    public ShowAimMsgTemplateDetailResponse withAppName(String appName) {
    ...
    public ShowAimMsgTemplateDetailResponse withSignatureId(String signatureId) {
    ...
    public ShowAimMsgTemplateDetailResponse withTemplateContent(String templateContent) {
    ...
    public ShowAimMsgTemplateDetailResponse withTemplateDesc(String templateDesc) {
    ...
    public ShowAimMsgTemplateDetailResponse withHasVariable(String hasVariable) {
    ...
    public ShowAimMsgTemplateDetailResponse withFlowStatus(String flowStatus) {
    ...
    public ShowAimMsgTemplateDetailResponse withStatus(String status) {
        this.status = status;
        return this;
    }
    ...
    public ShowAimMsgTemplateDetailResponse withUniversalTemplate(Integer universalTemplate) {
    ...
    public ShowAimMsgTemplateDetailResponse withUrgeStatus(String urgeStatus) {
    ...
    public ShowAimMsgTemplateDetailResponse withUrgeTime(String urgeTime) {
    ...
    public ShowAimMsgTemplateDetailResponse withUrgeDesc(String urgeDesc) {
    ...
    public ShowAimMsgTemplateDetailResponse withReviewDesc(String reviewDesc) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ShowAimMsgTemplateDetailResponse that = (ShowAimMsgTemplateDetailResponse) obj;
    ...
    public String toString() {
        ...
        sb.append("class ShowAimMsgTemplateDetailResponse {\n");
