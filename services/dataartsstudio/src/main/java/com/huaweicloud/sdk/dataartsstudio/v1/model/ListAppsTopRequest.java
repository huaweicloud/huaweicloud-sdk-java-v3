 ...
 * Request Object
 */
public class ListAppsTopRequest {
    ...
    public ListAppsTopRequest withWorkspace(String workspace) {
    ...
    public ListAppsTopRequest withDlmType(DlmTypeEnum dlmType) {
    ...
    public ListAppsTopRequest withStartTime(Long startTime) {
    ...
    public ListAppsTopRequest withEndTime(Long endTime) {
    ...
    public ListAppsTopRequest withTimeUnit(TimeUnitEnum timeUnit) {
    ...
    public ListAppsTopRequest withTopNum(Integer topNum) {
        this.topNum = topNum;
        return this;
    }
    ...
    public ListAppsTopRequest withOrderBy(OrderByEnum orderBy) {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(workspace, dlmType, startTime, endTime, timeUnit, topNum, orderBy);
    }

    @Override
    public String toString() {
        StringBuilder sb = new StringBuilder();
        sb.append("class ListAppsTopRequest {\n");
