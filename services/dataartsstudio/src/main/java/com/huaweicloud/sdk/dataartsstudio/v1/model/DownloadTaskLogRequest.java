...
public class DownloadTaskLogRequest implements ProgressRequest {
    ...
    public DownloadTaskLogRequest withWorkspace(String workspace) {
    ...
    public DownloadTaskLogRequest withXProjectId(String xProjectId) {
    ...
    public DownloadTaskLogRequest withTaskId(String taskId) {
        this.taskId = taskId;
        return this;
    }
    ...
    public DownloadTaskLogRequest withPath(String path) {
        this.path = path;
        return this;
    }
    ...
    public DownloadTaskLogRequest withRange(String range) {
        this.range = range;
        return this;
    }
    ...
    @Override
    public int hashCode() {
        return Objects.hash(workspace, xProjectId, taskId, path, range);
    }
