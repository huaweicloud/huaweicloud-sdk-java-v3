...
public class CreateAppRequest {
    ...
    private AppRequestDTO body;

    public CreateAppRequest withWorkspace(String workspace) {
    ...
    public CreateAppRequest withDlmType(DlmTypeEnum dlmType) {
    ...
    public CreateAppRequest withBody(AppRequestDTO body) {
        this.body = body;
        return this;
    }

    public CreateAppRequest withBody(Consumer<AppRequestDTO> bodySetter) {
        if (this.body == null) {
            this.body = new AppRequestDTO();
     ...
     * @return body
     */
    public AppRequestDTO getBody() {
        return body;
    }

    public void setBody(AppRequestDTO body) {
        this.body = body;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        return Objects.equals(this.workspace, createAppRequest.workspace)
            && Objects.equals(this.dlmType, createAppRequest.dlmType)
            && Objects.equals(this.body, createAppRequest.body);
    }
