 ...
 * Response Object
 */
public class ShowAppInfoResponse extends SdkResponse {
    ...
    public ShowAppInfoResponse withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public ShowAppInfoResponse withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public ShowAppInfoResponse withDescription(String description) {
    ...
    public ShowAppInfoResponse withAppKey(String appKey) {
        this.appKey = appKey;
        return this;
    }
    ...
    public ShowAppInfoResponse withAppSecret(String appSecret) {
    ...
    public ShowAppInfoResponse withRegisterTime(Long registerTime) {
    ...
    public ShowAppInfoResponse withUpdateTime(Long updateTime) {
    ...
    public ShowAppInfoResponse withCreateUser(String createUser) {
    ...
    public ShowAppInfoResponse withUpdateUser(String updateUser) {
    ...
    public ShowAppInfoResponse withAppType(AppTypeEnum appType) {
    ...
    public String toString() {
        ...
        sb.append("class ShowAppInfoResponse {\n");
