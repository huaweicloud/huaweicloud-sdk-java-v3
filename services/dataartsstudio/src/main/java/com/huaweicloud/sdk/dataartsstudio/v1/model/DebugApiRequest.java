...
public class DebugApiRequest {
    ...
    private ApiTestDTO body;

    public DebugApiRequest withWorkspace(String workspace) {
    ...
    public DebugApiRequest withDlmType(DlmTypeEnum dlmType) {
    ...
    public DebugApiRequest withApiId(String apiId) {
        this.apiId = apiId;
        return this;
    }
    ...
    public DebugApiRequest withInstanceId(String instanceId) {
    ...
    public DebugApiRequest withBody(ApiTestDTO body) {
        this.body = body;
        return this;
    }

    public DebugApiRequest withBody(Consumer<ApiTestDTO> bodySetter) {
        if (this.body == null) {
            this.body = new ApiTestDTO();
     ...
     * @return body
     */
    public ApiTestDTO getBody() {
        return body;
    }

    public void setBody(ApiTestDTO body) {
        this.body = body;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        DebugApiRequest debugApiRequest = (DebugApiRequest) o;
        return Objects.equals(this.workspace, debugApiRequest.workspace)
            && Objects.equals(this.dlmType, debugApiRequest.dlmType)
            && Objects.equals(this.apiId, debugApiRequest.apiId)
            && Objects.equals(this.instanceId, debugApiRequest.instanceId)
            && Objects.equals(this.body, debugApiRequest.body);
    }
    ...
    public String toString() {
        ...
        sb.append("class DebugApiRequest {\n");
