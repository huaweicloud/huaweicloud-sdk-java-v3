...
public class UpdateSecuritySecrecyLevelResponse extends SdkResponse {
    ...
    public UpdateSecuritySecrecyLevelResponse withSecrecyLevelId(String secrecyLevelId) {
    ...
    public UpdateSecuritySecrecyLevelResponse withSecrecyLevelName(String secrecyLevelName) {
    ...
    public UpdateSecuritySecrecyLevelResponse withSecrecyLevelNumber(Integer secrecyLevelNumber) {
    ...
    public UpdateSecuritySecrecyLevelResponse withDescription(String description) {
    ...
    public UpdateSecuritySecrecyLevelResponse withCreatedBy(String createdBy) {
    ...
    public UpdateSecuritySecrecyLevelResponse withCreatedAt(Long createdAt) {
    ...
    public UpdateSecuritySecrecyLevelResponse withUpdatedBy(String updatedBy) {
    ...
    public UpdateSecuritySecrecyLevelResponse withUpdatedAt(Long updatedAt) {
    ...
    public UpdateSecuritySecrecyLevelResponse withInstanceId(String instanceId) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        UpdateSecuritySecrecyLevelResponse that = (UpdateSecuritySecrecyLevelResponse) obj;
