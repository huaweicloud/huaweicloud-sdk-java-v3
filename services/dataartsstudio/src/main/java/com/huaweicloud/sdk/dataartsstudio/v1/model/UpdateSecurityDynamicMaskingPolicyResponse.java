 ...
 * Response Object
 */
public class UpdateSecurityDynamicMaskingPolicyResponse extends SdkResponse {
    ...
    public UpdateSecurityDynamicMaskingPolicyResponse withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public UpdateSecurityDynamicMaskingPolicyResponse withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public UpdateSecurityDynamicMaskingPolicyResponse withDatasourceType(DatasourceTypeEnum datasourceType) {
    ...
    public UpdateSecurityDynamicMaskingPolicyResponse withClusterId(String clusterId) {
    ...
    public UpdateSecurityDynamicMaskingPolicyResponse withClusterName(String clusterName) {
    ...
    public UpdateSecurityDynamicMaskingPolicyResponse withDatabaseName(String databaseName) {
    ...
    public UpdateSecurityDynamicMaskingPolicyResponse withTableId(String tableId) {
    ...
    public UpdateSecurityDynamicMaskingPolicyResponse withTableName(String tableName) {
    ...
    public UpdateSecurityDynamicMaskingPolicyResponse withUserGroups(String userGroups) {
    ...
    public UpdateSecurityDynamicMaskingPolicyResponse withUsers(String users) {
        this.users = users;
        return this;
    }
    ...
    public UpdateSecurityDynamicMaskingPolicyResponse withConnName(String connName) {
    ...
    public UpdateSecurityDynamicMaskingPolicyResponse withConnId(String connId) {
        this.connId = connId;
        return this;
    }
    ...
    public UpdateSecurityDynamicMaskingPolicyResponse withSyncStatus(SyncStatusEnum syncStatus) {
    ...
    public UpdateSecurityDynamicMaskingPolicyResponse withSyncMsg(String syncMsg) {
    ...
    public UpdateSecurityDynamicMaskingPolicyResponse withSyncLog(String syncLog) {
    ...
    public UpdateSecurityDynamicMaskingPolicyResponse withCreateTime(Long createTime) {
    ...
    public UpdateSecurityDynamicMaskingPolicyResponse withCreateUser(String createUser) {
    ...
    public UpdateSecurityDynamicMaskingPolicyResponse withUpdateTime(Long updateTime) {
    ...
    public UpdateSecurityDynamicMaskingPolicyResponse withUpdateUser(String updateUser) {
    ...
    public UpdateSecurityDynamicMaskingPolicyResponse withSchemaName(String schemaName) {
    ...
    public UpdateSecurityDynamicMaskingPolicyResponse withPolicyList(List<DynamicMaskingPolicy> policyList) {
        this.policyList = policyList;
        return this;
    }

    public UpdateSecurityDynamicMaskingPolicyResponse addPolicyListItem(DynamicMaskingPolicy policyListItem) {
    ...
    public UpdateSecurityDynamicMaskingPolicyResponse withPolicyList(
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        UpdateSecurityDynamicMaskingPolicyResponse that = (UpdateSecurityDynamicMaskingPolicyResponse) obj;
    ...
    public String toString() {
        ...
        sb.append("class UpdateSecurityDynamicMaskingPolicyResponse {\n");
