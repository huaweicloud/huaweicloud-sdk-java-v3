 ...
 * Response Object
 */
public class CreateSecurityPermissionSetPermissionResponse extends SdkResponse {
    ...
    public CreateSecurityPermissionSetPermissionResponse withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public CreateSecurityPermissionSetPermissionResponse withPermissionSetId(String permissionSetId) {
    ...
    public CreateSecurityPermissionSetPermissionResponse withProjectId(String projectId) {
    ...
    public CreateSecurityPermissionSetPermissionResponse withInstanceId(String instanceId) {
    ...
    public CreateSecurityPermissionSetPermissionResponse withPermissionType(PermissionTypeEnum permissionType) {
    ...
    public CreateSecurityPermissionSetPermissionResponse withPermissionAction(String permissionAction) {
    ...
    public CreateSecurityPermissionSetPermissionResponse withPermissionActions(
        List<PermissionActionsEnum> permissionActions) {
        this.permissionActions = permissionActions;
        return this;
    }

    public CreateSecurityPermissionSetPermissionResponse addPermissionActionsItem(
        PermissionActionsEnum permissionActionsItem) {
    ...
    public CreateSecurityPermissionSetPermissionResponse withPermissionActionCode(Integer permissionActionCode) {
    ...
    public CreateSecurityPermissionSetPermissionResponse withClusterId(String clusterId) {
    ...
    public CreateSecurityPermissionSetPermissionResponse withClusterName(String clusterName) {
    ...
    public CreateSecurityPermissionSetPermissionResponse withDatasourceType(DatasourceTypeEnum datasourceType) {
    ...
    public CreateSecurityPermissionSetPermissionResponse withDatabaseName(String databaseName) {
    ...
    public CreateSecurityPermissionSetPermissionResponse withSchemaName(String schemaName) {
    ...
    public CreateSecurityPermissionSetPermissionResponse withNamespace(String namespace) {
    ...
    public CreateSecurityPermissionSetPermissionResponse withTableName(String tableName) {
    ...
    public CreateSecurityPermissionSetPermissionResponse withColumnName(String columnName) {
    ...
    public CreateSecurityPermissionSetPermissionResponse withRowLevelSecurity(String rowLevelSecurity) {
    ...
    public CreateSecurityPermissionSetPermissionResponse withSyncStatus(SyncStatusEnum syncStatus) {
    ...
    public CreateSecurityPermissionSetPermissionResponse withSyncMsg(String syncMsg) {
    ...
    public CreateSecurityPermissionSetPermissionResponse withUrl(String url) {
        this.url = url;
        return this;
    }
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        CreateSecurityPermissionSetPermissionResponse that = (CreateSecurityPermissionSetPermissionResponse) obj;
    ...
    public String toString() {
        ...
        sb.append("class CreateSecurityPermissionSetPermissionResponse {\n");
