...
public class ListFactLogicTablesRequest {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ListFactLogicTablesRequest listFactLogicTablesRequest = (ListFactLogicTablesRequest) o;
        return Objects.equals(this.workspace, listFactLogicTablesRequest.workspace)
            && Objects.equals(this.name, listFactLogicTablesRequest.name)
            && Objects.equals(this.createBy, listFactLogicTablesRequest.createBy)
            && Objects.equals(this.approver, listFactLogicTablesRequest.approver)
            && Objects.equals(this.owner, listFactLogicTablesRequest.owner)
            && Objects.equals(this.status, listFactLogicTablesRequest.status)
            && Objects.equals(this.syncStatus, listFactLogicTablesRequest.syncStatus)
            && Objects.equals(this.syncKey, listFactLogicTablesRequest.syncKey)
            && Objects.equals(this.l3Id, listFactLogicTablesRequest.l3Id)
            && Objects.equals(this.beginTime, listFactLogicTablesRequest.beginTime)
            && Objects.equals(this.endTime, listFactLogicTablesRequest.endTime)
            && Objects.equals(this.limit, listFactLogicTablesRequest.limit)
            && Objects.equals(this.offset, listFactLogicTablesRequest.offset)
            && Objects.equals(this.bizCatalogId, listFactLogicTablesRequest.bizCatalogId);
    }
