...
public class UpdateWorkspaceRequest {
    ...
    public UpdateWorkspaceRequest withWorkspace(String workspace) {
    ...
    public UpdateWorkspaceRequest withXProjectId(String xProjectId) {
    ...
    public UpdateWorkspaceRequest withBody(WorkspaceVO body) {
        this.body = body;
        return this;
    }

    public UpdateWorkspaceRequest withBody(Consumer<WorkspaceVO> bodySetter) {
        if (this.body == null) {
