 ...
 * Request Object
 */
public class SearchIdByPathRequest {
    ...
    public SearchIdByPathRequest withWorkspace(String workspace) {
    ...
    public SearchIdByPathRequest withDlmType(DlmTypeEnum dlmType) {
    ...
    public SearchIdByPathRequest withPath(String path) {
        this.path = path;
        return this;
    }
    ...
    public SearchIdByPathRequest withLimit(Integer limit) {
        this.limit = limit;
        return this;
    }
    ...
    public SearchIdByPathRequest withOffset(Integer offset) {
        this.offset = offset;
        return this;
    }
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        SearchIdByPathRequest that = (SearchIdByPathRequest) obj;
        return Objects.equals(this.workspace, that.workspace) && Objects.equals(this.dlmType, that.dlmType)
            && Objects.equals(this.path, that.path) && Objects.equals(this.limit, that.limit)
            && Objects.equals(this.offset, that.offset);
    }

    @Override
    public int hashCode() {
        return Objects.hash(workspace, dlmType, path, limit, offset);
    }

    @Override
    public String toString() {
        StringBuilder sb = new StringBuilder();
        sb.append("class SearchIdByPathRequest {\n");
