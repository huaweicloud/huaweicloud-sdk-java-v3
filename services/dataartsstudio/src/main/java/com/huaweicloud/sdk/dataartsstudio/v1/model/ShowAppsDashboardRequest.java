 ...
 * Request Object
 */
public class ShowAppsDashboardRequest {
    ...
    public ShowAppsDashboardRequest withWorkspace(String workspace) {
    ...
    public ShowAppsDashboardRequest withDlmType(DlmTypeEnum dlmType) {
    ...
    public ShowAppsDashboardRequest withStartTime(Long startTime) {
    ...
    public ShowAppsDashboardRequest withEndTime(Long endTime) {
    ...
    public ShowAppsDashboardRequest withTimeUnit(TimeUnitEnum timeUnit) {
    ...
    public ShowAppsDashboardRequest withLimit(Integer limit) {
        this.limit = limit;
        return this;
    }
    ...
    public ShowAppsDashboardRequest withOffset(Integer offset) {
        this.offset = offset;
        return this;
    }
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ShowAppsDashboardRequest that = (ShowAppsDashboardRequest) obj;
        return Objects.equals(this.workspace, that.workspace) && Objects.equals(this.dlmType, that.dlmType)
            && Objects.equals(this.startTime, that.startTime) && Objects.equals(this.endTime, that.endTime)
            && Objects.equals(this.timeUnit, that.timeUnit) && Objects.equals(this.limit, that.limit)
            && Objects.equals(this.offset, that.offset);
    }

    @Override
    public int hashCode() {
        return Objects.hash(workspace, dlmType, startTime, endTime, timeUnit, limit, offset);
    }

    @Override
    public String toString() {
        StringBuilder sb = new StringBuilder();
        sb.append("class ShowAppsDashboardRequest {\n");
