 ...
 * Request Object
 */
public class ShowApisDetailRequest {
    ...
    public ShowApisDetailRequest withWorkspace(String workspace) {
    ...
    public ShowApisDetailRequest withDlmType(DlmTypeEnum dlmType) {
    ...
    public ShowApisDetailRequest withApiId(String apiId) {
        this.apiId = apiId;
        return this;
    }
    ...
    public ShowApisDetailRequest withInstanceId(String instanceId) {
    ...
    public ShowApisDetailRequest withStartTime(Long startTime) {
    ...
    public ShowApisDetailRequest withEndTime(Long endTime) {
    ...
    public ShowApisDetailRequest withTimeUnit(TimeUnitEnum timeUnit) {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ShowApisDetailRequest showApisDetailRequest = (ShowApisDetailRequest) o;
        return Objects.equals(this.workspace, showApisDetailRequest.workspace)
            && Objects.equals(this.dlmType, showApisDetailRequest.dlmType)
            && Objects.equals(this.apiId, showApisDetailRequest.apiId)
            && Objects.equals(this.instanceId, showApisDetailRequest.instanceId)
            && Objects.equals(this.startTime, showApisDetailRequest.startTime)
            && Objects.equals(this.endTime, showApisDetailRequest.endTime)
            && Objects.equals(this.timeUnit, showApisDetailRequest.timeUnit);
    }
    ...
    public String toString() {
        ...
        sb.append("class ShowApisDetailRequest {\n");
