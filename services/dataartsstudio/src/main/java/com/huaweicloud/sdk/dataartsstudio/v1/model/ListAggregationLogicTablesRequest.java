 ...
 * Request Object
 */
public class ListAggregationLogicTablesRequest {
    ...
    @JsonInclude(JsonInclude.Include.NON_NULL)
    @JsonProperty(value = "auto_generate")

    private Boolean autoGenerate;

    public ListAggregationLogicTablesRequest withWorkspace(String workspace) {
    ...
    public ListAggregationLogicTablesRequest withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public ListAggregationLogicTablesRequest withCreateBy(String createBy) {
    ...
    public ListAggregationLogicTablesRequest withApprover(String approver) {
    ...
    public ListAggregationLogicTablesRequest withOwner(String owner) {
        this.owner = owner;
        return this;
    }
    ...
    public ListAggregationLogicTablesRequest withStatus(StatusEnum status) {
        this.status = status;
        return this;
    }
    ...
    public ListAggregationLogicTablesRequest withSyncStatus(SyncStatusEnum syncStatus) {
    ...
    public ListAggregationLogicTablesRequest withSyncKey(List<SyncKeyEnum> syncKey) {
        this.syncKey = syncKey;
        return this;
    }

    public ListAggregationLogicTablesRequest addSyncKeyItem(SyncKeyEnum syncKeyItem) {
    ...
    public ListAggregationLogicTablesRequest withSyncKey(Consumer<List<SyncKeyEnum>> syncKeySetter) {
        if (this.syncKey == null) {
            this.syncKey = new ArrayList<>();
        }
    ...
    public ListAggregationLogicTablesRequest withL3Id(Long l3Id) {
        this.l3Id = l3Id;
        return this;
    }
    ...
    public ListAggregationLogicTablesRequest withBeginTime(String beginTime) {
    ...
    public ListAggregationLogicTablesRequest withEndTime(String endTime) {
    ...
    public ListAggregationLogicTablesRequest withLimit(Integer limit) {
        this.limit = limit;
        return this;
    }
    ...
    public ListAggregationLogicTablesRequest withOffset(Integer offset) {
        this.offset = offset;
        return this;
    }
    ...
    public ListAggregationLogicTablesRequest withBizCatalogId(String bizCatalogId) {
    ...
    public ListAggregationLogicTablesRequest withAutoGenerate(Boolean autoGenerate) {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ListAggregationLogicTablesRequest listAggregationLogicTablesRequest = (ListAggregationLogicTablesRequest) o;
        return Objects.equals(this.workspace, listAggregationLogicTablesRequest.workspace)
            && Objects.equals(this.name, listAggregationLogicTablesRequest.name)
            && Objects.equals(this.createBy, listAggregationLogicTablesRequest.createBy)
            && Objects.equals(this.approver, listAggregationLogicTablesRequest.approver)
            && Objects.equals(this.owner, listAggregationLogicTablesRequest.owner)
            && Objects.equals(this.status, listAggregationLogicTablesRequest.status)
            && Objects.equals(this.syncStatus, listAggregationLogicTablesRequest.syncStatus)
            && Objects.equals(this.syncKey, listAggregationLogicTablesRequest.syncKey)
            && Objects.equals(this.l3Id, listAggregationLogicTablesRequest.l3Id)
            && Objects.equals(this.beginTime, listAggregationLogicTablesRequest.beginTime)
            && Objects.equals(this.endTime, listAggregationLogicTablesRequest.endTime)
            && Objects.equals(this.limit, listAggregationLogicTablesRequest.limit)
            && Objects.equals(this.offset, listAggregationLogicTablesRequest.offset)
            && Objects.equals(this.bizCatalogId, listAggregationLogicTablesRequest.bizCatalogId)
            && Objects.equals(this.autoGenerate, listAggregationLogicTablesRequest.autoGenerate);
    }
    ...
    public String toString() {
        ...
        sb.append("class ListAggregationLogicTablesRequest {\n");
