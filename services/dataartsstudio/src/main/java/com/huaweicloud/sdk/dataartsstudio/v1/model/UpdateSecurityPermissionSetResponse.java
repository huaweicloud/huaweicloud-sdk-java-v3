 ...
 * Response Object
 */
public class UpdateSecurityPermissionSetResponse extends SdkResponse {
    ...
    public UpdateSecurityPermissionSetResponse withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public UpdateSecurityPermissionSetResponse withParentId(String parentId) {
    ...
    public UpdateSecurityPermissionSetResponse withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public UpdateSecurityPermissionSetResponse withDescription(String description) {
    ...
    public UpdateSecurityPermissionSetResponse withType(TypeEnum type) {
        this.type = type;
        return this;
    }
    ...
    public UpdateSecurityPermissionSetResponse withManagedClusterId(String managedClusterId) {
    ...
    public UpdateSecurityPermissionSetResponse withManagedClusterName(String managedClusterName) {
    ...
    public UpdateSecurityPermissionSetResponse withProjectId(String projectId) {
    ...
    public UpdateSecurityPermissionSetResponse withDomainId(String domainId) {
    ...
    public UpdateSecurityPermissionSetResponse withInstanceId(String instanceId) {
    ...
    public UpdateSecurityPermissionSetResponse withManagerId(String managerId) {
    ...
    public UpdateSecurityPermissionSetResponse withManagerName(String managerName) {
    ...
    public UpdateSecurityPermissionSetResponse withManagerType(String managerType) {
    ...
    public UpdateSecurityPermissionSetResponse withDatasourceType(String datasourceType) {
    ...
    public UpdateSecurityPermissionSetResponse withSyncStatus(SyncStatusEnum syncStatus) {
    ...
    public UpdateSecurityPermissionSetResponse withSyncMsg(String syncMsg) {
    ...
    public UpdateSecurityPermissionSetResponse withSyncTime(Long syncTime) {
    ...
    public UpdateSecurityPermissionSetResponse withCreateTime(Long createTime) {
    ...
    public UpdateSecurityPermissionSetResponse withCreateUser(String createUser) {
    ...
    public UpdateSecurityPermissionSetResponse withUpdateTime(Long updateTime) {
    ...
    public UpdateSecurityPermissionSetResponse withUpdateUser(String updateUser) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        UpdateSecurityPermissionSetResponse that = (UpdateSecurityPermissionSetResponse) obj;
    ...
    public String toString() {
        ...
        sb.append("class UpdateSecurityPermissionSetResponse {\n");
