...
public class Workspacebody {
    ...
    public Workspacebody withBadRecordLocationName(String badRecordLocationName) {
    ...
    public Workspacebody withDescription(String description) {
    ...
    public Workspacebody withEpsId(String epsId) {
        this.epsId = epsId;
        return this;
    }
    ...
    public Workspacebody withJobLogLocationName(String jobLogLocationName) {
    ...
    public Workspacebody withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Workspacebody withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public Workspacebody withIsDefault(Integer isDefault) {
    ...
    public Workspacebody withOwnerName(String ownerName) {
    ...
    public Workspacebody withProjectId(String projectId) {
    ...
    public Workspacebody withDomainId(String domainId) {
    ...
    public Workspacebody withInstanceId(String instanceId) {
    ...
    public Workspacebody withCreateTime(BigDecimal createTime) {
    ...
    public Workspacebody withCreateUser(String createUser) {
    ...
    public Workspacebody withMemberNum(Integer memberNum) {
    ...
    public Workspacebody withUpdateTime(BigDecimal updateTime) {
    ...
    public Workspacebody withUpdateUser(String updateUser) {
