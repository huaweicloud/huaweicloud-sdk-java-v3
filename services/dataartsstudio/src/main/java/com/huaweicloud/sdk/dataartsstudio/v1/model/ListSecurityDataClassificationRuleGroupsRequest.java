 ...
 * Request Object
 */
public class ListSecurityDataClassificationRuleGroupsRequest {
    ...
    public ListSecurityDataClassificationRuleGroupsRequest withWorkspace(String workspace) {
    ...
    public ListSecurityDataClassificationRuleGroupsRequest withLimit(Integer limit) {
        this.limit = limit;
        return this;
    }
    ...
    public ListSecurityDataClassificationRuleGroupsRequest withOffset(Integer offset) {
        this.offset = offset;
        return this;
    }
    ...
    public ListSecurityDataClassificationRuleGroupsRequest withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public ListSecurityDataClassificationRuleGroupsRequest withCreator(String creator) {
    ...
    public ListSecurityDataClassificationRuleGroupsRequest withOrderBy(OrderByEnum orderBy) {
    ...
    public ListSecurityDataClassificationRuleGroupsRequest withDesc(Boolean desc) {
        this.desc = desc;
        return this;
    }
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ListSecurityDataClassificationRuleGroupsRequest that = (ListSecurityDataClassificationRuleGroupsRequest) obj;
        return Objects.equals(this.workspace, that.workspace) && Objects.equals(this.limit, that.limit)
            ...
            && Objects.equals(this.creator, that.creator) && Objects.equals(this.orderBy, that.orderBy)
            && Objects.equals(this.desc, that.desc);
    }

    @Override
    public int hashCode() {
        return Objects.hash(workspace, limit, offset, name, creator, orderBy, desc);
    }

    @Override
    public String toString() {
        StringBuilder sb = new StringBuilder();
        sb.append("class ListSecurityDataClassificationRuleGroupsRequest {\n");
