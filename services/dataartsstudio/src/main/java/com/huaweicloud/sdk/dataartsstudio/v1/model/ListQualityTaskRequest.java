...
public class ListQualityTaskRequest {
    ...
    public ListQualityTaskRequest withCategoryId(Long categoryId) {
    ...
    public ListQualityTaskRequest withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public ListQualityTaskRequest withScheduleStatus(ScheduleStatusEnum scheduleStatus) {
    ...
    public ListQualityTaskRequest withStartTime(Long startTime) {
    ...
    public ListQualityTaskRequest withEndTime(Long endTime) {
    ...
    public ListQualityTaskRequest withCreator(String creator) {
    ...
    public ListQualityTaskRequest withLimit(Long limit) {
        this.limit = limit;
        return this;
    }
    ...
    public ListQualityTaskRequest withOffset(Long offset) {
        this.offset = offset;
        return this;
    }
    ...
    public ListQualityTaskRequest withWorkspace(String workspace) {
