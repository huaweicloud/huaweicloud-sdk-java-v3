 ...
 * Request Object
 */
public class SearchFieldsForRelationRequest {
    ...
    public SearchFieldsForRelationRequest withWorkspace(String workspace) {
    ...
    public SearchFieldsForRelationRequest withXProjectId(String xProjectId) {
