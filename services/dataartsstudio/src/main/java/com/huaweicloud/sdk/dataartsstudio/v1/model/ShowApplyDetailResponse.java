 ...
 * Response Object
 */
public class ShowApplyDetailResponse extends SdkResponse {
    ...
    public ShowApplyDetailResponse withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public ShowApplyDetailResponse withApiApplyStatus(ApiApplyStatusEnum apiApplyStatus) {
    ...
    public ShowApplyDetailResponse withApiApplyType(ApiApplyTypeEnum apiApplyType) {
    ...
    public ShowApplyDetailResponse withApiId(String apiId) {
        this.apiId = apiId;
        return this;
    }
    ...
    public ShowApplyDetailResponse withApiName(String apiName) {
    ...
    public ShowApplyDetailResponse withApiUsingTime(Long apiUsingTime) {
    ...
    public ShowApplyDetailResponse withAppId(String appId) {
        this.appId = appId;
        return this;
    }
    ...
    public ShowApplyDetailResponse withAppName(String appName) {
    ...
    public ShowApplyDetailResponse withApplyTime(Long applyTime) {
    ...
    public ShowApplyDetailResponse withApprovalTime(Long approvalTime) {
    ...
    public ShowApplyDetailResponse withApproverName(String approverName) {
    ...
    public ShowApplyDetailResponse withComment(String comment) {
    ...
    public ShowApplyDetailResponse withUserName(String userName) {
    ...
    public String toString() {
        ...
        sb.append("class ShowApplyDetailResponse {\n");
