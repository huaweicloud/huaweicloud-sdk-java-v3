 ...
 * Request Object
 */
public class ExportDataServiceExcelTemplateRequest implements ProgressRequest {
    ...
    public ExportDataServiceExcelTemplateRequest withWorkspace(String workspace) {
    ...
    public ExportDataServiceExcelTemplateRequest withDlmType(DlmTypeEnum dlmType) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ExportDataServiceExcelTemplateRequest that = (ExportDataServiceExcelTemplateRequest) obj;
        return Objects.equals(this.workspace, that.workspace) && Objects.equals(this.dlmType, that.dlmType);
    }

    @Override
    public int hashCode() {
        return Objects.hash(workspace, dlmType);
    }

    @Override
    public String toString() {
        StringBuilder sb = new StringBuilder();
        sb.append("class ExportDataServiceExcelTemplateRequest {\n");
