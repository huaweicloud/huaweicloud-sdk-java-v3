 ...
 * Request Object
 */
public class ImportDataServiceExcelRequest {
    ...
    private ImportDataServiceExcelRequestBody body;

    public ImportDataServiceExcelRequest withWorkspace(String workspace) {
    ...
    public ImportDataServiceExcelRequest withDlmType(DlmTypeEnum dlmType) {
    ...
    public ImportDataServiceExcelRequest withBody(ImportDataServiceExcelRequestBody body) {
        this.body = body;
        return this;
    }

    public ImportDataServiceExcelRequest withBody(Consumer<ImportDataServiceExcelRequestBody> bodySetter) {
        if (this.body == null) {
            this.body = new ImportDataServiceExcelRequestBody();
     ...
     * @return body
     */
    public ImportDataServiceExcelRequestBody getBody() {
        return body;
    }

    public void setBody(ImportDataServiceExcelRequestBody body) {
        this.body = body;
    }
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ImportDataServiceExcelRequest that = (ImportDataServiceExcelRequest) obj;
    ...
    public String toString() {
        ...
        sb.append("class ImportDataServiceExcelRequest {\n");
