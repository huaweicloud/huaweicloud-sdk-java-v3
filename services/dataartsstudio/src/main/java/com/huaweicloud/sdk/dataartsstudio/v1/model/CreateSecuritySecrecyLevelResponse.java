 ...
 * Response Object
 */
public class CreateSecuritySecrecyLevelResponse extends SdkResponse {
    ...
    public CreateSecuritySecrecyLevelResponse withSecrecyLevelId(String secrecyLevelId) {
    ...
    public CreateSecuritySecrecyLevelResponse withSecrecyLevelName(String secrecyLevelName) {
    ...
    public CreateSecuritySecrecyLevelResponse withSecrecyLevelNumber(Integer secrecyLevelNumber) {
    ...
    public CreateSecuritySecrecyLevelResponse withDescription(String description) {
    ...
    public CreateSecuritySecrecyLevelResponse withCreatedBy(String createdBy) {
    ...
    public CreateSecuritySecrecyLevelResponse withCreatedAt(Long createdAt) {
    ...
    public CreateSecuritySecrecyLevelResponse withUpdatedBy(String updatedBy) {
    ...
    public CreateSecuritySecrecyLevelResponse withUpdatedAt(Long updatedAt) {
    ...
    public CreateSecuritySecrecyLevelResponse withInstanceId(String instanceId) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        CreateSecuritySecrecyLevelResponse that = (CreateSecuritySecrecyLevelResponse) obj;
    ...
    public String toString() {
        ...
        sb.append("class CreateSecuritySecrecyLevelResponse {\n");
