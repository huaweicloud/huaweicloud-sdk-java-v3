 ...
 * Request Object
 */
public class ShowPathObjectByIdRequest {
    ...
    public ShowPathObjectByIdRequest withWorkspace(String workspace) {
    ...
    public ShowPathObjectByIdRequest withDlmType(DlmTypeEnum dlmType) {
    ...
    public ShowPathObjectByIdRequest withCatalogId(String catalogId) {
    ...
    public ShowPathObjectByIdRequest withLimit(Integer limit) {
        this.limit = limit;
        return this;
    }
    ...
    public ShowPathObjectByIdRequest withOffset(Integer offset) {
        this.offset = offset;
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append("class ShowPathObjectByIdRequest {\n");
