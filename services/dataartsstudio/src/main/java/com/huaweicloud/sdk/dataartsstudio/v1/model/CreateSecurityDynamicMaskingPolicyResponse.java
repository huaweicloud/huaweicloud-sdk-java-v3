 ...
 * Response Object
 */
public class CreateSecurityDynamicMaskingPolicyResponse extends SdkResponse {
    ...
    public CreateSecurityDynamicMaskingPolicyResponse withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public CreateSecurityDynamicMaskingPolicyResponse withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public CreateSecurityDynamicMaskingPolicyResponse withDatasourceType(DatasourceTypeEnum datasourceType) {
    ...
    public CreateSecurityDynamicMaskingPolicyResponse withClusterId(String clusterId) {
    ...
    public CreateSecurityDynamicMaskingPolicyResponse withClusterName(String clusterName) {
    ...
    public CreateSecurityDynamicMaskingPolicyResponse withDatabaseName(String databaseName) {
    ...
    public CreateSecurityDynamicMaskingPolicyResponse withTableId(String tableId) {
    ...
    public CreateSecurityDynamicMaskingPolicyResponse withTableName(String tableName) {
    ...
    public CreateSecurityDynamicMaskingPolicyResponse withUserGroups(String userGroups) {
    ...
    public CreateSecurityDynamicMaskingPolicyResponse withUsers(String users) {
        this.users = users;
        return this;
    }
    ...
    public CreateSecurityDynamicMaskingPolicyResponse withConnName(String connName) {
    ...
    public CreateSecurityDynamicMaskingPolicyResponse withConnId(String connId) {
        this.connId = connId;
        return this;
    }
    ...
    public CreateSecurityDynamicMaskingPolicyResponse withSyncStatus(SyncStatusEnum syncStatus) {
    ...
    public CreateSecurityDynamicMaskingPolicyResponse withSyncMsg(String syncMsg) {
    ...
    public CreateSecurityDynamicMaskingPolicyResponse withSyncLog(String syncLog) {
    ...
    public CreateSecurityDynamicMaskingPolicyResponse withCreateTime(Long createTime) {
    ...
    public CreateSecurityDynamicMaskingPolicyResponse withCreateUser(String createUser) {
    ...
    public CreateSecurityDynamicMaskingPolicyResponse withUpdateTime(Long updateTime) {
    ...
    public CreateSecurityDynamicMaskingPolicyResponse withUpdateUser(String updateUser) {
    ...
    public CreateSecurityDynamicMaskingPolicyResponse withSchemaName(String schemaName) {
    ...
    public CreateSecurityDynamicMaskingPolicyResponse withPolicyList(List<DynamicMaskingPolicy> policyList) {
        this.policyList = policyList;
        return this;
    }

    public CreateSecurityDynamicMaskingPolicyResponse addPolicyListItem(DynamicMaskingPolicy policyListItem) {
    ...
    public CreateSecurityDynamicMaskingPolicyResponse withPolicyList(
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        CreateSecurityDynamicMaskingPolicyResponse that = (CreateSecurityDynamicMaskingPolicyResponse) obj;
    ...
    public String toString() {
        ...
        sb.append("class CreateSecurityDynamicMaskingPolicyResponse {\n");
