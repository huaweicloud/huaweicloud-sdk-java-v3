...
public class UpdateCatalogResponse extends SdkResponse {
    ...
    public UpdateCatalogResponse withCatalogId(String catalogId) {
    ...
    public UpdateCatalogResponse withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public UpdateCatalogResponse withCreateTime(Long createTime) {
    ...
    public UpdateCatalogResponse withCreateUser(String createUser) {
    ...
    public UpdateCatalogResponse withUpdateTime(Long updateTime) {
    ...
    public UpdateCatalogResponse withUpdateUser(String updateUser) {
