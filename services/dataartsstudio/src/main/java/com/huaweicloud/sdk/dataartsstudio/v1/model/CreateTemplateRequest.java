...
public class CreateTemplateRequest {
    ...
    public CreateTemplateRequest withWorkspace(String workspace) {
    ...
    public CreateTemplateRequest withBody(TemplateRO body) {
        this.body = body;
        return this;
    }

    public CreateTemplateRequest withBody(Consumer<TemplateRO> bodySetter) {
        if (this.body == null) {
