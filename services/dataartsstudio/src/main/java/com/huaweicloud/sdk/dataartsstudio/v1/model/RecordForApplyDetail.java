 ...
 */
public class RecordForApplyDetail {
    ...
    public RecordForApplyDetail withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public RecordForApplyDetail withApiApplyStatus(ApiApplyStatusEnum apiApplyStatus) {
    ...
    public RecordForApplyDetail withApiApplyType(ApiApplyTypeEnum apiApplyType) {
    ...
    public RecordForApplyDetail withApiId(String apiId) {
        this.apiId = apiId;
        return this;
    }
    ...
    public RecordForApplyDetail withApiName(String apiName) {
    ...
    public RecordForApplyDetail withApiUsingTime(Long apiUsingTime) {
    ...
    public RecordForApplyDetail withAppId(String appId) {
        this.appId = appId;
        return this;
    }
    ...
    public RecordForApplyDetail withAppName(String appName) {
    ...
    public RecordForApplyDetail withApplyTime(Long applyTime) {
    ...
    public RecordForApplyDetail withApprovalTime(Long approvalTime) {
    ...
    public RecordForApplyDetail withApproverName(String approverName) {
    ...
    public RecordForApplyDetail withComment(String comment) {
    ...
    public RecordForApplyDetail withUserName(String userName) {
    ...
    public String toString() {
        ...
        sb.append("class RecordForApplyDetail {\n");
