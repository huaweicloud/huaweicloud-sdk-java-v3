 ...
 * Request Object
 */
public class ListDataServiceInstancesDetailRequest {
    ...
    public ListDataServiceInstancesDetailRequest withWorkspace(String workspace) {
    ...
    public ListDataServiceInstancesDetailRequest withDlmType(DlmTypeEnum dlmType) {
    ...
    public ListDataServiceInstancesDetailRequest withLimit(Integer limit) {
        this.limit = limit;
        return this;
    }
    ...
    public ListDataServiceInstancesDetailRequest withOffset(Integer offset) {
        this.offset = offset;
        return this;
    }
    ...
    public ListDataServiceInstancesDetailRequest withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public ListDataServiceInstancesDetailRequest withCreateUser(String createUser) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ListDataServiceInstancesDetailRequest that = (ListDataServiceInstancesDetailRequest) obj;
    ...
    public String toString() {
        ...
        sb.append("class ListDataServiceInstancesDetailRequest {\n");
