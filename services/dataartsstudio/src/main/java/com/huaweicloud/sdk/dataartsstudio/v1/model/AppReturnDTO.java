...
public class AppReturnDTO {
    ...
    public AppReturnDTO withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public AppReturnDTO withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public AppReturnDTO withDescription(String description) {
    ...
    public AppReturnDTO withAppKey(String appKey) {
        this.appKey = appKey;
        return this;
    }
    ...
    public AppReturnDTO withAppSecret(String appSecret) {
    ...
    public AppReturnDTO withRegisterTime(Long registerTime) {
    ...
    public AppReturnDTO withUpdateTime(Long updateTime) {
    ...
    public AppReturnDTO withCreateUser(String createUser) {
    ...
    public AppReturnDTO withUpdateUser(String updateUser) {
    ...
    public AppReturnDTO withAppType(AppTypeEnum appType) {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        AppReturnDTO appReturnDTO = (AppReturnDTO) o;
        return Objects.equals(this.id, appReturnDTO.id) && Objects.equals(this.name, appReturnDTO.name)
            && Objects.equals(this.description, appReturnDTO.description)
            && Objects.equals(this.appKey, appReturnDTO.appKey)
            && Objects.equals(this.appSecret, appReturnDTO.appSecret)
            && Objects.equals(this.registerTime, appReturnDTO.registerTime)
            && Objects.equals(this.updateTime, appReturnDTO.updateTime)
            && Objects.equals(this.createUser, appReturnDTO.createUser)
            && Objects.equals(this.updateUser, appReturnDTO.updateUser)
            && Objects.equals(this.appType, appReturnDTO.appType);
    }
