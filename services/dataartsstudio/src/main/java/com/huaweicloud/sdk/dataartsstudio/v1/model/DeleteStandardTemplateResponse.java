...
public class DeleteStandardTemplateResponse extends SdkResponse {
    ...
    public DeleteStandardTemplateResponse withData(DeleteResultData data) {
        this.data = data;
        return this;
    }

    public DeleteStandardTemplateResponse withData(Consumer<DeleteResultData> dataSetter) {
        if (this.data == null) {
