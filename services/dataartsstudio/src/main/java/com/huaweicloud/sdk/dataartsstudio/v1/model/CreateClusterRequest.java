...
public class CreateClusterRequest {
    ...
    public CreateClusterRequest withWorkspace(String workspace) {
    ...
    public CreateClusterRequest withXProjectId(String xProjectId) {
    ...
    public CreateClusterRequest withInstanceId(String instanceId) {
