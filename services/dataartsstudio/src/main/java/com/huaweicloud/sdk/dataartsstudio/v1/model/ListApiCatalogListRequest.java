 ...
 * Request Object
 */
public class ListApiCatalogListRequest {
    ...
    public ListApiCatalogListRequest withWorkspace(String workspace) {
    ...
    public ListApiCatalogListRequest withDlmType(DlmTypeEnum dlmType) {
    ...
    public ListApiCatalogListRequest withCatalogId(String catalogId) {
    ...
    public ListApiCatalogListRequest withOffset(Integer offset) {
        this.offset = offset;
        return this;
    }
    ...
    public ListApiCatalogListRequest withLimit(Integer limit) {
        this.limit = limit;
        return this;
    }
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        return Objects.equals(this.workspace, that.workspace) && Objects.equals(this.dlmType, that.dlmType)
            && Objects.equals(this.catalogId, that.catalogId) && Objects.equals(this.offset, that.offset)
            && Objects.equals(this.limit, that.limit);
    }

    @Override
    public int hashCode() {
        return Objects.hash(workspace, dlmType, catalogId, offset, limit);
    }

    @Override
    public String toString() {
        StringBuilder sb = new StringBuilder();
        sb.append("class ListApiCatalogListRequest {\n");
