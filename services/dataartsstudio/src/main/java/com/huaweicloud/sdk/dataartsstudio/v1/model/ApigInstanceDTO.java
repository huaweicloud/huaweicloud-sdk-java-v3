...
public class ApigInstanceDTO {
    ...
    public ApigInstanceDTO withInstanceId(String instanceId) {
    ...
    public ApigInstanceDTO withInstanceName(String instanceName) {
    ...
    public String toString() {
        ...
        sb.append("class ApigInstanceDTO {\n");
