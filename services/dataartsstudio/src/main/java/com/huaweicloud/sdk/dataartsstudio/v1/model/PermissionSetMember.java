...
public class PermissionSetMember {
    ...
    public PermissionSetMember withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public PermissionSetMember withPermissionSetId(String permissionSetId) {
    ...
    public PermissionSetMember withProjectId(String projectId) {
    ...
    public PermissionSetMember withInstanceId(String instanceId) {
    ...
    public PermissionSetMember withMemberType(MemberTypeEnum memberType) {
    ...
    public PermissionSetMember withMemberId(String memberId) {
    ...
    public PermissionSetMember withMemberName(String memberName) {
    ...
    public PermissionSetMember withMemberStatus(MemberStatusEnum memberStatus) {
    ...
    public PermissionSetMember withWorkspace(String workspace) {
    ...
    public PermissionSetMember withClusterType(ClusterTypeEnum clusterType) {
    ...
    public PermissionSetMember withClusterId(String clusterId) {
    ...
    public PermissionSetMember withClusterName(String clusterName) {
    ...
    public PermissionSetMember withCreateTime(Long createTime) {
    ...
    public PermissionSetMember withCreateUser(String createUser) {
    ...
    public PermissionSetMember withDeadline(Long deadline) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        PermissionSetMember that = (PermissionSetMember) obj;
