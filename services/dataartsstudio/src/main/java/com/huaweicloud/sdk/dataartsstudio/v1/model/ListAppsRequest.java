...
public class ListAppsRequest {
    ...
    public ListAppsRequest withWorkspace(String workspace) {
    ...
    public ListAppsRequest withDlmType(DlmTypeEnum dlmType) {
    ...
    public ListAppsRequest withAppType(AppTypeEnum appType) {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(workspace, dlmType, limit, offset, name, appType);
    }
