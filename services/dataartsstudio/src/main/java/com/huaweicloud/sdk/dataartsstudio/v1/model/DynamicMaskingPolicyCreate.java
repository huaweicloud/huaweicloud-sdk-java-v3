...
public class DynamicMaskingPolicyCreate {
    ...
    public DynamicMaskingPolicyCreate withColumnName(String columnName) {
    ...
    public DynamicMaskingPolicyCreate withColumnType(String columnType) {
    ...
    public DynamicMaskingPolicyCreate withAlgorithmType(String algorithmType) {
    ...
    public DynamicMaskingPolicyCreate withAlgorithmDetail(String algorithmDetail) {
    ...
    public DynamicMaskingPolicyCreate withAlgorithmDetailDto(Consumer<AlgorithmDetailDTO> algorithmDetailDtoSetter) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        DynamicMaskingPolicyCreate that = (DynamicMaskingPolicyCreate) obj;
