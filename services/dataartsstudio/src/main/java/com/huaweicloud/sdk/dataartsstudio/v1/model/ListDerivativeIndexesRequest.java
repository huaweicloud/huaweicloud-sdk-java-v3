...
public class ListDerivativeIndexesRequest {
    ...
    public ListDerivativeIndexesRequest withXProjectId(String xProjectId) {
    ...
    public ListDerivativeIndexesRequest withDimensionId(String dimensionId) {
    ...
    public ListDerivativeIndexesRequest withAtomicIndexId(String atomicIndexId) {
    ...
    public ListDerivativeIndexesRequest withL3Id(String l3Id) {
        this.l3Id = l3Id;
        return this;
    }
