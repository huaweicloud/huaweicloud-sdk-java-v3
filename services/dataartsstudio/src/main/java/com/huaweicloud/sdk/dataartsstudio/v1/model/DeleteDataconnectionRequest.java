...
public class DeleteDataconnectionRequest {
    ...
    public DeleteDataconnectionRequest withWorkspace(String workspace) {
    ...
    public DeleteDataconnectionRequest withDataConnectionId(String dataConnectionId) {
    ...
    public String toString() {
        ...
        sb.append("class DeleteDataconnectionRequest {\n");
