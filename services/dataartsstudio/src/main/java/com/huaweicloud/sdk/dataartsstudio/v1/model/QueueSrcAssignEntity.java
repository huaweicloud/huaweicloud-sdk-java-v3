 ...
 * 创建的队列资源。
 */
public class QueueSrcAssignEntity {
    ...
    public QueueSrcAssignEntity withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public QueueSrcAssignEntity withSourceType(String sourceType) {
    ...
    public QueueSrcAssignEntity withQueueName(String queueName) {
    ...
    public QueueSrcAssignEntity withQueueType(String queueType) {
    ...
    public QueueSrcAssignEntity withQueueAttr(Integer queueAttr) {
    ...
    public QueueSrcAssignEntity withConnId(String connId) {
        this.connId = connId;
        return this;
    }
    ...
    public QueueSrcAssignEntity withConnName(String connName) {
    ...
    public QueueSrcAssignEntity withClusterId(String clusterId) {
    ...
    public QueueSrcAssignEntity withClusterName(String clusterName) {
    ...
    public QueueSrcAssignEntity withCreateTime(Long createTime) {
    ...
    public QueueSrcAssignEntity withCreateUser(String createUser) {
    ...
    public QueueSrcAssignEntity withUpdateTime(Long updateTime) {
    ...
    public QueueSrcAssignEntity withUpdateUser(String updateUser) {
    ...
    public QueueSrcAssignEntity withProjectId(String projectId) {
    ...
    public QueueSrcAssignEntity withDescription(String description) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        QueueSrcAssignEntity that = (QueueSrcAssignEntity) obj;
    ...
    public String toString() {
        ...
        sb.append("class QueueSrcAssignEntity {\n");
