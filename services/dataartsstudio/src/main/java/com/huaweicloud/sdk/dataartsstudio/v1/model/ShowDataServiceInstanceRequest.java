 ...
 * Request Object
 */
public class ShowDataServiceInstanceRequest {
    ...
    public ShowDataServiceInstanceRequest withWorkspace(String workspace) {
    ...
    public ShowDataServiceInstanceRequest withDlmType(DlmTypeEnum dlmType) {
    ...
    public ShowDataServiceInstanceRequest withInstanceId(String instanceId) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ShowDataServiceInstanceRequest that = (ShowDataServiceInstanceRequest) obj;
    ...
    @Override
    public int hashCode() {
        return Objects.hash(workspace, dlmType, instanceId);
    }

    @Override
    public String toString() {
        StringBuilder sb = new StringBuilder();
        sb.append("class ShowDataServiceInstanceRequest {\n");
