...
/**
 * 关系类型。ONE(表示每条子（父）逻辑实体数据在父（子）逻辑实体中有且只有一条数据与之对应。)、ZERO_OR_ONE(表示每条子（父）逻辑实体数据在父（子）逻辑实体中最多有一条数据与之对应。)、ZERO_OR_N(表示每条子（父）逻辑实体数据在父（子）逻辑实体中可能有多条数据与之对应。)、ONE_OR_N(表示每条子（父）逻辑实体数据在父（子）逻辑实体中至少有一条数据与之对应。)。
 */
