...
public class ShowSecurityPermissionSetResponse extends SdkResponse {
    ...
    public ShowSecurityPermissionSetResponse withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public ShowSecurityPermissionSetResponse withParentId(String parentId) {
    ...
    public ShowSecurityPermissionSetResponse withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public ShowSecurityPermissionSetResponse withDescription(String description) {
    ...
    public ShowSecurityPermissionSetResponse withType(TypeEnum type) {
        this.type = type;
        return this;
    }
    ...
    public ShowSecurityPermissionSetResponse withManagedClusterId(String managedClusterId) {
    ...
    public ShowSecurityPermissionSetResponse withManagedClusterName(String managedClusterName) {
    ...
    public ShowSecurityPermissionSetResponse withProjectId(String projectId) {
    ...
    public ShowSecurityPermissionSetResponse withDomainId(String domainId) {
    ...
    public ShowSecurityPermissionSetResponse withInstanceId(String instanceId) {
    ...
    public ShowSecurityPermissionSetResponse withManagerId(String managerId) {
    ...
    public ShowSecurityPermissionSetResponse withManagerName(String managerName) {
    ...
    public ShowSecurityPermissionSetResponse withManagerType(String managerType) {
    ...
    public ShowSecurityPermissionSetResponse withDatasourceType(String datasourceType) {
    ...
    public ShowSecurityPermissionSetResponse withSyncStatus(SyncStatusEnum syncStatus) {
    ...
    public ShowSecurityPermissionSetResponse withSyncMsg(String syncMsg) {
    ...
    public ShowSecurityPermissionSetResponse withSyncTime(Long syncTime) {
    ...
    public ShowSecurityPermissionSetResponse withCreateTime(Long createTime) {
    ...
    public ShowSecurityPermissionSetResponse withCreateUser(String createUser) {
    ...
    public ShowSecurityPermissionSetResponse withUpdateTime(Long updateTime) {
    ...
    public ShowSecurityPermissionSetResponse withUpdateUser(String updateUser) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ShowSecurityPermissionSetResponse that = (ShowSecurityPermissionSetResponse) obj;
