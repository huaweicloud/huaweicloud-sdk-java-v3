...
public class DataArtsStudioAsyncClient {
     ...
     * @return CompletableFuture<ListTaskTableReferenceDetailResponse>
     */
    public CompletableFuture<ListTaskTableReferenceDetailResponse> listTaskTableReferenceDetailAsync(
        ListTaskTableReferenceDetailRequest request) {
        return hcClient.asyncInvokeHttp(request, DataArtsStudioMeta.listTaskTableReferenceDetail);
    }
     ...
     *
     * @param request ListTaskTableReferenceDetailRequest 请求对象
     * @return AsyncInvoker<ListTaskTableReferenceDetailRequest, ListTaskTableReferenceDetailResponse>
     */
    public AsyncInvoker<ListTaskTableReferenceDetailRequest, ListTaskTableReferenceDetailResponse> listTaskTableReferenceDetailAsyncInvoker(
        ListTaskTableReferenceDetailRequest request) {
        return new AsyncInvoker<>(request, DataArtsStudioMeta.listTaskTableReferenceDetail, hcClient);
    }
