 ...
 * Request Object
 */
public class ExecuteApiToInstanceRequest {
    ...
    private ApiActionDTO body;

    public ExecuteApiToInstanceRequest withWorkspace(String workspace) {
    ...
    public ExecuteApiToInstanceRequest withDlmType(DlmTypeEnum dlmType) {
    ...
    public ExecuteApiToInstanceRequest withApiId(String apiId) {
        this.apiId = apiId;
        return this;
    }
    ...
    public ExecuteApiToInstanceRequest withInstanceId(String instanceId) {
    ...
    public ExecuteApiToInstanceRequest withBody(ApiActionDTO body) {
        this.body = body;
        return this;
    }

    public ExecuteApiToInstanceRequest withBody(Consumer<ApiActionDTO> bodySetter) {
        if (this.body == null) {
            this.body = new ApiActionDTO();
     ...
     * @return body
     */
    public ApiActionDTO getBody() {
        return body;
    }

    public void setBody(ApiActionDTO body) {
        this.body = body;
    }
    ...
    public String toString() {
        ...
        sb.append("class ExecuteApiToInstanceRequest {\n");
