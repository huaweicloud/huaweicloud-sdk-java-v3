 ...
 */
public class PermissionSetMemberCreateDTO {
    ...
    public PermissionSetMemberCreateDTO withMemberId(String memberId) {
    ...
    public PermissionSetMemberCreateDTO withMemberName(String memberName) {
    ...
    public PermissionSetMemberCreateDTO withWorkspace(String workspace) {
    ...
    public String toString() {
        ...
        sb.append("class PermissionSetMemberCreateDTO {\n");
