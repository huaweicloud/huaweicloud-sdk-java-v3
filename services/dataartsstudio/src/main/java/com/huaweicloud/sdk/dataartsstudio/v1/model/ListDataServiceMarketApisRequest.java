 ...
 * Request Object
 */
public class ListDataServiceMarketApisRequest {
    ...
    private MallParaDTO body;

    public ListDataServiceMarketApisRequest withWorkspace(String workspace) {
    ...
    public ListDataServiceMarketApisRequest withDlmType(DlmTypeEnum dlmType) {
    ...
    public ListDataServiceMarketApisRequest withBody(MallParaDTO body) {
        this.body = body;
        return this;
    }

    public ListDataServiceMarketApisRequest withBody(Consumer<MallParaDTO> bodySetter) {
        if (this.body == null) {
            this.body = new MallParaDTO();
     ...
     * @return body
     */
    public MallParaDTO getBody() {
        return body;
    }

    public void setBody(MallParaDTO body) {
        this.body = body;
    }
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ListDataServiceMarketApisRequest that = (ListDataServiceMarketApisRequest) obj;
    ...
    public String toString() {
        ...
        sb.append("class ListDataServiceMarketApisRequest {\n");
