...
public class SecrecyLevel {
    ...
    public SecrecyLevel withSecrecyLevelId(String secrecyLevelId) {
    ...
    public SecrecyLevel withSecrecyLevelName(String secrecyLevelName) {
    ...
    public SecrecyLevel withSecrecyLevelNumber(Integer secrecyLevelNumber) {
    ...
    public SecrecyLevel withDescription(String description) {
    ...
    public SecrecyLevel withCreatedBy(String createdBy) {
    ...
    public SecrecyLevel withCreatedAt(Long createdAt) {
    ...
    public SecrecyLevel withUpdatedBy(String updatedBy) {
    ...
    public SecrecyLevel withUpdatedAt(Long updatedAt) {
    ...
    public SecrecyLevel withInstanceId(String instanceId) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        SecrecyLevel that = (SecrecyLevel) obj;
