 ...
 * Request Object
 */
public class ExportDataServiceZipRequest implements ProgressRequest {
    ...
    public ExportDataServiceZipRequest withWorkspace(String workspace) {
    ...
    public ExportDataServiceZipRequest withDlmType(DlmTypeEnum dlmType) {
    ...
    public ExportDataServiceZipRequest withBody(ApiParam body) {
        this.body = body;
        return this;
    }

    public ExportDataServiceZipRequest withBody(Consumer<ApiParam> bodySetter) {
        if (this.body == null) {
            this.body = new ApiParam();
     ...
     * @return body
     */
    public ApiParam getBody() {
        return body;
    }

    public void setBody(ApiParam body) {
        this.body = body;
    }
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ExportDataServiceZipRequest that = (ExportDataServiceZipRequest) obj;
    ...
    public String toString() {
        ...
        sb.append("class ExportDataServiceZipRequest {\n");
