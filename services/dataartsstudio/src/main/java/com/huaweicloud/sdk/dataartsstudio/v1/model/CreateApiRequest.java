...
public class CreateApiRequest {
    ...
    public CreateApiRequest withDlmType(DlmTypeEnum dlmType) {
    ...
    public CreateApiRequest withBody(Api body) {
        this.body = body;
        return this;
    }

    public CreateApiRequest withBody(Consumer<Api> bodySetter) {
        if (this.body == null) {
            this.body = new Api();
    ...
    public boolean equals(java.lang.Object o) {
        ...
        return Objects.equals(this.workspace, createApiRequest.workspace)
            && Objects.equals(this.dlmType, createApiRequest.dlmType)
            && Objects.equals(this.body, createApiRequest.body);
    }
