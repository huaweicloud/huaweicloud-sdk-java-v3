...
public class MemberSyncTask {
    ...
    public MemberSyncTask withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public MemberSyncTask withProjectId(String projectId) {
    ...
    public MemberSyncTask withDomainId(String domainId) {
    ...
    public MemberSyncTask withInstanceId(String instanceId) {
    ...
    public MemberSyncTask withDataConnectionWorkspace(String dataConnectionWorkspace) {
    ...
    public MemberSyncTask withClusterType(ClusterTypeEnum clusterType) {
    ...
    public MemberSyncTask withDataConnectionId(String dataConnectionId) {
    ...
    public MemberSyncTask withDataConnectionName(String dataConnectionName) {
    ...
    public MemberSyncTask withClusterId(String clusterId) {
    ...
    public MemberSyncTask withClusterName(String clusterName) {
    ...
    public MemberSyncTask withScheduleStartHour(Integer scheduleStartHour) {
    ...
    public MemberSyncTask withScheduleEndHour(Integer scheduleEndHour) {
    ...
    public MemberSyncTask withSchedulePeriod(SchedulePeriodEnum schedulePeriod) {
    ...
    public MemberSyncTask withScheduleInterval(Integer scheduleInterval) {
    ...
    public MemberSyncTask withScheduleStatus(ScheduleStatusEnum scheduleStatus) {
    ...
    public MemberSyncTask withSyncStatus(SyncStatusEnum syncStatus) {
    ...
    public MemberSyncTask withSyncMsg(String syncMsg) {
    ...
    public MemberSyncTask withSyncTime(Long syncTime) {
    ...
    public MemberSyncTask withCreateTime(Long createTime) {
    ...
    public MemberSyncTask withCreateUser(String createUser) {
    ...
    public MemberSyncTask withUpdateTime(Long updateTime) {
    ...
    public MemberSyncTask withUpdateUser(String updateUser) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        MemberSyncTask that = (MemberSyncTask) obj;
    ...
    public String toString() {
        ...
        sb.append("class MemberSyncTask {\n");
