 ...
 * Request Object
 */
public class UpdateDataServiceInstanceObsLogRequest {
    ...
    private ObsLogDump body;

    public UpdateDataServiceInstanceObsLogRequest withWorkspace(String workspace) {
    ...
    public UpdateDataServiceInstanceObsLogRequest withDlmType(DlmTypeEnum dlmType) {
    ...
    public UpdateDataServiceInstanceObsLogRequest withInstanceId(String instanceId) {
    ...
    public UpdateDataServiceInstanceObsLogRequest withBody(ObsLogDump body) {
        this.body = body;
        return this;
    }

    public UpdateDataServiceInstanceObsLogRequest withBody(Consumer<ObsLogDump> bodySetter) {
        if (this.body == null) {
            this.body = new ObsLogDump();
     ...
     * @return body
     */
    public ObsLogDump getBody() {
        return body;
    }

    public void setBody(ObsLogDump body) {
        this.body = body;
    }
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        UpdateDataServiceInstanceObsLogRequest that = (UpdateDataServiceInstanceObsLogRequest) obj;
    ...
    public String toString() {
        ...
        sb.append("class UpdateDataServiceInstanceObsLogRequest {\n");
