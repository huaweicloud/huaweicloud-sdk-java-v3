 ...
 * Response Object
 */
public class ShowGroupGeneralPolicyResponse extends SdkResponse {
    ...
    public ShowGroupGeneralPolicyResponse withDisableFork(Boolean disableFork) {
    ...
    public ShowGroupGeneralPolicyResponse withForbiddenDeveloperCreateBranch(Boolean forbiddenDeveloperCreateBranch) {
    ...
    public ShowGroupGeneralPolicyResponse withForbiddenDeveloperCreateTag(Boolean forbiddenDeveloperCreateTag) {
    ...
    public ShowGroupGeneralPolicyResponse withForbiddenCommitterCreateBranch(Boolean forbiddenCommitterCreateBranch) {
    ...
    public ShowGroupGeneralPolicyResponse withBranchNameRegex(String branchNameRegex) {
    ...
    public ShowGroupGeneralPolicyResponse withTagNameRegex(String tagNameRegex) {
    ...
    public ShowGroupGeneralPolicyResponse withGeneratePreMergeRef(Boolean generatePreMergeRef) {
    ...
    public ShowGroupGeneralPolicyResponse withForbiddenGitlabAccess(Boolean forbiddenGitlabAccess) {
    ...
    public ShowGroupGeneralPolicyResponse withRebaseDisableTriggerWebhook(Boolean rebaseDisableTriggerWebhook) {
    ...
    public ShowGroupGeneralPolicyResponse withOpenGpgVerified(Boolean openGpgVerified) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ShowGroupGeneralPolicyResponse that = (ShowGroupGeneralPolicyResponse) obj;
    ...
    public String toString() {
        ...
        sb.append("class ShowGroupGeneralPolicyResponse {\n");
