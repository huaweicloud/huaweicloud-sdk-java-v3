 ...
 * Response Object
 */
public class UpdateGroupMergeRequestTemplateResponse extends SdkResponse {
    ...
    public UpdateGroupMergeRequestTemplateResponse withId(Integer id) {
        this.id = id;
        return this;
    }
    ...
    public UpdateGroupMergeRequestTemplateResponse withRepositoryId(Integer repositoryId) {
    ...
    public UpdateGroupMergeRequestTemplateResponse withDescription(String description) {
    ...
    public UpdateGroupMergeRequestTemplateResponse withCreatedAt(String createdAt) {
    ...
    public UpdateGroupMergeRequestTemplateResponse withUpdatedAt(String updatedAt) {
    ...
    public UpdateGroupMergeRequestTemplateResponse withTemplateName(String templateName) {
    ...
    public UpdateGroupMergeRequestTemplateResponse withMergeRequestTitle(String mergeRequestTitle) {
    ...
    public UpdateGroupMergeRequestTemplateResponse withIsDefault(Boolean isDefault) {
    ...
    public UpdateGroupMergeRequestTemplateResponse withIsWip(Boolean isWip) {
        this.isWip = isWip;
        return this;
    }
    ...
    public UpdateGroupMergeRequestTemplateResponse withAutoExtractMrTitle(Integer autoExtractMrTitle) {
    ...
    public UpdateGroupMergeRequestTemplateResponse withCreator(UserBasicDto creator) {
        this.creator = creator;
        return this;
    }

    public UpdateGroupMergeRequestTemplateResponse withCreator(Consumer<UserBasicDto> creatorSetter) {
    ...
    public UpdateGroupMergeRequestTemplateResponse withGroupId(Integer groupId) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        UpdateGroupMergeRequestTemplateResponse that = (UpdateGroupMergeRequestTemplateResponse) obj;
    ...
    public String toString() {
        ...
        sb.append("class UpdateGroupMergeRequestTemplateResponse {\n");
