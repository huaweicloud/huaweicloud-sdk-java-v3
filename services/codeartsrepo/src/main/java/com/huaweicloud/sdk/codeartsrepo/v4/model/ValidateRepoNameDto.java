...
public class ValidateRepoNameDto {
    ...
    public ValidateRepoNameDto withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public ValidateRepoNameDto withProjectId(String projectId) {
    ...
    public ValidateRepoNameDto withGroupId(Integer groupId) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ValidateRepoNameDto that = (ValidateRepoNameDto) obj;
    ...
    @Override
    public int hashCode() {
        return Objects.hash(name, projectId, groupId);
    }
