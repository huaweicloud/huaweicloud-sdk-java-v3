...
public class UpdateRepoNotificationSubscriptionDto {
    ...
    public UpdateRepoNotificationSubscriptionDto withEnabled(Boolean enabled) {
    ...
    public UpdateRepoNotificationSubscriptionDto withConfigSource(ConfigSourceEnum configSource) {
    ...
    public UpdateRepoNotificationSubscriptionDto withWebhookConfig(UpdateRepoWebHookSubscriptionDto webhookConfig) {
        this.webhookConfig = webhookConfig;
        return this;
    }

    public UpdateRepoNotificationSubscriptionDto withWebhookConfig(
        Consumer<UpdateRepoWebHookSubscriptionDto> webhookConfigSetter) {
        if (this.webhookConfig == null) {
            this.webhookConfig = new UpdateRepoWebHookSubscriptionDto();
     ...
     */
    public UpdateRepoWebHookSubscriptionDto getWebhookConfig() {
        return webhookConfig;
    }

    public void setWebhookConfig(UpdateRepoWebHookSubscriptionDto webhookConfig) {
        this.webhookConfig = webhookConfig;
    }

    public UpdateRepoNotificationSubscriptionDto withWaringRepoUsageRate(WaringRepoUsageRateEnum waringRepoUsageRate) {
    ...
    public UpdateRepoNotificationSubscriptionDto withSubscriptEvents(List<RepoSubscriptionEventDto> subscriptEvents) {
        this.subscriptEvents = subscriptEvents;
        return this;
    }

    public UpdateRepoNotificationSubscriptionDto addSubscriptEventsItem(RepoSubscriptionEventDto subscriptEventsItem) {
    ...
    public UpdateRepoNotificationSubscriptionDto withSubscriptEvents(
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        UpdateRepoNotificationSubscriptionDto that = (UpdateRepoNotificationSubscriptionDto) obj;
        return Objects.equals(this.enabled, that.enabled) && Objects.equals(this.configSource, that.configSource)
    ...
    @Override
    public int hashCode() {
        return Objects.hash(enabled, configSource, webhookConfig, waringRepoUsageRate, subscriptEvents);
    }
