 ...
 * Response Object
 */
public class UpdateMergeRequestResponse extends SdkResponse {
    ...
    public UpdateMergeRequestResponse withId(Integer id) {
        this.id = id;
        return this;
    }
    ...
    public UpdateMergeRequestResponse withIid(Integer iid) {
        this.iid = iid;
        return this;
    }
    ...
    public UpdateMergeRequestResponse withRepositoryId(Integer repositoryId) {
    ...
    public UpdateMergeRequestResponse withTitle(String title) {
        this.title = title;
        return this;
    }
    ...
    public UpdateMergeRequestResponse withDescription(String description) {
    ...
    public UpdateMergeRequestResponse withState(String state) {
        this.state = state;
        return this;
    }
    ...
    public UpdateMergeRequestResponse withCreatedAt(String createdAt) {
    ...
    public UpdateMergeRequestResponse withUpdatedAt(String updatedAt) {
    ...
    public UpdateMergeRequestResponse withSourceBranch(String sourceBranch) {
    ...
    public UpdateMergeRequestResponse withTargetBranch(String targetBranch) {
    ...
    public UpdateMergeRequestResponse withIsSourceBranchProtected(Boolean isSourceBranchProtected) {
    ...
    public UpdateMergeRequestResponse withIsSourceBranchDefault(Boolean isSourceBranchDefault) {
    ...
    public UpdateMergeRequestResponse withDevcloudSourceBranch(String devcloudSourceBranch) {
    ...
    public UpdateMergeRequestResponse withUpvotes(Integer upvotes) {
    ...
    public UpdateMergeRequestResponse withDownvotes(Integer downvotes) {
    ...
    public UpdateMergeRequestResponse withAuthor(UserBasicExternalDto author) {
        this.author = author;
        return this;
    }

    public UpdateMergeRequestResponse withAuthor(Consumer<UserBasicExternalDto> authorSetter) {
        if (this.author == null) {
    ...
    public UpdateMergeRequestResponse withAssignee(UserBasicExternalDto assignee) {
        this.assignee = assignee;
        return this;
    }

    public UpdateMergeRequestResponse withAssignee(Consumer<UserBasicExternalDto> assigneeSetter) {
    ...
    public UpdateMergeRequestResponse withSourceRepositoryId(Integer sourceRepositoryId) {
    ...
    public UpdateMergeRequestResponse withTargetRepositoryId(Integer targetRepositoryId) {
    ...
    public UpdateMergeRequestResponse withSourceProjectId(String sourceProjectId) {
    ...
    public UpdateMergeRequestResponse withTargetProjectId(String targetProjectId) {
    ...
    public UpdateMergeRequestResponse withLabels(List<Object> labels) {
        this.labels = labels;
        return this;
    }

    public UpdateMergeRequestResponse addLabelsItem(Object labelsItem) {
        if (this.labels == null) {
    ...
    public UpdateMergeRequestResponse withLabels(Consumer<List<Object>> labelsSetter) {
        if (this.labels == null) {
            this.labels = new ArrayList<>();
        }
    ...
    public UpdateMergeRequestResponse withWorkInProgress(Boolean workInProgress) {
    ...
    public UpdateMergeRequestResponse withMilestone(MilestoneBasicDto milestone) {
        this.milestone = milestone;
        return this;
    }

    public UpdateMergeRequestResponse withMilestone(Consumer<MilestoneBasicDto> milestoneSetter) {
    ...
    public UpdateMergeRequestResponse withMergeWhenBuildSucceeds(Boolean mergeWhenBuildSucceeds) {
    ...
    public UpdateMergeRequestResponse withMergeStatus(String mergeStatus) {
    ...
    public UpdateMergeRequestResponse withSha(String sha) {
        this.sha = sha;
        return this;
    }
    ...
    public UpdateMergeRequestResponse withMergeCommitSha(String mergeCommitSha) {
    ...
    public UpdateMergeRequestResponse withSubscribed(Boolean subscribed) {
    ...
    public UpdateMergeRequestResponse withMergedBy(UserBasicExternalDto mergedBy) {
        this.mergedBy = mergedBy;
        return this;
    }

    public UpdateMergeRequestResponse withMergedBy(Consumer<UserBasicExternalDto> mergedBySetter) {
    ...
    public UpdateMergeRequestResponse withMergedAt(String mergedAt) {
    ...
    public UpdateMergeRequestResponse withClosedBy(UserBasicExternalDto closedBy) {
        this.closedBy = closedBy;
        return this;
    }

    public UpdateMergeRequestResponse withClosedBy(Consumer<UserBasicExternalDto> closedBySetter) {
    ...
    public UpdateMergeRequestResponse withClosedAt(String closedAt) {
    ...
    public UpdateMergeRequestResponse withUserNotesCount(Integer userNotesCount) {
    ...
    public UpdateMergeRequestResponse withShouldRemoveSourceBranch(Boolean shouldRemoveSourceBranch) {
    ...
    public UpdateMergeRequestResponse withForceRemoveSourceBranch(Boolean forceRemoveSourceBranch) {
    ...
    public UpdateMergeRequestResponse withWebUrl(String webUrl) {
        this.webUrl = webUrl;
        return this;
    }
    ...
    public UpdateMergeRequestResponse withMergeRequestDiff(MergeRequestDiffExternalDto mergeRequestDiff) {
        this.mergeRequestDiff = mergeRequestDiff;
        return this;
    }

    public UpdateMergeRequestResponse withMergeRequestDiff(
    ...
    public UpdateMergeRequestResponse withMergeRequestReviewersCount(Integer mergeRequestReviewersCount) {
    ...
    public UpdateMergeRequestResponse withMergeRequestReviewCount(Integer mergeRequestReviewCount) {
    ...
    public UpdateMergeRequestResponse withMergeRequestReviewerList(
        List<MergeRequestReviewerExternalDto> mergeRequestReviewerList) {
        this.mergeRequestReviewerList = mergeRequestReviewerList;
        return this;
    }

    public UpdateMergeRequestResponse addMergeRequestReviewerListItem(
    ...
    public UpdateMergeRequestResponse withMergeRequestAssigneeList(
        List<UserBasicExternalDto> mergeRequestAssigneeList) {
        this.mergeRequestAssigneeList = mergeRequestAssigneeList;
        return this;
    }

    public UpdateMergeRequestResponse addMergeRequestAssigneeListItem(
    ...
    public UpdateMergeRequestResponse withNotes(Integer notes) {
        this.notes = notes;
        return this;
    }
    ...
    public UpdateMergeRequestResponse withCodecheckState(Integer codecheckState) {
    ...
    public UpdateMergeRequestResponse withCodecheckDefectCount(Integer codecheckDefectCount) {
    ...
    public UpdateMergeRequestResponse withMergeRequestRelatedWorkItems(
    ...
    public UpdateMergeRequestResponse addMergeRequestRelatedWorkItemsItem(
    ...
    public UpdateMergeRequestResponse withDivergedCommitsCount(Integer divergedCommitsCount) {
    ...
    public UpdateMergeRequestResponse withModerationResult(Boolean moderationResult) {
    ...
    public UpdateMergeRequestResponse withModerationTime(Long moderationTime) {
    ...
    public UpdateMergeRequestResponse withModerationStatus(Integer moderationStatus) {
    ...
    public UpdateMergeRequestResponse withIsUseTempBranch(Boolean isUseTempBranch) {
    ...
    public UpdateMergeRequestResponse withOnlyAssigneeCanMerge(Boolean onlyAssigneeCanMerge) {
    ...
    public UpdateMergeRequestResponse withApprovalMergeRequestApprovers(
        List<ApprovalUserDto> approvalMergeRequestApprovers) {
        this.approvalMergeRequestApprovers = approvalMergeRequestApprovers;
        return this;
    }

    public UpdateMergeRequestResponse addApprovalMergeRequestApproversItem(
    ...
    public UpdateMergeRequestResponse withReviewMode(ReviewModeEnum reviewMode) {
    ...
    public UpdateMergeRequestResponse withSquash(Boolean squash) {
        this.squash = squash;
        return this;
    }
    ...
    public UpdateMergeRequestResponse withSquashCommitMessage(String squashCommitMessage) {
    ...
    public UpdateMergeRequestResponse withRebaseInProgress(Boolean rebaseInProgress) {
    ...
    public UpdateMergeRequestResponse withSourceRepository(ProjectSimpleDto sourceRepository) {
        this.sourceRepository = sourceRepository;
        return this;
    }

    public UpdateMergeRequestResponse withSourceRepository(Consumer<ProjectSimpleDto> sourceRepositorySetter) {
    ...
    public UpdateMergeRequestResponse withTargetRepository(ProjectSimpleDto targetRepository) {
        this.targetRepository = targetRepository;
        return this;
    }

    public UpdateMergeRequestResponse withTargetRepository(Consumer<ProjectSimpleDto> targetRepositorySetter) {
    ...
    public UpdateMergeRequestResponse withIsSourceBranchExist(Boolean isSourceBranchExist) {
    ...
    public UpdateMergeRequestResponse withMergeRequestType(String mergeRequestType) {
    ...
    public UpdateMergeRequestResponse withTopic(String topic) {
        this.topic = topic;
        return this;
    }
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        UpdateMergeRequestResponse that = (UpdateMergeRequestResponse) obj;
    ...
    public String toString() {
        ...
        sb.append("class UpdateMergeRequestResponse {\n");
