...
public class ListPipelineJobsRequest {
    ...
    public ListPipelineJobsRequest withRepositoryId(Integer repositoryId) {
    ...
    public ListPipelineJobsRequest withPipelineId(Integer pipelineId) {
    ...
    public ListPipelineJobsRequest withOffset(Integer offset) {
        this.offset = offset;
        return this;
    }
    ...
    @Override
    public int hashCode() {
        return Objects.hash(repositoryId, pipelineId, offset, limit);
    }
