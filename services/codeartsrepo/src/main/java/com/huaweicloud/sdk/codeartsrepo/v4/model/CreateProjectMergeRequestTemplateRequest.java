 ...
 * Request Object
 */
public class CreateProjectMergeRequestTemplateRequest {
    ...
    public CreateProjectMergeRequestTemplateRequest withProjectId(String projectId) {
    ...
    public CreateProjectMergeRequestTemplateRequest withBody(CreateMergeRequestTemplateDto body) {
        this.body = body;
        return this;
    }

    public CreateProjectMergeRequestTemplateRequest withBody(Consumer<CreateMergeRequestTemplateDto> bodySetter) {
        if (this.body == null) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        CreateProjectMergeRequestTemplateRequest that = (CreateProjectMergeRequestTemplateRequest) obj;
    ...
    public String toString() {
        ...
        sb.append("class CreateProjectMergeRequestTemplateRequest {\n");
