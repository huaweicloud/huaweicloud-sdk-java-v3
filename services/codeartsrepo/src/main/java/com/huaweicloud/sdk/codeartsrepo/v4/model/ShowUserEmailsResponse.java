 ...
 * Response Object
 */
public class ShowUserEmailsResponse extends SdkResponse {
    ...
    public ShowUserEmailsResponse withId(Integer id) {
        this.id = id;
        return this;
    }
    ...
    public ShowUserEmailsResponse withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public ShowUserEmailsResponse withUsername(String username) {
    ...
    public ShowUserEmailsResponse withCreatedAt(String createdAt) {
    ...
    public ShowUserEmailsResponse withUpdatedAt(String updatedAt) {
    ...
    public ShowUserEmailsResponse withLastActivityOn(String lastActivityOn) {
    ...
    public ShowUserEmailsResponse withCommitEmail(String commitEmail) {
    ...
    public ShowUserEmailsResponse withIsDefault(Boolean isDefault) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ShowUserEmailsResponse that = (ShowUserEmailsResponse) obj;
