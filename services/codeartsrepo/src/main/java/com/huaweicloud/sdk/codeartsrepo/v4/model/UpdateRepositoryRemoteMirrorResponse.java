 ...
 * Response Object
 */
public class UpdateRepositoryRemoteMirrorResponse extends SdkResponse {
    ...
    public UpdateRepositoryRemoteMirrorResponse withUrl(String url) {
        this.url = url;
        return this;
    }
    ...
    public UpdateRepositoryRemoteMirrorResponse withMirroringEnabled(Boolean mirroringEnabled) {
    ...
    public UpdateRepositoryRemoteMirrorResponse withEndpointUuid(String endpointUuid) {
    ...
    public UpdateRepositoryRemoteMirrorResponse withSyncBranchType(SyncBranchTypeEnum syncBranchType) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        UpdateRepositoryRemoteMirrorResponse that = (UpdateRepositoryRemoteMirrorResponse) obj;
        return Objects.equals(this.url, that.url) && Objects.equals(this.mirroringEnabled, that.mirroringEnabled)
            && Objects.equals(this.endpointUuid, that.endpointUuid)
            && Objects.equals(this.syncBranchType, that.syncBranchType);
    }

    @Override
    public int hashCode() {
        return Objects.hash(url, mirroringEnabled, endpointUuid, syncBranchType);
    }
