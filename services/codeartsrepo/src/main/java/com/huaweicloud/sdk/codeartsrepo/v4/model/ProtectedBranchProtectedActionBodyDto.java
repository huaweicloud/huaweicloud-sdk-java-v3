 ...
 */
public class ProtectedBranchProtectedActionBodyDto {
    ...
    public ProtectedBranchProtectedActionBodyDto withUserTeamIds(List<Integer> userTeamIds) {
        this.userTeamIds = userTeamIds;
        return this;
    }

    public ProtectedBranchProtectedActionBodyDto addUserTeamIdsItem(Integer userTeamIdsItem) {
    ...
    public ProtectedBranchProtectedActionBodyDto withUserTeamIds(Consumer<List<Integer>> userTeamIdsSetter) {
        if (this.userTeamIds == null) {
            this.userTeamIds = new ArrayList<>();
        }
    ...
    public ProtectedBranchProtectedActionBodyDto withRelatedRoleIds(List<String> relatedRoleIds) {
        this.relatedRoleIds = relatedRoleIds;
        return this;
    }

    public ProtectedBranchProtectedActionBodyDto addRelatedRoleIdsItem(String relatedRoleIdsItem) {
    ...
    public ProtectedBranchProtectedActionBodyDto withRelatedRoleIds(Consumer<List<String>> relatedRoleIdsSetter) {
        if (this.relatedRoleIds == null) {
            this.relatedRoleIds = new ArrayList<>();
        }
    ...
    public ProtectedBranchProtectedActionBodyDto withAction(ActionEnum action) {
        this.action = action;
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append("class ProtectedBranchProtectedActionBodyDto {\n");
