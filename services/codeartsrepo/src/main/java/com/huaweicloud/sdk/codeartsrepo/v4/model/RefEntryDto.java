...
public class RefEntryDto {
    ...
    public RefEntryDto withTagName(String tagName) {
    ...
    public RefEntryDto withFilePath(String filePath) {
    ...
    public RefEntryDto withBlob(String blob) {
        this.blob = blob;
        return this;
    }
    ...
    public RefEntryDto withLineImage(String lineImage) {
    ...
    public RefEntryDto withLineNumber(Integer lineNumber) {
    ...
    public RefEntryDto withSyntaxType(String syntaxType) {
    ...
    public RefEntryDto withRevision(String revision) {
    ...
    public RefEntryDto withExtend(String extend) {
        this.extend = extend;
        return this;
    }
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        RefEntryDto that = (RefEntryDto) obj;
        return Objects.equals(this.tagName, that.tagName) && Objects.equals(this.filePath, that.filePath)
            ...
            && Objects.equals(this.lineNumber, that.lineNumber) && Objects.equals(this.syntaxType, that.syntaxType)
            && Objects.equals(this.revision, that.revision) && Objects.equals(this.extend, that.extend);
    }

    @Override
    public int hashCode() {
        return Objects.hash(tagName, filePath, blob, lineImage, lineNumber, syntaxType, revision, extend);
    }
