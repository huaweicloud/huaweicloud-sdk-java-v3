 ...
 */
public class GeneralCommitRuleBodyDto {
    ...
    public GeneralCommitRuleBodyDto withRejectUnsignedCommits(Boolean rejectUnsignedCommits) {
    ...
    public GeneralCommitRuleBodyDto withRejectNotSignedByGpg(Boolean rejectNotSignedByGpg) {
    ...
    public GeneralCommitRuleBodyDto withDenyDeleteTag(Boolean denyDeleteTag) {
    ...
    public GeneralCommitRuleBodyDto withPreventSecrets(Boolean preventSecrets) {
    ...
    public GeneralCommitRuleBodyDto withDenyForcePush(Boolean denyForcePush) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        GeneralCommitRuleBodyDto that = (GeneralCommitRuleBodyDto) obj;
    ...
    public String toString() {
        ...
        sb.append("class GeneralCommitRuleBodyDto {\n");
