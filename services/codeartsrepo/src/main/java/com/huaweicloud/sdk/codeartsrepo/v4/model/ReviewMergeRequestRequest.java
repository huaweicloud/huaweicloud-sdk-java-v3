 ...
 * Request Object
 */
public class ReviewMergeRequestRequest {
    ...
    public ReviewMergeRequestRequest withRepositoryId(Integer repositoryId) {
    ...
    public ReviewMergeRequestRequest withMergeRequestIid(Integer mergeRequestIid) {
    ...
    public ReviewMergeRequestRequest withBody(ApprovalActionTypeDto body) {
        this.body = body;
        return this;
    }

    public ReviewMergeRequestRequest withBody(Consumer<ApprovalActionTypeDto> bodySetter) {
        if (this.body == null) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ReviewMergeRequestRequest that = (ReviewMergeRequestRequest) obj;
    ...
    public String toString() {
        ...
        sb.append("class ReviewMergeRequestRequest {\n");
