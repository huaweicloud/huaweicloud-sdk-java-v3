 ...
 * Response Object
 */
public class UpdateMergeRequestSettingResponse extends SdkResponse {
    ...
    public UpdateMergeRequestSettingResponse withDisableMergeBySelf(Boolean disableMergeBySelf) {
    ...
    public UpdateMergeRequestSettingResponse withDisableApproveBySelf(Boolean disableApproveBySelf) {
    ...
    public UpdateMergeRequestSettingResponse withDisableReviewBySelf(Boolean disableReviewBySelf) {
    ...
    public UpdateMergeRequestSettingResponse withCreatedAt(String createdAt) {
    ...
    public UpdateMergeRequestSettingResponse withUpdatedAt(String updatedAt) {
    ...
    public UpdateMergeRequestSettingResponse withCanForceMerge(Boolean canForceMerge) {
    ...
    public UpdateMergeRequestSettingResponse withDisableSquashMerge(Boolean disableSquashMerge) {
    ...
    public UpdateMergeRequestSettingResponse withMustRelateIssue(Boolean mustRelateIssue) {
    ...
    public UpdateMergeRequestSettingResponse withNeedRelateIssueBranches(String needRelateIssueBranches) {
    ...
    public UpdateMergeRequestSettingResponse withNeedAllIssuesCheckPassed(Boolean needAllIssuesCheckPassed) {
    ...
    public UpdateMergeRequestSettingResponse withReviewMode(ReviewModeEnum reviewMode) {
    ...
    public UpdateMergeRequestSettingResponse withAddNotesAfterMerged(Boolean addNotesAfterMerged) {
    ...
    public UpdateMergeRequestSettingResponse withMergedCommitAuthor(MergedCommitAuthorEnum mergedCommitAuthor) {
    ...
    public UpdateMergeRequestSettingResponse withEvaluationRole(EvaluationRoleEnum evaluationRole) {
    ...
    public UpdateMergeRequestSettingResponse withEvaluationMergeGate(Boolean evaluationMergeGate) {
    ...
    public UpdateMergeRequestSettingResponse withMarkAutoMergedMrAsClosed(Boolean markAutoMergedMrAsClosed) {
    ...
    public UpdateMergeRequestSettingResponse withDeleteSourceBranchWhenMerged(Boolean deleteSourceBranchWhenMerged) {
    ...
    public UpdateMergeRequestSettingResponse withAutoSquashMerge(Boolean autoSquashMerge) {
    ...
    public UpdateMergeRequestSettingResponse withSquashMergeWithNoMergeCommit(Boolean squashMergeWithNoMergeCommit) {
    ...
    public UpdateMergeRequestSettingResponse withOnlyAllowOneIssueCheckPassed(Boolean onlyAllowOneIssueCheckPassed) {
    ...
    public UpdateMergeRequestSettingResponse withEnableCustomEvaluation(Boolean enableCustomEvaluation) {
    ...
    public UpdateMergeRequestSettingResponse withEvaluationTypes(List<EvaluationTypeDto> evaluationTypes) {
        this.evaluationTypes = evaluationTypes;
        return this;
    }

    public UpdateMergeRequestSettingResponse addEvaluationTypesItem(EvaluationTypeDto evaluationTypesItem) {
    ...
    public UpdateMergeRequestSettingResponse withEvaluationTypes(
    ...
    public UpdateMergeRequestSettingResponse withCanReopen(Boolean canReopen) {
    ...
    public UpdateMergeRequestSettingResponse withOnlyAllowMergeIfAllDiscussionsAreResolved(
    ...
    public UpdateMergeRequestSettingResponse withMergeMethod(MergeMethodEnum mergeMethod) {
    ...
    public UpdateMergeRequestSettingResponse withOnlyAllowMergeIfVoteBiggerThan(
    ...
    public UpdateMergeRequestSettingResponse withOnlyAssigneeCanMerge(Boolean onlyAssigneeCanMerge) {
    ...
    public UpdateMergeRequestSettingResponse withRepositoryId(Integer repositoryId) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        UpdateMergeRequestSettingResponse that = (UpdateMergeRequestSettingResponse) obj;
    ...
    public String toString() {
        ...
        sb.append("class UpdateMergeRequestSettingResponse {\n");
