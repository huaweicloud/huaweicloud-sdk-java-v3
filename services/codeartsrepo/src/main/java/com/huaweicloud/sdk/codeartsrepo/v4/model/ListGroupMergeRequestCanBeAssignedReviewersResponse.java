 ...
 * Response Object
 */
public class ListGroupMergeRequestCanBeAssignedReviewersResponse extends SdkResponse {
    ...
    public ListGroupMergeRequestCanBeAssignedReviewersResponse withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public ListGroupMergeRequestCanBeAssignedReviewersResponse withUsername(String username) {
    ...
    public ListGroupMergeRequestCanBeAssignedReviewersResponse withState(StateEnum state) {
        this.state = state;
        return this;
    }
    ...
    public ListGroupMergeRequestCanBeAssignedReviewersResponse withServiceLicenseStatus(Integer serviceLicenseStatus) {
    ...
    public ListGroupMergeRequestCanBeAssignedReviewersResponse withAvatarUrl(String avatarUrl) {
    ...
    public ListGroupMergeRequestCanBeAssignedReviewersResponse withAvatarPath(String avatarPath) {
    ...
    public ListGroupMergeRequestCanBeAssignedReviewersResponse withEmail(String email) {
        this.email = email;
        return this;
    }
    ...
    public ListGroupMergeRequestCanBeAssignedReviewersResponse withNameCn(String nameCn) {
        this.nameCn = nameCn;
        return this;
    }
    ...
    public ListGroupMergeRequestCanBeAssignedReviewersResponse withWebUrl(String webUrl) {
        this.webUrl = webUrl;
        return this;
    }
    ...
    public ListGroupMergeRequestCanBeAssignedReviewersResponse withNickName(String nickName) {
    ...
    public ListGroupMergeRequestCanBeAssignedReviewersResponse withTenantName(String tenantName) {
    ...
    public ListGroupMergeRequestCanBeAssignedReviewersResponse withErrorMessage(String errorMessage) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ListGroupMergeRequestCanBeAssignedReviewersResponse that =
            (ListGroupMergeRequestCanBeAssignedReviewersResponse) obj;
