 ...
 * Response Object
 */
public class CreateMergeRequestResponse extends SdkResponse {
    ...
    public CreateMergeRequestResponse withId(Integer id) {
        this.id = id;
        return this;
    }
    ...
    public CreateMergeRequestResponse withIid(Integer iid) {
        this.iid = iid;
        return this;
    }
    ...
    public CreateMergeRequestResponse withRepositoryId(Integer repositoryId) {
    ...
    public CreateMergeRequestResponse withTitle(String title) {
        this.title = title;
        return this;
    }
    ...
    public CreateMergeRequestResponse withDescription(String description) {
    ...
    public CreateMergeRequestResponse withState(String state) {
        this.state = state;
        return this;
    }
    ...
    public CreateMergeRequestResponse withCreatedAt(String createdAt) {
    ...
    public CreateMergeRequestResponse withUpdatedAt(String updatedAt) {
    ...
    public CreateMergeRequestResponse withSourceBranch(String sourceBranch) {
    ...
    public CreateMergeRequestResponse withTargetBranch(String targetBranch) {
    ...
    public CreateMergeRequestResponse withIsSourceBranchProtected(Boolean isSourceBranchProtected) {
    ...
    public CreateMergeRequestResponse withIsSourceBranchDefault(Boolean isSourceBranchDefault) {
    ...
    public CreateMergeRequestResponse withDevcloudSourceBranch(String devcloudSourceBranch) {
    ...
    public CreateMergeRequestResponse withUpvotes(Integer upvotes) {
    ...
    public CreateMergeRequestResponse withDownvotes(Integer downvotes) {
    ...
    public CreateMergeRequestResponse withAuthor(UserBasicExternalDto author) {
        this.author = author;
        return this;
    }

    public CreateMergeRequestResponse withAuthor(Consumer<UserBasicExternalDto> authorSetter) {
        if (this.author == null) {
    ...
    public CreateMergeRequestResponse withAssignee(UserBasicExternalDto assignee) {
        this.assignee = assignee;
        return this;
    }

    public CreateMergeRequestResponse withAssignee(Consumer<UserBasicExternalDto> assigneeSetter) {
    ...
    public CreateMergeRequestResponse withSourceRepositoryId(Integer sourceRepositoryId) {
    ...
    public CreateMergeRequestResponse withTargetRepositoryId(Integer targetRepositoryId) {
    ...
    public CreateMergeRequestResponse withSourceProjectId(String sourceProjectId) {
    ...
    public CreateMergeRequestResponse withTargetProjectId(String targetProjectId) {
    ...
    public CreateMergeRequestResponse withLabels(List<Object> labels) {
        this.labels = labels;
        return this;
    }

    public CreateMergeRequestResponse addLabelsItem(Object labelsItem) {
        if (this.labels == null) {
    ...
    public CreateMergeRequestResponse withLabels(Consumer<List<Object>> labelsSetter) {
        if (this.labels == null) {
            this.labels = new ArrayList<>();
        }
    ...
    public CreateMergeRequestResponse withWorkInProgress(Boolean workInProgress) {
    ...
    public CreateMergeRequestResponse withMilestone(MilestoneBasicDto milestone) {
        this.milestone = milestone;
        return this;
    }

    public CreateMergeRequestResponse withMilestone(Consumer<MilestoneBasicDto> milestoneSetter) {
    ...
    public CreateMergeRequestResponse withMergeWhenBuildSucceeds(Boolean mergeWhenBuildSucceeds) {
    ...
    public CreateMergeRequestResponse withMergeStatus(String mergeStatus) {
    ...
    public CreateMergeRequestResponse withSha(String sha) {
        this.sha = sha;
        return this;
    }
    ...
    public CreateMergeRequestResponse withMergeCommitSha(String mergeCommitSha) {
    ...
    public CreateMergeRequestResponse withSubscribed(Boolean subscribed) {
    ...
    public CreateMergeRequestResponse withMergedBy(UserBasicExternalDto mergedBy) {
        this.mergedBy = mergedBy;
        return this;
    }

    public CreateMergeRequestResponse withMergedBy(Consumer<UserBasicExternalDto> mergedBySetter) {
    ...
    public CreateMergeRequestResponse withMergedAt(String mergedAt) {
    ...
    public CreateMergeRequestResponse withClosedBy(UserBasicExternalDto closedBy) {
        this.closedBy = closedBy;
        return this;
    }

    public CreateMergeRequestResponse withClosedBy(Consumer<UserBasicExternalDto> closedBySetter) {
    ...
    public CreateMergeRequestResponse withClosedAt(String closedAt) {
    ...
    public CreateMergeRequestResponse withUserNotesCount(Integer userNotesCount) {
    ...
    public CreateMergeRequestResponse withShouldRemoveSourceBranch(Boolean shouldRemoveSourceBranch) {
    ...
    public CreateMergeRequestResponse withForceRemoveSourceBranch(Boolean forceRemoveSourceBranch) {
    ...
    public CreateMergeRequestResponse withWebUrl(String webUrl) {
        this.webUrl = webUrl;
        return this;
    }
    ...
    public CreateMergeRequestResponse withMergeRequestDiff(MergeRequestDiffExternalDto mergeRequestDiff) {
        this.mergeRequestDiff = mergeRequestDiff;
        return this;
    }

    public CreateMergeRequestResponse withMergeRequestDiff(
    ...
    public CreateMergeRequestResponse withMergeRequestReviewersCount(Integer mergeRequestReviewersCount) {
    ...
    public CreateMergeRequestResponse withMergeRequestReviewCount(Integer mergeRequestReviewCount) {
    ...
    public CreateMergeRequestResponse withMergeRequestReviewerList(
        List<MergeRequestReviewerExternalDto> mergeRequestReviewerList) {
        this.mergeRequestReviewerList = mergeRequestReviewerList;
        return this;
    }

    public CreateMergeRequestResponse addMergeRequestReviewerListItem(
    ...
    public CreateMergeRequestResponse withMergeRequestAssigneeList(
        List<UserBasicExternalDto> mergeRequestAssigneeList) {
        this.mergeRequestAssigneeList = mergeRequestAssigneeList;
        return this;
    }

    public CreateMergeRequestResponse addMergeRequestAssigneeListItem(
    ...
    public CreateMergeRequestResponse withNotes(Integer notes) {
        this.notes = notes;
        return this;
    }
    ...
    public CreateMergeRequestResponse withCodecheckState(Integer codecheckState) {
    ...
    public CreateMergeRequestResponse withCodecheckDefectCount(Integer codecheckDefectCount) {
    ...
    public CreateMergeRequestResponse withMergeRequestRelatedWorkItems(
    ...
    public CreateMergeRequestResponse addMergeRequestRelatedWorkItemsItem(
    ...
    public CreateMergeRequestResponse withDivergedCommitsCount(Integer divergedCommitsCount) {
    ...
    public CreateMergeRequestResponse withModerationResult(Boolean moderationResult) {
    ...
    public CreateMergeRequestResponse withModerationTime(Long moderationTime) {
    ...
    public CreateMergeRequestResponse withModerationStatus(Integer moderationStatus) {
    ...
    public CreateMergeRequestResponse withIsUseTempBranch(Boolean isUseTempBranch) {
    ...
    public CreateMergeRequestResponse withOnlyAssigneeCanMerge(Boolean onlyAssigneeCanMerge) {
    ...
    public CreateMergeRequestResponse withApprovalMergeRequestApprovers(
        List<ApprovalUserDto> approvalMergeRequestApprovers) {
        this.approvalMergeRequestApprovers = approvalMergeRequestApprovers;
        return this;
    }

    public CreateMergeRequestResponse addApprovalMergeRequestApproversItem(
    ...
    public CreateMergeRequestResponse withReviewMode(ReviewModeEnum reviewMode) {
    ...
    public CreateMergeRequestResponse withSquash(Boolean squash) {
        this.squash = squash;
        return this;
    }
    ...
    public CreateMergeRequestResponse withSquashCommitMessage(String squashCommitMessage) {
    ...
    public CreateMergeRequestResponse withRebaseInProgress(Boolean rebaseInProgress) {
    ...
    public CreateMergeRequestResponse withSourceRepository(ProjectSimpleDto sourceRepository) {
        this.sourceRepository = sourceRepository;
        return this;
    }

    public CreateMergeRequestResponse withSourceRepository(Consumer<ProjectSimpleDto> sourceRepositorySetter) {
    ...
    public CreateMergeRequestResponse withTargetRepository(ProjectSimpleDto targetRepository) {
        this.targetRepository = targetRepository;
        return this;
    }

    public CreateMergeRequestResponse withTargetRepository(Consumer<ProjectSimpleDto> targetRepositorySetter) {
    ...
    public CreateMergeRequestResponse withIsSourceBranchExist(Boolean isSourceBranchExist) {
    ...
    public CreateMergeRequestResponse withMergeRequestType(String mergeRequestType) {
    ...
    public CreateMergeRequestResponse withTopic(String topic) {
        this.topic = topic;
        return this;
    }
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        CreateMergeRequestResponse that = (CreateMergeRequestResponse) obj;
        return Objects.equals(this.id, that.id) && Objects.equals(this.iid, that.iid)
            ...
            && Objects.equals(this.mergeRequestType, that.mergeRequestType) && Objects.equals(this.topic, that.topic);
    }
    ...
    public String toString() {
        ...
        sb.append("class CreateMergeRequestResponse {\n");
