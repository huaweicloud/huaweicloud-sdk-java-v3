 ...
 * Response Object
 */
public class ShowRepositoryE2eSettingResponse extends SdkResponse {
    ...
    public ShowRepositoryE2eSettingResponse withE2ePolicies(E2ePolicyDto e2ePolicies) {
        this.e2ePolicies = e2ePolicies;
        return this;
    }

    public ShowRepositoryE2eSettingResponse withE2ePolicies(Consumer<E2ePolicyDto> e2ePoliciesSetter) {
    ...
    public ShowRepositoryE2eSettingResponse withReq(ReqSettingDto req) {
        this.req = req;
        return this;
    }

    public ShowRepositoryE2eSettingResponse withReq(Consumer<ReqSettingDto> reqSetter) {
        if (this.req == null) {
    ...
    public ShowRepositoryE2eSettingResponse withLink(LinkSettingDto link) {
        this.link = link;
        return this;
    }

    public ShowRepositoryE2eSettingResponse withLink(Consumer<LinkSettingDto> linkSetter) {
        if (this.link == null) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ShowRepositoryE2eSettingResponse that = (ShowRepositoryE2eSettingResponse) obj;
    ...
    public String toString() {
        ...
        sb.append("class ShowRepositoryE2eSettingResponse {\n");
