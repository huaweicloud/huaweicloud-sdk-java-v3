 ...
 * Request Object
 */
public class ListMergeRequestApproversRequest {
    ...
    public ListMergeRequestApproversRequest withRepositoryId(Integer repositoryId) {
    ...
    public ListMergeRequestApproversRequest withTargetBranch(String targetBranch) {
    ...
    public ListMergeRequestApproversRequest withSourceBranch(String sourceBranch) {
    ...
    public ListMergeRequestApproversRequest withMergeRequestIid(Integer mergeRequestIid) {
    ...
    public ListMergeRequestApproversRequest withTargetRepositoryId(String targetRepositoryId) {
    ...
    public ListMergeRequestApproversRequest withSearch(String search) {
        this.search = search;
        return this;
    }
    ...
    public ListMergeRequestApproversRequest withOffset(Integer offset) {
        this.offset = offset;
        return this;
    }
    ...
    public ListMergeRequestApproversRequest withLimit(Integer limit) {
        this.limit = limit;
        return this;
    }
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ListMergeRequestApproversRequest that = (ListMergeRequestApproversRequest) obj;
    ...
    public String toString() {
        ...
        sb.append("class ListMergeRequestApproversRequest {\n");
