 ...
 * Response Object
 */
public class ShowRepositoryGeneralCommitRuleResponse extends SdkResponse {
    ...
    public ShowRepositoryGeneralCommitRuleResponse withRejectUnsignedCommits(Boolean rejectUnsignedCommits) {
    ...
    public ShowRepositoryGeneralCommitRuleResponse withRejectNotSignedByGpg(Boolean rejectNotSignedByGpg) {
    ...
    public ShowRepositoryGeneralCommitRuleResponse withDenyDeleteTag(Boolean denyDeleteTag) {
    ...
    public ShowRepositoryGeneralCommitRuleResponse withPreventSecrets(Boolean preventSecrets) {
    ...
    public ShowRepositoryGeneralCommitRuleResponse withDenyForcePush(Boolean denyForcePush) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ShowRepositoryGeneralCommitRuleResponse that = (ShowRepositoryGeneralCommitRuleResponse) obj;
