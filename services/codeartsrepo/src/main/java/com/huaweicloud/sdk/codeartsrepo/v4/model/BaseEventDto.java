...
public class BaseEventDto {
    ...
    public BaseEventDto withActionName(ActionNameEnum actionName) {
    ...
    public BaseEventDto withAuthor(RepositoryEventAuthorDto author) {
        this.author = author;
        return this;
    }

    public BaseEventDto withAuthor(Consumer<RepositoryEventAuthorDto> authorSetter) {
        if (this.author == null) {
    ...
    public BaseEventDto withAuthorId(Integer authorId) {
    ...
    public BaseEventDto withAuthorUsername(String authorUsername) {
    ...
    public BaseEventDto withCreatedAt(String createdAt) {
    ...
    public BaseEventDto withRepositoryId(Integer repositoryId) {
    ...
    public BaseEventDto withRepositoryName(String repositoryName) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        BaseEventDto that = (BaseEventDto) obj;
    ...
    @Override
    public int hashCode() {
        return Objects.hash(actionName, author, authorId, authorUsername, createdAt, repositoryId, repositoryName);
    }

    @Override
    public String toString() {
        StringBuilder sb = new StringBuilder();
        sb.append("class BaseEventDto {\n");
