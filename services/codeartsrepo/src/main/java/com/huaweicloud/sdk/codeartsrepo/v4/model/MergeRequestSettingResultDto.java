 ...
 * 合并请求设置返回体
 */
public class MergeRequestSettingResultDto {
    ...
    public MergeRequestSettingResultDto withId(Integer id) {
        this.id = id;
        return this;
    }
    ...
    public MergeRequestSettingResultDto withDisableMergeBySelf(Boolean disableMergeBySelf) {
    ...
    public MergeRequestSettingResultDto withDisableApproveBySelf(Boolean disableApproveBySelf) {
    ...
    public MergeRequestSettingResultDto withDisableReviewBySelf(Boolean disableReviewBySelf) {
    ...
    public MergeRequestSettingResultDto withCreatedAt(String createdAt) {
    ...
    public MergeRequestSettingResultDto withUpdatedAt(String updatedAt) {
    ...
    public MergeRequestSettingResultDto withCanForceMerge(Boolean canForceMerge) {
    ...
    public MergeRequestSettingResultDto withDisableSquashMerge(Boolean disableSquashMerge) {
    ...
    public MergeRequestSettingResultDto withMustRelateIssue(Boolean mustRelateIssue) {
    ...
    public MergeRequestSettingResultDto withNeedRelateIssueBranches(String needRelateIssueBranches) {
    ...
    public MergeRequestSettingResultDto withNeedAllIssuesCheckPassed(Boolean needAllIssuesCheckPassed) {
    ...
    public MergeRequestSettingResultDto withReviewMode(ReviewModeEnum reviewMode) {
    ...
    public MergeRequestSettingResultDto withAddNotesAfterMerged(Boolean addNotesAfterMerged) {
    ...
    public MergeRequestSettingResultDto withMergedCommitAuthor(MergedCommitAuthorEnum mergedCommitAuthor) {
    ...
    public MergeRequestSettingResultDto withEvaluationRole(EvaluationRoleEnum evaluationRole) {
    ...
    public MergeRequestSettingResultDto withEvaluationMergeGate(Boolean evaluationMergeGate) {
    ...
    public MergeRequestSettingResultDto withMarkAutoMergedMrAsClosed(Boolean markAutoMergedMrAsClosed) {
    ...
    public MergeRequestSettingResultDto withDeleteSourceBranchWhenMerged(Boolean deleteSourceBranchWhenMerged) {
    ...
    public MergeRequestSettingResultDto withAutoSquashMerge(Boolean autoSquashMerge) {
    ...
    public MergeRequestSettingResultDto withSquashMergeWithNoMergeCommit(Boolean squashMergeWithNoMergeCommit) {
    ...
    public MergeRequestSettingResultDto withOnlyAllowOneIssueCheckPassed(Boolean onlyAllowOneIssueCheckPassed) {
    ...
    public MergeRequestSettingResultDto withEnableCustomEvaluation(Boolean enableCustomEvaluation) {
    ...
    public MergeRequestSettingResultDto withEvaluationTypes(List<EvaluationTypeDto> evaluationTypes) {
        this.evaluationTypes = evaluationTypes;
        return this;
    }

    public MergeRequestSettingResultDto addEvaluationTypesItem(EvaluationTypeDto evaluationTypesItem) {
    ...
    public MergeRequestSettingResultDto withEvaluationTypes(Consumer<List<EvaluationTypeDto>> evaluationTypesSetter) {
        if (this.evaluationTypes == null) {
            this.evaluationTypes = new ArrayList<>();
        }
    ...
    public MergeRequestSettingResultDto withCanReopen(Boolean canReopen) {
    ...
    public MergeRequestSettingResultDto withOnlyAllowMergeIfAllDiscussionsAreResolved(
    ...
    public MergeRequestSettingResultDto withMergeMethod(MergeMethodEnum mergeMethod) {
    ...
    public MergeRequestSettingResultDto withOnlyAllowMergeIfVoteBiggerThan(Integer onlyAllowMergeIfVoteBiggerThan) {
    ...
    public MergeRequestSettingResultDto withOnlyAssigneeCanMerge(Boolean onlyAssigneeCanMerge) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        MergeRequestSettingResultDto that = (MergeRequestSettingResultDto) obj;
    ...
    public String toString() {
        ...
        sb.append("class MergeRequestSettingResultDto {\n");
