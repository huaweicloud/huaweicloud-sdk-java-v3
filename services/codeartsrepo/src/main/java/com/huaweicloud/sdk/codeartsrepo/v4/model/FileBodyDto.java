...
public class FileBodyDto {
    ...
    public FileBodyDto withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public FileBodyDto withFilePath(String filePath) {
    ...
    public FileBodyDto withBranch(String branch) {
        this.branch = branch;
        return this;
    }
    ...
    public FileBodyDto withCommitMessage(String commitMessage) {
    ...
    public FileBodyDto withAuthorEmail(String authorEmail) {
    ...
    public FileBodyDto withAuthorName(String authorName) {
    ...
    public FileBodyDto withContent(String content) {
    ...
    public FileBodyDto withEncoding(String encoding) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        FileBodyDto that = (FileBodyDto) obj;
    ...
    @Override
    public int hashCode() {
        return Objects.hash(name, filePath, branch, commitMessage, authorEmail, authorName, content, encoding);
    }

    @Override
    public String toString() {
        StringBuilder sb = new StringBuilder();
        sb.append("class FileBodyDto {\n");
