 ...
 * Request Object
 */
public class UpdateMergeRequestDiscussionInfoRequest {
    ...
    public UpdateMergeRequestDiscussionInfoRequest withRepositoryId(Integer repositoryId) {
    ...
    public UpdateMergeRequestDiscussionInfoRequest withMergeRequestIid(Integer mergeRequestIid) {
    ...
    public UpdateMergeRequestDiscussionInfoRequest withDiscussionId(String discussionId) {
    ...
    public UpdateMergeRequestDiscussionInfoRequest withBody(UpdateMergeRequestNoteDto body) {
        this.body = body;
        return this;
    }

    public UpdateMergeRequestDiscussionInfoRequest withBody(Consumer<UpdateMergeRequestNoteDto> bodySetter) {
        if (this.body == null) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        UpdateMergeRequestDiscussionInfoRequest that = (UpdateMergeRequestDiscussionInfoRequest) obj;
    ...
    public String toString() {
        ...
        sb.append("class UpdateMergeRequestDiscussionInfoRequest {\n");
