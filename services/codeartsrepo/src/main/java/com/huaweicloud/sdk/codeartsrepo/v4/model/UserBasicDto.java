...
public class UserBasicDto {
    ...
    public UserBasicDto withState(StateEnum state) {
        this.state = state;
        return this;
    }
    ...
    public UserBasicDto withServiceLicenseStatus(Integer serviceLicenseStatus) {
    ...
    public UserBasicDto withErrorMessage(String errorMessage) {
