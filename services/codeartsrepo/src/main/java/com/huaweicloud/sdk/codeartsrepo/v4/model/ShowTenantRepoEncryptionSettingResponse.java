 ...
 * Response Object
 */
public class ShowTenantRepoEncryptionSettingResponse extends SdkResponse {
    ...
    public ShowTenantRepoEncryptionSettingResponse withTenantId(String tenantId) {
    ...
    public ShowTenantRepoEncryptionSettingResponse withEncryptionType(String encryptionType) {
    ...
    public ShowTenantRepoEncryptionSettingResponse withDefaultEncryptionEnabled(Boolean defaultEncryptionEnabled) {
    ...
    public ShowTenantRepoEncryptionSettingResponse withCmkKeyName(String cmkKeyName) {
    ...
    public ShowTenantRepoEncryptionSettingResponse withCmkKeyId(String cmkKeyId) {
    ...
    public ShowTenantRepoEncryptionSettingResponse withId(Integer id) {
        this.id = id;
        return this;
    }
    ...
    public ShowTenantRepoEncryptionSettingResponse withKeyState(KeyStateEnum keyState) {
    ...
    public ShowTenantRepoEncryptionSettingResponse withRegion(String region) {
        this.region = region;
        return this;
    }
    ...
    public ShowTenantRepoEncryptionSettingResponse withRegionType(String regionType) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ShowTenantRepoEncryptionSettingResponse that = (ShowTenantRepoEncryptionSettingResponse) obj;
