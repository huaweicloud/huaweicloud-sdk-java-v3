 ...
 * Response Object
 */
public class CreateProjectMergeRequestTemplateResponse extends SdkResponse {
    ...
    public CreateProjectMergeRequestTemplateResponse withId(Integer id) {
        this.id = id;
        return this;
    }
    ...
    public CreateProjectMergeRequestTemplateResponse withRepositoryId(Integer repositoryId) {
    ...
    public CreateProjectMergeRequestTemplateResponse withDescription(String description) {
    ...
    public CreateProjectMergeRequestTemplateResponse withCreatedAt(String createdAt) {
    ...
    public CreateProjectMergeRequestTemplateResponse withUpdatedAt(String updatedAt) {
    ...
    public CreateProjectMergeRequestTemplateResponse withTemplateName(String templateName) {
    ...
    public CreateProjectMergeRequestTemplateResponse withMergeRequestTitle(String mergeRequestTitle) {
    ...
    public CreateProjectMergeRequestTemplateResponse withIsDefault(Boolean isDefault) {
    ...
    public CreateProjectMergeRequestTemplateResponse withIsWip(Boolean isWip) {
        this.isWip = isWip;
        return this;
    }
    ...
    public CreateProjectMergeRequestTemplateResponse withAutoExtractMrTitle(Integer autoExtractMrTitle) {
    ...
    public CreateProjectMergeRequestTemplateResponse withCreator(UserBasicDto creator) {
        this.creator = creator;
        return this;
    }

    public CreateProjectMergeRequestTemplateResponse withCreator(Consumer<UserBasicDto> creatorSetter) {
    ...
    public CreateProjectMergeRequestTemplateResponse withProjectId(String projectId) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        CreateProjectMergeRequestTemplateResponse that = (CreateProjectMergeRequestTemplateResponse) obj;
    ...
    public String toString() {
        ...
        sb.append("class CreateProjectMergeRequestTemplateResponse {\n");
