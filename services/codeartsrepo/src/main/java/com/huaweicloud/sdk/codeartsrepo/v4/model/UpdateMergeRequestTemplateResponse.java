 ...
 * Response Object
 */
public class UpdateMergeRequestTemplateResponse extends SdkResponse {
    ...
    public UpdateMergeRequestTemplateResponse withId(Integer id) {
        this.id = id;
        return this;
    }
    ...
    public UpdateMergeRequestTemplateResponse withDescription(String description) {
    ...
    public UpdateMergeRequestTemplateResponse withCreatedAt(String createdAt) {
    ...
    public UpdateMergeRequestTemplateResponse withUpdatedAt(String updatedAt) {
    ...
    public UpdateMergeRequestTemplateResponse withTemplateName(String templateName) {
    ...
    public UpdateMergeRequestTemplateResponse withMergeRequestTitle(String mergeRequestTitle) {
    ...
    public UpdateMergeRequestTemplateResponse withIsDefault(Boolean isDefault) {
    ...
    public UpdateMergeRequestTemplateResponse withIsWip(Boolean isWip) {
        this.isWip = isWip;
        return this;
    }
    ...
    public UpdateMergeRequestTemplateResponse withAutoExtractMrTitle(Integer autoExtractMrTitle) {
    ...
    public UpdateMergeRequestTemplateResponse withCreator(UserBasicDto creator) {
        this.creator = creator;
        return this;
    }

    public UpdateMergeRequestTemplateResponse withCreator(Consumer<UserBasicDto> creatorSetter) {
    ...
    public UpdateMergeRequestTemplateResponse withRepositoryId(Integer repositoryId) {
    ...
    public UpdateMergeRequestTemplateResponse withFrom(MergeRequestTemplateFromDto from) {
        this.from = from;
        return this;
    }

    public UpdateMergeRequestTemplateResponse withFrom(Consumer<MergeRequestTemplateFromDto> fromSetter) {
        if (this.from == null) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        UpdateMergeRequestTemplateResponse that = (UpdateMergeRequestTemplateResponse) obj;
    ...
    public String toString() {
        ...
        sb.append("class UpdateMergeRequestTemplateResponse {\n");
