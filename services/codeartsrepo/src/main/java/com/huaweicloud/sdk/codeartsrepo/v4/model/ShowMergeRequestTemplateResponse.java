 ...
 * Response Object
 */
public class ShowMergeRequestTemplateResponse extends SdkResponse {
    ...
    public ShowMergeRequestTemplateResponse withId(Integer id) {
        this.id = id;
        return this;
    }
    ...
    public ShowMergeRequestTemplateResponse withDescription(String description) {
    ...
    public ShowMergeRequestTemplateResponse withCreatedAt(String createdAt) {
    ...
    public ShowMergeRequestTemplateResponse withUpdatedAt(String updatedAt) {
    ...
    public ShowMergeRequestTemplateResponse withTemplateName(String templateName) {
    ...
    public ShowMergeRequestTemplateResponse withMergeRequestTitle(String mergeRequestTitle) {
    ...
    public ShowMergeRequestTemplateResponse withIsDefault(Boolean isDefault) {
    ...
    public ShowMergeRequestTemplateResponse withIsWip(Boolean isWip) {
        this.isWip = isWip;
        return this;
    }
    ...
    public ShowMergeRequestTemplateResponse withAutoExtractMrTitle(Integer autoExtractMrTitle) {
    ...
    public ShowMergeRequestTemplateResponse withCreator(UserBasicDto creator) {
        this.creator = creator;
        return this;
    }

    public ShowMergeRequestTemplateResponse withCreator(Consumer<UserBasicDto> creatorSetter) {
    ...
    public ShowMergeRequestTemplateResponse withRepositoryId(Integer repositoryId) {
    ...
    public ShowMergeRequestTemplateResponse withFrom(MergeRequestTemplateFromDto from) {
        this.from = from;
        return this;
    }

    public ShowMergeRequestTemplateResponse withFrom(Consumer<MergeRequestTemplateFromDto> fromSetter) {
        if (this.from == null) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ShowMergeRequestTemplateResponse that = (ShowMergeRequestTemplateResponse) obj;
