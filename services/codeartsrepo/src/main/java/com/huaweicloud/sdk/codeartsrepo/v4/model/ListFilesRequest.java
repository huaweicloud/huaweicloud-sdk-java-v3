...
public class ListFilesRequest {
    ...
    public ListFilesRequest withRepositoryId(Integer repositoryId) {
    ...
    public ListFilesRequest withRefName(String refName) {
    ...
    public ListFilesRequest withLimit(Integer limit) {
        this.limit = limit;
        return this;
    }
