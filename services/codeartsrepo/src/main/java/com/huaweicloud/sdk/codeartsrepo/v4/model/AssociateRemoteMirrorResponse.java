 ...
 * Response Object
 */
public class AssociateRemoteMirrorResponse extends SdkResponse {
    ...
    public AssociateRemoteMirrorResponse withId(Integer id) {
        this.id = id;
        return this;
    }
    ...
    public AssociateRemoteMirrorResponse withRepositoryId(Integer repositoryId) {
    ...
    public AssociateRemoteMirrorResponse withUpdateStatus(String updateStatus) {
    ...
    public AssociateRemoteMirrorResponse withLastUpdateAt(String lastUpdateAt) {
    ...
    public AssociateRemoteMirrorResponse withUrl(String url) {
        this.url = url;
        return this;
    }
    ...
    public AssociateRemoteMirrorResponse withLastSuccessfulUpdateAt(String lastSuccessfulUpdateAt) {
    ...
    public AssociateRemoteMirrorResponse withNumberOfFailures(Integer numberOfFailures) {
    ...
    public AssociateRemoteMirrorResponse withMirroringEnabled(Boolean mirroringEnabled) {
    ...
    public AssociateRemoteMirrorResponse withIsPrivate(Boolean isPrivate) {
    ...
    public AssociateRemoteMirrorResponse withEndpointUuid(String endpointUuid) {
    ...
    public AssociateRemoteMirrorResponse withLastError(String lastError) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        AssociateRemoteMirrorResponse that = (AssociateRemoteMirrorResponse) obj;
