...
public class TrustedIpAddressDto {
    ...
    public TrustedIpAddressDto withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public TrustedIpAddressDto withRepositoryId(Integer repositoryId) {
    ...
    public TrustedIpAddressDto withIpRange(String ipRange) {
    ...
    public TrustedIpAddressDto withIpType(IpTypeEnum ipType) {
        this.ipType = ipType;
        return this;
    }
    ...
    public TrustedIpAddressDto withIpStart(String ipStart) {
    ...
    public TrustedIpAddressDto withIpEnd(String ipEnd) {
        this.ipEnd = ipEnd;
        return this;
    }
    ...
    public TrustedIpAddressDto withViewFlag(ViewFlagEnum viewFlag) {
    ...
    public TrustedIpAddressDto withDownloadFlag(DownloadFlagEnum downloadFlag) {
    ...
    public TrustedIpAddressDto withUploadFlag(UploadFlagEnum uploadFlag) {
    ...
    public TrustedIpAddressDto withRemark(String remark) {
        this.remark = remark;
        return this;
    }
    ...
    public TrustedIpAddressDto withCreatedAt(String createdAt) {
    ...
    public TrustedIpAddressDto withUpdatedAt(String updatedAt) {
    ...
    public TrustedIpAddressDto withOrderFlag(OrderFlagEnum orderFlag) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        TrustedIpAddressDto that = (TrustedIpAddressDto) obj;
