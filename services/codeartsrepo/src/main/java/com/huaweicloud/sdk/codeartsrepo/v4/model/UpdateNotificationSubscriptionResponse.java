 ...
 * Response Object
 */
public class UpdateNotificationSubscriptionResponse extends SdkResponse {
    ...
    public UpdateNotificationSubscriptionResponse withRepositoryId(Integer repositoryId) {
    ...
    public UpdateNotificationSubscriptionResponse withEnabled(Boolean enabled) {
    ...
    public UpdateNotificationSubscriptionResponse withConfigSource(ConfigSourceEnum configSource) {
    ...
    public UpdateNotificationSubscriptionResponse withWebhookConfig(RepoWebHookSubscriptionDto webhookConfig) {
        this.webhookConfig = webhookConfig;
        return this;
    }

    public UpdateNotificationSubscriptionResponse withWebhookConfig(
    ...
    public UpdateNotificationSubscriptionResponse withWaringRepoUsageRate(WaringRepoUsageRateEnum waringRepoUsageRate) {
    ...
    public UpdateNotificationSubscriptionResponse withSubscriptEvents(List<RepoSubscriptionEventDto> subscriptEvents) {
        this.subscriptEvents = subscriptEvents;
        return this;
    }

    public UpdateNotificationSubscriptionResponse addSubscriptEventsItem(RepoSubscriptionEventDto subscriptEventsItem) {
    ...
    public UpdateNotificationSubscriptionResponse withSubscriptEvents(
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        UpdateNotificationSubscriptionResponse that = (UpdateNotificationSubscriptionResponse) obj;
    ...
    public String toString() {
        ...
        sb.append("class UpdateNotificationSubscriptionResponse {\n");
