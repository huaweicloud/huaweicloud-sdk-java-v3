 ...
 * Response Object
 */
public class ShowMergeRequestSettingResponse extends SdkResponse {
    ...
    public ShowMergeRequestSettingResponse withId(Integer id) {
        this.id = id;
        return this;
    }
    ...
    public ShowMergeRequestSettingResponse withDisableMergeBySelf(Boolean disableMergeBySelf) {
    ...
    public ShowMergeRequestSettingResponse withDisableApproveBySelf(Boolean disableApproveBySelf) {
    ...
    public ShowMergeRequestSettingResponse withDisableReviewBySelf(Boolean disableReviewBySelf) {
    ...
    public ShowMergeRequestSettingResponse withCreatedAt(String createdAt) {
    ...
    public ShowMergeRequestSettingResponse withUpdatedAt(String updatedAt) {
    ...
    public ShowMergeRequestSettingResponse withCanForceMerge(Boolean canForceMerge) {
    ...
    public ShowMergeRequestSettingResponse withDisableSquashMerge(Boolean disableSquashMerge) {
    ...
    public ShowMergeRequestSettingResponse withMustRelateIssue(Boolean mustRelateIssue) {
    ...
    public ShowMergeRequestSettingResponse withNeedRelateIssueBranches(String needRelateIssueBranches) {
    ...
    public ShowMergeRequestSettingResponse withNeedAllIssuesCheckPassed(Boolean needAllIssuesCheckPassed) {
    ...
    public ShowMergeRequestSettingResponse withReviewMode(ReviewModeEnum reviewMode) {
    ...
    public ShowMergeRequestSettingResponse withAddNotesAfterMerged(Boolean addNotesAfterMerged) {
    ...
    public ShowMergeRequestSettingResponse withMergedCommitAuthor(MergedCommitAuthorEnum mergedCommitAuthor) {
    ...
    public ShowMergeRequestSettingResponse withEvaluationRole(EvaluationRoleEnum evaluationRole) {
    ...
    public ShowMergeRequestSettingResponse withEvaluationMergeGate(Boolean evaluationMergeGate) {
    ...
    public ShowMergeRequestSettingResponse withMarkAutoMergedMrAsClosed(Boolean markAutoMergedMrAsClosed) {
    ...
    public ShowMergeRequestSettingResponse withDeleteSourceBranchWhenMerged(Boolean deleteSourceBranchWhenMerged) {
    ...
    public ShowMergeRequestSettingResponse withAutoSquashMerge(Boolean autoSquashMerge) {
    ...
    public ShowMergeRequestSettingResponse withSquashMergeWithNoMergeCommit(Boolean squashMergeWithNoMergeCommit) {
    ...
    public ShowMergeRequestSettingResponse withOnlyAllowOneIssueCheckPassed(Boolean onlyAllowOneIssueCheckPassed) {
    ...
    public ShowMergeRequestSettingResponse withEnableCustomEvaluation(Boolean enableCustomEvaluation) {
    ...
    public ShowMergeRequestSettingResponse withEvaluationTypes(List<EvaluationTypeDto> evaluationTypes) {
        this.evaluationTypes = evaluationTypes;
        return this;
    }

    public ShowMergeRequestSettingResponse addEvaluationTypesItem(EvaluationTypeDto evaluationTypesItem) {
    ...
    public ShowMergeRequestSettingResponse withEvaluationTypes(
    ...
    public ShowMergeRequestSettingResponse withCanReopen(Boolean canReopen) {
    ...
    public ShowMergeRequestSettingResponse withOnlyAllowMergeIfAllDiscussionsAreResolved(
    ...
    public ShowMergeRequestSettingResponse withMergeMethod(MergeMethodEnum mergeMethod) {
    ...
    public ShowMergeRequestSettingResponse withOnlyAllowMergeIfVoteBiggerThan(Integer onlyAllowMergeIfVoteBiggerThan) {
    ...
    public ShowMergeRequestSettingResponse withOnlyAssigneeCanMerge(Boolean onlyAssigneeCanMerge) {
    ...
    public ShowMergeRequestSettingResponse withRepositoryId(Integer repositoryId) {
    ...
    public ShowMergeRequestSettingResponse withHasEvaluationPermission(Boolean hasEvaluationPermission) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ShowMergeRequestSettingResponse that = (ShowMergeRequestSettingResponse) obj;
    ...
    public String toString() {
        ...
        sb.append("class ShowMergeRequestSettingResponse {\n");
