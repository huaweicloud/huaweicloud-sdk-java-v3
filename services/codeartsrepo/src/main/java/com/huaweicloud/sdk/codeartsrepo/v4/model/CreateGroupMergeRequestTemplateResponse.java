 ...
 * Response Object
 */
public class CreateGroupMergeRequestTemplateResponse extends SdkResponse {
    ...
    public CreateGroupMergeRequestTemplateResponse withId(Integer id) {
        this.id = id;
        return this;
    }
    ...
    public CreateGroupMergeRequestTemplateResponse withRepositoryId(Integer repositoryId) {
    ...
    public CreateGroupMergeRequestTemplateResponse withDescription(String description) {
    ...
    public CreateGroupMergeRequestTemplateResponse withCreatedAt(String createdAt) {
    ...
    public CreateGroupMergeRequestTemplateResponse withUpdatedAt(String updatedAt) {
    ...
    public CreateGroupMergeRequestTemplateResponse withTemplateName(String templateName) {
    ...
    public CreateGroupMergeRequestTemplateResponse withMergeRequestTitle(String mergeRequestTitle) {
    ...
    public CreateGroupMergeRequestTemplateResponse withIsDefault(Boolean isDefault) {
    ...
    public CreateGroupMergeRequestTemplateResponse withIsWip(Boolean isWip) {
        this.isWip = isWip;
        return this;
    }
    ...
    public CreateGroupMergeRequestTemplateResponse withAutoExtractMrTitle(Integer autoExtractMrTitle) {
    ...
    public CreateGroupMergeRequestTemplateResponse withCreator(UserBasicDto creator) {
        this.creator = creator;
        return this;
    }

    public CreateGroupMergeRequestTemplateResponse withCreator(Consumer<UserBasicDto> creatorSetter) {
    ...
    public CreateGroupMergeRequestTemplateResponse withGroupId(Integer groupId) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        CreateGroupMergeRequestTemplateResponse that = (CreateGroupMergeRequestTemplateResponse) obj;
    ...
    public String toString() {
        ...
        sb.append("class CreateGroupMergeRequestTemplateResponse {\n");
