...
public class ShowDeptAndChildDeptResponse extends SdkResponse {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(corpId, deptCode, deptLevel, deptName, deptNamePath, isLeafNode, parentDeptCode, deptCodePath, note, inPermission, outPermission, designatedOutDeptCodes, childDepts);
    }
    @Override
