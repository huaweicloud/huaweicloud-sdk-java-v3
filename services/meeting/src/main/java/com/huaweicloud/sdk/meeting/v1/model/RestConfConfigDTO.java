...
public class RestConfConfigDTO  {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(isSendNotify, isSendSms, isSendCalendar, isAutoMute, isGuestFreePwd, callInRestriction, allowGuestStartConf, guestPwd, vmrIDType, prolongLength, enableWaitingRoom);
    }
    @Override
