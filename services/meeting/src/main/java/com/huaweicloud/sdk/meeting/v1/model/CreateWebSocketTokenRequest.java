...
/** Request Object */
public class CreateWebSocketTokenRequest {
    ...
    public CreateWebSocketTokenRequest withConferenceID(String conferenceID) {
    ...
    public CreateWebSocketTokenRequest withXConferenceAuthorization(String xConferenceAuthorization) {
    ...
    public String toString() {
        ...
        sb.append("class CreateWebSocketTokenRequest {\n");
