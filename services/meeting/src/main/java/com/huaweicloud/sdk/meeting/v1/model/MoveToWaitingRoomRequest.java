 ...
 * Request Object
 */
public class MoveToWaitingRoomRequest {
    ...
    private RestMoveToWaitingRoomReqBody body;

    public MoveToWaitingRoomRequest withConferenceID(String conferenceID) {
    ...
    public MoveToWaitingRoomRequest withXConferenceAuthorization(String xConferenceAuthorization) {
    ...
    public MoveToWaitingRoomRequest withBody(RestMoveToWaitingRoomReqBody body) {
        this.body = body;
        return this;
    }

    public MoveToWaitingRoomRequest withBody(Consumer<RestMoveToWaitingRoomReqBody> bodySetter) {
        if (this.body == null) {
            this.body = new RestMoveToWaitingRoomReqBody();
     ...
     * @return body
     */
    public RestMoveToWaitingRoomReqBody getBody() {
        return body;
    }

    public void setBody(RestMoveToWaitingRoomReqBody body) {
        this.body = body;
    }
    ...
    public String toString() {
        ...
        sb.append("class MoveToWaitingRoomRequest {\n");
