 ...
 * Request Object
 */
public class ShowDeptAndChildDeptRequest {
    ...
    @JacksonXmlProperty(localName = "dept_code")

    private String deptCode;

    public ShowDeptAndChildDeptRequest withXRequestId(String xRequestId) {
    ...
    public String toString() {
        ...
        sb.append("class ShowDeptAndChildDeptRequest {\n");
