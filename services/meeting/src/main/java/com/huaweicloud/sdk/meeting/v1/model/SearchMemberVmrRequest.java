 ...
 * Request Object
 */
public class SearchMemberVmrRequest {
    ...
    @JsonInclude(JsonInclude.Include.NON_NULL)
    @JsonProperty(value = "specialVmr")

    @JacksonXmlProperty(localName = "specialVmr")

    private Boolean specialVmr;

    public SearchMemberVmrRequest withXRequestId(String xRequestId) {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(xRequestId, acceptLanguage, offset, limit, searchKey, specialVmr);
    }

    @Override
    public String toString() {
        StringBuilder sb = new StringBuilder();
        sb.append("class SearchMemberVmrRequest {\n");
        sb.append("    xRequestId: ").append(toIndentedString(xRequestId)).append("\n");
        sb.append("    acceptLanguage: ").append(toIndentedString(acceptLanguage)).append("\n");
        sb.append("    offset: ").append(toIndentedString(offset)).append("\n");
        sb.append("    limit: ").append(toIndentedString(limit)).append("\n");
        sb.append("    searchKey: ").append(toIndentedString(searchKey)).append("\n");
        sb.append("    specialVmr: ").append(toIndentedString(specialVmr)).append("\n");
        sb.append("}");
        return sb.toString();
    }
