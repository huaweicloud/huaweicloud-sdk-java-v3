 ...
 * Request Object
 */
public class AllowWaitingParticipantRequest {
    ...
    private RestAllowWaitingParticipantReqBody body;

    public AllowWaitingParticipantRequest withConferenceID(String conferenceID) {
    ...
    public AllowWaitingParticipantRequest withXConferenceAuthorization(String xConferenceAuthorization) {
    ...
    public AllowWaitingParticipantRequest withBody(RestAllowWaitingParticipantReqBody body) {
        this.body = body;
        return this;
    }

    public AllowWaitingParticipantRequest withBody(Consumer<RestAllowWaitingParticipantReqBody> bodySetter) {
        if (this.body == null) {
            this.body = new RestAllowWaitingParticipantReqBody();
     ...
     * @return body
     */
    public RestAllowWaitingParticipantReqBody getBody() {
        return body;
    }

    public void setBody(RestAllowWaitingParticipantReqBody body) {
        this.body = body;
    }
    ...
    public String toString() {
        ...
        sb.append("class AllowWaitingParticipantRequest {\n");
