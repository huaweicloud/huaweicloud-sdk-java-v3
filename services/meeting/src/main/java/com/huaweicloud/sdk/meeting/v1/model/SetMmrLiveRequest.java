 ...
 * Request Object
 */
public class SetMmrLiveRequest {
    ...
    private RestSetMmrLiveReqBody body;

    public SetMmrLiveRequest withConferenceID(String conferenceID) {
    ...
    public SetMmrLiveRequest withXConferenceAuthorization(String xConferenceAuthorization) {
    ...
    public SetMmrLiveRequest withBody(RestSetMmrLiveReqBody body) {
        this.body = body;
        return this;
    }

    public SetMmrLiveRequest withBody(Consumer<RestSetMmrLiveReqBody> bodySetter) {
        if (this.body == null) {
            this.body = new RestSetMmrLiveReqBody();
     ...
     * @return body
     */
    public RestSetMmrLiveReqBody getBody() {
        return body;
    }

    public void setBody(RestSetMmrLiveReqBody body) {
        this.body = body;
    }
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        SetMmrLiveRequest that = (SetMmrLiveRequest) obj;
    ...
    public String toString() {
        ...
        sb.append("class SetMmrLiveRequest {\n");
