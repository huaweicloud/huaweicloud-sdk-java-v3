 ...
 * Request Object
 */
public class PauseConferenceRequest {
    ...
    private PauseConferenceReq body;

    public PauseConferenceRequest withConferenceID(String conferenceID) {
    ...
    public PauseConferenceRequest withXConferenceAuthorization(String xConferenceAuthorization) {
    ...
    public PauseConferenceRequest withBody(PauseConferenceReq body) {
        this.body = body;
        return this;
    }

    public PauseConferenceRequest withBody(Consumer<PauseConferenceReq> bodySetter) {
        if (this.body == null) {
            this.body = new PauseConferenceReq();
     ...
     * @return body
     */
    public PauseConferenceReq getBody() {
        return body;
    }

    public void setBody(PauseConferenceReq body) {
        this.body = body;
    }
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        PauseConferenceRequest that = (PauseConferenceRequest) obj;
    ...
    public String toString() {
        ...
        sb.append("class PauseConferenceRequest {\n");
