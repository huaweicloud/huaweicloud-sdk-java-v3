...
public class OpenEditConfReq  {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(conferenceId, subject, description, startTime, duration, timeZoneId, attendees, notifySetting, guestPasswd, audiencePasswd, callRestriction, scope, audienceScope);
    }
    @Override
