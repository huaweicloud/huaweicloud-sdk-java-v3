...
public class ShowRoomSettingRequest {
    ...
    public ShowRoomSettingRequest withXRequestId(String xRequestId) {
    ...
    public ShowRoomSettingRequest withAcceptLanguage(String acceptLanguage) {
    ...
    public ShowRoomSettingRequest withConferenceId(String conferenceId) {
    ...
    public String toString() {
        ...
        sb.append("class ShowRoomSettingRequest {\n");
