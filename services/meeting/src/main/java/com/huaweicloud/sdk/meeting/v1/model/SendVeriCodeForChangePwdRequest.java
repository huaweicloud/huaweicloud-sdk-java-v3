 ...
 * Request Object
 */
public class SendVeriCodeForChangePwdRequest  {
    ...
    public SendVeriCodeForChangePwdRequest withBody(Consumer<VerifyCodeSendDTOV1> bodySetter) {
        if(this.body == null ){
            this.body = new VerifyCodeSendDTOV1();
     ...
     * @return body
     */
    public VerifyCodeSendDTOV1 getBody() {
        return body;
    }
    ...
    public String toString() {
        ...
        sb.append("class SendVeriCodeForChangePwdRequest {\n");
