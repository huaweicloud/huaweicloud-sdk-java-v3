...
public class UpdateStartedConfConfigRequest {
    ...
    private UpdateStartedConfigReqBody body;

    public UpdateStartedConfConfigRequest withConferenceID(String conferenceID) {
    ...
    public UpdateStartedConfConfigRequest withXConferenceAuthorization(String xConferenceAuthorization) {
    ...
    public UpdateStartedConfConfigRequest withBody(UpdateStartedConfigReqBody body) {
        this.body = body;
        return this;
    }

    public UpdateStartedConfConfigRequest withBody(Consumer<UpdateStartedConfigReqBody> bodySetter) {
        if (this.body == null) {
            this.body = new UpdateStartedConfigReqBody();
     ...
     * @return body
     */
    public UpdateStartedConfigReqBody getBody() {
        return body;
    }

    public void setBody(UpdateStartedConfigReqBody body) {
        this.body = body;
    }
