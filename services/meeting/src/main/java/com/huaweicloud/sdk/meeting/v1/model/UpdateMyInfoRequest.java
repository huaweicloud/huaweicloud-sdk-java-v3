...
public class UpdateMyInfoRequest {
    ...
    public UpdateMyInfoRequest withBody(Consumer<ModMemberDTO> bodySetter) {
        if (this.body == null) {
            this.body = new ModMemberDTO();
    ...
    public String toString() {
        ...
        sb.append("class UpdateMyInfoRequest {\n");
