...
public class AddCorpRequest  {
    ...
    public AddCorpRequest withBody(Consumer<AddCorpDTO> bodySetter) {
        if(this.body == null ){
            this.body = new AddCorpDTO();
    ...
    public String toString() {
        ...
        sb.append("class AddCorpRequest {\n");
