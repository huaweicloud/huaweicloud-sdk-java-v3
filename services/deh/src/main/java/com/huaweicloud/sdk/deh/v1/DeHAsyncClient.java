...
public class DeHAsyncClient {
     ...
     * @return CompletableFuture<ListDedicatedHostTagsResponse>
     */
    public CompletableFuture<ListDedicatedHostTagsResponse> listDedicatedHostTagsAsync(
        ListDedicatedHostTagsRequest request) {
        return hcClient.asyncInvokeHttp(request, DeHMeta.listDedicatedHostTags);
    }
     ...
     *
     * @param request ListDedicatedHostTagsRequest 请求对象
     * @return AsyncInvoker<ListDedicatedHostTagsRequest, ListDedicatedHostTagsResponse>
     */
    public AsyncInvoker<ListDedicatedHostTagsRequest, ListDedicatedHostTagsResponse> listDedicatedHostTagsAsyncInvoker(
        ListDedicatedHostTagsRequest request) {
        return new AsyncInvoker<>(request, DeHMeta.listDedicatedHostTags, hcClient);
    }
