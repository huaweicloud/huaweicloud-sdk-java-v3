...
public class ShowProjectReleaseFilesRequest {
    ...
    public ShowProjectReleaseFilesRequest withFileName(String fileName) {
    ...
    public ShowProjectReleaseFilesRequest withLimit(Integer limit) {
        this.limit = limit;
        return this;
    }
    ...
    public ShowProjectReleaseFilesRequest withOffset(Integer offset) {
        this.offset = offset;
        return this;
    }
    ...
    public ShowProjectReleaseFilesRequest withProjectId(String projectId) {
