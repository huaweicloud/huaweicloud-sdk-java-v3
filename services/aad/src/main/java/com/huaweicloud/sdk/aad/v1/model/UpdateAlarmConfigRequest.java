...
public class UpdateAlarmConfigRequest {
    ...
    private AlarmBody body;

    public UpdateAlarmConfigRequest withBody(AlarmBody body) {
        this.body = body;
        return this;
    }

    public UpdateAlarmConfigRequest withBody(Consumer<AlarmBody> bodySetter) {
        if (this.body == null) {
            this.body = new AlarmBody();
