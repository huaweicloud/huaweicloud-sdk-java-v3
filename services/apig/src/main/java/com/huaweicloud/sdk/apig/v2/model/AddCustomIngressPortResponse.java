 ...
 * Response Object
 */
public class AddCustomIngressPortResponse extends SdkResponse {
    ...
    public AddCustomIngressPortResponse withProtocol(ProtocolEnum protocol) {
    ...
    public AddCustomIngressPortResponse withIngressPort(Integer ingressPort) {
    ...
    public AddCustomIngressPortResponse withIngressPortId(String ingressPortId) {
    ...
    public AddCustomIngressPortResponse withStatus(StatusEnum status) {
        this.status = status;
        return this;
    }
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        AddCustomIngressPortResponse that = (AddCustomIngressPortResponse) obj;
    ...
    public String toString() {
        ...
        sb.append("class AddCustomIngressPortResponse {\n");
