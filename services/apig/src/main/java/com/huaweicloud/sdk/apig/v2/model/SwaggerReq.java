...
public class SwaggerReq {
    ...
    public SwaggerReq withEnvId(String envId) {
        this.envId = envId;
        return this;
    }
    ...
    public SwaggerReq withApis(Consumer<List<String>> apisSetter) {
        if (this.apis == null) {
            this.apis = new ArrayList<>();
        }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        SwaggerReq swaggerReq = (SwaggerReq) o;
        return Objects.equals(this.envId, swaggerReq.envId) && Objects.equals(this.define, swaggerReq.define)
            && Objects.equals(this.type, swaggerReq.type) && Objects.equals(this.version, swaggerReq.version)
            && Objects.equals(this.apis, swaggerReq.apis) && Objects.equals(this.groupId, swaggerReq.groupId);
    }

    @Override
    public int hashCode() {
        return Objects.hash(envId, define, type, version, apis, groupId);
    }

    @Override
    public String toString() {
        StringBuilder sb = new StringBuilder();
        sb.append("class SwaggerReq {\n");
