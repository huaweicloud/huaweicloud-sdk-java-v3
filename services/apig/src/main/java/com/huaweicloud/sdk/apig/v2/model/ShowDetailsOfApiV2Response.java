...
public class ShowDetailsOfApiV2Response extends SdkResponse {
    ...
    public ShowDetailsOfApiV2Response withTraceEnabled(Boolean traceEnabled) {
    ...
    public ShowDetailsOfApiV2Response withSamplingStrategy(SamplingStrategyEnum samplingStrategy) {
    ...
    public ShowDetailsOfApiV2Response withSamplingParam(String samplingParam) {
    ...
    public ShowDetailsOfApiV2Response withContentType(ContentTypeEnum contentType) {
    ...
    public ShowDetailsOfApiV2Response withIsSendFgBodyBase64(Boolean isSendFgBodyBase64) {
    ...
    public ShowDetailsOfApiV2Response withPublishTime(String publishTime) {
    ...
    public ShowDetailsOfApiV2Response withApiGroupInfo(ApiGroupCommonInfo apiGroupInfo) {
        this.apiGroupInfo = apiGroupInfo;
        return this;
    }

    public ShowDetailsOfApiV2Response withApiGroupInfo(Consumer<ApiGroupCommonInfo> apiGroupInfoSetter) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ShowDetailsOfApiV2Response that = (ShowDetailsOfApiV2Response) obj;
