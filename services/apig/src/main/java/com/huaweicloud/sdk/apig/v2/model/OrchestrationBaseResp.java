 ...
 * 编排规则基本信息详情。
 */
public class OrchestrationBaseResp {
    ...
    public OrchestrationBaseResp withOrchestrationName(String orchestrationName) {
    ...
    public OrchestrationBaseResp withOrchestrationStrategy(OrchestrationStrategyEnum orchestrationStrategy) {
    ...
    public OrchestrationBaseResp withOrchestrationMappedParam(OrchestrationMappedParam orchestrationMappedParam) {
        this.orchestrationMappedParam = orchestrationMappedParam;
        return this;
    }

    public OrchestrationBaseResp withOrchestrationMappedParam(
    ...
    public OrchestrationBaseResp withIsPreprocessing(Boolean isPreprocessing) {
    ...
    public OrchestrationBaseResp withOrchestrationId(String orchestrationId) {
    ...
    public OrchestrationBaseResp withOrchestrationCreateTime(OffsetDateTime orchestrationCreateTime) {
    ...
    public OrchestrationBaseResp withOrchestrationUpdateTime(OffsetDateTime orchestrationUpdateTime) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        OrchestrationBaseResp that = (OrchestrationBaseResp) obj;
    ...
    public String toString() {
        ...
        sb.append("class OrchestrationBaseResp {\n");
