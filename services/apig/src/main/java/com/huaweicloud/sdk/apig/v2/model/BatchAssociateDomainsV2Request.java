 ...
 * Request Object
 */
public class BatchAssociateDomainsV2Request {
    ...
    public BatchAssociateDomainsV2Request withCertificateId(String certificateId) {
    ...
    public BatchAssociateDomainsV2Request withBody(AttachOrDetachDomainsReqBody body) {
        this.body = body;
        return this;
    }

    public BatchAssociateDomainsV2Request withBody(Consumer<AttachOrDetachDomainsReqBody> bodySetter) {
        if (this.body == null) {
    ...
    public String toString() {
        ...
        sb.append("class BatchAssociateDomainsV2Request {\n");
