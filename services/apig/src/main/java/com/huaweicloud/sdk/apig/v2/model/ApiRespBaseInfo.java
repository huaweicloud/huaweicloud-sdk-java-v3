...
public class ApiRespBaseInfo {
    ...
    public ApiRespBaseInfo withTraceEnabled(Boolean traceEnabled) {
    ...
    public ApiRespBaseInfo withSamplingStrategy(SamplingStrategyEnum samplingStrategy) {
    ...
    public ApiRespBaseInfo withSamplingParam(String samplingParam) {
