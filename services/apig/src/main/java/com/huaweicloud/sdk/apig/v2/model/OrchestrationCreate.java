 ...
 * OrchestrationCreate
 */
public class OrchestrationCreate {
    ...
    public OrchestrationCreate withOrchestrationName(String orchestrationName) {
    ...
    public OrchestrationCreate withOrchestrationStrategy(OrchestrationStrategyEnum orchestrationStrategy) {
    ...
    public OrchestrationCreate withOrchestrationMappedParam(OrchestrationMappedParam orchestrationMappedParam) {
        this.orchestrationMappedParam = orchestrationMappedParam;
        return this;
    }

    public OrchestrationCreate withOrchestrationMappedParam(
    ...
    public OrchestrationCreate withIsPreprocessing(Boolean isPreprocessing) {
    ...
    public OrchestrationCreate withOrchestrationMap(List<OrchestrationMap> orchestrationMap) {
        this.orchestrationMap = orchestrationMap;
        return this;
    }

    public OrchestrationCreate addOrchestrationMapItem(OrchestrationMap orchestrationMapItem) {
    ...
    public OrchestrationCreate withOrchestrationMap(Consumer<List<OrchestrationMap>> orchestrationMapSetter) {
        if (this.orchestrationMap == null) {
            this.orchestrationMap = new ArrayList<>();
        }
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        OrchestrationCreate that = (OrchestrationCreate) obj;
    ...
    public String toString() {
        ...
        sb.append("class OrchestrationCreate {\n");
