 ...
 * Response Object
 */
public class UpdateOrchestrationResponse extends SdkResponse {
    ...
    public UpdateOrchestrationResponse withOrchestrationName(String orchestrationName) {
    ...
    public UpdateOrchestrationResponse withOrchestrationStrategy(OrchestrationStrategyEnum orchestrationStrategy) {
    ...
    public UpdateOrchestrationResponse withOrchestrationMappedParam(OrchestrationMappedParam orchestrationMappedParam) {
        this.orchestrationMappedParam = orchestrationMappedParam;
        return this;
    }

    public UpdateOrchestrationResponse withOrchestrationMappedParam(
    ...
    public UpdateOrchestrationResponse withIsPreprocessing(Boolean isPreprocessing) {
    ...
    public UpdateOrchestrationResponse withOrchestrationMap(List<OrchestrationMap> orchestrationMap) {
        this.orchestrationMap = orchestrationMap;
        return this;
    }

    public UpdateOrchestrationResponse addOrchestrationMapItem(OrchestrationMap orchestrationMapItem) {
    ...
    public UpdateOrchestrationResponse withOrchestrationMap(Consumer<List<OrchestrationMap>> orchestrationMapSetter) {
        if (this.orchestrationMap == null) {
            this.orchestrationMap = new ArrayList<>();
        }
    ...
    public UpdateOrchestrationResponse withOrchestrationId(String orchestrationId) {
    ...
    public UpdateOrchestrationResponse withOrchestrationCreateTime(OffsetDateTime orchestrationCreateTime) {
    ...
    public UpdateOrchestrationResponse withOrchestrationUpdateTime(OffsetDateTime orchestrationUpdateTime) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        UpdateOrchestrationResponse that = (UpdateOrchestrationResponse) obj;
    ...
    public String toString() {
        ...
        sb.append("class UpdateOrchestrationResponse {\n");
