...
public class DebugApiReq {
    ...
    public DebugApiReq withHeader(Map<String, String> header) {
        this.header = header;
        return this;
    }

    public DebugApiReq putHeaderItem(String key, String headerItem) {
        if (this.header == null) {
    ...
    public DebugApiReq withHeader(Consumer<Map<String, String>> headerSetter) {
        if (this.header == null) {
            this.header = new HashMap<>();
        }
    ...
    public DebugApiReq withQuery(Map<String, String> query) {
        this.query = query;
        return this;
    }

    public DebugApiReq putQueryItem(String key, String queryItem) {
        if (this.query == null) {
    ...
    public DebugApiReq withQuery(Consumer<Map<String, String>> querySetter) {
        if (this.query == null) {
            this.query = new HashMap<>();
        }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        return Objects.equals(this.body, debugApiReq.body) && Objects.equals(this.header, debugApiReq.header)
            && Objects.equals(this.method, debugApiReq.method) && Objects.equals(this.mode, debugApiReq.mode)
            && Objects.equals(this.path, debugApiReq.path) && Objects.equals(this.query, debugApiReq.query)
            && Objects.equals(this.scheme, debugApiReq.scheme) && Objects.equals(this.appKey, debugApiReq.appKey)
            && Objects.equals(this.appSecret, debugApiReq.appSecret) && Objects.equals(this.domain, debugApiReq.domain)
