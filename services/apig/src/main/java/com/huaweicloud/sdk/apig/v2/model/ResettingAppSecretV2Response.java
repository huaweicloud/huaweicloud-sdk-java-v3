...
public class ResettingAppSecretV2Response extends SdkResponse {
    ...
    public ResettingAppSecretV2Response withRelatedDomainId(String relatedDomainId) {
    ...
    public ResettingAppSecretV2Response withRelatedProjectId(String relatedProjectId) {
