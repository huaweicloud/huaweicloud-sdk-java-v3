...
public class ApiBaseInfo {
    ...
    public ApiBaseInfo withTraceEnabled(Boolean traceEnabled) {
    ...
    public ApiBaseInfo withSamplingStrategy(SamplingStrategyEnum samplingStrategy) {
    ...
    public ApiBaseInfo withSamplingParam(String samplingParam) {
