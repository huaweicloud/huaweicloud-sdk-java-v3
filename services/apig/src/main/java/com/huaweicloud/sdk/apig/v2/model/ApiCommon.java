...
public class ApiCommon {
    ...
    public ApiCommon withTraceEnabled(Boolean traceEnabled) {
    ...
    public ApiCommon withSamplingStrategy(SamplingStrategyEnum samplingStrategy) {
    ...
    public ApiCommon withSamplingParam(String samplingParam) {
