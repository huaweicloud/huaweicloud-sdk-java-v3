 ...
 * Response Object
 */
public class CreatePluginResponse extends SdkResponse {
    ...
    public CreatePluginResponse withPluginId(String pluginId) {
    ...
    public CreatePluginResponse withPluginName(String pluginName) {
    ...
    public CreatePluginResponse withPluginType(PluginTypeEnum pluginType) {
    ...
    public CreatePluginResponse withPluginScope(PluginScopeEnum pluginScope) {
    ...
    public CreatePluginResponse withPluginContent(String pluginContent) {
    ...
    public CreatePluginResponse withRemark(String remark) {
        this.remark = remark;
        return this;
    }
    ...
    public CreatePluginResponse withCreateTime(OffsetDateTime createTime) {
    ...
    public CreatePluginResponse withUpdateTime(OffsetDateTime updateTime) {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        return Objects.equals(this.pluginId, createPluginResponse.pluginId)
            && Objects.equals(this.pluginName, createPluginResponse.pluginName)
            && Objects.equals(this.pluginType, createPluginResponse.pluginType)
            && Objects.equals(this.pluginScope, createPluginResponse.pluginScope)
            && Objects.equals(this.pluginContent, createPluginResponse.pluginContent)
            && Objects.equals(this.remark, createPluginResponse.remark)
            && Objects.equals(this.createTime, createPluginResponse.createTime)
            && Objects.equals(this.updateTime, createPluginResponse.updateTime);
    }
