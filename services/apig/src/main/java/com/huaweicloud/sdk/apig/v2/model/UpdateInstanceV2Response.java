...
public class UpdateInstanceV2Response extends SdkResponse {
    ...
    public UpdateInstanceV2Response withCbcOperationLocks(List<CbcOperationLock> cbcOperationLocks) {
        this.cbcOperationLocks = cbcOperationLocks;
        return this;
    }

    public UpdateInstanceV2Response addCbcOperationLocksItem(CbcOperationLock cbcOperationLocksItem) {
    ...
    public UpdateInstanceV2Response withCbcOperationLocks(Consumer<List<CbcOperationLock>> cbcOperationLocksSetter) {
        if (this.cbcOperationLocks == null) {
            this.cbcOperationLocks = new ArrayList<>();
        }
