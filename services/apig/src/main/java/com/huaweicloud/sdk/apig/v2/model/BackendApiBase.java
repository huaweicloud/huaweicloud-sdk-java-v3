...
public class BackendApiBase {
    ...
    public BackendApiBase withMemberGroupUrlInfos(List<MemberGroupUrlInfo> memberGroupUrlInfos) {
        this.memberGroupUrlInfos = memberGroupUrlInfos;
        return this;
    }

    public BackendApiBase addMemberGroupUrlInfosItem(MemberGroupUrlInfo memberGroupUrlInfosItem) {
    ...
    public BackendApiBase withMemberGroupUrlInfos(Consumer<List<MemberGroupUrlInfo>> memberGroupUrlInfosSetter) {
        if (this.memberGroupUrlInfos == null) {
            this.memberGroupUrlInfos = new ArrayList<>();
        }
