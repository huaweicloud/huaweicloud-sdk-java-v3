...
public class AuthOpt {
    ...
    public static final class AppCodeAuthTypeEnum {
        ...
        public static AppCodeAuthTypeEnum fromValue(String value) {
            ...
            return java.util.Optional.ofNullable(STATIC_FIELDS.get(value)).orElse(new AppCodeAuthTypeEnum(value));
        }
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        AuthOpt that = (AuthOpt) obj;
        return Objects.equals(this.appCodeAuthType, that.appCodeAuthType);
    }
