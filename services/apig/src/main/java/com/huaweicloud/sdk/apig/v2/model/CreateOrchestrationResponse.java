 ...
 * Response Object
 */
public class CreateOrchestrationResponse extends SdkResponse {
    ...
    public CreateOrchestrationResponse withOrchestrationName(String orchestrationName) {
    ...
    public CreateOrchestrationResponse withOrchestrationStrategy(OrchestrationStrategyEnum orchestrationStrategy) {
    ...
    public CreateOrchestrationResponse withOrchestrationMappedParam(OrchestrationMappedParam orchestrationMappedParam) {
        this.orchestrationMappedParam = orchestrationMappedParam;
        return this;
    }

    public CreateOrchestrationResponse withOrchestrationMappedParam(
    ...
    public CreateOrchestrationResponse withIsPreprocessing(Boolean isPreprocessing) {
    ...
    public CreateOrchestrationResponse withOrchestrationMap(List<OrchestrationMap> orchestrationMap) {
        this.orchestrationMap = orchestrationMap;
        return this;
    }

    public CreateOrchestrationResponse addOrchestrationMapItem(OrchestrationMap orchestrationMapItem) {
    ...
    public CreateOrchestrationResponse withOrchestrationMap(Consumer<List<OrchestrationMap>> orchestrationMapSetter) {
        if (this.orchestrationMap == null) {
            this.orchestrationMap = new ArrayList<>();
        }
    ...
    public CreateOrchestrationResponse withOrchestrationId(String orchestrationId) {
    ...
    public CreateOrchestrationResponse withOrchestrationCreateTime(OffsetDateTime orchestrationCreateTime) {
    ...
    public CreateOrchestrationResponse withOrchestrationUpdateTime(OffsetDateTime orchestrationUpdateTime) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        CreateOrchestrationResponse that = (CreateOrchestrationResponse) obj;
    ...
    public String toString() {
        ...
        sb.append("class CreateOrchestrationResponse {\n");
