...
public class ListApiRuntimeDefinitionV2Response extends SdkResponse {
    ...
    public ListApiRuntimeDefinitionV2Response withTraceEnabled(Boolean traceEnabled) {
    ...
    public ListApiRuntimeDefinitionV2Response withSamplingStrategy(SamplingStrategyEnum samplingStrategy) {
    ...
    public ListApiRuntimeDefinitionV2Response withSamplingParam(String samplingParam) {
