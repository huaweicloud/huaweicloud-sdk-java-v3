 ...
 * Response Object
 */
public class UpdateIngressEipV2Response extends SdkResponse {
    ...
    public UpdateIngressEipV2Response withInstanceId(String instanceId) {
    ...
    public UpdateIngressEipV2Response withMessage(String message) {
    ...
    public UpdateIngressEipV2Response withJobId(String jobId) {
        this.jobId = jobId;
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append("class UpdateIngressEipV2Response {\n");
