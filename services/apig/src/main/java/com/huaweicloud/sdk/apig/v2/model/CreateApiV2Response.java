...
public class CreateApiV2Response extends SdkResponse {
    ...
    public CreateApiV2Response withTraceEnabled(Boolean traceEnabled) {
    ...
    public CreateApiV2Response withSamplingStrategy(SamplingStrategyEnum samplingStrategy) {
    ...
    public CreateApiV2Response withSamplingParam(String samplingParam) {
    ...
    public CreateApiV2Response withIsSendFgBodyBase64(Boolean isSendFgBodyBase64) {
