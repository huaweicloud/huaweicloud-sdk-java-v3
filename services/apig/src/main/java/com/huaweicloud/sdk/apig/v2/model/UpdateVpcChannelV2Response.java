...
public class UpdateVpcChannelV2Response extends SdkResponse {
    ...
    public UpdateVpcChannelV2Response withBalanceStrategy(BalanceStrategyEnum balanceStrategy) {
    ...
    public UpdateVpcChannelV2Response withMemberType(MemberTypeEnum memberType) {
    ...
    public UpdateVpcChannelV2Response withVpcChannelType(VpcChannelTypeEnum vpcChannelType) {
    ...
    public UpdateVpcChannelV2Response withCreateTime(OffsetDateTime createTime) {
    ...
    public UpdateVpcChannelV2Response withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public UpdateVpcChannelV2Response withMicroserviceInfo(MicroServiceInfo microserviceInfo) {
        this.microserviceInfo = microserviceInfo;
        return this;
    }

    public UpdateVpcChannelV2Response withMicroserviceInfo(Consumer<MicroServiceInfo> microserviceInfoSetter) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        UpdateVpcChannelV2Response that = (UpdateVpcChannelV2Response) obj;
