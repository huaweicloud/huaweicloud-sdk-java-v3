...
public class ApiInfo {
    ...
    public ApiInfo withTraceEnabled(Boolean traceEnabled) {
    ...
    public ApiInfo withSamplingStrategy(SamplingStrategyEnum samplingStrategy) {
    ...
    public ApiInfo withSamplingParam(String samplingParam) {
    ...
    public ApiInfo withIsSendFgBodyBase64(Boolean isSendFgBodyBase64) {
