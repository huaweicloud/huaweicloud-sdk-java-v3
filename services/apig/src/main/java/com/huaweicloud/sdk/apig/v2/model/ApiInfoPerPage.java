...
public class ApiInfoPerPage {
    ...
    public ApiInfoPerPage withTraceEnabled(Boolean traceEnabled) {
    ...
    public ApiInfoPerPage withSamplingStrategy(SamplingStrategyEnum samplingStrategy) {
    ...
    public ApiInfoPerPage withSamplingParam(String samplingParam) {
    ...
    public ApiInfoPerPage withIsSendFgBodyBase64(Boolean isSendFgBodyBase64) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ApiInfoPerPage that = (ApiInfoPerPage) obj;
