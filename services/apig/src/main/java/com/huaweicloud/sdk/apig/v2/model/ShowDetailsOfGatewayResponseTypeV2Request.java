...
public class ShowDetailsOfGatewayResponseTypeV2Request {
    ...
    public ShowDetailsOfGatewayResponseTypeV2Request withInstanceId(String instanceId) {
    ...
    public ShowDetailsOfGatewayResponseTypeV2Request withGroupId(String groupId) {
    ...
    public ShowDetailsOfGatewayResponseTypeV2Request withResponseId(String responseId) {
    ...
    public ShowDetailsOfGatewayResponseTypeV2Request withResponseType(ResponseTypeEnum responseType) {
