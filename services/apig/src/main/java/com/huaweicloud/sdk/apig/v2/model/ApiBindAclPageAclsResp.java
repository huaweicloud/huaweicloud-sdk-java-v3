...
/** ApiBindAclPageAclsResp */
public class ApiBindAclPageAclsResp {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ApiBindAclPageAclsResp apiBindAclPageAclsResp = (ApiBindAclPageAclsResp) o;
        return Objects.equals(this.aclId, apiBindAclPageAclsResp.aclId)
            && Objects.equals(this.aclName, apiBindAclPageAclsResp.aclName)
            && Objects.equals(this.aclType, apiBindAclPageAclsResp.aclType)
            && Objects.equals(this.aclValue, apiBindAclPageAclsResp.aclValue)
            && Objects.equals(this.entityType, apiBindAclPageAclsResp.entityType)
            && Objects.equals(this.envId, apiBindAclPageAclsResp.envId)
            && Objects.equals(this.envName, apiBindAclPageAclsResp.envName)
            && Objects.equals(this.bindId, apiBindAclPageAclsResp.bindId)
            && Objects.equals(this.bindTime, apiBindAclPageAclsResp.bindTime);
    }

    @Override
    public int hashCode() {
        return Objects.hash(aclId, aclName, aclType, aclValue, entityType, envId, envName, bindId, bindTime);
    }

    @Override
    public String toString() {
        StringBuilder sb = new StringBuilder();
        sb.append("class ApiBindAclPageAclsResp {\n");
