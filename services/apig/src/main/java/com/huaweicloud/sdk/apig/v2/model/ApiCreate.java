...
public class ApiCreate {
    ...
    public ApiCreate withTraceEnabled(Boolean traceEnabled) {
    ...
    public ApiCreate withSamplingStrategy(SamplingStrategyEnum samplingStrategy) {
    ...
    public ApiCreate withSamplingParam(String samplingParam) {
    ...
    public ApiCreate withIsSendFgBodyBase64(Boolean isSendFgBodyBase64) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        return Objects.equals(this.name, that.name) && Objects.equals(this.type, that.type)
            ...
            && Objects.equals(this.backendApi, that.backendApi) && Objects.equals(this.policyHttps, that.policyHttps);
    }
