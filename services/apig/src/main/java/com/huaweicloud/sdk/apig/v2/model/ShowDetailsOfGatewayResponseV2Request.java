 ...
 * Request Object
 */
public class ShowDetailsOfGatewayResponseV2Request {
    ...
    public ShowDetailsOfGatewayResponseV2Request withInstanceId(String instanceId) {
    ...
    public ShowDetailsOfGatewayResponseV2Request withGroupId(String groupId) {
    ...
    public ShowDetailsOfGatewayResponseV2Request withResponseId(String responseId) {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(instanceId, groupId, responseId);
    }

    @Override
    public String toString() {
        StringBuilder sb = new StringBuilder();
        sb.append("class ShowDetailsOfGatewayResponseV2Request {\n");
