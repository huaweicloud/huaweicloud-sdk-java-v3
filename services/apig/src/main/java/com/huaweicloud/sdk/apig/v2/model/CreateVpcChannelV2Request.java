 ...
 * Request Object
 */
public class CreateVpcChannelV2Request {
    ...
    public CreateVpcChannelV2Request withInstanceId(String instanceId) {
    ...
    public CreateVpcChannelV2Request withBody(VpcCreate body) {
        this.body = body;
        return this;
    }

    public CreateVpcChannelV2Request withBody(Consumer<VpcCreate> bodySetter) {
        if (this.body == null) {
    ...
    public String toString() {
        ...
        sb.append("class CreateVpcChannelV2Request {\n");
