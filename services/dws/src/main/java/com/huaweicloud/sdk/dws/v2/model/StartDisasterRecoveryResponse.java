 ...
 * Response Object
 */
public class StartDisasterRecoveryResponse extends SdkResponse {
    ...
    public StartDisasterRecoveryResponse withDisasterRecovery(DisasterRecoveryId disasterRecovery) {
        this.disasterRecovery = disasterRecovery;
        return this;
    }

    public StartDisasterRecoveryResponse withDisasterRecovery(Consumer<DisasterRecoveryId> disasterRecoverySetter) {
    ...
    public String toString() {
        ...
        sb.append("class StartDisasterRecoveryResponse {\n");
