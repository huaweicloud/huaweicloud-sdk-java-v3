 ...
 * Response Object
 */
public class SwitchoverDisasterRecoveryResponse extends SdkResponse {
    ...
    public SwitchoverDisasterRecoveryResponse withDisasterRecovery(DisasterRecoveryId disasterRecovery) {
        this.disasterRecovery = disasterRecovery;
        return this;
    }

    public SwitchoverDisasterRecoveryResponse withDisasterRecovery(
        Consumer<DisasterRecoveryId> disasterRecoverySetter) {
    ...
    public String toString() {
        ...
        sb.append("class SwitchoverDisasterRecoveryResponse {\n");
