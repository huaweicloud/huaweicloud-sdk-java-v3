 ...
 * Request Object
 */
public class DeleteTableRequest extends SdkBsonDocRequest {
    ...
    private DeleteTableRequestBody body;

    private static Codec<DeleteTableRequestBody> codec;

    public DeleteTableRequest withStoreName(String storeName) {
    ...
    public DeleteTableRequest withBody(DeleteTableRequestBody body) {
        this.body = body;
        return this;
    }

    public DeleteTableRequest withBody(Consumer<DeleteTableRequestBody> bodySetter) {
        if (this.body == null) {
            this.body = new DeleteTableRequestBody();
     ...
     * @return body
     */
    public DeleteTableRequestBody getBody() {
        return body;
    }

    public void setBody(DeleteTableRequestBody body) {
        this.body = body;
    }
    ...
    protected void encodeBody(CodecRegistry codecRegistry, BsonWriter writer) {
        if (codec == null) {
            codec = codecRegistry.get(DeleteTableRequestBody.class);
        }
