...
public class TemplateInfo {
    ...
    public TemplateInfo withTemplate(TemplateBean template) {
        this.template = template;
        return this;
    }

    public TemplateInfo withTemplate(Consumer<TemplateBean> templateSetter) {
        if (this.template == null) {
            this.template = new TemplateBean();
