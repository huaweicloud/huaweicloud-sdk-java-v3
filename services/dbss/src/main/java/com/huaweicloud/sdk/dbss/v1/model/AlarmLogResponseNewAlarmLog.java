...
/**
 * AlarmLogResponseNewAlarmLog
 */
public class AlarmLogResponseNewAlarmLog {
    ...
    public AlarmLogResponseNewAlarmLog withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public AlarmLogResponseNewAlarmLog withAlarmLife(String alarmLife) {
    ...
    public AlarmLogResponseNewAlarmLog withSendEmail(Boolean sendEmail) {
    ...
    public AlarmLogResponseNewAlarmLog withAlarmTime(String alarmTime) {
    ...
    public AlarmLogResponseNewAlarmLog withAlarmType(String alarmType) {
    ...
    public AlarmLogResponseNewAlarmLog withAlarmFixTime(String alarmFixTime) {
    ...
    public AlarmLogResponseNewAlarmLog withAlarmStatus(String alarmStatus) {
    ...
    public AlarmLogResponseNewAlarmLog withAlarmRisk(String alarmRisk) {
    ...
    public AlarmLogResponseNewAlarmLog withAlarmDescription(String alarmDescription) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        AlarmLogResponseNewAlarmLog that = (AlarmLogResponseNewAlarmLog) obj;
    ...
    public String toString() {
        ...
        sb.append("class AlarmLogResponseNewAlarmLog {\n");
