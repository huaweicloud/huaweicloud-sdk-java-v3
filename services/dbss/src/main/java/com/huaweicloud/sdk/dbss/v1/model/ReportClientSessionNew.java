...
public class ReportClientSessionNew {
    ...
    public ReportClientSessionNew withDbId(String dbId) {
        this.dbId = dbId;
        return this;
    }
    ...
    public ReportClientSessionNew withDbIp(String dbIp) {
        this.dbIp = dbIp;
        return this;
    }
    ...
    public ReportClientSessionNew withDbName(String dbName) {
        this.dbName = dbName;
        return this;
    }
    ...
    public ReportClientSessionNew withSessionNum(Long sessionNum) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ReportClientSessionNew that = (ReportClientSessionNew) obj;
        return Objects.equals(this.dbId, that.dbId) && Objects.equals(this.dbIp, that.dbIp)
            && Objects.equals(this.dbName, that.dbName) && Objects.equals(this.sessionNum, that.sessionNum);
    }

    @Override
    public int hashCode() {
        return Objects.hash(dbId, dbIp, dbName, sessionNum);
    }
