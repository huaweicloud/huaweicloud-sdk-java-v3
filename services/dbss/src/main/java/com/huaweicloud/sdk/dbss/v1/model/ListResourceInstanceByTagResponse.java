...
public class ListResourceInstanceByTagResponse extends SdkResponse {
    ...
    public ListResourceInstanceByTagResponse withResources(Consumer<List<ResourceInstanceResponseResources>> resourcesSetter) {
        if(this.resources == null) {
            this.resources = new ArrayList<>();
        }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ListResourceInstanceByTagResponse listResourceInstanceByTagResponse = (ListResourceInstanceByTagResponse) o;
        return Objects.equals(this.resources, listResourceInstanceByTagResponse.resources) &&
            Objects.equals(this.totalCount, listResourceInstanceByTagResponse.totalCount);
    }
    @Override
    public int hashCode() {
