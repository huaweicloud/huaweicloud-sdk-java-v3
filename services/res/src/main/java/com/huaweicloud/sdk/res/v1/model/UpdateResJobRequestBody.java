...
public class UpdateResJobRequestBody {
    ...
    public UpdateResJobRequestBody withCategory(String category) {
    ...
    public UpdateResJobRequestBody withDescription(String description) {
    ...
    public UpdateResJobRequestBody withJobConfig(Consumer<JobConfig> jobConfigSetter) {
    ...
    public UpdateResJobRequestBody withJobName(String jobName) {
    ...
    public UpdateResJobRequestBody withJobType(String jobType) {
    ...
    public UpdateResJobRequestBody withSchedule(String schedule) {
