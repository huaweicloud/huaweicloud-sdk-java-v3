...
/** Response Object */
public class UpdateResOnlineInstanceResponse extends SdkResponse {
    ...
    public UpdateResOnlineInstanceResponse withIsSuccess(Boolean isSuccess) {
    ...
    public UpdateResOnlineInstanceResponse withMessage(String message) {
    ...
    public UpdateResOnlineInstanceResponse withErrorCode(String errorCode) {
    ...
    public String toString() {
        ...
        sb.append("class UpdateResOnlineInstanceResponse {\n");
