 ...
 * Response Object
 */
public class DeleteResDatasourceResponse extends SdkResponse {
    ...
    public DeleteResDatasourceResponse withIsSuccess(Boolean isSuccess) {
    ...
    public DeleteResDatasourceResponse withMessage(String message) {
    ...
    public DeleteResDatasourceResponse withErrorCode(String errorCode) {
    ...
    public String toString() {
        ...
        sb.append("class DeleteResDatasourceResponse {\n");
