 ...
 */
public class UpdateResWorkspaceRequestBody {
    ...
    public UpdateResWorkspaceRequestBody withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public UpdateResWorkspaceRequestBody withDescription(String description) {
    ...
    public String toString() {
        ...
        sb.append("class UpdateResWorkspaceRequestBody {\n");
