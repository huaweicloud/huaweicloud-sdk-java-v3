...
/** Response Object */
public class StartResSceneJobsResponse extends SdkResponse {
    ...
    public StartResSceneJobsResponse withIsSuccess(Boolean isSuccess) {
    ...
    public StartResSceneJobsResponse withMessage(String message) {
    ...
    public StartResSceneJobsResponse withErrorCode(String errorCode) {
    ...
    public String toString() {
        ...
        sb.append("class StartResSceneJobsResponse {\n");
