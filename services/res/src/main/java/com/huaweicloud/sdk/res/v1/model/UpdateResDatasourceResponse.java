...
/** Response Object */
public class UpdateResDatasourceResponse extends SdkResponse {
    ...
    public UpdateResDatasourceResponse withIsSuccess(Boolean isSuccess) {
    ...
    public UpdateResDatasourceResponse withMessage(String message) {
    ...
    public UpdateResDatasourceResponse withErrorCode(String errorCode) {
    ...
    public String toString() {
        ...
        sb.append("class UpdateResDatasourceResponse {\n");
