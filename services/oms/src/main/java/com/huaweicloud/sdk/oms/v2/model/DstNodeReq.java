...
public class DstNodeReq {
    ...
    public DstNodeReq withCryptoType(CryptoTypeEnum cryptoType) {
    ...
    public DstNodeReq withKmsKeyId(String kmsKeyId) {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(ak, sk, securityToken, bucket, savePrefix, region, cryptoType, kmsKeyId);
    }
