...
public class TaskGroupDstNode {
    ...
    public TaskGroupDstNode withCryptoType(CryptoTypeEnum cryptoType) {
    ...
    public TaskGroupDstNode withKmsKeyId(String kmsKeyId) {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(ak, sk, cryptoType, kmsKeyId, region, bucket, cloudType, savePrefix);
    }
