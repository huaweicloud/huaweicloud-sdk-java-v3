...
public class StartTaskGroupReq {
    ...
    public StartTaskGroupReq withSrcCryptoType(SrcCryptoTypeEnum srcCryptoType) {
    ...
    public StartTaskGroupReq withSrcKmsKeyId(String srcKmsKeyId) {
    ...
    public StartTaskGroupReq withDstCryptoType(DstCryptoTypeEnum dstCryptoType) {
    ...
    public StartTaskGroupReq withDstKmsKeyId(String dstKmsKeyId) {
    ...
    public StartTaskGroupReq withSourceCdnCryptoType(SourceCdnCryptoTypeEnum sourceCdnCryptoType) {
    ...
    public StartTaskGroupReq withSourceCdnKmsKeyId(String sourceCdnKmsKeyId) {
