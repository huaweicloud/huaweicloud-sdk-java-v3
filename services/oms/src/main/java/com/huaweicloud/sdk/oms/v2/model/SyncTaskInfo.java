...
public class SyncTaskInfo {
    ...
    public SyncTaskInfo withObjectOverwriteMode(ObjectOverwriteModeEnum objectOverwriteMode) {
    ...
    public SyncTaskInfo withDstStoragePolicy(DstStoragePolicyEnum dstStoragePolicy) {
