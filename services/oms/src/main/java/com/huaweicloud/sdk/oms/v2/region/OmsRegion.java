...
public class OmsRegion {
    ...
    public static final Region LA_NORTH_2 = new Region("la-north-2", "https://oms.la-north-2.myhuaweicloud.com");

    public static final Region TR_WEST_1 = new Region("tr-west-1", "https://oms.tr-west-1.myhuaweicloud.com");
    ...
    public static final Region AF_SOUTH_1 = new Region("af-south-1", "https://oms.af-south-1.myhuaweicloud.com");

    public static final Region CN_EAST_4 = new Region("cn-east-4", "https://oms.cn-east-4.myhuaweicloud.com");

    public static final Region AP_SOUTHEAST_5 =
        new Region("ap-southeast-5", "https://oms.ap-southeast-5.myhuaweicloud.com");

    public static final Region CN_NORTH_12 = new Region("cn-north-12", "https://oms.cn-north-12.myhuaweicloud.com");
    ...
    public static Region valueOf(String regionId) {
        ...
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "region id '%s' is not in the following supported regions of service OMS: [%s]",
            regionId,
