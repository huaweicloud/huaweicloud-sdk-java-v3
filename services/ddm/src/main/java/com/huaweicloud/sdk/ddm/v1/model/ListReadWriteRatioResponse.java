...
import com.huaweicloud.sdk.ddm.v1.model.ReadWriteRatioList;
...
public class ListReadWriteRatioResponse extends SdkResponse {
    ...
    public ListReadWriteRatioResponse withReadWriteRatioList(Consumer<List<ReadWriteRatioList>> readWriteRatioListSetter) {
        if(this.readWriteRatioList == null) {
            this.readWriteRatioList = new ArrayList<>();
        }
