...
public class GetUsersListDetailResponses  {
    ...
    private List<String> baseAuthority = new ArrayList<>();
    

    @JsonInclude(JsonInclude.Include.NON_NULL)
    @JsonProperty(value="extend_authority")
    
    private List<String> extendAuthority = new ArrayList<>();
    ...
    private List<GetUsersListdatabase> databases = new ArrayList<>();
    ...
    /**
     * DDM实例账号的扩展权限。  取值为：fulltableDelete、fulltableSelect、fulltableUpdate
    ...
    public GetUsersListDetailResponses withCreated(String created) {
