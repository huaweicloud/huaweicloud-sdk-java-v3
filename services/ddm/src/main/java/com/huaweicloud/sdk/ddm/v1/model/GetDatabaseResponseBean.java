...
import com.huaweicloud.sdk.ddm.v1.model.GetDatabases;
...
public class GetDatabaseResponseBean  {
    ...
    private List<GetDatabases> databases = new ArrayList<>();
    ...
    private List<String> dataVips = new ArrayList<>();
    ...
    @Override
    public int hashCode() {
        return Objects.hash(name, created, status, updated, databases, shardMode, shardNumber, shardUnit, dataVips, usedRds);
    }
    @Override
