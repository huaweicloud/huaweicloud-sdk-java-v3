...
public class CreateUsersInfo  {
    ...
    private List<BaseAuthorityEnum> baseAuthority = new ArrayList<>();
        /**
    ...
    /**
     * DDM实例账号名称，命名要求如下。  - 长度为6-32个字符。 - 必须以字母开头。 - 可以包含字母，数字、下划线，不能包含其它特殊字符。
     * @return name
     */
    ...
    /**
     * DDM实例账号的基础权限。  取值为：CREATE、DROP、ALTER、INDEX、INSERT、DELETE、UPDATE、SELECT
    ...
    public CreateUsersInfo withExtendAuthority(List<ExtendAuthorityEnum> extendAuthority) {
        this.extendAuthority = extendAuthority;
        return this;
    }

    
    public CreateUsersInfo addExtendAuthorityItem(ExtendAuthorityEnum extendAuthorityItem) {
    ...
    public CreateUsersInfo withExtendAuthority(Consumer<List<ExtendAuthorityEnum>> extendAuthoritySetter) {
        if(this.extendAuthority == null ){
            this.extendAuthority = new ArrayList<>();
        }
    ...
    /**
     * DDM实例账号的扩展权限，默认值为空。  取值范围为：fulltableDelete、fulltableSelect、fulltableUpdate。  说明： 权限配置应该遵循如下原则：  请至少选择一个基础权限，且扩展权限对应的基础权限必须选择，对应关系如下：   - “fulltableSelect”对应“SELECT”   - “fulltableDelete”对应“DELETE”   - “fulltableUpdate”对应“UPDATE”
    ...
    public boolean equals(java.lang.Object o) {
        ...
        return Objects.equals(this.name, createUsersInfo.name) &&
            ...
            Objects.equals(this.extendAuthority, createUsersInfo.extendAuthority) &&
            Objects.equals(this.description, createUsersInfo.description) &&
            Objects.equals(this.databases, createUsersInfo.databases);
    }
    @Override
    public int hashCode() {
        return Objects.hash(name, password, baseAuthority, extendAuthority, description, databases);
    }
    @Override
    public String toString() {
