...
import com.huaweicloud.sdk.ddm.v1.model.GetDetailfNodesInfo;
...
public class ShowInstanceResponse extends SdkResponse {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, status, name, created, updated, availableZone, vpcId, subnetId, securityGroupId, nodeCount, accessIp, accessPort, nodeStatus, coreCount, ramCapacity, errorMsg, projectId, orderId, enterpriseProjectId, engineVersion, nodes);
    }
    @Override
