...
public class CreateDatabaseDetail  {
     ...
     */
    public static final class ShardUnitEnum {

        
        /**
         * Enum NUMBER_8 for value: 8
         */
        public static final ShardUnitEnum NUMBER_8 = new ShardUnitEnum(8);
        
        /**
         * Enum NUMBER_16 for value: 16
         */
        public static final ShardUnitEnum NUMBER_16 = new ShardUnitEnum(16);
        

        private static final Map<Integer, ShardUnitEnum> STATIC_FIELDS = createStaticFields();

        private static Map<Integer, ShardUnitEnum> createStaticFields() {
            Map<Integer, ShardUnitEnum> map = new HashMap<>();
            map.put(8, NUMBER_8);
            map.put(16, NUMBER_16);
            return Collections.unmodifiableMap(map);
        }

        private Integer value;

        ShardUnitEnum(Integer value) {
            this.value = value;
        }
        ...
        @JsonCreator
        public static ShardUnitEnum fromValue(Integer value) {
            if( value == null ){
                return null;
            }
            ShardUnitEnum result = STATIC_FIELDS.get(value);
            if (result == null) {
                result = new ShardUnitEnum(value);
            }
            return result;
        }

        public static ShardUnitEnum valueOf(Integer value) {
            if( value == null ){
                return null;
            }
            ShardUnitEnum result = STATIC_FIELDS.get(value);
        ...
        @Override
        public boolean equals(Object obj) {
            if (obj != null && obj instanceof ShardUnitEnum) {
                return this.value.equals(((ShardUnitEnum) obj).value);
            }
            return false;
        }
    ...
    private ShardUnitEnum shardUnit;


    @JsonInclude(JsonInclude.Include.NON_NULL)
    @JsonProperty(value="used_rds")
    
    private List<DatabaseInstabcesParam> usedRds = new ArrayList<>();
    ...
    public CreateDatabaseDetail withShardUnit(ShardUnitEnum shardUnit) {
     ...
     * @return shardUnit
     */
    public ShardUnitEnum getShardUnit() {
        return shardUnit;
    }

    public void setShardUnit(ShardUnitEnum shardUnit) {
        this.shardUnit = shardUnit;
    }
