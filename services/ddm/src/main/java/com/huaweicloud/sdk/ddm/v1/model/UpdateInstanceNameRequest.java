...
public class UpdateInstanceNameRequest  {
    ...
    private ModifyInstanceNameReq body = null;
    ...
    public UpdateInstanceNameRequest withBody(ModifyInstanceNameReq body) {
        this.body = body;
        return this;
    }

    public UpdateInstanceNameRequest withBody(Consumer<ModifyInstanceNameReq> bodySetter) {
        if(this.body == null ){
            this.body = new ModifyInstanceNameReq();
     ...
     * @return body
     */
    public ModifyInstanceNameReq getBody() {
        return body;
    }

    public void setBody(ModifyInstanceNameReq body) {
        this.body = body;
    }
    @Override
