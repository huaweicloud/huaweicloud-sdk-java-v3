...
public class DdmClient {
     ...
     */
    public SyncInvoker<ListReadWriteRatioRequest, ListReadWriteRatioResponse> listReadWriteRatioInvoker(ListReadWriteRatioRequest request) {
        return new SyncInvoker<ListReadWriteRatioRequest, ListReadWriteRatioResponse>(request, DdmMeta.listReadWriteRatio, hcClient);
    }
