...
public class SupplyOption {
    ...
    public static final class ResultGranularityEnum {
        ...
        public static ResultGranularityEnum fromValue(String value) {
            ...
            return java.util.Optional.ofNullable(STATIC_FIELDS.get(value)).orElse(new ResultGranularityEnum(value));
        }
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        SupplyOption that = (SupplyOption) obj;
        return Objects.equals(this.resultGranularity, that.resultGranularity)
            && Objects.equals(this.enableSpot, that.enableSpot);
    }
