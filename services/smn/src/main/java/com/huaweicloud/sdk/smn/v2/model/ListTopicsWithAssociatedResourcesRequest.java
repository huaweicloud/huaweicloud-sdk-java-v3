...
public class ListTopicsWithAssociatedResourcesRequest {
    ...
    public ListTopicsWithAssociatedResourcesRequest withOffset(Integer offset) {
        this.offset = offset;
        return this;
    }
    ...
    public ListTopicsWithAssociatedResourcesRequest withLimit(Integer limit) {
        this.limit = limit;
        return this;
    }
    ...
    public ListTopicsWithAssociatedResourcesRequest withTopicId(String topicId) {
    ...
    public ListTopicsWithAssociatedResourcesRequest withEnterpriseProjectId(String enterpriseProjectId) {
    ...
    public ListTopicsWithAssociatedResourcesRequest withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public ListTopicsWithAssociatedResourcesRequest withFuzzyName(String fuzzyName) {
    ...
    public ListTopicsWithAssociatedResourcesRequest withFuzzyDisplayName(String fuzzyDisplayName) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ListTopicsWithAssociatedResourcesRequest that = (ListTopicsWithAssociatedResourcesRequest) obj;
    ...
    @Override
    public int hashCode() {
        return Objects.hash(offset, limit, topicId, enterpriseProjectId, name, fuzzyName, fuzzyDisplayName);
    }
