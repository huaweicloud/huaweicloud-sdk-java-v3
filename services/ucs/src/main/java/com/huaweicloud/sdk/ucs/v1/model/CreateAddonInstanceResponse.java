...
public class CreateAddonInstanceResponse extends SdkResponse {
    ...
    public CreateAddonInstanceResponse withMetadata(ObjectMeta metadata) {
        this.metadata = metadata;
        return this;
    }

    public CreateAddonInstanceResponse withMetadata(Consumer<ObjectMeta> metadataSetter) {
    ...
    public CreateAddonInstanceResponse withSpec(AddonInstanceSpec spec) {
        this.spec = spec;
        return this;
    }

    public CreateAddonInstanceResponse withSpec(Consumer<AddonInstanceSpec> specSetter) {
        if (this.spec == null) {
