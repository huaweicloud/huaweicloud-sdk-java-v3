 ...
 * Response Object
 */
public class ShowProxyUnitedWorkloadResponse extends SdkResponse {
    ...
    public ShowProxyUnitedWorkloadResponse withKind(String kind) {
        this.kind = kind;
        return this;
    }
    ...
    public ShowProxyUnitedWorkloadResponse withApiVersion(String apiVersion) {
    ...
    public ShowProxyUnitedWorkloadResponse withMetadata(ObjectMeta metadata) {
        this.metadata = metadata;
        return this;
    }

    public ShowProxyUnitedWorkloadResponse withMetadata(Consumer<ObjectMeta> metadataSetter) {
    ...
    public ShowProxyUnitedWorkloadResponse withTemplate(Object template) {
    ...
    public ShowProxyUnitedWorkloadResponse withPropagationPolicy(PropagationPolicy propagationPolicy) {
        this.propagationPolicy = propagationPolicy;
        return this;
    }

    public ShowProxyUnitedWorkloadResponse withPropagationPolicy(Consumer<PropagationPolicy> propagationPolicySetter) {
    ...
    public ShowProxyUnitedWorkloadResponse withOverridePolicy(OverridePolicy overridePolicy) {
        this.overridePolicy = overridePolicy;
        return this;
    }

    public ShowProxyUnitedWorkloadResponse withOverridePolicy(Consumer<OverridePolicy> overridePolicySetter) {
    ...
    public ShowProxyUnitedWorkloadResponse withResourceBinding(ResourceBinding resourceBinding) {
        this.resourceBinding = resourceBinding;
        return this;
    }

    public ShowProxyUnitedWorkloadResponse withResourceBinding(Consumer<ResourceBinding> resourceBindingSetter) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ShowProxyUnitedWorkloadResponse that = (ShowProxyUnitedWorkloadResponse) obj;
    ...
    public String toString() {
        ...
        sb.append("class ShowProxyUnitedWorkloadResponse {\n");
