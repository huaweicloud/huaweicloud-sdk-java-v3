...
public class AddonInstance {
    ...
    public AddonInstance withMetadata(ObjectMeta metadata) {
        this.metadata = metadata;
        return this;
    }

    public AddonInstance withMetadata(Consumer<ObjectMeta> metadataSetter) {
    ...
    public AddonInstance withSpec(AddonInstanceSpec spec) {
        this.spec = spec;
        return this;
    }

    public AddonInstance withSpec(Consumer<AddonInstanceSpec> specSetter) {
        if (this.spec == null) {
