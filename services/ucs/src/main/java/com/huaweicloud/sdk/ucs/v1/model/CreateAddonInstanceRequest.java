...
public class CreateAddonInstanceRequest {
    ...
    public CreateAddonInstanceRequest withBody(AddonInstance body) {
        this.body = body;
        return this;
    }

    public CreateAddonInstanceRequest withBody(Consumer<AddonInstance> bodySetter) {
        if (this.body == null) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        CreateAddonInstanceRequest that = (CreateAddonInstanceRequest) obj;
