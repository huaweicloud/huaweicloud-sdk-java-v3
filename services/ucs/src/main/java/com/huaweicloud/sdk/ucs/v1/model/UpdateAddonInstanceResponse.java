...
public class UpdateAddonInstanceResponse extends SdkResponse {
    ...
    public UpdateAddonInstanceResponse withMetadata(ObjectMeta metadata) {
        this.metadata = metadata;
        return this;
    }

    public UpdateAddonInstanceResponse withMetadata(Consumer<ObjectMeta> metadataSetter) {
    ...
    public UpdateAddonInstanceResponse withSpec(AddonInstanceSpec spec) {
        this.spec = spec;
        return this;
    }

    public UpdateAddonInstanceResponse withSpec(Consumer<AddonInstanceSpec> specSetter) {
        if (this.spec == null) {
