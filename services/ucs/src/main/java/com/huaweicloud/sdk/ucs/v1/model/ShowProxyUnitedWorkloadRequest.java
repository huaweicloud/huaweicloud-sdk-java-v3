 ...
 * Request Object
 */
public class ShowProxyUnitedWorkloadRequest {
    ...
    public ShowProxyUnitedWorkloadRequest withClustergroupid(String clustergroupid) {
    ...
    public ShowProxyUnitedWorkloadRequest withKind(String kind) {
        this.kind = kind;
        return this;
    }
    ...
    public ShowProxyUnitedWorkloadRequest withNamespace(String namespace) {
    ...
    public ShowProxyUnitedWorkloadRequest withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ShowProxyUnitedWorkloadRequest that = (ShowProxyUnitedWorkloadRequest) obj;
    ...
    public String toString() {
        ...
        sb.append("class ShowProxyUnitedWorkloadRequest {\n");
