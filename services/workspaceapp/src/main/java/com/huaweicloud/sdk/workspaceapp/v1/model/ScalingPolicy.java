...
public class ScalingPolicy {
    ...
    public ScalingPolicy withEnable(Boolean enable) {
        this.enable = enable;
        return this;
    }
    ...
    public ScalingPolicy withMaxScalingAmount(Integer maxScalingAmount) {
    ...
    public ScalingPolicy withSingleExpansionCount(Integer singleExpansionCount) {
    ...
    public ScalingPolicy withScalingPolicyBySession(ScalingPolicyBySession scalingPolicyBySession) {
        this.scalingPolicyBySession = scalingPolicyBySession;
        return this;
    }

    public ScalingPolicy withScalingPolicyBySession(Consumer<ScalingPolicyBySession> scalingPolicyBySessionSetter) {
    ...
    public ScalingPolicy withScalingPolicyByResource(ScalingPolicyByResource scalingPolicyByResource) {
        this.scalingPolicyByResource = scalingPolicyByResource;
        return this;
    }

    public ScalingPolicy withScalingPolicyByResource(Consumer<ScalingPolicyByResource> scalingPolicyByResourceSetter) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ScalingPolicy that = (ScalingPolicy) obj;
