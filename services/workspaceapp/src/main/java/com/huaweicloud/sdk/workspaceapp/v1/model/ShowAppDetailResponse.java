...
public class ShowAppDetailResponse extends SdkResponse {
    ...
    public ShowAppDetailResponse withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public ShowAppDetailResponse withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public ShowAppDetailResponse withVersion(String version) {
    ...
    public ShowAppDetailResponse withCommandParam(String commandParam) {
    ...
    public ShowAppDetailResponse withExecutePath(String executePath) {
    ...
    public ShowAppDetailResponse withWorkPath(String workPath) {
    ...
    public ShowAppDetailResponse withIconPath(String iconPath) {
    ...
    public ShowAppDetailResponse withIconIndex(Integer iconIndex) {
    ...
    public ShowAppDetailResponse withDescription(String description) {
    ...
    public ShowAppDetailResponse withAppGroupId(String appGroupId) {
    ...
    public ShowAppDetailResponse withState(AppStateEnum state) {
        this.state = state;
        return this;
    }
    ...
    public ShowAppDetailResponse withTenantId(String tenantId) {
    ...
    public ShowAppDetailResponse withPublishAt(OffsetDateTime publishAt) {
    ...
    public ShowAppDetailResponse withSourceType(Integer sourceType) {
    ...
    public ShowAppDetailResponse withPublisher(String publisher) {
    ...
    public ShowAppDetailResponse withIconUrl(String iconUrl) {
    ...
    public ShowAppDetailResponse withPublishable(Boolean publishable) {
    ...
    public ShowAppDetailResponse withSandboxEnable(Boolean sandboxEnable) {
    ...
    public ShowAppDetailResponse withIsPreBoot(Boolean isPreBoot) {
    ...
    public ShowAppDetailResponse withAppExtendedInfo(AppExtendedInfo appExtendedInfo) {
        this.appExtendedInfo = appExtendedInfo;
        return this;
    }

    public ShowAppDetailResponse withAppExtendedInfo(Consumer<AppExtendedInfo> appExtendedInfoSetter) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ShowAppDetailResponse that = (ShowAppDetailResponse) obj;
