 ...
 * Request Object
 */
public class BatchDisableAppRequest {
    ...
    public BatchDisableAppRequest withAppGroupId(String appGroupId) {
    ...
    public BatchDisableAppRequest withBody(BatchUpdateAppReq body) {
        this.body = body;
        return this;
    }

    public BatchDisableAppRequest withBody(Consumer<BatchUpdateAppReq> bodySetter) {
        if (this.body == null) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        BatchDisableAppRequest that = (BatchDisableAppRequest) obj;
    ...
    public String toString() {
        ...
        sb.append("class BatchDisableAppRequest {\n");
