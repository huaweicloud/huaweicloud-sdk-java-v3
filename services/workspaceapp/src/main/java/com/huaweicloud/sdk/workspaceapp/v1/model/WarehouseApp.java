...
public class WarehouseApp {
    ...
    public WarehouseApp withAppId(String appId) {
        this.appId = appId;
        return this;
    }
    ...
    public WarehouseApp withTenantId(String tenantId) {
    ...
    public WarehouseApp withAppName(String appName) {
    ...
    public WarehouseApp withAppCategory(AppCategoryEnum appCategory) {
    ...
    public WarehouseApp withOsType(OsTypeEnum osType) {
        this.osType = osType;
        return this;
    }
    ...
    public WarehouseApp withVersionId(String versionId) {
    ...
    public WarehouseApp withVersionName(String versionName) {
    ...
    public WarehouseApp withAppfileStorePath(String appfileStorePath) {
    ...
    public WarehouseApp withAppFileSize(String appFileSize) {
    ...
    public WarehouseApp withAppDescription(String appDescription) {
    ...
    public WarehouseApp withAppiconStorePath(String appiconStorePath) {
    ...
    public WarehouseApp withCreateTime(OffsetDateTime createTime) {
    ...
    public WarehouseApp withModifyTime(OffsetDateTime modifyTime) {
    ...
    public WarehouseApp withVerifyTime(OffsetDateTime verifyTime) {
    ...
    public WarehouseApp withVerifyStatus(VerifyStatusEnum verifyStatus) {
    ...
    public WarehouseApp withVerifyComment(String verifyComment) {
    ...
    public WarehouseApp withAppIcon(String appIcon) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        WarehouseApp that = (WarehouseApp) obj;
