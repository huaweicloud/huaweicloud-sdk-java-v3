package com.huaweicloud.sdk.workspaceapp.v1.region;
...
public class WorkspaceAppRegion {
    ...
    public static final Region CN_NORTH_9 = new Region("cn-north-9", "https://appstream.cn-north-9.myhuaweicloud.com");

    public static final Region CN_SOUTHWEST_2 =
        new Region("cn-southwest-2", "https://appstream.cn-southwest-2.myhuaweicloud.com");

    public static final Region CN_NORTH_4 = new Region("cn-north-4", "https://appstream.cn-north-4.myhuaweicloud.com");

    public static final Region CN_EAST_3 = new Region("cn-east-3", "https://appstream.cn-east-3.myhuaweicloud.com");

    public static final Region CN_SOUTH_1 = new Region("cn-south-1", "https://appstream.cn-south-1.myhuaweicloud.com");
    ...
    public static final Region AF_NORTH_1 = new Region("af-north-1", "https://workspace.af-north-1.myhuaweicloud.com");

    public static final Region AP_SOUTHEAST_2 =
        new Region("ap-southeast-2", "https://workspace.ap-southeast-2.myhuaweicloud.com");

    private static final IRegionProvider PROVIDER = RegionProviderChain.getDefaultRegionProviderChain("WORKSPACEAPP");
    ...
    public static Region valueOf(String regionId) {
        ...
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "region id '%s' is not in the following supported regions of service WorkspaceApp: [%s]",
            regionId,
