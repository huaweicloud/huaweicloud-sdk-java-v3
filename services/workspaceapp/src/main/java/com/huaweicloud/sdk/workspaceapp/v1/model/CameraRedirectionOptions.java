 ...
 * 摄像头设备重定向控制的选项。
 */
public class CameraRedirectionOptions {
    ...
    public CameraRedirectionOptions withCameraFrameRate(Integer cameraFrameRate) {
    ...
    public CameraRedirectionOptions withCameraMaxWidth(Integer cameraMaxWidth) {
    ...
    public CameraRedirectionOptions withCameraMaxHeigth(Integer cameraMaxHeigth) {
    ...
    public CameraRedirectionOptions withCameraCompressionMethod(String cameraCompressionMethod) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        CameraRedirectionOptions that = (CameraRedirectionOptions) obj;
    ...
    public String toString() {
        ...
        sb.append("class CameraRedirectionOptions {\n");
