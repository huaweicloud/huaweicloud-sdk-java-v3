 ...
 * Response Object
 */
public class CreatePersistentStorageResponse extends SdkResponse {
    ...
    public CreatePersistentStorageResponse withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public CreatePersistentStorageResponse withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public CreatePersistentStorageResponse withStorageMetadata(StorageMetadata storageMetadata) {
        this.storageMetadata = storageMetadata;
        return this;
    }

    public CreatePersistentStorageResponse withStorageMetadata(Consumer<StorageMetadata> storageMetadataSetter) {
    ...
    public CreatePersistentStorageResponse withCreateTime(OffsetDateTime createTime) {
    ...
    public CreatePersistentStorageResponse withUserClaimCount(Integer userClaimCount) {
    ...
    public CreatePersistentStorageResponse withShareClaimCount(Integer shareClaimCount) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        CreatePersistentStorageResponse that = (CreatePersistentStorageResponse) obj;
    ...
    public String toString() {
        ...
        sb.append("class CreatePersistentStorageResponse {\n");
