 ...
 * Response Object
 */
public class UploadAppIconRawResponse extends SdkResponse {
    ...
    public UploadAppIconRawResponse withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public UploadAppIconRawResponse withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public UploadAppIconRawResponse withVersion(String version) {
    ...
    public UploadAppIconRawResponse withCommandParam(String commandParam) {
    ...
    public UploadAppIconRawResponse withExecutePath(String executePath) {
    ...
    public UploadAppIconRawResponse withWorkPath(String workPath) {
    ...
    public UploadAppIconRawResponse withIconPath(String iconPath) {
    ...
    public UploadAppIconRawResponse withIconIndex(Integer iconIndex) {
    ...
    public UploadAppIconRawResponse withDescription(String description) {
    ...
    public UploadAppIconRawResponse withAppGroupId(String appGroupId) {
    ...
    public UploadAppIconRawResponse withState(AppStateEnum state) {
        this.state = state;
        return this;
    }
    ...
    public UploadAppIconRawResponse withTenantId(String tenantId) {
    ...
    public UploadAppIconRawResponse withPublishAt(OffsetDateTime publishAt) {
    ...
    public UploadAppIconRawResponse withSourceType(Integer sourceType) {
    ...
    public UploadAppIconRawResponse withPublisher(String publisher) {
    ...
    public UploadAppIconRawResponse withIconUrl(String iconUrl) {
    ...
    public UploadAppIconRawResponse withPublishable(Boolean publishable) {
    ...
    public UploadAppIconRawResponse withSandboxEnable(Boolean sandboxEnable) {
    ...
    public UploadAppIconRawResponse withIsPreBoot(Boolean isPreBoot) {
    ...
    public UploadAppIconRawResponse withAppExtendedInfo(AppExtendedInfo appExtendedInfo) {
        this.appExtendedInfo = appExtendedInfo;
        return this;
    }

    public UploadAppIconRawResponse withAppExtendedInfo(Consumer<AppExtendedInfo> appExtendedInfoSetter) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        UploadAppIconRawResponse that = (UploadAppIconRawResponse) obj;
    ...
    public String toString() {
        ...
        sb.append("class UploadAppIconRawResponse {\n");
