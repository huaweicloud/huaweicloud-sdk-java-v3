...
/**
 * UploadWarehouseAppIconRequestBody
 */
public class UploadWarehouseAppIconRequestBody implements SdkFormDataBody {

    @JsonProperty(value = "data", access = JsonProperty.Access.WRITE_ONLY)

    private FormDataFilePart data;

    public UploadWarehouseAppIconRequestBody withData(FormDataFilePart data) {
        this.data = data;
        return this;
    }
    ...
    public UploadWarehouseAppIconRequestBody withData(InputStream inputStream, String fileName, String contentType) {
        this.data = new FormDataFilePart(inputStream, fileName).withContentType(contentType);
        return this;
    }

    public UploadWarehouseAppIconRequestBody withData(InputStream inputStream, String fileName) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        UploadWarehouseAppIconRequestBody that = (UploadWarehouseAppIconRequestBody) obj;
