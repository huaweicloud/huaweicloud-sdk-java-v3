...
public class AppServerTaskStatus {
    ...
    /**
     * Enum INSTALLING_APP for value: "installing_app"
     */
    public static final AppServerTaskStatus INSTALLING_APP = new AppServerTaskStatus("installing_app");

    /**
     * Enum INSTALL_APP_FAILED for value: "install_app_failed"
     */
    public static final AppServerTaskStatus INSTALL_APP_FAILED = new AppServerTaskStatus("install_app_failed");
    ...
    private static Map<String, AppServerTaskStatus> createStaticFields() {
        ...
        map.put("installing_app", INSTALLING_APP);
        map.put("install_app_failed", INSTALL_APP_FAILED);
        map.put("null", NULL);
