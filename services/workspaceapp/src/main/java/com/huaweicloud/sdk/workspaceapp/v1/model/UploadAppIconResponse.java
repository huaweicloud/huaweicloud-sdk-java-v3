 ...
 * Response Object
 */
public class UploadAppIconResponse extends SdkResponse {
    ...
    public UploadAppIconResponse withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public UploadAppIconResponse withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public UploadAppIconResponse withVersion(String version) {
    ...
    public UploadAppIconResponse withCommandParam(String commandParam) {
    ...
    public UploadAppIconResponse withExecutePath(String executePath) {
    ...
    public UploadAppIconResponse withWorkPath(String workPath) {
    ...
    public UploadAppIconResponse withIconPath(String iconPath) {
    ...
    public UploadAppIconResponse withIconIndex(Integer iconIndex) {
    ...
    public UploadAppIconResponse withDescription(String description) {
    ...
    public UploadAppIconResponse withAppGroupId(String appGroupId) {
    ...
    public UploadAppIconResponse withState(AppStateEnum state) {
        this.state = state;
        return this;
    }
    ...
    public UploadAppIconResponse withTenantId(String tenantId) {
    ...
    public UploadAppIconResponse withPublishAt(OffsetDateTime publishAt) {
    ...
    public UploadAppIconResponse withSourceType(Integer sourceType) {
    ...
    public UploadAppIconResponse withPublisher(String publisher) {
    ...
    public UploadAppIconResponse withIconUrl(String iconUrl) {
    ...
    public UploadAppIconResponse withPublishable(Boolean publishable) {
    ...
    public UploadAppIconResponse withSandboxEnable(Boolean sandboxEnable) {
    ...
    public UploadAppIconResponse withIsPreBoot(Boolean isPreBoot) {
    ...
    public UploadAppIconResponse withAppExtendedInfo(AppExtendedInfo appExtendedInfo) {
        this.appExtendedInfo = appExtendedInfo;
        return this;
    }

    public UploadAppIconResponse withAppExtendedInfo(Consumer<AppExtendedInfo> appExtendedInfoSetter) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        UploadAppIconResponse that = (UploadAppIconResponse) obj;
    ...
    public String toString() {
        ...
        sb.append("class UploadAppIconResponse {\n");
