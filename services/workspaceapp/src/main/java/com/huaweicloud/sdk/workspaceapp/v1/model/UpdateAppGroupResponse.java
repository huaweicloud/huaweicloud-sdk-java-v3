 ...
 * Response Object
 */
public class UpdateAppGroupResponse extends SdkResponse {
    ...
    public UpdateAppGroupResponse withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public UpdateAppGroupResponse withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public UpdateAppGroupResponse withAppServerGroupId(String appServerGroupId) {
    ...
    public UpdateAppGroupResponse withAppServerGroupName(String appServerGroupName) {
    ...
    public UpdateAppGroupResponse withDescription(String description) {
    ...
    public UpdateAppGroupResponse withAuthorizationType(AuthorizationTypeEnum authorizationType) {
    ...
    public UpdateAppGroupResponse withTenantId(String tenantId) {
    ...
    public UpdateAppGroupResponse withAppCount(Integer appCount) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        UpdateAppGroupResponse that = (UpdateAppGroupResponse) obj;
    ...
    public String toString() {
        ...
        sb.append("class UpdateAppGroupResponse {\n");
