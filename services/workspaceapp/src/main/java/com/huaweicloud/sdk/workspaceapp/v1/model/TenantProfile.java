...
public class TenantProfile {
    ...
    public TenantProfile withProjectId(String projectId) {
    ...
    public TenantProfile withProjectName(String projectName) {
    ...
    public TenantProfile withTenantDomainId(String tenantDomainId) {
    ...
    public TenantProfile withServiceStatus(String serviceStatus) {
    ...
    public TenantProfile withOpenWithAd(Boolean openWithAd) {
    ...
    public TenantProfile withTenantDomainName(String tenantDomainName) {
    ...
    public TenantProfile withCreateTime(OffsetDateTime createTime) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        TenantProfile that = (TenantProfile) obj;
