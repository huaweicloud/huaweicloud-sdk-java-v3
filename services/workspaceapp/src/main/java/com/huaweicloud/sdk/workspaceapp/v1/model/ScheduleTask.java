...
public class ScheduleTask {
    ...
    public ScheduleTask withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public ScheduleTask withTaskName(String taskName) {
    ...
    public ScheduleTask withLastStatus(ScheduleTaskStatus lastStatus) {
    ...
    public ScheduleTask withTaskType(ScheduleTaskTypeEnum taskType) {
    ...
    public ScheduleTask withTaskCron(String taskCron) {
    ...
    public ScheduleTask withNextExecutionTime(String nextExecutionTime) {
    ...
    public ScheduleTask withScheduleTaskPolicy(ScheduleTaskPolicy scheduleTaskPolicy) {
        this.scheduleTaskPolicy = scheduleTaskPolicy;
        return this;
    }

    public ScheduleTask withScheduleTaskPolicy(Consumer<ScheduleTaskPolicy> scheduleTaskPolicySetter) {
    ...
    public ScheduleTask withScheduledType(ScheduledTypeEnum scheduledType) {
    ...
    public ScheduleTask withDayInterval(Integer dayInterval) {
    ...
    public ScheduleTask withWeekList(String weekList) {
    ...
    public ScheduleTask withMonthList(String monthList) {
    ...
    public ScheduleTask withDateList(String dateList) {
    ...
    public ScheduleTask withTimeZone(String timeZone) {
    ...
    public ScheduleTask withScheduledDate(String scheduledDate) {
    ...
    public ScheduleTask withScheduledTime(String scheduledTime) {
    ...
    public ScheduleTask withExpireTime(OffsetDateTime expireTime) {
    ...
    public ScheduleTask withDescription(String description) {
    ...
    public ScheduleTask withIsEnable(Boolean isEnable) {
    ...
    public ScheduleTask withCreateTime(OffsetDateTime createTime) {
    ...
    public ScheduleTask withUpdateTime(OffsetDateTime updateTime) {
