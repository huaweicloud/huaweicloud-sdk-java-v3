...
public class BaseAppGroup {
    ...
    public BaseAppGroup withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public BaseAppGroup withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public BaseAppGroup withAppServerGroupId(String appServerGroupId) {
    ...
    public BaseAppGroup withAppServerGroupName(String appServerGroupName) {
    ...
    public BaseAppGroup withDescription(String description) {
    ...
    public BaseAppGroup withAuthorizationType(AuthorizationTypeEnum authorizationType) {
    ...
    public BaseAppGroup withTenantId(String tenantId) {
    ...
    public BaseAppGroup withCreateAt(OffsetDateTime createAt) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        BaseAppGroup that = (BaseAppGroup) obj;
    ...
    public int hashCode() {
        return Objects
            .hash(id, name, appServerGroupId, appServerGroupName, description, authorizationType, tenantId, createAt);
    }

    @Override
    public String toString() {
        StringBuilder sb = new StringBuilder();
        sb.append("class BaseAppGroup {\n");
