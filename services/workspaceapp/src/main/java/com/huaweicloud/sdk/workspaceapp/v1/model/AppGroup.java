...
public class AppGroup {
    ...
    public AppGroup withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public AppGroup withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public AppGroup withAppServerGroupId(String appServerGroupId) {
    ...
    public AppGroup withAppServerGroupName(String appServerGroupName) {
    ...
    public AppGroup withDescription(String description) {
    ...
    public AppGroup withAuthorizationType(AuthorizationTypeEnum authorizationType) {
    ...
    public AppGroup withTenantId(String tenantId) {
    ...
    public AppGroup withAppCount(Integer appCount) {
