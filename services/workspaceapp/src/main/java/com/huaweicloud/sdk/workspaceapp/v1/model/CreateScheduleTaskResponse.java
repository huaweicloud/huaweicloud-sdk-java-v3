...
public class CreateScheduleTaskResponse extends SdkResponse {
    ...
    public CreateScheduleTaskResponse withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public CreateScheduleTaskResponse withTaskName(String taskName) {
    ...
    public CreateScheduleTaskResponse withLastStatus(ScheduleTaskStatus lastStatus) {
    ...
    public CreateScheduleTaskResponse withTaskType(ScheduleTaskTypeEnum taskType) {
    ...
    public CreateScheduleTaskResponse withTaskCron(String taskCron) {
    ...
    public CreateScheduleTaskResponse withNextExecutionTime(String nextExecutionTime) {
    ...
    public CreateScheduleTaskResponse withScheduleTaskPolicy(ScheduleTaskPolicy scheduleTaskPolicy) {
        this.scheduleTaskPolicy = scheduleTaskPolicy;
        return this;
    }

    public CreateScheduleTaskResponse withScheduleTaskPolicy(Consumer<ScheduleTaskPolicy> scheduleTaskPolicySetter) {
    ...
    public CreateScheduleTaskResponse withScheduledType(ScheduledTypeEnum scheduledType) {
    ...
    public CreateScheduleTaskResponse withDayInterval(Integer dayInterval) {
    ...
    public CreateScheduleTaskResponse withWeekList(String weekList) {
    ...
    public CreateScheduleTaskResponse withMonthList(String monthList) {
    ...
    public CreateScheduleTaskResponse withDateList(String dateList) {
    ...
    public CreateScheduleTaskResponse withTimeZone(String timeZone) {
    ...
    public CreateScheduleTaskResponse withScheduledDate(String scheduledDate) {
    ...
    public CreateScheduleTaskResponse withScheduledTime(String scheduledTime) {
    ...
    public CreateScheduleTaskResponse withExpireTime(OffsetDateTime expireTime) {
    ...
    public CreateScheduleTaskResponse withDescription(String description) {
    ...
    public CreateScheduleTaskResponse withIsEnable(Boolean isEnable) {
    ...
    public CreateScheduleTaskResponse withCreateTime(OffsetDateTime createTime) {
    ...
    public CreateScheduleTaskResponse withUpdateTime(OffsetDateTime updateTime) {
