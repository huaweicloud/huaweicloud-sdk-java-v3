...
public class SubJobDetailInfo {
    ...
    public SubJobDetailInfo withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public SubJobDetailInfo withJobType(JobType jobType) {
    ...
    public SubJobDetailInfo withJobResourceInfo(JobResourceInfo jobResourceInfo) {
        this.jobResourceInfo = jobResourceInfo;
        return this;
    }

    public SubJobDetailInfo withJobResourceInfo(Consumer<JobResourceInfo> jobResourceInfoSetter) {
    ...
    public SubJobDetailInfo withBeginTime(OffsetDateTime beginTime) {
    ...
    public SubJobDetailInfo withEndTime(OffsetDateTime endTime) {
    ...
    public SubJobDetailInfo withStatus(JobDetailStatus status) {
        this.status = status;
        return this;
    }
    ...
    public SubJobDetailInfo withErrorCode(String errorCode) {
    ...
    public SubJobDetailInfo withErrorMessage(String errorMessage) {
    ...
    public SubJobDetailInfo withProjectId(String projectId) {
    ...
    public SubJobDetailInfo withJobId(String jobId) {
        this.jobId = jobId;
        return this;
    }
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        SubJobDetailInfo that = (SubJobDetailInfo) obj;
    ...
    public String toString() {
        ...
        sb.append("class SubJobDetailInfo {\n");
