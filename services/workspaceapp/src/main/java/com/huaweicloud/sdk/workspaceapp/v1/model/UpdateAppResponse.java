...
public class UpdateAppResponse extends SdkResponse {
    ...
    public UpdateAppResponse withVersion(String version) {
    ...
    public UpdateAppResponse withCommandParam(String commandParam) {
    ...
    public UpdateAppResponse withExecutePath(String executePath) {
    ...
    public UpdateAppResponse withWorkPath(String workPath) {
    ...
    public UpdateAppResponse withIconPath(String iconPath) {
    ...
    public UpdateAppResponse withIconIndex(Integer iconIndex) {
    ...
    public UpdateAppResponse withAppGroupId(String appGroupId) {
    ...
    public UpdateAppResponse withState(AppStateEnum state) {
        this.state = state;
        return this;
    }
    ...
    public UpdateAppResponse withTenantId(String tenantId) {
    ...
    public UpdateAppResponse withPublishAt(OffsetDateTime publishAt) {
    ...
    public UpdateAppResponse withSourceType(Integer sourceType) {
    ...
    public UpdateAppResponse withPublisher(String publisher) {
    ...
    public UpdateAppResponse withIconUrl(String iconUrl) {
    ...
    public UpdateAppResponse withPublishable(Boolean publishable) {
    ...
    public UpdateAppResponse withSandboxEnable(Boolean sandboxEnable) {
    ...
    public UpdateAppResponse withIsPreBoot(Boolean isPreBoot) {
    ...
    public UpdateAppResponse withAppExtendedInfo(AppExtendedInfo appExtendedInfo) {
        this.appExtendedInfo = appExtendedInfo;
        return this;
    }

    public UpdateAppResponse withAppExtendedInfo(Consumer<AppExtendedInfo> appExtendedInfoSetter) {
