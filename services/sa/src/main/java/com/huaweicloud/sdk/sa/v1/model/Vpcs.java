...
public class Vpcs {
    ...
    /** 虚拟私有云下可用子网的范围。 取值范围： 10.0.0.0/8~10.255.255.240/28、 172.16.0.0/12 ~ 172.31.255.240/28、 192.168.0.0/16 ~
    ...
    public boolean equals(java.lang.Object o) {
        ...
        Vpcs vpcs = (Vpcs) o;
        return Objects.equals(this.cidr, vpcs.cidr) && Objects.equals(this.status, vpcs.status);
    }
