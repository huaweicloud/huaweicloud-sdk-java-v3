...
public class SaClient {
     ...
     */
    public SyncInvoker<CheckProductHealthyRequest, CheckProductHealthyResponse> checkProductHealthyInvoker(CheckProductHealthyRequest request) {
        return new SyncInvoker<CheckProductHealthyRequest, CheckProductHealthyResponse>(request, SaMeta.checkProductHealthy, hcClient);
    }
