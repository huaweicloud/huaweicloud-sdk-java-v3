 ...
 * Response Object
 */
public class ShowTestCaseDetailResponse extends SdkResponse {

    @JsonInclude(JsonInclude.Include.NON_NULL)
    @JsonProperty(value = "testcase_id")

    @JacksonXmlProperty(localName = "testcase_id")
    ...
    @JacksonXmlProperty(localName = "execute_count")
    ...
    public ShowTestCaseDetailResponse withTestcaseId(String testcaseId) {
    ...
    public ShowTestCaseDetailResponse withProjectId(String projectId) {
    ...
    public ShowTestCaseDetailResponse withServiceId(Integer serviceId) {
    ...
    public ShowTestCaseDetailResponse withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public ShowTestCaseDetailResponse withTestcaseNumber(String testcaseNumber) {
    ...
    public ShowTestCaseDetailResponse withRankId(String rankId) {
        this.rankId = rankId;
        return this;
    }
    ...
    public ShowTestCaseDetailResponse withStatusId(String statusId) {
    ...
    public ShowTestCaseDetailResponse withAssignedUser(AssignedUserInfo assignedUser) {
        this.assignedUser = assignedUser;
        return this;
    }

    public ShowTestCaseDetailResponse withAssignedUser(Consumer<AssignedUserInfo> assignedUserSetter) {
    ...
    public ShowTestCaseDetailResponse withExecuteCount(Integer executeCount) {
    ...
    public ShowTestCaseDetailResponse withResultId(String resultId) {
    ...
    public ShowTestCaseDetailResponse withExtendInfo(ExtendInfo extendInfo) {
        this.extendInfo = extendInfo;
        return this;
    }

    public ShowTestCaseDetailResponse withExtendInfo(Consumer<ExtendInfo> extendInfoSetter) {
    ...
    public ShowTestCaseDetailResponse withErrorCode(String errorCode) {
    ...
    public ShowTestCaseDetailResponse withErrorMsg(String errorMsg) {
    ...
    public String toString() {
        ...
        sb.append("class ShowTestCaseDetailResponse {\n");
