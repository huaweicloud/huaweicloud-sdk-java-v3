...
public class DeleteBranchResponse extends SdkResponse {
    ...
    public DeleteBranchResponse withResult(ResultValueString result) {
        this.result = result;
        return this;
    }

    public DeleteBranchResponse withResult(Consumer<ResultValueString> resultSetter) {
        if (this.result == null) {
    ...
    public DeleteBranchResponse withError(ApiError error) {
        this.error = error;
        return this;
    }

    public DeleteBranchResponse withError(Consumer<ApiError> errorSetter) {
        if (this.error == null) {
    ...
    public DeleteBranchResponse withRequestId(String requestId) {
    ...
    public DeleteBranchResponse withServerAddress(String serverAddress) {
