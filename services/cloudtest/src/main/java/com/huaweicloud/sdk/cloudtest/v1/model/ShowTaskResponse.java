...
public class ShowTaskResponse extends SdkResponse {
    ...
    private ResultValueTaskVo result;
    ...
    public ShowTaskResponse withResult(ResultValueTaskVo result) {
        this.result = result;
        return this;
    }

    public ShowTaskResponse withResult(Consumer<ResultValueTaskVo> resultSetter) {
        if (this.result == null) {
            this.result = new ResultValueTaskVo();
     ...
     * @return result
     */
    public ResultValueTaskVo getResult() {
        return result;
    }

    public void setResult(ResultValueTaskVo result) {
        this.result = result;
    }

    public ShowTaskResponse withError(ApiError error) {
        this.error = error;
        return this;
    }

    public ShowTaskResponse withError(Consumer<ApiError> errorSetter) {
        if (this.error == null) {
    ...
    public ShowTaskResponse withRequestId(String requestId) {
    ...
    public ShowTaskResponse withServerAddress(String serverAddress) {
