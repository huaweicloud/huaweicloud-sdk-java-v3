...
public class CreateTaskRequest {
    ...
    public CreateTaskRequest withProjectUuid(String projectUuid) {
    ...
    public CreateTaskRequest withBody(TaskInfo body) {
        this.body = body;
        return this;
    }

    public CreateTaskRequest withBody(Consumer<TaskInfo> bodySetter) {
        if (this.body == null) {
