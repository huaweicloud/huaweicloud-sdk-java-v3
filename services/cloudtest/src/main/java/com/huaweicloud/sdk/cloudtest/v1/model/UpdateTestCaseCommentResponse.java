...
public class UpdateTestCaseCommentResponse extends SdkResponse {
    ...
    public UpdateTestCaseCommentResponse withStatus(String status) {
        this.status = status;
        return this;
    }
    ...
    public UpdateTestCaseCommentResponse withResult(ResultValueTestCaseCommentVo result) {
        this.result = result;
        return this;
    }

    public UpdateTestCaseCommentResponse withResult(Consumer<ResultValueTestCaseCommentVo> resultSetter) {
        if (this.result == null) {
    ...
    public UpdateTestCaseCommentResponse withError(ApiError error) {
        this.error = error;
        return this;
    }

    public UpdateTestCaseCommentResponse withError(Consumer<ApiError> errorSetter) {
        if (this.error == null) {
    ...
    public UpdateTestCaseCommentResponse withRequestId(String requestId) {
    ...
    public UpdateTestCaseCommentResponse withServerAddress(String serverAddress) {
