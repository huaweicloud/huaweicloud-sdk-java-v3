...
public class DeleteTestCaseCommentResponse extends SdkResponse {
    ...
    public DeleteTestCaseCommentResponse withResult(ResultValueString result) {
        this.result = result;
        return this;
    }

    public DeleteTestCaseCommentResponse withResult(Consumer<ResultValueString> resultSetter) {
        if (this.result == null) {
    ...
    public DeleteTestCaseCommentResponse withError(ApiError error) {
        this.error = error;
        return this;
    }

    public DeleteTestCaseCommentResponse withError(Consumer<ApiError> errorSetter) {
        if (this.error == null) {
    ...
    public DeleteTestCaseCommentResponse withRequestId(String requestId) {
    ...
    public DeleteTestCaseCommentResponse withServerAddress(String serverAddress) {
