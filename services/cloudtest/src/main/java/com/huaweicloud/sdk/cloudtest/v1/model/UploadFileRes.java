...
public class UploadFileRes {
    ...
    public UploadFileRes withAwInsId(String awInsId) {
    ...
    public UploadFileRes withCreateTime(String createTime) {
    ...
    public UploadFileRes withCreateTimeStamp(Long createTimeStamp) {
    ...
    public UploadFileRes withCreateTimeString(String createTimeString) {
    ...
    public UploadFileRes withCreateUser(String createUser) {
    ...
    public UploadFileRes withCurrentSize(Long currentSize) {
    ...
    public UploadFileRes withFilePath(String filePath) {
    ...
    public UploadFileRes withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public UploadFileRes withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public UploadFileRes withOriginName(String originName) {
    ...
    public UploadFileRes withProjectId(String projectId) {
    ...
    public UploadFileRes withRegion(String region) {
        this.region = region;
        return this;
    }
    ...
    public UploadFileRes withTestcaseId(String testcaseId) {
    ...
    public UploadFileRes withUpdateTime(String updateTime) {
    ...
    public UploadFileRes withUpdateTimeStamp(Long updateTimeStamp) {
    ...
    public UploadFileRes withUpdateTimeString(String updateTimeString) {
    ...
    public UploadFileRes withUpdateUser(String updateUser) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        UploadFileRes that = (UploadFileRes) obj;
