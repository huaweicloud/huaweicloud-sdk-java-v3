...
import com.huaweicloud.sdk.cloudtest.v1.model.ShowPlansResponseDesignStage;
import com.huaweicloud.sdk.cloudtest.v1.model.ShowPlansResponseExecuteStage;
import com.huaweicloud.sdk.cloudtest.v1.model.ShowPlansResponseOwner;
import com.huaweicloud.sdk.cloudtest.v1.model.ShowPlansResponseReportStage;
...
public class ShowPlansResponseBody  {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(planId, name, startDate, endDate, finishDate, projectId, currentStage, expireDay, owner, designStage, executeStage, reportStage);
    }
    @Override
