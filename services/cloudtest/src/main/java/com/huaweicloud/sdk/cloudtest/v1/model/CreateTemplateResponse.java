...
public class CreateTemplateResponse extends SdkResponse {
    ...
    public CreateTemplateResponse withCode(String code) {
        this.code = code;
        return this;
    }
    ...
    public CreateTemplateResponse withData(Template data) {
        this.data = data;
        return this;
    }

    public CreateTemplateResponse withData(Consumer<Template> dataSetter) {
        if (this.data == null) {
    ...
    public CreateTemplateResponse withMessage(String message) {
