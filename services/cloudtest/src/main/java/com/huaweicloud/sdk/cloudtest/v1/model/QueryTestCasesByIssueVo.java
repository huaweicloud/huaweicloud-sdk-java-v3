...
public class QueryTestCasesByIssueVo {
    ...
    public QueryTestCasesByIssueVo withCaseStatusMap(Map<String, Integer> caseStatusMap) {
        this.caseStatusMap = caseStatusMap;
        return this;
    }

    public QueryTestCasesByIssueVo putCaseStatusMapItem(String key, Integer caseStatusMapItem) {
    ...
    public QueryTestCasesByIssueVo withCaseStatusMap(Consumer<Map<String, Integer>> caseStatusMapSetter) {
        if (this.caseStatusMap == null) {
            this.caseStatusMap = new HashMap<>();
        }
    ...
    public QueryTestCasesByIssueVo withNewCreate(Integer newCreate) {
    ...
    public QueryTestCasesByIssueVo withDesigning(Integer designing) {
    ...
    public QueryTestCasesByIssueVo withFinished(Integer finished) {
    ...
    public QueryTestCasesByIssueVo withTesting(Integer testing) {
    ...
    public QueryTestCasesByIssueVo withTestCaseNum(Integer testCaseNum) {
    ...
    public QueryTestCasesByIssueVo withTestcases(List<TestCaseVo> testcases) {
        this.testcases = testcases;
        return this;
    }

    public QueryTestCasesByIssueVo addTestcasesItem(TestCaseVo testcasesItem) {
    ...
    public QueryTestCasesByIssueVo withTestcases(Consumer<List<TestCaseVo>> testcasesSetter) {
        if (this.testcases == null) {
            this.testcases = new ArrayList<>();
        }
    ...
    public QueryTestCasesByIssueVo withTotalCount(Integer totalCount) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        QueryTestCasesByIssueVo that = (QueryTestCasesByIssueVo) obj;
