package com.huaweicloud.sdk.cloudtest.v1.region;
...
public class CloudtestRegion {
    ...
    public static final Region CN_NORTH_1 =
        new Region("cn-north-1", "https://cloudtest-ext.cn-north-1.myhuaweicloud.com");

    public static final Region CN_NORTH_4 =
        new Region("cn-north-4", "https://cloudtest-ext.cn-north-4.myhuaweicloud.com");
    ...
    public static final Region AP_SOUTHEAST_3 =
        new Region("ap-southeast-3", "https://cloudtest-ext.ap-southeast-3.myhuaweicloud.com");
    ...
    public static Region valueOf(String regionId) {
        ...
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "region id '%s' is not in the following supported regions of service Cloudtest: [%s]",
            regionId,
