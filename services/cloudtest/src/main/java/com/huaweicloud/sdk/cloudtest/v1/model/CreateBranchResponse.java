...
public class CreateBranchResponse extends SdkResponse {
    ...
    public CreateBranchResponse withResult(ResultValueTestVersionVo result) {
        this.result = result;
        return this;
    }

    public CreateBranchResponse withResult(Consumer<ResultValueTestVersionVo> resultSetter) {
        if (this.result == null) {
    ...
    public CreateBranchResponse withError(ApiError error) {
        this.error = error;
        return this;
    }

    public CreateBranchResponse withError(Consumer<ApiError> errorSetter) {
        if (this.error == null) {
    ...
    public CreateBranchResponse withRequestId(String requestId) {
    ...
    public CreateBranchResponse withServerAddress(String serverAddress) {
