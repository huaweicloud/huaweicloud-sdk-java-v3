...
public class CreateVersionTestCaseResponse extends SdkResponse {
    ...
    public CreateVersionTestCaseResponse withStatus(String status) {
        this.status = status;
        return this;
    }
    ...
    public CreateVersionTestCaseResponse withResult(ResultValueTestCaseVo result) {
        this.result = result;
        return this;
    }

    public CreateVersionTestCaseResponse withResult(Consumer<ResultValueTestCaseVo> resultSetter) {
        if (this.result == null) {
    ...
    public CreateVersionTestCaseResponse withError(ApiError error) {
        this.error = error;
        return this;
    }

    public CreateVersionTestCaseResponse withError(Consumer<ApiError> errorSetter) {
        if (this.error == null) {
    ...
    public CreateVersionTestCaseResponse withRequestId(String requestId) {
    ...
    public CreateVersionTestCaseResponse withServerAddress(String serverAddress) {
