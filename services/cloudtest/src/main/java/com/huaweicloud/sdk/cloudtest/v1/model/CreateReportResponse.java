 ...
 * Response Object
 */
public class CreateReportResponse extends SdkResponse {
    ...
    public CreateReportResponse withStatus(String status) {
        this.status = status;
        return this;
    }
    ...
    public CreateReportResponse withResult(ResultValueString result) {
        this.result = result;
        return this;
    }

    public CreateReportResponse withResult(Consumer<ResultValueString> resultSetter) {
        if (this.result == null) {
    ...
    public CreateReportResponse withError(ApiError error) {
        this.error = error;
        return this;
    }

    public CreateReportResponse withError(Consumer<ApiError> errorSetter) {
        if (this.error == null) {
    ...
    public CreateReportResponse withRequestId(String requestId) {
    ...
    public CreateReportResponse withServerAddress(String serverAddress) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        CreateReportResponse that = (CreateReportResponse) obj;
