...
public class UpdateTaskResponse extends SdkResponse {
    ...
    public UpdateTaskResponse withResult(ResultValueString result) {
        this.result = result;
        return this;
    }

    public UpdateTaskResponse withResult(Consumer<ResultValueString> resultSetter) {
        if (this.result == null) {
    ...
    public UpdateTaskResponse withError(ApiError error) {
        this.error = error;
        return this;
    }

    public UpdateTaskResponse withError(Consumer<ApiError> errorSetter) {
        if (this.error == null) {
    ...
    public UpdateTaskResponse withRequestId(String requestId) {
    ...
    public UpdateTaskResponse withServerAddress(String serverAddress) {
