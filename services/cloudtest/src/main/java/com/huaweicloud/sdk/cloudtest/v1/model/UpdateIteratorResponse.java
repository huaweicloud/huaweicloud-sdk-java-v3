 ...
 * Response Object
 */
public class UpdateIteratorResponse extends SdkResponse {
    ...
    public UpdateIteratorResponse withUri(String uri) {
        this.uri = uri;
        return this;
    }
    ...
    public UpdateIteratorResponse withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public UpdateIteratorResponse withAuthor(String author) {
        this.author = author;
        return this;
    }
    ...
    public UpdateIteratorResponse withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public UpdateIteratorResponse withRank(Integer rank) {
        this.rank = rank;
        return this;
    }
    ...
    public UpdateIteratorResponse withVersion(String version) {
    ...
    public UpdateIteratorResponse withOwner(String owner) {
        this.owner = owner;
        return this;
    }
    ...
    public UpdateIteratorResponse withCreator(String creator) {
    ...
    public UpdateIteratorResponse withIterations(String iterations) {
    ...
    public UpdateIteratorResponse withDescription(String description) {
    ...
    public UpdateIteratorResponse withRegion(String region) {
        this.region = region;
        return this;
    }
    ...
    public UpdateIteratorResponse withLastModifier(String lastModifier) {
    ...
    public UpdateIteratorResponse withLastModified(OffsetDateTime lastModified) {
    ...
    public UpdateIteratorResponse withLastModifiedTimestamp(Long lastModifiedTimestamp) {
    ...
    public UpdateIteratorResponse withLastChangeTime(OffsetDateTime lastChangeTime) {
    ...
    public UpdateIteratorResponse withVersionUri(String versionUri) {
    ...
    public UpdateIteratorResponse withOriginUri(String originUri) {
    ...
    public UpdateIteratorResponse withParentUri(String parentUri) {
    ...
    public UpdateIteratorResponse withParentPath(String parentPath) {
    ...
    public UpdateIteratorResponse withCreationVersionUri(String creationVersionUri) {
    ...
    public UpdateIteratorResponse withCreationDate(OffsetDateTime creationDate) {
    ...
    public UpdateIteratorResponse withCreationDateTimestamp(Long creationDateTimestamp) {
    ...
    public UpdateIteratorResponse withAuthorName(String authorName) {
    ...
    public UpdateIteratorResponse withComment(String comment) {
    ...
    public UpdateIteratorResponse withNumber(String number) {
        this.number = number;
        return this;
    }
    ...
    public UpdateIteratorResponse withIsMaster(Integer isMaster) {
    ...
    public UpdateIteratorResponse withIsIterator(Integer isIterator) {
    ...
    public UpdateIteratorResponse withPlanStartDate(OffsetDateTime planStartDate) {
    ...
    public UpdateIteratorResponse withPlanEndDate(OffsetDateTime planEndDate) {
    ...
    public UpdateIteratorResponse withServiceId(String serviceId) {
    ...
    public UpdateIteratorResponse withServiceName(String serviceName) {
    ...
    public UpdateIteratorResponse withPbiId(String pbiId) {
        this.pbiId = pbiId;
        return this;
    }
    ...
    public UpdateIteratorResponse withPbiName(String pbiName) {
    ...
    public UpdateIteratorResponse withPlanId(String planId) {
        this.planId = planId;
        return this;
    }
    ...
    public UpdateIteratorResponse withMetricPbiIds(String metricPbiIds) {
    ...
    public UpdateIteratorResponse withMetricPbiIdNames(String metricPbiIdNames) {
    ...
    public UpdateIteratorResponse withLastSynDate(OffsetDateTime lastSynDate) {
    ...
    public UpdateIteratorResponse withIsClosed(String isClosed) {
    ...
    public UpdateIteratorResponse withAsynGit(String asynGit) {
    ...
    public UpdateIteratorResponse withSchemaNo(Integer schemaNo) {
    ...
    public UpdateIteratorResponse withFinishDate(OffsetDateTime finishDate) {
    ...
    public UpdateIteratorResponse withOwnerName(String ownerName) {
    ...
    public UpdateIteratorResponse withCreatorName(String creatorName) {
    ...
    public UpdateIteratorResponse withCurrentStage(String currentStage) {
    ...
    public UpdateIteratorResponse withServiceTypes(String serviceTypes) {
    ...
    public UpdateIteratorResponse withRiskRating(Integer riskRating) {
    ...
    public UpdateIteratorResponse withRiskDes(String riskDes) {
    ...
    public UpdateIteratorResponse withProjectUuid(String projectUuid) {
    ...
    public UpdateIteratorResponse withDomainId(String domainId) {
    ...
    public UpdateIteratorResponse withPiId(String piId) {
        this.piId = piId;
        return this;
    }
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        UpdateIteratorResponse that = (UpdateIteratorResponse) obj;
    ...
    public String toString() {
        ...
        sb.append("class UpdateIteratorResponse {\n");
