...
public class CreateTaskResponse extends SdkResponse {
    ...
    public CreateTaskResponse withStatus(String status) {
        this.status = status;
        return this;
    }
    ...
    public CreateTaskResponse withResult(ResultValueString result) {
        this.result = result;
        return this;
    }

    public CreateTaskResponse withResult(Consumer<ResultValueString> resultSetter) {
        if (this.result == null) {
    ...
    public CreateTaskResponse withError(ApiError error) {
        this.error = error;
        return this;
    }

    public CreateTaskResponse withError(Consumer<ApiError> errorSetter) {
        if (this.error == null) {
    ...
    public CreateTaskResponse withRequestId(String requestId) {
    ...
    public CreateTaskResponse withServerAddress(String serverAddress) {
