 ...
 */
public class ImportFactorRequestBody implements SdkFormDataBody {

    @JsonProperty(value = "excel_file", access = JsonProperty.Access.WRITE_ONLY)

    private FormDataFilePart excelFile;

    public ImportFactorRequestBody withExcelFile(FormDataFilePart excelFile) {
    ...
    public ImportFactorRequestBody withExcelFile(InputStream inputStream, String fileName, String contentType) {
        this.excelFile = new FormDataFilePart(inputStream, fileName).withContentType(contentType);
        return this;
    }

    public ImportFactorRequestBody withExcelFile(InputStream inputStream, String fileName) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ImportFactorRequestBody that = (ImportFactorRequestBody) obj;
