...
public class UpdateVersionTestCaseRequest {
    ...
    public UpdateVersionTestCaseRequest withCaseId(String caseId) {
        this.caseId = caseId;
        return this;
    }
    ...
    public UpdateVersionTestCaseRequest withBody(TestCaseInfo body) {
        this.body = body;
        return this;
    }

    public UpdateVersionTestCaseRequest withBody(Consumer<TestCaseInfo> bodySetter) {
        if (this.body == null) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        UpdateVersionTestCaseRequest that = (UpdateVersionTestCaseRequest) obj;
