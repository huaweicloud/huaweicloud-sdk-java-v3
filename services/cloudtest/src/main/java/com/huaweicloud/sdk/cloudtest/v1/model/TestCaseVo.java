...
public class TestCaseVo {
    ...
    public TestCaseVo withStatusName(String statusName) {
    ...
    public TestCaseVo withAuthorId(String authorId) {
    ...
    public TestCaseVo withCreationDate(String creationDate) {
