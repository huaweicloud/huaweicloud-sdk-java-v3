...
public class ShowBranchResponse extends SdkResponse {
    ...
    public ShowBranchResponse withUri(String uri) {
        this.uri = uri;
        return this;
    }
    ...
    public ShowBranchResponse withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public ShowBranchResponse withAuthor(String author) {
        this.author = author;
        return this;
    }
    ...
    public ShowBranchResponse withRank(Integer rank) {
        this.rank = rank;
        return this;
    }
    ...
    public ShowBranchResponse withVersion(String version) {
    ...
    public ShowBranchResponse withOwner(String owner) {
        this.owner = owner;
        return this;
    }
    ...
    public ShowBranchResponse withCreator(String creator) {
    ...
    public ShowBranchResponse withIterations(String iterations) {
    ...
    public ShowBranchResponse withDescription(String description) {
    ...
    public ShowBranchResponse withRegion(String region) {
        this.region = region;
        return this;
    }
    ...
    public ShowBranchResponse withLastModifier(String lastModifier) {
    ...
    public ShowBranchResponse withLastModified(OffsetDateTime lastModified) {
    ...
    public ShowBranchResponse withLastModifiedTimestamp(Long lastModifiedTimestamp) {
    ...
    public ShowBranchResponse withLastChangeTime(OffsetDateTime lastChangeTime) {
    ...
    public ShowBranchResponse withVersionUri(String versionUri) {
    ...
    public ShowBranchResponse withOriginUri(String originUri) {
    ...
    public ShowBranchResponse withParentUri(String parentUri) {
    ...
    public ShowBranchResponse withParentPath(String parentPath) {
    ...
    public ShowBranchResponse withCreationVersionUri(String creationVersionUri) {
    ...
    public ShowBranchResponse withCreationDate(OffsetDateTime creationDate) {
    ...
    public ShowBranchResponse withCreationDateTimestamp(Long creationDateTimestamp) {
    ...
    public ShowBranchResponse withAuthorName(String authorName) {
    ...
    public ShowBranchResponse withComment(String comment) {
    ...
    public ShowBranchResponse withNumber(String number) {
        this.number = number;
        return this;
    }
    ...
    public ShowBranchResponse withIsMaster(Integer isMaster) {
    ...
    public ShowBranchResponse withIsIterator(Integer isIterator) {
    ...
    public ShowBranchResponse withPlanStartDate(OffsetDateTime planStartDate) {
    ...
    public ShowBranchResponse withPlanEndDate(OffsetDateTime planEndDate) {
    ...
    public ShowBranchResponse withServiceId(String serviceId) {
    ...
    public ShowBranchResponse withServiceName(String serviceName) {
    ...
    public ShowBranchResponse withPbiId(String pbiId) {
        this.pbiId = pbiId;
        return this;
    }
    ...
    public ShowBranchResponse withPbiName(String pbiName) {
    ...
    public ShowBranchResponse withPlanId(String planId) {
        this.planId = planId;
        return this;
    }
    ...
    public ShowBranchResponse withMetricPbiIds(String metricPbiIds) {
    ...
    public ShowBranchResponse withMetricPbiIdNames(String metricPbiIdNames) {
    ...
    public ShowBranchResponse withLastSynDate(OffsetDateTime lastSynDate) {
    ...
    public ShowBranchResponse withIsClosed(String isClosed) {
    ...
    public ShowBranchResponse withAsynGit(String asynGit) {
    ...
    public ShowBranchResponse withSchemaNo(Integer schemaNo) {
    ...
    public ShowBranchResponse withFinishDate(OffsetDateTime finishDate) {
    ...
    public ShowBranchResponse withOwnerName(String ownerName) {
    ...
    public ShowBranchResponse withCreatorName(String creatorName) {
    ...
    public ShowBranchResponse withCurrentStage(String currentStage) {
    ...
    public ShowBranchResponse withServiceTypes(String serviceTypes) {
    ...
    public ShowBranchResponse withRiskRating(Integer riskRating) {
    ...
    public ShowBranchResponse withRiskDes(String riskDes) {
    ...
    public ShowBranchResponse withProjectUuid(String projectUuid) {
    ...
    public ShowBranchResponse withDomainId(String domainId) {
    ...
    public ShowBranchResponse withPiId(String piId) {
        this.piId = piId;
        return this;
    }
