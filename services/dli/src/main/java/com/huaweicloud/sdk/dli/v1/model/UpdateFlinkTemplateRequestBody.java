 ...
 * 
 */
public class UpdateFlinkTemplateRequestBody {
    ...
    public UpdateFlinkTemplateRequestBody withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public UpdateFlinkTemplateRequestBody withDesc(String desc) {
        this.desc = desc;
        return this;
    }
    ...
    public UpdateFlinkTemplateRequestBody withSqlBody(String sqlBody) {
    ...
    public String toString() {
        ...
        sb.append("class UpdateFlinkTemplateRequestBody {\n");
