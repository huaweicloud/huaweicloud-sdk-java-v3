...
public class DliAsyncClient {
     ...
     */
    public CompletableFuture<CreateDownloadJobResponse> createDownloadJobAsync(CreateDownloadJobRequest request) {
        return hcClient.asyncInvokeHttp(request, DliMeta.createDownloadJob);
    }
     ...
     */
    public AsyncInvoker<CreateDownloadJobRequest, CreateDownloadJobResponse> createDownloadJobAsyncInvoker(
        CreateDownloadJobRequest request) {
        return new AsyncInvoker<CreateDownloadJobRequest, CreateDownloadJobResponse>(request, DliMeta.createDownloadJob,
            hcClient);
    }
     ...
     */
    public CompletableFuture<ExportJobResultResponse> exportJobResultAsync(ExportJobResultRequest request) {
        return hcClient.asyncInvokeHttp(request, DliMeta.exportJobResult);
    }
     ...
     */
    public AsyncInvoker<ExportJobResultRequest, ExportJobResultResponse> exportJobResultAsyncInvoker(
        ExportJobResultRequest request) {
        return new AsyncInvoker<ExportJobResultRequest, ExportJobResultResponse>(request, DliMeta.exportJobResult,
            hcClient);
    }
