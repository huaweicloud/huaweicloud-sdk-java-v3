 ...
 */
public class CreateSessionReqResource {
    ...
    public CreateSessionReqResource withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public CreateSessionReqResource withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append("class CreateSessionReqResource {\n");
