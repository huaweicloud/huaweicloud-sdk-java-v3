 ...
 * 创建全局变量
 */
public class CreateGlobalVariableRequestBody {
    ...
    public CreateGlobalVariableRequestBody withVarName(String varName) {
    ...
    public CreateGlobalVariableRequestBody withVarValue(String varValue) {
    ...
    public CreateGlobalVariableRequestBody withIsSensitive(Boolean isSensitive) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        CreateGlobalVariableRequestBody that = (CreateGlobalVariableRequestBody) obj;
    ...
    public String toString() {
        ...
        sb.append("class CreateGlobalVariableRequestBody {\n");
