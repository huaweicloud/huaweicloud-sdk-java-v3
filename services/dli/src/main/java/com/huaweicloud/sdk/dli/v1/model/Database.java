...
public class Database {
    ...
    public Database withTableNumber(Integer tableNumber) {
    ...
    public Database withEnterpriseProjectId(String enterpriseProjectId) {
    ...
    public Database withResourceId(String resourceId) {
