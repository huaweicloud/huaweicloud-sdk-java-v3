...
public class UpdateFlinkSqlRequest {
    ...
    public UpdateFlinkSqlRequest withBody(UpdateFlinkSqlRequestBody body) {
        this.body = body;
        return this;
    }

    public UpdateFlinkSqlRequest withBody(Consumer<UpdateFlinkSqlRequestBody> bodySetter) {
        if (this.body == null) {
