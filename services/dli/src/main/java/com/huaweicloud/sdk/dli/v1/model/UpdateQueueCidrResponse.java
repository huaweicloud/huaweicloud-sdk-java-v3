 ...
 * Response Object
 */
public class UpdateQueueCidrResponse extends SdkResponse {
    ...
    public UpdateQueueCidrResponse withIsSuccess(Boolean isSuccess) {
    ...
    public UpdateQueueCidrResponse withMessage(String message) {
    ...
    public String toString() {
        ...
        sb.append("class UpdateQueueCidrResponse {\n");
