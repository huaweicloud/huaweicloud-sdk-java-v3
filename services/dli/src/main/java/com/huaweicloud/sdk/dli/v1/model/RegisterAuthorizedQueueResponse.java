 ...
 * Response Object
 */
public class RegisterAuthorizedQueueResponse extends SdkResponse {
    ...
    public RegisterAuthorizedQueueResponse withIsSuccess(Boolean isSuccess) {
    ...
    public RegisterAuthorizedQueueResponse withMessage(String message) {
    ...
    public String toString() {
        ...
        sb.append("class RegisterAuthorizedQueueResponse {\n");
