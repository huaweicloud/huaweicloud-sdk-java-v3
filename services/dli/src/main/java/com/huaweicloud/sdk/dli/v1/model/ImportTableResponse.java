 ...
 * Response Object
 */
public class ImportTableResponse extends SdkResponse {
    ...
    public ImportTableResponse withIsSuccess(Boolean isSuccess) {
    ...
    public ImportTableResponse withMessage(String message) {
    ...
    public ImportTableResponse withJobId(String jobId) {
        this.jobId = jobId;
        return this;
    }
    ...
    public ImportTableResponse withJobMode(String jobMode) {
    ...
    public String toString() {
        ...
        sb.append("class ImportTableResponse {\n");
