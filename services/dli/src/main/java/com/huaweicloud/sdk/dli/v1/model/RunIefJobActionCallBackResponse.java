 ...
 * Response Object
 */
public class RunIefJobActionCallBackResponse extends SdkResponse {
    ...
    public RunIefJobActionCallBackResponse withIsSuccess(Boolean isSuccess) {
    ...
    public RunIefJobActionCallBackResponse withMessage(String message) {
    ...
    public String toString() {
        ...
        sb.append("class RunIefJobActionCallBackResponse {\n");
