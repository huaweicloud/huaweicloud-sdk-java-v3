...
public class CountResourcesByTagsRequest {
    ...
    private CountResourcesByTagsRequestBody body;
    ...
    public CountResourcesByTagsRequest withBody(CountResourcesByTagsRequestBody body) {
        this.body = body;
        return this;
    }

    public CountResourcesByTagsRequest withBody(Consumer<CountResourcesByTagsRequestBody> bodySetter) {
        if (this.body == null) {
            this.body = new CountResourcesByTagsRequestBody();
     ...
     * @return body
     */
    public CountResourcesByTagsRequestBody getBody() {
        return body;
    }

    public void setBody(CountResourcesByTagsRequestBody body) {
        this.body = body;
    }
