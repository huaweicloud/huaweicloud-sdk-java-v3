...
public class ShowPartitionsRequest {
    ...
    public ShowPartitionsRequest withDatabaseName(String databaseName) {
    ...
    public ShowPartitionsRequest withTableName(String tableName) {
    ...
    public ShowPartitionsRequest withLimit(Integer limit) {
        this.limit = limit;
        return this;
    }
    ...
    public ShowPartitionsRequest withOffset(Integer offset) {
        this.offset = offset;
        return this;
    }
    ...
    @Override
    public int hashCode() {
        return Objects.hash(databaseName, tableName, limit, offset);
    }

    @Override
    public String toString() {
        StringBuilder sb = new StringBuilder();
        sb.append("class ShowPartitionsRequest {\n");
