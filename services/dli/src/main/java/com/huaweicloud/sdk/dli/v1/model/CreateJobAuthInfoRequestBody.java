 ...
 */
public class CreateJobAuthInfoRequestBody {
    ...
    public CreateJobAuthInfoRequestBody withAuthInfoName(String authInfoName) {
    ...
    public CreateJobAuthInfoRequestBody withUserName(String userName) {
    ...
    public CreateJobAuthInfoRequestBody withPassword(String password) {
    ...
    public CreateJobAuthInfoRequestBody withKrb5Conf(String krb5Conf) {
    ...
    public CreateJobAuthInfoRequestBody withKeytab(String keytab) {
        this.keytab = keytab;
        return this;
    }
    ...
    public CreateJobAuthInfoRequestBody withTruststoreLocation(String truststoreLocation) {
    ...
    public CreateJobAuthInfoRequestBody withTruststorePassword(String truststorePassword) {
    ...
    public CreateJobAuthInfoRequestBody withKeystoreLocation(String keystoreLocation) {
    ...
    public CreateJobAuthInfoRequestBody withKeystorePassword(String keystorePassword) {
    ...
    public CreateJobAuthInfoRequestBody withCertificateLocation(String certificateLocation) {
    ...
    public CreateJobAuthInfoRequestBody withDatasourceType(String datasourceType) {
    ...
    public CreateJobAuthInfoRequestBody withKeyPassword(String keyPassword) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        CreateJobAuthInfoRequestBody that = (CreateJobAuthInfoRequestBody) obj;
    ...
    public String toString() {
        ...
        sb.append("class CreateJobAuthInfoRequestBody {\n");
