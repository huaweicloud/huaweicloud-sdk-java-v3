...
public class QueuePlan {
    ...
    public QueuePlan withId(Long id) {
        this.id = id;
        return this;
    }
    ...
    public QueuePlan withPlanName(String planName) {
    ...
    public QueuePlan withTargetCu(Integer targetCu) {
    ...
    public QueuePlan withStartHour(Integer startHour) {
    ...
    public QueuePlan withStartMinute(Integer startMinute) {
    ...
    public QueuePlan withRepeatDay(List<RepeatDayEnum> repeatDay) {
        this.repeatDay = repeatDay;
        return this;
    }

    public QueuePlan addRepeatDayItem(RepeatDayEnum repeatDayItem) {
    ...
    public QueuePlan withRepeatDay(Consumer<List<RepeatDayEnum>> repeatDaySetter) {
        if (this.repeatDay == null) {
            this.repeatDay = new ArrayList<>();
        }
    ...
    public QueuePlan withValidDateBegin(Long validDateBegin) {
    ...
    public QueuePlan withValidDateEnd(Long validDateEnd) {
    ...
    public QueuePlan withActivate(Boolean activate) {
    ...
    public QueuePlan withLastExecuteTime(Long lastExecuteTime) {
