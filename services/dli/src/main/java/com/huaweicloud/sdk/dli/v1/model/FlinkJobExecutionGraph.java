 ...
 * 查询作业执行计划。
 */
public class FlinkJobExecutionGraph {
    ...
    public FlinkJobExecutionGraph withJid(String jid) {
        this.jid = jid;
        return this;
    }
    ...
    public FlinkJobExecutionGraph withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public FlinkJobExecutionGraph withIsStoppable(Boolean isStoppable) {
    ...
    public FlinkJobExecutionGraph withState(String state) {
        this.state = state;
        return this;
    }
    ...
    public FlinkJobExecutionGraph withStartTime(Long startTime) {
    ...
    public FlinkJobExecutionGraph withEndTime(Long endTime) {
    ...
    public FlinkJobExecutionGraph withDuration(Long duration) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        FlinkJobExecutionGraph that = (FlinkJobExecutionGraph) obj;
    ...
    public String toString() {
        ...
        sb.append("class FlinkJobExecutionGraph {\n");
