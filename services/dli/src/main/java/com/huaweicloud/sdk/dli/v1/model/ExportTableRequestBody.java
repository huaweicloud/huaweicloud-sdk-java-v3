 ...
 * 导出数据
 */
public class ExportTableRequestBody {
    ...
    public ExportTableRequestBody withDataPath(String dataPath) {
    ...
    public ExportTableRequestBody withDataType(String dataType) {
    ...
    public ExportTableRequestBody withDatabaseName(String databaseName) {
    ...
    public ExportTableRequestBody withTableName(String tableName) {
    ...
    public ExportTableRequestBody withCompress(String compress) {
    ...
    public ExportTableRequestBody withQueueName(String queueName) {
    ...
    public ExportTableRequestBody withExportMode(String exportMode) {
    ...
    public ExportTableRequestBody withWithColumnHeader(Boolean withColumnHeader) {
    ...
    public String toString() {
        ...
        sb.append("class ExportTableRequestBody {\n");
