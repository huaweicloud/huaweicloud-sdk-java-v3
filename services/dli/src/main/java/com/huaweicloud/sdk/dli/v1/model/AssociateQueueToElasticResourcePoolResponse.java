 ...
 * Response Object
 */
public class AssociateQueueToElasticResourcePoolResponse extends SdkResponse {
    ...
    public AssociateQueueToElasticResourcePoolResponse withIsSuccess(Boolean isSuccess) {
    ...
    public AssociateQueueToElasticResourcePoolResponse withMessage(String message) {
    ...
    public String toString() {
        ...
        sb.append("class AssociateQueueToElasticResourcePoolResponse {\n");
