 ...
 * 已上传的用户资源名列表。
 */
public class ListGroupPackagesResource {
    ...
    @JacksonXmlProperty(localName = "underlying_name")
    ...
    public ListGroupPackagesResource withCreateTime(Long createTime) {
    ...
    public ListGroupPackagesResource withUpdateTime(Long updateTime) {
    ...
    public ListGroupPackagesResource withResourceType(String resourceType) {
    ...
    public ListGroupPackagesResource withResourceName(String resourceName) {
    ...
    public ListGroupPackagesResource withStatus(String status) {
        this.status = status;
        return this;
    }
    ...
    public ListGroupPackagesResource withUnderlyingName(String underlyingName) {
    ...
    public ListGroupPackagesResource withOwner(String owner) {
        this.owner = owner;
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append("class ListGroupPackagesResource {\n");
