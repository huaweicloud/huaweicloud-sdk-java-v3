 ...
 * Response Object
 */
public class CreateDliAgencyResponse extends SdkResponse {
    ...
    public CreateDliAgencyResponse withIsSuccess(Boolean isSuccess) {
    ...
    public CreateDliAgencyResponse withMessage(String message) {
    ...
    public String toString() {
        ...
        sb.append("class CreateDliAgencyResponse {\n");
