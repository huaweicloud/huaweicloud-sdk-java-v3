 ...
 * Response Object
 */
public class UpdateElasticResourcePoolQueueInfoResponse extends SdkResponse {
    ...
    public UpdateElasticResourcePoolQueueInfoResponse withIsSuccess(Boolean isSuccess) {
    ...
    public UpdateElasticResourcePoolQueueInfoResponse withMessage(String message) {
    ...
    public String toString() {
        ...
        sb.append("class UpdateElasticResourcePoolQueueInfoResponse {\n");
