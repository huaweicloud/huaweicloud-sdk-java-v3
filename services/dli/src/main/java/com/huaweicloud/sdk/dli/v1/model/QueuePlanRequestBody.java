...
public class QueuePlanRequestBody {
    ...
    public QueuePlanRequestBody withPlanName(String planName) {
    ...
    public QueuePlanRequestBody withTargetCu(Integer targetCu) {
    ...
    public QueuePlanRequestBody withStartHour(Integer startHour) {
    ...
    public QueuePlanRequestBody withStartMinute(Integer startMinute) {
    ...
    public QueuePlanRequestBody withRepeatDay(List<RepeatDayEnum> repeatDay) {
        this.repeatDay = repeatDay;
        return this;
    }

    public QueuePlanRequestBody addRepeatDayItem(RepeatDayEnum repeatDayItem) {
    ...
    public QueuePlanRequestBody withRepeatDay(Consumer<List<RepeatDayEnum>> repeatDaySetter) {
        if (this.repeatDay == null) {
            this.repeatDay = new ArrayList<>();
        }
    ...
    public QueuePlanRequestBody withValidDateBegin(Long validDateBegin) {
    ...
    public QueuePlanRequestBody withValidDateEnd(Long validDateEnd) {
    ...
    public QueuePlanRequestBody withActivate(Boolean activate) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        QueuePlanRequestBody that = (QueuePlanRequestBody) obj;
