 ...
 */
public class UpdateJobResourceOwnerRequestBody {
    ...
    public UpdateJobResourceOwnerRequestBody withNewOwner(String newOwner) {
    ...
    public UpdateJobResourceOwnerRequestBody withGroupName(String groupName) {
    ...
    public UpdateJobResourceOwnerRequestBody withResourceName(String resourceName) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        UpdateJobResourceOwnerRequestBody that = (UpdateJobResourceOwnerRequestBody) obj;
    ...
    public String toString() {
        ...
        sb.append("class UpdateJobResourceOwnerRequestBody {\n");
