 ...
 * Response Object
 */
public class DisassociateConnectionQueueResponse extends SdkResponse {
    ...
    public DisassociateConnectionQueueResponse withIsSuccess(Boolean isSuccess) {
    ...
    public DisassociateConnectionQueueResponse withMessage(String message) {
    ...
    public String toString() {
        ...
        sb.append("class DisassociateConnectionQueueResponse {\n");
