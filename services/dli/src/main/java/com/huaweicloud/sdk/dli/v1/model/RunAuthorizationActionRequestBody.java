 ...
 */
public class RunAuthorizationActionRequestBody {
    ...
    public RunAuthorizationActionRequestBody withUserName(String userName) {
    ...
    public RunAuthorizationActionRequestBody withPrivileges(List<Privilege> privileges) {
        this.privileges = privileges;
        return this;
    }

    public RunAuthorizationActionRequestBody addPrivilegesItem(Privilege privilegesItem) {
    ...
    public RunAuthorizationActionRequestBody withPrivileges(Consumer<List<Privilege>> privilegesSetter) {
        if (this.privileges == null) {
            this.privileges = new ArrayList<>();
        }
