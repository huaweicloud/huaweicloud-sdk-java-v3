...
public class CreateFlinkSqlJobResponse extends SdkResponse {
    ...
    public CreateFlinkSqlJobResponse withIsSuccess(String isSuccess) {
    ...
    public CreateFlinkSqlJobResponse withJob(FlinkJobStatus job) {
        this.job = job;
        return this;
    }

    public CreateFlinkSqlJobResponse withJob(Consumer<FlinkJobStatus> jobSetter) {
        if (this.job == null) {
