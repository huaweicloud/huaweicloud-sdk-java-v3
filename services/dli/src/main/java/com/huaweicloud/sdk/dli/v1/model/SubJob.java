...
public class SubJob {
    ...
    public SubJob withId(Integer id) {
        this.id = id;
        return this;
    }
    ...
    public SubJob withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public SubJob withDescription(String description) {
    ...
    public SubJob withSubmissionTime(String submissionTime) {
    ...
    public SubJob withCompletionTime(String completionTime) {
    ...
    public SubJob withStageIds(List<Integer> stageIds) {
        this.stageIds = stageIds;
        return this;
    }

    public SubJob addStageIdsItem(Integer stageIdsItem) {
    ...
    public SubJob withStageIds(Consumer<List<Integer>> stageIdsSetter) {
        if (this.stageIds == null) {
            this.stageIds = new ArrayList<>();
        }
    ...
    public SubJob withJobGroup(String jobGroup) {
    ...
    public SubJob withStatus(String status) {
        this.status = status;
        return this;
    }
    ...
    public SubJob withNumTasks(Integer numTasks) {
    ...
    public SubJob withNumActiveTasks(Integer numActiveTasks) {
    ...
    public SubJob withNumCompletedTasks(Integer numCompletedTasks) {
    ...
    public SubJob withNumSkippedTasks(Integer numSkippedTasks) {
    ...
    public SubJob withNumFailedTasks(Integer numFailedTasks) {
    ...
    public SubJob withNumKilledTasks(Integer numKilledTasks) {
    ...
    public SubJob withNumCompletedIndices(Integer numCompletedIndices) {
    ...
    public SubJob withNumActiveStages(Integer numActiveStages) {
    ...
    public SubJob withNumCompletedStages(Integer numCompletedStages) {
    ...
    public SubJob withNumSkippedStages(Integer numSkippedStages) {
    ...
    public SubJob withNumFailedStages(Integer numFailedStages) {
    ...
    public SubJob withKilledTasksSummary(Map<String, Integer> killedTasksSummary) {
        this.killedTasksSummary = killedTasksSummary;
        return this;
    }

    public SubJob putKilledTasksSummaryItem(String key, Integer killedTasksSummaryItem) {
    ...
    public SubJob withKilledTasksSummary(Consumer<Map<String, Integer>> killedTasksSummarySetter) {
        if (this.killedTasksSummary == null) {
            this.killedTasksSummary = new HashMap<>();
        }
