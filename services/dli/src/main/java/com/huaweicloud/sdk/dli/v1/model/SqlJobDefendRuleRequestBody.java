 ...
 * 用户创建的sql拦截规则
 */
public class SqlJobDefendRuleRequestBody {
    ...
    public SqlJobDefendRuleRequestBody withRuleName(String ruleName) {
    ...
    public SqlJobDefendRuleRequestBody withRuleId(RuleIdEnum ruleId) {
        this.ruleId = ruleId;
        return this;
    }
    ...
    public SqlJobDefendRuleRequestBody withCategory(CategoryEnum category) {
    ...
    public SqlJobDefendRuleRequestBody withEngineRules(Object engineRules) {
    ...
    public SqlJobDefendRuleRequestBody withQueueNames(List<String> queueNames) {
        this.queueNames = queueNames;
        return this;
    }

    public SqlJobDefendRuleRequestBody addQueueNamesItem(String queueNamesItem) {
    ...
    public SqlJobDefendRuleRequestBody withQueueNames(Consumer<List<String>> queueNamesSetter) {
        if (this.queueNames == null) {
            this.queueNames = new ArrayList<>();
        }
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        SqlJobDefendRuleRequestBody that = (SqlJobDefendRuleRequestBody) obj;
        return Objects.equals(this.ruleName, that.ruleName) && Objects.equals(this.ruleId, that.ruleId)
            && Objects.equals(this.category, that.category) && Objects.equals(this.engineRules, that.engineRules)
            && Objects.equals(this.queueNames, that.queueNames);
    }

    @Override
    public int hashCode() {
        return Objects.hash(ruleName, ruleId, category, engineRules, queueNames);
    }

    @Override
    public String toString() {
        StringBuilder sb = new StringBuilder();
        sb.append("class SqlJobDefendRuleRequestBody {\n");
