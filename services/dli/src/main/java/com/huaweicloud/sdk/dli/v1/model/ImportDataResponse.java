...
public class ImportDataResponse extends SdkResponse {
    ...
    public ImportDataResponse withIsSuccess(Boolean isSuccess) {
    ...
    public ImportDataResponse withMessage(String message) {
    ...
    public ImportDataResponse withJobMode(String jobMode) {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        return Objects.equals(this.isSuccess, importDataResponse.isSuccess)
            && Objects.equals(this.message, importDataResponse.message)
            && Objects.equals(this.jobId, importDataResponse.jobId)
            && Objects.equals(this.jobMode, importDataResponse.jobMode);
    }
