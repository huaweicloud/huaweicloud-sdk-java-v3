...
public class SparkJobTemplate {
    ...
    public SparkJobTemplate withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public SparkJobTemplate withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public SparkJobTemplate withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public SparkJobTemplate withBody(SparkJobTemplateDetail body) {
        this.body = body;
        return this;
    }

    public SparkJobTemplate withBody(Consumer<SparkJobTemplateDetail> bodySetter) {
        if (this.body == null) {
    ...
    public SparkJobTemplate withGroup(String group) {
        this.group = group;
        return this;
    }
    ...
    public SparkJobTemplate withDescription(String description) {
    ...
    public SparkJobTemplate withLanguage(String language) {
    ...
    public SparkJobTemplate withOwner(String owner) {
        this.owner = owner;
        return this;
    }
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        SparkJobTemplate that = (SparkJobTemplate) obj;
    ...
    public String toString() {
        ...
        sb.append("class SparkJobTemplate {\n");
