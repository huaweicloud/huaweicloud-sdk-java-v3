...
public class JobMapInfo {
    ...
    public JobMapInfo withOldJobId(Long oldJobId) {
    ...
    public JobMapInfo withNewJobId(Long newJobId) {
    ...
    public JobMapInfo withRemark(String remark) {
        this.remark = remark;
        return this;
    }
