...
public class SubJobs  {
    ...
    private List<Entitie> entities = null;
    ...
    public SubJobs withEntities(List<Entitie> entities) {
        this.entities = entities;
        return this;
    }

    
    public SubJobs addEntitiesItem(Entitie entitiesItem) {
    ...
    public SubJobs withEntities(Consumer<List<Entitie>> entitiesSetter) {
        if(this.entities == null ){
            this.entities = new ArrayList<>();
        }
