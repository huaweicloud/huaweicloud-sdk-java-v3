...
public class BmsAsyncClient {
     ...
     * @return CompletableFuture<WindowsBaremetalServerCleanPwdResponse>
     */
    public CompletableFuture<WindowsBaremetalServerCleanPwdResponse> windowsBaremetalServerCleanPwdAsync(WindowsBaremetalServerCleanPwdRequest request) {
        return hcClient.asyncInvokeHttp(request, BmsMeta.windowsBaremetalServerCleanPwd);
    }
     ...
     *
     * @param WindowsBaremetalServerCleanPwdRequest 请求对象
     * @return AsyncInvoker<WindowsBaremetalServerCleanPwdRequest, WindowsBaremetalServerCleanPwdResponse>
     */
    public AsyncInvoker<WindowsBaremetalServerCleanPwdRequest, WindowsBaremetalServerCleanPwdResponse> windowsBaremetalServerCleanPwdAsyncInvoker(WindowsBaremetalServerCleanPwdRequest request) {
        return new AsyncInvoker<WindowsBaremetalServerCleanPwdRequest, WindowsBaremetalServerCleanPwdResponse>(request, BmsMeta.windowsBaremetalServerCleanPwd, hcClient);
    }
