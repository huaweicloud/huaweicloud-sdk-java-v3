...
public class BmsAsyncClient {
    ...
    /** 裸金属服务器挂载云硬盘 裸金属服务器创建成功后，如果发现磁盘不够用或者当前磁盘不满足要求，可以将已有云硬盘挂载给裸金属服务器，作为数据盘使用
     *
    ...
    /** 重启裸金属服务器 根据给定的裸金属服务器ID列表，批量重启裸金属服务器
     *
    ...
    /** 启动裸金属服务器 根据给定的裸金属服务器ID列表，批量启动裸金属服务器
     *
    ...
    /** 关闭裸金属服务器 根据给定的裸金属服务器ID列表，批量关闭裸金属服务器
     *
    ...
    /** 创建裸金属服务器 创建一台或多台裸金属服务器,裸金属服务器的登录鉴权方式包括两种：密钥对、密码。为安全起见，推荐使用密钥对方式
     *
     ...
     *
     * @param DeleteWindowsBareMetalServerPasswordRequest 请求对象
     * @return AsyncInvoker<DeleteWindowsBareMetalServerPasswordRequest,
    ...
    /** 查询裸金属服务器详情 获取裸金属服务器详细信息，该接口支持查询裸金属服务器的计费方式，以及是否被冻结
     *
    ...
    /** 查询裸金属服务器详情列表 用户根据设置的请求条件筛选裸金属服务器，并获取裸金属服务器的详细信息。该接口支持查询裸金属服务器计费方式，以及是否被冻结。
     *
    ...
    /** 查询规格详情和规格扩展信息列表 查询裸金属服务器的规格详情和规格的扩展信息。您可以调用此接口查询“baremetal:extBootType”参数取值，以确认某个规格是否支持快速发放
     *
    ...
    /** 重装裸金属服务器操作系统 重装裸金属服务器的操作系统。快速发放裸金属服务器支持裸金属服务器数据盘不变的情况下，使用原镜像重装系统盘。重装操作系统支持密码或者密钥注入
     *
    ...
    /** 查询裸金属服务器网卡信息 查询裸金属服务器的网卡信息，比如网卡的IP地址、MAC地址
     *
     ...
     *
     * @param ShowBaremetalServerInterfaceAttachmentsRequest 请求对象
     * @return AsyncInvoker<ShowBaremetalServerInterfaceAttachmentsRequest,
    ...
    /** 查询裸金属服务器挂载的云硬盘信息 查询裸金属服务器挂载的磁盘信息
     *
    ...
    /** 查询租户配额 查询该租户下，所有资源的配额信息，包括已使用配额
     *
    ...
    /** 更新裸金属服务器元数据 更新裸金属服务器元数据。如果元数据中没有待更新字段，则自动添加该字段。如果元数据中已存在待更新字段，则直接更新字段值；如果元数据中的字段不再请求参数中，则保持不变
     *
    ...
    /** 查询Job状态 查询Job的执行状态。对于创建裸金属服务器物理机、挂卸卷等异步API，命令下发后，会返回job_id，通过job_id可以查询任务的执行状态
     *
