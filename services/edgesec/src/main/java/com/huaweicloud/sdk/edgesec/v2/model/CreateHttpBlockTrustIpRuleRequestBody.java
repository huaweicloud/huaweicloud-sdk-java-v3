 ...
 */
public class CreateHttpBlockTrustIpRuleRequestBody {
    ...
    public CreateHttpBlockTrustIpRuleRequestBody withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public CreateHttpBlockTrustIpRuleRequestBody withDescription(String description) {
    ...
    public CreateHttpBlockTrustIpRuleRequestBody withAddr(String addr) {
        this.addr = addr;
        return this;
    }
    ...
    public CreateHttpBlockTrustIpRuleRequestBody withWhite(Integer white) {
        this.white = white;
        return this;
    }
    ...
    public CreateHttpBlockTrustIpRuleRequestBody withFollowedActionId(String followedActionId) {
    ...
    public CreateHttpBlockTrustIpRuleRequestBody withIpGroupId(String ipGroupId) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        CreateHttpBlockTrustIpRuleRequestBody that = (CreateHttpBlockTrustIpRuleRequestBody) obj;
    ...
    public String toString() {
        ...
        sb.append("class CreateHttpBlockTrustIpRuleRequestBody {\n");
