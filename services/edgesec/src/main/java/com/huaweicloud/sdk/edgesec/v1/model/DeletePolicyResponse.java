...
public class DeletePolicyResponse extends SdkResponse {
    ...
    public DeletePolicyResponse withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public DeletePolicyResponse withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public DeletePolicyResponse withLevel(Integer level) {
        this.level = level;
        return this;
    }
    ...
    public DeletePolicyResponse withFullDetection(Boolean fullDetection) {
    ...
    public DeletePolicyResponse withRobotAction(Action robotAction) {
        this.robotAction = robotAction;
        return this;
    }

    public DeletePolicyResponse withRobotAction(Consumer<Action> robotActionSetter) {
    ...
    public DeletePolicyResponse withAction(WafPolicyAction action) {
        this.action = action;
        return this;
    }

    public DeletePolicyResponse withAction(Consumer<WafPolicyAction> actionSetter) {
        if (this.action == null) {
    ...
    public DeletePolicyResponse withOptions(PolicyOption options) {
        this.options = options;
        return this;
    }

    public DeletePolicyResponse withOptions(Consumer<PolicyOption> optionsSetter) {
    ...
    public DeletePolicyResponse withModulexOptions(Map<String, Object> modulexOptions) {
        this.modulexOptions = modulexOptions;
        return this;
    }

    public DeletePolicyResponse putModulexOptionsItem(String key, Object modulexOptionsItem) {
    ...
    public DeletePolicyResponse withModulexOptions(Consumer<Map<String, Object>> modulexOptionsSetter) {
        if (this.modulexOptions == null) {
            this.modulexOptions = new HashMap<>();
        }
    ...
    public DeletePolicyResponse withHosts(List<String> hosts) {
        this.hosts = hosts;
        return this;
    }

    public DeletePolicyResponse addHostsItem(String hostsItem) {
        if (this.hosts == null) {
    ...
    public DeletePolicyResponse withHosts(Consumer<List<String>> hostsSetter) {
        if (this.hosts == null) {
            this.hosts = new ArrayList<>();
        }
    ...
    public DeletePolicyResponse withBindHost(List<BindHost> bindHost) {
        this.bindHost = bindHost;
        return this;
    }

    public DeletePolicyResponse addBindHostItem(BindHost bindHostItem) {
    ...
    public DeletePolicyResponse withBindHost(Consumer<List<BindHost>> bindHostSetter) {
        if (this.bindHost == null) {
            this.bindHost = new ArrayList<>();
        }
    ...
    public DeletePolicyResponse withExtend(Map<String, String> extend) {
        this.extend = extend;
        return this;
    }

    public DeletePolicyResponse putExtendItem(String key, String extendItem) {
        if (this.extend == null) {
    ...
    public DeletePolicyResponse withExtend(Consumer<Map<String, String>> extendSetter) {
        if (this.extend == null) {
            this.extend = new HashMap<>();
        }
    ...
    public DeletePolicyResponse withTimestamp(Long timestamp) {
