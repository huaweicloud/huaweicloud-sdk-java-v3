...
public class DomainInfo {
    ...
    public DomainInfo withProtectStatus(String protectStatus) {
    ...
    public DomainInfo withCreateTime(Long createTime) {
    ...
    public DomainInfo withUpdateTime(Long updateTime) {
