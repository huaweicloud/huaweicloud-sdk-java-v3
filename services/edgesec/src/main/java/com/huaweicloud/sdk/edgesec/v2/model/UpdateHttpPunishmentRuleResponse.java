 ...
 * Response Object
 */
public class UpdateHttpPunishmentRuleResponse extends SdkResponse {
    ...
    public UpdateHttpPunishmentRuleResponse withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public UpdateHttpPunishmentRuleResponse withPolicyId(String policyId) {
    ...
    public UpdateHttpPunishmentRuleResponse withTimestamp(Long timestamp) {
    ...
    public UpdateHttpPunishmentRuleResponse withDescription(String description) {
    ...
    public UpdateHttpPunishmentRuleResponse withCategory(String category) {
    ...
    public UpdateHttpPunishmentRuleResponse withBlockTime(Integer blockTime) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        UpdateHttpPunishmentRuleResponse that = (UpdateHttpPunishmentRuleResponse) obj;
    ...
    public String toString() {
        ...
        sb.append("class UpdateHttpPunishmentRuleResponse {\n");
