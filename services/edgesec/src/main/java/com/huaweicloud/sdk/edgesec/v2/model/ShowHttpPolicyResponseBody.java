 ...
 */
public class ShowHttpPolicyResponseBody {
    ...
    public ShowHttpPolicyResponseBody withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public ShowHttpPolicyResponseBody withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public ShowHttpPolicyResponseBody withLevel(Integer level) {
        this.level = level;
        return this;
    }
    ...
    public ShowHttpPolicyResponseBody withFullDetection(Boolean fullDetection) {
    ...
    public ShowHttpPolicyResponseBody withAction(HttpPolicyAction action) {
        this.action = action;
        return this;
    }

    public ShowHttpPolicyResponseBody withAction(Consumer<HttpPolicyAction> actionSetter) {
        if (this.action == null) {
    ...
    public ShowHttpPolicyResponseBody withRobotAction(HttpPolicyAction robotAction) {
        this.robotAction = robotAction;
        return this;
    }

    public ShowHttpPolicyResponseBody withRobotAction(Consumer<HttpPolicyAction> robotActionSetter) {
    ...
    public ShowHttpPolicyResponseBody withOptions(HttpPolicyOption options) {
        this.options = options;
        return this;
    }

    public ShowHttpPolicyResponseBody withOptions(Consumer<HttpPolicyOption> optionsSetter) {
    ...
    public ShowHttpPolicyResponseBody withBindHost(List<HttpPolicyBindHost> bindHost) {
        this.bindHost = bindHost;
        return this;
    }

    public ShowHttpPolicyResponseBody addBindHostItem(HttpPolicyBindHost bindHostItem) {
    ...
    public ShowHttpPolicyResponseBody withBindHost(Consumer<List<HttpPolicyBindHost>> bindHostSetter) {
        if (this.bindHost == null) {
            this.bindHost = new ArrayList<>();
        }
    ...
    public ShowHttpPolicyResponseBody withExtend(Map<String, String> extend) {
        this.extend = extend;
        return this;
    }

    public ShowHttpPolicyResponseBody putExtendItem(String key, String extendItem) {
        if (this.extend == null) {
    ...
    public ShowHttpPolicyResponseBody withExtend(Consumer<Map<String, String>> extendSetter) {
        if (this.extend == null) {
            this.extend = new HashMap<>();
        }
    ...
    public ShowHttpPolicyResponseBody withThirdBotOptions(Map<String, Object> thirdBotOptions) {
        this.thirdBotOptions = thirdBotOptions;
        return this;
    }

    public ShowHttpPolicyResponseBody putThirdBotOptionsItem(String key, Object thirdBotOptionsItem) {
    ...
    public ShowHttpPolicyResponseBody withThirdBotOptions(Consumer<Map<String, Object>> thirdBotOptionsSetter) {
        if (this.thirdBotOptions == null) {
            this.thirdBotOptions = new HashMap<>();
        }
    ...
    public ShowHttpPolicyResponseBody withWapManagedRulesetId(String wapManagedRulesetId) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ShowHttpPolicyResponseBody that = (ShowHttpPolicyResponseBody) obj;
    ...
    public String toString() {
        ...
        sb.append("class ShowHttpPolicyResponseBody {\n");
