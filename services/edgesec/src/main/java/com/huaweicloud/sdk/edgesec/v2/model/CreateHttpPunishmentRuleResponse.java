 ...
 * Response Object
 */
public class CreateHttpPunishmentRuleResponse extends SdkResponse {
    ...
    public CreateHttpPunishmentRuleResponse withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public CreateHttpPunishmentRuleResponse withPolicyId(String policyId) {
    ...
    public CreateHttpPunishmentRuleResponse withTimestamp(Long timestamp) {
    ...
    public CreateHttpPunishmentRuleResponse withDescription(String description) {
    ...
    public CreateHttpPunishmentRuleResponse withCategory(String category) {
    ...
    public CreateHttpPunishmentRuleResponse withBlockTime(Integer blockTime) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        CreateHttpPunishmentRuleResponse that = (CreateHttpPunishmentRuleResponse) obj;
    ...
    public String toString() {
        ...
        sb.append("class CreateHttpPunishmentRuleResponse {\n");
