 ...
 * Response Object
 */
public class ApplyHttpPolicyResponse extends SdkResponse {
    ...
    public ApplyHttpPolicyResponse withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public ApplyHttpPolicyResponse withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public ApplyHttpPolicyResponse withLevel(Integer level) {
        this.level = level;
        return this;
    }
    ...
    public ApplyHttpPolicyResponse withFullDetection(Boolean fullDetection) {
    ...
    public ApplyHttpPolicyResponse withAction(HttpPolicyAction action) {
        this.action = action;
        return this;
    }

    public ApplyHttpPolicyResponse withAction(Consumer<HttpPolicyAction> actionSetter) {
        if (this.action == null) {
    ...
    public ApplyHttpPolicyResponse withRobotAction(HttpPolicyAction robotAction) {
        this.robotAction = robotAction;
        return this;
    }

    public ApplyHttpPolicyResponse withRobotAction(Consumer<HttpPolicyAction> robotActionSetter) {
    ...
    public ApplyHttpPolicyResponse withOptions(HttpPolicyOption options) {
        this.options = options;
        return this;
    }

    public ApplyHttpPolicyResponse withOptions(Consumer<HttpPolicyOption> optionsSetter) {
    ...
    public ApplyHttpPolicyResponse withBindHost(List<HttpPolicyBindHost> bindHost) {
        this.bindHost = bindHost;
        return this;
    }

    public ApplyHttpPolicyResponse addBindHostItem(HttpPolicyBindHost bindHostItem) {
    ...
    public ApplyHttpPolicyResponse withBindHost(Consumer<List<HttpPolicyBindHost>> bindHostSetter) {
        if (this.bindHost == null) {
            this.bindHost = new ArrayList<>();
        }
    ...
    public ApplyHttpPolicyResponse withExtend(Map<String, String> extend) {
        this.extend = extend;
        return this;
    }

    public ApplyHttpPolicyResponse putExtendItem(String key, String extendItem) {
        if (this.extend == null) {
    ...
    public ApplyHttpPolicyResponse withExtend(Consumer<Map<String, String>> extendSetter) {
        if (this.extend == null) {
            this.extend = new HashMap<>();
        }
    ...
    public ApplyHttpPolicyResponse withThirdBotOptions(Map<String, Object> thirdBotOptions) {
        this.thirdBotOptions = thirdBotOptions;
        return this;
    }

    public ApplyHttpPolicyResponse putThirdBotOptionsItem(String key, Object thirdBotOptionsItem) {
    ...
    public ApplyHttpPolicyResponse withThirdBotOptions(Consumer<Map<String, Object>> thirdBotOptionsSetter) {
        if (this.thirdBotOptions == null) {
            this.thirdBotOptions = new HashMap<>();
        }
    ...
    public ApplyHttpPolicyResponse withWapManagedRulesetId(String wapManagedRulesetId) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ApplyHttpPolicyResponse that = (ApplyHttpPolicyResponse) obj;
    ...
    public String toString() {
        ...
        sb.append("class ApplyHttpPolicyResponse {\n");
