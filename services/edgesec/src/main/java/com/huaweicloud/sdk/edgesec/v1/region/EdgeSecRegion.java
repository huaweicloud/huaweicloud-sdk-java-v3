package com.huaweicloud.sdk.edgesec.v1.region;
...
public class EdgeSecRegion {

    public static final Region CN_NORTH_2 = new Region("cn-north-2", "https://edgesec.myhuaweicloud.com");

    public static final Region CN_NORTH_4 = new Region("cn-north-4", "https://edgesec.myhuaweicloud.com");

    public static final Region CN_NORTH_1 = new Region("cn-north-1", "https://edgesec.myhuaweicloud.com");

    public static final Region CN_EAST_2 = new Region("cn-east-2", "https://edgesec.myhuaweicloud.com");

    public static final Region CN_EAST_3 = new Region("cn-east-3", "https://edgesec.myhuaweicloud.com");

    public static final Region CN_SOUTH_1 = new Region("cn-south-1", "https://edgesec.myhuaweicloud.com");

    public static final Region CN_SOUTH_2 = new Region("cn-south-2", "https://edgesec.myhuaweicloud.com");

    public static final Region CN_SOUTH_4 = new Region("cn-south-4", "https://edgesec.myhuaweicloud.com");

    public static final Region CN_SOUTHWEST_2 = new Region("cn-southwest-2", "https://edgesec.myhuaweicloud.com");

    public static final Region CN_NORTH_9 = new Region("cn-north-9", "https://edgesec.myhuaweicloud.com");
    ...
    public static Region valueOf(String regionId) {
        ...
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "region id '%s' is not in the following supported regions of service EdgeSec: [%s]",
            regionId,
