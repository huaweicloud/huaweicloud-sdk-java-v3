 ...
 * Response Object
 */
public class ShowHttpPunishmentRuleResponse extends SdkResponse {
    ...
    public ShowHttpPunishmentRuleResponse withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public ShowHttpPunishmentRuleResponse withPolicyId(String policyId) {
    ...
    public ShowHttpPunishmentRuleResponse withTimestamp(Long timestamp) {
    ...
    public ShowHttpPunishmentRuleResponse withDescription(String description) {
    ...
    public ShowHttpPunishmentRuleResponse withCategory(String category) {
    ...
    public ShowHttpPunishmentRuleResponse withBlockTime(Integer blockTime) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ShowHttpPunishmentRuleResponse that = (ShowHttpPunishmentRuleResponse) obj;
    ...
    public String toString() {
        ...
        sb.append("class ShowHttpPunishmentRuleResponse {\n");
