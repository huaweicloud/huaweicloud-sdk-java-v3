 ...
 * Response Object
 */
public class CreateHttpPolicyResponse extends SdkResponse {
    ...
    public CreateHttpPolicyResponse withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public CreateHttpPolicyResponse withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public CreateHttpPolicyResponse withLevel(Integer level) {
        this.level = level;
        return this;
    }
    ...
    public CreateHttpPolicyResponse withFullDetection(Boolean fullDetection) {
    ...
    public CreateHttpPolicyResponse withAction(HttpPolicyAction action) {
        this.action = action;
        return this;
    }

    public CreateHttpPolicyResponse withAction(Consumer<HttpPolicyAction> actionSetter) {
        if (this.action == null) {
    ...
    public CreateHttpPolicyResponse withRobotAction(HttpPolicyAction robotAction) {
        this.robotAction = robotAction;
        return this;
    }

    public CreateHttpPolicyResponse withRobotAction(Consumer<HttpPolicyAction> robotActionSetter) {
    ...
    public CreateHttpPolicyResponse withOptions(HttpPolicyOption options) {
        this.options = options;
        return this;
    }

    public CreateHttpPolicyResponse withOptions(Consumer<HttpPolicyOption> optionsSetter) {
    ...
    public CreateHttpPolicyResponse withBindHost(List<HttpPolicyBindHost> bindHost) {
        this.bindHost = bindHost;
        return this;
    }

    public CreateHttpPolicyResponse addBindHostItem(HttpPolicyBindHost bindHostItem) {
    ...
    public CreateHttpPolicyResponse withBindHost(Consumer<List<HttpPolicyBindHost>> bindHostSetter) {
        if (this.bindHost == null) {
            this.bindHost = new ArrayList<>();
        }
    ...
    public CreateHttpPolicyResponse withExtend(Map<String, String> extend) {
        this.extend = extend;
        return this;
    }

    public CreateHttpPolicyResponse putExtendItem(String key, String extendItem) {
        if (this.extend == null) {
    ...
    public CreateHttpPolicyResponse withExtend(Consumer<Map<String, String>> extendSetter) {
        if (this.extend == null) {
            this.extend = new HashMap<>();
        }
    ...
    public CreateHttpPolicyResponse withThirdBotOptions(Map<String, Object> thirdBotOptions) {
        this.thirdBotOptions = thirdBotOptions;
        return this;
    }

    public CreateHttpPolicyResponse putThirdBotOptionsItem(String key, Object thirdBotOptionsItem) {
    ...
    public CreateHttpPolicyResponse withThirdBotOptions(Consumer<Map<String, Object>> thirdBotOptionsSetter) {
        if (this.thirdBotOptions == null) {
            this.thirdBotOptions = new HashMap<>();
        }
    ...
    public CreateHttpPolicyResponse withWapManagedRulesetId(String wapManagedRulesetId) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        CreateHttpPolicyResponse that = (CreateHttpPolicyResponse) obj;
    ...
    public String toString() {
        ...
        sb.append("class CreateHttpPolicyResponse {\n");
