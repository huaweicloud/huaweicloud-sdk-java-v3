 ...
 * Response Object
 */
public class ShowHttpPolicyResponse extends SdkResponse {
    ...
    public ShowHttpPolicyResponse withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public ShowHttpPolicyResponse withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public ShowHttpPolicyResponse withLevel(Integer level) {
        this.level = level;
        return this;
    }
    ...
    public ShowHttpPolicyResponse withFullDetection(Boolean fullDetection) {
    ...
    public ShowHttpPolicyResponse withAction(HttpPolicyAction action) {
        this.action = action;
        return this;
    }

    public ShowHttpPolicyResponse withAction(Consumer<HttpPolicyAction> actionSetter) {
        if (this.action == null) {
    ...
    public ShowHttpPolicyResponse withRobotAction(HttpPolicyAction robotAction) {
        this.robotAction = robotAction;
        return this;
    }

    public ShowHttpPolicyResponse withRobotAction(Consumer<HttpPolicyAction> robotActionSetter) {
    ...
    public ShowHttpPolicyResponse withOptions(HttpPolicyOption options) {
        this.options = options;
        return this;
    }

    public ShowHttpPolicyResponse withOptions(Consumer<HttpPolicyOption> optionsSetter) {
    ...
    public ShowHttpPolicyResponse withBindHost(List<HttpPolicyBindHost> bindHost) {
        this.bindHost = bindHost;
        return this;
    }

    public ShowHttpPolicyResponse addBindHostItem(HttpPolicyBindHost bindHostItem) {
    ...
    public ShowHttpPolicyResponse withBindHost(Consumer<List<HttpPolicyBindHost>> bindHostSetter) {
        if (this.bindHost == null) {
            this.bindHost = new ArrayList<>();
        }
    ...
    public ShowHttpPolicyResponse withExtend(Map<String, String> extend) {
        this.extend = extend;
        return this;
    }

    public ShowHttpPolicyResponse putExtendItem(String key, String extendItem) {
        if (this.extend == null) {
    ...
    public ShowHttpPolicyResponse withExtend(Consumer<Map<String, String>> extendSetter) {
        if (this.extend == null) {
            this.extend = new HashMap<>();
        }
    ...
    public ShowHttpPolicyResponse withThirdBotOptions(Map<String, Object> thirdBotOptions) {
        this.thirdBotOptions = thirdBotOptions;
        return this;
    }

    public ShowHttpPolicyResponse putThirdBotOptionsItem(String key, Object thirdBotOptionsItem) {
    ...
    public ShowHttpPolicyResponse withThirdBotOptions(Consumer<Map<String, Object>> thirdBotOptionsSetter) {
        if (this.thirdBotOptions == null) {
            this.thirdBotOptions = new HashMap<>();
        }
    ...
    public ShowHttpPolicyResponse withWapManagedRulesetId(String wapManagedRulesetId) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ShowHttpPolicyResponse that = (ShowHttpPolicyResponse) obj;
    ...
    public String toString() {
        ...
        sb.append("class ShowHttpPolicyResponse {\n");
