...
public class ShowConnectionRequest {
    ...
    public ShowConnectionRequest withConnectionId(String connectionId) {
    ...
    public ShowConnectionRequest withInstanceId(String instanceId) {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(connectionId, instanceId);
    }
