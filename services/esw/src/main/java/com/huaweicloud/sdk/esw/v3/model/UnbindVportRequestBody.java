...
/**
 * UnbindVportRequestBody
 */
public class UnbindVportRequestBody {
    ...
    public UnbindVportRequestBody withVport(Vport vport) {
        this.vport = vport;
        return this;
    }

    public UnbindVportRequestBody withVport(Consumer<Vport> vportSetter) {
        if (this.vport == null) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        UnbindVportRequestBody that = (UnbindVportRequestBody) obj;
    ...
    public String toString() {
        ...
        sb.append("class UnbindVportRequestBody {\n");
