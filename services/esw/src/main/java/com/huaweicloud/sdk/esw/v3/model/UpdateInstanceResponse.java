...
public class UpdateInstanceResponse extends SdkResponse {
    ...
    public UpdateInstanceResponse withRequestId(String requestId) {
    ...
    public UpdateInstanceResponse withInstance(Instance instance) {
        this.instance = instance;
        return this;
    }

    public UpdateInstanceResponse withInstance(Consumer<Instance> instanceSetter) {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(requestId, instance);
    }
