...
public class ShowConnectionResponse extends SdkResponse {
    ...
    public ShowConnectionResponse withRequestId(String requestId) {
    ...
    public ShowConnectionResponse withConnection(Connection connection) {
        this.connection = connection;
        return this;
    }

    public ShowConnectionResponse withConnection(Consumer<Connection> connectionSetter) {
