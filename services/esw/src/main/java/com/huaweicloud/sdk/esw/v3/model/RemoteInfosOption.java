 ...
 * RemoteInfosOption
 */
public class RemoteInfosOption {
    ...
    public RemoteInfosOption withSegmentationId(Integer segmentationId) {
    ...
    public RemoteInfosOption withTunnelIp(String tunnelIp) {
    ...
    public RemoteInfosOption withTunnelPort(Integer tunnelPort) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        RemoteInfosOption that = (RemoteInfosOption) obj;
        return Objects.equals(this.segmentationId, that.segmentationId) && Objects.equals(this.tunnelIp, that.tunnelIp)
            && Objects.equals(this.tunnelPort, that.tunnelPort);
    }

    @Override
    public int hashCode() {
        return Objects.hash(segmentationId, tunnelIp, tunnelPort);
    }

    @Override
    public String toString() {
        StringBuilder sb = new StringBuilder();
        sb.append("class RemoteInfosOption {\n");
