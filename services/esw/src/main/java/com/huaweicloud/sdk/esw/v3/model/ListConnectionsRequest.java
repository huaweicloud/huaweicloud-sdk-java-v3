...
public class ListConnectionsRequest {
    ...
    public ListConnectionsRequest withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public ListConnectionsRequest withMarker(String marker) {
        this.marker = marker;
        return this;
    }
    ...
    @Override
    public int hashCode() {
        return Objects.hash(instanceId, id, name, limit, marker);
    }
