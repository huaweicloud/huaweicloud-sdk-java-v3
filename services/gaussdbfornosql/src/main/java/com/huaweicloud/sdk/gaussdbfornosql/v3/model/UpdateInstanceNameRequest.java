...
public class UpdateInstanceNameRequest {
    ...
    private UpdateInstanceNameRequestBody body;
    ...
    public UpdateInstanceNameRequest withBody(UpdateInstanceNameRequestBody body) {
        this.body = body;
        return this;
    }

    public UpdateInstanceNameRequest withBody(Consumer<UpdateInstanceNameRequestBody> bodySetter) {
        if (this.body == null) {
            this.body = new UpdateInstanceNameRequestBody();
     ...
     * @return body
     */
    public UpdateInstanceNameRequestBody getBody() {
        return body;
    }

    public void setBody(UpdateInstanceNameRequestBody body) {
        this.body = body;
    }
