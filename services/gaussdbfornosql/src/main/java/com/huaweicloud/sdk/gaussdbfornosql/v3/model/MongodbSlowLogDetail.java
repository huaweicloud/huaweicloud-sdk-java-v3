...
public class MongodbSlowLogDetail {
    ...
    public MongodbSlowLogDetail withNodeName(String nodeName) {
    ...
    public MongodbSlowLogDetail withNodeId(String nodeId) {
        this.nodeId = nodeId;
        return this;
    }
    ...
    public MongodbSlowLogDetail withWholeMessage(String wholeMessage) {
    ...
    public MongodbSlowLogDetail withOperateType(String operateType) {
    ...
    public MongodbSlowLogDetail withCostTime(Integer costTime) {
    ...
    public MongodbSlowLogDetail withLockTime(Integer lockTime) {
    ...
    public MongodbSlowLogDetail withDocsReturned(Integer docsReturned) {
    ...
    public MongodbSlowLogDetail withDocsScanned(Integer docsScanned) {
    ...
    public MongodbSlowLogDetail withDatabase(String database) {
    ...
    public MongodbSlowLogDetail withCollection(String collection) {
    ...
    public MongodbSlowLogDetail withLogTime(String logTime) {
    ...
    public MongodbSlowLogDetail withLineNum(String lineNum) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        MongodbSlowLogDetail that = (MongodbSlowLogDetail) obj;
