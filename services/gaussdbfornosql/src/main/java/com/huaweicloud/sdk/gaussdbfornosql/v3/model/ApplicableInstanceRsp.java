 ...
 */
public class ApplicableInstanceRsp {
    ...
    public ApplicableInstanceRsp withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public ApplicableInstanceRsp withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append("class ApplicableInstanceRsp {\n");
