...
import com.huaweicloud.sdk.gaussdbfornosql.v3.model.BackupStrategyOption;
import com.huaweicloud.sdk.gaussdbfornosql.v3.model.ChargeInfoOption;
import com.huaweicloud.sdk.gaussdbfornosql.v3.model.CreateInstanceFlavorOption;
import com.huaweicloud.sdk.gaussdbfornosql.v3.model.DatastoreOption;
...
public class CreateInstanceRequestBody  {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(name, datastore, region, availabilityZone, vpcId, subnetId, securityGroupId, password, mode, flavor, configurationId, backupStrategy, enterpriseProjectId, sslOption, chargeInfo);
    }
    @Override
