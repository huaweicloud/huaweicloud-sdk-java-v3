 ...
 * Request Object
 */
public class ShowAllInstancesBackupsNewRequest {
    ...
    public ShowAllInstancesBackupsNewRequest withInstanceId(String instanceId) {
    ...
    public ShowAllInstancesBackupsNewRequest withDatastoreType(String datastoreType) {
    ...
    public ShowAllInstancesBackupsNewRequest withBackupId(String backupId) {
    ...
    public ShowAllInstancesBackupsNewRequest withBackupType(String backupType) {
    ...
    public ShowAllInstancesBackupsNewRequest withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public ShowAllInstancesBackupsNewRequest withLimit(Integer limit) {
        this.limit = limit;
        return this;
    }
    ...
    public ShowAllInstancesBackupsNewRequest withOffset(Integer offset) {
        this.offset = offset;
        return this;
    }
    ...
    public ShowAllInstancesBackupsNewRequest withBeginTime(String beginTime) {
    ...
    public ShowAllInstancesBackupsNewRequest withEndTime(String endTime) {
    ...
    public String toString() {
        ...
        sb.append("class ShowAllInstancesBackupsNewRequest {\n");
