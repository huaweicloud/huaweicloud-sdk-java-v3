...
public class MongodbErrorLogDetail {
    ...
    public MongodbErrorLogDetail withNodeName(String nodeName) {
    ...
    public MongodbErrorLogDetail withNodeId(String nodeId) {
        this.nodeId = nodeId;
        return this;
    }
    ...
    public MongodbErrorLogDetail withRawMessage(String rawMessage) {
    ...
    public MongodbErrorLogDetail withSeverity(String severity) {
    ...
    public MongodbErrorLogDetail withLogTime(String logTime) {
    ...
    public MongodbErrorLogDetail withLineNum(String lineNum) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        MongodbErrorLogDetail that = (MongodbErrorLogDetail) obj;
