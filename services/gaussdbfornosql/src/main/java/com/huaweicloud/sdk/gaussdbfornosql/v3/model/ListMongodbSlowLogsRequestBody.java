...
public class ListMongodbSlowLogsRequestBody {
    ...
    public ListMongodbSlowLogsRequestBody withStartTime(String startTime) {
    ...
    public ListMongodbSlowLogsRequestBody withEndTime(String endTime) {
    ...
    public ListMongodbSlowLogsRequestBody withLimit(Integer limit) {
        this.limit = limit;
        return this;
    }
    ...
    public ListMongodbSlowLogsRequestBody withLineNum(String lineNum) {
    ...
    public ListMongodbSlowLogsRequestBody withOperateType(OperateTypeEnum operateType) {
    ...
    public ListMongodbSlowLogsRequestBody withNodeId(String nodeId) {
        this.nodeId = nodeId;
        return this;
    }
    ...
    public ListMongodbSlowLogsRequestBody withKeywords(List<String> keywords) {
        this.keywords = keywords;
        return this;
    }

    public ListMongodbSlowLogsRequestBody addKeywordsItem(String keywordsItem) {
    ...
    public ListMongodbSlowLogsRequestBody withKeywords(Consumer<List<String>> keywordsSetter) {
        if (this.keywords == null) {
            this.keywords = new ArrayList<>();
        }
    ...
    public ListMongodbSlowLogsRequestBody withDatabaseKeywords(List<String> databaseKeywords) {
        this.databaseKeywords = databaseKeywords;
        return this;
    }

    public ListMongodbSlowLogsRequestBody addDatabaseKeywordsItem(String databaseKeywordsItem) {
    ...
    public ListMongodbSlowLogsRequestBody withDatabaseKeywords(Consumer<List<String>> databaseKeywordsSetter) {
        if (this.databaseKeywords == null) {
            this.databaseKeywords = new ArrayList<>();
        }
    ...
    public ListMongodbSlowLogsRequestBody withCollectionKeywords(List<String> collectionKeywords) {
        this.collectionKeywords = collectionKeywords;
        return this;
    }

    public ListMongodbSlowLogsRequestBody addCollectionKeywordsItem(String collectionKeywordsItem) {
    ...
    public ListMongodbSlowLogsRequestBody withCollectionKeywords(Consumer<List<String>> collectionKeywordsSetter) {
        if (this.collectionKeywords == null) {
            this.collectionKeywords = new ArrayList<>();
        }
    ...
    public ListMongodbSlowLogsRequestBody withMaxCostTime(Integer maxCostTime) {
    ...
    public ListMongodbSlowLogsRequestBody withMinCostTime(Integer minCostTime) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ListMongodbSlowLogsRequestBody that = (ListMongodbSlowLogsRequestBody) obj;
