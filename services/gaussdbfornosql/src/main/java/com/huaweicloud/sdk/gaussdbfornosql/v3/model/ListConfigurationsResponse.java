...
import com.huaweicloud.sdk.gaussdbfornosql.v3.model.ListConfigurationsResult;
...
public class ListConfigurationsResponse extends SdkResponse {
    ...
    public ListConfigurationsResponse withConfigurations(Consumer<List<ListConfigurationsResult>> configurationsSetter) {
        if(this.configurations == null) {
            this.configurations = new ArrayList<>();
        }
