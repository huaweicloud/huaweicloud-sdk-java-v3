...
public class ModifyAutoNodeExpansionPolicyRequestBody {
    ...
    public ModifyAutoNodeExpansionPolicyRequestBody withSwitchOption(Boolean switchOption) {
    ...
    public ModifyAutoNodeExpansionPolicyRequestBody withOverloadNodeThreshold(Integer overloadNodeThreshold) {
    ...
    public ModifyAutoNodeExpansionPolicyRequestBody withCpuThreshold(Integer cpuThreshold) {
    ...
    public ModifyAutoNodeExpansionPolicyRequestBody withMemThreshold(Integer memThreshold) {
    ...
    public ModifyAutoNodeExpansionPolicyRequestBody withStep(Integer step) {
        this.step = step;
        return this;
    }
    ...
    public ModifyAutoNodeExpansionPolicyRequestBody withNodeLimit(Integer nodeLimit) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ModifyAutoNodeExpansionPolicyRequestBody that = (ModifyAutoNodeExpansionPolicyRequestBody) obj;
