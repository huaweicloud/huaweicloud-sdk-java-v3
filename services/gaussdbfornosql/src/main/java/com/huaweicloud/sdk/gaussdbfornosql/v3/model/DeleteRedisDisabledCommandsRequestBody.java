 ...
 */
public class DeleteRedisDisabledCommandsRequestBody {
    ...
    public DeleteRedisDisabledCommandsRequestBody withDisabledType(DisabledTypeEnum disabledType) {
    ...
    public DeleteRedisDisabledCommandsRequestBody withCommands(List<String> commands) {
        this.commands = commands;
        return this;
    }

    public DeleteRedisDisabledCommandsRequestBody addCommandsItem(String commandsItem) {
    ...
    public DeleteRedisDisabledCommandsRequestBody withCommands(Consumer<List<String>> commandsSetter) {
        if (this.commands == null) {
            this.commands = new ArrayList<>();
        }
    ...
    public DeleteRedisDisabledCommandsRequestBody withKeys(List<RedisDisabledCommandsDetail> keys) {
        this.keys = keys;
        return this;
    }

    public DeleteRedisDisabledCommandsRequestBody addKeysItem(RedisDisabledCommandsDetail keysItem) {
        if (this.keys == null) {
    ...
    public DeleteRedisDisabledCommandsRequestBody withKeys(Consumer<List<RedisDisabledCommandsDetail>> keysSetter) {
        if (this.keys == null) {
            this.keys = new ArrayList<>();
        }
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        DeleteRedisDisabledCommandsRequestBody that = (DeleteRedisDisabledCommandsRequestBody) obj;
    ...
    public String toString() {
        ...
        sb.append("class DeleteRedisDisabledCommandsRequestBody {\n");
