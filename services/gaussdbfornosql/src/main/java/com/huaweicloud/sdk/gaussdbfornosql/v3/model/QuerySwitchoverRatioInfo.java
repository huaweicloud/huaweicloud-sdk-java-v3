 ...
 */
public class QuerySwitchoverRatioInfo {
    ...
    public QuerySwitchoverRatioInfo withInstanceId(String instanceId) {
    ...
    public QuerySwitchoverRatioInfo withSwitchoverRatio(Integer switchoverRatio) {
    ...
    public QuerySwitchoverRatioInfo withSyncDelay(Long syncDelay) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        QuerySwitchoverRatioInfo that = (QuerySwitchoverRatioInfo) obj;
    ...
    public String toString() {
        ...
        sb.append("class QuerySwitchoverRatioInfo {\n");
