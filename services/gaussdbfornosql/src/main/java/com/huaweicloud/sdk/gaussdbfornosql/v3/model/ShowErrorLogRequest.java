...
public class ShowErrorLogRequest {
    ...
    public ShowErrorLogRequest withInstanceId(String instanceId) {
    ...
    public ShowErrorLogRequest withStartTime(String startTime) {
    ...
    public ShowErrorLogRequest withEndTime(String endTime) {
    ...
    public ShowErrorLogRequest withNodeId(String nodeId) {
        this.nodeId = nodeId;
        return this;
    }
    ...
    public ShowErrorLogRequest withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public ShowErrorLogRequest withOffset(Integer offset) {
        this.offset = offset;
        return this;
    }
    ...
    public ShowErrorLogRequest withLimit(Integer limit) {
        this.limit = limit;
        return this;
    }
    ...
    @Override
    public int hashCode() {
        return Objects.hash(instanceId, startTime, endTime, nodeId, type, offset, limit);
    }
