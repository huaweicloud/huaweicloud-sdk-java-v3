...
public class RestorableTime {
    ...
    public RestorableTime withStartTime(Long startTime) {
    ...
    public RestorableTime withEndTime(Long endTime) {
    ...
    public String toString() {
        ...
        sb.append("class RestorableTime {\n");
