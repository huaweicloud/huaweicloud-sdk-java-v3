...
public class ComplianceRule {
    ...
    private ComplianceRuleLocalBackupFrequency localBackupFrequency;
    ...
    public ComplianceRule withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public ComplianceRule withIsSystemEmbedded(Boolean isSystemEmbedded) {
    ...
    public ComplianceRule withDomainId(String domainId) {
    ...
    public ComplianceRule withResourceType(String resourceType) {
    ...
    public ComplianceRule withBackupType(String backupType) {
    ...
    public ComplianceRule withLocalBackupEnabled(Boolean localBackupEnabled) {
    ...
    public ComplianceRule withLocalBackupRetention(Integer localBackupRetention) {
    ...
    public ComplianceRule withLocalBackupFrequency(ComplianceRuleLocalBackupFrequency localBackupFrequency) {
        this.localBackupFrequency = localBackupFrequency;
        return this;
    }

    public ComplianceRule withLocalBackupFrequency(
        Consumer<ComplianceRuleLocalBackupFrequency> localBackupFrequencySetter) {
        if (this.localBackupFrequency == null) {
            this.localBackupFrequency = new ComplianceRuleLocalBackupFrequency();
     ...
     */
    public ComplianceRuleLocalBackupFrequency getLocalBackupFrequency() {
        return localBackupFrequency;
    }

    public void setLocalBackupFrequency(ComplianceRuleLocalBackupFrequency localBackupFrequency) {
        this.localBackupFrequency = localBackupFrequency;
    }

    public ComplianceRule withRemoteBackupEnabled(Boolean remoteBackupEnabled) {
    ...
    public ComplianceRule withRemoteBackupRetention(Integer remoteBackupRetention) {
    ...
    public ComplianceRule withLocalWormEnabled(Boolean localWormEnabled) {
    ...
    public ComplianceRule withRemoteWormEnabled(Boolean remoteWormEnabled) {
    ...
    public ComplianceRule withIsCrossAccountBackupForced(Boolean isCrossAccountBackupForced) {
    ...
    public ComplianceRule withDescription(String description) {
    ...
    public ComplianceRule withCreated(Long created) {
    ...
    public ComplianceRule withUpdated(Long updated) {
    ...
    public ComplianceRule withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ComplianceRule that = (ComplianceRule) obj;
