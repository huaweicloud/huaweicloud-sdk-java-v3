 ...
 * Response Object
 */
public class ShowOrganizationPolicyResponse extends SdkResponse {
    ...
    public ShowOrganizationPolicyResponse withRegionId(String regionId) {
    ...
    public ShowOrganizationPolicyResponse withDetail(BccOrganizationPolicyDetail detail) {
        this.detail = detail;
        return this;
    }

    public ShowOrganizationPolicyResponse withDetail(Consumer<BccOrganizationPolicyDetail> detailSetter) {
        if (this.detail == null) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ShowOrganizationPolicyResponse that = (ShowOrganizationPolicyResponse) obj;
