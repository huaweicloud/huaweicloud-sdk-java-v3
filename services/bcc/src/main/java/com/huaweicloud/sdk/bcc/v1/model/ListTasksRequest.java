...
public class ListTasksRequest {
    ...
    public ListTasksRequest withDomainId(String domainId) {
    ...
    public ListTasksRequest withRegionId(String regionId) {
    ...
    public ListTasksRequest withTaskStatus(TaskStatusEnum taskStatus) {
    ...
    public ListTasksRequest withResourceType(ResourceTypeEnum resourceType) {
    ...
    public ListTasksRequest withMarker(String marker) {
        this.marker = marker;
        return this;
    }
    ...
    @Override
    public int hashCode() {
        return Objects.hash(domainId, regionId, taskStatus, taskType, resourceType, startTime, endTime, marker, limit);
    }
