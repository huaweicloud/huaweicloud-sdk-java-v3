 ...
 */
public class CreateBccPolicyRequestBodyPolicyCbrPolicyDetailOperationDefinition {
    ...
    public CreateBccPolicyRequestBodyPolicyCbrPolicyDetailOperationDefinition withDayBackups(Integer dayBackups) {
    ...
    public CreateBccPolicyRequestBodyPolicyCbrPolicyDetailOperationDefinition withDestinationProjectId(
    ...
    public CreateBccPolicyRequestBodyPolicyCbrPolicyDetailOperationDefinition withDestinationRegion(
    ...
    public CreateBccPolicyRequestBodyPolicyCbrPolicyDetailOperationDefinition withEnableAcceleration(
    ...
    public CreateBccPolicyRequestBodyPolicyCbrPolicyDetailOperationDefinition withMaxBackups(Integer maxBackups) {
    ...
    public CreateBccPolicyRequestBodyPolicyCbrPolicyDetailOperationDefinition withMonthBackups(Integer monthBackups) {
    ...
    public CreateBccPolicyRequestBodyPolicyCbrPolicyDetailOperationDefinition withRetentionDurationDays(
    ...
    public CreateBccPolicyRequestBodyPolicyCbrPolicyDetailOperationDefinition withTimezone(String timezone) {
    ...
    public CreateBccPolicyRequestBodyPolicyCbrPolicyDetailOperationDefinition withWeekBackups(Integer weekBackups) {
    ...
    public CreateBccPolicyRequestBodyPolicyCbrPolicyDetailOperationDefinition withYearBackups(Integer yearBackups) {
    ...
    public CreateBccPolicyRequestBodyPolicyCbrPolicyDetailOperationDefinition withFullBackupInterval(
        Integer fullBackupInterval) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        CreateBccPolicyRequestBodyPolicyCbrPolicyDetailOperationDefinition that =
            (CreateBccPolicyRequestBodyPolicyCbrPolicyDetailOperationDefinition) obj;
    ...
    public String toString() {
        ...
        sb.append("class CreateBccPolicyRequestBodyPolicyCbrPolicyDetailOperationDefinition {\n");
