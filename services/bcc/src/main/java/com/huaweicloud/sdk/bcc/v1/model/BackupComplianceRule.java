 ...
 */
public class BackupComplianceRule {
    ...
    public BackupComplianceRule withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public BackupComplianceRule withIsSystemEmbedded(Boolean isSystemEmbedded) {
    ...
    public BackupComplianceRule withDomainId(String domainId) {
    ...
    public BackupComplianceRule withResourceType(String resourceType) {
    ...
    public BackupComplianceRule withBackupType(String backupType) {
    ...
    public BackupComplianceRule withLocalBackupEnabled(Boolean localBackupEnabled) {
    ...
    public BackupComplianceRule withLocalBackupRetention(Integer localBackupRetention) {
    ...
    public BackupComplianceRule withLocalBackupFrequency(
    ...
    public BackupComplianceRule withRemoteBackupEnabled(Boolean remoteBackupEnabled) {
    ...
    public BackupComplianceRule withRemoteBackupRetention(Integer remoteBackupRetention) {
    ...
    public BackupComplianceRule withLocalWormEnabled(Boolean localWormEnabled) {
    ...
    public BackupComplianceRule withRemoteWormEnabled(Boolean remoteWormEnabled) {
    ...
    public BackupComplianceRule withIsCrossAccountBackupForced(Boolean isCrossAccountBackupForced) {
    ...
    public BackupComplianceRule withDescription(String description) {
    ...
    public BackupComplianceRule withCreated(Long created) {
    ...
    public BackupComplianceRule withUpdated(Long updated) {
    ...
    public BackupComplianceRule withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        BackupComplianceRule that = (BackupComplianceRule) obj;
    ...
    public String toString() {
        ...
        sb.append("class BackupComplianceRule {\n");
