...
public class ShowPolicyResponse extends SdkResponse {
    ...
    public ShowPolicyResponse withProtectionType(String protectionType) {
    ...
    public ShowPolicyResponse withEnabled(Boolean enabled) {
    ...
    public ShowPolicyResponse withCyber(String cyber) {
        this.cyber = cyber;
        return this;
    }
    ...
    public ShowPolicyResponse withRegionId(String regionId) {
    ...
    public ShowPolicyResponse withStorageType(String storageType) {
    ...
    public ShowPolicyResponse withPolicyType(String policyType) {
    ...
    public ShowPolicyResponse withServiceType(String serviceType) {
    ...
    public ShowPolicyResponse withCbrPolicyDetail(CbrPolicyDetail cbrPolicyDetail) {
        this.cbrPolicyDetail = cbrPolicyDetail;
        return this;
    }

    public ShowPolicyResponse withCbrPolicyDetail(Consumer<CbrPolicyDetail> cbrPolicyDetailSetter) {
    ...
    public ShowPolicyResponse withDbPolicyDetail(DbPolicyDetail dbPolicyDetail) {
        this.dbPolicyDetail = dbPolicyDetail;
        return this;
    }

    public ShowPolicyResponse withDbPolicyDetail(Consumer<DbPolicyDetail> dbPolicyDetailSetter) {
