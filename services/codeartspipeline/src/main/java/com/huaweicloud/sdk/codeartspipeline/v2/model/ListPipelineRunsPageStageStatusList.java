...
public class ListPipelineRunsPageStageStatusList {
    ...
    public ListPipelineRunsPageStageStatusList withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public ListPipelineRunsPageStageStatusList withSequence(Integer sequence) {
    ...
    public ListPipelineRunsPageStageStatusList withStatus(String status) {
        this.status = status;
        return this;
    }
    ...
    public ListPipelineRunsPageStageStatusList withStartTime(String startTime) {
    ...
    public ListPipelineRunsPageStageStatusList withEndTime(String endTime) {
    ...
    public ListPipelineRunsPageStageStatusList withId(String id) {
        this.id = id;
        return this;
    }
