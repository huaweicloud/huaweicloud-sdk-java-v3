...
public class PublishPluginRequest {
    ...
    public PublishPluginRequest withDomainId(String domainId) {
    ...
    public PublishPluginRequest withBody(PublishPluginDTO body) {
        this.body = body;
        return this;
    }

    public PublishPluginRequest withBody(Consumer<PublishPluginDTO> bodySetter) {
        if (this.body == null) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        PublishPluginRequest that = (PublishPluginRequest) obj;
    ...
    public String toString() {
        ...
        sb.append("class PublishPluginRequest {\n");
