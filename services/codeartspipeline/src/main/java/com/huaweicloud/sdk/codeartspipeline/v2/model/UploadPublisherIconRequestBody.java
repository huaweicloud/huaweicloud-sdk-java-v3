 ...
 */
public class UploadPublisherIconRequestBody implements SdkFormDataBody {

    @JsonProperty(value = "upload_file", access = JsonProperty.Access.WRITE_ONLY)

    private FormDataFilePart uploadFile;

    public UploadPublisherIconRequestBody withUploadFile(FormDataFilePart uploadFile) {
    ...
    public UploadPublisherIconRequestBody withUploadFile(InputStream inputStream, String fileName, String contentType) {
        this.uploadFile = new FormDataFilePart(inputStream, fileName).withContentType(contentType);
        return this;
    }

    public UploadPublisherIconRequestBody withUploadFile(InputStream inputStream, String fileName) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        UploadPublisherIconRequestBody that = (UploadPublisherIconRequestBody) obj;
    ...
    public String toString() {
        ...
        sb.append("class UploadPublisherIconRequestBody {\n");
