...
public class ListPipelinesPageLatestRunBuildParams {
    ...
    public ListPipelinesPageLatestRunBuildParams withSourceCodehubId(String sourceCodehubId) {
    ...
    public ListPipelinesPageLatestRunBuildParams withSourceCodehubUrl(String sourceCodehubUrl) {
    ...
    public ListPipelinesPageLatestRunBuildParams withSourceCodehubHttpUrl(String sourceCodehubHttpUrl) {
