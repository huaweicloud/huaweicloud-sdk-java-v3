...
public class PipelineLatestRunBuildParams {
    ...
    public PipelineLatestRunBuildParams withSourceCodehubId(String sourceCodehubId) {
    ...
    public PipelineLatestRunBuildParams withSourceCodehubUrl(String sourceCodehubUrl) {
    ...
    public PipelineLatestRunBuildParams withSourceCodehubHttpUrl(String sourceCodehubHttpUrl) {
