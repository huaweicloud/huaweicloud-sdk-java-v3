 ...
 * Request Object
 */
public class RetryPipelineRunRequest {
    ...
    public RetryPipelineRunRequest withPipelineId(String pipelineId) {
    ...
    public RetryPipelineRunRequest withPipelineRunId(String pipelineRunId) {
    ...
    public String toString() {
        ...
        sb.append("class RetryPipelineRunRequest {\n");
