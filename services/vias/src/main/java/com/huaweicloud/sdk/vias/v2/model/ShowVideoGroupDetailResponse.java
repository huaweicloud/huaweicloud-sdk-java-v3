 ...
 * Response Object
 */
public class ShowVideoGroupDetailResponse extends SdkResponse {
    ...
    public ShowVideoGroupDetailResponse withVideoGroupId(String videoGroupId) {
    ...
    public ShowVideoGroupDetailResponse withVideoGroupName(String videoGroupName) {
    ...
    public ShowVideoGroupDetailResponse withDescription(String description) {
    ...
    public ShowVideoGroupDetailResponse withAccessType(String accessType) {
    ...
    public ShowVideoGroupDetailResponse withCreateAt(Long createAt) {
    ...
    public ShowVideoGroupDetailResponse withModifyAt(Long modifyAt) {
    ...
    public ShowVideoGroupDetailResponse withNumVideoSource(Integer numVideoSource) {
    ...
    public ShowVideoGroupDetailResponse withGroupStatus(GroupStatusDto groupStatus) {
        this.groupStatus = groupStatus;
        return this;
    }

    public ShowVideoGroupDetailResponse withGroupStatus(Consumer<GroupStatusDto> groupStatusSetter) {
    ...
    public ShowVideoGroupDetailResponse withNumBatchTask(Integer numBatchTask) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ShowVideoGroupDetailResponse that = (ShowVideoGroupDetailResponse) obj;
    ...
    public String toString() {
        ...
        sb.append("class ShowVideoGroupDetailResponse {\n");
