...
/**
 * UpdateTasksRequestBody
 */
public class UpdateTasksRequestBody {
    ...
    public UpdateTasksRequestBody withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public UpdateTasksRequestBody withDescription(String description) {
    ...
    public UpdateTasksRequestBody withSchedule(TaskSchedule schedule) {
        this.schedule = schedule;
        return this;
    }

    public UpdateTasksRequestBody withSchedule(Consumer<TaskSchedule> scheduleSetter) {
    ...
    public UpdateTasksRequestBody withInput(TaskInput input) {
        this.input = input;
        return this;
    }

    public UpdateTasksRequestBody withInput(Consumer<TaskInput> inputSetter) {
        if (this.input == null) {
    ...
    public UpdateTasksRequestBody withOutput(TaskOutput output) {
        this.output = output;
        return this;
    }

    public UpdateTasksRequestBody withOutput(Consumer<TaskOutput> outputSetter) {
        if (this.output == null) {
    ...
    public UpdateTasksRequestBody withConfig(TaskServiceConfig config) {
        this.config = config;
        return this;
    }

    public UpdateTasksRequestBody withConfig(Consumer<TaskServiceConfig> configSetter) {
        if (this.config == null) {
    ...
    public UpdateTasksRequestBody withIsSavedAsTemplate(Boolean isSavedAsTemplate) {
    ...
    public UpdateTasksRequestBody withResourceOrderId(String resourceOrderId) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        UpdateTasksRequestBody that = (UpdateTasksRequestBody) obj;
    ...
    @Override
    public int hashCode() {
        return Objects.hash(name, description, schedule, input, output, config, isSavedAsTemplate, resourceOrderId);
    }

    @Override
    public String toString() {
        StringBuilder sb = new StringBuilder();
        sb.append("class UpdateTasksRequestBody {\n");
