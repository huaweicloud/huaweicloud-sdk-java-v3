...
public class ShowTaskDetailResponse extends SdkResponse {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(taskId, taskName, creatorId, gitUrl, gitBranch, lastCheckTime, codeLineTotal, codeLine, codeQuality, issueCount, riskCoefficient, duplicationRatio, complexityCount, duplicatedLines, commentLines, commentRatio, duplicatedBlocks, lastExecTime, checkType, createdAt, cyclomaticComplexityPerMethod, criticalCount, majorCount, minorCount, suggestionCount);
    }
    @Override
    public String toString() {
        ...
        sb.append("    cyclomaticComplexityPerMethod: ").append(toIndentedString(cyclomaticComplexityPerMethod)).append("\n");
