...
public class GetDataPolicyRsp {
    ...
    public GetDataPolicyRsp withDataDelete(Boolean dataDelete) {
    ...
    public GetDataPolicyRsp withDataDownload(Boolean dataDownload) {
    ...
    public GetDataPolicyRsp withDataEncrypted(Boolean dataEncrypted) {
    ...
    public GetDataPolicyRsp withDataShare(Boolean dataShare) {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GetDataPolicyRsp getDataPolicyRsp = (GetDataPolicyRsp) o;
        return Objects.equals(this.dataDelete, getDataPolicyRsp.dataDelete)
            && Objects.equals(this.dataDownload, getDataPolicyRsp.dataDownload)
            && Objects.equals(this.dataEncrypted, getDataPolicyRsp.dataEncrypted)
            && Objects.equals(this.dataShare, getDataPolicyRsp.dataShare);
    }
    ...
    public String toString() {
        ...
        sb.append("class GetDataPolicyRsp {\n");
