 ...
 * Request Object
 */
public class DeleteNextflowWorkflowRequest {
    ...
    public DeleteNextflowWorkflowRequest withEihealthProjectId(String eihealthProjectId) {
    ...
    public DeleteNextflowWorkflowRequest withWorkflowId(String workflowId) {
    ...
    public String toString() {
        ...
        sb.append("class DeleteNextflowWorkflowRequest {\n");
