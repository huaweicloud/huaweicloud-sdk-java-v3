...
/**
 * **参数解释**： 助手模型创建请求体。 **约束限制**： 不涉及 **取值范围**： 不涉及 **默认取值**： 不涉及 
 */
public class CreateAssistantModelReq {
    ...
    public CreateAssistantModelReq withServiceName(String serviceName) {
    ...
    public CreateAssistantModelReq withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public CreateAssistantModelReq withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public CreateAssistantModelReq withModelServiceApi(String modelServiceApi) {
    ...
    public CreateAssistantModelReq withDescription(String description) {
    ...
    public CreateAssistantModelReq withFunctionCall(Boolean functionCall) {
    ...
    public CreateAssistantModelReq withChainOfThought(Boolean chainOfThought) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        CreateAssistantModelReq that = (CreateAssistantModelReq) obj;
        return Objects.equals(this.serviceName, that.serviceName) && Objects.equals(this.name, that.name)
            && Objects.equals(this.type, that.type) && Objects.equals(this.modelServiceApi, that.modelServiceApi)
    ...
    @Override
    public int hashCode() {
        return Objects.hash(serviceName, name, type, modelServiceApi, description, functionCall, chainOfThought);
    }

    @Override
    public String toString() {
        StringBuilder sb = new StringBuilder();
        sb.append("class CreateAssistantModelReq {\n");
