 ...
 * Request Object
 */
public class ShowBackupPathRequest {
    ...
    public ShowBackupPathRequest withBackupId(String backupId) {
    ...
    public ShowBackupPathRequest withEihealthProjectId(String eihealthProjectId) {
    ...
    public String toString() {
        ...
        sb.append("class ShowBackupPathRequest {\n");
