 ...
 * Request Object
 */
public class DownloadDataJobLogRequest {
    ...
    public DownloadDataJobLogRequest withEihealthProjectId(String eihealthProjectId) {
    ...
    public DownloadDataJobLogRequest withDataJobId(String dataJobId) {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(eihealthProjectId, dataJobId);
    }

    @Override
    public String toString() {
        StringBuilder sb = new StringBuilder();
        sb.append("class DownloadDataJobLogRequest {\n");
