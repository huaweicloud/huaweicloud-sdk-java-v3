...
public class ExecuteJobRequest {
    ...
    public ExecuteJobRequest withEihealthProjectId(String eihealthProjectId) {
    ...
    public ExecuteJobRequest withBody(JobDto body) {
        this.body = body;
        return this;
    }

    public ExecuteJobRequest withBody(Consumer<JobDto> bodySetter) {
        if (this.body == null) {
            this.body = new JobDto();
     ...
     * @return body
     */
    public JobDto getBody() {
        return body;
    }

    public void setBody(JobDto body) {
        this.body = body;
    }
