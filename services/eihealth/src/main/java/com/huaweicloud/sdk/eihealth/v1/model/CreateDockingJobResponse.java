 ...
 * Response Object
 */
public class CreateDockingJobResponse extends SdkResponse {
    ...
    public CreateDockingJobResponse withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public CreateDockingJobResponse withLimitConcurrency(Integer limitConcurrency) {
    ...
    public String toString() {
        ...
        sb.append("class CreateDockingJobResponse {\n");
