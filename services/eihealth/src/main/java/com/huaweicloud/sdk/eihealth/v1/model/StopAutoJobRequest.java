 ...
 * Request Object
 */
public class StopAutoJobRequest {
    ...
    public StopAutoJobRequest withEihealthProjectId(String eihealthProjectId) {
    ...
    public StopAutoJobRequest withAutoJobId(String autoJobId) {
    ...
    public String toString() {
        ...
        sb.append("class StopAutoJobRequest {\n");
