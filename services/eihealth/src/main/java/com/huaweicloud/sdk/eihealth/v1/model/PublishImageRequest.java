...
public class PublishImageRequest {
    ...
    public PublishImageRequest withEihealthProjectId(String eihealthProjectId) {
    ...
    public PublishImageRequest withBody(PublishAssetReq body) {
        this.body = body;
        return this;
    }

    public PublishImageRequest withBody(Consumer<PublishAssetReq> bodySetter) {
        if (this.body == null) {
    ...
    public String toString() {
        ...
        sb.append("class PublishImageRequest {\n");
