 ...
 * 自定义属性建模的评估指标
 */
public class CustomPropsModelMetric {
    ...
    public CustomPropsModelMetric withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public CustomPropsModelMetric withValue(Float value) {
        this.value = value;
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append("class CustomPropsModelMetric {\n");
