 ...
 */
public class UpdateVendorRequestBody implements SdkFormDataBody {
    ...
    public UpdateVendorRequestBody withFile(FormDataFilePart file) {
        this.file = file;
        return this;
    }
    ...
    public UpdateVendorRequestBody withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public UpdateVendorRequestBody withFile(InputStream inputStream, String fileName, String contentType) {
        this.file = new FormDataFilePart(inputStream, fileName).withContentType(contentType);
        return this;
    }

    public UpdateVendorRequestBody withFile(InputStream inputStream, String fileName) {
        this.file = new FormDataFilePart(inputStream, fileName);
        return this;
    }

    public UpdateVendorRequestBody withFile(InputStream inputStream, String fileName, Map<String, String> headers) {
    ...
    public String toString() {
        ...
        sb.append("class UpdateVendorRequestBody {\n");
