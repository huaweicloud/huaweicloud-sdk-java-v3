...
public class CreateInstanceRequest {
    ...
    public CreateInstanceRequest withEihealthProjectId(String eihealthProjectId) {
    ...
    public CreateInstanceRequest withBody(CreateDatabaseReq body) {
        this.body = body;
        return this;
    }

    public CreateInstanceRequest withBody(Consumer<CreateDatabaseReq> bodySetter) {
        if (this.body == null) {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        return Objects.equals(this.eihealthProjectId, createInstanceRequest.eihealthProjectId)
