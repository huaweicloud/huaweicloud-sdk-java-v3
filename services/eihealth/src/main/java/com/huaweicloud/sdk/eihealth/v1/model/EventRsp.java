...
public class EventRsp {
    ...
    public EventRsp withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public EventRsp withCount(Integer count) {
        this.count = count;
        return this;
    }
    ...
    public EventRsp withReason(String reason) {
        this.reason = reason;
        return this;
    }
    ...
    public EventRsp withMessage(String message) {
    ...
    public EventRsp withFirstTimestamp(String firstTimestamp) {
    ...
    public EventRsp withLastTimestamp(String lastTimestamp) {
