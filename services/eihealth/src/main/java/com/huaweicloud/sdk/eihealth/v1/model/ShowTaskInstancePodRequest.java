 ...
 * Request Object
 */
public class ShowTaskInstancePodRequest {
    ...
    public ShowTaskInstancePodRequest withEihealthProjectId(String eihealthProjectId) {
    ...
    public ShowTaskInstancePodRequest withJobId(String jobId) {
        this.jobId = jobId;
        return this;
    }
    ...
    public ShowTaskInstancePodRequest withTaskName(String taskName) {
    ...
    public ShowTaskInstancePodRequest withTaskIndex(String taskIndex) {
    ...
    public ShowTaskInstancePodRequest withInstanceName(String instanceName) {
    ...
    public String toString() {
        ...
        sb.append("class ShowTaskInstancePodRequest {\n");
