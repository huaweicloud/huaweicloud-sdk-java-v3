...
public class CreateWorkspaceRequest {
    ...
    public CreateWorkspaceRequest withInstanceId(String instanceId) {
    ...
    public CreateWorkspaceRequest withBody(WorkspaceDTO body) {
        this.body = body;
        return this;
    }

    public CreateWorkspaceRequest withBody(Consumer<WorkspaceDTO> bodySetter) {
        if (this.body == null) {
