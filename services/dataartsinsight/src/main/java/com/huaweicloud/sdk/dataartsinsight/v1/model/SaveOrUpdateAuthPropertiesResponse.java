 ...
 * Response Object
 */
public class SaveOrUpdateAuthPropertiesResponse extends SdkResponse {
    ...
    public SaveOrUpdateAuthPropertiesResponse withAuthSwitchConfig(Map<String, Boolean> authSwitchConfig) {
        this.authSwitchConfig = authSwitchConfig;
        return this;
    }

    public SaveOrUpdateAuthPropertiesResponse putAuthSwitchConfigItem(String key, Boolean authSwitchConfigItem) {
    ...
    public SaveOrUpdateAuthPropertiesResponse withAuthSwitchConfig(
        Consumer<Map<String, Boolean>> authSwitchConfigSetter) {
        if (this.authSwitchConfig == null) {
            this.authSwitchConfig = new HashMap<>();
        }
    ...
    public SaveOrUpdateAuthPropertiesResponse withCreateDate(Long createDate) {
    ...
    public SaveOrUpdateAuthPropertiesResponse withCreateUser(String createUser) {
    ...
    public SaveOrUpdateAuthPropertiesResponse withCreateUserName(String createUserName) {
    ...
    public SaveOrUpdateAuthPropertiesResponse withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public SaveOrUpdateAuthPropertiesResponse withOwner(String owner) {
        this.owner = owner;
        return this;
    }
    ...
    public SaveOrUpdateAuthPropertiesResponse withProjectId(String projectId) {
    ...
    public SaveOrUpdateAuthPropertiesResponse withResourceId(String resourceId) {
    ...
    public SaveOrUpdateAuthPropertiesResponse withResourceType(String resourceType) {
    ...
    public SaveOrUpdateAuthPropertiesResponse withUpdateDate(Long updateDate) {
    ...
    public SaveOrUpdateAuthPropertiesResponse withUpdateUser(String updateUser) {
    ...
    public SaveOrUpdateAuthPropertiesResponse withUpdateUserName(String updateUserName) {
    ...
    public SaveOrUpdateAuthPropertiesResponse withWorkspaceId(String workspaceId) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        SaveOrUpdateAuthPropertiesResponse that = (SaveOrUpdateAuthPropertiesResponse) obj;
    ...
    public String toString() {
        ...
        sb.append("class SaveOrUpdateAuthPropertiesResponse {\n");
