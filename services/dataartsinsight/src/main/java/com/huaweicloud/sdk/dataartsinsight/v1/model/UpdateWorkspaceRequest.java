...
public class UpdateWorkspaceRequest {
    ...
    public UpdateWorkspaceRequest withInstanceId(String instanceId) {
    ...
    public UpdateWorkspaceRequest withBody(WorkspaceDTO body) {
        this.body = body;
        return this;
    }

    public UpdateWorkspaceRequest withBody(Consumer<WorkspaceDTO> bodySetter) {
        if (this.body == null) {
