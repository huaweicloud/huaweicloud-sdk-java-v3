...
public class WorkspaceVO {
    ...
    public WorkspaceVO withConfigs(Map<String, String> configs) {
        this.configs = configs;
        return this;
    }

    public WorkspaceVO putConfigsItem(String key, String configsItem) {
    ...
    public WorkspaceVO withConfigs(Consumer<Map<String, String>> configsSetter) {
        if (this.configs == null) {
            this.configs = new HashMap<>();
        }
    ...
    public WorkspaceVO withCreateTime(Long createTime) {
    ...
    public WorkspaceVO withCreateUser(String createUser) {
    ...
    public WorkspaceVO withDomainId(String domainId) {
    ...
    public WorkspaceVO withEpsId(String epsId) {
        this.epsId = epsId;
        return this;
    }
    ...
    public WorkspaceVO withInstanceId(String instanceId) {
    ...
    public WorkspaceVO withIsDefault(Integer isDefault) {
    ...
    public WorkspaceVO withOwnerName(String ownerName) {
    ...
    public WorkspaceVO withProjectId(String projectId) {
    ...
    public WorkspaceVO withUpdateTime(Long updateTime) {
    ...
    public WorkspaceVO withUpdateUser(String updateUser) {
