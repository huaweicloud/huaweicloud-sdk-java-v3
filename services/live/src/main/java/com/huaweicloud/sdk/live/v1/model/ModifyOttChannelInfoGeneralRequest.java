 ...
 * Request Object
 */
public class ModifyOttChannelInfoGeneralRequest {
    ...
    private ModifyOttChannelGeneral body;

    public ModifyOttChannelInfoGeneralRequest withAccessControlAllowInternal(String accessControlAllowInternal) {
    ...
    public ModifyOttChannelInfoGeneralRequest withAccessControlAllowExternal(String accessControlAllowExternal) {
    ...
    public ModifyOttChannelInfoGeneralRequest withBody(ModifyOttChannelGeneral body) {
        this.body = body;
        return this;
    }

    public ModifyOttChannelInfoGeneralRequest withBody(Consumer<ModifyOttChannelGeneral> bodySetter) {
        if (this.body == null) {
            this.body = new ModifyOttChannelGeneral();
     ...
     * @return body
     */
    public ModifyOttChannelGeneral getBody() {
        return body;
    }

    public void setBody(ModifyOttChannelGeneral body) {
        this.body = body;
    }
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ModifyOttChannelInfoGeneralRequest that = (ModifyOttChannelInfoGeneralRequest) obj;
    ...
    public String toString() {
        ...
        sb.append("class ModifyOttChannelInfoGeneralRequest {\n");
