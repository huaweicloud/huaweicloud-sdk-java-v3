...
public class ModifyOttChannelInfoEncoderSettingsRequest {
    ...
    private ModifyOttChannelEncoderSettings body;

    public ModifyOttChannelInfoEncoderSettingsRequest withAccessControlAllowInternal(
        String accessControlAllowInternal) {
    ...
    public ModifyOttChannelInfoEncoderSettingsRequest withAccessControlAllowExternal(
        String accessControlAllowExternal) {
    ...
    public ModifyOttChannelInfoEncoderSettingsRequest withBody(ModifyOttChannelEncoderSettings body) {
        this.body = body;
        return this;
    }

    public ModifyOttChannelInfoEncoderSettingsRequest withBody(Consumer<ModifyOttChannelEncoderSettings> bodySetter) {
        if (this.body == null) {
            this.body = new ModifyOttChannelEncoderSettings();
     ...
     * @return body
     */
    public ModifyOttChannelEncoderSettings getBody() {
        return body;
    }

    public void setBody(ModifyOttChannelEncoderSettings body) {
        this.body = body;
    }
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ModifyOttChannelInfoEncoderSettingsRequest that = (ModifyOttChannelInfoEncoderSettingsRequest) obj;
