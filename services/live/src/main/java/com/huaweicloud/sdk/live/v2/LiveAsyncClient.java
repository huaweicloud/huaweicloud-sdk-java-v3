...
public class LiveAsyncClient {
    ...
    /** 查询直播拉流HTTP状态码接口 查询直播拉流HTTP状态码接口。 获取加速域名1分钟粒度的HTTP返回码 最大查询跨度不能超过24小时，最大查询周期7天。
     *
    ...
    /** 查询录制用量接口 查询直播租户每小时录制的最大并发数，计算1小时内每分钟的并发总路数，取最大值做为统计值。 最大查询跨度31天，最大查询周期90天。
     *
    ...
    /** 查询截图用量接口 查询直播域名每小时的截图数量。 最大查询跨度31天，最大查询周期90天。
     *
    ...
    /** 查询转码用量接口 查询直播域名每小时的转码时长数据。 最大查询跨度31天，最大查询周期90天。
     *
