...
public class ShowRecordRuleResponse extends SdkResponse {
    ...
    public ShowRecordRuleResponse withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public ShowRecordRuleResponse withPublishDomain(String publishDomain) {
    ...
    public ShowRecordRuleResponse withApp(String app) {
        this.app = app;
        return this;
    }
    ...
    public ShowRecordRuleResponse withStream(String stream) {
        this.stream = stream;
        return this;
    }
    ...
    public ShowRecordRuleResponse withRecordType(RecordTypeEnum recordType) {
    ...
    public ShowRecordRuleResponse withDefaultRecordConfig(Consumer<DefaultRecordConfig> defaultRecordConfigSetter) {
    ...
    public ShowRecordRuleResponse withCreateTime(LocalDate createTime) {
    ...
    public ShowRecordRuleResponse withUpdateTime(LocalDate updateTime) {
