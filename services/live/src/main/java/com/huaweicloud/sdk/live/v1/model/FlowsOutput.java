...
public class FlowsOutput {
    ...
    public FlowsOutput withCidrWhitelist(List<String> cidrWhitelist) {
        this.cidrWhitelist = cidrWhitelist;
        return this;
    }

    public FlowsOutput addCidrWhitelistItem(String cidrWhitelistItem) {
    ...
    public FlowsOutput withCidrWhitelist(Consumer<List<String>> cidrWhitelistSetter) {
        if (this.cidrWhitelist == null) {
            this.cidrWhitelist = new ArrayList<>();
        }
    ...
    public FlowsOutput withDestination(String destination) {
    ...
    public FlowsOutput withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public FlowsOutput withEncryption(FlowSourceDecryption encryption) {
        this.encryption = encryption;
        return this;
    }

    public FlowsOutput withEncryption(Consumer<FlowSourceDecryption> encryptionSetter) {
    ...
    public FlowsOutput withOutputStatus(OutputStatusEnum outputStatus) {
    ...
    public FlowsOutput withListenerAddress(String listenerAddress) {
    ...
    public FlowsOutput withPort(Integer port) {
        this.port = port;
        return this;
    }
    ...
    public FlowsOutput withProtocol(ProtocolEnum protocol) {
    ...
    public FlowsOutput withStreamId(String streamId) {
    ...
    public FlowsOutput withDescription(String description) {
    ...
    public FlowsOutput withMinLatency(Integer minLatency) {
    ...
    public FlowsOutput withHealthStatus(HealthStatusEnum healthStatus) {
    ...
    public FlowsOutput withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        FlowsOutput that = (FlowsOutput) obj;
