 ...
 * Request Object
 */
public class ModifyOttChannelInfoEndPointsRequest {
    ...
    private ModifyOttChannelEndPointsReq body;

    public ModifyOttChannelInfoEndPointsRequest withAccessControlAllowInternal(String accessControlAllowInternal) {
    ...
    public ModifyOttChannelInfoEndPointsRequest withAccessControlAllowExternal(String accessControlAllowExternal) {
    ...
    public ModifyOttChannelInfoEndPointsRequest withBody(ModifyOttChannelEndPointsReq body) {
        this.body = body;
        return this;
    }

    public ModifyOttChannelInfoEndPointsRequest withBody(Consumer<ModifyOttChannelEndPointsReq> bodySetter) {
        if (this.body == null) {
            this.body = new ModifyOttChannelEndPointsReq();
     ...
     * @return body
     */
    public ModifyOttChannelEndPointsReq getBody() {
        return body;
    }

    public void setBody(ModifyOttChannelEndPointsReq body) {
        this.body = body;
    }
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ModifyOttChannelInfoEndPointsRequest that = (ModifyOttChannelInfoEndPointsRequest) obj;
    ...
    public String toString() {
        ...
        sb.append("class ModifyOttChannelInfoEndPointsRequest {\n");
