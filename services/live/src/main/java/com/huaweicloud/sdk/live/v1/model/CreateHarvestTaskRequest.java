...
public class CreateHarvestTaskRequest {
    ...
    private CreateHarvestTaskInfoReq body;

    public CreateHarvestTaskRequest withAccessControlAllowInternal(String accessControlAllowInternal) {
    ...
    public CreateHarvestTaskRequest withAccessControlAllowExternal(String accessControlAllowExternal) {
    ...
    public CreateHarvestTaskRequest withBody(CreateHarvestTaskInfoReq body) {
        this.body = body;
        return this;
    }

    public CreateHarvestTaskRequest withBody(Consumer<CreateHarvestTaskInfoReq> bodySetter) {
        if (this.body == null) {
            this.body = new CreateHarvestTaskInfoReq();
     ...
     * @return body
     */
    public CreateHarvestTaskInfoReq getBody() {
        return body;
    }

    public void setBody(CreateHarvestTaskInfoReq body) {
        this.body = body;
    }
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        CreateHarvestTaskRequest that = (CreateHarvestTaskRequest) obj;
