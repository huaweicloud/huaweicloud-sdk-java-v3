 ...
 * Response Object
 */
public class UpdateWatermarkTemplateResponse extends SdkResponse {
    ...
    public UpdateWatermarkTemplateResponse withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public UpdateWatermarkTemplateResponse withType(Integer type) {
        this.type = type;
        return this;
    }
    ...
    public UpdateWatermarkTemplateResponse withDescription(String description) {
    ...
    public UpdateWatermarkTemplateResponse withPictureUrl(String pictureUrl) {
    ...
    public UpdateWatermarkTemplateResponse withWidth(BigDecimal width) {
        this.width = width;
        return this;
    }
    ...
    public UpdateWatermarkTemplateResponse withHeight(BigDecimal height) {
        this.height = height;
        return this;
    }
    ...
    public UpdateWatermarkTemplateResponse withLocation(WatermarkLocation location) {
        this.location = location;
        return this;
    }

    public UpdateWatermarkTemplateResponse withLocation(Consumer<WatermarkLocation> locationSetter) {
    ...
    public UpdateWatermarkTemplateResponse withText(WordWaterMarkInfo text) {
        this.text = text;
        return this;
    }

    public UpdateWatermarkTemplateResponse withText(Consumer<WordWaterMarkInfo> textSetter) {
        if (this.text == null) {
    ...
    public UpdateWatermarkTemplateResponse withScene(SceneEnum scene) {
        this.scene = scene;
        return this;
    }
    ...
    public UpdateWatermarkTemplateResponse withXRequestId(String xRequestId) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        UpdateWatermarkTemplateResponse that = (UpdateWatermarkTemplateResponse) obj;
    ...
    public String toString() {
        ...
        sb.append("class UpdateWatermarkTemplateResponse {\n");
