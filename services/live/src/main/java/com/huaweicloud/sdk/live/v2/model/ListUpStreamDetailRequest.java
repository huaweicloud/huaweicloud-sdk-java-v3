 ...
 * Request Object
 */
public class ListUpStreamDetailRequest {
    ...
    public ListUpStreamDetailRequest withPublishDomain(String publishDomain) {
    ...
    public ListUpStreamDetailRequest withApp(String app) {
        this.app = app;
        return this;
    }
    ...
    public ListUpStreamDetailRequest withStream(String stream) {
        this.stream = stream;
        return this;
    }
    ...
    public ListUpStreamDetailRequest withStartTime(String startTime) {
    ...
    public ListUpStreamDetailRequest withEndTime(String endTime) {
    ...
    public String toString() {
        ...
        sb.append("class ListUpStreamDetailRequest {\n");
