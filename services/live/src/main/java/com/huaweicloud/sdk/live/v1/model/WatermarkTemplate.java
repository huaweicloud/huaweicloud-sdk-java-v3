...
public class WatermarkTemplate {
    ...
    public WatermarkTemplate withType(Integer type) {
        this.type = type;
        return this;
    }
    ...
    public WatermarkTemplate withDescription(String description) {
    ...
    public WatermarkTemplate withPictureUrl(String pictureUrl) {
    ...
    public WatermarkTemplate withWidth(BigDecimal width) {
        this.width = width;
        return this;
    }
    ...
    public WatermarkTemplate withHeight(BigDecimal height) {
        this.height = height;
        return this;
    }
    ...
    public WatermarkTemplate withLocation(WatermarkLocation location) {
        this.location = location;
        return this;
    }

    public WatermarkTemplate withLocation(Consumer<WatermarkLocation> locationSetter) {
    ...
    public WatermarkTemplate withText(WordWaterMarkInfo text) {
        this.text = text;
        return this;
    }

    public WatermarkTemplate withText(Consumer<WordWaterMarkInfo> textSetter) {
        if (this.text == null) {
    ...
    public WatermarkTemplate withScene(SceneEnum scene) {
        this.scene = scene;
        return this;
    }
    ...
    @Override
    public int hashCode() {
        return Objects.hash(name, type, description, pictureUrl, width, height, location, text, scene);
    }
