...
public class SetRefererChainInfo {
    ...
    public SetRefererChainInfo withDomain(String domain) {
        this.domain = domain;
        return this;
    }
    ...
    public SetRefererChainInfo withGuardSwitch(GuardSwitchEnum guardSwitch) {
    ...
    public SetRefererChainInfo withRefererConfigEmpty(RefererConfigEmptyEnum refererConfigEmpty) {
    ...
    public SetRefererChainInfo withRefererWhiteList(RefererWhiteListEnum refererWhiteList) {
    ...
    public SetRefererChainInfo withRefererAuthList(List<String> refererAuthList) {
        this.refererAuthList = refererAuthList;
        return this;
    }

    public SetRefererChainInfo addRefererAuthListItem(String refererAuthListItem) {
    ...
    public SetRefererChainInfo withRefererAuthList(Consumer<List<String>> refererAuthListSetter) {
        if (this.refererAuthList == null) {
            this.refererAuthList = new ArrayList<>();
        }
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        SetRefererChainInfo that = (SetRefererChainInfo) obj;
