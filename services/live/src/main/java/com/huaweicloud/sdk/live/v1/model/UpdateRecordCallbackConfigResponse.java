 ...
 * Response Object
 */
public class UpdateRecordCallbackConfigResponse extends SdkResponse {
    ...
    */
    ...
    public UpdateRecordCallbackConfigResponse withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public UpdateRecordCallbackConfigResponse withPublishDomain(String publishDomain) {
    ...
    public UpdateRecordCallbackConfigResponse withApp(String app) {
        this.app = app;
        return this;
    }
    ...
    public UpdateRecordCallbackConfigResponse withNotifyCallbackUrl(String notifyCallbackUrl) {
    ...
    public UpdateRecordCallbackConfigResponse withNotifyEventSubscription(
        List<NotifyEventSubscriptionEnum> notifyEventSubscription) {
        this.notifyEventSubscription = notifyEventSubscription;
        return this;
    }

    public UpdateRecordCallbackConfigResponse addNotifyEventSubscriptionItem(
    ...
    public UpdateRecordCallbackConfigResponse withSignType(SignTypeEnum signType) {
    ...
    public UpdateRecordCallbackConfigResponse withCreateTime(LocalDate createTime) {
    ...
    public UpdateRecordCallbackConfigResponse withUpdateTime(LocalDate updateTime) {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        UpdateRecordCallbackConfigResponse updateRecordCallbackConfigResponse = (UpdateRecordCallbackConfigResponse) o;
        return Objects.equals(this.id, updateRecordCallbackConfigResponse.id)
            && Objects.equals(this.publishDomain, updateRecordCallbackConfigResponse.publishDomain)
            && Objects.equals(this.app, updateRecordCallbackConfigResponse.app)
            && Objects.equals(this.notifyCallbackUrl, updateRecordCallbackConfigResponse.notifyCallbackUrl)
            && Objects.equals(this.notifyEventSubscription, updateRecordCallbackConfigResponse.notifyEventSubscription)
            && Objects.equals(this.signType, updateRecordCallbackConfigResponse.signType)
            && Objects.equals(this.createTime, updateRecordCallbackConfigResponse.createTime)
            && Objects.equals(this.updateTime, updateRecordCallbackConfigResponse.updateTime);
    }
    ...
    public String toString() {
        ...
        sb.append("class UpdateRecordCallbackConfigResponse {\n");
