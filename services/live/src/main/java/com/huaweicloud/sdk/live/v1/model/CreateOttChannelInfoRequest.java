 ...
 * Request Object
 */
public class CreateOttChannelInfoRequest {
    ...
    private CreateOttChannelInfoReq body;

    public CreateOttChannelInfoRequest withAccessControlAllowInternal(String accessControlAllowInternal) {
    ...
    public CreateOttChannelInfoRequest withAccessControlAllowExternal(String accessControlAllowExternal) {
    ...
    public CreateOttChannelInfoRequest withBody(CreateOttChannelInfoReq body) {
        this.body = body;
        return this;
    }

    public CreateOttChannelInfoRequest withBody(Consumer<CreateOttChannelInfoReq> bodySetter) {
        if (this.body == null) {
            this.body = new CreateOttChannelInfoReq();
     ...
     * @return body
     */
    public CreateOttChannelInfoReq getBody() {
        return body;
    }

    public void setBody(CreateOttChannelInfoReq body) {
        this.body = body;
    }
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        CreateOttChannelInfoRequest that = (CreateOttChannelInfoRequest) obj;
    ...
    public String toString() {
        ...
        sb.append("class CreateOttChannelInfoRequest {\n");
