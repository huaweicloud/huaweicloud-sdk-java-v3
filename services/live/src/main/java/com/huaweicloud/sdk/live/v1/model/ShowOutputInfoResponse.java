...
public class ShowOutputInfoResponse extends SdkResponse {
    ...
    public ShowOutputInfoResponse withCidrWhitelist(List<String> cidrWhitelist) {
        this.cidrWhitelist = cidrWhitelist;
        return this;
    }

    public ShowOutputInfoResponse addCidrWhitelistItem(String cidrWhitelistItem) {
    ...
    public ShowOutputInfoResponse withCidrWhitelist(Consumer<List<String>> cidrWhitelistSetter) {
        if (this.cidrWhitelist == null) {
            this.cidrWhitelist = new ArrayList<>();
        }
    ...
    public ShowOutputInfoResponse withDestination(String destination) {
    ...
    public ShowOutputInfoResponse withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public ShowOutputInfoResponse withEncryption(FlowSourceDecryption encryption) {
        this.encryption = encryption;
        return this;
    }

    public ShowOutputInfoResponse withEncryption(Consumer<FlowSourceDecryption> encryptionSetter) {
    ...
    public ShowOutputInfoResponse withOutputStatus(OutputStatusEnum outputStatus) {
    ...
    public ShowOutputInfoResponse withListenerAddress(String listenerAddress) {
    ...
    public ShowOutputInfoResponse withPort(Integer port) {
        this.port = port;
        return this;
    }
    ...
    public ShowOutputInfoResponse withProtocol(ProtocolEnum protocol) {
    ...
    public ShowOutputInfoResponse withStreamId(String streamId) {
    ...
    public ShowOutputInfoResponse withDescription(String description) {
    ...
    public ShowOutputInfoResponse withMinLatency(Integer minLatency) {
    ...
    public ShowOutputInfoResponse withHealthStatus(HealthStatusEnum healthStatus) {
    ...
    public ShowOutputInfoResponse withType(String type) {
        this.type = type;
        return this;
    }
