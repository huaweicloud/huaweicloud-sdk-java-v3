...
public class ModifyHarvestTaskRequest {
    ...
    private ModifyHarvestTaskRequestBody body;

    public ModifyHarvestTaskRequest withAccessControlAllowInternal(String accessControlAllowInternal) {
    ...
    public ModifyHarvestTaskRequest withAccessControlAllowExternal(String accessControlAllowExternal) {
    ...
    public ModifyHarvestTaskRequest withBody(ModifyHarvestTaskRequestBody body) {
        this.body = body;
        return this;
    }

    public ModifyHarvestTaskRequest withBody(Consumer<ModifyHarvestTaskRequestBody> bodySetter) {
        if (this.body == null) {
            this.body = new ModifyHarvestTaskRequestBody();
     ...
     * @return body
     */
    public ModifyHarvestTaskRequestBody getBody() {
        return body;
    }

    public void setBody(ModifyHarvestTaskRequestBody body) {
        this.body = body;
    }
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ModifyHarvestTaskRequest that = (ModifyHarvestTaskRequest) obj;
