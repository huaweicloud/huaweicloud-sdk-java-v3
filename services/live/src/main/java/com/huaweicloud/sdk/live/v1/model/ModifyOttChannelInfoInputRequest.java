 ...
 * Request Object
 */
public class ModifyOttChannelInfoInputRequest {
    ...
    private ModifyOttChannelInputReq body;

    public ModifyOttChannelInfoInputRequest withAccessControlAllowInternal(String accessControlAllowInternal) {
    ...
    public ModifyOttChannelInfoInputRequest withAccessControlAllowExternal(String accessControlAllowExternal) {
    ...
    public ModifyOttChannelInfoInputRequest withBody(ModifyOttChannelInputReq body) {
        this.body = body;
        return this;
    }

    public ModifyOttChannelInfoInputRequest withBody(Consumer<ModifyOttChannelInputReq> bodySetter) {
        if (this.body == null) {
            this.body = new ModifyOttChannelInputReq();
     ...
     * @return body
     */
    public ModifyOttChannelInputReq getBody() {
        return body;
    }

    public void setBody(ModifyOttChannelInputReq body) {
        this.body = body;
    }
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ModifyOttChannelInfoInputRequest that = (ModifyOttChannelInfoInputRequest) obj;
    ...
    public String toString() {
        ...
        sb.append("class ModifyOttChannelInfoInputRequest {\n");
