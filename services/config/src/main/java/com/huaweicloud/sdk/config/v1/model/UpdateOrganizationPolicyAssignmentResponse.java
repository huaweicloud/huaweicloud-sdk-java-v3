 ...
 * Response Object
 */
public class UpdateOrganizationPolicyAssignmentResponse extends SdkResponse {
    ...
    public UpdateOrganizationPolicyAssignmentResponse withOwnerId(String ownerId) {
    ...
    public UpdateOrganizationPolicyAssignmentResponse withOrganizationId(String organizationId) {
    ...
    public UpdateOrganizationPolicyAssignmentResponse withOrganizationPolicyAssignmentUrn(
    ...
    public UpdateOrganizationPolicyAssignmentResponse withOrganizationPolicyAssignmentId(
    ...
    public UpdateOrganizationPolicyAssignmentResponse withOrganizationPolicyAssignmentName(
    ...
    public UpdateOrganizationPolicyAssignmentResponse withDescription(String description) {
    ...
    public UpdateOrganizationPolicyAssignmentResponse withPeriod(String period) {
        this.period = period;
        return this;
    }
    ...
    public UpdateOrganizationPolicyAssignmentResponse withPolicyFilter(PolicyFilterDefinition policyFilter) {
        this.policyFilter = policyFilter;
        return this;
    }

    public UpdateOrganizationPolicyAssignmentResponse withPolicyFilter(
    ...
    public UpdateOrganizationPolicyAssignmentResponse withPolicyFilterV2(PolicyFilterDefinitionV2 policyFilterV2) {
        this.policyFilterV2 = policyFilterV2;
        return this;
    }

    public UpdateOrganizationPolicyAssignmentResponse withPolicyFilterV2(
    ...
    public UpdateOrganizationPolicyAssignmentResponse withParameters(Map<String, PolicyParameterValue> parameters) {
        this.parameters = parameters;
        return this;
    }

    public UpdateOrganizationPolicyAssignmentResponse putParametersItem(String key,
    ...
    public UpdateOrganizationPolicyAssignmentResponse withParameters(
    ...
    public UpdateOrganizationPolicyAssignmentResponse withPolicyDefinitionId(String policyDefinitionId) {
    ...
    public UpdateOrganizationPolicyAssignmentResponse withCreatedAt(String createdAt) {
    ...
    public UpdateOrganizationPolicyAssignmentResponse withUpdatedAt(String updatedAt) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        UpdateOrganizationPolicyAssignmentResponse that = (UpdateOrganizationPolicyAssignmentResponse) obj;
