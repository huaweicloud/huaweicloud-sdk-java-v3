...
public class RemediationConfigurationRequestBody {
    ...
    public RemediationConfigurationRequestBody withTargetRegionId(String targetRegionId) {
    ...
    public RemediationConfigurationRequestBody withTargetProjectId(String targetProjectId) {
