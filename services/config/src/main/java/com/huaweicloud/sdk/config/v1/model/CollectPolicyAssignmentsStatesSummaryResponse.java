 ...
 * Response Object
 */
public class CollectPolicyAssignmentsStatesSummaryResponse extends SdkResponse {
    ...
    public CollectPolicyAssignmentsStatesSummaryResponse withComplianceState(String complianceState) {
    ...
    public CollectPolicyAssignmentsStatesSummaryResponse withPolicyAssignment(PolicyAssignment policyAssignment) {
        this.policyAssignment = policyAssignment;
        return this;
    }

    public CollectPolicyAssignmentsStatesSummaryResponse withPolicyAssignment(
        Consumer<PolicyAssignment> policyAssignmentSetter) {
    ...
    public CollectPolicyAssignmentsStatesSummaryResponse withResults(PolicyComplianceSummaryResults results) {
        this.results = results;
        return this;
    }

    public CollectPolicyAssignmentsStatesSummaryResponse withResults(
        Consumer<PolicyComplianceSummaryResults> resultsSetter) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        CollectPolicyAssignmentsStatesSummaryResponse that = (CollectPolicyAssignmentsStatesSummaryResponse) obj;
