 ...
 * Response Object
 */
public class CreateConformancePackResponse extends SdkResponse {
    ...
    public CreateConformancePackResponse withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public CreateConformancePackResponse withStackId(String stackId) {
    ...
    public CreateConformancePackResponse withStackName(String stackName) {
    ...
    public CreateConformancePackResponse withDeploymentId(String deploymentId) {
    ...
    public CreateConformancePackResponse withCreatedAt(String createdAt) {
    ...
    public CreateConformancePackResponse withUpdatedAt(String updatedAt) {
    ...
    public CreateConformancePackResponse withTemplateKey(String templateKey) {
    ...
    public CreateConformancePackResponse withTemplateUri(String templateUri) {
    ...
    public CreateConformancePackResponse withAgencyName(String agencyName) {
    ...
    public CreateConformancePackResponse withStatus(StatusEnum status) {
        this.status = status;
        return this;
    }
    ...
    public CreateConformancePackResponse withErrorMessage(String errorMessage) {
    ...
    public CreateConformancePackResponse withVarsStructure(List<VarsStructure> varsStructure) {
        this.varsStructure = varsStructure;
        return this;
    }

    public CreateConformancePackResponse addVarsStructureItem(VarsStructure varsStructureItem) {
    ...
    public CreateConformancePackResponse withVarsStructure(Consumer<List<VarsStructure>> varsStructureSetter) {
        if (this.varsStructure == null) {
            this.varsStructure = new ArrayList<>();
        }
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        CreateConformancePackResponse that = (CreateConformancePackResponse) obj;
    ...
    public String toString() {
        ...
        sb.append("class CreateConformancePackResponse {\n");
