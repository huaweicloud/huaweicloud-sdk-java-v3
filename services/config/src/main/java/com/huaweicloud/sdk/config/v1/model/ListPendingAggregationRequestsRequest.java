...
public class ListPendingAggregationRequestsRequest {
    ...
    public ListPendingAggregationRequestsRequest withAccountId(String accountId) {
    ...
    public ListPendingAggregationRequestsRequest withLimit(Integer limit) {
        this.limit = limit;
        return this;
    }
    ...
    public ListPendingAggregationRequestsRequest withMarker(String marker) {
        this.marker = marker;
        return this;
    }
