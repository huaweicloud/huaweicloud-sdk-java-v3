...
public class ListPolicyAssignmentsRequest {
    ...
    public ListPolicyAssignmentsRequest withPolicyAssignmentName(String policyAssignmentName) {
    ...
    public ListPolicyAssignmentsRequest withLimit(Integer limit) {
        this.limit = limit;
        return this;
    }
    ...
    public ListPolicyAssignmentsRequest withMarker(String marker) {
        this.marker = marker;
        return this;
    }
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ListPolicyAssignmentsRequest that = (ListPolicyAssignmentsRequest) obj;
        return Objects.equals(this.policyAssignmentName, that.policyAssignmentName)
            && Objects.equals(this.limit, that.limit) && Objects.equals(this.marker, that.marker);
    }

    @Override
    public int hashCode() {
        return Objects.hash(policyAssignmentName, limit, marker);
    }
