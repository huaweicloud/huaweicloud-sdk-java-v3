 ...
 * Response Object
 */
public class UpdateConformancePackResponse extends SdkResponse {
    ...
    public UpdateConformancePackResponse withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public UpdateConformancePackResponse withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public UpdateConformancePackResponse withStackId(String stackId) {
    ...
    public UpdateConformancePackResponse withStackName(String stackName) {
    ...
    public UpdateConformancePackResponse withDeploymentId(String deploymentId) {
    ...
    public UpdateConformancePackResponse withCreatedAt(String createdAt) {
    ...
    public UpdateConformancePackResponse withUpdatedAt(String updatedAt) {
    ...
    public UpdateConformancePackResponse withTemplateKey(String templateKey) {
    ...
    public UpdateConformancePackResponse withTemplateUri(String templateUri) {
    ...
    public UpdateConformancePackResponse withAgencyName(String agencyName) {
    ...
    public UpdateConformancePackResponse withStatus(StatusEnum status) {
        this.status = status;
        return this;
    }
    ...
    public UpdateConformancePackResponse withErrorMessage(String errorMessage) {
    ...
    public UpdateConformancePackResponse withVarsStructure(List<VarsStructure> varsStructure) {
        this.varsStructure = varsStructure;
        return this;
    }

    public UpdateConformancePackResponse addVarsStructureItem(VarsStructure varsStructureItem) {
    ...
    public UpdateConformancePackResponse withVarsStructure(Consumer<List<VarsStructure>> varsStructureSetter) {
        if (this.varsStructure == null) {
            this.varsStructure = new ArrayList<>();
        }
    ...
    public UpdateConformancePackResponse withCreatedBy(String createdBy) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        UpdateConformancePackResponse that = (UpdateConformancePackResponse) obj;
    ...
    public String toString() {
        ...
        sb.append("class UpdateConformancePackResponse {\n");
