...
public class CollectConformancePackComplianceSummaryRequest {
    ...
    public CollectConformancePackComplianceSummaryRequest withLimit(Integer limit) {
        this.limit = limit;
        return this;
    }
    ...
    public CollectConformancePackComplianceSummaryRequest withMarker(String marker) {
        this.marker = marker;
        return this;
    }
    ...
    public CollectConformancePackComplianceSummaryRequest withConformancePackName(String conformancePackName) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        CollectConformancePackComplianceSummaryRequest that = (CollectConformancePackComplianceSummaryRequest) obj;
    ...
    @Override
    public int hashCode() {
        return Objects.hash(limit, marker, conformancePackName);
    }
