 ...
 * Response Object
 */
public class UpdateStoredQueryResponse extends SdkResponse {
    ...
    public UpdateStoredQueryResponse withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public UpdateStoredQueryResponse withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public UpdateStoredQueryResponse withType(TypeEnum type) {
        this.type = type;
        return this;
    }
    ...
    public UpdateStoredQueryResponse withDescription(String description) {
    ...
    public UpdateStoredQueryResponse withExpression(String expression) {
    ...
    public UpdateStoredQueryResponse withCreated(String created) {
    ...
    public UpdateStoredQueryResponse withUpdated(String updated) {
    ...
    public String toString() {
        ...
        sb.append("class UpdateStoredQueryResponse {\n");
