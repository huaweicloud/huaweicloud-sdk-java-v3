...
public class PolicyDefinition {
    ...
    public PolicyDefinition withDisplayName(String displayName) {
    ...
    public PolicyDefinition withDefaultResourceTypes(List<PolicyDefinitionDefaultResourceTypes> defaultResourceTypes) {
        this.defaultResourceTypes = defaultResourceTypes;
        return this;
    }

    public PolicyDefinition addDefaultResourceTypesItem(PolicyDefinitionDefaultResourceTypes defaultResourceTypesItem) {
    ...
    public PolicyDefinition withDefaultResourceTypes(
