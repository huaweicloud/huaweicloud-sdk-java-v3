...
public class UpdatePolicyAssignmentResponse extends SdkResponse {
    ...
    public UpdatePolicyAssignmentResponse withPolicyAssignmentType(PolicyAssignmentTypeEnum policyAssignmentType) {
    ...
    public UpdatePolicyAssignmentResponse withPolicyFilterV2(PolicyFilterDefinitionV2 policyFilterV2) {
        this.policyFilterV2 = policyFilterV2;
        return this;
    }

    public UpdatePolicyAssignmentResponse withPolicyFilterV2(Consumer<PolicyFilterDefinitionV2> policyFilterV2Setter) {
    ...
    public UpdatePolicyAssignmentResponse withCustomPolicy(CustomPolicy customPolicy) {
        this.customPolicy = customPolicy;
        return this;
    }

    public UpdatePolicyAssignmentResponse withCustomPolicy(Consumer<CustomPolicy> customPolicySetter) {
    ...
    public UpdatePolicyAssignmentResponse withTags(List<ResourceTag> tags) {
        this.tags = tags;
        return this;
    }

    public UpdatePolicyAssignmentResponse addTagsItem(ResourceTag tagsItem) {
        if (this.tags == null) {
    ...
    public UpdatePolicyAssignmentResponse withTags(Consumer<List<ResourceTag>> tagsSetter) {
        if (this.tags == null) {
            this.tags = new ArrayList<>();
        }
    ...
    public UpdatePolicyAssignmentResponse withCreatedBy(String createdBy) {
    ...
    public UpdatePolicyAssignmentResponse withTargetType(String targetType) {
    ...
    public UpdatePolicyAssignmentResponse withTargetId(String targetId) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        UpdatePolicyAssignmentResponse that = (UpdatePolicyAssignmentResponse) obj;
