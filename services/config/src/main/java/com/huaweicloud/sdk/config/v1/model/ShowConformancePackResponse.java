 ...
 * Response Object
 */
public class ShowConformancePackResponse extends SdkResponse {
    ...
    public ShowConformancePackResponse withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public ShowConformancePackResponse withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public ShowConformancePackResponse withStackId(String stackId) {
    ...
    public ShowConformancePackResponse withStackName(String stackName) {
    ...
    public ShowConformancePackResponse withDeploymentId(String deploymentId) {
    ...
    public ShowConformancePackResponse withCreatedAt(String createdAt) {
    ...
    public ShowConformancePackResponse withUpdatedAt(String updatedAt) {
    ...
    public ShowConformancePackResponse withErrorMessage(String errorMessage) {
    ...
    public ShowConformancePackResponse withVarsStructure(List<VarsStructure> varsStructure) {
        this.varsStructure = varsStructure;
        return this;
    }

    public ShowConformancePackResponse addVarsStructureItem(VarsStructure varsStructureItem) {
    ...
    public ShowConformancePackResponse withVarsStructure(Consumer<List<VarsStructure>> varsStructureSetter) {
        if (this.varsStructure == null) {
            this.varsStructure = new ArrayList<>();
        }
    ...
    public ShowConformancePackResponse withCreatedBy(String createdBy) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ShowConformancePackResponse that = (ShowConformancePackResponse) obj;
    ...
    public String toString() {
        ...
        sb.append("class ShowConformancePackResponse {\n");
