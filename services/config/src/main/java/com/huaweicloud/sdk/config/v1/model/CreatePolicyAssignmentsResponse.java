...
public class CreatePolicyAssignmentsResponse extends SdkResponse {
    ...
    public CreatePolicyAssignmentsResponse withPolicyFilterV2(PolicyFilterDefinitionV2 policyFilterV2) {
        this.policyFilterV2 = policyFilterV2;
        return this;
    }

    public CreatePolicyAssignmentsResponse withPolicyFilterV2(Consumer<PolicyFilterDefinitionV2> policyFilterV2Setter) {
    ...
    public CreatePolicyAssignmentsResponse withTags(List<ResourceTag> tags) {
        this.tags = tags;
        return this;
    }

    public CreatePolicyAssignmentsResponse addTagsItem(ResourceTag tagsItem) {
        if (this.tags == null) {
    ...
    public CreatePolicyAssignmentsResponse withTags(Consumer<List<ResourceTag>> tagsSetter) {
        if (this.tags == null) {
            this.tags = new ArrayList<>();
        }
    ...
    public CreatePolicyAssignmentsResponse withCreatedBy(String createdBy) {
