...
public class CollectPolicyAssignmentsStatesSummaryRequest {
    ...
    public CollectPolicyAssignmentsStatesSummaryRequest withPolicyAssignmentId(String policyAssignmentId) {
    ...
    public CollectPolicyAssignmentsStatesSummaryRequest withResourceName(String resourceName) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        CollectPolicyAssignmentsStatesSummaryRequest that = (CollectPolicyAssignmentsStatesSummaryRequest) obj;
    ...
    @Override
    public int hashCode() {
        return Objects.hash(policyAssignmentId, resourceName);
    }
