...
public class ConformancePack {
    ...
    public ConformancePack withTemplateKey(String templateKey) {
    ...
    public ConformancePack withTemplateUri(String templateUri) {
    ...
    public ConformancePack withAgencyName(String agencyName) {
