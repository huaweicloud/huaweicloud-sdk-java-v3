...
public class UnTagResourceRequest {
    ...
    private UnTagsReq body;

    public UnTagResourceRequest withResourceType(ResourceTypeEnum resourceType) {
    ...
    public UnTagResourceRequest withBody(UnTagsReq body) {
        this.body = body;
        return this;
    }

    public UnTagResourceRequest withBody(Consumer<UnTagsReq> bodySetter) {
        if (this.body == null) {
            this.body = new UnTagsReq();
     ...
     * @return body
     */
    public UnTagsReq getBody() {
        return body;
    }

    public void setBody(UnTagsReq body) {
        this.body = body;
    }
