...
public class PolicyParameterDefinition {
    ...
    public PolicyParameterDefinition withMinimum(Float minimum) {
    ...
    public PolicyParameterDefinition withMaximum(Float maximum) {
    ...
    public PolicyParameterDefinition withMinItems(Integer minItems) {
    ...
    public PolicyParameterDefinition withMaxItems(Integer maxItems) {
    ...
    public PolicyParameterDefinition withMinLength(Integer minLength) {
    ...
    public PolicyParameterDefinition withMaxLength(Integer maxLength) {
    ...
    public PolicyParameterDefinition withPattern(String pattern) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        PolicyParameterDefinition that = (PolicyParameterDefinition) obj;
        return Objects.equals(this.name, that.name) && Objects.equals(this.description, that.description)
            && Objects.equals(this.allowedValues, that.allowedValues)
            && Objects.equals(this.defaultValue, that.defaultValue) && Objects.equals(this.minimum, that.minimum)
