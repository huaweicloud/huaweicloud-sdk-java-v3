 ...
 */
public class GithubOauth2ProviderConfigOutput {
    ...
    public GithubOauth2ProviderConfigOutput withOauth2Discovery(Oauth2Discovery oauth2Discovery) {
        this.oauth2Discovery = oauth2Discovery;
        return this;
    }

    public GithubOauth2ProviderConfigOutput withOauth2Discovery(Consumer<Oauth2Discovery> oauth2DiscoverySetter) {
    ...
    public GithubOauth2ProviderConfigOutput withClientId(String clientId) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        GithubOauth2ProviderConfigOutput that = (GithubOauth2ProviderConfigOutput) obj;
    ...
    public String toString() {
        ...
        sb.append("class GithubOauth2ProviderConfigOutput {\n");
