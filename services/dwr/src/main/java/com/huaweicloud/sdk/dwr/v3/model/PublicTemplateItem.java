...
public class PublicTemplateItem {
    ...
    public PublicTemplateItem withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public PublicTemplateItem withCategory(CategoryEnum category) {
    ...
    public PublicTemplateItem withRegisterStatus(PublicTemplateRegisterType registerStatus) {
    ...
    public PublicTemplateItem withProviderName(String providerName) {
    ...
    public PublicTemplateItem withDescription(String description) {
    ...
    public PublicTemplateItem withCreateTime(String createTime) {
    ...
    public PublicTemplateItem withLastModifyTime(String lastModifyTime) {
