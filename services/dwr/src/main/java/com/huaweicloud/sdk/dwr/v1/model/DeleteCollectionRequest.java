...
public class DeleteCollectionRequest {
    ...
    public DeleteCollectionRequest withBody(CollectionBaseInfo body) {
        this.body = body;
        return this;
    }

    public DeleteCollectionRequest withBody(Consumer<CollectionBaseInfo> bodySetter) {
        if (this.body == null) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        DeleteCollectionRequest that = (DeleteCollectionRequest) obj;
