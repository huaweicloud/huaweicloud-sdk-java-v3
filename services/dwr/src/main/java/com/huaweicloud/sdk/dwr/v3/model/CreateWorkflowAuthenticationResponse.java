 ...
 * Response Object
 */
public class CreateWorkflowAuthenticationResponse extends SdkResponse {
    ...
    public CreateWorkflowAuthenticationResponse withXRequestId(String xRequestId) {
    ...
    public CreateWorkflowAuthenticationResponse withContentLength(String contentLength) {
    ...
    public String toString() {
        ...
        sb.append("class CreateWorkflowAuthenticationResponse {\n");
