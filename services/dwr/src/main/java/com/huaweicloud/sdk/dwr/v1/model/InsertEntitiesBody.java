 ...
 * InsertEntitiesBody
 */
public class InsertEntitiesBody {
    ...
    public InsertEntitiesBody withStoreName(String storeName) {
    ...
    public InsertEntitiesBody withCollectionName(String collectionName) {
    ...
    public InsertEntitiesBody withData(List<Map<String, Object>> data) {
        this.data = data;
        return this;
    }

    public InsertEntitiesBody addDataItem(Map<String, Object> dataItem) {
        if (this.data == null) {
    ...
    public InsertEntitiesBody withData(Consumer<List<Map<String, Object>>> dataSetter) {
        if (this.data == null) {
            this.data = new ArrayList<>();
        }
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        InsertEntitiesBody that = (InsertEntitiesBody) obj;
    ...
    public String toString() {
        ...
        sb.append("class InsertEntitiesBody {\n");
