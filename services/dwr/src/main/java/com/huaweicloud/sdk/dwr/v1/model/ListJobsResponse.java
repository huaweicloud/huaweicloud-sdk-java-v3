...
public class ListJobsResponse extends SdkResponse {
    ...
    private ListJobsData data;

    public ListJobsResponse withCode(String code) {
        this.code = code;
        return this;
    }
    ...
    public ListJobsResponse withData(ListJobsData data) {
        this.data = data;
        return this;
    }

    public ListJobsResponse withData(Consumer<ListJobsData> dataSetter) {
        if (this.data == null) {
            this.data = new ListJobsData();
     ...
     * @return data
     */
    public ListJobsData getData() {
        return data;
    }

    public void setData(ListJobsData data) {
        this.data = data;
    }
