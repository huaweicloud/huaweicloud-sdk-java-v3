 ...
 * DescribeIndexBody
 */
public class DescribeIndexBody {
    ...
    public DescribeIndexBody withStoreName(String storeName) {
    ...
    public DescribeIndexBody withCollectionName(String collectionName) {
    ...
    public DescribeIndexBody withIndexName(String indexName) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        DescribeIndexBody that = (DescribeIndexBody) obj;
    ...
    public String toString() {
        ...
        sb.append("class DescribeIndexBody {\n");
