...
public class VideoMotionCaptureInfo {
    ...
    public VideoMotionCaptureInfo withMotionCaptureMode(MotionCaptureModeEnum motionCaptureMode) {
    ...
    public VideoMotionCaptureInfo withInputInfo(InputInfo inputInfo) {
        this.inputInfo = inputInfo;
        return this;
    }

    public VideoMotionCaptureInfo withInputInfo(Consumer<InputInfo> inputInfoSetter) {
    ...
    public VideoMotionCaptureInfo withOutputInfo(OutputInfo outputInfo) {
        this.outputInfo = outputInfo;
        return this;
    }

    public VideoMotionCaptureInfo withOutputInfo(Consumer<OutputInfo> outputInfoSetter) {
    ...
    public VideoMotionCaptureInfo withJobId(String jobId) {
        this.jobId = jobId;
        return this;
    }
    ...
    public VideoMotionCaptureInfo withState(StateEnum state) {
        this.state = state;
        return this;
    }
    ...
    public VideoMotionCaptureInfo withStartTime(String startTime) {
    ...
    public VideoMotionCaptureInfo withEndTime(String endTime) {
    ...
    public String toString() {
        ...
        sb.append("class VideoMotionCaptureInfo {\n");
