...
public class CreateQuestionAnswerReq {
    ...
    public CreateQuestionAnswerReq withQuestion(String question) {
    ...
    public CreateQuestionAnswerReq withAnswer(String answer) {
        this.answer = answer;
        return this;
    }
    ...
    public CreateQuestionAnswerReq withKnowledgeLibraryId(String knowledgeLibraryId) {
    ...
    public CreateQuestionAnswerReq withSimilarQuestions(String similarQuestions) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        CreateQuestionAnswerReq that = (CreateQuestionAnswerReq) obj;
    ...
    @Override
    public int hashCode() {
        return Objects.hash(question, answer, knowledgeLibraryId, similarQuestions);
    }
