...
public class DigitalAssetInfo {
    ...
    public DigitalAssetInfo withProduceId(String produceId) {
    ...
    public DigitalAssetInfo withAssetName(String assetName) {
    ...
    public DigitalAssetInfo withAssetDescription(String assetDescription) {
    ...
    public DigitalAssetInfo withUpdateTime(String updateTime) {
    ...
    public DigitalAssetInfo withAssetType(AssetTypeEnum assetType) {
    ...
    public DigitalAssetInfo withAssetState(AssetStateEnum assetState) {
    ...
    public DigitalAssetInfo withFailType(FailTypeEnum failType) {
    ...
    public DigitalAssetInfo addTagsItem(String tagsItem) {
        if (this.tags == null) {
    ...
    public DigitalAssetInfo withTags(Consumer<List<String>> tagsSetter) {
        if (this.tags == null) {
            this.tags = new ArrayList<>();
        }
    ...
    public DigitalAssetInfo withAssetExtraMeta(AssetExtraMeta assetExtraMeta) {
        this.assetExtraMeta = assetExtraMeta;
        return this;
    }

    public DigitalAssetInfo withAssetExtraMeta(Consumer<AssetExtraMeta> assetExtraMetaSetter) {
    ...
    public DigitalAssetInfo withSystemProperties(List<SystemProperty> systemProperties) {
        this.systemProperties = systemProperties;
        return this;
    }

    public DigitalAssetInfo addSystemPropertiesItem(SystemProperty systemPropertiesItem) {
    ...
    public DigitalAssetInfo withSystemProperties(Consumer<List<SystemProperty>> systemPropertiesSetter) {
        if (this.systemProperties == null) {
            this.systemProperties = new ArrayList<>();
        }
    ...
    public DigitalAssetInfo withFiles(List<AssetFileInfo> files) {
        this.files = files;
        return this;
    }

    public DigitalAssetInfo addFilesItem(AssetFileInfo filesItem) {
        if (this.files == null) {
    ...
    public DigitalAssetInfo withFiles(Consumer<List<AssetFileInfo>> filesSetter) {
        if (this.files == null) {
            this.files = new ArrayList<>();
        }
    ...
    public DigitalAssetInfo withAssetOrder(Integer assetOrder) {
    ...
    public DigitalAssetInfo withSupportedService(List<SupportedServiceEnum> supportedService) {
        this.supportedService = supportedService;
        return this;
    }

    public DigitalAssetInfo addSupportedServiceItem(SupportedServiceEnum supportedServiceItem) {
    ...
    public DigitalAssetInfo withSupportedService(Consumer<List<SupportedServiceEnum>> supportedServiceSetter) {
        if (this.supportedService == null) {
            this.supportedService = new ArrayList<>();
        }
