 ...
 * 修改语音录制配置请求。
 */
public class UpdateAudioRecordConfigReq {
    ...
    public UpdateAudioRecordConfigReq withObsBucketName(String obsBucketName) {
    ...
    public UpdateAudioRecordConfigReq withObsEndpoint(String obsEndpoint) {
    ...
    public UpdateAudioRecordConfigReq withEnableAudioRecord(Boolean enableAudioRecord) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        UpdateAudioRecordConfigReq that = (UpdateAudioRecordConfigReq) obj;
    ...
    public String toString() {
        ...
        sb.append("class UpdateAudioRecordConfigReq {\n");
