...
public class ProductDetailInfo {
    ...
    public ProductDetailInfo withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public ProductDetailInfo withDescription(String description) {
    ...
    public ProductDetailInfo withTags(List<String> tags) {
        this.tags = tags;
        return this;
    }

    public ProductDetailInfo addTagsItem(String tagsItem) {
        if (this.tags == null) {
    ...
    public ProductDetailInfo withTags(Consumer<List<String>> tagsSetter) {
        if (this.tags == null) {
            this.tags = new ArrayList<>();
        }
    ...
    public ProductDetailInfo withCover(ProductCoverDetailInfo cover) {
        this.cover = cover;
        return this;
    }

    public ProductDetailInfo withCover(Consumer<ProductCoverDetailInfo> coverSetter) {
        if (this.cover == null) {
    ...
    public ProductDetailInfo withTextList(List<ProductTextInfo> textList) {
        this.textList = textList;
        return this;
    }

    public ProductDetailInfo addTextListItem(ProductTextInfo textListItem) {
    ...
    public ProductDetailInfo withTextList(Consumer<List<ProductTextInfo>> textListSetter) {
        if (this.textList == null) {
            this.textList = new ArrayList<>();
        }
    ...
    public ProductDetailInfo withAssetList(List<ProductMediaDetailInfo> assetList) {
        this.assetList = assetList;
        return this;
    }

    public ProductDetailInfo addAssetListItem(ProductMediaDetailInfo assetListItem) {
    ...
    public ProductDetailInfo withAssetList(Consumer<List<ProductMediaDetailInfo>> assetListSetter) {
        if (this.assetList == null) {
            this.assetList = new ArrayList<>();
        }
    ...
    public ProductDetailInfo withCreateTime(String createTime) {
    ...
    public ProductDetailInfo withUpdateTime(String updateTime) {
    ...
    public ProductDetailInfo withState(StateEnum state) {
        this.state = state;
        return this;
    }
    ...
    public int hashCode() {
        return Objects
            .hash(productId, name, description, tags, cover, textList, assetList, createTime, updateTime, state);
    }
