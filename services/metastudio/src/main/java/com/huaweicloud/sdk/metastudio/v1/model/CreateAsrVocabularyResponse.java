 ...
 * Response Object
 */
public class CreateAsrVocabularyResponse extends SdkResponse {
    ...
    public CreateAsrVocabularyResponse withAsrVocabularyId(String asrVocabularyId) {
    ...
    public CreateAsrVocabularyResponse withVocabularyType(AsrVocabularyTypeEnum vocabularyType) {
    ...
    public CreateAsrVocabularyResponse withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public CreateAsrVocabularyResponse withContent(String content) {
    ...
    public CreateAsrVocabularyResponse withLanguage(LanguageEnum language) {
    ...
    public CreateAsrVocabularyResponse withCreateTime(String createTime) {
    ...
    public CreateAsrVocabularyResponse withUpdateTime(String updateTime) {
    ...
    public CreateAsrVocabularyResponse withXRequestId(String xRequestId) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        CreateAsrVocabularyResponse that = (CreateAsrVocabularyResponse) obj;
    ...
    public String toString() {
        ...
        sb.append("class CreateAsrVocabularyResponse {\n");
