 ...
 * Response Object
 */
public class CreateDialogReportConfigResponse extends SdkResponse {
    ...
    public CreateDialogReportConfigResponse withProjectId(String projectId) {
    ...
    public CreateDialogReportConfigResponse withObsBucketName(String obsBucketName) {
    ...
    public CreateDialogReportConfigResponse withObsEndpoint(String obsEndpoint) {
    ...
    public CreateDialogReportConfigResponse withEnableDialogReport(Boolean enableDialogReport) {
    ...
    public CreateDialogReportConfigResponse withCreateTime(String createTime) {
    ...
    public CreateDialogReportConfigResponse withUpdateTime(String updateTime) {
    ...
    public CreateDialogReportConfigResponse withXRequestId(String xRequestId) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        CreateDialogReportConfigResponse that = (CreateDialogReportConfigResponse) obj;
    ...
    public String toString() {
        ...
        sb.append("class CreateDialogReportConfigResponse {\n");
