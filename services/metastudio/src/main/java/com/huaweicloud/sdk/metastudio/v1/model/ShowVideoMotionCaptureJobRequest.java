...
public class ShowVideoMotionCaptureJobRequest {
    ...
    public ShowVideoMotionCaptureJobRequest withJobId(String jobId) {
        this.jobId = jobId;
        return this;
    }
    ...
    public ShowVideoMotionCaptureJobRequest withAuthorization(String authorization) {
    ...
    public ShowVideoMotionCaptureJobRequest withXSdkDate(String xSdkDate) {
    ...
    public ShowVideoMotionCaptureJobRequest withXProjectId(String xProjectId) {
    ...
    public ShowVideoMotionCaptureJobRequest withXAppUserId(String xAppUserId) {
