 ...
 * Request Object
 */
public class CheckVoiceAssetRequest {
    ...
    public CheckVoiceAssetRequest withAuthorization(String authorization) {
    ...
    public CheckVoiceAssetRequest withXSdkDate(String xSdkDate) {
    ...
    public CheckVoiceAssetRequest withXProjectId(String xProjectId) {
    ...
    public CheckVoiceAssetRequest withXAppUserId(String xAppUserId) {
    ...
    public CheckVoiceAssetRequest withVoiceAssetId(String voiceAssetId) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        CheckVoiceAssetRequest that = (CheckVoiceAssetRequest) obj;
    ...
    @Override
    public int hashCode() {
        return Objects.hash(authorization, xSdkDate, xProjectId, xAppUserId, voiceAssetId);
    }

    @Override
    public String toString() {
        StringBuilder sb = new StringBuilder();
        sb.append("class CheckVoiceAssetRequest {\n");
