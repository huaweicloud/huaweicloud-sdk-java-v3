...
public class ActiveCodeInfo {
    ...
    public ActiveCodeInfo withActiveCodeId(String activeCodeId) {
    ...
    public ActiveCodeInfo withActiveCode(String activeCode) {
    ...
    public ActiveCodeInfo withRobotId(String robotId) {
    ...
    public ActiveCodeInfo withRoomId(String roomId) {
        this.roomId = roomId;
        return this;
    }
    ...
    public ActiveCodeInfo withValidPeriod(Integer validPeriod) {
    ...
    public ActiveCodeInfo withExpireTime(String expireTime) {
    ...
    public ActiveCodeInfo withCreateTime(String createTime) {
    ...
    public ActiveCodeInfo withUpdateTime(String updateTime) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ActiveCodeInfo that = (ActiveCodeInfo) obj;
    ...
    @Override
    public int hashCode() {
        return Objects.hash(activeCodeId, activeCode, robotId, roomId, validPeriod, expireTime, createTime, updateTime);
    }

    @Override
    public String toString() {
        StringBuilder sb = new StringBuilder();
        sb.append("class ActiveCodeInfo {\n");
