...
public class DeleteProductRequest {
    ...
    public DeleteProductRequest withAuthorization(String authorization) {
    ...
    public DeleteProductRequest withXSdkDate(String xSdkDate) {
    ...
    public DeleteProductRequest withXProjectId(String xProjectId) {
    ...
    public DeleteProductRequest withXAppUserId(String xAppUserId) {
