...
public class UpdateSmartLiveRoomResponse extends SdkResponse {
    ...
    public UpdateSmartLiveRoomResponse withConfirmState(ConfirmStateEnum confirmState) {
    ...
    public UpdateSmartLiveRoomResponse withScriptVersion(String scriptVersion) {
