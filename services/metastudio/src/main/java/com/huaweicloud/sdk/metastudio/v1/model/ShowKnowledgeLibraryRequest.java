 ...
 * Request Object
 */
public class ShowKnowledgeLibraryRequest {
    ...
    public ShowKnowledgeLibraryRequest withAuthorization(String authorization) {
    ...
    public ShowKnowledgeLibraryRequest withXSdkDate(String xSdkDate) {
    ...
    public ShowKnowledgeLibraryRequest withXProjectId(String xProjectId) {
    ...
    public ShowKnowledgeLibraryRequest withXAppUserId(String xAppUserId) {
    ...
    public ShowKnowledgeLibraryRequest withKnowledgeLibraryId(String knowledgeLibraryId) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ShowKnowledgeLibraryRequest that = (ShowKnowledgeLibraryRequest) obj;
    ...
    @Override
    public int hashCode() {
        return Objects.hash(authorization, xSdkDate, xProjectId, xAppUserId, knowledgeLibraryId);
    }

    @Override
    public String toString() {
        StringBuilder sb = new StringBuilder();
        sb.append("class ShowKnowledgeLibraryRequest {\n");
