...
public class SmartLiveJob {
    ...
    public SmartLiveJob withDuration(Float duration) {
    ...
    public SmartLiveJob withEndTime(String endTime) {
    ...
    public SmartLiveJob withErrorInfo(ErrorResponse errorInfo) {
        this.errorInfo = errorInfo;
        return this;
    }

    public SmartLiveJob withErrorInfo(Consumer<ErrorResponse> errorInfoSetter) {
    ...
    public SmartLiveJob withCreateTime(String createTime) {
    ...
    public SmartLiveJob withLastupdateTime(String lastupdateTime) {
    ...
    public SmartLiveJob withRtcRoomInfo(RTCRoomInfoList rtcRoomInfo) {
        this.rtcRoomInfo = rtcRoomInfo;
        return this;
    }

    public SmartLiveJob withRtcRoomInfo(Consumer<RTCRoomInfoList> rtcRoomInfoSetter) {
    ...
    public SmartLiveJob withLiveEventReportUrl(String liveEventReportUrl) {
    ...
    public SmartLiveJob withUsedResourceType(UsedResourceTypeEnum usedResourceType) {
