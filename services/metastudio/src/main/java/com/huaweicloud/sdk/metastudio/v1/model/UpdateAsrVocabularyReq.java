...
public class UpdateAsrVocabularyReq {
    ...
    public UpdateAsrVocabularyReq withVocabularyType(AsrVocabularyTypeEnum vocabularyType) {
    ...
    public UpdateAsrVocabularyReq withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public UpdateAsrVocabularyReq withLanguage(LanguageEnum language) {
    ...
    public UpdateAsrVocabularyReq withMobvoiVocabulary(MobvoiVocabulary mobvoiVocabulary) {
        this.mobvoiVocabulary = mobvoiVocabulary;
        return this;
    }

    public UpdateAsrVocabularyReq withMobvoiVocabulary(Consumer<MobvoiVocabulary> mobvoiVocabularySetter) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        UpdateAsrVocabularyReq that = (UpdateAsrVocabularyReq) obj;
