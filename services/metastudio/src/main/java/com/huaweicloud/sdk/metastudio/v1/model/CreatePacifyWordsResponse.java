 ...
 * Response Object
 */
public class CreatePacifyWordsResponse extends SdkResponse {
    ...
    public CreatePacifyWordsResponse withPacifyWordsId(String pacifyWordsId) {
    ...
    public CreatePacifyWordsResponse withPacifyWords(String pacifyWords) {
    ...
    public CreatePacifyWordsResponse withLanguage(LanguageEnum language) {
    ...
    public CreatePacifyWordsResponse withRobotId(String robotId) {
    ...
    public CreatePacifyWordsResponse withPacifyWordsType(Integer pacifyWordsType) {
    ...
    public CreatePacifyWordsResponse withIntent(String intent) {
        this.intent = intent;
        return this;
    }
    ...
    public CreatePacifyWordsResponse withCreateTime(String createTime) {
    ...
    public CreatePacifyWordsResponse withUpdateTime(String updateTime) {
    ...
    public CreatePacifyWordsResponse withXRequestId(String xRequestId) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        CreatePacifyWordsResponse that = (CreatePacifyWordsResponse) obj;
    ...
    public String toString() {
        ...
        sb.append("class CreatePacifyWordsResponse {\n");
