...
public class ListRobotRequest {
    ...
    public ListRobotRequest withXSdkDate(String xSdkDate) {
    ...
    public ListRobotRequest withXProjectId(String xProjectId) {
    ...
    public ListRobotRequest withXAppUserId(String xAppUserId) {
    ...
    public ListRobotRequest withOffset(Integer offset) {
        this.offset = offset;
        return this;
    }
    ...
    public ListRobotRequest withLimit(Integer limit) {
        this.limit = limit;
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append("class ListRobotRequest {\n");
