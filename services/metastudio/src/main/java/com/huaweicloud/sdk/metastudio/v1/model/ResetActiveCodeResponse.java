 ...
 * Response Object
 */
public class ResetActiveCodeResponse extends SdkResponse {
    ...
    public ResetActiveCodeResponse withActiveCodeId(String activeCodeId) {
    ...
    public ResetActiveCodeResponse withActiveCode(String activeCode) {
    ...
    public ResetActiveCodeResponse withRobotId(String robotId) {
    ...
    public ResetActiveCodeResponse withRoomId(String roomId) {
        this.roomId = roomId;
        return this;
    }
    ...
    public ResetActiveCodeResponse withValidPeriod(Integer validPeriod) {
    ...
    public ResetActiveCodeResponse withExpireTime(String expireTime) {
    ...
    public ResetActiveCodeResponse withCreateTime(String createTime) {
    ...
    public ResetActiveCodeResponse withUpdateTime(String updateTime) {
    ...
    public ResetActiveCodeResponse withXRequestId(String xRequestId) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ResetActiveCodeResponse that = (ResetActiveCodeResponse) obj;
