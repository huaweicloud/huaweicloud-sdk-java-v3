 ...
 * Request Object
 */
public class ListSelfPrivilegesRequest {
    ...
    @JsonInclude(JsonInclude.Include.NON_NULL)
    @JsonProperty(value = "privilege_type")

    private String privilegeType;

    public ListSelfPrivilegesRequest withAuthorization(String authorization) {
    ...
    public ListSelfPrivilegesRequest withXSdkDate(String xSdkDate) {
    ...
    public ListSelfPrivilegesRequest withXProjectId(String xProjectId) {
    ...
    public ListSelfPrivilegesRequest withXAppUserId(String xAppUserId) {
    ...
    public ListSelfPrivilegesRequest withLimit(Integer limit) {
        this.limit = limit;
        return this;
    }
    ...
    public ListSelfPrivilegesRequest withOffset(Integer offset) {
        this.offset = offset;
        return this;
    }
    ...
    public ListSelfPrivilegesRequest withPrivilegeType(String privilegeType) {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(authorization, xSdkDate, xProjectId, xAppUserId, limit, offset, privilegeType);
    }

    @Override
    public String toString() {
        StringBuilder sb = new StringBuilder();
        sb.append("class ListSelfPrivilegesRequest {\n");
