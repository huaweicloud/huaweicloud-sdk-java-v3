 ...
 * Response Object
 */
public class UpdatePacifyWordsResponse extends SdkResponse {
    ...
    public UpdatePacifyWordsResponse withPacifyWordsId(String pacifyWordsId) {
    ...
    public UpdatePacifyWordsResponse withPacifyWords(String pacifyWords) {
    ...
    public UpdatePacifyWordsResponse withLanguage(LanguageEnum language) {
    ...
    public UpdatePacifyWordsResponse withRobotId(String robotId) {
    ...
    public UpdatePacifyWordsResponse withPacifyWordsType(Integer pacifyWordsType) {
    ...
    public UpdatePacifyWordsResponse withIntent(String intent) {
        this.intent = intent;
        return this;
    }
    ...
    public UpdatePacifyWordsResponse withCreateTime(String createTime) {
    ...
    public UpdatePacifyWordsResponse withUpdateTime(String updateTime) {
    ...
    public UpdatePacifyWordsResponse withXRequestId(String xRequestId) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        UpdatePacifyWordsResponse that = (UpdatePacifyWordsResponse) obj;
