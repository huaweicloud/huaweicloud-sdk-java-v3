...
public class HotWordsInfo {
    ...
    public HotWordsInfo withHotWordsId(String hotWordsId) {
    ...
    public HotWordsInfo withRobotId(String robotId) {
    ...
    public HotWordsInfo withHotWordsType(HotWordsTypeEnum hotWordsType) {
    ...
    public HotWordsInfo withVocabularyId(String vocabularyId) {
    ...
    public HotWordsInfo withSisProjectId(String sisProjectId) {
    ...
    public HotWordsInfo withRegion(Integer region) {
        this.region = region;
        return this;
    }
    ...
    public HotWordsInfo withLanguage(LanguageEnum language) {
    ...
    public HotWordsInfo withCreateTime(String createTime) {
    ...
    public HotWordsInfo withUpdateTime(String updateTime) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        HotWordsInfo that = (HotWordsInfo) obj;
