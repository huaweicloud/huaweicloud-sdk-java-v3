 ...
 * Request Object
 */
public class CommitVoiceTrainingJobRequest {
    ...
    public CommitVoiceTrainingJobRequest withXSdkDate(String xSdkDate) {
    ...
    public CommitVoiceTrainingJobRequest withXProjectId(String xProjectId) {
    ...
    public CommitVoiceTrainingJobRequest withXAppUserId(String xAppUserId) {
    ...
    public CommitVoiceTrainingJobRequest withJobId(String jobId) {
        this.jobId = jobId;
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append("class CommitVoiceTrainingJobRequest {\n");
