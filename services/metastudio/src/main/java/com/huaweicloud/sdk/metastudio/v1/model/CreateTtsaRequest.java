 ...
 * Request Object
 */
public class CreateTtsaRequest {
    ...
    public CreateTtsaRequest withAuthorization(String authorization) {
    ...
    public CreateTtsaRequest withXSdkDate(String xSdkDate) {
    ...
    public CreateTtsaRequest withXProjectId(String xProjectId) {
    ...
    public CreateTtsaRequest withBody(Consumer<CreateTTSAReq> bodySetter) {
        if (this.body == null) {
            this.body = new CreateTTSAReq();
     ...
     * @return body
     */
    public CreateTTSAReq getBody() {
        return body;
    }

    public void setBody(CreateTTSAReq body) {
        this.body = body;
    }
    ...
    public String toString() {
        ...
        sb.append("class CreateTtsaRequest {\n");
