...
public class UpdateProductRequest {
    ...
    public UpdateProductRequest withAuthorization(String authorization) {
    ...
    public UpdateProductRequest withXSdkDate(String xSdkDate) {
    ...
    public UpdateProductRequest withXProjectId(String xProjectId) {
    ...
    public UpdateProductRequest withXAppUserId(String xAppUserId) {
