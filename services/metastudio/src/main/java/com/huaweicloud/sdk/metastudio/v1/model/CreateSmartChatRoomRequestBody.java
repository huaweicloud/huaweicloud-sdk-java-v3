...
public class CreateSmartChatRoomRequestBody {
    ...
    public CreateSmartChatRoomRequestBody withBillingMode(BillingModeEnum billingMode) {
    ...
    public CreateSmartChatRoomRequestBody withReuseResource(Boolean reuseResource) {
    ...
    public CreateSmartChatRoomRequestBody withClientNums(Integer clientNums) {
