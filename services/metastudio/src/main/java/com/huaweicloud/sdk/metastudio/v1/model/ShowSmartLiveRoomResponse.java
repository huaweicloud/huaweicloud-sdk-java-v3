 ...
 * Response Object
 */
public class ShowSmartLiveRoomResponse extends SdkResponse {
    ...
    public ShowSmartLiveRoomResponse withRoomName(String roomName) {
    ...
    public ShowSmartLiveRoomResponse withRoomDescription(String roomDescription) {
    ...
    public ShowSmartLiveRoomResponse withRoomType(RoomTypeEnum roomType) {
    ...
    public ShowSmartLiveRoomResponse withSceneScripts(List<LiveVideoScriptInfo> sceneScripts) {
        this.sceneScripts = sceneScripts;
        return this;
    }

    public ShowSmartLiveRoomResponse addSceneScriptsItem(LiveVideoScriptInfo sceneScriptsItem) {
    ...
    public ShowSmartLiveRoomResponse withSceneScripts(Consumer<List<LiveVideoScriptInfo>> sceneScriptsSetter) {
        if (this.sceneScripts == null) {
            this.sceneScripts = new ArrayList<>();
        }
    ...
    public ShowSmartLiveRoomResponse withInteractionConfig(LiveRoomInteractionConfig interactionConfig) {
        this.interactionConfig = interactionConfig;
        return this;
    }

    public ShowSmartLiveRoomResponse withInteractionConfig(
    ...
    public ShowSmartLiveRoomResponse withInteractionRules(List<LiveRoomInteractionRuleInfo> interactionRules) {
        this.interactionRules = interactionRules;
        return this;
    }

    public ShowSmartLiveRoomResponse addInteractionRulesItem(LiveRoomInteractionRuleInfo interactionRulesItem) {
    ...
    public ShowSmartLiveRoomResponse withInteractionRules(
    ...
    public ShowSmartLiveRoomResponse withPlayPolicy(PlayPolicy playPolicy) {
        this.playPolicy = playPolicy;
        return this;
    }

    public ShowSmartLiveRoomResponse withPlayPolicy(Consumer<PlayPolicy> playPolicySetter) {
    ...
    public ShowSmartLiveRoomResponse withVideoConfig(VideoConfig videoConfig) {
        this.videoConfig = videoConfig;
        return this;
    }

    public ShowSmartLiveRoomResponse withVideoConfig(Consumer<VideoConfig> videoConfigSetter) {
    ...
    public ShowSmartLiveRoomResponse withOutputUrls(List<String> outputUrls) {
        this.outputUrls = outputUrls;
        return this;
    }

    public ShowSmartLiveRoomResponse addOutputUrlsItem(String outputUrlsItem) {
    ...
    public ShowSmartLiveRoomResponse withOutputUrls(Consumer<List<String>> outputUrlsSetter) {
        if (this.outputUrls == null) {
            this.outputUrls = new ArrayList<>();
        }
    ...
    public ShowSmartLiveRoomResponse withRtcCallbackConfig(RTCLiveEventCallBackConfig rtcCallbackConfig) {
        this.rtcCallbackConfig = rtcCallbackConfig;
        return this;
    }

    public ShowSmartLiveRoomResponse withRtcCallbackConfig(
    ...
    public ShowSmartLiveRoomResponse withViewMode(ViewModeEnum viewMode) {
    ...
    public ShowSmartLiveRoomResponse withCoStreamerConfig(CoStreamerConfig coStreamerConfig) {
        this.coStreamerConfig = coStreamerConfig;
        return this;
    }

    public ShowSmartLiveRoomResponse withCoStreamerConfig(Consumer<CoStreamerConfig> coStreamerConfigSetter) {
    ...
    public ShowSmartLiveRoomResponse withPrivData(String privData) {
    ...
    public ShowSmartLiveRoomResponse withRelationLivePlatformInfo(PlatformLiveDetailInfo relationLivePlatformInfo) {
        this.relationLivePlatformInfo = relationLivePlatformInfo;
        return this;
    }

    public ShowSmartLiveRoomResponse withRelationLivePlatformInfo(
    ...
    public ShowSmartLiveRoomResponse withCreateTime(String createTime) {
    ...
    public ShowSmartLiveRoomResponse withUpdateTime(String updateTime) {
    ...
    public ShowSmartLiveRoomResponse withCoverUrl(String coverUrl) {
    ...
    public ShowSmartLiveRoomResponse withThumbnail(String thumbnail) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ShowSmartLiveRoomResponse that = (ShowSmartLiveRoomResponse) obj;
    ...
    public String toString() {
        ...
        sb.append("class ShowSmartLiveRoomResponse {\n");
