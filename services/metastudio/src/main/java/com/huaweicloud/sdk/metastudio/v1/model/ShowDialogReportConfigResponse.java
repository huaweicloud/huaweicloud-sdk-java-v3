 ...
 * Response Object
 */
public class ShowDialogReportConfigResponse extends SdkResponse {
    ...
    public ShowDialogReportConfigResponse withProjectId(String projectId) {
    ...
    public ShowDialogReportConfigResponse withObsBucketName(String obsBucketName) {
    ...
    public ShowDialogReportConfigResponse withObsEndpoint(String obsEndpoint) {
    ...
    public ShowDialogReportConfigResponse withEnableDialogReport(Boolean enableDialogReport) {
    ...
    public ShowDialogReportConfigResponse withCreateTime(String createTime) {
    ...
    public ShowDialogReportConfigResponse withUpdateTime(String updateTime) {
    ...
    public ShowDialogReportConfigResponse withXRequestId(String xRequestId) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ShowDialogReportConfigResponse that = (ShowDialogReportConfigResponse) obj;
    ...
    public String toString() {
        ...
        sb.append("class ShowDialogReportConfigResponse {\n");
