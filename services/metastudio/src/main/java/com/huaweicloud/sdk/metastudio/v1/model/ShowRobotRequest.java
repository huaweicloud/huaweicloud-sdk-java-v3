...
public class ShowRobotRequest {
    ...
    public ShowRobotRequest withAuthorization(String authorization) {
    ...
    public ShowRobotRequest withXSdkDate(String xSdkDate) {
    ...
    public ShowRobotRequest withXProjectId(String xProjectId) {
    ...
    public ShowRobotRequest withXAppUserId(String xAppUserId) {
    ...
    public ShowRobotRequest withRobotId(String robotId) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ShowRobotRequest that = (ShowRobotRequest) obj;
    ...
    public String toString() {
        ...
        sb.append("class ShowRobotRequest {\n");
