...
public class ShowSmartChatRoomResponse extends SdkResponse {
    ...
    public ShowSmartChatRoomResponse withBillingMode(BillingModeEnum billingMode) {
    ...
    public ShowSmartChatRoomResponse withReuseResource(Boolean reuseResource) {
    ...
    public ShowSmartChatRoomResponse withClientNums(Integer clientNums) {
