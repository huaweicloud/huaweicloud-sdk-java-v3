...
public class CreateProductRequest {
    ...
    public CreateProductRequest withAuthorization(String authorization) {
    ...
    public CreateProductRequest withXSdkDate(String xSdkDate) {
    ...
    public CreateProductRequest withXProjectId(String xProjectId) {
    ...
    public CreateProductRequest withXAppUserId(String xAppUserId) {
