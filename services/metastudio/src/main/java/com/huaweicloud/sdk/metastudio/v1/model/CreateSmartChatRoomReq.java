...
public class CreateSmartChatRoomReq {
    ...
    public CreateSmartChatRoomReq withBillingMode(BillingModeEnum billingMode) {
    ...
    public CreateSmartChatRoomReq withReuseResource(Boolean reuseResource) {
    ...
    public CreateSmartChatRoomReq withClientNums(Integer clientNums) {
    ...
    public CreateSmartChatRoomReq withEnableSemanticAction(Boolean enableSemanticAction) {
