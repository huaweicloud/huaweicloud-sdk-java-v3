 ...
 * sis类型热词
 */
public class UpdateSisHotWords {
    ...
    public UpdateSisHotWords withVocabularyId(String vocabularyId) {
    ...
    public UpdateSisHotWords withSisProjectId(String sisProjectId) {
    ...
    public UpdateSisHotWords withRegion(Integer region) {
        this.region = region;
        return this;
    }
    ...
    public UpdateSisHotWords withLanguage(LanguageEnum language) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        UpdateSisHotWords that = (UpdateSisHotWords) obj;
    ...
    public String toString() {
        ...
        sb.append("class UpdateSisHotWords {\n");
