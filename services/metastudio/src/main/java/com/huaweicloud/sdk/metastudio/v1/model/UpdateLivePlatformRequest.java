 ...
 * Request Object
 */
public class UpdateLivePlatformRequest {
    ...
    public UpdateLivePlatformRequest withXSdkDate(String xSdkDate) {
    ...
    public UpdateLivePlatformRequest withXProjectId(String xProjectId) {
    ...
    public UpdateLivePlatformRequest withXAppUserId(String xAppUserId) {
    ...
    public UpdateLivePlatformRequest withPlatformId(String platformId) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        UpdateLivePlatformRequest that = (UpdateLivePlatformRequest) obj;
        return Objects.equals(this.authorization, that.authorization) && Objects.equals(this.xSdkDate, that.xSdkDate)
            && Objects.equals(this.xProjectId, that.xProjectId) && Objects.equals(this.xAppUserId, that.xAppUserId)
            && Objects.equals(this.platformId, that.platformId) && Objects.equals(this.body, that.body);
    }

    @Override
    public int hashCode() {
        return Objects.hash(authorization, xSdkDate, xProjectId, xAppUserId, platformId, body);
    }

    @Override
    public String toString() {
        StringBuilder sb = new StringBuilder();
        sb.append("class UpdateLivePlatformRequest {\n");
