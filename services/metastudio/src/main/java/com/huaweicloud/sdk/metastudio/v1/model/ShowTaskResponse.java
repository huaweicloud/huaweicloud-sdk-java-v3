...
public class ShowTaskResponse extends SdkResponse {
    ...
    public ShowTaskResponse withResource(String resource) {
    ...
    public ShowTaskResponse withTaskName(String taskName) {
    ...
    public ShowTaskResponse withBeginTime(String beginTime) {
    ...
    public ShowTaskResponse withEndTime(String endTime) {
    ...
    public ShowTaskResponse withTaskType(String taskType) {
    ...
    public ShowTaskResponse withOperator(String operator) {
    ...
    public ShowTaskResponse withTotalCount(Integer totalCount) {
    ...
    public ShowTaskResponse withSuccessCount(Integer successCount) {
    ...
    public ShowTaskResponse withFailureCount(Integer failureCount) {
    ...
    public ShowTaskResponse withTaskStatus(String taskStatus) {
    ...
    public ShowTaskResponse withUserId(String userId) {
        this.userId = userId;
        return this;
    }
