...
public class DeleteFileRequest {
    ...
    public DeleteFileRequest withAuthorization(String authorization) {
    ...
    public DeleteFileRequest withXSdkDate(String xSdkDate) {
    ...
    public DeleteFileRequest withXAppUserId(String xAppUserId) {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(authorization, xSdkDate, xAppUserId, fileId);
    }
