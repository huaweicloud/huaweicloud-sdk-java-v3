 ...
 * Request Object
 */
public class ShowWelcomeSpeechSwitchRequest {
    ...
    public ShowWelcomeSpeechSwitchRequest withXSdkDate(String xSdkDate) {
    ...
    public ShowWelcomeSpeechSwitchRequest withXProjectId(String xProjectId) {
    ...
    public ShowWelcomeSpeechSwitchRequest withXAppUserId(String xAppUserId) {
    ...
    public ShowWelcomeSpeechSwitchRequest withRobotId(String robotId) {
    ...
    public String toString() {
        ...
        sb.append("class ShowWelcomeSpeechSwitchRequest {\n");
