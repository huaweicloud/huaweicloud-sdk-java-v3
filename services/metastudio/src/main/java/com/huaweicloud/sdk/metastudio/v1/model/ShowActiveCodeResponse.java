 ...
 * Response Object
 */
public class ShowActiveCodeResponse extends SdkResponse {
    ...
    public ShowActiveCodeResponse withActiveCodeId(String activeCodeId) {
    ...
    public ShowActiveCodeResponse withActiveCode(String activeCode) {
    ...
    public ShowActiveCodeResponse withRobotId(String robotId) {
    ...
    public ShowActiveCodeResponse withRoomId(String roomId) {
        this.roomId = roomId;
        return this;
    }
    ...
    public ShowActiveCodeResponse withValidPeriod(Integer validPeriod) {
    ...
    public ShowActiveCodeResponse withExpireTime(String expireTime) {
    ...
    public ShowActiveCodeResponse withCreateTime(String createTime) {
    ...
    public ShowActiveCodeResponse withUpdateTime(String updateTime) {
    ...
    public ShowActiveCodeResponse withXRequestId(String xRequestId) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ShowActiveCodeResponse that = (ShowActiveCodeResponse) obj;
    ...
    public String toString() {
        ...
        sb.append("class ShowActiveCodeResponse {\n");
