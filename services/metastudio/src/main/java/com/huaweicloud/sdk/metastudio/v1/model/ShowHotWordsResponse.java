 ...
 * Response Object
 */
public class ShowHotWordsResponse extends SdkResponse {
    ...
    public ShowHotWordsResponse withHotWordsId(String hotWordsId) {
    ...
    public ShowHotWordsResponse withRobotId(String robotId) {
    ...
    public ShowHotWordsResponse withHotWordsType(HotWordsTypeEnum hotWordsType) {
    ...
    public ShowHotWordsResponse withVocabularyId(String vocabularyId) {
    ...
    public ShowHotWordsResponse withSisProjectId(String sisProjectId) {
    ...
    public ShowHotWordsResponse withRegion(Integer region) {
        this.region = region;
        return this;
    }
    ...
    public ShowHotWordsResponse withLanguage(LanguageEnum language) {
    ...
    public ShowHotWordsResponse withCreateTime(String createTime) {
    ...
    public ShowHotWordsResponse withUpdateTime(String updateTime) {
    ...
    public ShowHotWordsResponse withXRequestId(String xRequestId) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ShowHotWordsResponse that = (ShowHotWordsResponse) obj;
    ...
    public String toString() {
        ...
        sb.append("class ShowHotWordsResponse {\n");
