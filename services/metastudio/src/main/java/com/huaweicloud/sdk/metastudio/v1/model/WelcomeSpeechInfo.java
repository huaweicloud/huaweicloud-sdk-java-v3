 ...
 * 欢迎词基本信息。
 */
public class WelcomeSpeechInfo {
    ...
    public WelcomeSpeechInfo withWelcomeSpeechId(String welcomeSpeechId) {
    ...
    public WelcomeSpeechInfo withWelcomeSpeech(String welcomeSpeech) {
    ...
    public WelcomeSpeechInfo withCreateTime(String createTime) {
    ...
    public WelcomeSpeechInfo withUpdateTime(String updateTime) {
