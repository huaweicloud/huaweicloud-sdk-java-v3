 ...
 * Request Object
 */
public class ShowInstructionLibraryRequest {
    ...
    public ShowInstructionLibraryRequest withAuthorization(String authorization) {
    ...
    public ShowInstructionLibraryRequest withXSdkDate(String xSdkDate) {
    ...
    public ShowInstructionLibraryRequest withXProjectId(String xProjectId) {
    ...
    public ShowInstructionLibraryRequest withXAppUserId(String xAppUserId) {
    ...
    public ShowInstructionLibraryRequest withInstructionLibraryId(String instructionLibraryId) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ShowInstructionLibraryRequest that = (ShowInstructionLibraryRequest) obj;
    ...
    @Override
    public int hashCode() {
        return Objects.hash(authorization, xSdkDate, xProjectId, xAppUserId, instructionLibraryId);
    }

    @Override
    public String toString() {
        StringBuilder sb = new StringBuilder();
        sb.append("class ShowInstructionLibraryRequest {\n");
