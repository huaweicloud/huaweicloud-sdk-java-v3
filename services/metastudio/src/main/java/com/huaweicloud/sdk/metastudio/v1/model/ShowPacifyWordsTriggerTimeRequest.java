...
public class ShowPacifyWordsTriggerTimeRequest {
    ...
    public ShowPacifyWordsTriggerTimeRequest withAuthorization(String authorization) {
    ...
    public ShowPacifyWordsTriggerTimeRequest withXSdkDate(String xSdkDate) {
    ...
    public ShowPacifyWordsTriggerTimeRequest withXProjectId(String xProjectId) {
    ...
    public ShowPacifyWordsTriggerTimeRequest withXAppUserId(String xAppUserId) {
    ...
    public ShowPacifyWordsTriggerTimeRequest withRobotId(String robotId) {
    ...
    public ShowPacifyWordsTriggerTimeRequest withLanguage(LanguageEnum language) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ShowPacifyWordsTriggerTimeRequest that = (ShowPacifyWordsTriggerTimeRequest) obj;
    ...
    public String toString() {
        ...
        sb.append("class ShowPacifyWordsTriggerTimeRequest {\n");
