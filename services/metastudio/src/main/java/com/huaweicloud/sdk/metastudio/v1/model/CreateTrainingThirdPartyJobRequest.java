 ...
 * Request Object
 */
public class CreateTrainingThirdPartyJobRequest {
    ...
    public CreateTrainingThirdPartyJobRequest withXAppUserId(String xAppUserId) {
    ...
    public CreateTrainingThirdPartyJobRequest withBody(CreateTrainingJobReq body) {
        this.body = body;
        return this;
    }

    public CreateTrainingThirdPartyJobRequest withBody(Consumer<CreateTrainingJobReq> bodySetter) {
        if (this.body == null) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        CreateTrainingThirdPartyJobRequest that = (CreateTrainingThirdPartyJobRequest) obj;
    ...
    public String toString() {
        ...
        sb.append("class CreateTrainingThirdPartyJobRequest {\n");
