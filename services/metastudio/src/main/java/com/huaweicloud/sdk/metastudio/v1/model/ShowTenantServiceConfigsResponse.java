 ...
 * Response Object
 */
public class ShowTenantServiceConfigsResponse extends SdkResponse {
    ...
    public ShowTenantServiceConfigsResponse withServiceSharedConfig(ServiceSharedConfig serviceSharedConfig) {
        this.serviceSharedConfig = serviceSharedConfig;
        return this;
    }

    public ShowTenantServiceConfigsResponse withServiceSharedConfig(
    ...
    public ShowTenantServiceConfigsResponse withTenantLogConfig(TenantLogConfig tenantLogConfig) {
        this.tenantLogConfig = tenantLogConfig;
        return this;
    }

    public ShowTenantServiceConfigsResponse withTenantLogConfig(Consumer<TenantLogConfig> tenantLogConfigSetter) {
    ...
    public ShowTenantServiceConfigsResponse withSubAccountControlConfig(
    ...
    public ShowTenantServiceConfigsResponse withIsAiMarkOn(Boolean isAiMarkOn) {
    ...
    public ShowTenantServiceConfigsResponse withXRequestId(String xRequestId) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ShowTenantServiceConfigsResponse that = (ShowTenantServiceConfigsResponse) obj;
    ...
    @Override
    public int hashCode() {
        return Objects.hash(serviceSharedConfig, tenantLogConfig, subAccountControlConfig, isAiMarkOn, xRequestId);
    }

    @Override
    public String toString() {
        StringBuilder sb = new StringBuilder();
        sb.append("class ShowTenantServiceConfigsResponse {\n");
