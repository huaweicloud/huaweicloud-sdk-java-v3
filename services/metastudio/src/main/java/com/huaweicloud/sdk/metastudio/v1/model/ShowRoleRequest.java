...
public class ShowRoleRequest {
    ...
    public ShowRoleRequest withAuthorization(String authorization) {
    ...
    public ShowRoleRequest withXSdkDate(String xSdkDate) {
    ...
    public ShowRoleRequest withXProjectId(String xProjectId) {
    ...
    public ShowRoleRequest withXAppUserId(String xAppUserId) {
    ...
    public ShowRoleRequest withRoleId(String roleId) {
        this.roleId = roleId;
        return this;
    }
    ...
    @Override
    public int hashCode() {
        return Objects.hash(authorization, xSdkDate, xProjectId, xAppUserId, roleId);
    }
