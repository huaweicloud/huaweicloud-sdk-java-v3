...
public class UpdateMcpServerReq {
    ...
    public UpdateMcpServerReq withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public UpdateMcpServerReq withMcpServerUrl(String mcpServerUrl) {
    ...
    public UpdateMcpServerReq withAuthHeaderName(String authHeaderName) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        UpdateMcpServerReq that = (UpdateMcpServerReq) obj;
    ...
    public String toString() {
        ...
        sb.append("class UpdateMcpServerReq {\n");
