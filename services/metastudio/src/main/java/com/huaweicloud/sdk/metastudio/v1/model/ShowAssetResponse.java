...
public class ShowAssetResponse extends SdkResponse {
    ...
    public ShowAssetResponse withAssetDescription(String assetDescription) {
    ...
    public ShowAssetResponse withAppUserId(String appUserId) {
    ...
    public ShowAssetResponse withAssetType(AssetTypeEnum assetType) {
    ...
    public ShowAssetResponse withAssetState(AssetStateEnum assetState) {
    ...
    public ShowAssetResponse withBlockReasonCode(String blockReasonCode) {
    ...
    public ShowAssetResponse addTagsItem(String tagsItem) {
        if (this.tags == null) {
    ...
    public ShowAssetResponse withTags(Consumer<List<String>> tagsSetter) {
        if (this.tags == null) {
            this.tags = new ArrayList<>();
        }
    ...
    public ShowAssetResponse withAssetExtraMeta(AssetExtraMeta assetExtraMeta) {
        this.assetExtraMeta = assetExtraMeta;
        return this;
    }

    public ShowAssetResponse withAssetExtraMeta(Consumer<AssetExtraMeta> assetExtraMetaSetter) {
    ...
    public ShowAssetResponse withSystemProperties(List<SystemProperty> systemProperties) {
        this.systemProperties = systemProperties;
        return this;
    }

    public ShowAssetResponse addSystemPropertiesItem(SystemProperty systemPropertiesItem) {
    ...
    public ShowAssetResponse withSystemProperties(Consumer<List<SystemProperty>> systemPropertiesSetter) {
        if (this.systemProperties == null) {
            this.systemProperties = new ArrayList<>();
        }
    ...
    public ShowAssetResponse withFiles(List<AssetFileInfo> files) {
        this.files = files;
        return this;
    }

    public ShowAssetResponse addFilesItem(AssetFileInfo filesItem) {
        if (this.files == null) {
    ...
    public ShowAssetResponse withFiles(Consumer<List<AssetFileInfo>> filesSetter) {
        if (this.files == null) {
            this.files = new ArrayList<>();
        }
    ...
    public ShowAssetResponse withAssetOrder(Integer assetOrder) {
    ...
    public ShowAssetResponse withSupportedService(List<SupportedServiceEnum> supportedService) {
        this.supportedService = supportedService;
        return this;
    }

    public ShowAssetResponse addSupportedServiceItem(SupportedServiceEnum supportedServiceItem) {
    ...
    public ShowAssetResponse withSupportedService(Consumer<List<SupportedServiceEnum>> supportedServiceSetter) {
        if (this.supportedService == null) {
            this.supportedService = new ArrayList<>();
        }
    ...
    public ShowAssetResponse withAutoOperationConfig(List<AutoOperationConfig> autoOperationConfig) {
        this.autoOperationConfig = autoOperationConfig;
        return this;
    }

    public ShowAssetResponse addAutoOperationConfigItem(AutoOperationConfig autoOperationConfigItem) {
    ...
    public ShowAssetResponse withAutoOperationConfig(Consumer<List<AutoOperationConfig>> autoOperationConfigSetter) {
        if (this.autoOperationConfig == null) {
            this.autoOperationConfig = new ArrayList<>();
        }
    ...
    public ShowAssetResponse withXRequestId(String xRequestId) {
