 ...
 * Response Object
 */
public class ShowHotQuestionResponse extends SdkResponse {
    ...
    public ShowHotQuestionResponse withHotQuestionId(String hotQuestionId) {
    ...
    public ShowHotQuestionResponse withHotQuestion(String hotQuestion) {
    ...
    public ShowHotQuestionResponse withCreateTime(String createTime) {
    ...
    public ShowHotQuestionResponse withUpdateTime(String updateTime) {
    ...
    public ShowHotQuestionResponse withXRequestId(String xRequestId) {
