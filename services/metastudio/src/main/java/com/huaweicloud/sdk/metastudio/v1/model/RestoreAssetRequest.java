 ...
 * Request Object
 */
public class RestoreAssetRequest {
    ...
    public RestoreAssetRequest withAuthorization(String authorization) {
    ...
    public RestoreAssetRequest withXSdkDate(String xSdkDate) {
    ...
    public RestoreAssetRequest withXAppUserId(String xAppUserId) {
    ...
    public RestoreAssetRequest withAssetId(String assetId) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        RestoreAssetRequest that = (RestoreAssetRequest) obj;
    ...
    public String toString() {
        ...
        sb.append("class RestoreAssetRequest {\n");
