 ...
 * Response Object
 */
public class UpdateAudioRecordConfigResponse extends SdkResponse {
    ...
    public UpdateAudioRecordConfigResponse withProjectId(String projectId) {
    ...
    public UpdateAudioRecordConfigResponse withObsBucketName(String obsBucketName) {
    ...
    public UpdateAudioRecordConfigResponse withObsEndpoint(String obsEndpoint) {
    ...
    public UpdateAudioRecordConfigResponse withEnableAudioRecord(Boolean enableAudioRecord) {
    ...
    public UpdateAudioRecordConfigResponse withCreateTime(String createTime) {
    ...
    public UpdateAudioRecordConfigResponse withUpdateTime(String updateTime) {
    ...
    public UpdateAudioRecordConfigResponse withXRequestId(String xRequestId) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        UpdateAudioRecordConfigResponse that = (UpdateAudioRecordConfigResponse) obj;
    ...
    public String toString() {
        ...
        sb.append("class UpdateAudioRecordConfigResponse {\n");
