 ...
 * Request Object
 */
public class CreateTtsOnceCodeRequest {
    ...
    public CreateTtsOnceCodeRequest withXRequestId(String xRequestId) {
    ...
    public CreateTtsOnceCodeRequest withAuthorization(String authorization) {
    ...
    public CreateTtsOnceCodeRequest withXSdkDate(String xSdkDate) {
    ...
    public CreateTtsOnceCodeRequest withXProjectId(String xProjectId) {
    ...
    public CreateTtsOnceCodeRequest withXAppUserId(String xAppUserId) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        CreateTtsOnceCodeRequest that = (CreateTtsOnceCodeRequest) obj;
    ...
    public String toString() {
        ...
        sb.append("class CreateTtsOnceCodeRequest {\n");
