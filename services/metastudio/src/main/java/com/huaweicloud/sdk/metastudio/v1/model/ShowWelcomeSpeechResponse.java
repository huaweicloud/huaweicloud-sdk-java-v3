 ...
 * Response Object
 */
public class ShowWelcomeSpeechResponse extends SdkResponse {
    ...
    public ShowWelcomeSpeechResponse withWelcomeSpeech(String welcomeSpeech) {
    ...
    public ShowWelcomeSpeechResponse withEnableWelcomeSpeech(Boolean enableWelcomeSpeech) {
    ...
    public ShowWelcomeSpeechResponse withLanguage(LanguageEnum language) {
    ...
    public ShowWelcomeSpeechResponse withRobotId(String robotId) {
    ...
    public ShowWelcomeSpeechResponse withCreateTime(String createTime) {
    ...
    public ShowWelcomeSpeechResponse withUpdateTime(String updateTime) {
    ...
    public ShowWelcomeSpeechResponse withXRequestId(String xRequestId) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ShowWelcomeSpeechResponse that = (ShowWelcomeSpeechResponse) obj;
    ...
    public String toString() {
        ...
        sb.append("class ShowWelcomeSpeechResponse {\n");
