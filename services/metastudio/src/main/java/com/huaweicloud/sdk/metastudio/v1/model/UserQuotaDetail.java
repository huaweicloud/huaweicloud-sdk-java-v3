...
public class UserQuotaDetail {
    ...
    private Integer videoTime2dModel;

    @JsonInclude(JsonInclude.Include.NON_NULL)
    @JsonProperty(value = "video_time_flexus_2d_model")

    private Integer videoTimeFlexus2dModel;
    ...
    public UserQuotaDetail withModelingCount2dModel(Integer modelingCount2dModel) {
    ...
    public UserQuotaDetail withModelingCount2dModelFlexus(Integer modelingCount2dModelFlexus) {
    ...
    public UserQuotaDetail withVideoTime2dModel(Integer videoTime2dModel) {
     ...
     */
    public Integer getVideoTime2dModel() {
        return videoTime2dModel;
    }

    public void setVideoTime2dModel(Integer videoTime2dModel) {
        this.videoTime2dModel = videoTime2dModel;
    }

    public UserQuotaDetail withVideoTimeFlexus2dModel(Integer videoTimeFlexus2dModel) {
     ...
     */
    public Integer getVideoTimeFlexus2dModel() {
        return videoTimeFlexus2dModel;
    }

    public void setVideoTimeFlexus2dModel(Integer videoTimeFlexus2dModel) {
        this.videoTimeFlexus2dModel = videoTimeFlexus2dModel;
    }

    public UserQuotaDetail withVoiceCloneBasic(Integer voiceCloneBasic) {
    ...
    public UserQuotaDetail withVoiceCloneMiddle(Integer voiceCloneMiddle) {
    ...
    public UserQuotaDetail withVoiceCloneAdvance(Integer voiceCloneAdvance) {
    ...
    public UserQuotaDetail withVoiceCloneFlexus(Integer voiceCloneFlexus) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        UserQuotaDetail that = (UserQuotaDetail) obj;
    ...
    public String toString() {
        ...
        sb.append("class UserQuotaDetail {\n");
