 ...
 * Request Object
 */
public class ShowPluginConfigRequest {
    ...
    public ShowPluginConfigRequest withAuthorization(String authorization) {
    ...
    public ShowPluginConfigRequest withXSdkDate(String xSdkDate) {
    ...
    public ShowPluginConfigRequest withXProjectId(String xProjectId) {
    ...
    public ShowPluginConfigRequest withXAppUserId(String xAppUserId) {
    ...
    public ShowPluginConfigRequest withPluginConfigId(String pluginConfigId) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ShowPluginConfigRequest that = (ShowPluginConfigRequest) obj;
    ...
    @Override
    public int hashCode() {
        return Objects.hash(authorization, xSdkDate, xProjectId, xAppUserId, pluginConfigId);
    }

    @Override
    public String toString() {
        StringBuilder sb = new StringBuilder();
        sb.append("class ShowPluginConfigRequest {\n");
