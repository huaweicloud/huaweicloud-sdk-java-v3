...
public class ListWelcomeSpeechRequest {
    ...
    public ListWelcomeSpeechRequest withAuthorization(String authorization) {
    ...
    public ListWelcomeSpeechRequest withXSdkDate(String xSdkDate) {
    ...
    public ListWelcomeSpeechRequest withXProjectId(String xProjectId) {
    ...
    public ListWelcomeSpeechRequest withXAppUserId(String xAppUserId) {
    ...
    public ListWelcomeSpeechRequest withOffset(Integer offset) {
        this.offset = offset;
        return this;
    }
    ...
    public ListWelcomeSpeechRequest withLimit(Integer limit) {
        this.limit = limit;
        return this;
    }
    ...
    public ListWelcomeSpeechRequest withRobotId(String robotId) {
    ...
    public ListWelcomeSpeechRequest withLanguage(LanguageEnum language) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ListWelcomeSpeechRequest that = (ListWelcomeSpeechRequest) obj;
    ...
    @Override
    public int hashCode() {
        return Objects.hash(authorization, xSdkDate, xProjectId, xAppUserId, offset, limit, robotId, language);
    }
