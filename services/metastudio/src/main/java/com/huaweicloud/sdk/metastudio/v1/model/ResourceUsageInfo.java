...
public class ResourceUsageInfo {
    ...
    public ResourceUsageInfo withResourceType(String resourceType) {
    ...
    public ResourceUsageInfo withBusinessType(BusinessTypeEnum businessType) {
    ...
    public ResourceUsageInfo withSubResourceType(String subResourceType) {
    ...
    public ResourceUsageInfo withIsSubResource(Boolean isSubResource) {
    ...
    public ResourceUsageInfo withChargingMode(ChargingModeEnum chargingMode) {
    ...
    public ResourceUsageInfo withResourceSource(String resourceSource) {
    ...
    public ResourceUsageInfo withUnit(UnitEnum unit) {
        this.unit = unit;
        return this;
    }
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ResourceUsageInfo that = (ResourceUsageInfo) obj;
