...
public class ImportResourceRequestBody implements SdkFormDataBody {
    ...
    public ImportResourceRequestBody withFile(FormDataFilePart file) {
        this.file = file;
        return this;
    }
    ...
    public ImportResourceRequestBody withFile(InputStream inputStream, String fileName, String contentType) {
        this.file = new FormDataFilePart(inputStream, fileName).withContentType(contentType);
        return this;
    }

    public ImportResourceRequestBody withFile(InputStream inputStream, String fileName) {
        this.file = new FormDataFilePart(inputStream, fileName);
        return this;
    }

    public ImportResourceRequestBody withFile(InputStream inputStream, String fileName, Map<String, String> headers) {
