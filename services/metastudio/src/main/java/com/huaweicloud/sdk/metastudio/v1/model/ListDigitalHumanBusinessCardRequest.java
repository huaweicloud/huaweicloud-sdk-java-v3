 ...
 * Request Object
 */
public class ListDigitalHumanBusinessCardRequest {
    ...
    public ListDigitalHumanBusinessCardRequest withAuthorization(String authorization) {
    ...
    public ListDigitalHumanBusinessCardRequest withXSdkDate(String xSdkDate) {
    ...
    public ListDigitalHumanBusinessCardRequest withXProjectId(String xProjectId) {
    ...
    public ListDigitalHumanBusinessCardRequest withXAppUserId(String xAppUserId) {
    ...
    public ListDigitalHumanBusinessCardRequest withOffset(Integer offset) {
        this.offset = offset;
        return this;
    }
    ...
    public ListDigitalHumanBusinessCardRequest withLimit(Integer limit) {
        this.limit = limit;
        return this;
    }
    ...
    public ListDigitalHumanBusinessCardRequest withState(String state) {
        this.state = state;
        return this;
    }
    ...
    public ListDigitalHumanBusinessCardRequest withSortKey(String sortKey) {
    ...
    public ListDigitalHumanBusinessCardRequest withSortDir(String sortDir) {
    ...
    public ListDigitalHumanBusinessCardRequest withCreateUntil(String createUntil) {
    ...
    public ListDigitalHumanBusinessCardRequest withCreateSince(String createSince) {
    ...
    public ListDigitalHumanBusinessCardRequest withVideoAssetName(String videoAssetName) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ListDigitalHumanBusinessCardRequest that = (ListDigitalHumanBusinessCardRequest) obj;
        return Objects.equals(this.authorization, that.authorization) && Objects.equals(this.xSdkDate, that.xSdkDate)
            ...
            && Objects.equals(this.videoAssetName, that.videoAssetName);
    }
    ...
    public String toString() {
        ...
        sb.append("class ListDigitalHumanBusinessCardRequest {\n");
