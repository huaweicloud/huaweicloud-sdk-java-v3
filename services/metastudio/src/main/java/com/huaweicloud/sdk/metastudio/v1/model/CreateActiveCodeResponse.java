 ...
 * Response Object
 */
public class CreateActiveCodeResponse extends SdkResponse {
    ...
    public CreateActiveCodeResponse withActiveCodeId(String activeCodeId) {
    ...
    public CreateActiveCodeResponse withActiveCode(String activeCode) {
    ...
    public CreateActiveCodeResponse withRobotId(String robotId) {
    ...
    public CreateActiveCodeResponse withRoomId(String roomId) {
        this.roomId = roomId;
        return this;
    }
    ...
    public CreateActiveCodeResponse withValidPeriod(Integer validPeriod) {
    ...
    public CreateActiveCodeResponse withExpireTime(String expireTime) {
    ...
    public CreateActiveCodeResponse withCreateTime(String createTime) {
    ...
    public CreateActiveCodeResponse withUpdateTime(String updateTime) {
    ...
    public CreateActiveCodeResponse withXRequestId(String xRequestId) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        CreateActiveCodeResponse that = (CreateActiveCodeResponse) obj;
    ...
    public String toString() {
        ...
        sb.append("class CreateActiveCodeResponse {\n");
