 ...
 * Response Object
 */
public class CreateHotWordsResponse extends SdkResponse {
    ...
    public CreateHotWordsResponse withHotWordsId(String hotWordsId) {
    ...
    public CreateHotWordsResponse withRobotId(String robotId) {
    ...
    public CreateHotWordsResponse withHotWordsType(HotWordsTypeEnum hotWordsType) {
    ...
    public CreateHotWordsResponse withVocabularyId(String vocabularyId) {
    ...
    public CreateHotWordsResponse withSisProjectId(String sisProjectId) {
    ...
    public CreateHotWordsResponse withRegion(Integer region) {
        this.region = region;
        return this;
    }
    ...
    public CreateHotWordsResponse withLanguage(LanguageEnum language) {
    ...
    public CreateHotWordsResponse withCreateTime(String createTime) {
    ...
    public CreateHotWordsResponse withUpdateTime(String updateTime) {
    ...
    public CreateHotWordsResponse withXRequestId(String xRequestId) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        CreateHotWordsResponse that = (CreateHotWordsResponse) obj;
    ...
    public String toString() {
        ...
        sb.append("class CreateHotWordsResponse {\n");
