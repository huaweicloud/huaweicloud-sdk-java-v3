...
public class KnowledgeLibraryInfo {
    ...
    public KnowledgeLibraryInfo withKnowledgeLibraryId(String knowledgeLibraryId) {
    ...
    public KnowledgeLibraryInfo withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public KnowledgeLibraryInfo withLanguage(LanguageEnum language) {
    ...
    public KnowledgeLibraryInfo withKnowledgeType(KnowledgeTypeEnum knowledgeType) {
    ...
    public KnowledgeLibraryInfo withKnowledgeSize(Integer knowledgeSize) {
    ...
    public KnowledgeLibraryInfo withTopk(Integer topk) {
        this.topk = topk;
        return this;
    }
    ...
    public KnowledgeLibraryInfo withScore(Double score) {
        this.score = score;
        return this;
    }
    ...
    public KnowledgeLibraryInfo withCreateTime(String createTime) {
    ...
    public KnowledgeLibraryInfo withUpdateTime(String updateTime) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        KnowledgeLibraryInfo that = (KnowledgeLibraryInfo) obj;
