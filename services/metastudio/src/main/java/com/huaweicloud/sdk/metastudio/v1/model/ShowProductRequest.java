...
public class ShowProductRequest {
    ...
    public ShowProductRequest withAuthorization(String authorization) {
    ...
    public ShowProductRequest withXSdkDate(String xSdkDate) {
    ...
    public ShowProductRequest withXProjectId(String xProjectId) {
    ...
    public ShowProductRequest withXAppUserId(String xAppUserId) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ShowProductRequest that = (ShowProductRequest) obj;
    ...
    @Override
    public int hashCode() {
        return Objects.hash(authorization, xSdkDate, xProjectId, xAppUserId, productId);
    }
