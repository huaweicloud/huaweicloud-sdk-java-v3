...
public class CreateVideoScriptsReq {
    ...
    public CreateVideoScriptsReq withViewMode(ViewModeEnum viewMode) {
    ...
    public CreateVideoScriptsReq withAudioFiles(ShootScriptAudioFiles audioFiles) {
        this.audioFiles = audioFiles;
        return this;
    }

    public CreateVideoScriptsReq withAudioFiles(Consumer<ShootScriptAudioFiles> audioFilesSetter) {
    ...
    public CreateVideoScriptsReq withActionConfig(ActionConfig actionConfig) {
        this.actionConfig = actionConfig;
        return this;
    }

    public CreateVideoScriptsReq withActionConfig(Consumer<ActionConfig> actionConfigSetter) {
