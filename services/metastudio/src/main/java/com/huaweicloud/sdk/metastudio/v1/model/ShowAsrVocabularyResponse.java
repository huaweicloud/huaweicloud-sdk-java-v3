 ...
 * Response Object
 */
public class ShowAsrVocabularyResponse extends SdkResponse {
    ...
    public ShowAsrVocabularyResponse withAsrVocabularyId(String asrVocabularyId) {
    ...
    public ShowAsrVocabularyResponse withVocabularyType(AsrVocabularyTypeEnum vocabularyType) {
    ...
    public ShowAsrVocabularyResponse withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public ShowAsrVocabularyResponse withContent(String content) {
    ...
    public ShowAsrVocabularyResponse withLanguage(LanguageEnum language) {
    ...
    public ShowAsrVocabularyResponse withCreateTime(String createTime) {
    ...
    public ShowAsrVocabularyResponse withUpdateTime(String updateTime) {
    ...
    public ShowAsrVocabularyResponse withXRequestId(String xRequestId) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ShowAsrVocabularyResponse that = (ShowAsrVocabularyResponse) obj;
    ...
    public String toString() {
        ...
        sb.append("class ShowAsrVocabularyResponse {\n");
