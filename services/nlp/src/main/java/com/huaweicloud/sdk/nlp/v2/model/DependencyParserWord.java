...
public class DependencyParserWord {
    ...
    public static final class DependencyLabelEnum {
        ...
        public static DependencyLabelEnum fromValue(String value) {
            ...
            return java.util.Optional.ofNullable(STATIC_FIELDS.get(value)).orElse(new DependencyLabelEnum(value));
        }
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        DependencyParserWord that = (DependencyParserWord) obj;
        return Objects.equals(this.id, that.id) && Objects.equals(this.word, that.word)
            && Objects.equals(this.headWordId, that.headWordId) && Objects.equals(this.pos, that.pos)
            && Objects.equals(this.dependencyLabel, that.dependencyLabel);
    }
