...
public class AntiDDoSAsyncClient {
     ...
     */
    public AsyncInvoker<CreateDefaultConfigRequest, CreateDefaultConfigResponse> createDefaultConfigAsyncInvoker(CreateDefaultConfigRequest request) {
        return new AsyncInvoker<CreateDefaultConfigRequest, CreateDefaultConfigResponse>(request, AntiDDoSMeta.createDefaultConfig, hcClient);
    }
     ...
     */
    public AsyncInvoker<DeleteDefaultConfigRequest, DeleteDefaultConfigResponse> deleteDefaultConfigAsyncInvoker(DeleteDefaultConfigRequest request) {
        return new AsyncInvoker<DeleteDefaultConfigRequest, DeleteDefaultConfigResponse>(request, AntiDDoSMeta.deleteDefaultConfig, hcClient);
    }
     ...
     */
    public AsyncInvoker<ShowAlertConfigRequest, ShowAlertConfigResponse> showAlertConfigAsyncInvoker(ShowAlertConfigRequest request) {
        return new AsyncInvoker<ShowAlertConfigRequest, ShowAlertConfigResponse>(request, AntiDDoSMeta.showAlertConfig, hcClient);
    }
     ...
     */
    public AsyncInvoker<ShowDefaultConfigRequest, ShowDefaultConfigResponse> showDefaultConfigAsyncInvoker(ShowDefaultConfigRequest request) {
        return new AsyncInvoker<ShowDefaultConfigRequest, ShowDefaultConfigResponse>(request, AntiDDoSMeta.showDefaultConfig, hcClient);
    }
     ...
     */
    public AsyncInvoker<UpdateAlertConfigRequest, UpdateAlertConfigResponse> updateAlertConfigAsyncInvoker(UpdateAlertConfigRequest request) {
        return new AsyncInvoker<UpdateAlertConfigRequest, UpdateAlertConfigResponse>(request, AntiDDoSMeta.updateAlertConfig, hcClient);
    }
     ...
     */
    public AsyncInvoker<ListDDosStatusRequest, ListDDosStatusResponse> listDDosStatusAsyncInvoker(ListDDosStatusRequest request) {
        return new AsyncInvoker<ListDDosStatusRequest, ListDDosStatusResponse>(request, AntiDDoSMeta.listDDosStatus, hcClient);
    }
     ...
     */
    public AsyncInvoker<ListDailyLogRequest, ListDailyLogResponse> listDailyLogAsyncInvoker(ListDailyLogRequest request) {
        return new AsyncInvoker<ListDailyLogRequest, ListDailyLogResponse>(request, AntiDDoSMeta.listDailyLog, hcClient);
    }
     ...
     */
    public AsyncInvoker<ListDailyReportRequest, ListDailyReportResponse> listDailyReportAsyncInvoker(ListDailyReportRequest request) {
        return new AsyncInvoker<ListDailyReportRequest, ListDailyReportResponse>(request, AntiDDoSMeta.listDailyReport, hcClient);
    }
     ...
     */
    public AsyncInvoker<ListNewConfigsRequest, ListNewConfigsResponse> listNewConfigsAsyncInvoker(ListNewConfigsRequest request) {
        return new AsyncInvoker<ListNewConfigsRequest, ListNewConfigsResponse>(request, AntiDDoSMeta.listNewConfigs, hcClient);
    }
     ...
     */
    public AsyncInvoker<ListWeeklyReportsRequest, ListWeeklyReportsResponse> listWeeklyReportsAsyncInvoker(ListWeeklyReportsRequest request) {
        return new AsyncInvoker<ListWeeklyReportsRequest, ListWeeklyReportsResponse>(request, AntiDDoSMeta.listWeeklyReports, hcClient);
    }
     ...
     */
    public AsyncInvoker<ShowDDosStatusRequest, ShowDDosStatusResponse> showDDosStatusAsyncInvoker(ShowDDosStatusRequest request) {
        return new AsyncInvoker<ShowDDosStatusRequest, ShowDDosStatusResponse>(request, AntiDDoSMeta.showDDosStatus, hcClient);
    }
     ...
     */
    public AsyncInvoker<ShowNewTaskStatusRequest, ShowNewTaskStatusResponse> showNewTaskStatusAsyncInvoker(ShowNewTaskStatusRequest request) {
        return new AsyncInvoker<ShowNewTaskStatusRequest, ShowNewTaskStatusResponse>(request, AntiDDoSMeta.showNewTaskStatus, hcClient);
    }
