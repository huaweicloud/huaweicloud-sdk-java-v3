...
public class AntiDDoSClient {
     ...
     */
    public SyncInvoker<CreateDefaultConfigRequest, CreateDefaultConfigResponse> createDefaultConfigInvoker(CreateDefaultConfigRequest request) {
        return new SyncInvoker<CreateDefaultConfigRequest, CreateDefaultConfigResponse>(request, AntiDDoSMeta.createDefaultConfig, hcClient);
    }
     ...
     */
    public SyncInvoker<DeleteDefaultConfigRequest, DeleteDefaultConfigResponse> deleteDefaultConfigInvoker(DeleteDefaultConfigRequest request) {
        return new SyncInvoker<DeleteDefaultConfigRequest, DeleteDefaultConfigResponse>(request, AntiDDoSMeta.deleteDefaultConfig, hcClient);
    }
     ...
     */
    public SyncInvoker<ShowAlertConfigRequest, ShowAlertConfigResponse> showAlertConfigInvoker(ShowAlertConfigRequest request) {
        return new SyncInvoker<ShowAlertConfigRequest, ShowAlertConfigResponse>(request, AntiDDoSMeta.showAlertConfig, hcClient);
    }
     ...
     */
    public SyncInvoker<ShowDefaultConfigRequest, ShowDefaultConfigResponse> showDefaultConfigInvoker(ShowDefaultConfigRequest request) {
        return new SyncInvoker<ShowDefaultConfigRequest, ShowDefaultConfigResponse>(request, AntiDDoSMeta.showDefaultConfig, hcClient);
    }
     ...
     */
    public SyncInvoker<UpdateAlertConfigRequest, UpdateAlertConfigResponse> updateAlertConfigInvoker(UpdateAlertConfigRequest request) {
        return new SyncInvoker<UpdateAlertConfigRequest, UpdateAlertConfigResponse>(request, AntiDDoSMeta.updateAlertConfig, hcClient);
    }
     ...
     */
    public SyncInvoker<ListDDosStatusRequest, ListDDosStatusResponse> listDDosStatusInvoker(ListDDosStatusRequest request) {
        return new SyncInvoker<ListDDosStatusRequest, ListDDosStatusResponse>(request, AntiDDoSMeta.listDDosStatus, hcClient);
    }
    ...
    public SyncInvoker<ListDailyLogRequest, ListDailyLogResponse> listDailyLogInvoker(ListDailyLogRequest request) {
        return new SyncInvoker<ListDailyLogRequest, ListDailyLogResponse>(request, AntiDDoSMeta.listDailyLog, hcClient);
    }
     ...
     */
    public SyncInvoker<ListDailyReportRequest, ListDailyReportResponse> listDailyReportInvoker(ListDailyReportRequest request) {
        return new SyncInvoker<ListDailyReportRequest, ListDailyReportResponse>(request, AntiDDoSMeta.listDailyReport, hcClient);
    }
     ...
     */
    public SyncInvoker<ListNewConfigsRequest, ListNewConfigsResponse> listNewConfigsInvoker(ListNewConfigsRequest request) {
        return new SyncInvoker<ListNewConfigsRequest, ListNewConfigsResponse>(request, AntiDDoSMeta.listNewConfigs, hcClient);
    }
     ...
     */
    public SyncInvoker<ListWeeklyReportsRequest, ListWeeklyReportsResponse> listWeeklyReportsInvoker(ListWeeklyReportsRequest request) {
        return new SyncInvoker<ListWeeklyReportsRequest, ListWeeklyReportsResponse>(request, AntiDDoSMeta.listWeeklyReports, hcClient);
    }
    ...
    public SyncInvoker<ShowDDosRequest, ShowDDosResponse> showDDosInvoker(ShowDDosRequest request) {
        return new SyncInvoker<ShowDDosRequest, ShowDDosResponse>(request, AntiDDoSMeta.showDDos, hcClient);
    }
     ...
     */
    public SyncInvoker<ShowDDosStatusRequest, ShowDDosStatusResponse> showDDosStatusInvoker(ShowDDosStatusRequest request) {
        return new SyncInvoker<ShowDDosStatusRequest, ShowDDosStatusResponse>(request, AntiDDoSMeta.showDDosStatus, hcClient);
    }
     ...
     */
    public SyncInvoker<ShowNewTaskStatusRequest, ShowNewTaskStatusResponse> showNewTaskStatusInvoker(ShowNewTaskStatusRequest request) {
        return new SyncInvoker<ShowNewTaskStatusRequest, ShowNewTaskStatusResponse>(request, AntiDDoSMeta.showNewTaskStatus, hcClient);
    }
    ...
    public SyncInvoker<UpdateDDosRequest, UpdateDDosResponse> updateDDosInvoker(UpdateDDosRequest request) {
        return new SyncInvoker<UpdateDDosRequest, UpdateDDosResponse>(request, AntiDDoSMeta.updateDDos, hcClient);
    }
