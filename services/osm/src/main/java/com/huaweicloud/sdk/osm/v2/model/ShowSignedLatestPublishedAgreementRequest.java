...
public class ShowSignedLatestPublishedAgreementRequest {
    ...
    public ShowSignedLatestPublishedAgreementRequest withXSite(Integer xSite) {
        this.xSite = xSite;
        return this;
    }
    ...
    public ShowSignedLatestPublishedAgreementRequest withXLanguage(String xLanguage) {
    ...
    public ShowSignedLatestPublishedAgreementRequest withXTimeZone(String xTimeZone) {
    ...
    public String toString() {
        ...
        sb.append("class ShowSignedLatestPublishedAgreementRequest {\n");
