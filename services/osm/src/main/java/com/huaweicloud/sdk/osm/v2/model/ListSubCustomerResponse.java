 ...
 * Response Object
 */
public class ListSubCustomerResponse extends SdkResponse {
    ...
    public ListSubCustomerResponse withSubCustomerInfos(List<SubCutomerInfoV2> subCustomerInfos) {
        this.subCustomerInfos = subCustomerInfos;
        return this;
    }

    
    public ListSubCustomerResponse addSubCustomerInfosItem(SubCutomerInfoV2 subCustomerInfosItem) {
    ...
    public ListSubCustomerResponse withSubCustomerInfos(Consumer<List<SubCutomerInfoV2>> subCustomerInfosSetter) {
        if(this.subCustomerInfos == null ){
            this.subCustomerInfos = new ArrayList<>();
        }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ListSubCustomerResponse listSubCustomerResponse = (ListSubCustomerResponse) o;
        return Objects.equals(this.subCustomerInfos, listSubCustomerResponse.subCustomerInfos);
    }
    @Override
    public int hashCode() {
    ...
    public String toString() {
        ...
        sb.append("class ListSubCustomerResponse {\n");
