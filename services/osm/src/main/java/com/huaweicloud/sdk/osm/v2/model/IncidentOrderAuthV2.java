...
public class IncidentOrderAuthV2  {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, status, incidentId, simpleDescription, resourceTypeName, visitTypeName, createTime, authEffectiveTime, authExpireTime, rejectReason, customerId, xCustomerId, xCustomerName);
    }
    @Override
