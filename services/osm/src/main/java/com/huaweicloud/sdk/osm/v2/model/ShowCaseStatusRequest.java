 ...
 * Request Object
 */
public class ShowCaseStatusRequest  {
    ...
    public ShowCaseStatusRequest withCaseId(String caseId) {
        this.caseId = caseId;
        return this;
    }
    ...
    public ShowCaseStatusRequest withXSite(Integer xSite) {
        this.xSite = xSite;
        return this;
    }
    ...
    public ShowCaseStatusRequest withXLanguage(String xLanguage) {
    ...
    public ShowCaseStatusRequest withXTimeZone(String xTimeZone) {
    ...
    public String toString() {
        ...
        sb.append("class ShowCaseStatusRequest {\n");
