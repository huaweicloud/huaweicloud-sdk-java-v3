 ...
 * Response Object
 */
public class DeleteCaseLabelsResponse extends SdkResponse {
    ...
    public DeleteCaseLabelsResponse withErrorCode(String errorCode) {
    ...
    public DeleteCaseLabelsResponse withErrorMsg(String errorMsg) {
    ...
    public String toString() {
        ...
        sb.append("class DeleteCaseLabelsResponse {\n");
