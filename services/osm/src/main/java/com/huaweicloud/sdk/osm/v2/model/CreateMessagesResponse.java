...
/** Response Object */
public class CreateMessagesResponse extends SdkResponse {
    ...
    public CreateMessagesResponse withErrorCode(String errorCode) {
    ...
    public CreateMessagesResponse withErrorMsg(String errorMsg) {
    ...
    public String toString() {
        ...
        sb.append("class CreateMessagesResponse {\n");
