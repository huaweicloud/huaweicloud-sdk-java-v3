 ...
 * Request Object
 */
public class ListProblemTypesRequest {
    ...
    public ListProblemTypesRequest withProductCategoryId(String productCategoryId) {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(productCategoryId, xSite, xLanguage, xTimeZone);
    }

    @Override
    public String toString() {
        StringBuilder sb = new StringBuilder();
        sb.append("class ListProblemTypesRequest {\n");
