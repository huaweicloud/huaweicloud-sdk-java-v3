...
public class ShowQaPairDetailRequest {
    ...
    public ShowQaPairDetailRequest withXServiceKey(String xServiceKey) {
    ...
    public ShowQaPairDetailRequest withXSite(String xSite) {
        this.xSite = xSite;
        return this;
    }
    ...
    public ShowQaPairDetailRequest withXLanguage(String xLanguage) {
    ...
    public ShowQaPairDetailRequest withQaPairId(String qaPairId) {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(xServiceKey, xSite, xLanguage, qaPairId);
    }
