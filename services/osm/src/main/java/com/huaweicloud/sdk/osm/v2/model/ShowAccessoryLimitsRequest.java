 ...
 * Request Object
 */
public class ShowAccessoryLimitsRequest  {
    ...
    public ShowAccessoryLimitsRequest withXSite(Integer xSite) {
        this.xSite = xSite;
        return this;
    }
    ...
    public ShowAccessoryLimitsRequest withXLanguage(String xLanguage) {
    ...
    public ShowAccessoryLimitsRequest withXTimeZone(String xTimeZone) {
    ...
    public String toString() {
        ...
        sb.append("class ShowAccessoryLimitsRequest {\n");
