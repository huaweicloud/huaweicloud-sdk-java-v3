...
/** Response Object */
public class CreatePrivilegesResponse extends SdkResponse {
    ...
    public CreatePrivilegesResponse withErrorCode(String errorCode) {
    ...
    public CreatePrivilegesResponse withErrorMsg(String errorMsg) {
    ...
    public String toString() {
        ...
        sb.append("class CreatePrivilegesResponse {\n");
