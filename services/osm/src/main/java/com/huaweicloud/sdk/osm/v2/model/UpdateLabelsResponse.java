 ...
 * Response Object
 */
public class UpdateLabelsResponse extends SdkResponse {
    ...
    public UpdateLabelsResponse withErrorCode(String errorCode) {
    ...
    public UpdateLabelsResponse withErrorMsg(String errorMsg) {
    ...
    public String toString() {
        ...
        sb.append("class UpdateLabelsResponse {\n");
