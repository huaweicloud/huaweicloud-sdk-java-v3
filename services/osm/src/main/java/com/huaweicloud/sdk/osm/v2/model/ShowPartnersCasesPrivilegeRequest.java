 ...
 * Request Object
 */
public class ShowPartnersCasesPrivilegeRequest  {
    ...
    public ShowPartnersCasesPrivilegeRequest withXSite(Integer xSite) {
        this.xSite = xSite;
        return this;
    }
    ...
    public ShowPartnersCasesPrivilegeRequest withXLanguage(String xLanguage) {
    ...
    public ShowPartnersCasesPrivilegeRequest withXTimeZone(String xTimeZone) {
    ...
    public String toString() {
        ...
        sb.append("class ShowPartnersCasesPrivilegeRequest {\n");
