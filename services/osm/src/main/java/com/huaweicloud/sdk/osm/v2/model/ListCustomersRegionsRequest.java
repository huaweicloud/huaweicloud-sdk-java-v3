 ...
 * Request Object
 */
public class ListCustomersRegionsRequest {
    ...
    public ListCustomersRegionsRequest withXSite(Integer xSite) {
        this.xSite = xSite;
        return this;
    }
    ...
    public ListCustomersRegionsRequest withXLanguage(String xLanguage) {
    ...
    public ListCustomersRegionsRequest withXTimeZone(String xTimeZone) {
    ...
    public String toString() {
        ...
        sb.append("class ListCustomersRegionsRequest {\n");
