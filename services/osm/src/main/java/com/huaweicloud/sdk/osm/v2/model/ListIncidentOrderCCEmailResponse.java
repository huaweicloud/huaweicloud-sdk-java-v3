...
public class ListIncidentOrderCCEmailResponse extends SdkResponse {
    ...
    public ListIncidentOrderCCEmailResponse withCcEmailInfo(IncidentOrderCCEmailInfoV2 ccEmailInfo) {
        this.ccEmailInfo = ccEmailInfo;
        return this;
    }

    public ListIncidentOrderCCEmailResponse withCcEmailInfo(Consumer<IncidentOrderCCEmailInfoV2> ccEmailInfoSetter) {
    ...
    public ListIncidentOrderCCEmailResponse withMcEmailInfos(List<String> mcEmailInfos) {
        this.mcEmailInfos = mcEmailInfos;
        return this;
    }

    
    public ListIncidentOrderCCEmailResponse addMcEmailInfosItem(String mcEmailInfosItem) {
    ...
    public ListIncidentOrderCCEmailResponse withMcEmailInfos(Consumer<List<String>> mcEmailInfosSetter) {
        if(this.mcEmailInfos == null ){
            this.mcEmailInfos = new ArrayList<>();
        }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ListIncidentOrderCCEmailResponse listIncidentOrderCCEmailResponse = (ListIncidentOrderCCEmailResponse) o;
        return Objects.equals(this.ccEmailInfo, listIncidentOrderCCEmailResponse.ccEmailInfo) &&
            Objects.equals(this.mcEmailInfos, listIncidentOrderCCEmailResponse.mcEmailInfos);
    }
    @Override
    public int hashCode() {
