 ...
 * Response Object
 */
public class CreateFeedbackResponse extends SdkResponse {
    ...
    public CreateFeedbackResponse withErrorCode(String errorCode) {
    ...
    public CreateFeedbackResponse withErrorMsg(String errorMsg) {
