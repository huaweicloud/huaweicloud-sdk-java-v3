 ...
 * Request Object
 */
public class ShowCustomerPrivilegePolicyRequest {
    ...
    public ShowCustomerPrivilegePolicyRequest withXSite(Integer xSite) {
        this.xSite = xSite;
        return this;
    }
    ...
    public ShowCustomerPrivilegePolicyRequest withXLanguage(String xLanguage) {
    ...
    public ShowCustomerPrivilegePolicyRequest withXTimeZone(String xTimeZone) {
    ...
    public String toString() {
        ...
        sb.append("class ShowCustomerPrivilegePolicyRequest {\n");
