 ...
 * Request Object
 */
public class ListCaseLimitsRequest {
    ...
    public ListCaseLimitsRequest withXSite(Integer xSite) {
        this.xSite = xSite;
        return this;
    }
    ...
    public ListCaseLimitsRequest withXLanguage(String xLanguage) {
    ...
    public ListCaseLimitsRequest withXTimeZone(String xTimeZone) {
    ...
    public String toString() {
        ...
        sb.append("class ListCaseLimitsRequest {\n");
