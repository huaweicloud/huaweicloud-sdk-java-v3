 ...
 * Response Object
 */
public class DeleteLabelsResponse extends SdkResponse {
    ...
    public DeleteLabelsResponse withErrorCode(String errorCode) {
    ...
    public DeleteLabelsResponse withErrorMsg(String errorMsg) {
    ...
    public String toString() {
        ...
        sb.append("class DeleteLabelsResponse {\n");
