 ...
 * Response Object
 */
public class UpdateOpsAnalysisTaskResponse extends SdkResponse {
    ...
    public UpdateOpsAnalysisTaskResponse withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public UpdateOpsAnalysisTaskResponse withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public UpdateOpsAnalysisTaskResponse withDescription(String description) {
    ...
    public UpdateOpsAnalysisTaskResponse withAgent(OpsAnalysisTaskAgent agent) {
        this.agent = agent;
        return this;
    }

    public UpdateOpsAnalysisTaskResponse withAgent(Consumer<OpsAnalysisTaskAgent> agentSetter) {
        if (this.agent == null) {
    ...
    public UpdateOpsAnalysisTaskResponse withAgencyName(String agencyName) {
    ...
    public UpdateOpsAnalysisTaskResponse withStatus(StatusEnum status) {
        this.status = status;
        return this;
    }
    ...
    public UpdateOpsAnalysisTaskResponse withCreatedAt(Long createdAt) {
    ...
    public UpdateOpsAnalysisTaskResponse withUpdatedAt(Long updatedAt) {
    ...
    public UpdateOpsAnalysisTaskResponse withNextFireTime(Long nextFireTime) {
    ...
    public UpdateOpsAnalysisTaskResponse withTags(List<OpsTasksTagForTMS> tags) {
        this.tags = tags;
        return this;
    }

    public UpdateOpsAnalysisTaskResponse addTagsItem(OpsTasksTagForTMS tagsItem) {
        if (this.tags == null) {
    ...
    public UpdateOpsAnalysisTaskResponse withTags(Consumer<List<OpsTasksTagForTMS>> tagsSetter) {
        if (this.tags == null) {
            this.tags = new ArrayList<>();
        }
    ...
    public UpdateOpsAnalysisTaskResponse withProgress(OpsTaskProgress progress) {
        this.progress = progress;
        return this;
    }

    public UpdateOpsAnalysisTaskResponse withProgress(Consumer<OpsTaskProgress> progressSetter) {
    ...
    public UpdateOpsAnalysisTaskResponse withExecutionStrategy(OpsExecutionStrategy executionStrategy) {
        this.executionStrategy = executionStrategy;
        return this;
    }

    public UpdateOpsAnalysisTaskResponse withExecutionStrategy(Consumer<OpsExecutionStrategy> executionStrategySetter) {
    ...
    public UpdateOpsAnalysisTaskResponse withStatusCount(OpsAnalysisTaskInstanceStatusCount statusCount) {
        this.statusCount = statusCount;
        return this;
    }

    public UpdateOpsAnalysisTaskResponse withStatusCount(
    ...
    public UpdateOpsAnalysisTaskResponse withSampleStrategy(OpsSampleStrategy sampleStrategy) {
        this.sampleStrategy = sampleStrategy;
        return this;
    }

    public UpdateOpsAnalysisTaskResponse withSampleStrategy(Consumer<OpsSampleStrategy> sampleStrategySetter) {
    ...
    public UpdateOpsAnalysisTaskResponse withFailures(List<OpsFailureCategory> failures) {
        this.failures = failures;
        return this;
    }

    public UpdateOpsAnalysisTaskResponse addFailuresItem(OpsFailureCategory failuresItem) {
    ...
    public UpdateOpsAnalysisTaskResponse withFailures(Consumer<List<OpsFailureCategory>> failuresSetter) {
        if (this.failures == null) {
            this.failures = new ArrayList<>();
        }
    ...
    public UpdateOpsAnalysisTaskResponse withInputTokens(Long inputTokens) {
    ...
    public UpdateOpsAnalysisTaskResponse withOutputTokens(Long outputTokens) {
    ...
    public UpdateOpsAnalysisTaskResponse withTotalSessionCount(Integer totalSessionCount) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        UpdateOpsAnalysisTaskResponse that = (UpdateOpsAnalysisTaskResponse) obj;
    ...
    public String toString() {
        ...
        sb.append("class UpdateOpsAnalysisTaskResponse {\n");
