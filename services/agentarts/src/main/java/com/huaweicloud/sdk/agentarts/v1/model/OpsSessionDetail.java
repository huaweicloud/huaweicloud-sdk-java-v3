...
public class OpsSessionDetail {
    ...
    public OpsSessionDetail withSessionId(String sessionId) {
    ...
    public OpsSessionDetail withLatency(BigDecimal latency) {
    ...
    public OpsSessionDetail withTokens(BigDecimal tokens) {
        this.tokens = tokens;
        return this;
    }
    ...
    public OpsSessionDetail withInputTokens(BigDecimal inputTokens) {
    ...
    public OpsSessionDetail withOutputTokens(BigDecimal outputTokens) {
    ...
    public OpsSessionDetail withTraceNum(BigDecimal traceNum) {
    ...
    public OpsSessionDetail withUserId(String userId) {
        this.userId = userId;
        return this;
    }
    ...
    public OpsSessionDetail withCallType(String callType) {
    ...
    public OpsSessionDetail withStartTime(Long startTime) {
    ...
    public OpsSessionDetail withDomainId(String domainId) {
    ...
    public OpsSessionDetail withResourceId(String resourceId) {
    ...
    public OpsSessionDetail withResourceName(String resourceName) {
    ...
    public OpsSessionDetail withResourceType(String resourceType) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        OpsSessionDetail that = (OpsSessionDetail) obj;
    ...
    public String toString() {
        ...
        sb.append("class OpsSessionDetail {\n");
