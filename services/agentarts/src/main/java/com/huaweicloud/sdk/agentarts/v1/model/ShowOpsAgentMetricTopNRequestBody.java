...
/**
 * ShowOpsAgentMetricTopNRequestBody
 */
public class ShowOpsAgentMetricTopNRequestBody {
    ...
    public ShowOpsAgentMetricTopNRequestBody withEndTime(String endTime) {
    ...
    public ShowOpsAgentMetricTopNRequestBody withMetricName(String metricName) {
    ...
    public ShowOpsAgentMetricTopNRequestBody withResourceId(String resourceId) {
    ...
    public ShowOpsAgentMetricTopNRequestBody withResourceType(ResourceTypeEnum resourceType) {
    ...
    public ShowOpsAgentMetricTopNRequestBody withUserId(String userId) {
        this.userId = userId;
        return this;
    }
    ...
    public ShowOpsAgentMetricTopNRequestBody withFilter(List<MetricFilterParam> filter) {
        this.filter = filter;
        return this;
    }

    public ShowOpsAgentMetricTopNRequestBody addFilterItem(MetricFilterParam filterItem) {
        if (this.filter == null) {
    ...
    public ShowOpsAgentMetricTopNRequestBody withFilter(Consumer<List<MetricFilterParam>> filterSetter) {
        if (this.filter == null) {
            this.filter = new ArrayList<>();
        }
