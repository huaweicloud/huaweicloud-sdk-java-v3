 ...
 * Response Object
 */
public class CreateOpsModelDeploymentResponse extends SdkResponse {
    ...
    public CreateOpsModelDeploymentResponse withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public CreateOpsModelDeploymentResponse withTaskId(String taskId) {
        this.taskId = taskId;
        return this;
    }
    ...
    public CreateOpsModelDeploymentResponse withProductId(String productId) {
    ...
    public CreateOpsModelDeploymentResponse withTaskName(String taskName) {
    ...
    public CreateOpsModelDeploymentResponse withAgent(OpsTuningTargetAgent agent) {
        this.agent = agent;
        return this;
    }

    public CreateOpsModelDeploymentResponse withAgent(Consumer<OpsTuningTargetAgent> agentSetter) {
        if (this.agent == null) {
    ...
    public CreateOpsModelDeploymentResponse withModelName(String modelName) {
    ...
    public CreateOpsModelDeploymentResponse withMaServiceId(String maServiceId) {
    ...
    public CreateOpsModelDeploymentResponse withModelProviderId(String modelProviderId) {
    ...
    public CreateOpsModelDeploymentResponse withModelServiceId(String modelServiceId) {
    ...
    public CreateOpsModelDeploymentResponse withModelServiceName(String modelServiceName) {
    ...
    public CreateOpsModelDeploymentResponse withApiUrl(String apiUrl) {
        this.apiUrl = apiUrl;
        return this;
    }
    ...
    public CreateOpsModelDeploymentResponse withStatus(StatusEnum status) {
        this.status = status;
        return this;
    }
    ...
    public CreateOpsModelDeploymentResponse withCreatedAt(Long createdAt) {
    ...
    public CreateOpsModelDeploymentResponse withFailReason(String failReason) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        CreateOpsModelDeploymentResponse that = (CreateOpsModelDeploymentResponse) obj;
    ...
    public String toString() {
        ...
        sb.append("class CreateOpsModelDeploymentResponse {\n");
