...
/**
 * ShowOpsAgentMetricTrendRequestBody
 */
public class ShowOpsAgentMetricTrendRequestBody {
    ...
    public ShowOpsAgentMetricTrendRequestBody withEndTime(String endTime) {
    ...
    public ShowOpsAgentMetricTrendRequestBody withMetricName(String metricName) {
    ...
    public ShowOpsAgentMetricTrendRequestBody withResourceId(String resourceId) {
    ...
    public ShowOpsAgentMetricTrendRequestBody withResourceType(ResourceTypeEnum resourceType) {
    ...
    public ShowOpsAgentMetricTrendRequestBody withUserId(String userId) {
        this.userId = userId;
        return this;
    }
    ...
    public ShowOpsAgentMetricTrendRequestBody withFilter(List<MetricFilterParam> filter) {
        this.filter = filter;
        return this;
    }

    public ShowOpsAgentMetricTrendRequestBody addFilterItem(MetricFilterParam filterItem) {
        if (this.filter == null) {
    ...
    public ShowOpsAgentMetricTrendRequestBody withFilter(Consumer<List<MetricFilterParam>> filterSetter) {
        if (this.filter == null) {
            this.filter = new ArrayList<>();
        }
