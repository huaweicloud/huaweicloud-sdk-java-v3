...
public class ShowOpsEvaluatorResponse extends SdkResponse {
    ...
    public ShowOpsEvaluatorResponse withEvaluator(OpsListEvaluatorsInfo evaluator) {
        this.evaluator = evaluator;
        return this;
    }

    public ShowOpsEvaluatorResponse withEvaluator(Consumer<OpsListEvaluatorsInfo> evaluatorSetter) {
