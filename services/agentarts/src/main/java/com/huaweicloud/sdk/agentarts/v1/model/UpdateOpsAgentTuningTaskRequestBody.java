 ...
 * 修改智能体优化任务请求体。
 */
public class UpdateOpsAgentTuningTaskRequestBody {
    ...
    public UpdateOpsAgentTuningTaskRequestBody withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public UpdateOpsAgentTuningTaskRequestBody withDescription(String description) {
    ...
    public UpdateOpsAgentTuningTaskRequestBody withType(TypeEnum type) {
        this.type = type;
        return this;
    }
    ...
    public UpdateOpsAgentTuningTaskRequestBody withAgent(OpsAgentTuningTaskAgent agent) {
        this.agent = agent;
        return this;
    }

    public UpdateOpsAgentTuningTaskRequestBody withAgent(Consumer<OpsAgentTuningTaskAgent> agentSetter) {
        if (this.agent == null) {
    ...
    public UpdateOpsAgentTuningTaskRequestBody withTuningTarget(OpsTuningTarget tuningTarget) {
        this.tuningTarget = tuningTarget;
        return this;
    }

    public UpdateOpsAgentTuningTaskRequestBody withTuningTarget(Consumer<OpsTuningTarget> tuningTargetSetter) {
    ...
    public UpdateOpsAgentTuningTaskRequestBody withSampleDuration(OpsSampleDuration sampleDuration) {
        this.sampleDuration = sampleDuration;
        return this;
    }

    public UpdateOpsAgentTuningTaskRequestBody withSampleDuration(Consumer<OpsSampleDuration> sampleDurationSetter) {
    ...
    public UpdateOpsAgentTuningTaskRequestBody withSampleStrategy(OpsSampleStrategy sampleStrategy) {
        this.sampleStrategy = sampleStrategy;
        return this;
    }

    public UpdateOpsAgentTuningTaskRequestBody withSampleStrategy(Consumer<OpsSampleStrategy> sampleStrategySetter) {
    ...
    public UpdateOpsAgentTuningTaskRequestBody withAgencyName(String agencyName) {
    ...
    public UpdateOpsAgentTuningTaskRequestBody withTags(List<OpsTasksTagForTMS> tags) {
        this.tags = tags;
        return this;
    }

    public UpdateOpsAgentTuningTaskRequestBody addTagsItem(OpsTasksTagForTMS tagsItem) {
        if (this.tags == null) {
    ...
    public UpdateOpsAgentTuningTaskRequestBody withTags(Consumer<List<OpsTasksTagForTMS>> tagsSetter) {
        if (this.tags == null) {
            this.tags = new ArrayList<>();
        }
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        UpdateOpsAgentTuningTaskRequestBody that = (UpdateOpsAgentTuningTaskRequestBody) obj;
    ...
    public String toString() {
        ...
        sb.append("class UpdateOpsAgentTuningTaskRequestBody {\n");
