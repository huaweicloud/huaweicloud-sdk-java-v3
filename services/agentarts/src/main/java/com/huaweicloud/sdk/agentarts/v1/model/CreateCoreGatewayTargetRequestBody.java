 ...
 */
public class CreateCoreGatewayTargetRequestBody {
    ...
    public CreateCoreGatewayTargetRequestBody withName(String name) {
        this.name = name;
        return this;
    }

    /**
     * **参数解释：** 目标服务名称。 **约束限制：** 必须以字母或数字开头和结尾，同一网关内目标服务名称唯一。 **取值范围：** 长度为 1-50 个字符，匹配以字母数字开头和结尾、中间可含0到48个字母数字或短横线的字符串，符合正则条件^[a-zA-Z0-9]\\([a-zA-Z0-9-]{0,48}[a-zA-Z0-9])?$。 **默认取值：** 不涉及。 
     * @return name
     */
    ...
    public CreateCoreGatewayTargetRequestBody withDescription(String description) {
        this.description = description;
        return this;
    }

    /**
     * **参数解释：** 目标服务描述。 **约束限制：** 不涉及。 **取值范围：** 长度为 0-200 个字符。 **默认取值：** 不涉及。 
     * @return description
     */
    ...
    public CreateCoreGatewayTargetRequestBody withTargetConfiguration(
    ...
    public CreateCoreGatewayTargetRequestBody withCredentialProviderConfiguration(
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        CreateCoreGatewayTargetRequestBody that = (CreateCoreGatewayTargetRequestBody) obj;
    ...
    public String toString() {
        ...
        sb.append("class CreateCoreGatewayTargetRequestBody {\n");
