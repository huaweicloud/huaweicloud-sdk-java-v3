 ...
 * Response Object
 */
public class ShowOpsModelDeploymentResponse extends SdkResponse {
    ...
    public ShowOpsModelDeploymentResponse withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public ShowOpsModelDeploymentResponse withTaskId(String taskId) {
        this.taskId = taskId;
        return this;
    }
    ...
    public ShowOpsModelDeploymentResponse withProductId(String productId) {
    ...
    public ShowOpsModelDeploymentResponse withTaskName(String taskName) {
    ...
    public ShowOpsModelDeploymentResponse withAgent(OpsTuningTargetAgent agent) {
        this.agent = agent;
        return this;
    }

    public ShowOpsModelDeploymentResponse withAgent(Consumer<OpsTuningTargetAgent> agentSetter) {
        if (this.agent == null) {
    ...
    public ShowOpsModelDeploymentResponse withModelName(String modelName) {
    ...
    public ShowOpsModelDeploymentResponse withMaServiceId(String maServiceId) {
    ...
    public ShowOpsModelDeploymentResponse withModelProviderId(String modelProviderId) {
    ...
    public ShowOpsModelDeploymentResponse withModelServiceId(String modelServiceId) {
    ...
    public ShowOpsModelDeploymentResponse withModelServiceName(String modelServiceName) {
    ...
    public ShowOpsModelDeploymentResponse withApiUrl(String apiUrl) {
        this.apiUrl = apiUrl;
        return this;
    }
    ...
    public ShowOpsModelDeploymentResponse withStatus(StatusEnum status) {
        this.status = status;
        return this;
    }
    ...
    public ShowOpsModelDeploymentResponse withCreatedAt(Long createdAt) {
    ...
    public ShowOpsModelDeploymentResponse withFailReason(String failReason) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ShowOpsModelDeploymentResponse that = (ShowOpsModelDeploymentResponse) obj;
    ...
    public String toString() {
        ...
        sb.append("class ShowOpsModelDeploymentResponse {\n");
