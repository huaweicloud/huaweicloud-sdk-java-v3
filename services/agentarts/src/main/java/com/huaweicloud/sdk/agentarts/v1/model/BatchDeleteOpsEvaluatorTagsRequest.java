 ...
 * Request Object
 */
public class BatchDeleteOpsEvaluatorTagsRequest {
    ...
    public BatchDeleteOpsEvaluatorTagsRequest withEvaluatorId(String evaluatorId) {
    ...
    public BatchDeleteOpsEvaluatorTagsRequest withBody(OpsResourceTagsBatchOptionRequestBody body) {
        this.body = body;
        return this;
    }

    public BatchDeleteOpsEvaluatorTagsRequest withBody(Consumer<OpsResourceTagsBatchOptionRequestBody> bodySetter) {
        if (this.body == null) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        BatchDeleteOpsEvaluatorTagsRequest that = (BatchDeleteOpsEvaluatorTagsRequest) obj;
    ...
    public String toString() {
        ...
        sb.append("class BatchDeleteOpsEvaluatorTagsRequest {\n");
