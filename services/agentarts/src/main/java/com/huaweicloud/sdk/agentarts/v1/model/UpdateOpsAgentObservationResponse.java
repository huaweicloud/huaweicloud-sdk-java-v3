 ...
 * Response Object
 */
public class UpdateOpsAgentObservationResponse extends SdkResponse {
    ...
    public UpdateOpsAgentObservationResponse withResourceId(String resourceId) {
    ...
    public UpdateOpsAgentObservationResponse withResourceName(String resourceName) {
    ...
    public UpdateOpsAgentObservationResponse withResourceType(ResourceTypeEnum resourceType) {
    ...
    public UpdateOpsAgentObservationResponse withStatus(StatusEnum status) {
        this.status = status;
        return this;
    }
    ...
    public UpdateOpsAgentObservationResponse withCreatedAt(OffsetDateTime createdAt) {
    ...
    public UpdateOpsAgentObservationResponse withUpdatedAt(OffsetDateTime updatedAt) {
    ...
    public UpdateOpsAgentObservationResponse withVersion(String version) {
    ...
    public UpdateOpsAgentObservationResponse withSource(SourceEnum source) {
        this.source = source;
        return this;
    }
    ...
    public UpdateOpsAgentObservationResponse withApmAppId(String apmAppId) {
    ...
    public UpdateOpsAgentObservationResponse withAomPromId(String aomPromId) {
    ...
    public UpdateOpsAgentObservationResponse withApmAppToken(String apmAppToken) {
    ...
    public UpdateOpsAgentObservationResponse withAomAccessCode(String aomAccessCode) {
    ...
    public UpdateOpsAgentObservationResponse withLtsGroupId(String ltsGroupId) {
    ...
    public UpdateOpsAgentObservationResponse withLtsStreamId(String ltsStreamId) {
    ...
    public UpdateOpsAgentObservationResponse withLtsLabelName(String ltsLabelName) {
    ...
    public UpdateOpsAgentObservationResponse withApmExporterEndpoint(String apmExporterEndpoint) {
    ...
    public UpdateOpsAgentObservationResponse withAomExporterEndpoint(String aomExporterEndpoint) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        UpdateOpsAgentObservationResponse that = (UpdateOpsAgentObservationResponse) obj;
    ...
    public String toString() {
        ...
        sb.append("class UpdateOpsAgentObservationResponse {\n");
