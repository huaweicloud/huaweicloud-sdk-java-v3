...
/**
 * **参数解释：** Space详细信息。 **约束限制：** 不涉及。 **取值范围：** 不涉及。 **默认取值：** 不涉及。 
 */
public class CoreSpace {
    ...
    public CoreSpace withId(UUID id) {
        this.id = id;
        return this;
    }
    ...
    public CoreSpace withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public CoreSpace withDescription(String description) {
    ...
    public CoreSpace withMessageTtlHours(Integer messageTtlHours) {
    ...
    public CoreSpace withMemoryExtractEnabled(Boolean memoryExtractEnabled) {
    ...
    public CoreSpace withMemoryExtractIdleSeconds(Integer memoryExtractIdleSeconds) {
    ...
    public CoreSpace withMemoryExtractMaxTokens(Integer memoryExtractMaxTokens) {
    ...
    public CoreSpace withMemoryExtractMaxMessages(Integer memoryExtractMaxMessages) {
    ...
    public CoreSpace withMemoryStrategiesBuiltin(List<CoreSpaceBuiltinMemoryStrategy> memoryStrategiesBuiltin) {
        this.memoryStrategiesBuiltin = memoryStrategiesBuiltin;
        return this;
    }

    public CoreSpace addMemoryStrategiesBuiltinItem(CoreSpaceBuiltinMemoryStrategy memoryStrategiesBuiltinItem) {
    ...
    public CoreSpace withMemoryStrategiesBuiltin(
    ...
    public CoreSpace withMemoryStrategiesCustomized(List<CoreSpaceMemoryStrategy> memoryStrategiesCustomized) {
        this.memoryStrategiesCustomized = memoryStrategiesCustomized;
        return this;
    }

    public CoreSpace addMemoryStrategiesCustomizedItem(CoreSpaceMemoryStrategy memoryStrategiesCustomizedItem) {
    ...
    public CoreSpace withMemoryStrategiesCustomized(
    ...
    public CoreSpace withVpcId(String vpcId) {
        this.vpcId = vpcId;
        return this;
    }
    ...
    public CoreSpace withSubnetId(String subnetId) {
    ...
    public CoreSpace withPrivateAccess(CoreSpaceNetwork privateAccess) {
        this.privateAccess = privateAccess;
        return this;
    }

    public CoreSpace withPrivateAccess(Consumer<CoreSpaceNetwork> privateAccessSetter) {
    ...
    public CoreSpace withPublicAccess(CoreSpaceNetwork publicAccess) {
        this.publicAccess = publicAccess;
        return this;
    }

    public CoreSpace withPublicAccess(Consumer<CoreSpaceNetwork> publicAccessSetter) {
    ...
    public CoreSpace withApiKey(ShowCoreSpaceApiKeyResponseBody apiKey) {
        this.apiKey = apiKey;
        return this;
    }

    public CoreSpace withApiKey(Consumer<ShowCoreSpaceApiKeyResponseBody> apiKeySetter) {
        if (this.apiKey == null) {
    ...
    public CoreSpace withEncryptionConfig(EncryptionConfig encryptionConfig) {
        this.encryptionConfig = encryptionConfig;
        return this;
    }

    public CoreSpace withEncryptionConfig(Consumer<EncryptionConfig> encryptionConfigSetter) {
    ...
    public CoreSpace withTags(List<CoreSpaceTag> tags) {
        this.tags = tags;
        return this;
    }

    public CoreSpace addTagsItem(CoreSpaceTag tagsItem) {
        if (this.tags == null) {
    ...
    public CoreSpace withTags(Consumer<List<CoreSpaceTag>> tagsSetter) {
        if (this.tags == null) {
            this.tags = new ArrayList<>();
        }
    ...
    public CoreSpace withStatus(StatusEnum status) {
        this.status = status;
        return this;
    }
    ...
    public CoreSpace withCreatedAt(OffsetDateTime createdAt) {
    ...
    public CoreSpace withUpdatedAt(OffsetDateTime updatedAt) {
