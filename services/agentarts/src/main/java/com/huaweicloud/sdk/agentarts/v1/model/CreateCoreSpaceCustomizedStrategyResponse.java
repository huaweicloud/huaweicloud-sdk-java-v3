...
public class CreateCoreSpaceCustomizedStrategyResponse extends SdkResponse {
    ...
    public CreateCoreSpaceCustomizedStrategyResponse withId(UUID id) {
        this.id = id;
        return this;
    }
    ...
    public CreateCoreSpaceCustomizedStrategyResponse withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public CreateCoreSpaceCustomizedStrategyResponse withType(TypeEnum type) {
        this.type = type;
        return this;
    }
    ...
    public CreateCoreSpaceCustomizedStrategyResponse withOriginType(OriginTypeEnum originType) {
    ...
    public CreateCoreSpaceCustomizedStrategyResponse withSteps(List<CoreSpaceMemoryStrategyStep> steps) {
        this.steps = steps;
        return this;
    }

    public CreateCoreSpaceCustomizedStrategyResponse addStepsItem(CoreSpaceMemoryStrategyStep stepsItem) {
        if (this.steps == null) {
    ...
    public CreateCoreSpaceCustomizedStrategyResponse withSteps(
    ...
    public CreateCoreSpaceCustomizedStrategyResponse withCreatedAt(OffsetDateTime createdAt) {
    ...
    public CreateCoreSpaceCustomizedStrategyResponse withUpdatedAt(OffsetDateTime updatedAt) {
