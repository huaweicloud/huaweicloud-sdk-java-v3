...
/**
 * **参数解释：** 批量为评估任务条目添加自定义标签值的请求体。 **约束限制：** 所有属性均为必填项。 **取值范围：** 不涉及。 **默认取值：** 不涉及。 
 */
public class AddOpsEvaluationTaskCustomLabelValuesRequestBody {
    ...
    public AddOpsEvaluationTaskCustomLabelValuesRequestBody withTagId(String tagId) {
        this.tagId = tagId;
        return this;
    }
    ...
    public AddOpsEvaluationTaskCustomLabelValuesRequestBody withItemId(String itemId) {
        this.itemId = itemId;
        return this;
    }
    ...
    public AddOpsEvaluationTaskCustomLabelValuesRequestBody withAnnotatedValue(String annotatedValue) {
    ...
    public AddOpsEvaluationTaskCustomLabelValuesRequestBody withTagType(String tagType) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        AddOpsEvaluationTaskCustomLabelValuesRequestBody that = (AddOpsEvaluationTaskCustomLabelValuesRequestBody) obj;
    ...
    public String toString() {
        ...
        sb.append("class AddOpsEvaluationTaskCustomLabelValuesRequestBody {\n");
