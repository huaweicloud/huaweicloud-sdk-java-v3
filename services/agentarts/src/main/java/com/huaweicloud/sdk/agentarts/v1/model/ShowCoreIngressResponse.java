 ...
 * Response Object
 */
public class ShowCoreIngressResponse extends SdkResponse {
    ...
    public ShowCoreIngressResponse withId(UUID id) {
        this.id = id;
        return this;
    }
    ...
    public ShowCoreIngressResponse withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public ShowCoreIngressResponse withDescription(String description) {
    ...
    public ShowCoreIngressResponse withStatus(StatusEnum status) {
        this.status = status;
        return this;
    }
    ...
    public ShowCoreIngressResponse withEnablePublicNetwork(Boolean enablePublicNetwork) {
    ...
    public ShowCoreIngressResponse withPublicDomainName(String publicDomainName) {
    ...
    public ShowCoreIngressResponse withCreatedAt(OffsetDateTime createdAt) {
    ...
    public ShowCoreIngressResponse withUpdatedAt(OffsetDateTime updatedAt) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ShowCoreIngressResponse that = (ShowCoreIngressResponse) obj;
    ...
    public String toString() {
        ...
        sb.append("class ShowCoreIngressResponse {\n");
