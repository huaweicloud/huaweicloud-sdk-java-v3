 ...
 * Request Object
 */
public class BatchDeleteOpsDatasetTagsRequest {
    ...
    public BatchDeleteOpsDatasetTagsRequest withDatasetId(String datasetId) {
    ...
    public BatchDeleteOpsDatasetTagsRequest withBody(OpsResourceTagsBatchOptionRequestBody body) {
        this.body = body;
        return this;
    }

    public BatchDeleteOpsDatasetTagsRequest withBody(Consumer<OpsResourceTagsBatchOptionRequestBody> bodySetter) {
        if (this.body == null) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        BatchDeleteOpsDatasetTagsRequest that = (BatchDeleteOpsDatasetTagsRequest) obj;
    ...
    public String toString() {
        ...
        sb.append("class BatchDeleteOpsDatasetTagsRequest {\n");
