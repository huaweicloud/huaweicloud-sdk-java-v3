 ...
 * **参数解释**: 探针配置，用于沙箱预热探测。
 */
public class CoreRunWarmUpProbeConfig {
    ...
    public CoreRunWarmUpProbeConfig withInitialDelaySeconds(Integer initialDelaySeconds) {
    ...
    public CoreRunWarmUpProbeConfig withTimeoutSeconds(Integer timeoutSeconds) {
    ...
    public CoreRunWarmUpProbeConfig withPeriodSeconds(Integer periodSeconds) {
    ...
    public CoreRunWarmUpProbeConfig withSuccessThreshold(Integer successThreshold) {
    ...
    public CoreRunWarmUpProbeConfig withFailureThreshold(Integer failureThreshold) {
    ...
    public CoreRunWarmUpProbeConfig withFailureThresholdSeconds(Integer failureThresholdSeconds) {
    ...
    public CoreRunWarmUpProbeConfig withInitialDelayMilliseconds(Integer initialDelayMilliseconds) {
    ...
    public CoreRunWarmUpProbeConfig withTimeoutMilliseconds(Integer timeoutMilliseconds) {
    ...
    public CoreRunWarmUpProbeConfig withPeriodMilliseconds(Integer periodMilliseconds) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        CoreRunWarmUpProbeConfig that = (CoreRunWarmUpProbeConfig) obj;
    ...
    public String toString() {
        ...
        sb.append("class CoreRunWarmUpProbeConfig {\n");
