 ...
 * Response Object
 */
public class CreateCoreIngressNetworkResponse extends SdkResponse {
    ...
    public CreateCoreIngressNetworkResponse withId(UUID id) {
        this.id = id;
        return this;
    }
    ...
    public CreateCoreIngressNetworkResponse withStatus(StatusEnum status) {
        this.status = status;
        return this;
    }
    ...
    public CreateCoreIngressNetworkResponse withSubnetId(UUID subnetId) {
    ...
    public CreateCoreIngressNetworkResponse withIpAddress(String ipAddress) {
    ...
    public CreateCoreIngressNetworkResponse withCreatedAt(OffsetDateTime createdAt) {
    ...
    public CreateCoreIngressNetworkResponse withUpdatedAt(OffsetDateTime updatedAt) {
    ...
    public CreateCoreIngressNetworkResponse withDefaultPrivateZoneDomainName(String defaultPrivateZoneDomainName) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        CreateCoreIngressNetworkResponse that = (CreateCoreIngressNetworkResponse) obj;
    ...
    public String toString() {
        ...
        sb.append("class CreateCoreIngressNetworkResponse {\n");
