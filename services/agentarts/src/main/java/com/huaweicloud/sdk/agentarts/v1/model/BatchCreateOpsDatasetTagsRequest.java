 ...
 * Request Object
 */
public class BatchCreateOpsDatasetTagsRequest {
    ...
    public BatchCreateOpsDatasetTagsRequest withDatasetId(String datasetId) {
    ...
    public BatchCreateOpsDatasetTagsRequest withBody(OpsResourceTagsBatchOptionRequestBody body) {
        this.body = body;
        return this;
    }

    public BatchCreateOpsDatasetTagsRequest withBody(Consumer<OpsResourceTagsBatchOptionRequestBody> bodySetter) {
        if (this.body == null) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        BatchCreateOpsDatasetTagsRequest that = (BatchCreateOpsDatasetTagsRequest) obj;
    ...
    public String toString() {
        ...
        sb.append("class BatchCreateOpsDatasetTagsRequest {\n");
