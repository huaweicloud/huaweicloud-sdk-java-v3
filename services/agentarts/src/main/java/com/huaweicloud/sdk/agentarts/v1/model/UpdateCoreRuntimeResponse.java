 ...
 * Response Object
 */
public class UpdateCoreRuntimeResponse extends SdkResponse {
    ...
    public UpdateCoreRuntimeResponse withId(UUID id) {
        this.id = id;
        return this;
    }
    ...
    public UpdateCoreRuntimeResponse withDescription(String description) {
    ...
    public UpdateCoreRuntimeResponse withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public UpdateCoreRuntimeResponse withLatestVersion(String latestVersion) {
    ...
    public UpdateCoreRuntimeResponse withCreatedAt(OffsetDateTime createdAt) {
    ...
    public UpdateCoreRuntimeResponse withAgentGatewayId(UUID agentGatewayId) {
    ...
    public UpdateCoreRuntimeResponse withUpdatedAt(OffsetDateTime updatedAt) {
    ...
    public UpdateCoreRuntimeResponse withWorkloadIdentityUrn(UUID workloadIdentityUrn) {
    ...
    public UpdateCoreRuntimeResponse withTags(List<CoreRunTagItemResp> tags) {
        this.tags = tags;
        return this;
    }

    public UpdateCoreRuntimeResponse addTagsItem(CoreRunTagItemResp tagsItem) {
        if (this.tags == null) {
    ...
    public UpdateCoreRuntimeResponse withTags(Consumer<List<CoreRunTagItemResp>> tagsSetter) {
        if (this.tags == null) {
            this.tags = new ArrayList<>();
        }
    ...
    public UpdateCoreRuntimeResponse withArch(ArchEnum arch) {
        this.arch = arch;
        return this;
    }
    ...
    public UpdateCoreRuntimeResponse withVersionDetail(CoreRunRuntimeVersion versionDetail) {
        this.versionDetail = versionDetail;
        return this;
    }

    public UpdateCoreRuntimeResponse withVersionDetail(Consumer<CoreRunRuntimeVersion> versionDetailSetter) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        UpdateCoreRuntimeResponse that = (UpdateCoreRuntimeResponse) obj;
    ...
    public String toString() {
        ...
        sb.append("class UpdateCoreRuntimeResponse {\n");
