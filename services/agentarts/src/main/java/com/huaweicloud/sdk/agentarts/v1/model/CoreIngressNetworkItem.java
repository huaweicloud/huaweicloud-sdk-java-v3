 ...
 * **参数解释**: VPC入站网络详情。 
 */
public class CoreIngressNetworkItem {
    ...
    public CoreIngressNetworkItem withId(UUID id) {
        this.id = id;
        return this;
    }
    ...
    public CoreIngressNetworkItem withStatus(StatusEnum status) {
        this.status = status;
        return this;
    }
    ...
    public CoreIngressNetworkItem withSubnetId(UUID subnetId) {
    ...
    public CoreIngressNetworkItem withIpAddress(String ipAddress) {
    ...
    public CoreIngressNetworkItem withCreatedAt(OffsetDateTime createdAt) {
    ...
    public CoreIngressNetworkItem withUpdatedAt(OffsetDateTime updatedAt) {
    ...
    public CoreIngressNetworkItem withDefaultPrivateZoneDomainName(String defaultPrivateZoneDomainName) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        CoreIngressNetworkItem that = (CoreIngressNetworkItem) obj;
    ...
    public String toString() {
        ...
        sb.append("class CoreIngressNetworkItem {\n");
