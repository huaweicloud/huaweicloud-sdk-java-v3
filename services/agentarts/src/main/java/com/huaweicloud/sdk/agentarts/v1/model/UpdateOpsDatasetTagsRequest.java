 ...
 * Request Object
 */
public class UpdateOpsDatasetTagsRequest {
    ...
    public UpdateOpsDatasetTagsRequest withDatasetId(String datasetId) {
    ...
    public UpdateOpsDatasetTagsRequest withBody(UpdateOpsResourceTagsRequestBody body) {
        this.body = body;
        return this;
    }

    public UpdateOpsDatasetTagsRequest withBody(Consumer<UpdateOpsResourceTagsRequestBody> bodySetter) {
        if (this.body == null) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        UpdateOpsDatasetTagsRequest that = (UpdateOpsDatasetTagsRequest) obj;
    ...
    public String toString() {
        ...
        sb.append("class UpdateOpsDatasetTagsRequest {\n");
