 ...
 * Response Object
 */
public class CreateOpsAnalysisTaskResponse extends SdkResponse {
    ...
    public CreateOpsAnalysisTaskResponse withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public CreateOpsAnalysisTaskResponse withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public CreateOpsAnalysisTaskResponse withDescription(String description) {
    ...
    public CreateOpsAnalysisTaskResponse withAgent(OpsAnalysisTaskAgent agent) {
        this.agent = agent;
        return this;
    }

    public CreateOpsAnalysisTaskResponse withAgent(Consumer<OpsAnalysisTaskAgent> agentSetter) {
        if (this.agent == null) {
    ...
    public CreateOpsAnalysisTaskResponse withAgencyName(String agencyName) {
    ...
    public CreateOpsAnalysisTaskResponse withStatus(StatusEnum status) {
        this.status = status;
        return this;
    }
    ...
    public CreateOpsAnalysisTaskResponse withCreatedAt(Long createdAt) {
    ...
    public CreateOpsAnalysisTaskResponse withUpdatedAt(Long updatedAt) {
    ...
    public CreateOpsAnalysisTaskResponse withNextFireTime(Long nextFireTime) {
    ...
    public CreateOpsAnalysisTaskResponse withTags(List<OpsTasksTagForTMS> tags) {
        this.tags = tags;
        return this;
    }

    public CreateOpsAnalysisTaskResponse addTagsItem(OpsTasksTagForTMS tagsItem) {
        if (this.tags == null) {
    ...
    public CreateOpsAnalysisTaskResponse withTags(Consumer<List<OpsTasksTagForTMS>> tagsSetter) {
        if (this.tags == null) {
            this.tags = new ArrayList<>();
        }
    ...
    public CreateOpsAnalysisTaskResponse withProgress(OpsTaskProgress progress) {
        this.progress = progress;
        return this;
    }

    public CreateOpsAnalysisTaskResponse withProgress(Consumer<OpsTaskProgress> progressSetter) {
    ...
    public CreateOpsAnalysisTaskResponse withExecutionStrategy(OpsExecutionStrategy executionStrategy) {
        this.executionStrategy = executionStrategy;
        return this;
    }

    public CreateOpsAnalysisTaskResponse withExecutionStrategy(Consumer<OpsExecutionStrategy> executionStrategySetter) {
    ...
    public CreateOpsAnalysisTaskResponse withStatusCount(OpsAnalysisTaskInstanceStatusCount statusCount) {
        this.statusCount = statusCount;
        return this;
    }

    public CreateOpsAnalysisTaskResponse withStatusCount(
        Consumer<OpsAnalysisTaskInstanceStatusCount> statusCountSetter) {
    ...
    public CreateOpsAnalysisTaskResponse withSampleStrategy(OpsSampleStrategy sampleStrategy) {
        this.sampleStrategy = sampleStrategy;
        return this;
    }

    public CreateOpsAnalysisTaskResponse withSampleStrategy(Consumer<OpsSampleStrategy> sampleStrategySetter) {
    ...
    public CreateOpsAnalysisTaskResponse withFailures(List<OpsFailureCategory> failures) {
        this.failures = failures;
        return this;
    }

    public CreateOpsAnalysisTaskResponse addFailuresItem(OpsFailureCategory failuresItem) {
    ...
    public CreateOpsAnalysisTaskResponse withFailures(Consumer<List<OpsFailureCategory>> failuresSetter) {
        if (this.failures == null) {
            this.failures = new ArrayList<>();
        }
    ...
    public CreateOpsAnalysisTaskResponse withInputTokens(Long inputTokens) {
    ...
    public CreateOpsAnalysisTaskResponse withOutputTokens(Long outputTokens) {
    ...
    public CreateOpsAnalysisTaskResponse withTotalSessionCount(Integer totalSessionCount) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        CreateOpsAnalysisTaskResponse that = (CreateOpsAnalysisTaskResponse) obj;
    ...
    public String toString() {
        ...
        sb.append("class CreateOpsAnalysisTaskResponse {\n");
