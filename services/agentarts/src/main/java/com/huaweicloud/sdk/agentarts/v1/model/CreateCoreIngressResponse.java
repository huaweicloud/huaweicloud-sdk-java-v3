 ...
 * Response Object
 */
public class CreateCoreIngressResponse extends SdkResponse {
    ...
    public CreateCoreIngressResponse withId(UUID id) {
        this.id = id;
        return this;
    }
    ...
    public CreateCoreIngressResponse withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public CreateCoreIngressResponse withDescription(String description) {
    ...
    public CreateCoreIngressResponse withStatus(StatusEnum status) {
        this.status = status;
        return this;
    }
    ...
    public CreateCoreIngressResponse withEnablePublicNetwork(Boolean enablePublicNetwork) {
    ...
    public CreateCoreIngressResponse withPublicDomainName(String publicDomainName) {
    ...
    public CreateCoreIngressResponse withCreatedAt(OffsetDateTime createdAt) {
    ...
    public CreateCoreIngressResponse withUpdatedAt(OffsetDateTime updatedAt) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        CreateCoreIngressResponse that = (CreateCoreIngressResponse) obj;
    ...
    public String toString() {
        ...
        sb.append("class CreateCoreIngressResponse {\n");
