...
public class UpdateCoreSpaceCustomizedStrategyResponse extends SdkResponse {
    ...
    public UpdateCoreSpaceCustomizedStrategyResponse withBody(CoreSpaceMemoryStrategy body) {
        this.body = body;
        return this;
    }

    public UpdateCoreSpaceCustomizedStrategyResponse withBody(Consumer<CoreSpaceMemoryStrategy> bodySetter) {
        if (this.body == null) {
