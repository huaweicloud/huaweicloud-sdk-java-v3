 ...
 * **参数解释**: Ingress响应体。 
 */
public class CoreIngressResponse {
    ...
    public CoreIngressResponse withId(UUID id) {
        this.id = id;
        return this;
    }
    ...
    public CoreIngressResponse withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public CoreIngressResponse withDescription(String description) {
    ...
    public CoreIngressResponse withStatus(StatusEnum status) {
        this.status = status;
        return this;
    }
    ...
    public CoreIngressResponse withEnablePublicNetwork(Boolean enablePublicNetwork) {
    ...
    public CoreIngressResponse withPublicDomainName(String publicDomainName) {
    ...
    public CoreIngressResponse withCreatedAt(OffsetDateTime createdAt) {
    ...
    public CoreIngressResponse withUpdatedAt(OffsetDateTime updatedAt) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        CoreIngressResponse that = (CoreIngressResponse) obj;
    ...
    public String toString() {
        ...
        sb.append("class CoreIngressResponse {\n");
