 ...
 * Response Object
 */
public class ShowCoreRuntimeResponse extends SdkResponse {
    ...
    public ShowCoreRuntimeResponse withId(UUID id) {
        this.id = id;
        return this;
    }
    ...
    public ShowCoreRuntimeResponse withDescription(String description) {
    ...
    public ShowCoreRuntimeResponse withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public ShowCoreRuntimeResponse withLatestVersion(String latestVersion) {
    ...
    public ShowCoreRuntimeResponse withCreatedAt(OffsetDateTime createdAt) {
    ...
    public ShowCoreRuntimeResponse withAgentGatewayId(UUID agentGatewayId) {
    ...
    public ShowCoreRuntimeResponse withUpdatedAt(OffsetDateTime updatedAt) {
    ...
    public ShowCoreRuntimeResponse withWorkloadIdentityUrn(UUID workloadIdentityUrn) {
    ...
    public ShowCoreRuntimeResponse withTags(List<CoreRunTagItemResp> tags) {
        this.tags = tags;
        return this;
    }

    public ShowCoreRuntimeResponse addTagsItem(CoreRunTagItemResp tagsItem) {
        if (this.tags == null) {
    ...
    public ShowCoreRuntimeResponse withTags(Consumer<List<CoreRunTagItemResp>> tagsSetter) {
        if (this.tags == null) {
            this.tags = new ArrayList<>();
        }
    ...
    public ShowCoreRuntimeResponse withArch(ArchEnum arch) {
        this.arch = arch;
        return this;
    }
    ...
    public ShowCoreRuntimeResponse withVersionDetail(CoreRunRuntimeVersion versionDetail) {
        this.versionDetail = versionDetail;
        return this;
    }

    public ShowCoreRuntimeResponse withVersionDetail(Consumer<CoreRunRuntimeVersion> versionDetailSetter) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ShowCoreRuntimeResponse that = (ShowCoreRuntimeResponse) obj;
    ...
    public String toString() {
        ...
        sb.append("class ShowCoreRuntimeResponse {\n");
