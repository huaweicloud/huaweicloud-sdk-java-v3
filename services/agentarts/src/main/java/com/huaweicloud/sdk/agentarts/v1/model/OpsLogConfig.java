...
public class OpsLogConfig {
    ...
    public OpsLogConfig withEnabled(Boolean enabled) {
    ...
    public OpsLogConfig withStorageMode(StorageModeEnum storageMode) {
    ...
    public OpsLogConfig withGroupId(String groupId) {
    ...
    public OpsLogConfig withStreamId(String streamId) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        OpsLogConfig that = (OpsLogConfig) obj;
        return Objects.equals(this.enabled, that.enabled) && Objects.equals(this.storageMode, that.storageMode)
            && Objects.equals(this.groupId, that.groupId) && Objects.equals(this.streamId, that.streamId);
    }

    @Override
    public int hashCode() {
        return Objects.hash(enabled, storageMode, groupId, streamId);
    }

    @Override
    public String toString() {
        StringBuilder sb = new StringBuilder();
        sb.append("class OpsLogConfig {\n");
