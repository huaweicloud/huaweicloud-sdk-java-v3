...
/**
 * ModifyOpsAgentTuningTaskRequestBody
 */
public class ModifyOpsAgentTuningTaskRequestBody {
    ...
    public ModifyOpsAgentTuningTaskRequestBody withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public ModifyOpsAgentTuningTaskRequestBody withDescription(String description) {
    ...
    public ModifyOpsAgentTuningTaskRequestBody withType(TypeEnum type) {
        this.type = type;
        return this;
    }
    ...
    public ModifyOpsAgentTuningTaskRequestBody withAgent(OpsAgentTuningTaskAgent agent) {
        this.agent = agent;
        return this;
    }

    public ModifyOpsAgentTuningTaskRequestBody withAgent(Consumer<OpsAgentTuningTaskAgent> agentSetter) {
        if (this.agent == null) {
    ...
    public ModifyOpsAgentTuningTaskRequestBody withTuningTarget(OpsTuningTarget tuningTarget) {
        this.tuningTarget = tuningTarget;
        return this;
    }

    public ModifyOpsAgentTuningTaskRequestBody withTuningTarget(Consumer<OpsTuningTarget> tuningTargetSetter) {
    ...
    public ModifyOpsAgentTuningTaskRequestBody withSampleDuration(OpsSampleDuration sampleDuration) {
        this.sampleDuration = sampleDuration;
        return this;
    }

    public ModifyOpsAgentTuningTaskRequestBody withSampleDuration(Consumer<OpsSampleDuration> sampleDurationSetter) {
    ...
    public ModifyOpsAgentTuningTaskRequestBody withSampleStrategy(OpsSampleStrategy sampleStrategy) {
        this.sampleStrategy = sampleStrategy;
        return this;
    }

    public ModifyOpsAgentTuningTaskRequestBody withSampleStrategy(Consumer<OpsSampleStrategy> sampleStrategySetter) {
    ...
    public ModifyOpsAgentTuningTaskRequestBody withAgencyName(String agencyName) {
    ...
    public ModifyOpsAgentTuningTaskRequestBody withTags(List<OpsTasksTagForTMS> tags) {
        this.tags = tags;
        return this;
    }

    public ModifyOpsAgentTuningTaskRequestBody addTagsItem(OpsTasksTagForTMS tagsItem) {
        if (this.tags == null) {
    ...
    public ModifyOpsAgentTuningTaskRequestBody withTags(Consumer<List<OpsTasksTagForTMS>> tagsSetter) {
        if (this.tags == null) {
            this.tags = new ArrayList<>();
        }
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ModifyOpsAgentTuningTaskRequestBody that = (ModifyOpsAgentTuningTaskRequestBody) obj;
    ...
    public String toString() {
        ...
        sb.append("class ModifyOpsAgentTuningTaskRequestBody {\n");
