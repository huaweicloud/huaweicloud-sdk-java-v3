...
public class DeleteApplicationRequest {
    ...
    public DeleteApplicationRequest withXEnvironmentID(String xEnvironmentID) {
    ...
    public DeleteApplicationRequest withXEnterpriseProjectID(String xEnterpriseProjectID) {
