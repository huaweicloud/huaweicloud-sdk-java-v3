...
public class DeleteCertificateRequest {
    ...
    public DeleteCertificateRequest withXEnterpriseProjectID(String xEnterpriseProjectID) {
    ...
    public DeleteCertificateRequest withXEnvironmentID(String xEnvironmentID) {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(certificateId, xEnterpriseProjectID, xEnvironmentID);
    }
