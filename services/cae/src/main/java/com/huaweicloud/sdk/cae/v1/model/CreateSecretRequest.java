...
public class CreateSecretRequest {
    ...
    public CreateSecretRequest withXEnterpriseProjectID(String xEnterpriseProjectID) {
    ...
    public CreateSecretRequest withXEnvironmentID(String xEnvironmentID) {
    ...
    public CreateSecretRequest withBody(CreateOrUpdateSecretReq body) {
        this.body = body;
        return this;
    }

    public CreateSecretRequest withBody(Consumer<CreateOrUpdateSecretReq> bodySetter) {
        if (this.body == null) {
