 ...
 * Request Object
 */
public class CreateTimerRuleRequest {
    ...
    private CreateTimerRuleReq body;

    public CreateTimerRuleRequest withXEnterpriseProjectID(String xEnterpriseProjectID) {
    ...
    public CreateTimerRuleRequest withXEnvironmentID(String xEnvironmentID) {
    ...
    public CreateTimerRuleRequest withBody(CreateTimerRuleReq body) {
        this.body = body;
        return this;
    }

    public CreateTimerRuleRequest withBody(Consumer<CreateTimerRuleReq> bodySetter) {
        if (this.body == null) {
            this.body = new CreateTimerRuleReq();
     ...
     * @return body
     */
    public CreateTimerRuleReq getBody() {
        return body;
    }

    public void setBody(CreateTimerRuleReq body) {
        this.body = body;
    }
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        CreateTimerRuleRequest that = (CreateTimerRuleRequest) obj;
    ...
    public String toString() {
        ...
        sb.append("class CreateTimerRuleRequest {\n");
