...
public class ListConfigurationsResponse extends SdkResponse {
    ...
    public ListConfigurationsResponse withKind(KindEnum kind) {
        this.kind = kind;
        return this;
    }
    ...
    public ListConfigurationsResponse withItems(List<ModelConfiguration> items) {
        this.items = items;
        return this;
    }
    ...
    public ListConfigurationsResponse withItems(Consumer<List<ModelConfiguration>> itemsSetter) {
        if (this.items == null) {
            this.items = new ArrayList<>();
        }
