...
public class ListConfigurationsRequest {
    ...
    public ListConfigurationsRequest withComponentId(String componentId) {
    ...
    public ListConfigurationsRequest withXEnvironmentID(String xEnvironmentID) {
    ...
    public ListConfigurationsRequest withXEnterpriseProjectID(String xEnterpriseProjectID) {
    ...
    public ListConfigurationsRequest withApplicationId(String applicationId) {
