 ...
 * 组件规格信息。
 */
public class CreateComponentWithConfigurationRequestBodySpec {
    ...
    public CreateComponentWithConfigurationRequestBodySpec withRuntime(RuntimeEnum runtime) {
    ...
    public CreateComponentWithConfigurationRequestBodySpec withReplica(Integer replica) {
    ...
    public CreateComponentWithConfigurationRequestBodySpec withBuild(Build build) {
        this.build = build;
        return this;
    }

    public CreateComponentWithConfigurationRequestBodySpec withBuild(Consumer<Build> buildSetter) {
        if (this.build == null) {
    ...
    public CreateComponentWithConfigurationRequestBodySpec withSource(Source source) {
        this.source = source;
        return this;
    }

    public CreateComponentWithConfigurationRequestBodySpec withSource(Consumer<Source> sourceSetter) {
        if (this.source == null) {
    ...
    public CreateComponentWithConfigurationRequestBodySpec withResourceLimit(ResourceLimit resourceLimit) {
        this.resourceLimit = resourceLimit;
        return this;
    }

    public CreateComponentWithConfigurationRequestBodySpec withResourceLimit(
        Consumer<ResourceLimit> resourceLimitSetter) {
    ...
    public CreateComponentWithConfigurationRequestBodySpec withImageUrl(String imageUrl) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        CreateComponentWithConfigurationRequestBodySpec that = (CreateComponentWithConfigurationRequestBodySpec) obj;
