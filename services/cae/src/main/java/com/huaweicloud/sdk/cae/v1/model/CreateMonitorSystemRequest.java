 ...
 * Request Object
 */
public class CreateMonitorSystemRequest {
    ...
    public CreateMonitorSystemRequest withXEnterpriseProjectID(String xEnterpriseProjectID) {
    ...
    public CreateMonitorSystemRequest withXEnvironmentID(String xEnvironmentID) {
    ...
    public CreateMonitorSystemRequest withBody(MonitorSystemRequestBody body) {
        this.body = body;
        return this;
    }

    public CreateMonitorSystemRequest withBody(Consumer<MonitorSystemRequestBody> bodySetter) {
        if (this.body == null) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        CreateMonitorSystemRequest that = (CreateMonitorSystemRequest) obj;
    ...
    public String toString() {
        ...
        sb.append("class CreateMonitorSystemRequest {\n");
