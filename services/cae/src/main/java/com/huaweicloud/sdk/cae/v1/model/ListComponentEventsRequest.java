 ...
 * Request Object
 */
public class ListComponentEventsRequest {
    ...
    public ListComponentEventsRequest withApplicationId(String applicationId) {
    ...
    public ListComponentEventsRequest withComponentId(String componentId) {
    ...
    public ListComponentEventsRequest withXEnterpriseProjectID(String xEnterpriseProjectID) {
    ...
    public ListComponentEventsRequest withXEnvironmentID(String xEnvironmentID) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ListComponentEventsRequest that = (ListComponentEventsRequest) obj;
    ...
    public String toString() {
        ...
        sb.append("class ListComponentEventsRequest {\n");
