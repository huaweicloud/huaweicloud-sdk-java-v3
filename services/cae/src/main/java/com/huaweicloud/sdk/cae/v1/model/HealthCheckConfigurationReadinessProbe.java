 ...
 * 组件健康检查配置的就绪探针配置。
 */
public class HealthCheckConfigurationReadinessProbe {
    ...
    public HealthCheckConfigurationReadinessProbe withPeriodSeconds(Integer periodSeconds) {
    ...
    public HealthCheckConfigurationReadinessProbe withInitialDelaySeconds(Integer initialDelaySeconds) {
    ...
    public HealthCheckConfigurationReadinessProbe withTimeoutSeconds(Integer timeoutSeconds) {
    ...
    public HealthCheckConfigurationReadinessProbe withSuccessThreshold(Integer successThreshold) {
    ...
    public HealthCheckConfigurationReadinessProbe withFailureThreshold(Integer failureThreshold) {
    ...
    public HealthCheckConfigurationReadinessProbe withHttpGet(HealthCheckConfigurationHttpGet httpGet) {
        this.httpGet = httpGet;
        return this;
    }

    public HealthCheckConfigurationReadinessProbe withHttpGet(Consumer<HealthCheckConfigurationHttpGet> httpGetSetter) {
    ...
    public HealthCheckConfigurationReadinessProbe withTcpSocket(HealthCheckConfigurationTcpSocket tcpSocket) {
        this.tcpSocket = tcpSocket;
        return this;
    }

    public HealthCheckConfigurationReadinessProbe withTcpSocket(
    ...
    public HealthCheckConfigurationReadinessProbe withExec(HealthCheckConfigurationExec exec) {
        this.exec = exec;
        return this;
    }

    public HealthCheckConfigurationReadinessProbe withExec(Consumer<HealthCheckConfigurationExec> execSetter) {
        if (this.exec == null) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        HealthCheckConfigurationReadinessProbe that = (HealthCheckConfigurationReadinessProbe) obj;
    ...
    public String toString() {
        ...
        sb.append("class HealthCheckConfigurationReadinessProbe {\n");
