 ...
 * Request Object
 */
public class CreateVpcEgressRequest {
    ...
    private VpcEgressRequestBody body;

    public CreateVpcEgressRequest withXEnterpriseProjectID(String xEnterpriseProjectID) {
    ...
    public CreateVpcEgressRequest withXEnvironmentID(String xEnvironmentID) {
    ...
    public CreateVpcEgressRequest withBody(VpcEgressRequestBody body) {
        this.body = body;
        return this;
    }

    public CreateVpcEgressRequest withBody(Consumer<VpcEgressRequestBody> bodySetter) {
        if (this.body == null) {
            this.body = new VpcEgressRequestBody();
     ...
     * @return body
     */
    public VpcEgressRequestBody getBody() {
        return body;
    }

    public void setBody(VpcEgressRequestBody body) {
        this.body = body;
    }
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        CreateVpcEgressRequest that = (CreateVpcEgressRequest) obj;
    ...
    public String toString() {
        ...
        sb.append("class CreateVpcEgressRequest {\n");
