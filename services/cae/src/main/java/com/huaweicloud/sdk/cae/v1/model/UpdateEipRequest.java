...
public class UpdateEipRequest {
    ...
    private UpdateEipRequestBody body;

    public UpdateEipRequest withXEnterpriseProjectID(String xEnterpriseProjectID) {
    ...
    public UpdateEipRequest withXEnvironmentID(String xEnvironmentID) {
    ...
    public UpdateEipRequest withBody(UpdateEipRequestBody body) {
        this.body = body;
        return this;
    }

    public UpdateEipRequest withBody(Consumer<UpdateEipRequestBody> bodySetter) {
        if (this.body == null) {
            this.body = new UpdateEipRequestBody();
     ...
     * @return body
     */
    public UpdateEipRequestBody getBody() {
        return body;
    }

    public void setBody(UpdateEipRequestBody body) {
        this.body = body;
    }
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        UpdateEipRequest that = (UpdateEipRequest) obj;
    ...
    public String toString() {
        ...
        sb.append("class UpdateEipRequest {\n");
