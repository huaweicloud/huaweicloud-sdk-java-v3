...
public class CreateEnvironmentRequestBody {
    ...
    private EnvironmentKindObj kind;
    ...
    public CreateEnvironmentRequestBody withApiVersion(ApiVersionObj apiVersion) {
    ...
    public CreateEnvironmentRequestBody withKind(EnvironmentKindObj kind) {
        this.kind = kind;
        return this;
    }
     ...
     * @return kind
     */
    public EnvironmentKindObj getKind() {
        return kind;
    }

    public void setKind(EnvironmentKindObj kind) {
        this.kind = kind;
    }
