 ...
 * Response Object
 */
public class ListVpcEgressResponse extends SdkResponse {
    ...
    public ListVpcEgressResponse withApiVersion(ApiVersionObj apiVersion) {
    ...
    public ListVpcEgressResponse withKind(VpcEgressKindObj kind) {
        this.kind = kind;
        return this;
    }
    ...
    public ListVpcEgressResponse withSpec(VpcEgressResponseBodySpec spec) {
        this.spec = spec;
        return this;
    }

    public ListVpcEgressResponse withSpec(Consumer<VpcEgressResponseBodySpec> specSetter) {
        if (this.spec == null) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ListVpcEgressResponse that = (ListVpcEgressResponse) obj;
    ...
    public String toString() {
        ...
        sb.append("class ListVpcEgressResponse {\n");
