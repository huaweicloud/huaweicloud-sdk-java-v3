...
public class ListCertificatesRequest {
    ...
    public ListCertificatesRequest withXEnterpriseProjectID(String xEnterpriseProjectID) {
    ...
    public ListCertificatesRequest withXEnvironmentID(String xEnvironmentID) {
