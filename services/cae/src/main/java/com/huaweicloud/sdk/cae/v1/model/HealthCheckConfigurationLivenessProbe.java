 ...
 * 组件健康检查配置的存活探针配置。
 */
public class HealthCheckConfigurationLivenessProbe {
    ...
    public HealthCheckConfigurationLivenessProbe withPeriodSeconds(Integer periodSeconds) {
    ...
    public HealthCheckConfigurationLivenessProbe withInitialDelaySeconds(Integer initialDelaySeconds) {
    ...
    public HealthCheckConfigurationLivenessProbe withTimeoutSeconds(Integer timeoutSeconds) {
    ...
    public HealthCheckConfigurationLivenessProbe withSuccessThreshold(Integer successThreshold) {
    ...
    public HealthCheckConfigurationLivenessProbe withFailureThreshold(Integer failureThreshold) {
    ...
    public HealthCheckConfigurationLivenessProbe withHttpGet(HealthCheckConfigurationHttpGet httpGet) {
        this.httpGet = httpGet;
        return this;
    }

    public HealthCheckConfigurationLivenessProbe withHttpGet(Consumer<HealthCheckConfigurationHttpGet> httpGetSetter) {
    ...
    public HealthCheckConfigurationLivenessProbe withTcpSocket(HealthCheckConfigurationTcpSocket tcpSocket) {
        this.tcpSocket = tcpSocket;
        return this;
    }

    public HealthCheckConfigurationLivenessProbe withTcpSocket(
    ...
    public HealthCheckConfigurationLivenessProbe withExec(HealthCheckConfigurationExec exec) {
        this.exec = exec;
        return this;
    }

    public HealthCheckConfigurationLivenessProbe withExec(Consumer<HealthCheckConfigurationExec> execSetter) {
        if (this.exec == null) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        HealthCheckConfigurationLivenessProbe that = (HealthCheckConfigurationLivenessProbe) obj;
    ...
    public String toString() {
        ...
        sb.append("class HealthCheckConfigurationLivenessProbe {\n");
