...
public class ConfigurationResponseDataSpecPostStart {
    ...
    public ConfigurationResponseDataSpecPostStart withExec(LifeCycleConfigurationExec exec) {
        this.exec = exec;
        return this;
    }

    public ConfigurationResponseDataSpecPostStart withExec(Consumer<LifeCycleConfigurationExec> execSetter) {
        if (this.exec == null) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ConfigurationResponseDataSpecPostStart that = (ConfigurationResponseDataSpecPostStart) obj;
    ...
    public String toString() {
        ...
        sb.append("class ConfigurationResponseDataSpecPostStart {\n");
