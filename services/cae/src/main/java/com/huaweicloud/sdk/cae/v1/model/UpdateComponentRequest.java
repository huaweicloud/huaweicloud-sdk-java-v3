...
public class UpdateComponentRequest {
    ...
    private UpdateComponentRequestBody body;

    public UpdateComponentRequest withApplicationId(String applicationId) {
    ...
    public UpdateComponentRequest withXEnterpriseProjectID(String xEnterpriseProjectID) {
    ...
    public UpdateComponentRequest withXEnvironmentID(String xEnvironmentID) {
    ...
    public UpdateComponentRequest withBody(UpdateComponentRequestBody body) {
        this.body = body;
        return this;
    }

    public UpdateComponentRequest withBody(Consumer<UpdateComponentRequestBody> bodySetter) {
        if (this.body == null) {
            this.body = new UpdateComponentRequestBody();
     ...
     * @return body
     */
    public UpdateComponentRequestBody getBody() {
        return body;
    }

    public void setBody(UpdateComponentRequestBody body) {
        this.body = body;
    }
