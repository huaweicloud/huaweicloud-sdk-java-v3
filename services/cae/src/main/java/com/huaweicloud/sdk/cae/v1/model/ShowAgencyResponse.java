...
public class ShowAgencyResponse extends SdkResponse {
    ...
    private List<AgencyItem> items = null;

    public ShowAgencyResponse withApiVersion(ApiVersionEnum apiVersion) {
    ...
    public ShowAgencyResponse withKind(KindEnum kind) {
        this.kind = kind;
        return this;
    }
    ...
    public ShowAgencyResponse withItems(List<AgencyItem> items) {
        this.items = items;
        return this;
    }

    public ShowAgencyResponse addItemsItem(AgencyItem itemsItem) {
        if (this.items == null) {
    ...
    public ShowAgencyResponse withItems(Consumer<List<AgencyItem>> itemsSetter) {
        if (this.items == null) {
            this.items = new ArrayList<>();
        }
    ...
    public void setItems(List<AgencyItem> items) {
        this.items = items;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ShowAgencyResponse showAgencyResponse = (ShowAgencyResponse) o;
        return Objects.equals(this.apiVersion, showAgencyResponse.apiVersion)
            && Objects.equals(this.kind, showAgencyResponse.kind)
            && Objects.equals(this.items, showAgencyResponse.items);
    }
