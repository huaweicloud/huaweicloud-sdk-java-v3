...
public class CreateCertificateRequest {
    ...
    private CertReq body;

    public CreateCertificateRequest withXEnterpriseProjectID(String xEnterpriseProjectID) {
    ...
    public CreateCertificateRequest withXEnvironmentID(String xEnvironmentID) {
    ...
    public CreateCertificateRequest withBody(CertReq body) {
        this.body = body;
        return this;
    }

    public CreateCertificateRequest withBody(Consumer<CertReq> bodySetter) {
        if (this.body == null) {
            this.body = new CertReq();
     ...
     * @return body
     */
    public CertReq getBody() {
        return body;
    }

    public void setBody(CertReq body) {
        this.body = body;
    }
