...
public class UpdateNoticeRuleItem {
    ...
    public UpdateNoticeRuleItem withEventName(EventNameEnum eventName) {
    ...
    public UpdateNoticeRuleItem withScope(NoticeRuleScope scope) {
        this.scope = scope;
        return this;
    }

    public UpdateNoticeRuleItem withScope(Consumer<NoticeRuleScope> scopeSetter) {
        if (this.scope == null) {
    ...
    public UpdateNoticeRuleItem withTriggerPolicy(TriggerPolicy triggerPolicy) {
        this.triggerPolicy = triggerPolicy;
        return this;
    }

    public UpdateNoticeRuleItem withTriggerPolicy(Consumer<TriggerPolicy> triggerPolicySetter) {
    ...
    public UpdateNoticeRuleItem withEnable(Boolean enable) {
        this.enable = enable;
        return this;
    }
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        UpdateNoticeRuleItem that = (UpdateNoticeRuleItem) obj;
        return Objects.equals(this.eventName, that.eventName) && Objects.equals(this.scope, that.scope)
            && Objects.equals(this.triggerPolicy, that.triggerPolicy) && Objects.equals(this.enable, that.enable);
    }

    @Override
    public int hashCode() {
        return Objects.hash(eventName, scope, triggerPolicy, enable);
    }

    @Override
    public String toString() {
        StringBuilder sb = new StringBuilder();
        sb.append("class UpdateNoticeRuleItem {\n");
