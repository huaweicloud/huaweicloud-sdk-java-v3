...
public class ListComponentInstancesRequest {
    ...
    public ListComponentInstancesRequest withApplicationId(String applicationId) {
    ...
    public ListComponentInstancesRequest withComponentId(String componentId) {
    ...
    public ListComponentInstancesRequest withXEnterpriseProjectID(String xEnterpriseProjectID) {
    ...
    public ListComponentInstancesRequest withXEnvironmentID(String xEnvironmentID) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ListComponentInstancesRequest that = (ListComponentInstancesRequest) obj;
