 ...
 * UpdateTimerRuleReq
 */
public class UpdateTimerRuleReq {
    ...
    public UpdateTimerRuleReq withApiVersion(ApiVersionObj apiVersion) {
    ...
    public UpdateTimerRuleReq withKind(TimeRuleKindObj kind) {
        this.kind = kind;
        return this;
    }
    ...
    public UpdateTimerRuleReq withSpec(UpdateTimerRuleDetails spec) {
        this.spec = spec;
        return this;
    }

    public UpdateTimerRuleReq withSpec(Consumer<UpdateTimerRuleDetails> specSetter) {
        if (this.spec == null) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        UpdateTimerRuleReq that = (UpdateTimerRuleReq) obj;
    ...
    public String toString() {
        ...
        sb.append("class UpdateTimerRuleReq {\n");
