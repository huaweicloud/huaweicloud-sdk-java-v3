 ...
 * Request Object
 */
public class UpdateTimerRuleRequest {
    ...
    private UpdateTimerRuleReq body;

    public UpdateTimerRuleRequest withXEnterpriseProjectID(String xEnterpriseProjectID) {
    ...
    public UpdateTimerRuleRequest withXEnvironmentID(String xEnvironmentID) {
    ...
    public UpdateTimerRuleRequest withTimerRuleId(String timerRuleId) {
    ...
    public UpdateTimerRuleRequest withBody(UpdateTimerRuleReq body) {
        this.body = body;
        return this;
    }

    public UpdateTimerRuleRequest withBody(Consumer<UpdateTimerRuleReq> bodySetter) {
        if (this.body == null) {
            this.body = new UpdateTimerRuleReq();
     ...
     * @return body
     */
    public UpdateTimerRuleReq getBody() {
        return body;
    }

    public void setBody(UpdateTimerRuleReq body) {
        this.body = body;
    }
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        UpdateTimerRuleRequest that = (UpdateTimerRuleRequest) obj;
        return Objects.equals(this.xEnterpriseProjectID, that.xEnterpriseProjectID)
            ...
            && Objects.equals(this.timerRuleId, that.timerRuleId) && Objects.equals(this.body, that.body);
    }

    @Override
    public int hashCode() {
        return Objects.hash(xEnterpriseProjectID, xEnvironmentID, timerRuleId, body);
    }

    @Override
    public String toString() {
        StringBuilder sb = new StringBuilder();
        sb.append("class UpdateTimerRuleRequest {\n");
