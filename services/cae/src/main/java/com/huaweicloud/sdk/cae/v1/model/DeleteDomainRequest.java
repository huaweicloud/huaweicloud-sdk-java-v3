...
public class DeleteDomainRequest {
    ...
    public DeleteDomainRequest withXEnterpriseProjectID(String xEnterpriseProjectID) {
    ...
    public DeleteDomainRequest withXEnvironmentID(String xEnvironmentID) {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(domainId, xEnterpriseProjectID, xEnvironmentID);
    }
