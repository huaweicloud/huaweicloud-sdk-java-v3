...
public class CreateVolumeRequest {
    ...
    public CreateVolumeRequest withXEnterpriseProjectID(String xEnterpriseProjectID) {
    ...
    public CreateVolumeRequest withXEnvironmentID(String xEnvironmentID) {
    ...
    public CreateVolumeRequest withBody(CreateVolumeReq body) {
        this.body = body;
        return this;
    }

    public CreateVolumeRequest withBody(Consumer<CreateVolumeReq> bodySetter) {
        if (this.body == null) {
    ...
    public void setBody(CreateVolumeReq body) {
        this.body = body;
    }
