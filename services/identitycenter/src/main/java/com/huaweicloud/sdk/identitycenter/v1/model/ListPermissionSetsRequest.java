...
public class ListPermissionSetsRequest {
    ...
    public ListPermissionSetsRequest withXSecurityToken(String xSecurityToken) {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(xSecurityToken, instanceId, limit, marker, permissionSetId, permissionUrn, name);
    }
