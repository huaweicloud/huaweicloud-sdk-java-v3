...
public class ListApplicationsRequest {
    ...
    public ListApplicationsRequest withXSecurityToken(String xSecurityToken) {
    ...
    public ListApplicationsRequest withInstanceId(String instanceId) {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(xSecurityToken, limit, marker, instanceId);
    }
