...
public class AttachManagedRoleToPermissionSetRequest {
    ...
    public AttachManagedRoleToPermissionSetRequest withPermissionSetId(String permissionSetId) {
    ...
    public AttachManagedRoleToPermissionSetRequest withBody(
        Consumer<ResourceAttachManagedPolicyToPermissionSetReqBody> bodySetter) {
        if (this.body == null) {
            this.body = new ResourceAttachManagedPolicyToPermissionSetReqBody();
     ...
     * @return body
     */
    public ResourceAttachManagedPolicyToPermissionSetReqBody getBody() {
        return body;
    }

    public void setBody(ResourceAttachManagedPolicyToPermissionSetReqBody body) {
        this.body = body;
    }
