...
public class DeleteTagResourceRequest {
    ...
    private DeleteTagResourceReqBody body;

    public DeleteTagResourceRequest withXSecurityToken(String xSecurityToken) {
    ...
    public DeleteTagResourceRequest withBody(DeleteTagResourceReqBody body) {
        this.body = body;
        return this;
    }

    public DeleteTagResourceRequest withBody(Consumer<DeleteTagResourceReqBody> bodySetter) {
        if (this.body == null) {
            this.body = new DeleteTagResourceReqBody();
     ...
     * @return body
     */
    public DeleteTagResourceReqBody getBody() {
        return body;
    }

    public void setBody(DeleteTagResourceReqBody body) {
        this.body = body;
    }
