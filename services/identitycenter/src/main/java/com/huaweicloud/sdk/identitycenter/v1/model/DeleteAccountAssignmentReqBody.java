...
public class DeleteAccountAssignmentReqBody {
    ...
    public DeleteAccountAssignmentReqBody withPermissionSetId(String permissionSetId) {
    ...
    public DeleteAccountAssignmentReqBody withPrincipalId(String principalId) {
    ...
    public DeleteAccountAssignmentReqBody withPrincipalType(PrincipalTypeEnum principalType) {
    ...
    public DeleteAccountAssignmentReqBody withTargetId(String targetId) {
    ...
    public DeleteAccountAssignmentReqBody withTargetType(TargetTypeEnum targetType) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        DeleteAccountAssignmentReqBody that = (DeleteAccountAssignmentReqBody) obj;
