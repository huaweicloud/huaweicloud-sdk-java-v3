...
public class ApplicationProviderDto {
    ...
    public ApplicationProviderDto withApplicationProviderUrn(String applicationProviderUrn) {
    ...
    public ApplicationProviderDto withDisplayData(DisplayDataDto displayData) {
        this.displayData = displayData;
        return this;
    }

    public ApplicationProviderDto withDisplayData(Consumer<DisplayDataDto> displayDataSetter) {
    ...
    public ApplicationProviderDto withFederationProtocol(FederationProtocolEnum federationProtocol) {
    ...
    public ApplicationProviderDto withApplicationProviderId(String applicationProviderId) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ApplicationProviderDto that = (ApplicationProviderDto) obj;
    ...
    public String toString() {
        ...
        sb.append("class ApplicationProviderDto {\n");
