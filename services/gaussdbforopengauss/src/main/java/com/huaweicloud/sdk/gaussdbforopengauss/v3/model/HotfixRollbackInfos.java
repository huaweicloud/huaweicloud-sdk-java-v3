...
public class HotfixRollbackInfos {
    ...
    public HotfixRollbackInfos withVersion(String version) {
    ...
    public HotfixRollbackInfos withCommonPatch(String commonPatch) {
    ...
    public HotfixRollbackInfos withBackupSensitive(Boolean backupSensitive) {
    ...
    public HotfixRollbackInfos withDescripition(String descripition) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        HotfixRollbackInfos that = (HotfixRollbackInfos) obj;
