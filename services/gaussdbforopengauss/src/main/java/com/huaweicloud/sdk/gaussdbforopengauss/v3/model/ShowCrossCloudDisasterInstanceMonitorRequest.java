...
public class ShowCrossCloudDisasterInstanceMonitorRequest {
    ...
    public ShowCrossCloudDisasterInstanceMonitorRequest withXLanguage(XLanguageEnum xLanguage) {
    ...
    public ShowCrossCloudDisasterInstanceMonitorRequest withInstanceId(String instanceId) {
    ...
    public ShowCrossCloudDisasterInstanceMonitorRequest withDisasterType(DisasterTypeEnum disasterType) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ShowCrossCloudDisasterInstanceMonitorRequest that = (ShowCrossCloudDisasterInstanceMonitorRequest) obj;
    ...
    @Override
    public int hashCode() {
        return Objects.hash(xLanguage, instanceId, disasterType);
    }
