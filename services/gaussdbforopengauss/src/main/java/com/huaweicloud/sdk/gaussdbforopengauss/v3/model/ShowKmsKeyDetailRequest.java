 ...
 * Request Object
 */
public class ShowKmsKeyDetailRequest {
    ...
    public ShowKmsKeyDetailRequest withXLanguage(XLanguageEnum xLanguage) {
    ...
    public ShowKmsKeyDetailRequest withKmsKeyId(String kmsKeyId) {
    ...
    public ShowKmsKeyDetailRequest withKmsProjectName(String kmsProjectName) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ShowKmsKeyDetailRequest that = (ShowKmsKeyDetailRequest) obj;
        return Objects.equals(this.xLanguage, that.xLanguage) && Objects.equals(this.kmsKeyId, that.kmsKeyId)
            && Objects.equals(this.kmsProjectName, that.kmsProjectName);
    }

    @Override
    public int hashCode() {
        return Objects.hash(xLanguage, kmsKeyId, kmsProjectName);
    }

    @Override
    public String toString() {
        StringBuilder sb = new StringBuilder();
        sb.append("class ShowKmsKeyDetailRequest {\n");
