 ...
 * 可以升级的热补丁信息。
 */
public class CanBeUpgradedHotfixDetail {
    ...
    public CanBeUpgradedHotfixDetail withVersion(String version) {
    ...
    public CanBeUpgradedHotfixDetail withCommonPatch(String commonPatch) {
    ...
    public CanBeUpgradedHotfixDetail withBackupSensitive(Boolean backupSensitive) {
    ...
    public CanBeUpgradedHotfixDetail withDescripition(String descripition) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        CanBeUpgradedHotfixDetail that = (CanBeUpgradedHotfixDetail) obj;
    ...
    public String toString() {
        ...
        sb.append("class CanBeUpgradedHotfixDetail {\n");
