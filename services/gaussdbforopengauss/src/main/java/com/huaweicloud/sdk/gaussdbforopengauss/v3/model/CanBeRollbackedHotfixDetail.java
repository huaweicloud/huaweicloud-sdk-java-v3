 ...
 * 可以回退的热补丁信息。
 */
public class CanBeRollbackedHotfixDetail {
    ...
    public CanBeRollbackedHotfixDetail withVersion(String version) {
    ...
    public CanBeRollbackedHotfixDetail withCommonPatch(String commonPatch) {
    ...
    public CanBeRollbackedHotfixDetail withBackupSensitive(Boolean backupSensitive) {
    ...
    public CanBeRollbackedHotfixDetail withDescripition(String descripition) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        CanBeRollbackedHotfixDetail that = (CanBeRollbackedHotfixDetail) obj;
    ...
    public String toString() {
        ...
        sb.append("class CanBeRollbackedHotfixDetail {\n");
