 ...
 * 备份策略信息
 */
public class BackupPolicyInfoOption {
    ...
    public BackupPolicyInfoOption withKeepDays(Integer keepDays) {
    ...
    public BackupPolicyInfoOption withStartTime(String startTime) {
    ...
    public BackupPolicyInfoOption withPeriod(String period) {
        this.period = period;
        return this;
    }
    ...
    public BackupPolicyInfoOption withDifferentialPeriod(String differentialPeriod) {
    ...
    public BackupPolicyInfoOption withRateLimit(Integer rateLimit) {
    ...
    public BackupPolicyInfoOption withPrefetchBlock(Integer prefetchBlock) {
    ...
    public BackupPolicyInfoOption withFileSplitSize(Integer fileSplitSize) {
    ...
    public BackupPolicyInfoOption withEnableStandbyBackup(Boolean enableStandbyBackup) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        BackupPolicyInfoOption that = (BackupPolicyInfoOption) obj;
    ...
    public String toString() {
        ...
        sb.append("class BackupPolicyInfoOption {\n");
