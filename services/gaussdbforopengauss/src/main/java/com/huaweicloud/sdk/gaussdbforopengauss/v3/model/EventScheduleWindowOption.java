 ...
 */
public class EventScheduleWindowOption {
    ...
    public EventScheduleWindowOption withPlannedDay(String plannedDay) {
    ...
    public EventScheduleWindowOption withStartTime(String startTime) {
    ...
    public EventScheduleWindowOption withEndTime(String endTime) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        EventScheduleWindowOption that = (EventScheduleWindowOption) obj;
    ...
    public String toString() {
        ...
        sb.append("class EventScheduleWindowOption {\n");
