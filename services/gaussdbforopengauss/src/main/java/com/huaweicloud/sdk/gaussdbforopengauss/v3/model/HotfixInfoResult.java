...
public class HotfixInfoResult {
    ...
    public HotfixInfoResult withVersion(String version) {
    ...
    public HotfixInfoResult withCommonPatch(CommonPatchEnum commonPatch) {
    ...
    public HotfixInfoResult withBackupSensitive(Boolean backupSensitive) {
    ...
    public HotfixInfoResult withDescripition(String descripition) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        HotfixInfoResult that = (HotfixInfoResult) obj;
    ...
    public String toString() {
        ...
        sb.append("class HotfixInfoResult {\n");
