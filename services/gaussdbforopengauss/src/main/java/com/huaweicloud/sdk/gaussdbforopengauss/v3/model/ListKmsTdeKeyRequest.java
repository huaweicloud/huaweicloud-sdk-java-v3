 ...
 * Request Object
 */
public class ListKmsTdeKeyRequest {
    ...
    public ListKmsTdeKeyRequest withXLanguage(XLanguageEnum xLanguage) {
    ...
    public ListKmsTdeKeyRequest withKmsProjectName(String kmsProjectName) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ListKmsTdeKeyRequest that = (ListKmsTdeKeyRequest) obj;
    ...
    @Override
    public int hashCode() {
        return Objects.hash(xLanguage, kmsProjectName);
    }

    @Override
    public String toString() {
        StringBuilder sb = new StringBuilder();
        sb.append("class ListKmsTdeKeyRequest {\n");
