...
public class WaitEventQueryInfoOption {
    ...
    public WaitEventQueryInfoOption withDatabaseName(String databaseName) {
    ...
    public WaitEventQueryInfoOption withUserName(String userName) {
    ...
    public WaitEventQueryInfoOption withWaiting(String waiting) {
    ...
    public WaitEventQueryInfoOption withSessionId(String sessionId) {
    ...
    public WaitEventQueryInfoOption withBlockSessionId(String blockSessionId) {
    ...
    public WaitEventQueryInfoOption withBlockCount(Integer blockCount) {
    ...
    public WaitEventQueryInfoOption withUniqueSqlId(String uniqueSqlId) {
    ...
    public WaitEventQueryInfoOption withQueryId(String queryId) {
    ...
    public WaitEventQueryInfoOption withState(String state) {
        this.state = state;
        return this;
    }
    ...
    public WaitEventQueryInfoOption withWaitEvent(String waitEvent) {
    ...
    public WaitEventQueryInfoOption withWaitStatus(String waitStatus) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        WaitEventQueryInfoOption that = (WaitEventQueryInfoOption) obj;
