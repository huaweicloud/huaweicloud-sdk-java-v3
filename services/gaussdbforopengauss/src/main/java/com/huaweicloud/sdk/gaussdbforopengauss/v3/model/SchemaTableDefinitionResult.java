...
public class SchemaTableDefinitionResult {
    ...
    public SchemaTableDefinitionResult withSchemaName(String schemaName) {
    ...
    public SchemaTableDefinitionResult withTableDefinition(String tableDefinition) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        SchemaTableDefinitionResult that = (SchemaTableDefinitionResult) obj;
        return Objects.equals(this.schemaName, that.schemaName)
            && Objects.equals(this.tableDefinition, that.tableDefinition);
    }

    @Override
    public int hashCode() {
        return Objects.hash(schemaName, tableDefinition);
    }
