...
public class CopyConfigurationRequest  {
    ...
    public CopyConfigurationRequest withXLanguage(XLanguageEnum xLanguage) {
     ...
     * @return body
     */
    public ParamGroupCopyRequestBody getBody() {
        return body;
    }

    public void setBody(ParamGroupCopyRequestBody body) {
        this.body = body;
    }
