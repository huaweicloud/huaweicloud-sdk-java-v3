 ...
 * Response Object
 */
public class CreateMessageNotificationPolicyResponse extends SdkResponse {
    ...
    public CreateMessageNotificationPolicyResponse withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public CreateMessageNotificationPolicyResponse withMessageType(MessageTypeEnum messageType) {
    ...
    public CreateMessageNotificationPolicyResponse withNamePattern(String namePattern) {
    ...
    public CreateMessageNotificationPolicyResponse withNotificationTypes(
        List<NotificationTypesEnum> notificationTypes) {
        this.notificationTypes = notificationTypes;
        return this;
    }

    public CreateMessageNotificationPolicyResponse addNotificationTypesItem(
        NotificationTypesEnum notificationTypesItem) {
    ...
    public CreateMessageNotificationPolicyResponse withTopicUrn(String topicUrn) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        CreateMessageNotificationPolicyResponse that = (CreateMessageNotificationPolicyResponse) obj;
    ...
    public String toString() {
        ...
        sb.append("class CreateMessageNotificationPolicyResponse {\n");
