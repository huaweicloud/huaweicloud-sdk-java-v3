...
public class Url {
    ...
    public Url withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Url withType(TypeEnum type) {
        this.type = type;
        return this;
    }
    ...
    public Url withToken(String token) {
        this.token = token;
        return this;
    }
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        return Objects.equals(this.name, that.name) && Objects.equals(this.address, that.address)
            && Objects.equals(this.type, that.type) && Objects.equals(this.token, that.token);
    }
