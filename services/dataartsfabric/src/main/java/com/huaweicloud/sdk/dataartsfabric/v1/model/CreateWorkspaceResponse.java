...
public class CreateWorkspaceResponse extends SdkResponse {
    ...
    public CreateWorkspaceResponse withCreateDomainName(String createDomainName) {
    ...
    public CreateWorkspaceResponse withCreateUserName(String createUserName) {
    ...
    public CreateWorkspaceResponse withMetastoreId(String metastoreId) {
    ...
    public CreateWorkspaceResponse withAccessUrl(String accessUrl) {
    ...
    public CreateWorkspaceResponse withXRequestId(String xRequestId) {
