...
/**
 * **参数解释**：RayService类型端点的简洁配置。 **约束限制**：不涉及。 
 */
public class RayServiceBriefConfig {
    ...
    public RayServiceBriefConfig withRayServeConfig(RayServeConfig rayServeConfig) {
        this.rayServeConfig = rayServeConfig;
        return this;
    }

    public RayServiceBriefConfig withRayServeConfig(Consumer<RayServeConfig> rayServeConfigSetter) {
    ...
    public RayServiceBriefConfig withRayClusterConfig(RayClusterConfig rayClusterConfig) {
        this.rayClusterConfig = rayClusterConfig;
        return this;
    }

    public RayServiceBriefConfig withRayClusterConfig(Consumer<RayClusterConfig> rayClusterConfigSetter) {
    ...
    public RayServiceBriefConfig withLogConfig(RayServiceLogConfig logConfig) {
        this.logConfig = logConfig;
        return this;
    }

    public RayServiceBriefConfig withLogConfig(Consumer<RayServiceLogConfig> logConfigSetter) {
    ...
    public RayServiceBriefConfig withOidcConfig(OidcConfig oidcConfig) {
        this.oidcConfig = oidcConfig;
        return this;
    }

    public RayServiceBriefConfig withOidcConfig(Consumer<OidcConfig> oidcConfigSetter) {
    ...
    public RayServiceBriefConfig withApiConfig(ApiConfig apiConfig) {
        this.apiConfig = apiConfig;
        return this;
    }

    public RayServiceBriefConfig withApiConfig(Consumer<ApiConfig> apiConfigSetter) {
    ...
    public RayServiceBriefConfig withAgencyConfig(AgencyConfig agencyConfig) {
        this.agencyConfig = agencyConfig;
        return this;
    }

    public RayServiceBriefConfig withAgencyConfig(Consumer<AgencyConfig> agencyConfigSetter) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        RayServiceBriefConfig that = (RayServiceBriefConfig) obj;
    ...
    @Override
    public int hashCode() {
        return Objects.hash(rayServeConfig, rayClusterConfig, logConfig, oidcConfig, apiConfig, agencyConfig);
    }

    @Override
    public String toString() {
        StringBuilder sb = new StringBuilder();
        sb.append("class RayServiceBriefConfig {\n");
