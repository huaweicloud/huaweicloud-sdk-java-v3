 ...
 * Request Object
 */
public class ListHistoryOnlineInfoRequest {
    ...
    public ListHistoryOnlineInfoRequest withStartTime(String startTime) {
    ...
    public ListHistoryOnlineInfoRequest withEndTime(String endTime) {
    ...
    public ListHistoryOnlineInfoRequest withQueryType(String queryType) {
    ...
    public ListHistoryOnlineInfoRequest withClientHour(Integer clientHour) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ListHistoryOnlineInfoRequest that = (ListHistoryOnlineInfoRequest) obj;
    ...
    public String toString() {
        ...
        sb.append("class ListHistoryOnlineInfoRequest {\n");
