 ...
 * Response Object
 */
public class ApplySubnetBandwidthResponse extends SdkResponse {
    ...
    public ApplySubnetBandwidthResponse withJobId(String jobId) {
        this.jobId = jobId;
        return this;
    }
    ...
    public ApplySubnetBandwidthResponse withGetJobEndpoint(String getJobEndpoint) {
    ...
    public ApplySubnetBandwidthResponse withMaxProvisionTime(Integer maxProvisionTime) {
    ...
    public ApplySubnetBandwidthResponse withMinProvisionTime(Integer minProvisionTime) {
    ...
    public ApplySubnetBandwidthResponse withPeriodicQueryTime(Integer periodicQueryTime) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ApplySubnetBandwidthResponse that = (ApplySubnetBandwidthResponse) obj;
    ...
    public String toString() {
        ...
        sb.append("class ApplySubnetBandwidthResponse {\n");
