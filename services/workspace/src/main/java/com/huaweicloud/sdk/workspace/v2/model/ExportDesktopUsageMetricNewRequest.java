 ...
 * Request Object
 */
public class ExportDesktopUsageMetricNewRequest {
    ...
    public ExportDesktopUsageMetricNewRequest withStartTime(String startTime) {
    ...
    public ExportDesktopUsageMetricNewRequest withEndTime(String endTime) {
    ...
    public ExportDesktopUsageMetricNewRequest withResourceName(String resourceName) {
    ...
    public ExportDesktopUsageMetricNewRequest withMaxIdleDays(Integer maxIdleDays) {
    ...
    public ExportDesktopUsageMetricNewRequest withUsageMinHours(Integer usageMinHours) {
    ...
    public ExportDesktopUsageMetricNewRequest withUsageMaxHours(Integer usageMaxHours) {
    ...
    public ExportDesktopUsageMetricNewRequest withEnterpriseProjectId(String enterpriseProjectId) {
    ...
    public ExportDesktopUsageMetricNewRequest withSortField(String sortField) {
    ...
    public ExportDesktopUsageMetricNewRequest withSortType(String sortType) {
    ...
    public String toString() {
        ...
        sb.append("class ExportDesktopUsageMetricNewRequest {\n");
