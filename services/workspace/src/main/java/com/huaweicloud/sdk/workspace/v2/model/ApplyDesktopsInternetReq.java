...
public class ApplyDesktopsInternetReq {
    ...
    public ApplyDesktopsInternetReq withDesktopIds(List<String> desktopIds) {
        this.desktopIds = desktopIds;
        return this;
    }

    public ApplyDesktopsInternetReq addDesktopIdsItem(String desktopIdsItem) {
    ...
    public ApplyDesktopsInternetReq withDesktopIds(Consumer<List<String>> desktopIdsSetter) {
        if (this.desktopIds == null) {
            this.desktopIds = new ArrayList<>();
        }
    ...
    public ApplyDesktopsInternetReq withEipChargeMode(EipChargeModeEnum eipChargeMode) {
    ...
    public ApplyDesktopsInternetReq withBandwidthSize(Integer bandwidthSize) {
