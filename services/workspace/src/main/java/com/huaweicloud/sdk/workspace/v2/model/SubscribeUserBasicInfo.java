 ...
 * 查询订阅用户信息
 */
public class SubscribeUserBasicInfo {
    ...
    public SubscribeUserBasicInfo withUserId(String userId) {
        this.userId = userId;
        return this;
    }
    ...
    public SubscribeUserBasicInfo withUserName(String userName) {
    ...
    public SubscribeUserBasicInfo withUserPhone(String userPhone) {
    ...
    public SubscribeUserBasicInfo withAiFunc(Boolean aiFunc) {
        this.aiFunc = aiFunc;
        return this;
    }
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        SubscribeUserBasicInfo that = (SubscribeUserBasicInfo) obj;
    ...
    public String toString() {
        ...
        sb.append("class SubscribeUserBasicInfo {\n");
