 ...
 * Response Object
 */
public class DeleteDesktopSubResourcesResponse extends SdkResponse {
    ...
    public DeleteDesktopSubResourcesResponse withJobId(String jobId) {
        this.jobId = jobId;
        return this;
    }
    ...
    public DeleteDesktopSubResourcesResponse withCbcJobId(String cbcJobId) {
    ...
    public DeleteDesktopSubResourcesResponse withGetJobEndpoint(String getJobEndpoint) {
    ...
    public DeleteDesktopSubResourcesResponse withMaxProvisionTime(Integer maxProvisionTime) {
    ...
    public DeleteDesktopSubResourcesResponse withMinProvisionTime(Integer minProvisionTime) {
    ...
    public DeleteDesktopSubResourcesResponse withPeriodicQueryTime(Integer periodicQueryTime) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        DeleteDesktopSubResourcesResponse that = (DeleteDesktopSubResourcesResponse) obj;
    ...
    public String toString() {
        ...
        sb.append("class DeleteDesktopSubResourcesResponse {\n");
