...
public class CbcCallbackRsp {
    ...
    public CbcCallbackRsp withErrorCode(String errorCode) {
    ...
    public CbcCallbackRsp withErrorMsg(String errorMsg) {
    ...
    public CbcCallbackRsp withCbcJobId(String cbcJobId) {
    ...
    public CbcCallbackRsp withGetJobEndpoint(String getJobEndpoint) {
    ...
    public CbcCallbackRsp withMaxProvisionTime(Integer maxProvisionTime) {
    ...
    public CbcCallbackRsp withMinProvisionTime(Integer minProvisionTime) {
    ...
    public CbcCallbackRsp withPeriodicQueryTime(Integer periodicQueryTime) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        CbcCallbackRsp that = (CbcCallbackRsp) obj;
    ...
    public int hashCode() {
        return Objects
            .hash(errorCode, errorMsg, cbcJobId, getJobEndpoint, maxProvisionTime, minProvisionTime, periodicQueryTime);
    }
