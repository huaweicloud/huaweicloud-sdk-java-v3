...
public class ThirdGatewayInfo {
    ...
    public ThirdGatewayInfo withLoginUrl(String loginUrl) {
    ...
    public ThirdGatewayInfo withLogoutUrl(String logoutUrl) {
    ...
    public ThirdGatewayInfo withTokenUrl(String tokenUrl) {
    ...
    public ThirdGatewayInfo withVerificationCipherUrl(String verificationCipherUrl) {
    ...
    public ThirdGatewayInfo withCertContent(String certContent) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ThirdGatewayInfo that = (ThirdGatewayInfo) obj;
