 ...
 * Response Object
 */
public class UpdateUploadedAppResponse extends SdkResponse {
    ...
    public UpdateUploadedAppResponse withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public UpdateUploadedAppResponse withTenantId(String tenantId) {
    ...
    public UpdateUploadedAppResponse withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public UpdateUploadedAppResponse withVersion(String version) {
    ...
    public UpdateUploadedAppResponse withDescription(String description) {
    ...
    public UpdateUploadedAppResponse withAuthorizationType(AssignType authorizationType) {
    ...
    public UpdateUploadedAppResponse withAppFileStore(FileStoreLink appFileStore) {
        this.appFileStore = appFileStore;
        return this;
    }

    public UpdateUploadedAppResponse withAppFileStore(Consumer<FileStoreLink> appFileStoreSetter) {
    ...
    public UpdateUploadedAppResponse withAppIconUrl(String appIconUrl) {
    ...
    public UpdateUploadedAppResponse withInstallType(InstallType installType) {
    ...
    public UpdateUploadedAppResponse withInstallCommand(String installCommand) {
    ...
    public UpdateUploadedAppResponse withUninstallCommand(String uninstallCommand) {
    ...
    public UpdateUploadedAppResponse withSupportOs(OsTypeEnum supportOs) {
    ...
    public UpdateUploadedAppResponse withStatus(AppStatusEnum status) {
        this.status = status;
        return this;
    }
    ...
    public UpdateUploadedAppResponse withApplicationSource(AppSourceType applicationSource) {
    ...
    public UpdateUploadedAppResponse withCreateTime(OffsetDateTime createTime) {
    ...
    public UpdateUploadedAppResponse withCatalogId(String catalogId) {
    ...
    public UpdateUploadedAppResponse withCatalog(String catalog) {
    ...
    public UpdateUploadedAppResponse withInstallInfo(String installInfo) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        UpdateUploadedAppResponse that = (UpdateUploadedAppResponse) obj;
    ...
    public String toString() {
        ...
        sb.append("class UpdateUploadedAppResponse {\n");
