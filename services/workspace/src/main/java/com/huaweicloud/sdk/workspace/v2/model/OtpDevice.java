...
public class OtpDevice {
    ...
    public static final class StatusEnum {
         ...
         */
        public static final StatusEnum UNREGISTER = new StatusEnum("UNREGISTER");

        /**
         * Enum REGISTERED for value: "REGISTERED"
         */
        public static final StatusEnum REGISTERED = new StatusEnum("REGISTERED");
    ...
    public OtpDevice withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public OtpDevice withUserId(String userId) {
        this.userId = userId;
        return this;
    }
    ...
    public OtpDevice withUserName(String userName) {
    ...
    public OtpDevice withStatus(StatusEnum status) {
        this.status = status;
        return this;
    }
    ...
    public OtpDevice withCreateTime(OffsetDateTime createTime) {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, userId, userName, status, createTime);
    }
