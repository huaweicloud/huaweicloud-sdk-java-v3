...
public class ExpandDesktopPoolVolumesReq {
    ...
    private List<ExpandDesktopPoolVolumesReqVolumes> volumes = null;

    public ExpandDesktopPoolVolumesReq withHandleType(HandleTypeEnum handleType) {
    ...
    public ExpandDesktopPoolVolumesReq withDesktopIds(List<String> desktopIds) {
        this.desktopIds = desktopIds;
        return this;
    }

    public ExpandDesktopPoolVolumesReq addDesktopIdsItem(String desktopIdsItem) {
    ...
    public ExpandDesktopPoolVolumesReq withDesktopIds(Consumer<List<String>> desktopIdsSetter) {
        if (this.desktopIds == null) {
            this.desktopIds = new ArrayList<>();
        }
    ...
    public ExpandDesktopPoolVolumesReq withVolumes(List<ExpandDesktopPoolVolumesReqVolumes> volumes) {
        this.volumes = volumes;
        return this;
    }

    public ExpandDesktopPoolVolumesReq addVolumesItem(ExpandDesktopPoolVolumesReqVolumes volumesItem) {
    ...
    public ExpandDesktopPoolVolumesReq withVolumes(Consumer<List<ExpandDesktopPoolVolumesReqVolumes>> volumesSetter) {
        if (this.volumes == null) {
            this.volumes = new ArrayList<>();
        }
     ...
     * @return volumes
     */
    public List<ExpandDesktopPoolVolumesReqVolumes> getVolumes() {
        return volumes;
    }

    public void setVolumes(List<ExpandDesktopPoolVolumesReqVolumes> volumes) {
        this.volumes = volumes;
    }
