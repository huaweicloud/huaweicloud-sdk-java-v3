 ...
 * Response Object
 */
public class ApplyDesktopsInternetResponse extends SdkResponse {
    ...
    public ApplyDesktopsInternetResponse withJobId(String jobId) {
        this.jobId = jobId;
        return this;
    }
    ...
    public ApplyDesktopsInternetResponse withGetJobEndpoint(String getJobEndpoint) {
    ...
    public ApplyDesktopsInternetResponse withMaxProvisionTime(Integer maxProvisionTime) {
    ...
    public ApplyDesktopsInternetResponse withMinProvisionTime(Integer minProvisionTime) {
    ...
    public ApplyDesktopsInternetResponse withPeriodicQueryTime(Integer periodicQueryTime) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ApplyDesktopsInternetResponse that = (ApplyDesktopsInternetResponse) obj;
    ...
    public String toString() {
        ...
        sb.append("class ApplyDesktopsInternetResponse {\n");
