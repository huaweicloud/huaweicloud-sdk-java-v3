...
public class AttachInstancesResponse extends SdkResponse {
    ...
    public AttachInstancesResponse withGetJobEndpoint(String getJobEndpoint) {
    ...
    public AttachInstancesResponse withMaxProvisionTime(Integer maxProvisionTime) {
    ...
    public AttachInstancesResponse withMinProvisionTime(Integer minProvisionTime) {
    ...
    public AttachInstancesResponse withPeriodicQueryTime(Integer periodicQueryTime) {
