 ...
 * Response Object
 */
public class AddDesktopSubResourcesResponse extends SdkResponse {
    ...
    public AddDesktopSubResourcesResponse withJobId(String jobId) {
        this.jobId = jobId;
        return this;
    }
    ...
    public AddDesktopSubResourcesResponse withCbcJobId(String cbcJobId) {
    ...
    public AddDesktopSubResourcesResponse withGetJobEndpoint(String getJobEndpoint) {
    ...
    public AddDesktopSubResourcesResponse withMaxProvisionTime(Integer maxProvisionTime) {
    ...
    public AddDesktopSubResourcesResponse withMinProvisionTime(Integer minProvisionTime) {
    ...
    public AddDesktopSubResourcesResponse withPeriodicQueryTime(Integer periodicQueryTime) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        AddDesktopSubResourcesResponse that = (AddDesktopSubResourcesResponse) obj;
    ...
    public String toString() {
        ...
        sb.append("class AddDesktopSubResourcesResponse {\n");
