 ...
 * Response Object
 */
public class CreateDesktopPoolResponse extends SdkResponse {
    ...
    public CreateDesktopPoolResponse withJobId(String jobId) {
        this.jobId = jobId;
        return this;
    }
    ...
    public CreateDesktopPoolResponse withCbcJobId(String cbcJobId) {
    ...
    public CreateDesktopPoolResponse withGetJobEndpoint(String getJobEndpoint) {
    ...
    public CreateDesktopPoolResponse withMaxProvisionTime(Integer maxProvisionTime) {
    ...
    public CreateDesktopPoolResponse withMinProvisionTime(Integer minProvisionTime) {
    ...
    public CreateDesktopPoolResponse withPeriodicQueryTime(Integer periodicQueryTime) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        CreateDesktopPoolResponse that = (CreateDesktopPoolResponse) obj;
