 ...
 */
public class EstimateAddVolumeRequestBody {
    ...
    public EstimateAddVolumeRequestBody withDesktopIds(List<String> desktopIds) {
        this.desktopIds = desktopIds;
        return this;
    }

    public EstimateAddVolumeRequestBody addDesktopIdsItem(String desktopIdsItem) {
    ...
    public EstimateAddVolumeRequestBody withDesktopIds(Consumer<List<String>> desktopIdsSetter) {
        if (this.desktopIds == null) {
            this.desktopIds = new ArrayList<>();
        }
    ...
    public EstimateAddVolumeRequestBody withPromotionPlanId(String promotionPlanId) {
    ...
    public EstimateAddVolumeRequestBody withHandleType(HandleTypeEnum handleType) {
    ...
    public String toString() {
        ...
        sb.append("class EstimateAddVolumeRequestBody {\n");
