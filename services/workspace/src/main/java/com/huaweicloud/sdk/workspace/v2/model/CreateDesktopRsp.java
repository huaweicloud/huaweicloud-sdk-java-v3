...
/**
 * 创建按需桌面时的响应体，可根据job_id查询资源是否创建成功。
 */
public class CreateDesktopRsp {
    ...
    public CreateDesktopRsp withJobId(String jobId) {
        this.jobId = jobId;
        return this;
    }
    ...
    public CreateDesktopRsp withCbcJobId(String cbcJobId) {
    ...
    public CreateDesktopRsp withGetJobEndpoint(String getJobEndpoint) {
    ...
    public CreateDesktopRsp withMaxProvisionTime(Integer maxProvisionTime) {
    ...
    public CreateDesktopRsp withMinProvisionTime(Integer minProvisionTime) {
    ...
    public CreateDesktopRsp withPeriodicQueryTime(Integer periodicQueryTime) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        CreateDesktopRsp that = (CreateDesktopRsp) obj;
    ...
    public String toString() {
        ...
        sb.append("class CreateDesktopRsp {\n");
