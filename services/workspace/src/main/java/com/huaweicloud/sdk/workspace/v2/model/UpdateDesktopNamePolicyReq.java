...
public class UpdateDesktopNamePolicyReq {
    ...
    public UpdateDesktopNamePolicyReq withNamePrefix(String namePrefix) {
    ...
    public UpdateDesktopNamePolicyReq withDigitNumber(Integer digitNumber) {
    ...
    public UpdateDesktopNamePolicyReq withStartNumber(Integer startNumber) {
    ...
    public UpdateDesktopNamePolicyReq withSingleDomainUserInc(Integer singleDomainUserInc) {
    ...
    public UpdateDesktopNamePolicyReq withIsDefaultPolicy(Boolean isDefaultPolicy) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        UpdateDesktopNamePolicyReq that = (UpdateDesktopNamePolicyReq) obj;
