 ...
 * 域信息。
 */
public class ApplyWorkspaceAdDomain {
    ...
    public ApplyWorkspaceAdDomain withDomainType(DomainTypeEnum domainType) {
    ...
    public ApplyWorkspaceAdDomain withDomainName(String domainName) {
    ...
    public ApplyWorkspaceAdDomain withDomainAdminAccount(String domainAdminAccount) {
    ...
    public ApplyWorkspaceAdDomain withDomainPassword(String domainPassword) {
    ...
    public ApplyWorkspaceAdDomain withActiveDomainIp(String activeDomainIp) {
    ...
    public ApplyWorkspaceAdDomain withActiveDomainName(String activeDomainName) {
    ...
    public ApplyWorkspaceAdDomain withStandbyDomainIp(String standbyDomainIp) {
    ...
    public ApplyWorkspaceAdDomain withStandbyDomainName(String standbyDomainName) {
    ...
    public ApplyWorkspaceAdDomain withActiveDnsIp(String activeDnsIp) {
    ...
    public ApplyWorkspaceAdDomain withStandbyDnsIp(String standbyDnsIp) {
    ...
    public ApplyWorkspaceAdDomain withDeleteComputerObject(Integer deleteComputerObject) {
    ...
    public ApplyWorkspaceAdDomain withUseLdaps(Boolean useLdaps) {
    ...
    public ApplyWorkspaceAdDomain withTlsConfig(Consumer<TlsConfig> tlsConfigSetter) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ApplyWorkspaceAdDomain that = (ApplyWorkspaceAdDomain) obj;
    ...
    public String toString() {
        ...
        sb.append("class ApplyWorkspaceAdDomain {\n");
