 ...
 * 设置管控规则。
 */
public class SetRuleRestrictionReq {
    ...
    public SetRuleRestrictionReq withAppRestrictRuleSwitch(Boolean appRestrictRuleSwitch) {
    ...
    public SetRuleRestrictionReq withAppControlMode(Integer appControlMode) {
    ...
    public SetRuleRestrictionReq withAppPeriodicSwitch(Boolean appPeriodicSwitch) {
    ...
    public SetRuleRestrictionReq withAppPeriodicInterval(Integer appPeriodicInterval) {
    ...
    public SetRuleRestrictionReq withAppForceKillProcSwitch(Boolean appForceKillProcSwitch) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        SetRuleRestrictionReq that = (SetRuleRestrictionReq) obj;
    ...
    public String toString() {
        ...
        sb.append("class SetRuleRestrictionReq {\n");
