...
public class PoliciesUserProfileOptions {
    ...
    public PoliciesUserProfileOptions withUserProfileRule(String userProfileRule) {
    ...
    public PoliciesUserProfileOptions withRedirExcludeCommonFolders(String redirExcludeCommonFolders) {
    ...
    public PoliciesUserProfileOptions withRedirExcludeCopy0s(String redirExcludeCopy0s) {
    ...
    public PoliciesUserProfileOptions withRedirExcludeCopy1s(String redirExcludeCopy1s) {
    ...
    public PoliciesUserProfileOptions withRedirExcludeCopy2s(String redirExcludeCopy2s) {
    ...
    public PoliciesUserProfileOptions withRedirExcludeCopy3s(String redirExcludeCopy3s) {
    ...
    public PoliciesUserProfileOptions withRedirExcludeIncludes(String redirExcludeIncludes) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        PoliciesUserProfileOptions that = (PoliciesUserProfileOptions) obj;
