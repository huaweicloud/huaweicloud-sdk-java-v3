 ...
 * Response Object
 */
public class ShowUpgradeTaskDetailResponse extends SdkResponse {
    ...
    public ShowUpgradeTaskDetailResponse withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public ShowUpgradeTaskDetailResponse withProjectId(String projectId) {
    ...
    public ShowUpgradeTaskDetailResponse withTaskName(String taskName) {
    ...
    public ShowUpgradeTaskDetailResponse withTaskType(Integer taskType) {
    ...
    public ShowUpgradeTaskDetailResponse withScheduledType(ScheduledTypeEnum scheduledType) {
    ...
    public ShowUpgradeTaskDetailResponse withTimezone(String timezone) {
    ...
    public ShowUpgradeTaskDetailResponse withWeekList(String weekList) {
    ...
    public ShowUpgradeTaskDetailResponse withMonthList(String monthList) {
    ...
    public ShowUpgradeTaskDetailResponse withDateList(String dateList) {
    ...
    public ShowUpgradeTaskDetailResponse withDayInterval(Integer dayInterval) {
    ...
    public ShowUpgradeTaskDetailResponse withScheduledDate(String scheduledDate) {
    ...
    public ShowUpgradeTaskDetailResponse withScheduledTime(String scheduledTime) {
    ...
    public ShowUpgradeTaskDetailResponse withCronExpression(String cronExpression) {
    ...
    public ShowUpgradeTaskDetailResponse withLastExecuteStatus(String lastExecuteStatus) {
    ...
    public ShowUpgradeTaskDetailResponse withLastExecuteTime(String lastExecuteTime) {
    ...
    public ShowUpgradeTaskDetailResponse withNextExecuteTime(String nextExecuteTime) {
    ...
    public ShowUpgradeTaskDetailResponse withIsEnable(Integer isEnable) {
    ...
    public ShowUpgradeTaskDetailResponse withIsForceExecute(Integer isForceExecute) {
    ...
    public ShowUpgradeTaskDetailResponse withMinVersion(String minVersion) {
    ...
    public ShowUpgradeTaskDetailResponse withTargetVersion(String targetVersion) {
    ...
    public ShowUpgradeTaskDetailResponse withExpireEnable(Integer expireEnable) {
    ...
    public ShowUpgradeTaskDetailResponse withExpireTime(String expireTime) {
    ...
    public ShowUpgradeTaskDetailResponse withIsNotify(Integer isNotify) {
    ...
    public ShowUpgradeTaskDetailResponse withExtraParams(String extraParams) {
    ...
    public ShowUpgradeTaskDetailResponse withExecuteStrategy(Integer executeStrategy) {
    ...
    public ShowUpgradeTaskDetailResponse withGrayscaleRule(Integer grayscaleRule) {
    ...
    public ShowUpgradeTaskDetailResponse withGrayObjectIds(String grayObjectIds) {
    ...
    public ShowUpgradeTaskDetailResponse withRandomFirstBatchCount(Integer randomFirstBatchCount) {
    ...
    public ShowUpgradeTaskDetailResponse withGrayFailThreshold(Integer grayFailThreshold) {
    ...
    public ShowUpgradeTaskDetailResponse withScheduledEndTime(String scheduledEndTime) {
    ...
    public ShowUpgradeTaskDetailResponse withDescription(String description) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ShowUpgradeTaskDetailResponse that = (ShowUpgradeTaskDetailResponse) obj;
        return Objects.equals(this.id, that.id) && Objects.equals(this.projectId, that.projectId)
            ...
            && Objects.equals(this.isEnable, that.isEnable) && Objects.equals(this.isForceExecute, that.isForceExecute)
    ...
    public String toString() {
        ...
        sb.append("class ShowUpgradeTaskDetailResponse {\n");
