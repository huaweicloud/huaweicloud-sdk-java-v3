...
public class QueryScreenRecordDetailRsp {
    ...
    public QueryScreenRecordDetailRsp withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public QueryScreenRecordDetailRsp withDesktopId(String desktopId) {
    ...
    public QueryScreenRecordDetailRsp withDesktopName(String desktopName) {
    ...
    public QueryScreenRecordDetailRsp withDesktopPoolId(String desktopPoolId) {
    ...
    public QueryScreenRecordDetailRsp withUsername(String username) {
    ...
    public QueryScreenRecordDetailRsp withSize(Integer size) {
        this.size = size;
        return this;
    }
    ...
    public QueryScreenRecordDetailRsp withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public QueryScreenRecordDetailRsp withStatus(String status) {
        this.status = status;
        return this;
    }
    ...
    public QueryScreenRecordDetailRsp withVideoFilename(String videoFilename) {
    ...
    public QueryScreenRecordDetailRsp withEventFilename(String eventFilename) {
    ...
    public QueryScreenRecordDetailRsp withStartTime(String startTime) {
    ...
    public QueryScreenRecordDetailRsp withEndTime(String endTime) {
    ...
    public QueryScreenRecordDetailRsp withUpdateTime(String updateTime) {
    ...
    public QueryScreenRecordDetailRsp withDuration(Integer duration) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        QueryScreenRecordDetailRsp that = (QueryScreenRecordDetailRsp) obj;
