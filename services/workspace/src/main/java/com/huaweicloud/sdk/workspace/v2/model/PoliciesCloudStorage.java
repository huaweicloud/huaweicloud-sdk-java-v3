...
public class PoliciesCloudStorage {
    ...
    private PoliciesCloudStorageOptions options;
    ...
    public PoliciesCloudStorage withOptions(PoliciesCloudStorageOptions options) {
        this.options = options;
        return this;
    }

    public PoliciesCloudStorage withOptions(Consumer<PoliciesCloudStorageOptions> optionsSetter) {
        if (this.options == null) {
            this.options = new PoliciesCloudStorageOptions();
     ...
     * @return options
     */
    public PoliciesCloudStorageOptions getOptions() {
        return options;
    }

    public void setOptions(PoliciesCloudStorageOptions options) {
        this.options = options;
    }
