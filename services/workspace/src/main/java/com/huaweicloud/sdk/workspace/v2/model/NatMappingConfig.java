...
public class NatMappingConfig {
    ...
    public NatMappingConfig withNatMapType(NatMapTypeEnum natMapType) {
    ...
    public NatMappingConfig withNatMapValue(String natMapValue) {
    ...
    public NatMappingConfig withNatIp(String natIp) {
        this.natIp = natIp;
        return this;
    }
    ...
    public NatMappingConfig withNatPort(String natPort) {
    ...
    public NatMappingConfig withVagIp(String vagIp) {
        this.vagIp = vagIp;
        return this;
    }
    ...
    public NatMappingConfig withVagPort(String vagPort) {
    ...
    public NatMappingConfig withAccessFilterType(Integer accessFilterType) {
    ...
    public NatMappingConfig withEnterpriseProjectId(String enterpriseProjectId) {
    ...
    public NatMappingConfig addTagsItem(Tag tagsItem) {
        if (this.tags == null) {
    ...
    public NatMappingConfig withTags(Consumer<List<Tag>> tagsSetter) {
        if (this.tags == null) {
            this.tags = new ArrayList<>();
        }
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        NatMappingConfig that = (NatMappingConfig) obj;
    ...
    public String toString() {
        ...
        sb.append("class NatMappingConfig {\n");
