...
public class PoliciesUserProfile {
    ...
    private PoliciesUserProfileOptions options;
    ...
    public PoliciesUserProfile withOptions(PoliciesUserProfileOptions options) {
        this.options = options;
        return this;
    }

    public PoliciesUserProfile withOptions(Consumer<PoliciesUserProfileOptions> optionsSetter) {
        if (this.options == null) {
            this.options = new PoliciesUserProfileOptions();
     ...
     * @return options
     */
    public PoliciesUserProfileOptions getOptions() {
        return options;
    }

    public void setOptions(PoliciesUserProfileOptions options) {
        this.options = options;
    }
