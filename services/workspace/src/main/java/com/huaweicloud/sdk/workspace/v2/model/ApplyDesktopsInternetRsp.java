 ...
 * 创建云办公带宽响应。
 */
public class ApplyDesktopsInternetRsp {
    ...
    public ApplyDesktopsInternetRsp withJobId(String jobId) {
        this.jobId = jobId;
        return this;
    }
    ...
    public ApplyDesktopsInternetRsp withGetJobEndpoint(String getJobEndpoint) {
    ...
    public ApplyDesktopsInternetRsp withMaxProvisionTime(Integer maxProvisionTime) {
    ...
    public ApplyDesktopsInternetRsp withMinProvisionTime(Integer minProvisionTime) {
    ...
    public ApplyDesktopsInternetRsp withPeriodicQueryTime(Integer periodicQueryTime) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ApplyDesktopsInternetRsp that = (ApplyDesktopsInternetRsp) obj;
    ...
    public String toString() {
        ...
        sb.append("class ApplyDesktopsInternetRsp {\n");
