...
public class DesktopDetailInfo {
    ...
    public DesktopDetailInfo withDomainStatus(Integer domainStatus) {
    ...
    public DesktopDetailInfo withIsolated(Boolean isolated) {
    ...
    public DesktopDetailInfo withDomain(String domain) {
        this.domain = domain;
        return this;
    }
    ...
    public DesktopDetailInfo withAgentVersion(String agentVersion) {
