...
public class CreateDeleteSubResourcesOrderRequestBody {
    ...
    public CreateDeleteSubResourcesOrderRequestBody withDesktopPoolId(String desktopPoolId) {
    ...
    public CreateDeleteSubResourcesOrderRequestBody withDesktopIds(List<String> desktopIds) {
        this.desktopIds = desktopIds;
        return this;
    }

    public CreateDeleteSubResourcesOrderRequestBody addDesktopIdsItem(String desktopIdsItem) {
    ...
    public CreateDeleteSubResourcesOrderRequestBody withDesktopIds(Consumer<List<String>> desktopIdsSetter) {
        if (this.desktopIds == null) {
            this.desktopIds = new ArrayList<>();
        }
    ...
    public CreateDeleteSubResourcesOrderRequestBody withPromotionPlanId(String promotionPlanId) {
    ...
    public CreateDeleteSubResourcesOrderRequestBody withHandleType(HandleTypeEnum handleType) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        CreateDeleteSubResourcesOrderRequestBody that = (CreateDeleteSubResourcesOrderRequestBody) obj;
