...
public class CreateDomainNewReq {
    ...
    private CreateUosDomainInfo uosDomainInfo;
    ...
    public CreateDomainNewReq withUosDomainInfo(CreateUosDomainInfo uosDomainInfo) {
        this.uosDomainInfo = uosDomainInfo;
        return this;
    }

    public CreateDomainNewReq withUosDomainInfo(Consumer<CreateUosDomainInfo> uosDomainInfoSetter) {
        if (this.uosDomainInfo == null) {
            this.uosDomainInfo = new CreateUosDomainInfo();
     ...
     */
    public CreateUosDomainInfo getUosDomainInfo() {
        return uosDomainInfo;
    }

    public void setUosDomainInfo(CreateUosDomainInfo uosDomainInfo) {
        this.uosDomainInfo = uosDomainInfo;
    }

    public CreateDomainNewReq withAdDomainInfo(AdDomain adDomainInfo) {
        this.adDomainInfo = adDomainInfo;
        return this;
    }

    public CreateDomainNewReq withAdDomainInfo(Consumer<AdDomain> adDomainInfoSetter) {
    ...
    public CreateDomainNewReq withAuthType(DomainType authType) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        CreateDomainNewReq that = (CreateDomainNewReq) obj;
    ...
    @Override
    public int hashCode() {
        return Objects.hash(uosDomainInfo, adDomainInfo, authType);
    }
