 ...
 * Response Object
 */
public class AddDesktopPoolVolumesResponse extends SdkResponse {
    ...
    public AddDesktopPoolVolumesResponse withErrorCode(String errorCode) {
    ...
    public AddDesktopPoolVolumesResponse withErrorMsg(String errorMsg) {
    ...
    public AddDesktopPoolVolumesResponse withCbcJobId(String cbcJobId) {
    ...
    public AddDesktopPoolVolumesResponse withGetJobEndpoint(String getJobEndpoint) {
    ...
    public AddDesktopPoolVolumesResponse withMaxProvisionTime(Integer maxProvisionTime) {
    ...
    public AddDesktopPoolVolumesResponse withMinProvisionTime(Integer minProvisionTime) {
    ...
    public AddDesktopPoolVolumesResponse withPeriodicQueryTime(Integer periodicQueryTime) {
    ...
    public AddDesktopPoolVolumesResponse withJobId(String jobId) {
        this.jobId = jobId;
        return this;
    }
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        AddDesktopPoolVolumesResponse that = (AddDesktopPoolVolumesResponse) obj;
