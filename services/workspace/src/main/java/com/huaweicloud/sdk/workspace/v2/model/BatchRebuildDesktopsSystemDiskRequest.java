...
public class BatchRebuildDesktopsSystemDiskRequest {
    ...
    public BatchRebuildDesktopsSystemDiskRequest withBody(Consumer<RebuildDesktopsReq> bodySetter) {
        if (this.body == null) {
            this.body = new RebuildDesktopsReq();
     ...
     * @return body
     */
    public RebuildDesktopsReq getBody() {
        return body;
    }

    public void setBody(RebuildDesktopsReq body) {
        this.body = body;
    }
