...
public class UpdatePolicyGroupRequest {
    ...
    private ModifyPolicyGroupRequest body;
    ...
    public UpdatePolicyGroupRequest withBody(ModifyPolicyGroupRequest body) {
        this.body = body;
        return this;
    }

    public UpdatePolicyGroupRequest withBody(Consumer<ModifyPolicyGroupRequest> bodySetter) {
        if (this.body == null) {
            this.body = new ModifyPolicyGroupRequest();
     ...
     * @return body
     */
    public ModifyPolicyGroupRequest getBody() {
        return body;
    }

    public void setBody(ModifyPolicyGroupRequest body) {
        this.body = body;
    }
