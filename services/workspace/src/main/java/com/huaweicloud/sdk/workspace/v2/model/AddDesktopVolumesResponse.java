 ...
 * Response Object
 */
public class AddDesktopVolumesResponse extends SdkResponse {
    ...
    public AddDesktopVolumesResponse withJobId(String jobId) {
        this.jobId = jobId;
        return this;
    }
    ...
    public AddDesktopVolumesResponse withGetJobEndpoint(String getJobEndpoint) {
    ...
    public AddDesktopVolumesResponse withMaxProvisionTime(Integer maxProvisionTime) {
    ...
    public AddDesktopVolumesResponse withMinProvisionTime(Integer minProvisionTime) {
    ...
    public AddDesktopVolumesResponse withPeriodicQueryTime(Integer periodicQueryTime) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        AddDesktopVolumesResponse that = (AddDesktopVolumesResponse) obj;
