...
public class UpdateMetricNotifyRuleReq {
    ...
    public UpdateMetricNotifyRuleReq withMetricName(String metricName) {
    ...
    public UpdateMetricNotifyRuleReq withThreshold(Integer threshold) {
    ...
    public UpdateMetricNotifyRuleReq withComparisonOperator(String comparisonOperator) {
    ...
    public UpdateMetricNotifyRuleReq withInterval(Integer interval) {
    ...
    public UpdateMetricNotifyRuleReq withEnable(Boolean enable) {
        this.enable = enable;
        return this;
    }
    ...
    public UpdateMetricNotifyRuleReq withNotifyObject(String notifyObject) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        UpdateMetricNotifyRuleReq that = (UpdateMetricNotifyRuleReq) obj;
