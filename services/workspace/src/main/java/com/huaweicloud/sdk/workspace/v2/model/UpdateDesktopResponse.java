 ...
 * Response Object
 */
public class UpdateDesktopResponse extends SdkResponse {
    ...
    public UpdateDesktopResponse withErrorCode(String errorCode) {
    ...
    public UpdateDesktopResponse withErrorMsg(String errorMsg) {
    ...
    public UpdateDesktopResponse withErrorDetail(String errorDetail) {
    ...
    public UpdateDesktopResponse withEncodedAuthorizationMessage(String encodedAuthorizationMessage) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        UpdateDesktopResponse that = (UpdateDesktopResponse) obj;
