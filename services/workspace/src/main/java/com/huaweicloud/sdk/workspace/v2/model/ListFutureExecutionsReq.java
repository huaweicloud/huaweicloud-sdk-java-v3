...
public class ListFutureExecutionsReq {
    ...
    public ListFutureExecutionsReq withExpireTime(String expireTime) {
    ...
    public ListFutureExecutionsReq withGrayCount(Integer grayCount) {
    ...
    public ListFutureExecutionsReq withGrayDesktopIds(List<String> grayDesktopIds) {
        this.grayDesktopIds = grayDesktopIds;
        return this;
    }

    public ListFutureExecutionsReq addGrayDesktopIdsItem(String grayDesktopIdsItem) {
    ...
    public ListFutureExecutionsReq withGrayDesktopIds(Consumer<List<String>> grayDesktopIdsSetter) {
        if (this.grayDesktopIds == null) {
            this.grayDesktopIds = new ArrayList<>();
        }
    ...
    public ListFutureExecutionsReq withGrayFailThreshold(Integer grayFailThreshold) {
    ...
    public ListFutureExecutionsReq withLifeCycleType(String lifeCycleType) {
