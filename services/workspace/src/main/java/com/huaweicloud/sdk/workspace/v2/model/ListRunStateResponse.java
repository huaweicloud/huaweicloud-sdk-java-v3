 ...
 * Response Object
 */
public class ListRunStateResponse extends SdkResponse {
    ...
    public ListRunStateResponse withStopNum(Integer stopNum) {
    ...
    public ListRunStateResponse withActiveNum(Integer activeNum) {
    ...
    public ListRunStateResponse withErrorNum(Integer errorNum) {
    ...
    public ListRunStateResponse withHibernatedNum(Integer hibernatedNum) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ListRunStateResponse that = (ListRunStateResponse) obj;
    ...
    public String toString() {
        ...
        sb.append("class ListRunStateResponse {\n");
