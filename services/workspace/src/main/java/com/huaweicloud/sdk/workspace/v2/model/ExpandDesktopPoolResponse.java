 ...
 * Response Object
 */
public class ExpandDesktopPoolResponse extends SdkResponse {
    ...
    public ExpandDesktopPoolResponse withJobId(String jobId) {
        this.jobId = jobId;
        return this;
    }
    ...
    public ExpandDesktopPoolResponse withCbcJobId(String cbcJobId) {
    ...
    public ExpandDesktopPoolResponse withGetJobEndpoint(String getJobEndpoint) {
    ...
    public ExpandDesktopPoolResponse withMaxProvisionTime(Integer maxProvisionTime) {
    ...
    public ExpandDesktopPoolResponse withMinProvisionTime(Integer minProvisionTime) {
    ...
    public ExpandDesktopPoolResponse withPeriodicQueryTime(Integer periodicQueryTime) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ExpandDesktopPoolResponse that = (ExpandDesktopPoolResponse) obj;
    ...
    public String toString() {
        ...
        sb.append("class ExpandDesktopPoolResponse {\n");
