...
public class Application {
    ...
    public Application withAuthorizationType(AssignType authorizationType) {
    ...
    public Application withAppFileStore(FileStoreLink appFileStore) {
        this.appFileStore = appFileStore;
        return this;
    }

    public Application withAppFileStore(Consumer<FileStoreLink> appFileStoreSetter) {
    ...
    public Application withAppIconUrl(String appIconUrl) {
    ...
    public Application withInstallType(InstallType installType) {
    ...
    public Application withInstallCommand(String installCommand) {
    ...
    public Application withUninstallCommand(String uninstallCommand) {
    ...
    public Application withSupportOs(OsTypeEnum supportOs) {
    ...
    public Application withStatus(AppStatusEnum status) {
        this.status = status;
        return this;
    }
    ...
    public Application withApplicationSource(AppSourceType applicationSource) {
    ...
    public Application withCreateTime(OffsetDateTime createTime) {
    ...
    public Application withCatalogId(String catalogId) {
    ...
    public Application withCatalog(String catalog) {
    ...
    public Application withInstallInfo(String installInfo) {
