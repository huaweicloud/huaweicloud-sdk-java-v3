...
public class ImChannelItem {
    ...
    public ImChannelItem withPlatform(String platform) {
    ...
    public ImChannelItem withEnabled(Boolean enabled) {
    ...
    public ImChannelItem withClientId(String clientId) {
    ...
    public ImChannelItem withPlatformSpecific(Map<String, String> platformSpecific) {
        this.platformSpecific = platformSpecific;
        return this;
    }

    public ImChannelItem putPlatformSpecificItem(String key, String platformSpecificItem) {
    ...
    public ImChannelItem withPlatformSpecific(Consumer<Map<String, String>> platformSpecificSetter) {
        if (this.platformSpecific == null) {
            this.platformSpecific = new HashMap<>();
        }
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ImChannelItem that = (ImChannelItem) obj;
    ...
    @Override
    public int hashCode() {
        return Objects.hash(platform, enabled, clientId, platformSpecific);
    }
