...
public class DeleteDesktopPoolVolumesReq {
    ...
    private List<DeleteDesktopPoolVolumesReqVolumes> volumes = null;

    public DeleteDesktopPoolVolumesReq withHandleType(HandleTypeEnum handleType) {
    ...
    public DeleteDesktopPoolVolumesReq withDesktopIds(List<String> desktopIds) {
        this.desktopIds = desktopIds;
        return this;
    }

    public DeleteDesktopPoolVolumesReq addDesktopIdsItem(String desktopIdsItem) {
    ...
    public DeleteDesktopPoolVolumesReq withDesktopIds(Consumer<List<String>> desktopIdsSetter) {
        if (this.desktopIds == null) {
            this.desktopIds = new ArrayList<>();
        }
    ...
    public DeleteDesktopPoolVolumesReq withVolumes(List<DeleteDesktopPoolVolumesReqVolumes> volumes) {
        this.volumes = volumes;
        return this;
    }

    public DeleteDesktopPoolVolumesReq addVolumesItem(DeleteDesktopPoolVolumesReqVolumes volumesItem) {
    ...
    public DeleteDesktopPoolVolumesReq withVolumes(Consumer<List<DeleteDesktopPoolVolumesReqVolumes>> volumesSetter) {
        if (this.volumes == null) {
            this.volumes = new ArrayList<>();
        }
     ...
     * @return volumes
     */
    public List<DeleteDesktopPoolVolumesReqVolumes> getVolumes() {
        return volumes;
    }

    public void setVolumes(List<DeleteDesktopPoolVolumesReqVolumes> volumes) {
        this.volumes = volumes;
    }
