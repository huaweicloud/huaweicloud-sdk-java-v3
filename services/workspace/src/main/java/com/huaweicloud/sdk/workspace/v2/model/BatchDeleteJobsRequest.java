...
public class BatchDeleteJobsRequest {
    ...
    public BatchDeleteJobsRequest withBody(BatchOperateJobsReq body) {
        this.body = body;
        return this;
    }

    public BatchDeleteJobsRequest withBody(Consumer<BatchOperateJobsReq> bodySetter) {
        if (this.body == null) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        BatchDeleteJobsRequest that = (BatchDeleteJobsRequest) obj;
