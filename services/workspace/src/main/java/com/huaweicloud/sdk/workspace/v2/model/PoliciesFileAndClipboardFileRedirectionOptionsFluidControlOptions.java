...
public class PoliciesFileAndClipboardFileRedirectionOptionsFluidControlOptions {
    ...
    public PoliciesFileAndClipboardFileRedirectionOptionsFluidControlOptions withGoodNetworkLatency(
        Integer goodNetworkLatency) {
    ...
    public PoliciesFileAndClipboardFileRedirectionOptionsFluidControlOptions withNormalNetworkLatency(
        Integer normalNetworkLatency) {
    ...
    public PoliciesFileAndClipboardFileRedirectionOptionsFluidControlOptions withPoorNetworkLatency(
        Integer poorNetworkLatency) {
    ...
    public PoliciesFileAndClipboardFileRedirectionOptionsFluidControlOptions withReducingStep(Integer reducingStep) {
    ...
    public PoliciesFileAndClipboardFileRedirectionOptionsFluidControlOptions withSlowIncreasingStep(
        Integer slowIncreasingStep) {
    ...
    public PoliciesFileAndClipboardFileRedirectionOptionsFluidControlOptions withQuickIncreasingStep(
        Integer quickIncreasingStep) {
    ...
    public PoliciesFileAndClipboardFileRedirectionOptionsFluidControlOptions withStartSpeed(Integer startSpeed) {
    ...
    public PoliciesFileAndClipboardFileRedirectionOptionsFluidControlOptions withTestBlockSize(Integer testBlockSize) {
    ...
    public PoliciesFileAndClipboardFileRedirectionOptionsFluidControlOptions withTestTimeGap(Integer testTimeGap) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        PoliciesFileAndClipboardFileRedirectionOptionsFluidControlOptions that =
            (PoliciesFileAndClipboardFileRedirectionOptionsFluidControlOptions) obj;
