 ...
 * Response Object
 */
public class ShowEvaluationProjectStatusResponse extends SdkResponse {
    ...
    public ShowEvaluationProjectStatusResponse withEvaluationProjectId(Integer evaluationProjectId) {
    ...
    public ShowEvaluationProjectStatusResponse withEvaluationProjectName(String evaluationProjectName) {
    ...
    public ShowEvaluationProjectStatusResponse withEvaluationProjectStatus(
    ...
    public ShowEvaluationProjectStatusResponse withProjectStatusDetail(ProjectStatusDetail projectStatusDetail) {
        this.projectStatusDetail = projectStatusDetail;
        return this;
    }

    public ShowEvaluationProjectStatusResponse withProjectStatusDetail(
    ...
    public ShowEvaluationProjectStatusResponse withSourceDbType(String sourceDbType) {
    ...
    public ShowEvaluationProjectStatusResponse withSourceDbVersion(String sourceDbVersion) {
    ...
    public ShowEvaluationProjectStatusResponse withTargetDbType(String targetDbType) {
    ...
    public ShowEvaluationProjectStatusResponse withTargetDbVersion(String targetDbVersion) {
    ...
    public String toString() {
        ...
        sb.append("class ShowEvaluationProjectStatusResponse {\n");
