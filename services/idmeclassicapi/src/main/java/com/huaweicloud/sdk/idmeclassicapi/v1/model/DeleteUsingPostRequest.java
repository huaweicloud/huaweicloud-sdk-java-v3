 ...
 * Request Object
 */
public class DeleteUsingPostRequest {
    ...
    public DeleteUsingPostRequest withIdentifier(String identifier) {
    ...
    public DeleteUsingPostRequest withModelName(String modelName) {
    ...
    public DeleteUsingPostRequest withBody(RDMParamVOPersistObjectIdModifierDTO body) {
        this.body = body;
        return this;
    }

    public DeleteUsingPostRequest withBody(Consumer<RDMParamVOPersistObjectIdModifierDTO> bodySetter) {
        if (this.body == null) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        DeleteUsingPostRequest that = (DeleteUsingPostRequest) obj;
    ...
    public String toString() {
        ...
        sb.append("class DeleteUsingPostRequest {\n");
