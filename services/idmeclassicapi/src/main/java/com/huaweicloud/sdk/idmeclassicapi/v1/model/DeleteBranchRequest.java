...
public class DeleteBranchRequest {
    ...
    public DeleteBranchRequest withIdentifier(String identifier) {
    ...
    public DeleteBranchRequest withModelName(String modelName) {
    ...
    public DeleteBranchRequest withBody(RDMParamVOVersionModelVersionMasterModifierDTO body) {
        this.body = body;
        return this;
    }

    public DeleteBranchRequest withBody(Consumer<RDMParamVOVersionModelVersionMasterModifierDTO> bodySetter) {
        if (this.body == null) {
