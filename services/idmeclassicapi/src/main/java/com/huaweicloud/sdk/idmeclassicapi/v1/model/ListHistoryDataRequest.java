...
public class ListHistoryDataRequest {
    ...
    private RDMParamVOMongoPageRequest body;
    ...
    public ListHistoryDataRequest withBody(RDMParamVOMongoPageRequest body) {
        this.body = body;
        return this;
    }

    public ListHistoryDataRequest withBody(Consumer<RDMParamVOMongoPageRequest> bodySetter) {
        if (this.body == null) {
            this.body = new RDMParamVOMongoPageRequest();
     ...
     * @return body
     */
    public RDMParamVOMongoPageRequest getBody() {
        return body;
    }

    public void setBody(RDMParamVOMongoPageRequest body) {
        this.body = body;
    }
