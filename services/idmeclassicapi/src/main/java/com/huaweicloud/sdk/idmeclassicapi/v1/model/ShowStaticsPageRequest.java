 ...
 * Request Object
 */
public class ShowStaticsPageRequest {
    ...
    private RDMParamVOQueryRequestStaticsVo body;

    public ShowStaticsPageRequest withCurPage(Integer curPage) {
    ...
    public ShowStaticsPageRequest withEndIndex(Integer endIndex) {
    ...
    public ShowStaticsPageRequest withMaxPageSize(Integer maxPageSize) {
    ...
    public ShowStaticsPageRequest withPageSize(Integer pageSize) {
    ...
    public ShowStaticsPageRequest withStartIndex(Integer startIndex) {
    ...
    public ShowStaticsPageRequest withTotalPages(Integer totalPages) {
    ...
    public ShowStaticsPageRequest withTotalRows(Integer totalRows) {
    ...
    public ShowStaticsPageRequest withModelName(String modelName) {
    ...
    public ShowStaticsPageRequest withIdentifier(String identifier) {
    ...
    public ShowStaticsPageRequest withPageSizePath(Integer pageSizePath) {
    ...
    public ShowStaticsPageRequest withCurPagePath(Integer curPagePath) {
    ...
    public ShowStaticsPageRequest withBody(RDMParamVOQueryRequestStaticsVo body) {
        this.body = body;
        return this;
    }

    public ShowStaticsPageRequest withBody(Consumer<RDMParamVOQueryRequestStaticsVo> bodySetter) {
        if (this.body == null) {
            this.body = new RDMParamVOQueryRequestStaticsVo();
     ...
     * @return body
     */
    public RDMParamVOQueryRequestStaticsVo getBody() {
        return body;
    }

    public void setBody(RDMParamVOQueryRequestStaticsVo body) {
        this.body = body;
    }
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ShowStaticsPageRequest that = (ShowStaticsPageRequest) obj;
        return Objects.equals(this.curPage, that.curPage) && Objects.equals(this.endIndex, that.endIndex)
            ...
            && Objects.equals(this.totalRows, that.totalRows) && Objects.equals(this.modelName, that.modelName)
            && Objects.equals(this.identifier, that.identifier) && Objects.equals(this.pageSizePath, that.pageSizePath)
    ...
    public String toString() {
        ...
        sb.append("class ShowStaticsPageRequest {\n");
