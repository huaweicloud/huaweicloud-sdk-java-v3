...
public class MultiViewModelViewDTO {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        return Objects.equals(this.id, that.id) && Objects.equals(this.name, that.name)
            && Objects.equals(this.description, that.description) && Objects.equals(this.className, that.className)
            && Objects.equals(this.creator, that.creator) && Objects.equals(this.createTime, that.createTime)
            && Objects.equals(this.modifier, that.modifier) && Objects.equals(this.lastUpdateTime, that.lastUpdateTime)
            ...
            && Objects.equals(this.kiaguid, that.kiaguid) && Objects.equals(this.securityLevel, that.securityLevel)
            && Objects.equals(this.version, that.version) && Objects.equals(this.versionCode, that.versionCode)
            && Objects.equals(this.iteration, that.iteration) && Objects.equals(this.latest, that.latest)
            ...
            && Objects.equals(this.preVersionId, that.preVersionId) && Objects.equals(this.master, that.master)
            && Objects.equals(this.branch, that.branch) && Objects.equals(this.item, that.item)
