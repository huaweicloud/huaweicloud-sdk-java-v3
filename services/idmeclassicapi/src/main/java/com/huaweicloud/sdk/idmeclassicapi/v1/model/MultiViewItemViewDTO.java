 ...
 */
public class MultiViewItemViewDTO {
    ...
    public MultiViewItemViewDTO withClassName(String className) {
    ...
    public MultiViewItemViewDTO withCreateTime(String createTime) {
    ...
    public MultiViewItemViewDTO withCreator(String creator) {
    ...
    public MultiViewItemViewDTO withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public MultiViewItemViewDTO withRdmDeleteFlag(Integer rdmDeleteFlag) {
    ...
    public MultiViewItemViewDTO withRdmExtensionType(String rdmExtensionType) {
    ...
    public MultiViewItemViewDTO withRdmVersion(Integer rdmVersion) {
    ...
    public MultiViewItemViewDTO withModifier(String modifier) {
    ...
    public MultiViewItemViewDTO withLastUpdateTime(Object lastUpdateTime) {
    ...
    public MultiViewItemViewDTO withTenant(TenantViewDTO tenant) {
        this.tenant = tenant;
        return this;
    }

    public MultiViewItemViewDTO withTenant(Consumer<TenantViewDTO> tenantSetter) {
        if (this.tenant == null) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        MultiViewItemViewDTO that = (MultiViewItemViewDTO) obj;
    ...
    public String toString() {
        ...
        sb.append("class MultiViewItemViewDTO {\n");
