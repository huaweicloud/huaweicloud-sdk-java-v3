 ...
 */
public class PersistableModelViewDTO {
    ...
    public PersistableModelViewDTO withClassName(String className) {
    ...
    public PersistableModelViewDTO withCreateTime(String createTime) {
    ...
    public PersistableModelViewDTO withCreator(String creator) {
    ...
    public PersistableModelViewDTO withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public PersistableModelViewDTO withRdmDeleteFlag(Integer rdmDeleteFlag) {
    ...
    public PersistableModelViewDTO withRdmExtensionType(String rdmExtensionType) {
    ...
    public PersistableModelViewDTO withRdmVersion(Integer rdmVersion) {
    ...
    public PersistableModelViewDTO withModifier(String modifier) {
    ...
    public PersistableModelViewDTO withLastUpdateTime(Object lastUpdateTime) {
    ...
    public PersistableModelViewDTO withTenant(TenantViewDTO tenant) {
        this.tenant = tenant;
        return this;
    }

    public PersistableModelViewDTO withTenant(Consumer<TenantViewDTO> tenantSetter) {
        if (this.tenant == null) {
    ...
    public PersistableModelViewDTO withUniqueKey(String uniqueKey) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        PersistableModelViewDTO that = (PersistableModelViewDTO) obj;
        return Objects.equals(this.className, that.className) && Objects.equals(this.createTime, that.createTime)
            ...
            && Objects.equals(this.rdmVersion, that.rdmVersion) && Objects.equals(this.modifier, that.modifier)
            && Objects.equals(this.lastUpdateTime, that.lastUpdateTime) && Objects.equals(this.tenant, that.tenant)
    ...
    public String toString() {
        ...
        sb.append("class PersistableModelViewDTO {\n");
