 ...
 */
public class VersionModelMasterViewDTO {
    ...
    public VersionModelMasterViewDTO withClassName(String className) {
    ...
    public VersionModelMasterViewDTO withCreateTime(String createTime) {
    ...
    public VersionModelMasterViewDTO withCreator(String creator) {
    ...
    public VersionModelMasterViewDTO withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public VersionModelMasterViewDTO withLastUpdateTime(String lastUpdateTime) {
    ...
    public VersionModelMasterViewDTO withModifier(String modifier) {
    ...
    public VersionModelMasterViewDTO withRdmDeleteFlag(Integer rdmDeleteFlag) {
    ...
    public VersionModelMasterViewDTO withRdmExtensionType(String rdmExtensionType) {
    ...
    public VersionModelMasterViewDTO withRdmVersion(Integer rdmVersion) {
    ...
    public VersionModelMasterViewDTO withTenant(TenantViewDTO tenant) {
        this.tenant = tenant;
        return this;
    }

    public VersionModelMasterViewDTO withTenant(Consumer<TenantViewDTO> tenantSetter) {
        if (this.tenant == null) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        VersionModelMasterViewDTO that = (VersionModelMasterViewDTO) obj;
    ...
    public String toString() {
        ...
        sb.append("class VersionModelMasterViewDTO {\n");
