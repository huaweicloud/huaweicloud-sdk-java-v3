 ...
 */
public class MultiViewModelBranchViewDTO {
    ...
    public MultiViewModelBranchViewDTO withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public MultiViewModelBranchViewDTO withClassName(String className) {
    ...
    public MultiViewModelBranchViewDTO withCreateTime(String createTime) {
    ...
    public MultiViewModelBranchViewDTO withCreator(String creator) {
    ...
    public MultiViewModelBranchViewDTO withModifier(String modifier) {
    ...
    public MultiViewModelBranchViewDTO withRdmDeleteFlag(Integer rdmDeleteFlag) {
    ...
    public MultiViewModelBranchViewDTO withRdmExtensionType(String rdmExtensionType) {
    ...
    public MultiViewModelBranchViewDTO withRdmVersion(Integer rdmVersion) {
    ...
    public MultiViewModelBranchViewDTO withTenant(TenantViewDTO tenant) {
        this.tenant = tenant;
        return this;
    }

    public MultiViewModelBranchViewDTO withTenant(Consumer<TenantViewDTO> tenantSetter) {
        if (this.tenant == null) {
    ...
    public MultiViewModelBranchViewDTO withVersion(String version) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        MultiViewModelBranchViewDTO that = (MultiViewModelBranchViewDTO) obj;
        return Objects.equals(this.id, that.id) && Objects.equals(this.className, that.className)
    ...
    public String toString() {
        ...
        sb.append("class MultiViewModelBranchViewDTO {\n");
