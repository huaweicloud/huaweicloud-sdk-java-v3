 ...
 * Request Object
 */
public class BatchRemoveChildNodeRequest {
    ...
    public BatchRemoveChildNodeRequest withIdentifier(String identifier) {
    ...
    public BatchRemoveChildNodeRequest withModelName(String modelName) {
    ...
    public BatchRemoveChildNodeRequest withBody(RDMParamVOBatchOperateChildDTO body) {
        this.body = body;
        return this;
    }

    public BatchRemoveChildNodeRequest withBody(Consumer<RDMParamVOBatchOperateChildDTO> bodySetter) {
        if (this.body == null) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        BatchRemoveChildNodeRequest that = (BatchRemoveChildNodeRequest) obj;
    ...
    public String toString() {
        ...
        sb.append("class BatchRemoveChildNodeRequest {\n");
