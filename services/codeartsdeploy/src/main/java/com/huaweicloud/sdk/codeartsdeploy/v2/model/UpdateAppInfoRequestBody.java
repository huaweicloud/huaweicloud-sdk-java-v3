 ...
 * 更新应用请求体
 */
public class UpdateAppInfoRequestBody {
    ...
    private List<UpdateTaskV2RequestBody> arrangeInfos = null;

    public UpdateAppInfoRequestBody withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public UpdateAppInfoRequestBody withProjectId(String projectId) {
    ...
    public UpdateAppInfoRequestBody withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public UpdateAppInfoRequestBody withDescription(String description) {
    ...
    public UpdateAppInfoRequestBody withIsDraft(Boolean isDraft) {
    ...
    public UpdateAppInfoRequestBody withCreateType(CreateTypeEnum createType) {
    ...
    public UpdateAppInfoRequestBody withSlaveClusterId(String slaveClusterId) {
    ...
    public UpdateAppInfoRequestBody withTrigger(TaskTriggerVO trigger) {
        this.trigger = trigger;
        return this;
    }

    public UpdateAppInfoRequestBody withTrigger(Consumer<TaskTriggerVO> triggerSetter) {
    ...
    public UpdateAppInfoRequestBody withArrangeInfos(List<UpdateTaskV2RequestBody> arrangeInfos) {
        this.arrangeInfos = arrangeInfos;
        return this;
    }

    public UpdateAppInfoRequestBody addArrangeInfosItem(UpdateTaskV2RequestBody arrangeInfosItem) {
    ...
    public UpdateAppInfoRequestBody withArrangeInfos(Consumer<List<UpdateTaskV2RequestBody>> arrangeInfosSetter) {
        if (this.arrangeInfos == null) {
            this.arrangeInfos = new ArrayList<>();
        }
     ...
     * @return arrangeInfos
     */
    public List<UpdateTaskV2RequestBody> getArrangeInfos() {
        return arrangeInfos;
    }

    public void setArrangeInfos(List<UpdateTaskV2RequestBody> arrangeInfos) {
        this.arrangeInfos = arrangeInfos;
    }
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        UpdateAppInfoRequestBody that = (UpdateAppInfoRequestBody) obj;
    ...
    public int hashCode() {
        return Objects
            .hash(id, projectId, name, description, isDraft, createType, slaveClusterId, trigger, arrangeInfos);
    }

    @Override
    public String toString() {
        StringBuilder sb = new StringBuilder();
        sb.append("class UpdateAppInfoRequestBody {\n");
