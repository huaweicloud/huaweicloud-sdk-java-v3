...
public class TaskV2Info {
    ...
    public TaskV2Info withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public TaskV2Info withState(String state) {
        this.state = state;
        return this;
    }
    ...
    public TaskV2Info withDescription(String description) {
    ...
    public TaskV2Info withOwner(String owner) {
        this.owner = owner;
        return this;
    }
    ...
    public TaskV2Info withSteps(Map<String, Step> steps) {
        this.steps = steps;
        return this;
    }

    public TaskV2Info putStepsItem(String key, Step stepsItem) {
        if (this.steps == null) {
    ...
    public TaskV2Info withSteps(Consumer<Map<String, Step>> stepsSetter) {
        if (this.steps == null) {
            this.steps = new HashMap<>();
        }
    ...
    public TaskV2Info withProjectId(String projectId) {
    ...
    public TaskV2Info withProjectName(String projectName) {
    ...
    public TaskV2Info withDeploySystem(String deploySystem) {
    ...
    public TaskV2Info withCreateTime(String createTime) {
    ...
    public TaskV2Info withUpdateTime(String updateTime) {
    ...
    public TaskV2Info withRoleId(Integer roleId) {
        this.roleId = roleId;
        return this;
    }
    ...
    public TaskV2Info withIsDefautPermission(Boolean isDefautPermission) {
    ...
    public TaskV2Info withTemplateId(String templateId) {
    ...
    public TaskV2Info withNickName(String nickName) {
    ...
    public TaskV2Info withOwnerId(String ownerId) {
    ...
    public TaskV2Info withTenantId(String tenantId) {
    ...
    public TaskV2Info withTenantName(String tenantName) {
    ...
    public TaskV2Info withSlaveClusterId(String slaveClusterId) {
    ...
    public TaskV2Info withIsCare(Boolean isCare) {
        this.isCare = isCare;
        return this;
    }
    ...
    public TaskV2Info withCanModify(Boolean canModify) {
    ...
    public TaskV2Info withCanDelete(Boolean canDelete) {
    ...
    public TaskV2Info withCanView(Boolean canView) {
    ...
    public TaskV2Info withCanExecute(Boolean canExecute) {
    ...
    public TaskV2Info withCanCopy(Boolean canCopy) {
    ...
    public TaskV2Info withCanManage(Boolean canManage) {
    ...
    public TaskV2Info withCanCreateEnv(Boolean canCreateEnv) {
    ...
    public TaskV2Info addAppComponentListItem(AppComponentDao appComponentListItem) {
    ...
    public TaskV2Info withAppComponentList(Consumer<List<AppComponentDao>> appComponentListSetter) {
        if (this.appComponentList == null) {
            this.appComponentList = new ArrayList<>();
        }
    ...
    public TaskV2Info withReleaseId(Integer releaseId) {
    ...
    public TaskV2Info withAppId(String appId) {
        this.appId = appId;
        return this;
    }
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        TaskV2Info that = (TaskV2Info) obj;
        return Objects.equals(this.id, that.id) && Objects.equals(this.name, that.name)
            && Objects.equals(this.state, that.state) && Objects.equals(this.description, that.description)
            && Objects.equals(this.owner, that.owner) && Objects.equals(this.steps, that.steps)
            ...
            && Objects.equals(this.updateTime, that.updateTime) && Objects.equals(this.roleId, that.roleId)
            && Objects.equals(this.isDefautPermission, that.isDefautPermission)
            && Objects.equals(this.templateId, that.templateId) && Objects.equals(this.nickName, that.nickName)
            && Objects.equals(this.ownerId, that.ownerId) && Objects.equals(this.tenantId, that.tenantId)
