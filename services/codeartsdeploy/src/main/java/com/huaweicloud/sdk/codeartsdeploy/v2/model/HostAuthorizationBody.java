 ...
 */
public class HostAuthorizationBody {
    ...
    public HostAuthorizationBody withUsername(String username) {
    ...
    public HostAuthorizationBody withPassword(String password) {
    ...
    public HostAuthorizationBody withPrivateKey(String privateKey) {
    ...
    public HostAuthorizationBody withTrustedType(TrustedTypeEnum trustedType) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        HostAuthorizationBody that = (HostAuthorizationBody) obj;
    ...
    public String toString() {
        ...
        sb.append("class HostAuthorizationBody {\n");
