...
public class DevUcClusterPermission {
    ...
    public DevUcClusterPermission withRegion(String region) {
        this.region = region;
        return this;
    }
    ...
    public DevUcClusterPermission withRoleId(String roleId) {
        this.roleId = roleId;
        return this;
    }
    ...
    public DevUcClusterPermission withDevucRoleIdList(List<String> devucRoleIdList) {
        this.devucRoleIdList = devucRoleIdList;
        return this;
    }

    public DevUcClusterPermission addDevucRoleIdListItem(String devucRoleIdListItem) {
    ...
    public DevUcClusterPermission withDevucRoleIdList(Consumer<List<String>> devucRoleIdListSetter) {
        if (this.devucRoleIdList == null) {
            this.devucRoleIdList = new ArrayList<>();
        }
    ...
    public DevUcClusterPermission withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public DevUcClusterPermission withGroupId(String groupId) {
    ...
    public DevUcClusterPermission withCanView(Boolean canView) {
    ...
    public DevUcClusterPermission withCanEdit(Boolean canEdit) {
    ...
    public DevUcClusterPermission withCanDelete(Boolean canDelete) {
    ...
    public DevUcClusterPermission withCanAddHost(Boolean canAddHost) {
    ...
    public DevUcClusterPermission withCanManage(Boolean canManage) {
    ...
    public DevUcClusterPermission withCanCopy(Boolean canCopy) {
    ...
    public DevUcClusterPermission withCreateTime(OffsetDateTime createTime) {
    ...
    public DevUcClusterPermission withUpdateTime(OffsetDateTime updateTime) {
    ...
    public DevUcClusterPermission withRoleType(RoleTypeEnum roleType) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        DevUcClusterPermission that = (DevUcClusterPermission) obj;
