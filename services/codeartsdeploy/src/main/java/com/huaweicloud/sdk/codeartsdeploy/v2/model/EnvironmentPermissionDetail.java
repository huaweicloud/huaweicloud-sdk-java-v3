 ...
 * 环境权限详情
 */
public class EnvironmentPermissionDetail {
    ...
    public EnvironmentPermissionDetail withCanDelete(Boolean canDelete) {
    ...
    public EnvironmentPermissionDetail withCanDeploy(Boolean canDeploy) {
    ...
    public EnvironmentPermissionDetail withCanEdit(Boolean canEdit) {
    ...
    public EnvironmentPermissionDetail withCanManage(Boolean canManage) {
    ...
    public EnvironmentPermissionDetail withCanView(Boolean canView) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        EnvironmentPermissionDetail that = (EnvironmentPermissionDetail) obj;
    ...
    public String toString() {
        ...
        sb.append("class EnvironmentPermissionDetail {\n");
