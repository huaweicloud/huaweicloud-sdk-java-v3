...
public class CreateHostRequestBody {
    ...
    public CreateHostRequestBody withIp(String ip) {
        this.ip = ip;
        return this;
    }
    ...
    public CreateHostRequestBody withPort(Integer port) {
        this.port = port;
        return this;
    }
    ...
    public CreateHostRequestBody withOs(OsEnum os) {
        this.os = os;
        return this;
    }
    ...
    public CreateHostRequestBody withAsProxy(Boolean asProxy) {
    ...
    public CreateHostRequestBody withProxyHostId(String proxyHostId) {
    ...
    public CreateHostRequestBody withAuthorization(HostAuthorizationBody authorization) {
        this.authorization = authorization;
        return this;
    }

    public CreateHostRequestBody withAuthorization(Consumer<HostAuthorizationBody> authorizationSetter) {
    ...
    public CreateHostRequestBody withInstallIcagent(Boolean installIcagent) {
