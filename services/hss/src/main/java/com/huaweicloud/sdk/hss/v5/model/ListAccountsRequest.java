...
public class ListAccountsRequest {
    ...
    public ListAccountsRequest withRegion(String region) {
        this.region = region;
        return this;
    }
    ...
    public ListAccountsRequest withOffset(Integer offset) {
        this.offset = offset;
        return this;
    }
    ...
    public ListAccountsRequest withEnterpriseProjectId(String enterpriseProjectId) {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(xSecurityToken, region, limit, offset, enterpriseProjectId);
    }
