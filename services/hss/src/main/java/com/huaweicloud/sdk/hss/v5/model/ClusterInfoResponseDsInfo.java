...
public class ClusterInfoResponseDsInfo {
    ...
    public ClusterInfoResponseDsInfo withDesiredNum(Integer desiredNum) {
    ...
    public ClusterInfoResponseDsInfo withCurrentNum(Integer currentNum) {
    ...
    public ClusterInfoResponseDsInfo withReadyNum(Integer readyNum) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ClusterInfoResponseDsInfo that = (ClusterInfoResponseDsInfo) obj;
    ...
    public String toString() {
        ...
        sb.append("class ClusterInfoResponseDsInfo {\n");
