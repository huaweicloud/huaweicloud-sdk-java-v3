 ...
 * 文件具体变更信息
 */
public class FileEventResponseInfo {
    ...
    public FileEventResponseInfo withId(Integer id) {
        this.id = id;
        return this;
    }
    ...
    public FileEventResponseInfo withFileName(String fileName) {
    ...
    public FileEventResponseInfo withFilePath(String filePath) {
    ...
    public FileEventResponseInfo withStatus(StatusEnum status) {
        this.status = status;
        return this;
    }
    ...
    public FileEventResponseInfo withHostName(String hostName) {
    ...
    public FileEventResponseInfo withChangeType(ChangeTypeEnum changeType) {
    ...
    public FileEventResponseInfo withChangeCategory(ChangeCategoryEnum changeCategory) {
    ...
    public FileEventResponseInfo withAfterChange(String afterChange) {
    ...
    public FileEventResponseInfo withBeforeChange(String beforeChange) {
    ...
    public FileEventResponseInfo withLatestTime(Long latestTime) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        FileEventResponseInfo that = (FileEventResponseInfo) obj;
        return Objects.equals(this.id, that.id) && Objects.equals(this.fileName, that.fileName)
            ...
            && Objects.equals(this.hostName, that.hostName) && Objects.equals(this.changeType, that.changeType)
    ...
    public String toString() {
        ...
        sb.append("class FileEventResponseInfo {\n");
