 ...
 * 资源配置信息
 */
public class DaemonsetYamlResponseInfoResourceInfo {
    ...
    public DaemonsetYamlResponseInfoResourceInfo withMode(String mode) {
        this.mode = mode;
        return this;
    }
    ...
    public DaemonsetYamlResponseInfoResourceInfo withCpuLimit(String cpuLimit) {
    ...
    public DaemonsetYamlResponseInfoResourceInfo withMemLimit(String memLimit) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        DaemonsetYamlResponseInfoResourceInfo that = (DaemonsetYamlResponseInfoResourceInfo) obj;
    ...
    public String toString() {
        ...
        sb.append("class DaemonsetYamlResponseInfoResourceInfo {\n");
