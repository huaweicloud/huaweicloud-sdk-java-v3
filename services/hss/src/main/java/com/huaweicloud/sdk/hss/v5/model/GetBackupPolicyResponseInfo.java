...
/**
 * GetBackupPolicyResponseInfo
 */
public class GetBackupPolicyResponseInfo {
    ...
    public GetBackupPolicyResponseInfo withEnabled(Boolean enabled) {
    ...
    public GetBackupPolicyResponseInfo withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public GetBackupPolicyResponseInfo withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public GetBackupPolicyResponseInfo withOperationType(String operationType) {
    ...
    public GetBackupPolicyResponseInfo withOperationDefinition(OperationDefinitionInfo operationDefinition) {
        this.operationDefinition = operationDefinition;
        return this;
    }

    public GetBackupPolicyResponseInfo withOperationDefinition(
    ...
    public GetBackupPolicyResponseInfo withTrigger(BackupTriggerInfo trigger) {
        this.trigger = trigger;
        return this;
    }

    public GetBackupPolicyResponseInfo withTrigger(Consumer<BackupTriggerInfo> triggerSetter) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        GetBackupPolicyResponseInfo that = (GetBackupPolicyResponseInfo) obj;
    ...
    public String toString() {
        ...
        sb.append("class GetBackupPolicyResponseInfo {\n");
