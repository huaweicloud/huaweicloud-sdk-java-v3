 ...
 * Request Object
 */
public class ShowSwitchesStatusRequest {
    ...
    public ShowSwitchesStatusRequest withEnterpriseProjectId(String enterpriseProjectId) {
    ...
    public ShowSwitchesStatusRequest withCode(CodeEnum code) {
        this.code = code;
        return this;
    }
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ShowSwitchesStatusRequest that = (ShowSwitchesStatusRequest) obj;
    ...
    @Override
    public int hashCode() {
        return Objects.hash(enterpriseProjectId, code);
    }

    @Override
    public String toString() {
        StringBuilder sb = new StringBuilder();
        sb.append("class ShowSwitchesStatusRequest {\n");
