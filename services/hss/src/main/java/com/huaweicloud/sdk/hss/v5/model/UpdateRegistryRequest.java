...
public class UpdateRegistryRequest {
    ...
    public UpdateRegistryRequest withEnterpriseProjectId(String enterpriseProjectId) {
    ...
    public UpdateRegistryRequest withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public UpdateRegistryRequest withBody(UpdateRegistryRequestBody body) {
        this.body = body;
        return this;
    }

    public UpdateRegistryRequest withBody(Consumer<UpdateRegistryRequestBody> bodySetter) {
        if (this.body == null) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        UpdateRegistryRequest that = (UpdateRegistryRequest) obj;
