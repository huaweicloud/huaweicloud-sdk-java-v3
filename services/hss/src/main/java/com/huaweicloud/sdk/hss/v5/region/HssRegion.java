...
public class HssRegion {
    ...
    public static final Region TR_WEST_1 = new Region("tr-west-1", "https://hss.tr-west-1.myhuaweicloud.com");

    public static final Region CN_NORTH_2 = new Region("cn-north-2", "https://hss.cn-north-2.myhuaweicloud.com");

    public static final Region AP_SOUTHEAST_4 =
        new Region("ap-southeast-4", "https://hss.ap-southeast-4.myhuaweicloud.com");

    public static final Region AE_AD_1 = new Region("ae-ad-1", "https://hss.ae-ad-1.myhuaweicloud.com");

    public static final Region ME_EAST_1 = new Region("me-east-1", "https://hss.me-east-1.myhuaweicloud.com");

    public static final Region CN_EAST_5 = new Region("cn-east-5", "https://hss.cn-east-5.myhuaweicloud.com");
    ...
    public static final Region RU_MOSCOW_1 = new Region("ru-moscow-1", "https://hss.ru-moscow-1.myhuaweicloud.com");

    public static final Region CN_NORTH_12 = new Region("cn-north-12", "https://hss.cn-north-12.myhuaweicloud.com");

    public static final Region CN_SOUTHWEST_3 =
        new Region("cn-southwest-3", "https://hss.cn-southwest-3.myhuaweicloud.com");

    public static final Region CN_NORTH_11 = new Region("cn-north-11", "https://hss.cn-north-11.myhuaweicloud.com");

    public static final Region AF_NORTH_1 = new Region("af-north-1", "https://hss.af-north-1.myhuaweicloud.com");

    public static final Region AP_SOUTHEAST_5 =
        new Region("ap-southeast-5", "https://hss.ap-southeast-5.myhuaweicloud.com");
    ...
    public static Region valueOf(String regionId) {
        ...
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "region id '%s' is not in the following supported regions of service HSS: [%s]",
            regionId,
