 ...
 * 恢复的文件详情
 */
public class IsolatedFileRequestInfo {
    ...
    public IsolatedFileRequestInfo withHostId(String hostId) {
        this.hostId = hostId;
        return this;
    }
    ...
    public IsolatedFileRequestInfo withFileHash(String fileHash) {
    ...
    public IsolatedFileRequestInfo withFilePath(String filePath) {
    ...
    public IsolatedFileRequestInfo withFileAttr(String fileAttr) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        IsolatedFileRequestInfo that = (IsolatedFileRequestInfo) obj;
    ...
    public String toString() {
        ...
        sb.append("class IsolatedFileRequestInfo {\n");
