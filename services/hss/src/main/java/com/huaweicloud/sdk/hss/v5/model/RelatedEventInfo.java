...
public class RelatedEventInfo {
    ...
    @JsonInclude(JsonInclude.Include.NON_NULL)
    @JsonProperty(value = "similiar_type")
    ...
    public RelatedEventInfo withEventName(String eventName) {
    ...
    public RelatedEventInfo withEventClassId(String eventClassId) {
    ...
    public RelatedEventInfo withEventId(String eventId) {
    ...
    public RelatedEventInfo withEventType(Integer eventType) {
    ...
    public RelatedEventInfo withSeverity(String severity) {
    ...
    public RelatedEventInfo withAbstract(String _abstract) {
    ...
    public RelatedEventInfo withEventAbstract(String eventAbstract) {
    ...
    public RelatedEventInfo withSimiliarType(String similiarType) {
    ...
    public RelatedEventInfo withHandleMethod(String handleMethod) {
    ...
    public RelatedEventInfo withHandler(String handler) {
    ...
    public RelatedEventInfo withMemo(String memo) {
        this.memo = memo;
        return this;
    }
    ...
    public RelatedEventInfo withHandleTime(Long handleTime) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        RelatedEventInfo that = (RelatedEventInfo) obj;
        return Objects.equals(this.eventName, that.eventName) && Objects.equals(this.eventClassId, that.eventClassId)
            && Objects.equals(this.eventId, that.eventId) && Objects.equals(this.eventType, that.eventType)
            && Objects.equals(this.severity, that.severity) && Objects.equals(this._abstract, that._abstract)
            && Objects.equals(this.eventAbstract, that.eventAbstract)
            && Objects.equals(this.similiarType, that.similiarType)
            && Objects.equals(this.handleMethod, that.handleMethod) && Objects.equals(this.handler, that.handler)
            && Objects.equals(this.memo, that.memo) && Objects.equals(this.handleTime, that.handleTime);
    }
    ...
    public String toString() {
        ...
        sb.append("class RelatedEventInfo {\n");
        ...
        sb.append("    similiarType: ").append(toIndentedString(similiarType)).append("\n");
