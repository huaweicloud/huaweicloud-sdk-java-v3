...
public class ShowExportTaskRequest {
    ...
    public ShowExportTaskRequest withEnterpriseProjectId(String enterpriseProjectId) {
    ...
    public ShowExportTaskRequest withTaskId(String taskId) {
        this.taskId = taskId;
        return this;
    }
    ...
    @Override
    public int hashCode() {
        return Objects.hash(enterpriseProjectId, taskId);
    }
