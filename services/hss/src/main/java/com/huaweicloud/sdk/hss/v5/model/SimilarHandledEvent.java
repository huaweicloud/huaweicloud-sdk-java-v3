 ...
 * 相似告警历史处置列表
 */
public class SimilarHandledEvent {
    ...
    public SimilarHandledEvent withSimiliarType(String similiarType) {
    ...
    public SimilarHandledEvent withEventClassId(String eventClassId) {
    ...
    public SimilarHandledEvent withEventId(String eventId) {
    ...
    public SimilarHandledEvent withEventType(Integer eventType) {
    ...
    public SimilarHandledEvent withSeverity(String severity) {
    ...
    public SimilarHandledEvent withAbstract(String _abstract) {
    ...
    public SimilarHandledEvent withHandleMethod(String handleMethod) {
    ...
    public SimilarHandledEvent withHandler(String handler) {
    ...
    public SimilarHandledEvent withMemo(String memo) {
        this.memo = memo;
        return this;
    }
    ...
    public SimilarHandledEvent withHandleTime(Long handleTime) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        SimilarHandledEvent that = (SimilarHandledEvent) obj;
        return Objects.equals(this.similiarType, that.similiarType)
            && Objects.equals(this.eventClassId, that.eventClassId) && Objects.equals(this.eventId, that.eventId)
            && Objects.equals(this.eventType, that.eventType) && Objects.equals(this.severity, that.severity)
            && Objects.equals(this._abstract, that._abstract) && Objects.equals(this.handleMethod, that.handleMethod)
            && Objects.equals(this.handler, that.handler) && Objects.equals(this.memo, that.memo)
            && Objects.equals(this.handleTime, that.handleTime);
    }

    @Override
    public int hashCode() {
        return Objects.hash(similiarType,
            eventClassId,
            eventId,
            eventType,
            severity,
    ...
    public String toString() {
        ...
        sb.append("class SimilarHandledEvent {\n");
