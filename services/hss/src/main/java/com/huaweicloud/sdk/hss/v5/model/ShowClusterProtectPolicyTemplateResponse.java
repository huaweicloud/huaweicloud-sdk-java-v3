 ...
 * Response Object
 */
public class ShowClusterProtectPolicyTemplateResponse extends SdkResponse {
    ...
    public ShowClusterProtectPolicyTemplateResponse withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public ShowClusterProtectPolicyTemplateResponse withTemplateName(String templateName) {
    ...
    public ShowClusterProtectPolicyTemplateResponse withTemplateType(String templateType) {
    ...
    public ShowClusterProtectPolicyTemplateResponse withDescription(String description) {
    ...
    public ShowClusterProtectPolicyTemplateResponse withTargetKind(String targetKind) {
    ...
    public ShowClusterProtectPolicyTemplateResponse withTag(String tag) {
        this.tag = tag;
        return this;
    }
    ...
    public ShowClusterProtectPolicyTemplateResponse withLevel(String level) {
        this.level = level;
        return this;
    }
    ...
    public ShowClusterProtectPolicyTemplateResponse withConstraintTemplate(String constraintTemplate) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ShowClusterProtectPolicyTemplateResponse that = (ShowClusterProtectPolicyTemplateResponse) obj;
    ...
    public String toString() {
        ...
        sb.append("class ShowClusterProtectPolicyTemplateResponse {\n");
