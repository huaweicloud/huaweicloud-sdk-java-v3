 ...
 * 用户自定义告警白名单规则
 */
public class EventWhiteRuleListRequestInfo {
    ...
    public EventWhiteRuleListRequestInfo withFieldKey(String fieldKey) {
    ...
    public EventWhiteRuleListRequestInfo withFieldValue(String fieldValue) {
    ...
    public EventWhiteRuleListRequestInfo withJudgeType(String judgeType) {
    ...
    public String toString() {
        ...
        sb.append("class EventWhiteRuleListRequestInfo {\n");
