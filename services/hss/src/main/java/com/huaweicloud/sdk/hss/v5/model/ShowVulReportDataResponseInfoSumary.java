...
public class ShowVulReportDataResponseInfoSumary {
    ...
    public ShowVulReportDataResponseInfoSumary withVulNumUnfixed(Integer vulNumUnfixed) {
    ...
    public ShowVulReportDataResponseInfoSumary withVulNumLinux(Integer vulNumLinux) {
    ...
    public ShowVulReportDataResponseInfoSumary withVulNumWindows(Integer vulNumWindows) {
    ...
    public ShowVulReportDataResponseInfoSumary withVulNumWebCms(Integer vulNumWebCms) {
    ...
    public ShowVulReportDataResponseInfoSumary withVulNumApp(Integer vulNumApp) {
    ...
    public ShowVulReportDataResponseInfoSumary withHostNumRisk(Integer hostNumRisk) {
    ...
    public ShowVulReportDataResponseInfoSumary withHostNumHighRisk(Integer hostNumHighRisk) {
    ...
    public ShowVulReportDataResponseInfoSumary withHostNumMediumRisk(Integer hostNumMediumRisk) {
    ...
    public ShowVulReportDataResponseInfoSumary withHostNumLowRisk(Integer hostNumLowRisk) {
    ...
    public ShowVulReportDataResponseInfoSumary withAffectAssetNumImportant(Integer affectAssetNumImportant) {
    ...
    public ShowVulReportDataResponseInfoSumary withAffectAssetNumCommon(Integer affectAssetNumCommon) {
    ...
    public ShowVulReportDataResponseInfoSumary withAffectAssetNumTest(Integer affectAssetNumTest) {
