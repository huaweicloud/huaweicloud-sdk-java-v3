 ...
 * 事件类型数量统计
 */
public class EventTopRiskResponseInfo {
    ...
    public EventTopRiskResponseInfo withEventClassId(String eventClassId) {
    ...
    public EventTopRiskResponseInfo withEventNum(Integer eventNum) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        EventTopRiskResponseInfo that = (EventTopRiskResponseInfo) obj;
        return Objects.equals(this.eventClassId, that.eventClassId) && Objects.equals(this.eventNum, that.eventNum);
    }

    @Override
    public int hashCode() {
        return Objects.hash(eventClassId, eventNum);
    }

    @Override
    public String toString() {
        StringBuilder sb = new StringBuilder();
        sb.append("class EventTopRiskResponseInfo {\n");
