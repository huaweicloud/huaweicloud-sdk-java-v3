...
public class ShowBackupPolicyInfoResponse extends SdkResponse {
    ...
    public ShowBackupPolicyInfoResponse withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public ShowBackupPolicyInfoResponse withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public ShowBackupPolicyInfoResponse withOperationType(String operationType) {
    ...
    public ShowBackupPolicyInfoResponse withOperationDefinition(OperationDefinitionInfo operationDefinition) {
        this.operationDefinition = operationDefinition;
        return this;
    }

    public ShowBackupPolicyInfoResponse withOperationDefinition(
    ...
    public ShowBackupPolicyInfoResponse withTrigger(BackupTriggerInfo trigger) {
        this.trigger = trigger;
        return this;
    }

    public ShowBackupPolicyInfoResponse withTrigger(Consumer<BackupTriggerInfo> triggerSetter) {
