 ...
 * 配置检测检查项的检测用例信息
 */
public class ImageCheckRuleCheckCaseResponseInfo {
    ...
    public ImageCheckRuleCheckCaseResponseInfo withCheckDescription(String checkDescription) {
    ...
    public ImageCheckRuleCheckCaseResponseInfo withCurrentValue(String currentValue) {
    ...
    public ImageCheckRuleCheckCaseResponseInfo withSuggestValue(String suggestValue) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ImageCheckRuleCheckCaseResponseInfo that = (ImageCheckRuleCheckCaseResponseInfo) obj;
    ...
    public String toString() {
        ...
        sb.append("class ImageCheckRuleCheckCaseResponseInfo {\n");
