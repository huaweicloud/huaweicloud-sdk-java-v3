...
public class AddProtectionPolicyRequest {
    ...
    public AddProtectionPolicyRequest withBody(Consumer<AddProtectionPolicyInfoRequestInfo> bodySetter) {
        if (this.body == null) {
            this.body = new AddProtectionPolicyInfoRequestInfo();
     ...
     * @return body
     */
    public AddProtectionPolicyInfoRequestInfo getBody() {
        return body;
    }

    public void setBody(AddProtectionPolicyInfoRequestInfo body) {
        this.body = body;
    }
