...
public class ListHostGroupsRequest {
    ...
    public ListHostGroupsRequest withRegion(String region) {
        this.region = region;
        return this;
    }
    ...
    public ListHostGroupsRequest withEnterpriseProjectId(String enterpriseProjectId) {
    ...
    public ListHostGroupsRequest withGroupName(String groupName) {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(region, enterpriseProjectId, offset, limit, groupName);
    }
