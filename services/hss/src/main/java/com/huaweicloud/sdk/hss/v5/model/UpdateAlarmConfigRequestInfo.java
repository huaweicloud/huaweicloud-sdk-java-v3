 ...
 * alarm config
 */
public class UpdateAlarmConfigRequestInfo {
    ...
    public UpdateAlarmConfigRequestInfo withAlarmType(AlarmTypeEnum alarmType) {
    ...
    public UpdateAlarmConfigRequestInfo withDisplayName(String displayName) {
    ...
    public UpdateAlarmConfigRequestInfo withTopicUrn(String topicUrn) {
    ...
    public UpdateAlarmConfigRequestInfo withDailyAlarm(Boolean dailyAlarm) {
    ...
    public UpdateAlarmConfigRequestInfo withRealtimeAlarm(Boolean realtimeAlarm) {
    ...
    public UpdateAlarmConfigRequestInfo withAlarmLevel(AlarmLevelEnum alarmLevel) {
    ...
    public UpdateAlarmConfigRequestInfo withIgnoredEventClassList(
        List<IgnoredEventClassListEnum> ignoredEventClassList) {
        this.ignoredEventClassList = ignoredEventClassList;
        return this;
    }

    public UpdateAlarmConfigRequestInfo addIgnoredEventClassListItem(
        IgnoredEventClassListEnum ignoredEventClassListItem) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        UpdateAlarmConfigRequestInfo that = (UpdateAlarmConfigRequestInfo) obj;
    ...
    public String toString() {
        ...
        sb.append("class UpdateAlarmConfigRequestInfo {\n");
