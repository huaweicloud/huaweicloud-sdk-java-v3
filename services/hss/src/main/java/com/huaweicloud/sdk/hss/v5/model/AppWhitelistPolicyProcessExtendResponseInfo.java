 ...
 * 策略识别进程信息
 */
public class AppWhitelistPolicyProcessExtendResponseInfo {
    ...
    public AppWhitelistPolicyProcessExtendResponseInfo withProcessName(String processName) {
    ...
    public AppWhitelistPolicyProcessExtendResponseInfo withProcessPath(String processPath) {
    ...
    public AppWhitelistPolicyProcessExtendResponseInfo withProcessHash(String processHash) {
    ...
    public AppWhitelistPolicyProcessExtendResponseInfo withContainerId(String containerId) {
    ...
    public AppWhitelistPolicyProcessExtendResponseInfo withCmdline(String cmdline) {
    ...
    public AppWhitelistPolicyProcessExtendResponseInfo withFileSize(Long fileSize) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        AppWhitelistPolicyProcessExtendResponseInfo that = (AppWhitelistPolicyProcessExtendResponseInfo) obj;
    ...
    public String toString() {
        ...
        sb.append("class AppWhitelistPolicyProcessExtendResponseInfo {\n");
