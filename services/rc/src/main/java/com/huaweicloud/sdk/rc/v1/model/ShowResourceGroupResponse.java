...
public class ShowResourceGroupResponse extends SdkResponse {
    ...
    public ShowResourceGroupResponse withDomainId(String domainId) {
    ...
    public ShowResourceGroupResponse withDescription(String description) {
    ...
    public ShowResourceGroupResponse withCreateTime(String createTime) {
    ...
    public ShowResourceGroupResponse withUpdateTime(String updateTime) {
