 ...
 * Request Object
 */
public class ExecutePublicScriptRequest {
    ...
    public ExecutePublicScriptRequest withScriptUuid(String scriptUuid) {
    ...
    public ExecutePublicScriptRequest withXLanguage(String xLanguage) {
    ...
    public ExecutePublicScriptRequest withXProjectId(String xProjectId) {
    ...
    public ExecutePublicScriptRequest withXUserProfile(String xUserProfile) {
    ...
    public ExecutePublicScriptRequest withBody(ScriptExecuteModel body) {
        this.body = body;
        return this;
    }

    public ExecutePublicScriptRequest withBody(Consumer<ScriptExecuteModel> bodySetter) {
        if (this.body == null) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ExecutePublicScriptRequest that = (ExecutePublicScriptRequest) obj;
    ...
    public String toString() {
        ...
        sb.append("class ExecutePublicScriptRequest {\n");
