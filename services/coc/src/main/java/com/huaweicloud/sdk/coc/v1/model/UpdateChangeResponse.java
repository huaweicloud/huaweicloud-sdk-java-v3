 ...
 * Response Object
 */
public class UpdateChangeResponse extends SdkResponse {
    ...
    public UpdateChangeResponse withErrorCode(String errorCode) {
    ...
    public UpdateChangeResponse withErrorMsg(String errorMsg) {
    ...
    public String toString() {
        ...
        sb.append("class UpdateChangeResponse {\n");
