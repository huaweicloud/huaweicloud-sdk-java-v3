...
/**
 * CocUpdateChangeRequestBodySubTickets
 */
public class CocUpdateChangeRequestBodySubTickets {
    ...
    public CocUpdateChangeRequestBodySubTickets withTicketId(String ticketId) {
    ...
    public CocUpdateChangeRequestBodySubTickets withChangeResult(String changeResult) {
    ...
    public CocUpdateChangeRequestBodySubTickets withIsVerifiedInChangeTime(Boolean isVerifiedInChangeTime) {
    ...
    public CocUpdateChangeRequestBodySubTickets withVerifiedDocs(String verifiedDocs) {
    ...
    public CocUpdateChangeRequestBodySubTickets withComment(String comment) {
    ...
    public CocUpdateChangeRequestBodySubTickets withChangeFailType(String changeFailType) {
    ...
    public CocUpdateChangeRequestBodySubTickets withRollbackStartTime(Long rollbackStartTime) {
    ...
    public CocUpdateChangeRequestBodySubTickets withRollbackEndTime(Long rollbackEndTime) {
    ...
    public CocUpdateChangeRequestBodySubTickets withIsRollbackSuccess(Boolean isRollbackSuccess) {
    ...
    public CocUpdateChangeRequestBodySubTickets withIsMonitorFound(Boolean isMonitorFound) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        CocUpdateChangeRequestBodySubTickets that = (CocUpdateChangeRequestBodySubTickets) obj;
    ...
    public String toString() {
        ...
        sb.append("class CocUpdateChangeRequestBodySubTickets {\n");
