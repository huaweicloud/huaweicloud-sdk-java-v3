 ...
 * Request Object
 */
public class GetScriptJobInfoRequest {
    ...
    public GetScriptJobInfoRequest withExecuteUuid(String executeUuid) {
    ...
    public GetScriptJobInfoRequest withXLanguage(String xLanguage) {
    ...
    public GetScriptJobInfoRequest withXProjectId(String xProjectId) {
    ...
    public GetScriptJobInfoRequest withXUserProfile(String xUserProfile) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        GetScriptJobInfoRequest that = (GetScriptJobInfoRequest) obj;
    ...
    public String toString() {
        ...
        sb.append("class GetScriptJobInfoRequest {\n");
