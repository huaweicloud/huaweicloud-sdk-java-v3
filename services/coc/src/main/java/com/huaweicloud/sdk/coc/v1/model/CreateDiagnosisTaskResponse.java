...
public class CreateDiagnosisTaskResponse extends SdkResponse {
    ...
    public CreateDiagnosisTaskResponse withErrorCode(String errorCode) {
    ...
    public CreateDiagnosisTaskResponse withErrorMsg(String errorMsg) {
    ...
    public CreateDiagnosisTaskResponse withId(String id) {
        this.id = id;
        return this;
    }
