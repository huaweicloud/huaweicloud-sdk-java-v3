...
public class DeleteScriptRequest {
    ...
    public DeleteScriptRequest withScriptUuid(String scriptUuid) {
    ...
    public DeleteScriptRequest withXLanguage(String xLanguage) {
    ...
    public DeleteScriptRequest withXProjectId(String xProjectId) {
    ...
    public DeleteScriptRequest withXUserProfile(String xUserProfile) {
