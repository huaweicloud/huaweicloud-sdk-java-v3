...
public class DownloadAttachmentResponse extends SdkResponse {
    ...
    public DownloadAttachmentResponse withProviderCode(String providerCode) {
    ...
    public DownloadAttachmentResponse withErrorCode(String errorCode) {
    ...
    public DownloadAttachmentResponse withErrorMsg(String errorMsg) {
