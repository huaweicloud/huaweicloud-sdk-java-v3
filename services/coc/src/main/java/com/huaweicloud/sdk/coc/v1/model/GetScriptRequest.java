...
public class GetScriptRequest {
    ...
    public GetScriptRequest withScriptUuid(String scriptUuid) {
    ...
    public GetScriptRequest withXLanguage(String xLanguage) {
    ...
    public GetScriptRequest withXProjectId(String xProjectId) {
    ...
    public GetScriptRequest withXUserProfile(String xUserProfile) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        GetScriptRequest that = (GetScriptRequest) obj;
    ...
    public String toString() {
        ...
        sb.append("class GetScriptRequest {\n");
