...
public class ListIncidentsResponse extends SdkResponse {
    ...
    public ListIncidentsResponse withProviderCode(String providerCode) {
    ...
    public ListIncidentsResponse withErrorCode(String errorCode) {
    ...
    public ListIncidentsResponse withErrorMsg(String errorMsg) {
    ...
    public ListIncidentsResponse withData(Object data) {
        this.data = data;
        return this;
    }

    public ListIncidentsResponse withData(Consumer<Object> dataSetter) {
        if (this.data == null) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ListIncidentsResponse that = (ListIncidentsResponse) obj;
