...
public class ListScriptsRequest {
    ...
    public ListScriptsRequest withMarker(Long marker) {
        this.marker = marker;
        return this;
    }
    ...
    public ListScriptsRequest withNameLike(String nameLike) {
    ...
    public ListScriptsRequest withCreator(String creator) {
    ...
    public ListScriptsRequest withRiskLevel(RiskLevelEnum riskLevel) {
    ...
    public ListScriptsRequest withType(TypeEnum type) {
        this.type = type;
        return this;
    }
    ...
    public ListScriptsRequest withEnterpriseProjectId(String enterpriseProjectId) {
    ...
    public ListScriptsRequest withXLanguage(String xLanguage) {
    ...
    public ListScriptsRequest withXProjectId(String xProjectId) {
    ...
    public ListScriptsRequest withXUserProfile(String xUserProfile) {
