 ...
 * Response Object
 */
public class CreateReportCustomEventResponse extends SdkResponse {
    ...
    public CreateReportCustomEventResponse withErrorCode(String errorCode) {
    ...
    public CreateReportCustomEventResponse withErrorMsg(String errorMsg) {
    ...
    public String toString() {
        ...
        sb.append("class CreateReportCustomEventResponse {\n");
