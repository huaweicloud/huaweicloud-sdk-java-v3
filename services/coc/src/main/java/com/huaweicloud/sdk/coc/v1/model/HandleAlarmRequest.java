...
public class HandleAlarmRequest {
    ...
    public HandleAlarmRequest withAlarmId(String alarmId) {
    ...
    public HandleAlarmRequest withBody(AutoHandlerAlarmRequestBody body) {
        this.body = body;
        return this;
    }

    public HandleAlarmRequest withBody(Consumer<AutoHandlerAlarmRequestBody> bodySetter) {
        if (this.body == null) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        HandleAlarmRequest that = (HandleAlarmRequest) obj;
    ...
    public String toString() {
        ...
        sb.append("class HandleAlarmRequest {\n");
