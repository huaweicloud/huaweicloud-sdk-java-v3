...
public class ScheduleInstance {
    ...
    private List<ScheduleInstance> subTargetInstances = null;

    public ScheduleInstance withTargetSelection(TargetSelectionEnum targetSelection) {
    ...
    public ScheduleInstance withTargetResource(TargetResource targetResource) {
        this.targetResource = targetResource;
        return this;
    }

    public ScheduleInstance withTargetResource(Consumer<TargetResource> targetResourceSetter) {
        if (this.targetResource == null) {
            this.targetResource = new TargetResource();
    ...
    public ScheduleInstance withTargetInstances(String targetInstances) {
    ...
    public ScheduleInstance withOrderNo(Integer orderNo) {
    ...
    public ScheduleInstance withBatchStrategy(BatchStrategyEnum batchStrategy) {
    ...
    public ScheduleInstance withSubTargetInstances(List<ScheduleInstance> subTargetInstances) {
        this.subTargetInstances = subTargetInstances;
        return this;
    }

    public ScheduleInstance addSubTargetInstancesItem(ScheduleInstance subTargetInstancesItem) {
    ...
    public ScheduleInstance withSubTargetInstances(Consumer<List<ScheduleInstance>> subTargetInstancesSetter) {
        if (this.subTargetInstances == null) {
            this.subTargetInstances = new ArrayList<>();
        }
     ...
     */
    public List<ScheduleInstance> getSubTargetInstances() {
        return subTargetInstances;
    }

    public void setSubTargetInstances(List<ScheduleInstance> subTargetInstances) {
        this.subTargetInstances = subTargetInstances;
    }
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ScheduleInstance that = (ScheduleInstance) obj;
    ...
    public int hashCode() {
        return Objects
            .hash(targetSelection, targetResource, targetInstances, orderNo, batchStrategy, subTargetInstances);
    }
