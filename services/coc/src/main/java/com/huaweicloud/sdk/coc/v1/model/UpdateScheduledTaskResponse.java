 ...
 * Response Object
 */
public class UpdateScheduledTaskResponse extends SdkResponse {
    ...
    public UpdateScheduledTaskResponse withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public UpdateScheduledTaskResponse withEnterpriseProjectId(String enterpriseProjectId) {
    ...
    public UpdateScheduledTaskResponse withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public UpdateScheduledTaskResponse withAgencyName(String agencyName) {
    ...
    public UpdateScheduledTaskResponse withTriggerTime(TriggerTime triggerTime) {
        this.triggerTime = triggerTime;
        return this;
    }

    public UpdateScheduledTaskResponse withTriggerTime(Consumer<TriggerTime> triggerTimeSetter) {
    ...
    public UpdateScheduledTaskResponse withVersionNo(String versionNo) {
    ...
    public UpdateScheduledTaskResponse withTaskType(Object taskType) {
    ...
    public UpdateScheduledTaskResponse withAssociatedTaskId(String associatedTaskId) {
    ...
    public UpdateScheduledTaskResponse withAssociatedTaskName(String associatedTaskName) {
    ...
    public UpdateScheduledTaskResponse withAssociatedTaskNameEn(String associatedTaskNameEn) {
    ...
    public UpdateScheduledTaskResponse withAssociatedTaskType(String associatedTaskType) {
    ...
    public UpdateScheduledTaskResponse withRunbookInstanceMode(String runbookInstanceMode) {
    ...
    public UpdateScheduledTaskResponse withRiskLevel(String riskLevel) {
    ...
    public UpdateScheduledTaskResponse withInputParam(String inputParam) {
    ...
    public UpdateScheduledTaskResponse withEnableApprove(Boolean enableApprove) {
    ...
    public UpdateScheduledTaskResponse withReviewerNotification(MessageNotification reviewerNotification) {
        this.reviewerNotification = reviewerNotification;
        return this;
    }

    public UpdateScheduledTaskResponse withReviewerNotification(
    ...
    public UpdateScheduledTaskResponse withCreatedUserName(String createdUserName) {
    ...
    public UpdateScheduledTaskResponse withReviewerUserName(String reviewerUserName) {
    ...
    public UpdateScheduledTaskResponse withApproveStatus(Object approveStatus) {
    ...
    public UpdateScheduledTaskResponse withApproveComments(String approveComments) {
    ...
    public UpdateScheduledTaskResponse withTargetInstances(String targetInstances) {
    ...
    public UpdateScheduledTaskResponse withEnableMessageNotification(Boolean enableMessageNotification) {
    ...
    public UpdateScheduledTaskResponse withMessageNotification(MessageNotification messageNotification) {
        this.messageNotification = messageNotification;
        return this;
    }

    public UpdateScheduledTaskResponse withMessageNotification(
        Consumer<MessageNotification> messageNotificationSetter) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        UpdateScheduledTaskResponse that = (UpdateScheduledTaskResponse) obj;
    ...
    public String toString() {
        ...
        sb.append("class UpdateScheduledTaskResponse {\n");
