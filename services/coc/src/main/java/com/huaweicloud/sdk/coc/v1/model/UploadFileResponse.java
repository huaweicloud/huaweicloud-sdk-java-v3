...
public class UploadFileResponse {
    ...
    public UploadFileResponse withCode(String code) {
        this.code = code;
        return this;
    }
    ...
    public UploadFileResponse withProviderCode(String providerCode) {
    ...
    public UploadFileResponse withMsg(String msg) {
        this.msg = msg;
        return this;
    }
    ...
    public UploadFileResponse withData(ExternalAttachment data) {
        this.data = data;
        return this;
    }

    public UploadFileResponse withData(Consumer<ExternalAttachment> dataSetter) {
        if (this.data == null) {
