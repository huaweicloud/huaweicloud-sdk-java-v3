 ...
 * Request Object
 */
public class GetScriptJobStatisticsRequest {
    ...
    public GetScriptJobStatisticsRequest withExecuteUuid(String executeUuid) {
    ...
    public GetScriptJobStatisticsRequest withXLanguage(String xLanguage) {
    ...
    public GetScriptJobStatisticsRequest withXProjectId(String xProjectId) {
    ...
    public GetScriptJobStatisticsRequest withXUserProfile(String xUserProfile) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        GetScriptJobStatisticsRequest that = (GetScriptJobStatisticsRequest) obj;
    ...
    public String toString() {
        ...
        sb.append("class GetScriptJobStatisticsRequest {\n");
