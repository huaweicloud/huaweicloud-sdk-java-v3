...
public class UpdateGaussMySqlInstanceAliasRequest  {
    ...
    public UpdateGaussMySqlInstanceAliasRequest withXLanguage(String xLanguage) {
     ...
     * @return body
     */
    public ModifyAliasRequest getBody() {
        return body;
    }

    public void setBody(ModifyAliasRequest body) {
        this.body = body;
    }
    ...
    public String toString() {
        ...
        sb.append("class UpdateGaussMySqlInstanceAliasRequest {\n");
