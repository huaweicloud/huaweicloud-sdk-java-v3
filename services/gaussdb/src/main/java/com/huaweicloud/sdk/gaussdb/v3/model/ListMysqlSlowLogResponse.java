 ...
 * Response Object
 */
public class ListMysqlSlowLogResponse extends SdkResponse {
    ...
    public ListMysqlSlowLogResponse withSlowLogList(List<MysqlSlowLogList> slowLogList) {
        this.slowLogList = slowLogList;
        return this;
    }

    
    public ListMysqlSlowLogResponse addSlowLogListItem(MysqlSlowLogList slowLogListItem) {
    ...
    public ListMysqlSlowLogResponse withSlowLogList(Consumer<List<MysqlSlowLogList>> slowLogListSetter) {
        if(this.slowLogList == null) {
            this.slowLogList = new ArrayList<>();
        }
    ...
    public ListMysqlSlowLogResponse withLongQueryTime(String longQueryTime) {
    ...
    public ListMysqlSlowLogResponse withTotalRecord(Integer totalRecord) {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ListMysqlSlowLogResponse listMysqlSlowLogResponse = (ListMysqlSlowLogResponse) o;
        return Objects.equals(this.slowLogList, listMysqlSlowLogResponse.slowLogList) &&
            Objects.equals(this.longQueryTime, listMysqlSlowLogResponse.longQueryTime) &&
            Objects.equals(this.totalRecord, listMysqlSlowLogResponse.totalRecord);
    }
    @Override
    public int hashCode() {
    ...
    public String toString() {
        ...
        sb.append("class ListMysqlSlowLogResponse {\n");
