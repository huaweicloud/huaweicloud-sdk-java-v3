 ...
 * Response Object
 */
public class ShowMysqlProxyFlavorsResponse extends SdkResponse {
    ...
    public ShowMysqlProxyFlavorsResponse withProxyFlavorGroups(List<MysqlProxyFlavorGroups> proxyFlavorGroups) {
        this.proxyFlavorGroups = proxyFlavorGroups;
        return this;
    }

    
    public ShowMysqlProxyFlavorsResponse addProxyFlavorGroupsItem(MysqlProxyFlavorGroups proxyFlavorGroupsItem) {
    ...
    public ShowMysqlProxyFlavorsResponse withProxyFlavorGroups(Consumer<List<MysqlProxyFlavorGroups>> proxyFlavorGroupsSetter) {
        if(this.proxyFlavorGroups == null) {
            this.proxyFlavorGroups = new ArrayList<>();
        }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ShowMysqlProxyFlavorsResponse showMysqlProxyFlavorsResponse = (ShowMysqlProxyFlavorsResponse) o;
        return Objects.equals(this.proxyFlavorGroups, showMysqlProxyFlavorsResponse.proxyFlavorGroups);
    }
    @Override
    public int hashCode() {
    ...
    public String toString() {
        ...
        sb.append("class ShowMysqlProxyFlavorsResponse {\n");
