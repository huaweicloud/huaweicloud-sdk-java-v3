...
public class ModifyAutoExpandPolicyReq {
    ...
    public ModifyAutoExpandPolicyReq withSwitchOption(Boolean switchOption) {
    ...
    public ModifyAutoExpandPolicyReq withLimitSize(Integer limitSize) {
    ...
    public ModifyAutoExpandPolicyReq withTriggerAvailablePercent(TriggerAvailablePercentEnum triggerAvailablePercent) {
    ...
    public ModifyAutoExpandPolicyReq withStepPercent(Integer stepPercent) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ModifyAutoExpandPolicyReq that = (ModifyAutoExpandPolicyReq) obj;
