...
public class ListGaussMySqlInstancesUnifyStatusRequest {
    ...
    public ListGaussMySqlInstancesUnifyStatusRequest withXLanguage(String xLanguage) {
    ...
    public ListGaussMySqlInstancesUnifyStatusRequest withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public ListGaussMySqlInstancesUnifyStatusRequest withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public ListGaussMySqlInstancesUnifyStatusRequest withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public ListGaussMySqlInstancesUnifyStatusRequest withDatastoreType(String datastoreType) {
    ...
    public ListGaussMySqlInstancesUnifyStatusRequest withVpcId(String vpcId) {
        this.vpcId = vpcId;
        return this;
    }
    ...
    public ListGaussMySqlInstancesUnifyStatusRequest withSubnetId(String subnetId) {
    ...
    public ListGaussMySqlInstancesUnifyStatusRequest withPrivateIp(String privateIp) {
    ...
    public ListGaussMySqlInstancesUnifyStatusRequest withReadonlyPrivateIp(String readonlyPrivateIp) {
    ...
    public ListGaussMySqlInstancesUnifyStatusRequest withProxyIp(String proxyIp) {
    ...
    public ListGaussMySqlInstancesUnifyStatusRequest withOffset(Integer offset) {
        this.offset = offset;
        return this;
    }
    ...
    public ListGaussMySqlInstancesUnifyStatusRequest withLimit(Integer limit) {
        this.limit = limit;
        return this;
    }
    ...
    public ListGaussMySqlInstancesUnifyStatusRequest withTags(String tags) {
        this.tags = tags;
        return this;
    }
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ListGaussMySqlInstancesUnifyStatusRequest that = (ListGaussMySqlInstancesUnifyStatusRequest) obj;
