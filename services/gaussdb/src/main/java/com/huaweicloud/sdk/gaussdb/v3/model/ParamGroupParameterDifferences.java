 ...
 */
public class ParamGroupParameterDifferences {
    ...
    public ParamGroupParameterDifferences withParameterName(String parameterName) {
    ...
    public ParamGroupParameterDifferences withSourceValue(String sourceValue) {
    ...
    public ParamGroupParameterDifferences withTargetValue(String targetValue) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ParamGroupParameterDifferences that = (ParamGroupParameterDifferences) obj;
    ...
    public String toString() {
        ...
        sb.append("class ParamGroupParameterDifferences {\n");
