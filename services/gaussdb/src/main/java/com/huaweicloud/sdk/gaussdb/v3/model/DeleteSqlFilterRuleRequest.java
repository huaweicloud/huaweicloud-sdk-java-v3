...
public class DeleteSqlFilterRuleRequest  {
    ...
    public DeleteSqlFilterRuleRequest withXLanguage(String xLanguage) {
     ...
     * @return body
     */
    public DeleteSqlFilterRuleReq getBody() {
        return body;
    }

    public void setBody(DeleteSqlFilterRuleReq body) {
        this.body = body;
    }
    ...
    public String toString() {
        ...
        sb.append("class DeleteSqlFilterRuleRequest {\n");
