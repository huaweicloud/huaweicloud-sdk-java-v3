...
public class ServerlessScalingPolicy {
    ...
    public ServerlessScalingPolicy withEnlargeStepSize(String enlargeStepSize) {
    ...
    public ServerlessScalingPolicy withCustomScalingConfig(CustomScalingConfig customScalingConfig) {
        this.customScalingConfig = customScalingConfig;
        return this;
    }

    public ServerlessScalingPolicy withCustomScalingConfig(Consumer<CustomScalingConfig> customScalingConfigSetter) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ServerlessScalingPolicy that = (ServerlessScalingPolicy) obj;
