...
public class SetGaussMySqlQuotasResponse extends SdkResponse {
    ...
    public SetGaussMySqlQuotasResponse withQuotaList(List<SetQuota> quotaList) {
        this.quotaList = quotaList;
        return this;
    }

    
    public SetGaussMySqlQuotasResponse addQuotaListItem(SetQuota quotaListItem) {
    ...
    public SetGaussMySqlQuotasResponse withQuotaList(Consumer<List<SetQuota>> quotaListSetter) {
        if(this.quotaList == null) {
            this.quotaList = new ArrayList<>();
        }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        SetGaussMySqlQuotasResponse setGaussMySqlQuotasResponse = (SetGaussMySqlQuotasResponse) o;
        return Objects.equals(this.quotaList, setGaussMySqlQuotasResponse.quotaList);
    }
    @Override
    public int hashCode() {
    ...
    public String toString() {
        ...
        sb.append("class SetGaussMySqlQuotasResponse {\n");
