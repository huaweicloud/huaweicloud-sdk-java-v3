...
public class UpdateInstanceNameRequest {
    ...
    private ModifiyInstanceNameRequest body;

    public UpdateInstanceNameRequest withXLanguage(XLanguageEnum xLanguage) {
    ...
    public UpdateInstanceNameRequest withBody(ModifiyInstanceNameRequest body) {
        this.body = body;
        return this;
    }

    public UpdateInstanceNameRequest withBody(Consumer<ModifiyInstanceNameRequest> bodySetter) {
        if (this.body == null) {
            this.body = new ModifiyInstanceNameRequest();
     ...
     * @return body
     */
    public ModifiyInstanceNameRequest getBody() {
        return body;
    }

    public void setBody(ModifiyInstanceNameRequest body) {
        this.body = body;
    }
