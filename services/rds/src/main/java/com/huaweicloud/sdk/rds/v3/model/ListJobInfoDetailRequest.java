...
public class ListJobInfoDetailRequest {
    ...
    public ListJobInfoDetailRequest withXLanguage(String xLanguage) {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(xLanguage, instanceId, startTime, endTime);
    }

    @Override
    public String toString() {
        StringBuilder sb = new StringBuilder();
        sb.append("class ListJobInfoDetailRequest {\n");
