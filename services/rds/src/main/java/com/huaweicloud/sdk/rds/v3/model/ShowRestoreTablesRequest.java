...
public class ShowRestoreTablesRequest {
    ...
    private ShowRestoreTablesRequestBody body;
    ...
    public ShowRestoreTablesRequest withBody(ShowRestoreTablesRequestBody body) {
        this.body = body;
        return this;
    }

    public ShowRestoreTablesRequest withBody(Consumer<ShowRestoreTablesRequestBody> bodySetter) {
        if (this.body == null) {
            this.body = new ShowRestoreTablesRequestBody();
     ...
     * @return body
     */
    public ShowRestoreTablesRequestBody getBody() {
        return body;
    }

    public void setBody(ShowRestoreTablesRequestBody body) {
        this.body = body;
    }
