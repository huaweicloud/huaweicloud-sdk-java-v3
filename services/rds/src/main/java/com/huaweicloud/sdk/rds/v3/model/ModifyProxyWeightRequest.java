...
import com.huaweicloud.sdk.rds.v3.model.ProxyReadonlyInstances;
...
public class ModifyProxyWeightRequest  {
    ...
    public ModifyProxyWeightRequest withReadonlyInstances(Consumer<List<ProxyReadonlyInstances>> readonlyInstancesSetter) {
