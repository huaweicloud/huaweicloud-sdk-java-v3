...
public class ListHistorySessionsRequest {
    ...
    public ListHistorySessionsRequest withInstanceId(String instanceId) {
    ...
    public ListHistorySessionsRequest withPid(String pid) {
        this.pid = pid;
        return this;
    }
    ...
    public ListHistorySessionsRequest withUserName(String userName) {
    ...
    public ListHistorySessionsRequest withDatabaseName(String databaseName) {
    ...
    public ListHistorySessionsRequest withStartTime(Long startTime) {
    ...
    public ListHistorySessionsRequest withEndTime(Long endTime) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        return Objects.equals(this.instanceId, that.instanceId) && Objects.equals(this.pid, that.pid)
            && Objects.equals(this.xLanguage, that.xLanguage) && Objects.equals(this.userName, that.userName)
    ...
    @Override
    public int hashCode() {
        return Objects.hash(instanceId, pid, xLanguage, userName, databaseName, startTime, endTime, offset, limit);
    }
