...
public class UsedJobSchedule {
    ...
    public UsedJobSchedule withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public UsedJobSchedule withJobScheduleType(String jobScheduleType) {
    ...
    public UsedJobSchedule withOneTimeOccurrence(JobScheduleOneTimeOccurrenceInfo oneTimeOccurrence) {
        this.oneTimeOccurrence = oneTimeOccurrence;
        return this;
    }

    public UsedJobSchedule withOneTimeOccurrence(Consumer<JobScheduleOneTimeOccurrenceInfo> oneTimeOccurrenceSetter) {
    ...
    public UsedJobSchedule withFrequency(JobScheduleFrequencyInfo frequency) {
        this.frequency = frequency;
        return this;
    }

    public UsedJobSchedule withFrequency(Consumer<JobScheduleFrequencyInfo> frequencySetter) {
    ...
    public UsedJobSchedule withDailyFrequency(JobScheduleDailyFrequencyInfo dailyFrequency) {
        this.dailyFrequency = dailyFrequency;
        return this;
    }

    public UsedJobSchedule withDailyFrequency(Consumer<JobScheduleDailyFrequencyInfo> dailyFrequencySetter) {
    ...
    public UsedJobSchedule withDuration(JobScheduleDurationInfo duration) {
        this.duration = duration;
        return this;
    }

    public UsedJobSchedule withDuration(Consumer<JobScheduleDurationInfo> durationSetter) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        UsedJobSchedule that = (UsedJobSchedule) obj;
