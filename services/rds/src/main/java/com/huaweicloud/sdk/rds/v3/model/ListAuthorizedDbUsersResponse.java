 ...
 * Response Object
 */
public class ListAuthorizedDbUsersResponse extends SdkResponse {
    ...
    public ListAuthorizedDbUsersResponse withUsers(List<UserWithPrivilege> users) {
        this.users = users;
        return this;
    }
    ...
    public ListAuthorizedDbUsersResponse withTotalCount(Integer totalCount) {
