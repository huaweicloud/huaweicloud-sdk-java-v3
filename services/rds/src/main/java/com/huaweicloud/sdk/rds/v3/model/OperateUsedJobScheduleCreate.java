 ...
 * 策略信息。
 */
public class OperateUsedJobScheduleCreate {
    ...
    public OperateUsedJobScheduleCreate withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public OperateUsedJobScheduleCreate withJobScheduleType(String jobScheduleType) {
    ...
    public OperateUsedJobScheduleCreate withOneTimeOccurrence(JobScheduleOneTimeOccurrenceInfo oneTimeOccurrence) {
        this.oneTimeOccurrence = oneTimeOccurrence;
        return this;
    }

    public OperateUsedJobScheduleCreate withOneTimeOccurrence(
    ...
    public OperateUsedJobScheduleCreate withFrequency(JobScheduleFrequencyInfo frequency) {
        this.frequency = frequency;
        return this;
    }

    public OperateUsedJobScheduleCreate withFrequency(Consumer<JobScheduleFrequencyInfo> frequencySetter) {
    ...
    public OperateUsedJobScheduleCreate withDailyFrequency(JobScheduleDailyFrequencyInfo dailyFrequency) {
        this.dailyFrequency = dailyFrequency;
        return this;
    }

    public OperateUsedJobScheduleCreate withDailyFrequency(
    ...
    public OperateUsedJobScheduleCreate withDuration(JobScheduleDurationInfo duration) {
        this.duration = duration;
        return this;
    }

    public OperateUsedJobScheduleCreate withDuration(Consumer<JobScheduleDurationInfo> durationSetter) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        OperateUsedJobScheduleCreate that = (OperateUsedJobScheduleCreate) obj;
    ...
    public String toString() {
        ...
        sb.append("class OperateUsedJobScheduleCreate {\n");
