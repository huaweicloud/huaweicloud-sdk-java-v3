 ...
 * Request Object
 */
public class SetSensitiveSlowLogRequest {
    ...
    public SetSensitiveSlowLogRequest withXLanguage(String xLanguage) {
    ...
    public SetSensitiveSlowLogRequest withInstanceId(String instanceId) {
    ...
    public SetSensitiveSlowLogRequest withStatus(String status) {
        this.status = status;
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append("class SetSensitiveSlowLogRequest {\n");
