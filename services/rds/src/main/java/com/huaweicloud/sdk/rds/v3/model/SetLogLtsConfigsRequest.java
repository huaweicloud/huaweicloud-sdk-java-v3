...
public class SetLogLtsConfigsRequest {
    ...
    private AddLogConfigResponseBody body;

    public SetLogLtsConfigsRequest withEngine(EngineEnum engine) {
        this.engine = engine;
        return this;
    }
    ...
    public SetLogLtsConfigsRequest withXLanguage(XLanguageEnum xLanguage) {
    ...
    public SetLogLtsConfigsRequest withBody(AddLogConfigResponseBody body) {
        this.body = body;
        return this;
    }

    public SetLogLtsConfigsRequest withBody(Consumer<AddLogConfigResponseBody> bodySetter) {
        if (this.body == null) {
            this.body = new AddLogConfigResponseBody();
     ...
     * @return body
     */
    public AddLogConfigResponseBody getBody() {
        return body;
    }

    public void setBody(AddLogConfigResponseBody body) {
        this.body = body;
    }
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        SetLogLtsConfigsRequest that = (SetLogLtsConfigsRequest) obj;
    ...
    public String toString() {
        ...
        sb.append("class SetLogLtsConfigsRequest {\n");
