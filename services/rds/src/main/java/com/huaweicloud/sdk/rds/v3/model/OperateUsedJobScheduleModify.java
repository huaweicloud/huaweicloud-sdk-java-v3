 ...
 * 策略信息。
 */
public class OperateUsedJobScheduleModify {
    ...
    public OperateUsedJobScheduleModify withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public OperateUsedJobScheduleModify withJobScheduleType(String jobScheduleType) {
    ...
    public OperateUsedJobScheduleModify withScheduleType(String scheduleType) {
    ...
    public OperateUsedJobScheduleModify withUserDefined(Boolean userDefined) {
    ...
    public OperateUsedJobScheduleModify withOneTimeOccurrence(JobScheduleOneTimeOccurrenceInfo oneTimeOccurrence) {
        this.oneTimeOccurrence = oneTimeOccurrence;
        return this;
    }

    public OperateUsedJobScheduleModify withOneTimeOccurrence(
    ...
    public OperateUsedJobScheduleModify withFrequency(JobScheduleFrequencyInfo frequency) {
        this.frequency = frequency;
        return this;
    }

    public OperateUsedJobScheduleModify withFrequency(Consumer<JobScheduleFrequencyInfo> frequencySetter) {
    ...
    public OperateUsedJobScheduleModify withDailyFrequency(JobScheduleDailyFrequencyInfo dailyFrequency) {
        this.dailyFrequency = dailyFrequency;
        return this;
    }

    public OperateUsedJobScheduleModify withDailyFrequency(
    ...
    public OperateUsedJobScheduleModify withDuration(JobScheduleDurationInfo duration) {
        this.duration = duration;
        return this;
    }

    public OperateUsedJobScheduleModify withDuration(Consumer<JobScheduleDurationInfo> durationSetter) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        OperateUsedJobScheduleModify that = (OperateUsedJobScheduleModify) obj;
    ...
    public String toString() {
        ...
        sb.append("class OperateUsedJobScheduleModify {\n");
