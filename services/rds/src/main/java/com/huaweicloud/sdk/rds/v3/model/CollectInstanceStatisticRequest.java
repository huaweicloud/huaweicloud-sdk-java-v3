 ...
 * Request Object
 */
public class CollectInstanceStatisticRequest {
    ...
    public CollectInstanceStatisticRequest withXLanguage(String xLanguage) {
    ...
    public CollectInstanceStatisticRequest withEngine(EngineEnum engine) {
        this.engine = engine;
        return this;
    }
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        CollectInstanceStatisticRequest that = (CollectInstanceStatisticRequest) obj;
        return Objects.equals(this.xLanguage, that.xLanguage) && Objects.equals(this.engine, that.engine);
    }

    @Override
    public int hashCode() {
        return Objects.hash(xLanguage, engine);
    }

    @Override
    public String toString() {
        StringBuilder sb = new StringBuilder();
        sb.append("class CollectInstanceStatisticRequest {\n");
