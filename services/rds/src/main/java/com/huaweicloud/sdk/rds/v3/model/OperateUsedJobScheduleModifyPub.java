 ...
 * 策略信息。
 */
public class OperateUsedJobScheduleModifyPub {
    ...
    public OperateUsedJobScheduleModifyPub withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public OperateUsedJobScheduleModifyPub withJobScheduleType(String jobScheduleType) {
    ...
    public OperateUsedJobScheduleModifyPub withOneTimeOccurrence(JobScheduleOneTimeOccurrenceInfo oneTimeOccurrence) {
        this.oneTimeOccurrence = oneTimeOccurrence;
        return this;
    }

    public OperateUsedJobScheduleModifyPub withOneTimeOccurrence(
    ...
    public OperateUsedJobScheduleModifyPub withFrequency(JobScheduleFrequencyInfo frequency) {
        this.frequency = frequency;
        return this;
    }

    public OperateUsedJobScheduleModifyPub withFrequency(Consumer<JobScheduleFrequencyInfo> frequencySetter) {
    ...
    public OperateUsedJobScheduleModifyPub withDailyFrequency(JobScheduleDailyFrequencyInfo dailyFrequency) {
        this.dailyFrequency = dailyFrequency;
        return this;
    }

    public OperateUsedJobScheduleModifyPub withDailyFrequency(
    ...
    public OperateUsedJobScheduleModifyPub withDuration(JobScheduleDurationInfo duration) {
        this.duration = duration;
        return this;
    }

    public OperateUsedJobScheduleModifyPub withDuration(Consumer<JobScheduleDurationInfo> durationSetter) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        OperateUsedJobScheduleModifyPub that = (OperateUsedJobScheduleModifyPub) obj;
    ...
    public String toString() {
        ...
        sb.append("class OperateUsedJobScheduleModifyPub {\n");
