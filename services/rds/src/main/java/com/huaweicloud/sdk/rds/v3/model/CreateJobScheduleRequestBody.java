 ...
 * 创建策略信息。
 */
public class CreateJobScheduleRequestBody {
    ...
    public CreateJobScheduleRequestBody withScheduleType(String scheduleType) {
    ...
    public CreateJobScheduleRequestBody withJobScheduleType(String jobScheduleType) {
    ...
    public CreateJobScheduleRequestBody withOneTimeOccurrence(JobScheduleOneTimeOccurrenceInfo oneTimeOccurrence) {
        this.oneTimeOccurrence = oneTimeOccurrence;
        return this;
    }

    public CreateJobScheduleRequestBody withOneTimeOccurrence(
    ...
    public CreateJobScheduleRequestBody withFrequency(JobScheduleFrequencyInfo frequency) {
        this.frequency = frequency;
        return this;
    }

    public CreateJobScheduleRequestBody withFrequency(Consumer<JobScheduleFrequencyInfo> frequencySetter) {
    ...
    public CreateJobScheduleRequestBody withDailyFrequency(JobScheduleDailyFrequencyInfo dailyFrequency) {
        this.dailyFrequency = dailyFrequency;
        return this;
    }

    public CreateJobScheduleRequestBody withDailyFrequency(
        Consumer<JobScheduleDailyFrequencyInfo> dailyFrequencySetter) {
    ...
    public CreateJobScheduleRequestBody withDuration(JobScheduleDurationInfo duration) {
        this.duration = duration;
        return this;
    }

    public CreateJobScheduleRequestBody withDuration(Consumer<JobScheduleDurationInfo> durationSetter) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        CreateJobScheduleRequestBody that = (CreateJobScheduleRequestBody) obj;
        return Objects.equals(this.scheduleType, that.scheduleType)
    ...
    @Override
    public int hashCode() {
        return Objects.hash(scheduleType, jobScheduleType, oneTimeOccurrence, frequency, dailyFrequency, duration);
    }

    @Override
    public String toString() {
        StringBuilder sb = new StringBuilder();
        sb.append("class CreateJobScheduleRequestBody {\n");
