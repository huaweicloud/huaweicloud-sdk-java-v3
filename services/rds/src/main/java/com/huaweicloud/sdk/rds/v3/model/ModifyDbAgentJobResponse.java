 ...
 * Response Object
 */
public class ModifyDbAgentJobResponse extends SdkResponse {
    ...
    public ModifyDbAgentJobResponse withJobId(String jobId) {
        this.jobId = jobId;
        return this;
    }
    ...
    public ModifyDbAgentJobResponse withJobName(String jobName) {
    ...
    public ModifyDbAgentJobResponse withIsEnabled(Boolean isEnabled) {
    ...
    public ModifyDbAgentJobResponse withRunTime(String runTime) {
    ...
    public ModifyDbAgentJobResponse withRunStatus(String runStatus) {
    ...
    public ModifyDbAgentJobResponse withLastFailureTime(String lastFailureTime) {
    ...
    public ModifyDbAgentJobResponse withFailureCount(Integer failureCount) {
    ...
    public ModifyDbAgentJobResponse withAgentType(String agentType) {
    ...
    public ModifyDbAgentJobResponse withProfileId(String profileId) {
    ...
    public ModifyDbAgentJobResponse withProfileName(String profileName) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ModifyDbAgentJobResponse that = (ModifyDbAgentJobResponse) obj;
    ...
    public String toString() {
        ...
        sb.append("class ModifyDbAgentJobResponse {\n");
