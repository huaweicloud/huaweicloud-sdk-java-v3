 ...
 * 修改策略信息。
 */
public class ModifyJobScheduleRequestBody {
    ...
    public ModifyJobScheduleRequestBody withJobScheduleType(String jobScheduleType) {
    ...
    public ModifyJobScheduleRequestBody withOneTimeOccurrence(JobScheduleOneTimeOccurrenceInfo oneTimeOccurrence) {
        this.oneTimeOccurrence = oneTimeOccurrence;
        return this;
    }

    public ModifyJobScheduleRequestBody withOneTimeOccurrence(
    ...
    public ModifyJobScheduleRequestBody withFrequency(JobScheduleFrequencyInfo frequency) {
        this.frequency = frequency;
        return this;
    }

    public ModifyJobScheduleRequestBody withFrequency(Consumer<JobScheduleFrequencyInfo> frequencySetter) {
    ...
    public ModifyJobScheduleRequestBody withDailyFrequency(JobScheduleDailyFrequencyInfo dailyFrequency) {
        this.dailyFrequency = dailyFrequency;
        return this;
    }

    public ModifyJobScheduleRequestBody withDailyFrequency(
    ...
    public ModifyJobScheduleRequestBody withDuration(JobScheduleDurationInfo duration) {
        this.duration = duration;
        return this;
    }

    public ModifyJobScheduleRequestBody withDuration(Consumer<JobScheduleDurationInfo> durationSetter) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ModifyJobScheduleRequestBody that = (ModifyJobScheduleRequestBody) obj;
        return Objects.equals(this.jobScheduleType, that.jobScheduleType)
    ...
    @Override
    public int hashCode() {
        return Objects.hash(jobScheduleType, oneTimeOccurrence, frequency, dailyFrequency, duration);
    }

    @Override
    public String toString() {
        StringBuilder sb = new StringBuilder();
        sb.append("class ModifyJobScheduleRequestBody {\n");
