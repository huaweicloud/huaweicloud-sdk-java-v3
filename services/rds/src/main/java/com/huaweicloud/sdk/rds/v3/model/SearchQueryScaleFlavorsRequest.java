...
/** Request Object */
public class SearchQueryScaleFlavorsRequest {
    ...
    public SearchQueryScaleFlavorsRequest withXLanguage(String xLanguage) {
    ...
    public SearchQueryScaleFlavorsRequest withInstanceId(String instanceId) {
    ...
    public String toString() {
        ...
        sb.append("class SearchQueryScaleFlavorsRequest {\n");
