...
public class ValidateConnectionUserInfo {
    ...
    public ValidateConnectionUserInfo withServerIp(String serverIp) {
    ...
    public ValidateConnectionUserInfo withServerPort(Integer serverPort) {
    ...
    public ValidateConnectionUserInfo withLoginUserName(String loginUserName) {
    ...
    public ValidateConnectionUserInfo withLoginUserPassword(String loginUserPassword) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ValidateConnectionUserInfo that = (ValidateConnectionUserInfo) obj;
    ...
    @Override
    public int hashCode() {
        return Objects.hash(serverIp, serverPort, loginUserName, loginUserPassword);
    }
