...
public class CopyConfigurationResponse extends SdkResponse {
    ...
    public CopyConfigurationResponse withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public CopyConfigurationResponse withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public CopyConfigurationResponse withDescription(String description) {
    ...
    public CopyConfigurationResponse withDatastoreVersionName(String datastoreVersionName) {
    ...
    public CopyConfigurationResponse withDatastoreName(String datastoreName) {
    ...
    public CopyConfigurationResponse withCreateTime(String createTime) {
    ...
    public CopyConfigurationResponse withUpdateTime(String updateTime) {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, name, description, datastoreVersionName, datastoreName, createTime, updateTime);
    }
