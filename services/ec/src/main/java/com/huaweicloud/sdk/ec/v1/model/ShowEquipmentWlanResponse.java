 ...
 * Response Object
 */
public class ShowEquipmentWlanResponse extends SdkResponse {
    ...
    public ShowEquipmentWlanResponse withSupportWlan(Boolean supportWlan) {
    ...
    public ShowEquipmentWlanResponse withWlanEnabled(Boolean wlanEnabled) {
    ...
    public ShowEquipmentWlanResponse withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public ShowEquipmentWlanResponse withSecurityEnabled(Boolean securityEnabled) {
    ...
    public ShowEquipmentWlanResponse withPassword(String password) {
    ...
    public ShowEquipmentWlanResponse withAuthenticationMethod(AuthenticationMethodEnum authenticationMethod) {
    ...
    public ShowEquipmentWlanResponse withEncrptionMethod(EncrptionMethodEnum encrptionMethod) {
    ...
    public ShowEquipmentWlanResponse withNameHided(Boolean nameHided) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ShowEquipmentWlanResponse that = (ShowEquipmentWlanResponse) obj;
    ...
    public String toString() {
        ...
        sb.append("class ShowEquipmentWlanResponse {\n");
