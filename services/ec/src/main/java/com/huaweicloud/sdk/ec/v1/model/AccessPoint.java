...
public class AccessPoint {
    ...
    public AccessPoint withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public AccessPoint withRegionId(String regionId) {
    ...
    public AccessPoint withBandwidthSize(Integer bandwidthSize) {
    ...
    public AccessPoint withBindIegCount(Integer bindIegCount) {
    ...
    public AccessPoint withUpdatedAt(OffsetDateTime updatedAt) {
