...
public class VrrpConfigItem {
    ...
    public VrrpConfigItem withIegId(String iegId) {
        this.iegId = iegId;
        return this;
    }
    ...
    public VrrpConfigItem withVirtualRouterId(Integer virtualRouterId) {
    ...
    public VrrpConfigItem withVirtualIp(String virtualIp) {
    ...
    public VrrpConfigItem withActiveEquipmentId(String activeEquipmentId) {
    ...
    public VrrpConfigItem withActiveInterfaceName(String activeInterfaceName) {
    ...
    public VrrpConfigItem withStandbyEquipmentId(String standbyEquipmentId) {
    ...
    public VrrpConfigItem withStandbyInterfaceName(String standbyInterfaceName) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        VrrpConfigItem that = (VrrpConfigItem) obj;
    ...
    public String toString() {
        ...
        sb.append("class VrrpConfigItem {\n");
