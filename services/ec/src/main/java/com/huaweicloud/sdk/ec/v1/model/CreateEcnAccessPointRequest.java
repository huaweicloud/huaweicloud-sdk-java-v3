 ...
 * Request Object
 */
public class CreateEcnAccessPointRequest {
    ...
    public CreateEcnAccessPointRequest withEcnId(String ecnId) {
        this.ecnId = ecnId;
        return this;
    }
    ...
    public CreateEcnAccessPointRequest withBody(CreateAccessPointRequestBody body) {
        this.body = body;
        return this;
    }

    public CreateEcnAccessPointRequest withBody(Consumer<CreateAccessPointRequestBody> bodySetter) {
        if (this.body == null) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        CreateEcnAccessPointRequest that = (CreateEcnAccessPointRequest) obj;
    ...
    public String toString() {
        ...
        sb.append("class CreateEcnAccessPointRequest {\n");
