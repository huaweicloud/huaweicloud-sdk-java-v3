 ...
 * Response Object
 */
public class UpdateEquipmentWlanResponse extends SdkResponse {
    ...
    public UpdateEquipmentWlanResponse withSupportWlan(Boolean supportWlan) {
    ...
    public UpdateEquipmentWlanResponse withWlanEnabled(Boolean wlanEnabled) {
    ...
    public UpdateEquipmentWlanResponse withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public UpdateEquipmentWlanResponse withSecurityEnabled(Boolean securityEnabled) {
    ...
    public UpdateEquipmentWlanResponse withPassword(String password) {
    ...
    public UpdateEquipmentWlanResponse withAuthenticationMethod(AuthenticationMethodEnum authenticationMethod) {
    ...
    public UpdateEquipmentWlanResponse withEncrptionMethod(EncrptionMethodEnum encrptionMethod) {
    ...
    public UpdateEquipmentWlanResponse withNameHided(Boolean nameHided) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        UpdateEquipmentWlanResponse that = (UpdateEquipmentWlanResponse) obj;
    ...
    public String toString() {
        ...
        sb.append("class UpdateEquipmentWlanResponse {\n");
