 ...
 * Request Object
 */
public class AddVrrpConfigRequest {
    ...
    public AddVrrpConfigRequest withIegId(String iegId) {
        this.iegId = iegId;
        return this;
    }
    ...
    public AddVrrpConfigRequest withBody(CreateUpdateVrrpConfigRequestBody body) {
        this.body = body;
        return this;
    }

    public AddVrrpConfigRequest withBody(Consumer<CreateUpdateVrrpConfigRequestBody> bodySetter) {
        if (this.body == null) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        AddVrrpConfigRequest that = (AddVrrpConfigRequest) obj;
    ...
    public String toString() {
        ...
        sb.append("class AddVrrpConfigRequest {\n");
