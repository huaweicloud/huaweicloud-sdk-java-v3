...
public class EcnErItem {
    ...
    public EcnErItem withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public EcnErItem withErId(String erId) {
        this.erId = erId;
        return this;
    }
    ...
    public EcnErItem withRegionId(String regionId) {
    ...
    public EcnErItem withStatus(String status) {
        this.status = status;
        return this;
    }
    ...
    public EcnErItem withHealthStatus(HealthStatusEnum healthStatus) {
    ...
    public EcnErItem withCreatedAt(OffsetDateTime createdAt) {
