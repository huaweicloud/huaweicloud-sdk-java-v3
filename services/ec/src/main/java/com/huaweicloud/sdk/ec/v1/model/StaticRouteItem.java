...
public class StaticRouteItem {
    ...
    public StaticRouteItem withPrefix(String prefix) {
        this.prefix = prefix;
        return this;
    }
    ...
    public StaticRouteItem withNextHop(String nextHop) {
    ...
    public StaticRouteItem withInterfaceName(String interfaceName) {
    ...
    public StaticRouteItem withPriority(Integer priority) {
    ...
    public StaticRouteItem withTrackNqa(Boolean trackNqa) {
    ...
    public StaticRouteItem withPostToCloud(Boolean postToCloud) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        StaticRouteItem that = (StaticRouteItem) obj;
    ...
    public String toString() {
        ...
        sb.append("class StaticRouteItem {\n");
