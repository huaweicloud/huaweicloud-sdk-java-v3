 ...
 * Response Object
 */
public class UpdateEquipmentLanConfigResponse extends SdkResponse {
    ...
    public UpdateEquipmentLanConfigResponse withInterfaceName(String interfaceName) {
    ...
    public UpdateEquipmentLanConfigResponse withInterfaceType(InterfaceTypeEnum interfaceType) {
    ...
    public UpdateEquipmentLanConfigResponse withVlanId(Integer vlanId) {
        this.vlanId = vlanId;
        return this;
    }
    ...
    public UpdateEquipmentLanConfigResponse withIpAddress(String ipAddress) {
    ...
    public UpdateEquipmentLanConfigResponse withDhcp(Boolean dhcp) {
        this.dhcp = dhcp;
        return this;
    }
    ...
    public UpdateEquipmentLanConfigResponse withStartIpAddress(String startIpAddress) {
    ...
    public UpdateEquipmentLanConfigResponse withEndIpAddress(String endIpAddress) {
    ...
    public UpdateEquipmentLanConfigResponse withLeaseTime(Integer leaseTime) {
    ...
    public UpdateEquipmentLanConfigResponse withPostToCloud(Boolean postToCloud) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        UpdateEquipmentLanConfigResponse that = (UpdateEquipmentLanConfigResponse) obj;
    ...
    public String toString() {
        ...
        sb.append("class UpdateEquipmentLanConfigResponse {\n");
