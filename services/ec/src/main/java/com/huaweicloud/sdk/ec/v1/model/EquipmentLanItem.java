...
public class EquipmentLanItem {
    ...
    public EquipmentLanItem withInterfaceName(String interfaceName) {
    ...
    public EquipmentLanItem withInterfaceType(InterfaceTypeEnum interfaceType) {
    ...
    public EquipmentLanItem withVlanId(Integer vlanId) {
        this.vlanId = vlanId;
        return this;
    }
    ...
    public EquipmentLanItem withIpAddress(String ipAddress) {
    ...
    public EquipmentLanItem withDhcp(Boolean dhcp) {
        this.dhcp = dhcp;
        return this;
    }
    ...
    public EquipmentLanItem withStartIpAddress(String startIpAddress) {
    ...
    public EquipmentLanItem withEndIpAddress(String endIpAddress) {
    ...
    public EquipmentLanItem withLeaseTime(Integer leaseTime) {
    ...
    public EquipmentLanItem withPostToCloud(Boolean postToCloud) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        EquipmentLanItem that = (EquipmentLanItem) obj;
    ...
    public String toString() {
        ...
        sb.append("class EquipmentLanItem {\n");
