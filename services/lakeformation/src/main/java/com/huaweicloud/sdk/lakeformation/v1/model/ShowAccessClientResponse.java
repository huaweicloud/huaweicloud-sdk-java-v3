...
public class ShowAccessClientResponse extends SdkResponse {
    ...
    public ShowAccessClientResponse withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public ShowAccessClientResponse withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public ShowAccessClientResponse withAccessMode(AccessModeEnum accessMode) {
    ...
    public ShowAccessClientResponse withStatus(StatusEnum status) {
        this.status = status;
        return this;
    }
    ...
    public ShowAccessClientResponse withVpcId(String vpcId) {
        this.vpcId = vpcId;
        return this;
    }
    ...
    public ShowAccessClientResponse withSubnetId(String subnetId) {
    ...
    public ShowAccessClientResponse withAccessConnections(List<AccessConnectionInfo> accessConnections) {
        this.accessConnections = accessConnections;
        return this;
    }

    public ShowAccessClientResponse addAccessConnectionsItem(AccessConnectionInfo accessConnectionsItem) {
    ...
    public ShowAccessClientResponse withAccessConnections(
    ...
    public ShowAccessClientResponse withCreateTime(OffsetDateTime createTime) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ShowAccessClientResponse that = (ShowAccessClientResponse) obj;
