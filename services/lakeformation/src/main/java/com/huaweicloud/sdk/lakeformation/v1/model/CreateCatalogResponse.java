...
public class CreateCatalogResponse extends SdkResponse {
    ...
    public CreateCatalogResponse withOwner(String owner) {
        this.owner = owner;
        return this;
    }
    ...
    public CreateCatalogResponse withOwnerType(OwnerTypeEnum ownerType) {
    ...
    public CreateCatalogResponse withOwnerSource(OwnerSourceEnum ownerSource) {
