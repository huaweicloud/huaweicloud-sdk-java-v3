...
public class ShowDatasetRequest {
    ...
    public ShowDatasetRequest withInstanceId(String instanceId) {
    ...
    public ShowDatasetRequest withCatalogName(String catalogName) {
    ...
    public ShowDatasetRequest withDatasetName(String datasetName) {
    ...
    public ShowDatasetRequest withDatabaseName(String databaseName) {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(instanceId, catalogName, datasetName, databaseName);
    }
