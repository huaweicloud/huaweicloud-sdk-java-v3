 ...
 * Response Object
 */
public class UpdateDatasetResponse extends SdkResponse {
    ...
    public UpdateDatasetResponse withCatalogName(String catalogName) {
    ...
    public UpdateDatasetResponse withCatalogId(String catalogId) {
    ...
    public UpdateDatasetResponse withDatasetName(String datasetName) {
    ...
    public UpdateDatasetResponse withDatasetId(String datasetId) {
    ...
    public UpdateDatasetResponse withDescription(String description) {
    ...
    public UpdateDatasetResponse withDatabaseName(String databaseName) {
    ...
    public UpdateDatasetResponse withDatabaseId(String databaseId) {
    ...
    public UpdateDatasetResponse withStorageType(StorageTypeEnum storageType) {
    ...
    public UpdateDatasetResponse withDatasetFormat(DatasetFileFormat datasetFormat) {
        this.datasetFormat = datasetFormat;
        return this;
    }

    public UpdateDatasetResponse withDatasetFormat(Consumer<DatasetFileFormat> datasetFormatSetter) {
    ...
    public UpdateDatasetResponse withOwner(String owner) {
        this.owner = owner;
        return this;
    }
    ...
    public UpdateDatasetResponse withOwnerType(OwnerTypeEnum ownerType) {
    ...
    public UpdateDatasetResponse withOwnerSource(OwnerSourceEnum ownerSource) {
    ...
    public UpdateDatasetResponse withLocation(String location) {
    ...
    public UpdateDatasetResponse withProperties(Map<String, String> properties) {
        this.properties = properties;
        return this;
    }

    public UpdateDatasetResponse putPropertiesItem(String key, String propertiesItem) {
    ...
    public UpdateDatasetResponse withProperties(Consumer<Map<String, String>> propertiesSetter) {
        if (this.properties == null) {
            this.properties = new HashMap<>();
        }
    ...
    public UpdateDatasetResponse withCreateTime(OffsetDateTime createTime) {
    ...
    public UpdateDatasetResponse withUpdateTime(OffsetDateTime updateTime) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        UpdateDatasetResponse that = (UpdateDatasetResponse) obj;
