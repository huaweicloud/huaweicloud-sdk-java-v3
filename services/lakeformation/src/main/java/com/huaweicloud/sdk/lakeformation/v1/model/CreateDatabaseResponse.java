...
public class CreateDatabaseResponse extends SdkResponse {
    ...
    public CreateDatabaseResponse withCatalogName(String catalogName) {
    ...
    public CreateDatabaseResponse withDatabaseName(String databaseName) {
    ...
    public CreateDatabaseResponse withOwner(String owner) {
        this.owner = owner;
        return this;
    }
    ...
    public CreateDatabaseResponse withOwnerType(OwnerTypeEnum ownerType) {
    ...
    public CreateDatabaseResponse withLocation(String location) {
    ...
    public CreateDatabaseResponse withParameters(Map<String, String> parameters) {
        this.parameters = parameters;
        return this;
    }

    public CreateDatabaseResponse putParametersItem(String key, String parametersItem) {
    ...
    public CreateDatabaseResponse withParameters(Consumer<Map<String, String>> parametersSetter) {
        if (this.parameters == null) {
            this.parameters = new HashMap<>();
        }
    ...
    public CreateDatabaseResponse withTableLocationList(List<String> tableLocationList) {
        this.tableLocationList = tableLocationList;
        return this;
    }

    public CreateDatabaseResponse addTableLocationListItem(String tableLocationListItem) {
    ...
    public CreateDatabaseResponse withTableLocationList(Consumer<List<String>> tableLocationListSetter) {
        if (this.tableLocationList == null) {
            this.tableLocationList = new ArrayList<>();
        }
    ...
    public CreateDatabaseResponse withFunctionLocationList(List<String> functionLocationList) {
        this.functionLocationList = functionLocationList;
        return this;
    }

    public CreateDatabaseResponse addFunctionLocationListItem(String functionLocationListItem) {
    ...
    public CreateDatabaseResponse withFunctionLocationList(Consumer<List<String>> functionLocationListSetter) {
        if (this.functionLocationList == null) {
            this.functionLocationList = new ArrayList<>();
        }
