...
public class UpdateCatalogResponse extends SdkResponse {
    ...
    public UpdateCatalogResponse withOwner(String owner) {
        this.owner = owner;
        return this;
    }
    ...
    public UpdateCatalogResponse withOwnerType(OwnerTypeEnum ownerType) {
    ...
    public UpdateCatalogResponse withOwnerSource(OwnerSourceEnum ownerSource) {
