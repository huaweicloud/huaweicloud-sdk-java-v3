...
public class CreateLakeFormationInstanceResponse extends SdkResponse {
    ...
    public CreateLakeFormationInstanceResponse withDefaultInstance(Boolean defaultInstance) {
    ...
    public CreateLakeFormationInstanceResponse withStatus(StatusEnum status) {
        this.status = status;
        return this;
    }
    ...
    public CreateLakeFormationInstanceResponse withResourceProgress(Integer resourceProgress) {
    ...
    public CreateLakeFormationInstanceResponse withResourceExpectedDuration(Integer resourceExpectedDuration) {
    ...
    public CreateLakeFormationInstanceResponse withScaleProgress(Integer scaleProgress) {
    ...
    public CreateLakeFormationInstanceResponse withScaleExpectedDuration(Integer scaleExpectedDuration) {
    ...
    public CreateLakeFormationInstanceResponse withChargeMode(ChargeModeEnum chargeMode) {
