...
public class BatchUpdatePartitionRequest {
    ...
    private AlterPartitionsInput body;

    public BatchUpdatePartitionRequest withInstanceId(String instanceId) {
    ...
    public BatchUpdatePartitionRequest withCatalogName(String catalogName) {
    ...
    public BatchUpdatePartitionRequest withBody(AlterPartitionsInput body) {
        this.body = body;
        return this;
    }

    public BatchUpdatePartitionRequest withBody(Consumer<AlterPartitionsInput> bodySetter) {
        if (this.body == null) {
            this.body = new AlterPartitionsInput();
     ...
     * @return body
     */
    public AlterPartitionsInput getBody() {
        return body;
    }

    public void setBody(AlterPartitionsInput body) {
        this.body = body;
    }
    ...
    public String toString() {
        ...
        sb.append("class BatchUpdatePartitionRequest {\n");
