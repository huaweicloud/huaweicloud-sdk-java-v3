...
public class UpdateDatasetRequest {
    ...
    private AlterDatasetInput body;

    public UpdateDatasetRequest withInstanceId(String instanceId) {
    ...
    public UpdateDatasetRequest withCatalogName(String catalogName) {
    ...
    public UpdateDatasetRequest withDatabaseName(String databaseName) {
    ...
    public UpdateDatasetRequest withBody(AlterDatasetInput body) {
        this.body = body;
        return this;
    }

    public UpdateDatasetRequest withBody(Consumer<AlterDatasetInput> bodySetter) {
        if (this.body == null) {
            this.body = new AlterDatasetInput();
     ...
     * @return body
     */
    public AlterDatasetInput getBody() {
        return body;
    }

    public void setBody(AlterDatasetInput body) {
        this.body = body;
    }
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        UpdateDatasetRequest that = (UpdateDatasetRequest) obj;
    ...
    @Override
    public int hashCode() {
        return Objects.hash(instanceId, catalogName, datasetName, databaseName, body);
    }
