...
public class Dataset {
    ...
    public Dataset withCatalogName(String catalogName) {
    ...
    public Dataset withCatalogId(String catalogId) {
    ...
    public Dataset withDatabaseName(String databaseName) {
    ...
    public Dataset withDatabaseId(String databaseId) {
    ...
    public Dataset withStorageType(StorageTypeEnum storageType) {
    ...
    public Dataset withDatasetFormat(DatasetFileFormat datasetFormat) {
        this.datasetFormat = datasetFormat;
        return this;
    }

    public Dataset withDatasetFormat(Consumer<DatasetFileFormat> datasetFormatSetter) {
    ...
    public Dataset withOwner(String owner) {
        this.owner = owner;
        return this;
    }
    ...
    public Dataset withOwnerType(OwnerTypeEnum ownerType) {
    ...
    public Dataset withOwnerSource(OwnerSourceEnum ownerSource) {
    ...
    public Dataset withProperties(Consumer<Map<String, String>> propertiesSetter) {
        if (this.properties == null) {
            this.properties = new HashMap<>();
        }
    ...
    public Dataset withCreateTime(OffsetDateTime createTime) {
    ...
    public Dataset withUpdateTime(OffsetDateTime updateTime) {
