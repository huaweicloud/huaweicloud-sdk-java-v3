 ...
 */
public class NotNullConstraintInput {
    ...
    public NotNullConstraintInput withColumnName(String columnName) {
    ...
    public NotNullConstraintInput withConstraintName(String constraintName) {
    ...
    public NotNullConstraintInput withEnableConstraint(Boolean enableConstraint) {
    ...
    public NotNullConstraintInput withRelyConstraint(Boolean relyConstraint) {
    ...
    public NotNullConstraintInput withValidateConstraint(Boolean validateConstraint) {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(columnName, constraintName, enableConstraint, relyConstraint, validateConstraint);
    }

    @Override
    public String toString() {
        StringBuilder sb = new StringBuilder();
        sb.append("class NotNullConstraintInput {\n");
