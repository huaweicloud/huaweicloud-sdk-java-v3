...
public class NotNullConstraint {
    ...
    public NotNullConstraint withCatalogName(String catalogName) {
    ...
    public NotNullConstraint withDatabaseName(String databaseName) {
    ...
    public NotNullConstraint withTableName(String tableName) {
    ...
    public NotNullConstraint withColumnName(String columnName) {
    ...
    public NotNullConstraint withConstraintName(String constraintName) {
    ...
    public NotNullConstraint withEnableConstraint(Boolean enableConstraint) {
    ...
    public NotNullConstraint withRelyConstraint(Boolean relyConstraint) {
    ...
    public NotNullConstraint withValidateConstraint(Boolean validateConstraint) {
    ...
    public String toString() {
        ...
        sb.append("class NotNullConstraint {\n");
