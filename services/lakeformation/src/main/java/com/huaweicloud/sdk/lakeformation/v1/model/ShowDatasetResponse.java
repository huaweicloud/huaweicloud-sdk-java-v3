...
public class ShowDatasetResponse extends SdkResponse {
    ...
    public ShowDatasetResponse withCatalogName(String catalogName) {
    ...
    public ShowDatasetResponse withCatalogId(String catalogId) {
    ...
    public ShowDatasetResponse withDatasetName(String datasetName) {
    ...
    public ShowDatasetResponse withDatasetId(String datasetId) {
    ...
    public ShowDatasetResponse withDescription(String description) {
    ...
    public ShowDatasetResponse withDatabaseName(String databaseName) {
    ...
    public ShowDatasetResponse withDatabaseId(String databaseId) {
    ...
    public ShowDatasetResponse withStorageType(StorageTypeEnum storageType) {
    ...
    public ShowDatasetResponse withDatasetFormat(DatasetFileFormat datasetFormat) {
        this.datasetFormat = datasetFormat;
        return this;
    }

    public ShowDatasetResponse withDatasetFormat(Consumer<DatasetFileFormat> datasetFormatSetter) {
    ...
    public ShowDatasetResponse withOwner(String owner) {
        this.owner = owner;
        return this;
    }
    ...
    public ShowDatasetResponse withOwnerType(OwnerTypeEnum ownerType) {
    ...
    public ShowDatasetResponse withOwnerSource(OwnerSourceEnum ownerSource) {
    ...
    public ShowDatasetResponse withLocation(String location) {
    ...
    public ShowDatasetResponse withProperties(Map<String, String> properties) {
        this.properties = properties;
        return this;
    }

    public ShowDatasetResponse putPropertiesItem(String key, String propertiesItem) {
    ...
    public ShowDatasetResponse withProperties(Consumer<Map<String, String>> propertiesSetter) {
        if (this.properties == null) {
            this.properties = new HashMap<>();
        }
    ...
    public ShowDatasetResponse withCreateTime(OffsetDateTime createTime) {
    ...
    public ShowDatasetResponse withUpdateTime(OffsetDateTime updateTime) {
