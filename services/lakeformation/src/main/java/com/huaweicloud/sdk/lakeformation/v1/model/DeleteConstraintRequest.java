...
public class DeleteConstraintRequest {
    ...
    public DeleteConstraintRequest withInstanceId(String instanceId) {
    ...
    public DeleteConstraintRequest withCatalogName(String catalogName) {
    ...
    public DeleteConstraintRequest withDatabaseName(String databaseName) {
    ...
    public DeleteConstraintRequest withTableName(String tableName) {
    ...
    public DeleteConstraintRequest withConstraintName(String constraintName) {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(instanceId, catalogName, databaseName, tableName, constraintName);
    }

    @Override
    public String toString() {
        StringBuilder sb = new StringBuilder();
        sb.append("class DeleteConstraintRequest {\n");
