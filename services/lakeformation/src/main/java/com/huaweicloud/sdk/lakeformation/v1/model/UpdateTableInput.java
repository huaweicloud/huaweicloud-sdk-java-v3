...
public class UpdateTableInput {
    ...
    @JsonInclude(JsonInclude.Include.NON_NULL)
    @JsonProperty(value = "external_table_id")
    ...
    public UpdateTableInput withTableFormat(TableFormatEnum tableFormat) {
    ...
    public UpdateTableInput withTableType(TableTypeEnum tableType) {
    ...
    public UpdateTableInput withOwner(String owner) {
        this.owner = owner;
        return this;
    }
    ...
    public UpdateTableInput withOwnerType(OwnerTypeEnum ownerType) {
    ...
    public UpdateTableInput withCreateTime(OffsetDateTime createTime) {
    ...
    public UpdateTableInput withLastAccessTime(OffsetDateTime lastAccessTime) {
    ...
    public UpdateTableInput withLastAnalyzedTime(OffsetDateTime lastAnalyzedTime) {
    ...
    public UpdateTableInput withPartitionKeys(List<Column> partitionKeys) {
        this.partitionKeys = partitionKeys;
        return this;
    }

    public UpdateTableInput addPartitionKeysItem(Column partitionKeysItem) {
    ...
    public UpdateTableInput withPartitionKeys(Consumer<List<Column>> partitionKeysSetter) {
        if (this.partitionKeys == null) {
            this.partitionKeys = new ArrayList<>();
        }
    ...
    public UpdateTableInput withRetention(Integer retention) {
    ...
    public UpdateTableInput withStorageDescriptor(StorageDescriptor storageDescriptor) {
        this.storageDescriptor = storageDescriptor;
        return this;
    }

    public UpdateTableInput withStorageDescriptor(Consumer<StorageDescriptor> storageDescriptorSetter) {
    ...
    public UpdateTableInput withParameters(Map<String, String> parameters) {
        this.parameters = parameters;
        return this;
    }

    public UpdateTableInput putParametersItem(String key, String parametersItem) {
    ...
    public UpdateTableInput withParameters(Consumer<Map<String, String>> parametersSetter) {
        if (this.parameters == null) {
            this.parameters = new HashMap<>();
        }
    ...
    public UpdateTableInput withComments(String comments) {
    ...
    public UpdateTableInput withViewExpandedText(String viewExpandedText) {
    ...
    public UpdateTableInput withViewOriginalText(String viewOriginalText) {
    ...
    public UpdateTableInput withIgnoreObsChecked(Boolean ignoreObsChecked) {
    ...
    public UpdateTableInput withExternalTableId(String externalTableId) {
    ...
    public UpdateTableInput withDataStatisticEnable(Boolean dataStatisticEnable) {
    ...
    public UpdateTableInput withVersionId(String versionId) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        UpdateTableInput that = (UpdateTableInput) obj;
        return Objects.equals(this.tableName, that.tableName) && Objects.equals(this.tableFormat, that.tableFormat)
            ...
            && Objects.equals(this.externalTableId, that.externalTableId)
    ...
    public String toString() {
        ...
        sb.append("    externalTableId: ").append(toIndentedString(externalTableId)).append("\n");
