...
public class CreateFunctionRequest {
    ...
    public CreateFunctionRequest withInstanceId(String instanceId) {
    ...
    public CreateFunctionRequest withCatalogName(String catalogName) {
    ...
    public CreateFunctionRequest withDatabaseName(String databaseName) {
    ...
    public CreateFunctionRequest withBody(FunctionInput body) {
        this.body = body;
        return this;
    }

    public CreateFunctionRequest withBody(Consumer<FunctionInput> bodySetter) {
        if (this.body == null) {
