 ...
 * Response Object
 */
public class CreateV2xEdgeAppResponse extends SdkResponse {
    ...
    public CreateV2xEdgeAppResponse withV2xEdgeId(String v2xEdgeId) {
    ...
    public CreateV2xEdgeAppResponse withEdgeAppId(String edgeAppId) {
    ...
    public CreateV2xEdgeAppResponse withAppVersion(String appVersion) {
    ...
    public CreateV2xEdgeAppResponse withStatus(String status) {
        this.status = status;
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append("class CreateV2xEdgeAppResponse {\n");
