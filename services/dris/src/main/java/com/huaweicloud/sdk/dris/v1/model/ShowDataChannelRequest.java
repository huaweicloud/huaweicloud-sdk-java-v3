 ...
 * Request Object
 */
public class ShowDataChannelRequest {
    ...
    public ShowDataChannelRequest withInstanceId(String instanceId) {
    ...
    public ShowDataChannelRequest withV2xEdgeId(String v2xEdgeId) {
    ...
    public String toString() {
        ...
        sb.append("class ShowDataChannelRequest {\n");
