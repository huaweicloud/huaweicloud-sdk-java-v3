 ...
 * Response Object
 */
public class ShowRsuModelResponse extends SdkResponse {
    ...
    public ShowRsuModelResponse withRsuModelId(String rsuModelId) {
    ...
    public ShowRsuModelResponse withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public ShowRsuModelResponse withManufacturerName(String manufacturerName) {
    ...
    public ShowRsuModelResponse withDescription(String description) {
    ...
    public ShowRsuModelResponse withLastModifiedTime(OffsetDateTime lastModifiedTime) {
    ...
    public ShowRsuModelResponse withCreatedTime(OffsetDateTime createdTime) {
    ...
    public String toString() {
        ...
        sb.append("class ShowRsuModelResponse {\n");
