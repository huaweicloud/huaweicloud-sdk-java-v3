...
public class QueryApplicationBriefResponseDTO {
    ...
    public QueryApplicationBriefResponseDTO withCreatedTime(String createdTime) {
    ...
    public QueryApplicationBriefResponseDTO withLastModifiedTime(String lastModifiedTime) {
