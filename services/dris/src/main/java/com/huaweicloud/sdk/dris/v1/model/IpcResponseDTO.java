...
public class IpcResponseDTO {
    ...
    public IpcResponseDTO withCameraId(String cameraId) {
    ...
    public IpcResponseDTO withV2xEdgeId(String v2xEdgeId) {
    ...
    public IpcResponseDTO withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public IpcResponseDTO withCrossId(String crossId) {
    ...
    public IpcResponseDTO withFocalType(String focalType) {
    ...
    public IpcResponseDTO withParentConnectCode(String parentConnectCode) {
    ...
    public IpcResponseDTO withConnectCode(String connectCode) {
    ...
    public IpcResponseDTO withDescription(String description) {
    ...
    public IpcResponseDTO withEsn(String esn) {
        this.esn = esn;
        return this;
    }
    ...
    public IpcResponseDTO withIp(String ip) {
        this.ip = ip;
        return this;
    }
    ...
    public IpcResponseDTO withStatus(StatusEnum status) {
        this.status = status;
        return this;
    }
    ...
    public IpcResponseDTO withCreatedTime(OffsetDateTime createdTime) {
    ...
    public IpcResponseDTO withLastModifiedTime(OffsetDateTime lastModifiedTime) {
    ...
    public IpcResponseDTO withLastOnlineTime(OffsetDateTime lastOnlineTime) {
    ...
    public String toString() {
        ...
        sb.append("class IpcResponseDTO {\n");
