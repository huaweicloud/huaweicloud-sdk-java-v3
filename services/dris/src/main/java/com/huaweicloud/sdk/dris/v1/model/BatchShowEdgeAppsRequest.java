 ...
 * Request Object
 */
public class BatchShowEdgeAppsRequest {
    ...
    public BatchShowEdgeAppsRequest withInstanceId(String instanceId) {
    ...
    public BatchShowEdgeAppsRequest withEdgeAppId(String edgeAppId) {
    ...
    public BatchShowEdgeAppsRequest withOffset(Integer offset) {
        this.offset = offset;
        return this;
    }
    ...
    public BatchShowEdgeAppsRequest withLimit(Integer limit) {
        this.limit = limit;
        return this;
    }
    ...
    @Override
    public int hashCode() {
        return Objects.hash(instanceId, edgeAppId, offset, limit);
    }

    @Override
    public String toString() {
        StringBuilder sb = new StringBuilder();
        sb.append("class BatchShowEdgeAppsRequest {\n");
