...
public class ForwardingConfig {
    ...
    public ForwardingConfig withForwardingType(String forwardingType) {
    ...
    public ForwardingConfig withKafkaConfig(KafkaConfigResponseDTO kafkaConfig) {
        this.kafkaConfig = kafkaConfig;
        return this;
    }

    public ForwardingConfig withKafkaConfig(Consumer<KafkaConfigResponseDTO> kafkaConfigSetter) {
    ...
    public ForwardingConfig withMrsKafkaConfig(MrsKafkaConfigResponseDTO mrsKafkaConfig) {
        this.mrsKafkaConfig = mrsKafkaConfig;
        return this;
    }

    public ForwardingConfig withMrsKafkaConfig(Consumer<MrsKafkaConfigResponseDTO> mrsKafkaConfigSetter) {
