...
public class AddForwardingConfigsResponse extends SdkResponse {
    ...
    public AddForwardingConfigsResponse withForwardingType(String forwardingType) {
    ...
    public AddForwardingConfigsResponse withKafkaConfig(KafkaConfigResponseDTO kafkaConfig) {
        this.kafkaConfig = kafkaConfig;
        return this;
    }

    public AddForwardingConfigsResponse withKafkaConfig(Consumer<KafkaConfigResponseDTO> kafkaConfigSetter) {
    ...
    public AddForwardingConfigsResponse withMrsKafkaConfig(MrsKafkaConfigResponseDTO mrsKafkaConfig) {
        this.mrsKafkaConfig = mrsKafkaConfig;
        return this;
    }

    public AddForwardingConfigsResponse withMrsKafkaConfig(Consumer<MrsKafkaConfigResponseDTO> mrsKafkaConfigSetter) {
