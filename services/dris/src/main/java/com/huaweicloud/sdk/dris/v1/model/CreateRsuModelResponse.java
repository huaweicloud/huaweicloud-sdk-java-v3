...
public class CreateRsuModelResponse extends SdkResponse {
    ...
    public CreateRsuModelResponse withRsuModelId(String rsuModelId) {
    ...
    public CreateRsuModelResponse withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public CreateRsuModelResponse withManufacturerName(String manufacturerName) {
    ...
    public CreateRsuModelResponse withDescription(String description) {
    ...
    public CreateRsuModelResponse withLastModifiedTime(OffsetDateTime lastModifiedTime) {
    ...
    public CreateRsuModelResponse withCreatedTime(OffsetDateTime createdTime) {
