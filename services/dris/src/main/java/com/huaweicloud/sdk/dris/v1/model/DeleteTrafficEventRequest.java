 ...
 * Request Object
 */
public class DeleteTrafficEventRequest {
    ...
    public DeleteTrafficEventRequest withInstanceId(String instanceId) {
    ...
    public DeleteTrafficEventRequest withEventId(String eventId) {
    ...
    public String toString() {
        ...
        sb.append("class DeleteTrafficEventRequest {\n");
