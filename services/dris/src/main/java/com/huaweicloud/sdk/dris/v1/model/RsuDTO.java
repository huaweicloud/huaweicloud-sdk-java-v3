...
public class RsuDTO {
    ...
    public RsuDTO withRsuId(String rsuId) {
        this.rsuId = rsuId;
        return this;
    }
    ...
    public RsuDTO withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public RsuDTO withDescription(String description) {
    ...
    public RsuDTO withEsn(String esn) {
        this.esn = esn;
        return this;
    }
    ...
    public RsuDTO withLastModifiedTime(OffsetDateTime lastModifiedTime) {
    ...
    public RsuDTO withCreatedTime(OffsetDateTime createdTime) {
    ...
    public RsuDTO withLastOnlineTime(OffsetDateTime lastOnlineTime) {
    ...
    public RsuDTO withIp(String ip) {
        this.ip = ip;
        return this;
    }
    ...
    public RsuDTO withPositionDescription(String positionDescription) {
    ...
    public RsuDTO withLocation(RsuLocation location) {
        this.location = location;
        return this;
    }

    public RsuDTO withLocation(Consumer<RsuLocation> locationSetter) {
    ...
    public RsuDTO withStatus(String status) {
        this.status = status;
        return this;
    }
    ...
    public RsuDTO withRsuModelId(String rsuModelId) {
    ...
    public RsuDTO withIntersectionId(String intersectionId) {
    ...
    public RsuDTO withRelatedEdgeNum(Integer relatedEdgeNum) {
    ...
    public RsuDTO withSoftwareVersion(String softwareVersion) {
