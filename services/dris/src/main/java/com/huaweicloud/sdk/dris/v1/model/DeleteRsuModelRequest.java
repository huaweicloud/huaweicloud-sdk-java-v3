 ...
 * Request Object
 */
public class DeleteRsuModelRequest {
    ...
    public DeleteRsuModelRequest withInstanceId(String instanceId) {
    ...
    public DeleteRsuModelRequest withRsuModelId(String rsuModelId) {
    ...
    public String toString() {
        ...
        sb.append("class DeleteRsuModelRequest {\n");
