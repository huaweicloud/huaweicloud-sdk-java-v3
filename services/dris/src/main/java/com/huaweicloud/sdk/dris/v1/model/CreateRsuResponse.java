...
public class CreateRsuResponse extends SdkResponse {
    ...
    public CreateRsuResponse withRsuId(String rsuId) {
        this.rsuId = rsuId;
        return this;
    }
    ...
    public CreateRsuResponse withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public CreateRsuResponse withDescription(String description) {
    ...
    public CreateRsuResponse withEsn(String esn) {
        this.esn = esn;
        return this;
    }
    ...
    public CreateRsuResponse withLastModifiedTime(OffsetDateTime lastModifiedTime) {
    ...
    public CreateRsuResponse withCreatedTime(OffsetDateTime createdTime) {
    ...
    public CreateRsuResponse withLastOnlineTime(OffsetDateTime lastOnlineTime) {
    ...
    public CreateRsuResponse withIp(String ip) {
        this.ip = ip;
        return this;
    }
    ...
    public CreateRsuResponse withPositionDescription(String positionDescription) {
    ...
    public CreateRsuResponse withLocation(RsuLocation location) {
        this.location = location;
        return this;
    }

    public CreateRsuResponse withLocation(Consumer<RsuLocation> locationSetter) {
    ...
    public CreateRsuResponse withStatus(String status) {
        this.status = status;
        return this;
    }
    ...
    public CreateRsuResponse withRsuModelId(String rsuModelId) {
    ...
    public CreateRsuResponse withIntersectionId(String intersectionId) {
    ...
    public CreateRsuResponse withRelatedEdgeNum(Integer relatedEdgeNum) {
    ...
    public CreateRsuResponse withSoftwareVersion(String softwareVersion) {
