 ...
 * **参数说明**：即时事件的内容。
 */
public class ImmediateEventResponseDTO {
    ...
    public ImmediateEventResponseDTO withTimeStamp(OffsetDateTime timeStamp) {
    ...
    public ImmediateEventResponseDTO withEventClass(EventClassEnum eventClass) {
    ...
    public ImmediateEventResponseDTO withEventType(Integer eventType) {
    ...
    public ImmediateEventResponseDTO withEventSource(EventSourceEnum eventSource) {
    ...
    public ImmediateEventResponseDTO withEventSourceId(String eventSourceId) {
    ...
    public ImmediateEventResponseDTO withEventConfidence(Integer eventConfidence) {
    ...
    public ImmediateEventResponseDTO withEventPosition(ImmediateEventPosition3D eventPosition) {
        this.eventPosition = eventPosition;
        return this;
    }

    public ImmediateEventResponseDTO withEventPosition(Consumer<ImmediateEventPosition3D> eventPositionSetter) {
    ...
    public ImmediateEventResponseDTO withEventRadius(Integer eventRadius) {
    ...
    public ImmediateEventResponseDTO withEventDescription(String eventDescription) {
    ...
    public ImmediateEventResponseDTO withEventPriority(Integer eventPriority) {
    ...
    public ImmediateEventResponseDTO withReferencePaths(List<ImmediateEventReferencePath> referencePaths) {
        this.referencePaths = referencePaths;
        return this;
    }

    public ImmediateEventResponseDTO addReferencePathsItem(ImmediateEventReferencePath referencePathsItem) {
    ...
    public ImmediateEventResponseDTO withReferencePaths(
        Consumer<List<ImmediateEventReferencePath>> referencePathsSetter) {
        if (this.referencePaths == null) {
            this.referencePaths = new ArrayList<>();
        }
    ...
    public String toString() {
        ...
        sb.append("class ImmediateEventResponseDTO {\n");
