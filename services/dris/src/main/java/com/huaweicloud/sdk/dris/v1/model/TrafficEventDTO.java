...
public class TrafficEventDTO {
    ...
    public TrafficEventDTO withStatus(String status) {
        this.status = status;
        return this;
    }
    ...
    public TrafficEventDTO withEventId(String eventId) {
    ...
    public TrafficEventDTO withEventSourceType(String eventSourceType) {
    ...
    public TrafficEventDTO withEventSourceId(String eventSourceId) {
    ...
    public TrafficEventDTO withEventClass(String eventClass) {
    ...
    public TrafficEventDTO withEventType(Integer eventType) {
    ...
    public TrafficEventDTO withAreaCode(Integer areaCode) {
    ...
    public TrafficEventDTO withEventLevel(Integer eventLevel) {
    ...
    public TrafficEventDTO withEventParams(Map<String, String> eventParams) {
        this.eventParams = eventParams;
        return this;
    }

    public TrafficEventDTO putEventParamsItem(String key, String eventParamsItem) {
    ...
    public TrafficEventDTO withEventParams(Consumer<Map<String, String>> eventParamsSetter) {
        if (this.eventParams == null) {
            this.eventParams = new HashMap<>();
        }
    ...
    public TrafficEventDTO withEventPosition(EventLocation eventPosition) {
        this.eventPosition = eventPosition;
        return this;
    }

    public TrafficEventDTO withEventPosition(Consumer<EventLocation> eventPositionSetter) {
    ...
    public TrafficEventDTO withEventDescription(String eventDescription) {
    ...
    public TrafficEventDTO withReferencePaths(List<EventReferencePath> referencePaths) {
        this.referencePaths = referencePaths;
        return this;
    }

    public TrafficEventDTO addReferencePathsItem(EventReferencePath referencePathsItem) {
    ...
    public TrafficEventDTO withReferencePaths(Consumer<List<EventReferencePath>> referencePathsSetter) {
        if (this.referencePaths == null) {
            this.referencePaths = new ArrayList<>();
        }
    ...
    public TrafficEventDTO withEventPositionName(String eventPositionName) {
    ...
    public TrafficEventDTO withStartTime(OffsetDateTime startTime) {
    ...
    public TrafficEventDTO withEndTime(OffsetDateTime endTime) {
    ...
    public TrafficEventDTO withNote(String note) {
        this.note = note;
        return this;
    }
    ...
    public TrafficEventDTO withEventConfidence(Integer eventConfidence) {
    ...
    public TrafficEventDTO withCreatedTime(OffsetDateTime createdTime) {
    ...
    public TrafficEventDTO withLastModifiedTime(OffsetDateTime lastModifiedTime) {
    ...
    public String toString() {
        ...
        sb.append("class TrafficEventDTO {\n");
