 ...
 * Response Object
 */
public class UpdateTrafficEventResponse extends SdkResponse {
    ...
    public UpdateTrafficEventResponse withStatus(String status) {
        this.status = status;
        return this;
    }
    ...
    public UpdateTrafficEventResponse withEventId(String eventId) {
    ...
    public UpdateTrafficEventResponse withEventSourceType(String eventSourceType) {
    ...
    public UpdateTrafficEventResponse withEventSourceId(String eventSourceId) {
    ...
    public UpdateTrafficEventResponse withEventClass(String eventClass) {
    ...
    public UpdateTrafficEventResponse withEventType(Integer eventType) {
    ...
    public UpdateTrafficEventResponse withAreaCode(Integer areaCode) {
    ...
    public UpdateTrafficEventResponse withEventLevel(Integer eventLevel) {
    ...
    public UpdateTrafficEventResponse withEventParams(Map<String, String> eventParams) {
        this.eventParams = eventParams;
        return this;
    }

    public UpdateTrafficEventResponse putEventParamsItem(String key, String eventParamsItem) {
    ...
    public UpdateTrafficEventResponse withEventParams(Consumer<Map<String, String>> eventParamsSetter) {
        if (this.eventParams == null) {
            this.eventParams = new HashMap<>();
        }
    ...
    public UpdateTrafficEventResponse withEventPosition(EventLocation eventPosition) {
        this.eventPosition = eventPosition;
        return this;
    }

    public UpdateTrafficEventResponse withEventPosition(Consumer<EventLocation> eventPositionSetter) {
    ...
    public UpdateTrafficEventResponse withEventDescription(String eventDescription) {
    ...
    public UpdateTrafficEventResponse withReferencePaths(List<EventReferencePath> referencePaths) {
        this.referencePaths = referencePaths;
        return this;
    }

    public UpdateTrafficEventResponse addReferencePathsItem(EventReferencePath referencePathsItem) {
    ...
    public UpdateTrafficEventResponse withReferencePaths(Consumer<List<EventReferencePath>> referencePathsSetter) {
        if (this.referencePaths == null) {
            this.referencePaths = new ArrayList<>();
        }
    ...
    public UpdateTrafficEventResponse withEventPositionName(String eventPositionName) {
    ...
    public UpdateTrafficEventResponse withStartTime(OffsetDateTime startTime) {
    ...
    public UpdateTrafficEventResponse withEndTime(OffsetDateTime endTime) {
    ...
    public UpdateTrafficEventResponse withNote(String note) {
        this.note = note;
        return this;
    }
    ...
    public UpdateTrafficEventResponse withEventConfidence(Integer eventConfidence) {
    ...
    public UpdateTrafficEventResponse withCreatedTime(OffsetDateTime createdTime) {
    ...
    public UpdateTrafficEventResponse withLastModifiedTime(OffsetDateTime lastModifiedTime) {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        UpdateTrafficEventResponse updateTrafficEventResponse = (UpdateTrafficEventResponse) o;
        return Objects.equals(this.status, updateTrafficEventResponse.status)
            && Objects.equals(this.eventId, updateTrafficEventResponse.eventId)
            && Objects.equals(this.eventSourceType, updateTrafficEventResponse.eventSourceType)
            && Objects.equals(this.eventSourceId, updateTrafficEventResponse.eventSourceId)
            && Objects.equals(this.eventClass, updateTrafficEventResponse.eventClass)
            && Objects.equals(this.eventType, updateTrafficEventResponse.eventType)
            && Objects.equals(this.areaCode, updateTrafficEventResponse.areaCode)
            && Objects.equals(this.eventLevel, updateTrafficEventResponse.eventLevel)
            && Objects.equals(this.eventParams, updateTrafficEventResponse.eventParams)
            && Objects.equals(this.eventPosition, updateTrafficEventResponse.eventPosition)
            && Objects.equals(this.eventDescription, updateTrafficEventResponse.eventDescription)
            && Objects.equals(this.referencePaths, updateTrafficEventResponse.referencePaths)
            && Objects.equals(this.eventPositionName, updateTrafficEventResponse.eventPositionName)
            && Objects.equals(this.startTime, updateTrafficEventResponse.startTime)
            && Objects.equals(this.endTime, updateTrafficEventResponse.endTime)
            && Objects.equals(this.note, updateTrafficEventResponse.note)
            && Objects.equals(this.eventConfidence, updateTrafficEventResponse.eventConfidence)
            && Objects.equals(this.createdTime, updateTrafficEventResponse.createdTime)
            && Objects.equals(this.lastModifiedTime, updateTrafficEventResponse.lastModifiedTime);
    }
    ...
    public String toString() {
        ...
        sb.append("class UpdateTrafficEventResponse {\n");
