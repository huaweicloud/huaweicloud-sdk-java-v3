 ...
 */
public class UpdateTrafficEventDTO {
    ...
    public UpdateTrafficEventDTO withEventSourceType(String eventSourceType) {
    ...
    public UpdateTrafficEventDTO withEventSourceId(String eventSourceId) {
    ...
    public UpdateTrafficEventDTO withEventClass(String eventClass) {
    ...
    public UpdateTrafficEventDTO withEventType(Integer eventType) {
    ...
    public UpdateTrafficEventDTO withAreaCode(Integer areaCode) {
    ...
    public UpdateTrafficEventDTO withEventLevel(Integer eventLevel) {
    ...
    public UpdateTrafficEventDTO withEventParams(Map<String, String> eventParams) {
        this.eventParams = eventParams;
        return this;
    }

    public UpdateTrafficEventDTO putEventParamsItem(String key, String eventParamsItem) {
    ...
    public UpdateTrafficEventDTO withEventParams(Consumer<Map<String, String>> eventParamsSetter) {
        if (this.eventParams == null) {
            this.eventParams = new HashMap<>();
        }
    ...
    public UpdateTrafficEventDTO withEventPosition(EventLocation eventPosition) {
        this.eventPosition = eventPosition;
        return this;
    }

    public UpdateTrafficEventDTO withEventPosition(Consumer<EventLocation> eventPositionSetter) {
    ...
    public UpdateTrafficEventDTO withEventDescription(String eventDescription) {
    ...
    public UpdateTrafficEventDTO withReferencePaths(List<EventReferencePath> referencePaths) {
        this.referencePaths = referencePaths;
        return this;
    }

    public UpdateTrafficEventDTO addReferencePathsItem(EventReferencePath referencePathsItem) {
    ...
    public UpdateTrafficEventDTO withReferencePaths(Consumer<List<EventReferencePath>> referencePathsSetter) {
        if (this.referencePaths == null) {
            this.referencePaths = new ArrayList<>();
        }
    ...
    public UpdateTrafficEventDTO withEventPositionName(String eventPositionName) {
    ...
    public UpdateTrafficEventDTO withStartTime(String startTime) {
    ...
    public UpdateTrafficEventDTO withEndTime(String endTime) {
    ...
    public UpdateTrafficEventDTO withNote(String note) {
        this.note = note;
        return this;
    }
    ...
    public UpdateTrafficEventDTO withEventConfidence(Integer eventConfidence) {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        UpdateTrafficEventDTO updateTrafficEventDTO = (UpdateTrafficEventDTO) o;
        return Objects.equals(this.eventSourceType, updateTrafficEventDTO.eventSourceType)
            && Objects.equals(this.eventSourceId, updateTrafficEventDTO.eventSourceId)
            && Objects.equals(this.eventClass, updateTrafficEventDTO.eventClass)
            && Objects.equals(this.eventType, updateTrafficEventDTO.eventType)
            && Objects.equals(this.areaCode, updateTrafficEventDTO.areaCode)
            && Objects.equals(this.eventLevel, updateTrafficEventDTO.eventLevel)
            && Objects.equals(this.eventParams, updateTrafficEventDTO.eventParams)
            && Objects.equals(this.eventPosition, updateTrafficEventDTO.eventPosition)
            && Objects.equals(this.eventDescription, updateTrafficEventDTO.eventDescription)
            && Objects.equals(this.referencePaths, updateTrafficEventDTO.referencePaths)
            && Objects.equals(this.eventPositionName, updateTrafficEventDTO.eventPositionName)
            && Objects.equals(this.startTime, updateTrafficEventDTO.startTime)
            && Objects.equals(this.endTime, updateTrafficEventDTO.endTime)
            && Objects.equals(this.note, updateTrafficEventDTO.note)
            && Objects.equals(this.eventConfidence, updateTrafficEventDTO.eventConfidence);
    }
    ...
    public String toString() {
        ...
        sb.append("class UpdateTrafficEventDTO {\n");
