 ...
 * Response Object
 */
public class ShowTrafficEventResponse extends SdkResponse {
    ...
    public ShowTrafficEventResponse withStatus(String status) {
        this.status = status;
        return this;
    }
    ...
    public ShowTrafficEventResponse withEventId(String eventId) {
    ...
    public ShowTrafficEventResponse withEventSourceType(String eventSourceType) {
    ...
    public ShowTrafficEventResponse withEventSourceId(String eventSourceId) {
    ...
    public ShowTrafficEventResponse withEventClass(String eventClass) {
    ...
    public ShowTrafficEventResponse withEventType(Integer eventType) {
    ...
    public ShowTrafficEventResponse withAreaCode(Integer areaCode) {
    ...
    public ShowTrafficEventResponse withEventLevel(Integer eventLevel) {
    ...
    public ShowTrafficEventResponse withEventParams(Map<String, String> eventParams) {
        this.eventParams = eventParams;
        return this;
    }

    public ShowTrafficEventResponse putEventParamsItem(String key, String eventParamsItem) {
    ...
    public ShowTrafficEventResponse withEventParams(Consumer<Map<String, String>> eventParamsSetter) {
        if (this.eventParams == null) {
            this.eventParams = new HashMap<>();
        }
    ...
    public ShowTrafficEventResponse withEventPosition(EventLocation eventPosition) {
        this.eventPosition = eventPosition;
        return this;
    }

    public ShowTrafficEventResponse withEventPosition(Consumer<EventLocation> eventPositionSetter) {
    ...
    public ShowTrafficEventResponse withEventDescription(String eventDescription) {
    ...
    public ShowTrafficEventResponse withReferencePaths(List<EventReferencePath> referencePaths) {
        this.referencePaths = referencePaths;
        return this;
    }

    public ShowTrafficEventResponse addReferencePathsItem(EventReferencePath referencePathsItem) {
    ...
    public ShowTrafficEventResponse withReferencePaths(Consumer<List<EventReferencePath>> referencePathsSetter) {
        if (this.referencePaths == null) {
            this.referencePaths = new ArrayList<>();
        }
    ...
    public ShowTrafficEventResponse withEventPositionName(String eventPositionName) {
    ...
    public ShowTrafficEventResponse withStartTime(OffsetDateTime startTime) {
    ...
    public ShowTrafficEventResponse withEndTime(OffsetDateTime endTime) {
    ...
    public ShowTrafficEventResponse withNote(String note) {
        this.note = note;
        return this;
    }
    ...
    public ShowTrafficEventResponse withEventConfidence(Integer eventConfidence) {
    ...
    public ShowTrafficEventResponse withCreatedTime(OffsetDateTime createdTime) {
    ...
    public ShowTrafficEventResponse withLastModifiedTime(OffsetDateTime lastModifiedTime) {
    ...
    public String toString() {
        ...
        sb.append("class ShowTrafficEventResponse {\n");
