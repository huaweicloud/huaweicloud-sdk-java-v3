 ...
 * Request Object
 */
public class ShowV2xEdgeDetailRequest {
    ...
    public ShowV2xEdgeDetailRequest withInstanceId(String instanceId) {
    ...
    public ShowV2xEdgeDetailRequest withV2xEdgeId(String v2xEdgeId) {
    ...
    public String toString() {
        ...
        sb.append("class ShowV2xEdgeDetailRequest {\n");
