...
public class PoolDetails {
    ...
    public PoolDetails withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public PoolDetails withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public PoolDetails withProjectId(String projectId) {
    ...
    public PoolDetails withCapacity(Integer capacity) {
    ...
    public PoolDetails withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public PoolDetails withStatus(String status) {
        this.status = status;
        return this;
    }
    ...
    public PoolDetails withAvailabilityZone(String availabilityZone) {
    ...
    public PoolDetails withCreatedAt(String createdAt) {
    ...
    public PoolDetails withTotalCapacityGb(Integer totalCapacityGb) {
    ...
    public PoolDetails withUsedCapacityGb(Integer usedCapacityGb) {
    ...
    public PoolDetails withProvisionedCapacityGb(Integer provisionedCapacityGb) {
    ...
    public PoolDetails withMaxOverSubscriptionRatio(Float maxOverSubscriptionRatio) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        PoolDetails that = (PoolDetails) obj;
