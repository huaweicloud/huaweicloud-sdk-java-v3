...
public class ZoneData {
    ...
    public ZoneData withLinks(Link links) {
        this.links = links;
        return this;
    }

    public ZoneData withLinks(Consumer<Link> linksSetter) {
        if (this.links == null) {
            this.links = new Link();
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        return Objects.equals(this.id, that.id) && Objects.equals(this.name, that.name)
            ...
            && Objects.equals(this.ttl, that.ttl) && Objects.equals(this.serial, that.serial)
            && Objects.equals(this.masters, that.masters) && Objects.equals(this.status, that.status)
            && Objects.equals(this.poolId, that.poolId) && Objects.equals(this.projectId, that.projectId)
            && Objects.equals(this.zoneType, that.zoneType) && Objects.equals(this.createdAt, that.createdAt)
            && Objects.equals(this.updatedAt, that.updatedAt) && Objects.equals(this.recordNum, that.recordNum)
