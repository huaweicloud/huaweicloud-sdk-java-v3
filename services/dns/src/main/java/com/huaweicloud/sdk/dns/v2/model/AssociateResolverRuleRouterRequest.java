...
public class AssociateResolverRuleRouterRequest {
    ...
    public AssociateResolverRuleRouterRequest withResolverruleId(String resolverruleId) {
    ...
    public AssociateResolverRuleRouterRequest withBody(AssociateOrDisassociateRouterWithRuleRequestBody body) {
        this.body = body;
        return this;
    }

    public AssociateResolverRuleRouterRequest withBody(
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        AssociateResolverRuleRouterRequest that = (AssociateResolverRuleRouterRequest) obj;
