...
public class ShowRetrievalResponse extends SdkResponse {
    ...
    public ShowRetrievalResponse withRecord(RecordInfo record) {
        this.record = record;
        return this;
    }

    public ShowRetrievalResponse withRecord(Consumer<RecordInfo> recordSetter) {
        if (this.record == null) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ShowRetrievalResponse that = (ShowRetrievalResponse) obj;
