 ...
 * Response Object
 */
public class ShowAuthorizeTxtRecordResponse extends SdkResponse {
    ...
    public ShowAuthorizeTxtRecordResponse withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public ShowAuthorizeTxtRecordResponse withZoneName(String zoneName) {
    ...
    public ShowAuthorizeTxtRecordResponse withRecord(RecordInfo record) {
        this.record = record;
        return this;
    }

    public ShowAuthorizeTxtRecordResponse withRecord(Consumer<RecordInfo> recordSetter) {
        if (this.record == null) {
    ...
    public ShowAuthorizeTxtRecordResponse withStatus(String status) {
        this.status = status;
        return this;
    }
    ...
    public ShowAuthorizeTxtRecordResponse withSecondLevelZoneName(String secondLevelZoneName) {
    ...
    public ShowAuthorizeTxtRecordResponse withCreatedAt(String createdAt) {
    ...
    public ShowAuthorizeTxtRecordResponse withUpdatedAt(String updatedAt) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ShowAuthorizeTxtRecordResponse that = (ShowAuthorizeTxtRecordResponse) obj;
    ...
    public String toString() {
        ...
        sb.append("class ShowAuthorizeTxtRecordResponse {\n");
