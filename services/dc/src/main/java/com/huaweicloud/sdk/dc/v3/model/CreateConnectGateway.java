 ...
 * 互联网关的实例对象
 */
public class CreateConnectGateway {
    ...
    public CreateConnectGateway withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public CreateConnectGateway withDescription(String description) {
    ...
    public CreateConnectGateway withAddressFamily(AddressFamilyEnum addressFamily) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        CreateConnectGateway that = (CreateConnectGateway) obj;
    ...
    public String toString() {
        ...
        sb.append("class CreateConnectGateway {\n");
