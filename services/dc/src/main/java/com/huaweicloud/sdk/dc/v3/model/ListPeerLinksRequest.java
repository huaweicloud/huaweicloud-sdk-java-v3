...
public class ListPeerLinksRequest {
    ...
    public ListPeerLinksRequest withOffset(Integer offset) {
        this.offset = offset;
        return this;
    }
    ...
    public ListPeerLinksRequest withMarker(String marker) {
        this.marker = marker;
        return this;
    }
    ...
    public ListPeerLinksRequest withPageReverse(Boolean pageReverse) {
    ...
    public ListPeerLinksRequest withFields(List<String> fields) {
        this.fields = fields;
        return this;
    }

    public ListPeerLinksRequest addFieldsItem(String fieldsItem) {
        if (this.fields == null) {
    ...
    public ListPeerLinksRequest withFields(Consumer<List<String>> fieldsSetter) {
        if (this.fields == null) {
            this.fields = new ArrayList<>();
        }
    ...
    public ListPeerLinksRequest withExtFields(List<String> extFields) {
        this.extFields = extFields;
        return this;
    }

    public ListPeerLinksRequest addExtFieldsItem(String extFieldsItem) {
    ...
    public ListPeerLinksRequest withExtFields(Consumer<List<String>> extFieldsSetter) {
        if (this.extFields == null) {
            this.extFields = new ArrayList<>();
        }
    ...
    public ListPeerLinksRequest withSortKey(String sortKey) {
    ...
    public ListPeerLinksRequest withSortDir(List<SortDirEnum> sortDir) {
        this.sortDir = sortDir;
        return this;
    }

    public ListPeerLinksRequest addSortDirItem(SortDirEnum sortDirItem) {
    ...
    public ListPeerLinksRequest withSortDir(Consumer<List<SortDirEnum>> sortDirSetter) {
        if (this.sortDir == null) {
            this.sortDir = new ArrayList<>();
        }
    ...
    public ListPeerLinksRequest addIdItem(String idItem) {
        if (this.id == null) {
    ...
    public ListPeerLinksRequest withId(Consumer<List<String>> idSetter) {
        if (this.id == null) {
            this.id = new ArrayList<>();
        }
    ...
    public ListPeerLinksRequest withName(List<String> name) {
        this.name = name;
        return this;
    }

    public ListPeerLinksRequest addNameItem(String nameItem) {
        if (this.name == null) {
    ...
    public ListPeerLinksRequest withName(Consumer<List<String>> nameSetter) {
        if (this.name == null) {
            this.name = new ArrayList<>();
        }
