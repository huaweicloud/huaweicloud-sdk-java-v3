...
public class UpdateVirtualInterfaceRequestBody  {
    ...
    public UpdateVirtualInterfaceRequestBody withVirtualInterface(VirtualInterfaceDict virtualInterface) {
        this.virtualInterface = virtualInterface;
        return this;
    }

    public UpdateVirtualInterfaceRequestBody withVirtualInterface(Consumer<VirtualInterfaceDict> virtualInterfaceSetter) {
