 ...
 */
public class ExternalShowGlobalDcGateway {
    ...
    public ExternalShowGlobalDcGateway withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public ExternalShowGlobalDcGateway withTenantId(String tenantId) {
    ...
    public ExternalShowGlobalDcGateway withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public ExternalShowGlobalDcGateway withDescription(String description) {
    ...
    public ExternalShowGlobalDcGateway withEnterpriseProjectId(String enterpriseProjectId) {
    ...
    public ExternalShowGlobalDcGateway withGlobalCenterNetworkId(String globalCenterNetworkId) {
    ...
    public ExternalShowGlobalDcGateway withSiteNetworkId(String siteNetworkId) {
    ...
    public ExternalShowGlobalDcGateway withCloudConnectionId(String cloudConnectionId) {
    ...
    public ExternalShowGlobalDcGateway withBgpAsn(Long bgpAsn) {
        this.bgpAsn = bgpAsn;
        return this;
    }
    ...
    public ExternalShowGlobalDcGateway withRegionId(String regionId) {
    ...
    public ExternalShowGlobalDcGateway withLocationName(String locationName) {
    ...
    public ExternalShowGlobalDcGateway withLocales(Locale locales) {
        this.locales = locales;
        return this;
    }

    public ExternalShowGlobalDcGateway withLocales(Consumer<Locale> localesSetter) {
    ...
    public ExternalShowGlobalDcGateway withCurrentPeerLinkCount(Integer currentPeerLinkCount) {
    ...
    public ExternalShowGlobalDcGateway withAvailablePeerLinkCount(Integer availablePeerLinkCount) {
    ...
    public ExternalShowGlobalDcGateway withAdminStateUp(Boolean adminStateUp) {
    ...
    public ExternalShowGlobalDcGateway withStatus(String status) {
        this.status = status;
        return this;
    }
    ...
    public ExternalShowGlobalDcGateway withCreatedTime(OffsetDateTime createdTime) {
    ...
    public ExternalShowGlobalDcGateway withUpdatedTime(OffsetDateTime updatedTime) {
    ...
    public ExternalShowGlobalDcGateway withTags(Map<String, String> tags) {
        this.tags = tags;
        return this;
    }

    public ExternalShowGlobalDcGateway putTagsItem(String key, String tagsItem) {
        if (this.tags == null) {
    ...
    public ExternalShowGlobalDcGateway withTags(Consumer<Map<String, String>> tagsSetter) {
        if (this.tags == null) {
            this.tags = new HashMap<>();
        }
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ExternalShowGlobalDcGateway that = (ExternalShowGlobalDcGateway) obj;
    ...
    public String toString() {
        ...
        sb.append("class ExternalShowGlobalDcGateway {\n");
