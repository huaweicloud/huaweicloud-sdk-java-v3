 ...
 * Response Object
 */
public class UnbindGlobalEipsResponse extends SdkResponse {
    ...
    public UnbindGlobalEipsResponse withGlobalEips(ListBindingGeip globalEips) {
        this.globalEips = globalEips;
        return this;
    }

    public UnbindGlobalEipsResponse withGlobalEips(Consumer<ListBindingGeip> globalEipsSetter) {
