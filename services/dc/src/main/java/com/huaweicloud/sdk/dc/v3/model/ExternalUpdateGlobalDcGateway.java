 ...
 * 修改响应体对象
 */
public class ExternalUpdateGlobalDcGateway {
    ...
    public ExternalUpdateGlobalDcGateway withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public ExternalUpdateGlobalDcGateway withTenantId(String tenantId) {
    ...
    public ExternalUpdateGlobalDcGateway withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public ExternalUpdateGlobalDcGateway withDescription(String description) {
    ...
    public ExternalUpdateGlobalDcGateway withEnterpriseProjectId(String enterpriseProjectId) {
    ...
    public ExternalUpdateGlobalDcGateway withGlobalCenterNetworkId(String globalCenterNetworkId) {
    ...
    public ExternalUpdateGlobalDcGateway withSiteNetworkId(String siteNetworkId) {
    ...
    public ExternalUpdateGlobalDcGateway withCloudConnectionId(String cloudConnectionId) {
    ...
    public ExternalUpdateGlobalDcGateway withBgpAsn(Long bgpAsn) {
        this.bgpAsn = bgpAsn;
        return this;
    }
    ...
    public ExternalUpdateGlobalDcGateway withRegionId(String regionId) {
    ...
    public ExternalUpdateGlobalDcGateway withLocationName(String locationName) {
    ...
    public ExternalUpdateGlobalDcGateway withCurrentPeerLinkCount(Integer currentPeerLinkCount) {
    ...
    public ExternalUpdateGlobalDcGateway withAvailablePeerLinkCount(Integer availablePeerLinkCount) {
    ...
    public ExternalUpdateGlobalDcGateway withAdminStateUp(Boolean adminStateUp) {
    ...
    public ExternalUpdateGlobalDcGateway withStatus(String status) {
        this.status = status;
        return this;
    }
    ...
    public ExternalUpdateGlobalDcGateway withCreatedTime(OffsetDateTime createdTime) {
    ...
    public ExternalUpdateGlobalDcGateway withUpdatedTime(OffsetDateTime updatedTime) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ExternalUpdateGlobalDcGateway that = (ExternalUpdateGlobalDcGateway) obj;
    ...
    public String toString() {
        ...
        sb.append("class ExternalUpdateGlobalDcGateway {\n");
