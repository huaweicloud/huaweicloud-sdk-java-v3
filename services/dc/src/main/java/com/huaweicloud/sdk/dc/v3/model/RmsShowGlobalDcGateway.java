...
/**
 * RmsShowGlobalDcGateway
 */
public class RmsShowGlobalDcGateway {
    ...
    public RmsShowGlobalDcGateway withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public RmsShowGlobalDcGateway withTenantId(String tenantId) {
    ...
    public RmsShowGlobalDcGateway withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public RmsShowGlobalDcGateway withDescription(String description) {
    ...
    public RmsShowGlobalDcGateway withEnterpriseProjectId(String enterpriseProjectId) {
    ...
    public RmsShowGlobalDcGateway withGlobalCenterNetworkId(String globalCenterNetworkId) {
    ...
    public RmsShowGlobalDcGateway withSiteNetworkId(String siteNetworkId) {
    ...
    public RmsShowGlobalDcGateway withCloudConnectionId(String cloudConnectionId) {
    ...
    public RmsShowGlobalDcGateway withBgpAsn(Long bgpAsn) {
        this.bgpAsn = bgpAsn;
        return this;
    }
    ...
    public RmsShowGlobalDcGateway withRegionId(String regionId) {
    ...
    public RmsShowGlobalDcGateway withLocationName(String locationName) {
    ...
    public RmsShowGlobalDcGateway withLocales(Locale locales) {
        this.locales = locales;
        return this;
    }

    public RmsShowGlobalDcGateway withLocales(Consumer<Locale> localesSetter) {
    ...
    public RmsShowGlobalDcGateway withCurrentPeerLinkCount(Integer currentPeerLinkCount) {
    ...
    public RmsShowGlobalDcGateway withAvailablePeerLinkCount(Integer availablePeerLinkCount) {
    ...
    public RmsShowGlobalDcGateway withAdminStateUp(Boolean adminStateUp) {
    ...
    public RmsShowGlobalDcGateway withStatus(String status) {
        this.status = status;
        return this;
    }
    ...
    public RmsShowGlobalDcGateway withCreatedTime(OffsetDateTime createdTime) {
    ...
    public RmsShowGlobalDcGateway withUpdatedTime(OffsetDateTime updatedTime) {
    ...
    public RmsShowGlobalDcGateway withTags(Map<String, String> tags) {
        this.tags = tags;
        return this;
    }

    public RmsShowGlobalDcGateway putTagsItem(String key, String tagsItem) {
        if (this.tags == null) {
    ...
    public RmsShowGlobalDcGateway withTags(Consumer<Map<String, String>> tagsSetter) {
        if (this.tags == null) {
            this.tags = new HashMap<>();
        }
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        RmsShowGlobalDcGateway that = (RmsShowGlobalDcGateway) obj;
    ...
    public String toString() {
        ...
        sb.append("class RmsShowGlobalDcGateway {\n");
