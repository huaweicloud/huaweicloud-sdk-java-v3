...
/**
 * UpdateGlobalDcGatewayRequestBodyGlobalDcGateway
 */
public class UpdateGlobalDcGatewayRequestBodyGlobalDcGateway {
    ...
    public UpdateGlobalDcGatewayRequestBodyGlobalDcGateway withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public UpdateGlobalDcGatewayRequestBodyGlobalDcGateway withDescription(String description) {
    ...
    public UpdateGlobalDcGatewayRequestBodyGlobalDcGateway withAddressFamily(AddressFamilyEnum addressFamily) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        UpdateGlobalDcGatewayRequestBodyGlobalDcGateway that = (UpdateGlobalDcGatewayRequestBodyGlobalDcGateway) obj;
    ...
    public String toString() {
        ...
        sb.append("class UpdateGlobalDcGatewayRequestBodyGlobalDcGateway {\n");
