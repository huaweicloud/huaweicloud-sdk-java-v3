...
public class BatchCreateResourceTagsRequest {
    ...
    public BatchCreateResourceTagsRequest withBody(BatchOperateResourceTagsRequestBody body) {
        this.body = body;
        return this;
    }

    public BatchCreateResourceTagsRequest withBody(Consumer<BatchOperateResourceTagsRequestBody> bodySetter) {
        if (this.body == null) {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        BatchCreateResourceTagsRequest batchCreateResourceTagsRequest = (BatchCreateResourceTagsRequest) o;
        return Objects.equals(this.resourceId, batchCreateResourceTagsRequest.resourceId)
            && Objects.equals(this.resourceType, batchCreateResourceTagsRequest.resourceType)
            && Objects.equals(this.body, batchCreateResourceTagsRequest.body);
    }
