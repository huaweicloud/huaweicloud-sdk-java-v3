 ...
 * Request Object
 */
public class ListVifPeerDetectionsRequest {
    ...
    public ListVifPeerDetectionsRequest withLimit(Integer limit) {
        this.limit = limit;
        return this;
    }
    ...
    public ListVifPeerDetectionsRequest withSortKey(String sortKey) {
    ...
    public ListVifPeerDetectionsRequest withSortDir(List<SortDirEnum> sortDir) {
        this.sortDir = sortDir;
        return this;
    }

    public ListVifPeerDetectionsRequest addSortDirItem(SortDirEnum sortDirItem) {
    ...
    public ListVifPeerDetectionsRequest withSortDir(Consumer<List<SortDirEnum>> sortDirSetter) {
        if (this.sortDir == null) {
            this.sortDir = new ArrayList<>();
        }
    ...
    public ListVifPeerDetectionsRequest withOffset(Integer offset) {
        this.offset = offset;
        return this;
    }
    ...
    public ListVifPeerDetectionsRequest withPageReverse(Boolean pageReverse) {
    ...
    public String toString() {
        ...
        sb.append("class ListVifPeerDetectionsRequest {\n");
