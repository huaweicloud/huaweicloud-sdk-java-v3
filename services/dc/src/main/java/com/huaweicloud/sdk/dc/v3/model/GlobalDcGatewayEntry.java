 ...
 * global-dc-gateway详情。
 */
public class GlobalDcGatewayEntry {
    ...
    public GlobalDcGatewayEntry withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public GlobalDcGatewayEntry withTenantId(String tenantId) {
    ...
    public GlobalDcGatewayEntry withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public GlobalDcGatewayEntry withDescription(String description) {
    ...
    public GlobalDcGatewayEntry withGlobalCenterNetworkId(String globalCenterNetworkId) {
    ...
    public GlobalDcGatewayEntry withBgpAsn(Long bgpAsn) {
        this.bgpAsn = bgpAsn;
        return this;
    }
    ...
    public GlobalDcGatewayEntry withRegionId(String regionId) {
    ...
    public GlobalDcGatewayEntry withLocationName(String locationName) {
    ...
    public GlobalDcGatewayEntry withLocales(LocalesBody locales) {
        this.locales = locales;
        return this;
    }

    public GlobalDcGatewayEntry withLocales(Consumer<LocalesBody> localesSetter) {
    ...
    public GlobalDcGatewayEntry withCurrentPeerLinkCount(Integer currentPeerLinkCount) {
    ...
    public GlobalDcGatewayEntry withAvailablePeerLinkCount(Integer availablePeerLinkCount) {
    ...
    public GlobalDcGatewayEntry withTags(List<Tag> tags) {
        this.tags = tags;
        return this;
    }

    public GlobalDcGatewayEntry addTagsItem(Tag tagsItem) {
        if (this.tags == null) {
    ...
    public GlobalDcGatewayEntry withTags(Consumer<List<Tag>> tagsSetter) {
        if (this.tags == null) {
            this.tags = new ArrayList<>();
        }
    ...
    public GlobalDcGatewayEntry withAdminStateUp(Boolean adminStateUp) {
    ...
    public GlobalDcGatewayEntry withStatus(GlobalDcGatewayStatus status) {
        this.status = status;
        return this;
    }
    ...
    public GlobalDcGatewayEntry withCreatedTime(OffsetDateTime createdTime) {
    ...
    public GlobalDcGatewayEntry withUpdatedTime(OffsetDateTime updatedTime) {
    ...
    public GlobalDcGatewayEntry withAddressFamily(AddressFamilyEnum addressFamily) {
