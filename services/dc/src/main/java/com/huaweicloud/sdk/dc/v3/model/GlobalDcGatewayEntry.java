...
public class GlobalDcGatewayEntry {
    ...
    public GlobalDcGatewayEntry withCurrentPeerLinkCount(String currentPeerLinkCount) {
    ...
    public GlobalDcGatewayEntry withAvailablePeerLinkCount(String availablePeerLinkCount) {
