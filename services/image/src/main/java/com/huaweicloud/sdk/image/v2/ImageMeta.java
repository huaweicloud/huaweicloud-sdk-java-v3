...
public class ImageMeta {
    ...
    public static final HttpRequestDef<RunImageWisedesignColorfilterRequest, RunImageWisedesignColorfilterResponse> runImageWisedesignColorfilter =
        genForrunImageWisedesignColorfilter();

    private static HttpRequestDef<RunImageWisedesignColorfilterRequest, RunImageWisedesignColorfilterResponse> genForrunImageWisedesignColorfilter() {
        // basic
        HttpRequestDef.Builder<RunImageWisedesignColorfilterRequest, RunImageWisedesignColorfilterResponse> builder =
            HttpRequestDef
                .builder(HttpMethod.POST,
                    RunImageWisedesignColorfilterRequest.class,
                    RunImageWisedesignColorfilterResponse.class)
                .withName("RunImageWisedesignColorfilter")
                .withUri("/v2/{project_id}/image/image-wisedesign-colorfilter")
                .withContentType("application/json;charset=UTF-8");

        // requests
        builder.<ImageWisedesignColorfilterReq>withRequestField("body",
            LocationType.Body,
            FieldExistence.NON_NULL_NON_EMPTY,
            TypeCasts.uncheckedConversion(ImageWisedesignColorfilterReq.class),
            f -> f.withMarshaller(RunImageWisedesignColorfilterRequest::getBody, (req, v) -> {
                req.setBody(v);
            }));
    ...
    public static final HttpRequestDef<RunImageWisedesignCombineRequest, RunImageWisedesignCombineResponse> runImageWisedesignCombine =
        genForrunImageWisedesignCombine();

    private static HttpRequestDef<RunImageWisedesignCombineRequest, RunImageWisedesignCombineResponse> genForrunImageWisedesignCombine() {
        // basic
        HttpRequestDef.Builder<RunImageWisedesignCombineRequest, RunImageWisedesignCombineResponse> builder =
            HttpRequestDef
                .builder(HttpMethod.POST,
                    RunImageWisedesignCombineRequest.class,
                    RunImageWisedesignCombineResponse.class)
                .withName("RunImageWisedesignCombine")
                .withUri("/v2/{project_id}/image/image-wisedesign-combine")
                .withContentType("application/json;charset=UTF-8");

        // requests
        builder.<ImageWisedesignCombineReq>withRequestField("body",
            LocationType.Body,
            FieldExistence.NON_NULL_NON_EMPTY,
            TypeCasts.uncheckedConversion(ImageWisedesignCombineReq.class),
            f -> f.withMarshaller(RunImageWisedesignCombineRequest::getBody, (req, v) -> {
                req.setBody(v);
            }));
