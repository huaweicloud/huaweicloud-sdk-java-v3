...
public class CreateDomainsResponse extends SdkResponse {
    ...
    public CreateDomainsResponse withInfoCode(InfoCodeEnum infoCode) {
    ...
    public CreateDomainsResponse withInfoDescription(String infoDescription) {
    ...
    public CreateDomainsResponse withDomainId(String domainId) {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(infoCode, infoDescription, domainId);
    }

    @Override
    public String toString() {
        StringBuilder sb = new StringBuilder();
        sb.append("class CreateDomainsResponse {\n");
