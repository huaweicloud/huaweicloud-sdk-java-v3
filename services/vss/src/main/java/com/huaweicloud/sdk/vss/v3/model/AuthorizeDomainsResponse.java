 ...
 * Response Object
 */
public class AuthorizeDomainsResponse extends SdkResponse {
    ...
    @JacksonXmlProperty(localName = "usage_notice")
    ...
    public AuthorizeDomainsResponse withInfoDescription(String infoDescription) {
