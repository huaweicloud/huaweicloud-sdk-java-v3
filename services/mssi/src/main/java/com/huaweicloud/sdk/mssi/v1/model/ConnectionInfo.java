...
public class ConnectionInfo {
    ...
    public ConnectionInfo withAuthConfig(Object authConfig) {
    ...
    public ConnectionInfo withAuthConfigId(String authConfigId) {
    ...
    public ConnectionInfo withAuthDynamic(Object authDynamic) {
    ...
    public ConnectionInfo withAuthId(String authId) {
        this.authId = authId;
        return this;
    }
    ...
    public ConnectionInfo withAuthInfo(Object authInfo) {
    ...
    public ConnectionInfo withAuthKey(String authKey) {
    ...
    public ConnectionInfo withAuthName(String authName) {
    ...
    public ConnectionInfo withAuthProp(Object authProp) {
    ...
    public ConnectionInfo withAuthType(String authType) {
    ...
    public ConnectionInfo withCdmParamsConfig(Object cdmParamsConfig) {
    ...
    public ConnectionInfo withConnectionName(String connectionName) {
    ...
    public ConnectionInfo withConnectorId(String connectorId) {
    ...
    public ConnectionInfo withConnectorName(String connectorName) {
    ...
    public ConnectionInfo withCreateTime(OffsetDateTime createTime) {
    ...
    public ConnectionInfo withCreatedBy(String createdBy) {
    ...
    public ConnectionInfo withDomainId(String domainId) {
    ...
    public ConnectionInfo withHostConfig(Object hostConfig) {
    ...
    public ConnectionInfo withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public ConnectionInfo withIsOpen(Integer isOpen) {
        this.isOpen = isOpen;
        return this;
    }
    ...
    public ConnectionInfo withLogo(String logo) {
        this.logo = logo;
        return this;
    }
    ...
    public ConnectionInfo withProjectId(String projectId) {
    ...
    public ConnectionInfo withStatus(String status) {
        this.status = status;
        return this;
    }
    ...
    public ConnectionInfo withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public ConnectionInfo withUpdatedBy(String updatedBy) {
    ...
    public ConnectionInfo withUpdatedTime(OffsetDateTime updatedTime) {
    ...
    public ConnectionInfo withUserId(String userId) {
        this.userId = userId;
        return this;
    }
