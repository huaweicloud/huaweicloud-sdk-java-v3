...
public class DeleteFlowResponse extends SdkResponse {
    ...
    public DeleteFlowResponse withResCode(Integer resCode) {
    ...
    public DeleteFlowResponse withResLog(String resLog) {
        this.resLog = resLog;
        return this;
    }
    ...
    public DeleteFlowResponse withResMsg(String resMsg) {
        this.resMsg = resMsg;
        return this;
    }
