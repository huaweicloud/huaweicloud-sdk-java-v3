 ...
 * BackupDownloadLink
 */
public class BackupDownloadLink {
    ...
    public BackupDownloadLink withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public BackupDownloadLink withSize(Integer size) {
        this.size = size;
        return this;
    }
    ...
    public BackupDownloadLink withDownloadLink(String downloadLink) {
    ...
    public BackupDownloadLink withLinkExpiredTime(String linkExpiredTime) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        BackupDownloadLink that = (BackupDownloadLink) obj;
    ...
    public String toString() {
        ...
        sb.append("class BackupDownloadLink {\n");
