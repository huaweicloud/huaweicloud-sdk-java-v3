...
public class NatAsyncClient {
     ...
     */
    public AsyncInvoker<BatchCreateNatGatewayDnatRulesRequest, BatchCreateNatGatewayDnatRulesResponse> batchCreateNatGatewayDnatRulesAsyncInvoker(BatchCreateNatGatewayDnatRulesRequest request) {
        return new AsyncInvoker<BatchCreateNatGatewayDnatRulesRequest, BatchCreateNatGatewayDnatRulesResponse>(request, NatMeta.batchCreateNatGatewayDnatRules, hcClient);
    }
     ...
     */
    public AsyncInvoker<CreateNatGatewayDnatRuleRequest, CreateNatGatewayDnatRuleResponse> createNatGatewayDnatRuleAsyncInvoker(CreateNatGatewayDnatRuleRequest request) {
        return new AsyncInvoker<CreateNatGatewayDnatRuleRequest, CreateNatGatewayDnatRuleResponse>(request, NatMeta.createNatGatewayDnatRule, hcClient);
    }
     ...
     */
    public AsyncInvoker<DeleteNatGatewayDnatRuleRequest, DeleteNatGatewayDnatRuleResponse> deleteNatGatewayDnatRuleAsyncInvoker(DeleteNatGatewayDnatRuleRequest request) {
        return new AsyncInvoker<DeleteNatGatewayDnatRuleRequest, DeleteNatGatewayDnatRuleResponse>(request, NatMeta.deleteNatGatewayDnatRule, hcClient);
    }
     ...
     */
    public AsyncInvoker<ListNatGatewayDnatRulesRequest, ListNatGatewayDnatRulesResponse> listNatGatewayDnatRulesAsyncInvoker(ListNatGatewayDnatRulesRequest request) {
        return new AsyncInvoker<ListNatGatewayDnatRulesRequest, ListNatGatewayDnatRulesResponse>(request, NatMeta.listNatGatewayDnatRules, hcClient);
    }
     ...
     */
    public AsyncInvoker<ShowNatGatewayDnatRuleRequest, ShowNatGatewayDnatRuleResponse> showNatGatewayDnatRuleAsyncInvoker(ShowNatGatewayDnatRuleRequest request) {
        return new AsyncInvoker<ShowNatGatewayDnatRuleRequest, ShowNatGatewayDnatRuleResponse>(request, NatMeta.showNatGatewayDnatRule, hcClient);
    }
     ...
     */
    public AsyncInvoker<UpdateNatGatewayDnatRuleRequest, UpdateNatGatewayDnatRuleResponse> updateNatGatewayDnatRuleAsyncInvoker(UpdateNatGatewayDnatRuleRequest request) {
        return new AsyncInvoker<UpdateNatGatewayDnatRuleRequest, UpdateNatGatewayDnatRuleResponse>(request, NatMeta.updateNatGatewayDnatRule, hcClient);
    }
     ...
     */
    public AsyncInvoker<CreateNatGatewayRequest, CreateNatGatewayResponse> createNatGatewayAsyncInvoker(CreateNatGatewayRequest request) {
        return new AsyncInvoker<CreateNatGatewayRequest, CreateNatGatewayResponse>(request, NatMeta.createNatGateway, hcClient);
    }
     ...
     */
    public AsyncInvoker<DeleteNatGatewayRequest, DeleteNatGatewayResponse> deleteNatGatewayAsyncInvoker(DeleteNatGatewayRequest request) {
        return new AsyncInvoker<DeleteNatGatewayRequest, DeleteNatGatewayResponse>(request, NatMeta.deleteNatGateway, hcClient);
    }
     ...
     */
    public AsyncInvoker<ListNatGatewaysRequest, ListNatGatewaysResponse> listNatGatewaysAsyncInvoker(ListNatGatewaysRequest request) {
        return new AsyncInvoker<ListNatGatewaysRequest, ListNatGatewaysResponse>(request, NatMeta.listNatGateways, hcClient);
    }
     ...
     */
    public AsyncInvoker<ShowNatGatewayRequest, ShowNatGatewayResponse> showNatGatewayAsyncInvoker(ShowNatGatewayRequest request) {
        return new AsyncInvoker<ShowNatGatewayRequest, ShowNatGatewayResponse>(request, NatMeta.showNatGateway, hcClient);
    }
     ...
     */
    public AsyncInvoker<UpdateNatGatewayRequest, UpdateNatGatewayResponse> updateNatGatewayAsyncInvoker(UpdateNatGatewayRequest request) {
        return new AsyncInvoker<UpdateNatGatewayRequest, UpdateNatGatewayResponse>(request, NatMeta.updateNatGateway, hcClient);
    }
     ...
     */
    public AsyncInvoker<CreateNatGatewaySnatRuleRequest, CreateNatGatewaySnatRuleResponse> createNatGatewaySnatRuleAsyncInvoker(CreateNatGatewaySnatRuleRequest request) {
        return new AsyncInvoker<CreateNatGatewaySnatRuleRequest, CreateNatGatewaySnatRuleResponse>(request, NatMeta.createNatGatewaySnatRule, hcClient);
    }
     ...
     */
    public AsyncInvoker<DeleteNatGatewaySnatRuleRequest, DeleteNatGatewaySnatRuleResponse> deleteNatGatewaySnatRuleAsyncInvoker(DeleteNatGatewaySnatRuleRequest request) {
        return new AsyncInvoker<DeleteNatGatewaySnatRuleRequest, DeleteNatGatewaySnatRuleResponse>(request, NatMeta.deleteNatGatewaySnatRule, hcClient);
    }
     ...
     */
    public AsyncInvoker<ListNatGatewaySnatRulesRequest, ListNatGatewaySnatRulesResponse> listNatGatewaySnatRulesAsyncInvoker(ListNatGatewaySnatRulesRequest request) {
        return new AsyncInvoker<ListNatGatewaySnatRulesRequest, ListNatGatewaySnatRulesResponse>(request, NatMeta.listNatGatewaySnatRules, hcClient);
    }
     ...
     */
    public AsyncInvoker<ShowNatGatewaySnatRuleRequest, ShowNatGatewaySnatRuleResponse> showNatGatewaySnatRuleAsyncInvoker(ShowNatGatewaySnatRuleRequest request) {
        return new AsyncInvoker<ShowNatGatewaySnatRuleRequest, ShowNatGatewaySnatRuleResponse>(request, NatMeta.showNatGatewaySnatRule, hcClient);
    }
     ...
     */
    public AsyncInvoker<UpdateNatGatewaySnatRuleRequest, UpdateNatGatewaySnatRuleResponse> updateNatGatewaySnatRuleAsyncInvoker(UpdateNatGatewaySnatRuleRequest request) {
        return new AsyncInvoker<UpdateNatGatewaySnatRuleRequest, UpdateNatGatewaySnatRuleResponse>(request, NatMeta.updateNatGatewaySnatRule, hcClient);
    }
