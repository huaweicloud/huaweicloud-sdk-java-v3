 ...
 * Response Object
 */
public class UpdatePrivateNatResponse extends SdkResponse {
    ...
    public UpdatePrivateNatResponse withGateway(PrivateNat gateway) {
        this.gateway = gateway;
        return this;
    }

    public UpdatePrivateNatResponse withGateway(Consumer<PrivateNat> gatewaySetter) {
    ...
    public UpdatePrivateNatResponse withRequestId(String requestId) {
    ...
    public String toString() {
        ...
        sb.append("class UpdatePrivateNatResponse {\n");
