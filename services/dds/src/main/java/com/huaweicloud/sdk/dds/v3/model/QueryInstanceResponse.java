...
public class QueryInstanceResponse  {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, name, status, port, mode, region, datastore, engine, created, updated, dbUserName, ssl, vpcId, subnetId, securityGroupId, backupStrategy, payMode, maintenanceWindow, groups, diskEncryptionId, enterpriseProjectId, timeZone, dssPoolId, actions);
    }
    @Override
