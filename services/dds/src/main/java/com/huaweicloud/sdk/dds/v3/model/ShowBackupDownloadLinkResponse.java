...
import com.huaweicloud.sdk.dds.v3.model.GetBackupDownloadLinkResponseBodyFiles;
...
public class ShowBackupDownloadLinkResponse extends SdkResponse {
    ...
    public ShowBackupDownloadLinkResponse withFiles(Consumer<List<GetBackupDownloadLinkResponseBodyFiles>> filesSetter) {
        if(this.files == null ){
            this.files = new ArrayList<>();
        }
