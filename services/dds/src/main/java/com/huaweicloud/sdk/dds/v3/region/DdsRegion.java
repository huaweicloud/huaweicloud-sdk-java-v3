...
public class DdsRegion {
    ...
    public static final Region EU_WEST_101 = new Region("eu-west-101", "https://dds.eu-west-101.myhuaweicloud.eu");
    ...
    public static final Region NA_MEXICO_1 = new Region("na-mexico-1", "https://dds.na-mexico-1.myhuaweicloud.com");

    public static final Region LA_NORTH_2 = new Region("la-north-2", "https://dds.la-north-2.myhuaweicloud.com");

    public static final Region SA_BRAZIL_1 = new Region("sa-brazil-1", "https://dds.sa-brazil-1.myhuaweicloud.com");

    public static final Region LA_SOUTH_2 = new Region("la-south-2", "https://dds.la-south-2.myhuaweicloud.com");
    ...
    public static final Region AE_AD_1 = new Region("ae-ad-1", "https://dds.ae-ad-1.myhuaweicloud.com");

    public static final Region CN_EAST_5 = new Region("cn-east-5", "https://dds.cn-east-5.myhuaweicloud.com");

    public static final Region CN_EAST_4 = new Region("cn-east-4", "https://dds.cn-east-4.myhuaweicloud.com");

    public static final Region CN_NORTH_12 = new Region("cn-north-12", "https://dds.cn-north-12.myhuaweicloud.com");

    public static final Region AF_NORTH_1 = new Region("af-north-1", "https://dds.af-north-1.myhuaweicloud.com");

    public static final Region AP_SOUTHEAST_5 =
        new Region("ap-southeast-5", "https://dds.ap-southeast-5.myhuaweicloud.com");

    public static final Region CN_NORTH_11 = new Region("cn-north-11", "https://dds.cn-north-11.myhuaweicloud.com");

    public static final Region CN_SOUTHWEST_3 =
        new Region("cn-southwest-3", "https://dds.cn-southwest-3.myhuaweicloud.com");

    public static final Region CN_SOUTH_4 = new Region("cn-south-4", "https://dds.cn-south-4.myhuaweicloud.com");
    ...
    public static Region valueOf(String regionId) {
        ...
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "region id '%s' is not in the following supported regions of service DDS: [%s]",
            regionId,
