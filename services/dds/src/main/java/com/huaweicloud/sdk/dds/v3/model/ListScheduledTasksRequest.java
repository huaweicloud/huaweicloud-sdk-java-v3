...
public class ListScheduledTasksRequest {
    ...
    public ListScheduledTasksRequest withJobName(String jobName) {
    ...
    public ListScheduledTasksRequest withJobStatus(String jobStatus) {
    ...
    public ListScheduledTasksRequest withStartTime(String startTime) {
