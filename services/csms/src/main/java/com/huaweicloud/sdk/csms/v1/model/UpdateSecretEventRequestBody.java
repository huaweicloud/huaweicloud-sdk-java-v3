...
public class UpdateSecretEventRequestBody {
    ...
    public UpdateSecretEventRequestBody withEventTypes(List<String> eventTypes) {
    ...
    public UpdateSecretEventRequestBody withEventTypes(Consumer<List<String>> eventTypesSetter) {
        if (this.eventTypes == null) {
            this.eventTypes = new ArrayList<>();
        }
