...
public class UpdateSecretEventRequestBody {
    ...
    public UpdateSecretEventRequestBody withEventTypes(List<EventTypesEnum> eventTypes) {
        this.eventTypes = eventTypes;
        return this;
    }

    public UpdateSecretEventRequestBody addEventTypesItem(EventTypesEnum eventTypesItem) {
    ...
    public UpdateSecretEventRequestBody withEventTypes(Consumer<List<EventTypesEnum>> eventTypesSetter) {
        if (this.eventTypes == null) {
            this.eventTypes = new ArrayList<>();
        }
    ...
    public UpdateSecretEventRequestBody withNotification(Consumer<Notification> notificationSetter) {
