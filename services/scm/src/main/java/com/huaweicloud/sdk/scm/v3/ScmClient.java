...
public class ScmClient {
    ...
    public SyncInvoker<DeleteCertificateRequest, DeleteCertificateResponse> deleteCertificateInvoker(DeleteCertificateRequest request) {
        return new SyncInvoker<DeleteCertificateRequest, DeleteCertificateResponse>(request, ScmMeta.deleteCertificate, hcClient);
    }
    ...
    public SyncInvoker<ExportCertificateRequest, ExportCertificateResponse> exportCertificateInvoker(ExportCertificateRequest request) {
        return new SyncInvoker<ExportCertificateRequest, ExportCertificateResponse>(request, ScmMeta.exportCertificate, hcClient);
    }
     ...
     */
    public SyncInvoker<ImportCertificateRequest, ImportCertificateResponse> importCertificateInvoker(ImportCertificateRequest request) {
        return new SyncInvoker<ImportCertificateRequest, ImportCertificateResponse>(request, ScmMeta.importCertificate, hcClient);
    }
    ...
    public SyncInvoker<ListCertificatesRequest, ListCertificatesResponse> listCertificatesInvoker(ListCertificatesRequest request) {
        return new SyncInvoker<ListCertificatesRequest, ListCertificatesResponse>(request, ScmMeta.listCertificates, hcClient);
    }
     ...
     */
    public SyncInvoker<PushCertificateRequest, PushCertificateResponse> pushCertificateInvoker(PushCertificateRequest request) {
        return new SyncInvoker<PushCertificateRequest, PushCertificateResponse>(request, ScmMeta.pushCertificate, hcClient);
    }
    ...
    public SyncInvoker<ShowCertificateRequest, ShowCertificateResponse> showCertificateInvoker(ShowCertificateRequest request) {
        return new SyncInvoker<ShowCertificateRequest, ShowCertificateResponse>(request, ScmMeta.showCertificate, hcClient);
    }
