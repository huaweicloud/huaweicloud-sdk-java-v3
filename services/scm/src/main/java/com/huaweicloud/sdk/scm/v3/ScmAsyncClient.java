...
public class ScmAsyncClient {
    ...
    /** 推送证书 推送SSL证书到弹性负载均衡（Elastic Load Balance，简称ELB）、Web应用防火墙（Web Application Firewall，WAF）、CDN（Content Delivery
     * Network，内容分发网络）等其它华为云产品中。
     *
