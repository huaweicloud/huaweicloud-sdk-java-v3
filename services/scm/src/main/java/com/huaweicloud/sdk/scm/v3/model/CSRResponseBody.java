...
public class CSRResponseBody {
    ...
    public CSRResponseBody withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public CSRResponseBody withSans(String sans) {
        this.sans = sans;
        return this;
    }
    ...
    public CSRResponseBody withPrivateKeyAlgo(String privateKeyAlgo) {
    ...
    public CSRResponseBody withUsage(String usage) {
        this.usage = usage;
        return this;
    }
    ...
    public CSRResponseBody withCompanyCountry(String companyCountry) {
    ...
    public CSRResponseBody withCompanyProvince(String companyProvince) {
    ...
    public CSRResponseBody withCompanyCity(String companyCity) {
    ...
    public CSRResponseBody withCompanyName(String companyName) {
