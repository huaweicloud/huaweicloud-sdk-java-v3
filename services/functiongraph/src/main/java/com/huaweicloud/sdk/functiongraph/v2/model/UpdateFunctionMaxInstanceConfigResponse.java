...
public class UpdateFunctionMaxInstanceConfigResponse extends SdkResponse {
    ...
    public UpdateFunctionMaxInstanceConfigResponse withPreStopHandler(String preStopHandler) {
    ...
    public UpdateFunctionMaxInstanceConfigResponse withPreStopTimeout(Integer preStopTimeout) {
