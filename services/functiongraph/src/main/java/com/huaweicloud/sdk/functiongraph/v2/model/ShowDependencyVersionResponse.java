...
public class ShowDependencyVersionResponse extends SdkResponse {
    ...
    public ShowDependencyVersionResponse withRuntime(RuntimeEnum runtime) {
    ...
    public ShowDependencyVersionResponse withDepId(String depId) {
        this.depId = depId;
        return this;
    }
    ...
    public ShowDependencyVersionResponse withDownloadLink(String downloadLink) {
    ...
    public ShowDependencyVersionResponse withIsShared(Boolean isShared) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ShowDependencyVersionResponse that = (ShowDependencyVersionResponse) obj;
        return Objects.equals(this.id, that.id) && Objects.equals(this.owner, that.owner)
            ...
            && Objects.equals(this.downloadLink, that.downloadLink) && Objects.equals(this.isShared, that.isShared);
    }
