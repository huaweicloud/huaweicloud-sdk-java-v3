...
public class DeleteTagsRequest {
    ...
    public DeleteTagsRequest withBody(UpdateFunctionTagsRequestBody body) {
        this.body = body;
        return this;
    }

    public DeleteTagsRequest withBody(Consumer<UpdateFunctionTagsRequestBody> bodySetter) {
        if (this.body == null) {
