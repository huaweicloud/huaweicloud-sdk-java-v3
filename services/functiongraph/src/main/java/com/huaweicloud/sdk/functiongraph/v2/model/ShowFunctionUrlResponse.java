...
public class ShowFunctionUrlResponse extends SdkResponse {
    ...
    public ShowFunctionUrlResponse withAuthType(String authType) {
    ...
    public ShowFunctionUrlResponse withCors(CorsConfig cors) {
        this.cors = cors;
        return this;
    }

    public ShowFunctionUrlResponse withCors(Consumer<CorsConfig> corsSetter) {
        if (this.cors == null) {
    ...
    public ShowFunctionUrlResponse withFunctionUrl(String functionUrl) {
    ...
    public ShowFunctionUrlResponse withCreateTime(String createTime) {
    ...
    public ShowFunctionUrlResponse withLastModifiedTime(String lastModifiedTime) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ShowFunctionUrlResponse that = (ShowFunctionUrlResponse) obj;
