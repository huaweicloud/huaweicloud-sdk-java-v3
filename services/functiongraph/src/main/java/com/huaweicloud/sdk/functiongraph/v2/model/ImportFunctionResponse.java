...
public class ImportFunctionResponse extends SdkResponse {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(funcUrn, funcName, domainId, namespace, projectName, _package, runtime, timeout, handler, memorySize, cpu, codeType, codeUrl, codeFilename, codeSize, userData, digest, version, imageName, xrole, appXrole, description, versionDescription, lastModified, funcVpc, dependList, strategyConfig, extendConfig, initializerHandler, initializerTimeout, enterpriseProjectId);
    }
    @Override
    public String toString() {
