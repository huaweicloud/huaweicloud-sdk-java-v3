...
public class FlowExecutionBrief {
    ...
    public FlowExecutionBrief withWorkflowId(String workflowId) {
    ...
    public FlowExecutionBrief withWorkflowUrn(String workflowUrn) {
    ...
    public FlowExecutionBrief withExecutionId(String executionId) {
    ...
    public FlowExecutionBrief withStatus(StatusEnum status) {
        this.status = status;
        return this;
    }
    ...
    public FlowExecutionBrief withBeginTime(String beginTime) {
    ...
    public FlowExecutionBrief withEndTime(String endTime) {
    ...
    public FlowExecutionBrief withLastUpdateTime(String lastUpdateTime) {
    ...
    public FlowExecutionBrief withCreatedBy(String createdBy) {
