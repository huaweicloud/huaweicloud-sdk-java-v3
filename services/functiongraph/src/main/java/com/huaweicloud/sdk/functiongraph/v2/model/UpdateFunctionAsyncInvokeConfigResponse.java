...
public class UpdateFunctionAsyncInvokeConfigResponse extends SdkResponse {
    ...
    public UpdateFunctionAsyncInvokeConfigResponse withMaxAsyncEventAgeInSeconds(Integer maxAsyncEventAgeInSeconds) {
    ...
    public UpdateFunctionAsyncInvokeConfigResponse withMaxAsyncRetryAttempts(Integer maxAsyncRetryAttempts) {
    ...
    public UpdateFunctionAsyncInvokeConfigResponse withDestinationConfig(FuncAsyncDestinationConfig destinationConfig) {
        this.destinationConfig = destinationConfig;
        return this;
    }

    public UpdateFunctionAsyncInvokeConfigResponse withDestinationConfig(Consumer<FuncAsyncDestinationConfig> destinationConfigSetter) {
    ...
    public UpdateFunctionAsyncInvokeConfigResponse withCreatedTime(String createdTime) {
    ...
    public UpdateFunctionAsyncInvokeConfigResponse withLastModified(String lastModified) {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        UpdateFunctionAsyncInvokeConfigResponse updateFunctionAsyncInvokeConfigResponse = (UpdateFunctionAsyncInvokeConfigResponse) o;
        return Objects.equals(this.funcUrn, updateFunctionAsyncInvokeConfigResponse.funcUrn) &&
            Objects.equals(this.maxAsyncEventAgeInSeconds, updateFunctionAsyncInvokeConfigResponse.maxAsyncEventAgeInSeconds) &&
    ...
    public String toString() {
        ...
        sb.append("class UpdateFunctionAsyncInvokeConfigResponse {\n");
