...
public class ListActiveAsyncInvocationsRequest {
    ...
    public ListActiveAsyncInvocationsRequest withFunctionUrn(String functionUrn) {
    ...
    public ListActiveAsyncInvocationsRequest withRequests(String requests) {
    ...
    public ListActiveAsyncInvocationsRequest withMarker(String marker) {
        this.marker = marker;
        return this;
    }
    ...
    public ListActiveAsyncInvocationsRequest withLimit(String limit) {
        this.limit = limit;
        return this;
    }
    ...
    public ListActiveAsyncInvocationsRequest withStatus(String status) {
        this.status = status;
        return this;
    }
    ...
    public ListActiveAsyncInvocationsRequest withQueryBeginTime(OffsetDateTime queryBeginTime) {
    ...
    public ListActiveAsyncInvocationsRequest withQueryEndTime(OffsetDateTime queryEndTime) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ListActiveAsyncInvocationsRequest that = (ListActiveAsyncInvocationsRequest) obj;
        return Objects.equals(this.functionUrn, that.functionUrn) && Objects.equals(this.requests, that.requests)
    ...
    @Override
    public int hashCode() {
        return Objects.hash(functionUrn, requests, marker, limit, status, queryBeginTime, queryEndTime);
    }
