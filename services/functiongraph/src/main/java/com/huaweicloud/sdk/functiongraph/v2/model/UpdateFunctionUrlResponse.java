 ...
 * Response Object
 */
public class UpdateFunctionUrlResponse extends SdkResponse {
    ...
    public UpdateFunctionUrlResponse withAuthType(String authType) {
    ...
    public UpdateFunctionUrlResponse withCors(CorsConfig cors) {
        this.cors = cors;
        return this;
    }

    public UpdateFunctionUrlResponse withCors(Consumer<CorsConfig> corsSetter) {
        if (this.cors == null) {
    ...
    public UpdateFunctionUrlResponse withFunctionUrl(String functionUrl) {
    ...
    public UpdateFunctionUrlResponse withCreateTime(String createTime) {
    ...
    public UpdateFunctionUrlResponse withLastModifiedTime(String lastModifiedTime) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        UpdateFunctionUrlResponse that = (UpdateFunctionUrlResponse) obj;
    ...
    public String toString() {
        ...
        sb.append("class UpdateFunctionUrlResponse {\n");
