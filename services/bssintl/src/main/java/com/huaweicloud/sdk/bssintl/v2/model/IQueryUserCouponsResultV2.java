...
import com.huaweicloud.sdk.bssintl.v2.model.ICouponUseLimitInfoV2;
...
public class IQueryUserCouponsResultV2  {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(couponId, couponCode, status, customerId, couponType, measureId, faceValue, validTime, expireTime, orderId, promotionPlanId, planName, planDesc, mediaType, fetchMethod, useLimits, activeTime, reserveTime, promotionId, createTime, couponVersion, balance, lockOrderId, couponUsage, isFrozen, currency, extendParam1, sourceId);
    }
    @Override
