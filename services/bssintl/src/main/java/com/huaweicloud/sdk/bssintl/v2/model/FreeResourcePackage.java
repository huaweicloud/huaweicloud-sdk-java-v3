...
import com.huaweicloud.sdk.bssintl.v2.model.FreeResource;
...
public class FreeResourcePackage  {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(orderInstanceId, orderId, productId, productName, enterpriseProjectId, enterpriseProjectScope, effectiveTime, expireTime, status, serviceTypeCode, regionCode, sourceType, bundleType, quotaReuseMode, freeResources);
    }
    @Override
