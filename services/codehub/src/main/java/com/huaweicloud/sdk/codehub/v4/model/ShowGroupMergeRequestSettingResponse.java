 ...
 * Response Object
 */
public class ShowGroupMergeRequestSettingResponse extends SdkResponse {
    ...
    public ShowGroupMergeRequestSettingResponse withId(Integer id) {
        this.id = id;
        return this;
    }
    ...
    public ShowGroupMergeRequestSettingResponse withDisableMergeBySelf(Boolean disableMergeBySelf) {
    ...
    public ShowGroupMergeRequestSettingResponse withDisableApproveBySelf(Boolean disableApproveBySelf) {
    ...
    public ShowGroupMergeRequestSettingResponse withDisableReviewBySelf(Boolean disableReviewBySelf) {
    ...
    public ShowGroupMergeRequestSettingResponse withCreatedAt(String createdAt) {
    ...
    public ShowGroupMergeRequestSettingResponse withUpdatedAt(String updatedAt) {
    ...
    public ShowGroupMergeRequestSettingResponse withCanForceMerge(Boolean canForceMerge) {
    ...
    public ShowGroupMergeRequestSettingResponse withDisableSquashMerge(Boolean disableSquashMerge) {
    ...
    public ShowGroupMergeRequestSettingResponse withMustRelateIssue(Boolean mustRelateIssue) {
    ...
    public ShowGroupMergeRequestSettingResponse withNeedRelateIssueBranches(String needRelateIssueBranches) {
    ...
    public ShowGroupMergeRequestSettingResponse withNeedAllIssuesCheckPassed(Boolean needAllIssuesCheckPassed) {
    ...
    public ShowGroupMergeRequestSettingResponse withReviewMode(ReviewModeEnum reviewMode) {
    ...
    public ShowGroupMergeRequestSettingResponse withAddNotesAfterMerged(Boolean addNotesAfterMerged) {
    ...
    public ShowGroupMergeRequestSettingResponse withMergedCommitAuthor(MergedCommitAuthorEnum mergedCommitAuthor) {
    ...
    public ShowGroupMergeRequestSettingResponse withEvaluationRole(EvaluationRoleEnum evaluationRole) {
    ...
    public ShowGroupMergeRequestSettingResponse withEvaluationMergeGate(Boolean evaluationMergeGate) {
    ...
    public ShowGroupMergeRequestSettingResponse withMarkAutoMergedMrAsClosed(Boolean markAutoMergedMrAsClosed) {
    ...
    public ShowGroupMergeRequestSettingResponse withDeleteSourceBranchWhenMerged(Boolean deleteSourceBranchWhenMerged) {
    ...
    public ShowGroupMergeRequestSettingResponse withAutoSquashMerge(Boolean autoSquashMerge) {
    ...
    public ShowGroupMergeRequestSettingResponse withSquashMergeWithNoMergeCommit(Boolean squashMergeWithNoMergeCommit) {
    ...
    public ShowGroupMergeRequestSettingResponse withOnlyAllowOneIssueCheckPassed(Boolean onlyAllowOneIssueCheckPassed) {
    ...
    public ShowGroupMergeRequestSettingResponse withEnableCustomEvaluation(Boolean enableCustomEvaluation) {
    ...
    public ShowGroupMergeRequestSettingResponse withEvaluationTypes(List<EvaluationTypeDto> evaluationTypes) {
        this.evaluationTypes = evaluationTypes;
        return this;
    }

    public ShowGroupMergeRequestSettingResponse addEvaluationTypesItem(EvaluationTypeDto evaluationTypesItem) {
    ...
    public ShowGroupMergeRequestSettingResponse withEvaluationTypes(
    ...
    public ShowGroupMergeRequestSettingResponse withCanReopen(Boolean canReopen) {
    ...
    public ShowGroupMergeRequestSettingResponse withOnlyAllowMergeIfAllDiscussionsAreResolved(
    ...
    public ShowGroupMergeRequestSettingResponse withMergeMethod(MergeMethodEnum mergeMethod) {
    ...
    public ShowGroupMergeRequestSettingResponse withOnlyAllowMergeIfVoteBiggerThan(
    ...
    public ShowGroupMergeRequestSettingResponse withOnlyAssigneeCanMerge(Boolean onlyAssigneeCanMerge) {
    ...
    public ShowGroupMergeRequestSettingResponse withGroupId(Integer groupId) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ShowGroupMergeRequestSettingResponse that = (ShowGroupMergeRequestSettingResponse) obj;
    ...
    public String toString() {
        ...
        sb.append("class ShowGroupMergeRequestSettingResponse {\n");
