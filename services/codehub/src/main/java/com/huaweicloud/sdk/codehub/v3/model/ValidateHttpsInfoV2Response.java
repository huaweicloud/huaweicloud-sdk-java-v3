 ...
 * Response Object
 */
public class ValidateHttpsInfoV2Response extends SdkResponse {
    ...
    public ValidateHttpsInfoV2Response withError(Error error) {
        this.error = error;
        return this;
    }

    public ValidateHttpsInfoV2Response withError(Consumer<Error> errorSetter) {
        if(this.error == null ){
    ...
    public ValidateHttpsInfoV2Response withResult(String result) {
        this.result = result;
        return this;
    }
    ...
    public ValidateHttpsInfoV2Response withStatus(String status) {
        this.status = status;
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append("class ValidateHttpsInfoV2Response {\n");
