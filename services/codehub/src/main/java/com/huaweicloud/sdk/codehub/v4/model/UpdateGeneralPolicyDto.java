 ...
 */
public class UpdateGeneralPolicyDto {
    ...
    public UpdateGeneralPolicyDto withDisableFork(Boolean disableFork) {
    ...
    public UpdateGeneralPolicyDto withBranchNameRegex(String branchNameRegex) {
    ...
    public UpdateGeneralPolicyDto withTagNameRegex(String tagNameRegex) {
    ...
    public UpdateGeneralPolicyDto withGeneratePreMergeRef(Boolean generatePreMergeRef) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        UpdateGeneralPolicyDto that = (UpdateGeneralPolicyDto) obj;
    ...
    public String toString() {
        ...
        sb.append("class UpdateGeneralPolicyDto {\n");
