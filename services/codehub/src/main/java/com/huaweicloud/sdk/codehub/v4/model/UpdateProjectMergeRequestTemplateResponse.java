 ...
 * Response Object
 */
public class UpdateProjectMergeRequestTemplateResponse extends SdkResponse {
    ...
    public UpdateProjectMergeRequestTemplateResponse withId(Integer id) {
        this.id = id;
        return this;
    }
    ...
    public UpdateProjectMergeRequestTemplateResponse withCreatedAt(String createdAt) {
    ...
    public UpdateProjectMergeRequestTemplateResponse withUpdatedAt(String updatedAt) {
    ...
    public UpdateProjectMergeRequestTemplateResponse withTemplateName(String templateName) {
    ...
    public UpdateProjectMergeRequestTemplateResponse withMergeRequestTitle(String mergeRequestTitle) {
    ...
    public UpdateProjectMergeRequestTemplateResponse withIsDefault(Boolean isDefault) {
    ...
    public UpdateProjectMergeRequestTemplateResponse withIsWip(Boolean isWip) {
        this.isWip = isWip;
        return this;
    }
    ...
    public UpdateProjectMergeRequestTemplateResponse withAutoExtractMrTitle(Integer autoExtractMrTitle) {
    ...
    public UpdateProjectMergeRequestTemplateResponse withCreator(UserBasicDto creator) {
        this.creator = creator;
        return this;
    }

    public UpdateProjectMergeRequestTemplateResponse withCreator(Consumer<UserBasicDto> creatorSetter) {
    ...
    public UpdateProjectMergeRequestTemplateResponse withProjectId(String projectId) {
