...
public class UpdateTenantTrustedIpAddressResponse extends SdkResponse {
    ...
    public UpdateTenantTrustedIpAddressResponse withIpType(IpTypeEnum ipType) {
        this.ipType = ipType;
        return this;
    }
    ...
    public UpdateTenantTrustedIpAddressResponse withViewFlag(ViewFlagEnum viewFlag) {
    ...
    public UpdateTenantTrustedIpAddressResponse withDownloadFlag(DownloadFlagEnum downloadFlag) {
    ...
    public UpdateTenantTrustedIpAddressResponse withUploadFlag(UploadFlagEnum uploadFlag) {
    ...
    public UpdateTenantTrustedIpAddressResponse withOrderFlag(OrderFlagEnum orderFlag) {
