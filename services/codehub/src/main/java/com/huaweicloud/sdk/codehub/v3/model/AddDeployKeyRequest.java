...
public class AddDeployKeyRequest {
    ...
    public AddDeployKeyRequest withBody(AddDeployKeyRequestBody body) {
        this.body = body;
        return this;
    }

    public AddDeployKeyRequest withBody(Consumer<AddDeployKeyRequestBody> bodySetter) {
        if (this.body == null) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        AddDeployKeyRequest that = (AddDeployKeyRequest) obj;
