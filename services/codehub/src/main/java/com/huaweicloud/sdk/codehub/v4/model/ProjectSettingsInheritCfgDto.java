...
public class ProjectSettingsInheritCfgDto {
    ...
    public ProjectSettingsInheritCfgDto withName(NameEnum name) {
        this.name = name;
        return this;
    }
    ...
    public ProjectSettingsInheritCfgDto withInheritMod(InheritModEnum inheritMod) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ProjectSettingsInheritCfgDto that = (ProjectSettingsInheritCfgDto) obj;
    ...
    public String toString() {
        ...
        sb.append("class ProjectSettingsInheritCfgDto {\n");
