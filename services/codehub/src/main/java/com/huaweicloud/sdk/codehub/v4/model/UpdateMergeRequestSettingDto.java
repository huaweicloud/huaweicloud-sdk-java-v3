...
public class UpdateMergeRequestSettingDto {
    ...
    private List<String> evaluationTypes = null;
    ...
    public UpdateMergeRequestSettingDto withReviewMode(ReviewModeEnum reviewMode) {
    ...
    public UpdateMergeRequestSettingDto withOnlyAllowMergeIfAllDiscussionsAreResolved(
    ...
    public UpdateMergeRequestSettingDto withMustRelateIssue(Boolean mustRelateIssue) {
    ...
    public UpdateMergeRequestSettingDto withOnlyAllowOneIssueCheckPassed(Boolean onlyAllowOneIssueCheckPassed) {
    ...
    public UpdateMergeRequestSettingDto withNeedAllIssuesCheckPassed(Boolean needAllIssuesCheckPassed) {
    ...
    public UpdateMergeRequestSettingDto withNeedRelateIssueBranches(String needRelateIssueBranches) {
    ...
    public UpdateMergeRequestSettingDto withEvaluationMergeGate(Boolean evaluationMergeGate) {
    ...
    public UpdateMergeRequestSettingDto withEvaluationRole(EvaluationRoleEnum evaluationRole) {
    ...
    public UpdateMergeRequestSettingDto withDisableMergeBySelf(Boolean disableMergeBySelf) {
    ...
    public UpdateMergeRequestSettingDto withDisableApproveBySelf(Boolean disableApproveBySelf) {
    ...
    public UpdateMergeRequestSettingDto withDisableReviewBySelf(Boolean disableReviewBySelf) {
    ...
    public UpdateMergeRequestSettingDto withCanForceMerge(Boolean canForceMerge) {
    ...
    public UpdateMergeRequestSettingDto withAddNotesAfterMerged(Boolean addNotesAfterMerged) {
    ...
    public UpdateMergeRequestSettingDto withMarkAutoMergedMrAsClosed(Boolean markAutoMergedMrAsClosed) {
    ...
    public UpdateMergeRequestSettingDto withCanReopen(Boolean canReopen) {
    ...
    public UpdateMergeRequestSettingDto withDeleteSourceBranchWhenMerged(Boolean deleteSourceBranchWhenMerged) {
    ...
    public UpdateMergeRequestSettingDto withDisableSquashMerge(Boolean disableSquashMerge) {
    ...
    public UpdateMergeRequestSettingDto withAutoSquashMerge(Boolean autoSquashMerge) {
    ...
    public UpdateMergeRequestSettingDto withMergeMethod(MergeMethodEnum mergeMethod) {
    ...
    public UpdateMergeRequestSettingDto withSquashMergeWithNoMergeCommit(Boolean squashMergeWithNoMergeCommit) {
    ...
    public UpdateMergeRequestSettingDto withMergedCommitAuthor(MergedCommitAuthorEnum mergedCommitAuthor) {
    ...
    public UpdateMergeRequestSettingDto withEnableCustomEvaluation(Boolean enableCustomEvaluation) {
    ...
    public UpdateMergeRequestSettingDto withEvaluationTypes(List<String> evaluationTypes) {
        this.evaluationTypes = evaluationTypes;
        return this;
    }

    public UpdateMergeRequestSettingDto addEvaluationTypesItem(String evaluationTypesItem) {
    ...
    public UpdateMergeRequestSettingDto withEvaluationTypes(Consumer<List<String>> evaluationTypesSetter) {
        if (this.evaluationTypes == null) {
            this.evaluationTypes = new ArrayList<>();
        }
    ...
    public UpdateMergeRequestSettingDto withOnlyAllowMergeIfVoteBiggerThan(Integer onlyAllowMergeIfVoteBiggerThan) {
    ...
    public UpdateMergeRequestSettingDto withOnlyAssigneeCanMerge(Boolean onlyAssigneeCanMerge) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        UpdateMergeRequestSettingDto that = (UpdateMergeRequestSettingDto) obj;
        return Objects.equals(this.reviewMode, that.reviewMode)
            ...
            && Objects.equals(this.disableMergeBySelf, that.disableMergeBySelf)
    ...
    @Override
    public int hashCode() {
        return Objects.hash(reviewMode,
