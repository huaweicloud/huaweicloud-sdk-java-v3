 ...
 * 合并请求模板返回体
 */
public class MergeRequestTemplateDto {
    ...
    public MergeRequestTemplateDto withId(Integer id) {
        this.id = id;
        return this;
    }
    ...
    public MergeRequestTemplateDto withRepositoryId(Integer repositoryId) {
    ...
    public MergeRequestTemplateDto withDescription(String description) {
    ...
    public MergeRequestTemplateDto withCreatedAt(String createdAt) {
    ...
    public MergeRequestTemplateDto withUpdatedAt(String updatedAt) {
    ...
    public MergeRequestTemplateDto withTemplateName(String templateName) {
    ...
    public MergeRequestTemplateDto withMergeRequestTitle(String mergeRequestTitle) {
    ...
    public MergeRequestTemplateDto withIsDefault(Boolean isDefault) {
    ...
    public MergeRequestTemplateDto withIsWip(Boolean isWip) {
        this.isWip = isWip;
        return this;
    }
    ...
    public MergeRequestTemplateDto withAutoExtractMrTitle(Integer autoExtractMrTitle) {
    ...
    public MergeRequestTemplateDto withCreator(UserBasicDto creator) {
        this.creator = creator;
        return this;
    }

    public MergeRequestTemplateDto withCreator(Consumer<UserBasicDto> creatorSetter) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        MergeRequestTemplateDto that = (MergeRequestTemplateDto) obj;
    ...
    public String toString() {
        ...
        sb.append("class MergeRequestTemplateDto {\n");
