 ...
 * commit单个检视意见信息。
 */
public class CommitDiscussionDto {
    ...
    private List<CommitNoteDto> notes = null;
    ...
    public CommitDiscussionDto withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public CommitDiscussionDto withIndividualNote(Boolean individualNote) {
    ...
    public CommitDiscussionDto withNotes(List<CommitNoteDto> notes) {
        this.notes = notes;
        return this;
    }

    public CommitDiscussionDto addNotesItem(CommitNoteDto notesItem) {
        if (this.notes == null) {
    ...
    public CommitDiscussionDto withNotes(Consumer<List<CommitNoteDto>> notesSetter) {
        if (this.notes == null) {
            this.notes = new ArrayList<>();
        }
     ...
     * @return notes
     */
    public List<CommitNoteDto> getNotes() {
        return notes;
    }

    public void setNotes(List<CommitNoteDto> notes) {
        this.notes = notes;
    }

    public CommitDiscussionDto withRepositoryId(Integer repositoryId) {
    ...
    public CommitDiscussionDto withNoteableType(NoteableTypeEnum noteableType) {
    ...
    public CommitDiscussionDto withCommitId(String commitId) {
    ...
    public CommitDiscussionDto withRepositoryFullPath(String repositoryFullPath) {
    ...
    public CommitDiscussionDto withAMode(String aMode) {
        this.aMode = aMode;
        return this;
    }
    ...
    public CommitDiscussionDto withBMode(String bMode) {
        this.bMode = bMode;
        return this;
    }
    ...
    public CommitDiscussionDto withDeletedFile(Boolean deletedFile) {
    ...
    public CommitDiscussionDto withNewFile(Boolean newFile) {
    ...
    public CommitDiscussionDto withDiffFile(Boolean diffFile) {
     ...
     * @return diffFile
     */
    public Boolean getDiffFile() {
        return diffFile;
    }

    public void setDiffFile(Boolean diffFile) {
        this.diffFile = diffFile;
    }

    public CommitDiscussionDto withAddedLines(Integer addedLines) {
    ...
    public CommitDiscussionDto withRemovedLines(Integer removedLines) {
    ...
    public CommitDiscussionDto withResolved(Boolean resolved) {
    ...
    public CommitDiscussionDto withArchived(Boolean archived) {
    ...
    public CommitDiscussionDto withReviewCategories(String reviewCategories) {
    ...
    public CommitDiscussionDto withReviewCategoriesCn(String reviewCategoriesCn) {
    ...
    public CommitDiscussionDto withReviewCategoriesEn(String reviewCategoriesEn) {
    ...
    public CommitDiscussionDto withReviewModules(String reviewModules) {
    ...
    public CommitDiscussionDto withSeverity(SeverityEnum severity) {
    ...
    public CommitDiscussionDto withSeverityCn(String severityCn) {
    ...
    public CommitDiscussionDto withSeverityEn(SeverityEnEnum severityEn) {
    ...
    public CommitDiscussionDto withAssignee(UserBasicDto assignee) {
        this.assignee = assignee;
        return this;
    }

    public CommitDiscussionDto withAssignee(Consumer<UserBasicDto> assigneeSetter) {
    ...
    public CommitDiscussionDto withProposer(UserBasicDto proposer) {
        this.proposer = proposer;
        return this;
    }

    public CommitDiscussionDto withProposer(Consumer<UserBasicDto> proposerSetter) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        CommitDiscussionDto that = (CommitDiscussionDto) obj;
        return Objects.equals(this.id, that.id) && Objects.equals(this.individualNote, that.individualNote)
            ...
            && Objects.equals(this.removedLines, that.removedLines) && Objects.equals(this.resolved, that.resolved)
    ...
    public String toString() {
        ...
        sb.append("class CommitDiscussionDto {\n");
