 ...
 * Response Object
 */
public class ShowMasterResponse extends SdkResponse {
    ...
    public ShowMasterResponse withError(Error error) {
        this.error = error;
        return this;
    }

    public ShowMasterResponse withError(Consumer<Error> errorSetter) {
        if(this.error == null ){
    ...
    public ShowMasterResponse withResult(Boolean result) {
        this.result = result;
        return this;
    }
    ...
    public ShowMasterResponse withStatus(String status) {
        this.status = status;
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append("class ShowMasterResponse {\n");
