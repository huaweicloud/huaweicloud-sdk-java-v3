 ...
 * 仓库合并请求模板返回体
 */
public class RepositoryMergeRequestTemplateDto {
    ...
    public RepositoryMergeRequestTemplateDto withCreatedAt(String createdAt) {
    ...
    public RepositoryMergeRequestTemplateDto withUpdatedAt(String updatedAt) {
    ...
    public RepositoryMergeRequestTemplateDto withTemplateName(String templateName) {
    ...
    public RepositoryMergeRequestTemplateDto withMergeRequestTitle(String mergeRequestTitle) {
    ...
    public RepositoryMergeRequestTemplateDto withIsDefault(Boolean isDefault) {
    ...
    public RepositoryMergeRequestTemplateDto withIsWip(Boolean isWip) {
        this.isWip = isWip;
        return this;
    }
    ...
    public RepositoryMergeRequestTemplateDto withAutoExtractMrTitle(Integer autoExtractMrTitle) {
    ...
    public RepositoryMergeRequestTemplateDto withCreator(UserBasicDto creator) {
        this.creator = creator;
        return this;
    }

    public RepositoryMergeRequestTemplateDto withCreator(Consumer<UserBasicDto> creatorSetter) {
