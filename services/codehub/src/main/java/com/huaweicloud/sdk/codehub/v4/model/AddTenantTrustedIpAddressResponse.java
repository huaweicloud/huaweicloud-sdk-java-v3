...
public class AddTenantTrustedIpAddressResponse extends SdkResponse {
    ...
    public AddTenantTrustedIpAddressResponse withIpType(Integer ipType) {
        this.ipType = ipType;
        return this;
    }
    ...
    public AddTenantTrustedIpAddressResponse withViewFlag(Integer viewFlag) {
    ...
    public AddTenantTrustedIpAddressResponse withDownloadFlag(Integer downloadFlag) {
    ...
    public AddTenantTrustedIpAddressResponse withUploadFlag(Integer uploadFlag) {
    ...
    public AddTenantTrustedIpAddressResponse withOrderFlag(Integer orderFlag) {
