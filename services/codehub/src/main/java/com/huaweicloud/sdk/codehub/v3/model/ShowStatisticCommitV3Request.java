...
public class ShowStatisticCommitV3Request {
    ...
    public ShowStatisticCommitV3Request withRepositoryId(Integer repositoryId) {
    ...
    public ShowStatisticCommitV3Request withRefName(String refName) {
    ...
    public ShowStatisticCommitV3Request withBeginDate(String beginDate) {
    ...
    public ShowStatisticCommitV3Request withEndDate(String endDate) {
