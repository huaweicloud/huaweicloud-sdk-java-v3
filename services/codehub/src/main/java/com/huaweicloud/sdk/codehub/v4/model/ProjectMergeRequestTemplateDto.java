 ...
 * 仓库合并请求模板返回体
 */
public class ProjectMergeRequestTemplateDto {
    ...
    public ProjectMergeRequestTemplateDto withId(Integer id) {
        this.id = id;
        return this;
    }
    ...
    public ProjectMergeRequestTemplateDto withCreatedAt(String createdAt) {
    ...
    public ProjectMergeRequestTemplateDto withUpdatedAt(String updatedAt) {
    ...
    public ProjectMergeRequestTemplateDto withTemplateName(String templateName) {
    ...
    public ProjectMergeRequestTemplateDto withMergeRequestTitle(String mergeRequestTitle) {
    ...
    public ProjectMergeRequestTemplateDto withIsDefault(Boolean isDefault) {
    ...
    public ProjectMergeRequestTemplateDto withIsWip(Boolean isWip) {
        this.isWip = isWip;
        return this;
    }
    ...
    public ProjectMergeRequestTemplateDto withAutoExtractMrTitle(Integer autoExtractMrTitle) {
    ...
    public ProjectMergeRequestTemplateDto withCreator(UserBasicDto creator) {
        this.creator = creator;
        return this;
    }

    public ProjectMergeRequestTemplateDto withCreator(Consumer<UserBasicDto> creatorSetter) {
    ...
    public ProjectMergeRequestTemplateDto withProjectId(String projectId) {
