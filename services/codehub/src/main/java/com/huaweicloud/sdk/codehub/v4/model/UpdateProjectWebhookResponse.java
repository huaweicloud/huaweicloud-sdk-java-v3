 ...
 * Response Object
 */
public class UpdateProjectWebhookResponse extends SdkResponse {
    ...
    public UpdateProjectWebhookResponse withPushEvents(Boolean pushEvents) {
    ...
    public UpdateProjectWebhookResponse withPushEventsBranchRegexFilter(String pushEventsBranchRegexFilter) {
    ...
    public UpdateProjectWebhookResponse withMergeRequestsEvents(Boolean mergeRequestsEvents) {
    ...
    public UpdateProjectWebhookResponse withNoteEvents(Boolean noteEvents) {
    ...
    public UpdateProjectWebhookResponse withToken(String token) {
        this.token = token;
        return this;
    }
    ...
    public UpdateProjectWebhookResponse withTokenType(String tokenType) {
    ...
    public UpdateProjectWebhookResponse withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public UpdateProjectWebhookResponse withDescription(String description) {
    ...
    public UpdateProjectWebhookResponse withCreatedAt(String createdAt) {
    ...
    public UpdateProjectWebhookResponse withUpdatedAt(String updatedAt) {
    ...
    public String toString() {
        ...
        sb.append("class UpdateProjectWebhookResponse {\n");
