...
public class MergeRequestBasicDiscussionDto {
    ...
    public MergeRequestBasicDiscussionDto withRepositoryId(Integer repositoryId) {
    ...
    public MergeRequestBasicDiscussionDto withNoteableType(NoteableTypeEnum noteableType) {
    ...
    public MergeRequestBasicDiscussionDto withRepositoryFullPath(String repositoryFullPath) {
    ...
    public MergeRequestBasicDiscussionDto withSeverity(SeverityEnum severity) {
    ...
    public MergeRequestBasicDiscussionDto withSeverityEn(SeverityEnEnum severityEn) {
