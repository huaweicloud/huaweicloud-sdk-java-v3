 ...
 * Response Object
 */
public class ShowProjectsGeneralPolicyResponse extends SdkResponse {
    ...
    public ShowProjectsGeneralPolicyResponse withDisableFork(Boolean disableFork) {
    ...
    public ShowProjectsGeneralPolicyResponse withForbiddenDeveloperCreateBranch(
    ...
    public ShowProjectsGeneralPolicyResponse withForbiddenDeveloperCreateTag(Boolean forbiddenDeveloperCreateTag) {
    ...
    public ShowProjectsGeneralPolicyResponse withForbiddenCommitterCreateBranch(
        Boolean forbiddenCommitterCreateBranch) {
    ...
    public ShowProjectsGeneralPolicyResponse withBranchNameRegex(String branchNameRegex) {
    ...
    public ShowProjectsGeneralPolicyResponse withTagNameRegex(String tagNameRegex) {
    ...
    public ShowProjectsGeneralPolicyResponse withGeneratePreMergeRef(Boolean generatePreMergeRef) {
    ...
    public ShowProjectsGeneralPolicyResponse withForbiddenGitlabAccess(Boolean forbiddenGitlabAccess) {
    ...
    public ShowProjectsGeneralPolicyResponse withRebaseDisableTriggerWebhook(Boolean rebaseDisableTriggerWebhook) {
    ...
    public ShowProjectsGeneralPolicyResponse withOpenGpgVerified(Boolean openGpgVerified) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ShowProjectsGeneralPolicyResponse that = (ShowProjectsGeneralPolicyResponse) obj;
    ...
    public String toString() {
        ...
        sb.append("class ShowProjectsGeneralPolicyResponse {\n");
