 ...
 * Response Object
 */
public class UpdateMergeRequestDiscussionResponse extends SdkResponse {
    ...
    public UpdateMergeRequestDiscussionResponse withId(Integer id) {
        this.id = id;
        return this;
    }
    ...
    public UpdateMergeRequestDiscussionResponse withType(TypeEnum type) {
        this.type = type;
        return this;
    }
    ...
    public UpdateMergeRequestDiscussionResponse withBody(String body) {
        this.body = body;
        return this;
    }
    ...
    public UpdateMergeRequestDiscussionResponse withAuthor(Consumer<UserBasicDto> authorSetter) {
        if (this.author == null) {
    ...
    public UpdateMergeRequestDiscussionResponse withCreatedAt(String createdAt) {
    ...
    public UpdateMergeRequestDiscussionResponse withUpdatedAt(String updatedAt) {
    ...
    public UpdateMergeRequestDiscussionResponse withSystem(Boolean system) {
        this.system = system;
        return this;
    }
    ...
    public UpdateMergeRequestDiscussionResponse withNoteableId(Integer noteableId) {
    ...
    public UpdateMergeRequestDiscussionResponse withNoteableType(NoteableTypeEnum noteableType) {
    ...
    public UpdateMergeRequestDiscussionResponse withCommitId(String commitId) {
    ...
    public UpdateMergeRequestDiscussionResponse withResolvable(Boolean resolvable) {
    ...
    public UpdateMergeRequestDiscussionResponse withIsReply(Boolean isReply) {
    ...
    public UpdateMergeRequestDiscussionResponse withResolvedBy(UserBasicDto resolvedBy) {
        this.resolvedBy = resolvedBy;
        return this;
    }

    public UpdateMergeRequestDiscussionResponse withResolvedBy(Consumer<UserBasicDto> resolvedBySetter) {
    ...
    public UpdateMergeRequestDiscussionResponse withNoteableIid(Integer noteableIid) {
    ...
    public UpdateMergeRequestDiscussionResponse withDiscussionId(String discussionId) {
    ...
    public UpdateMergeRequestDiscussionResponse withRepository(String repository) {
    ...
    public UpdateMergeRequestDiscussionResponse withDiffFile(String diffFile) {
    ...
    public UpdateMergeRequestDiscussionResponse withDiff(String diff) {
        this.diff = diff;
        return this;
    }
    ...
    public UpdateMergeRequestDiscussionResponse withArchived(Boolean archived) {
    ...
    public UpdateMergeRequestDiscussionResponse withReviewCategories(String reviewCategories) {
    ...
    public UpdateMergeRequestDiscussionResponse withReviewCategoriesCn(String reviewCategoriesCn) {
    ...
    public UpdateMergeRequestDiscussionResponse withReviewCategoriesEn(String reviewCategoriesEn) {
    ...
    public UpdateMergeRequestDiscussionResponse withReviewModules(String reviewModules) {
    ...
    public UpdateMergeRequestDiscussionResponse withSeverity(SeverityEnum severity) {
    ...
    public UpdateMergeRequestDiscussionResponse withSeverityCn(String severityCn) {
    ...
    public UpdateMergeRequestDiscussionResponse withSeverityEn(SeverityEnEnum severityEn) {
    ...
    public UpdateMergeRequestDiscussionResponse withFilePath(String filePath) {
    ...
    public UpdateMergeRequestDiscussionResponse withLine(String line) {
        this.line = line;
        return this;
    }
    ...
    public UpdateMergeRequestDiscussionResponse withAssignee(UserBasicDto assignee) {
        this.assignee = assignee;
        return this;
    }

    public UpdateMergeRequestDiscussionResponse withAssignee(Consumer<UserBasicDto> assigneeSetter) {
    ...
    public UpdateMergeRequestDiscussionResponse withProposer(UserBasicDto proposer) {
        this.proposer = proposer;
        return this;
    }

    public UpdateMergeRequestDiscussionResponse withProposer(Consumer<UserBasicDto> proposerSetter) {
    ...
    public UpdateMergeRequestDiscussionResponse withPosition(PositionDto position) {
        this.position = position;
        return this;
    }

    public UpdateMergeRequestDiscussionResponse withPosition(Consumer<PositionDto> positionSetter) {
    ...
    public UpdateMergeRequestDiscussionResponse withResolved(Boolean resolved) {
    ...
    public UpdateMergeRequestDiscussionResponse withIsOutdated(Boolean isOutdated) {
    ...
    public UpdateMergeRequestDiscussionResponse withModerationTime(Long moderationTime) {
    ...
    public UpdateMergeRequestDiscussionResponse withModerationStatus(Integer moderationStatus) {
    ...
    public String toString() {
        ...
        sb.append("class UpdateMergeRequestDiscussionResponse {\n");
