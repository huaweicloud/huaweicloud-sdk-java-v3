 ...
 * **参数解释：** ip白名单信息。
 */
public class TenantTrustedIpAddressDto {
    ...
    public TenantTrustedIpAddressDto withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public TenantTrustedIpAddressDto withUserId(Integer userId) {
        this.userId = userId;
        return this;
    }
    ...
    public TenantTrustedIpAddressDto withDomainId(String domainId) {
    ...
    public TenantTrustedIpAddressDto withIpRange(String ipRange) {
    ...
    public TenantTrustedIpAddressDto withIpType(IpTypeEnum ipType) {
        this.ipType = ipType;
        return this;
    }
    ...
    public TenantTrustedIpAddressDto withIpStart(String ipStart) {
    ...
    public TenantTrustedIpAddressDto withIpEnd(String ipEnd) {
        this.ipEnd = ipEnd;
        return this;
    }
    ...
    public TenantTrustedIpAddressDto withViewFlag(ViewFlagEnum viewFlag) {
    ...
    public TenantTrustedIpAddressDto withDownloadFlag(DownloadFlagEnum downloadFlag) {
    ...
    public TenantTrustedIpAddressDto withUploadFlag(UploadFlagEnum uploadFlag) {
    ...
    public TenantTrustedIpAddressDto withRemark(String remark) {
        this.remark = remark;
        return this;
    }
    ...
    public TenantTrustedIpAddressDto withCreatedAt(String createdAt) {
    ...
    public TenantTrustedIpAddressDto withUpdatedAt(String updatedAt) {
    ...
    public TenantTrustedIpAddressDto withOrderFlag(OrderFlagEnum orderFlag) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        TenantTrustedIpAddressDto that = (TenantTrustedIpAddressDto) obj;
    ...
    public String toString() {
        ...
        sb.append("class TenantTrustedIpAddressDto {\n");
