...
public class TenantTrustedIpAddressDto {
    ...
    public TenantTrustedIpAddressDto withIpType(Integer ipType) {
        this.ipType = ipType;
        return this;
    }
    ...
    public TenantTrustedIpAddressDto withViewFlag(Integer viewFlag) {
    ...
    public TenantTrustedIpAddressDto withDownloadFlag(Integer downloadFlag) {
    ...
    public TenantTrustedIpAddressDto withUploadFlag(Integer uploadFlag) {
    ...
    public TenantTrustedIpAddressDto withOrderFlag(Integer orderFlag) {
