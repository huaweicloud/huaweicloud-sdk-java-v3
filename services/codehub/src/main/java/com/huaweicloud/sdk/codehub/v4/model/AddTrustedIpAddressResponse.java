...
public class AddTrustedIpAddressResponse extends SdkResponse {
    ...
    public AddTrustedIpAddressResponse withIpType(Integer ipType) {
        this.ipType = ipType;
        return this;
    }
    ...
    public AddTrustedIpAddressResponse withViewFlag(Integer viewFlag) {
    ...
    public AddTrustedIpAddressResponse withDownloadFlag(Integer downloadFlag) {
    ...
    public AddTrustedIpAddressResponse withUploadFlag(Integer uploadFlag) {
    ...
    public AddTrustedIpAddressResponse withOrderFlag(Integer orderFlag) {
