...
public class AddTrustedIpAddressResponse extends SdkResponse {
    ...
    public AddTrustedIpAddressResponse withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public AddTrustedIpAddressResponse withRepositoryId(Integer repositoryId) {
    ...
    public AddTrustedIpAddressResponse withIpRange(String ipRange) {
    ...
    public AddTrustedIpAddressResponse withIpType(IpTypeEnum ipType) {
        this.ipType = ipType;
        return this;
    }
    ...
    public AddTrustedIpAddressResponse withIpStart(String ipStart) {
    ...
    public AddTrustedIpAddressResponse withIpEnd(String ipEnd) {
        this.ipEnd = ipEnd;
        return this;
    }
    ...
    public AddTrustedIpAddressResponse withViewFlag(ViewFlagEnum viewFlag) {
    ...
    public AddTrustedIpAddressResponse withDownloadFlag(DownloadFlagEnum downloadFlag) {
    ...
    public AddTrustedIpAddressResponse withUploadFlag(UploadFlagEnum uploadFlag) {
    ...
    public AddTrustedIpAddressResponse withRemark(String remark) {
        this.remark = remark;
        return this;
    }
    ...
    public AddTrustedIpAddressResponse withCreatedAt(String createdAt) {
    ...
    public AddTrustedIpAddressResponse withUpdatedAt(String updatedAt) {
    ...
    public AddTrustedIpAddressResponse withOrderFlag(OrderFlagEnum orderFlag) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        AddTrustedIpAddressResponse that = (AddTrustedIpAddressResponse) obj;
