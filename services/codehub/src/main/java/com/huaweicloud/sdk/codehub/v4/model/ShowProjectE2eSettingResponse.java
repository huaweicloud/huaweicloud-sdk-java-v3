 ...
 * Response Object
 */
public class ShowProjectE2eSettingResponse extends SdkResponse {
    ...
    public ShowProjectE2eSettingResponse withE2ePolicies(E2ePolicyDto e2ePolicies) {
        this.e2ePolicies = e2ePolicies;
        return this;
    }

    public ShowProjectE2eSettingResponse withE2ePolicies(Consumer<E2ePolicyDto> e2ePoliciesSetter) {
    ...
    public ShowProjectE2eSettingResponse withReq(ReqSettingDto req) {
        this.req = req;
        return this;
    }

    public ShowProjectE2eSettingResponse withReq(Consumer<ReqSettingDto> reqSetter) {
        if (this.req == null) {
    ...
    public ShowProjectE2eSettingResponse withLink(LinkSettingDto link) {
        this.link = link;
        return this;
    }

    public ShowProjectE2eSettingResponse withLink(Consumer<LinkSettingDto> linkSetter) {
        if (this.link == null) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ShowProjectE2eSettingResponse that = (ShowProjectE2eSettingResponse) obj;
