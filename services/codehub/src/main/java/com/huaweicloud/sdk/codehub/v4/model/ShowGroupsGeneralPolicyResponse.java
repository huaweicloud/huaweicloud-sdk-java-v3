 ...
 * Response Object
 */
public class ShowGroupsGeneralPolicyResponse extends SdkResponse {
    ...
    public ShowGroupsGeneralPolicyResponse withDisableFork(Boolean disableFork) {
    ...
    public ShowGroupsGeneralPolicyResponse withForbiddenDeveloperCreateBranch(Boolean forbiddenDeveloperCreateBranch) {
    ...
    public ShowGroupsGeneralPolicyResponse withForbiddenDeveloperCreateTag(Boolean forbiddenDeveloperCreateTag) {
    ...
    public ShowGroupsGeneralPolicyResponse withForbiddenCommitterCreateBranch(Boolean forbiddenCommitterCreateBranch) {
    ...
    public ShowGroupsGeneralPolicyResponse withBranchNameRegex(String branchNameRegex) {
    ...
    public ShowGroupsGeneralPolicyResponse withTagNameRegex(String tagNameRegex) {
    ...
    public ShowGroupsGeneralPolicyResponse withGeneratePreMergeRef(Boolean generatePreMergeRef) {
    ...
    public ShowGroupsGeneralPolicyResponse withForbiddenGitlabAccess(Boolean forbiddenGitlabAccess) {
    ...
    public ShowGroupsGeneralPolicyResponse withRebaseDisableTriggerWebhook(Boolean rebaseDisableTriggerWebhook) {
    ...
    public ShowGroupsGeneralPolicyResponse withOpenGpgVerified(Boolean openGpgVerified) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ShowGroupsGeneralPolicyResponse that = (ShowGroupsGeneralPolicyResponse) obj;
