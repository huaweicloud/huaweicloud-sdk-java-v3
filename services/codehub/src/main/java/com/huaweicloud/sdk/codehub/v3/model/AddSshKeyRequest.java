...
public class AddSshKeyRequest  {
    ...
    private PublicKey body = null;

    public AddSshKeyRequest withBody(PublicKey body) {
        this.body = body;
        return this;
    }

    public AddSshKeyRequest withBody(Consumer<PublicKey> bodySetter) {
        if(this.body == null ){
            this.body = new PublicKey();
