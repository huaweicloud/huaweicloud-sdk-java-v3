 ...
 * Response Object
 */
public class UpdateProjectGeneralPolicyResponse extends SdkResponse {
    ...
    public UpdateProjectGeneralPolicyResponse withDisableFork(Boolean disableFork) {
    ...
    public UpdateProjectGeneralPolicyResponse withBranchNameRegex(String branchNameRegex) {
    ...
    public UpdateProjectGeneralPolicyResponse withTagNameRegex(String tagNameRegex) {
    ...
    public UpdateProjectGeneralPolicyResponse withGeneratePreMergeRef(Boolean generatePreMergeRef) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        UpdateProjectGeneralPolicyResponse that = (UpdateProjectGeneralPolicyResponse) obj;
    ...
    public String toString() {
        ...
        sb.append("class UpdateProjectGeneralPolicyResponse {\n");
