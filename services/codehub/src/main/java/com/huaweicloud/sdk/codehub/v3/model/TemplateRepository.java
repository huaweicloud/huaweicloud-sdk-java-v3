...
public class TemplateRepository  {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        return Objects.equals(this.id, templateRepository.id) &&
            Objects.equals(this.name, templateRepository.name) &&
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, name, templateName, tags, description, briefIntroduction, autoPendingPipelines, language, createdAt, usedTimes, likedTimes, creatorName, httpsUrl);
    }
    @Override
