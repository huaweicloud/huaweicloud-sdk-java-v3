...
public class Commit  {
    ...
    private OffsetDateTime authoredDate = null;


    @JsonInclude(JsonInclude.Include.NON_NULL)
    @JsonProperty(value="committed_date")
    
    private OffsetDateTime committedDate = null;
    ...
    public boolean equals(java.lang.Object o) {
        ...
        return Objects.equals(this.authorEmail, commit.authorEmail) &&
            ...
            Objects.equals(this.committerName, commit.committerName) &&
            Objects.equals(this.format, commit.format) &&
    ...
    @Override
    public int hashCode() {
        return Objects.hash(authorEmail, authorName, authoredDate, committedDate, committerEmail, committerName, format, id, message, parentIds);
    }
    @Override
