...
public class UpdateNotificationSubscriptionRequest {
    ...
    private UpdateRepoNotificationSubscriptionDto body;

    public UpdateNotificationSubscriptionRequest withRepositoryId(Integer repositoryId) {
    ...
    public UpdateNotificationSubscriptionRequest withType(TypeEnum type) {
        this.type = type;
        return this;
    }
    ...
    public UpdateNotificationSubscriptionRequest withBody(UpdateRepoNotificationSubscriptionDto body) {
        this.body = body;
        return this;
    }

    public UpdateNotificationSubscriptionRequest withBody(Consumer<UpdateRepoNotificationSubscriptionDto> bodySetter) {
        if (this.body == null) {
            this.body = new UpdateRepoNotificationSubscriptionDto();
     ...
     * @return body
     */
    public UpdateRepoNotificationSubscriptionDto getBody() {
        return body;
    }

    public void setBody(UpdateRepoNotificationSubscriptionDto body) {
        this.body = body;
    }
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        UpdateNotificationSubscriptionRequest that = (UpdateNotificationSubscriptionRequest) obj;
    ...
    @Override
    public int hashCode() {
        return Objects.hash(repositoryId, type, body);
    }
