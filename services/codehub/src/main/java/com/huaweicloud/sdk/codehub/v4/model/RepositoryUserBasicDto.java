...
public class RepositoryUserBasicDto {
    ...
    public RepositoryUserBasicDto withId(Integer id) {
        this.id = id;
        return this;
    }
    ...
    public RepositoryUserBasicDto withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public RepositoryUserBasicDto withUsername(String username) {
    ...
    public RepositoryUserBasicDto withState(StateEnum state) {
        this.state = state;
        return this;
    }
    ...
    public RepositoryUserBasicDto withServiceLicenseStatus(Integer serviceLicenseStatus) {
    ...
    public RepositoryUserBasicDto withNameCn(String nameCn) {
        this.nameCn = nameCn;
        return this;
    }
    ...
    public RepositoryUserBasicDto withNickName(String nickName) {
    ...
    public RepositoryUserBasicDto withTenantName(String tenantName) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        RepositoryUserBasicDto that = (RepositoryUserBasicDto) obj;
        return Objects.equals(this.id, that.id) && Objects.equals(this.name, that.name)
            ...
            && Objects.equals(this.nameCn, that.nameCn) && Objects.equals(this.nickName, that.nickName)
            && Objects.equals(this.tenantName, that.tenantName);
    }

    @Override
    public int hashCode() {
        return Objects.hash(id, name, username, state, serviceLicenseStatus, nameCn, nickName, tenantName);
    }
