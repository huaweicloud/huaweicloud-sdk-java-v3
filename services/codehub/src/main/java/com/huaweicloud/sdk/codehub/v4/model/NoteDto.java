...
public class NoteDto {
    ...
    public NoteDto withType(TypeEnum type) {
        this.type = type;
        return this;
    }
    ...
    public NoteDto withNoteableType(NoteableTypeEnum noteableType) {
    ...
    public NoteDto withRepository(String repository) {
    ...
    public NoteDto withSeverity(SeverityEnum severity) {
    ...
    public NoteDto withSeverityEn(SeverityEnEnum severityEn) {
    ...
    public NoteDto withModerationTime(Long moderationTime) {
    ...
    public NoteDto withModerationStatus(Integer moderationStatus) {
