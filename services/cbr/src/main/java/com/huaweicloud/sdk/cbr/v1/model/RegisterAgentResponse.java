...
public class RegisterAgentResponse extends SdkResponse {
    ...
    public RegisterAgentResponse withAgent(Agent agent) {
        this.agent = agent;
        return this;
    }

    public RegisterAgentResponse withAgent(Consumer<Agent> agentSetter) {
        if (this.agent == null) {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        return Objects.equals(this.agent, registerAgentResponse.agent);
    }
