...
public class ResponseEipInfo {
    ...
    public ResponseEipInfo withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public ResponseEipInfo withIpVersion(Integer ipVersion) {
    ...
    public ResponseEipInfo withIpBillingInfo(String ipBillingInfo) {
    ...
    public ResponseEipInfo withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public ResponseEipInfo withIpAddress(String ipAddress) {
    ...
    public ResponseEipInfo withChargeMode(ChargeModeEnum chargeMode) {
    ...
    public ResponseEipInfo withBandwidthId(String bandwidthId) {
    ...
    public ResponseEipInfo withBandwidthSize(Integer bandwidthSize) {
    ...
    public ResponseEipInfo withBandwidthName(String bandwidthName) {
    ...
    public ResponseEipInfo withBandwidthBillingInfo(String bandwidthBillingInfo) {
    ...
    public ResponseEipInfo withShareType(String shareType) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ResponseEipInfo that = (ResponseEipInfo) obj;
    ...
    public String toString() {
        ...
        sb.append("class ResponseEipInfo {\n");
