 ...
 */
public class UpdateResponseVpnConnection {
    ...
    public UpdateResponseVpnConnection withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public UpdateResponseVpnConnection withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public UpdateResponseVpnConnection withVgwId(String vgwId) {
        this.vgwId = vgwId;
        return this;
    }
    ...
    public UpdateResponseVpnConnection withVgwIp(String vgwIp) {
        this.vgwIp = vgwIp;
        return this;
    }
    ...
    public UpdateResponseVpnConnection withStyle(StyleEnum style) {
        this.style = style;
        return this;
    }
    ...
    public UpdateResponseVpnConnection withCgwId(String cgwId) {
        this.cgwId = cgwId;
        return this;
    }
    ...
    public UpdateResponseVpnConnection withPeerSubnets(List<String> peerSubnets) {
        this.peerSubnets = peerSubnets;
        return this;
    }

    public UpdateResponseVpnConnection addPeerSubnetsItem(String peerSubnetsItem) {
    ...
    public UpdateResponseVpnConnection withPeerSubnets(Consumer<List<String>> peerSubnetsSetter) {
        if (this.peerSubnets == null) {
            this.peerSubnets = new ArrayList<>();
        }
    ...
    public UpdateResponseVpnConnection withTunnelLocalAddress(String tunnelLocalAddress) {
    ...
    public UpdateResponseVpnConnection withTunnelPeerAddress(String tunnelPeerAddress) {
    ...
    public UpdateResponseVpnConnection withEnableNqa(Boolean enableNqa) {
    ...
    public UpdateResponseVpnConnection withEnableHub(Boolean enableHub) {
    ...
    public UpdateResponseVpnConnection withPolicyRules(List<PolicyRule> policyRules) {
        this.policyRules = policyRules;
        return this;
    }

    public UpdateResponseVpnConnection addPolicyRulesItem(PolicyRule policyRulesItem) {
    ...
    public UpdateResponseVpnConnection withPolicyRules(Consumer<List<PolicyRule>> policyRulesSetter) {
        if (this.policyRules == null) {
            this.policyRules = new ArrayList<>();
        }
    ...
    public UpdateResponseVpnConnection withIkepolicy(IkePolicy ikepolicy) {
        this.ikepolicy = ikepolicy;
        return this;
    }

    public UpdateResponseVpnConnection withIkepolicy(Consumer<IkePolicy> ikepolicySetter) {
    ...
    public UpdateResponseVpnConnection withIpsecpolicy(IpsecPolicy ipsecpolicy) {
        this.ipsecpolicy = ipsecpolicy;
        return this;
    }

    public UpdateResponseVpnConnection withIpsecpolicy(Consumer<IpsecPolicy> ipsecpolicySetter) {
    ...
    public UpdateResponseVpnConnection withCreatedAt(String createdAt) {
    ...
    public UpdateResponseVpnConnection withUpdatedAt(String updatedAt) {
    ...
    public UpdateResponseVpnConnection withEnterpriseProjectId(String enterpriseProjectId) {
    ...
    public UpdateResponseVpnConnection withConnectionMonitorId(String connectionMonitorId) {
    ...
    public UpdateResponseVpnConnection withHaRole(String haRole) {
        this.haRole = haRole;
        return this;
    }
    ...
    public UpdateResponseVpnConnection withTags(List<VpnResourceTag> tags) {
        this.tags = tags;
        return this;
    }

    public UpdateResponseVpnConnection addTagsItem(VpnResourceTag tagsItem) {
        if (this.tags == null) {
    ...
    public UpdateResponseVpnConnection withTags(Consumer<List<VpnResourceTag>> tagsSetter) {
        if (this.tags == null) {
            this.tags = new ArrayList<>();
        }
    ...
    public UpdateResponseVpnConnection withPeerSubnetsV6(List<String> peerSubnetsV6) {
        this.peerSubnetsV6 = peerSubnetsV6;
        return this;
    }

    public UpdateResponseVpnConnection addPeerSubnetsV6Item(String peerSubnetsV6Item) {
    ...
    public UpdateResponseVpnConnection withPeerSubnetsV6(Consumer<List<String>> peerSubnetsV6Setter) {
        if (this.peerSubnetsV6 == null) {
            this.peerSubnetsV6 = new ArrayList<>();
        }
    ...
    public UpdateResponseVpnConnection withTunnelLocalAddressV6(String tunnelLocalAddressV6) {
    ...
    public UpdateResponseVpnConnection withTunnelPeerAddressV6(String tunnelPeerAddressV6) {
    ...
    public UpdateResponseVpnConnection withPolicyRulesV6(List<PolicyRule> policyRulesV6) {
        this.policyRulesV6 = policyRulesV6;
        return this;
    }

    public UpdateResponseVpnConnection addPolicyRulesV6Item(PolicyRule policyRulesV6Item) {
    ...
    public UpdateResponseVpnConnection withPolicyRulesV6(Consumer<List<PolicyRule>> policyRulesV6Setter) {
        if (this.policyRulesV6 == null) {
            this.policyRulesV6 = new ArrayList<>();
        }
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        UpdateResponseVpnConnection that = (UpdateResponseVpnConnection) obj;
    ...
    public String toString() {
        ...
        sb.append("class UpdateResponseVpnConnection {\n");
