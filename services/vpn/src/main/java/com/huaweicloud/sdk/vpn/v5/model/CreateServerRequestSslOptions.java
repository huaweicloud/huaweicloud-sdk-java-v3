 ...
 */
public class CreateServerRequestSslOptions {
    ...
    public CreateServerRequestSslOptions withProtocol(ProtocolEnum protocol) {
    ...
    public CreateServerRequestSslOptions withPort(PortEnum port) {
        this.port = port;
        return this;
    }
    ...
    public CreateServerRequestSslOptions withEncryptionAlgorithm(EncryptionAlgorithmEnum encryptionAlgorithm) {
    ...
    public CreateServerRequestSslOptions withIsCompressed(Boolean isCompressed) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        CreateServerRequestSslOptions that = (CreateServerRequestSslOptions) obj;
    ...
    @Override
    public int hashCode() {
        return Objects.hash(protocol, port, encryptionAlgorithm, isCompressed);
    }

    @Override
    public String toString() {
        StringBuilder sb = new StringBuilder();
        sb.append("class CreateServerRequestSslOptions {\n");
