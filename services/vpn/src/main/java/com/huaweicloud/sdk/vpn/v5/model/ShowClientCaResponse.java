 ...
 * Response Object
 */
public class ShowClientCaResponse extends SdkResponse {

    @JsonInclude(JsonInclude.Include.NON_NULL)
    @JsonProperty(value = "client_ca_certificate")

    private QueryClientCaCertificateBody clientCaCertificate;
    ...
    public ShowClientCaResponse withClientCaCertificate(QueryClientCaCertificateBody clientCaCertificate) {
        this.clientCaCertificate = clientCaCertificate;
        return this;
    }

    public ShowClientCaResponse withClientCaCertificate(
        Consumer<QueryClientCaCertificateBody> clientCaCertificateSetter) {
        if (this.clientCaCertificate == null) {
            this.clientCaCertificate = new QueryClientCaCertificateBody();
     ...
     */
    public QueryClientCaCertificateBody getClientCaCertificate() {
        return clientCaCertificate;
    }

    public void setClientCaCertificate(QueryClientCaCertificateBody clientCaCertificate) {
        this.clientCaCertificate = clientCaCertificate;
    }

    public ShowClientCaResponse withRequestId(String requestId) {
    ...
    public ShowClientCaResponse withHeaderResponseToken(String headerResponseToken) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ShowClientCaResponse that = (ShowClientCaResponse) obj;
    ...
    public String toString() {
        ...
        sb.append("class ShowClientCaResponse {\n");
