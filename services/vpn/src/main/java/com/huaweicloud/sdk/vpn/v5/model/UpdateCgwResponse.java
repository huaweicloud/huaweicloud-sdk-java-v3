 ...
 * Response Object
 */
public class UpdateCgwResponse extends SdkResponse {
    ...
    public UpdateCgwResponse withCustomerGateway(ResponseCustomerGateway customerGateway) {
        this.customerGateway = customerGateway;
        return this;
    }

    public UpdateCgwResponse withCustomerGateway(Consumer<ResponseCustomerGateway> customerGatewaySetter) {
    ...
    public UpdateCgwResponse withRequestId(String requestId) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        UpdateCgwResponse that = (UpdateCgwResponse) obj;
    ...
    @Override
    public int hashCode() {
        return Objects.hash(customerGateway, requestId);
    }

    @Override
    public String toString() {
        StringBuilder sb = new StringBuilder();
        sb.append("class UpdateCgwResponse {\n");
