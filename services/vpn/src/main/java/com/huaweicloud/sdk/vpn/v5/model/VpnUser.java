...
public class VpnUser {
    ...
    public VpnUser withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public VpnUser withDescription(String description) {
    ...
    public VpnUser withUserGroupId(String userGroupId) {
    ...
    public VpnUser withUserGroupName(String userGroupName) {
    ...
    public VpnUser withCreatedAt(OffsetDateTime createdAt) {
    ...
    public VpnUser withUpdatedAt(OffsetDateTime updatedAt) {
