 ...
 * Response Object
 */
public class UpdateVgwResponse extends SdkResponse {
    ...
    public UpdateVgwResponse withVpnGateway(UpdateResponseVpnGateway vpnGateway) {
        this.vpnGateway = vpnGateway;
        return this;
    }

    public UpdateVgwResponse withVpnGateway(Consumer<UpdateResponseVpnGateway> vpnGatewaySetter) {
    ...
    public UpdateVgwResponse withRequestId(String requestId) {
    ...
    public UpdateVgwResponse withHeaderResponseToken(String headerResponseToken) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        UpdateVgwResponse that = (UpdateVgwResponse) obj;
    ...
    public String toString() {
        ...
        sb.append("class UpdateVgwResponse {\n");
