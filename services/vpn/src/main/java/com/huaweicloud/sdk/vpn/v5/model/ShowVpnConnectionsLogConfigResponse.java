 ...
 * Response Object
 */
public class ShowVpnConnectionsLogConfigResponse extends SdkResponse {
    ...
    public ShowVpnConnectionsLogConfigResponse withLogConfig(ConnectionsLogConfig logConfig) {
        this.logConfig = logConfig;
        return this;
    }

    public ShowVpnConnectionsLogConfigResponse withLogConfig(Consumer<ConnectionsLogConfig> logConfigSetter) {
    ...
    public ShowVpnConnectionsLogConfigResponse withRequestId(String requestId) {
    ...
    public ShowVpnConnectionsLogConfigResponse withHeaderResponseToken(String headerResponseToken) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ShowVpnConnectionsLogConfigResponse that = (ShowVpnConnectionsLogConfigResponse) obj;
    ...
    public String toString() {
        ...
        sb.append("class ShowVpnConnectionsLogConfigResponse {\n");
