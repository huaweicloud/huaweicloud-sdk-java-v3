 ...
 * Request Object
 */
public class CreateVpnUserRequest {
    ...
    private CreateVpnUserRequestBody body;

    public CreateVpnUserRequest withVpnServerId(String vpnServerId) {
    ...
    public CreateVpnUserRequest withXClientToken(String xClientToken) {
    ...
    public CreateVpnUserRequest withBody(CreateVpnUserRequestBody body) {
        this.body = body;
        return this;
    }

    public CreateVpnUserRequest withBody(Consumer<CreateVpnUserRequestBody> bodySetter) {
        if (this.body == null) {
            this.body = new CreateVpnUserRequestBody();
     ...
     * @return body
     */
    public CreateVpnUserRequestBody getBody() {
        return body;
    }

    public void setBody(CreateVpnUserRequestBody body) {
        this.body = body;
    }
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        CreateVpnUserRequest that = (CreateVpnUserRequest) obj;
    ...
    public String toString() {
        ...
        sb.append("class CreateVpnUserRequest {\n");
