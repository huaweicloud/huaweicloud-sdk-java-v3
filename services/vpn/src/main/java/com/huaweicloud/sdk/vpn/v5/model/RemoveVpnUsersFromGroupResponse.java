 ...
 * Response Object
 */
public class RemoveVpnUsersFromGroupResponse extends SdkResponse {
    ...
    public RemoveVpnUsersFromGroupResponse withRequestId(String requestId) {
    ...
    public RemoveVpnUsersFromGroupResponse withHeaderResponseToken(String headerResponseToken) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        RemoveVpnUsersFromGroupResponse that = (RemoveVpnUsersFromGroupResponse) obj;
    ...
    @Override
    public int hashCode() {
        return Objects.hash(requestId, headerResponseToken);
    }

    @Override
    public String toString() {
        StringBuilder sb = new StringBuilder();
        sb.append("class RemoveVpnUsersFromGroupResponse {\n");
