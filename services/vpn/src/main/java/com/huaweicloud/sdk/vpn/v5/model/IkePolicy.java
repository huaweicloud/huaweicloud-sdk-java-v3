...
public class IkePolicy {
    ...
    public static final class AuthenticationMethodEnum {
        ...
        /**
         * Enum PRE_SHARE for value: "pre-share"
         */
        public static final AuthenticationMethodEnum PRE_SHARE = new AuthenticationMethodEnum("pre-share");

        /**
         * Enum DIGITAL_ENVELOPE_V2 for value: "digital-envelope-v2"
         */
        public static final AuthenticationMethodEnum DIGITAL_ENVELOPE_V2 =
            new AuthenticationMethodEnum("digital-envelope-v2");
        ...
        private static Map<String, AuthenticationMethodEnum> createStaticFields() {
            ...
            map.put("pre-share", PRE_SHARE);
            map.put("digital-envelope-v2", DIGITAL_ENVELOPE_V2);
            return Collections.unmodifiableMap(map);
        }
    ...
    public IkePolicy withIkeVersion(IkeVersionEnum ikeVersion) {
    ...
    public IkePolicy withPhase1NegotiationMode(Phase1NegotiationModeEnum phase1NegotiationMode) {
    ...
    public IkePolicy withAuthenticationAlgorithm(AuthenticationAlgorithmEnum authenticationAlgorithm) {
    ...
    public IkePolicy withEncryptionAlgorithm(EncryptionAlgorithmEnum encryptionAlgorithm) {
    ...
    public IkePolicy withDhGroup(String dhGroup) {
    ...
    public IkePolicy withAuthenticationMethod(AuthenticationMethodEnum authenticationMethod) {
    ...
    public IkePolicy withLifetimeSeconds(Integer lifetimeSeconds) {
    ...
    public IkePolicy withLocalIdType(LocalIdTypeEnum localIdType) {
    ...
    public IkePolicy withLocalId(String localId) {
    ...
    public IkePolicy withPeerIdType(PeerIdTypeEnum peerIdType) {
    ...
    public IkePolicy withPeerId(String peerId) {
        this.peerId = peerId;
        return this;
    }
    ...
    public IkePolicy withDpd(Dpd dpd) {
        this.dpd = dpd;
        return this;
    }

    public IkePolicy withDpd(Consumer<Dpd> dpdSetter) {
        if (this.dpd == null) {
            this.dpd = new Dpd();
