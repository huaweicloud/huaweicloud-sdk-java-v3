 ...
 * Response Object
 */
public class ShowVpnConnectionResponse extends SdkResponse {

    @JsonInclude(JsonInclude.Include.NON_NULL)
    @JsonProperty(value = "vpn_connection")

    private ResponseVpnConnection vpnConnection;
    ...
    public ShowVpnConnectionResponse withVpnConnection(ResponseVpnConnection vpnConnection) {
        this.vpnConnection = vpnConnection;
        return this;
    }

    public ShowVpnConnectionResponse withVpnConnection(Consumer<ResponseVpnConnection> vpnConnectionSetter) {
        if (this.vpnConnection == null) {
            this.vpnConnection = new ResponseVpnConnection();
     ...
     */
    public ResponseVpnConnection getVpnConnection() {
        return vpnConnection;
    }

    public void setVpnConnection(ResponseVpnConnection vpnConnection) {
        this.vpnConnection = vpnConnection;
    }

    public ShowVpnConnectionResponse withRequestId(String requestId) {
    ...
    public ShowVpnConnectionResponse withHeaderResponseToken(String headerResponseToken) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ShowVpnConnectionResponse that = (ShowVpnConnectionResponse) obj;
    ...
    public String toString() {
        ...
        sb.append("class ShowVpnConnectionResponse {\n");
