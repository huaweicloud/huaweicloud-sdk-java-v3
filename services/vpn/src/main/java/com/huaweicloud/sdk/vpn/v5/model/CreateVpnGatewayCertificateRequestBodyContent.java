 ...
 */
public class CreateVpnGatewayCertificateRequestBodyContent {
    ...
    public CreateVpnGatewayCertificateRequestBodyContent withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public CreateVpnGatewayCertificateRequestBodyContent withCertificate(String certificate) {
    ...
    public CreateVpnGatewayCertificateRequestBodyContent withPrivateKey(String privateKey) {
    ...
    public CreateVpnGatewayCertificateRequestBodyContent withCertificateChain(String certificateChain) {
    ...
    public CreateVpnGatewayCertificateRequestBodyContent withEncCertificate(String encCertificate) {
    ...
    public CreateVpnGatewayCertificateRequestBodyContent withEncPrivateKey(String encPrivateKey) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        CreateVpnGatewayCertificateRequestBodyContent that = (CreateVpnGatewayCertificateRequestBodyContent) obj;
    ...
    public String toString() {
        ...
        sb.append("class CreateVpnGatewayCertificateRequestBodyContent {\n");
