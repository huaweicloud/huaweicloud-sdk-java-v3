 ...
 * Response Object
 */
public class UpdateVpnUserResponse extends SdkResponse {
    ...
    public UpdateVpnUserResponse withUser(VpnUser user) {
        this.user = user;
        return this;
    }

    public UpdateVpnUserResponse withUser(Consumer<VpnUser> userSetter) {
        if (this.user == null) {
    ...
    public UpdateVpnUserResponse withRequestId(String requestId) {
    ...
    public UpdateVpnUserResponse withHeaderResponseToken(String headerResponseToken) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        UpdateVpnUserResponse that = (UpdateVpnUserResponse) obj;
    ...
    public String toString() {
        ...
        sb.append("class UpdateVpnUserResponse {\n");
