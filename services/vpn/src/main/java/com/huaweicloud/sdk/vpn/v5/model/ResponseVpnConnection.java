...
public class ResponseVpnConnection {
    ...
    public ResponseVpnConnection withTunnelLocalAddressV6(String tunnelLocalAddressV6) {
    ...
    public ResponseVpnConnection withTunnelPeerAddressV6(String tunnelPeerAddressV6) {
