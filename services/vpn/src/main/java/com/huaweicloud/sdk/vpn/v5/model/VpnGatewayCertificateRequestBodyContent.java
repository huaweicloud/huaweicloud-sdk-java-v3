 ...
 */
public class VpnGatewayCertificateRequestBodyContent {
    ...
    public VpnGatewayCertificateRequestBodyContent withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public VpnGatewayCertificateRequestBodyContent withCertificate(String certificate) {
    ...
    public VpnGatewayCertificateRequestBodyContent withPrivateKey(String privateKey) {
    ...
    public VpnGatewayCertificateRequestBodyContent withCertificateChain(String certificateChain) {
    ...
    public VpnGatewayCertificateRequestBodyContent withEncCertificate(String encCertificate) {
    ...
    public VpnGatewayCertificateRequestBodyContent withEncPrivateKey(String encPrivateKey) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        VpnGatewayCertificateRequestBodyContent that = (VpnGatewayCertificateRequestBodyContent) obj;
    ...
    public String toString() {
        ...
        sb.append("class VpnGatewayCertificateRequestBodyContent {\n");
