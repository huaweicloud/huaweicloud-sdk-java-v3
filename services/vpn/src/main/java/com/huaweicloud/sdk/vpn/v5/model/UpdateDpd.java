...
public class UpdateDpd {
    ...
    public UpdateDpd withInterval(Integer interval) {
    ...
    public UpdateDpd withTimeout(Integer timeout) {
    ...
    public UpdateDpd withMsg(MsgEnum msg) {
        this.msg = msg;
        return this;
    }
