package com.huaweicloud.sdk.vpn.v5.region;
...
public class VpnRegion {
    ...
    public static final Region CN_NORTH_4 = new Region("cn-north-4", "https://vpn.cn-north-4.myhuaweicloud.com");

    public static final Region CN_NORTH_1 = new Region("cn-north-1", "https://vpn.cn-north-1.myhuaweicloud.com");

    public static final Region CN_EAST_2 = new Region("cn-east-2", "https://vpn.cn-east-2.myhuaweicloud.com");

    public static final Region CN_EAST_3 = new Region("cn-east-3", "https://vpn.cn-east-3.myhuaweicloud.com");

    public static final Region CN_SOUTH_1 = new Region("cn-south-1", "https://vpn.cn-south-1.myhuaweicloud.com");

    public static final Region AP_SOUTHEAST_2 =
        new Region("ap-southeast-2", "https://vpn.ap-southeast-2.myhuaweicloud.com");

    public static final Region AP_SOUTHEAST_3 =
        new Region("ap-southeast-3", "https://vpn.ap-southeast-3.myhuaweicloud.com");
    ...
    public static final Region LA_NORTH_2 = new Region("la-north-2", "https://vpn.la-north-2.myhuaweicloud.com");

    public static final Region CN_NORTH_9 = new Region("cn-north-9", "https://vpn.cn-north-9.myhuaweicloud.com");
    ...
    public static final Region CN_SOUTH_4 = new Region("cn-south-4", "https://vpn.cn-south-4.myhuaweicloud.com");

    public static final Region CN_NORTH_12 = new Region("cn-north-12", "https://vpn.cn-north-12.myhuaweicloud.com");

    public static final Region CN_EAST_4 = new Region("cn-east-4", "https://vpn.cn-east-4.myhuaweicloud.com");

    public static final Region CN_SOUTHWEST_3 =
        new Region("cn-southwest-3", "https://vpn.cn-southwest-3.myhuaweicloud.com");

    public static final Region CN_SOUTH_2 = new Region("cn-south-2", "https://vpn.cn-south-2.myhuaweicloud.com");

    public static final Region CN_NORTH_2 = new Region("cn-north-2", "https://vpn.cn-north-2.myhuaweicloud.com");

    public static final Region CN_NORTH_11 = new Region("cn-north-11", "https://vpn.cn-north-11.myhuaweicloud.com");

    public static final Region AP_SOUTHEAST_5 =
        new Region("ap-southeast-5", "https://vpn.ap-southeast-5.myhuaweicloud.com");

    public static final Region AF_NORTH_1 = new Region("af-north-1", "https://vpn.af-north-1.myhuaweicloud.com");
    ...
    public static Region valueOf(String regionId) {
        ...
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "region id '%s' is not in the following supported regions of service VPN: [%s]",
            regionId,
