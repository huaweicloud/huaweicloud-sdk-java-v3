 ...
 * Response Object
 */
public class CreateVgwResponse extends SdkResponse {

    @JsonInclude(JsonInclude.Include.NON_NULL)
    @JsonProperty(value = "vpn_gateway")

    private CreateResponseVpnGateway vpnGateway;
    ...
    public CreateVgwResponse withVpnGateway(CreateResponseVpnGateway vpnGateway) {
        this.vpnGateway = vpnGateway;
        return this;
    }

    public CreateVgwResponse withVpnGateway(Consumer<CreateResponseVpnGateway> vpnGatewaySetter) {
        if (this.vpnGateway == null) {
            this.vpnGateway = new CreateResponseVpnGateway();
     ...
     * @return vpnGateway
     */
    public CreateResponseVpnGateway getVpnGateway() {
        return vpnGateway;
    }

    public void setVpnGateway(CreateResponseVpnGateway vpnGateway) {
        this.vpnGateway = vpnGateway;
    }

    public CreateVgwResponse withRequestId(String requestId) {
    ...
    public CreateVgwResponse withHeaderResponseToken(String headerResponseToken) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        CreateVgwResponse that = (CreateVgwResponse) obj;
    ...
    public String toString() {
        ...
        sb.append("class CreateVgwResponse {\n");
