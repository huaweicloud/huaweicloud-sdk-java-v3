...
public class CreateConnectorTaskResponse extends SdkResponse {
    ...
    public CreateConnectorTaskResponse withTaskName(String taskName) {
    ...
    public CreateConnectorTaskResponse withTopics(String topics) {
        this.topics = topics;
        return this;
    }
    ...
    public CreateConnectorTaskResponse withSourceTask(SmartConnectTaskRespSourceConfig sourceTask) {
        this.sourceTask = sourceTask;
        return this;
    }

    public CreateConnectorTaskResponse withSourceTask(Consumer<SmartConnectTaskRespSourceConfig> sourceTaskSetter) {
    ...
    public CreateConnectorTaskResponse withSinkType(String sinkType) {
    ...
    public CreateConnectorTaskResponse withSinkTask(SmartConnectTaskRespSinkConfig sinkTask) {
        this.sinkTask = sinkTask;
        return this;
    }

    public CreateConnectorTaskResponse withSinkTask(Consumer<SmartConnectTaskRespSinkConfig> sinkTaskSetter) {
    ...
    public CreateConnectorTaskResponse withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public CreateConnectorTaskResponse withStatus(String status) {
        this.status = status;
        return this;
    }
    ...
    public CreateConnectorTaskResponse withCreateTime(Long createTime) {
