 ...
 * Response Object
 */
public class ShowConnectorTaskResponse extends SdkResponse {
    ...
    public ShowConnectorTaskResponse withTaskName(String taskName) {
    ...
    public ShowConnectorTaskResponse withTopics(String topics) {
        this.topics = topics;
        return this;
    }
    ...
    public ShowConnectorTaskResponse withTopicsRegex(String topicsRegex) {
    ...
    public ShowConnectorTaskResponse withSourceType(String sourceType) {
    ...
    public ShowConnectorTaskResponse withSourceTask(SmartConnectTaskRespSourceConfig sourceTask) {
        this.sourceTask = sourceTask;
        return this;
    }

    public ShowConnectorTaskResponse withSourceTask(Consumer<SmartConnectTaskRespSourceConfig> sourceTaskSetter) {
    ...
    public ShowConnectorTaskResponse withSinkType(String sinkType) {
    ...
    public ShowConnectorTaskResponse withSinkTask(SmartConnectTaskRespSinkConfig sinkTask) {
        this.sinkTask = sinkTask;
        return this;
    }

    public ShowConnectorTaskResponse withSinkTask(Consumer<SmartConnectTaskRespSinkConfig> sinkTaskSetter) {
    ...
    public ShowConnectorTaskResponse withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public ShowConnectorTaskResponse withStatus(String status) {
        this.status = status;
        return this;
    }
    ...
    public ShowConnectorTaskResponse withCreateTime(Long createTime) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ShowConnectorTaskResponse that = (ShowConnectorTaskResponse) obj;
    ...
    public String toString() {
        ...
        sb.append("class ShowConnectorTaskResponse {\n");
