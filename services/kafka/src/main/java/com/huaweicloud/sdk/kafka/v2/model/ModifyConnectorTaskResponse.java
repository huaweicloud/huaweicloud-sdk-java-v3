 ...
 * Response Object
 */
public class ModifyConnectorTaskResponse extends SdkResponse {
    ...
    public ModifyConnectorTaskResponse withTaskName(String taskName) {
    ...
    public ModifyConnectorTaskResponse withTopics(String topics) {
        this.topics = topics;
        return this;
    }
    ...
    public ModifyConnectorTaskResponse withTopicsRegex(String topicsRegex) {
    ...
    public ModifyConnectorTaskResponse withSourceType(String sourceType) {
    ...
    public ModifyConnectorTaskResponse withSourceTask(SmartConnectTaskRespSourceConfig sourceTask) {
        this.sourceTask = sourceTask;
        return this;
    }

    public ModifyConnectorTaskResponse withSourceTask(Consumer<SmartConnectTaskRespSourceConfig> sourceTaskSetter) {
    ...
    public ModifyConnectorTaskResponse withSinkType(String sinkType) {
    ...
    public ModifyConnectorTaskResponse withSinkTask(SmartConnectTaskRespSinkConfig sinkTask) {
        this.sinkTask = sinkTask;
        return this;
    }

    public ModifyConnectorTaskResponse withSinkTask(Consumer<SmartConnectTaskRespSinkConfig> sinkTaskSetter) {
    ...
    public ModifyConnectorTaskResponse withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public ModifyConnectorTaskResponse withStatus(String status) {
        this.status = status;
        return this;
    }
    ...
    public ModifyConnectorTaskResponse withCreateTime(Long createTime) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ModifyConnectorTaskResponse that = (ModifyConnectorTaskResponse) obj;
    ...
    public String toString() {
        ...
        sb.append("class ModifyConnectorTaskResponse {\n");
