...
public class ObsBucketEntity {
    ...
    public ObsBucketEntity withResponseHeaders(Object responseHeaders) {
    ...
    public ObsBucketEntity withOriginalHeaders(Object originalHeaders) {
    ...
    public ObsBucketEntity withStatusCode(Integer statusCode) {
    ...
    public ObsBucketEntity withBucketName(String bucketName) {
    ...
    public ObsBucketEntity withOwner(Object owner) {
        this.owner = owner;
        return this;
    }
    ...
    public ObsBucketEntity withCreationDate(Long creationDate) {
    ...
    public ObsBucketEntity withLocation(String location) {
    ...
    public ObsBucketEntity withClustertype(String clustertype) {
    ...
    public ObsBucketEntity withStorageClass(String storageClass) {
    ...
    public ObsBucketEntity withMetadata(Object metadata) {
    ...
    public ObsBucketEntity withAcl(String acl) {
        this.acl = acl;
        return this;
    }
    ...
    public ObsBucketEntity withBucketStorageClass(String bucketStorageClass) {
    ...
    public ObsBucketEntity withBucketType(String bucketType) {
    ...
    public ObsBucketEntity withRequestId(String requestId) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ObsBucketEntity that = (ObsBucketEntity) obj;
