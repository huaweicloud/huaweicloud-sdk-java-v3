...
public class CreateKafkaUserClientQuotaTaskReq {
    ...
    public CreateKafkaUserClientQuotaTaskReq withUser(String user) {
        this.user = user;
        return this;
    }
    ...
    public CreateKafkaUserClientQuotaTaskReq withClient(String client) {
        this.client = client;
        return this;
    }
    ...
    public CreateKafkaUserClientQuotaTaskReq withUserDefault(Boolean userDefault) {
    ...
    public CreateKafkaUserClientQuotaTaskReq withClientDefault(Boolean clientDefault) {
    ...
    public CreateKafkaUserClientQuotaTaskReq withProducerByteRate(Long producerByteRate) {
    ...
    public CreateKafkaUserClientQuotaTaskReq withConsumerByteRate(Long consumerByteRate) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        CreateKafkaUserClientQuotaTaskReq that = (CreateKafkaUserClientQuotaTaskReq) obj;
