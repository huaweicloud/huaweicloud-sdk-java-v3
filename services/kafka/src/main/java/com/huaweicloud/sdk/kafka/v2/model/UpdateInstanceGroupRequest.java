...
public class UpdateInstanceGroupRequest {
    ...
    public UpdateInstanceGroupRequest withInstanceId(String instanceId) {
    ...
    public UpdateInstanceGroupRequest withBody(GroupCreateReq body) {
        this.body = body;
        return this;
    }

    public UpdateInstanceGroupRequest withBody(Consumer<GroupCreateReq> bodySetter) {
        if (this.body == null) {
