 ...
 * Request Object
 */
public class SetUserPoliciesRequest {
    ...
    private SetUserPoliciesReq body;

    public SetUserPoliciesRequest withEngine(EngineEnum engine) {
        this.engine = engine;
        return this;
    }
    ...
    public SetUserPoliciesRequest withInstanceId(String instanceId) {
    ...
    public SetUserPoliciesRequest withUserName(String userName) {
    ...
    public SetUserPoliciesRequest withBody(SetUserPoliciesReq body) {
        this.body = body;
        return this;
    }

    public SetUserPoliciesRequest withBody(Consumer<SetUserPoliciesReq> bodySetter) {
        if (this.body == null) {
            this.body = new SetUserPoliciesReq();
     ...
     * @return body
     */
    public SetUserPoliciesReq getBody() {
        return body;
    }

    public void setBody(SetUserPoliciesReq body) {
        this.body = body;
    }
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        SetUserPoliciesRequest that = (SetUserPoliciesRequest) obj;
    ...
    @Override
    public int hashCode() {
        return Objects.hash(engine, instanceId, userName, body);
    }

    @Override
    public String toString() {
        StringBuilder sb = new StringBuilder();
        sb.append("class SetUserPoliciesRequest {\n");
