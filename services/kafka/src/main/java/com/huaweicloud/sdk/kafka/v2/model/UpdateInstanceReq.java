...
public class UpdateInstanceReq {
     ...
     * 维护时间窗开始和结束时间必须为指定的时间段，可参考查[询维护时间窗时间段](https://support.huaweicloud.com/api-kafka/ShowMaintainWindows.html)。 -
    ...
    public int hashCode() {
        return Objects
            .hash(name, description, maintainBegin, maintainEnd, securityGroupId, retentionPolicy, enterpriseProjectId);
    }
