...
public class UpdateKafkaUserClientQuotaTaskReq {
    ...
    public UpdateKafkaUserClientQuotaTaskReq withUser(String user) {
        this.user = user;
        return this;
    }
    ...
    public UpdateKafkaUserClientQuotaTaskReq withClient(String client) {
        this.client = client;
        return this;
    }
    ...
    public UpdateKafkaUserClientQuotaTaskReq withUserDefault(Boolean userDefault) {
    ...
    public UpdateKafkaUserClientQuotaTaskReq withClientDefault(Boolean clientDefault) {
    ...
    public UpdateKafkaUserClientQuotaTaskReq withProducerByteRate(Long producerByteRate) {
    ...
    public UpdateKafkaUserClientQuotaTaskReq withConsumerByteRate(Long consumerByteRate) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        UpdateKafkaUserClientQuotaTaskReq that = (UpdateKafkaUserClientQuotaTaskReq) obj;
