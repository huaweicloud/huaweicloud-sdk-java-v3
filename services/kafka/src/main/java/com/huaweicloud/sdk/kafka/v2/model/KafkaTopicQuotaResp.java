 ...
 * Topic流控配置
 */
public class KafkaTopicQuotaResp {
    ...
    public KafkaTopicQuotaResp withTopic(String topic) {
        this.topic = topic;
        return this;
    }
    ...
    public KafkaTopicQuotaResp withProducerByteRate(Integer producerByteRate) {
    ...
    public KafkaTopicQuotaResp withConsumerByteRate(Integer consumerByteRate) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        KafkaTopicQuotaResp that = (KafkaTopicQuotaResp) obj;
    ...
    public String toString() {
        ...
        sb.append("class KafkaTopicQuotaResp {\n");
