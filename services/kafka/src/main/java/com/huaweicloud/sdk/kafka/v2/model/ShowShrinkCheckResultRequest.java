...
public class ShowShrinkCheckResultRequest {
    ...
    private ShowShrinkCheckRequestBody body;

    public ShowShrinkCheckResultRequest withEngine(EngineEnum engine) {
        this.engine = engine;
        return this;
    }
    ...
    public ShowShrinkCheckResultRequest withInstanceId(String instanceId) {
    ...
    public ShowShrinkCheckResultRequest withBody(ShowShrinkCheckRequestBody body) {
        this.body = body;
        return this;
    }

    public ShowShrinkCheckResultRequest withBody(Consumer<ShowShrinkCheckRequestBody> bodySetter) {
        if (this.body == null) {
            this.body = new ShowShrinkCheckRequestBody();
     ...
     * @return body
     */
    public ShowShrinkCheckRequestBody getBody() {
        return body;
    }

    public void setBody(ShowShrinkCheckRequestBody body) {
        this.body = body;
    }
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ShowShrinkCheckResultRequest that = (ShowShrinkCheckResultRequest) obj;
