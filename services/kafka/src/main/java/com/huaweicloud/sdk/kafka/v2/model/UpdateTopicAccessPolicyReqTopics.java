...
import com.huaweicloud.sdk.kafka.v2.model.UpdateTopicAccessPolicyReqPolicies;
...
public class UpdateTopicAccessPolicyReqTopics  {
    ...
    public UpdateTopicAccessPolicyReqTopics withPolicies(Consumer<List<UpdateTopicAccessPolicyReqPolicies>> policiesSetter) {
        if(this.policies == null) {
            this.policies = new ArrayList<>();
        }
