...
public class BatchAddMembersRequest  {
    ...
    public BatchAddMembersRequest withBody(Consumer<BatchAddMembersRequestBody> bodySetter) {
        if(this.body == null ){
    ...
    public boolean equals(java.lang.Object o) {
        ...
        BatchAddMembersRequest batchAddMembersRequest = (BatchAddMembersRequest) o;
        return Objects.equals(this.body, batchAddMembersRequest.body);
    }
    @Override
    public int hashCode() {
