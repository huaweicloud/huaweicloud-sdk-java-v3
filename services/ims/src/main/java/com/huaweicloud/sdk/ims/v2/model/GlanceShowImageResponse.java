...
public class GlanceShowImageResponse extends SdkResponse {
    ...
    public GlanceShowImageResponse withDataOrigin(String dataOrigin) {
    ...
    public GlanceShowImageResponse withDescription(String description) {
    ...
    public GlanceShowImageResponse withImageSize(String imageSize) {
    ...
    public GlanceShowImageResponse withImageSourceType(ImageSourceTypeEnum imageSourceType) {
    ...
    public GlanceShowImageResponse withImagetype(ImagetypeEnum imagetype) {
    ...
    public GlanceShowImageResponse withIsregistered(IsregisteredEnum isregistered) {
    ...
    public GlanceShowImageResponse withOriginalimagename(String originalimagename) {
    ...
    public GlanceShowImageResponse withOsBit(OsBitEnum osBit) {
        this.osBit = osBit;
        return this;
    }
    ...
    public GlanceShowImageResponse withOsType(OsTypeEnum osType) {
        this.osType = osType;
        return this;
    }
    ...
    public GlanceShowImageResponse withOsVersion(String osVersion) {
    ...
    public GlanceShowImageResponse withPlatform(PlatformEnum platform) {
    ...
    public GlanceShowImageResponse withProductcode(String productcode) {
    ...
    public GlanceShowImageResponse withSupportDiskintensive(String supportDiskintensive) {
    ...
    public GlanceShowImageResponse withSupportHighperformance(String supportHighperformance) {
    ...
    public GlanceShowImageResponse withSupportKvm(String supportKvm) {
    ...
    public GlanceShowImageResponse withSupportKvmGpuType(String supportKvmGpuType) {
    ...
    public GlanceShowImageResponse withSupportKvmInfiniband(String supportKvmInfiniband) {
    ...
    public GlanceShowImageResponse withSupportLargememory(String supportLargememory) {
    ...
    public GlanceShowImageResponse withSupportXen(String supportXen) {
    ...
    public GlanceShowImageResponse withSupportXenGpuType(String supportXenGpuType) {
        this.supportXenGpuType = supportXenGpuType;
        return this;
    }

    /** 表示该镜像是支持XEN虚拟化平台下的GPU优化类型，取值参考8.10-表 镜像支持的GPU类型说明。镜像操作系统类型请参考8.10-表
     * 镜像类型。如果不支持XEN虚拟化下GPU类型，无需添加该属性。该属性与“__support_xen”和“__support_kvm”属性不共存。
     * 
    ...
    public GlanceShowImageResponse withSupportXenHana(String supportXenHana) {
    ...
    public GlanceShowImageResponse withChecksum(String checksum) {
    ...
    public GlanceShowImageResponse withContainerFormat(String containerFormat) {
    ...
    public GlanceShowImageResponse withCreatedAt(String createdAt) {
    ...
    public GlanceShowImageResponse withFile(String file) {
        this.file = file;
        return this;
    }
    ...
    public GlanceShowImageResponse withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public GlanceShowImageResponse withMinDisk(Integer minDisk) {
    ...
    public GlanceShowImageResponse withMinRam(Integer minRam) {
        this.minRam = minRam;
        return this;
    }
    ...
    public GlanceShowImageResponse withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public GlanceShowImageResponse withOwner(String owner) {
        this.owner = owner;
        return this;
    }
    ...
    public GlanceShowImageResponse withProtected(Boolean _protected) {
    ...
    public GlanceShowImageResponse withSchema(String schema) {
        this.schema = schema;
        return this;
    }
    ...
    public GlanceShowImageResponse withSelf(String self) {
        this.self = self;
        return this;
    }
    ...
    public GlanceShowImageResponse withSize(Long size) {
        this.size = size;
        return this;
    }
    ...
    public GlanceShowImageResponse withStatus(StatusEnum status) {
        this.status = status;
        return this;
    }
    ...
    public GlanceShowImageResponse withTags(List<String> tags) {
        this.tags = tags;
        return this;
    }

    public GlanceShowImageResponse addTagsItem(String tagsItem) {
        if (this.tags == null) {
    ...
    public GlanceShowImageResponse withTags(Consumer<List<String>> tagsSetter) {
        if (this.tags == null) {
            this.tags = new ArrayList<>();
        }
    ...
    public GlanceShowImageResponse withUpdatedAt(String updatedAt) {
    ...
    public GlanceShowImageResponse withVirtualEnvType(VirtualEnvTypeEnum virtualEnvType) {
    ...
    public GlanceShowImageResponse withVirtualSize(Integer virtualSize) {
    ...
    public GlanceShowImageResponse withVisibility(VisibilityEnum visibility) {
    ...
    public GlanceShowImageResponse withSupportFcInject(SupportFcInjectEnum supportFcInject) {
    ...
    public GlanceShowImageResponse withEnterpriseProjectId(String enterpriseProjectId) {
    ...
    public GlanceShowImageResponse withHwFirmwareType(HwFirmwareTypeEnum hwFirmwareType) {
    ...
    public GlanceShowImageResponse withSupportArm(SupportArmEnum supportArm) {
    ...
    public GlanceShowImageResponse withIsOffshelved(IsOffshelvedEnum isOffshelved) {
    ...
    public GlanceShowImageResponse withLazyloading(String lazyloading) {
    ...
    public GlanceShowImageResponse withSupportAmd(String supportAmd) {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        GlanceShowImageResponse glanceShowImageResponse = (GlanceShowImageResponse) o;
        return Objects.equals(this.backupId, glanceShowImageResponse.backupId)
            && Objects.equals(this.dataOrigin, glanceShowImageResponse.dataOrigin)
            && Objects.equals(this.description, glanceShowImageResponse.description)
            && Objects.equals(this.imageSize, glanceShowImageResponse.imageSize)
            && Objects.equals(this.imageSourceType, glanceShowImageResponse.imageSourceType)
            && Objects.equals(this.imagetype, glanceShowImageResponse.imagetype)
            && Objects.equals(this.isregistered, glanceShowImageResponse.isregistered)
            && Objects.equals(this.originalimagename, glanceShowImageResponse.originalimagename)
            && Objects.equals(this.osBit, glanceShowImageResponse.osBit)
            && Objects.equals(this.osType, glanceShowImageResponse.osType)
            && Objects.equals(this.osVersion, glanceShowImageResponse.osVersion)
            && Objects.equals(this.platform, glanceShowImageResponse.platform)
            && Objects.equals(this.productcode, glanceShowImageResponse.productcode)
            && Objects.equals(this.supportDiskintensive, glanceShowImageResponse.supportDiskintensive)
            && Objects.equals(this.supportHighperformance, glanceShowImageResponse.supportHighperformance)
            && Objects.equals(this.supportKvm, glanceShowImageResponse.supportKvm)
            && Objects.equals(this.supportKvmGpuType, glanceShowImageResponse.supportKvmGpuType)
            && Objects.equals(this.supportKvmInfiniband, glanceShowImageResponse.supportKvmInfiniband)
            && Objects.equals(this.supportLargememory, glanceShowImageResponse.supportLargememory)
            && Objects.equals(this.supportXen, glanceShowImageResponse.supportXen)
            && Objects.equals(this.supportXenGpuType, glanceShowImageResponse.supportXenGpuType)
            && Objects.equals(this.supportXenHana, glanceShowImageResponse.supportXenHana)
            ...
            && Objects.equals(this.minDisk, glanceShowImageResponse.minDisk)
            && Objects.equals(this.minRam, glanceShowImageResponse.minRam)
            && Objects.equals(this.name, glanceShowImageResponse.name)
            && Objects.equals(this.owner, glanceShowImageResponse.owner)
            && Objects.equals(this._protected, glanceShowImageResponse._protected)
            && Objects.equals(this.schema, glanceShowImageResponse.schema)
            && Objects.equals(this.self, glanceShowImageResponse.self)
            && Objects.equals(this.size, glanceShowImageResponse.size)
            && Objects.equals(this.status, glanceShowImageResponse.status)
            && Objects.equals(this.tags, glanceShowImageResponse.tags)
            && Objects.equals(this.updatedAt, glanceShowImageResponse.updatedAt)
            && Objects.equals(this.virtualEnvType, glanceShowImageResponse.virtualEnvType)
            && Objects.equals(this.virtualSize, glanceShowImageResponse.virtualSize)
            && Objects.equals(this.visibility, glanceShowImageResponse.visibility)
            && Objects.equals(this.supportFcInject, glanceShowImageResponse.supportFcInject)
            ...
            && Objects.equals(this.supportAmd, glanceShowImageResponse.supportAmd);
    }
