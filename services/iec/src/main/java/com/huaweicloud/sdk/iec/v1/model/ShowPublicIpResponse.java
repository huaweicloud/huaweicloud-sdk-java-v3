...
import com.huaweicloud.sdk.iec.v1.model.PublicIp;
...
public class ShowPublicIpResponse extends SdkResponse {
    ...
    public ShowPublicIpResponse withPublicip(PublicIp publicip) {
        this.publicip = publicip;
        return this;
    }

    public ShowPublicIpResponse withPublicip(Consumer<PublicIp> publicipSetter) {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        return Objects.equals(this.publicip, showPublicIpResponse.publicip);
    }
    @Override
    public int hashCode() {
