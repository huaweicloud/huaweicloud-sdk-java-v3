...
public class RouteOption {
    ...
    public RouteOption withType(TypeEnum type) {
        this.type = type;
        return this;
    }
    ...
    public RouteOption withDestination(String destination) {
    ...
    public RouteOption withNexthop(String nexthop) {
    ...
    public RouteOption withDescription(String description) {
