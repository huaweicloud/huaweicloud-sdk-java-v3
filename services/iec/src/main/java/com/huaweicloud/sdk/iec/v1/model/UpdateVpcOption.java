...
public class UpdateVpcOption {
    ...
    /** 虚拟私有云下可用子网的范围。 约束条件： SYSTEM模式，cidr取值范围：10.0.0.0/8~10.255.0.0/16或者172.16.0.0/12 ~ 172.31.0.0/16或者192.168.0.0/16 。
     * [CUSTOMER模式，cidr的取值范围：10.0.0.0/8~10.255.255.0/24或者172.16.0.0/12 ~
     * 172.32.255.0/24或者192.168.0.0/16~192.168.255.0/24。](tag:internal)
     * 
     * @return cidr */
