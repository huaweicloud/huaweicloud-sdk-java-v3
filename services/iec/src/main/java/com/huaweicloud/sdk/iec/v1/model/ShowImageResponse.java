...
public class ShowImageResponse extends SdkResponse {
    ...
    @JacksonXmlProperty(localName = "deleted_at")
    ...
    @JacksonXmlProperty(localName = "relation_job_id")
    ...
    @JacksonXmlProperty(localName = "origin_region_info")
    ...
    @JacksonXmlProperty(localName = "edge_region_info")
