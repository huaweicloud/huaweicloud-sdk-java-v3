...
import com.huaweicloud.sdk.iec.v1.model.QuotaResources;
...
public class ListQuotaResponse extends SdkResponse {
    ...
    public ListQuotaResponse withQuotas(QuotaResources quotas) {
        this.quotas = quotas;
        return this;
    }

    public ListQuotaResponse withQuotas(Consumer<QuotaResources> quotasSetter) {
        if(this.quotas == null ){
