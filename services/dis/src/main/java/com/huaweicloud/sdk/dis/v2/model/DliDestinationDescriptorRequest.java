 ...
 * 转储目的地为DLI的参数列表。
 */
public class DliDestinationDescriptorRequest {
    ...
    @JsonInclude(JsonInclude.Include.NON_NULL)
    @JsonProperty(value = "dli_database_name")

    private String dliDatabaseName;

    @JsonInclude(JsonInclude.Include.NON_NULL)
    @JsonProperty(value = "dli_table_name")
    ...
    public DliDestinationDescriptorRequest withTaskName(String taskName) {
    ...
    public DliDestinationDescriptorRequest withAgencyName(String agencyName) {
    ...
    public DliDestinationDescriptorRequest withDeliverTimeInterval(Integer deliverTimeInterval) {
    ...
    public DliDestinationDescriptorRequest withConsumerStrategy(ConsumerStrategyEnum consumerStrategy) {
    ...
    public DliDestinationDescriptorRequest withDliDatabaseName(String dliDatabaseName) {
    ...
    public DliDestinationDescriptorRequest withDliTableName(String dliTableName) {
    ...
    public DliDestinationDescriptorRequest withObsBucketPath(String obsBucketPath) {
    ...
    public DliDestinationDescriptorRequest withFilePrefix(String filePrefix) {
    ...
    public DliDestinationDescriptorRequest withRetryDuration(String retryDuration) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        DliDestinationDescriptorRequest that = (DliDestinationDescriptorRequest) obj;
        return Objects.equals(this.taskName, that.taskName) && Objects.equals(this.agencyName, that.agencyName)
            ...
            && Objects.equals(this.dliDatabaseName, that.dliDatabaseName)
            && Objects.equals(this.dliTableName, that.dliTableName)
    ...
    public String toString() {
        ...
        sb.append("class DliDestinationDescriptorRequest {\n");
        ...
        sb.append("    dliDatabaseName: ").append(toIndentedString(dliDatabaseName)).append("\n");
        sb.append("    dliTableName: ").append(toIndentedString(dliTableName)).append("\n");
