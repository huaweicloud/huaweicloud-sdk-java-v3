...
public class ShowCheckpointRequest {
    ...
    public ShowCheckpointRequest withStreamName(String streamName) {
    ...
    public ShowCheckpointRequest withPartitionId(String partitionId) {
    ...
    public ShowCheckpointRequest withAppName(String appName) {
    ...
    public ShowCheckpointRequest withCheckpointType(CheckpointTypeEnum checkpointType) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        return Objects.equals(this.streamName, that.streamName) && Objects.equals(this.partitionId, that.partitionId)
            && Objects.equals(this.appName, that.appName) && Objects.equals(this.checkpointType, that.checkpointType);
    }

    @Override
    public int hashCode() {
        return Objects.hash(streamName, partitionId, appName, checkpointType);
    }
