...
public class CreatePartitionRequest {
    ...
    public CreatePartitionRequest withClusterId(String clusterId) {
    ...
    public CreatePartitionRequest withBody(PartitionReqBody body) {
        this.body = body;
        return this;
    }

    public CreatePartitionRequest withBody(Consumer<PartitionReqBody> bodySetter) {
        if (this.body == null) {
