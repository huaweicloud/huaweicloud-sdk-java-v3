...
public class MaintenanceWindow {
    ...
    public MaintenanceWindow withWeeklyPeriod(String weeklyPeriod) {
    ...
    public MaintenanceWindow withDurationHours(Integer durationHours) {
    ...
    public MaintenanceWindow withUpgradeScope(String upgradeScope) {
