...
public class ListReleasesRequest {
    ...
    public ListReleasesRequest withClusterId(String clusterId) {
    ...
    public ListReleasesRequest withChartId(String chartId) {
    ...
    public ListReleasesRequest withNamespace(String namespace) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ListReleasesRequest that = (ListReleasesRequest) obj;
