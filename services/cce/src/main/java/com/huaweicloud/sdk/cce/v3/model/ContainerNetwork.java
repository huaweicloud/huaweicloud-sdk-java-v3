...
public class ContainerNetwork  {
    ...
    public static final class ModeEnum {
        ...
        /**
         * Enum UNDERLAY_IPVLAN for value: "underlay_ipvlan"
         */
        public static final ModeEnum UNDERLAY_IPVLAN = new ModeEnum("underlay_ipvlan");
        ...
        private static Map<String, ModeEnum> createStaticFields() {
            ...
            map.put("underlay_ipvlan", UNDERLAY_IPVLAN);
            map.put("eni", ENI);
    ...
    public boolean equals(java.lang.Object o) {
        ...
        return Objects.equals(this.cidr, containerNetwork.cidr) &&
            Objects.equals(this.mode, containerNetwork.mode);
    }
    @Override
    public int hashCode() {
        return Objects.hash(cidr, mode);
    }
    @Override
    public String toString() {
