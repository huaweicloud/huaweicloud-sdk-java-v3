...
public class GetClusterSupportConfigurationRequest {
    ...
    public GetClusterSupportConfigurationRequest withClusterType(String clusterType) {
    ...
    public GetClusterSupportConfigurationRequest withClusterVersion(String clusterVersion) {
    ...
    public GetClusterSupportConfigurationRequest withClusterID(String clusterID) {
    ...
    public GetClusterSupportConfigurationRequest withNetworkMode(String networkMode) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        GetClusterSupportConfigurationRequest that = (GetClusterSupportConfigurationRequest) obj;
