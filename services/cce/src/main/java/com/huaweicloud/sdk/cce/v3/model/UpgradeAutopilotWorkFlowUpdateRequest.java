 ...
 * Request Object
 */
public class UpgradeAutopilotWorkFlowUpdateRequest {
    ...
    public UpgradeAutopilotWorkFlowUpdateRequest withClusterId(String clusterId) {
    ...
    public UpgradeAutopilotWorkFlowUpdateRequest withUpgradeWorkflowId(String upgradeWorkflowId) {
    ...
    public UpgradeAutopilotWorkFlowUpdateRequest withBody(UpgradeWorkFlowUpdateRequestBody body) {
        this.body = body;
        return this;
    }

    public UpgradeAutopilotWorkFlowUpdateRequest withBody(Consumer<UpgradeWorkFlowUpdateRequestBody> bodySetter) {
        if (this.body == null) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        UpgradeAutopilotWorkFlowUpdateRequest that = (UpgradeAutopilotWorkFlowUpdateRequest) obj;
    ...
    public String toString() {
        ...
        sb.append("class UpgradeAutopilotWorkFlowUpdateRequest {\n");
