...
public class ChartResp {
    ...
    public ChartResp withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public ChartResp withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public ChartResp withValues(String values) {
        this.values = values;
        return this;
    }
    ...
    public ChartResp withTranslate(String translate) {
    ...
    public ChartResp withInstruction(String instruction) {
    ...
    public ChartResp withVersion(String version) {
    ...
    public ChartResp withDescription(String description) {
    ...
    public ChartResp withSource(String source) {
        this.source = source;
        return this;
    }
    ...
    public ChartResp withIconUrl(String iconUrl) {
    ...
    public ChartResp withPublic(Boolean _public) {
    ...
    public ChartResp withChartUrl(String chartUrl) {
    ...
    public ChartResp withCreateAt(String createAt) {
    ...
    public ChartResp withUpdateAt(String updateAt) {
