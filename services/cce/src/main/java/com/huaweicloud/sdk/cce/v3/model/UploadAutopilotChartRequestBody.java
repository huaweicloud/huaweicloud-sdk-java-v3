 ...
 */
public class UploadAutopilotChartRequestBody implements SdkFormDataBody {
    ...
    public UploadAutopilotChartRequestBody withParameters(String parameters) {
    ...
    public UploadAutopilotChartRequestBody withContent(FormDataFilePart content) {
    ...
    public UploadAutopilotChartRequestBody withContent(InputStream inputStream, String fileName, String contentType) {
        this.content = new FormDataFilePart(inputStream, fileName).withContentType(contentType);
        return this;
    }

    public UploadAutopilotChartRequestBody withContent(InputStream inputStream, String fileName) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        UploadAutopilotChartRequestBody that = (UploadAutopilotChartRequestBody) obj;
