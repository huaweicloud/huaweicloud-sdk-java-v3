...
public class UpgradeClusterRequest {
    ...
    public UpgradeClusterRequest withClusterId(String clusterId) {
    ...
    public UpgradeClusterRequest withBody(UpgradeClusterRequestBody body) {
        this.body = body;
        return this;
    }

    public UpgradeClusterRequest withBody(Consumer<UpgradeClusterRequestBody> bodySetter) {
        if (this.body == null) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        UpgradeClusterRequest that = (UpgradeClusterRequest) obj;
