...
public class CreateNodeResponse extends SdkResponse {
    ...
    public CreateNodeResponse withSpec(V3NodeSpec spec) {
        this.spec = spec;
        return this;
    }

    public CreateNodeResponse withSpec(Consumer<V3NodeSpec> specSetter) {
        if(this.spec == null ){
    ...
    public CreateNodeResponse withStatus(V3NodeStatus status) {
        this.status = status;
        return this;
    }

    public CreateNodeResponse withStatus(Consumer<V3NodeStatus> statusSetter) {
        if(this.status == null ){
    ...
    public boolean equals(java.lang.Object o) {
        ...
        return Objects.equals(this.apiVersion, createNodeResponse.apiVersion) &&
            Objects.equals(this.kind, createNodeResponse.kind) &&
