 ...
 * Response Object
 */
public class ShowAutopilotMaintenanceWindowResponse extends SdkResponse {
    ...
    public ShowAutopilotMaintenanceWindowResponse withWeeklyPeriod(String weeklyPeriod) {
    ...
    public ShowAutopilotMaintenanceWindowResponse withStartTime(String startTime) {
    ...
    public ShowAutopilotMaintenanceWindowResponse withDurationHours(Integer durationHours) {
    ...
    public ShowAutopilotMaintenanceWindowResponse withUpgradeScope(String upgradeScope) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ShowAutopilotMaintenanceWindowResponse that = (ShowAutopilotMaintenanceWindowResponse) obj;
