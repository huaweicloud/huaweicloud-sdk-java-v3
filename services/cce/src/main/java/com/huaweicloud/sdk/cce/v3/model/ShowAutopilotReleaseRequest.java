 ...
 * Request Object
 */
public class ShowAutopilotReleaseRequest {
    ...
    public ShowAutopilotReleaseRequest withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public ShowAutopilotReleaseRequest withNamespace(String namespace) {
    ...
    public ShowAutopilotReleaseRequest withShowResources(String showResources) {
    ...
    public ShowAutopilotReleaseRequest withClusterId(String clusterId) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ShowAutopilotReleaseRequest that = (ShowAutopilotReleaseRequest) obj;
    ...
    public String toString() {
        ...
        sb.append("class ShowAutopilotReleaseRequest {\n");
