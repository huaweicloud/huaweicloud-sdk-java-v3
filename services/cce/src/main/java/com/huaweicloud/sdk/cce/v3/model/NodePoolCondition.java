...
public class NodePoolCondition {
    ...
    public static final class TypeEnum {
         ...
         */
        public static final TypeEnum UNEXPECTEDPERIODNODESINCLUDED = new TypeEnum("UnexpectedPeriodNodesIncluded");
        ...
        private static Map<String, TypeEnum> createStaticFields() {
            ...
            map.put("Error", ERROR);
            map.put("UnexpectedPeriodNodesIncluded", UNEXPECTEDPERIODNODESINCLUDED);
