 ...
 * Response Object
 */
public class ListAutopilotClusterUpgradeFeatureGatesResponse extends SdkResponse {
    ...
    public ListAutopilotClusterUpgradeFeatureGatesResponse withApiVersion(String apiVersion) {
    ...
    public ListAutopilotClusterUpgradeFeatureGatesResponse withKind(String kind) {
        this.kind = kind;
        return this;
    }
    ...
    public ListAutopilotClusterUpgradeFeatureGatesResponse withMetadata(Metadata metadata) {
        this.metadata = metadata;
        return this;
    }

    public ListAutopilotClusterUpgradeFeatureGatesResponse withMetadata(Consumer<Metadata> metadataSetter) {
    ...
    public ListAutopilotClusterUpgradeFeatureGatesResponse withUpgradeFeatureGates(
        Map<String, String> upgradeFeatureGates) {
        this.upgradeFeatureGates = upgradeFeatureGates;
        return this;
    }

    public ListAutopilotClusterUpgradeFeatureGatesResponse putUpgradeFeatureGatesItem(String key,
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ListAutopilotClusterUpgradeFeatureGatesResponse that = (ListAutopilotClusterUpgradeFeatureGatesResponse) obj;
    ...
    public String toString() {
        ...
        sb.append("class ListAutopilotClusterUpgradeFeatureGatesResponse {\n");
