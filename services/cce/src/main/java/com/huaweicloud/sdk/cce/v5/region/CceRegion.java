package com.huaweicloud.sdk.cce.v5.region;
...
public class CceRegion {
    ...
    public static final Region CN_EAST_4 = new Region("cn-east-4", "https://cce.cn-east-4.myhuaweicloud.com");

    public static final Region AF_NORTH_1 = new Region("af-north-1", "https://cce.af-north-1.myhuaweicloud.com");

    public static final Region CN_EAST_5 = new Region("cn-east-5", "https://cce.cn-east-5.myhuaweicloud.com");

    public static final Region AP_SOUTHEAST_5 =
        new Region("ap-southeast-5", "https://cce.ap-southeast-5.myhuaweicloud.com");

    public static final Region CN_NORTH_12 = new Region("cn-north-12", "https://cce.cn-north-12.myhuaweicloud.com");
