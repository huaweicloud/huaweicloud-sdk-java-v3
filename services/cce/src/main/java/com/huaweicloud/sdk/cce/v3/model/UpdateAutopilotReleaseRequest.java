 ...
 * Request Object
 */
public class UpdateAutopilotReleaseRequest {
    ...
    public UpdateAutopilotReleaseRequest withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public UpdateAutopilotReleaseRequest withNamespace(String namespace) {
    ...
    public UpdateAutopilotReleaseRequest withShowResources(String showResources) {
    ...
    public UpdateAutopilotReleaseRequest withClusterId(String clusterId) {
    ...
    public UpdateAutopilotReleaseRequest withBody(UpdateReleaseReqBody body) {
        this.body = body;
        return this;
    }

    public UpdateAutopilotReleaseRequest withBody(Consumer<UpdateReleaseReqBody> bodySetter) {
        if (this.body == null) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        UpdateAutopilotReleaseRequest that = (UpdateAutopilotReleaseRequest) obj;
    ...
    public String toString() {
        ...
        sb.append("class UpdateAutopilotReleaseRequest {\n");
