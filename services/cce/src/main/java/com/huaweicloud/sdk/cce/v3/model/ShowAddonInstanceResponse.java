...
public class ShowAddonInstanceResponse extends SdkResponse {
    ...
    public ShowAddonInstanceResponse withMetadata(AddonMetadata metadata) {
        this.metadata = metadata;
        return this;
    }

    public ShowAddonInstanceResponse withMetadata(Consumer<AddonMetadata> metadataSetter) {
