 ...
 * Request Object
 */
public class DeleteAutopilotReleaseRequest {
    ...
    public DeleteAutopilotReleaseRequest withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public DeleteAutopilotReleaseRequest withNamespace(String namespace) {
    ...
    public DeleteAutopilotReleaseRequest withShowResources(String showResources) {
    ...
    public DeleteAutopilotReleaseRequest withClusterId(String clusterId) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        DeleteAutopilotReleaseRequest that = (DeleteAutopilotReleaseRequest) obj;
    ...
    public String toString() {
        ...
        sb.append("class DeleteAutopilotReleaseRequest {\n");
