 ...
 * SecretConfigUpdate
 */
public class SecretConfigUpdate {
    ...
    public SecretConfigUpdate withDisableDefaultAddonCredSecret(Boolean disableDefaultAddonCredSecret) {
    ...
    public SecretConfigUpdate withDisableNodeAgencyCredSecret(Boolean disableNodeAgencyCredSecret) {
    ...
    public SecretConfigUpdate withDisableDefaultImagePullSecret(Boolean disableDefaultImagePullSecret) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        SecretConfigUpdate that = (SecretConfigUpdate) obj;
    ...
    public String toString() {
        ...
        sb.append("class SecretConfigUpdate {\n");
