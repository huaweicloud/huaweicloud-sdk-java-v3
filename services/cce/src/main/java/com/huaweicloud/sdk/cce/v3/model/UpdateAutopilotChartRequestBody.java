...
/**
 * UpdateAutopilotChartRequestBody
 */
public class UpdateAutopilotChartRequestBody implements SdkFormDataBody {
    ...
    public UpdateAutopilotChartRequestBody withParameters(String parameters) {
    ...
    public UpdateAutopilotChartRequestBody withContent(FormDataFilePart content) {
    ...
    public UpdateAutopilotChartRequestBody withContent(InputStream inputStream, String fileName, String contentType) {
        this.content = new FormDataFilePart(inputStream, fileName).withContentType(contentType);
        return this;
    }

    public UpdateAutopilotChartRequestBody withContent(InputStream inputStream, String fileName) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        UpdateAutopilotChartRequestBody that = (UpdateAutopilotChartRequestBody) obj;
