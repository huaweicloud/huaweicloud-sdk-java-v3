 ...
 * Response Object
 */
public class UpdateAutopilotMaintenanceWindowResponse extends SdkResponse {
    ...
    public UpdateAutopilotMaintenanceWindowResponse withWeeklyPeriod(String weeklyPeriod) {
    ...
    public UpdateAutopilotMaintenanceWindowResponse withStartTime(String startTime) {
    ...
    public UpdateAutopilotMaintenanceWindowResponse withDurationHours(Integer durationHours) {
    ...
    public UpdateAutopilotMaintenanceWindowResponse withUpgradeScope(String upgradeScope) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        UpdateAutopilotMaintenanceWindowResponse that = (UpdateAutopilotMaintenanceWindowResponse) obj;
    ...
    public String toString() {
        ...
        sb.append("class UpdateAutopilotMaintenanceWindowResponse {\n");
