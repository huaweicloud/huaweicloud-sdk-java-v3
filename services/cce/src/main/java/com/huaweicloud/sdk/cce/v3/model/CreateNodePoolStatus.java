...
public class CreateNodePoolStatus {
    ...
    public CreateNodePoolStatus withCreatingNode(Integer creatingNode) {
    ...
    public CreateNodePoolStatus withDeletingNode(Integer deletingNode) {
    ...
    public CreateNodePoolStatus withActiveNode(Integer activeNode) {
    ...
    public CreateNodePoolStatus withConfigurationSyncedNodeCount(Integer configurationSyncedNodeCount) {
    ...
    public CreateNodePoolStatus withPhase(PhaseEnum phase) {
        this.phase = phase;
        return this;
    }
    ...
    public CreateNodePoolStatus withConditions(List<NodePoolCondition> conditions) {
        this.conditions = conditions;
        return this;
    }

    public CreateNodePoolStatus addConditionsItem(NodePoolCondition conditionsItem) {
    ...
    public CreateNodePoolStatus withConditions(Consumer<List<NodePoolCondition>> conditionsSetter) {
        if (this.conditions == null) {
            this.conditions = new ArrayList<>();
        }
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        CreateNodePoolStatus that = (CreateNodePoolStatus) obj;
