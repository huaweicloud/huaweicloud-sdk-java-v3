...
public class ShowPartitionRequest {
    ...
    public ShowPartitionRequest withClusterId(String clusterId) {
    ...
    public ShowPartitionRequest withPartitionName(String partitionName) {
