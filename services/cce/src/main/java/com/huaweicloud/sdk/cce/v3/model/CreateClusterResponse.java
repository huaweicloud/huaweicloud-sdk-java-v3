...
public class CreateClusterResponse extends SdkResponse {
    ...
    public CreateClusterResponse withSpec(V3ClusterSpec spec) {
        this.spec = spec;
        return this;
    }

    public CreateClusterResponse withSpec(Consumer<V3ClusterSpec> specSetter) {
        if(this.spec == null ){
    ...
    public boolean equals(java.lang.Object o) {
        ...
        return Objects.equals(this.kind, createClusterResponse.kind) &&
            Objects.equals(this.apiVersion, createClusterResponse.apiVersion) &&
            Objects.equals(this.metadata, createClusterResponse.metadata) &&
            Objects.equals(this.spec, createClusterResponse.spec) &&
            Objects.equals(this.status, createClusterResponse.status);
    }
    @Override
    public int hashCode() {
