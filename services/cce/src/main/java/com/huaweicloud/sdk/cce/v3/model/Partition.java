...
public class Partition {
    ...
    public Partition withKind(String kind) {
        this.kind = kind;
        return this;
    }
    ...
    public Partition withApiVersion(String apiVersion) {
    ...
    public Partition withMetadata(PartitionMetadata metadata) {
        this.metadata = metadata;
        return this;
    }

    public Partition withMetadata(Consumer<PartitionMetadata> metadataSetter) {
    ...
    public Partition withSpec(PartitionSpec spec) {
        this.spec = spec;
        return this;
    }

    public Partition withSpec(Consumer<PartitionSpec> specSetter) {
        if (this.spec == null) {
