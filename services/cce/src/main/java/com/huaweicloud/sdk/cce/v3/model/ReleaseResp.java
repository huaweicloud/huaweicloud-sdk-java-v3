...
public class ReleaseResp {
    ...
    public ReleaseResp withChartName(String chartName) {
    ...
    public ReleaseResp withChartPublic(Boolean chartPublic) {
    ...
    public ReleaseResp withChartVersion(String chartVersion) {
    ...
    public ReleaseResp withClusterId(String clusterId) {
    ...
    public ReleaseResp withClusterName(String clusterName) {
    ...
    public ReleaseResp withCreateAt(String createAt) {
    ...
    public ReleaseResp withDescription(String description) {
    ...
    public ReleaseResp withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public ReleaseResp withNamespace(String namespace) {
    ...
    public ReleaseResp withParameters(String parameters) {
    ...
    public ReleaseResp withResources(String resources) {
    ...
    public ReleaseResp withStatus(String status) {
        this.status = status;
        return this;
    }
    ...
    public ReleaseResp withStatusDescription(String statusDescription) {
    ...
    public ReleaseResp withUpdateAt(String updateAt) {
    ...
    public ReleaseResp withValues(String values) {
        this.values = values;
        return this;
    }
    ...
    public ReleaseResp withVersion(Integer version) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ReleaseResp that = (ReleaseResp) obj;
