 ...
 * Response Object
 */
public class CreateAutopilotMaintenanceWindowResponse extends SdkResponse {
    ...
    public CreateAutopilotMaintenanceWindowResponse withWeeklyPeriod(String weeklyPeriod) {
    ...
    public CreateAutopilotMaintenanceWindowResponse withStartTime(String startTime) {
    ...
    public CreateAutopilotMaintenanceWindowResponse withDurationHours(Integer durationHours) {
    ...
    public CreateAutopilotMaintenanceWindowResponse withUpgradeScope(String upgradeScope) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        CreateAutopilotMaintenanceWindowResponse that = (CreateAutopilotMaintenanceWindowResponse) obj;
    ...
    public String toString() {
        ...
        sb.append("class CreateAutopilotMaintenanceWindowResponse {\n");
