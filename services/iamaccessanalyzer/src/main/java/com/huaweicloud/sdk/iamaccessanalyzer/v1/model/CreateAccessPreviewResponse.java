 ...
 * Response Object
 */
public class CreateAccessPreviewResponse extends SdkResponse {
    ...
    public CreateAccessPreviewResponse withAccessPreviewId(String accessPreviewId) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        CreateAccessPreviewResponse that = (CreateAccessPreviewResponse) obj;
        return Objects.equals(this.accessPreviewId, that.accessPreviewId);
    }

    @Override
    public int hashCode() {
        return Objects.hash(accessPreviewId);
    }

    @Override
    public String toString() {
        StringBuilder sb = new StringBuilder();
        sb.append("class CreateAccessPreviewResponse {\n");
