 ...
 * Response Object
 */
public class RetryInstanceTaskResponse extends SdkResponse {
    ...
    public RetryInstanceTaskResponse withTaskId(String taskId) {
        this.taskId = taskId;
        return this;
    }
    ...
    public RetryInstanceTaskResponse withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public RetryInstanceTaskResponse withStatus(String status) {
        this.status = status;
        return this;
    }
    ...
    public RetryInstanceTaskResponse withStatusDetail(String statusDetail) {
    ...
    public RetryInstanceTaskResponse withCreateTime(String createTime) {
    ...
    public RetryInstanceTaskResponse withStartTime(String startTime) {
    ...
    public RetryInstanceTaskResponse withEndTime(String endTime) {
    ...
    public RetryInstanceTaskResponse withTargetConfig(TargetConfig targetConfig) {
        this.targetConfig = targetConfig;
        return this;
    }

    public RetryInstanceTaskResponse withTargetConfig(Consumer<TargetConfig> targetConfigSetter) {
    ...
    public RetryInstanceTaskResponse withOperateWindow(OperateWindow operateWindow) {
        this.operateWindow = operateWindow;
        return this;
    }

    public RetryInstanceTaskResponse withOperateWindow(Consumer<OperateWindow> operateWindowSetter) {
    ...
    public RetryInstanceTaskResponse withProgress(Integer progress) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        RetryInstanceTaskResponse that = (RetryInstanceTaskResponse) obj;
        return Objects.equals(this.taskId, that.taskId) && Objects.equals(this.type, that.type)
            ...
            && Objects.equals(this.operateWindow, that.operateWindow) && Objects.equals(this.progress, that.progress);
    }
    ...
    public String toString() {
        ...
        sb.append("class RetryInstanceTaskResponse {\n");
