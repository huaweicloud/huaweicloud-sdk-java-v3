...
public class IoTDMClient {
     ...
     * @return ListInstanceFlavorsResponse
     */
    public ListInstanceFlavorsResponse listInstanceFlavors(ListInstanceFlavorsRequest request) {
        return hcClient.syncInvokeHttp(request, IoTDMMeta.listInstanceFlavors);
    }
     ...
     *
     * @param request ListInstanceFlavorsRequest 请求对象
     * @return SyncInvoker<ListInstanceFlavorsRequest, ListInstanceFlavorsResponse>
     */
    public SyncInvoker<ListInstanceFlavorsRequest, ListInstanceFlavorsResponse> listInstanceFlavorsInvoker(
        ListInstanceFlavorsRequest request) {
        return new SyncInvoker<>(request, IoTDMMeta.listInstanceFlavors, hcClient);
    }
     ...
     */
    public ListInstanceTasksResponse listInstanceTasks(ListInstanceTasksRequest request) {
        return hcClient.syncInvokeHttp(request, IoTDMMeta.listInstanceTasks);
    }
     ...
     *
     * @param request ListInstanceTasksRequest 请求对象
     * @return SyncInvoker<ListInstanceTasksRequest, ListInstanceTasksResponse>
     */
    public SyncInvoker<ListInstanceTasksRequest, ListInstanceTasksResponse> listInstanceTasksInvoker(
        ListInstanceTasksRequest request) {
        return new SyncInvoker<>(request, IoTDMMeta.listInstanceTasks, hcClient);
    }
     ...
     * @return RetryInstanceTaskResponse
     */
    public RetryInstanceTaskResponse retryInstanceTask(RetryInstanceTaskRequest request) {
        return hcClient.syncInvokeHttp(request, IoTDMMeta.retryInstanceTask);
    }
     ...
     *
     * @param request RetryInstanceTaskRequest 请求对象
     * @return SyncInvoker<RetryInstanceTaskRequest, RetryInstanceTaskResponse>
     */
    public SyncInvoker<RetryInstanceTaskRequest, RetryInstanceTaskResponse> retryInstanceTaskInvoker(
        RetryInstanceTaskRequest request) {
        return new SyncInvoker<>(request, IoTDMMeta.retryInstanceTask, hcClient);
    }
     ...
     * @return ShowInstanceTaskResponse
     */
    public ShowInstanceTaskResponse showInstanceTask(ShowInstanceTaskRequest request) {
        return hcClient.syncInvokeHttp(request, IoTDMMeta.showInstanceTask);
    }
     ...
     *
     * @param request ShowInstanceTaskRequest 请求对象
     * @return SyncInvoker<ShowInstanceTaskRequest, ShowInstanceTaskResponse>
     */
    public SyncInvoker<ShowInstanceTaskRequest, ShowInstanceTaskResponse> showInstanceTaskInvoker(
        ShowInstanceTaskRequest request) {
        return new SyncInvoker<>(request, IoTDMMeta.showInstanceTask, hcClient);
    }
