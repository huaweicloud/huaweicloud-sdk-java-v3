...
public class ResizeInstanceRequest {
    ...
    public ResizeInstanceRequest withBody(ResizeInstance body) {
        this.body = body;
        return this;
    }

    public ResizeInstanceRequest withBody(Consumer<ResizeInstance> bodySetter) {
        if (this.body == null) {
            this.body = new ResizeInstance();
     ...
     * @return body
     */
    public ResizeInstance getBody() {
        return body;
    }

    public void setBody(ResizeInstance body) {
        this.body = body;
    }
