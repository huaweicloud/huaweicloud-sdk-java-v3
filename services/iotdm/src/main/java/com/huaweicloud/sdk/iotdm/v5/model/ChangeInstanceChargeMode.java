...
public class ChangeInstanceChargeMode {
    ...
    public ChangeInstanceChargeMode withPeriodType(String periodType) {
    ...
    public ChangeInstanceChargeMode withPeriodNum(Integer periodNum) {
    ...
    public ChangeInstanceChargeMode withIsAutoRenew(Boolean isAutoRenew) {
    ...
    public ChangeInstanceChargeMode withIsAutoPay(Boolean isAutoPay) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ChangeInstanceChargeMode that = (ChangeInstanceChargeMode) obj;
