 ...
 * Response Object
 */
public class ShowInstanceTaskResponse extends SdkResponse {
    ...
    public ShowInstanceTaskResponse withTaskId(String taskId) {
        this.taskId = taskId;
        return this;
    }
    ...
    public ShowInstanceTaskResponse withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public ShowInstanceTaskResponse withStatus(String status) {
        this.status = status;
        return this;
    }
    ...
    public ShowInstanceTaskResponse withStatusDetail(String statusDetail) {
    ...
    public ShowInstanceTaskResponse withCreateTime(String createTime) {
    ...
    public ShowInstanceTaskResponse withStartTime(String startTime) {
    ...
    public ShowInstanceTaskResponse withEndTime(String endTime) {
    ...
    public ShowInstanceTaskResponse withTargetConfig(TargetConfig targetConfig) {
        this.targetConfig = targetConfig;
        return this;
    }

    public ShowInstanceTaskResponse withTargetConfig(Consumer<TargetConfig> targetConfigSetter) {
    ...
    public ShowInstanceTaskResponse withOperateWindow(OperateWindow operateWindow) {
        this.operateWindow = operateWindow;
        return this;
    }

    public ShowInstanceTaskResponse withOperateWindow(Consumer<OperateWindow> operateWindowSetter) {
    ...
    public ShowInstanceTaskResponse withProgress(Integer progress) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ShowInstanceTaskResponse that = (ShowInstanceTaskResponse) obj;
