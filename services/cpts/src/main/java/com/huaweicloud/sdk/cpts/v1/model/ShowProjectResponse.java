...
public class ShowProjectResponse extends SdkResponse {
    ...
    public ShowProjectResponse withMessage(String message) {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        return Objects.equals(this.code, showProjectResponse.code)
            && Objects.equals(this.message, showProjectResponse.message)
            && Objects.equals(this.project, showProjectResponse.project);
    }

    @Override
    public int hashCode() {
        return Objects.hash(code, message, project);
    }
