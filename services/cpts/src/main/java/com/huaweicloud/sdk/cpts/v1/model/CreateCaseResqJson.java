...
/** json */
public class CreateCaseResqJson {
    ...
    public CreateCaseResqJson withTaskCaseId(Integer taskCaseId) {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        CreateCaseResqJson createCaseResqJson = (CreateCaseResqJson) o;
        return Objects.equals(this.taskCaseId, createCaseResqJson.taskCaseId);
    }
    ...
    public String toString() {
        ...
        sb.append("class CreateCaseResqJson {\n");
