 ...
 * Response Object
 */
public class ShowEPResponse extends SdkResponse {
    ...
    public ShowEPResponse withEnterpriseProject(EpDetail enterpriseProject) {
        this.enterpriseProject = enterpriseProject;
        return this;
    }

    public ShowEPResponse withEnterpriseProject(Consumer<EpDetail> enterpriseProjectSetter) {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ShowEPResponse showEPResponse = (ShowEPResponse) o;
        return Objects.equals(this.enterpriseProject, showEPResponse.enterpriseProject);
    }
    @Override
    public int hashCode() {
    ...
    public String toString() {
        ...
        sb.append("class ShowEPResponse {\n");
