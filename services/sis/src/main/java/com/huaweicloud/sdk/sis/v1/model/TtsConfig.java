...
public class TtsConfig {
    ...
    public static final class PropertyEnum {
         ...
         */
        public static final PropertyEnum CHINESE_HUAXIAOMAN_COMMON = new PropertyEnum("chinese_huaxiaoman_common");

        /**
         * Enum CHINESE_HUAXIAOFANG_COMMON for value: "chinese_huaxiaofang_common"
         */
        public static final PropertyEnum CHINESE_HUAXIAOFANG_COMMON = new PropertyEnum("chinese_huaxiaofang_common");

        /**
         * Enum CHINESE_HUAXIAOJUN_COMMON for value: "chinese_huaxiaojun_common"
         */
        public static final PropertyEnum CHINESE_HUAXIAOJUN_COMMON = new PropertyEnum("chinese_huaxiaojun_common");
        ...
        private static Map<String, PropertyEnum> createStaticFields() {
            ...
            map.put("chinese_huaxiaoman_common", CHINESE_HUAXIAOMAN_COMMON);
            map.put("chinese_huaxiaofang_common", CHINESE_HUAXIAOFANG_COMMON);
            map.put("chinese_huaxiaojun_common", CHINESE_HUAXIAOJUN_COMMON);
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        return Objects.equals(this.audioFormat, that.audioFormat) && Objects.equals(this.sampleRate, that.sampleRate)
            && Objects.equals(this.property, that.property) && Objects.equals(this.speed, that.speed)
