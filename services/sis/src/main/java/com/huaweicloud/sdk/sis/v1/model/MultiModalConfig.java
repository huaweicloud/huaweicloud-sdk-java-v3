...
public class MultiModalConfig {
    ...
    public static final class VideoFormatEnum {
        ...
        public static VideoFormatEnum fromValue(String value) {
            ...
            return java.util.Optional.ofNullable(STATIC_FIELDS.get(value)).orElse(new VideoFormatEnum(value));
        }
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        MultiModalConfig that = (MultiModalConfig) obj;
        return Objects.equals(this.videoFormat, that.videoFormat) && Objects.equals(this.language, that.language)
