...
public class ProjectManClient {
    ...
    /** AGC调用 当前用户申请加入项目 AGC调用 当前用户申请加入项目, 申请的用户id写在header中
     *
    ...
    /** 批量添加项目成员 批量添加项目成员，只能添加和项目创建者同一租户下的成员，不正确的用户id会略过，添加的用户超过权限的，默认角色设置为7
     *
