...
public class IssueAccessoryV2 {
    ...
    public IssueAccessoryV2 withAttachmentId(Integer attachmentId) {
    ...
    public IssueAccessoryV2 withIssueId(Integer issueId) {
    ...
    public IssueAccessoryV2 withCreatorNumId(Integer creatorNumId) {
    ...
    public IssueAccessoryV2 withCreatedDate(String createdDate) {
    ...
    public IssueAccessoryV2 withFileName(String fileName) {
    ...
    public IssueAccessoryV2 withContainerType(String containerType) {
    ...
    public IssueAccessoryV2 withDiskFileName(String diskFileName) {
    ...
    public IssueAccessoryV2 withDigest(String digest) {
        this.digest = digest;
        return this;
    }
    ...
    public IssueAccessoryV2 withDiskDirectory(String diskDirectory) {
    ...
    public IssueAccessoryV2 withCreatorId(String creatorId) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        IssueAccessoryV2 that = (IssueAccessoryV2) obj;
    ...
    public String toString() {
        ...
        sb.append("class IssueAccessoryV2 {\n");
