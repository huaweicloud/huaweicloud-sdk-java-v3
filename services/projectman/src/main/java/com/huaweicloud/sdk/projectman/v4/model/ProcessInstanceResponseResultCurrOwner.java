...
public class ProcessInstanceResponseResultCurrOwner {
    ...
    public ProcessInstanceResponseResultCurrOwner withWatcher(String watcher) {
    ...
    public ProcessInstanceResponseResultCurrOwner withUserId(String userId) {
        this.userId = userId;
        return this;
    }
    ...
    public ProcessInstanceResponseResultCurrOwner withUserNumId(String userNumId) {
    ...
    public ProcessInstanceResponseResultCurrOwner withUserName(String userName) {
    ...
    public ProcessInstanceResponseResultCurrOwner withDomainId(String domainId) {
    ...
    public ProcessInstanceResponseResultCurrOwner withDomainName(String domainName) {
    ...
    public ProcessInstanceResponseResultCurrOwner withNickName(String nickName) {
    ...
    public ProcessInstanceResponseResultCurrOwner withRoleId(String roleId) {
        this.roleId = roleId;
        return this;
    }
    ...
    public ProcessInstanceResponseResultCurrOwner withRoleName(String roleName) {
    ...
    public ProcessInstanceResponseResultCurrOwner withImageId(String imageId) {
    ...
    public ProcessInstanceResponseResultCurrOwner withRegion(String region) {
        this.region = region;
        return this;
    }
    ...
    public ProcessInstanceResponseResultCurrOwner withOpinion(String opinion) {
    ...
    public ProcessInstanceResponseResultCurrOwner withDescription(String description) {
    ...
    public ProcessInstanceResponseResultCurrOwner withOwner(String owner) {
        this.owner = owner;
        return this;
    }
    ...
    public ProcessInstanceResponseResultCurrOwner withCcbId(String ccbId) {
        this.ccbId = ccbId;
        return this;
    }
    ...
    public ProcessInstanceResponseResultCurrOwner withHasRemoved(String hasRemoved) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ProcessInstanceResponseResultCurrOwner that = (ProcessInstanceResponseResultCurrOwner) obj;
