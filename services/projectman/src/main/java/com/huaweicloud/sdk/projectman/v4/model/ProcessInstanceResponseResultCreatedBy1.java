 ...
 * 创建人
 */
public class ProcessInstanceResponseResultCreatedBy1 {
    ...
    public ProcessInstanceResponseResultCreatedBy1 withWatcher(String watcher) {
    ...
    public ProcessInstanceResponseResultCreatedBy1 withUserId(String userId) {
        this.userId = userId;
        return this;
    }
    ...
    public ProcessInstanceResponseResultCreatedBy1 withUserNumId(String userNumId) {
    ...
    public ProcessInstanceResponseResultCreatedBy1 withUserName(String userName) {
    ...
    public ProcessInstanceResponseResultCreatedBy1 withDomainId(String domainId) {
    ...
    public ProcessInstanceResponseResultCreatedBy1 withDomainName(String domainName) {
    ...
    public ProcessInstanceResponseResultCreatedBy1 withNickName(String nickName) {
    ...
    public ProcessInstanceResponseResultCreatedBy1 withRoleId(String roleId) {
        this.roleId = roleId;
        return this;
    }
    ...
    public ProcessInstanceResponseResultCreatedBy1 withRoleName(String roleName) {
    ...
    public ProcessInstanceResponseResultCreatedBy1 withImageId(String imageId) {
    ...
    public ProcessInstanceResponseResultCreatedBy1 withRegion(String region) {
        this.region = region;
        return this;
    }
    ...
    public ProcessInstanceResponseResultCreatedBy1 withOpinion(String opinion) {
    ...
    public ProcessInstanceResponseResultCreatedBy1 withDescription(String description) {
    ...
    public ProcessInstanceResponseResultCreatedBy1 withOwner(String owner) {
        this.owner = owner;
        return this;
    }
    ...
    public ProcessInstanceResponseResultCreatedBy1 withCcbId(String ccbId) {
        this.ccbId = ccbId;
        return this;
    }
    ...
    public ProcessInstanceResponseResultCreatedBy1 withHasRemoved(String hasRemoved) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ProcessInstanceResponseResultCreatedBy1 that = (ProcessInstanceResponseResultCreatedBy1) obj;
    ...
    public String toString() {
        ...
        sb.append("class ProcessInstanceResponseResultCreatedBy1 {\n");
