package com.huaweicloud.sdk.projectman.v4.region;
...
public class ProjectManRegion {
    ...
    public static final Region CN_NORTH_4 =
        new Region("cn-north-4", "https://projectman-ext.cn-north-4.myhuaweicloud.com");

    public static final Region CN_NORTH_1 =
        new Region("cn-north-1", "https://projectman-ext.cn-north-1.myhuaweicloud.com");

    public static final Region CN_EAST_2 =
        new Region("cn-east-2", "https://projectman-ext.cn-east-2.myhuaweicloud.com");

    public static final Region CN_SOUTH_1 =
        new Region("cn-south-1", "https://projectman-ext.cn-south-1.myhuaweicloud.com");

    public static final Region CN_SOUTHWEST_2 =
        new Region("cn-southwest-2", "https://projectman-ext.cn-southwest-2.myhuaweicloud.com");
    ...
    public static Region valueOf(String regionId) {
        ...
        throw new IllegalArgumentException(String.format(Locale.ROOT,
            "region id '%s' is not in the following supported regions of service ProjectMan: [%s]",
            regionId,
