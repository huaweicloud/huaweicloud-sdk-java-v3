...
public class ShowCompletionRateRequest {
    ...
    public ShowCompletionRateRequest withProjectId(String projectId) {
    ...
    public ShowCompletionRateRequest withBody(MetricRequest3 body) {
        this.body = body;
        return this;
    }

    public ShowCompletionRateRequest withBody(Consumer<MetricRequest3> bodySetter) {
        if (this.body == null) {
    ...
    public void setBody(MetricRequest3 body) {
        this.body = body;
    }
