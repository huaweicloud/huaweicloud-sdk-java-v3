 ...
 * 工作项优先级信息
 */
public class WorkTableIssuseListResponseBodyPriority {
    ...
    public WorkTableIssuseListResponseBodyPriority withId(Integer id) {
        this.id = id;
        return this;
    }
    ...
    public WorkTableIssuseListResponseBodyPriority withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append("class WorkTableIssuseListResponseBodyPriority {\n");
