 ...
 */
public class IssueDetailCustomFieldV2 {
    ...
    public IssueDetailCustomFieldV2 withCustomField(String customField) {
    ...
    public IssueDetailCustomFieldV2 withFieldName(String fieldName) {
    ...
    public IssueDetailCustomFieldV2 withValue(String value) {
        this.value = value;
        return this;
    }
    ...
    public IssueDetailCustomFieldV2 withFieldType(String fieldType) {
    ...
    public IssueDetailCustomFieldV2 withDescription(String description) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        IssueDetailCustomFieldV2 that = (IssueDetailCustomFieldV2) obj;
    ...
    public String toString() {
        ...
        sb.append("class IssueDetailCustomFieldV2 {\n");
