 ...
 */
public class CreateIssueResponseV4Tracker {
    ...
    public CreateIssueResponseV4Tracker withId(Integer id) {
        this.id = id;
        return this;
    }
    ...
    public CreateIssueResponseV4Tracker withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append("class CreateIssueResponseV4Tracker {\n");
