...
public class DetectStandardByVideoAndIdCardImageRequest {
    ...
    public DetectStandardByVideoAndIdCardImageRequest withEnterpriseProjectId(String enterpriseProjectId) {
    ...
    public DetectStandardByVideoAndIdCardImageRequest withBody(IvsStandardByVideoAndIdCardImageRequestBody body) {
        this.body = body;
        return this;
    }

    public DetectStandardByVideoAndIdCardImageRequest withBody(
        Consumer<IvsStandardByVideoAndIdCardImageRequestBody> bodySetter) {
        if (this.body == null) {
    ...
    public void setBody(IvsStandardByVideoAndIdCardImageRequestBody body) {
        this.body = body;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        DetectStandardByVideoAndIdCardImageRequest detectStandardByVideoAndIdCardImageRequest =
            (DetectStandardByVideoAndIdCardImageRequest) o;
        return Objects.equals(this.enterpriseProjectId, detectStandardByVideoAndIdCardImageRequest.enterpriseProjectId)
            && Objects.equals(this.body, detectStandardByVideoAndIdCardImageRequest.body);
    }
