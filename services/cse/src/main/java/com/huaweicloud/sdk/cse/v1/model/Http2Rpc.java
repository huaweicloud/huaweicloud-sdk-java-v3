...
public class Http2Rpc {
    ...
    public Http2Rpc withGatewayId(String gatewayId) {
    ...
    public Http2Rpc withPluginConfig(Object pluginConfig) {
    ...
    public Http2Rpc withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Http2Rpc withRouteName(String routeName) {
    ...
    public Http2Rpc withRouteDestinationName(String routeDestinationName) {
    ...
    public Http2Rpc withDubbo(Dubbo dubbo) {
        this.dubbo = dubbo;
        return this;
    }

    public Http2Rpc withDubbo(Consumer<Dubbo> dubboSetter) {
        if (this.dubbo == null) {
