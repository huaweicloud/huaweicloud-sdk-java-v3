 ...
 * Request Object
 */
public class DeleteMicroserviceRouteRuleRequest {
    ...
    public DeleteMicroserviceRouteRuleRequest withXEngineId(String xEngineId) {
    ...
    public DeleteMicroserviceRouteRuleRequest withXEnterpriseProjectID(String xEnterpriseProjectID) {
    ...
    public DeleteMicroserviceRouteRuleRequest withServiceName(String serviceName) {
    ...
    public DeleteMicroserviceRouteRuleRequest withEnvironment(String environment) {
    ...
    public DeleteMicroserviceRouteRuleRequest withAppId(String appId) {
        this.appId = appId;
        return this;
    }
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        DeleteMicroserviceRouteRuleRequest that = (DeleteMicroserviceRouteRuleRequest) obj;
    ...
    public String toString() {
        ...
        sb.append("class DeleteMicroserviceRouteRuleRequest {\n");
