...
public class CreatePluginResponse extends SdkResponse {
    ...
    public CreatePluginResponse withImagePullPolicy(ImagePullPolicyEnum imagePullPolicy) {
    ...
    public CreatePluginResponse withImagePullSecret(String imagePullSecret) {
    ...
    public CreatePluginResponse withPhase(PhaseEnum phase) {
        this.phase = phase;
        return this;
    }
    ...
    public CreatePluginResponse withPluginConfig(Object pluginConfig) {
    ...
    public CreatePluginResponse withPriority(Integer priority) {
    ...
    public CreatePluginResponse withSha256(String sha256) {
        this.sha256 = sha256;
        return this;
    }
    ...
    public CreatePluginResponse withUrl(String url) {
        this.url = url;
        return this;
    }
    ...
    public CreatePluginResponse withVerificationKey(String verificationKey) {
