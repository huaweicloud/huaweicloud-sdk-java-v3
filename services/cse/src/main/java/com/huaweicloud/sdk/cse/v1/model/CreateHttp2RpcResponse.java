 ...
 * Response Object
 */
public class CreateHttp2RpcResponse extends SdkResponse {
    ...
    public CreateHttp2RpcResponse withGatewayId(String gatewayId) {
    ...
    public CreateHttp2RpcResponse withPluginConfig(Object pluginConfig) {
    ...
    public CreateHttp2RpcResponse withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public CreateHttp2RpcResponse withRouteName(String routeName) {
    ...
    public CreateHttp2RpcResponse withRouteDestinationName(String routeDestinationName) {
    ...
    public CreateHttp2RpcResponse withDubbo(Dubbo dubbo) {
        this.dubbo = dubbo;
        return this;
    }

    public CreateHttp2RpcResponse withDubbo(Consumer<Dubbo> dubboSetter) {
        if (this.dubbo == null) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        CreateHttp2RpcResponse that = (CreateHttp2RpcResponse) obj;
    ...
    public String toString() {
        ...
        sb.append("class CreateHttp2RpcResponse {\n");
