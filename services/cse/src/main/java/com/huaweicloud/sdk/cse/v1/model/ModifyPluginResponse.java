 ...
 * Response Object
 */
public class ModifyPluginResponse extends SdkResponse {
    ...
    public ModifyPluginResponse withImagePullPolicy(ImagePullPolicyEnum imagePullPolicy) {
    ...
    public ModifyPluginResponse withPhase(PhaseEnum phase) {
        this.phase = phase;
        return this;
    }
    ...
    public ModifyPluginResponse withPluginConfig(Object pluginConfig) {
    ...
    public ModifyPluginResponse withPluginName(String pluginName) {
    ...
    public ModifyPluginResponse withPriority(Integer priority) {
    ...
    public ModifyPluginResponse withSha256(String sha256) {
        this.sha256 = sha256;
        return this;
    }
    ...
    public ModifyPluginResponse withUrl(String url) {
        this.url = url;
        return this;
    }
    ...
    public ModifyPluginResponse withVerificationKey(String verificationKey) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ModifyPluginResponse that = (ModifyPluginResponse) obj;
