 ...
 * Response Object
 */
public class UpgradeEngineResponse extends SdkResponse {
    ...
    public UpgradeEngineResponse withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public UpgradeEngineResponse withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public UpgradeEngineResponse withJobId(Integer jobId) {
        this.jobId = jobId;
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append("class UpgradeEngineResponse {\n");
