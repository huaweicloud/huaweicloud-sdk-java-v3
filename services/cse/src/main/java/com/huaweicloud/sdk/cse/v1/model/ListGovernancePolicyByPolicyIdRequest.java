 ...
 * Request Object
 */
public class ListGovernancePolicyByPolicyIdRequest {
    ...
    public ListGovernancePolicyByPolicyIdRequest withXEngineId(String xEngineId) {
    ...
    public ListGovernancePolicyByPolicyIdRequest withXEnterpriseProjectID(String xEnterpriseProjectID) {
    ...
    public ListGovernancePolicyByPolicyIdRequest withXEnvironment(String xEnvironment) {
    ...
    public ListGovernancePolicyByPolicyIdRequest withKind(String kind) {
        this.kind = kind;
        return this;
    }
    ...
    public ListGovernancePolicyByPolicyIdRequest withPolicyId(String policyId) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ListGovernancePolicyByPolicyIdRequest that = (ListGovernancePolicyByPolicyIdRequest) obj;
    ...
    public String toString() {
        ...
        sb.append("class ListGovernancePolicyByPolicyIdRequest {\n");
