...
public class PipelineTemplate {
    ...
    public PipelineTemplate withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public PipelineTemplate withDescription(String description) {
    ...
    public PipelineTemplate withRegionId(String regionId) {
    ...
    public PipelineTemplate withUrl(String url) {
        this.url = url;
        return this;
    }
    ...
    @Override
    public int hashCode() {
        return Objects.hash(name, id, description, regionId, url);
    }
