...
public class ListCdnDomainTopRefersRequest {
    ...
    public ListCdnDomainTopRefersRequest withEndTime(Long endTime) {
    ...
    public ListCdnDomainTopRefersRequest withDomainName(String domainName) {
    ...
    public ListCdnDomainTopRefersRequest withStatType(String statType) {
    ...
    public ListCdnDomainTopRefersRequest withServiceArea(String serviceArea) {
    ...
    public ListCdnDomainTopRefersRequest withEnterpriseProjectId(String enterpriseProjectId) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ListCdnDomainTopRefersRequest that = (ListCdnDomainTopRefersRequest) obj;
