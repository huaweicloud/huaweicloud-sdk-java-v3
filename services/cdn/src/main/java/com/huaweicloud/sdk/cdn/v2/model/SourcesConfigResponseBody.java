 ...
 * 源站配置。
 */
public class SourcesConfigResponseBody {
    ...
    public SourcesConfigResponseBody withOriginType(String originType) {
    ...
    public SourcesConfigResponseBody withOriginAddr(String originAddr) {
    ...
    public SourcesConfigResponseBody withPriority(Integer priority) {
    ...
    public SourcesConfigResponseBody withWeight(Integer weight) {
        this.weight = weight;
        return this;
    }
    ...
    public SourcesConfigResponseBody withObsWebHostingStatus(String obsWebHostingStatus) {
    ...
    public SourcesConfigResponseBody withHttpPort(Integer httpPort) {
    ...
    public SourcesConfigResponseBody withHttpsPort(Integer httpsPort) {
    ...
    public SourcesConfigResponseBody withHostName(String hostName) {
    ...
    public SourcesConfigResponseBody withObsBucketType(String obsBucketType) {
    ...
    public SourcesConfigResponseBody withBucketAccessKey(String bucketAccessKey) {
    ...
    public SourcesConfigResponseBody withBucketSecretKey(String bucketSecretKey) {
    ...
    public SourcesConfigResponseBody withBucketRegion(String bucketRegion) {
    ...
    public SourcesConfigResponseBody withBucketName(String bucketName) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        SourcesConfigResponseBody that = (SourcesConfigResponseBody) obj;
    ...
    public String toString() {
        ...
        sb.append("class SourcesConfigResponseBody {\n");
