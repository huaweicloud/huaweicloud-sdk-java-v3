...
public class HeaderMap  {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(contentDisposition, contentLanguage, accessControlAllowOrigin, accessControlAllowMethods, accessControlMaxAge, accessControlExposeHeaders);
    }
    @Override
