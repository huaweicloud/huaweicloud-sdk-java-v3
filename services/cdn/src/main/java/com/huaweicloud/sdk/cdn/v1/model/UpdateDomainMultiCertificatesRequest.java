...
public class UpdateDomainMultiCertificatesRequest  {
    ...
    public UpdateDomainMultiCertificatesRequest withBody(Consumer<UpdateDomainMultiCertificatesRequestBody> bodySetter) {
        if(this.body == null ){
    ...
    public boolean equals(java.lang.Object o) {
        ...
        UpdateDomainMultiCertificatesRequest updateDomainMultiCertificatesRequest = (UpdateDomainMultiCertificatesRequest) o;
        return Objects.equals(this.body, updateDomainMultiCertificatesRequest.body);
    }
    @Override
    public int hashCode() {
