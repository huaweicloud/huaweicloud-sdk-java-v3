...
public class ListCdnDomainTopPathRequest {
    ...
    public ListCdnDomainTopPathRequest withStartTime(Long startTime) {
    ...
    public ListCdnDomainTopPathRequest withEndTime(Long endTime) {
    ...
    public ListCdnDomainTopPathRequest withDomainName(String domainName) {
    ...
    public ListCdnDomainTopPathRequest withStatType(String statType) {
    ...
    public ListCdnDomainTopPathRequest withServiceArea(String serviceArea) {
    ...
    public ListCdnDomainTopPathRequest withUserDomainId(String userDomainId) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ListCdnDomainTopPathRequest that = (ListCdnDomainTopPathRequest) obj;
    ...
    @Override
    public int hashCode() {
        return Objects.hash(startTime, endTime, domainName, statType, serviceArea, userDomainId);
    }
