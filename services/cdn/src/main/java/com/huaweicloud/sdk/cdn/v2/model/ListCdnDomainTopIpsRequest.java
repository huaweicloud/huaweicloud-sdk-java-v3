 ...
 * Request Object
 */
public class ListCdnDomainTopIpsRequest {
    ...
    public ListCdnDomainTopIpsRequest withStartTime(Long startTime) {
    ...
    public ListCdnDomainTopIpsRequest withEndTime(Long endTime) {
    ...
    public ListCdnDomainTopIpsRequest withDomainName(String domainName) {
    ...
    public ListCdnDomainTopIpsRequest withGroupBy(String groupBy) {
    ...
    public ListCdnDomainTopIpsRequest withStatType(String statType) {
    ...
    public ListCdnDomainTopIpsRequest withServiceArea(String serviceArea) {
    ...
    public ListCdnDomainTopIpsRequest withEnterpriseProjectId(String enterpriseProjectId) {
    ...
    public ListCdnDomainTopIpsRequest withIncludeRatio(Boolean includeRatio) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ListCdnDomainTopIpsRequest that = (ListCdnDomainTopIpsRequest) obj;
    ...
    public int hashCode() {
        return Objects
            .hash(startTime, endTime, domainName, groupBy, statType, serviceArea, enterpriseProjectId, includeRatio);
    }

    @Override
    public String toString() {
        StringBuilder sb = new StringBuilder();
        sb.append("class ListCdnDomainTopIpsRequest {\n");
