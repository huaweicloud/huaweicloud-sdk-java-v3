...
public class ListCdnDomainTopUasRequest {
    ...
    public ListCdnDomainTopUasRequest withStartTime(Long startTime) {
    ...
    public ListCdnDomainTopUasRequest withEndTime(Long endTime) {
    ...
    public ListCdnDomainTopUasRequest withDomainName(String domainName) {
    ...
    public ListCdnDomainTopUasRequest withGroupBy(String groupBy) {
    ...
    public ListCdnDomainTopUasRequest withStatType(String statType) {
    ...
    public ListCdnDomainTopUasRequest withServiceArea(String serviceArea) {
    ...
    public ListCdnDomainTopUasRequest withEnterpriseProjectId(String enterpriseProjectId) {
    ...
    public ListCdnDomainTopUasRequest withIncludeRatio(Boolean includeRatio) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        ListCdnDomainTopUasRequest that = (ListCdnDomainTopUasRequest) obj;
