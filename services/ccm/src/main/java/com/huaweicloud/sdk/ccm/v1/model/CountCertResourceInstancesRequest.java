 ...
 * Request Object
 */
public class CountCertResourceInstancesRequest {
    ...
    public CountCertResourceInstancesRequest withBody(ListResourceInstancesRequestBody body) {
        this.body = body;
        return this;
    }

    public CountCertResourceInstancesRequest withBody(Consumer<ListResourceInstancesRequestBody> bodySetter) {
        if (this.body == null) {
    ...
    public String toString() {
        ...
        sb.append("class CountCertResourceInstancesRequest {\n");
