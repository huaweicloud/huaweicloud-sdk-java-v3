...
public final class JsonUtils {
    ...
    private static ObjectMapper initializeBaseMapper() {
        ...
        try {
            ...
            logger.warn("Cannot find class definitions for JsonReadFeature and JsonWriteFeature" +
                    " due to version conflict, use deprecated JsonParser and JsonGenerator instead." +
                    " It is recommended that you use v2.10+(currently in use: {})" +
                    " for better security and compatibility.", mapper.version().toFullString());
        }
