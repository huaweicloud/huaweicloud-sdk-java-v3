...
public class HcClientTest {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(HcClientTest.class);

    private static final int FILE_SIZE = 1024 * 1024 * 5;

    HcClient hcClient;

    HttpRequestDef<HttpRequestDefTest.TestRequest, HttpRequestDefTest.TestResponse> requestDef
            = HttpRequestDefTest.buildHttpRequestDef();

    HttpRequestDef<HttpRequestDefTest.TestNoBodyRequest, HttpRequestDefTest.TestResponse> requestNoRequestBodyDef
            = HttpRequestDefTest.buildHttpRequestNoRequestBodyDef();

    HttpRequestDef<HttpRequestDefTest.TestUploadDownloadRequest, HttpRequestDefTest.TestUploadDownloadResponse>
            testUploadDownloadDef = HttpRequestDefTest.buildTestUploadDownloadRequestDef();

    HttpRequestDef<HttpRequestDefTest.TestUploadDownloadRequest, SdkResponse>
            testUploadDef = HttpRequestDefTest.buildTestUploadRequestDef();

    HttpRequestDef<HttpRequestDefTest.TestProgressRequest, HttpRequestDefTest.TestUploadDownloadResponse>
            testDownloadDef = HttpRequestDefTest.buildTestDownloadRequestDef();

    HttpRequestDef<HttpRequestDefTest.TestCustomAuthorizationRequest,
            HttpRequestDefTest.TestCustomAuthorizationResponse> testCustomizeAuthorizationDef =
            HttpRequestDefTest.buildTestCustomizedAuthorizationRequestDef();
    ...
    public void testAsyncClient() throws ExecutionException, InterruptedException {
        CompletableFuture<HttpRequestDefTest.TestResponse> future = callAsync(new HttpRequestDefTest.TestRequest());
        HttpRequestDefTest.TestResponse response = future.get();
        Assert.assertNotNull(response.getBody());
        HttpRequestDefTest.InnerResponse[] result = new HttpRequestDefTest.InnerResponse[]{
                new HttpRequestDefTest.InnerResponse().withIres("1").withJres("2"),
                new HttpRequestDefTest.InnerResponse().withIres("2").withJres("3")
        };
    ...
    public void testAsyncClientNoRequestBody() throws ExecutionException, InterruptedException {
        CompletableFuture<HttpRequestDefTest.TestResponse> future = callNoRequestBodyAsync(
                new HttpRequestDefTest.TestNoBodyRequest());
        HttpRequestDefTest.TestResponse response = future.get();
        Assert.assertNotNull(response.getBody());
        HttpRequestDefTest.InnerResponse[] result = new HttpRequestDefTest.InnerResponse[]{
                new HttpRequestDefTest.InnerResponse().withIres("1").withJres("2"),
    ...
    public CompletableFuture<HttpRequestDefTest.TestResponse> callAsync(HttpRequestDefTest.TestRequest request) {
        return hcClient.asyncInvokeHttp(request, requestDef);
    }

    public CompletableFuture<HttpRequestDefTest.TestResponse> callNoRequestBodyAsync(
            HttpRequestDefTest.TestNoBodyRequest request) {
    ...
    public void testUploadDownloadRequest() {
        ...
        HttpRequestDefTest.TestUploadDownloadRequest testUploadDownloadRequest
                = new HttpRequestDefTest.TestUploadDownloadRequest();
        testUploadDownloadRequest.setUploadStream(byteArrayInputStream);
        HttpRequestDefTest.TestUploadDownloadResponse response = hcClient.syncInvokeHttp(testUploadDownloadRequest,
    ...
    public void testDownloadProgressRequest() {
        HttpRequestDefTest.TestProgressRequest testProgressRequest = new HttpRequestDefTest.TestProgressRequest();
        TestProgressListener testProgressListener = new TestProgressListener();
        testProgressRequest.setProgressListener(testProgressListener);
        testProgressRequest.setProgressInterval(1024 * 1024L);

        HttpRequestDefTest.TestUploadDownloadResponse response = hcClient.syncInvokeHttp(
    ...
    public void testCustomizedHeaderRequest() throws ExecutionException, InterruptedException {
        CompletableFuture<HttpRequestDefTest.TestCustomAuthorizationResponse> future = callCustomAuthorizationAsync(
                new HttpRequestDefTest.TestCustomAuthorizationRequest().withAuthorization("test"));
        HttpRequestDefTest.TestCustomAuthorizationResponse response = future.get();
    ...
    public CompletableFuture<HttpRequestDefTest.TestCustomAuthorizationResponse> callCustomAuthorizationAsync(
            HttpRequestDefTest.TestCustomAuthorizationRequest request) {
