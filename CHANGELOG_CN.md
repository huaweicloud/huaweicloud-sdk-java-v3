...
- _特性变更_
  ...
  - **StartReal3DTask**
    - 响应参数变更
      - `+ modeling_type`
      - `* modeling_params.key_point_limit: string -> int32`
      - `* modeling_params.tie_point_limit: string -> int32`
      - `* modeling_params.mesh_accuracy: string -> int32`
  - **UpdateReal3DTask**
    - 请求参数变更
      - `+ modeling_type`
      - `* modeling_params.key_point_limit: string -> int32`
  ...
  - **ListTasksInWorkspace**
    ...
    - 响应参数变更
      - `+ modeling_type`
      - `+ tasks.modeling_type`
      - `* tasks.modeling_params.key_point_limit: string -> int32`
      - `* tasks.modeling_params.tie_point_limit: string -> int32`
      - `* tasks.modeling_params.mesh_accuracy: string -> int32`
...
- _新增特性_
  - 支持接口`ListObjects`、`GetBucketAcl`、`SetBucketAcl`
- _解决问题_
  - 无
- _特性变更_
  - **SetBucketCustomedomain**
  ...
  - **GetBucketCustomdomain**
    - 响应参数变更
      - `* Domains: object<Domains> -> list<Domains>`
  - **ListBuckets**
    - 响应参数变更
      - `* Buckets: list<Bucket> -> object<Buckets>`
...
- _解决问题_
  - 无
- _特性变更_
  - 移除接口`ListWorkspace`、`CreateWorkspace`、`UpdateWorkspace`、`DeleteWorkspace`
  - **ValidateImage**
    - 请求参数变更
      - `+ coordination`
  - **CreateTask**
...
- _解决问题_
  - 无
- _特性变更_
  - 接口`CreateAimPersonalTemplate`新增请求参数 `sms_signs`、`sms_template`、`vivo_background`
...
- _新增特性_
  - 支持接口`ListVmsCallbacks`、`AddVmsCallBack`
- _解决问题_
  - 无
- _特性变更_
  - 接口`CreateAimSendTask`新增响应参数 `failed_short_chains`
  - 接口`ListAimSendTasks`新增响应参数 `failed_short_chains`、`success_number`
...
- _新增特性_
  - 支持接口`ListElasticResourcePoolQueues`、`UpdateElasticResourcePoolQueueInfo`
- _解决问题_
  - 无
- _特性变更_
  - 无
...
- _新增特性_
  - 支持接口`ListElasticResourcePools`、`CreateElasticResourcePool`、`UpdateElasticResourcePool`、`DeleteElasticResourcePool`
- _解决问题_
  - 无
- _特性变更_
  - 接口`CreateFlinkJar`请求参数`runtime_config`类型调整 `string` -> `array`
  - 接口`UpdateFlinkJar`请求参数`runtime_config`类型调整 `string` -> `array`
  - 接口`CreateFlinkSql`请求参数`runtime_config`类型调整 `string` -> `array`
  - 接口`UpdateFlinkSql`请求参数`runtime_config`类型调整 `string` -> `array`
...
- _解决问题_
  - 无
- _特性变更_
  - 修改接口`ExportAsset`的请求参数名称: `task_id` -> `id`
...
- _新增特性_
  - 支持接口`ShowRestrictionOfInstanceV2`
- _解决问题_
  - 无
- _特性变更_
  - 接口`ListApiGroupsV2`新增响应参数 `sl_domains`、`remark`、`call_limits`、`time_interval`、`time_unit`、`is_default`、`version`、`roma_app_id`、`roma_app_name`
  - 接口`UpdateApiGroupV2`新增响应参数 `sl_domains`、`remark`、`call_limits`、`time_interval`、`time_unit`、`is_default`、`version`、`roma_app_id`、`roma_app_name`
  - 接口`ShowDetailsOfApiGroupV2`新增响应参数 `sl_domains`、`remark`、`call_limits`、`time_interval`、`time_unit`、`is_default`、`version`、`roma_app_id`、`roma_app_name`
  - 接口`ListApisBindedToRequestThrottlingPolicyV2`新增响应参数 `type`、`throttle_apply_id`、`throttle_name`、`apply_time`
  - 接口`ListApisUnbindedToRequestThrottlingPolicyV2`新增响应参数 `type`、`throttle_apply_id`、`throttle_name`、`apply_time`
...
- _解决问题_
  - 无
- _特性变更_
  - 接口`ListApiGroupsV2`新增请求参数`domain_name`
  - 接口`ListApisV2`新增请求参数`vpc_channel_id`和`vpc_channel_name`
  - 接口`CreateSignatureKeyV2`和`UpdateSignatureKeyV2`新增请求参数`sign_algorithm`
  - 接口`ListVpcChannelsV2`新增请求参数`dict_code`、`member_host`、`member_port`、`member_group_name`、`member_group_id`
  - 接口`ListBackendInstancesV2`新增请求参数`member_group_name`、`member_group_id`、`precise_search`
  - 接口`PublishLiveDataApiV2`新增请求参数`retry_count`
...
- _新增特性_
  - 支持接口`CreateNotification`、`UpdateNotification`、`DeleteNotification`、`ListNotifications`
- _解决问题_
  - 无
- _特性变更_
  - 无
...
- _新增特性_
  - 支持以下接口:
    ...
    - `ShowAlarmRule`
- _解决问题_
  - [Issue #43](https://github.com/huaweicloud/huaweicloud-sdk-java-v3/issues/43)：修复接口`ListSeries`的响应参数`offset`类型错误的问题
- _特性变更_
  - 无
...
- _新增特性_
  - 新增接口`CreateNotification`、`ListNotification`、`UpdateNotification`、`DeleteNotification`
- _解决问题_
  - 无
- _特性变更_
  - 无
...
- _解决问题_
  - 无
- _特性变更_
  - 接口`ListRomaApp`的响应参数`create_time`和`update_time`类型调整： `number` -> `string`
  - 接口`ListDictionary`的响应参数`create_time`和`update_time`类型调整： `number` -> `string`
...
- _特性变更_
    - 部分接口名称调整：
      - `CreateTaskV2`->`CreateTask`
      - `ShowTaskListByProjectIdV2`->`ShowTaskListByProjectId`
      - `RunTaskV2`->`RunTask`
      - `StopTaskByIdV2`->`StopTaskById`
      - `ShowProgressDetailV2`->`ShowProgressDetail`
      - `ShowTaskDetailV2`->`ShowTaskDetail`
...
- _解决问题_
    - 无
- _特性变更_
    - 接口`ListSpaceAnalysis`的请求参数`show_instance_info`类型调整：`boolean`->`string`
    - 接口`ListInnodbLocks`新增响应参数`count`
