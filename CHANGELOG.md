...
- _Bug Fix_
  - None
- _Change_
  - Remove the APIs `UpdateOpsDatasetTags`, `UpdateOpsEvaluatorTags`, `UpdateOpsEvaluationTaskTags`
...
- _Change_
  - **ExecuteInstanceAuthToken**
    - changes of response param
      - `+ data.resource.app_ip_synchronize_list`
  - **CreateInstance**
    - changes of request param
      - `- customImageType`
      - `- customImageId`
  ...
  - **BatchShowSku**
    - changes of response param
      - `+ data.skuSpecResponseList.skuResponses.resourceSize`
  - **InstallApp**
    - changes of response param
      - `+ data.cmd_jobs`
      - `+ data.task_id`
      - `- data.data`
      - `* data: object<RmInstallAppResp> -> object<TaskDataResult>`
...
- _Features_
  - Support the following APIs:
    ...
    - `BatchLockPoolNodes`
    - `BatchUnlockPoolNodes`
    - `BatchRebootPoolNodes`
    - `BatchResetPoolNodes`
    - `BatchResizePoolNodes`
    - `BatchMigratePoolNodes`
    - `BatchBindPoolNodes`
    - `ShowOsConfig`
    - `ShowPluginTemplate`
    - `ListPluginTemplates`
...
- _Change_
  ...
  - **PatchPool**
    - changes of response param
      - `* status.resources.creating.azs: list<object> -> list<PoolNodeAz>`
  - **PatchNetwork**
    - changes of request param
      - `* spec.connection.peerConnectionList: list<object> -> list<PeerConnectionItem>`
    - changes of response param
      - `* metadata: object<NeworkMetadata> -> object<NetworkMetadata>`
      - `* spec.connection.peerConnectionList: list<object> -> list<PeerConnectionItem>`
      - `* status.connectionStatus.peerConnectionStatus: list<object> -> list<PeerConnectionStatus>`
      - `+ status.connectionStatus.sfsTurboStatus.connectionType`
      - `* status.connectionStatus.sfsTurboStatus: list<object> -> list<SfsTurboConnectionStatus>`
  - **PatchNodePool**
    - changes of request param
      - `+ metadata`
      - `+ spec.resources.rootVolume`
      - `+ spec.resources.dataVolumes`
      - `+ spec.resources.volumeGroupConfigs`
      - `+ spec.resources.os`
      - `+ spec.resources.extendParams.dockerBaseSize`
      - `+ spec.resources.extendParams.postInstall`
      - `+ spec.resources.extendParams.runtime`
      - `+ spec.resources.extendParams.labelPolicyOnExistingNodes`
      - `+ spec.resources.extendParams.taintPolicyOnExistingNodes`
      - `+ spec.resources.extendParams.tagPolicyOnExistingNodes`
      - `+ spec.resources.extendParams.XParameterPlaneSubnet`
      - `+ spec.resources.extendParams.nodePoolName`
      - `* spec.resources.extendParams: map<string, string> -> object<ResourceExtendParams>`
      - `* spec.resources.taints: list<Taint> -> list<Taints>`
      - `* spec.resources.tags: list<UserTag> -> list<UserTags>`
    - changes of response param
      - `+ metadata`
      - `+ spec.resources.rootVolume`
      - `+ spec.resources.dataVolumes`
  ...
  - **ShowTrainingJobDetails**
    - changes of response param
      - `* algorithm.engine: object<JobEngine> -> object<JobEngineResp>`
      - `- algorithm.inputs.remote.dataset.dataset_proportion`
      - `* algorithm.inputs.remote: object<InputDataInfo> -> object<InputDataInfoResp>`
      - `* algorithm.inputs: list<Input> -> list<InputResp>`
      - `* algorithm.outputs.remote.obs: object<RemoteObs> -> object<RemoteObsResp>`
      - `* algorithm.outputs.remote: object<Remote> -> object<RemoteResp>`
      - `* algorithm.outputs: list<Output> -> list<OutputResp>`
  - **StopTrainingJob**
    - changes of response param
      - `* algorithm.engine: object<JobEngine> -> object<JobEngineResp>`
      - `- algorithm.inputs.remote.dataset.dataset_proportion`
  ...
  - **ListTrainingJobs**
    - changes of response param
      - `* items.algorithm.engine: object<JobEngine> -> object<JobEngineResp>`
      - `- items.algorithm.inputs.remote.dataset.dataset_proportion`
      - `* items.algorithm.inputs.remote: object<InputDataInfo> -> object<InputDataInfoResp>`
      - `* items.algorithm.inputs: list<Input> -> list<InputResp>`
      - `* items.algorithm.outputs.remote.obs: object<RemoteObs> -> object<RemoteObsResp>`
      - `* items.algorithm.outputs.remote: object<Remote> -> object<RemoteResp>`
      - `* items.algorithm.outputs: list<Output> -> list<OutputResp>`
...
- _Features_
  - Support the following APIs:
    ...
    - `CheckTrainingExperiment`
    - `CreateAlgorithmVersionToGallery`
    - `CreateTrainingJob`
    - `ShowTrainingJobDetails`
    ...
    - `ListTrainingJobs`
    - `ShowAutoSearchTrials`
    - `ShowAutoSearchPerTrial`
    - `ShowAutoSearchParamsAnalysis`
    - `ShowAutoSearchParamAnalysisResultPath`
    - `ShowAutoSearchTrialEarlyStop`
    ...
    - `ShowWorkflowStepExecutionMetrics`
    - `ShowTrainingExperimentDetails`
    - `ChangeTrainingExperiment`
...
- _Change_
  ...
  - **UpdateWorkspaceQuotas**
    - changes of response param
      - `* quotas.update_time: int32 -> int64`
  - **CreateWorkspace**
    - changes of response param
      - `* update_time: int32 -> int64`
      - `* create_time: int32 -> int64`
...
- _Features_
  - Support the following APIs:
    ...
    - `ListTrainingJobStages`
    - `ListTrainingJobTasks`
    - `NotifyTrainingJobInformation`
    - `ShowAuthmodeDetail`
    - `UpdateAuthMode`
    - `ShowWorkspace`
    - `UpdateWorkspace`
...
- _Change_
  ...
  - **ExecuteInstanceAuthToken**
    - changes of response param
      - `+ data.streamingId`
      - `+ data.resource.sdk.external.address_adn`
  - **CreateInstance**
    - changes of request param
      - `+ os: enum value [AOSP14]`
      - `- os: enum value [AOSP9]`
...
- _API Version_
  - V1
- _Features_
  - Support the API `ListInstanceApp`
- _Bug Fix_
  - None
- _Change_
  - None
