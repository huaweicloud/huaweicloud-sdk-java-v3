...
- _Features_
  - Support the following interfaces：
    - `ListCommonWorkspace`
    - `CreateCommonWorkspace`
    - `UpdateCommonWorkspace`
    - `DeleteCommonWorkspace`
    - `StartReal3DTask`
    ...
    - `ListReal3DProducts`
    - `EstimateSpurPoint`
    - `ShowSpurPredictStatus`
    - `DeleteReal3DProduct`
- _Bug Fix_
  - None
- _Change_
  - Remove the interfaces `ListWorkspace`, `CreateWorkspace`, `UpdateWorkspace`, `DeleteWorkspace`
  - **ValidateImage**
    - changes of request param
      - `+ coordination`
  - **CreateTask**
  ...
  - **ListImageBaseInfo**
    - changes of request param
      ...
      - `+ image_type`
    - changes of response param
      - `+ data_info.product_clip`
      - `+ data_info.product_tile`
      - `+ data_info.is_cog`
      - `- data_info.image_producer`
      - `+ data_info.is_product: enum value [0,1]`
      - `+ data_info.image_type: enum value [0,1]`
...
- _Features_
  - Support the interface `UpdatePersonalTemplateState`
- _Bug Fix_
  - None
- _Change_
  - **ListPortInfos**
...
- _Features_
  - Support the `Object Storage Service`
- _Bug Fix_
  - None
- _Change_
  - None
...
- _Features_
  - Support the service `Exchange Data Space`
- _Bug Fix_
  - None
- _Change_
  - None
...
- _Features_
  - None
- _Bug Fix_
  - Fix the problem that the dependent logging framework cannot be found.
- _Change_
  - None
...
- _Features_
  - Support the service `MetaStudio`
- _Bug Fix_
  - None
- _Change_
  - None
...
- _Bug Fix_
  - None
- _Change_
  - Add the request parameters `sms_signs`, `sms_template`, `vivo_background` to the interface `CreateAimPersonalTemplate`
...
- _Features_
  - Support the interfaces `ListVmsCallbacks`, `AddVmsCallBack`
- _Bug Fix_
  - None
- _Change_
  - Add the response parameter `failed_short_chains` to the interface `CreateAimSendTask`
  - Add the response parameters `failed_short_chains`, `success_number` to the interface `ListAimSendTasks`
...
- _Features_
  - Support the `Multi-Site High Availability Service`
- _Bug Fix_
  - None
- _Change_
  - None
...
- _Features_
  - None
- _Bug Fix_
  - Fixed an issue where a request error occurs because the query parameter value contains an ampersand (&)
- _Change_
  - None
...
- _Bug Fix_
  - None
- _Change_
  - Changes of the interface `CreateResolveTask`:
    - Add the request parameters `generation_type`, `custom_short_code`
    - Add the response parameter `custom_short_code`
  - Changes of the interface `CreateAimSendTask`:
    - Add the request parameters `generation_type`, `custom_short_code`
    - Add the response parameters `generation_type`, `custom_short_code`
...
- _Features_
  - Support the signing algorithm `SM3`
- _Bug Fix_
  - None
- _Change_
  - None
...
- _Features_
  - Support the client configurations `Dispatcher` and `ConnectionPool`
- _Bug Fix_
  - None
- _Change_
  - None
...
- _Bug Fix_
  - None
- _Change_
  - Changes of the interface `ListSecretVersions`:
    - Add the request parameters `marker`, `limit`
...
- _Bug Fix_
  - None
- _Change_
  - Modify the name `task_id` -> `id` of the request parameter of the interface `ExportAsset`
...
- _Features_
  - Support the interface `ShowRestrictionOfInstanceV2`
- _Bug Fix_
  - None
- _Change_
  - Add the response parameters `sl_domains`, `remark`, `call_limits`, `time_interval`, `time_unit`, `is_default`, `version`, `roma_app_id`, `roma_app_name` to the interface `ListApiGroupsV2`
  - Add the response parameters `sl_domains`, `remark`, `call_limits`, `time_interval`, `time_unit`, `is_default`, `version`, `roma_app_id`, `roma_app_name` to the interface `UpdateApiGroupV2`
  - Add the response parameters `sl_domains`, `remark`, `call_limits`, `time_interval`, `time_unit`, `is_default`, `version`, `roma_app_id`, `roma_app_name` to the interface `ShowDetailsOfApiGroupV2`
  - Add the response parameters `type`, `throttle_apply_id`, `throttle_name`, `apply_time` to the interface `ListApisBindedToRequestThrottlingPolicyV2`
  - Add the response parameters `type`, `throttle_apply_id`, `throttle_name`, `apply_time` to the interface `ListApisUnbindedToRequestThrottlingPolicyV2`
...
- _Features_
  - Support the following interfaces:
    ...
    - `UpdateMemberGroup`
    - `DeleteMemberGroup`
    - `ListProjectVpcChannelsV2`
    - `UpdateProjectVpcChannel`
    - `CreateProjectVpcChannel`
    - `CreateProjectVpcChannelSyncs`
    - `ShowDetailsOfInstanceV2`
    - `UpdateBackendInstancesV2`
- _Bug Fix_
  - None
- _Change_
  - Add the request parameter `domain_name` to the interface `ListApiGroupsV2`.
  - Add the request parameters `vpc_channel_id` and `vpc_channel_name` to the interface `ListApisV2`.
  - Add the request parameter `sign_algorithm` to the interfaces `CreateSignatureKeyV2` and `UpdateSignatureKeyV2`.
  - Add the request parameters `dict_code`, `member_host`, `member_port`, `member_group_name` and `member_group_id` to the interface `ListVpcChannelsV2`.
  - Add the request parameters `member_group_name`, `member_group_id` and `precise_search` to the interface `ListBackendInstancesV2`.
  - Add the request parameter `retry_count` to the interface `PublishLiveDataApiV2`.
...
- _Features_
  - Support the interfaces `CreateNotification`, `UpdateNotification`, `DeleteNotification` and `ListNotifications`.
- _Bug Fix_
  - None
- _Change_
  - None
...
- _Change_
  - Modify the name of the interfaces:
    - `CreateKmsTag` -> `CreateSecretTag`
    - `ListKmsTags` -> `ListProjectSecretsTags`
    - `DeleteTag` -> `DeleteSecretTag`
    - `ShowKmsTags` -> `ListSecretTags`
...
- _Features_
  - Support the interfaces `CreateNotification`, `ListNotification`, `UpdateNotification` and `DeleteNotification`.
- _Bug Fix_
  - None
- _Change_
  - None
...
- _Bug Fix_
  - None
- _Change_
  - Modify the type of the response parameters `create_time` and `update_time` of the interface `ListRomaApp`: `number` -> `string`
  - Modify the type of the response parameters `create_time` and `update_time` of the interface `ListDictionary`: `number` -> `string`
...
- _Features_
  - Support custom SSL certificate.
- _Bug Fix_
  - None
- _Change_
  - None
...
- _Features_
  - Support the interface `CheckRomaInstanceListV2`
- _Bug Fix_
  - None
- _Change_
  - None
...
- _Features_
  - Support the interface `ShowLastHistory`.
- _Bug Fix_
  - None
- _Change_
  - None
...
- _Features_
    - Support more interfaces:
        - `ShowTaskDefects`
        - `ShowTaskDefectsStatistic`
        - `ListLibApiMapping`
        - `ListJavaLibUpdateSuggestion`
        - `DownloadLibCodeAnalysisReport`
        - `CollectPluginRecord`
        - `UpdateDefectStatus`
- _Bug Fix_
    - None
...
- _Bug Fix_
    - None
- _Change_
    - Modify the type of request parameter `show_instance_info` of interface `ListSpaceAnalysis`: `boolean`->`string`.
    - Add response parameter `count` to interface `ListInnodbLocks`.
...
- _Features_
    - Support interfaces `CreateJob`,`UpdateJob`
- _Bug Fix_
    - None
- _Change_
    - None
...
- _Bug Fix_
    - None
- _Change_
    - Modify the type of request parameter `raw_devices` of interfaces `RegisterServer`,`UpdateTask`: boolean -> string
    - Add a response parameter `compress_rate` to interfaces `ListTasks`,`ShowTask`
...
- _Features_
    - None
- _Bug Fix_
    - Solve the issue that verifying AK/SK failed while the Content-Type is `multipart/form-data`.
- _Change_
    - Remove a Maven dependency `validation-api`.
...
- _Bug Fix_
    - None
- _Change_
    - Add fields `closed_time` ,`id`,`created_time` to response body of interfaces `ListIssuesV4`, `ListChildIssuesV4`.
