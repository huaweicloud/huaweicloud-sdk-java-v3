...
- _API Version_
  - V1
- _Features_
  - Support the APIs `StopInstancesStreaming`, `StopInstancesSession`
- _Bug Fix_
  - None
- _Change_
  - None
...
- _Change_
  ...
  - **BatchShowSku**
    - changes of response param
      - `+ data.skuSpecResponseList.skuResponses.poolInfo.aosp.network`
      - `+ data.skuSpecResponseList.skuResponses.poolInfo.aosp.enable`
      - `* data.skuSpecResponseList.skuResponses.poolInfo.aosp.id: string -> int32`
  - **ExecuteJob**
    - changes of response param
      - `+ data.jobs.status: enum value [0,3]`
      - `- data.jobs.status: enum value [-1]`
